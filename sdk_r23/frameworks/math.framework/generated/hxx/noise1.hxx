...
struct RenderNoiseInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, RenderNoiseInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(RenderNoiseInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
