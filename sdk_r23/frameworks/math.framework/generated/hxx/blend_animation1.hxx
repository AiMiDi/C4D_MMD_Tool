...
struct BlendTweenInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, BlendTweenInterface>::value || ObserverObjectInterface::HasBase::template Check<I>::value; static I* Cast(BlendTweenInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct BlendAnimationInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, BlendAnimationInterface>::value || ObserverObjectInterface::HasBase::template Check<I>::value; static I* Cast(BlendAnimationInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
