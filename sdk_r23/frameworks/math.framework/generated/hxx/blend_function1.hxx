...
struct BlendFunctionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, BlendFunctionInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(BlendFunctionInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
