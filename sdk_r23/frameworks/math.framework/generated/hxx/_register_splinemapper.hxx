...
namespace maxon
{
	...
	maxon::Bool SplineMapperInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->_SplineMapperInterface_IsEqual = &Hxx2::Wrapper<Hxx2::Unresolved>::_SplineMapperInterface_IsEqual;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SplineMapperInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::_SplineMapperInterface_GetHashCode;
		#else
		tbl->_SplineMapperInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::_SplineMapperInterface_GetHashCode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
