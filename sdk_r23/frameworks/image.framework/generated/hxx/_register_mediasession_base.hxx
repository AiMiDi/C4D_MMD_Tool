...
namespace maxon
{
	...
	namespace enum157 { enum class MEDIAFORMATTYPE
	{
	...
	maxon::String PrivateToString_MEDIAFORMATTYPE157(std::underlying_type<enum157::MEDIAFORMATTYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum157::MEDIAFORMATTYPE::UNDEFINED, (maxon::UInt64) enum157::MEDIAFORMATTYPE::IMAGE, (maxon::UInt64) enum157::MEDIAFORMATTYPE::ALPHA, (maxon::UInt64) enum157::MEDIAFORMATTYPE::LAYERFOLDER, (maxon::UInt64) enum157::MEDIAFORMATTYPE::LAYER, (maxon::UInt64) enum157::MEDIAFORMATTYPE::LAYERADJUSTMENT, (maxon::UInt64) enum157::MEDIAFORMATTYPE::LAYERMASK, (maxon::UInt64) enum157::MEDIAFORMATTYPE::MIPMAP, (maxon::UInt64) enum157::MEDIAFORMATTYPE::DEEPIMAGEDATA};
	...
	namespace enum169 { enum class MEDIAALPHATYPE
	{
		UNDEFINED,			///< Undefined.
		PREMULTIPLIED,	///< The alpha is related to premultiplied rgb data.
		STRAIGHT,				///< The alpha is related to straight rgb data.
	} ; }
	maxon::String PrivateToString_MEDIAALPHATYPE169(std::underlying_type<enum169::MEDIAALPHATYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum169::MEDIAALPHATYPE::UNDEFINED, (maxon::UInt64) enum169::MEDIAALPHATYPE::PREMULTIPLIED, (maxon::UInt64) enum169::MEDIAALPHATYPE::STRAIGHT};
