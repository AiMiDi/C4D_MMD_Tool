...
struct PixelFormatInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PixelFormatInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(PixelFormatInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
