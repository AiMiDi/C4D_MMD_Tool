...
namespace maxon
{
	...
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaSessionFileFormatHandlerInterface, , "net.maxon.image.interface.mediasessionfileformathandler", "maxon.MediaSessionFileFormatHandlerInterface", (FileFormatHandlerInterface::PrivateGetInterface()));
	...
	namespace URLFLAGS
	{
		IMAGESEQUENCE_FPS_PrivateAttribute IMAGESEQUENCE_FPS;
		IMAGESEQUENCE_FIRSTFRAME_PrivateAttribute IMAGESEQUENCE_FIRSTFRAME;
		IMAGESEQUENCE_LASTFRAME_PrivateAttribute IMAGESEQUENCE_LASTFRAME;
	}
