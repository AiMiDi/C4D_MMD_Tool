...
struct MediaStreamFormatInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaStreamFormatInterface>::value || DataDictionaryObjectInterface::HasBase::template Check<I>::value; static I* Cast(MediaStreamFormatInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct MediaStreamFormatInterface::Hxx1
{
	...
	public:
		...
		using RESTRICT_DICTIONARY_PROPS = MediaStreamFormatInterface::RESTRICT_DICTIONARY_PROPS;
	};
	/// Intermediate helper class for MediaStreamFormatInterface.
...
struct MediaStreamPropertiesInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaStreamPropertiesInterface>::value || MediaStreamFormatInterface::HasBase::template Check<I>::value; static I* Cast(MediaStreamPropertiesInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct MediaStreamPropertiesInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using RESTRICT_DICTIONARY_PROPS = MediaStreamPropertiesInterface::RESTRICT_DICTIONARY_PROPS;
	};
	/// Intermediate helper class for MediaStreamPropertiesInterface.
	template <typename S> class ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename MediaStreamFormatInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename MediaStreamFormatInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename MediaStreamFormatInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type> { };
};
