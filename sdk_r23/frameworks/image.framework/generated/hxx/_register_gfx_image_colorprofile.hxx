...
namespace maxon
{
	namespace enum30 { enum class COLORPROFILEINFO
	{
	...
	maxon::String PrivateToString_COLORPROFILEINFO30(std::underlying_type<enum30::COLORPROFILEINFO>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum30::COLORPROFILEINFO::DESCRIPTION, (maxon::UInt64) enum30::COLORPROFILEINFO::MANUFACTURER, (maxon::UInt64) enum30::COLORPROFILEINFO::MODEL, (maxon::UInt64) enum30::COLORPROFILEINFO::COPYRIGHT};
	...
	namespace enum60 { enum class COLORCONVERSIONINTENT
	{
	...
	maxon::String PrivateToString_COLORCONVERSIONINTENT60(std::underlying_type<enum60::COLORCONVERSIONINTENT>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum60::COLORCONVERSIONINTENT::PERCEPTUAL, (maxon::UInt64) enum60::COLORCONVERSIONINTENT::RELATIVE_COLORIMETRIC, (maxon::UInt64) enum60::COLORCONVERSIONINTENT::SATURATION, (maxon::UInt64) enum60::COLORCONVERSIONINTENT::ABSOLUTE_COLORIMETRIC};
	...
	namespace enum78 { enum class COLORCONVERSIONFLAGS
	{
		NONE = 0,
	...
	maxon::String PrivateToString_COLORCONVERSIONFLAGS78(std::underlying_type<enum78::COLORCONVERSIONFLAGS>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum78::COLORCONVERSIONFLAGS::NONE, (maxon::UInt64) enum78::COLORCONVERSIONFLAGS::BLACKPOINTCOMPENSATION};
