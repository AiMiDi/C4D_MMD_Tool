...
namespace maxon
{
	...
	{
		namespace enum52 { enum class ITYPE
			{
				UNDEFINED,
				TEXTURE,
				IMAGE,
		...
		maxon::String PrivateToString_ITYPE52(std::underlying_type<enum52::ITYPE>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum52::ITYPE::UNDEFINED, (maxon::UInt64) enum52::ITYPE::TEXTURE, (maxon::UInt64) enum52::ITYPE::IMAGE, (maxon::UInt64) enum52::ITYPE::ALPHA, (maxon::UInt64) enum52::ITYPE::LAYER, (maxon::UInt64) enum52::ITYPE::LAYERMASK, (maxon::UInt64) enum52::ITYPE::FOLDER, (maxon::UInt64) enum52::ITYPE::ADJUSTMENT, (maxon::UInt64) enum52::ITYPE::DEEPIMAGEDATA};
	...
	namespace enum115 { enum class IMAGEHIERARCHY
	{
	...
	maxon::String PrivateToString_IMAGEHIERARCHY115(std::underlying_type<enum115::IMAGEHIERARCHY>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum115::IMAGEHIERARCHY::TEXTURE, (maxon::UInt64) enum115::IMAGEHIERARCHY::IMAGE, (maxon::UInt64) enum115::IMAGEHIERARCHY::ALPHA, (maxon::UInt64) enum115::IMAGEHIERARCHY::LAYER, (maxon::UInt64) enum115::IMAGEHIERARCHY::MASK, (maxon::UInt64) enum115::IMAGEHIERARCHY::DEEPIMAGEDATA, (maxon::UInt64) enum115::IMAGEHIERARCHY::MAX_ELEMENTS};
...
/// @endcond
	...
	maxon::Bool ImageTextureInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<ImageTextureRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ImageTextureInterface_LoadTexture = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImageTextureInterface_LoadTexture;
		#else
		tbl->_ImageTextureInterface_LoadTexture = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImageTextureInterface_LoadTexture;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
