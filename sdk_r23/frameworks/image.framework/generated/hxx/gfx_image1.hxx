...
struct ImageTextureInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ImageTextureInterface>::value || ImageBaseInterface::HasBase::template Check<I>::value; static I* Cast(ImageTextureInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct ImageInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ImageInterface>::value || ImageBaseInterface::HasBase::template Check<I>::value; static I* Cast(ImageInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct ImageLayerInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ImageLayerInterface>::value || ImageInterface::HasBase::template Check<I>::value; static I* Cast(ImageLayerInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
