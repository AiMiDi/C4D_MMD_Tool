...
struct MediaConverterInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaConverterInterface>::value || MediaBaseInterface::HasBase::template Check<I>::value; static I* Cast(MediaConverterInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct MediaConverterErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaConverterErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(MediaConverterErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
