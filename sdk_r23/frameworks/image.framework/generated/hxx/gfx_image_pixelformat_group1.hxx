...
struct PixelFormatGroupInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PixelFormatGroupInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(PixelFormatGroupInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
