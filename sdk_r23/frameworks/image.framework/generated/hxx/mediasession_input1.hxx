...
struct MediaInputInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaInputInterface>::value || MediaConverterInterface::HasBase::template Check<I>::value; static I* Cast(MediaInputInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
