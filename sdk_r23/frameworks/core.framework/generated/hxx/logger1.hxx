...
struct FileLoggerTypeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, FileLoggerTypeInterface>::value || LoggerTypeInterface::HasBase::template Check<I>::value; static I* Cast(FileLoggerTypeInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct UserLoggerTypeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UserLoggerTypeInterface>::value || LoggerTypeInterface::HasBase::template Check<I>::value; static I* Cast(UserLoggerTypeInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
