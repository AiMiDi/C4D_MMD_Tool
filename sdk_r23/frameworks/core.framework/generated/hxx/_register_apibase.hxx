...
#else
#endif
	namespace enum540 { enum class ENUM_DONT_INITIALIZE
	{
		VALUE
	} ; }
	maxon::String PrivateToString_ENUM_DONT_INITIALIZE540(std::underlying_type<enum540::ENUM_DONT_INITIALIZE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum540::ENUM_DONT_INITIALIZE::VALUE};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "ENUM_DONT_INITIALIZE", SIZEOF(x), false, values, "VALUE\0", fmt);
	}
	namespace enum550 { enum class IN_PLACE_TYPE
	{
		VALUE = 1
	} ; }
	maxon::String PrivateToString_IN_PLACE_TYPE550(std::underlying_type<enum550::IN_PLACE_TYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum550::IN_PLACE_TYPE::VALUE};
...
/// @cond INTERNAL
	...
	namespace enum1670 { enum class TYPE
		{
	...
	maxon::String PrivateToString_TYPE1670(std::underlying_type<enum1670::TYPE>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1670::TYPE::INVALID_0, (maxon::UInt64) enum1670::TYPE::INTERFACE, (maxon::UInt64) enum1670::TYPE::INTERFACE_NVMTABLE, (maxon::UInt64) enum1670::TYPE::NONVIRTUAL_INTERFACE, (maxon::UInt64) enum1670::TYPE::DECLARATION, (maxon::UInt64) enum1670::TYPE::COMPONENT, (maxon::UInt64) enum1670::TYPE::CLASS, (maxon::UInt64) enum1670::TYPE::TRANSLATION_UNIT, (maxon::UInt64) enum1670::TYPE::MODULE, (maxon::UInt64) enum1670::TYPE::INITIALIZATION, (maxon::UInt64) enum1670::TYPE::DEPENDENCY, (maxon::UInt64) enum1670::TYPE::REGISTRY, (maxon::UInt64) enum1670::TYPE::UNUSED, (maxon::UInt64) enum1670::TYPE::GLOBAL, (maxon::UInt64) enum1670::TYPE::COUNT};
	...
	namespace enum1793 { enum class FLAGS : UInt32
		{
			NONE = 0,
	...
	maxon::String PrivateToString_FLAGS1793(std::underlying_type<enum1793::FLAGS>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1793::FLAGS::NONE, (maxon::UInt64) enum1793::FLAGS::CONSTRUCTED, (maxon::UInt64) enum1793::FLAGS::DISABLED, (maxon::UInt64) enum1793::FLAGS::INITIALIZED, (maxon::UInt64) enum1793::FLAGS::INITIALIZING, (maxon::UInt64) enum1793::FLAGS::INITIALIZATION_FAILED, (maxon::UInt64) enum1793::FLAGS::NULL_AS_DEFAULT, (maxon::UInt64) enum1793::FLAGS::USED, (maxon::UInt64) enum1793::FLAGS::HIDDEN, (maxon::UInt64) enum1793::FLAGS::REGISTRATION_UNIT, (maxon::UInt64) enum1793::FLAGS::DEFINITION, (maxon::UInt64) enum1793::FLAGS::SINGLE_BASE, (maxon::UInt64) enum1793::FLAGS::IGNORE_WARNINGS, (maxon::UInt64) enum1793::FLAGS::EXPLICIT, (maxon::UInt64) enum1793::FLAGS::FRAMEWORK, (maxon::UInt64) enum1793::FLAGS::CORE, (maxon::UInt64) enum1793::FLAGS::PROXY, (maxon::UInt64) enum1793::FLAGS::CLASS_PROXY, (maxon::UInt64) enum1793::FLAGS::FINAL, (maxon::UInt64) enum1793::FLAGS::SINGLE_IMPLEMENTATION, (maxon::UInt64) enum1793::FLAGS::MAIN_DEFINITION, (maxon::UInt64) enum1793::FLAGS::CALLABLE, (maxon::UInt64) enum1793::FLAGS::IMPLEMENTABLE, (maxon::UInt64) enum1793::FLAGS::ADAPTER, (maxon::UInt64) enum1793::FLAGS::SYNTHETIC, (maxon::UInt64) enum1793::FLAGS::LIVE, (maxon::UInt64) enum1793::FLAGS::EXPECT_FAILURE, (maxon::UInt64) enum1793::FLAGS::FRAMEWORK_REGISTRATION, (maxon::UInt64) enum1793::FLAGS::MARK, (maxon::UInt64) enum1793::FLAGS::PUBLIC, (maxon::UInt64) enum1793::FLAGS::REFERENCE_NONE, (maxon::UInt64) enum1793::FLAGS::REFERENCE_POINTER, (maxon::UInt64) enum1793::FLAGS::REFERENCE_CONST_POINTER, (maxon::UInt64) enum1793::FLAGS::REFERENCE_NORMAL, (maxon::UInt64) enum1793::FLAGS::REFERENCE_CONST, (maxon::UInt64) enum1793::FLAGS::REFERENCE_COPY_ON_WRITE, (maxon::UInt64) enum1793::FLAGS::REFERENCE_ALWAYS_COPY_ON_WRITE, (maxon::UInt64) enum1793::FLAGS::REFERENCE_MASK, (maxon::UInt64) enum1793::FLAGS::ON_CONSTRUCTION_MASK};
...
/// @endcond
...
#ifdef USE_API_MAXON
#endif
	namespace enum2310 { enum class VALUEKIND : UInt64
	{
		NONE													= 0,
	...
	maxon::String PrivateToString_VALUEKIND2310(std::underlying_type<enum2310::VALUEKIND>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum2310::VALUEKIND::NONE, (maxon::UInt64) enum2310::VALUEKIND::VOID_TYPE, (maxon::UInt64) enum2310::VALUEKIND::GENERIC, (maxon::UInt64) enum2310::VALUEKIND::GENERIC_ARITHMETIC, (maxon::UInt64) enum2310::VALUEKIND::SCALAR, (maxon::UInt64) enum2310::VALUEKIND::INTEGRAL, (maxon::UInt64) enum2310::VALUEKIND::FLOATING_POINT, (maxon::UInt64) enum2310::VALUEKIND::ENUM, (maxon::UInt64) enum2310::VALUEKIND::ENUM_LIST, (maxon::UInt64) enum2310::VALUEKIND::ENUM_FLAGS, (maxon::UInt64) enum2310::VALUEKIND::DATA, (maxon::UInt64) enum2310::VALUEKIND::DATAPTR, (maxon::UInt64) enum2310::VALUEKIND::NONVIRTUAL_INTERFACE, (maxon::UInt64) enum2310::VALUEKIND::VIRTUAL_INTERFACE, (maxon::UInt64) enum2310::VALUEKIND::REF_OR_POINTER, (maxon::UInt64) enum2310::VALUEKIND::POINTER, (maxon::UInt64) enum2310::VALUEKIND::STRONG_REFERENCE, (maxon::UInt64) enum2310::VALUEKIND::COW_REFERENCE, (maxon::UInt64) enum2310::VALUEKIND::UNIQUE_REFERENCE, (maxon::UInt64) enum2310::VALUEKIND::ACOW_REFERENCE, (maxon::UInt64) enum2310::VALUEKIND::LV_REFERENCE, (maxon::UInt64) enum2310::VALUEKIND::RV_REFERENCE, (maxon::UInt64) enum2310::VALUEKIND::TUPLE, (maxon::UInt64) enum2310::VALUEKIND::STRUCT, (maxon::UInt64) enum2310::VALUEKIND::SIMD, (maxon::UInt64) enum2310::VALUEKIND::BLOCK, (maxon::UInt64) enum2310::VALUEKIND::STRIDED_BLOCK, (maxon::UInt64) enum2310::VALUEKIND::BASEARRAY, (maxon::UInt64) enum2310::VALUEKIND::BLOCKARRAY, (maxon::UInt64) enum2310::VALUEKIND::RESULT, (maxon::UInt64) enum2310::VALUEKIND::DELEGATE, (maxon::UInt64) enum2310::VALUEKIND::FUNCTION, (maxon::UInt64) enum2310::VALUEKIND::CONST_QUALIFIED, (maxon::UInt64) enum2310::VALUEKIND::OPAQUE_QUALIFIED, (maxon::UInt64) enum2310::VALUEKIND::SOURCE_LEVEL, (maxon::UInt64) enum2310::VALUEKIND::DEEP_CONSTNESS, (maxon::UInt64) enum2310::VALUEKIND::INT_SIZE_OR_LESS, (maxon::UInt64) enum2310::VALUEKIND::ZERO_INITIALIZED, (maxon::UInt64) enum2310::VALUEKIND::ORDERED, (maxon::UInt64) enum2310::VALUEKIND::TRIVIALLY_CONSTRUCTIBLE, (maxon::UInt64) enum2310::VALUEKIND::TRIVIALLY_DESTRUCTIBLE, (maxon::UInt64) enum2310::VALUEKIND::TRIVIALLY_COPYABLE, (maxon::UInt64) enum2310::VALUEKIND::TRIVIALLY_EQUATABLE, (maxon::UInt64) enum2310::VALUEKIND::OBJECT_REF, (maxon::UInt64) enum2310::VALUEKIND::VALUE, (maxon::UInt64) enum2310::VALUEKIND::ELEMENT_TYPE_AS_ARG, (maxon::UInt64) enum2310::VALUEKIND::NEVER_NULLPTR, (maxon::UInt64) enum2310::VALUEKIND::SIGNED, (maxon::UInt64) enum2310::VALUEKIND::GENERIC_INSTANTIATION, (maxon::UInt64) enum2310::VALUEKIND::GLOBALLY_REFERENCED, (maxon::UInt64) enum2310::VALUEKIND::ABSTRACT, (maxon::UInt64) enum2310::VALUEKIND::NAMED, (maxon::UInt64) enum2310::VALUEKIND::CONTAINER_REF, (maxon::UInt64) enum2310::VALUEKIND::GENERIC_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::RECURSIVE_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::RESOLVED_RECURSIVE_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::EMPTY_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::SINGLETON_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::STATIC_ARRAY_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::ARRAY_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::ARRAY, (maxon::UInt64) enum2310::VALUEKIND::CONTAINER_MASK, (maxon::UInt64) enum2310::VALUEKIND::NAMED_TUPLE, (maxon::UInt64) enum2310::VALUEKIND::MIN_DERIVED_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::MIN_ARRAY_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::MAX_ARRAY_CONTAINER, (maxon::UInt64) enum2310::VALUEKIND::COW_MASK, (maxon::UInt64) enum2310::VALUEKIND::STRONG_MASK, (maxon::UInt64) enum2310::VALUEKIND::PTR_MASK, (maxon::UInt64) enum2310::VALUEKIND::CONTAINER_OR_REF, (maxon::UInt64) enum2310::VALUEKIND::REFERENCE_MASK, (maxon::UInt64) enum2310::VALUEKIND::ARITHMETIC_MASK, (maxon::UInt64) enum2310::VALUEKIND::TUPLE_MASK, (maxon::UInt64) enum2310::VALUEKIND::TUPLE_INHERIT_MASK, (maxon::UInt64) enum2310::VALUEKIND::POINTER_FLAGS, (maxon::UInt64) enum2310::VALUEKIND::QUALIFIER_MASK};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "VALUEKIND", SIZEOF(x), true, values, "NONE\0VOID_TYPE\0GENERIC\0GENERIC_ARITHMETIC\0SCALAR\0INTEGRAL\0FLOATING_POINT\0ENUM\0ENUM_LIST\0ENUM_FLAGS\0DATA\0DATAPTR\0NONVIRTUAL_INTERFACE\0VIRTUAL_INTERFACE\0REF_OR_POINTER\0POINTER\0STRONG_REFERENCE\0COW_REFERENCE\0UNIQUE_REFERENCE\0ACOW_REFERENCE\0LV_REFERENCE\0RV_REFERENCE\0TUPLE\0STRUCT\0SIMD\0BLOCK\0STRIDED_BLOCK\0BASEARRAY\0BLOCKARRAY\0RESULT\0DELEGATE\0FUNCTION\0CONST_QUALIFIED\0OPAQUE_QUALIFIED\0SOURCE_LEVEL\0DEEP_CONSTNESS\0INT_SIZE_OR_LESS\0ZERO_INITIALIZED\0ORDERED\0TRIVIALLY_CONSTRUCTIBLE\0TRIVIALLY_DESTRUCTIBLE\0TRIVIALLY_COPYABLE\0TRIVIALLY_EQUATABLE\0OBJECT_REF\0VALUE\0ELEMENT_TYPE_AS_ARG\0NEVER_NULLPTR\0SIGNED\0GENERIC_INSTANTIATION\0GLOBALLY_REFERENCED\0ABSTRACT\0NAMED\0CONTAINER_REF\0GENERIC_CONTAINER\0RECURSIVE_CONTAINER\0RESOLVED_RECURSIVE_CONTAINER\0CONTAINER\0EMPTY_CONTAINER\0SINGLETON_CONTAINER\0STATIC_ARRAY_CONTAINER\0ARRAY_CONTAINER\0ARRAY\0CONTAINER_MASK\0NAMED_TUPLE\0MIN_DERIVED_CONTAINER\0MIN_ARRAY_CONTAINER\0MAX_ARRAY_CONTAINER\0COW_MASK\0STRONG_MASK\0PTR_MASK\0CONTAINER_OR_REF\0REFERENCE_MASK\0ARITHMETIC_MASK\0TUPLE_MASK\0TUPLE_INHERIT_MASK\0POINTER_FLAGS\0QUALIFIER_MASK\0", fmt);
	}
	PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(DT_VALUEKIND, , "net.maxon.datatype.enum.valuekind");
	namespace enum2356 { enum class COLLECTION_KIND
	{
	...
	maxon::String PrivateToString_COLLECTION_KIND2356(std::underlying_type<enum2356::COLLECTION_KIND>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum2356::COLLECTION_KIND::NONE, (maxon::UInt64) enum2356::COLLECTION_KIND::ARRAY, (maxon::UInt64) enum2356::COLLECTION_KIND::SET, (maxon::UInt64) enum2356::COLLECTION_KIND::MAP};
