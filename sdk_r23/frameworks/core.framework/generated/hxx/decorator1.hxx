...
struct DecoratorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DecoratorInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(DecoratorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct EagerDecoratorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, EagerDecoratorInterface>::value || DecoratorInterface::HasBase::template Check<I>::value; static I* Cast(EagerDecoratorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct WeakDecoratorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, WeakDecoratorInterface>::value || DecoratorInterface::HasBase::template Check<I>::value; static I* Cast(WeakDecoratorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
