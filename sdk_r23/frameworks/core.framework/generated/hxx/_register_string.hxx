...
namespace maxon
{
	namespace enum44 { enum class STRINGCONVERSION
	{
		NONE									= 0,
	...
	maxon::String PrivateToString_STRINGCONVERSION44(std::underlying_type<enum44::STRINGCONVERSION>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum44::STRINGCONVERSION::NONE, (maxon::UInt64) enum44::STRINGCONVERSION::ALLOW_MORE_CHARACTERS};
	...
	namespace enum56 { enum class STRINGCOMPARISON
	{
	...
	maxon::String PrivateToString_STRINGCOMPARISON56(std::underlying_type<enum56::STRINGCOMPARISON>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum56::STRINGCOMPARISON::MEMORY, (maxon::UInt64) enum56::STRINGCOMPARISON::UNICODE_LETTERS, (maxon::UInt64) enum56::STRINGCOMPARISON::UNICODE_NUMBERS, (maxon::UInt64) enum56::STRINGCOMPARISON::CASEINSENSITIVE, (maxon::UInt64) enum56::STRINGCOMPARISON::CASEINSENSITIVE_NUMBERS};
