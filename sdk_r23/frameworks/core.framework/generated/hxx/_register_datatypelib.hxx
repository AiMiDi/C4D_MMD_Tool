...
namespace maxon
{
	namespace enum309 { enum class INNERMOST_MEMBER : Int32
	{
	} ; }
	maxon::String PrivateToString_INNERMOST_MEMBER309(std::underlying_type<enum309::INNERMOST_MEMBER>::type x, const maxon::FormatStatement* fmt)
	{
