...
namespace maxon
{
	...
	namespace enum1015 { enum class BASE_OF_MODE
		{
			NONE,
	...
	maxon::String PrivateToString_BASE_OF_MODE1015(std::underlying_type<enum1015::BASE_OF_MODE>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1015::BASE_OF_MODE::NONE, (maxon::UInt64) enum1015::BASE_OF_MODE::ORDERED_TYPE_ONLY, (maxon::UInt64) enum1015::BASE_OF_MODE::UNORDERED_BY_NAME, (maxon::UInt64) enum1015::BASE_OF_MODE::GENERIC_DOWNCAST};
...
#endif
	namespace enum1119 { enum class GET_DATATYPE_POLICY
	{
		NONE = 0,
	...
	maxon::String PrivateToString_GET_DATATYPE_POLICY1119(std::underlying_type<enum1119::GET_DATATYPE_POLICY>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1119::GET_DATATYPE_POLICY::NONE, (maxon::UInt64) enum1119::GET_DATATYPE_POLICY::GENERIC_FOR_UNKNOWN, (maxon::UInt64) enum1119::GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN, (maxon::UInt64) enum1119::GET_DATATYPE_POLICY::NO_DECAY, (maxon::UInt64) enum1119::GET_DATATYPE_POLICY::ALLOW_BASEARRAY, (maxon::UInt64) enum1119::GET_DATATYPE_POLICY::RESULT_FOR_UNKNOWN_MASK};
