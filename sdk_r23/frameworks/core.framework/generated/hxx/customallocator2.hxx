...
struct CustomAllocatorInterface::Hxx2
{
	...
	public:
		...
		static void* _CustomAllocatorInterface_Alloc_1(CustomAllocatorInterface* this_, Int s, const maxon::SourceLocation& allocLocation) { return C::Get(this_)->Alloc(s, allocLocation); }
		static void* _CustomAllocatorInterface_AllocClear(CustomAllocatorInterface* this_, Int s, const maxon::SourceLocation& allocLocation) { return C::Get(this_)->AllocClear(s, allocLocation); }
		static void* _CustomAllocatorInterface_Realloc(CustomAllocatorInterface* this_, void* data, Int size, const maxon::SourceLocation& allocLocation) { return C::Get(this_)->Realloc(data, size, allocLocation); }
		static void* _CustomAllocatorInterface_PrivateAlloc(CustomAllocatorInterface* this_, Int size, Bool clear, const maxon::SourceLocation& allocLocation) { return C::Get(this_)->PrivateAlloc(size, clear, allocLocation); }
		static void _CustomAllocatorInterface_PrivateFree(CustomAllocatorInterface* this_, void* data) { return C::Get(this_)->PrivateFree(data); }
		static Int _CustomAllocatorInterface_PrivateGetDataSize(CustomAllocatorInterface* this_, void* data) { return C::Get(this_)->PrivateGetDataSize(data); }
	};
