...
struct ObjectInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ObjectInterface>::value || std::is_same<I, maxon::ObjectInterface>::value; static I* Cast(ObjectInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
/// @return												Success of message handling.
		inline Result<void> HandleMessage(const InternedId& message, const void* argument) const;
/// @cond INTERNAL
...
/// @param[in] argument						A message-specific argument.
/// @return												Success of message handling.
		inline Result<void> HandleMessage(const InternedId& message, const void* argument);
/// @cond INTERNAL
...
struct ErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ErrorInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(ErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
