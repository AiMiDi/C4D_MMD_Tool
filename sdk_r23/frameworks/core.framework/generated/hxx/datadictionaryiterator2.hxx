...
struct DataDictionaryIteratorInterface::Hxx2
{
	...
	{
	public:
		static void _DataDictionaryIteratorInterface_Destruct(DataDictionaryIteratorInterface* this_) { return C::Get(this_)->Destruct(); }
		static void _DataDictionaryIteratorInterface_MoveConstruct(DataDictionaryIteratorInterface* this_, DataDictionaryIteratorInterface* src) { return C::Get(this_)->MoveConstruct(src); }
		static Bool _DataDictionaryIteratorInterface_HasValue(const DataDictionaryIteratorInterface* this_) { return C::Get(this_)->HasValue(); }
		static Bool _DataDictionaryIteratorInterface_IsEqual(const DataDictionaryIteratorInterface* this_, const DataDictionaryIteratorInterface* other) { return C::Get(this_)->IsEqual(other); }
		static void _DataDictionaryIteratorInterface_MoveToNext(DataDictionaryIteratorInterface* this_) { return C::Get(this_)->MoveToNext(); }
		static void _DataDictionaryIteratorInterface_GetKeyAndData(const DataDictionaryIteratorInterface* this_, Tuple<const Data&, const Data&>& res) { return C::Get(this_)->GetKeyAndData(res); }
	};
