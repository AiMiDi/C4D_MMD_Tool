...
namespace maxon
{
	...
	namespace enum81 { enum class LOADDESCRIPTIONMODE
	{
	...
	maxon::String PrivateToString_LOADDESCRIPTIONMODE81(std::underlying_type<enum81::LOADDESCRIPTIONMODE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum81::LOADDESCRIPTIONMODE::COMPLETE, (maxon::UInt64) enum81::LOADDESCRIPTIONMODE::OVERWRITTEN};
