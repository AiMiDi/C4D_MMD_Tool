...
struct Member::Hxx2
{
	...
	{
	public:
		static const Container* _Member_GetEnclosingContainer(const Member* this_) { return C::Get(this_)->GetEnclosingContainer(); }
		static KIND _Member_GetKind(const Member* this_) { return C::Get(this_)->GetKind(); }
		static const Id& _Member_GetSimpleName(const Member* this_) { return C::Get(this_)->GetSimpleName(); }
		static const Id& _Member_GetId(const Member* this_) { return C::Get(this_)->GetId(); }
		static String _Member_ToString(const Member* this_, const FormatStatement* fs) { return C::Get(this_)->ToString(fs); }
...
struct Container::Hxx2
{
	...
	{
	public:
		static Block<const Class* const> _Container_GetClasses(const Container* this_) { return C::Get(this_)->GetClasses(); }
		static const Class* _Container_FindClass(const Container* this_, const Id& name) { return C::Get(this_)->FindClass(name); }
		static Block<const Function* const> _Container_GetFunctions(const Container* this_) { return C::Get(this_)->GetFunctions(); }
		static Result<const Function*> _Container_FindFunction(const Container* this_, const Id& name) { return C::Get(this_)->FindFunction(name); }
		static Result<void> _Container_FindFunctions(const Container* this_, const Id& name, const ValueReceiver<const Function*>& result) { return C::Get(this_)->FindFunctions(name, result); }
	};
...
struct Package::Hxx2
{
	...
	{
	public:
		static Block<const Package* const> _Package_GetPackages(const Package* this_) { return C::Get(this_)->GetPackages(); }
		static const Package* _Package_FindPackage(const Package* this_, const Id& name) { return C::Get(this_)->FindPackage(name); }
...
struct Class::Hxx2
{
	...
	{
	public:
		static const InterfaceReference* _Class_GetInterface(const Class* this_) { return C::Get(this_)->GetInterface(); }
		static const NonvirtualInterfaceReference* _Class_GetNonvirtualInterface(const Class* this_) { return C::Get(this_)->GetNonvirtualInterface(); }
		static Block<const Class* const> _Class_GetBaseClasses(const Class* this_) { return C::Get(this_)->GetBaseClasses(); }
		static const Class* _Class_GetStaticInterface(const Class* this_) { return C::Get(this_)->GetStaticInterface(); }
	};
...
struct Function::Hxx2
{
	...
	{
	public:
		static Result<void> _Function_Invoke(const Function* this_, void* result, const Block<Argument>& arguments) { return C::Get(this_)->Invoke(result, arguments); }
		static ParameterType _Function_GetReturnType(const Function* this_) { return C::Get(this_)->GetReturnType(); }
		static Block<const ParameterType> _Function_GetParameterTypes(const Function* this_) { return C::Get(this_)->GetParameterTypes(); }
		static const Block<const Parameter>& _Function_GetParameters(const Function* this_) { return C::Get(this_)->GetParameters(); }
		static Bool _Function_IsPure(const Function* this_) { return C::Get(this_)->IsPure(); }
		static void* _Function_GetAddress(const Function* this_) { return C::Get(this_)->GetAddress(); }
