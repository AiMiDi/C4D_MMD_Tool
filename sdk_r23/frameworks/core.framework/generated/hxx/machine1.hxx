...
struct MachineInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MachineInterface>::value || ObserverObjectInterface::HasBase::template Check<I>::value; static I* Cast(MachineInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
