...
namespace maxon
{
	...
	namespace enum1904 { enum class NO_MATCH_TYPE
	{
		VALUE = 1
	} ; }
	maxon::String PrivateToString_NO_MATCH_TYPE1904(std::underlying_type<enum1904::NO_MATCH_TYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum1904::NO_MATCH_TYPE::VALUE};
