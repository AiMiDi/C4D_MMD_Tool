...
struct IoBrowseInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IoBrowseInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(IoBrowseInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
