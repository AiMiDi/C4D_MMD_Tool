...
struct ObserverObjectInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ObserverObjectInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(ObserverObjectInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
