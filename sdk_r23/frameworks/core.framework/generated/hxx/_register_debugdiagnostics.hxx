...
namespace maxon
{
	namespace enum38 { enum class TARGETAUDIENCE
	{
		DEBUGGER = 1 << 1,
		DEVELOPERS = 1 << 2,
		USERS = 1 << 3,
	...
	maxon::String PrivateToString_TARGETAUDIENCE38(std::underlying_type<enum38::TARGETAUDIENCE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum38::TARGETAUDIENCE::DEBUGGER, (maxon::UInt64) enum38::TARGETAUDIENCE::DEVELOPERS, (maxon::UInt64) enum38::TARGETAUDIENCE::USERS, (maxon::UInt64) enum38::TARGETAUDIENCE::ALL};
	...
	namespace enum49 { enum class WRITEMETA
	{
	...
	maxon::String PrivateToString_WRITEMETA49(std::underlying_type<enum49::WRITEMETA>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum49::WRITEMETA::DEFAULT, (maxon::UInt64) enum49::WRITEMETA::WARNING, (maxon::UInt64) enum49::WRITEMETA::CRITICAL, (maxon::UInt64) enum49::WRITEMETA::NONEWLINE, (maxon::UInt64) enum49::WRITEMETA::UI_SYNC_DRAW};
	...
	namespace enum60 { enum class OUTPUT
	{
	...
	maxon::String PrivateToString_OUTPUT60(std::underlying_type<enum60::OUTPUT>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum60::OUTPUT::DIAGNOSTIC, (maxon::UInt64) enum60::OUTPUT::WARNING, (maxon::UInt64) enum60::OUTPUT::CRITICAL, (maxon::UInt64) enum60::OUTPUT::NOLINEBREAK, (maxon::UInt64) enum60::OUTPUT::HEADER};
