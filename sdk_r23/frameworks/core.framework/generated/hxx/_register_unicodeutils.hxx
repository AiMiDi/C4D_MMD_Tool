...
namespace maxon
{
	...
	namespace enum57 { enum class CHARACTERTYPE : UChar
	{
		UNKNOWN = 0,
		LU, // Letter, Uppercase
		LL, // Letter, Lowercase
	...
	maxon::String PrivateToString_CHARACTERTYPE57(std::underlying_type<enum57::CHARACTERTYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum57::CHARACTERTYPE::UNKNOWN, (maxon::UInt64) enum57::CHARACTERTYPE::LU, (maxon::UInt64) enum57::CHARACTERTYPE::LL, (maxon::UInt64) enum57::CHARACTERTYPE::LT, (maxon::UInt64) enum57::CHARACTERTYPE::LM, (maxon::UInt64) enum57::CHARACTERTYPE::LO, (maxon::UInt64) enum57::CHARACTERTYPE::MN, (maxon::UInt64) enum57::CHARACTERTYPE::MC, (maxon::UInt64) enum57::CHARACTERTYPE::ME, (maxon::UInt64) enum57::CHARACTERTYPE::ND, (maxon::UInt64) enum57::CHARACTERTYPE::NL, (maxon::UInt64) enum57::CHARACTERTYPE::NO, (maxon::UInt64) enum57::CHARACTERTYPE::PC, (maxon::UInt64) enum57::CHARACTERTYPE::PD, (maxon::UInt64) enum57::CHARACTERTYPE::PS, (maxon::UInt64) enum57::CHARACTERTYPE::PE, (maxon::UInt64) enum57::CHARACTERTYPE::PI, (maxon::UInt64) enum57::CHARACTERTYPE::PF, (maxon::UInt64) enum57::CHARACTERTYPE::PO, (maxon::UInt64) enum57::CHARACTERTYPE::SM, (maxon::UInt64) enum57::CHARACTERTYPE::SC, (maxon::UInt64) enum57::CHARACTERTYPE::SK, (maxon::UInt64) enum57::CHARACTERTYPE::SO, (maxon::UInt64) enum57::CHARACTERTYPE::ZS, (maxon::UInt64) enum57::CHARACTERTYPE::ZL, (maxon::UInt64) enum57::CHARACTERTYPE::ZP, (maxon::UInt64) enum57::CHARACTERTYPE::CC, (maxon::UInt64) enum57::CHARACTERTYPE::CF, (maxon::UInt64) enum57::CHARACTERTYPE::CS, (maxon::UInt64) enum57::CHARACTERTYPE::CO, (maxon::UInt64) enum57::CHARACTERTYPE::CN};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "CHARACTERTYPE", SIZEOF(x), false, values, "UNKNOWN\0LU\0LL\0LT\0LM\0LO\0MN\0MC\0ME\0ND\0NL\0NO\0PC\0PD\0PS\0PE\0PI\0PF\0PO\0SM\0SC\0SK\0SO\0ZS\0ZL\0ZP\0CC\0CF\0CS\0CO\0CN\0", fmt);
	}
	...
	maxon::Bool UnicodeUtils::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<CHARACTERTYPE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UnicodeUtils_GetCharacterType = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_GetCharacterType;
		#else
		tbl->_UnicodeUtils_GetCharacterType = &Hxx2::Wrapper<Hxx2::Unresolved>::_UnicodeUtils_GetCharacterType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
