...
namespace maxon
{
	...
	namespace enum78 { enum class OPENSTREAMFLAGS
	{
		NONE														= 0,				///< No flags set.
	...
	maxon::String PrivateToString_OPENSTREAMFLAGS78(std::underlying_type<enum78::OPENSTREAMFLAGS>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum78::OPENSTREAMFLAGS::NONE, (maxon::UInt64) enum78::OPENSTREAMFLAGS::WRITE_DONT_TRUNCATE, (maxon::UInt64) enum78::OPENSTREAMFLAGS::ALLOW_SHARED_READ_WRITE_ACCESS, (maxon::UInt64) enum78::OPENSTREAMFLAGS::SEEK_TO_END, (maxon::UInt64) enum78::OPENSTREAMFLAGS::FULL_DUPLEX, (maxon::UInt64) enum78::OPENSTREAMFLAGS::ASK_FOR_REMOVE_WRITE_PROTECTION};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "OPENSTREAMFLAGS", SIZEOF(x), true, values, "NONE\0WRITE_DONT_TRUNCATE\0ALLOW_SHARED_READ_WRITE_ACCESS\0SEEK_TO_END\0FULL_DUPLEX\0ASK_FOR_REMOVE_WRITE_PROTECTION\0", fmt);
	}
	PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(DT_OPENSTREAMFLAGS, , "net.maxon.datatype.enum.openstreamflags");
	namespace enum93 { enum class NORMALIZEFLAGS
	{
	...
	maxon::String PrivateToString_NORMALIZEFLAGS93(std::underlying_type<enum93::NORMALIZEFLAGS>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum93::NORMALIZEFLAGS::NONE, (maxon::UInt64) enum93::NORMALIZEFLAGS::SCHEME_BASED, (maxon::UInt64) enum93::NORMALIZEFLAGS::CASE, (maxon::UInt64) enum93::NORMALIZEFLAGS::PATH_SEGMENT, (maxon::UInt64) enum93::NORMALIZEFLAGS::UNICODE_DECOMPOSITION, (maxon::UInt64) enum93::NORMALIZEFLAGS::UNDERLYING};
	...
	namespace enum123 { enum class IOATTRIBUTES : UInt
	{
		NONE = 0,
	...
	maxon::String PrivateToString_IOATTRIBUTES123(std::underlying_type<enum123::IOATTRIBUTES>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum123::IOATTRIBUTES::NONE, (maxon::UInt64) enum123::IOATTRIBUTES::READONLY, (maxon::UInt64) enum123::IOATTRIBUTES::HIDDEN, (maxon::UInt64) enum123::IOATTRIBUTES::ARCHIVE, (maxon::UInt64) enum123::IOATTRIBUTES::LOCKED, (maxon::UInt64) enum123::IOATTRIBUTES::OWNER_R, (maxon::UInt64) enum123::IOATTRIBUTES::OWNER_W, (maxon::UInt64) enum123::IOATTRIBUTES::OWNER_X, (maxon::UInt64) enum123::IOATTRIBUTES::GROUP_R, (maxon::UInt64) enum123::IOATTRIBUTES::GROUP_W, (maxon::UInt64) enum123::IOATTRIBUTES::GROUP_X, (maxon::UInt64) enum123::IOATTRIBUTES::PUBLIC_R, (maxon::UInt64) enum123::IOATTRIBUTES::PUBLIC_W, (maxon::UInt64) enum123::IOATTRIBUTES::PUBLIC_X, (maxon::UInt64) enum123::IOATTRIBUTES::RW_MASK, (maxon::UInt64) enum123::IOATTRIBUTES::RWX_MASK, (maxon::UInt64) enum123::IOATTRIBUTES::MASK_ALL};
	...
	namespace enum156 { enum class IOSHOWINOSFLAGS
	{
		NONE							= 0,			///< No flags.
	...
	maxon::String PrivateToString_IOSHOWINOSFLAGS156(std::underlying_type<enum156::IOSHOWINOSFLAGS>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum156::IOSHOWINOSFLAGS::NONE, (maxon::UInt64) enum156::IOSHOWINOSFLAGS::SHOW_IN_EXPLORER, (maxon::UInt64) enum156::IOSHOWINOSFLAGS::OPEN_IN_EXPLORER};
