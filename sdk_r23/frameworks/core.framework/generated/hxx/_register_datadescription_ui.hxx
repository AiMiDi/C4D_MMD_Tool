...
namespace maxon
{
	...
	maxon::Bool DataDescriptionUIInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionUIInterface_EvaluateCondition = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_DataDescriptionUIInterface_EvaluateCondition;
		#else
		tbl->_DataDescriptionUIInterface_EvaluateCondition = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_DataDescriptionUIInterface_EvaluateCondition;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionUIInterface_BuildPopupMenuForDescription = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_DataDescriptionUIInterface_BuildPopupMenuForDescription;
		#else
		tbl->_DataDescriptionUIInterface_BuildPopupMenuForDescription = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_DataDescriptionUIInterface_BuildPopupMenuForDescription;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
