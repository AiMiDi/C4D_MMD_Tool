...
struct FunctionBaseInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, FunctionBaseInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(FunctionBaseInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct CombinerInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CombinerInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(CombinerInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct ObservableBaseInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ObservableBaseInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(ObservableBaseInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
