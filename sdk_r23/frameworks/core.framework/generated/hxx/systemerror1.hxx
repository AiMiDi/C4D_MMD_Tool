...
struct SystemErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, SystemErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(SystemErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct NSSystemErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, NSSystemErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(NSSystemErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
