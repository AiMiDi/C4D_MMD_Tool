...
struct DimensionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DimensionInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(DimensionInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
