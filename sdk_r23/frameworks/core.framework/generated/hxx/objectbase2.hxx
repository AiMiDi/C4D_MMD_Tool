...
struct ObjectInterface::MTable
{
	...
	Result<void> (*_ObjectInterface_HandleMessage) (maxon::GenericComponent* this_, const InternedId& message, const void* argument);
...
struct ObjectInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _ObjectInterface_HandleMessage(maxon::GenericComponent* this_, const InternedId& message, const void* argument) { return ((typename S::Implementation*) this_)->HandleMessage(message, argument); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ObjectInterface::HandleMessage(const InternedId& message, const void* argument) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObjectInterface::Hxx1::ReferenceFunctionsImpl<S>::HandleMessage(const InternedId& message, const void* argument) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObjectInterface* o_ = (ObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObjectInterface, o_, ObjectInterface_HandleMessage) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObjectInterface>() : PRIVATE_MAXON_VTABLE(ObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObjectInterface::Hxx1::COWReferenceFunctionsImpl<S>::HandleMessage(const InternedId& message, const void* argument) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObjectInterface* o_ = (ObjectInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObjectInterface, o_, ObjectInterface_HandleMessage) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObjectInterface>() : PRIVATE_MAXON_VTABLE(ObjectInterface, o_); 
	return (mt_._ObjectInterface_HandleMessage(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_HandleMessage_Offset, message, argument));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<HashInt>, HashInt>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ObjectInterface* o_ = (const ObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = ObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<HashInt>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObjectInterface, o_, ObjectInterface_GetHashCodeImpl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObjectInterface>() : PRIVATE_MAXON_VTABLE(ObjectInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<HashValue>, HashValue>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ObjectInterface* o_ = (const ObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = ObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<HashValue>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObjectInterface, o_, ObjectInterface_GetHashValueImpl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObjectInterface>() : PRIVATE_MAXON_VTABLE(ObjectInterface, o_); 
...
{
	static_assert(!S::HAS_ERROR, "ErrorInterface::SetStackTrace can't be used on a Result object because it does not return a Result object itself."); ErrorInterface* o_ = (ErrorInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return this->PrivateGetRefMember(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ErrorInterface, o_, ErrorInterface_SetStackTrace) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ErrorInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ErrorInterface>() : PRIVATE_MAXON_VTABLE(ErrorInterface, o_); 
...
{
	static_assert(!S::HAS_ERROR, "ErrorInterface::SetMessage can't be used on a Result object because it does not return a Result object itself."); ErrorInterface* o_ = (ErrorInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return this->PrivateGetRefMember(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ErrorInterface, o_, ErrorInterface_SetMessage) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ErrorInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ErrorInterface>() : PRIVATE_MAXON_VTABLE(ErrorInterface, o_); 
...
{
	static_assert(!S::HAS_ERROR, "ErrorInterface::SetCause can't be used on a Result object because it does not return a Result object itself."); ErrorInterface* o_ = (ErrorInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return this->PrivateGetRefMember(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ErrorInterface, o_, ErrorInterface_SetCause) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ErrorInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ErrorInterface>() : PRIVATE_MAXON_VTABLE(ErrorInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ErrorInterface* o_ = (ErrorInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ErrorInterface, o_, ErrorInterface_SetMachine) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ErrorInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ErrorInterface>() : PRIVATE_MAXON_VTABLE(ErrorInterface, o_); 
...
{
	static_assert(!S::HAS_ERROR, "ErrorInterface::PrivateSetCode can't be used on a Result object because it does not return a Result object itself."); ErrorInterface* o_ = (ErrorInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return this->PrivateGetRefMember(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ErrorInterface, o_, ErrorInterface_PrivateSetCode) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ErrorInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ErrorInterface>() : PRIVATE_MAXON_VTABLE(ErrorInterface, o_); 
