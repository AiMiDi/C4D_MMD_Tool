...
struct UrlFileCacheEntryInterface::Hxx2
{
	...
	public:
		...
		static Url _UrlFileCacheEntryInterface_GetSourceUrl(const UrlFileCacheEntryInterface* this_) { return C::Get(this_)->GetSourceUrl(); }
		static Url _UrlFileCacheEntryInterface_GetCacheUrl(const UrlFileCacheEntryInterface* this_) { return C::Get(this_)->GetCacheUrl(); }
	};
