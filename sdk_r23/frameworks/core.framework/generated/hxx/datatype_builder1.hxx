...
struct DataTypeBuilderInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataTypeBuilderInterface>::value || Object::HasBase::template Check<I>::value; static I* Cast(DataTypeBuilderInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataTypeBuilderInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::Hxx1::template ReferenceFunctionsHelper<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename Object::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type> { };
};
