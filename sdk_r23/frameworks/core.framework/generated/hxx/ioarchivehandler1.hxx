...
struct ReadArchiveInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ReadArchiveInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(ReadArchiveInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct WriteArchiveInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, WriteArchiveInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(WriteArchiveInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
