...
struct UnicodeUtils::MTable
{
	...
	CHARACTERTYPE (*_UnicodeUtils_GetCharacterType) (Utf32Char chr);
	...
	template <typename IMPL> void Init()
	{
		...
		_UnicodeUtils_GetCharacterType = &IMPL::_UnicodeUtils_GetCharacterType;
...
struct UnicodeUtils::Hxx2
{
	...
	public:
		...
		static CHARACTERTYPE _UnicodeUtils_GetCharacterType(Utf32Char chr) { return C::GetCharacterType(chr); }
...
{
	return MTable::_instance._UnicodeUtils_GetCharacterType(chr);
}
