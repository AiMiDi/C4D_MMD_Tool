...
struct IoErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IoErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(IoErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct FileFormatErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, FileFormatErrorInterface>::value || IoErrorInterface::HasBase::template Check<I>::value; static I* Cast(FileFormatErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct UnknownFileSizeErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UnknownFileSizeErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(UnknownFileSizeErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct BaseStreamInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, BaseStreamInterface>::value || DataDictionaryObjectInterface::HasBase::template Check<I>::value; static I* Cast(BaseStreamInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct InputStreamInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, InputStreamInterface>::value || BaseStreamInterface::HasBase::template Check<I>::value; static I* Cast(InputStreamInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct OutputStreamInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, OutputStreamInterface>::value || BaseStreamInterface::HasBase::template Check<I>::value; static I* Cast(OutputStreamInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
