...
struct IoHandlerInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IoHandlerInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(IoHandlerInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
