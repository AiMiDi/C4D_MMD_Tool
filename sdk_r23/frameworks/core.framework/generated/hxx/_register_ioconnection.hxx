...
namespace maxon
{
	...
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableErrorOpenFileDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoConnectionInterface_ObservableErrorOpenFile = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_IoConnectionInterface_ObservableErrorOpenFile;
		#else
		tbl->_IoConnectionInterface_ObservableErrorOpenFile = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_IoConnectionInterface_ObservableErrorOpenFile;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
