...
struct UnsupportedArgumentErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UnsupportedArgumentErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(UnsupportedArgumentErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct UnresolvedErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UnresolvedErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(UnresolvedErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct UnknownErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UnknownErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(UnknownErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct UnsupportedOperationErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UnsupportedOperationErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(UnsupportedOperationErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct ShutdownErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ShutdownErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(ShutdownErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct DisabledErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DisabledErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(DisabledErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct ErrnoErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ErrnoErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(ErrnoErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
