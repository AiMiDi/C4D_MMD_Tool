...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionDatabaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDatabaseInterface::MTable::_instance._DataDescriptionDatabaseInterface_GetEffectiveEnumList)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dataEntry\0guiEntry\0stringDescription\0resolveExtensionPointsAndGui\0repository\0filterData\0", 1365LL, nullptr),
