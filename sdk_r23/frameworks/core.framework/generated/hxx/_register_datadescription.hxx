...
namespace maxon
{
	...
	maxon::Bool DataDescriptionInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DataDescriptionInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::_DataDescriptionInterface_GetHashCode;
		#else
