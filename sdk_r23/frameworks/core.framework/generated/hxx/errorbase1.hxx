...
struct OutOfMemoryErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, OutOfMemoryErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(OutOfMemoryErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct IllegalArgumentErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IllegalArgumentErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(IllegalArgumentErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct NullptrErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, NullptrErrorInterface>::value || IllegalArgumentErrorInterface::HasBase::template Check<I>::value; static I* Cast(NullptrErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct IllegalStateErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IllegalStateErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(IllegalStateErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct UnexpectedErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, UnexpectedErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(UnexpectedErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct AggregatedErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, AggregatedErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(AggregatedErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
