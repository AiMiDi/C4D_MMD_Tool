...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_CryptoKeyInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CryptoKeyInterface::MTable::_instance._CryptoKeyInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CryptoKeyInterface::MTable::_instance._CryptoKeyInterface_Alloc)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "allocLocation\0cryptoAlgorithm\0blockSizeBits\0key1\0key1BitSize\0key2\0key2BitSize\0flags\0callback\0", 87381LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CryptoKeyInterface::MTable::_instance._CryptoKeyInterface_ToString)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "formatStatement\0", 0LL, nullptr),
		};
