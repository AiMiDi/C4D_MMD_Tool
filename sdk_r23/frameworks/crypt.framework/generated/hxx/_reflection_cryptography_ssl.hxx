...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_SSLInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(SSLInterface::MTable::_instance._SSLInterface_OPENSSL_init_ssl)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(SSLInterface::MTable::_instance._SSLInterface_TLS_method)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
