...
struct CryptoKeyInterface::MTable
{
	...
	{
		_CryptoKeyInterface_Free = &IMPL::_CryptoKeyInterface_Free;
		_CryptoKeyInterface_Alloc = &IMPL::_CryptoKeyInterface_Alloc;
		_CryptoKeyInterface_GetCryptoAlgorithm = &IMPL::_CryptoKeyInterface_GetCryptoAlgorithm;
		_CryptoKeyInterface_GetBlockBitSize = &IMPL::_CryptoKeyInterface_GetBlockBitSize;
		_CryptoKeyInterface_GetKey1 = &IMPL::_CryptoKeyInterface_GetKey1;
		_CryptoKeyInterface_GetKey1BitSize = &IMPL::_CryptoKeyInterface_GetKey1BitSize;
		_CryptoKeyInterface_GetKey2 = &IMPL::_CryptoKeyInterface_GetKey2;
		_CryptoKeyInterface_GetKey2BitSize = &IMPL::_CryptoKeyInterface_GetKey2BitSize;
		_CryptoKeyInterface_GetFlags = &IMPL::_CryptoKeyInterface_GetFlags;
		_CryptoKeyInterface_GetCallbackFunction = &IMPL::_CryptoKeyInterface_GetCallbackFunction;
		_CryptoKeyInterface_ToString = &IMPL::_CryptoKeyInterface_ToString;
	}
};
...
struct CryptoKeyInterface::Hxx2
{
	...
	public:
		...
		static const Id& _CryptoKeyInterface_GetCryptoAlgorithm(const CryptoKeyInterface* this_) { return C::Get(this_)->GetCryptoAlgorithm(); }
		static Int _CryptoKeyInterface_GetBlockBitSize(const CryptoKeyInterface* this_) { return C::Get(this_)->GetBlockBitSize(); }
		static const void* _CryptoKeyInterface_GetKey1(const CryptoKeyInterface* this_) { return C::Get(this_)->GetKey1(); }
		static Int _CryptoKeyInterface_GetKey1BitSize(const CryptoKeyInterface* this_) { return C::Get(this_)->GetKey1BitSize(); }
		static const void* _CryptoKeyInterface_GetKey2(const CryptoKeyInterface* this_) { return C::Get(this_)->GetKey2(); }
		static Int _CryptoKeyInterface_GetKey2BitSize(const CryptoKeyInterface* this_) { return C::Get(this_)->GetKey2BitSize(); }
		static UInt64 _CryptoKeyInterface_GetFlags(const CryptoKeyInterface* this_) { return C::Get(this_)->GetFlags(); }
		static const BLOCK_CIPHER_CTR_CALLBACK& _CryptoKeyInterface_GetCallbackFunction(const CryptoKeyInterface* this_) { return C::Get(this_)->GetCallbackFunction(); }
		static String _CryptoKeyInterface_ToString(const CryptoKeyInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetCryptoAlgorithm() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetBlockBitSize() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetKey1() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const void*>, const void*>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetKey1BitSize() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CryptoKeyInterface* o_ = (const CryptoKeyInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = CryptoKeyInterface::NullValuePtr(); if (!o_) return 0; } 
	return (MTable::_instance._CryptoKeyInterface_GetKey1BitSize(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetKey2() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const void*>, const void*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<const void*>, const void*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CryptoKeyInterface* o_ = (const CryptoKeyInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = CryptoKeyInterface::NullValuePtr(); if (!o_) return nullptr; } 
	return (MTable::_instance._CryptoKeyInterface_GetKey2(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetKey2BitSize() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CryptoKeyInterface* o_ = (const CryptoKeyInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = CryptoKeyInterface::NullValuePtr(); if (!o_) return 0; } 
	return (MTable::_instance._CryptoKeyInterface_GetKey2BitSize(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetFlags() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<UInt64>, UInt64>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetCallbackFunction() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const BLOCK_CIPHER_CTR_CALLBACK&>, const BLOCK_CIPHER_CTR_CALLBACK&>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptoKeyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* formatStatement) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
