...
namespace maxon
{
	namespace enum34 { enum class PyStringEncodings
	{
	  Utf8,
	  Utf16,
	  Utf32,
	...
	maxon::String PrivateToString_PyStringEncodings34(std::underlying_type<enum34::PyStringEncodings>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum34::PyStringEncodings::Utf8, (maxon::UInt64) enum34::PyStringEncodings::Utf16, (maxon::UInt64) enum34::PyStringEncodings::Utf32, (maxon::UInt64) enum34::PyStringEncodings::PyDecode};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "PyStringEncodings", SIZEOF(x), false, values, "Utf8\0Utf16\0Utf32\0PyDecode\0", fmt);
	}
	namespace enum49 { enum class OWNERSHIP
	{
	...
	maxon::String PrivateToString_OWNERSHIP49(std::underlying_type<enum49::OWNERSHIP>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum49::OWNERSHIP::NORMAL, (maxon::UInt64) enum49::OWNERSHIP::CALLER, (maxon::UInt64) enum49::OWNERSHIP::CALLEE, (maxon::UInt64) enum49::OWNERSHIP::CALLER_BUT_COPY};
	...
	namespace py
	{
		namespace enum82 { enum class PATHHANDLE
		{
			OVERWRITE,					/// Overwrite sys.path
			APPEND_AT_END,			/// Append array to sys.path
			INSERT_AT_BEGINNING	/// Insert array at sys.path[0]
		} ; }
		maxon::String PrivateToString_PATHHANDLE82(std::underlying_type<enum82::PATHHANDLE>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum82::PATHHANDLE::OVERWRITE, (maxon::UInt64) enum82::PATHHANDLE::APPEND_AT_END, (maxon::UInt64) enum82::PATHHANDLE::INSERT_AT_BEGINNING};
		...
		namespace enum89 { enum class GILSTATE
		{
		...
		maxon::String PrivateToString_GILSTATE89(std::underlying_type<enum89::GILSTATE>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum89::GILSTATE::NOT_ACTIVE, (maxon::UInt64) enum89::GILSTATE::ACTIVE_BUT_NOT_CURRENT_THREAD, (maxon::UInt64) enum89::GILSTATE::ACTIVE_AND_CURRENT_THREAD};
...
#endif
		namespace enum134 { enum class CPyMemAllocatorDomain
		{
			CPYMEM_DOMAIN_RAW,
			CPYMEM_DOMAIN_MEM,
			CPYMEM_DOMAIN_OBJ
		} ; }
		maxon::String PrivateToString_CPyMemAllocatorDomain134(std::underlying_type<enum134::CPyMemAllocatorDomain>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum134::CPyMemAllocatorDomain::CPYMEM_DOMAIN_RAW, (maxon::UInt64) enum134::CPyMemAllocatorDomain::CPYMEM_DOMAIN_MEM, (maxon::UInt64) enum134::CPyMemAllocatorDomain::CPYMEM_DOMAIN_OBJ};
			return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "CPyMemAllocatorDomain", SIZEOF(x), false, values, "CPYMEM_DOMAIN_RAW\0CPYMEM_DOMAIN_MEM\0CPYMEM_DOMAIN_OBJ\0", fmt);
		}
		namespace enum157 { enum class SPECIALPATH
		{
		...
		maxon::String PrivateToString_SPECIALPATH157(std::underlying_type<enum157::SPECIALPATH>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum157::SPECIALPATH::MAXON_MODULES, (maxon::UInt64) enum157::SPECIALPATH::PREFS_PYTHON_GENERATED_DIRECTORY, (maxon::UInt64) enum157::SPECIALPATH::PREFS_PYTHON_GLOBAL_LIBS, (maxon::UInt64) enum157::SPECIALPATH::PREFS_PYTHON_LOCAL_LIBS};
		...
		namespace enum163 { enum class PYGILSTATE
		{
			LOCKED,				/// GIL is locked.
			UNLOCKED			/// GIL is unlocked.
		} ; }
		maxon::String PrivateToString_PYGILSTATE163(std::underlying_type<enum163::PYGILSTATE>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum163::PYGILSTATE::LOCKED, (maxon::UInt64) enum163::PYGILSTATE::UNLOCKED};
			return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "PYGILSTATE", SIZEOF(x), false, values, "LOCKED\0UNLOCKED\0", fmt);
		}
		namespace enum170 { enum class PYINPUT
		{
		...
		maxon::String PrivateToString_PYINPUT170(std::underlying_type<enum170::PYINPUT>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum170::PYINPUT::SINGLE, (maxon::UInt64) enum170::PYINPUT::FILE, (maxon::UInt64) enum170::PYINPUT::EVAL};
			return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "PYINPUT", SIZEOF(x), false, values, "SINGLE\0FILE\0EVAL\0", fmt);
		}
		namespace enum179 { enum class PYSTARTOPERATION
		{
			NONE,
		...
		maxon::String PrivateToString_PYSTARTOPERATION179(std::underlying_type<enum179::PYSTARTOPERATION>::type x, const maxon::FormatStatement* fmt)
		{
			const maxon::UInt64 values[] = {(maxon::UInt64) enum179::PYSTARTOPERATION::NONE, (maxon::UInt64) enum179::PYSTARTOPERATION::EXECUTE_CODE, (maxon::UInt64) enum179::PYSTARTOPERATION::EXECUTE_MODULE, (maxon::UInt64) enum179::PYSTARTOPERATION::EXECUTE_FILE, (maxon::UInt64) enum179::PYSTARTOPERATION::VERSION};
		...
		const maxon::Char* const CPythonLibraryInterface::MTable::_ids = 
			...
			"CPyModule_AddObject@16b6070a1182fed3\0" // Bool CPyModule_AddObject(const CPyRef& module, const Char* name, const CPyRef& value)
			...
			"CPyEval_ReInitThreads@780cdac8f1a33934\0" // void CPyEval_ReInitThreads()
			...
			"CPyExc_RecursionErrorInst@f9f9724735b93e16\0" // CPyConstRef CPyExc_RecursionErrorInst()
	...
	const maxon::Char* const PyModuleInterface::MTable::_ids = 
		"GetFunctions37@f1bde589d92c6200\0" // Result<void> GetFunctions37(BaseArray<NativePyCFunctionTable>& functions)
	...
	{
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(Lib37, , "net.maxon.python.cpythonlibs.cpy37");
	}
}
