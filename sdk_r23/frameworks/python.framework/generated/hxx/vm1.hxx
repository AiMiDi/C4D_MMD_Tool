...
#endif
struct LibraryInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, LibraryInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(LibraryInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
#ifdef MAXON_COMPILER_GCC
#endif
struct VmDebuggerConnectionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VmDebuggerConnectionInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(VmDebuggerConnectionInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct VirtualMachineScopeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VirtualMachineScopeInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(VirtualMachineScopeInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct VirtualMachineInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VirtualMachineInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(VirtualMachineInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
