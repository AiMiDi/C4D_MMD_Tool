...
#endif
namespace enum40 { enum class GE_CM_CLIPREGION
{
...
maxon::String PrivateToString_GE_CM_CLIPREGION40(std::underlying_type<enum40::GE_CM_CLIPREGION>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum40::GE_CM_CLIPREGION::EVENODD, (maxon::UInt64) enum40::GE_CM_CLIPREGION::WINDING_};
...
namespace enum52 { enum class GE_CM_DRAWMODE
{
...
maxon::String PrivateToString_GE_CM_DRAWMODE52(std::underlying_type<enum52::GE_CM_DRAWMODE>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum52::GE_CM_DRAWMODE::COPY, (maxon::UInt64) enum52::GE_CM_DRAWMODE::BLEND, (maxon::UInt64) enum52::GE_CM_DRAWMODE::MASK};
...
#endif
namespace enum67 { enum class GE_CM_BLIT
{
...
maxon::String PrivateToString_GE_CM_BLIT67(std::underlying_type<enum67::GE_CM_BLIT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum67::GE_CM_BLIT::COPY, (maxon::UInt64) enum67::GE_CM_BLIT::COL, (maxon::UInt64) enum67::GE_CM_BLIT::FG};
	return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "GE_CM_BLIT", SIZEOF(x), false, values, "COPY\0COL\0FG\0", fmt);
}
namespace enum79 { enum class GE_CM_ARCSEGMENT
{
...
maxon::String PrivateToString_GE_CM_ARCSEGMENT79(std::underlying_type<enum79::GE_CM_ARCSEGMENT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum79::GE_CM_ARCSEGMENT::RIGHTTOP, (maxon::UInt64) enum79::GE_CM_ARCSEGMENT::RIGHTBOTTOM, (maxon::UInt64) enum79::GE_CM_ARCSEGMENT::LEFTBOTTOM, (maxon::UInt64) enum79::GE_CM_ARCSEGMENT::LEFTTOP};
...
namespace enum90 { enum class GE_CM_FONTSORT
{
...
maxon::String PrivateToString_GE_CM_FONTSORT90(std::underlying_type<enum90::GE_CM_FONTSORT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum90::GE_CM_FONTSORT::FLAT, (maxon::UInt64) enum90::GE_CM_FONTSORT::HIERARCHICAL};
