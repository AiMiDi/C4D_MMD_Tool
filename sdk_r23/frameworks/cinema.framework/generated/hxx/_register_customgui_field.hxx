...
#endif
namespace enum50 { enum class FIELDLIST_FLAGS
{
	NONE											= 0,					///< No flags
...
maxon::String PrivateToString_FIELDLIST_FLAGS50(std::underlying_type<enum50::FIELDLIST_FLAGS>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum50::FIELDLIST_FLAGS::NONE, (maxon::UInt64) enum50::FIELDLIST_FLAGS::CLAMPOUTPUT, (maxon::UInt64) enum50::FIELDLIST_FLAGS::ENABLEDIRECTIONBYDEFAULT, (maxon::UInt64) enum50::FIELDLIST_FLAGS::ENABLECOLORBYDEFAULT, (maxon::UInt64) enum50::FIELDLIST_FLAGS::DISABLEVALUEBYDEFAULT, (maxon::UInt64) enum50::FIELDLIST_FLAGS::SIMPLEGUI, (maxon::UInt64) enum50::FIELDLIST_FLAGS::ENABLEROTATIONBYDEFAULT};
