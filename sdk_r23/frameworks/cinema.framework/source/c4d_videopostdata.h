...
#define VPBUFFER_MAGICBULLETLOOKS				206				///< All but Magic Bullet Looks effect @since R23.
/// @}
...
#define PLUGINFLAG_VIDEOPOST_STATIC						(1 << 8)																																					///< Static video post effect (automatically created, cannot be deleted or dragged). @since R23
