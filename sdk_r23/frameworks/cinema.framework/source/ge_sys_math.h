...
#include "maxon/apibase.h"
...
#ifndef CINEWARE_NAMESPACE_ENABLE
	...
	/// Specifies single inheritance for a class (to stay compatible with the vms compiler setting when the header files are included in a different project setting context)
	#define CINEWARE_SINGLEINHERITANCE __single_inheritance
#else
	#define CINEWARE_SINGLEINHERITANCE
#endif

#if defined(MAXON_TARGET_LINUX) || defined (MAXON_TARGET_MACOS) || defined (MAXON_TARGET_IOS) || defined (MAXON_COMPILER_CLANG)
	#define GCC34T this->
#endif
