...
struct DistanceQueryInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DistanceQueryInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(DistanceQueryInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
