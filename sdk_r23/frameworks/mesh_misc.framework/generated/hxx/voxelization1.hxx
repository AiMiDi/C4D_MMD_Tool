...
struct VoxelizationInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VoxelizationInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(VoxelizationInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
