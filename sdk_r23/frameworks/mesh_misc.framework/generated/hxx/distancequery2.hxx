...
struct DistanceQueryInterface::MTable
{
	...
	Result<void> (*_DistanceQueryInterface_Init_3) (maxon::GenericComponent* this_, const Block<const Vector> points, const Block<const SimplePolygon> polygons, const Matrix& objectPosition);
	maxon::Int _DistanceQueryInterface_Init_3_Offset;
	...
	template <typename W> void Init(maxon::Int offset)
	{
		...
		if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, DistanceQueryInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, DistanceQueryInterface, Init), W, MTable>::type::_DistanceQueryInterface_Init_3;
			_DistanceQueryInterface_Init_3 = reinterpret_cast<const decltype(_DistanceQueryInterface_Init_3)&>(ptr);
			_DistanceQueryInterface_Init_3_Offset = offset;
		}
...
{
	const DistanceQueryInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(DistanceQueryInterface, this); return mt_._DistanceQueryInterface_Init_3((maxon::GenericComponent*) this + mt_._DistanceQueryInterface_Init_3_Offset, std::forward<const Block<const Vector>>(points), std::forward<const Block<const SimplePolygon>>(polygons), objectPosition);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::ReferenceFunctionsImpl<S>::Init(const Block<const Vector> points, const Block<const SimplePolygon> polygons, const Matrix& objectPosition) const -> Result<void>
{
	...
	return (mt_._DistanceQueryInterface_Init_3(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DistanceQueryInterface_Init_3_Offset, std::forward<const Block<const Vector>>(points), std::forward<const Block<const SimplePolygon>>(polygons), objectPosition));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::COWReferenceFunctionsImpl<S>::Init(const Block<const Vector> points, const Block<const SimplePolygon> polygons, const Matrix& objectPosition) -> Result<void>
{
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DistanceQueryInterface* o_ = (DistanceQueryInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DistanceQueryInterface, o_, DistanceQueryInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DistanceQueryInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DistanceQueryInterface>() : PRIVATE_MAXON_VTABLE(DistanceQueryInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DistanceQueryInterface* o_ = (DistanceQueryInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DistanceQueryInterface, o_, DistanceQueryInterface_SetThreading) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DistanceQueryInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DistanceQueryInterface>() : PRIVATE_MAXON_VTABLE(DistanceQueryInterface, o_); 
