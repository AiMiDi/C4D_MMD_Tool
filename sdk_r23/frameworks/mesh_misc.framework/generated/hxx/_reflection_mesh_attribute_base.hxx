...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_CustomDataTagDisplayInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "tag\0doc\0op\0bd\0bh\0cds\0", 1365LL, CustomDataTagDisplayInterface, _CustomDataTagDisplayInterface_DisplayControl),
	...
	public:
		...
		Bool Message(GeListNode* node, Int32 type, void* data) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<CustomDataTagClassInterface>();
			Bool proxy_result = maxon::PrivateLogNullptrError(false);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CustomDataTagClassInterface_Message_Offset), maxon::reflection::Argument::ByValue(node), maxon::reflection::Argument::ByValue(type), maxon::reflection::Argument::ByValue(data)};
			(*handler_)(_fn_CustomDataTagClassInterface_Message, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, GeListNode*, Int32, void*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_Message));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_CustomDataTagClassInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "node\0type\0data\0", 21LL, CustomDataTagClassInterface, _CustomDataTagClassInterface_Message),
		};
