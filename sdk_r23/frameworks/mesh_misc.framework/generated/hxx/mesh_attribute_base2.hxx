...
struct CustomDataTagDisplayInterface::MTable
{
	...
	Result<void> (*_CustomDataTagDisplayInterface_DisplayControl) (const maxon::GenericComponent* this_, BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds);
...
struct CustomDataTagDisplayInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _CustomDataTagDisplayInterface_DisplayControl(const maxon::GenericComponent* this_, BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) { return ((const typename S::Implementation*) this_)->DisplayControl(tag, doc, op, bd, bh, cds); }
...
{
	const CustomDataTagDisplayInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CustomDataTagDisplayInterface, this); return mt_._CustomDataTagDisplayInterface_DisplayControl((const maxon::GenericComponent*) this + mt_._CustomDataTagDisplayInterface_DisplayControl_Offset, tag, doc, op, bd, bh, cds);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const -> Result<void>
{
	...
	return (mt_._CustomDataTagDisplayInterface_DisplayControl(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._CustomDataTagDisplayInterface_DisplayControl_Offset, tag, doc, op, bd, bh, cds));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CustomDataTagDisplayInterface* o_ = (CustomDataTagDisplayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagDisplayInterface, o_, CustomDataTagDisplayInterface_FreeDisplayControl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagDisplayInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagDisplayInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagDisplayInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CustomDataTagDisplayInterface* o_ = (CustomDataTagDisplayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagDisplayInterface, o_, CustomDataTagDisplayInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagDisplayInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagDisplayInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagDisplayInterface, o_); 
...
struct CustomDataTagClassInterface::MTable
{
	...
	Bool (*_CustomDataTagClassInterface_Message) (const maxon::GenericComponent* this_, GeListNode* node, Int32 type, void* data);
	maxon::Int _CustomDataTagClassInterface_Message_Offset;
	template <typename W> void Init(maxon::Int offset)
	{
		...
		if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CustomDataTagClassInterface, Message))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CustomDataTagClassInterface, Message), W, MTable>::type::_CustomDataTagClassInterface_Message;
			_CustomDataTagClassInterface_Message = reinterpret_cast<const decltype(_CustomDataTagClassInterface_Message)&>(ptr);
			_CustomDataTagClassInterface_Message_Offset = offset;
		}
	}
	template <typename W> static maxon::Bool InitWithBases(maxon::ClassInfo* info, maxon::Int offset)
	{
...
struct CustomDataTagClassInterface::Hxx2
{
	...
	public:
		...
		static Bool _CustomDataTagClassInterface_Message(const maxon::GenericComponent* this_, GeListNode* node, Int32 type, void* data) { return ((const typename S::Implementation*) this_)->Message(node, type, data); }
	};
...
{
	const CustomDataTagClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CustomDataTagClassInterface, this); return mt_._CustomDataTagClassInterface_Message((const maxon::GenericComponent*) this + mt_._CustomDataTagClassInterface_Message_Offset, node, type, data);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Message(GeListNode* node, Int32 type, void* data) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	...
	return (mt_._CustomDataTagClassInterface_Message(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._CustomDataTagClassInterface_Message_Offset, node, type, data));
}
