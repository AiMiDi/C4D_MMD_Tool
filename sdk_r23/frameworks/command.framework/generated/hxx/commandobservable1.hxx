...
struct CommandObserverInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CommandObserverInterface>::value || ObserverObjectInterface::HasBase::template Check<I>::value; static I* Cast(CommandObserverInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
