...
private:
	...
	*/
	static constexpr config_item_type k_default_config_table[k_default_config_table_size]
	{
		...
		{{"DLG_CMT_TOOL_MODEL_IMPORT_MATERIAL_TYPE"},{kSDK2024 ? 1 : 0}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_SIZE"},{8.5f}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_POLYGON"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_NORMAL"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_UV"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_MATERIAL"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_BONE"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_WEIGHTS"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_IK"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_INHERIT"},{true}},
		{{"DLG_CMT_TOOL_MODEL_EXPORT_EXPRESSION"},{true}}
	};
};
