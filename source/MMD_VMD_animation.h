...
namespace mmd {
	...
	private:
		...
		/* 将欧拉旋转转换为四元旋转 */
		static maxon::Vector4d32 EulerToQuaternion(maxon::Vector& euler);


		/* 将四元旋转转换为欧拉旋转 */
		static maxon::Vector QuaternionToEuler(maxon::Vector4d32& quaternion);
	...
	public:
		...
		/* 从项目导出动作或表情数据 */
		static maxon::Result<void> FromDocumentExportMotions(VMD_Motions_export_settings setting);
	};
