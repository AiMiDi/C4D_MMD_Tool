...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyRef
{
	return (CPyInterface::CreateRef(lib, refType, pyObject));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateConstRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyConstRef
{
	return (CPyInterface::CreateConstRef(lib, refType, pyObject));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateTempRef(const CPythonLibraryInterface* lib, NativePyObject* pyObject) -> CPyTempRef
{
...
{
	template <typename S> using CWrapper = typename CPyInterface::Hxx2::template CWrapper<S>;
};

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateTypeRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyTypeRef
{
	return (CPyTypeInterface::CreateTypeRef(lib, refType, pyObject));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateTypeConstRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyTypeConstRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyFrameInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateFrameRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyFrameRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTracebackInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateTracebackRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyTracebackRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyCodeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateCodeRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyCodeRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyClassInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateClassRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyClassRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyMemberInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateMemberRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyMemberRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyFunctionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateFunctionRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyFunctionRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateDataTypeRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyDataTypeRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateDataRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyDataRef
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyCallerContextInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateCallerContextRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyCallerContextRef
{
