...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ConsoleIsAvailable() -> Bool
{
	return (Hxx2::StaticMTable::_instance._LibraryInterface_ConsoleIsAvailable());
}
#ifdef MAXON_TARGET_WINDOWS
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetVsVersion(Int32 compilerVersion) -> Result<Int32>
{
	return (Hxx2::StaticMTable::_instance._LibraryInterface_GetVsVersion(compilerVersion));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetVsRuntimeLibrary(Int32 version, Bool release) -> Result<Url>
{
	return (Hxx2::StaticMTable::_instance._LibraryInterface_GetVsRuntimeLibrary(version, release));
}
#endif
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetFileContent(const Url& filepath) -> Result<String>
{
	return (Hxx2::StaticMTable::_instance._LibraryInterface_GetFileContent(filepath));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::SetFileContent(const Url& filepath, const String& str, Bool append) -> Result<void>
{
	return (Hxx2::StaticMTable::_instance._LibraryInterface_SetFileContent(filepath, str, append));
}
