...
class MyLibraryImpl : public maxon::Component<MyLibraryImpl, LibraryInterface>
{
	MAXON_COMPONENT();
...
class MyVmDebuggerConnectionImpl : public maxon::Component<MyVmDebuggerConnectionImpl, VmDebuggerConnectionInterface>
{
	MAXON_COMPONENT();
...
class MyVirtualMachineScopeImpl : public maxon::Component<MyVirtualMachineScopeImpl, VirtualMachineScopeInterface>
{
	MAXON_COMPONENT();
...
class MyVirtualMachineImpl : public maxon::Component<MyVirtualMachineImpl, VirtualMachineInterface>
{
	MAXON_COMPONENT();
