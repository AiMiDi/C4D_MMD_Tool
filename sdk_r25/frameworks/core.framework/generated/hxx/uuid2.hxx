...
struct UuidInterface::MTable
{
	...
	HashInt (*_UuidInterface_GetHashCode) (const UuidInterface* this_);
...
struct UuidInterface::Hxx2
{
	...
	public:
		...
		static Bool _UuidInterface_IsEmpty(const UuidInterface* this_) { return C::Get(this_)->IsEmpty(); }
		static Result<void> _UuidInterface_CreateId(UuidInterface* this_) { return C::Get(this_)->CreateId(); }
		static Result<void> _UuidInterface_Set(UuidInterface* this_, const String& uuid) { return C::Get(this_)->Set(uuid); }
		static Result<void> _UuidInterface_Set_1(UuidInterface* this_, const UChar* uuid, Int uuidSize) { return C::Get(this_)->Set(uuid, uuidSize); }
		static Result<void> _UuidInterface_Get(const UuidInterface* this_, UChar* uuid, Int uuidSize) { return C::Get(this_)->Get(uuid, uuidSize); }
		static String _UuidInterface_ToString(const UuidInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
		static COMPARERESULT _UuidInterface_Compare(const UuidInterface* this_, const UuidInterface* uuid) { return C::Get(this_)->Compare(uuid); }
		static HashInt _UuidInterface_GetHashCode(const UuidInterface* this_) { return C::Get(this_)->GetHashCode(); }
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._UuidInterface_DescribeIO(stream));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::Hxx1::ConstReferenceFunctionsImpl<S>::CreateUuidString() -> Result<String>
{
	return (MTable::_instance._UuidInterface_CreateUuidString());
}
