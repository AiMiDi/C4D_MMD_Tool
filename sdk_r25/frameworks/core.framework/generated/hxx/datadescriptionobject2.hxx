...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionObjectInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetObjectName(const Id& classId, const LanguageRef& language) -> Result<String>
{
	return (Hxx2::StaticMTable::_instance._DataDescriptionObjectInterface_GetObjectName(classId, language));
}
