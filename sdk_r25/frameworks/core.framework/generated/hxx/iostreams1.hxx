...
struct FileFormatErrorInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename IoErrorInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename IoErrorInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type
	> { };
};
...
/// @return												OK on success.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename BaseStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename BaseStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename BaseStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
/// @return												True is the operation succeeded.
	...
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename BaseStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename BaseStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename BaseStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
struct InOutputStreamInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename OutputStreamInterface::Hxx1::template ReferenceFunctionsHelper<typename InputStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename OutputStreamInterface::Hxx1::template ReferenceFunctionsHelper<typename InputStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type, ReferenceFunctionsImpl<typename OutputStreamInterface::Hxx1::template ReferenceFunctionsHelper<typename InputStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>>::type
	> { };
};
