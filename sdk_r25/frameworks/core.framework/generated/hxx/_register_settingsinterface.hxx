...
namespace maxon
{
	...
	maxon::Bool SettingsInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<SettingsRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SettingsInterface_GetSettings = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_SettingsInterface_GetSettings;
		#else
		tbl->_SettingsInterface_GetSettings = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_SettingsInterface_GetSettings;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableSettingsChangedDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SettingsInterface_ObservableSettingsChanged = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_SettingsInterface_ObservableSettingsChanged;
		#else
		tbl->_SettingsInterface_ObservableSettingsChanged = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_SettingsInterface_ObservableSettingsChanged;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
