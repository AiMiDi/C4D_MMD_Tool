...
struct JobQueueInterface::MTable
{
	...
	void (*_JobQueueInterface_EnableThreadAffinity) (JobQueueInterface* this_, UInt ownerId);
...
/// @endcond
	...
	template <typename IMPL> void Init()
	{
		...
		_JobQueueInterface_EnableThreadAffinity = &IMPL::_JobQueueInterface_EnableThreadAffinity;
...
struct JobQueueInterface::Hxx2
{
	...
	public:
		...
		static Int _JobQueueInterface_GetThreadCount(const JobQueueInterface* this_) { return C::Get(this_)->GetThreadCount(); }
		...
		static void _JobQueueInterface_Cancel(JobQueueInterface* this_, UInt ownerId) { return C::Get(this_)->Cancel(ownerId); }
		static void _JobQueueInterface_CancelAndWait(JobQueueInterface* this_, UInt ownerId) { return C::Get(this_)->CancelAndWait(ownerId); }
		static void _JobQueueInterface_EnableThreadAffinity(JobQueueInterface* this_, UInt ownerId) { return C::Get(this_)->EnableThreadAffinity(ownerId); }
...
/// @cond IGNORE
		...
		static void _JobQueueInterface_ExecuteJobs(JobQueueInterface* this_, TimeValue timeout) { return C::Get(this_)->ExecuteJobs(std::forward<TimeValue>(timeout)); }
/// @endcond
...
{
	return MTable::_instance._JobQueueInterface_EnableThreadAffinity(this, ownerId);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetThreadCount(JobQueueInterface* queue, Int maxWaitSessionLevel) -> Int
{
	return (MTable::_instance._JobQueueInterface_GetThreadCount_1(queue, maxWaitSessionLevel));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::Hxx1::ReferenceFunctionsImpl<S>::EnableThreadAffinity(UInt ownerId) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); JobQueueInterface* o_ = (JobQueueInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
	MTable::_instance._JobQueueInterface_EnableThreadAffinity(o_, ownerId);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetDestinationQueue() -> JobQueueRef
{
	return JobQueueRef(MTable::_instance._JobQueueInterface_GetDestinationQueue());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::Hxx1::ConstReferenceFunctionsImpl<S>::SetDestinationQueue(JobQueueInterface* queue) -> Result<void>
{
	return (MTable::_instance._JobQueueInterface_SetDestinationQueue(queue));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetMainThreadQueue() -> JobQueueRef
{
	return JobQueueRef(MTable::_instance._JobQueueInterface_GetMainThreadQueue());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetServiceIOQueue() -> ServiceIOJobQueueInterface*
{
	return (MTable::_instance._JobQueueInterface_GetServiceIOQueue());
}
/// @cond IGNORE
