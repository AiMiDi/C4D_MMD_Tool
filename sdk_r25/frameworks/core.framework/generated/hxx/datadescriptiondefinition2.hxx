...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::MergeDescriptionDefinition(DataDescriptionDefinition& target, const DataDescriptionDefinition& source, Bool overwriteIncludes, Bool skipIncludes) -> Result<void>
{
	return (Hxx2::StaticMTable::_instance._DataDescriptionDefinitionInterface_MergeDescriptionDefinition(target, source, overwriteIncludes, skipIncludes));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetDataDefaults(const DataDictionary& dataEntry) -> Result<Data>
{
	return (Hxx2::StaticMTable::_instance._DataDescriptionDefinitionInterface_GetDataDefaults(dataEntry));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetDataValueOrDefaults(const InternedId& dataId, const DataDictionary& dataEntry, GETDATAFLAGS flags, const GetDataCallbackType& getDataCallback) -> Result<Data>
{
	return (Hxx2::StaticMTable::_instance._DataDescriptionDefinitionInterface_GetDataValueOrDefaults(dataId, dataEntry, flags, getDataCallback));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Create() -> DataDescriptionDefinition
{
	return DataDescriptionDefinition(Hxx2::StaticMTable::_instance._DataDescriptionDefinitionInterface_Create());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::NullValuePtr() -> const DataDescriptionDefinitionInterface*
{
	return (Hxx2::StaticMTable::_instance._DataDescriptionDefinitionInterface_NullValuePtr());
}
