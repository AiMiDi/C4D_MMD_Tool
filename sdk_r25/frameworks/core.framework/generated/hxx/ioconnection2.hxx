...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ResolveInterface::Hxx1::ConstReferenceFunctionsImpl<S>::RemoveDotSegments(const Url& url) -> Result<Url>
{
	return (MTable::_instance._ResolveInterface_RemoveDotSegments(url));
}
...
struct IoConnectionInterface::MTable
{
	...
	Result<void> (*_IoConnectionInterface_IoCopyFileProgress) (maxon::GenericComponent* this_, const Url& destName, Bool overwrite, Bool removeReadOnly, const IoProgressDelegate& progress);
	maxon::Int _IoConnectionInterface_IoCopyFileProgress_Offset;
	...
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, IoConnectionInterface, IoCopyFileProgress))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, IoConnectionInterface, IoCopyFileProgress), W, MTable>::type::_IoConnectionInterface_IoCopyFileProgress;
		_IoConnectionInterface_IoCopyFileProgress = reinterpret_cast<const decltype(_IoConnectionInterface_IoCopyFileProgress)&>(ptr);
		_IoConnectionInterface_IoCopyFileProgress_Offset = offset;
	}
...
struct IoConnectionInterface::Hxx2
{
	...
	struct StaticMTable
	{
		...
		static const maxon::Char* const _ids;
		static const maxon::NULL_RETURN_TYPE _returnTypes[];
	maxon::ObservableRef<ObservableErrorOpenFileDelegate> (*_IoConnectionInterface_ObservableErrorOpenFile) ();
		StaticMTable() = default;
		template <typename IMPL> static void Init(StaticMTable* tbl)
		{
		tbl->_IoConnectionInterface_ObservableErrorOpenFile = &IMPL::_IoConnectionInterface_ObservableErrorOpenFile;
		}
	};
	...
	public:
		...
		static Result<void> _IoConnectionInterface_IoCopyFileProgress(maxon::GenericComponent* this_, const Url& destName, Bool overwrite, Bool removeReadOnly, const IoProgressDelegate& progress) { return ((typename S::Implementation*) this_)->IoCopyFileProgress(destName, overwrite, removeReadOnly, progress); }
		...
		static maxon::ObservableRef<ObservableErrorOpenFileDelegate> _IoConnectionInterface_ObservableErrorOpenFile() { return S::Implementation::ObservableErrorOpenFile(); }
	};
...
{
	const IoConnectionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(IoConnectionInterface, this); return mt_._IoConnectionInterface_IoCopyFileProgress((maxon::GenericComponent*) this + mt_._IoConnectionInterface_IoCopyFileProgress_Offset, destName, overwrite, removeReadOnly, progress);
}
...
{
	return Hxx2::StaticMTable::_instance._IoConnectionInterface_ObservableErrorOpenFile();
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ReferenceFunctionsImpl<S>::IoCopyFileProgress(const Url& destName, Bool overwrite, Bool removeReadOnly, const IoProgressDelegate& progress) const -> Result<void>
{
	...
	return (mt_._IoConnectionInterface_IoCopyFileProgress(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoConnectionInterface_IoCopyFileProgress_Offset, destName, overwrite, removeReadOnly, progress));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::COWReferenceFunctionsImpl<S>::IoCopyFileProgress(const Url& destName, Bool overwrite, Bool removeReadOnly, const IoProgressDelegate& progress) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ObservableErrorOpenFile() -> maxon::ObservableRef<ObservableErrorOpenFileDelegate>
{
	return (Hxx2::StaticMTable::_instance._IoConnectionInterface_ObservableErrorOpenFile());
}
