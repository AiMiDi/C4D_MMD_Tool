...
struct DataDescriptionDatabaseInterface::MTable
{
	...
	Result<BaseArray<Tuple<Id, Data, String>>> (*_DataDescriptionDatabaseInterface_GetEffectiveEnumList) (const DataDictionary& dataEntry, const DataDictionary& guiEntry, const DataDescription& stringDescription, Bool resolveExtensionPointsAndGui, Bool withStrings, const LanguageRef& language, const AssetRepositoryRef& repository, const Data* filterData);
...
struct DataDescriptionDatabaseInterface::Hxx2
{
	...
	public:
		...
		static Result<BaseArray<Tuple<Id, Data, String>>> _DataDescriptionDatabaseInterface_GetEffectiveEnumList(const DataDictionary& dataEntry, const DataDictionary& guiEntry, const DataDescription& stringDescription, Bool resolveExtensionPointsAndGui, Bool withStrings, const LanguageRef& language, const AssetRepositoryRef& repository, const Data* filterData) { return C::GetEffectiveEnumList(dataEntry, guiEntry, stringDescription, resolveExtensionPointsAndGui, withStrings, language, repository, filterData); }
...
{
	return MTable::_instance._DataDescriptionDatabaseInterface_GetEffectiveEnumList(dataEntry, guiEntry, stringDescription, resolveExtensionPointsAndGui, withStrings, language, repository, filterData);
}
