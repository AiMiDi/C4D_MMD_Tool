...
#endif
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Application::MTable::_instance._Application_ObservableApplicationMessage)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
