...
struct UrlInterface::MTable
{
	...
	Result<void> (*_UrlInterface_EraseData) (UrlInterface* this_, ForwardingDataPtr&& key, Bool persistent);
	String (*_UrlInterface_ToString) (const UrlInterface* this_, const FormatStatement* formatStatement);
	Result<String> (*_UrlInterface_ConvertToUiName) (const UrlInterface* this_, CONVERTTOUINAMEFLAGS flags);
	Result<Url> (*_UrlInterface_ConvertFromUiName) (const String& str);
	...
	template <typename IMPL> void Init()
	{
		...
		_UrlInterface_EraseData = &IMPL::_UrlInterface_EraseData;
		_UrlInterface_ToString = &IMPL::_UrlInterface_ToString;
		_UrlInterface_ConvertToUiName = &IMPL::_UrlInterface_ConvertToUiName;
		_UrlInterface_ConvertFromUiName = &IMPL::_UrlInterface_ConvertFromUiName;
...
struct UrlInterface::Hxx2
{
	...
	public:
		...
		static const UrlScheme& _UrlInterface_GetScheme(const UrlInterface* this_) { return C::Get(this_)->GetScheme(); }
		static Result<void> _UrlInterface_SetScheme(UrlInterface* this_, const UrlScheme& scheme) { return C::Get(this_)->SetScheme(scheme); }
		static Result<void> _UrlInterface_Append(UrlInterface* this_, const String& name) { return C::Get(this_)->Append(name); }
		static Result<void> _UrlInterface_Append_1(UrlInterface* this_, const Url& relativeUrl) { return C::Get(this_)->Append(relativeUrl); }
		static Result<void> _UrlInterface_RemoveName(UrlInterface* this_) { return C::Get(this_)->RemoveName(); }
		static Url _UrlInterface_GetEmbeddedUrl(const UrlInterface* this_) { return C::Get(this_)->GetEmbeddedUrl(); }
		static Result<void> _UrlInterface_SetEmbeddedUrl(UrlInterface* this_, const Url& url) { return C::Get(this_)->SetEmbeddedUrl(url); }
		static String _UrlInterface_GetName(const UrlInterface* this_) { return C::Get(this_)->GetName(); }
		static Result<void> _UrlInterface_SetName(UrlInterface* this_, const String& name) { return C::Get(this_)->SetName(name); }
		static Url _UrlInterface_GetDirectory(const UrlInterface* this_) { return C::Get(this_)->GetDirectory(); }
		static Result<void> _UrlInterface_SetPath(UrlInterface* this_, const String& path) { return C::Get(this_)->SetPath(path); }
		static const String& _UrlInterface_GetPath(const UrlInterface* this_) { return C::Get(this_)->GetPath(); }
		static Result<void> _UrlInterface_SetSystemPath(UrlInterface* this_, const String& path) { return C::Get(this_)->SetSystemPath(path); }
		static Result<String> _UrlInterface_GetSystemPath(const UrlInterface* this_) { return C::Get(this_)->GetSystemPath(); }
		static Result<void> _UrlInterface_SetUrl(UrlInterface* this_, const String& urlString, Bool enableDefaultFallbackScheme) { return C::Get(this_)->SetUrl(urlString, enableDefaultFallbackScheme); }
		static String _UrlInterface_GetUrl(const UrlInterface* this_) { return C::Get(this_)->GetUrl(); }
		static Result<void> _UrlInterface_SetAuthority(UrlInterface* this_, const String& authority) { return C::Get(this_)->SetAuthority(authority); }
		static Result<void> _UrlInterface_SetAuthority_1(UrlInterface* this_, const Url& authority) { return C::Get(this_)->SetAuthority(authority); }
		static const Url& _UrlInterface_GetAuthority(const UrlInterface* this_) { return C::Get(this_)->GetAuthority(); }
		static Result<void> _UrlInterface_GetComponents(const UrlInterface* this_, const NonConstArray<String>& parts) { return C::Get(this_)->GetComponents(parts); }
		static Result<Url> _UrlInterface_GetRelativeUrl(const UrlInterface* this_, const Url& basePath) { return C::Get(this_)->GetRelativeUrl(basePath); }
		static String _UrlInterface_GetSuffix(const UrlInterface* this_) { return C::Get(this_)->GetSuffix(); }
		static Bool _UrlInterface_CheckSuffix(const UrlInterface* this_, const String& suffix) { return C::Get(this_)->CheckSuffix(suffix); }
		static Result<void> _UrlInterface_SetSuffix(UrlInterface* this_, const String& suffix) { return C::Get(this_)->SetSuffix(suffix); }
		static void _UrlInterface_ClearSuffix(UrlInterface* this_) { return C::Get(this_)->ClearSuffix(); }
		static Bool _UrlInterface_IsEmpty(const UrlInterface* this_) { return C::Get(this_)->IsEmpty(); }
		static COMPARERESULT _UrlInterface_Compare(const UrlInterface* this_, const UrlInterface* name, URLCOMPARE mode) { return C::Get(this_)->Compare(name, mode); }
		static Result<Data> _UrlInterface_GetData(const UrlInterface* this_, const ConstDataPtr& key) { return C::Get(this_)->GetData(key); }
		static Result<void> _UrlInterface_SetData(UrlInterface* this_, ForwardingDataPtr&& key, const Data& data, Bool persistent) { return C::Get(this_)->SetData(std::forward<ForwardingDataPtr>(key), data, persistent); }
		static Result<void> _UrlInterface_SetData_1(UrlInterface* this_, ForwardingDataPtr&& key, Data&& data, Bool persistent) { return C::Get(this_)->SetData(std::forward<ForwardingDataPtr>(key), std::forward<Data>(data), persistent); }
		static Result<void> _UrlInterface_EraseData(UrlInterface* this_, ForwardingDataPtr&& key, Bool persistent) { return C::Get(this_)->EraseData(std::forward<ForwardingDataPtr>(key), persistent); }
		static String _UrlInterface_ToString(const UrlInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
		static Result<String> _UrlInterface_ConvertToUiName(const UrlInterface* this_, CONVERTTOUINAMEFLAGS flags) { return C::Get(this_)->ConvertToUiName(flags); }
		static Result<Url> _UrlInterface_ConvertFromUiName(const String& str) { return C::ConvertFromUiName(str); }
...
{
	return MTable::_instance._UrlInterface_EraseData(this, std::forward<ForwardingDataPtr>(key), persistent);
}
...
MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::ConvertToUiName(CONVERTTOUINAMEFLAGS flags) const -> Result<String>
{
	return MTable::_instance._UrlInterface_ConvertToUiName(this, flags);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::ConvertFromUiName(const String& str) -> Result<Url>
{
	return MTable::_instance._UrlInterface_ConvertFromUiName(str);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ReferenceFunctionsImpl<S>::EraseData(ForwardingDataPtr&& key, Bool persistent) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UrlInterface* o_ = (UrlInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UrlInterface_EraseData(o_, std::forward<ForwardingDataPtr>(key), persistent));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::COWReferenceFunctionsImpl<S>::EraseData(ForwardingDataPtr&& key, Bool persistent) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UrlInterface* o_ = (UrlInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (MTable::_instance._UrlInterface_EraseData(o_, std::forward<ForwardingDataPtr>(key), persistent));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OpenConnection() const -> typename maxon::SFINAEHelper<Result<IoConnectionRef>, S>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OpenInputStream(OPENSTREAMFLAGS flags) const -> typename maxon::SFINAEHelper<Result<InputStreamRef>, S>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OpenOutputStream(OPENSTREAMFLAGS flags) const -> typename maxon::SFINAEHelper<Result<OutputStreamRef>, S>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OpenInOutputStream(OPENSTREAMFLAGS flags) const -> typename maxon::SFINAEHelper<Result<InOutputStreamRef>, S>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetBrowseIterator(GETBROWSEITERATORFLAGS flags) const -> typename maxon::SFINAEHelper<Result<IoBrowseRef>, S>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IoGetTime(IOTIMEMODE mode) const -> typename maxon::SFINAEHelper<Result<UniversalDateTime>, S>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IoCopyFile(const Url& destName, Bool overwrite, Bool removeReadOnly, const IoProgressDelegate& progress) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UrlInterface* o_ = (const UrlInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = UrlInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ConvertToUiName(CONVERTTOUINAMEFLAGS flags) const -> Result<String>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<String>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UrlInterface* o_ = (const UrlInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = UrlInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UrlInterface_ConvertToUiName(o_, flags));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ConvertFromUiName(const String& str) -> Result<Url>
{
	return (MTable::_instance._UrlInterface_ConvertFromUiName(str));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._UrlInterface_DescribeIO(stream));
}
