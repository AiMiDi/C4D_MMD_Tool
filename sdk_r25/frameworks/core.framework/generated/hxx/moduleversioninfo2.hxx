...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ModuleVersionInfoInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Register(const Id& uniqueId, const DataDictionary& moduleInfo) -> Result<void>
{
