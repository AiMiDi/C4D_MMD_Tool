...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_StringInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(StringInterface::MTable::_instance._StringInterface_PrivateEnumToString)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "info\0value\0formatStatement\0", 21LL, nullptr),
