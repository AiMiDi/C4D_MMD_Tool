...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_ClassInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_GetMetaData)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance._ClassInterface_InitMetaData)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "data\0", 1LL, nullptr),
...
/// @endcond
	...
	public:
		...
		Result<void> HandleMessage(const InternedId& message, void* argument) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_HandleMessage_Offset), maxon::reflection::Argument::ByReference(message), maxon::reflection::Argument::ByValue(argument)};
			(*handler_)(_fn_ObjectInterface_HandleMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const InternedId&, void*>::Invoke, (const void*) mt_._ObjectInterface_HandleMessage));
			return proxy_result;
		}
		...
		Result<void> HandleConstMessage(const InternedId& message, void* argument) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObjectInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_HandleConstMessage_Offset), maxon::reflection::Argument::ByReference(message), maxon::reflection::Argument::ByValue(argument)};
			(*handler_)(_fn_ObjectInterface_HandleConstMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const InternedId&, void*>::Invoke, (const void*) mt_._ObjectInterface_HandleConstMessage));
			return proxy_result;
		}
		...
		HashInt GetHashCodeImpl() const 
		{
			...
			(*handler_)(_fn_ObjectInterface_GetHashCodeImpl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<HashInt, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObjectInterface_GetHashCodeImpl));
			return proxy_result;
		}
		...
		HashValue GetHashValueImpl() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObjectInterface_GetHashValueImpl_Offset)};
			(*handler_)(_fn_ObjectInterface_GetHashValueImpl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<HashValue, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObjectInterface_GetHashValueImpl));
			return proxy_result;
		}
...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_ObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "argument\0", 1LL, ObjectInterface, _ObjectInterface_InitObject),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "message\0argument\0", 5LL, ObjectInterface, _ObjectInterface_HandleMessage),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "message\0argument\0", 5LL, ObjectInterface, _ObjectInterface_HandleConstMessage),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ObjectInterface, _ObjectInterface_GetHashValueImpl),
/// @cond INTERNAL
...
/// @endcond
	...
	public:
		...
		String FormatMessage(const LanguageRef& language, const PartFormatter& partFormatter) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			String proxy_result = maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ErrorInterface_FormatMessage_Offset), maxon::reflection::Argument::ByReference(language), maxon::reflection::Argument::ByReference(partFormatter)};
			(*handler_)(_fn_ErrorInterface_FormatMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const LanguageRef&, const PartFormatter&>::Invoke, (const void*) mt_._ErrorInterface_FormatMessage));
			return proxy_result;
		}
		...
		void SetMessageDelegate(Delegate<String(const LanguageRef&language,const ErrorInterface::PartFormatter&fmt)>&& message) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ErrorInterface_SetMessageDelegate_Offset), maxon::reflection::Argument::ByReference(message)};
			(*handler_)(_fn_ErrorInterface_SetMessageDelegate, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, Delegate<String(const LanguageRef&language,const ErrorInterface::PartFormatter&fmt)>&&>::Invoke, (const void*) mt_._ErrorInterface_SetMessageDelegate));
		}
	...
	static maxon::Result<void> RegisterReflection_ErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "language\0partFormatter\0", 5LL, ErrorInterface, _ErrorInterface_FormatMessage),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "message\0", 1LL, ErrorInterface, _ErrorInterface_SetMessageDelegate),
