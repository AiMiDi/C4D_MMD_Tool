...
{
	template <typename S> using CWrapper = typename IoErrorInterface::Hxx2::template CWrapper<S>;
};
...
{
	template <typename S> using CWrapper = typename OutputStreamInterface::Hxx2::template CWrapper<typename InputStreamInterface::Hxx2::template CWrapper<S>>;
};
