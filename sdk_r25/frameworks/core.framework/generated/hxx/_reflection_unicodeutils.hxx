...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_UnicodeUtils(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnicodeUtils::MTable::_instance._UnicodeUtils_GetCharacterType)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "chr\0", 1LL, nullptr),
