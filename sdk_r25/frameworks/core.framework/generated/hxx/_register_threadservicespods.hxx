...
/// @endcond
	...
	namespace enum200
	{
		...
		static const maxon::UInt64 WAITMODE_values[] = {maxon::UInt64(enum200::WAITMODE::DEFAULT), maxon::UInt64(enum200::WAITMODE::RETURN_ON_CANCEL), maxon::UInt64(enum200::WAITMODE::PRIVATE_BLOCKING), maxon::UInt64(enum200::WAITMODE::EXTERNAL_ENQUEUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_WAITMODE200(){ return enum200::WAITMODE_info; }
	namespace enum209
	{
		...
		static const maxon::UInt64 THREADTYPE_values[] = {maxon::UInt64(enum209::THREADTYPE::MAIN), maxon::UInt64(enum209::THREADTYPE::WORKER), maxon::UInt64(enum209::THREADTYPE::STANDALONE), maxon::UInt64(enum209::THREADTYPE::ALIEN), maxon::UInt64(enum209::THREADTYPE::ASSIMILATED)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_THREADTYPE209(){ return enum209::THREADTYPE_info; }
}
#endif
