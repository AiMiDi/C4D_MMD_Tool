...
struct DataDescriptionDefinitionDatabaseInterface::MTable
{
	...
	Result<void> (*_DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps) (DBVERSION version, DataDictionary& entry);
	...
	template <typename IMPL> void Init()
	{
		...
		_DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps = &IMPL::_DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps;
...
struct DataDescriptionDefinitionDatabaseInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps(DBVERSION version, DataDictionary& entry) { return C::FixDatabaseProps(version, entry); }
...
{
	return MTable::_instance._DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps(version, entry);
}
