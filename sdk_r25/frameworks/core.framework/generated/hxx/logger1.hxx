...
/// Implement function to flush output.
	...
	COWReferenceFunctionsImpl<typename DataDictionaryObjectInterface::Hxx1::template ReferenceFunctionsHelper<typename ObserverObjectInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>,
...
/// @param[in] url								Destination path.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename LoggerTypeInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename LoggerTypeInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename LoggerTypeInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
/// Clears the cache of this logger type.
	...
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename LoggerTypeInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename LoggerTypeInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename LoggerTypeInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
