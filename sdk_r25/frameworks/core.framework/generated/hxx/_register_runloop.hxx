...
namespace maxon
{
	...
	maxon::Bool RunLoop::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_RunLoop_EnterLoop_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::_RunLoop_EnterLoop_1;
		#else
		tbl->_RunLoop_EnterLoop_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::_RunLoop_EnterLoop_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
