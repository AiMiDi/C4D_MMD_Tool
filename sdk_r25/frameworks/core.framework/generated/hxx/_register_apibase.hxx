...
namespace maxon
{
	...
	namespace enum575
	{
		...
		static const maxon::UInt64 ENUM_DONT_INITIALIZE_values[] = {maxon::UInt64(enum575::ENUM_DONT_INITIALIZE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_ENUM_DONT_INITIALIZE575(){ return enum575::ENUM_DONT_INITIALIZE_info; }
	namespace enum585
	{
		...
		static const maxon::UInt64 IN_PLACE_TYPE_values[] = {maxon::UInt64(enum585::IN_PLACE_TYPE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IN_PLACE_TYPE585(){ return enum585::IN_PLACE_TYPE_info; }
...
/// @cond INTERNAL
	...
	namespace enum1693
	{
		...
		static const maxon::UInt64 TYPE_values[] = {maxon::UInt64(enum1693::TYPE::INVALID_0), maxon::UInt64(enum1693::TYPE::INTERFACE), maxon::UInt64(enum1693::TYPE::INTERFACE_NVMTABLE), maxon::UInt64(enum1693::TYPE::NONVIRTUAL_INTERFACE), maxon::UInt64(enum1693::TYPE::DECLARATION), maxon::UInt64(enum1693::TYPE::COMPONENT), maxon::UInt64(enum1693::TYPE::CLASS), maxon::UInt64(enum1693::TYPE::TRANSLATION_UNIT), maxon::UInt64(enum1693::TYPE::MODULE), maxon::UInt64(enum1693::TYPE::INITIALIZATION), maxon::UInt64(enum1693::TYPE::DEPENDENCY), maxon::UInt64(enum1693::TYPE::REGISTRY), maxon::UInt64(enum1693::TYPE::UNUSED), maxon::UInt64(enum1693::TYPE::GLOBAL), maxon::UInt64(enum1693::TYPE::COUNT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TYPE1693(void*){ return enum1693::TYPE_info; }
	namespace enum1820
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum1820::FLAGS::NONE), maxon::UInt64(enum1820::FLAGS::CONSTRUCTED), maxon::UInt64(enum1820::FLAGS::DISABLED), maxon::UInt64(enum1820::FLAGS::INITIALIZED), maxon::UInt64(enum1820::FLAGS::INITIALIZING), maxon::UInt64(enum1820::FLAGS::INITIALIZATION_FAILED), maxon::UInt64(enum1820::FLAGS::NULL_AS_DEFAULT), maxon::UInt64(enum1820::FLAGS::USED), maxon::UInt64(enum1820::FLAGS::HIDDEN), maxon::UInt64(enum1820::FLAGS::REGISTRATION_UNIT), maxon::UInt64(enum1820::FLAGS::DEFINITION), maxon::UInt64(enum1820::FLAGS::SINGLE_BASE), maxon::UInt64(enum1820::FLAGS::IGNORE_WARNINGS), maxon::UInt64(enum1820::FLAGS::EXPLICIT), maxon::UInt64(enum1820::FLAGS::FRAMEWORK), maxon::UInt64(enum1820::FLAGS::CORE), maxon::UInt64(enum1820::FLAGS::PROXY), maxon::UInt64(enum1820::FLAGS::CLASS_PROXY), maxon::UInt64(enum1820::FLAGS::FINAL), maxon::UInt64(enum1820::FLAGS::SINGLE_IMPLEMENTATION), maxon::UInt64(enum1820::FLAGS::MAIN_DEFINITION), maxon::UInt64(enum1820::FLAGS::CALLABLE), maxon::UInt64(enum1820::FLAGS::IMPLEMENTABLE), maxon::UInt64(enum1820::FLAGS::ADAPTER), maxon::UInt64(enum1820::FLAGS::SYNTHETIC), maxon::UInt64(enum1820::FLAGS::LIVE), maxon::UInt64(enum1820::FLAGS::EXPECT_FAILURE), maxon::UInt64(enum1820::FLAGS::FRAMEWORK_REGISTRATION), maxon::UInt64(enum1820::FLAGS::EXTENDED), maxon::UInt64(enum1820::FLAGS::MARK), maxon::UInt64(enum1820::FLAGS::PUBLIC), maxon::UInt64(enum1820::FLAGS::REFERENCE_NONE), maxon::UInt64(enum1820::FLAGS::REFERENCE_POINTER), maxon::UInt64(enum1820::FLAGS::REFERENCE_CONST_POINTER), maxon::UInt64(enum1820::FLAGS::REFERENCE_NORMAL), maxon::UInt64(enum1820::FLAGS::REFERENCE_CONST), maxon::UInt64(enum1820::FLAGS::REFERENCE_COPY_ON_WRITE), maxon::UInt64(enum1820::FLAGS::REFERENCE_ALWAYS_COPY_ON_WRITE), maxon::UInt64(enum1820::FLAGS::REFERENCE_MASK), maxon::UInt64(enum1820::FLAGS::ON_CONSTRUCTION_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FLAGS1820(void*){ return enum1820::FLAGS_info; }
	namespace details
	{
...
/// @endcond
	...
	namespace enum2338
	{
		...
		static const maxon::UInt64 VALUEKIND_values[] = {maxon::UInt64(enum2338::VALUEKIND::NONE), maxon::UInt64(enum2338::VALUEKIND::VOID_TYPE), maxon::UInt64(enum2338::VALUEKIND::GENERIC), maxon::UInt64(enum2338::VALUEKIND::GENERIC_ARITHMETIC), maxon::UInt64(enum2338::VALUEKIND::SCALAR), maxon::UInt64(enum2338::VALUEKIND::INTEGRAL), maxon::UInt64(enum2338::VALUEKIND::FLOATING_POINT), maxon::UInt64(enum2338::VALUEKIND::ENUM), maxon::UInt64(enum2338::VALUEKIND::ENUM_LIST), maxon::UInt64(enum2338::VALUEKIND::ENUM_FLAGS), maxon::UInt64(enum2338::VALUEKIND::DATA), maxon::UInt64(enum2338::VALUEKIND::DATAPTR), maxon::UInt64(enum2338::VALUEKIND::NONVIRTUAL_INTERFACE), maxon::UInt64(enum2338::VALUEKIND::VIRTUAL_INTERFACE), maxon::UInt64(enum2338::VALUEKIND::REF_OR_POINTER), maxon::UInt64(enum2338::VALUEKIND::POINTER), maxon::UInt64(enum2338::VALUEKIND::STRONG_REFERENCE), maxon::UInt64(enum2338::VALUEKIND::COW_REFERENCE), maxon::UInt64(enum2338::VALUEKIND::UNIQUE_REFERENCE), maxon::UInt64(enum2338::VALUEKIND::ACOW_REFERENCE), maxon::UInt64(enum2338::VALUEKIND::LV_REFERENCE), maxon::UInt64(enum2338::VALUEKIND::RV_REFERENCE), maxon::UInt64(enum2338::VALUEKIND::TUPLE), maxon::UInt64(enum2338::VALUEKIND::STRUCT), maxon::UInt64(enum2338::VALUEKIND::SIMD), maxon::UInt64(enum2338::VALUEKIND::BLOCK), maxon::UInt64(enum2338::VALUEKIND::STRIDED_BLOCK), maxon::UInt64(enum2338::VALUEKIND::BASEARRAY), maxon::UInt64(enum2338::VALUEKIND::BLOCKARRAY), maxon::UInt64(enum2338::VALUEKIND::RESULT), maxon::UInt64(enum2338::VALUEKIND::DELEGATE), maxon::UInt64(enum2338::VALUEKIND::FUNCTION), maxon::UInt64(enum2338::VALUEKIND::CONST_QUALIFIED), maxon::UInt64(enum2338::VALUEKIND::SOURCE_LEVEL), maxon::UInt64(enum2338::VALUEKIND::DEEP_CONSTNESS), maxon::UInt64(enum2338::VALUEKIND::INT_SIZE_OR_LESS), maxon::UInt64(enum2338::VALUEKIND::ZERO_INITIALIZED), maxon::UInt64(enum2338::VALUEKIND::ORDERED), maxon::UInt64(enum2338::VALUEKIND::TRIVIALLY_CONSTRUCTIBLE), maxon::UInt64(enum2338::VALUEKIND::TRIVIALLY_DESTRUCTIBLE), maxon::UInt64(enum2338::VALUEKIND::TRIVIALLY_COPYABLE), maxon::UInt64(enum2338::VALUEKIND::TRIVIALLY_EQUATABLE), maxon::UInt64(enum2338::VALUEKIND::OBJECT_REF), maxon::UInt64(enum2338::VALUEKIND::VALUE), maxon::UInt64(enum2338::VALUEKIND::ELEMENT_TYPE_AS_ARG), maxon::UInt64(enum2338::VALUEKIND::NEVER_NULLPTR), maxon::UInt64(enum2338::VALUEKIND::SIGNED), maxon::UInt64(enum2338::VALUEKIND::GENERIC_INSTANTIATION), maxon::UInt64(enum2338::VALUEKIND::GLOBALLY_REFERENCED), maxon::UInt64(enum2338::VALUEKIND::ABSTRACT), maxon::UInt64(enum2338::VALUEKIND::NAMED), maxon::UInt64(enum2338::VALUEKIND::CONTAINER_REF), maxon::UInt64(enum2338::VALUEKIND::GENERIC_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::RECURSIVE_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::RESOLVED_RECURSIVE_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::CONTAINER), maxon::UInt64(enum2338::VALUEKIND::EMPTY_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::SINGLETON_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::STATIC_ARRAY_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::ARRAY_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::ARRAY), maxon::UInt64(enum2338::VALUEKIND::CONTAINER_MASK), maxon::UInt64(enum2338::VALUEKIND::NAMED_TUPLE), maxon::UInt64(enum2338::VALUEKIND::CONTAINS_RECURSIVE_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::CONTAINS_INVALID_TYPE), maxon::UInt64(enum2338::VALUEKIND::MIN_DERIVED_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::MIN_ARRAY_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::MAX_ARRAY_CONTAINER), maxon::UInt64(enum2338::VALUEKIND::COW_MASK), maxon::UInt64(enum2338::VALUEKIND::STRONG_MASK), maxon::UInt64(enum2338::VALUEKIND::PTR_MASK), maxon::UInt64(enum2338::VALUEKIND::CONTAINER_OR_REF), maxon::UInt64(enum2338::VALUEKIND::REFERENCE_MASK), maxon::UInt64(enum2338::VALUEKIND::ARITHMETIC_MASK), maxon::UInt64(enum2338::VALUEKIND::TUPLE_MASK), maxon::UInt64(enum2338::VALUEKIND::TUPLE_INHERIT_MASK), maxon::UInt64(enum2338::VALUEKIND::POINTER_FLAGS), maxon::UInt64(enum2338::VALUEKIND::QUALIFIER_MASK), maxon::UInt64(enum2338::VALUEKIND::CONTAINS_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VALUEKIND2338(){ return enum2338::VALUEKIND_info; }
	...
	namespace enum2384
	{
		...
		static const maxon::UInt64 COLLECTION_KIND_values[] = {maxon::UInt64(enum2384::COLLECTION_KIND::NONE), maxon::UInt64(enum2384::COLLECTION_KIND::ARRAY), maxon::UInt64(enum2384::COLLECTION_KIND::SET), maxon::UInt64(enum2384::COLLECTION_KIND::MAP)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_COLLECTION_KIND2384(){ return enum2384::COLLECTION_KIND_info; }
