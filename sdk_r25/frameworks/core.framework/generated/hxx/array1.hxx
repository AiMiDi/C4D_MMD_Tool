...
struct PersistentIdGeneratorInterface::Hxx1
{
	...
	ConstReferenceFunctionsImpl<typename ST::type>
	> { };
};
class PersistentIdGeneratorInterface::Hxx1::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<PersistentIdGenerator>
#else
public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PersistentIdGeneratorInterface, maxon::StrongCOWRefHandler, PersistentIdGenerator>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PersistentIdGeneratorInterface, maxon::StrongCOWRefHandler, PersistentIdGenerator>>>>);
...
#else
public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PersistentIdGeneratorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PersistentIdGeneratorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
/// @return												Start index of the block. I.e., the requested element can be found within the block at @p index - start index.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename GenericContainerInterface::Hxx1::template ReferenceFunctionsHelper<ST, NamedTuple<TYPE>>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename GenericContainerInterface::Hxx1::template ReferenceFunctionsHelper<ST, NamedTuple<TYPE>>::type>, ReferenceFunctionsImpl<typename GenericContainerInterface::Hxx1::template ReferenceFunctionsHelper<ST, NamedTuple<TYPE>>::type>>::type
	> { };
};
template <typename TYPE> class StaticArrayInterface<TYPE>::Hxx1::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<StaticArray<TYPE>>
#else
public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const StaticArrayInterface<TYPE>, maxon::StrongCOWRefHandler, StaticArray<TYPE>>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const StaticArrayInterface<TYPE>, maxon::StrongCOWRefHandler, StaticArray<TYPE>>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public ReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<StaticArrayInterface<TYPE>, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
};
...
/// @return												Success of operation.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename ArrayBase0<ArrayInterface<TYPE>, TYPE, StaticArrayInterface<TYPE>, DefaultCompare>::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ArrayBase0<ArrayInterface<TYPE>, TYPE, StaticArrayInterface<TYPE>, DefaultCompare>::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename ArrayBase0<ArrayInterface<TYPE>, TYPE, StaticArrayInterface<TYPE>, DefaultCompare>::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
public ReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<ArrayInterface<TYPE>, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
};
