...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_FileUtilities(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_CopyStreamProgress)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "from\0to\0progress\0", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_WriteDirectoryTree)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "root\0out\0filterDelegate\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_ReadDirectoryTree)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "in\0receiver\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_CreateCStringOutputStream)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "str\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_CreateNullOutputStream)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_WriteArray)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "out\0buffer\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_WriteString)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "out\0string\0encoding\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileUtilities::MTable::_instance._FileUtilities_ReadString)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "in\0decoding\0", 0LL, nullptr),
		};
