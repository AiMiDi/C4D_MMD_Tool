...
/// @endcond
	...
	namespace enum610
	{
		...
		static const maxon::UInt64 STATICJOBGROUPFLAGS_values[] = {maxon::UInt64(enum610::STATICJOBGROUPFLAGS::DEFAULT), maxon::UInt64(enum610::STATICJOBGROUPFLAGS::ENQUEUEING_THREAD_WAITS), maxon::UInt64(enum610::STATICJOBGROUPFLAGS::THREAD_AFFINITY), maxon::UInt64(enum610::STATICJOBGROUPFLAGS::NO_JOB_DESTRUCTOR)};
		static const maxon::EnumInfo STATICJOBGROUPFLAGS_info{"STATICJOBGROUPFLAGS", SIZEOF(STATICJOBGROUPFLAGS), true, "DEFAULT\0ENQUEUEING_THREAD_WAITS\0THREAD_AFFINITY\0NO_JOB_DESTRUCTOR\0", STATICJOBGROUPFLAGS_values, std::extent<decltype(STATICJOBGROUPFLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_STATICJOBGROUPFLAGS610(){ return enum610::STATICJOBGROUPFLAGS_info; }
	namespace enum849
	{
		...
		static const maxon::UInt64 STATICJOBARRAYFLAGS_values[] = {maxon::UInt64(enum849::STATICJOBARRAYFLAGS::DEFAULT), maxon::UInt64(enum849::STATICJOBARRAYFLAGS::INITIALIZE_LATER)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_STATICJOBARRAYFLAGS849(){ return enum849::STATICJOBARRAYFLAGS_info; }
/// @cond IGNORE
