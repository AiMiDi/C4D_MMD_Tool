...
struct DataDescriptionInterface::MTable
{
	...
	HashInt (*_DataDescriptionInterface_GetHashCode) (const DataDescriptionInterface* this_);
...
struct DataDescriptionInterface::Hxx2
{
	...
	public:
		...
		static DataDictionary _DataDescriptionInterface_GetInfo(const DataDescriptionInterface* this_) { return C::Get(this_)->GetInfo(); }
		static Result<void> _DataDescriptionInterface_SetInfo(DataDescriptionInterface* this_, const DataDictionary& info) { return C::Get(this_)->SetInfo(info); }
		static Int _DataDescriptionInterface_GetEntryCount(const DataDescriptionInterface* this_) { return C::Get(this_)->GetEntryCount(); }
		static Result<BaseArray<DataDictionary>> _DataDescriptionInterface_GetEntries(const DataDescriptionInterface* this_) { return C::Get(this_)->GetEntries(); }
		static Result<DataDictionary> _DataDescriptionInterface_GetEntry(const DataDescriptionInterface* this_, const InternedId& id) { return C::Get(this_)->GetEntry(id); }
		static Result<Bool> _DataDescriptionInterface_SetEntry(DataDescriptionInterface* this_, const DataDictionary& props, Bool merge) { return C::Get(this_)->SetEntry(props, merge); }
		static Result<void> _DataDescriptionInterface_EraseEntry(DataDescriptionInterface* this_, const InternedId& id) { return C::Get(this_)->EraseEntry(id); }
		static void _DataDescriptionInterface_Reset(DataDescriptionInterface* this_) { return C::Get(this_)->Reset(); }
		static Bool _DataDescriptionInterface_IsEqual(const DataDescriptionInterface* this_, const DataDescriptionInterface* other, EQUALITY equality) { return C::Get(this_)->IsEqual(other, equality); }
		static COMPARERESULT _DataDescriptionInterface_Compare(const DataDescriptionInterface* this_, const DataDescriptionInterface* other) { return C::Get(this_)->Compare(other); }
		static HashInt _DataDescriptionInterface_GetHashCode(const DataDescriptionInterface* this_) { return C::Get(this_)->GetHashCode(); }
		static String _DataDescriptionInterface_ToString(const DataDescriptionInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._DataDescriptionInterface_DescribeIO(stream));
}
