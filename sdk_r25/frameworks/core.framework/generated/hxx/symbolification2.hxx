...
struct SymbolificationInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _SymbolificationInterface_Init(SymbolificationInterface* this_, const Url& symbolFile, const String& architecture) { return C::Get(this_)->Init(symbolFile, architecture); }
		static Result<void> _SymbolificationInterface_FindSymbol(SymbolificationInterface* this_, UInt64 addr, String& file, Int& line, String& function) { return C::Get(this_)->FindSymbol(addr, file, line, function); }
	};
