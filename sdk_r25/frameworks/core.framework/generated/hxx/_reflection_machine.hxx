...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_MachineInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, MachineInterface, _MachineInterface_ObservablePrivateSplashMessageReceived),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, MachineInterface, _MachineInterface_ObservableActivationChanged),
		};
