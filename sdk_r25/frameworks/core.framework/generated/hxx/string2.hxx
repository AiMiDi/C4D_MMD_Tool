...
struct StringInterface::MTable
{
	...
	HashInt (*_StringInterface_GetHashCode) (const StringInterface* this_);
	...
	String (*_StringInterface_PrivateEnumToString) (const EnumInfo& info, UInt64 value, const FormatStatement* formatStatement);
...
struct StringInterface::Hxx2
{
	...
	public:
		...
		static Int _StringInterface_GetLength(const StringInterface* this_) { return C::Get(this_)->GetLength(); }
		static Result<void> _StringInterface_Init(StringInterface* this_, Int count, Utf32Char fillChar) { return C::Get(this_)->Init(count, fillChar); }
		static Result<void> _StringInterface_Shrink(StringInterface* this_) { return C::Get(this_)->Shrink(); }
		static Result<void> _StringInterface_Append(StringInterface* this_, const StringInterface* str) { return C::Get(this_)->Append(str); }
		static Result<void> _StringInterface_Append_1(StringInterface* this_, const Utf32Char* str, Int len) { return C::Get(this_)->Append(str, len); }
		static Int _StringInterface_FindIndex(const StringInterface* this_, const StringInterface* str, StringPosition start) { return C::Get(this_)->FindIndex(str, std::forward<StringPosition>(start)); }
		static Int _StringInterface_FindLastIndex(const StringInterface* this_, const StringInterface* str, StringPosition start) { return C::Get(this_)->FindLastIndex(str, std::forward<StringPosition>(start)); }
		static Int _StringInterface_FindIndex_1(const StringInterface* this_, Utf32Char ch, StringPosition start) { return C::Get(this_)->FindIndex(ch, std::forward<StringPosition>(start)); }
		static Int _StringInterface_FindLastIndex_1(const StringInterface* this_, Utf32Char ch, StringPosition start) { return C::Get(this_)->FindLastIndex(ch, std::forward<StringPosition>(start)); }
		static Int _StringInterface_FindUpperIndex(const StringInterface* this_, const StringInterface* str, StringPosition start) { return C::Get(this_)->FindUpperIndex(str, std::forward<StringPosition>(start)); }
		static Int _StringInterface_FindLastUpperIndex(const StringInterface* this_, const StringInterface* str, StringPosition start) { return C::Get(this_)->FindLastUpperIndex(str, std::forward<StringPosition>(start)); }
		static Result<void> _StringInterface_Erase(StringInterface* this_, StringPosition position, StringCount count) { return C::Get(this_)->Erase(std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		static Result<void> _StringInterface_Insert(StringInterface* this_, StringPosition position, const StringInterface* str, StringPosition strStart, StringCount strCount) { return C::Get(this_)->Insert(std::forward<StringPosition>(position), str, std::forward<StringPosition>(strStart), std::forward<StringCount>(strCount)); }
		static Result<void> _StringInterface_Insert_1(StringInterface* this_, StringPosition position, Utf32Char ch) { return C::Get(this_)->Insert(std::forward<StringPosition>(position), ch); }
		static StringInterface* _StringInterface_GetPart(const StringInterface* this_, StringPosition start, StringCount count) { return C::Get(this_)->GetPart(std::forward<StringPosition>(start), std::forward<StringCount>(count)); }
		static StringInterface* _StringInterface_ToUpper(const StringInterface* this_) { return C::Get(this_)->ToUpper(); }
		static StringInterface* _StringInterface_ToLower(const StringInterface* this_) { return C::Get(this_)->ToLower(); }
		static COMPARERESULT _StringInterface_ComparePart(const StringInterface* this_, const StringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) { return C::Get(this_)->ComparePart(str, mode, std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		static HashInt _StringInterface_GetHashCode(const StringInterface* this_) { return C::Get(this_)->GetHashCode(); }
		static void _StringInterface_SetChar(StringInterface* this_, Int pos, Utf32Char ch) { return C::Get(this_)->SetChar(pos, ch); }
		static Utf32Char _StringInterface_GetChar(const StringInterface* this_, Int pos) { return C::Get(this_)->GetChar(pos); }
		static Result<void> _StringInterface_GetUtf32(const StringInterface* this_, Utf32CharBuffer& stringData) { return C::Get(this_)->GetUtf32(stringData); }
		static Result<void> _StringInterface_TrimLeft(StringInterface* this_) { return C::Get(this_)->TrimLeft(); }
		static Result<void> _StringInterface_TrimRight(StringInterface* this_) { return C::Get(this_)->TrimRight(); }
		static Result<void> _StringInterface_Split(const StringInterface* this_, const String& splitSymbol, Bool trim, const ValueReceiver<const String&>& parts) { return C::Get(this_)->Split(splitSymbol, trim, parts); }
		static Result<Int> _StringInterface_Replace(StringInterface* this_, Utf32Char find, Utf32Char replace) { return C::Get(this_)->Replace(find, replace); }
		static Result<Int> _StringInterface_Replace_1(StringInterface* this_, const String& find, const String& replace) { return C::Get(this_)->Replace(find, replace); }
		static Result<Int> _StringInterface_Replace_2(StringInterface* this_, Utf32Char find, const String& replace) { return C::Get(this_)->Replace(find, replace); }
		...
		static Result<Int> _StringInterface_GetCStringBlock(const StringInterface* this_, const Block<Char>& buffer, const StringEncodingRef& stringEncoding) { return C::Get(this_)->GetCStringBlock(buffer, stringEncoding); }
		static Result<void> _StringInterface_GetCStringAppendArray(const StringInterface* this_, const NonConstArray<Char>& array, const StringEncodingRef& stringEncoding) { return C::Get(this_)->GetCStringAppendArray(array, stringEncoding); }
		static Result<BaseArray<Char>> _StringInterface_GetCString(const StringInterface* this_, const StringEncodingRef& stringEncoding) { return C::Get(this_)->GetCString(stringEncoding); }
		static Result<void> _StringInterface_SetCString(StringInterface* this_, const Char* buffer, Int count, const StringDecodingRef& stringDecoding) { return C::Get(this_)->SetCString(buffer, count, stringDecoding); }
		static Result<SysCharArray> _StringInterface_GetSystemEncoding(const StringInterface* this_) { return C::Get(this_)->GetSystemEncoding(); }
		static Result<void> _StringInterface_SetSystemEncoding(StringInterface* this_, const SysChar* buffer, Int count) { return C::Get(this_)->SetSystemEncoding(buffer, count); }
		static Result<void> _StringInterface_SetUtf32(StringInterface* this_, const Utf32Char* buffer, Int count) { return C::Get(this_)->SetUtf32(buffer, count); }
		static Result<void> _StringInterface_GetUtf16(const StringInterface* this_, Utf16CharBuffer& stringData) { return C::Get(this_)->GetUtf16(stringData); }
		static Result<void> _StringInterface_SetUtf16(StringInterface* this_, const Utf16Char* buffer, Int count) { return C::Get(this_)->SetUtf16(buffer, count); }
		...
		static String _StringInterface_PrivateEnumToString(const EnumInfo& info, UInt64 value, const FormatStatement* formatStatement) { return C::PrivateEnumToString(info, value, formatStatement); }
		static StridedBlock<const Generic> _StringInterface_GetVariableInternalData(const StringInterface* this_) { return C::Get(this_)->GetVariableInternalData(); }
		static Int _StringInterface_GetCharacterWidth(const StringInterface* this_) { return C::Get(this_)->GetCharacterWidth(); }
	};
...
{
	return MTable::_instance._StringInterface_PrivateEnumToString(info, value, formatStatement);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ReferenceFunctionsImpl<S>::Append(const String& str) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); StringInterface* o_ = (StringInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (o_->Append(str));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::COWReferenceFunctionsImpl<S>::Append(const String& str) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); StringInterface* o_ = (StringInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (o_->Append(str));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ReferenceFunctionsImpl<S>::Append(const Block<const Utf32Char>& block) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); StringInterface* o_ = (StringInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (o_->Append(block));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::COWReferenceFunctionsImpl<S>::Append(const Block<const Utf32Char>& block) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); StringInterface* o_ = (StringInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (o_->Append(block));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::FloatToString(Float32 value, Int charsBeforeComma, Int digitsAfterComma, Bool exponent, Utf32Char fillChar) -> String
{
	return (StringInterface::FloatToString(value, charsBeforeComma, digitsAfterComma, exponent, fillChar));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::FloatToString(Float64 value, Int charsBeforeComma, Int digitsAfterComma, Bool exponent, Utf32Char fillChar) -> String
{
	return (StringInterface::FloatToString(value, charsBeforeComma, digitsAfterComma, exponent, fillChar));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IntToString(Int32 v) -> String
{
	return (StringInterface::IntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::UIntToString(UInt32 v) -> String
{
	return (StringInterface::UIntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IntToString(Int64 v) -> String
{
	return (StringInterface::IntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::UIntToString(UInt64 v) -> String
{
	return (StringInterface::UIntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::MemorySizeToString(Int64 v, Bool mebibytes) -> String
{
	return (StringInterface::MemorySizeToString(v, mebibytes));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::HexToString(UInt32 v, Bool prefix0x) -> String
{
	return (StringInterface::HexToString(v, prefix0x));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::HexToString(UInt64 v, Bool prefix0x) -> String
{
	return (StringInterface::HexToString(v, prefix0x));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::PointerToString(const void* v) -> String
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetAndCacheConstString(const wchar_t* chr, Int len) -> const String&
{
	return (MTable::_instance._StringInterface_GetAndCacheConstString(chr, len));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetAndCacheConstString(const Char* chr, Int len, Int isUtf8) -> const String&
{
	return (MTable::_instance._StringInterface_GetAndCacheConstString_1(chr, len, isUtf8));
}
...
struct CStringInterface::MTable
{
	...
	HashInt (*_CStringInterface_GetHashCode) (const CStringInterface* this_);
...
struct CStringInterface::Hxx2
{
	...
	public:
		...
		static Int _CStringInterface_GetLength(const CStringInterface* this_) { return C::Get(this_)->GetLength(); }
		static Result<void> _CStringInterface_Init(CStringInterface* this_, Int count, Char fillChar) { return C::Get(this_)->Init(count, fillChar); }
		static Result<void> _CStringInterface_Shrink(CStringInterface* this_) { return C::Get(this_)->Shrink(); }
		static Result<void> _CStringInterface_Append(CStringInterface* this_, const CStringInterface* str) { return C::Get(this_)->Append(str); }
		static Result<void> _CStringInterface_Append_1(CStringInterface* this_, const Char* str, Int len) { return C::Get(this_)->Append(str, len); }
		static Int _CStringInterface_FindIndex(const CStringInterface* this_, const CStringInterface* str, StringPosition start) { return C::Get(this_)->FindIndex(str, std::forward<StringPosition>(start)); }
		static Int _CStringInterface_FindLastIndex(const CStringInterface* this_, const CStringInterface* str, StringPosition start) { return C::Get(this_)->FindLastIndex(str, std::forward<StringPosition>(start)); }
		static Int _CStringInterface_FindIndex_1(const CStringInterface* this_, Char ch, StringPosition start) { return C::Get(this_)->FindIndex(ch, std::forward<StringPosition>(start)); }
		static Int _CStringInterface_FindLastIndex_1(const CStringInterface* this_, Char ch, StringPosition start) { return C::Get(this_)->FindLastIndex(ch, std::forward<StringPosition>(start)); }
		static Int _CStringInterface_FindUpperIndex(const CStringInterface* this_, const CStringInterface* str, StringPosition start) { return C::Get(this_)->FindUpperIndex(str, std::forward<StringPosition>(start)); }
		static Int _CStringInterface_FindLastUpperIndex(const CStringInterface* this_, const CStringInterface* str, StringPosition start) { return C::Get(this_)->FindLastUpperIndex(str, std::forward<StringPosition>(start)); }
		static Result<void> _CStringInterface_Erase(CStringInterface* this_, StringPosition position, StringCount count) { return C::Get(this_)->Erase(std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		static Result<void> _CStringInterface_Insert(CStringInterface* this_, StringPosition position, const CStringInterface* str, StringPosition strStart, StringCount strCount) { return C::Get(this_)->Insert(std::forward<StringPosition>(position), str, std::forward<StringPosition>(strStart), std::forward<StringCount>(strCount)); }
		static Result<void> _CStringInterface_Insert_1(CStringInterface* this_, StringPosition position, Char ch) { return C::Get(this_)->Insert(std::forward<StringPosition>(position), ch); }
		static CStringInterface* _CStringInterface_GetPart(const CStringInterface* this_, StringPosition start, StringCount count) { return C::Get(this_)->GetPart(std::forward<StringPosition>(start), std::forward<StringCount>(count)); }
		static CStringInterface* _CStringInterface_ToUpper(const CStringInterface* this_) { return C::Get(this_)->ToUpper(); }
		static CStringInterface* _CStringInterface_ToLower(const CStringInterface* this_) { return C::Get(this_)->ToLower(); }
		static COMPARERESULT _CStringInterface_ComparePart(const CStringInterface* this_, const CStringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) { return C::Get(this_)->ComparePart(str, mode, std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		static HashInt _CStringInterface_GetHashCode(const CStringInterface* this_) { return C::Get(this_)->GetHashCode(); }
		static void _CStringInterface_SetChar(CStringInterface* this_, Int pos, Char ch) { return C::Get(this_)->SetChar(pos, ch); }
		static Char _CStringInterface_GetChar(const CStringInterface* this_, Int pos) { return C::Get(this_)->GetChar(pos); }
		static Result<void> _CStringInterface_GetUtf32(const CStringInterface* this_, Utf32CharBuffer& stringData) { return C::Get(this_)->GetUtf32(stringData); }
		static Result<void> _CStringInterface_TrimLeft(CStringInterface* this_) { return C::Get(this_)->TrimLeft(); }
		static Result<void> _CStringInterface_TrimRight(CStringInterface* this_) { return C::Get(this_)->TrimRight(); }
		static Result<void> _CStringInterface_Split(const CStringInterface* this_, const CString& splitSymbol, Bool trim, const ValueReceiver<const CString&>& parts) { return C::Get(this_)->Split(splitSymbol, trim, parts); }
		static Result<Int> _CStringInterface_Replace(CStringInterface* this_, Char find, Char replace) { return C::Get(this_)->Replace(find, replace); }
		static Result<Int> _CStringInterface_Replace_1(CStringInterface* this_, const CString& find, const CString& replace) { return C::Get(this_)->Replace(find, replace); }
		static Result<Int> _CStringInterface_Replace_2(CStringInterface* this_, Char find, const CString& replace) { return C::Get(this_)->Replace(find, replace); }
		...
		static Result<Int> _CStringInterface_GetCStringBlock(const CStringInterface* this_, const Block<Char>& buffer) { return C::Get(this_)->GetCStringBlock(buffer); }
		static Result<void> _CStringInterface_GetCStringAppendArray(const CStringInterface* this_, const NonConstArray<Char>& array) { return C::Get(this_)->GetCStringAppendArray(array); }
		static Result<void> _CStringInterface_SetCString(CStringInterface* this_, const Char* buffer, Int count) { return C::Get(this_)->SetCString(buffer, count); }
		static Result<BaseArray<Char>> _CStringInterface_GetCString(const CStringInterface* this_) { return C::Get(this_)->GetCString(); }
		static Block<const Char> _CStringInterface_GetInternalData(const CStringInterface* this_) { return C::Get(this_)->GetInternalData(); }
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ReferenceFunctionsImpl<S>::Append(const CString& str) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CStringInterface* o_ = (CStringInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (o_->Append(str));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::COWReferenceFunctionsImpl<S>::Append(const CString& str) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CStringInterface* o_ = (CStringInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (o_->Append(str));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ReferenceFunctionsImpl<S>::Append(const Block<const Char>& block) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CStringInterface* o_ = (CStringInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (o_->Append(block));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::COWReferenceFunctionsImpl<S>::Append(const Block<const Char>& block) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CStringInterface* o_ = (CStringInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (o_->Append(block));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::FloatToString(Float32 value, Int charsBeforeComma, Int digitsAfterComma, Bool exponent, Char fillChar) -> CString
{
	return (CStringInterface::FloatToString(value, charsBeforeComma, digitsAfterComma, exponent, fillChar));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::FloatToString(Float64 value, Int charsBeforeComma, Int digitsAfterComma, Bool exponent, Char fillChar) -> CString
{
	return (CStringInterface::FloatToString(value, charsBeforeComma, digitsAfterComma, exponent, fillChar));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IntToString(Int32 v) -> CString
{
	return (CStringInterface::IntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::UIntToString(UInt32 v) -> CString
{
	return (CStringInterface::UIntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IntToString(Int64 v) -> CString
{
	return (CStringInterface::IntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::UIntToString(UInt64 v) -> CString
{
	return (CStringInterface::UIntToString(v));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::MemorySizeToString(Int64 v, Bool mebibytes) -> CString
{
	return (CStringInterface::MemorySizeToString(v, mebibytes));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::HexToString(UInt32 v, Bool prefix0x) -> CString
{
	return (CStringInterface::HexToString(v, prefix0x));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::HexToString(UInt64 v, Bool prefix0x) -> CString
{
	return (CStringInterface::HexToString(v, prefix0x));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::PointerToString(const void* v) -> CString
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetAndCacheConstString(const Char* chr, Int len) -> const CString&
{
	return (MTable::_instance._CStringInterface_GetAndCacheConstString(chr, len));
}
#if defined(MAXON_DEPENDENCY_ENABLE) && !defined(PRIVATE_MAXON_REGISTRATION_UNIT)
