...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_LexerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LexerInterface::MTable::_instance._LexerInterface_Init)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "fileName\0flags\0stringEscapeCharacters\0stringDecoding\0firstParseFlag\0", 341LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LexerInterface::MTable::_instance._LexerInterface_SetStringQuoteCharacters)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "quoteChar\0", 1LL, nullptr),
		};
