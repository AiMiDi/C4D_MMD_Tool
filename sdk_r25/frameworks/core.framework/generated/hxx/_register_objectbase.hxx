...
/// @endcond
	...
	namespace enum758
	{
		...
		static const maxon::UInt64 KIND_values[] = {maxon::UInt64(enum758::KIND::NORMAL), maxon::UInt64(enum758::KIND::SINGLETON), maxon::UInt64(enum758::KIND::ABSTRACT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_KIND758(void*){ return enum758::KIND_info; }
