...
struct DataTypeLib::MTable
{
	...
	const DataType& (*_DataTypeLib_GetInvalidType) ();
	...
	Result<Tuple<DataType, const Char*>> (*_DataTypeLib_ParseDataType) (const Char* str);
	Result<Tuple<Member, const Char*>> (*_DataTypeLib_ParseMember) (const Char* str);
	Result<Tuple<Int64, const Char*>> (*_DataTypeLib_ParseInt) (const Char* str);
	...
	Result<const MemberMap*> (*_DataTypeLib_GetMemberMap_1) (const DataTypeImpl* containerType, const DataTypeImpl* runtimeType);
	...
	Bool (*_DataTypeLib_PrivateIsBaseOfOrSame) (const DataTypeImpl* type, const DataTypeImpl* other, DataType::BASE_OF_MODE mode);
	...
	template <typename IMPL> void Init()
	{
		...
		_DataTypeLib_GetInvalidType = &IMPL::_DataTypeLib_GetInvalidType;
		...
		_DataTypeLib_ParseMember = &IMPL::_DataTypeLib_ParseMember;
		_DataTypeLib_ParseInt = &IMPL::_DataTypeLib_ParseInt;
		...
		_DataTypeLib_GetMemberMap_1 = &IMPL::_DataTypeLib_GetMemberMap_1;
...
struct DataTypeLib::Hxx2
{
	...
	public:
		...
		static const DataType& _DataTypeLib_GetInvalidType() { return C::GetInvalidType(); }
		...
		static Result<Tuple<DataType, const Char*>> _DataTypeLib_ParseDataType(const Char* str) { return C::ParseDataType(str); }
		static Result<Tuple<Member, const Char*>> _DataTypeLib_ParseMember(const Char* str) { return C::ParseMember(str); }
		static Result<Tuple<Int64, const Char*>> _DataTypeLib_ParseInt(const Char* str) { return C::ParseInt(str); }
		...
		static Result<const MemberMap*> _DataTypeLib_GetMemberMap_1(const DataTypeImpl* containerType, const DataTypeImpl* runtimeType) { return C::GetMemberMap(containerType, runtimeType); }
		...
		static Bool _DataTypeLib_PrivateIsBaseOfOrSame(const DataTypeImpl* type, const DataTypeImpl* other, DataType::BASE_OF_MODE mode) { return C::PrivateIsBaseOfOrSame(type, other, mode); }
...
{
	return MTable::_instance._DataTypeLib_GetInvalidType();
}
...
{
	return MTable::_instance._DataTypeLib_GetMemberMap_1(containerType, runtimeType);
}
