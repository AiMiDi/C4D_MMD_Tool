...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ObservableLoggerNew() -> maxon::ObservableRef<ObservableLoggerNewDelegate>
{
	return (MTable::_instance._LoggerInterface_ObservableLoggerNew());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::AddNewLogger(const Id& id, const LoggerRef& logger, const maxon::ModuleInfo* module) -> Result<void>
{
	return (MTable::_instance._LoggerInterface_AddNewLogger(id, logger, module));
}
#if defined(MAXON_DEPENDENCY_ENABLE) && !defined(PRIVATE_MAXON_REGISTRATION_UNIT)
