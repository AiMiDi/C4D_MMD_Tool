...
namespace maxon
{
	...
	maxon::Bool ArrayFactory::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ArrayInterface<Generic>*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ArrayFactory_NewBaseArrayFromContainerType = &Hxx2::Wrapper<Hxx2::Unresolved>::_ArrayFactory_NewBaseArrayFromContainerType;
		#else
		tbl->_ArrayFactory_NewBaseArrayFromContainerType = &Hxx2::Wrapper<Hxx2::Unresolved>::_ArrayFactory_NewBaseArrayFromContainerType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
