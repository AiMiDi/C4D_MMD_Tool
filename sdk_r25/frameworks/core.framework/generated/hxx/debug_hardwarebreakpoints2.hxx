...
struct DebugHardwareBreakPointInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint(DebugHardwareBreakPointInterface* this_) { return C::Get(this_)->RemoveHardwareBreakpoint(); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DebugHardwareBreakPointInterface::Hxx1::ConstReferenceFunctionsImpl<S>::SetHardwareBreakpoint(HARDWAREBREAKPOINTTYPE type, HARDWAREBREAKPOINTSIZE size, void* watchAddress) -> Result<DebugHardwareBreakPointRef>
{
	return (MTable::_instance._DebugHardwareBreakPointInterface_SetHardwareBreakpoint(type, size, watchAddress));
}
