...
struct MachineInterface::MTable
{
	...
	maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> (*_MachineInterface_ObservablePrivateSplashMessageReceived) (const maxon::GenericComponent* this_);
	maxon::Int _MachineInterface_ObservablePrivateSplashMessageReceived_Offset;
	maxon::ObservableRef<ObservableActivationChangedDelegate> (*_MachineInterface_ObservableActivationChanged) (const maxon::GenericComponent* this_);
	maxon::Int _MachineInterface_ObservableActivationChanged_Offset;
	...
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MachineInterface, ObservablePrivateSplashMessageReceived))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MachineInterface, ObservablePrivateSplashMessageReceived), W, MTable>::type::_MachineInterface_ObservablePrivateSplashMessageReceived;
		_MachineInterface_ObservablePrivateSplashMessageReceived = reinterpret_cast<const decltype(_MachineInterface_ObservablePrivateSplashMessageReceived)&>(ptr);
		_MachineInterface_ObservablePrivateSplashMessageReceived_Offset = offset;
	}
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MachineInterface, ObservableActivationChanged))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MachineInterface, ObservableActivationChanged), W, MTable>::type::_MachineInterface_ObservableActivationChanged;
		_MachineInterface_ObservableActivationChanged = reinterpret_cast<const decltype(_MachineInterface_ObservableActivationChanged)&>(ptr);
		_MachineInterface_ObservableActivationChanged_Offset = offset;
	}
	}
...
struct MachineInterface::Hxx2
{
	...
	public:
		...
		static maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> _MachineInterface_ObservablePrivateSplashMessageReceived(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->ObservablePrivateSplashMessageReceived(); }
		static maxon::ObservableRef<ObservableActivationChangedDelegate> _MachineInterface_ObservableActivationChanged(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->ObservableActivationChanged(); }
	};
...
{
	const MachineInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(MachineInterface, this); return mt_._MachineInterface_ObservablePrivateSplashMessageReceived((const maxon::GenericComponent*) this + mt_._MachineInterface_ObservablePrivateSplashMessageReceived_Offset);
}
...
{
	const MachineInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(MachineInterface, this); return mt_._MachineInterface_ObservableActivationChanged((const maxon::GenericComponent*) this + mt_._MachineInterface_ObservableActivationChanged_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ObservablePrivateSplashMessageReceived() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>>, maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>>::type
{
	...
	return (mt_._MachineInterface_ObservablePrivateSplashMessageReceived(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._MachineInterface_ObservablePrivateSplashMessageReceived_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ObservableActivationChanged() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableActivationChangedDelegate>>, maxon::ObservableRef<ObservableActivationChangedDelegate>>::type
{
	...
	return (mt_._MachineInterface_ObservableActivationChanged(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._MachineInterface_ObservableActivationChanged_Offset));
}
