...
struct LexerInterface::MTable
{
	...
	Result<void> (*_LexerInterface_Init) (LexerInterface* this_, UrlOrInputStream&& fileName, LEXERINITFLAGS flags, const String& stringEscapeCharacters, const StringDecodingRef& stringDecoding, LEXERSYMBOLFLAGS firstParseFlag);
	...
	void (*_LexerInterface_SetStringQuoteCharacters) (LexerInterface* this_, const String& quoteChar);
	template <typename IMPL> void Init()
	{
		...
		_LexerInterface_SetStringQuoteCharacters = &IMPL::_LexerInterface_SetStringQuoteCharacters;
	}
};
...
struct LexerInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _LexerInterface_Init(LexerInterface* this_, UrlOrInputStream&& fileName, LEXERINITFLAGS flags, const String& stringEscapeCharacters, const StringDecodingRef& stringDecoding, LEXERSYMBOLFLAGS firstParseFlag) { return C::Get(this_)->Init(std::forward<UrlOrInputStream>(fileName), flags, stringEscapeCharacters, stringDecoding, firstParseFlag); }
		static Result<void> _LexerInterface_AddOperator(LexerInterface* this_, const String& chars) { return C::Get(this_)->AddOperator(chars); }
		static Result<void> _LexerInterface_Close(LexerInterface* this_) { return C::Get(this_)->Close(); }
		static Result<Utf32Char> _LexerInterface_ReadNextChar(LexerInterface* this_) { return C::Get(this_)->ReadNextChar(); }
		static Result<Bool> _LexerInterface_SkipSpaces(LexerInterface* this_) { return C::Get(this_)->SkipSpaces(); }
		static Result<Bool> _LexerInterface_SkipLineToEnd(LexerInterface* this_, Bool collectSkipped) { return C::Get(this_)->SkipLineToEnd(collectSkipped); }
		static Result<LEXERSYMBOL> _LexerInterface_ReadNextSymbol(LexerInterface* this_, LEXERSYMBOLFLAGS flags) { return C::Get(this_)->ReadNextSymbol(flags); }
		static Result<void> _LexerInterface_ReadNextSymbolExpected(LexerInterface* this_, LEXERSYMBOL expectedSymbols, LEXERSYMBOLFLAGS flags) { return C::Get(this_)->ReadNextSymbolExpected(expectedSymbols, flags); }
		static void _LexerInterface_RewindSymbol(LexerInterface* this_) { return C::Get(this_)->RewindSymbol(); }
		static LEXERSYMBOL _LexerInterface_GetSymbol(const LexerInterface* this_) { return C::Get(this_)->GetSymbol(); }
		static Int _LexerInterface_GetLeadingSpace(const LexerInterface* this_) { return C::Get(this_)->GetLeadingSpace(); }
		static String _LexerInterface_GetIdent(const LexerInterface* this_) { return C::Get(this_)->GetIdent(); }
		static Result<void> _LexerInterface_GetFloat(const LexerInterface* this_, Float32& val) { return C::Get(this_)->GetFloat(val); }
		static Result<void> _LexerInterface_GetFloat_1(const LexerInterface* this_, Float64& val) { return C::Get(this_)->GetFloat(val); }
		static Result<void> _LexerInterface_GetInt(const LexerInterface* this_, Int32& val) { return C::Get(this_)->GetInt(val); }
		static Result<void> _LexerInterface_GetInt_1(const LexerInterface* this_, Int64& val) { return C::Get(this_)->GetInt(val); }
		static Result<void> _LexerInterface_GetUInt(const LexerInterface* this_, UInt32& val) { return C::Get(this_)->GetUInt(val); }
		static Result<void> _LexerInterface_GetUInt_1(const LexerInterface* this_, UInt64& val) { return C::Get(this_)->GetUInt(val); }
		static Result<Int64> _LexerInterface_GetCurrentReadPosition(const LexerInterface* this_) { return C::Get(this_)->GetCurrentReadPosition(); }
		static Result<Int64> _LexerInterface_GetSymbolPosition(const LexerInterface* this_) { return C::Get(this_)->GetSymbolPosition(); }
		static Bool _LexerInterface_CheckIdent(const LexerInterface* this_, const Char* cmp) { return C::Get(this_)->CheckIdent(cmp); }
		static Bool _LexerInterface_CheckIdent_1(const LexerInterface* this_, const String& cmp) { return C::Get(this_)->CheckIdent(cmp); }
		static Int _LexerInterface_GetLine(const LexerInterface* this_) { return C::Get(this_)->GetLine(); }
		static void _LexerInterface_SetStringQuoteCharacters(LexerInterface* this_, const String& quoteChar) { return C::Get(this_)->SetStringQuoteCharacters(quoteChar); }
	};
...
{
	return MTable::_instance._LexerInterface_Init(this, std::forward<UrlOrInputStream>(fileName), flags, stringEscapeCharacters, stringDecoding, firstParseFlag);
}
...
{
	return MTable::_instance._LexerInterface_SetStringQuoteCharacters(this, quoteChar);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LexerInterface::Hxx1::ReferenceFunctionsImpl<S>::Init(UrlOrInputStream&& fileName, LEXERINITFLAGS flags, const String& stringEscapeCharacters, const StringDecodingRef& stringDecoding, LEXERSYMBOLFLAGS firstParseFlag) const -> Result<void>
{
	...
	return (MTable::_instance._LexerInterface_Init(o_, std::forward<UrlOrInputStream>(fileName), flags, stringEscapeCharacters, stringDecoding, firstParseFlag));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LexerInterface::Hxx1::ReferenceFunctionsImpl<S>::SetStringQuoteCharacters(const String& quoteChar) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LexerInterface* o_ = (LexerInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
	MTable::_instance._LexerInterface_SetStringQuoteCharacters(o_, quoteChar);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
