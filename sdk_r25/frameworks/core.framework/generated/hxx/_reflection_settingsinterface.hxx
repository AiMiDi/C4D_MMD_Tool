...
namespace maxon
{
	...
	public:
		...
		ACCESSLEVEL GetAccessLevel() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._SettingsInterface_GetAccessLevel_Offset)};
			(*handler_)(_fn_SettingsInterface_GetAccessLevel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ACCESSLEVEL, const maxon::GenericComponent*>::Invoke, (const void*) mt_._SettingsInterface_GetAccessLevel));
			return proxy_result;
		}
		...
		SettingsRef GetParentSettings() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._SettingsInterface_GetParentSettings_Offset)};
			(*handler_)(_fn_SettingsInterface_GetParentSettings, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<SettingsRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._SettingsInterface_GetParentSettings));
			return proxy_result;
		}
		...
		Result<DataDictionary> GetSettingsCopy(const HashSet<Id>& optionalList, ACCESSLEVEL accessLevel) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._SettingsInterface_GetSettingsCopy_Offset), maxon::reflection::Argument::ByReference(optionalList), maxon::reflection::Argument::ByValue(accessLevel)};
			(*handler_)(_fn_SettingsInterface_GetSettingsCopy, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataDictionary>, const maxon::GenericComponent*, const HashSet<Id>&, ACCESSLEVEL>::Invoke, (const void*) mt_._SettingsInterface_GetSettingsCopy));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_SettingsInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(SettingsInterface::Hxx2::StaticMTable::_instance._SettingsInterface_GetSettings)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "accessLevel\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(SettingsInterface::Hxx2::StaticMTable::_instance._SettingsInterface_ObservableSettingsChanged)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_SettingsInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, SettingsInterface, _SettingsInterface_GetAccessLevel),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, SettingsInterface, _SettingsInterface_GetParentSettings),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "optionalList\0accessLevel\0", 0LL, SettingsInterface, _SettingsInterface_GetSettingsCopy),
		};
