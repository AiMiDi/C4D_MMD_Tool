...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataTypeLib(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeLib::MTable::_instance._DataTypeLib_GetInvalidType)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeLib::MTable::_instance._DataTypeLib_ParseDataType)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "str\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeLib::MTable::_instance._DataTypeLib_ParseMember)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "str\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeLib::MTable::_instance._DataTypeLib_ParseInt)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "str\0", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeLib::MTable::_instance._DataTypeLib_GetMemberMap_1)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "containerType\0runtimeType\0", 0LL, nullptr),
