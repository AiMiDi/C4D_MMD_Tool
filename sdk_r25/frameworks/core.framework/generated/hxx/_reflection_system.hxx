...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_System(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(System::MTable::_instance._System_PrivateInitExternalDependency)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "initSystemTable\0externalDependency\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(System::MTable::_instance._System_PrivateResetExternalDependency)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "safeShutdownMethods\0externalDependency\0", 0LL, nullptr),
