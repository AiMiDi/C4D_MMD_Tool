...
struct StringEncodingInterface::Hxx1
{
	...
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename StreamConversionInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename StreamConversionInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
