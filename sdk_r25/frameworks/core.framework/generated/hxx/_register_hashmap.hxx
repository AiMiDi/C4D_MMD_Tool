...
namespace maxon
{
	...
	namespace enum1003
	{
		...
		static const maxon::UInt64 HASHMAP_MODE_values[] = {maxon::UInt64(enum1003::HASHMAP_MODE::DEFAULT), maxon::UInt64(enum1003::HASHMAP_MODE::SYNCHRONIZED), maxon::UInt64(enum1003::HASHMAP_MODE::NO_NONEMPTY_BUCKET_TABLE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_HASHMAP_MODE1003(){ return enum1003::HASHMAP_MODE_info; }
}
#endif
