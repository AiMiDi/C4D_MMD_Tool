...
#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableApplicationMessageDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_Application_ObservableApplicationMessage = &Hxx2::Wrapper<Hxx2::Unresolved>::_Application_ObservableApplicationMessage;
		#else
		tbl->_Application_ObservableApplicationMessage = &Hxx2::Wrapper<Hxx2::Unresolved>::_Application_ObservableApplicationMessage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
