...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_Resource(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Resource::MTable::_instance._Resource_WriteLanguagePrf)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "language\0", 1LL, nullptr),
