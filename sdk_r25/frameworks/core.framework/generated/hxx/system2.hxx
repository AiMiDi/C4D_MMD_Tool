...
struct System::MTable
{
	...
	Bool (*_System_PrivateInitExternalDependency) (InitMTable initSystemTable, Binary* externalDependency);
	Bool (*_System_PrivateResetExternalDependency) (const Block<Tuple<Id, const char*, void*>>& safeShutdownMethods, Binary* externalDependency);
	...
	template <typename IMPL> void Init()
	{
		...
		_System_PrivateInitExternalDependency = &IMPL::_System_PrivateInitExternalDependency;
		_System_PrivateResetExternalDependency = &IMPL::_System_PrivateResetExternalDependency;
...
struct System::Hxx2
{
	...
	public:
		...
		static Bool _System_PrivateInitExternalDependency(InitMTable initSystemTable, Binary* externalDependency) { return C::PrivateInitExternalDependency(std::forward<InitMTable>(initSystemTable), externalDependency); }
		static Bool _System_PrivateResetExternalDependency(const Block<Tuple<Id, const char*, void*>>& safeShutdownMethods, Binary* externalDependency) { return C::PrivateResetExternalDependency(safeShutdownMethods, externalDependency); }
...
{
	return MTable::_instance._System_PrivateInitExternalDependency(std::forward<InitMTable>(initSystemTable), externalDependency);
}
...
{
	return MTable::_instance._System_PrivateResetExternalDependency(safeShutdownMethods, externalDependency);
}
