...
struct LanguageInterface::Hxx2
{
	...
	public:
		...
		static String _LanguageInterface_LoadResourceString(LanguageInterface* this_, const Id& scope, const InternedId& keyValue) { return C::Get(this_)->LoadResourceString(scope, keyValue); }
		static String _LanguageInterface_GetName(const LanguageInterface* this_) { return C::Get(this_)->GetName(); }
		static Id _LanguageInterface_GetIdentifier(const LanguageInterface* this_) { return C::Get(this_)->GetIdentifier(); }
		static LanguageRef _LanguageInterface_GetFallbackLanguage(const LanguageInterface* this_) { return C::Get(this_)->GetFallbackLanguage(); }
		static String _LanguageInterface_ToString(const LanguageInterface* this_, const maxon::FormatStatement* fs) { return C::Get(this_)->ToString(fs); }
	};
...
struct Resource::MTable
{
	...
	Result<void> (*_Resource_WriteLanguagePrf) (const LanguageRef& language);
	...
	template <typename IMPL> void Init()
	{
		...
		_Resource_WriteLanguagePrf = &IMPL::_Resource_WriteLanguagePrf;
...
struct Resource::Hxx2
{
	...
	public:
		...
		static Result<void> _Resource_WriteLanguagePrf(const LanguageRef& language) { return C::WriteLanguagePrf(language); }
...
{
	return MTable::_instance._Resource_WriteLanguagePrf(language);
}
