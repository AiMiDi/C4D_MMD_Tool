...
struct RunLoop::MTable
{
	...
	Result<void> (*_RunLoop_EnterLoop) (Bool isInternalLoop);
	Result<void> (*_RunLoop_EnterLoop_1) (Bool isInternalLoop, void* osSpecific);
	...
	template <typename IMPL> void Init()
	{
		...
		_RunLoop_EnterLoop_1 = &IMPL::_RunLoop_EnterLoop_1;
...
struct RunLoop::Hxx2
{
	...
	{
	public:
		static Result<void> _RunLoop_EnterLoop(Bool isInternalLoop) { return C::EnterLoop(isInternalLoop); }
		static Result<void> _RunLoop_EnterLoop_1(Bool isInternalLoop, void* osSpecific) { return C::EnterLoop(isInternalLoop, osSpecific); }
...
{
	return MTable::_instance._RunLoop_EnterLoop(isInternalLoop);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::EnterLoop(Bool isInternalLoop, void* osSpecific) -> Result<void>
{
	return MTable::_instance._RunLoop_EnterLoop_1(isInternalLoop, osSpecific);
}
