...
namespace maxon
{
	...
	namespace enum1024
	{
		...
		static const maxon::UInt64 BASE_OF_MODE_values[] = {maxon::UInt64(enum1024::BASE_OF_MODE::NONE), maxon::UInt64(enum1024::BASE_OF_MODE::ORDERED_TYPE_ONLY), maxon::UInt64(enum1024::BASE_OF_MODE::UNORDERED_BY_NAME), maxon::UInt64(enum1024::BASE_OF_MODE::GENERIC_DOWNCAST)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_BASE_OF_MODE1024(void*){ return enum1024::BASE_OF_MODE_info; }
	...
	namespace enum1123
	{
		...
		static const maxon::UInt64 GET_DATATYPE_POLICY_values[] = {maxon::UInt64(enum1123::GET_DATATYPE_POLICY::NONE), maxon::UInt64(enum1123::GET_DATATYPE_POLICY::GENERIC_FOR_UNKNOWN), maxon::UInt64(enum1123::GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN), maxon::UInt64(enum1123::GET_DATATYPE_POLICY::RESULT_FOR_UNKNOWN_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GET_DATATYPE_POLICY1123(){ return enum1123::GET_DATATYPE_POLICY_info; }
}
#endif
