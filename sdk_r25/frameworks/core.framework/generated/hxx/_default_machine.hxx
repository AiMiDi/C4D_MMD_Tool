...
public:
	...
	{
		return maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>::NullValue();
	}

	MAXON_METHOD maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged() const
	{
		return maxon::ObservableRef<ObservableActivationChangedDelegate>::NullValue();
	}
