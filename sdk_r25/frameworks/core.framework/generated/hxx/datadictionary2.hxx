...
struct DataDictionaryInterface::MTable
{
	...
	Result<void> (*_DataDictionaryInterface_SetData_2) (DataDictionaryInterface* this_, ForwardingDataPtr&& key, ForwardingDataPtr&& data);
	...
	HashInt (*_DataDictionaryInterface_GetHashCode) (const DataDictionaryInterface* this_);
	...
	template <typename IMPL> void Init()
	{
		...
		_DataDictionaryInterface_SetData_2 = &IMPL::_DataDictionaryInterface_SetData_2;
...
struct DataDictionaryInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _DataDictionaryInterface_SetData(DataDictionaryInterface* this_, ForwardingDataPtr&& key, const Data& data) { return C::Get(this_)->SetData(std::forward<ForwardingDataPtr>(key), data); }
		static Result<void> _DataDictionaryInterface_SetData_1(DataDictionaryInterface* this_, ForwardingDataPtr&& key, Data&& data) { return C::Get(this_)->SetData(std::forward<ForwardingDataPtr>(key), std::forward<Data>(data)); }
		static Result<void> _DataDictionaryInterface_SetData_2(DataDictionaryInterface* this_, ForwardingDataPtr&& key, ForwardingDataPtr&& data) { return C::Get(this_)->SetData(std::forward<ForwardingDataPtr>(key), std::forward<ForwardingDataPtr>(data)); }
		static Result<Data> _DataDictionaryInterface_GetData(const DataDictionaryInterface* this_, const ConstDataPtr& key) { return C::Get(this_)->GetData(key); }
		static Result<void> _DataDictionaryInterface_EraseData(DataDictionaryInterface* this_, const ConstDataPtr& key) { return C::Get(this_)->EraseData(key); }
		static void _DataDictionaryInterface_Reset(DataDictionaryInterface* this_) { return C::Get(this_)->Reset(); }
		static Bool _DataDictionaryInterface_IsEmpty(const DataDictionaryInterface* this_) { return C::Get(this_)->IsEmpty(); }
		static String _DataDictionaryInterface_ToString(const DataDictionaryInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
		static Result<void> _DataDictionaryInterface_DescribeIO(const DataSerializeInterface& stream) { return C::DescribeIO(stream); }
		static Bool _DataDictionaryInterface_IsEqual(const DataDictionaryInterface* this_, const DataDictionaryInterface* other, EQUALITY equality) { return C::Get(this_)->IsEqual(other, equality); }
		static HashInt _DataDictionaryInterface_GetHashCode(const DataDictionaryInterface* this_) { return C::Get(this_)->GetHashCode(); }
		static void _DataDictionaryInterface_InitIterator(const DataDictionaryInterface* this_, DataDictionaryIteratorInterface* iterator, Bool end) { return C::Get(this_)->InitIterator(iterator, end); }
		static const Data* _DataDictionaryInterface_PrivateGetData(const DataDictionaryInterface* this_, const ConstDataPtr& key) { return C::Get(this_)->PrivateGetData(key); }
	};
...
{
	return MTable::_instance._DataDictionaryInterface_SetData_2(this, std::forward<ForwardingDataPtr>(key), std::forward<ForwardingDataPtr>(data));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ReferenceFunctionsImpl<S>::SetData(ForwardingDataPtr&& key, ForwardingDataPtr&& data) const -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), true, maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryInterface* o_ = (DataDictionaryInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR)); } 
	auto res_ = MTable::_instance._DataDictionaryInterface_SetData_2(o_, std::forward<ForwardingDataPtr>(key), std::forward<ForwardingDataPtr>(data));
	return ReturnHelper::Return(this, res_.GetErrorStorage());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::COWReferenceFunctionsImpl<S>::SetData(ForwardingDataPtr&& key, ForwardingDataPtr&& data) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), true, maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryInterface* o_ = (DataDictionaryInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	auto res_ = MTable::_instance._DataDictionaryInterface_SetData_2(o_, std::forward<ForwardingDataPtr>(key), std::forward<ForwardingDataPtr>(data));
	return ReturnHelper::Return(this, res_.GetErrorStorage());
...
template <typename S> template <typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Contains(KEY&& key) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._DataDictionaryInterface_DescribeIO(stream));
}
...
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Get(KEY&& key) const -> Result<typename std::conditional<std::is_void<T>::value, typename IsFidClass<KEY>::type, T>::type>
{
...
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Get(KEY&& key, const T& defaultValue) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>::type
{
...
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Get(KEY&& key, T&& defaultValue) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryInterface* o_ = (const DataDictionaryInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<typename std::conditional<IsFidClass<KEY>::value&&GetCollectionKind<T>::value!=COLLECTION_KIND::ARRAY, typename IsFidClass<KEY>::type, T>::type>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->Get<T, KEY>(std::forward<KEY>(key), std::forward<T>(defaultValue)));
}
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetOrDefault(KEY&& key) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<std::is_void<T>::value, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<std::is_void<T>::value, typename IsFidClass<KEY>::type, T>::type>::type
{
