...
struct ConditionVariableInterface::Hxx2
{
	...
	public:
		...
		static void _ConditionVariableInterface_Clear(ConditionVariableInterface* this_, Int32 dependencyCnt) { return C::Get(this_)->Clear(dependencyCnt); }
		static void _ConditionVariableInterface_AddDependency(ConditionVariableInterface* this_) { return C::Get(this_)->AddDependency(); }
		static Bool _ConditionVariableInterface_Set(ConditionVariableInterface* this_) { return C::Get(this_)->Set(); }
		static Bool _ConditionVariableInterface_Wait(const ConditionVariableInterface* this_, const TimeValue& timeout, WAITMODE mode) { return C::Get(this_)->Wait(timeout, mode); }
		static Result<void> _ConditionVariableInterface_PrivateAddFinishedObserver(ConditionVariableInterface* this_, const JobInterfacePOD& observerPod, JobQueueInterface* observerQueue) { return C::Get(this_)->PrivateAddFinishedObserver(observerPod, observerQueue); }
	};
