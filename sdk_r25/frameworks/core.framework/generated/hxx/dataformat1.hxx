...
struct DataFormatReaderInterface::Hxx1
{
	...
	COWReferenceFunctionsImpl<typename DataSerializeReaderInterface::Hxx1::template ReferenceFunctionsHelper<typename DataFormatBaseReaderInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename DataSerializeReaderInterface::Hxx1::template ReferenceFunctionsHelper<typename DataFormatBaseReaderInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type, ReferenceFunctionsImpl<typename DataSerializeReaderInterface::Hxx1::template ReferenceFunctionsHelper<typename DataFormatBaseReaderInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>>::type
	> { };
};
...
struct DataFormatWriterInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename DataSerializeWriterInterface::Hxx1::template ReferenceFunctionsHelper<typename DataFormatBaseWriterInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>,
