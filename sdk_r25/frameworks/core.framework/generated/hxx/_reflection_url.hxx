...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_UrlInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UrlInterface::MTable::_instance._UrlInterface_EraseData)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "key\0persistent\0", 5LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UrlInterface::MTable::_instance._UrlInterface_ConvertToUiName)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "flags\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UrlInterface::MTable::_instance._UrlInterface_ConvertFromUiName)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "str\0", 1LL, nullptr),
