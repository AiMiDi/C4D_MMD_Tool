...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SettingsInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetSettings(ACCESSLEVEL accessLevel) -> SettingsRef
{
	return (Hxx2::StaticMTable::_instance._SettingsInterface_GetSettings(accessLevel));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SettingsInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ObservableSettingsChanged() -> maxon::ObservableRef<ObservableSettingsChangedDelegate>
{
	return (Hxx2::StaticMTable::_instance._SettingsInterface_ObservableSettingsChanged());
}
