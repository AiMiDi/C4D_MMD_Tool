...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_RunLoop(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_EnterLoop)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "isInternalLoop\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_EnterLoop_1)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "isInternalLoop\0osSpecific\0", 5LL, nullptr),
