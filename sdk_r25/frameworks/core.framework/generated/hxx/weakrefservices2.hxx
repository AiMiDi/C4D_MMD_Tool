...
struct WeakRefServices::MTable
{
	...
	Bool (*_WeakRefServices_EraseObserver) (const void* target, MemoryObserverCallback callback, void* callbackData);
	...
	template <typename IMPL> void Init()
	{
		...
		_WeakRefServices_EraseObserver = &IMPL::_WeakRefServices_EraseObserver;
...
struct WeakRefServices::Hxx2
{
	...
	public:
		...
		static Bool _WeakRefServices_EraseObserver(const void* target, MemoryObserverCallback callback, void* callbackData) { return C::EraseObserver(target, std::forward<MemoryObserverCallback>(callback), callbackData); }
...
{
	return MTable::_instance._WeakRefServices_EraseObserver(target, std::forward<MemoryObserverCallback>(callback), callbackData);
}
