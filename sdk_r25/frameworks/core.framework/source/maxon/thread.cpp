...
{
	return "JobInterface "_s + String::PointerToString((void*) this) + " (CoreJobState: "_s + String::PointerToString((void*)this->_jobState) + ")"_s;
}
...
{
	return "ThreadInterface "_s + String::PointerToString((void*) this) + " (CoreJobState: "_s + String::PointerToString((void*)this->_jobState) + ")"_s;
}
