...
void ObjectInterface::PrivateDestructInstance(ObjectInterface* o)
{
...
void ObjectInterface::PrivateFreeInstance(ObjectInterface* o)
{
	System::FreeWithDestructor(o, &PrivateDestructInstance);
}
