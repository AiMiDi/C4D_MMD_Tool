...
public:
	...
	{
		return GetHashCodeImpl<DefaultCompare>((IndexSequence*) nullptr);
	}
...
private:
	...
	{
		return DefaultHash::CombineHashes(HASH::GetHashCode(Get<I>())...);
	}
...
public:
	...
	/// @return												Always 0.
	//----------------------------------------------------------------------------------------
	HashInt GetHashCode() const { return DefaultHash::EMPTY_HASH; }

	template <typename HASH> HashInt GetHashCode() const { return DefaultHash::EMPTY_HASH; }
