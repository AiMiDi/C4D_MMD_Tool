...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Delaunay3DInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OrientDet(const Vector& planePointA, const Vector& planePointB, const Vector& planePointC, const Vector& testPoint) -> Float
{
	return (MTable::_instance._Delaunay3DInterface_OrientDet(planePointA, planePointB, planePointC, testPoint));
}
