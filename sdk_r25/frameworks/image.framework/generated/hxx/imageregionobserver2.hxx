...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageRegionObservableHandlerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Create(const IntVector2d& dimensions) -> Result<ImageRegionObservableHandlerRef>
{
	return (MTable::_instance._ImageRegionObservableHandlerInterface_Create(dimensions));
}
