...
namespace maxon
{
	...
	public:
		...
		Result<ImageBaseRef> GetImageRef(UpdateCacheDelegate&& updateDelegate) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ImageUrlCacheInterface_GetImageRef_Offset), maxon::reflection::Argument::ByReference(updateDelegate)};
			(*handler_)(_fn_ImageUrlCacheInterface_GetImageRef, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<ImageBaseRef>, const maxon::GenericComponent*, UpdateCacheDelegate&&>::Invoke, (const void*) mt_._ImageUrlCacheInterface_GetImageRef));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableFreeCacheDelegate> ObservableFreeCache() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ImageUrlCacheInterface_ObservableFreeCache_Offset)};
			(*handler_)(_fn_ImageUrlCacheInterface_ObservableFreeCache, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableFreeCacheDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ImageUrlCacheInterface_ObservableFreeCache));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ImageUrlCacheInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageUrlCacheInterface::Hxx2::StaticMTable::_instance._ImageUrlCacheInterface_InvalidateCache)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "url\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageUrlCacheInterface::Hxx2::StaticMTable::_instance._ImageUrlCacheInterface_FindOrCreate)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "url\0", 0LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_ImageUrlCacheInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "updateDelegate\0", 0LL, ImageUrlCacheInterface, _ImageUrlCacheInterface_GetImageRef),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ImageUrlCacheInterface, _ImageUrlCacheInterface_ObservableFreeCache),
		};
