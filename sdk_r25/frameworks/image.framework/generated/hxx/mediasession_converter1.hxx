...
/// @return												OK on success.
	...
	COWReferenceFunctionsImpl<typename MediaBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename MediaBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename MediaBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
