...
/// @return												OK on success.
	...
	COWReferenceFunctionsImpl<typename HierarchyObjectInterface::Hxx1::template ReferenceFunctionsHelper<typename MediaBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>, DefaultHierarchy<MediaStreamRef>>::type>,
...
/// @return												OK on success.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename MediaStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename MediaStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename MediaStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
/// @return												OK on success.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename MediaStreamImageBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename MediaStreamImageBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename MediaStreamImageBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
/// @param[in] sourceStream				Stream that should be forwarded.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename MediaStreamImageDataImportInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename MediaStreamImageDataImportInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename MediaStreamImageDataImportInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
