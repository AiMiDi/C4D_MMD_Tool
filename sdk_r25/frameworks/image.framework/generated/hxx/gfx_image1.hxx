...
/// @return												OK on success.
	...
	COWReferenceFunctionsImpl<typename HierarchyObjectInterface::Hxx1::template ReferenceFunctionsHelper<typename DataDictionaryObjectInterface::Hxx1::template ReferenceFunctionsHelper<ST>, ImageHierarchy>::type>,
...
/// @return												OK on success.
	...
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename ImageBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename ImageBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename ImageBaseInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
struct ImageLayerInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename ImageInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename ImageInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename ImageInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
