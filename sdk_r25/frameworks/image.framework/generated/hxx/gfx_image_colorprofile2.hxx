...
struct ColorProfileInterface::MTable
{
	...
	HashInt (*_ColorProfileInterface_GetHashCode) (const ColorProfileInterface* this_);
...
struct ColorProfileInterface::Hxx2
{
	...
	public:
		...
		static Bool _ColorProfileInterface_IsEqual(const ColorProfileInterface* this_, const ColorProfileInterface* other) { return C::Get(this_)->IsEqual(other); }
		...
		static Result<void> _ColorProfileInterface_WriteProfileToMemory(const ColorProfileInterface* this_, WritableArrayInterface<Char>& mem) { return C::Get(this_)->WriteProfileToMemory(mem); }
		static Result<void> _ColorProfileInterface_WriteProfileToFile(const ColorProfileInterface* this_, const Url& fn) { return C::Get(this_)->WriteProfileToFile(fn); }
		static String _ColorProfileInterface_GetInfo(const ColorProfileInterface* this_, COLORPROFILEINFO info) { return C::Get(this_)->GetInfo(info); }
		static UInt32 _ColorProfileInterface_GetCrc(const ColorProfileInterface* this_) { return C::Get(this_)->GetCrc(); }
		static Bool _ColorProfileInterface_HasProfile(const ColorProfileInterface* this_) { return C::Get(this_)->HasProfile(); }
		static Bool _ColorProfileInterface_CheckCompatiblePixelFormat(const ColorProfileInterface* this_, const PixelFormat& pixelFormat) { return C::Get(this_)->CheckCompatiblePixelFormat(pixelFormat); }
		static Bool _ColorProfileInterface_IsMonitorProfileMode(const ColorProfileInterface* this_) { return C::Get(this_)->IsMonitorProfileMode(); }
		static HashInt _ColorProfileInterface_GetHashCode(const ColorProfileInterface* this_) { return C::Get(this_)->GetHashCode(); }
		static ColorSpace _ColorProfileInterface_GetColorSpace(const ColorProfileInterface* this_) { return C::Get(this_)->GetColorSpace(); }
		static String _ColorProfileInterface_ToString(const ColorProfileInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
/// @cond INTERNAL

		static Bool _ColorProfileInterface_SetMonitorProfileMode(ColorProfileInterface* this_, Bool on) { return C::Get(this_)->SetMonitorProfileMode(on); }
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OpenProfileFromFile(const Url& fn) -> Result<ColorProfile>
{
	return (MTable::_instance._ColorProfileInterface_OpenProfileFromFile(fn));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstReferenceFunctionsImpl<S>::OpenProfileFromMemory(const Block<const Byte>& mem) -> Result<ColorProfile>
{
	return (MTable::_instance._ColorProfileInterface_OpenProfileFromMemory(mem));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._ColorProfileInterface_DescribeIO(stream));
}
/// @endcond
...
struct ColorProfileConvertInterface::MTable
{
	...
	HashInt (*_ColorProfileConvertInterface_GetHashCode) (const ColorProfileConvertInterface* this_);
...
struct ColorProfileConvertInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _ColorProfileConvertInterface_Convert(const ColorProfileConvertInterface* this_, const ImageConstBuffer& src, const ImageMutableBuffer& dst, Int cnt) { return C::Get(this_)->Convert(src, dst, cnt); }
		static HashInt _ColorProfileConvertInterface_GetHashCode(const ColorProfileConvertInterface* this_) { return C::Get(this_)->GetHashCode(); }
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileConvertInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetNearestNativeFormat(const PixelFormat& format) -> Result<PixelFormat>
{
	return (MTable::_instance._ColorProfileConvertInterface_GetNearestNativeFormat(format));
}
#if defined(MAXON_DEPENDENCY_ENABLE) && !defined(PRIVATE_MAXON_REGISTRATION_UNIT)
