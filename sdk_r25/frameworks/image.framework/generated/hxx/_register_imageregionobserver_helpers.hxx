...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImageRegionTilesObserverInterface, , "net.maxon.nodes.interface.imageregionobserver.tiles", "maxon.ImageRegionTilesObserverInterface", (ImageRegionObserverInterface::PrivateGetInterface()));
