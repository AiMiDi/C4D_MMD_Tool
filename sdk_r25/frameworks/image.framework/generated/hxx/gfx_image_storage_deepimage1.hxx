...
struct ImagePixelDeepImageStorageInterface::Hxx1
{
	...
	COWReferenceFunctionsImpl<typename ImagePixelStorageInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename ImagePixelStorageInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type
	> { };
};
