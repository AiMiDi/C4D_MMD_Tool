...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageUrlCacheInterface::Hxx1::ConstReferenceFunctionsImpl<S>::InvalidateCache(const Url& url) -> Result<void>
{
	return (Hxx2::StaticMTable::_instance._ImageUrlCacheInterface_InvalidateCache(url));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageUrlCacheInterface::Hxx1::ConstReferenceFunctionsImpl<S>::FindOrCreate(const Url& url) -> Result<ImageUrlCacheRef>
{
	return (Hxx2::StaticMTable::_instance._ImageUrlCacheInterface_FindOrCreate(url));
}
