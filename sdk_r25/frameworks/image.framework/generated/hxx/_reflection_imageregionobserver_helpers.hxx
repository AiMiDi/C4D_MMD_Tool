...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(Int tileSize) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ImageRegionTilesObserverInterface_Init_Offset), maxon::reflection::Argument::ByValue(tileSize)};
			(*handler_)(_fn_ImageRegionTilesObserverInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_._ImageRegionTilesObserverInterface_Init));
			return proxy_result;
		}
		...
		Result<void> GetAndResetDirtyState(DirtyState& dirtyState) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ImageRegionTilesObserverInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ImageRegionTilesObserverInterface_GetAndResetDirtyState_Offset), maxon::reflection::Argument::ByReference(dirtyState)};
			(*handler_)(_fn_ImageRegionTilesObserverInterface_GetAndResetDirtyState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, DirtyState&>::Invoke, (const void*) mt_._ImageRegionTilesObserverInterface_GetAndResetDirtyState));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ImageRegionTilesObserverInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "tileSize\0", 1LL, ImageRegionTilesObserverInterface, _ImageRegionTilesObserverInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "dirtyState\0", 2LL, ImageRegionTilesObserverInterface, _ImageRegionTilesObserverInterface_GetAndResetDirtyState),
		};
