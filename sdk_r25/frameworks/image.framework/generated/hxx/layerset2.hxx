...
struct LayerSetInterface::MTable
{
	...
	HashInt (*_LayerSetInterface_GetHashCode) (const LayerSetInterface* this_);
...
struct LayerSetInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _LayerSetInterface_SetSelectedLayers(LayerSetInterface* this_, const LayerHash& layers) { return C::Get(this_)->SetSelectedLayers(layers); }
		static const LayerHash& _LayerSetInterface_GetSelectedLayers(const LayerSetInterface* this_) { return C::Get(this_)->GetSelectedLayers(); }
		static void _LayerSetInterface_SetSelectedImage(LayerSetInterface* this_, const String& image) { return C::Get(this_)->SetSelectedImage(image); }
		static String _LayerSetInterface_GetSelectedImage(const LayerSetInterface* this_) { return C::Get(this_)->GetSelectedImage(); }
		static void _LayerSetInterface_SetMode(LayerSetInterface* this_, LAYERSETMODE mode) { return C::Get(this_)->SetMode(mode); }
		static LAYERSETMODE _LayerSetInterface_GetMode(const LayerSetInterface* this_) { return C::Get(this_)->GetMode(); }
		static void _LayerSetInterface_SetCalculateAlpha(LayerSetInterface* this_, Bool calcAlpha) { return C::Get(this_)->SetCalculateAlpha(calcAlpha); }
		static Bool _LayerSetInterface_GetCalculateAlpha(const LayerSetInterface* this_) { return C::Get(this_)->GetCalculateAlpha(); }
		static Bool _LayerSetInterface_IsEqual(const LayerSetInterface* this_, const LayerSetInterface* other) { return C::Get(this_)->IsEqual(other); }
		static HashInt _LayerSetInterface_GetHashCode(const LayerSetInterface* this_) { return C::Get(this_)->GetHashCode(); }
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LayerSetInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._LayerSetInterface_DescribeIO(stream));
}
