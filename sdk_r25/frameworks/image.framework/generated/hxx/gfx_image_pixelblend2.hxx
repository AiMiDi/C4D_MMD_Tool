...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelBlendInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetOptimalPixelFormat(const Block<PixelFormat>& formats) -> Result<PixelFormat>
{
	return (Hxx2::StaticMTable::_instance._ImagePixelBlendInterface_GetOptimalPixelFormat(formats));
}
