...
protected:
	...
	MAXON_METHOD Result<Bool> IsSelected(const GraphNode& node);

	MAXON_METHOD Result<GraphNode> CreateOutputPort(const GraphNode& node, const CString& id, const String& name = String("Output"));

	MAXON_METHOD Result<GraphNode> CreateInputPort(const GraphNode& node, const CString& id, const String& name = String("Input"));
...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<Bool> IsTrueNodeSelected(const GraphNode& node);
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<Bool> IsPortSelected(const GraphNode& port);
...
public:
	...
	//----------------------------------------------------------------------------------------
	Result<typename SFINAEHelper<GraphNode, BASE>::type> CreateOutputPort(const CString& id, const String& name = String("Output"))
	{
		PRIVATE_MAXON_GRAPHFN_PROLOGUE;
	...
	/// @return												The created port.
	//----------------------------------------------------------------------------------------
	Result<typename SFINAEHelper<GraphNode, BASE>::type> CreateInputPort(const CString& id, const String& name = String("Input"))
	{
		PRIVATE_MAXON_GRAPHFN_PROLOGUE;
