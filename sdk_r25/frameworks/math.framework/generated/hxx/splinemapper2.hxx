...
struct SplineMapperInterface::MTable
{
	...
	Bool (*_SplineMapperInterface_IsEqual) (const SplineMapperInterface* this_, const SplineMapperInterface* other, EQUALITY equality);
	HashInt (*_SplineMapperInterface_GetHashCode) (const SplineMapperInterface* this_);
	Result<void> (*_SplineMapperInterface_InsertKnot) (SplineMapperInterface* this_, Int knotIndex, const SplineMapperKnot& knot);
	Result<Int> (*_SplineMapperInterface_InsertKnot_1) (SplineMapperInterface* this_, Float x, Float y, SPLINEMAPPER_KNOT_FLAGS flags, Bool adaptTangents);
	...
	template <typename IMPL> void Init()
	{
		...
		_SplineMapperInterface_IsEqual = &IMPL::_SplineMapperInterface_IsEqual;
		_SplineMapperInterface_GetHashCode = &IMPL::_SplineMapperInterface_GetHashCode;
...
struct SplineMapperInterface::Hxx2
{
	...
	public:
		...
		static Vector2d _SplineMapperInterface_GetPoint(const SplineMapperInterface* this_, Float positionX) { return C::Get(this_)->GetPoint(positionX); }
		static void _SplineMapperInterface_GetRange(const SplineMapperInterface* this_, Vector2d& min, Vector2d& max) { return C::Get(this_)->GetRange(min, max); }
		static void _SplineMapperInterface_SetRange(SplineMapperInterface* this_, const Vector2d& min, const Vector2d& max) { return C::Get(this_)->SetRange(min, max); }
		static void _SplineMapperInterface_AdaptRange(SplineMapperInterface* this_, const Vector2d& min, const Vector2d& max) { return C::Get(this_)->AdaptRange(min, max); }
		static Float _SplineMapperInterface_GetTension(const SplineMapperInterface* this_) { return C::Get(this_)->GetTension(); }
		static void _SplineMapperInterface_SetTension(SplineMapperInterface* this_, Float tension) { return C::Get(this_)->SetTension(tension); }
		static Int _SplineMapperInterface_GetKnotCount(const SplineMapperInterface* this_) { return C::Get(this_)->GetKnotCount(); }
		static SplineMapperKnot* _SplineMapperInterface_GetKnot(SplineMapperInterface* this_, Int knotIndex) { return C::Get(this_)->GetKnot(knotIndex); }
		static Bool _SplineMapperInterface_SetKnot(SplineMapperInterface* this_, Int knotIndex, const SplineMapperKnot& knot) { return C::Get(this_)->SetKnot(knotIndex, knot); }
		static Bool _SplineMapperInterface_IsEqual(const SplineMapperInterface* this_, const SplineMapperInterface* other, EQUALITY equality) { return C::Get(this_)->IsEqual(other, equality); }
		static HashInt _SplineMapperInterface_GetHashCode(const SplineMapperInterface* this_) { return C::Get(this_)->GetHashCode(); }
		static Result<void> _SplineMapperInterface_InsertKnot(SplineMapperInterface* this_, Int knotIndex, const SplineMapperKnot& knot) { return C::Get(this_)->InsertKnot(knotIndex, knot); }
		static Result<Int> _SplineMapperInterface_InsertKnot_1(SplineMapperInterface* this_, Float x, Float y, SPLINEMAPPER_KNOT_FLAGS flags, Bool adaptTangents) { return C::Get(this_)->InsertKnot(x, y, flags, adaptTangents); }
		static Result<void> _SplineMapperInterface_DeleteKnot(SplineMapperInterface* this_, Int knotIndex) { return C::Get(this_)->DeleteKnot(knotIndex); }
		static void _SplineMapperInterface_DeleteAllKnots(SplineMapperInterface* this_) { return C::Get(this_)->DeleteAllKnots(); }
		static const BaseArray<SplineMapperKnot>& _SplineMapperInterface_GetKnots(const SplineMapperInterface* this_) { return C::Get(this_)->GetKnots(); }
...
{
	return MTable::_instance._SplineMapperInterface_IsEqual(this, other, equality);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto SplineMapperInterface::GetHashCode() const -> HashInt
{
	return MTable::_instance._SplineMapperInterface_GetHashCode(this);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SplineMapperInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IsEqual(const SplineMapperInterface* other, EQUALITY equality) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	...
	return (MTable::_instance._SplineMapperInterface_IsEqual(o_, other, equality));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SplineMapperInterface::Hxx1::ReferenceFunctionsImpl<S>::InsertKnot(Float x, Float y, SPLINEMAPPER_KNOT_FLAGS flags, Bool adaptTangents) const -> Result<Int>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SplineMapperInterface::Hxx1::COWReferenceFunctionsImpl<S>::InsertKnot(Float x, Float y, SPLINEMAPPER_KNOT_FLAGS flags, Bool adaptTangents) -> Result<Int>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Int>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); SplineMapperInterface* o_ = (SplineMapperInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (MTable::_instance._SplineMapperInterface_InsertKnot_1(o_, x, y, flags, adaptTangents));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SplineMapperInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._SplineMapperInterface_DescribeIO(stream));
}
