...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BigIntegerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Zero() -> BigInteger
{
	return BigInteger(MTable::_instance._BigIntegerInterface_Zero());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BigIntegerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::One() -> BigInteger
{
	return BigInteger(MTable::_instance._BigIntegerInterface_One());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BigIntegerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::MinusOne() -> BigInteger
{
	return BigInteger(MTable::_instance._BigIntegerInterface_MinusOne());
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BigIntegerInterface::Hxx1::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void>
{
	return (MTable::_instance._BigIntegerInterface_DescribeIO(stream));
}
