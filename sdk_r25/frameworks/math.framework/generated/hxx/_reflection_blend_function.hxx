...
namespace maxon
{
	...
	public:
		...
		Result<Data> MapValue(Float x, const Data& startValue, const Data& endValue) 
		{
			...
			(*handler_)(_fn_BlendFunctionInterface_MapValue, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Data>, maxon::GenericComponent*, Float, const Data&, const Data&>::Invoke, (const void*) mt_._BlendFunctionInterface_MapValue));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_BlendFunctionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "x\0startValue\0endValue\0", 0LL, BlendFunctionInterface, _BlendFunctionInterface_MapValue),
		};
