...
#define PLUGINFLAG_COMMAND_ICONGADGET_DONOTSCALE (1 << 23)			///< if PLUGINFLAG_COMMAND_ICONGADGET, forbid to scale the element in the layout
/// @}
...
#define MSG_COMMANDGETOPTIONSICON			1056727				///< Special Message To Command to return different Options Icon if PLUGINFLAG_COMMAND_OPTION_DIALOG is set. data = IconData*. 
