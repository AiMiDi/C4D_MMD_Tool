...
BaseObject* BaseObject::GetEditObject(BaseObject** psds, DISPLAYEDITSTATE state, Bool safetey)
{
	return C4DOS.Bo->GetEditObject(this, psds, state, safetey);
}
...
Int32 BaseObject::GetEditorMode(void) const
{
	return C4DOS.Bo->GetMode(this, OBJECTSTATE::EDITOR);
}

Int32 BaseObject::GetEditorModeH(void) const
{
	return C4DOS.Bo->GetMode(this, OBJECTSTATE::EDITOR_HIERARCHICAL);
}
...
Int32 BaseObject::GetRenderMode(void) const
{
	return C4DOS.Bo->GetMode(this, OBJECTSTATE::RENDER);
}

Int32 BaseObject::GetRenderModeH(void) const
{
	return C4DOS.Bo->GetMode(this, OBJECTSTATE::RENDER_HIERARCHICAL);
}
...
Bool BaseObject::GetDeformMode(void) const
{
...
Int32 BaseObject::GetRealDeformMode(void) const
{
	return C4DOS.Bo->GetMode(this, OBJECTSTATE::REAL_DEFORM);
}

void BaseObject::SetRealDeformMode(Int32 mode)
{
	C4DOS.Bo->SetMode(this, OBJECTSTATE::REAL_DEFORM, mode);
}
...
{
	return C4DOS.Bo->CoGetTargetDistance(doc, this);
}
...
BaseObject* BaseObject::GetAndCheckHierarchyClone(HierarchyHelp* hh, BaseObject* op, HIERARCHYCLONEFLAGS flags, Bool* dirty, AliasTrans* trans, Int childCount, maxon::BaseArray<BaseObject*>* children)
{
	...
	*dirty = *dirty || !CompareDependenceList();
	...
	else
	{
		...
		for (tp = op; tp && cc > 0; tp = tp->GetNext())
		{
			...
			if (children && children->Append(dp) == maxon::FAILED)
			{
				BaseObject::Free(res);
				return nullptr;
			}
...
{
	return C4DOS.Bo->ObjDraw(this, drawpass, bd, bh);
}
...
BaseObject* BaseObject::GetCacheParent(void) const
{
	return C4DOS.Bo->GetCacheParent(this);
}

BaseObject* BaseObject::GetCacheTopParent(void) const
{
	return C4DOS.Bo->GetCacheTopParent(this);
}
...
{
	return C4DOS.Bo->ComputeLightColor(op, editor, reference); 
}

Vector ComputeColorTemperatureRGB(Float temperature, Float reference, Bool normalize)
{
	return C4DOS.Bo->ComputeColorTemperatureRGB(temperature, reference, normalize); 
}
