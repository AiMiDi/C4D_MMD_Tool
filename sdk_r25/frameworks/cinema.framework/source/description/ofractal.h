...
enum
{
	...
	PRIM_FRACTAL_USE_NEW_VERSION		= 1252,	// BOOL			- Use new elevation behavior if true (R21). In the BaseContainer but not in the UI.
	PRIM_FRACTAL_SWITCH_TO_UPDATED	= 1253	// BUTTON		- To switch from legacy to new behavior.
};
