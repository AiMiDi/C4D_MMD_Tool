...
namespace enum98
{
	...
	static const maxon::UInt64 MDDIRTY_values[] = {maxon::UInt64(enum98::MDDIRTY::NONE), maxon::UInt64(enum98::MDDIRTY::ALL), maxon::UInt64(enum98::MDDIRTY::ARRAYCOUNT), maxon::UInt64(enum98::MDDIRTY::COUNT), maxon::UInt64(enum98::MDDIRTY::DATA)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MDDIRTY98(){ return enum98::MDDIRTY_info; }
namespace enum120
{
	enum class MD_TYPE
	{
	...
	static const maxon::UInt64 MD_TYPE_values[] = {maxon::UInt64(enum120::MD_TYPE::MD_NONE), maxon::UInt64(enum120::MD_TYPE::MD_CHAR), maxon::UInt64(enum120::MD_TYPE::MD_UCHAR), maxon::UInt64(enum120::MD_TYPE::MD_LONG), maxon::UInt64(enum120::MD_TYPE::MD_ULONG), maxon::UInt64(enum120::MD_TYPE::MD_LLONG), maxon::UInt64(enum120::MD_TYPE::MD_MATRIX), maxon::UInt64(enum120::MD_TYPE::MD_COLOR), maxon::UInt64(enum120::MD_TYPE::MD_VECTOR), maxon::UInt64(enum120::MD_TYPE::MD_NORMAL), maxon::UInt64(enum120::MD_TYPE::MD_REAL), maxon::UInt64(enum120::MD_TYPE::MD_BOOL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MD_TYPE120(){ return enum120::MD_TYPE_info; }
#ifdef CINEWARE_NAMESPACE_ENABLE
