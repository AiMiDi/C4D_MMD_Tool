...
namespace enum900
{
	...
	static const maxon::EnumInfo CAMORPH_DATA_FLAGS_info{"CAMORPH_DATA_FLAGS", SIZEOF(CAMORPH_DATA_FLAGS), true, "P\0S\0R\0POINTS\0TANGENTS\0VERTEXMAPS\0WEIGHTMAPS\0PARAMS\0USERDATA\0UV\0ASTAG\0ALL\0NONE\0", CAMORPH_DATA_FLAGS_values, std::extent<decltype(CAMORPH_DATA_FLAGS_values)>::value};
}
