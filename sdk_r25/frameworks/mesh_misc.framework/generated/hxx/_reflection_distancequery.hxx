...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(const Block<const Vector> points, const Block<const SimplePolygon> polygons, const Matrix& objectPosition) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<DistanceQueryInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DistanceQueryInterface_Init_3_Offset), maxon::reflection::Argument::ByValue(points), maxon::reflection::Argument::ByValue(polygons), maxon::reflection::Argument::ByReference(objectPosition)};
			(*handler_)(_fn_DistanceQueryInterface_Init_3, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Block<const Vector>, const Block<const SimplePolygon>, const Matrix&>::Invoke, (const void*) mt_._DistanceQueryInterface_Init_3));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_DistanceQueryInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "points\0polygons\0objectPosition\0", 21LL, DistanceQueryInterface, _DistanceQueryInterface_Init_3),
