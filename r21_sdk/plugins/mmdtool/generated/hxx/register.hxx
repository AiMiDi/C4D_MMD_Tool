...
static maxon::Id g_usedFrameworks[] = {maxon::Id("net.maxon.c4d.cinema.framework"), maxon::Id("net.maxon.command.framework"), maxon::Id("net.maxon.core.framework"), maxon::Id("net.maxon.crypt.framework"), maxon::Id("net.maxon.image.framework"), maxon::Id("net.maxon.math.framework"), maxon::Id("net.maxon.mesh_misc.framework"), maxon::Id("net.maxon.python.framework")};
