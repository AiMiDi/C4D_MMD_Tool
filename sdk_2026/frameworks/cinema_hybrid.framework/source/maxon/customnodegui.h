...
//----------------------------------------------------------------------------------------
class CustomNodeGuiBase : public cinema::iBaseCustomGui
{
...
public:
	...
	//----------------------------------------------------------------------------------------
	CustomNodeGuiBase(const cinema::BaseContainer& settings, cinema::CUSTOMGUIPLUGIN* plugin) : cinema::iBaseCustomGui(settings, plugin)
	{
	...
	Result<BaseArray<cinema::DescID>> GetReplacementIds() const
	{
		...
		BaseArray<cinema::DescID> replacementIds;
