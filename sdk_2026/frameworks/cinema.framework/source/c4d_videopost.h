...
public:
	...
	/// @copydoc Alloc
	static BaseVideoPost* Alloc(const maxon::SourceLocation&, Int32 type) { return Alloc(type); }
	...
	//----------------------------------------------------------------------------------------
	BaseVideoPost* GetNext() const { return (BaseVideoPost*)AtCall(GetNext) (); }
	...
	//----------------------------------------------------------------------------------------
	BaseVideoPost* GetPred() const { return (BaseVideoPost*)AtCall(GetPred) (); }
	...
	//----------------------------------------------------------------------------------------
	Bool RenderEngineCheck(Int32 id) const;
