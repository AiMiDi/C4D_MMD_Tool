...
enum
{
	...
	DOCUMENT_USERCHANGECOUNT					= 1026, // LONG
	...
	DOCUMENT_EXISTING_DOCPOINTER_ONMERGE = 2213,	// VOID, pointer to the existing (active) document on merge process, only available during BaseSceneLoader::Load() then removed
	...
	DOCUMENT_CLONING_HINT							=	50015, // LONG
		...
		DOCUMENT_CLONING_HINT_GIRENDERER		=	4,
	...
	DOCUMENT_CHANGE_RENDER_COLORSPACE											= 50052,
	DOCUMENT_COLOR_MANAGEMENT_OCIO_CONVERTED_DESCRIPTION 	= 50053,
	DOCUMENT_CURRENT_RENDER_COLORSPACE = 50054,
	DOCUMENT_OCIO_FILE_RULES = 50055,
	DOCUMENT_OCIO_INFOSTRING = 50056,
	DOCUMENT_OCIO_PREVIOUS_LINEAR_WORKFLOW = 50057,
	DOCUMENT_OCIO_PREVIOUS_COLOR_PROFILE = 50058,
	DOCUMENT_OCIO_RENDER_COLORSPACE_NAME = 50059,
	DOCUMENT_OCIO_VIEW_TRANSFORM_NAME = 50060,
	DOCUMENT_OCIO_DISPLAY_COLORSPACE_NAME = 50061,
	DOCUMENT_OCIO_VIEW_TRANSFORM_THUMBNAILS_NAME = 50062,

	DOCUMENT_TEMPORARY_TIME_OVERRIDE = 2214,
	DOCUMENT_
};
