...
enum
{
	...
	RDATA_BAKE_OCIO_VIEW_TRANSFORM	=	5219, // Output in Render space, apply view tranform when file is saved.
	RDATA_BAKE_OCIO_VIEW_TRANSFORM_RENDER = 5220, // Apply the view transform in the render process, disables RDATA_BAKE_OCIO_VIEW_TRANSFORM. Not part of the description, needs to be set for RenderDocument.
  ...
  RDATA_GROUP_OVERRIDEMAT         = 1452472602,
	...
	RDATA_FRAMESEQUENCE							= 5016,
		...
		RDATA_FRAMESEQUENCE_CUSTOM        = 4,
	RDATA_FRAME_RANGE_STRING				= 5015, // string for RDATA_FRAMESEQUENCE_CUSTOM
	...
	RDATA_FRAMERATE_SYNC_WITH_PROJECT	= 5023,
	...
	RDATA_INFOTEXT									= 6010,
	RDATA_PRESET										= 6011,
		RDATA_PRESET_160_120_IS_DEPRECATED				= 200,
		...
		RDATA_PRESET_WEBVIDEO_IS_DEPRECATED				= 213,
		RDATA_PRESET_WEBBANNER_IS_DEPRECATED			= 214,
		RDATA_PRESET_IPODVIDEO_IS_DEPRECATED			= 215,
		...
		RDATA_PRESET_DVCPRO_HD720_25							= 287,
		RDATA_PRESET_DVCPRO_HD1080_25							= 288,

		RDATA_PRESET_UHD_4K_24										= 289,
		RDATA_PRESET_UHD_4K_25										= 290,
		RDATA_PRESET_UHD_4K_30										= 291,
		RDATA_PRESET_UHD_8K_24										= 292,

		RDATA_PRESET_IPHONE_XS_MAX								= 293,
		RDATA_PRESET_IPHONE_X											= 294,
		RDATA_PRESET_IPHONE_XR										= 295,
		RDATA_PRESET_IPHONE_6_PLUS								= 296,
		RDATA_PRESET_IPHONE_6											= 297,
		RDATA_PRESET_IPHONE_SE										= 298,
		RDATA_PRESET_IPAD_PRO_13									= 299,
		RDATA_PRESET_IPAD_PRO_11									= 300,
		RDATA_PRESET_IPAD_PRO_10									= 301,
		RDATA_PRESET_IPAD_RETINA									= 302,
		RDATA_PRESET_APPLEWATCH_44								= 303,
		RDATA_PRESET_APPLEWATCH_40								= 304,
		RDATA_PRESET_APPLEWATCH_42								= 305,
		RDATA_PRESET_APPLEWATCH_38								= 306,
		RDATA_PRESET_GOOGLE_PIXEL_XL							= 307,
		RDATA_PRESET_GOOGLE_PIXEL									= 308,
		RDATA_PRESET_SAMSUNG_GALAXY_S10						= 309,
		RDATA_PRESET_SAMSUNG_GALAXY_S10e					= 310,
		RDATA_PRESET_SAMSUNG_GALAXY_S8						= 311,
		RDATA_PRESET_SAMSUNG_GALAXY_WATCH					= 312,
		RDATA_PRESET_SURFACE_PRO_4								= 313,
		RDATA_PRESET_SURFACE_PRO_3								= 314,
		RDATA_PRESET_GOOGLE_PIXEL_2XL							= 315,
  ...
  RDATA_MULTIPASS_USERNAMES             	= 9201,
	...
	RDATA_FASTAFX														= 8501,	//! `Bool`: Enables FASTAFX mode for viewport render engine renderings. @warning Setting this flag will disable progress hook updates when rendering.
	...
	OBSOLETE_RDATA_VDFAKE_THREADCOUNT				=	440000176,
	OBSOLETE_RDATA_VDFAKE_CURRENTTHREAD			= 440000177,
  ...
  RDATA_MATERIAL_OVERRIDE_DSPL            = 10015,
	...
	RDATA_FORCE_HIDE_HUD 										= 10034,
	RDATA_OVERRIDE_VIEW_TRANSFORM						= 10035, // Override view transform
	
	RDATA_FORCE_PREROLL = 5090,
	RDATA_DUMMY
};
