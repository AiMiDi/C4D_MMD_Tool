...
enum
{
	...
	PYRO_TAG_EMISSION_TYPE = 1061,
		...
		PYRO_TAG_EMISSION_TYPE_SURFACE_DYNAMIC = 3,
		PYRO_TAG_EMISSION_TYPE_SURFACE_NANO = 4,
		PYRO_TAG_EMISSION_TYPE_VOLUME_NANO = 5,
	PYRO_TAG_EMISSION_VOXEL_FALLOFF = 1062,
	PYRO_TAG_VELOCITY_SPACE_CUSTOM_NORMAL = 1063,
	PYRO_TAG_DIVERGENCE_CONTROL_GROUP = 1064,
	PYRO_TAG_DIVERGENCE_CONTROL_STRENGTH = 1065,
	PYRO_TAG_DIVERGENCE_CONTROL_ENABLED = 1066,
	PYRO_TAG_NO_REQUESTS = 1067,
	PYRO_TAG_OLD_DIVERGENCE_CONTROL = 1068,
	PYRO_TAG_SURFACE_WEIGHTS_DENSITY_POPUP = 1069,
	PYRO_TAG_SURFACE_WEIGHTS_TEMPERATURE_POPUP = 1070,
	PYRO_TAG_SURFACE_WEIGHTS_FUEL_POPUP = 1071,
	PYRO_TAG_SURFACE_WEIGHTS_COLOR_POPUP = 1072,
	PYRO_TAG_SURFACE_WEIGHTS_GLOBAL_POPUP = 1073,
	PYRO_TAG_DUMMY
};
