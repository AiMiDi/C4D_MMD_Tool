...
enum
{
	...
	SNAP_SETTINGS_PIXELMODE						= 440000353,			///< Bool - whether to snap to the pixel center or top left corner
		SNAP_SETTINGS_PIXELMODE_EDGE			= 0,						///< Snap to the top left corner of the pixel
		SNAP_SETTINGS_PIXELMODE_CENTER		= 1,        	  ///< Snap to the center of the pixels
	// SNAP_SETTINGS_PIXELMODECONTRAST		= 440000354,			///< Filter snapping by contrast level between this pixel and it's neighbors
	QUANTIZE_PARAMETERS								= 440000355,			///< Real - Command ID for the Quantize parameter GUi.
	...
	SNAPMODE_PIXEL										= 440000352,			///< Snap to Texture Pixels in the UV viewport
	...
	MESH_CHECK_TRIANGLE               = 1038,
	MESH_CHECK_TRIANGLE_COLOR         = 1039,
	MESH_CHECK_TRIANGLE_SELECT        = 1040,
	MESH_CHECK_TRIANGLE_TEXT          = 1041,

	MESH_CHECK_NGON                   = 1042,
	MESH_CHECK_NGON_COLOR             = 1043,
	MESH_CHECK_NGON_SELECT            = 1044,
	MESH_CHECK_NGON_TEXT              = 1045,
	...
	MODELING_MODIFIERS = 3000,
	MODELING_MODIFIERS_PRESERVE_UV = 3001
};
