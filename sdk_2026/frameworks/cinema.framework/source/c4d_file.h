...
public:
	...
	/// @copydoc Alloc
	static MemoryFileStruct* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static BaseFile* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
/// @addAllocFreeAutoAllocNote
//----------------------------------------------------------------------------------------
class CINEWARE_SINGLEINHERITANCE AESFile : public BaseFile
{
private:
	AESFile();
	~AESFile();
...
public:
	...
	/// @copydoc Alloc
	static AESFile* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static BrowseFiles* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static BrowseVolumes* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static HyperFile* Alloc(const maxon::SourceLocation&) { return Alloc(); }
	...
	//----------------------------------------------------------------------------------------
	Bool WriteImage(const BaseBitmap* bmp, Int32 format, BaseContainer* data, SAVEBIT savebits = SAVEBIT::ALPHA);
