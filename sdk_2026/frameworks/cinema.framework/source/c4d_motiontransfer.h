...
public:
	...
	/// @copydoc Alloc
	static MTCharacterBodyPart* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static MTCharacterDefinitionTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static MTCharacterMotionTransferTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
