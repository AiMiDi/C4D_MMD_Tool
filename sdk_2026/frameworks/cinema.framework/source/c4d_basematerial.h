...
//----------------------------------------------------------------------------------------
class CINEWARE_SINGLEINHERITANCE BaseMaterial : public BaseList2D
{
private:
	BaseMaterial();
	~BaseMaterial();
...
public:
	...
	/// @copydoc Alloc
	static BaseMaterial* Alloc(const maxon::SourceLocation&, Int32 type) { return Alloc(type); }
	...
	//----------------------------------------------------------------------------------------
	BaseShader* MakeShader(Int32 type, Int32 id, BaseShader* pred = nullptr);
...
public:
	...
	/// @copydoc Alloc
	static Material* Alloc(const maxon::SourceLocation&) { return Alloc(); }
