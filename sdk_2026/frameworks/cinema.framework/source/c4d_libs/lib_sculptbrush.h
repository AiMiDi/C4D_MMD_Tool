...
public:
	...
	/// @copydoc Alloc
	static SculptFlagChecker* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static SculptPointPolysIterator* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static CustomSculptBrushBase* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static SculptBrushParams* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	//----------------------------------------------------------------------------------------
	virtual Bool GetEnabling(Int32 id) const;
...
public:
	...
	/// @copydoc Alloc
	static SculptModifierInterface* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
struct SculptBrushBaseLibrary : public C4DLibrary
{
	...
	Bool			(iSculptBrushBase::*GetDEnabling)(const BaseDocument* doc, const BaseContainer& data, const DescID& id, const GeData& t_data, DESCFLAGS_ENABLE flags, const BaseContainer* itemdesc, const SculptBrushToolData *tool) const;
	...
	Bool			(iSculptBrushBase::*GetDDescription)(const BaseDocument* doc, const BaseContainer& data, Description* description, DESCFLAGS_DESC& flags, const SculptBrushToolData *tool) const;
	...
	Bool			(iSculptBrushBase::*GetDParameter)(const BaseDocument* doc, const BaseContainer& data, const DescID& id, GeData& t_data, DESCFLAGS_GET& flags, const SculptBrushToolData *tool) const;
	Bool			(iSculptBrushBase::*DisplayControl)(BaseDocument* doc, BaseObject* op, BaseObject* chainstart, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds, const SculptBrushToolData *tool) const;
	Bool			(iSculptBrushBase::*InitDisplayControl)(BaseDocument* doc, const BaseContainer& data, BaseDraw* bd, const AtomArray* active, SculptBrushToolData *tool);
	...
	Bool	(iSculptBrushBase::*GetEnabling)(Int32 id) const;
