...
#define VolumeBuilderLibCall(b) 		cinema::VolumeBuilderLib *lib = cinema::CheckVolumeBuilderLib(LIBOFFSET(cinema::VolumeBuilderLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iVolumeBuilder*>(this)->*lib->b)

#define VolumeBuilderLibCallR(a, b) cinema::VolumeBuilderLib *lib = cinema::CheckVolumeBuilderLib(LIBOFFSET(cinema::VolumeBuilderLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iVolumeBuilder*>(this)->*lib->b)

#define VolumeBuilderLibCallRC(a, b) cinema::VolumeBuilderLib *lib = cinema::CheckVolumeBuilderLib(LIBOFFSET(cinema::VolumeBuilderLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iVolumeBuilder*>(this)->*lib->b)
