...
{
	const BaseObject* m_pObject;			///< Object that was hit.
...
public:
	...
	/// @copydoc Alloc
	static HairGuides* Alloc(const maxon::SourceLocation&, Int32 count, Int32 segments) { return Alloc(count, segments); }
...
public:
	...
	/// @copydoc Alloc
	static HairObject* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static HairVertexMapTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static HairSelectionTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static HairTangentTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static HairVideoPost* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	//----------------------------------------------------------------------------------------
	Bool GetHairGlobal(const BaseDocument* doc);
...
public:
	...
	/// @copydoc Alloc
	static HairCollider* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
struct HairObjectLib : public C4DLibrary
{
	...
	Bool (*hairGetHairGlobal)(const BaseDocument* doc);
