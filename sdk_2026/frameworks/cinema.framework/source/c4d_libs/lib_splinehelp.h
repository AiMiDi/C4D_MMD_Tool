...
public:
	...
	/// @copydoc Alloc
	static SplineHelp* Alloc(const maxon::SourceLocation&) { return Alloc(); }
	...
	/// 															@endcode
	//----------------------------------------------------------------------------------------
	void SetOwner(const BaseObject* op);
	...
	//----------------------------------------------------------------------------------------
	/// Get the cached SplineObject. @theOwnsPointed{SplineHelp, SplineObject}
...
class CINEWARE_SINGLEINHERITANCE iSplineHelp;
...
struct SplineHelpLibrary : public C4DLibrary
{
	...
	Bool							(iSplineHelp::*InitSplineEx2)(const SplineObject* op, Vector upvector);

	void							(iSplineHelp::*FreeSpline)();
	Bool							(iSplineHelp::*Exists)() const;
	Int32							(iSplineHelp::*GetSegmentCount)() const;
	Float							(iSplineHelp::*GetSplineLength)() const;
	Float							(iSplineHelp::*GetSegmentLength)(Int32 segment) const;
	Float							(iSplineHelp::*GetPointValue)(Float offset, Int32 segment) const;
	Int32							(iSplineHelp::*GetPointIndex)(Float offset, Int32 segment) const;

	Vector						(iSplineHelp::*GetPositionEx)(Float offset, Int32 segment, Bool smooth) const;
	Vector						(iSplineHelp::*GetTangentEx)(Float offset, Int32 segment, Bool smooth) const;
	Vector						(iSplineHelp::*GetNormalEx)(Float offset, Int32 segment, Bool smooth) const;
	Vector						(iSplineHelp::*GetCrossNormalEx)(Float offset, Int32 segment, Bool smooth) const;

	Float							(iSplineHelp::*GetOffsetFromUnit)(Float unitoffset, Int32 segment) const;
	Float							(iSplineHelp::*GetOffsetFromReal)(Float offset, Int32 segment) const;

	Matrix						(iSplineHelp::*GetMatrix)(Float offset, Int32 segment, Bool smooth, Bool realoffset) const;
	void							(iSplineHelp::*GetLinePointSegment)(Int32 index, Float *offset, Int32 *ind, Int32 *segment) const;
	void							(iSplineHelp::*GetSplinePointSegment)(Int32 index, Float *offset, Int32 *ind, Int32 *segment) const;
	void							(iSplineHelp::*GlobalToLocal)(Float offset, Float *off, Int32 *segment, Bool realoffset) const;
	Matrix						(iSplineHelp::*GetVertexMatrix)(Int32 index) const;
	Int32							(iSplineHelp::*SplineToLineIndex)(Int32 index) const;

	// MoGraph 2 Updates
	Bool							(iSplineHelp::*InitSplineEx)(const BaseObject *op, Vector upvector, const BaseObject* rail, Bool target_rail, Bool use_deformed_points, Bool force_update, Bool use_global_space);
	Vector						(iSplineHelp::*GetPosition)(Float offset, Int32 segment, Bool smooth, Bool realoffset) const;
	Vector						(iSplineHelp::*GetTangent)(Float offset, Int32 segment, Bool smooth, Bool realoffset) const;
	Vector						(iSplineHelp::*GetNormal)(Float offset, Int32 segment, Bool smooth, Bool realoffset) const;
	Vector						(iSplineHelp::*GetCrossNormal)(Float offset, Int32 segment, Bool smooth, Bool realoffset) const;
	Float							(iSplineHelp::*GetSize)(Float offset, Int32 segment, Bool smooth, Bool realoffset) const;
	Float							(iSplineHelp::*GetVertexSize)(Int32 index) const;
	Int32							(iSplineHelp::*GetVertexCount)(Int32 segment) const;
	Matrix						(iSplineHelp::*GetVertexMatrix2)(Int32 segment, Int32 index) const;
	Bool							(iSplineHelp::*IsClosed)(Int32 segment) const;
	SPLINETYPE				(iSplineHelp::*GetType)() const;
	Bool							(iSplineHelp::*CopyTo)(iSplineHelp *dest) const;

	Int32							(iSplineHelp::*GetPointCount)() const;
	void							(iSplineHelp::*SetOwner)(const BaseObject* op);

	Int32							(iSplineHelp::*LineToSplineIndex)(Int32 index) const;

	UInt32						(iSplineHelp::*GetDirty)() const;

	Matrix						(iSplineHelp::*GetPointMatrix)(Int32 index) const;

	Bool							(iSplineHelp::*InitSpline)(const BaseObject* op, Vector upvector, const BaseObject* rail, SPLINEHELPFLAGS flags);

	LineObject*				(iSplineHelp::*GetLineObject)();

	// R22, 21.604
	SplineObject*			(iSplineHelp::*GetSplineObjectCache)();
