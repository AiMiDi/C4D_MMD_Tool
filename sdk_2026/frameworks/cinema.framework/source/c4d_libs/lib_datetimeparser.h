...
public:
	...
	/// @copydoc Alloc
	static DateTimeParser* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
class CINEWARE_SINGLEINHERITANCE iDateTimeParser;

struct DateTimeParserLibrary : public C4DLibrary
{
//DateTimeParser		(iDateTimeParser::*DateTimeParser)	();
