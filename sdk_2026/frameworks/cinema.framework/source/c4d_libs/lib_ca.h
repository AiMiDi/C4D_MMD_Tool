...
public:
	...
	/// @copydoc Alloc
	static CAJointObject* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static CAWeightTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
public:
	...
	/// @copydoc Alloc
	static CAPoseMorphTag* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
struct CALibrary : public C4DLibrary
{
	...
	maxon::Result<Int32> (*weightMgrGetAutoWeightAlgoIndex)(BaseDocument* doc, const maxon::Id& id);
