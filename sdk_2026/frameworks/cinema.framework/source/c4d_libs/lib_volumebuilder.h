...
public:
	...
	/// @copydoc Alloc
	static VolumeBuilder* Alloc(const maxon::SourceLocation&) { return Alloc(); }

	//----------------------------------------------------------------------------------------
	/// @destructsAlloc{VolumeObject objects}
	/// @param[in] p									@theToDestruct{VolumeObject object}
	//----------------------------------------------------------------------------------------
	static void Free(VolumeBuilder*& p)	{ BaseList2D::Free(reinterpret_cast<BaseList2D*&>(p)); }
...
class CINEWARE_SINGLEINHERITANCE iVolumeBuilder;

struct VolumeBuilderLib : public C4DLibrary
{
	Bool									(iVolumeBuilder::*InputObjectIsChild)(Int32 index) const;
	Int32									(iVolumeBuilder::*GetInputObjectCount)(Bool countDouble);
	BaseObject*						(iVolumeBuilder::*GetInputObject)(Int32 index) const;
	...
	BaseContainer*				(iVolumeBuilder::*GetSettingsContainerForIndex)(Int32 index) const;
	BaseContainer*				(iVolumeBuilder::*GetSettingsContainerForObject)(BaseObject* object) const;
	void									(iVolumeBuilder::*SetBoolMode)(Int32 index, BOOLTYPE mode);
	BOOLTYPE							(iVolumeBuilder::*GetBoolMode)(Int32 index) const;
	void									(iVolumeBuilder::*SetMixMode)(Int32 index, MIXTYPE mode);
	MIXTYPE								(iVolumeBuilder::*GetMixMode)(Int32 index) const;
	void									(iVolumeBuilder::*SetEnable)(Int index, Bool enable);
	Bool									(iVolumeBuilder::*GetEnable)(Int index) const;
	void									(iVolumeBuilder::*SetSelected)(Int index, Bool select);
	Bool									(iVolumeBuilder::*GetSelected)(Int index) const;
	Int32									(iVolumeBuilder::*GetListEntryCount)();
	void									(iVolumeBuilder::*SetMixVectorMode)(Int32 index, MIXVECTORTYPE mode);
	MIXVECTORTYPE					(iVolumeBuilder::*GetMixVectorMode)(Int32 index) const;
};
