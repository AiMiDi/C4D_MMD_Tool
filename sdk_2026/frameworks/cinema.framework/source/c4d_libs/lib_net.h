...
class CINEWARE_SINGLEINHERITANCE NetRenderData
{
private:
	NetRenderData();
	~NetRenderData();
...
class CINEWARE_SINGLEINHERITANCE RenderJob : public BaseList2D
{
#ifndef __API_INTERN__
private:
	RenderJob();
...
public:
	...
	static User* Alloc();
	/// @copydoc Alloc
	static User* Alloc(const maxon::SourceLocation&) { return Alloc(); }
	static void Free(User*& p);
};

class CINEWARE_SINGLEINHERITANCE NetRenderService : public NetService
{
public:
