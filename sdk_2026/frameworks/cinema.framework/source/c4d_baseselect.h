...
public:
	...
	/// @copydoc Alloc
	static BaseSelect* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
class CINEWARE_SINGLEINHERITANCE EdgeBaseSelect : public BaseSelect
{
private:
	EdgeBaseSelect();
	~EdgeBaseSelect();
...
public:
	...
	/// @copydoc Alloc
	static EdgeBaseSelect* Alloc(const maxon::SourceLocation&) { return Alloc(); }
