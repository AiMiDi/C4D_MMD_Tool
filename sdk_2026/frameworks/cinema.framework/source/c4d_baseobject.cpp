...
void BaseObject::InsertTagCheckName(BaseTag* tp, BaseTag* pred)
{
	C4DOS_Bo->InsertTagCheckName(this, tp, pred);
}
...
Bool AssetData::ReplaceElement(BaseList2D* oldOwner, BaseList2D* newOwner, Int32 oldId, Int32 newId, GeListNode* startNodeSearch)
{
	return C4DOS_Bo->ReplaceElement(this, oldOwner, newOwner, oldId, newId, startNodeSearch);
}
...
Bool PolygonObject::BuildNgon()
{
	return C4DOS_Bo->PyBuildNgon(this);
}

const NgonBase* PolygonObject::GetNgonBaseR() const
{
	return C4DOS_Bo->PyGetNgonBaseC(this);
}
