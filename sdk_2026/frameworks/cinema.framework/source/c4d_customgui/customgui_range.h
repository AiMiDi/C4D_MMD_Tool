...
/// @since R19
//-------------------------------------------------------------------------------------------------
class RangeData : public CustomDataTypeT<CUSTOMDATATYPE_RANGE>
{
private:
...
public:
	...
	/// @copydoc Alloc
	static RangeData* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
class CINEWARE_SINGLEINHERITANCE iRangeData
{
};
#else
