...
#define KerningDataLibCall(b)			cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return; \
	(reinterpret_cast<cinema::iKerningData*>(this)->*lib->b)

#define KerningDataLibCallR(a, b)	cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<cinema::iKerningData*>(this)->*lib->b)

#define KerningDataLibCallRC(a, b)	cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<const cinema::iKerningData*>(this)->*lib->b)

#define KerningVpGuiHelperLibCall(b)			cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return; \
	(reinterpret_cast<cinema::iKerningVpGuiHelper*>(this)->*lib->b)

#define KerningVpGuiHelperLibCallR(a, b)		cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<cinema::iKerningVpGuiHelper*>(this)->*lib->b)

#define KerningVpGuiHelperLibCallRC(a, b)		cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<const cinema::iKerningVpGuiHelper*>(this)->*lib->b)

#define KerningLibCall(b)			cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return; \
	(lib->b)

#define KerningLibCallR(a, b)	cinema::KerningLib *lib = cinema::CheckKerningLib(LIBOFFSET(cinema::KerningLib, b)); \
	if (!lib || !lib->b) return a; \
	return (lib->b)
