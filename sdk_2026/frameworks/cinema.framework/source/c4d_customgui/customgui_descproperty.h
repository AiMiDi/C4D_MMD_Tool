...
static const Int32 CUSTOMGUI_DESCRIPTIONPROPERTY = 1000485;

/// @addtogroup DESCRIPTIONPROPERTY_CUSTOMGUISETTINGS
/// @ingroup CUSTOMGUISETTINGS
/// @{
static const Int32 DESCRIPTIONPROPERTY_SHOWBUTTON		= 10005;	///< ::Bool Show special button.
static const Int32 DESCRIPTIONPROPERTY_INDENT				= 10006;	///< ::Bool Indent text.
static const Int32 DESCRIPTIONPROPERTY_BPDOT				= 10007;	///< ::Bool Use @BP3D dot.
static const Int32 DESCRIPTIONPROPERTY_PORTSTATE		= 10008;	///< ::Int32 0: not connected, 1: connected, 2: connected but muted, 4: error, 8: warning, 16: limitation.
static const Int32 DESCRIPTIONPROPERTY_EXTRABUTTON 	= 10009;	///< ::Int32 If an icon Id is defined, an extra button will be shown. The received action is: @ref BFM_ACTION_DP_EXTRABUTTONCLICK
static const Int32 	DESCRIPTIONPROPERTY_EXTRABUTTON_DUMMY = -1;	///< When this dummy icon ID is used with @ref DESCRIPTIONPROPERTY_EXTRABUTTON, the description property will show an space instead the button. Useful to e.g. keep text left aligned when used with related parameters, e.g. subchannels.
///<

static const Int32 DESCRIPTIONPROPERTY_PARENTMSG = 20000; ///< @markPrivate ::DescID
/// @}

static const Int32 SETTING_AUTOIDENT = 1;	///< ::Bool Indent text if animation symbol is visible.
static const Int32 SETTING_HEIGHT 	 = 2;	///< ::Bool Height.

/// @addtogroup BFM_ACTION_DP
/// @ingroup group_enumeration
/// @{
static const Int32 BFM_ACTION_DP_MENUCLICK				= 'menu';	///< ::Bool Right mouse button.
static const Int32 BFM_ACTION_DP_ADDSELECT				= 'adds';	///< ::Bool Shift.
static const Int32 BFM_ACTION_DP_SUBSELECT				= 'subs';	///< ::Bool Control.
static const Int32 BFM_ACTION_DP_FOCUS						= 'dpfc';	///< ::DescID Focus.
static const Int32 BFM_ACTION_DP_ANIMCLICK				= 'anim';	///< ::Bool Animation click.
static const Int32 BFM_ACTION_DP_BUTTONCLICK			= 'butt';	///< ::Int32 Special button (e.g. parent collapse).
static const Int32 BFM_ACTION_DP_EXTRABUTTONCLICK	= 'xbut';	///< ::Int32 Extra special button (e.g. subchannels toggle).
static const Int32 BFM_ACTION_QUAL								= 'qual';	///< ::Int32 Qualifier.
...
enum class DESCPROP
{
	...
	PARAMETER_DRIVEN	= (1 << 22)			///< Driven by Parameter Tag
...
// INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF
	...
	class CINEWARE_SINGLEINHERITANCE iDescriptionPropertyCustomGui : public iBaseCustomGui
	{
