...
enum
{
	LINKBOX_HIDE_ICON	= 40000,			///< ::Bool Hide the icon.
	LINKBOX_LAYERMODE	= 40001,			///< ::Bool Layer mode.
	LINKBOX_NODE_MODE	= 40002,			///< ::Bool Private - Node mode.
	LINKBOX_NO_PICKER	= 40003,			///< ::Bool No picker mode.
	LINKBOX_EMPTY_TEXT = 40004,			///< ::String Empty text.
};
/// @}
...
// INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF
	...
	class CINEWARE_SINGLEINHERITANCE iLinkBoxGui
	{
	};
#else
	class iLinkBoxGui;
