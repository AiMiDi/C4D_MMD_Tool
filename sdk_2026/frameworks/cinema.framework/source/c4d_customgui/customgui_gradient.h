...
#define GRADIENTPROPERTY_NOBRIGHTNESS				10007			///< ::Bool No Brightness parameter.
																											...
																											/// @endcode
#define GRADIENTPROPERTY_OVERRIDEEDITALPHA	10008			///< ::Bool Override Edit Alpha parameter of a gradient.
																											///< @note The property can not be used in a @em res file.
																											/// @code
																											/// @endcode
...
//-------------------------------------------------------------------------------------------------
class Gradient : public CustomDataTypeT<CUSTOMDATATYPE_GRADIENT>
{
private:
		Gradient();
		~Gradient();
...
public:
	...
	/// @copydoc Alloc
	static Gradient* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
#if !defined(_INTERNAL_DEF_) && !defined(PRIVATE_MAXON_REGISTRATION_UNIT)
	class CINEWARE_SINGLEINHERITANCE iGradientCustomGui
	{
	};
	class CINEWARE_SINGLEINHERITANCE iGradient
	{
	};
#else
...
struct CustomGuiGradientLib : public BaseCustomGuiLib
{
	...
	maxon::Result<maxon::GradientRenderData> (iGradient::*PrepareRenderData)(const InitRenderStruct& irs) const;
	maxon::Result<GradientRenderDataTuple> (iGradient::*PrepareRenderDataWithAlpha)(const InitRenderStruct& irs) const;

	Int32							(iGradient::*GetKnotCount)() const;

	Int32							(iGradient::*InsertKnot)(const maxon::GradientKnot &knot);
	Bool							(iGradient::*RemoveKnot)(Int32 index);

	maxon::GradientKnot			(iGradient::*GetKnot)(Int32 index) const;
	void							(iGradient::*SetKnot)(Int32 index, const maxon::GradientKnot &k);
	...
	maxon::Result<maxon::GradientRenderData> (iGradient::*PrepareRenderData2)() const;
	maxon::Result<GradientRenderDataTuple> (iGradient::*PrepareRenderDataWithAlpha2)() const;
};
