...
#define ITEMTREE_ID_ALTERNATE_BG							2019
#define ITEMTREE_ID_EMPTY_TEXT								2020
#define ITEMTREE_ID_NO_SELECT_IN_OM_FLAG			2021
#define ITEMTREE_ID_NO_COPYPASTEREPLACE_FLAG	2022
...
#define ITEMTREE_CALLBACK_GET_EMPTY_TEXT 30
...
#define ITEMTREE_MENU_COPY					cinema::ID_TREEVIEW_FIRST_NEW_ID
#define ITEMTREE_MENU_PASTE					(cinema::ID_TREEVIEW_FIRST_NEW_ID+1)
#define ITEMTREE_MENU_SELECT				(cinema::ID_TREEVIEW_FIRST_NEW_ID+2)
#define ITEMTREE_MENU_LOCK					(cinema::ID_TREEVIEW_FIRST_NEW_ID+3)
#define ITEMTREE_MENU_LOCK_ALL			(cinema::ID_TREEVIEW_FIRST_NEW_ID+4)
#define ITEMTREE_MENU_UNLOCK				(cinema::ID_TREEVIEW_FIRST_NEW_ID+5)
#define ITEMTREE_MENU_UNLOCK_ALL		(cinema::ID_TREEVIEW_FIRST_NEW_ID+6)
#define ITEMTREE_MENU_NEW_FOLDER		(cinema::ID_TREEVIEW_FIRST_NEW_ID+7)
#define ITEMTREE_MENU_REPLACE				(cinema::ID_TREEVIEW_FIRST_NEW_ID+8)
#define ITEMTREE_MENU_ENABLE				(cinema::ID_TREEVIEW_FIRST_NEW_ID+9)
#define ITEMTREE_MENU_ENABLE_ALL		(cinema::ID_TREEVIEW_FIRST_NEW_ID+10)
#define ITEMTREE_MENU_DISABLE_ALL		(cinema::ID_TREEVIEW_FIRST_NEW_ID+11)
#define ITEMTREE_MENU_DISABLE				(cinema::ID_TREEVIEW_FIRST_NEW_ID+12)
#define ITEMTREE_MENU_SELECT_ALL		(cinema::ID_TREEVIEW_FIRST_NEW_ID+13)
#define ITEMTREE_MENU_DESELECT_ALL	(cinema::ID_TREEVIEW_FIRST_NEW_ID+14)
#define ITEMTREE_MENU_FOLD					(cinema::ID_TREEVIEW_FIRST_NEW_ID+15)
#define ITEMTREE_MENU_UNFOLD				(cinema::ID_TREEVIEW_FIRST_NEW_ID+16)
#define ITEMTREE_MENU_HIDE					(cinema::ID_TREEVIEW_FIRST_NEW_ID+17)
#define ITEMTREE_MENU_UNHIDE				(cinema::ID_TREEVIEW_FIRST_NEW_ID+18)
#define ITEMTREE_MENU_UNHIDE_ALL		(cinema::ID_TREEVIEW_FIRST_NEW_ID+19)
#define ITEMTREE_MENU_HIDE_UNSELECTED (cinema::ID_TREEVIEW_FIRST_NEW_ID + 20)

#define ITEMTREE_MENU_CUSTOM (cinema::ID_TREEVIEW_FIRST_NEW_ID + 1000)


class ItemTreeNode;

class ItemTreeData : public CustomDataTypeT<CUSTOMDATA_ITEMTREE>
{
private:
	ItemTreeData();
	~ItemTreeData();
public:
	...
	maxon::Result<void> PrepareIndex();
	void ClearIndex();
};
...
class CINEWARE_SINGLEINHERITANCE iItemTreeData;
...
struct CustomGuiItemTreeLib : public BaseCustomGuiLib
{
	...
	UInt64							(iItemTreeData::*GetChecksum				)() const;
	...
	maxon::HashInt			(iItemTreeData::*GetHashCode        )(Bool onlyGuid) const;
	maxon::Result<void>	(iItemTreeData::*PrepareIndex				)();
	void								(iItemTreeData::*ClearIndex					)();
};
