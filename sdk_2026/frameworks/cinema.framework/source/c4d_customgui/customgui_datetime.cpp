...
{
	return CheckLib<DateTimechooserLib>(DATETIME_GUI, offset, lib_DateTime);
}

#define DateTimeCall(b) 			cinema::DateTimechooserLib *lib = cinema::CheckDateTimechooserLib(LIBOFFSET(cinema::DateTimechooserLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iDateTimeData*>(this)->*lib->b)

#define DateTimeCallR(a, b) 		cinema::DateTimechooserLib *lib = cinema::CheckDateTimechooserLib(LIBOFFSET(cinema::DateTimechooserLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iDateTimeData*>(this)->*lib->b)

#define DateTimeCallRC(a, b) 		cinema::DateTimechooserLib *lib = cinema::CheckDateTimechooserLib(LIBOFFSET(cinema::DateTimechooserLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iDateTimeData*>(this)->*lib->b)

#define DateTimeGuiCall(b) 		cinema::DateTimechooserLib *lib = cinema::CheckDateTimechooserLib(LIBOFFSET(cinema::DateTimechooserLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iDateTimeControl*>(this)->*lib->b)

#define DateTimeGuiCallR(a, b) cinema::DateTimechooserLib *lib = cinema::CheckDateTimechooserLib(LIBOFFSET(cinema::DateTimechooserLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iDateTimeControl*>(this)->*lib->b)

#define DateTimeGuiCallRC(a, b) cinema::DateTimechooserLib *lib = cinema::CheckDateTimechooserLib(LIBOFFSET(cinema::DateTimechooserLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iDateTimeControl*>(this)->*lib->b)

DateTime DateTimeControl::GetDateTime() const { DateTimeGuiCallRC(DateTime(), GetDateTimeGUI)(); }
...
DateTime DateTimeData::GetDateTime() const { DateTimeCallRC(DateTime(), GetDateTimeData)(); }
