...
#define ItemTreeCall(b)       cinema::CustomGuiItemTreeLib *lib = cinema::CheckItemTree(LIBOFFSET(cinema::CustomGuiItemTreeLib, b)); \
	if (!lib || !lib->b) return; \
	(reinterpret_cast<cinema::iItemTreeData*>(this)->*lib->b)

#define ItemTreeCallR(a, b)     cinema::CustomGuiItemTreeLib *lib = cinema::CheckItemTree(LIBOFFSET(cinema::CustomGuiItemTreeLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<cinema::iItemTreeData*>(this)->*lib->b)

#define ItemTreeCallRC(a, b)     cinema::CustomGuiItemTreeLib *lib = cinema::CheckItemTree(LIBOFFSET(cinema::CustomGuiItemTreeLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<const cinema::iItemTreeData*>(this)->*lib->b)

#define ItemTreeStaticCall(b)       cinema::CustomGuiItemTreeLib *lib = cinema::CheckItemTree(LIBOFFSET(cinema::CustomGuiItemTreeLib, b)); \
	if (!lib || !lib->b) return; \
	(lib->b)

#define ItemTreeStaticCallR(a, b)     cinema::CustomGuiItemTreeLib *lib = cinema::CheckItemTree(LIBOFFSET(cinema::CustomGuiItemTreeLib, b)); \
	if (!lib || !lib->b) return a; \
	return (lib->b)
...
maxon::Result<void> ItemTreeData::PrepareIndex() { ItemTreeCallR(maxon::OK, PrepareIndex)(); }
void ItemTreeData::ClearIndex() { ItemTreeCall(ClearIndex)(); }
} // namespace cinema
