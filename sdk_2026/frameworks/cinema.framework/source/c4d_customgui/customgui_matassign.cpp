...
#define MatAssignCall(b) 			cinema::CustomGuiMatAssignLib *lib = cinema::CheckGuiMatAssignLib(LIBOFFSET(cinema::CustomGuiMatAssignLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iMatAssignData*>(this)->*lib->b)

#define MatAssignCallR(a, b) 	cinema::CustomGuiMatAssignLib *lib = cinema::CheckGuiMatAssignLib(LIBOFFSET(cinema::CustomGuiMatAssignLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iMatAssignData*>(this)->*lib->b)

#define MatAssignCallRC(a, b) cinema::CustomGuiMatAssignLib *lib = cinema::CheckGuiMatAssignLib(LIBOFFSET(cinema::CustomGuiMatAssignLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iMatAssignData*>(this)->*lib->b)

#define MatAssignGuiCall(b) 		cinema::CustomGuiMatAssignLib *lib = cinema::CheckGuiMatAssignLib(LIBOFFSET(cinema::CustomGuiMatAssignLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iMatAssignCustomGui*>(this)->*lib->b)

#define MatAssignGuiCallR(a, b) cinema::CustomGuiMatAssignLib *lib = cinema::CheckGuiMatAssignLib(LIBOFFSET(cinema::CustomGuiMatAssignLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iMatAssignCustomGui*>(this)->*lib->b)

#define MatAssignTableCallR(a, b) 	cinema::CustomGuiMatAssignLib *lib = cinema::CheckGuiMatAssignLib(LIBOFFSET(cinema::CustomGuiMatAssignLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iMatAssignTable*>(this)->*lib->b)
