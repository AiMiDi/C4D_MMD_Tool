...
//----------------------------------------------------------------------------------------
class KerningData : public CustomDataTypeT<CUSTOMDATATYPE_KERNING>
{
public:
	...
	/// @copydoc Alloc
	static KerningData* Alloc(const maxon::SourceLocation&) { return Alloc(); }
...
// INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF
	...
	class CINEWARE_SINGLEINHERITANCE iKerningGui : public iBaseCustomGui
	{
		iKerningGui(const BaseContainer &settings, CUSTOMGUIPLUGIN *plugin) : iBaseCustomGui(settings, plugin) { }
	};
	class CINEWARE_SINGLEINHERITANCE iKerningData
	{
	};
	class CINEWARE_SINGLEINHERITANCE iKerningVpGuiHelper
	{
	};
#else
	class iKerningGui;
...
struct KerningLib : public BaseCustomGuiLib
{
	...
	Bool					(iKerningVpGuiHelper::*VpGuiHelper_Init)(const maxon::String& s, BaseContainer* generationresults, const KerningData* kd, Int32 plane);
