...
public:
	...
	//----------------------------------------------------------------------------------------
	Bool InsertObject(const BaseList2D* pObject, Int32 lFlags);
...
{
	Bool						(iIncludeExcludeData::*InsertObject)(const BaseList2D* pObject, Int32 lFlags);
	...
	const BaseContainer*	(iIncludeExcludeData::*GetDataC)(Int32 lIndex) const;
