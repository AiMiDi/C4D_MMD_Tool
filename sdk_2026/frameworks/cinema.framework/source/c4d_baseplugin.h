...
#define PLUGINFLAG_INTERNAL					(1 << 20)			///< Mark the plugin as internal to differentiate the plugins from 3rd party.
...
//-------------------------------------------------------------------------------------------------
class CINEWARE_SINGLEINHERITANCE BasePlugin : public BaseList2D
{
private:
	BasePlugin();
...
public:
	...
	//----------------------------------------------------------------------------------------
	BasePlugin* GetNext() { return (BasePlugin*)AtCall(GetNext)(); }
	...
	//----------------------------------------------------------------------------------------
	BasePlugin* GetPred() { return (BasePlugin*)AtCall(GetPred)(); }
	...
	//----------------------------------------------------------------------------------------
	BasePlugin* GetUp() { return (BasePlugin*)AtCall(GetUp)(); }
	...
	//----------------------------------------------------------------------------------------
	BasePlugin* GetDown() { return (BasePlugin*)AtCall(GetDown)(); }
	...
	//----------------------------------------------------------------------------------------
	BasePlugin* GetDownLast() { return (BasePlugin*)AtCall(GetDownLast)(); }
...
/// @since R19
//-------------------------------------------------------------------------------------------------
class CINEWARE_SINGLEINHERITANCE ToolPlugin : public BasePlugin
{
private:
	ToolPlugin();
	~ToolPlugin();
