...
public:
	...
	/// @copydoc Alloc
	static BaseShader* Alloc(const maxon::SourceLocation&, Int32 type) { return Alloc(type); }
	...
	//----------------------------------------------------------------------------------------
	BaseShader* GetNext() { return (BaseShader*)AtCall(GetNext) (); }
	...
	//----------------------------------------------------------------------------------------
	BaseShader* GetPred() { return (BaseShader*)AtCall(GetPred) (); }
	...
	//----------------------------------------------------------------------------------------
	BaseShader* GetUp() { return (BaseShader*)AtCall(GetUp) (); }
	...
	//----------------------------------------------------------------------------------------
	BaseShader* GetDown() { return (BaseShader*)AtCall(GetDown) (); }
	...
	//----------------------------------------------------------------------------------------
	BaseShader* GetDownLast() { return (BaseShader*)AtCall(GetDownLast) (); }
	...
	//-------------------------------------------------------------------------------------------------
	void FreeRender() { PsBaCall(FreeRender) (); }
	...
	//----------------------------------------------------------------------------------------
	BaseBitmap* GetBitmap() { return PsBaCall(GetBitmap) (); }
	...
	//----------------------------------------------------------------------------------------
	SHADERINFO GetRenderInfo() { return PsBaCall(GetRenderInfo) (); }
	...
	/// @extOpenGlMode
	//-------------------------------------------------------------------------------------------------
	void ProcessEditorPreviewImage(const ProcessEditorPreviewImageFn& fn) { PsBaCall(ProcessEditorPreviewImage)(fn); }
...
public:
	...
	/// @copydoc Alloc
	static BaseChannel* Alloc(const maxon::SourceLocation&) { return Alloc(); }
	...
	//----------------------------------------------------------------------------------------
	BaseBitmap* GetBitmap() { return C4DOS_Ba->BCGetBitmap(this); }
	...
	//----------------------------------------------------------------------------------------
	Vector Sample(VolumeData* vd, Vector* p, Vector* delta, Vector* n, Float t, Int32 tflag, Float off, Float scale) { return C4DOS_Ba->BcSample(this, vd, p, delta, n, t, tflag, off, scale); }
...
//----------------------------------------------------------------------------------------
inline Bool HandleShaderPopupI(BaseList2D* parent, BaseShader*& current, Int32 value, Int param) { return C4DOS_Ba->HandleShaderPopupI(parent, current, value, param); }

//-------------------------------------------------------------------------------------------------
/// @markPrivate
//-------------------------------------------------------------------------------------------------
inline Bool BuildShaderPopupMenuI(BaseContainer* menu, BaseList2D* parent, BaseShader* current, Int param) { return C4DOS_Ba->BuildShaderPopupMenuI(menu, parent, current, param); }
...
/// @return												@trueIfOtherwiseFalse{successful}
//----------------------------------------------------------------------------------------
inline Bool HandleShaderPopup(const BaseContainer& bc, const DescID& descid, Int32 value, Int param) { return C4DOS_Ba->HandleShaderPopup(bc, descid, value, param); }

//-------------------------------------------------------------------------------------------------
/// @markPrivate
//-------------------------------------------------------------------------------------------------
inline Bool BuildShaderPopupMenu(BaseContainer* menu, const BaseContainer& bc, const DescID& descid, Int param) { return C4DOS_Ba->BuildShaderPopupMenu(menu, bc, descid, param); }
...
//----------------------------------------------------------------------------------------
inline String GetChannelName(Int32 channelid) { return C4DOS_Ba->GetChannelName(channelid); }
