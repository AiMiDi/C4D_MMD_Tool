...
/// @markInternal
#define ReturnLong(v)		{ res_type = LV_RES_INT; result = (void*)(cinema::Int)(v); return; }
/// @markInternal
...
#define ReturnLong(v)		{ res_type = LV_RES_INT; result = (void*)(cinema::Int)(v); return; }
#define ReturnBitmap(v)	{ res_type = LV_RES_BITMAP; result = (void*)(v); return; }
#define ReturnString(v)	{ res_type = LV_RES_STRING; result = (void*)NewObjClear(cinema::String, v); return; }
#define ReturnNull()		{ res_type = LV_RES_NIL; result = nullptr; return; }
#define ReturnVector(v)	{ res_type = LV_RES_VECTOR; result = (void*)NewObjClear(cinema::Vector, v); return; }
