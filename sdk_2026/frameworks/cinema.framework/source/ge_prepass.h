...
#define OBJECT_CUSTOM_NAME_ADDITION			 (1 << 20) ///< Specify that an object implement MSG_GETCUSTOM_NAME_ADDITION and this message should be called from the Object Manager to retrieve its custom additional name.
#define OBJECT_POTENTIALLY_GLOBALSPACEMODIFIER	(1 << 21)			///< This triggers a call to the callback message MSG_REQUESTISGLOBALSPACEMODIFIER. This can be returned true to indicate global position of an object to be relevant for the deformer result.
/// @}
...
#define Ofpbasicemitter		1061200			///< fp Shape Emitter
#define Ofpmeshemitter		1062577			///< fp Mesh Emitter
...
#define Oliquidmesh				1064613			///< liquid mesh object.
#define Ofpliquidhoseemitter	1066159			///< fp Liquid Hose Emitter
...
#define Ovolumecachelayer	1050456			///< Volume Cache Layer:
#define Osimulationscene	1057221			///< Simulation Scene.
#define Opyro							1059580			///< Pyro Object. @since 2023.100
#define Opython					  1023866			///< Python Generator object. @since 2024.0
#define Oremesh						1054750			///< Remesh:
#define SKY_OBJECT				1011146			///< Sky object ID.
#define Onodedistribution	190000011		///< Node Distribution. @since 2026.0.0

#define ID_SIMULATIONSCENE_HOOK	1057220	///< Simulation Scene Hook - this is where e.g. the default simulation scene of type Osimulationscene lives

// MoGraph generators
#define Omgsplinegen				440000054	///< MoSpline Generator.
#define Omgcloner						1018544		///< Cloner.
#define Omgfracture					1018791		///< Fracture.
#define Omgmatrix						1018545		///< Matrix.
#define Omginstance					1018957		///< MoInstance.
...
#define Omgpolyfx					1019222			///< PolyFX.

// MoGraph effectors
#define Omgdelay					1019234			///< Delay Effector.
#define Omgplain					1021337			///< Plain Effector.
#define Omginheritance		1018775			///< Inheritance Effector.
#define Omgformula				1018883			///< Formula Effector.
#define Omgspline					1018774			///< Spline Effector.
#define Omgpushapart			440000219		///< Push Apart Effector.
#define Omgpython					1025800			///< Python Effector.
#define Omgrandom					1018643			///< Random Effector.
#define Omgshader					1018561			///< Shader Effector.
#define Omgvolume					1021287			///< Volume Effector.
#define Omgeffectortarget	1018889			///< Target Effector.
#define Omgreeffector			440000234		///< ReEffector Effector.
#define Omgsound					440000255		///< Sound Effector.
#define Omgstep						1018881			///< Step Effector.
#define Omgtime						1018935			///< Time Effector.
...
static const Int32 Xnbm = 300001079;
static const Int32 Xnodeviewport = 1050994;
static const Int32 XstandardSpaceActivity = 1051374;
...
#define Talembic					1036433				///< Alembic tag.
...
#define Tfielddriver				1062953		///< Field Driver Tag @b Since 2025
...
#define Tinitialstate					1066317		///< Tag plugin 'Initial State'. @PublicExposure
...
#define Tjointsettings			1061976   ///< Tag plugin 'Joint settings'. @PublicExposure
/// @}
...
#define MCOMMAND_SPLIT										220			///< Split: @enumerateEnum{MDATA_SPLIT_KEEPPOLYGONS}
...
#define MDATA_SPLIT_KEEPPOLYGONS 									2029			///< ::Bool Keep Polygons in Source Object.
...
#define MDATA_JOIN_MERGE_CREATEALL								2168			///< ::Bool Create Poly and Spline and Volume result
...
#define WPREF_DRAGCLONEAT				1065786		///< ::Int32 Clone by dragging object at.
...
#define WPREF_NAVIGATION_CTRLCMD_MODIFIER 1065917    ///< ::Int32 functionality of ctrl/cmd key in viewport perspective mode during rotation
#define WPREF_NAVIGATION_CTRLCMD_TRACKBALL  1065918  ///< ::use ctrl/cmd key to temporarily switch between trackball or normal rotation This is the default behavior before 2026.1. @since 2026.1.
#define WPREF_NAVIGATION_CTRLCMD_ORTHOGONAL 1065919  ///< ::use ctrl/cmd key to snap perspective view to closet orthogonal view. This is new default behavior after 2026.1. @since 2026.1
...
/// @ingroup group_enumeration
/// @{
#define WPREF_DEFAULT_SCENE_BLANK			0		///< An empty scene.
#define WPREF_DEFAULT_SCENE_CUSTOM		1		///< A user-defined scene. @see WPREF_DEFAULT_SCENE_CUSTOM_FILE
...
#define WPREF_MOUSE_TOUCHSUPPORT											21090 ///< ::Int32 @Psince R22
...
#define WPREF_IMEXPORT_NODESPACE_STRINGIFIED_ID				21093 ///< String @since 2024
#define WPREF_IMEXPORT_VERIFY_SCRIPT									21094 ///< Determines the actions on loading a document which contains Python code (Int32). @since 2024
#define WPREF_IMEXPORT_VERIFY_SCRIPT_NEVER								0 ///< Used for always loading documents without asking the user, regardless if they contain Python code or not.
#define WPREF_IMEXPORT_VERIFY_SCRIPT_ONCE									1 ///< Used for permanently storing a user choice if a given document can be loaded safely when the decision has been made once.
#define WPREF_IMEXPORT_VERIFY_SCRIPT_ALWAYS								2 ///< Used for always asking the user for confirmation upon encountering files containing Python code.
#define WPREF_IMEXPORT_OCIO_IMPORT_MODE		21093			///< Int32 @since 2024.2
...
#define WPREF_UI_SPACING									23002			///< Int32 The size and spacing of the UI elements. @since 2026.1.0
#define WPREF_UI_SPACING_COMPACT						0			///< Int32 Compact size. @since 2026.1.0
#define WPREF_UI_SPACING_MEDIUM							1			///< Int32 Medium size. @since 2026.1.0
#define WPREF_UI_SPACING_COMFORTABLE				2			///< Int32 Comfortable size @since 2026.1.0
...
#define WPREF_PROFILER_MODE 189001000		///< ::Int Profiling manager mode. @since 2025.0
#define WPREF_PROFILER_UNIT 189001100		///< ::Int Profiling manager unit. @since 2025.0
#define WPREF_PROFILER_OM 189001200			///< ::Bool Show profiling results in object manager. @since 2025.0
...
#define EVMSG_TOOLCHANGED						cinema::Int32(0xfff36465)	///< A tool setting has changed (local event).
...
#define EVMSG_NE_UPDATE_MAINAM			465002371			///< @markPrivate

static constexpr Int32 EVMSG_RECENT_DOCS_CHANGED = 1063803;
...
/// @addtogroup DISPLAYCONTROL_MODE
/// @ingroup group_enumeration
/// @{
enum class DISPLAYCONTROL_MODE : UChar
{
	PER_OBJECT = 0,							///< Color is per object.
	PER_VERTEX = 1,							///< Color is per vertex.
	PER_POLYGON_PER_VERTEX = 2,	///< COlor is per vertex per polygon.
} MAXON_ENUM_FLAGS(DISPLAYCONTROL_MODE);
/// @}
...
#define VIEWCOLOR_UV_BOUNDARIES															125
#define VIEWCOLOR_MAXCOLORS																	126
/// @}
...
enum class BUILDFLAGS : UInt16
{
	...
	PREROLL								= (1 << 7),			///< When rendering externally, this is for prerolling pass
...
enum class EXECUTIONFLAGS
{
	...
	PREROLL_PASS							= (1 << 22),					///< When rendering with external renderer, passed to preroll frames into scenehook and object execution calls
...
#define FORMAT_AIIMPORT					1001045			///< Adobe Illustrator AI 8 import.
#define FORMAT_AIPDFIMPORT			1059752			///< Adobe Illustrator AI CC import.
...
#define FORMAT_AI_EXPORT				1012074			///< Adobe Illustrator AI 8 export.
...
#define FORMAT_USDIMPORT				1055178			///< USD import. @since R23
#define FORMAT_USDEXPORT				1055179			///< USD export. @since R23
#define FORMAT_GOZIMPORT				1053589			///< goz import. @since R22
#define FORMAT_SBSAR_IMPORT			1062093			///< Substance import. @since R2024.2
#define FORMAT_GOZEXPORT				1063475			///< GoZ export. @since 2026.1.0
#define FORMAT_GOZIPEXPORT			1063476			///< @markPrivate GoZip export. @since 2026.1.0
#define FORMAT_GOZIPIMPORT			1063477			///< @markPrivate GoZip import. @since 2026.1.0
...
enum class USERAREAFLAGS
{
	...
	NOHANDLEFOCUS	= (1 << 4),			///< The user area won't get the focus, this means it still can receive mouse events but not keyboard events, since these are only received by the element that has the focus. Can be useful in certain cases, for example to design a button that doesn't steal the focus when clicked (like palette icons work).
...
enum class VERSIONTYPE
{
	...
	AECVIEWER					= 16,			///< Maxon Redshift Viewer.
...
enum class DRAWOBJECT
{
	...
	USE_CUSTOM_SRGB_COLOR	= (1 << 18),			///< Use a custom sRGB color.
...
enum class SHADERINFO
{
	...
	WORLDSPACE				= 0x00000800			///< Channel shader is world space evaluated (i.e. a world 3d noise)
...
enum class DLG_TYPE
{
	...
	ASYNC_POPUP_MENU,								///< Non-modal (asynchronous) dialog. Popup dialog style with menu bar. It exhibits menu-like behavior, meaning it does not gain focus when opened, allowing the current focus to remain unchanged.
...
enum
{
	...
	DIALOG_EDITTEXTUD,										  ///< ::Int32 id, ::Int32 flags @since 2026.000
	DIALOG_
};
/// @}
...
#define EDITTEXT_SEARCHLOOK							(1 << 6) ///< Specifies that the edit field adopts a distinct appearance optimized for search or filtering purposes. This includes a magnifying glass icon on the left and a clear button on the right. @since 2026.000
/// @}
...
/// @ingroup group_enumeration
/// @{
/// Cinema API Scene Nodes related IDs. @since R23
...
static const Int32 CUSTOMDATATYPE_RSFILE = 1036765;
#define PORTBUNDLE_FILE_COLORSPACE "colorspace"

/// @addtogroup GETACTIVEUVWOBJECTSMODE
/// @ingroup group_enumeration
/// @{
/// @see BaseDocument::GetActiveUVWObjects
enum class GETACTIVEUVWOBJECTSMODE
{
	EDITABLE = 0,		///< UV objects that can be edited / modified. 
	VISIBLE = 1			///< Objects visible in the texture view / UV editor. 
} MAXON_ENUM_LIST(GETACTIVEUVWOBJECTSMODE);
/// @}
