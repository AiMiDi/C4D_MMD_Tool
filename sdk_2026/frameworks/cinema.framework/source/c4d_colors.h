...
enum
{
	...
	COLOR_SECTION_OVERLAY_OFFSET = 10000,		// offset to all overlay colors between COLOR_SECTION_BEGIN and COLOR_SECTION_END
	COLOR_SECTION_BEGIN = 1000,							// start of all individual colors
	...
	COLOR_EDGEDK					= 1007,
	COLOR_EDGEBL					= 1008,
	EX_COLOR_DBARFG1			= 1009,
	EX_COLOR_DBARBG1			= 1010,
	EX_COLOR_DBARFG2			= 1011,
	EX_COLOR_DBARBG2			= 1012,
	COLOR_BGGADGET				= 1013,
	...
	EX_COLOR_FG_MM_C_ACTIVE_LAYER_ACT_TEX,
	EX_COLOR_FG_MM_C_ACTIVE_LAYER_INACT_TEX,
	...
	EX_COLOR_CONTENTBROWSER_TEXT,
	COLOR_BROWSER_BACKGROUND_SELECTED_LARGE,
	EX_COLOR_CONTENTBROWSER_BG_TEXT_INACT,
	COLOR_BROWSER_TEXT_SELECTED,
	EX_COLOR_CONTENTBROWSER_FG_TEXT_INACT,
	EX_COLOR_CONTENTBROWSER_NOTAVAILABLE,
	...
	EX_COLOR_BG_GROUP2,
	COLOR_POWERSOUND,
	EX_COLOR_BG_GROUPBAR1,
	EX_COLOR_BG_GROUPBAR2,
	...
	EX_COLOR_DOTTED_LINE,
	EX_COLOR_DOTTED_LINE_DISABLED,
	...
	COLOR_HORIZONTAL_SEPARATOR,

	COLOR_BROWSER_PREVIEW_BG,
	COLOR_BROWSER_BACKGROUND_MOUSEOVER,
	COLOR_BROWSER_BACKGROUND_SELECTED_SMALL,

	COLOR_TEXT_SHORTCUT,
	COLOR_TEXT_SHORTCUT_DISABLED,

	COLOR_STATUSBAR,

	COLOR_HIERARCHY_LINES,

	COLOR_POWERSLIDER_HORIZONTAL_SEPARATOR,

	COLOR_QUICKTAB_BG_INACTIVE_DISABLED,
	COLOR_QUICKTAB_BG_ACTIVE_DISABLED,

	COLOR_BROWSER_BACKGROUND_MOUSEOVER_SELECTED,

	COLOR_KEYFRAMEDOT_DEFAULT,
	COLOR_KEYFRAMEDOT_ANIMATED,
	COLOR_KEYFRAMEDOT_ANIMATED_CHANGED,
	COLOR_KEYFRAMEDOT_BRUSH_EFFECTOR,

	COLOR_FIELDS_LINKED_OBJECT_ERROR,
	COLOR_FIELDS_NON_CRITICAL_ERROR,
	...
	COLOR_BG_GROUP_ROUNDED,

	COLOR_BG_BUTTON,
	COLOR_BG_BUTTON_HIGHLIGHTED,
	COLOR_BG_BUTTON_DISABLED,
	COLOR_TEXT_BUTTON_EMPHASIZED,
	COLOR_BG_BUTTON_EMPHASIZED,
	COLOR_BG_BUTTON_EMPHASIZED_HIGHLIGHTED,
	COLOR_TEXT_BUTTON_DIMMED,
	COLOR_BG_BUTTON_DIMMED,

	COLOR_KEYFRAMEDOT_FIELD_DRIVEN,

	COLOR_BG_C4DHOME,

	COLOR_SLIDER_BG_NORMAL,
	COLOR_SLIDER_BG_FOCUS,
	COLOR_SLIDER_BG_DISABLED,

	COLOR_SLIDER_OVERFLOW_NORMAL,
	COLOR_SLIDER_OVERFLOW_FOCUS,
	COLOR_SLIDER_OVERFLOW_DISABLED,

	COLOR_BG_GROUP_ROUNDED_OUT,

	COLOR_PROGRESSBAR_BG,

	COLOR_PALETTE_ICON_ACTIVE,

	COLOR_BROWSER_BACKGROUND,

	COLOR_SCENES_AND_LAYOUTS_TABS_BAR_BACKGROUND,
	COLOR_SCENES_AND_LAYOUTS_TABS_LAYOUT_ACTIVE_INDICATOR,
	COLOR_SCENES_AND_LAYOUTS_TABS_LAYOUT_ACTIVE_TEXT_COLOR,
	COLOR_SCENES_AND_LAYOUTS_TABS_LAYOUT_INACTIVE_TEXT_COLOR,

	COLOR_BROWSER_TEXT_MOUSEOVER,
	COLOR_BROWSER_TEXT_MOUSEOVER_SELECTED,

	COLOR_BG_COMBO,
	COLOR_BG_COMBO_FOCUS,
	COLOR_BG_COMBO_DISABLED,

	COLOR_SECTION_END, // end of all individual colors
};
