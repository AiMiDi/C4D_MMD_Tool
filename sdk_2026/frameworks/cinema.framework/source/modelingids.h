...
#define ID_MODELING_SEAM_SELECTION_TOOL											1066250				///< Seam selection tool. See seamselectiontool.h
...
#define ID_MODELING_PATTERN_TOOL														1060498				///< Pattern selection tool.
...
#define ID_MEASURE_TOOL																			1011182				///< Measure tool. See toolmeasure.h
																																					///< @note This tool cannot be used with SendModelingCommand().
#define ID_MODELING_FITCIRCLE_TOOL													1058461				///< Fit Circle tool. See toolfitcircle.h
#define ID_MODELING_EDGESMOOTH_TOOL													1058499				///< Edge Smooth tool. See tooledgesmooth.h
#define ID_MODELING_SETEDGEFLOW_TOOL												1058529				///< Set Edge Flow tool. See toolsetedgeflow.h
#define ID_MODELING_SETEDGESLINEAR_TOOL                     1058543       ///< Set Edges linear tool. See toolsetedgeslinear.h
#define ID_MODELING_EVENSPACING_TOOL                        1058592       ///< Set Even Spacing tool. See toolsetevenspacing.h
...
#define ID_MODELING_ATTRIBUTETRANSFER_COMMAND               1060715       ///< Attribute Transfer Command. See toolattributetransfer.h

#define ID_MODELING_NORMALS_ALIGNTOPOLYGON                  1060649       ///< Normal Editing Commands.
#define ID_MODELING_NORMALS_ALIGNTOVERTEX                   1060656       ///< Normal Editing Commands.
#define ID_MODELING_NORMALS_FLIP                            1060650       ///< Normal Editing Commands.
#define ID_MODELING_NORMALS_SETVALUE                        1060657       ///< Normal Editing Commands.
#define ID_MODELING_NORMALS_COPYFROMSELECTED                1060664       ///< Normal Editing Commands.
#define ID_MODELING_NORMALS_COPYTOSELECTED                  1060665       ///< Normal Editing Commands.
#define ID_MODELING_NORMALS_COPYFROMPHONG                   1060666       ///< Normal Editing Commands. Currently not used
...
#define ID_MODELING_SOFTSELECTION_TOGGLE_CMD								1057360				///< Command to toggle Soft Selection. @since R25
...
/// @ingroup group_enumeration
/// @{
#define ID_TOGGLE_PRESERVE_UV_COMMAND 1066202		///< Toggle Preserve UV Command.
#define ID_UVTOOL_BASE								1066099		///< @markPrivate Base UV Tool. See uvtoolbase.h
																								///< @note This tool cannot be used with SendModelingCommand().
#define ID_UVTOOL_BASE_TOGGLE_CMD			1066103		///< @markPrivate Toggle Base UV Tool Dialog.
/// @}
