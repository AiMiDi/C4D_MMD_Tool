...
class CINEWARE_SINGLEINHERITANCE Neighbor;
...
public:
	...
	{
		return reinterpret_cast<const Int32*>(this)[index & 3];
	}
	Int32& operator[](Int32 index)
	{
		return reinterpret_cast<Int32*>(this)[index & 3];
	}
	...
	{
		p1 = reinterpret_cast<const Int32*>(this)[edge & 3];
		p2 = reinterpret_cast<const Int32*>(this)[(edge + 1) & 3];
	}
	...
	{
		if (c == d)
			return reinterpret_cast<const Int32*>(this)[(index + (3 << 24)) % 3];
		return reinterpret_cast<const Int32*>(this)[index & 3];
	}

	Int32& GetPoint(Int32 index)
	{
		if (c == d)
			return reinterpret_cast<Int32*>(this)[(index + (3 << 24)) % 3];
		return reinterpret_cast<Int32*>(this)[index & 3];
	}
	...
	{
		return maxon::Block<const Int32>(&a, c == d ? 3 : 4);
	}
};
...
struct Tangent
{
	...
	//----------------------------------------------------------------------------------------
	Bool IsBroken() const { return Dot(!vl, !vr) > -1.0 + EPSILON; }
};
...
//----------------------------------------------------------------------------------------
class CINEWARE_SINGLEINHERITANCE BaseObject : public BaseList2D
{
private:
	BaseObject();
	~BaseObject();
...
public:
	...
	/// @copydoc Alloc
	static BaseObject* Alloc(const maxon::SourceLocation&, Int32 type) { return Alloc(type); }
	...
	const BaseObject* GetNext() const { return (BaseObject*)AtCall(GetNext) (); }
	...
	const BaseObject* GetPred() const { return (BaseObject*)AtCall(GetPred) (); }
	...
	const BaseObject* GetUp() const { return (BaseObject*)AtCall(GetUp) (); }
	...
	const BaseObject* GetDown() const { return (BaseObject*)AtCall(GetDown) (); }
	...
	const BaseObject* GetDownLast() const { return (BaseObject*)AtCall(GetDownLast) (); }
	...
	//----------------------------------------------------------------------------------------
	void CopyMatrixTo(BaseObject* dst) const { C4DOS_Bo->CopyMatrixTo(this, dst); }
	...
	//----------------------------------------------------------------------------------------
	Vector GetMp() const { return C4DOS_Bo->GetMp(this); }
	...
	//----------------------------------------------------------------------------------------
	Vector GetRad() const { return C4DOS_Bo->GetRad(this); }
	...
	{
		return BoCall(GetDimension)(mp, rad);
	}
	...
	{
		return C4DOS_Bo->GetMode(this, OBJECTSTATE::EDITOR);
	}
	...
	{
		return C4DOS_Bo->GetMode(this, OBJECTSTATE::EDITOR_HIERARCHICAL);
	}
	...
	{
		return C4DOS_Bo->GetMode(this, OBJECTSTATE::RENDER);
	}
	...
	{
		return C4DOS_Bo->GetMode(this, OBJECTSTATE::RENDER_HIERARCHICAL);
	}
	...
	{
		return C4DOS_Bo->GetMode(this, OBJECTSTATE::DEFORM) != 0;
	}
	...
	{
		return C4DOS_Bo->GetMode(this, OBJECTSTATE::REAL_DEFORM);
	}
	...
	BaseTag* GetFirstTag()
	{
		return C4DOS_Bo->GetFirstTag(this);
	}

	const BaseTag* GetFirstTag() const
	{
		return C4DOS_Bo->GetFirstTag(MAXON_REMOVE_CONST(this));
	}
	...
	BaseTag* GetLastTag()
	{
		return C4DOS_Bo->GetLastTag(this);
	}

	const BaseTag* GetLastTag() const
	{
		return C4DOS_Bo->GetLastTag(MAXON_REMOVE_CONST(this));
	}
	...
	//----------------------------------------------------------------------------------------
	BaseTag* GetTag(Int32 type, Int32 nr = 0) { return C4DOS_Bo->GetTag(this, type, nr); }
	const BaseTag* GetTag(Int32 type, Int32 nr = 0) const { return C4DOS_Bo->GetTag(MAXON_REMOVE_CONST(this), type, nr); }
	...
	//----------------------------------------------------------------------------------------
	maxon::Block<const BaseTag* const> GetTagsOfType(Int32 type) const { return BoCall(GetTagsOfType)(type); }
	#define ID_TAGSOFTYPE_HASORIGIN 1060233 ///< returns all tags which have return a value with GetOrigin()

	/// @copydoc GetTagsOfType
	maxon::Block<BaseTag* const> GetTagsOfType(Int32 type) { maxon::Block<const BaseTag* const> tags = static_cast<const BaseObject*>(this)->GetTagsOfType(type); return reinterpret_cast<const maxon::Block<BaseTag* const>&>(tags); }
	...
	//----------------------------------------------------------------------------------------
	const void* GetTagDataR(Int32 type, Int32 nr = 0) const { return C4DOS_Bo->GetTagDataR(this, type, nr); }
	...
	//----------------------------------------------------------------------------------------
	void* GetTagDataW(Int32 type, Int32 nr = 0) { return C4DOS_Bo->GetTagData(this, type, nr); }
	...
	//----------------------------------------------------------------------------------------
	Int32 GetTagDataCount(Int32 type) const { return C4DOS_Bo->GetTagDataCount(this, type); }

	//----------------------------------------------------------------------------------------
	/// Gets the copy-on-write reference to the data of a variable tag of a certain type associated with the object.
	/// @param[in] type								The type of tag to fetch the data for: @enumerateEnum{VariableTagTypes}
	/// @param[in] nr									Optionally specify a starting tag index to begin the search.
	/// @return												A reference to the variable tag's data, a null reference if there's no such variable tag.
	//----------------------------------------------------------------------------------------
	const VariableTagDataRef<>& GetVariableTagData(Int32 type, Int32 nr = 0) const { return C4DOS_Bo->GetVariableTagData(this, type, nr); }
	...
	//----------------------------------------------------------------------------------------
	BaseObject* GetCache() { return C4DOS_Bo->GetCache(this); }

	/// @copydoc GetCache
	const BaseObject* GetCache() const { return const_cast<BaseObject*>(this)->GetCache(); }
	...
	/// @see Hierarchy if a plugin needs access to pre-built caches.
	//----------------------------------------------------------------------------------------
	BaseObject* GetDeformCache() { return C4DOS_Bo->GetDeformCache(this); }

	/// @copydoc GetDeformCache
	const BaseObject* GetDeformCache() const { return const_cast<BaseObject*>(this)->GetDeformCache(); }
	...
	/// @see Hierarchy if a plugin needs access to pre-built caches.
	//----------------------------------------------------------------------------------------
	LineObject* GetIsoparm() { return C4DOS_Bo->GetIsoparm(this); }
	...
	{
		return C4DOS_Bo->GetCacheParent(this);
	}
	...
	{
		return C4DOS_Bo->GetCacheTopParent(this);
	}
	...
	//----------------------------------------------------------------------------------------
	Bool IsDirty(DIRTYFLAGS flags) const { return C4DOS_Bo->IsDirty(this, flags); }
	...
	//----------------------------------------------------------------------------------------
	Bool CheckCache(const HierarchyHelp* hh) const { return C4DOS_Bo->CheckCache(this, hh); }
	...
	//----------------------------------------------------------------------------------------
	void GetColorProperties(ObjectColorProperties* prop) const { C4DOS_Bo->GetColorProperties(this, prop); }
	...
	//----------------------------------------------------------------------------------------
	void SetColorProperties(ObjectColorProperties* prop) { C4DOS_Bo->SetColorProperties(this, prop); }
	...
	//----------------------------------------------------------------------------------------
	/// Returns the selected display color of the object as 32 bit color.
	/// @return												Res.HasValue() if the color should be used. Otherwise no color is set (see ID_BASEOBJECT_USECOLOR_OFF).
	//----------------------------------------------------------------------------------------
	maxon::Opt<maxon::Color32> GetDisplayColor32() const { return BoCall(GetDisplayColor32)(); }
	/// @}
	...
	//----------------------------------------------------------------------------------------
	const Matrix& GetModelingAxis(BaseDocument* doc) { return C4DOS_Bo->GetModelingAxis(this, doc); }
	...
	//----------------------------------------------------------------------------------------
	void SetModelingAxis(const Matrix& m) { C4DOS_Bo->SetModelingAxis(this, m); }
	...
	/// @param[in] trans							An alias translator for the operation. Can be @formatConstant{nullptr}. @callerOwnsPointed{alias translator}
	/// @param[in] childCount					Maximum number of children to check (starting at the first child).
	/// 															With a negative value the function checks exactly one child and doesn't create a parent Null object for the clones.
	/// @param[in] children						An optional array where the generated clones are added. For each child there will be one entry,
	/// 															even if no clone is generated for that child (then the entry will be nullptr or the child depending on addChildOrClone). Note that this array
	/// 															gets filled only in the dirty case.
	/// @param[in] addChildOrClone		When true, the original child will be added to children instead of a nullptr in the case of a child which doesn't generate a clone.
	...
	{
		return GetAndCheckHierarchyClone(hh, op, flags, dirty, trans, allchildren ? LIMIT<Int>::MAX : -1, nullptr, false);
	}
	...
	//----------------------------------------------------------------------------------------
	Bool IsQuaternionRotationMode() const { return BoCall(IsQuaternionRotationMode) (); }
	...
	//----------------------------------------------------------------------------------------
	UInt64 GetGUID() const { return C4DOS_Bo->GetGUID(this); }
	...
	//----------------------------------------------------------------------------------------
	Int32 GetHighlightHandle(BaseDraw* bd) { return C4DOS_Bo->GetHighlightHandle(this, bd); }
	...
	const SplineObject* GetRealSpline() const { return MAXON_REMOVE_CONST(this)->GetRealSpline(); }
	...
	//----------------------------------------------------------------------------------------
	Bool SearchHierarchy(const BaseObject* op) const { return C4DOS_Bo->SearchHierarchy(this, op); }
	...
	/// @markPrivate
	//----------------------------------------------------------------------------------------
	maxon::Tuple<Bool, maxon::HashInt> GetObjectDrawHash(Int32 type) const {return BoCall(GetObjectDrawHash)(type); }

	//----------------------------------------------------------------------------------------
	/// @markPrivate
	//----------------------------------------------------------------------------------------
	void GetDrawStateData(DrawStateData& state) const { BoCall(GetDrawStateData)(state); }
	/// @}

	//----------------------------------------------------------------------------------------
	/// Gets the deformation matrix.
	/// @return												The matrix that deforms the local matrix.
	//----------------------------------------------------------------------------------------
	const Matrix& GetDeformMatrix() const { return BoCall(GetDeformMatrix) (); }

	//----------------------------------------------------------------------------------------
	/// Sets the deformation of the local matrix.
	/// @param[in] dm									The matrix that deforms the local matrix.
	//----------------------------------------------------------------------------------------
	void SetDeformMatrix(const Matrix& dm) { BoCall(SetDeformMatrix) (dm); }

	//----------------------------------------------------------------------------------------
	/// Clears the deformation of the local matrix.
	//----------------------------------------------------------------------------------------
	void ClearDeformMatrix() { BoCall(ClearDeformMatrix) (); }
	...
	//----------------------------------------------------------------------------------------
	Bool HasDeformMatrix() const { return BoCall(HasDeformMatrix) (); }


#if API_VERSION >= 2027000
#error Add a parameter checkName into InsertTag with false as default value. InsertTag(....,  Bool checkName = false). And remove this InsertTagCheckName
#endif
	//----------------------------------------------------------------------------------------
	/// Same as InsertTag, but if the tag was registered with TAG_MULTIPLE and a same type of tag with the same name exists, it will check and rename the tag.
	/// For example, if you call InsertTagCheckNames twice to create 2 vertex colors tag, it will become to `vertex color`, `vertex color.1`
	/// @param[in] tp									The tag to insert. The object takes over the ownership of the pointed tag.
	/// @param[in] pred								The previous tag to insert the tag after, or @formatConstant{nullptr} if the tag should be inserted at the start of the tag list. @callerOwnsPointed{tag}
	//----------------------------------------------------------------------------------------
	void InsertTagCheckName(BaseTag* tp, BaseTag* pred = nullptr);
};
...
public:
	...
	/// @copydoc Alloc
	static CameraObject* Alloc(const maxon::SourceLocation&) { return Alloc(); }
	...
	//----------------------------------------------------------------------------------------
	Int32 StereoGetCameraCount(const BaseDocument* doc, BaseDraw* bd, RenderData* rd, Int32 flags) const;
	...
	//----------------------------------------------------------------------------------------
	Bool StereoGetCameraInfo(const BaseDocument* doc, BaseDraw* bd, RenderData* rd, Int32 n, StereoCameraInfo& info, Int32 flags) const;
...
public:
	...
	//----------------------------------------------------------------------------------------
	BaseSelect* GetWritablePointH();

	//----------------------------------------------------------------------------------------
	/// Gets the hidden points.
	/// @return												The hidden points. @theOwnsPointed{point object,base select}
	//----------------------------------------------------------------------------------------
	const BaseSelect* GetPointH() const;
	...
	//----------------------------------------------------------------------------------------
	const Vector* GetPointR() const { return static_cast<const Vector*>(GetTagDataR(Tpoint)); }
	...
	//----------------------------------------------------------------------------------------
	Vector* GetPointW() { return static_cast<Vector*>(GetTagDataW(Tpoint)); }
	...
	//----------------------------------------------------------------------------------------
	/// Gets the copy-on-write reference to the point array data.
	/// @return												A reference to the point data.
	//----------------------------------------------------------------------------------------
	const VariableTagDataRef<Vector>& GetPointData() const { return reinterpret_cast<const VariableTagDataRef<Vector>&>(GetVariableTagData(Tpoint)); }
	...
	//----------------------------------------------------------------------------------------
	Float32* CalcVertexMap(const BaseObject* modifier) const;
...
public:
	...
	/// @copydoc Alloc
	static LineObject* Alloc(const maxon::SourceLocation&, Int32 pcnt, Int32 scnt) { return Alloc(pcnt, scnt); }
	...
	/// @copydoc Free
	static void Free(const LineObject*& bl)
	{
		Free(const_cast<LineObject*&>(bl));
	}
	...
	//----------------------------------------------------------------------------------------
	const Segment* GetSegmentR() const { return static_cast<const Segment*>(GetTagDataR(Tsegment)); }
	...
	//----------------------------------------------------------------------------------------
	Segment* GetSegmentW() { return static_cast<Segment*>(GetTagDataW(Tsegment)); }

	//----------------------------------------------------------------------------------------
	/// Gets the number of segments.
	/// @return												The number of elements in the segments array.
	//----------------------------------------------------------------------------------------
	Int32 GetSegmentCount() const { return GetTagDataCount(Tsegment); }
	...
	//----------------------------------------------------------------------------------------
	const CLine* GetLineR() const { return static_cast<const CLine*>(GetTagDataR(Tline)); }
	...
	//----------------------------------------------------------------------------------------
	CLine* GetLineW() { return static_cast<CLine*>(GetTagDataW(Tline)); }
	...
	//----------------------------------------------------------------------------------------
	PolygonObject* Triangulate(const BaseDocument* doc, Int runId, Float regular, BaseThread* bt);
...
public:
	...
	/// @copydoc Alloc
	static PolygonObject* Alloc(const maxon::SourceLocation&, Int32 pcnt, Int32 vcnt) { return Alloc(pcnt, vcnt); }
	...
	//----------------------------------------------------------------------------------------
	BaseSelect* GetWritablePolygonS();
	...
	//----------------------------------------------------------------------------------------
	BaseSelect* GetWritablePolygonH();
	...
	//----------------------------------------------------------------------------------------
	EdgeBaseSelect* GetWritableEdgeH();
	...
	//----------------------------------------------------------------------------------------
	EdgeBaseSelect* GetWritablePhongBreak();
	...
	//----------------------------------------------------------------------------------------
	const CPolygon* GetPolygonR() const { return static_cast<const CPolygon*>(GetTagDataR(Tpolygon)); }
	...
	//----------------------------------------------------------------------------------------
	CPolygon* GetPolygonW() { return static_cast<CPolygon*>(GetTagDataW(Tpolygon)); }
	...
	//----------------------------------------------------------------------------------------
	Int32 GetPolygonCount() const { return GetTagDataCount(Tpolygon); }

	//----------------------------------------------------------------------------------------
	/// Gets the copy-on-write reference to the polygon array data.
	/// @return												A reference to the polygon data.
	//----------------------------------------------------------------------------------------
	const VariableTagDataRef<CPolygon>& GetPolygonData() const { return reinterpret_cast<const VariableTagDataRef<CPolygon>&>(GetVariableTagData(Tpolygon)); }
	...
	//----------------------------------------------------------------------------------------
	BaseSelect* GetSelectedEdges(Neighbor* e, EDGESELECTIONTYPE ltype) const;
	...
	//----------------------------------------------------------------------------------------
	BaseSelect* GetSelectedEdges(Neighbor* e, const BaseSelect* sel) const;
	...
	//----------------------------------------------------------------------------------------
	Vector32* CreatePhongNormals() const;
	...
	//----------------------------------------------------------------------------------------
	/// @markDeprecated Use BuildNgon() and GetNgonBase()->GetNgon() / GetNgonBaseR()->GetNgonR().
	...
	/// @return												The N-gon base. @theOwnsPointed{Polygon object,NgonBase}
	//----------------------------------------------------------------------------------------
	const NgonBase* GetNgonBase() const;
	...
	//----------------------------------------------------------------------------------------
	/// Allocates the NgonBase instance for the object. 
	/// @return												@trueIfOtherwiseFalse{successful}
	//----------------------------------------------------------------------------------------
	Bool BuildNgon();

	//----------------------------------------------------------------------------------------
	/// Gets the read-only NgonBase instance for the object.
	/// @return												The N-gon base. @theOwnsPointed{Polygon object,NgonBase}
	//----------------------------------------------------------------------------------------
	const NgonBase* GetNgonBaseR() const;
...
public:
	...
	/// @copydoc Alloc
	static SplineLengthData* Alloc(const maxon::SourceLocation&) { return Alloc(); }
	...
	//----------------------------------------------------------------------------------------
	Bool Init(const SplineObject* op, Int32 segment = 0, const Vector* padr = nullptr);
...
public:
	...
	/// @copydoc Alloc
	static SplineObject* Alloc(const maxon::SourceLocation&, Int32 pcnt, SPLINETYPE type) { return Alloc(pcnt, type); }
	...
	//----------------------------------------------------------------------------------------
	Vector GetSplinePoint(Float t, Int32 segment = 0, const Vector* padr = nullptr) const;
	...
	//----------------------------------------------------------------------------------------
	Vector GetSplineTangent(Float t, Int32 segment = 0, const Vector* padr = nullptr) const;
	...
	//----------------------------------------------------------------------------------------
	const Tangent* GetTangentR() const { return static_cast<const Tangent*>(GetTagDataR(Ttangent)); }
	...
	//----------------------------------------------------------------------------------------
	Tangent* GetTangentW() { return static_cast<Tangent*>(GetTagDataW(Ttangent)); }

	//----------------------------------------------------------------------------------------
	/// Gets the number of tangents.
	/// @return												The tangent count.
	//----------------------------------------------------------------------------------------
	Int32 GetTangentCount() const { return GetTagDataCount(Ttangent); }
	...
	//----------------------------------------------------------------------------------------
	LineObject* GetLineObject(const BaseDocument* doc, Float lod, BaseThread* thread = nullptr) const;
...
template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE const PointObject* ToPoint(const T* op)
{
	DebugAssert(!op || op->IsInstanceOf(Opoint));
	return static_cast<const PointObject*>(op);
}

template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE PointObject* ToPoint(T* op)
{
	DebugAssert(!op || op->IsInstanceOf(Opoint));
	return static_cast<PointObject*>(op);
}

/// Casts a @ref BaseObject* to a @ref PolygonObject*.
template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE const PolygonObject* ToPoly(const T* op)
{
	DebugAssert(!op || op->IsInstanceOf(Opolygon));
	return static_cast<const PolygonObject*>(op);
}

template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE PolygonObject* ToPoly(T* op)
{
	DebugAssert(!op || op->IsInstanceOf(Opolygon));
...
template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE const SplineObject* ToSpline(const T* op)
{
	DebugAssert(!op || (op->IsInstanceOf(Tbaselist2d) && (static_cast<const BaseList2D*>(op)->GetInfo() & OBJECT_ISSPLINE)));
	return static_cast<const SplineObject*>(static_cast<const BaseObject*>(op));
}
template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE SplineObject* ToSpline(T* op)
{
	DebugAssert(!op || (op->IsInstanceOf(Tbaselist2d) && (static_cast<BaseList2D*>(op)->GetInfo() & OBJECT_ISSPLINE)));
	return static_cast<SplineObject*>(static_cast<BaseObject*>(op));
}

/// Casts a @ref BaseObject* to a @ref LineObject*.
template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE const LineObject* ToLine(const T* op)
{
	return static_cast<const LineObject*>(op);
}
template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE LineObject* ToLine(T* op)
{
	return static_cast<LineObject*>(op);
}
...
public:
	...
	//----------------------------------------------------------------------------------------
	void GetEdgePolys(Int32 a, Int32 b, Int32* first, Int32* second) { C4DOS_Nb->GetEdgePolys(ee, a, b, first, second); }
	...
	//----------------------------------------------------------------------------------------
	void GetPointPolys(Int32 pnt, Int32** dadr, Int32* dcnt) { C4DOS_Nb->GetPointPolys(ee, pnt, dadr, dcnt); }
	...
	//----------------------------------------------------------------------------------------
	void GetPointOneRingPoints(Int32 pnt, Int32** dadr, Int32* dcnt) { C4DOS_Nb->GetPointOneRingPoints(ee, pnt, dadr, dcnt); }
	...
	//----------------------------------------------------------------------------------------
	PolyInfo* GetPolyInfo(Int32 poly) { return C4DOS_Nb->GetPolyInfo(ee, poly); }
	const PolyInfo* GetPolyInfo(Int32 poly) const { return C4DOS_Nb->GetPolyInfo(ee, poly); }
	...
	//----------------------------------------------------------------------------------------
	Bool GetNGons(PolygonObject* op, Int32& ngoncnt, NgonNeighbor*& ngons) { return C4DOS_Nb->GetNGons(ee, op, ngoncnt, ngons); }
	...
	//----------------------------------------------------------------------------------------
	void Flush() { C4DOS_Nb->Free(ee); ee = nullptr; }
	...
	//----------------------------------------------------------------------------------------
	void ResetAddress(const CPolygon* a_polyadr) { C4DOS_Nb->ResetAddress(ee, a_polyadr); }
...
public:
	...
	/// @copydoc Alloc
	static PolyTriangulate* Alloc(const maxon::SourceLocation&) { return Alloc(); }
