...
#define Obasemogendistributionmodes 1066482 			///< Clone modes resource ID.
...
struct Dpoint
{
	...
	{
		h.off = m.off;
		h.sqmat.v1 = m.sqmat.v1 - m.off;
		h.sqmat.v2 = (m.sqmat.v2 - m.off).GetNormalized();
		h.sqmat.v3 = (m.sqmat.v3 - m.off).GetNormalized();

		h.sqmat.v1 = Cross(h.sqmat.v2, h.sqmat.v3);
		h.sqmat.v2 = Cross(h.sqmat.v3, h.sqmat.v1);
...
public:
	...
	/// @copydoc Alloc
	static MoData* Alloc(const maxon::SourceLocation&) { return Alloc(); }
