...
template <> class LIMIT<IntVector32>
{
public:
	static constexpr IntVector32 MIN = IntVector32(LIMIT<Int32>::MIN);
	static constexpr IntVector32 MAX = IntVector32(LIMIT<Int32>::MIN);
};

template <> class LIMIT<IntVector64>
{
public:
	static constexpr IntVector64 MIN = IntVector64(LIMIT<Int64>::MIN);
	static constexpr IntVector64 MAX = IntVector64(LIMIT<Int64>::MAX);
};
