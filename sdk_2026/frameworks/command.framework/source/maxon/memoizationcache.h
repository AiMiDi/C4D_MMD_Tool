...
{
	MAXON_DECLARATION(NO_VALUE_TYPE, BaseDeformObject, "net.maxon.memoization.basedeform", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, CommandExecution, "net.maxon.memoization.commandexecution", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, TextOutlines, "net.maxon.memoization.textoutlines", MAXON_IMPLEMENTATION_MODULE("net.maxon.c4d.c4d_base"));
	MAXON_DECLARATION(NO_VALUE_TYPE, Caps, "net.maxon.memoization.caps", MAXON_IMPLEMENTATION_MODULE("net.maxon.c4d.c4d_base"));
	MAXON_DECLARATION(NO_VALUE_TYPE, CapsClose, "net.maxon.memoization.capsclose", MAXON_IMPLEMENTATION_MODULE("net.maxon.c4d.c4d_base"));
	MAXON_DECLARATION(NO_VALUE_TYPE, GetFieldDirAndUvwDataUVs, "net.maxon.memoization.getfielddiranduvw.uwv", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, GetFieldDirAndUvwDataNormals, "net.maxon.memoization.getfielddiranduvw.normals", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, RANDOMEFFECTOR, "net.maxon.memoization.randomeffector.randomnumbers", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, NEIGHBOR, "net.maxon.memoization.neighbor.topology", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, RAYINTERSECTOR32, "net.maxon.memoization.embree.rayintersector32", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
	MAXON_DECLARATION(NO_VALUE_TYPE, RANDOM01, "net.maxon.memoization.random01", MAXON_IMPLEMENTATION_MODULE("net.maxon.c4d.c4d_base"));
	MAXON_DECLARATION(NO_VALUE_TYPE, RANDOM11, "net.maxon.memoization.random11", MAXON_IMPLEMENTATION_MODULE("net.maxon.c4d.c4d_base"));
}
