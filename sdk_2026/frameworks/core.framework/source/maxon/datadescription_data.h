...
MAXON_DATATYPE(VariadicIdsElement, "net.maxon.datatype.variadicidselement", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel")); // TODO: (Ole) This can be removed when HashSet<T> is supported by the data type system. Not urgent.
}
...
namespace DESCRIPTION
{
	namespace BASE
	{
		...
		MAXON_ATTRIBUTE(Id, COMMAND, "net.maxon.description.base.command",
			RESOURCE_DEFINE(ENUM_ATTRIBUTE, LiteralId("attribute"))
			RESOURCE_DEFINE(ENUM_GROUP, LiteralId("group"))
			RESOURCE_DEFINE(ENUM_PRESET, LiteralId("preset"))
			RESOURCE_DEFINE(ENUM_SEPARATOR, LiteralId("separator"))
			RESOURCE_DEFINE(ENUM_STRING, LiteralId("string"))
			RESOURCE_DEFINE(ENUM_EXPORTEDSTRING, LiteralId("exportedstring"))
			RESOURCE_DEFINE(ENUM_COMMAND, LiteralId("command"))
			RESOURCE_DEFINE(ENUM_COMMANDSEPARATOR, LiteralId("commandseparator"))
			RESOURCE_DEFINE(ENUM_INCLUDE, LiteralId("include"))
			RESOURCE_DEFINE(ENUM_REMOVE, LiteralId("remove"))
			RESOURCE_DEFINE(ENUM_VALUE, LiteralId("value")));
	...
	namespace CLASSIFICATION
	{
		namespace BASE
		{
			...
			MAXON_ATTRIBUTE(Id, ENUM, "net.maxon.description.classification.base.enum",
				...
				RESOURCE_DEFINE(ENUM_DATA, LiteralId("data")));
		}
	}
	...
	namespace DATA
	{
		namespace BASE
		{
			...
			/// See "net.maxon.description.classification.base.enum".
			...
			MAXON_ATTRIBUTE(Id, UNIT, "net.maxon.description.data.base.unit",
				RESOURCE_DEFINE(ENUM_NONE, LiteralId("none"))
				RESOURCE_DEFINE(ENUM_PERCENT, LiteralId("percent"))
				RESOURCE_DEFINE(ENUM_DEGREE, LiteralId("degree"))
				RESOURCE_DEFINE(ENUM_METER, LiteralId("meter"))
				RESOURCE_DEFINE(ENUM_TIME, LiteralId("time")));
			...
			MAXON_ATTRIBUTE(Id, LIMITVALUE, "net.maxon.description.data.base.limitvalue",
				RESOURCE_DEFINE(ENUM_NONE, LiteralId("none"))
				RESOURCE_DEFINE(ENUM_MIN, LiteralId("min"))
				RESOURCE_DEFINE(ENUM_MAX, LiteralId("max"))
				RESOURCE_DEFINE(ENUM_BOTH, LiteralId("both")));
			...
			/// Defines the list of the enumeration identifiers.
			/// For an Id or InternedId type, the list contains only identifiers.
			/// For an Int type,the list contains <identifier, Int> pairs.
			...
			/// True if the attribute's default value is to be excluded from defaults presets.
		...
		namespace INFO
		{
			...
			MAXON_ATTRIBUTE(Id, CLASSIFICATION, "net.maxon.description.data.info.classification",
				RESOURCE_DEFINE(ENUM_UNCLASSIFIED, LiteralId("unclassified"))
				RESOURCE_DEFINE(ENUM_NODE, LiteralId("node"))
				RESOURCE_DEFINE(ENUM_ATTRIBUTE, LiteralId("attribute"))
				RESOURCE_DEFINE(ENUM_PORTBUNDLE, LiteralId("portbundle"))
				RESOURCE_DEFINE(ENUM_TYPE, LiteralId("type")));
