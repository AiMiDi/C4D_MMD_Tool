...
public:
	...
	template <typename T> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE HashInt GetHashCode(const T* key)
	{
		return GetHashCode((UInt) key);
	}

	template <typename T> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE HashInt GetHashCode(T* key)
	{
		return GetHashCode((UInt) key);
	}
	...
	template <typename E> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE HashInt GetHashCode(const maxon::details::EnumWrapper<E>& key)
	{
		return GetHashCode(typename std::underlying_type<E>::type(key.value));
	}

	template <typename K> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE HashInt GetHashCode(const K& key)
	{
	...
	template <typename T1, typename T2> static MAXON_ATTRIBUTE_FORCE_INLINE const COMPARERESULT& CompareHelper(const T1& a, const T2& b, OverloadRank0)
	{
		...
		static_assert(ALLOW_UNDEFINED, "Compare not defined. Implement COMPARERESULT T::Compare(const T& other) const");
	...
	template <typename... T> static constexpr HashInt GetCombinedHashCode(const T&... values)
	{
...
private:
	...
	template <typename K> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE HashInt GetHashCodeHelper(const K& key, OverloadRank0)
	{
	...
	template <typename K> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE auto GetHashCodeHelper(const K& key, OverloadRank1) -> decltype(key.GetHashCode())
	{
		return key.GetHashCode();
	}

	template <typename K> static constexpr MAXON_ATTRIBUTE_FORCE_INLINE typename std::enable_if<STD_IS_REPLACEMENT(enum, K), HashInt>::type GetHashCodeHelper(const K& key, OverloadRank2)
	{
