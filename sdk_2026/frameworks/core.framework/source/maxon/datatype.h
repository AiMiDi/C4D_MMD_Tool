...
{
	MAXON_INTERFACE(UnregisteredDataTypeErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.unregistereddatatypeerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
#define PRIVATE_MAXON_DATATYPE_A(type, id, ...) \
	...
	MAXON_DECLARATION(maxon::DataType, DT_##type, id, static constexpr maxon::EntityBase::TYPE TYPE = maxon::EntityBase::TYPE::DATATYPE; __VA_ARGS__); \
...
#define PRIVATE_MAXON_DATATYPE(type, id, ...) PRIVATE_MAXON_DATATYPE_A(type, id, __VA_ARGS__)
...
/// @param[in] ...								Optional information about the datatype, for now only MAXON_IMPLEMENTATION_MODULE can be used here.
//----------------------------------------------------------------------------------------
#define MAXON_DATATYPE(type, id, ...) PRIVATE_MAXON_DATATYPE(type, id, __VA_ARGS__) MAXON_ASSERT_LEGAL_LAYOUT(type)


#define PRIVATE_MAXON_DATATYPE_REGISTER(T, ret, flags) \
	PRIVATE_MAXON_REGISTER_CHECK("MAXON_DATATYPE_REGISTER"); \
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(decltype(DT_##T)); \
	namespace \
	{ \
		...
		static maxon::ObjectDefinition g_dataTypeDef_##T(DT_##T.GetId(), &InitDataType##T, static_cast<maxon::DataTypes::Registry*>(nullptr), &PRIVATE_MAXON_TRANSLATION_SUBUNIT, MAXON_FILE, maxon::EntityBase::FLAGS::NONE, maxon::EntityBase::TYPE::DATATYPE); \
	}
...
#define PRIVATE_MAXON_DATATYPE_REGISTER_ENUM(enumtype, cppname, id, size, flags, names, ...) \
	...
	{ \
		...
		static maxon::ObjectDefinition g_dataTypeRef_##enumtype(maxon::LiteralId(id), &InitDataType##enumtype, static_cast<maxon::DataTypes::Registry*>(nullptr), &PRIVATE_MAXON_TRANSLATION_SUBUNIT, MAXON_FILE, maxon::EntityBase::FLAGS::NONE, maxon::EntityBase::TYPE::DATATYPE); \
	}
...
MAXON_DATATYPE(Char, "char", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(UChar, "uchar", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Int16, "int16", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(UInt16, "uint16", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Int32, "int32", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(UInt32, "uint32", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Int64, "int64", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(UInt64, "uint64", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Utf16Char, "utf16char", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(Utf32Char, "utf32char", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Float32, "float32", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(Float64, "float64", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Bool, "bool", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Byte, "byte", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DATATYPE(AInt, "int", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DATATYPE(AUInt, "uint", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DATATYPE(AFloat, "float", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

// stylecheck.domains=net.maxon

MAXON_DATATYPE(UniqueHash, "net.maxon.datatype.hash", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(Id, "net.maxon.datatype.id", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(LiteralId, "net.maxon.datatype.literalid", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(InternedId, "net.maxon.datatype.internedid", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(Data, "net.maxon.datatype.data", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(UnitType, "net.maxon.datatype.unittype", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(SourceLocation, "net.maxon.datatype.sourcelocation", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(DelegateBase, "net.maxon.datatype.delegatebase", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DATATYPE(ConstDataPtr, "net.maxon.datatype.constdataptr", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(TrivialDataPtr, "net.maxon.datatype.trivialdataptr", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(DataPtr, "net.maxon.datatype.dataptr", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(MoveDataPtr, "net.maxon.datatype.movedataptr", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DATATYPE(ForwardingDataPtr, "net.maxon.datatype.forwardingdataptr", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DATATYPE(Member, "net.maxon.datatype.member", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
template <typename T> struct MemberTypeBase<T, true, typename std::enable_if<std::is_base_of<InternedIdFidBase, T>::value, typename SFINAEHelper<void, typename T::ValueType>::type>::type>
{
	using OrigType = T;
