...
template <typename T, Int STRIDE, typename SPACE> struct Vec2;
...
/// Color with 8-bit precision.
/// A color contains three components R, G and B.
using UIntColor8 = Col3<UChar, 1>;

/// Color with 16-bit precision.
/// A color contains three components R, G and B.
using UIntColor16 = Col3<UInt16, 1>;
...
static_assert(STD_IS_REPLACEMENT(trivially_copyable, Vector), "Vector not trivially copyable.");
#endif
