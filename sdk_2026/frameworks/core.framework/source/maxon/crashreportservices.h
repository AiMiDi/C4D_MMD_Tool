...
class CrashReportServices
{
	...
	MAXON_INTERFACE_NONVIRTUAL(CrashReportServices, MAXON_REFERENCE_STATIC, "net.maxon.interface.crashreportservices", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
private:
	//----------------------------------------------------------------------------------------
