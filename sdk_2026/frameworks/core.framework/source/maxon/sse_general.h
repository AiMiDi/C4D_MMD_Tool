...
//		#define C4D_HAS_AVX_INTRINSICS
		...
		// only include these files when compiling with -msse3
			...
			#include "pmmintrin.h"
				...
				(defined MAXON_TARGET_IOS && defined MAXON_TARGET_CPU_X86)
			#include <pmmintrin.h>
		#endif
		#define C4D_HAS_SSE3_INTRINSICS
	#endif
...
#elif defined(MAXON_TARGET_CPU_ARM)

	#define C4D_HAS_SSE2_CAPABILITY
	#define C4D_HAS_SSE2_INTRINSICS
	#if defined(MAXON_COMPILER_GCC)
		#include "maxon/utilities/sseconversion_gcc.h"
	#else
		#include "maxon/utilities/sseconversion.h"
	#endif
