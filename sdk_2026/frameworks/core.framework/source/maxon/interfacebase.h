...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Returns the number of methods in the MTable
	//----------------------------------------------------------------------------------------
...
#define MAXON_IMPLEMENTATION_REGISTER(C, ...) \
	...
	maxon::NonvirtualInterfaceImplementation C::_Wrapper::_implementation((C*) nullptr, #C, C::Interface::PrivateGetCppName(), C::Interface::_interface, (maxon::NonvirtualInterfaceReference::MTableInitializer) &maxon::details::InitMTable<typename C::Interface::MTable, typename C::_Wrapper>, C::Interface::REFERENCE_KIND | maxon::EntityBase::FLAGS(__VA_ARGS__), &PRIVATE_MAXON_TRANSLATION_SUBUNIT, MAXON_FILE); \
	C* C::_defaultValue; \
...
#define MAXON_IMPLEMENTATION_REGISTER_TEMPLATE(C, ...) \
	...
	PRIVATE_MAXON_EXTRA_TEMPLATE maxon::NonvirtualInterfaceImplementation				 C::_Wrapper::_implementation((C*)nullptr, #C, C::Interface::PrivateGetCppName(), C::Interface::_interface, (maxon::NonvirtualInterfaceReference::MTableInitializer)&maxon::details::InitMTable<typename C::Interface::MTable, typename C::_Wrapper>, C::Interface::REFERENCE_KIND | maxon::EntityBase::FLAGS(__VA_ARGS__), &PRIVATE_MAXON_TRANSLATION_SUBUNIT, MAXON_FILE); \
...
// Define some target-ABI-dependent macros to handle (non-static) member functions for method tables.
  ...
  #define PRIVATE_MAXON_MF_POINTER_BASE(NAME, CLS, CONST, RES, ...) \
	...
	#define PRIVATE_MAXON_MF_REFLECTION_INVOCATION(RES, ...) &maxon::reflection::Invocation<MAXON_EXPAND_VA_ARGS RES, ##__VA_ARGS__>::template InvokeMember<maxon::GenericComponent>
