...
public:
	...
	{
		_val = setAll ? _mm_set1_epi32(i) : _mm_cvtsi32_si128(i);
	}
	...
	{
		_val = _mm_loadu_si128(reinterpret_cast<const __m128i*>(p));
	}
	...
	{
		_val = _mm_load_si128(reinterpret_cast<const __m128i*>(p));
	}
	...
	{
		return Vector4i32(_mm_unpacklo_epi32(a._val, b._val));
	}

	static MAXON_ATTRIBUTE_FORCE_INLINE Vector4i32 UnpackHigh(const Vector4i32& a, const Vector4i32& b)
	{
		return Vector4i32(_mm_unpackhi_epi32(a._val, b._val));
	}
...
protected:
	...
	union { __m128i _val; Int32 v[4]; struct { Int32 x, y, z, w; }; };
...
private:
	...
	template <Int32 ma4, Int32 ma3, Int32 ma2, Int32 ma1> static MAXON_ATTRIBUTE_FORCE_INLINE Vector4i32 Shuffle(const Vector4i32&a)
	{
		return Vector4i32(a.v[ma1], a.v[ma2], a.v[ma3], a.v[ma4]);
	}
...
static_assert(sizeof(Vector4i32) == sizeof(__m128i), "size mismatch");
