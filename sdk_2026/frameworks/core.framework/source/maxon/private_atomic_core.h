...
#include "maxon/apibase.h"																				// basic type definitions
	...
	#undef id
			...
			#define MAXON_USE_ATOMIC_INTRINSICS
		#else
			MAXON_WARNING_PUSH
...
{
#ifdef MAXON_USE_ATOMIC_INTRINSICS
	return __atomic_compare_exchange_n(dst, &cmp, xchg, false, __ATOMIC_SEQ_CST, __ATOMIC_RELAXED);
...
{
#if defined(MAXON_TARGET_CPU_X86) && defined(MAXON_ASSEMBLY_GCC)
	Int32	prev;
...
{
#ifdef MAXON_USE_ATOMIC_INTRINSICS
	return __atomic_fetch_add(dst, value, __ATOMIC_SEQ_CST);
#elif defined(MAXON_TARGET_WINDOWS) && defined(MAXON_TARGET_CPU_X86)
...
{
#ifdef MAXON_USE_ATOMIC_INTRINSICS
	return __atomic_exchange_n(dst, value, __ATOMIC_SEQ_CST);
#elif defined(MAXON_TARGET_WINDOWS) && defined(MAXON_TARGET_CPU_X86)
...
/// @return												True if successul, false if memory location wasn't changed.
//----------------------------------------------------------------------------------------
MAXON_ATTRIBUTE_FORCE_INLINE Bool atomic_try_cas64(Int64 volatile* dst, Int32 xchghi, Int32 xchglo, Int32 cmphi, Int32 cmplo)
{
#ifdef MAXON_TARGET_WINDOWS
...
MAXON_ATTRIBUTE_FORCE_INLINE Bool atomic_try_cas128(Int64 volatile* dst, Int64 xchghi, Int64 xchglo, Int64 cmphi, Int64 cmplo)
{
	...
	Int64	xchg[2] = { xchglo, xchghi };												// this will be overwritten with the content of dst
...
/// @return												Previous memory location content.
//----------------------------------------------------------------------------------------
MAXON_ATTRIBUTE_FORCE_INLINE Int16 atomic_swap_or16(Int16 volatile* dst, Int16 mask)
{
#ifdef MAXON_USE_ATOMIC_INTRINSICS
	return __atomic_fetch_or(dst, mask, __ATOMIC_SEQ_CST);
#elif defined(MAXON_TARGET_WINDOWS) && defined(MAXON_TARGET_CPU_X86)
	return (Int16)_InterlockedOr16((short volatile*)dst, (short)mask);
#else
	Int16 old_value;
	Int16 new_value;
	...
	while (atomic_try_cas16(dst, new_value, old_value) == false);
...
{
#ifdef MAXON_USE_ATOMIC_INTRINSICS
	return __atomic_fetch_and(dst, mask, __ATOMIC_SEQ_CST);
#elif defined(MAXON_TARGET_WINDOWS) && defined(MAXON_TARGET_CPU_X86)
...
#elif defined(MAXON_TARGET_CPU_X86) || defined(MAXON_TARGET_CPU_PPC)
	return *src;
#else
...
{
#if defined(MAXON_TARGET_CPU_X86) && defined(MAXON_TARGET_64BIT) && defined(MAXON_ASSEMBLY_GCC)
	__asm__ volatile (".byte 0xf3\t\n"
										"movq %1, %0"
										: "=m" (*dst)
										: "r" (value)
...
{
#ifdef MAXON_USE_ATOMIC_INTRINSICS
	__atomic_store_n(dst, value, __ATOMIC_SEQ_CST);
