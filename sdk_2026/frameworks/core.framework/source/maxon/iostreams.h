...
{
	MAXON_INTERFACE(IoErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.ioerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE(FileFormatErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.fileformaterror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(UnknownFileSizeErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.unknownfilesizeerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(BaseStreamInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.basestream", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
public:
	...
	MAXON_DECLARATION(Factory<InputStreamRef(const Block<const Char>&, Bool)>, FromBlock, "net.maxon.inputstreaminterface.fromblock", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(OutputStreamInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.outputstream", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE(InOutputStreamInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.inoutputstream", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DECLARATION(Class<IoError>, IoErrorObjectClass, "net.maxon.class.ioerrorobject", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DECLARATION(Class<InputStreamRef>, InputStreamBaseClass, "net.maxon.class.inputstreambase", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DECLARATION(Class<OutputStreamRef>, OutputStreamBaseClass, "net.maxon.class.outputstreambase", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DECLARATION(Class<InOutputStreamRef>, InOutputStreamBaseClass, "net.maxon.class.inoutputstreambase", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

MAXON_DECLARATION(Class<InputStreamRef>, InputStreamDecoratorBaseClass, "net.maxon.class.inputstreamdecorator", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DECLARATION(Class<OutputStreamRef>, OutputStreamDecoratorBaseClass, "net.maxon.class.outputstreamdecorator", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DECLARATION(Class<InOutputStreamRef>, InOutputStreamDecoratorBaseClass, "net.maxon.class.inoutputstreamdecorator", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));


#include "iostreams2.hxx"

//----------------------------------------------------------------------------------------
/// This function is often useful when getting a file length and need to check if the size is convertible into a memory size.
