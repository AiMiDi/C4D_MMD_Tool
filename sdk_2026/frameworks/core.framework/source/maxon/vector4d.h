...
/// Color with Alpha with the precision of 8-bit UInt.
/// A color contains four components R, G, B and A.
using UIntColorA8 = Col4<UChar, 1>;

/// Color with Alpha with the precision of 16-bit UInt.
/// A color contains four components R, G, B and A.
using UIntColorA16 = Col4<UInt16, 1>;
...
{
	// Light colors
	constexpr inline ColorA White				(Float alpha = 1.0) { return ColorA(1.0,	1.0, 	1.0,	alpha); }
	constexpr inline ColorA LightGray		(Float alpha = 1.0) { return ColorA(0.75,	0.75,	0.75,	alpha); }
	constexpr inline ColorA LightRed		(Float alpha = 1.0) { return ColorA(1.0, 	0.6,	0.6,	alpha); }
	constexpr inline ColorA LightOrange	(Float alpha = 1.0) { return ColorA(1.0,	0.75,	0.5,	alpha); }
	constexpr inline ColorA LightYellow	(Float alpha = 1.0) { return ColorA(1.0,	1.0,	0.6,	alpha); }
	constexpr inline ColorA LightGreen	(Float alpha = 1.0) { return ColorA(0.6,	1.0,	0.6,	alpha); }
	constexpr inline ColorA LightBlue		(Float alpha = 1.0) { return ColorA(0.6,	1.0,	1.0,	alpha); }
	constexpr inline ColorA LightPurple	(Float alpha = 1.0) { return ColorA(0.75,	0.6,	1.0,	alpha); }
	constexpr inline ColorA LightMagenta(Float alpha = 1.0) { return ColorA(1.0,	0.6,	1.0,	alpha); }
	
	// Medium/pure colors
	constexpr inline ColorA Gray				(Float alpha = 1.0) { return ColorA(0.5,	0.5,	0.5,	alpha); }
	constexpr inline ColorA Red					(Float alpha = 1.0) { return ColorA(1.0, 	0.0,	0.0,	alpha); }
	constexpr inline ColorA Orange			(Float alpha = 1.0) { return ColorA(1.0,	0.6,	0.0,	alpha); }
	constexpr inline ColorA Yellow			(Float alpha = 1.0) { return ColorA(1.0,	1.0,	0.0,	alpha); }
	constexpr inline ColorA Green				(Float alpha = 1.0) { return ColorA(0.0,	1.0,	0.0,	alpha); }
	constexpr inline ColorA Blue				(Float alpha = 1.0) { return ColorA(0.0,	0.0,	1.0,	alpha); }
	constexpr inline ColorA BlueMedium	(Float alpha = 1.0) { return ColorA(0.0,	0.5,	1.0,	alpha); }
	constexpr inline ColorA Cyan				(Float alpha = 1.0) { return ColorA(0.0,	1.0,	1.0,	alpha); }
	constexpr inline ColorA Purple			(Float alpha = 1.0) { return ColorA(0.5,	0.0,	1.0,	alpha); }
	constexpr inline ColorA Magenta			(Float alpha = 1.0) { return ColorA(1.0,	0.0,	1.0,	alpha); }
	
	// Dark colors
	constexpr inline ColorA Black				(Float alpha = 1.0) { return ColorA(0.0,	0.0, 	0.0,	alpha); }
	constexpr inline ColorA DarkGray		(Float alpha = 1.0) { return ColorA(0.25,	0.25,	0.25,	alpha); }
	constexpr inline ColorA DarkRed			(Float alpha = 1.0) { return ColorA(0.5, 	0.0,	0.0,	alpha); }
	constexpr inline ColorA DarkOrange	(Float alpha = 1.0) { return ColorA(0.4,	0.2,	0.0,	alpha); }
	constexpr inline ColorA DarkYellow	(Float alpha = 1.0) { return ColorA(0.5,	0.5,	0.0,	alpha); }
	constexpr inline ColorA DarkGreen		(Float alpha = 1.0) { return ColorA(0.0,	0.4,	0.0,	alpha); }
	constexpr inline ColorA DarkBlue		(Float alpha = 1.0) { return ColorA(0.0,	0.0,	0.5,	alpha); }
	constexpr inline ColorA DarkPurple	(Float alpha = 1.0) { return ColorA(0.25,	0.0,	0.5,	alpha); }
	constexpr inline ColorA DarkMagenta	(Float alpha = 1.0) { return ColorA(0.5,	0.0,	0.5,	alpha); }

	// Special colors
	constexpr inline ColorA Transparent() { return ColorA(0.0, 0.0, 0.0, 0.0); }
}
