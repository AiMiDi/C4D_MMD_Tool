...
MAXON_ATTRIBUTE(Id, AssetBrowserHome, "net.maxon.assetbrowser.home");
...
public:
	...
	MAXON_METHOD void DoFilteringPreScan(const String& masterFilter, const String& groupFilter, const String& sortFilter, const String& filterString, Bool localFilterMode, Bool showUnavailable);

	MAXON_METHOD Result<const BaseArray<AssetDescription>&> GetSmartSearches() const;
