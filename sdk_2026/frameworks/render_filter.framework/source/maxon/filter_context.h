#ifndef FILTER_CONTEXT_H__
#define FILTER_CONTEXT_H__
...
MAXON_DEPENDENCY_ALWAYS_WEAK("maxon/filter_context.h"); // This is an optional component

#endif // FILTER_CONTEXT_H__
