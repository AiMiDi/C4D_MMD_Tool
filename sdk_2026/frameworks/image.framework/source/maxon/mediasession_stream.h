...
{
	MAXON_INTERFACE(MediaStreamExifDataInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamexifdata", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaStreamImageBaseInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamimagebase", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaStreamImageDataImportInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamimagedataimport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaStreamImageDataExportInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamimagedataexport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaStreamImageDataForwardImportInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamimagedataforwardimport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaStreamAudioDataImportInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamaudiodataimport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
MAXON_DECLARATION(Class<MediaStreamRef>, MediaStreamBaseClass, "net.maxon.image.class.mediastreambase", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaStreamExifDataRef>, MediaStreamExifDataClass, "net.maxon.image.class.mediastreamexifdata", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaStreamImageBaseRef>, MediaStreamImageBaseClass, "net.maxon.image.class.mediastreamimagebase", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaStreamImageDataImportRef>, MediaStreamImageDataImportClass, "net.maxon.image.class.mediastreamimagedataimport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaStreamImageDataExportRef>, MediaStreamImageDataExportClass, "net.maxon.image.class.mediastreamimagedataexport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaStreamAudioDataImportRef>, MediaStreamAudioDataImportClass, "net.maxon.image.class.mediastreamaudiodataimport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));

// special interface that forwards all streams to the destination stream
MAXON_DECLARATION(Class<MediaStreamImageDataForwardImportRef>, MediaStreamForwardImageDataStreamsImportClass, "net.maxon.image.class.mediastreamforwardimagedatastreamsimport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
