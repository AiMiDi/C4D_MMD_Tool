...
{
	MAXON_INTERFACE(MediaStreamAudioDataExportInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediastreamaudiodataexport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
MAXON_DECLARATION(Class<MediaStreamAudioDataExportRef>, MediaStreamAudioDataExportClass, "net.maxon.image.class.mediastreamaudiodataexport", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
