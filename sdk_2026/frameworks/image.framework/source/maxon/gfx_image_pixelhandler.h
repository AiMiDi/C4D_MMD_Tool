...
//----------------------------------------------------------------------------------------
/// Helper class returned by GetPixelHandler. This class provides/caches a fast access to pixels.
/// A lambda contains the most efficient code to access the pixel data.
/// This object is only valid as long as the bitmap properties (pixel format, pixel storage layout, width, height) don't change.
//----------------------------------------------------------------------------------------
...
public:
	...
	//----------------------------------------------------------------------------------------
	const ColorProfile& GetTargetColorProfile() const
	{
