...
class ProgressRef MAXON_FORWARD("maxon/progress.h");
...
MAXON_DECLARATION(Class<MediaSessionRef>, MediaSessionObject, "net.maxon.image.class.mediasessionobject", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
