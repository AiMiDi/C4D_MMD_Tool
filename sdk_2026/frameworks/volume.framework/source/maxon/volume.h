...
enum class NANOVDBPRECISION
{
	...
	FPN = 3,
	FLOAT = 5,
} MAXON_ENUM_LIST(NANOVDBPRECISION);
//----------------------------------------------------------------------------------------
...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Retrieve the active voxel bounding box (evalActiveVoxelBoundingBox). 
	/// @Since 2026.0
	/// @return												The active voxel bounding box of this volume.
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Range<IntVector32> GetActiveVoxelBoundingBox() const;
};
#include "volume1.hxx"
