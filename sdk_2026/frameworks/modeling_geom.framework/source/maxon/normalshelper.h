...
namespace NormalsHelper
{
	...
	public:
		...
		//----------------------------------------------------------------------------------------
		/// Returns a tessellation matching the output of CalculateShadingNormals().
		/// @param[in] polygons       The polygons of the mesh the normals have been generated from.
		/// @param[out] tessellation  The generated tessellation. The size of this block should equal the size of the polygons block.
		/// @return												OK on success, otherwise error.
		//----------------------------------------------------------------------------------------
		static MAXON_METHOD Result<void> GetShadingNormalsTessellation(const Block<const SimplePolygon>& polygons, Block<SimplePolygon>& tessellation);
	};
