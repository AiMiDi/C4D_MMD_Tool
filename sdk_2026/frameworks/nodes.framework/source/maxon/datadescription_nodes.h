...
#undef OPTIONAL // normally defined by windows system headers
#undef DUPLICATE // normally defined by windows system headers
#undef OUT // normally defined by windows system headers
...
namespace NODE
{
	...
	namespace BASE
	{
		...
		/// This attribute represents the name of a node. The name is used for the UI.
		/// However, to get the name to show in the UI, don't read the NAME attribute directly but use EffectiveName instead.
