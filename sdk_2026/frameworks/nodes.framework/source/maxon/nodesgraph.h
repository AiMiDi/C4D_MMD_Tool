...
class AssetDescription MAXON_FORWARD("maxon/assets.h");
...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<AssetDescription> MoveToAsset(const GraphNode& node, const AssetRepositoryRef& repository, const Id& assetId, Bool overwrite, const Delegate<Result<void>(const MutableRoot& rootNode)>& assetFinalizer);
