...
struct BlendFunctionInterface::MTable
{
	...
	Result<Data> (*BlendFunctionInterface_MapValue) (maxon::GenericComponent* this_, Float x, const Data& startValue, const Data& endValue);
	...
	{
		BlendFunctionInterface_MapValue = &W::BlendFunctionInterface_MapValue;
		BlendFunctionInterface_MapValue_Offset = offset;
	}
	}
...
struct BlendFunctionInterface::Hxx2
{
	...
	public:
		...
		static Result<Data> BlendFunctionInterface_MapValue(maxon::GenericComponent* this_, Float x, const Data& startValue, const Data& endValue) { return ((typename S::Implementation*) this_)->MapValue(x, startValue, endValue); }
	};
...
{
	const BlendFunctionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(BlendFunctionInterface, this); return mt_.BlendFunctionInterface_MapValue((maxon::GenericComponent*) this + mt_.BlendFunctionInterface_MapValue_Offset, x, startValue, endValue);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendFunctionInterface::Hxx1::Fn<S>::MapValue(Float x, const Data& startValue, const Data& endValue) const -> Result<Data>
{
	...
	return (mt_.BlendFunctionInterface_MapValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.BlendFunctionInterface_MapValue_Offset, x, startValue, endValue));
}
