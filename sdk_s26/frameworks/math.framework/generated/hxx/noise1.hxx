...
/// @return												OK on success. IllegalArgumentError is returned if the permutationTablePower was out of range.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(NoiseInterface**);
...
#ifdef DOXYGEN
public FnDoxy<NoiseRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<NoiseInterface, maxon::StrongRefHandler, NoiseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<NoiseInterface, maxon::StrongRefHandler, NoiseRef>>>>);
...
#ifdef DOXYGEN
public FnDoxy<RenderNoiseRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<RenderNoiseInterface, maxon::StrongRefHandler, RenderNoiseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<RenderNoiseInterface, maxon::StrongRefHandler, RenderNoiseRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
