...
namespace maxon
{
	...
	public:
		...
		Result<void> Transform1D(const ArrayInterface<Generic>& in, WritableArrayInterface<Generic>& out, FFT_FLAGS fftFlags) const 
		{
			...
			(*handler_)(_fn_FFTInterface_Transform1D, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const ArrayInterface<Generic>&, WritableArrayInterface<Generic>&, FFT_FLAGS>::Invoke, (const void*) mt_.FFTInterface_Transform1D));
			return proxy_result;
		}
		...
		Result<void> Transform2D(const ConstMatrixNxMInterface& in, const MatrixNxMInterface& out, FFT_FLAGS fftFlags) const 
		{
			...
			(*handler_)(_fn_FFTInterface_Transform2D, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const ConstMatrixNxMInterface&, const MatrixNxMInterface&, FFT_FLAGS>::Invoke, (const void*) mt_.FFTInterface_Transform2D));
			return proxy_result;
		}
		...
		FFT_SUPPORT GetSupportOptions() const 
		{
			...
			(*handler_)(_fn_FFTInterface_GetSupportOptions, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<FFT_SUPPORT, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FFTInterface_GetSupportOptions));
			return proxy_result;
		}
