...
namespace maxon
{
	...
	maxon::Bool NoiseInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->NoiseInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Init;
		#else
		tbl->NoiseInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Init;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetSeed = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetSeed;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetPermutationTablePower = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetPermutationTablePower;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetPermutationTable = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetPermutationTable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_GetGradientTable = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetGradientTable;
		#else
		tbl->NoiseInterface_GetGradientTable = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetGradientTable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_GetFbmTable = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetFbmTable;
		#else
		tbl->NoiseInterface_GetFbmTable = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetFbmTable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetRandomTable = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetRandomTable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_SNoise = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_SNoise;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_SNoise_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_SNoise_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_PeriodicSNoise = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_PeriodicSNoise;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_PeriodicSNoise_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_PeriodicSNoise_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Voronoi = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Voronoi;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Voronoi_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Voronoi_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultMemT<FbmTableRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_InitFbm = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_InitFbm;
		#else
		tbl->NoiseInterface_InitFbm = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_InitFbm;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Fbm = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Fbm;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Fbm_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Fbm_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Turbulence = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Turbulence;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Turbulence_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Turbulence_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_RidgedMultifractal = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_RidgedMultifractal;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_RidgedMultifractal_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_RidgedMultifractal_1;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
