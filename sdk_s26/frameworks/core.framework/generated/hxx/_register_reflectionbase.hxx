...
namespace maxon
{
	namespace reflection
	{
		...
		maxon::Bool Member::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
		{
			...
			#else
			tbl->Member_GetEnclosingContainer = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetEnclosingContainer;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<KIND>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetKind = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetKind;
			#else
			tbl->Member_GetKind = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetKind;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetSimpleName = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetSimpleName;
			#else
			tbl->Member_GetSimpleName = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetSimpleName;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetId;
			#else
			tbl->Member_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetId;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_ToString;
			#else
			tbl->Member_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_ToString;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetMembers = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetMembers;
			#else
			tbl->Member_GetMembers = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetMembers;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Member_Find = &Hxx2::Wrapper<Hxx2::Unresolved>::Member_Find;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		...
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Class* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_GetClasses = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_GetClasses;
			#else
			tbl->Container_GetClasses = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_GetClasses;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Container_FindClass = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindClass;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Function* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_GetFunctions = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_GetFunctions;
			#else
			tbl->Container_GetFunctions = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_GetFunctions;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<const Function*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_FindFunction = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindFunction;
			#else
			tbl->Container_FindFunction = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindFunction;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_FindFunctions = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindFunctions;
			#else
			tbl->Container_FindFunctions = &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindFunctions;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
			return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
		#else
		...
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Package* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Package_GetPackages = &Hxx2::Wrapper<Hxx2::Unresolved>::Package_GetPackages;
			#else
			tbl->Package_GetPackages = &Hxx2::Wrapper<Hxx2::Unresolved>::Package_GetPackages;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Package_FindPackage = &Hxx2::Wrapper<Hxx2::Unresolved>::Package_FindPackage;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Package_GetGlobalPackage = &Hxx2::Wrapper<Hxx2::Unresolved>::Package_GetGlobalPackage;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
			return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
		#else
		...
		maxon::Bool Class::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Class_GetInterface = &Hxx2::Wrapper<Hxx2::Unresolved>::Class_GetInterface;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Class_GetNonvirtualInterface = &Hxx2::Wrapper<Hxx2::Unresolved>::Class_GetNonvirtualInterface;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Class* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Class_GetBaseClasses = &Hxx2::Wrapper<Hxx2::Unresolved>::Class_GetBaseClasses;
			#else
			tbl->Class_GetBaseClasses = &Hxx2::Wrapper<Hxx2::Unresolved>::Class_GetBaseClasses;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Class_GetStaticInterface = &Hxx2::Wrapper<Hxx2::Unresolved>::Class_GetStaticInterface;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
			return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
		#else
		...
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_Invoke = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_Invoke;
			#else
			tbl->Function_Invoke = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_Invoke;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<ParameterType>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_GetReturnType = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetReturnType;
			#else
			tbl->Function_GetReturnType = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetReturnType;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const ParameterType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_GetParameterTypes = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetParameterTypes;
			#else
			tbl->Function_GetParameterTypes = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetParameterTypes;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<const Block<const Parameter>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_GetParameters = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetParameters;
			#else
			tbl->Function_GetParameters = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetParameters;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Function_IsPure = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_IsPure;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Function_GetAddress = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetAddress;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			#else
			tbl->Function_PrivateFindMethod = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_PrivateFindMethod;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_FindAll = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_FindAll;
			#else
			tbl->Function_FindAll = &Hxx2::Wrapper<Hxx2::Unresolved>::Function_FindAll;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
			return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
		#else
