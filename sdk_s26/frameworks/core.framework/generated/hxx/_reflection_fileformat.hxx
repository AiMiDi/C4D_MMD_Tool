...
namespace maxon
{
	...
	public:
		...
		Result<Bool> Detect(const Url& url, const InputStreamRef& probeStream) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.FileFormatInterface_Detect_Offset), maxon::reflection::Argument::ByReference(url), maxon::reflection::Argument::ByReference(probeStream)};
			(*handler_)(_fn_FileFormatInterface_Detect, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Bool>, const maxon::GenericComponent*, const Url&, const InputStreamRef&>::Invoke, (const void*) mt_.FileFormatInterface_Detect));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_FileFormatInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "url\0probeStream\0", 5LL, FileFormatInterface, FileFormatInterface_Detect),
		};
