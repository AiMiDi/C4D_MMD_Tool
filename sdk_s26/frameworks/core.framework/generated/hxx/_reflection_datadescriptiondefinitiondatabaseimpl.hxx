...
namespace maxon
{
	...
	public:
		...
		Result<Int> RenameId(const Id& oldId, const Id& newId) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_RenameId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const Id&, const Id&>::Invoke, (const void*) mt_.DataDescriptionDefinitionDatabaseImplInterface_RenameId));
			return proxy_result;
		}
		...
		Int GetChangeCount() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>();
			Int proxy_result = 0;
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount_Offset)};
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount));
			return proxy_result;
		}
		...
		Result<void> Write() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_Write, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDescriptionDefinitionDatabaseImplInterface_Write));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionDefinitionDatabaseImplInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, DataDescriptionDefinitionDatabaseImplInterface, DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount),
