...
struct StreamConversionInterface::MTable
{
	...
	Int (*StreamConversionInterface_GetBatchSize) (const maxon::GenericComponent* this_);
	maxon::Int StreamConversionInterface_GetBatchSize_Offset;
	Int (*StreamConversionInterface_GetBlockSize) (const maxon::GenericComponent* this_);
	maxon::Int StreamConversionInterface_GetBlockSize_Offset;
	Id (*StreamConversionInterface_GetCounterpart) (const maxon::GenericComponent* this_);
	maxon::Int StreamConversionInterface_GetCounterpart_Offset;
	const DataType& (*StreamConversionInterface_GetSourceType) (const maxon::GenericComponent* this_);
	maxon::Int StreamConversionInterface_GetSourceType_Offset;
	const DataType& (*StreamConversionInterface_GetDestinationType) (const maxon::GenericComponent* this_);
	maxon::Int StreamConversionInterface_GetDestinationType_Offset;
	Bool (*StreamConversionInterface_SupportInplaceConversion) (const maxon::GenericComponent* this_);
	maxon::Int StreamConversionInterface_SupportInplaceConversion_Offset;
	Result<Int> (*StreamConversionInterface_ConvertImpl) (maxon::GenericComponent* this_, const Block<const Generic>& src, WritableArrayInterface<Generic>& dst, Int dstLimitHint, Bool inputFinished, Bool& outputFinished);
	maxon::Int StreamConversionInterface_ConvertImpl_Offset;
	Result<InputStreamRef> (*StreamConversionInterface_ConvertToStream) (maxon::GenericComponent* this_, const InputStreamRef& in);
	maxon::Int StreamConversionInterface_ConvertToStream_Offset;
	Result<InputStreamRef> (*StreamConversionInterface_ConvertToStream_1) (maxon::GenericComponent* this_, const DataFormatBaseReaderRef& in);
	maxon::Int StreamConversionInterface_ConvertToStream_1_Offset;
	Result<DataFormatBaseReaderRef> (*StreamConversionInterface_ConvertToReader) (maxon::GenericComponent* this_, const InputStreamRef& in);
	maxon::Int StreamConversionInterface_ConvertToReader_Offset;
	Result<DataFormatBaseReaderRef> (*StreamConversionInterface_ConvertToReader_1) (maxon::GenericComponent* this_, const DataFormatBaseReaderRef& in);
	maxon::Int StreamConversionInterface_ConvertToReader_1_Offset;
	Result<OutputStreamRef> (*StreamConversionInterface_ConvertToStream_2) (maxon::GenericComponent* this_, const OutputStreamRef& out);
	maxon::Int StreamConversionInterface_ConvertToStream_2_Offset;
	Result<OutputStreamRef> (*StreamConversionInterface_ConvertToStream_3) (maxon::GenericComponent* this_, const DataFormatBaseWriterRef& out);
	maxon::Int StreamConversionInterface_ConvertToStream_3_Offset;
	Result<DataFormatBaseWriterRef> (*StreamConversionInterface_ConvertToWriter) (maxon::GenericComponent* this_, const OutputStreamRef& out);
	maxon::Int StreamConversionInterface_ConvertToWriter_Offset;
	Result<DataFormatBaseWriterRef> (*StreamConversionInterface_ConvertToWriter_1) (maxon::GenericComponent* this_, const DataFormatBaseWriterRef& out);
	...
	{
		StreamConversionInterface_GetBatchSize = &W::StreamConversionInterface_GetBatchSize;
		StreamConversionInterface_GetBatchSize_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, GetBlockSize))
	{
		StreamConversionInterface_GetBlockSize = &W::StreamConversionInterface_GetBlockSize;
		StreamConversionInterface_GetBlockSize_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, GetCounterpart))
	{
		StreamConversionInterface_GetCounterpart = &W::StreamConversionInterface_GetCounterpart;
		StreamConversionInterface_GetCounterpart_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, GetSourceType))
	{
		StreamConversionInterface_GetSourceType = &W::StreamConversionInterface_GetSourceType;
		StreamConversionInterface_GetSourceType_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, GetDestinationType))
	{
		StreamConversionInterface_GetDestinationType = &W::StreamConversionInterface_GetDestinationType;
		StreamConversionInterface_GetDestinationType_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, SupportInplaceConversion))
	{
		StreamConversionInterface_SupportInplaceConversion = &W::StreamConversionInterface_SupportInplaceConversion;
		StreamConversionInterface_SupportInplaceConversion_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertImpl))
	{
		StreamConversionInterface_ConvertImpl = &W::StreamConversionInterface_ConvertImpl;
		StreamConversionInterface_ConvertImpl_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToStream))
	{
		StreamConversionInterface_ConvertToStream = &W::StreamConversionInterface_ConvertToStream;
		StreamConversionInterface_ConvertToStream_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToStream))
	{
		StreamConversionInterface_ConvertToStream_1 = &W::StreamConversionInterface_ConvertToStream_1;
		StreamConversionInterface_ConvertToStream_1_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToReader))
	{
		StreamConversionInterface_ConvertToReader = &W::StreamConversionInterface_ConvertToReader;
		StreamConversionInterface_ConvertToReader_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToReader))
	{
		StreamConversionInterface_ConvertToReader_1 = &W::StreamConversionInterface_ConvertToReader_1;
		StreamConversionInterface_ConvertToReader_1_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToStream))
	{
		StreamConversionInterface_ConvertToStream_2 = &W::StreamConversionInterface_ConvertToStream_2;
		StreamConversionInterface_ConvertToStream_2_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToStream))
	{
		StreamConversionInterface_ConvertToStream_3 = &W::StreamConversionInterface_ConvertToStream_3;
		StreamConversionInterface_ConvertToStream_3_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToWriter))
	{
		StreamConversionInterface_ConvertToWriter = &W::StreamConversionInterface_ConvertToWriter;
		StreamConversionInterface_ConvertToWriter_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, StreamConversionInterface, ConvertToWriter))
	{
		StreamConversionInterface_ConvertToWriter_1 = &W::StreamConversionInterface_ConvertToWriter_1;
		StreamConversionInterface_ConvertToWriter_1_Offset = offset;
	}
	}
...
struct StreamConversionInterface::Hxx2
{
	...
	public:
		...
		static Int StreamConversionInterface_GetBatchSize(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetBatchSize(); }
		static Int StreamConversionInterface_GetBlockSize(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetBlockSize(); }
		static Id StreamConversionInterface_GetCounterpart(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetCounterpart(); }
		static const DataType& StreamConversionInterface_GetSourceType(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetSourceType(); }
		static const DataType& StreamConversionInterface_GetDestinationType(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetDestinationType(); }
		static Bool StreamConversionInterface_SupportInplaceConversion(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->SupportInplaceConversion(); }
		static Result<Int> StreamConversionInterface_ConvertImpl(maxon::GenericComponent* this_, const Block<const Generic>& src, WritableArrayInterface<Generic>& dst, Int dstLimitHint, Bool inputFinished, Bool& outputFinished) { return ((typename S::Implementation*) this_)->ConvertImpl(src, dst, dstLimitHint, inputFinished, outputFinished); }
		static Result<InputStreamRef> StreamConversionInterface_ConvertToStream(maxon::GenericComponent* this_, const InputStreamRef& in) { return ((typename S::Implementation*) this_)->ConvertToStream(in); }
		static Result<InputStreamRef> StreamConversionInterface_ConvertToStream_1(maxon::GenericComponent* this_, const DataFormatBaseReaderRef& in) { return ((typename S::Implementation*) this_)->ConvertToStream(in); }
		static Result<DataFormatBaseReaderRef> StreamConversionInterface_ConvertToReader(maxon::GenericComponent* this_, const InputStreamRef& in) { return ((typename S::Implementation*) this_)->ConvertToReader(in); }
		static Result<DataFormatBaseReaderRef> StreamConversionInterface_ConvertToReader_1(maxon::GenericComponent* this_, const DataFormatBaseReaderRef& in) { return ((typename S::Implementation*) this_)->ConvertToReader(in); }
		static Result<OutputStreamRef> StreamConversionInterface_ConvertToStream_2(maxon::GenericComponent* this_, const OutputStreamRef& out) { return ((typename S::Implementation*) this_)->ConvertToStream(out); }
		static Result<OutputStreamRef> StreamConversionInterface_ConvertToStream_3(maxon::GenericComponent* this_, const DataFormatBaseWriterRef& out) { return ((typename S::Implementation*) this_)->ConvertToStream(out); }
		static Result<DataFormatBaseWriterRef> StreamConversionInterface_ConvertToWriter(maxon::GenericComponent* this_, const OutputStreamRef& out) { return ((typename S::Implementation*) this_)->ConvertToWriter(out); }
		static Result<DataFormatBaseWriterRef> StreamConversionInterface_ConvertToWriter_1(maxon::GenericComponent* this_, const DataFormatBaseWriterRef& out) { return ((typename S::Implementation*) this_)->ConvertToWriter(out); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::GetBatchSize() const -> Int
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_GetBatchSize((const maxon::GenericComponent*) this + mt_.StreamConversionInterface_GetBatchSize_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::GetBlockSize() const -> Int
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_GetBlockSize((const maxon::GenericComponent*) this + mt_.StreamConversionInterface_GetBlockSize_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::GetCounterpart() const -> Id
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_GetCounterpart((const maxon::GenericComponent*) this + mt_.StreamConversionInterface_GetCounterpart_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::GetSourceType() const -> const DataType&
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_GetSourceType((const maxon::GenericComponent*) this + mt_.StreamConversionInterface_GetSourceType_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::GetDestinationType() const -> const DataType&
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_GetDestinationType((const maxon::GenericComponent*) this + mt_.StreamConversionInterface_GetDestinationType_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::SupportInplaceConversion() const -> Bool
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_SupportInplaceConversion((const maxon::GenericComponent*) this + mt_.StreamConversionInterface_SupportInplaceConversion_Offset);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertImpl((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertImpl_Offset, src, dst, dstLimitHint, inputFinished, outputFinished);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToStream((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToStream_Offset, in);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToStream_1((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToStream_1_Offset, in);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToReader((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToReader_Offset, in);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToReader_1((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToReader_1_Offset, in);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToStream_2((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToStream_2_Offset, out);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToStream_3((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToStream_3_Offset, out);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToWriter((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToWriter_Offset, out);
}
...
{
	const StreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(StreamConversionInterface, this); return mt_.StreamConversionInterface_ConvertToWriter_1((maxon::GenericComponent*) this + mt_.StreamConversionInterface_ConvertToWriter_1_Offset, out);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::ConstFn<S>::GetBatchSize() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	...
	return (mt_.StreamConversionInterface_GetBatchSize(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_GetBatchSize_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::ConstFn<S>::GetBlockSize() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	...
	return (mt_.StreamConversionInterface_GetBlockSize(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_GetBlockSize_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::ConstFn<S>::GetCounterpart() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Id>, Id>::type
{
	...
	return (mt_.StreamConversionInterface_GetCounterpart(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_GetCounterpart_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::ConstFn<S>::GetSourceType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type
{
	...
	return (mt_.StreamConversionInterface_GetSourceType(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_GetSourceType_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::ConstFn<S>::GetDestinationType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type
{
	...
	return (mt_.StreamConversionInterface_GetDestinationType(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_GetDestinationType_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::ConstFn<S>::SupportInplaceConversion() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	...
	return (mt_.StreamConversionInterface_SupportInplaceConversion(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_SupportInplaceConversion_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertImpl(const Block<const Generic>& src, WritableArrayInterface<Generic>& dst, Int dstLimitHint, Bool inputFinished, Bool& outputFinished) const -> Result<Int>
{
	...
	return (mt_.StreamConversionInterface_ConvertImpl(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertImpl_Offset, src, dst, dstLimitHint, inputFinished, outputFinished));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToStream(const InputStreamRef& in) const -> Result<InputStreamRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToStream(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToStream_Offset, in));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToStream(const DataFormatBaseReaderRef& in) const -> Result<InputStreamRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToStream_1(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToStream_1_Offset, in));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToReader(const InputStreamRef& in) const -> Result<DataFormatBaseReaderRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToReader(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToReader_Offset, in));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToReader(const DataFormatBaseReaderRef& in) const -> Result<DataFormatBaseReaderRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToReader_1(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToReader_1_Offset, in));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToStream(const OutputStreamRef& out) const -> Result<OutputStreamRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToStream_2(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToStream_2_Offset, out));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToStream(const DataFormatBaseWriterRef& out) const -> Result<OutputStreamRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToStream_3(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToStream_3_Offset, out));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToWriter(const OutputStreamRef& out) const -> Result<DataFormatBaseWriterRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToWriter(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToWriter_Offset, out));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StreamConversionInterface::Hxx1::Fn<S>::ConvertToWriter(const DataFormatBaseWriterRef& out) const -> Result<DataFormatBaseWriterRef>
{
	...
	return (mt_.StreamConversionInterface_ConvertToWriter_1(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.StreamConversionInterface_ConvertToWriter_1_Offset, out));
}
