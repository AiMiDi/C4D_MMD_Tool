...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_ClassInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_Alloc)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "allocLocation\0cid\0kind\0", 21LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetId)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetKind)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetSize)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetComponents)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_AddComponent)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "component\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_RemoveLastComponent)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_AddComponents)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "cls\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_Finalize)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_IsFinalized)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetImplementedInterfaces)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetDataType)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_Create)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_CreatePointer)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_CreatePointer_1)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "size\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_IsSubclassOf)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "other\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_ToString)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "formatStatement\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetMetaData)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_InitMetaData)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "data\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_DeleteInstance)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_DestructInstance)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_CopyInstance)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dest\0src\0", 6LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetInfo)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_GetOrCreateMTable)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "info\0i\0", 5LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ClassInterface::MTable::_instance.ClassInterface_AddProxyComponent)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "component\0shared\0", 0LL, nullptr),
		};
...
/// @endcond
	...
	public:
		...
		String ToString(const FormatStatement* formatStatement) const 
		{
			...
			(*handler_)(_fn_ObjectInterface_ToString, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const FormatStatement*>::Invoke, (const void*) mt_.ObjectInterface_ToString));
			return proxy_result;
		}
		...
		Result<void> HandleMessage(const InternedId& message, void* argument) 
		{
			...
			(*handler_)(_fn_ObjectInterface_HandleMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const InternedId&, void*>::Invoke, (const void*) mt_.ObjectInterface_HandleMessage));
			return proxy_result;
		}
		...
		Result<void> HandleConstMessage(const InternedId& message, void* argument) const 
		{
			...
			(*handler_)(_fn_ObjectInterface_HandleConstMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const InternedId&, void*>::Invoke, (const void*) mt_.ObjectInterface_HandleConstMessage));
			return proxy_result;
		}
		...
		Bool IsEqual(const maxon::ObjectInterface* other) const 
		{
			...
			(*handler_)(_fn_ObjectInterface_IsEqual, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const maxon::ObjectInterface*>::Invoke, (const void*) mt_.ObjectInterface_IsEqual));
			return proxy_result;
		}
		...
		COMPARERESULT Compare(const maxon::ObjectInterface* other) const 
		{
			...
			(*handler_)(_fn_ObjectInterface_Compare, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<COMPARERESULT, const maxon::GenericComponent*, const maxon::ObjectInterface*>::Invoke, (const void*) mt_.ObjectInterface_Compare));
			return proxy_result;
		}
		...
		HashInt GetHashCodeImpl() const 
		{
			...
			(*handler_)(_fn_ObjectInterface_GetHashCodeImpl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<HashInt, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObjectInterface_GetHashCodeImpl));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_ObjectInterface_GetHashCodeImpl;
		HashValue GetHashValueImpl() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObjectInterface>();
			HashValue proxy_result = maxon::PrivateIncompleteNullReturnValue<HashValue>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ObjectInterface_GetHashValueImpl_Offset)};
			(*handler_)(_fn_ObjectInterface_GetHashValueImpl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<HashValue, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObjectInterface_GetHashValueImpl));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_ObjectInterface_GetHashValueImpl;
#ifndef _HAS_CPP20_COMPARISONS
#endif
/// @cond INTERNAL
...
/// @endcond
	...
	const maxon::reflection::Function* ObjectInterface::ProxyComponent::_fn_ObjectInterface_GetHashValueImpl;
#ifndef _HAS_CPP20_COMPARISONS
#endif
/// @cond INTERNAL
...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_ObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ObjectInterface, ObjectInterface_GetHashValueImpl),
#ifndef _HAS_CPP20_COMPARISONS
#endif
/// @cond INTERNAL
...
/// @endcond
	...
	public:
		...
		const SourceLocation& GetLocation() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetLocation, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const SourceLocation&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ErrorInterface_GetLocation));
			return *proxy_result;
		}
		...
		void SetLocation(const maxon::SourceLocation& allocLocation) 
		{
			...
			(*handler_)(_fn_ErrorInterface_SetLocation, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const maxon::SourceLocation&>::Invoke, (const void*) mt_.ErrorInterface_SetLocation));
		}
		...
		Block<void* const> GetStackTrace() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetStackTrace, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Block<void* const>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ErrorInterface_GetStackTrace));
			return proxy_result;
		}
		...
		void SetStackTrace(const Block<void* const>& trace) 
		{
			...
			(*handler_)(_fn_ErrorInterface_SetStackTrace, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const Block<void* const>&>::Invoke, (const void*) mt_.ErrorInterface_SetStackTrace));
		}
		...
		String GetMessage() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ErrorInterface_GetMessage));
			return proxy_result;
		}
		...
		void SetMessage(const String& message) 
		{
			...
			(*handler_)(_fn_ErrorInterface_SetMessage, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_.ErrorInterface_SetMessage));
		}
		...
		String FormatMessage(const LanguageRef& language, const PartFormatter& partFormatter) const 
		{
			...
			(*handler_)(_fn_ErrorInterface_FormatMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const LanguageRef&, const PartFormatter&>::Invoke, (const void*) mt_.ErrorInterface_FormatMessage));
			return proxy_result;
		}
		...
		void SetMessageDelegate(Delegate<String(const LanguageRef&language,const ErrorInterface::PartFormatter&fmt)>&& message) 
		{
			...
			(*handler_)(_fn_ErrorInterface_SetMessageDelegate, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, Delegate<String(const LanguageRef&language,const ErrorInterface::PartFormatter&fmt)>&&>::Invoke, (const void*) mt_.ErrorInterface_SetMessageDelegate));
		}
		...
		const Error& GetCause() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetCause, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Error&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ErrorInterface_GetCause));
			return *proxy_result;
		}
		...
		void SetCause(const Error& cause) 
		{
			...
			(*handler_)(_fn_ErrorInterface_SetCause, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const Error&>::Invoke, (const void*) mt_.ErrorInterface_SetCause));
		}
		...
		void GetMachine(MachineRef& machine) const 
		{
			...
			(*handler_)(_fn_ErrorInterface_GetMachine, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, MachineRef&>::Invoke, (const void*) mt_.ErrorInterface_GetMachine));
		}
		...
		void SetMachine(const MachineRef& machine) 
		{
			...
			(*handler_)(_fn_ErrorInterface_SetMachine, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const MachineRef&>::Invoke, (const void*) mt_.ErrorInterface_SetMachine));
		}
		...
		Int PrivateGetCode() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_PrivateGetCode, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ErrorInterface_PrivateGetCode));
			return proxy_result;
		}
		...
		void PrivateSetCode(Int code) 
		{
			...
			(*handler_)(_fn_ErrorInterface_PrivateSetCode, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_.ErrorInterface_PrivateSetCode));
		}
		...
		void PrivateSetPreallocation(ThreadReferencedError preallocation) const 
		{
			...
			(*handler_)(_fn_ErrorInterface_PrivateSetPreallocation, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, ThreadReferencedError>::Invoke, (const void*) mt_.ErrorInterface_PrivateSetPreallocation));
		}
		...
		ThreadReferencedError PrivateGetPreallocation() const 
		{
			...
			(*handler_)(_fn_ErrorInterface_PrivateGetPreallocation, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ThreadReferencedError, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ErrorInterface_PrivateGetPreallocation));
			return proxy_result;
		}
		...
		void PrivateSetDebugError(const Error& cause) const 
		{
			...
			(*handler_)(_fn_ErrorInterface_PrivateSetDebugError, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, const Error&>::Invoke, (const void*) mt_.ErrorInterface_PrivateSetDebugError));
		}
