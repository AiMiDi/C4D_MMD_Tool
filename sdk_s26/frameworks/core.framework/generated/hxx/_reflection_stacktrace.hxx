...
#else
#endif
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(StackTrace::MTable::_instance.StackTrace_FindSymbol)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "function\0name\0module\0offset\0", 189LL, nullptr),
		};
