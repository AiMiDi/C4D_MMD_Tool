...
namespace maxon
{
	...
	maxon::Bool UrlFileCacheEntryInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->UrlFileCacheEntryInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheEntryInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Url>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlFileCacheEntryInterface_GetSourceUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheEntryInterface_GetSourceUrl;
		#else
		tbl->UrlFileCacheEntryInterface_GetSourceUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheEntryInterface_GetSourceUrl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Url>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlFileCacheEntryInterface_GetCacheUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheEntryInterface_GetCacheUrl;
		#else
		tbl->UrlFileCacheEntryInterface_GetCacheUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheEntryInterface_GetCacheUrl;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	maxon::Bool UrlFileCacheInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UrlFileCacheInterface_IsAccessible = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheInterface_IsAccessible;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UrlFileCacheEntry>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlFileCacheInterface_FindOrCreateUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheInterface_FindOrCreateUrl;
		#else
		tbl->UrlFileCacheInterface_FindOrCreateUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheInterface_FindOrCreateUrl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlFileCacheInterface_FlushCache = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheInterface_FlushCache;
		#else
		tbl->UrlFileCacheInterface_FlushCache = &Hxx2::Wrapper<Hxx2::Unresolved>::UrlFileCacheInterface_FlushCache;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
	#else
