...
namespace maxon
{
	namespace reflection
	{
		...
		maxon::Bool Proxy::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
		{
			...
			if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Proxy_AddComponents = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_AddComponents;
			#else
			tbl->Proxy_AddComponents = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_AddComponents;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Proxy_SetHandler = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_SetHandler;
			#else
			tbl->Proxy_SetHandler = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_SetHandler;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Proxy_SetHandler_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_SetHandler_1;
			#else
			tbl->Proxy_SetHandler_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_SetHandler_1;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<maxon::Class<>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Proxy_GetClass = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_GetClass;
			#else
			tbl->Proxy_GetClass = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_GetClass;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<ObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Proxy_Create = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_Create;
			#else
			tbl->Proxy_Create = &Hxx2::Wrapper<Hxx2::Unresolved>::Proxy_Create;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
