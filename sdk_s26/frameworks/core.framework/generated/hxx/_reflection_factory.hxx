...
namespace maxon
{
	...
	public:
		...
		const DelegateBase* PrivateGetDelegate() const 
		{
			...
			(*handler_)(_fn_FactoryInterface_PrivateGetDelegate, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DelegateBase*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FactoryInterface_PrivateGetDelegate));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_FactoryFactory(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FactoryFactory::MTable::_instance.FactoryFactory_PrivateCreate)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "func\0params\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FactoryFactory::MTable::_instance.FactoryFactory_PrivateCreateCached)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "func\0creator\0size\0params\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FactoryFactory::MTable::_instance.FactoryFactory_CreateDataCached)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "factory\0params\0dc\0", 0LL, nullptr),
		};
