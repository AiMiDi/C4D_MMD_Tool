...
namespace maxon
{
	...
	maxon::Bool DataDescriptionDatabaseInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<DataDescription>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_LoadDescription = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_LoadDescription;
		#else
		tbl->DataDescriptionDatabaseInterface_LoadDescription = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_LoadDescription;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataDescription>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_LoadDescription_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_LoadDescription_1;
		#else
		tbl->DataDescriptionDatabaseInterface_LoadDescription_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_LoadDescription_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_StoreDescription = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_StoreDescription;
		#else
		tbl->DataDescriptionDatabaseInterface_StoreDescription = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_StoreDescription;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_StoreDescription_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_StoreDescription_1;
		#else
		tbl->DataDescriptionDatabaseInterface_StoreDescription_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_StoreDescription_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_DescriptionDefinitionChanged = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_DescriptionDefinitionChanged;
		#else
		tbl->DataDescriptionDatabaseInterface_DescriptionDefinitionChanged = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_DescriptionDefinitionChanged;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Tuple<Id, Data, String>>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_GetEffectiveEnumList = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_GetEffectiveEnumList;
		#else
		tbl->DataDescriptionDatabaseInterface_GetEffectiveEnumList = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_GetEffectiveEnumList;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_PostProcessStringDescription = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_PostProcessStringDescription;
		#else
		tbl->DataDescriptionDatabaseInterface_PostProcessStringDescription = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_PostProcessStringDescription;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
