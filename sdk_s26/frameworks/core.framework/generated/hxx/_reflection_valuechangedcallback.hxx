...
namespace maxon
{
	...
	public:
		...
		Result<void> ValueChangedMessage(const InternedId& id) 
		{
			...
			(*handler_)(_fn_ValueChangedCallbackInterface_ValueChangedMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const InternedId&>::Invoke, (const void*) mt_.ValueChangedCallbackInterface_ValueChangedMessage));
			return proxy_result;
		}
