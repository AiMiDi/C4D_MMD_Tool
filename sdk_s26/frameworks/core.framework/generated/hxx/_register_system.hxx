...
namespace maxon
{
	namespace enum34
	{
		...
		static const maxon::UInt64 MEMORYDIAGNOSTICSMODE_values[] = {maxon::UInt64(enum34::MEMORYDIAGNOSTICSMODE::ESTIMATEONLY), maxon::UInt64(enum34::MEMORYDIAGNOSTICSMODE::QUIET), maxon::UInt64(enum34::MEMORYDIAGNOSTICSMODE::VERBOSE), maxon::UInt64(enum34::MEMORYDIAGNOSTICSMODE::LEAKGRAPH), maxon::UInt64(enum34::MEMORYDIAGNOSTICSMODE::PRIVATE_OFF), maxon::UInt64(enum34::MEMORYDIAGNOSTICSMODE::PRIVATE_ON)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_MEMORYDIAGNOSTICSMODE34(void*){ return enum34::MEMORYDIAGNOSTICSMODE_info; }
	namespace enum41
	{
		...
		static const maxon::UInt64 MEMORYOBSERVERMODE_values[] = {maxon::UInt64(enum41::MEMORYOBSERVERMODE::LOWMEM_CLEANUP), maxon::UInt64(enum41::MEMORYOBSERVERMODE::LOWMEM_FAILURE), maxon::UInt64(enum41::MEMORYOBSERVERMODE::WARNMEM_LIMIT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_MEMORYOBSERVERMODE41(void*){ return enum41::MEMORYOBSERVERMODE_info; }
	namespace enum48
	{
		...
		static const maxon::UInt64 SPECIALBEHAVIOR_values[] = {maxon::UInt64(enum48::SPECIALBEHAVIOR::NONE), maxon::UInt64(enum48::SPECIALBEHAVIOR::OMIT_HELP), maxon::UInt64(enum48::SPECIALBEHAVIOR::DONTWARN_MISSINGARGUMENTS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SPECIALBEHAVIOR48(void*){ return enum48::SPECIALBEHAVIOR_info; }
	...
	maxon::Bool System::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->System__ConsoleOutput = &Hxx2::Wrapper<Hxx2::Unresolved>::System__ConsoleOutput;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System__ConsoleOutput_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::System__ConsoleOutput_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<OUTPUT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->System_GetConsoleOutputType = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetConsoleOutputType;
		#else
		tbl->System_GetConsoleOutputType = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetConsoleOutputType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::System_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_AllocClear = &Hxx2::Wrapper<Hxx2::Unresolved>::System_AllocClear;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_Realloc = &Hxx2::Wrapper<Hxx2::Unresolved>::System_Realloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::System_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetAllocSize = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetAllocSize;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_MemoryDiagnostics = &Hxx2::Wrapper<Hxx2::Unresolved>::System_MemoryDiagnostics;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_MemoryAddObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::System_MemoryAddObserver;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_SetMemoryAllocationThreshold = &Hxx2::Wrapper<Hxx2::Unresolved>::System_SetMemoryAllocationThreshold;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetCustomTimer = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetCustomTimer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetConfigurationCount = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetConfigurationCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetConfiguration = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetConfiguration;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_ConfigurationRegister = &Hxx2::Wrapper<Hxx2::Unresolved>::System_ConfigurationRegister;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetCriticalLog = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetCriticalLog;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetDefinitionCount = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetDefinitionCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetVirtualInterfaceReference = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetVirtualInterfaceReference;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_FindDefinition = &Hxx2::Wrapper<Hxx2::Unresolved>::System_FindDefinition;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_SetDebugErrorObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::System_SetDebugErrorObserver;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_ResetDebugErrorObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::System_ResetDebugErrorObserver;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_SetCurrentError = &Hxx2::Wrapper<Hxx2::Unresolved>::System_SetCurrentError;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_SetCurrentError_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::System_SetCurrentError_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetLastError = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetLastError;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_SetDebugError = &Hxx2::Wrapper<Hxx2::Unresolved>::System_SetDebugError;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetDebugError = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetDebugError;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<const Id*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->System_PrivateGetInternedId = &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateGetInternedId;
		#else
		tbl->System_PrivateGetInternedId = &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateGetInternedId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_PrivateFreeInternedId = &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateFreeInternedId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Block<const Binary* const>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->System_GetBinaries = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetBinaries;
		#else
		tbl->System_GetBinaries = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetBinaries;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_PrivateShowSynchronizedHashMapDiagnostics = &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateShowSynchronizedHashMapDiagnostics;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_GetPreferencesPathSuffix = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetPreferencesPathSuffix;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Id>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->System_GetApplicationId = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetApplicationId;
		#else
		tbl->System_GetApplicationId = &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetApplicationId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_SetApplicationType = &Hxx2::Wrapper<Hxx2::Unresolved>::System_SetApplicationType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_PrivateInitExternalDependency = &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateInitExternalDependency;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_PrivateResetExternalDependency = &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateResetExternalDependency;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_FreeWithDestructorI = &Hxx2::Wrapper<Hxx2::Unresolved>::System_FreeWithDestructorI;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
