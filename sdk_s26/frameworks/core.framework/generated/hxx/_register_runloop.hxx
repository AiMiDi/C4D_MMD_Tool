...
namespace maxon
{
	...
	public:
		...
		static Result<void> EnterLoop(Bool isInternalLoop, void* osSpecific) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return RunLoop::EnterLoop(isInternalLoop, osSpecific); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	...
	maxon::Bool RunLoop::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_EnterLoop = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop;
		#else
		tbl->RunLoop_EnterLoop = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_EnterLoop_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop_1;
		#else
		tbl->RunLoop_EnterLoop_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_ExitLoop = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ExitLoop;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_TriggerMainThreadQueue = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_TriggerMainThreadQueue;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Timer*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_AddTimer = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_AddTimer;
		#else
		tbl->RunLoop_AddTimer = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_AddTimer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_RemoveTimer = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_RemoveTimer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_GetLinuxDefaultDisplayAndScreen = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_GetLinuxDefaultDisplayAndScreen;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableExitLoopDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_ObservableExitLoop = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableExitLoop;
		#else
		tbl->RunLoop_ObservableExitLoop = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableExitLoop;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableActivationChangeDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_ObservableActivationChange = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableActivationChange;
		#else
		tbl->RunLoop_ObservableActivationChange = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableActivationChange;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableRunLoopMessageDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_ObservableRunLoopMessage = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableRunLoopMessage;
		#else
		tbl->RunLoop_ObservableRunLoopMessage = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableRunLoopMessage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_PrivateGetMainThreadQueueTrigger = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_PrivateGetMainThreadQueueTrigger;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_PrivateSetWaitInterval = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_PrivateSetWaitInterval;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RunLoop_PrivateSetDefaultDisplayAndScreen = &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_PrivateSetDefaultDisplayAndScreen;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
