...
namespace maxon
{
	...
	public:
		...
		Result<Bool> DetectFile(const Url& url, const Block<const DataType>& limitDetection) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.FileFormatDetectionCacheInterface_DetectFile_Offset), maxon::reflection::Argument::ByReference(url), maxon::reflection::Argument::ByReference(limitDetection)};
			(*handler_)(_fn_FileFormatDetectionCacheInterface_DetectFile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, const Url&, const Block<const DataType>&>::Invoke, (const void*) mt_.FileFormatDetectionCacheInterface_DetectFile));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_FileFormatDetectionCacheInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "url\0limitDetection\0", 0LL, FileFormatDetectionCacheInterface, FileFormatDetectionCacheInterface_DetectFile),
		};
