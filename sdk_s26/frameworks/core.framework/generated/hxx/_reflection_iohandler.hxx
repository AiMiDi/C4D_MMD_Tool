...
namespace maxon
{
	...
	public:
		...
		const Id& GetUrlScheme() const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_GetUrlScheme, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Id&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.IoHandlerInterface_GetUrlScheme));
			return *proxy_result;
		}
		...
		Result<void> SetSystemPath(UrlInterface& url, const String& systemPath) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_SetSystemPath, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, UrlInterface&, const String&>::Invoke, (const void*) mt_.IoHandlerInterface_SetSystemPath));
			return proxy_result;
		}
		...
		Result<String> GetSystemPath(const UrlInterface& url) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_GetSystemPath, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<String>, const maxon::GenericComponent*, const UrlInterface&>::Invoke, (const void*) mt_.IoHandlerInterface_GetSystemPath));
			return proxy_result;
		}
		...
		Result<void> AppendUrl(UrlInterface& url, const String& name) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_AppendUrl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, UrlInterface&, const String&>::Invoke, (const void*) mt_.IoHandlerInterface_AppendUrl));
			return proxy_result;
		}
		...
		Result<void> AppendUrl(UrlInterface& url, const Url& relativeUrl) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_AppendUrl_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, UrlInterface&, const Url&>::Invoke, (const void*) mt_.IoHandlerInterface_AppendUrl_1));
			return proxy_result;
		}
		...
		Result<void> RemoveUrl(UrlInterface& url) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_RemoveUrl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, UrlInterface&>::Invoke, (const void*) mt_.IoHandlerInterface_RemoveUrl));
			return proxy_result;
		}
		...
		Result<IoConnectionRef> OpenConnection(const Url& name) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_OpenConnection, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<IoConnectionRef>, const maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_.IoHandlerInterface_OpenConnection));
			return proxy_result;
		}
		...
		Result<Url> Normalize(const Url& url, NORMALIZEFLAGS flags) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_Normalize, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Url>, const maxon::GenericComponent*, const Url&, NORMALIZEFLAGS>::Invoke, (const void*) mt_.IoHandlerInterface_Normalize));
			return proxy_result;
		}
		...
		Result<Url> IoNormalize(const Url& url, NORMALIZEFLAGS flags) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_IoNormalize, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Url>, const maxon::GenericComponent*, const Url&, NORMALIZEFLAGS>::Invoke, (const void*) mt_.IoHandlerInterface_IoNormalize));
			return proxy_result;
		}
		...
		Result<String> ConvertToUiName(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_ConvertToUiName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<String>, const maxon::GenericComponent*, const UrlInterface&, CONVERTTOUINAMEFLAGS>::Invoke, (const void*) mt_.IoHandlerInterface_ConvertToUiName));
			return proxy_result;
		}
		...
		Result<String> ConvertToUiNameWithRepository(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository) const 
		{
			...
			(*handler_)(_fn_IoHandlerInterface_ConvertToUiNameWithRepository, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<String>, const maxon::GenericComponent*, const UrlInterface&, CONVERTTOUINAMEFLAGS, const AssetRepositoryRef&>::Invoke, (const void*) mt_.IoHandlerInterface_ConvertToUiNameWithRepository));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_IoHandlerInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(IoHandlerInterface::Hxx2::StaticMTable::_instance.IoHandlerInterface_GetHandlerForScheme)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "scheme\0", 1LL, nullptr),
		};
