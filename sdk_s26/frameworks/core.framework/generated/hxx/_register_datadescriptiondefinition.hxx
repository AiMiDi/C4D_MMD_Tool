...
namespace maxon
{
	...
	maxon::Bool DataDescriptionDefinitionInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionInterface_MergeDescriptionDefinition = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_MergeDescriptionDefinition;
		#else
		tbl->DataDescriptionDefinitionInterface_MergeDescriptionDefinition = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_MergeDescriptionDefinition;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Data>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionInterface_GetDataDefaults = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_GetDataDefaults;
		#else
		tbl->DataDescriptionDefinitionInterface_GetDataDefaults = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_GetDataDefaults;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Data>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionInterface_GetDataValueOrDefaults = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_GetDataValueOrDefaults;
		#else
		tbl->DataDescriptionDefinitionInterface_GetDataValueOrDefaults = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_GetDataValueOrDefaults;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionDefinitionInterface_Create = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_Create;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionDefinitionInterface_NullValuePtr = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_NullValuePtr;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
