...
#else
#endif
	Bool (*StackTrace_FindSymbol) (const void* function, const Block<Char>& name, const Block<Char>& module, Int& offset);
	template <typename IMPL> void Init()
	{
#if defined MAXON_TARGET_WINDOWS || defined MAXON_TARGET_ANDROID
#else
#endif
		StackTrace_FindSymbol = &IMPL::StackTrace_FindSymbol;
	}
};
