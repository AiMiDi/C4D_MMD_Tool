...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_DATATYPE_REGISTER_ENUM(URLCOMPARE, "maxon::URLCOMPARE", "net.maxon.datatype.enum.urlcompare", SIZEOF(URLCOMPARE), false, "DEFAULT\0NORMALIZE\0IONORMALIZE\0LEGACY\0FULL\0", const maxon::UInt64 values[] = {(maxon::UInt64) URLCOMPARE::DEFAULT, (maxon::UInt64) URLCOMPARE::NORMALIZE, (maxon::UInt64) URLCOMPARE::IONORMALIZE, (maxon::UInt64) URLCOMPARE::LEGACY, (maxon::UInt64) URLCOMPARE::FULL})
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
