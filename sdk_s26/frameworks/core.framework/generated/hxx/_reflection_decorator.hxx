...
namespace maxon
{
	...
	public:
		...
		ObjectRef PrivateGetDecoratedObject() const 
		{
			...
			(*handler_)(_fn_DecoratorInterface_PrivateGetDecoratedObject, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ObjectRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DecoratorInterface_PrivateGetDecoratedObject));
			return proxy_result;
		}
	...
	public:
		...
		void PrivateSetDecoratedObject(const ObjectRef& object) 
		{
			...
			(*handler_)(_fn_EagerDecoratorInterface_PrivateSetDecoratedObject, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const ObjectRef&>::Invoke, (const void*) mt_.EagerDecoratorInterface_PrivateSetDecoratedObject));
		}
		...
		void PrivateSetDecoratedObject(ObjectRef&& object) 
		{
			...
			(*handler_)(_fn_EagerDecoratorInterface_PrivateSetDecoratedObject_1, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, ObjectRef&&>::Invoke, (const void*) mt_.EagerDecoratorInterface_PrivateSetDecoratedObject_1));
		}
	...
	public:
		...
		void PrivateSetDecoratedObject(const ObjectRef& object) 
		{
			...
			(*handler_)(_fn_WeakDecoratorInterface_PrivateSetDecoratedObject, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const ObjectRef&>::Invoke, (const void*) mt_.WeakDecoratorInterface_PrivateSetDecoratedObject));
		}
