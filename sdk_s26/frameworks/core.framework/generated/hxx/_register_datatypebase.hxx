...
namespace maxon
{
	...
	namespace enum1049
	{
		...
		static const maxon::UInt64 BASE_OF_MODE_values[] = {maxon::UInt64(enum1049::BASE_OF_MODE::NONE), maxon::UInt64(enum1049::BASE_OF_MODE::ORDERED_TYPE_ONLY), maxon::UInt64(enum1049::BASE_OF_MODE::UNORDERED_BY_NAME), maxon::UInt64(enum1049::BASE_OF_MODE::GENERIC_DOWNCAST)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_BASE_OF_MODE1049(void*){ return enum1049::BASE_OF_MODE_info; }
	...
	namespace enum1154
	{
		...
		static const maxon::UInt64 GET_DATATYPE_POLICY_values[] = {maxon::UInt64(enum1154::GET_DATATYPE_POLICY::NONE), maxon::UInt64(enum1154::GET_DATATYPE_POLICY::GENERIC_FOR_UNKNOWN), maxon::UInt64(enum1154::GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN), maxon::UInt64(enum1154::GET_DATATYPE_POLICY::RESULT_FOR_UNKNOWN_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GET_DATATYPE_POLICY1154(){ return enum1154::GET_DATATYPE_POLICY_info; }
}
#endif
