...
namespace maxon
{
	...
	maxon::Bool DataDictionaryInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->DataDictionaryInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_SetData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData;
		#else
		tbl->DataDictionaryInterface_SetData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_SetData_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData_1;
		#else
		tbl->DataDictionaryInterface_SetData_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_SetData_2 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData_2;
		#else
		tbl->DataDictionaryInterface_SetData_2 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData_2;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Data>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_GetData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetData;
		#else
		tbl->DataDictionaryInterface_GetData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_EraseData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_EraseData;
		#else
		tbl->DataDictionaryInterface_EraseData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_EraseData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_Reset;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_IsEmpty = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_IsEmpty;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_GetCount = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_ToString;
		#else
		tbl->DataDictionaryInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_ToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_DescribeIO;
		#else
		tbl->DataDictionaryInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_DescribeIO;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_IsEqual = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_IsEqual;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetHashCode;
		#else
		tbl->DataDictionaryInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetHashCode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_InitIterator = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_InitIterator;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDictionaryInterface_PrivateGetData = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_PrivateGetData;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
