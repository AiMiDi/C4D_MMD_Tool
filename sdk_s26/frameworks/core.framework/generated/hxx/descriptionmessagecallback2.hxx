...
struct DescriptionMessageCallbackInterface::MTable
{
	...
	Result<Tuple<Bool, Bool>> (*DescriptionMessageCallbackInterface_DescriptionMessage) (maxon::GenericComponent* this_, const InternedId& id, const Id& cmdId, Int32 type, void* data);
	...
	{
		DescriptionMessageCallbackInterface_DescriptionMessage = &W::DescriptionMessageCallbackInterface_DescriptionMessage;
		DescriptionMessageCallbackInterface_DescriptionMessage_Offset = offset;
	}
	}
...
struct DescriptionMessageCallbackInterface::Hxx2
{
	...
	public:
		...
		static Result<Tuple<Bool, Bool>> DescriptionMessageCallbackInterface_DescriptionMessage(maxon::GenericComponent* this_, const InternedId& id, const Id& cmdId, Int32 type, void* data) { return ((typename S::Implementation*) this_)->DescriptionMessage(id, cmdId, type, data); }
	};
...
{
	const DescriptionMessageCallbackInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(DescriptionMessageCallbackInterface, this); return mt_.DescriptionMessageCallbackInterface_DescriptionMessage((maxon::GenericComponent*) this + mt_.DescriptionMessageCallbackInterface_DescriptionMessage_Offset, id, cmdId, type, data);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DescriptionMessageCallbackInterface::Hxx1::Fn<S>::DescriptionMessage(const InternedId& id, const Id& cmdId, Int32 type, void* data) const -> Result<Tuple<Bool, Bool>>
{
	...
	return (mt_.DescriptionMessageCallbackInterface_DescriptionMessage(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DescriptionMessageCallbackInterface_DescriptionMessage_Offset, id, cmdId, type, data));
}
