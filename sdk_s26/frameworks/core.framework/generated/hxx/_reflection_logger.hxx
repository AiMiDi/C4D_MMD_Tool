...
namespace maxon
{
	...
	public:
		...
		Result<void> Write(const String& str, const SourceLocation& loc, WRITEMETA level) 
		{
			...
			(*handler_)(_fn_LoggerTypeInterface_Write, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, const SourceLocation&, WRITEMETA>::Invoke, (const void*) mt_.LoggerTypeInterface_Write));
			return proxy_result;
		}
		...
		Result<void> Flush() 
		{
			...
			(*handler_)(_fn_LoggerTypeInterface_Flush, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.LoggerTypeInterface_Flush));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_LoggerTypeInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, LoggerTypeInterface, LoggerTypeInterface_ObservableLoggerNotify),
		};
	...
	public:
		...
		Result<void> Init(const Url& url) 
		{
			...
			(*handler_)(_fn_FileLoggerTypeInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_.FileLoggerTypeInterface_Init));
			return proxy_result;
		}
		...
		Url GetUrl() const 
		{
			...
			(*handler_)(_fn_FileLoggerTypeInterface_GetUrl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Url, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FileLoggerTypeInterface_GetUrl));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> Iterate(const Delegate<Result<void>(LoggerLine&)>& callback) 
		{
			...
			(*handler_)(_fn_UserLoggerTypeInterface_Iterate, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Delegate<Result<void>(LoggerLine&)>&>::Invoke, (const void*) mt_.UserLoggerTypeInterface_Iterate));
			return proxy_result;
		}
		...
		Int GetCount() 
		{
			...
			(*handler_)(_fn_UserLoggerTypeInterface_GetCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*>::Invoke, (const void*) mt_.UserLoggerTypeInterface_GetCount));
			return proxy_result;
		}
		...
		void Reset() 
		{
			...
			(*handler_)(_fn_UserLoggerTypeInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.UserLoggerTypeInterface_Reset));
		}
	...
	static maxon::Result<void> RegisterReflection_LoggerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_Alloc)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "allocLocation\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_AddLoggerType)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "ta\0loggerTypeCls\0cb\0", 21LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_RemoveLoggerType)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "loggerType\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_RemoveLoggerTypes)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "loggerTypeCls\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_Write)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "ta\0str\0loc\0level\0", 85LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_GetName)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_SetName)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "name\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_Enable)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "enable\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_IsEnabled)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_GetLoggerTypes)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_ObservableLoggerNew)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LoggerInterface::MTable::_instance.LoggerInterface_AddNewLogger)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "id\0logger\0module\0", 16LL, nullptr),
		};
