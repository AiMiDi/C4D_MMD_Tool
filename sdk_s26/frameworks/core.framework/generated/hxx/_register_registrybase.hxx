...
/// @cond INTERNAL
	...
	maxon::Bool RegistryEntryIteratorInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->RegistryEntryIteratorInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RegistryEntryIteratorInterface_HasValue = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_HasValue;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RegistryEntryIteratorInterface_MoveToNext = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_MoveToNext;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryEntryIteratorInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_GetId;
		#else
		tbl->RegistryEntryIteratorInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_GetId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ConstDataPtr>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryEntryIteratorInterface_GetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_GetEntry;
		#else
		tbl->RegistryEntryIteratorInterface_GetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_GetEntry;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_GetId;
		#else
		tbl->RegistryInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_GetId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RegistryInterface_GetStamp = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_GetStamp;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_GetDataType = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_GetDataType;
		#else
		tbl->RegistryInterface_GetDataType = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_GetDataType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<GenericData>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_AddObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_AddObserver;
		#else
		tbl->RegistryInterface_AddObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_AddObserver;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RegistryInterface_Find = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_Find;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_InsertEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_InsertEntry;
		#else
		tbl->RegistryInterface_InsertEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_InsertEntry;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_EraseEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_EraseEntry;
		#else
		tbl->RegistryInterface_EraseEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_EraseEntry;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<GenericData>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_Register = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_Register;
		#else
		tbl->RegistryInterface_Register = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_Register;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ConstDataPtr>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RegistryInterface_FindEntryValue = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_FindEntryValue;
		#else
		tbl->RegistryInterface_FindEntryValue = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_FindEntryValue;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->RegistryInterface_PrivateCreateIterator = &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_PrivateCreateIterator;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
	#else
