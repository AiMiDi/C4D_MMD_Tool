...
namespace maxon
{
	...
	public:
		...
		Result<void> SetInputStream(const InputStreamRef& inputStream) 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_SetInputStream, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const InputStreamRef&>::Invoke, (const void*) mt_.IoDualInOutputStreamInterface_SetInputStream));
			return proxy_result;
		}
		...
		Result<void> SetOutputStream(const OutputStreamRef& outputStream) 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_SetOutputStream, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const OutputStreamRef&>::Invoke, (const void*) mt_.IoDualInOutputStreamInterface_SetOutputStream));
			return proxy_result;
		}
		...
		InputStreamRef GetInputStream() const 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_GetInputStream, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<InputStreamRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.IoDualInOutputStreamInterface_GetInputStream));
			return proxy_result;
		}
		...
		OutputStreamRef GetOutputStream() const 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_GetOutputStream, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<OutputStreamRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.IoDualInOutputStreamInterface_GetOutputStream));
			return proxy_result;
		}
