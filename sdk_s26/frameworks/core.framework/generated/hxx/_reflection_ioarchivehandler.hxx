...
namespace maxon
{
	...
	public:
		...
		Result<void> Open(const Url& inputFile, const String& password) 
		{
			...
			(*handler_)(_fn_ReadArchiveInterface_Open, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, const String&>::Invoke, (const void*) mt_.ReadArchiveInterface_Open));
			return proxy_result;
		}
		...
		Result<void> Close() 
		{
			...
			(*handler_)(_fn_ReadArchiveInterface_Close, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.ReadArchiveInterface_Close));
			return proxy_result;
		}
		...
		Result<void> Extract(const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) 
		{
			...
			(*handler_)(_fn_ReadArchiveInterface_Extract, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, ThreadRef, IOARCHIVEEXTRACTFLAGS, const ExtractCallback&>::Invoke, (const void*) mt_.ReadArchiveInterface_Extract));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> Open(const Url& inputFile, Bool append, const String& password) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_Open, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, Bool, const String&>::Invoke, (const void*) mt_.WriteArchiveInterface_Open));
			return proxy_result;
		}
		...
		Result<void> Close() 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_Close, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.WriteArchiveInterface_Close));
			return proxy_result;
		}
		...
		Result<void> SetCompressionLevel(Int compressionLevel) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_SetCompressionLevel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_.WriteArchiveInterface_SetCompressionLevel));
			return proxy_result;
		}
		...
		Int GetCompressionLevel() const 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_GetCompressionLevel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.WriteArchiveInterface_GetCompressionLevel));
			return proxy_result;
		}
		...
		Result<void> CreateDirectory(const String& name, const UniversalDateTime& dateTime, IOATTRIBUTES fileAttributes) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CreateDirectory, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, const UniversalDateTime&, IOATTRIBUTES>::Invoke, (const void*) mt_.WriteArchiveInterface_CreateDirectory));
			return proxy_result;
		}
		...
		Result<void> WriteFile(const Block<const Byte>& data) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_WriteFile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Block<const Byte>&>::Invoke, (const void*) mt_.WriteArchiveInterface_WriteFile));
			return proxy_result;
		}
		...
		Result<void> CloseFile() 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CloseFile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.WriteArchiveInterface_CloseFile));
			return proxy_result;
		}
		...
		Result<void> CopyFile(const Url& fn, const String& str, IOATTRIBUTES fileAttributes, IOATTRIBUTES fileAttributesMask) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CopyFile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, const String&, IOATTRIBUTES, IOATTRIBUTES>::Invoke, (const void*) mt_.WriteArchiveInterface_CopyFile));
			return proxy_result;
		}
