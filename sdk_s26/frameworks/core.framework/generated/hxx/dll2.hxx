...
struct DllInterface::MTable
{
	...
	void (*DllInterface_Free) (const DllInterface* object);
	Result<DllRef> (*DllInterface_LoadDll) (const Url& fileName, Bool registerDll, Bool requireCoreModule, Int systemDependentFlags);
	Result<DllRef> (*DllInterface_GetModule) (const void* handle, UInt processId);
	Result<void> (*DllInterface_AddDllPath) (const Url& dllDirectory);
	Result<void> (*DllInterface_RemoveDllPath) (const Url& dllDirectory);
	Result<void> (*DllInterface_GetLoadedDlls) (const ValueReceiver<const DllRef&>& dlls);
	Result<void> (*DllInterface_Unload) (DllInterface* this_);
	Result<void> (*DllInterface_Release) (DllInterface* this_);
	Result<void*> (*DllInterface_FindSymbolPointer) (const DllInterface* this_, const CString& symbol);
	Result<Binary*> (*DllInterface_GetBinary) (const DllInterface* this_);
	Result<void> (*DllInterface_UpdateSymbolData) (DllInterface* this_);
	Result<Url> (*DllInterface_GetPath) (const DllInterface* this_);
	template <typename IMPL> void Init()
	{
		DllInterface_Free = &IMPL::DllInterface_Free;
		DllInterface_LoadDll = &IMPL::DllInterface_LoadDll;
		DllInterface_GetModule = &IMPL::DllInterface_GetModule;
		DllInterface_AddDllPath = &IMPL::DllInterface_AddDllPath;
		DllInterface_RemoveDllPath = &IMPL::DllInterface_RemoveDllPath;
		DllInterface_GetLoadedDlls = &IMPL::DllInterface_GetLoadedDlls;
		DllInterface_Unload = &IMPL::DllInterface_Unload;
		DllInterface_Release = &IMPL::DllInterface_Release;
		DllInterface_FindSymbolPointer = &IMPL::DllInterface_FindSymbolPointer;
		DllInterface_GetBinary = &IMPL::DllInterface_GetBinary;
		DllInterface_UpdateSymbolData = &IMPL::DllInterface_UpdateSymbolData;
		DllInterface_GetPath = &IMPL::DllInterface_GetPath;
	}
};
...
struct DllInterface::Hxx2
{
	...
	public:
		...
		static Result<void> DllInterface_Unload(DllInterface* this_) { return C::Get(this_)->Unload(); }
		static Result<void> DllInterface_Release(DllInterface* this_) { return C::Get(this_)->Release(); }
		static Result<void*> DllInterface_FindSymbolPointer(const DllInterface* this_, const CString& symbol) { return C::Get(this_)->FindSymbolPointer(symbol); }
		static Result<Binary*> DllInterface_GetBinary(const DllInterface* this_) { return C::Get(this_)->GetBinary(); }
		static Result<void> DllInterface_UpdateSymbolData(DllInterface* this_) { return C::Get(this_)->UpdateSymbolData(); }
		static Result<Url> DllInterface_GetPath(const DllInterface* this_) { return C::Get(this_)->GetPath(); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DllInterface::Hxx1::ConstFn<S>::FindSymbolPointer(const CString& symbol) const -> Result<void*>
{
	...
	return (MTable::_instance.DllInterface_FindSymbolPointer(o_, symbol));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DllInterface::Hxx1::ConstFn<S>::GetPath() const -> Result<Url>
{
	...
	return (MTable::_instance.DllInterface_GetPath(o_));
}
