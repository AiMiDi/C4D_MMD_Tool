...
namespace maxon
{
	...
	maxon::Bool DebugHardwareBreakPointInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->DebugHardwareBreakPointInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DebugHardwareBreakPointRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DebugHardwareBreakPointInterface_SetHardwareBreakpoint = &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_SetHardwareBreakpoint;
		#else
		tbl->DebugHardwareBreakPointInterface_SetHardwareBreakpoint = &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_SetHardwareBreakpoint;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint = &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint;
		#else
		tbl->DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint = &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
