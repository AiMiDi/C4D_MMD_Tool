...
namespace maxon
{
	...
	maxon::Bool ResolveInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->ResolveInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::ResolveInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ResolveInterface_RemoveDotSegments = &Hxx2::Wrapper<Hxx2::Unresolved>::ResolveInterface_RemoveDotSegments;
		#else
		tbl->ResolveInterface_RemoveDotSegments = &Hxx2::Wrapper<Hxx2::Unresolved>::ResolveInterface_RemoveDotSegments;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableErrorOpenFileDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoConnectionInterface_ObservableErrorOpenFile = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::IoConnectionInterface_ObservableErrorOpenFile;
		#else
		tbl->IoConnectionInterface_ObservableErrorOpenFile = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::IoConnectionInterface_ObservableErrorOpenFile;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
