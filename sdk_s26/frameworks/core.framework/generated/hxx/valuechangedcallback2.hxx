...
struct ValueChangedCallbackInterface::MTable
{
	...
	Result<void> (*ValueChangedCallbackInterface_ValueChangedMessage) (maxon::GenericComponent* this_, const InternedId& id);
	...
	{
		ValueChangedCallbackInterface_ValueChangedMessage = &W::ValueChangedCallbackInterface_ValueChangedMessage;
		ValueChangedCallbackInterface_ValueChangedMessage_Offset = offset;
	}
	}
...
struct ValueChangedCallbackInterface::Hxx2
{
	...
	public:
		...
		static Result<void> ValueChangedCallbackInterface_ValueChangedMessage(maxon::GenericComponent* this_, const InternedId& id) { return ((typename S::Implementation*) this_)->ValueChangedMessage(id); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto ValueChangedCallbackInterface::ValueChangedMessage(const InternedId& id) -> Result<void>
{
	const ValueChangedCallbackInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(ValueChangedCallbackInterface, this); return mt_.ValueChangedCallbackInterface_ValueChangedMessage((maxon::GenericComponent*) this + mt_.ValueChangedCallbackInterface_ValueChangedMessage_Offset, id);
}
