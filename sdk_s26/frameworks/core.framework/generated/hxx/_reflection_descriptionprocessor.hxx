...
namespace maxon
{
	...
	public:
		...
		Result<GenericData> Process(const Id& descriptionId, const DataDescription& dataDescription) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DescriptionProcessorInterface_Process_Offset), maxon::reflection::Argument::ByReference(descriptionId), maxon::reflection::Argument::ByReference(dataDescription)};
			(*handler_)(_fn_DescriptionProcessorInterface_Process, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<GenericData>, const maxon::GenericComponent*, const Id&, const DataDescription&>::Invoke, (const void*) mt_.DescriptionProcessorInterface_Process));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_DescriptionProcessorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "descriptionId\0dataDescription\0", 5LL, DescriptionProcessorInterface, DescriptionProcessorInterface_Process),
		};
