...
namespace maxon
{
	...
	namespace enum135
	{
		...
		static const maxon::UInt64 APPLICATIONFEATURE_values[] = {maxon::UInt64(enum135::APPLICATIONFEATURE::NONE), maxon::UInt64(enum135::APPLICATIONFEATURE::COMMANDLINE)};
		static const maxon::EnumInfo APPLICATIONFEATURE_info{"APPLICATIONFEATURE", SIZEOF(APPLICATIONFEATURE), true, "NONE\0COMMANDLINE\0", APPLICATIONFEATURE_values, std::extent<decltype(APPLICATIONFEATURE_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATIONFEATURE135(){ return enum135::APPLICATIONFEATURE_info; }
	...
	maxon::Bool Application::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetTempUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetTempUrl;
		#else
		tbl->Application_GetTempUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetTempUrl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Url>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetModulePaths = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetModulePaths;
		#else
		tbl->Application_GetModulePaths = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetModulePaths;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Application_GetCommandLineArgCount = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetCommandLineArgCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetCommandLineArg = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetCommandLineArg;
		#else
		tbl->Application_GetCommandLineArg = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetCommandLineArg;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<DataDictionary>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetMachineInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetMachineInfo;
		#else
		tbl->Application_GetMachineInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetMachineInfo;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<APPLICATIONMODE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetApplicationMode = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetApplicationMode;
		#else
		tbl->Application_GetApplicationMode = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetApplicationMode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Application_SetApplicationMode = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_SetApplicationMode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Application_GetFeature = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetFeature;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Application_SetFeature = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_SetFeature;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetVersion = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetVersion;
		#else
		tbl->Application_GetVersion = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetVersion;
		#endif
#ifdef MAXON_TARGET_WINDOWS
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<SUBSYSTEM>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetWindowsSubsystem = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetWindowsSubsystem;
		#else
		tbl->Application_GetWindowsSubsystem = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetWindowsSubsystem;
		#endif
#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableApplicationMessageDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_ObservableApplicationMessage = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_ObservableApplicationMessage;
		#else
		tbl->Application_ObservableApplicationMessage = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_ObservableApplicationMessage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Application_GetUrlI = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetUrlI;
		#else
		tbl->Application_GetUrlI = &Hxx2::Wrapper<Hxx2::Unresolved>::Application_GetUrlI;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
