...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_SecureRandom(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(SecureRandom::MTable::_instance.SecureRandom_GetDefaultProvider)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(SecureRandom::MTable::_instance.SecureRandom_GetRandomNumber)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "provider\0buffer\0", 5LL, nullptr),
		};
