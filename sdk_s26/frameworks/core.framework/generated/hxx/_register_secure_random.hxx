...
namespace maxon
{
	...
	maxon::Bool SecureRandom::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<SecureRandomProvider>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SecureRandom_GetDefaultProvider = &Hxx2::Wrapper<Hxx2::Unresolved>::SecureRandom_GetDefaultProvider;
		#else
		tbl->SecureRandom_GetDefaultProvider = &Hxx2::Wrapper<Hxx2::Unresolved>::SecureRandom_GetDefaultProvider;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SecureRandom_GetRandomNumber = &Hxx2::Wrapper<Hxx2::Unresolved>::SecureRandom_GetRandomNumber;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
