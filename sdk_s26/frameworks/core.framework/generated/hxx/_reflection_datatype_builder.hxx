...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataTypeBuilderInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeBuilderInterface::Hxx2::StaticMTable::_instance.DataTypeBuilderInterface_GetDataTypeName)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dt\0category\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataTypeBuilderInterface::Hxx2::StaticMTable::_instance.DataTypeBuilderInterface_RecurseDataType)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "category\0dt\0parentTypeId\0globalIdentifier\0components\0", 0LL, nullptr),
		};
