...
namespace maxon
{
	...
	public:
		...
		Result<void> SetData(ForwardingDataPtr&& key, Data&& data) 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_SetData, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ForwardingDataPtr&&, Data&&>::Invoke, (const void*) mt_.DataDictionaryObjectInterface_SetData));
			return proxy_result;
		}
		...
		Result<Data> GetData(const ConstDataPtr& key) const 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_GetData, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_.DataDictionaryObjectInterface_GetData));
			return proxy_result;
		}
		...
		Result<void> EraseData(const ConstDataPtr& key) 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_EraseData, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_.DataDictionaryObjectInterface_EraseData));
			return proxy_result;
		}
		...
		void Reset() 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDictionaryObjectInterface_Reset));
		}
		...
		Bool IsEmpty() const 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_IsEmpty, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDictionaryObjectInterface_IsEmpty));
			return proxy_result;
		}
		...
		void InitIterator(DataDictionaryIteratorInterface* iterator, Bool end) const 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_InitIterator, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, DataDictionaryIteratorInterface*, Bool>::Invoke, (const void*) mt_.DataDictionaryObjectInterface_InitIterator));
		}
	...
	public:
		...
		Result<void> Init(DataDictionary* reference) 
		{
			...
			(*handler_)(_fn_DataDictionaryReferenceObjectInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, DataDictionary*>::Invoke, (const void*) mt_.DataDictionaryReferenceObjectInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(const DataDictionary* reference) 
		{
			...
			(*handler_)(_fn_DataDictionaryReferenceObjectInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDictionary*>::Invoke, (const void*) mt_.DataDictionaryReferenceObjectInterface_Init_1));
			return proxy_result;
		}
		...
		const DataDictionary& GetDataContainer() const 
		{
			...
			(*handler_)(_fn_DataDictionaryReferenceObjectInterface_GetDataContainer, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataDictionary&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDictionaryReferenceObjectInterface_GetDataContainer));
			return *proxy_result;
		}
