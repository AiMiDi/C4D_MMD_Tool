...
struct TimerInterface::MTable
{
	...
	void (*TimerInterface_Free) (const TimerInterface* object);
	TimerInterface* (*TimerInterface_Alloc) (const maxon::SourceLocation& allocLocation);
	void (*TimerInterface_CancelAndWait) (TimerInterface* this_);
	void (*TimerInterface_Cancel) (TimerInterface* this_);
	maxon::ObservableRef<ObservableTimerStartedDelegate> (*TimerInterface_ObservableTimerStarted) (const TimerInterface* this_);
	maxon::ObservableRef<ObservableTimerFinishedDelegate> (*TimerInterface_ObservableTimerFinished) (const TimerInterface* this_);
	maxon::ObservableRef<ObservableTimerOverloadDelegate> (*TimerInterface_ObservableTimerOverload) (const TimerInterface* this_);
/// @cond IGNORE

	void (*TimerInterface_PrivateDisableAllTimers) ();
	Result<void> (*TimerInterface_Start) (TimerInterface* this_, Float64 interval, Float64 startOffset, Float64 tolerance, const JobInterfacePOD& pod, JobQueueInterface* queue);
/// @endcond

	template <typename IMPL> void Init()
	{
		TimerInterface_Free = &IMPL::TimerInterface_Free;
		TimerInterface_Alloc = &IMPL::TimerInterface_Alloc;
		TimerInterface_CancelAndWait = &IMPL::TimerInterface_CancelAndWait;
		TimerInterface_Cancel = &IMPL::TimerInterface_Cancel;
		TimerInterface_ObservableTimerStarted = &IMPL::TimerInterface_ObservableTimerStarted;
		TimerInterface_ObservableTimerFinished = &IMPL::TimerInterface_ObservableTimerFinished;
		TimerInterface_ObservableTimerOverload = &IMPL::TimerInterface_ObservableTimerOverload;
/// @cond IGNORE

		TimerInterface_PrivateDisableAllTimers = &IMPL::TimerInterface_PrivateDisableAllTimers;
		TimerInterface_Start = &IMPL::TimerInterface_Start;
/// @endcond
...
struct TimerInterface::Hxx2
{
	...
	public:
		...
		static void TimerInterface_CancelAndWait(TimerInterface* this_) { return C::Get(this_)->CancelAndWait(); }
		static void TimerInterface_Cancel(TimerInterface* this_) { return C::Get(this_)->Cancel(); }
		static maxon::ObservableRef<ObservableTimerStartedDelegate> TimerInterface_ObservableTimerStarted(const TimerInterface* this_) { return C::Get(this_)->ObservableTimerStarted(); }
		static maxon::ObservableRef<ObservableTimerFinishedDelegate> TimerInterface_ObservableTimerFinished(const TimerInterface* this_) { return C::Get(this_)->ObservableTimerFinished(); }
		static maxon::ObservableRef<ObservableTimerOverloadDelegate> TimerInterface_ObservableTimerOverload(const TimerInterface* this_) { return C::Get(this_)->ObservableTimerOverload(); }
/// @cond IGNORE

		static void TimerInterface_PrivateDisableAllTimers() { return C::PrivateDisableAllTimers(); }
		static Result<void> TimerInterface_Start(TimerInterface* this_, Float64 interval, Float64 startOffset, Float64 tolerance, const JobInterfacePOD& pod, JobQueueInterface* queue) { return C::Get(this_)->Start(interval, startOffset, tolerance, pod, queue); }
/// @endcond
...
{
	return MTable::_instance.TimerInterface_CancelAndWait(this);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Cancel() -> void
{
	return MTable::_instance.TimerInterface_Cancel(this);
}
...
{
	return MTable::_instance.TimerInterface_ObservableTimerStarted(this);
}
...
{
	return MTable::_instance.TimerInterface_ObservableTimerFinished(this);
}
...
{
	return MTable::_instance.TimerInterface_ObservableTimerOverload(this);
}
/// @cond IGNORE
...
{
	return MTable::_instance.TimerInterface_Start(this, interval, startOffset, tolerance, pod, queue);
}
/// @endcond
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::Fn<S>::CancelAndWait() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	...
	MTable::_instance.TimerInterface_CancelAndWait(o_);
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); TimerInterface* o_ = (TimerInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
	MTable::_instance.TimerInterface_Cancel(o_);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::ConstFn<S>::ObservableTimerStarted() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableTimerStartedDelegate>>, maxon::ObservableRef<ObservableTimerStartedDelegate>>::type
{
	...
	return (MTable::_instance.TimerInterface_ObservableTimerStarted(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::ConstFn<S>::ObservableTimerFinished() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableTimerFinishedDelegate>>, maxon::ObservableRef<ObservableTimerFinishedDelegate>>::type
{
	...
	return (MTable::_instance.TimerInterface_ObservableTimerFinished(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::ConstFn<S>::ObservableTimerOverload() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableTimerOverloadDelegate>>, maxon::ObservableRef<ObservableTimerOverloadDelegate>>::type
{
	...
	return (MTable::_instance.TimerInterface_ObservableTimerOverload(o_));
}
/// @cond IGNORE
