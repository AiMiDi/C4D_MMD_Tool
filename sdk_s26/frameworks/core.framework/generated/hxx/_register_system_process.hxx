...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(SystemProcessKilledErrorInterface, , "net.maxon.interface.systemprocesskillederror", "maxon.SystemProcessKilledErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(SystemProcessOperationErrorInterface, , "net.maxon.interface.systemprocessoperationerror", "maxon.SystemProcessOperationErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	const maxon::Char* const SystemProcessObjectInterface::MTable::_ids = 
		...
		"ObservableProcessFinished@de47b17497b69f7c\0" // maxon::ObservableRef<ObservableProcessFinishedDelegate> ObservableProcessFinished() const
	"";
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(SystemProcessObjectInterface, , "net.maxon.interface.systemprocessobject", "maxon.SystemProcessObjectInterface", (ObserverObjectInterface::PrivateGetInterface()));
	...
	maxon::Bool SystemProcessInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<SystemProcessObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_CreateProcess = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_CreateProcess;
		#else
		tbl->SystemProcessInterface_CreateProcess = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_CreateProcess;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SystemProcessObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_StartProcessAndWait = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_StartProcessAndWait;
		#else
		tbl->SystemProcessInterface_StartProcessAndWait = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_StartProcessAndWait;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_GetSystemProcesses = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetSystemProcesses;
		#else
		tbl->SystemProcessInterface_GetSystemProcesses = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetSystemProcesses;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SystemProcessInterface_GetCurrentProcessId = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetCurrentProcessId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SystemProcessObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_GetProcess = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetProcess;
		#else
		tbl->SystemProcessInterface_GetProcess = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetProcess;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<WAIT_PROCESS_RESULT>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_WaitForProcess = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_WaitForProcess;
		#else
		tbl->SystemProcessInterface_WaitForProcess = &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_WaitForProcess;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
