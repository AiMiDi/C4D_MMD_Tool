...
namespace maxon
{
	...
	maxon::Bool DimensionInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<const Dimension&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DimensionInterface_Get = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DimensionInterface_Get;
		#else
		tbl->DimensionInterface_Get = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DimensionInterface_Get;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	maxon::Bool UnitInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnitInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetId;
		#else
		tbl->UnitInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Dimension&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_GetDimension = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetDimension;
		#else
		tbl->UnitInterface_GetDimension = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetDimension;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnitInterface_GetSIConversionFactor = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetSIConversionFactor;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Unit>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_operatorMul = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorMul;
		#else
		tbl->UnitInterface_operatorMul = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorMul;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Unit>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_operatorDiv = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorDiv;
		#else
		tbl->UnitInterface_operatorDiv = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorDiv;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Unit>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_operatorXor = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorXor;
		#else
		tbl->UnitInterface_operatorXor = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorXor;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Unit>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_Copy = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy;
		#else
		tbl->UnitInterface_Copy = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Unit>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_Copy_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy_1;
		#else
		tbl->UnitInterface_Copy_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_AddToDimension = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_AddToDimension;
		#else
		tbl->UnitInterface_AddToDimension = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_AddToDimension;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Unit>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_Reduce = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Reduce;
		#else
		tbl->UnitInterface_Reduce = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Reduce;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnitInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_ToString;
		#else
		tbl->UnitInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_ToString;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
