...
namespace maxon
{
	...
	maxon::Bool FileUtilities::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_ReadFileToMemory = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadFileToMemory;
		#else
		tbl->FileUtilities_ReadFileToMemory = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadFileToMemory;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_ReadUtfFile = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadUtfFile;
		#else
		tbl->FileUtilities_ReadUtfFile = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadUtfFile;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_WriteUtfFile = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteUtfFile;
		#else
		tbl->FileUtilities_WriteUtfFile = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteUtfFile;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CompareFiles = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CompareFiles;
		#else
		tbl->FileUtilities_CompareFiles = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CompareFiles;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CopyStream = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyStream;
		#else
		tbl->FileUtilities_CopyStream = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyStream;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CopyStreamProgress = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyStreamProgress;
		#else
		tbl->FileUtilities_CopyStreamProgress = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyStreamProgress;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CopyFileOrDirectory = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyFileOrDirectory;
		#else
		tbl->FileUtilities_CopyFileOrDirectory = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyFileOrDirectory;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CopyFileOrDirectory_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyFileOrDirectory_1;
		#else
		tbl->FileUtilities_CopyFileOrDirectory_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CopyFileOrDirectory_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_WriteDirectoryTree = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteDirectoryTree;
		#else
		tbl->FileUtilities_WriteDirectoryTree = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteDirectoryTree;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_ReadDirectoryTree = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadDirectoryTree;
		#else
		tbl->FileUtilities_ReadDirectoryTree = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadDirectoryTree;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<OutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CreateCStringOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CreateCStringOutputStream;
		#else
		tbl->FileUtilities_CreateCStringOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CreateCStringOutputStream;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<OutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CreateCStringOutputStream_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CreateCStringOutputStream_1;
		#else
		tbl->FileUtilities_CreateCStringOutputStream_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CreateCStringOutputStream_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<OutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_CreateNullOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CreateNullOutputStream;
		#else
		tbl->FileUtilities_CreateNullOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_CreateNullOutputStream;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_WriteArray = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteArray;
		#else
		tbl->FileUtilities_WriteArray = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteArray;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_WriteString = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteString;
		#else
		tbl->FileUtilities_WriteString = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_WriteString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileUtilities_ReadString = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadString;
		#else
		tbl->FileUtilities_ReadString = &Hxx2::Wrapper<Hxx2::Unresolved>::FileUtilities_ReadString;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
