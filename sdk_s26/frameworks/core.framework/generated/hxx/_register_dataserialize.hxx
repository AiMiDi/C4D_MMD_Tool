...
namespace maxon
{
	...
	namespace enum189
	{
		...
		static const maxon::UInt64 PREPAREHELPERFLAGS_values[] = {maxon::UInt64(enum189::PREPAREHELPERFLAGS::NONE), maxon::UInt64(enum189::PREPAREHELPERFLAGS::INITIALIZE_READ), maxon::UInt64(enum189::PREPAREHELPERFLAGS::INITIALIZE_WRITE), maxon::UInt64(enum189::PREPAREHELPERFLAGS::FINALIZE_READ), maxon::UInt64(enum189::PREPAREHELPERFLAGS::FINALIZE_WRITE), maxon::UInt64(enum189::PREPAREHELPERFLAGS::VALIDATE_STATE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_PREPAREHELPERFLAGS189(){ return enum189::PREPAREHELPERFLAGS_info; }
