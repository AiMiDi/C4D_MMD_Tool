...
namespace maxon
{
	...
	maxon::Bool CustomAllocatorInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->CustomAllocatorInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_AllocClear = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_AllocClear;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_Realloc = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_Realloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_PrivateAlloc = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_PrivateAlloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_PrivateFree = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_PrivateFree;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CustomAllocatorInterface_PrivateGetDataSize = &Hxx2::Wrapper<Hxx2::Unresolved>::CustomAllocatorInterface_PrivateGetDataSize;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
