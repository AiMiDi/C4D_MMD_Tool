...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionObjectInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionObjectInterface::Hxx2::StaticMTable::_instance.DataDescriptionObjectInterface_GetObjectName)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "classId\0language\0", 5LL, nullptr),
		};
