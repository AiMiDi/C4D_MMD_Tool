...
namespace maxon
{
	...
	maxon::Bool CrashReportServices::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->CrashReportServices_CreateCrashReportProperty = &Hxx2::Wrapper<Hxx2::Unresolved>::CrashReportServices_CreateCrashReportProperty;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CrashReportServices_FreeCrashReportProperty = &Hxx2::Wrapper<Hxx2::Unresolved>::CrashReportServices_FreeCrashReportProperty;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CrashReportServices_GetCrashReportProperties = &Hxx2::Wrapper<Hxx2::Unresolved>::CrashReportServices_GetCrashReportProperties;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
