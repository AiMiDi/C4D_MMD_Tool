...
namespace maxon
{
	...
	public:
		...
		String GetUniqueId() const 
		{
			...
			(*handler_)(_fn_MachineInterface_GetUniqueId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MachineInterface_GetUniqueId));
			return proxy_result;
		}
		...
		Result<DataDictionary> GetMachineInfo() const 
		{
			...
			(*handler_)(_fn_MachineInterface_GetMachineInfo, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataDictionary>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MachineInterface_GetMachineInfo));
			return proxy_result;
		}
		...
		Result<ObjectRef> GetInterface(const Id& interfaceName) 
		{
			...
			(*handler_)(_fn_MachineInterface_GetInterface, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<ObjectRef>, maxon::GenericComponent*, const Id&>::Invoke, (const void*) mt_.MachineInterface_GetInterface));
			return proxy_result;
		}
		...
		MACHINESTATE GetState() const 
		{
			...
			(*handler_)(_fn_MachineInterface_GetState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<MACHINESTATE, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MachineInterface_GetState));
			return proxy_result;
		}
		...
		Bool SetState(MACHINESTATE stateMask, MACHINESTATE stateFlags) 
		{
			...
			(*handler_)(_fn_MachineInterface_SetState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, MACHINESTATE, MACHINESTATE>::Invoke, (const void*) mt_.MachineInterface_SetState));
			return proxy_result;
		}
		...
		String ToString(const FormatStatement* formatStatement) const 
		{
			...
			(*handler_)(_fn_MachineInterface_ToString, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const FormatStatement*>::Invoke, (const void*) mt_.MachineInterface_ToString));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_MachineInterface_ToString;
		maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> ObservablePrivateSplashMessageReceived() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<MachineInterface>();
			maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> proxy_result = maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>::NullValue();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.MachineInterface_ObservablePrivateSplashMessageReceived_Offset)};
			(*handler_)(_fn_MachineInterface_ObservablePrivateSplashMessageReceived, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MachineInterface_ObservablePrivateSplashMessageReceived));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_MachineInterface_ObservablePrivateSplashMessageReceived;
		maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<MachineInterface>();
			maxon::ObservableRef<ObservableActivationChangedDelegate> proxy_result = maxon::ObservableRef<ObservableActivationChangedDelegate>::NullValue();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.MachineInterface_ObservableActivationChanged_Offset)};
			(*handler_)(_fn_MachineInterface_ObservableActivationChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableActivationChangedDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MachineInterface_ObservableActivationChanged));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_MachineInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, MachineInterface, MachineInterface_ObservablePrivateSplashMessageReceived),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, MachineInterface, MachineInterface_ObservableActivationChanged),
		};
...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_MachinesInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance.MachinesInterface_GetLocal)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance.MachinesInterface_GetRPCMachines)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "machines\0", 2LL, nullptr),
/// @cond INTERNAL

/// @endcond

			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance.MachinesInterface_FindRPCMachine)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "machineUuid\0", 1LL, nullptr),
/// @cond INTERNAL

/// @endcond

			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance.MachinesInterface_FindOrAddRPCMachine)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "machineUuid\0state\0newMachineCallback\0existingCallback\0", 85LL, nullptr),
/// @cond INTERNAL

/// @endcond

			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance.MachinesInterface_RemoveRPCMachine)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "machine\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance.MachinesInterface_ObservableMachineStateChanged)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
