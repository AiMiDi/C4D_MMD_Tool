...
/// @endcond
	...
	maxon::Bool MachinesInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<MachineRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->MachinesInterface_GetLocal = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_GetLocal;
		#else
		tbl->MachinesInterface_GetLocal = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_GetLocal;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->MachinesInterface_GetRPCMachines = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_GetRPCMachines;
		#else
		tbl->MachinesInterface_GetRPCMachines = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_GetRPCMachines;
		#endif
/// @cond INTERNAL
...
/// @endcond
		...
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<MachineRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->MachinesInterface_FindRPCMachine = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_FindRPCMachine;
		#else
		tbl->MachinesInterface_FindRPCMachine = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_FindRPCMachine;
		#endif
/// @cond INTERNAL
...
/// @endcond
		...
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<MachineRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->MachinesInterface_FindOrAddRPCMachine = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_FindOrAddRPCMachine;
		#else
		tbl->MachinesInterface_FindOrAddRPCMachine = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_FindOrAddRPCMachine;
		#endif
/// @cond INTERNAL
...
/// @endcond
		...
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->MachinesInterface_RemoveRPCMachine = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_RemoveRPCMachine;
		#else
		tbl->MachinesInterface_RemoveRPCMachine = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_RemoveRPCMachine;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableMachineStateChangedDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->MachinesInterface_ObservableMachineStateChanged = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_ObservableMachineStateChanged;
		#else
		tbl->MachinesInterface_ObservableMachineStateChanged = &Hxx2::Wrapper<Hxx2::Unresolved>::MachinesInterface_ObservableMachineStateChanged;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
