...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function) 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const ObservableForwardFunction, DelegateBase&&>::Invoke, (const void*) mt_.FunctionBaseInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function, const JobQueueRef& queue) 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const ObservableForwardFunction, DelegateBase&&, const JobQueueRef&>::Invoke, (const void*) mt_.FunctionBaseInterface_Init_1));
			return proxy_result;
		}
		...
		void Set(ObserverObjectInterface* owner, ObserverObjectInterface* observer) 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_Set, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, ObserverObjectInterface*, ObserverObjectInterface*>::Invoke, (const void*) mt_.FunctionBaseInterface_Set));
		}
		...
		void GetOwner(ObserverObjectRef& res) const 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_GetOwner, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, ObserverObjectRef&>::Invoke, (const void*) mt_.FunctionBaseInterface_GetOwner));
		}
		...
		void GetObserver(ObserverObjectRef& res) const 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_GetObserver, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, ObserverObjectRef&>::Invoke, (const void*) mt_.FunctionBaseInterface_GetObserver));
		}
		...
		const void* GetObserverPointer() const 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_GetObserverPointer, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const void*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FunctionBaseInterface_GetObserverPointer));
			return proxy_result;
		}
		...
		Result<Data> Execute(const Block<const ConstDataPtr>& args) 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_Execute, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Data>, maxon::GenericComponent*, const Block<const ConstDataPtr>&>::Invoke, (const void*) mt_.FunctionBaseInterface_Execute));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> InitCombine(Result<Data>& combinedRes) const 
		{
			...
			(*handler_)(_fn_CombinerInterface_InitCombine, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, Result<Data>&>::Invoke, (const void*) mt_.CombinerInterface_InitCombine));
			return proxy_result;
		}
		...
		Result<Bool> CombineResult(Result<Data>& combinedRes, Result<Data>&& newRes) const 
		{
			...
			(*handler_)(_fn_CombinerInterface_CombineResult, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Bool>, const maxon::GenericComponent*, Result<Data>&, Result<Data>&&>::Invoke, (const void*) mt_.CombinerInterface_CombineResult));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> Init(ObserverObjectInterface* owner, const Id& observableName) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObserverObjectInterface*, const Id&>::Invoke, (const void*) mt_.ObservableBaseInterface_Init));
			return proxy_result;
		}
		...
		Id GetObservableId() const 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_GetObservableId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Id, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObservableBaseInterface_GetObservableId));
			return proxy_result;
		}
		...
		void _intDisconnectAll(ObserverObjectInterface* observer, Int pass) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObservableBaseInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ObservableBaseInterface__intDisconnectAll_Offset), maxon::reflection::Argument::ByValue(observer), maxon::reflection::Argument::ByValue(pass)};
			(*handler_)(_fn_ObservableBaseInterface__intDisconnectAll, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, ObserverObjectInterface*, Int>::Invoke, (const void*) mt_.ObservableBaseInterface__intDisconnectAll));
		}
		...
		Result<void> AddObserver(ObserverObjectInterface* observer, const FunctionBaseRef& observerFunction, Int priority) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_AddObserver, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObserverObjectInterface*, const FunctionBaseRef&, Int>::Invoke, (const void*) mt_.ObservableBaseInterface_AddObserver));
			return proxy_result;
		}
		...
		Result<Data> Notify(const Block<const ConstDataPtr>& args) const 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_Notify, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*, const Block<const ConstDataPtr>&>::Invoke, (const void*) mt_.ObservableBaseInterface_Notify));
			return proxy_result;
		}
		...
		Result<void> RemoveObserver(const FunctionBaseRef& observerEntry) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_RemoveObserver, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const FunctionBaseRef&>::Invoke, (const void*) mt_.ObservableBaseInterface_RemoveObserver));
			return proxy_result;
		}
		...
		void SetInverseNotification(Bool inverse) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_SetInverseNotification, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, Bool>::Invoke, (const void*) mt_.ObservableBaseInterface_SetInverseNotification));
		}
		...
		Int GetObserverCount() 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_GetObserverCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*>::Invoke, (const void*) mt_.ObservableBaseInterface_GetObserverCount));
			return proxy_result;
		}
		...
		ObserverObjectInterface* GetOwner() const 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_GetOwner, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ObserverObjectInterface*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObservableBaseInterface_GetOwner));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ObservableBaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "observer\0pass\0", 5LL, ObservableBaseInterface, ObservableBaseInterface__intDisconnectAll),
	...
	static maxon::Result<void> RegisterReflection_ObservableStaticInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ObservableStaticInterface::MTable::_instance.ObservableStaticInterface_GetOrAllocClass)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "id\0id1\0id2\0", 0LL, nullptr),
		};
