...
/// @endcond
	...
	maxon::Bool ClassInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->ClassInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetId;
		#else
		tbl->ClassInterface_GetId = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetId;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<KIND>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_GetKind = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetKind;
		#else
		tbl->ClassInterface_GetKind = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetKind;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_GetSize = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetSize;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Block<const ComponentInfo* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_GetComponents = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetComponents;
		#else
		tbl->ClassInterface_GetComponents = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetComponents;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_AddComponent = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddComponent;
		#else
		tbl->ClassInterface_AddComponent = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddComponent;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_RemoveLastComponent = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_RemoveLastComponent;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_AddComponents = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddComponents;
		#else
		tbl->ClassInterface_AddComponents = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddComponents;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_Finalize = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Finalize;
		#else
		tbl->ClassInterface_Finalize = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Finalize;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_IsFinalized = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_IsFinalized;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Block<const InterfaceReference* const>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_GetImplementedInterfaces = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetImplementedInterfaces;
		#else
		tbl->ClassInterface_GetImplementedInterfaces = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetImplementedInterfaces;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_GetDataType = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetDataType;
		#else
		tbl->ClassInterface_GetDataType = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetDataType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<typename maxon::details::ClassGetNonConst<REF>::type>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_Create = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Create;
		#else
		tbl->ClassInterface_Create = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Create;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ObjectInterface*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_CreatePointer = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CreatePointer;
		#else
		tbl->ClassInterface_CreatePointer = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CreatePointer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ObjectInterface*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_CreatePointer_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CreatePointer_1;
		#else
		tbl->ClassInterface_CreatePointer_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CreatePointer_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_IsSubclassOf = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_IsSubclassOf;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_ToString;
		#else
		tbl->ClassInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_ToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataDictionary&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_GetMetaData = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetMetaData;
		#else
		tbl->ClassInterface_GetMetaData = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetMetaData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_InitMetaData = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_InitMetaData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_DeleteInstance = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_DeleteInstance;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_DestructInstance = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_DestructInstance;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_CopyInstance = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CopyInstance;
		#else
		tbl->ClassInterface_CopyInstance = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CopyInstance;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_GetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetInfo;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ClassInterface_GetOrCreateMTable = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetOrCreateMTable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ClassInterface_AddProxyComponent = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddProxyComponent;
		#else
		tbl->ClassInterface_AddProxyComponent = &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddProxyComponent;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
