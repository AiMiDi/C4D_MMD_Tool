...
namespace maxon
{
	...
	maxon::Bool DllInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->DllInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DllRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_LoadDll = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_LoadDll;
		#else
		tbl->DllInterface_LoadDll = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_LoadDll;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DllRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetModule = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetModule;
		#else
		tbl->DllInterface_GetModule = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetModule;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_AddDllPath = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_AddDllPath;
		#else
		tbl->DllInterface_AddDllPath = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_AddDllPath;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_RemoveDllPath = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_RemoveDllPath;
		#else
		tbl->DllInterface_RemoveDllPath = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_RemoveDllPath;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetLoadedDlls = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetLoadedDlls;
		#else
		tbl->DllInterface_GetLoadedDlls = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetLoadedDlls;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_Unload = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Unload;
		#else
		tbl->DllInterface_Unload = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Unload;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_Release = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Release;
		#else
		tbl->DllInterface_Release = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Release;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_FindSymbolPointer = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_FindSymbolPointer;
		#else
		tbl->DllInterface_FindSymbolPointer = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_FindSymbolPointer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Binary*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetBinary = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetBinary;
		#else
		tbl->DllInterface_GetBinary = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetBinary;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_UpdateSymbolData = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_UpdateSymbolData;
		#else
		tbl->DllInterface_UpdateSymbolData = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_UpdateSymbolData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetPath = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetPath;
		#else
		tbl->DllInterface_GetPath = &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetPath;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
