...
struct GetExtraDataCallbackInterface::MTable
{
	...
	Result<DelegateBase> (*GetExtraDataCallbackInterface_GetExtraDataMessage) (maxon::GenericComponent* this_, const Id& cmdId);
	...
	{
		GetExtraDataCallbackInterface_GetExtraDataMessage = &W::GetExtraDataCallbackInterface_GetExtraDataMessage;
		GetExtraDataCallbackInterface_GetExtraDataMessage_Offset = offset;
	}
	}
...
struct GetExtraDataCallbackInterface::Hxx2
{
	...
	public:
		...
		static Result<DelegateBase> GetExtraDataCallbackInterface_GetExtraDataMessage(maxon::GenericComponent* this_, const Id& cmdId) { return ((typename S::Implementation*) this_)->GetExtraDataMessage(cmdId); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto GetExtraDataCallbackInterface::GetExtraDataMessage(const Id& cmdId) -> Result<DelegateBase>
{
	const GetExtraDataCallbackInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(GetExtraDataCallbackInterface, this); return mt_.GetExtraDataCallbackInterface_GetExtraDataMessage((maxon::GenericComponent*) this + mt_.GetExtraDataCallbackInterface_GetExtraDataMessage_Offset, cmdId);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto GetExtraDataCallbackInterface::Hxx1::Fn<S>::GetExtraDataMessage(const Id& cmdId) const -> Result<DelegateBase>
{
	...
	return (mt_.GetExtraDataCallbackInterface_GetExtraDataMessage(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.GetExtraDataCallbackInterface_GetExtraDataMessage_Offset, cmdId));
}
