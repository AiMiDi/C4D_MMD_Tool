...
namespace maxon
{
	...
	maxon::Bool Configuration::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryBool = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryBool;
		#else
		tbl->Configuration_QueryBool = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryBool;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryInt = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryInt;
		#else
		tbl->Configuration_QueryInt = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryInt;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryFloat;
		#else
		tbl->Configuration_QueryFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryFloat;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryString = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryString;
		#else
		tbl->Configuration_QueryString = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForBool = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForBool;
		#else
		tbl->Configuration_AddHelpForBool = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForBool;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForInt = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForInt;
		#else
		tbl->Configuration_AddHelpForInt = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForInt;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForFloat;
		#else
		tbl->Configuration_AddHelpForFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForFloat;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForString = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForString;
		#else
		tbl->Configuration_AddHelpForString = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForOption = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForOption;
		#else
		tbl->Configuration_AddHelpForOption = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForOption;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastBool = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastBool;
		#else
		tbl->Configuration_BroadcastBool = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastBool;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastInt = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastInt;
		#else
		tbl->Configuration_BroadcastInt = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastInt;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastFloat;
		#else
		tbl->Configuration_BroadcastFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastFloat;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastString = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastString;
		#else
		tbl->Configuration_BroadcastString = &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastString;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
