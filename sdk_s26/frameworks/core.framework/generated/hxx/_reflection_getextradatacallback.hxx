...
namespace maxon
{
	...
	public:
		...
		Result<DelegateBase> GetExtraDataMessage(const Id& cmdId) 
		{
			...
			(*handler_)(_fn_GetExtraDataCallbackInterface_GetExtraDataMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DelegateBase>, maxon::GenericComponent*, const Id&>::Invoke, (const void*) mt_.GetExtraDataCallbackInterface_GetExtraDataMessage));
			return proxy_result;
		}
