...
namespace maxon
{
	...
	maxon::Bool UnicodeUtils::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnicodeUtils_DecomposeStringHfs = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_DecomposeStringHfs;
		#else
		tbl->UnicodeUtils_DecomposeStringHfs = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_DecomposeStringHfs;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnicodeUtils_DecomposeString = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_DecomposeString;
		#else
		tbl->UnicodeUtils_DecomposeString = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_DecomposeString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnicodeUtils_GetUnicodeVersion = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_GetUnicodeVersion;
		#else
		tbl->UnicodeUtils_GetUnicodeVersion = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_GetUnicodeVersion;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnicodeUtils_NormalizeString = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_NormalizeString;
		#else
		tbl->UnicodeUtils_NormalizeString = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_NormalizeString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnicodeUtils_UniCharDecomposition = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_UniCharDecomposition;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnicodeUtils_UniCharHfsDecomposition = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_UniCharHfsDecomposition;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnicodeUtils_UniCodeCompare = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_UniCodeCompare;
		#else
		tbl->UnicodeUtils_UniCodeCompare = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_UniCodeCompare;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<CHARACTERTYPE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UnicodeUtils_GetCharacterType = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_GetCharacterType;
		#else
		tbl->UnicodeUtils_GetCharacterType = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_GetCharacterType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnicodeUtils_UpperCase = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_UpperCase;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnicodeUtils_TitleCase = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_TitleCase;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->UnicodeUtils_LowerCase = &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_LowerCase;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
