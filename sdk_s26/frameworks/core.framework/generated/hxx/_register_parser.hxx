...
namespace maxon
{
	...
	namespace PARSERPARAMETERS
	{
		namespace JWT
		{
			STRINGENCODING_PrivateAttribute STRINGENCODING;
			PRIVATEKEY_PrivateAttribute PRIVATEKEY;
			PUBLICKEY_PrivateAttribute PUBLICKEY;
		}
		namespace CSV
		{
			AUTODETECTDELIMITER_PrivateAttribute AUTODETECTDELIMITER;
			DELIMITER_PrivateAttribute DELIMITER;
			DETECTDATATYPES_PrivateAttribute DETECTDATATYPES;
			FORCESAMECOLUMNDATATYPE_PrivateAttribute FORCESAMECOLUMNDATATYPE;
			HASHEADER_PrivateAttribute HASHEADER;
			QUOTECHAR_PrivateAttribute QUOTECHAR;
			HASHTAGCOMMENTS_PrivateAttribute HASHTAGCOMMENTS;
			DOUBLEQUOTE_PrivateAttribute DOUBLEQUOTE;
			TRIMSPACES_PrivateAttribute TRIMSPACES;
			ROWLIMIT_PrivateAttribute ROWLIMIT;
		}
	}
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ParserInterface, , "net.maxon.interface.parser", "maxon.ParserInterface", (DataDictionaryObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int ParserInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_parser(0
	| maxon::ParserInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
