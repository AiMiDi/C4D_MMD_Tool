...
namespace maxon
{
	...
	maxon::Bool IoMemoryInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->IoMemoryInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->IoMemoryInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->IoMemoryInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_PrepareReadBuffer = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_PrepareReadBuffer;
		#else
		tbl->IoMemoryInterface_PrepareReadBuffer = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_PrepareReadBuffer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_Reset;
		#else
		tbl->IoMemoryInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_Reset;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Char&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_operatorIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_operatorIndex;
		#else
		tbl->IoMemoryInterface_operatorIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_operatorIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->IoMemoryInterface_GetSize = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_GetSize;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->IoMemoryInterface_IsWritable = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_IsWritable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_GetUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_GetUrl;
		#else
		tbl->IoMemoryInterface_GetUrl = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_GetUrl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_ReadBytes = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_ReadBytes;
		#else
		tbl->IoMemoryInterface_ReadBytes = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_ReadBytes;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_ReadBytesEOS = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_ReadBytesEOS;
		#else
		tbl->IoMemoryInterface_ReadBytesEOS = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_ReadBytesEOS;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_WriteBytes = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_WriteBytes;
		#else
		tbl->IoMemoryInterface_WriteBytes = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_WriteBytes;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<InputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_OpenInputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_OpenInputStream;
		#else
		tbl->IoMemoryInterface_OpenInputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_OpenInputStream;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<OutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_OpenOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_OpenOutputStream;
		#else
		tbl->IoMemoryInterface_OpenOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_OpenOutputStream;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<InOutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoMemoryInterface_OpenInOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_OpenInOutputStream;
		#else
		tbl->IoMemoryInterface_OpenInOutputStream = &Hxx2::Wrapper<Hxx2::Unresolved>::IoMemoryInterface_OpenInOutputStream;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
