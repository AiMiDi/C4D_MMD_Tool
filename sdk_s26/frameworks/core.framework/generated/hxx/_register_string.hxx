...
namespace maxon
{
	namespace enum44
	{
		...
		static const maxon::UInt64 STRINGCONVERSION_values[] = {maxon::UInt64(enum44::STRINGCONVERSION::NONE), maxon::UInt64(enum44::STRINGCONVERSION::ALLOW_MORE_CHARACTERS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_STRINGCONVERSION44(){ return enum44::STRINGCONVERSION_info; }
	namespace enum56
	{
		...
		static const maxon::UInt64 STRINGCOMPARISON_values[] = {maxon::UInt64(enum56::STRINGCOMPARISON::MEMORY), maxon::UInt64(enum56::STRINGCOMPARISON::UNICODE_LETTERS), maxon::UInt64(enum56::STRINGCOMPARISON::UNICODE_NUMBERS), maxon::UInt64(enum56::STRINGCOMPARISON::CASEINSENSITIVE), maxon::UInt64(enum56::STRINGCOMPARISON::CASEINSENSITIVE_NUMBERS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_STRINGCOMPARISON56(){ return enum56::STRINGCOMPARISON_info; }
	...
	public:
		...
		HashInt GetHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const StringInterface*) this)->GetHashCode(); return maxon::PrivateIncompleteNullReturnValue<HashInt>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		static String PrivateEnumToString(const EnumInfo& info, UInt64 value, const FormatStatement* formatStatement) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return StringInterface::PrivateEnumToString(info, value, formatStatement); return maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		Result<String> Prettify(Int indent, const String& indentStr, Int breakUpThreshold, Bool angularBrackets) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const StringInterface*) this)->Prettify(indent, indentStr, breakUpThreshold, angularBrackets); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	};
	MAXON_WARNING_POP
	...
	maxon::Bool StringInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->StringInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_GetLength = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetLength;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Init;
		#else
		tbl->StringInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Init;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Shrink = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Shrink;
		#else
		tbl->StringInterface_Shrink = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Shrink;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Append = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Append;
		#else
		tbl->StringInterface_Append = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Append;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Append_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Append_1;
		#else
		tbl->StringInterface_Append_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Append_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_FindIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_FindIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_FindLastIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_FindLastIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_FindIndex_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_FindIndex_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_FindLastIndex_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_FindLastIndex_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_FindUpperIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_FindUpperIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_FindLastUpperIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_FindLastUpperIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Erase = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Erase;
		#else
		tbl->StringInterface_Erase = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Erase;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Insert = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Insert;
		#else
		tbl->StringInterface_Insert = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Insert;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Insert_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Insert_1;
		#else
		tbl->StringInterface_Insert_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Insert_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_GetPart = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetPart;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_ToUpper = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_ToUpper;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_ToLower = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_ToLower;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_ComparePart = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_ComparePart;
		#else
		tbl->StringInterface_ComparePart = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_ComparePart;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetHashCode;
		#else
		tbl->StringInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetHashCode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_SetChar = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetChar;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_GetChar = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetChar;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetUtf32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUtf32;
		#else
		tbl->StringInterface_GetUtf32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUtf32;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_TrimLeft = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_TrimLeft;
		#else
		tbl->StringInterface_TrimLeft = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_TrimLeft;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_TrimRight = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_TrimRight;
		#else
		tbl->StringInterface_TrimRight = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_TrimRight;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Split = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Split;
		#else
		tbl->StringInterface_Split = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Split;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Replace = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace;
		#else
		tbl->StringInterface_Replace = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Replace_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace_1;
		#else
		tbl->StringInterface_Replace_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Replace_2 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace_2;
		#else
		tbl->StringInterface_Replace_2 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace_2;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetCStringBlock = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCStringBlock;
		#else
		tbl->StringInterface_GetCStringBlock = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCStringBlock;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetCStringAppendArray = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCStringAppendArray;
		#else
		tbl->StringInterface_GetCStringAppendArray = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCStringAppendArray;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCString;
		#else
		tbl->StringInterface_GetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetCString;
		#else
		tbl->StringInterface_SetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetCString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SysCharArray>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetSystemEncoding = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetSystemEncoding;
		#else
		tbl->StringInterface_GetSystemEncoding = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetSystemEncoding;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetSystemEncoding = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetSystemEncoding;
		#else
		tbl->StringInterface_SetSystemEncoding = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetSystemEncoding;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetUtf32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetUtf32;
		#else
		tbl->StringInterface_SetUtf32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetUtf32;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetUtf16 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUtf16;
		#else
		tbl->StringInterface_GetUtf16 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUtf16;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetUtf16 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetUtf16;
		#else
		tbl->StringInterface_SetUtf16 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetUtf16;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetAndCacheConstString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetAndCacheConstString;
		#else
		tbl->StringInterface_GetAndCacheConstString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetAndCacheConstString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetAndCacheConstString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetAndCacheConstString_1;
		#else
		tbl->StringInterface_GetAndCacheConstString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetAndCacheConstString_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_PrivateEnumToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_PrivateEnumToString;
		#else
		tbl->StringInterface_PrivateEnumToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_PrivateEnumToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<StridedBlock<const Generic>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetVariableInternalData = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetVariableInternalData;
		#else
		tbl->StringInterface_GetVariableInternalData = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetVariableInternalData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringInterface_GetCharacterWidth = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCharacterWidth;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Prettify = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Prettify;
		#else
		tbl->StringInterface_Prettify = &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Prettify;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	public:
		...
		HashInt GetHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const CStringInterface*) this)->GetHashCode(); return maxon::PrivateIncompleteNullReturnValue<HashInt>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
	...
	maxon::Bool CStringInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_GetLength = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetLength;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Init;
		#else
		tbl->CStringInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Init;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Shrink = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Shrink;
		#else
		tbl->CStringInterface_Shrink = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Shrink;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Append = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Append;
		#else
		tbl->CStringInterface_Append = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Append;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Append_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Append_1;
		#else
		tbl->CStringInterface_Append_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Append_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_FindIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_FindIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_FindLastIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_FindLastIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_FindIndex_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_FindIndex_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_FindLastIndex_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_FindLastIndex_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_FindUpperIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_FindUpperIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_FindLastUpperIndex = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_FindLastUpperIndex;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Erase = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Erase;
		#else
		tbl->CStringInterface_Erase = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Erase;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Insert = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Insert;
		#else
		tbl->CStringInterface_Insert = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Insert;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Insert_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Insert_1;
		#else
		tbl->CStringInterface_Insert_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Insert_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_GetPart = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetPart;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_ToUpper = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_ToUpper;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_ToLower = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_ToLower;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_ComparePart = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_ComparePart;
		#else
		tbl->CStringInterface_ComparePart = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_ComparePart;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetHashCode;
		#else
		tbl->CStringInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetHashCode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_SetChar = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_SetChar;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_GetChar = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetChar;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetUtf32 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetUtf32;
		#else
		tbl->CStringInterface_GetUtf32 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetUtf32;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_TrimLeft = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_TrimLeft;
		#else
		tbl->CStringInterface_TrimLeft = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_TrimLeft;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_TrimRight = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_TrimRight;
		#else
		tbl->CStringInterface_TrimRight = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_TrimRight;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Split = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Split;
		#else
		tbl->CStringInterface_Split = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Split;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Replace = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace;
		#else
		tbl->CStringInterface_Replace = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Replace_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace_1;
		#else
		tbl->CStringInterface_Replace_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Replace_2 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace_2;
		#else
		tbl->CStringInterface_Replace_2 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace_2;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CStringInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetCStringBlock = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCStringBlock;
		#else
		tbl->CStringInterface_GetCStringBlock = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCStringBlock;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetCStringAppendArray = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCStringAppendArray;
		#else
		tbl->CStringInterface_GetCStringAppendArray = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCStringAppendArray;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_SetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_SetCString;
		#else
		tbl->CStringInterface_SetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_SetCString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCString;
		#else
		tbl->CStringInterface_GetCString = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Block<const Char>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetInternalData = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetInternalData;
		#else
		tbl->CStringInterface_GetInternalData = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetInternalData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const CString&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetAndCacheConstString = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetAndCacheConstString;
		#else
		tbl->CStringInterface_GetAndCacheConstString = &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetAndCacheConstString;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
	#else
