...
namespace maxon
{
	...
	public:
		...
		Result<void> Write(const DataDictionary& object, String& string, Bool niceFormatting) 
		{
			...
			(*handler_)(_fn_ParserInterface_Write, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDictionary&, String&, Bool>::Invoke, (const void*) mt_.ParserInterface_Write));
			return proxy_result;
		}
		...
		Result<void> WriteFile(UrlOrOutputStream&& out, const StringEncodingRef& stringEncoding, const DataDictionary& dict, Bool niceFormatting) 
		{
			...
			(*handler_)(_fn_ParserInterface_WriteFile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, UrlOrOutputStream&&, const StringEncodingRef&, const DataDictionary&, Bool>::Invoke, (const void*) mt_.ParserInterface_WriteFile));
			return proxy_result;
		}
		...
		String GetFileExtension() const 
		{
			...
			(*handler_)(_fn_ParserInterface_GetFileExtension, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ParserInterface_GetFileExtension));
			return proxy_result;
		}
