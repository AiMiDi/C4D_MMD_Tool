...
namespace maxon
{
	...
	maxon::Bool DataTypeBuilderInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeBuilderInterface_GetDataTypeName = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataTypeBuilderInterface_GetDataTypeName;
		#else
		tbl->DataTypeBuilderInterface_GetDataTypeName = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataTypeBuilderInterface_GetDataTypeName;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Tuple<String, Bool>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeBuilderInterface_RecurseDataType = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataTypeBuilderInterface_RecurseDataType;
		#else
		tbl->DataTypeBuilderInterface_RecurseDataType = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataTypeBuilderInterface_RecurseDataType;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
