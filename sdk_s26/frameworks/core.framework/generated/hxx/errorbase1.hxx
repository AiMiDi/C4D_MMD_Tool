...
struct ThreadCancelledErrorInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ThreadCancelledErrorInterface>::value || ErrorInterface::HasBaseDetector::template Check<I>::value; static I* Cast(ThreadCancelledErrorInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
...
struct ThreadCancelledErrorInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(ThreadCancelledErrorInterface**);
...
#ifdef DOXYGEN
public COWFnDoxy<ThreadCancelledError>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ThreadCancelledErrorInterface, maxon::StrongCOWRefHandler, ThreadCancelledError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ThreadCancelledErrorInterface, maxon::StrongCOWRefHandler, ThreadCancelledError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ThreadCancelledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ThreadCancelledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};

/// ThreadCancelledError is the reference class of ThreadCancelledErrorInterface.
///
/// A ThreadCancelledError is returned if a function terminated because a job or thread has been cancelled (from outside).
