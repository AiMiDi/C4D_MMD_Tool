...
namespace maxon
{
	...
	public:
		...
		Result<void*> RegisterDefaults(CreateIoHelperFunc* createFunc, DeleteIoHelperFunc* deleteFunc) const 
		{
			...
			(*handler_)(_fn_DataSerializeInterface_RegisterDefaults, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void*>, const maxon::GenericComponent*, CreateIoHelperFunc*, DeleteIoHelperFunc*>::Invoke, (const void*) mt_.DataSerializeInterface_RegisterDefaults));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> WriteDocument(const Id& id, const ConstDataPtr& data) 
		{
			...
			(*handler_)(_fn_DataSerializeWriterInterface_WriteDocument, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Id&, const ConstDataPtr&>::Invoke, (const void*) mt_.DataSerializeWriterInterface_WriteDocument));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> ReadDocument(const Id& id, const DataPtr& data) 
		{
			...
			(*handler_)(_fn_DataSerializeReaderInterface_ReadDocument, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Id&, const DataPtr&>::Invoke, (const void*) mt_.DataSerializeReaderInterface_ReadDocument));
			return proxy_result;
		}
