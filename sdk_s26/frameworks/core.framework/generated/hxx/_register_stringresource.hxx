...
namespace maxon
{
	...
	maxon::Bool LanguageInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->LanguageInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LanguageInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LanguageInterface_LoadResourceString = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_LoadResourceString;
		#else
		tbl->LanguageInterface_LoadResourceString = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_LoadResourceString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LanguageInterface_GetName = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_GetName;
		#else
		tbl->LanguageInterface_GetName = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_GetName;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Id>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LanguageInterface_GetIdentifier = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_GetIdentifier;
		#else
		tbl->LanguageInterface_GetIdentifier = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_GetIdentifier;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LanguageRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LanguageInterface_GetFallbackLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_GetFallbackLanguage;
		#else
		tbl->LanguageInterface_GetFallbackLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_GetFallbackLanguage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LanguageInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_ToString;
		#else
		tbl->LanguageInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::LanguageInterface_ToString;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LanguageRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_GetDefaultLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_GetDefaultLanguage;
		#else
		tbl->Resource_GetDefaultLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_GetDefaultLanguage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LanguageRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_GetCurrentLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_GetCurrentLanguage;
		#else
		tbl->Resource_GetCurrentLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_GetCurrentLanguage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LanguageRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_FindLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_FindLanguage;
		#else
		tbl->Resource_FindLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_FindLanguage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_SetCurrentLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_SetCurrentLanguage;
		#else
		tbl->Resource_SetCurrentLanguage = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_SetCurrentLanguage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<LanguageRef>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_GetAllLanguages = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_GetAllLanguages;
		#else
		tbl->Resource_GetAllLanguages = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_GetAllLanguages;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_LoadResourceString = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_LoadResourceString;
		#else
		tbl->Resource_LoadResourceString = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_LoadResourceString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_WriteLanguagePrf = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_WriteLanguagePrf;
		#else
		tbl->Resource_WriteLanguagePrf = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_WriteLanguagePrf;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableLanguageChangedDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Resource_ObservableLanguageChanged = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_ObservableLanguageChanged;
		#else
		tbl->Resource_ObservableLanguageChanged = &Hxx2::Wrapper<Hxx2::Unresolved>::Resource_ObservableLanguageChanged;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(MTable) / SIZEOF(void*));
	#else
