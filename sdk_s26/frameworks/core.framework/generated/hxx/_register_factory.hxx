...
namespace maxon
{
	...
	maxon::Bool FactoryFactory::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<GenericFactory::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FactoryFactory_PrivateCreate = &Hxx2::Wrapper<Hxx2::Unresolved>::FactoryFactory_PrivateCreate;
		#else
		tbl->FactoryFactory_PrivateCreate = &Hxx2::Wrapper<Hxx2::Unresolved>::FactoryFactory_PrivateCreate;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<GenericFactory::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FactoryFactory_PrivateCreateCached = &Hxx2::Wrapper<Hxx2::Unresolved>::FactoryFactory_PrivateCreateCached;
		#else
		tbl->FactoryFactory_PrivateCreateCached = &Hxx2::Wrapper<Hxx2::Unresolved>::FactoryFactory_PrivateCreateCached;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<const Data&>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FactoryFactory_CreateDataCached = &Hxx2::Wrapper<Hxx2::Unresolved>::FactoryFactory_CreateDataCached;
		#else
		tbl->FactoryFactory_CreateDataCached = &Hxx2::Wrapper<Hxx2::Unresolved>::FactoryFactory_CreateDataCached;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
