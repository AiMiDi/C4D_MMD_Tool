...
/// TODO: (Sven) check if this is useful or if maybe its better to return const REFTYPE& (for GetParent, GetNext, GetPrev)
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<std::add_pointer<HierarchyObjectInterface>::type>, std::add_pointer<HierarchyObjectInterface>::type>::type GetParentPtr() const;
...
/// Removes all brances in the object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type FlushBranches() const;
	};
	/// Intermediate helper class for HierarchyObjectInterface.
...
/// Removes all brances in the object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type FlushBranches();
	};
