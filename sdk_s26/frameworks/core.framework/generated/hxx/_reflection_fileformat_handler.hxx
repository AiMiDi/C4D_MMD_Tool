...
namespace maxon
{
	...
	public:
		...
		const FileFormat& GetFileFormat() const 
		{
			...
			(*handler_)(_fn_FileFormatHandlerInterface_GetFileFormat, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const FileFormat&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FileFormatHandlerInterface_GetFileFormat));
			return *proxy_result;
		}
		...
		Result<DataType> GetHandlerType() const 
		{
			...
			(*handler_)(_fn_FileFormatHandlerInterface_GetHandlerType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataType>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FileFormatHandlerInterface_GetHandlerType));
			return proxy_result;
		}
		...
		Result<ObjectRef> CreateHandler(const Url& url) const 
		{
			...
			(*handler_)(_fn_FileFormatHandlerInterface_CreateHandler, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<ObjectRef>, const maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_.FileFormatHandlerInterface_CreateHandler));
			return proxy_result;
		}
		...
		FILEFORMAT_PRIORITY GetDependends() const 
		{
			...
			(*handler_)(_fn_FileFormatHandlerInterface_GetDependends, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<FILEFORMAT_PRIORITY, const maxon::GenericComponent*>::Invoke, (const void*) mt_.FileFormatHandlerInterface_GetDependends));
			return proxy_result;
		}
...
#ifndef MAXON_COMPILER_CLANG
#endif
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileFormatDetectionInterface::MTable::_instance.FileFormatDetectionInterface_DetectAll)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "url\0limitDetection\0detectedCallback\0", 21LL, nullptr),
		};
