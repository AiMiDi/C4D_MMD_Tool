...
/// @cond INTERNAL
		...
		Result<void> AddSenderSignal(ObservableBaseInterface* observable) 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_AddSenderSignal, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObservableBaseInterface*>::Invoke, (const void*) mt_.ObserverObjectInterface_AddSenderSignal));
			return proxy_result;
		}
		...
		void RemoveSenderSignal(ObservableBaseInterface* observable) 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_RemoveSenderSignal, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, ObservableBaseInterface*>::Invoke, (const void*) mt_.ObserverObjectInterface_RemoveSenderSignal));
		}
...
/// @endcond
		...
		String GetName() const 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_GetName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObserverObjectInterface_GetName));
			return proxy_result;
		}
		...
		void SetName(const String& name) 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_SetName, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_.ObserverObjectInterface_SetName));
		}
		...
		maxon::ObservableRef<ObserverDestroyedDelegate> ObserverDestroyed() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ObserverObjectInterface_ObserverDestroyed_Offset)};
			(*handler_)(_fn_ObserverObjectInterface_ObserverDestroyed, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObserverDestroyedDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObserverObjectInterface_ObserverDestroyed));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObserverConnectNotifyDelegate> ObserverConnectNotify() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ObserverObjectInterface_ObserverConnectNotify_Offset)};
			(*handler_)(_fn_ObserverObjectInterface_ObserverConnectNotify, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObserverConnectNotifyDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ObserverObjectInterface_ObserverConnectNotify));
			return proxy_result;
		}
...
/// @endcond
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ObserverObjectInterface, ObserverObjectInterface_ObserverDestroyed),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ObserverObjectInterface, ObserverObjectInterface_ObserverDisconnectNotify),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ObserverObjectInterface, ObserverObjectInterface_ObserverConnectNotify),
		};
