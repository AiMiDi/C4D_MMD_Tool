...
namespace maxon
{
	...
	public:
		...
		DataDictionary GetInfo() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetInfo, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<DataDictionary, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_GetInfo));
			return proxy_result;
		}
		...
		Result<void> SetInfo(const DataDictionary& info) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_SetInfo, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDictionary&>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_SetInfo));
			return proxy_result;
		}
		...
		Int GetEntryCount() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetEntryCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_GetEntryCount));
			return proxy_result;
		}
		...
		Result<BaseArray<DataDescriptionEntry>> GetEntries() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetEntries, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<BaseArray<DataDescriptionEntry>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_GetEntries));
			return proxy_result;
		}
		...
		Result<DataDescriptionEntry> GetEntry(Int idx) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataDescriptionEntry>, const maxon::GenericComponent*, Int>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_GetEntry));
			return proxy_result;
		}
		...
		Result<DataDescriptionEntry> FindEntry(const InternedId& id) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_FindEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataDescriptionEntry>, const maxon::GenericComponent*, const InternedId&>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_FindEntry));
			return proxy_result;
		}
		...
		Result<Int> AddEntry(const DataDescriptionEntry& props) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_AddEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const DataDescriptionEntry&>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_AddEntry));
			return proxy_result;
		}
		...
		Result<void> ReplaceEntry(const DataDescriptionEntry& props) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_ReplaceEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDescriptionEntry&>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_ReplaceEntry));
			return proxy_result;
		}
		...
		Result<void> EraseEntry(Int idx) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_EraseEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_EraseEntry));
			return proxy_result;
		}
		...
		void Reset() 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.DataDescriptionDefinitionInterface_Reset));
		}
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionDefinitionInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDefinitionInterface::Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_MergeDescriptionDefinition)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "target\0source\0overwriteIncludes\0skipIncludes\0", 21LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDefinitionInterface::Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_GetDataDefaults)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dataEntry\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDefinitionInterface::Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_GetDataValueOrDefaults)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dataId\0dataEntry\0flags\0getDataCallback\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDefinitionInterface::Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_Create)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDefinitionInterface::Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_NullValuePtr)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
