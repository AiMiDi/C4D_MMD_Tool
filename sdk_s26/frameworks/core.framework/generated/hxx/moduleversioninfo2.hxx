...
struct ModuleVersionInfoInterface::Hxx2
{
	...
	Result<void> (*ModuleVersionInfoInterface_RegisterIntern) (const Id& uniqueId, const DataDictionary& moduleInfo, const ModuleInfo& info);
		StaticMTable() = default;
		template <typename IMPL> static void Init(StaticMTable* tbl)
		{
		tbl->ModuleVersionInfoInterface_RegisterIntern = &IMPL::ModuleVersionInfoInterface_RegisterIntern;
		}
	};
