...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_ModuleVersionInfoInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ModuleVersionInfoInterface::Hxx2::StaticMTable::_instance.ModuleVersionInfoInterface_RegisterIntern)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "uniqueId\0moduleInfo\0info\0", 21LL, nullptr),
		};
