...
namespace maxon
{
	...
	maxon::Bool StringConversion::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_FloatToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FloatToString;
		#else
		tbl->StringConversion_FloatToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FloatToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_FloatToString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FloatToString_1;
		#else
		tbl->StringConversion_FloatToString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FloatToString_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_AppendInt = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_AppendInt;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_AppendUInt = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_AppendUInt;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_AppendInt_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_AppendInt_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_AppendUInt_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_AppendUInt_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_MemorySizeToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_MemorySizeToString;
		#else
		tbl->StringConversion_MemorySizeToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_MemorySizeToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_HexToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_HexToString;
		#else
		tbl->StringConversion_HexToString = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_HexToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_HexToString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_HexToString_1;
		#else
		tbl->StringConversion_HexToString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_HexToString_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToFloat32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToFloat32;
		#else
		tbl->StringConversion_ToFloat32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToFloat32;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToFloat64 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToFloat64;
		#else
		tbl->StringConversion_ToFloat64 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToFloat64;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToInt64 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToInt64;
		#else
		tbl->StringConversion_ToInt64 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToInt64;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToInt32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToInt32;
		#else
		tbl->StringConversion_ToInt32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToInt32;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UInt64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToUInt64 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToUInt64;
		#else
		tbl->StringConversion_ToUInt64 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToUInt64;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UInt32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToUInt32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToUInt32;
		#else
		tbl->StringConversion_ToUInt32 = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToUInt32;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_StringToFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_StringToFloat;
		#else
		tbl->StringConversion_StringToFloat = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_StringToFloat;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UInt64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_StringToInteger = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_StringToInteger;
		#else
		tbl->StringConversion_StringToInteger = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_StringToInteger;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_GetLineEnd = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_GetLineEnd;
		#else
		tbl->StringConversion_GetLineEnd = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_GetLineEnd;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const CString&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_GetLineEndC = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_GetLineEndC;
		#else
		tbl->StringConversion_GetLineEndC = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_GetLineEndC;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_FormatXArgs = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FormatXArgs;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_ScanStringXArgs = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ScanStringXArgs;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->StringConversion_ScanParameterBasic = &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ScanParameterBasic;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
