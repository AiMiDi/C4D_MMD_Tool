...
namespace maxon
{
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_ThreadCancelledErrorInterface(ThreadCancelledErrorInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION,"maxon::ThreadCancelledError");
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ThreadCancelledErrorInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, &maxon::g_translationUnit, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	...
	public:
		...
		Bool AddError(const Error& error) 
		{
			...
			(*handler_)(_fn_AggregatedErrorInterface_AddError, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const Error&>::Invoke, (const void*) mt_.AggregatedErrorInterface_AddError));
			return proxy_result;
		}
		...
		Bool AddError(Error&& error) 
		{
			...
			(*handler_)(_fn_AggregatedErrorInterface_AddError_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, Error&&>::Invoke, (const void*) mt_.AggregatedErrorInterface_AddError_1));
			return proxy_result;
		}
		...
		Int GetCount() const 
		{
			...
			(*handler_)(_fn_AggregatedErrorInterface_GetCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AggregatedErrorInterface_GetCount));
			return proxy_result;
		}
		...
		const Error& GetError(Int index) const 
		{
			...
			(*handler_)(_fn_AggregatedErrorInterface_GetError, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Error&, const maxon::GenericComponent*, Int>::Invoke, (const void*) mt_.AggregatedErrorInterface_GetError));
			return *proxy_result;
		}
