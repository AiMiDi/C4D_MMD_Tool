...
struct FactoryInterface::MTable
{
	...
	const DelegateBase* (*FactoryInterface_PrivateGetDelegate) (const maxon::GenericComponent* this_);
	...
	{
		FactoryInterface_PrivateGetDelegate = &W::FactoryInterface_PrivateGetDelegate;
		FactoryInterface_PrivateGetDelegate_Offset = offset;
	}
	}
...
struct FactoryInterface::Hxx2
{
	...
	public:
		...
		static const DelegateBase* FactoryInterface_PrivateGetDelegate(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->PrivateGetDelegate(); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto FactoryInterface::PrivateGetDelegate() const -> const DelegateBase*
{
	const FactoryInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(FactoryInterface, this); return mt_.FactoryInterface_PrivateGetDelegate((const maxon::GenericComponent*) this + mt_.FactoryInterface_PrivateGetDelegate_Offset);
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FactoryInterface::Hxx1::ConstFn<S>::PrivateGetDelegate() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DelegateBase*>, const DelegateBase*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DelegateBase*>, const DelegateBase*>::type>; static_assert(std::is_base_of<maxon::SelfPointerHandler, typename S::Handler>::value, "Method FactoryInterface::PrivateGetDelegate with refclass=false can only be invoked on self or super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const FactoryInterface* o_ = (const FactoryInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = FactoryInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FactoryInterface, o_, FactoryInterface_PrivateGetDelegate) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<FactoryInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FactoryInterface>() : PRIVATE_MAXON_VTABLE(FactoryInterface, o_); 
	return (mt_.FactoryInterface_PrivateGetDelegate(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.FactoryInterface_PrivateGetDelegate_Offset));
}
...
struct FactoryFactory::MTable
{
	...
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<GenericFactory::NonConst> (*FactoryFactory_PrivateCreate) (DelegateBase&& func, const DataDictionary& params);
	Result<GenericFactory::NonConst> (*FactoryFactory_PrivateCreateCached) (DelegateBase&& func, DelegateBase&& creator, Int size, const DataDictionary& params);
	Result<const Data&> (*FactoryFactory_CreateDataCached) (const FactoryInterface* factory, const DataDictionary& params, DataCreator* dc);
	template <typename IMPL> void Init()
	{
		FactoryFactory_PrivateCreate = &IMPL::FactoryFactory_PrivateCreate;
		FactoryFactory_PrivateCreateCached = &IMPL::FactoryFactory_PrivateCreateCached;
		FactoryFactory_CreateDataCached = &IMPL::FactoryFactory_CreateDataCached;
	}
};
...
struct FactoryFactory::Hxx2
{
	...
	{
	public:
		static Result<GenericFactory::NonConst> FactoryFactory_PrivateCreate(DelegateBase&& func, const DataDictionary& params) { return C::PrivateCreate(std::forward<DelegateBase>(func), params); }
		static Result<GenericFactory::NonConst> FactoryFactory_PrivateCreateCached(DelegateBase&& func, DelegateBase&& creator, Int size, const DataDictionary& params) { return C::PrivateCreateCached(std::forward<DelegateBase>(func), std::forward<DelegateBase>(creator), size, params); }
		static Result<const Data&> FactoryFactory_CreateDataCached(const FactoryInterface* factory, const DataDictionary& params, DataCreator* dc) { return C::CreateDataCached(factory, params, dc); }
	};
