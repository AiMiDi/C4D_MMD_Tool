...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> ObservablePrivateSplashMessageReceived() const
	{
		return maxon::Cast<MachineRef>(self.GetDecoratedObject()).ObservablePrivateSplashMessageReceived();
	}

	MAXON_METHOD maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged() const
	{
		return maxon::Cast<MachineRef>(self.GetDecoratedObject()).ObservableActivationChanged();
	}
