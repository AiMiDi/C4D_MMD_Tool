...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UnsupportedArgumentErrorInterface, , "net.maxon.interface.unsupportedargumenterror", "maxon.UnsupportedArgumentErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UnresolvedErrorInterface, , "net.maxon.interface.unresolvederror", "maxon.UnresolvedErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UnknownErrorInterface, , "net.maxon.interface.unknownerror", "maxon.UnknownErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UnsupportedOperationErrorInterface, , "net.maxon.interface.unsupportedoperationerror", "maxon.UnsupportedOperationErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ShutdownErrorInterface, , "net.maxon.interface.shutdownerror", "maxon.ShutdownErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DisabledErrorInterface, , "net.maxon.interface.disablederror", "maxon.DisabledErrorInterface", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ErrnoErrorInterface, , "net.maxon.interface.errnoerror", "maxon.ErrnoErrorInterface", (ErrorInterface::PrivateGetInterface()));
