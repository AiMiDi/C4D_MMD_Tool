...
namespace maxon
{
	...
	maxon::Bool Java::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->Java_GetMainThreadJavaEnv = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetMainThreadJavaEnv;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Java_GetJavaEnv = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetJavaEnv;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Java_GetJavaVM = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetJavaVM;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jobject>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_GetNativeActivityObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetNativeActivityObject;
		#else
		tbl->Java_GetNativeActivityObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetNativeActivityObject;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Java_GetAssetManager = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetAssetManager;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jobject>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_AllcoObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_AllcoObject;
		#else
		tbl->Java_AllcoObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_AllcoObject;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jclass>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_MakeGlobalRef = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_MakeGlobalRef;
		#else
		tbl->Java_MakeGlobalRef = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_MakeGlobalRef;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Java_DeleteGlobalRef = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_DeleteGlobalRef;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jfieldID>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_GetFieldID = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetFieldID;
		#else
		tbl->Java_GetFieldID = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetFieldID;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jlong>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_GetLongField = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetLongField;
		#else
		tbl->Java_GetLongField = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetLongField;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Java_SetLongField = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_SetLongField;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_ConvertString = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString;
		#else
		tbl->Java_ConvertString = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jstring>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_ConvertString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString_1;
		#else
		tbl->Java_ConvertString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jobject>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_IntGetStaticObjectField = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntGetStaticObjectField;
		#else
		tbl->Java_IntGetStaticObjectField = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntGetStaticObjectField;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jobject>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_IntCallStaticMethodObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodObject;
		#else
		tbl->Java_IntCallStaticMethodObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodObject;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Java_IntCallStaticMethodVoid = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodVoid;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jlong>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_IntCallStaticMethodLong = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodLong;
		#else
		tbl->Java_IntCallStaticMethodLong = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodLong;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jobject>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_IntCallMethodObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallMethodObject;
		#else
		tbl->Java_IntCallMethodObject = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallMethodObject;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<jlong>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Java_IntCallMethodLong = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallMethodLong;
		#else
		tbl->Java_IntCallMethodLong = &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallMethodLong;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
