...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionUIInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionUIInterface::Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "condition\0description\0uiEntries\0getDataCallback\0externalVariables\0", 341LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionUIInterface::Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_BuildPopupMenuForDescription)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "description\0externalVariables\0contextVars\0mainMenuEntries\0", 149LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionUIInterface::Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition_1)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "condition\0description\0getDescCallback\0getDataCallback\0externalVariables\0", 341LL, nullptr),
		};
