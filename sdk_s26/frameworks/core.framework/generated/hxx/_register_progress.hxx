...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ProgressInterface, , "net.maxon.image.interface.mediasessionprogress", "maxon.ProgressInterface", (ObserverObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int ProgressInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_progress(0
	| maxon::ProgressInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
