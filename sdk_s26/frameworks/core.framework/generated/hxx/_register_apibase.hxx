...
namespace maxon
{
	...
	namespace enum607
	{
		...
		static const maxon::UInt64 ENUM_DONT_INITIALIZE_values[] = {maxon::UInt64(enum607::ENUM_DONT_INITIALIZE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_ENUM_DONT_INITIALIZE607(){ return enum607::ENUM_DONT_INITIALIZE_info; }
	namespace enum617
	{
		...
		static const maxon::UInt64 IN_PLACE_TYPE_values[] = {maxon::UInt64(enum617::IN_PLACE_TYPE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IN_PLACE_TYPE617(){ return enum617::IN_PLACE_TYPE_info; }
...
/// @cond INTERNAL
	...
	namespace enum1757
	{
		...
		static const maxon::UInt64 TYPE_values[] = {maxon::UInt64(enum1757::TYPE::INVALID_0), maxon::UInt64(enum1757::TYPE::INTERFACE), maxon::UInt64(enum1757::TYPE::INTERFACE_NVMTABLE), maxon::UInt64(enum1757::TYPE::NONVIRTUAL_INTERFACE), maxon::UInt64(enum1757::TYPE::DECLARATION), maxon::UInt64(enum1757::TYPE::COMPONENT), maxon::UInt64(enum1757::TYPE::CLASS), maxon::UInt64(enum1757::TYPE::TRANSLATION_UNIT), maxon::UInt64(enum1757::TYPE::MODULE), maxon::UInt64(enum1757::TYPE::INITIALIZATION), maxon::UInt64(enum1757::TYPE::DEPENDENCY), maxon::UInt64(enum1757::TYPE::REGISTRY), maxon::UInt64(enum1757::TYPE::UNUSED), maxon::UInt64(enum1757::TYPE::GLOBAL), maxon::UInt64(enum1757::TYPE::COUNT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TYPE1757(void*){ return enum1757::TYPE_info; }
	namespace enum1884
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum1884::FLAGS::NONE), maxon::UInt64(enum1884::FLAGS::CONSTRUCTED), maxon::UInt64(enum1884::FLAGS::DISABLED), maxon::UInt64(enum1884::FLAGS::INITIALIZED), maxon::UInt64(enum1884::FLAGS::INITIALIZING), maxon::UInt64(enum1884::FLAGS::INITIALIZATION_FAILED), maxon::UInt64(enum1884::FLAGS::NULL_AS_DEFAULT), maxon::UInt64(enum1884::FLAGS::USED), maxon::UInt64(enum1884::FLAGS::HIDDEN), maxon::UInt64(enum1884::FLAGS::REGISTRATION_UNIT), maxon::UInt64(enum1884::FLAGS::DEFINITION), maxon::UInt64(enum1884::FLAGS::SINGLE_BASE), maxon::UInt64(enum1884::FLAGS::IGNORE_WARNINGS), maxon::UInt64(enum1884::FLAGS::EXPLICIT), maxon::UInt64(enum1884::FLAGS::FRAMEWORK), maxon::UInt64(enum1884::FLAGS::CORE), maxon::UInt64(enum1884::FLAGS::PROXY), maxon::UInt64(enum1884::FLAGS::CLASS_PROXY), maxon::UInt64(enum1884::FLAGS::FINAL), maxon::UInt64(enum1884::FLAGS::SINGLE_IMPLEMENTATION), maxon::UInt64(enum1884::FLAGS::MAIN_DEFINITION), maxon::UInt64(enum1884::FLAGS::CALLABLE), maxon::UInt64(enum1884::FLAGS::IMPLEMENTABLE), maxon::UInt64(enum1884::FLAGS::ADAPTER), maxon::UInt64(enum1884::FLAGS::SYNTHETIC), maxon::UInt64(enum1884::FLAGS::LIVE), maxon::UInt64(enum1884::FLAGS::EXPECT_FAILURE), maxon::UInt64(enum1884::FLAGS::FRAMEWORK_REGISTRATION), maxon::UInt64(enum1884::FLAGS::EXTENDED), maxon::UInt64(enum1884::FLAGS::MARK), maxon::UInt64(enum1884::FLAGS::PUBLIC), maxon::UInt64(enum1884::FLAGS::REFERENCE_NONE), maxon::UInt64(enum1884::FLAGS::REFERENCE_POINTER), maxon::UInt64(enum1884::FLAGS::REFERENCE_CONST_POINTER), maxon::UInt64(enum1884::FLAGS::REFERENCE_NORMAL), maxon::UInt64(enum1884::FLAGS::REFERENCE_CONST), maxon::UInt64(enum1884::FLAGS::REFERENCE_COPY_ON_WRITE), maxon::UInt64(enum1884::FLAGS::REFERENCE_ALWAYS_COPY_ON_WRITE), maxon::UInt64(enum1884::FLAGS::REFERENCE_MASK), maxon::UInt64(enum1884::FLAGS::ON_CONSTRUCTION_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FLAGS1884(void*){ return enum1884::FLAGS_info; }
	namespace details
	{
...
/// @endcond
	...
	namespace enum2404
	{
		...
		static const maxon::UInt64 VALUEKIND_values[] = {maxon::UInt64(enum2404::VALUEKIND::NONE), maxon::UInt64(enum2404::VALUEKIND::VOID_TYPE), maxon::UInt64(enum2404::VALUEKIND::GENERIC), maxon::UInt64(enum2404::VALUEKIND::GENERIC_ARITHMETIC), maxon::UInt64(enum2404::VALUEKIND::SCALAR), maxon::UInt64(enum2404::VALUEKIND::INTEGRAL), maxon::UInt64(enum2404::VALUEKIND::FLOATING_POINT), maxon::UInt64(enum2404::VALUEKIND::ENUM), maxon::UInt64(enum2404::VALUEKIND::ENUM_LIST), maxon::UInt64(enum2404::VALUEKIND::ENUM_FLAGS), maxon::UInt64(enum2404::VALUEKIND::DATA), maxon::UInt64(enum2404::VALUEKIND::DATAPTR), maxon::UInt64(enum2404::VALUEKIND::NONVIRTUAL_INTERFACE), maxon::UInt64(enum2404::VALUEKIND::VIRTUAL_INTERFACE), maxon::UInt64(enum2404::VALUEKIND::REF_OR_POINTER), maxon::UInt64(enum2404::VALUEKIND::POINTER), maxon::UInt64(enum2404::VALUEKIND::STRONG_REFERENCE), maxon::UInt64(enum2404::VALUEKIND::COW_REFERENCE), maxon::UInt64(enum2404::VALUEKIND::UNIQUE_REFERENCE), maxon::UInt64(enum2404::VALUEKIND::ACOW_REFERENCE), maxon::UInt64(enum2404::VALUEKIND::LV_REFERENCE), maxon::UInt64(enum2404::VALUEKIND::RV_REFERENCE), maxon::UInt64(enum2404::VALUEKIND::TUPLE), maxon::UInt64(enum2404::VALUEKIND::STRUCT), maxon::UInt64(enum2404::VALUEKIND::SIMD), maxon::UInt64(enum2404::VALUEKIND::BLOCK), maxon::UInt64(enum2404::VALUEKIND::STRIDED_BLOCK), maxon::UInt64(enum2404::VALUEKIND::BASEARRAY), maxon::UInt64(enum2404::VALUEKIND::BLOCKARRAY), maxon::UInt64(enum2404::VALUEKIND::RESULT), maxon::UInt64(enum2404::VALUEKIND::DELEGATE), maxon::UInt64(enum2404::VALUEKIND::FUNCTION), maxon::UInt64(enum2404::VALUEKIND::CONST_QUALIFIED), maxon::UInt64(enum2404::VALUEKIND::SOURCE_LEVEL), maxon::UInt64(enum2404::VALUEKIND::DEEP_CONSTNESS), maxon::UInt64(enum2404::VALUEKIND::INT_SIZE_OR_LESS), maxon::UInt64(enum2404::VALUEKIND::ZERO_INITIALIZED), maxon::UInt64(enum2404::VALUEKIND::ORDERED), maxon::UInt64(enum2404::VALUEKIND::TRIVIALLY_CONSTRUCTIBLE), maxon::UInt64(enum2404::VALUEKIND::TRIVIALLY_DESTRUCTIBLE), maxon::UInt64(enum2404::VALUEKIND::TRIVIALLY_COPYABLE), maxon::UInt64(enum2404::VALUEKIND::TRIVIALLY_EQUATABLE), maxon::UInt64(enum2404::VALUEKIND::OBJECT_REF), maxon::UInt64(enum2404::VALUEKIND::VALUE), maxon::UInt64(enum2404::VALUEKIND::ELEMENT_TYPE_AS_ARG), maxon::UInt64(enum2404::VALUEKIND::NEVER_NULLPTR), maxon::UInt64(enum2404::VALUEKIND::SIGNED), maxon::UInt64(enum2404::VALUEKIND::GENERIC_INSTANTIATION), maxon::UInt64(enum2404::VALUEKIND::GLOBALLY_REFERENCED), maxon::UInt64(enum2404::VALUEKIND::ABSTRACT), maxon::UInt64(enum2404::VALUEKIND::NAMED), maxon::UInt64(enum2404::VALUEKIND::CONTAINER_REF), maxon::UInt64(enum2404::VALUEKIND::GENERIC_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::RECURSIVE_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::RESOLVED_RECURSIVE_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::CONTAINER), maxon::UInt64(enum2404::VALUEKIND::EMPTY_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::VIRTUAL_TUPLE_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::STATIC_ARRAY_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::ARRAY_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::ARRAY), maxon::UInt64(enum2404::VALUEKIND::CONTAINER_MASK), maxon::UInt64(enum2404::VALUEKIND::NAMED_TUPLE), maxon::UInt64(enum2404::VALUEKIND::CONTAINS_RECURSIVE_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::CONTAINS_INVALID_TYPE), maxon::UInt64(enum2404::VALUEKIND::BUNDLE), maxon::UInt64(enum2404::VALUEKIND::MIN_DERIVED_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::MIN_ARRAY_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::MAX_ARRAY_CONTAINER), maxon::UInt64(enum2404::VALUEKIND::COW_MASK), maxon::UInt64(enum2404::VALUEKIND::STRONG_MASK), maxon::UInt64(enum2404::VALUEKIND::PTR_MASK), maxon::UInt64(enum2404::VALUEKIND::CONTAINER_OR_REF), maxon::UInt64(enum2404::VALUEKIND::REFERENCE_MASK), maxon::UInt64(enum2404::VALUEKIND::ARITHMETIC_MASK), maxon::UInt64(enum2404::VALUEKIND::TUPLE_MASK), maxon::UInt64(enum2404::VALUEKIND::TUPLE_INHERIT_MASK), maxon::UInt64(enum2404::VALUEKIND::POINTER_FLAGS), maxon::UInt64(enum2404::VALUEKIND::QUALIFIER_MASK), maxon::UInt64(enum2404::VALUEKIND::CONTAINS_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VALUEKIND2404(){ return enum2404::VALUEKIND_info; }
	...
	namespace enum2450
	{
		...
		static const maxon::UInt64 COLLECTION_KIND_values[] = {maxon::UInt64(enum2450::COLLECTION_KIND::NONE), maxon::UInt64(enum2450::COLLECTION_KIND::ARRAY), maxon::UInt64(enum2450::COLLECTION_KIND::SET), maxon::UInt64(enum2450::COLLECTION_KIND::MAP)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_COLLECTION_KIND2450(){ return enum2450::COLLECTION_KIND_info; }
