...
namespace maxon
{
	...
	maxon::Bool ConditionVariableInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->ConditionVariableInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConditionVariableInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConditionVariableInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConditionVariableInterface_Clear = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_Clear;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConditionVariableInterface_AddDependency = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_AddDependency;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConditionVariableInterface_Set = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_Set;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConditionVariableInterface_Wait = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_Wait;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ConditionVariableInterface_PrivateAddFinishedObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_PrivateAddFinishedObserver;
		#else
		tbl->ConditionVariableInterface_PrivateAddFinishedObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::ConditionVariableInterface_PrivateAddFinishedObserver;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
