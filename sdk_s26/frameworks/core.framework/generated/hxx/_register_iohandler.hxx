...
namespace maxon
{
	...
	maxon::Bool IoHandlerInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<IoHandler>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->IoHandlerInterface_GetHandlerForScheme = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::IoHandlerInterface_GetHandlerForScheme;
		#else
		tbl->IoHandlerInterface_GetHandlerForScheme = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::IoHandlerInterface_GetHandlerForScheme;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
