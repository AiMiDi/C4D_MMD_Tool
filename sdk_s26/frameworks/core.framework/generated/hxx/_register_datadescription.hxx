...
namespace maxon
{
	...
	maxon::Bool DataDescriptionInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->DataDescriptionInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<DataDictionary>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_GetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetInfo;
		#else
		tbl->DataDescriptionInterface_GetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetInfo;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_SetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_SetInfo;
		#else
		tbl->DataDescriptionInterface_SetInfo = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_SetInfo;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionInterface_GetEntryCount = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetEntryCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<DataDictionary>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_GetEntries = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetEntries;
		#else
		tbl->DataDescriptionInterface_GetEntries = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetEntries;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataDictionary>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_GetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetEntry;
		#else
		tbl->DataDescriptionInterface_GetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetEntry;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_SetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_SetEntry;
		#else
		tbl->DataDescriptionInterface_SetEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_SetEntry;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_EraseEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_EraseEntry;
		#else
		tbl->DataDescriptionInterface_EraseEntry = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_EraseEntry;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_Reset;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionInterface_IsEqual = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_IsEqual;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_Compare = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_Compare;
		#else
		tbl->DataDescriptionInterface_Compare = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_Compare;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetHashCode;
		#else
		tbl->DataDescriptionInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_GetHashCode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_ToString;
		#else
		tbl->DataDescriptionInterface_ToString = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_ToString;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_DescribeIO;
		#else
		tbl->DataDescriptionInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionInterface_DescribeIO;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
