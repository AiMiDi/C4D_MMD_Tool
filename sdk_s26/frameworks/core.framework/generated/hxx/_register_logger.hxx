...
namespace maxon
{
	...
	maxon::Bool LoggerInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->LoggerInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LoggerInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_AddLoggerType = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_AddLoggerType;
		#else
		tbl->LoggerInterface_AddLoggerType = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_AddLoggerType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_RemoveLoggerType = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_RemoveLoggerType;
		#else
		tbl->LoggerInterface_RemoveLoggerType = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_RemoveLoggerType;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_RemoveLoggerTypes = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_RemoveLoggerTypes;
		#else
		tbl->LoggerInterface_RemoveLoggerTypes = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_RemoveLoggerTypes;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_Write = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_Write;
		#else
		tbl->LoggerInterface_Write = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_Write;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_GetName = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_GetName;
		#else
		tbl->LoggerInterface_GetName = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_GetName;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LoggerInterface_SetName = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_SetName;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LoggerInterface_Enable = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_Enable;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LoggerInterface_IsEnabled = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_IsEnabled;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_GetLoggerTypes = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_GetLoggerTypes;
		#else
		tbl->LoggerInterface_GetLoggerTypes = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_GetLoggerTypes;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableLoggerNewDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_ObservableLoggerNew = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_ObservableLoggerNew;
		#else
		tbl->LoggerInterface_ObservableLoggerNew = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_ObservableLoggerNew;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_AddNewLogger = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_AddNewLogger;
		#else
		tbl->LoggerInterface_AddNewLogger = &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_AddNewLogger;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
