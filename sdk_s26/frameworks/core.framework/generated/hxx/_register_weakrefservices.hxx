...
namespace maxon
{
	...
	maxon::Bool WeakRefServices::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->WeakRefServices_HasWeakReferences = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_HasWeakReferences;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_AddWeakReference = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_AddWeakReference;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_RemoveWeakReference = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_RemoveWeakReference;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_MoveWeakReference = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_MoveWeakReference;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_CopyWeakReference = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_CopyWeakReference;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_ClearAllWeakReferences = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_ClearAllWeakReferences;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_TransferAllWeakReferences = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_TransferAllWeakReferences;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_AddObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_AddObserver;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_EraseObserver = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_EraseObserver;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_AddMetadata = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_AddMetadata;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->WeakRefServices_EraseMetadata = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_EraseMetadata;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<MemoryMetadataProxy>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->WeakRefServices_GetMetadata = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_GetMetadata;
		#else
		tbl->WeakRefServices_GetMetadata = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_GetMetadata;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->WeakRefServices_BrowseAllWeakReferences = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_BrowseAllWeakReferences;
		#else
		tbl->WeakRefServices_BrowseAllWeakReferences = &Hxx2::Wrapper<Hxx2::Unresolved>::WeakRefServices_BrowseAllWeakReferences;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
