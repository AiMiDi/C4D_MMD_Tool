...
public:
	...
	{
		return maxon::Cast<BackgroundProgressRef>(self.GetDecoratedObject()).ObservableStateChanged();
	}

	MAXON_METHOD maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> ObservableTotalProgressNotification() const
	{
		return maxon::Cast<BackgroundProgressRef>(self.GetDecoratedObject()).ObservableTotalProgressNotification();
	}
