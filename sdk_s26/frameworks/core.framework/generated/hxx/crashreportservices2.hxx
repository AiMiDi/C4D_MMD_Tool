...
struct CrashReportServices::MTable
{
	...
	Int32 (*CrashReportServices_CreateCrashReportProperty) (const Char* name, const Char* value);
	void (*CrashReportServices_FreeCrashReportProperty) (Int32 propertyIdx);
	void* (*CrashReportServices_GetCrashReportProperties) (void* osThread);
	template <typename IMPL> void Init()
	{
		CrashReportServices_CreateCrashReportProperty = &IMPL::CrashReportServices_CreateCrashReportProperty;
		CrashReportServices_FreeCrashReportProperty = &IMPL::CrashReportServices_FreeCrashReportProperty;
		CrashReportServices_GetCrashReportProperties = &IMPL::CrashReportServices_GetCrashReportProperties;
	}
};
