...
{
	iferr_scope;
	DataDescription dataBaseRef = DataDescriptionDatabaseInterface::LoadDescription(DATADESCRIPTION_CATEGORY_DATA, GetZeroRef<LanguageRef>(), databaseScope) iferr_return;
...
DataIdSwitch::DataIdSwitch(const ConstDataPtr& key)
{
