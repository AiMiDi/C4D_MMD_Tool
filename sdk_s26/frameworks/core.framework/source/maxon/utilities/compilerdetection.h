...
#else
	#define PRIVATE_MAXON_PTR_COPY_CONSTRUCTOR { this->PrivateSetPointer(const_cast<ReferencedType*>(value.GetPointer())); }
	#define PRIVATE_MAXON_PTR_COPY_ASSIGNMENT { this->PrivateSetPointer(const_cast<ReferencedType*>(value.GetPointer())); return *this; }
#endif
