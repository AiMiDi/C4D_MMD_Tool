...
#pragma warning disable 177
	...
	return DataTypeLib::GetDelegateType(CheckedGetDataType<R, POLICY>::Get(), {types, sizeof...(ARGS)},
...
inline const Generic* DataTypeImpl::GetDefaultValue() const
{
	return DataTypeLib::PrivateGetDefault(this);
}
