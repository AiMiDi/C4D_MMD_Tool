...
public:
	...
	HashInt GetHashCode() const
	{
		...
		for (AutoIterator<const COLLECTION> i(*static_cast<const COLLECTION*>(this)); i; ++i)
		{
			hash.Combine(HASH::GetHashCode(*i));
		}
		return hash;
	}
...
public:
	...
	HashInt GetHashCode() const
	{
		...
		for (AutoIterator<const COLLECTION> i(*static_cast<const COLLECTION*>(this)); i; ++i)
		{
			hash.CombineUnordered(HASH::GetHashCode(*i));
		}
		return hash;
	}
};
...
public:
	...
	HashInt GetHashCode() const
	{
		...
		for (AutoIterator<const COLLECTION> i(*static_cast<const COLLECTION*>(this)); i; ++i)
		{
			hash.CombineUnordered(DefaultHash::CombineHashes(HASH::GetHashCode((*i).GetKey()), HASH::GetHashCode((*i).GetValue())));
		}
		return hash;
	}
};
