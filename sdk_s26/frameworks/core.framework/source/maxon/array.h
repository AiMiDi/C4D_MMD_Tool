...
private:
	...
	{
		return reinterpret_cast<ArrayInterface*>(SFINAEHelper<ArrayFactory, TYPE>::type::NewBaseArrayFromContainerType(maxon::GetDataType<ContainerInterface<TYPE>>(), nullptr, false).UncheckedGetValue());
	}
...
public:
	...
	//----------------------------------------------------------------------------------------
	// #LEGACYCOMPATIBILITY: change return type from pointer to ref
	...
	{
		iferr_scope;
		ArrayInterface<Generic>* res = NewBaseArray(type, nullptr, false) iferr_return;
	...
	{
		iferr_scope;
		ArrayInterface<Generic>* res = NewBaseArrayFromContainerType(maxon::GetDataType<ContainerInterface<T>>(), nullptr, false) iferr_return;
	...
	{
		iferr_scope;
		ArrayInterface<Generic>* res = NewBaseArrayFromContainerType(maxon::GetDataType<ContainerInterface<T>>(), reinterpret_cast<const Generic*>(&src), false) iferr_return;
		return Array<T>(reinterpret_cast<ArrayInterface<T>*>(res));
	}
	...
	{
		iferr_scope;
		ArrayInterface<Generic>* res = NewBaseArrayFromContainerType(maxon::GetDataType<ContainerInterface<T>>(), reinterpret_cast<const Generic*>(&src), true) iferr_return;
		return Array<T>(reinterpret_cast<ArrayInterface<T>*>(res));
	}
	...
	{
		iferr_scope;
		Array<Generic> res = NewPagedArrayFromContainerType(maxon::GetDataType<ContainerInterface<T>>(), reinterpret_cast<const Generic*>(&NullValue<const T&>()), false) iferr_return;
