...
namespace maxon
{
	...
	public:
		...
		Bool IsChainingChiffre() const 
		{
			...
			(*handler_)(_fn_CryptographyStreamConversionInterface_IsChainingChiffre, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CryptographyStreamConversionInterface_IsChainingChiffre));
			return proxy_result;
		}
