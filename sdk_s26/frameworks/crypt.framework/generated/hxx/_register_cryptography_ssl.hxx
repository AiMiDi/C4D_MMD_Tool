...
namespace maxon
{
	...
	maxon::Bool SSLInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->SSLInterface_ERR_get_state = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_get_state;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_ERR_clear_error = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_clear_error;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_ADD_thread_state = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ADD_thread_state;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_load_error_strings = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_load_error_strings;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_library_init = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_library_init;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_OPENSSL_init_ssl = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_OPENSSL_init_ssl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_new = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_new;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_TLSv1_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_TLSv1_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_TLSv1_1_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_TLSv1_1_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_TLSv1_2_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_TLSv1_2_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSLv3_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSLv3_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSLv2_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSLv2_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSLv23_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSLv23_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_TLS_method = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_TLS_method;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_new = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_new;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SSLInterface_ERR_get_error_string = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_get_error_string;
		#else
		tbl->SSLInterface_ERR_get_error_string = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_get_error_string;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<unsigned long>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SSLInterface_ERR_get_error = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_get_error;
		#else
		tbl->SSLInterface_ERR_get_error = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_get_error;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<unsigned long>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SSLInterface_ERR_peek_last_error = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_peek_last_error;
		#else
		tbl->SSLInterface_ERR_peek_last_error = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_ERR_peek_last_error;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_set_fd = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_set_fd;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_set_tlsext_hostname = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_set_tlsext_hostname;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_connect = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_connect;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_shutdown = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_shutdown;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_free = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_free = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_read = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_read;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_write = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_write;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_verify_result = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_verify_result;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_set_cipher_list = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_set_cipher_list;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_load_verify_locations = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_load_verify_locations;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_set_default_verify_paths = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_set_default_verify_paths;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_use_PrivateKey_file = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_use_PrivateKey_file;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_use_certificate_chain_file = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_use_certificate_chain_file;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_ctrl = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_ctrl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_set_verify = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_set_verify;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_set_connect_state = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_set_connect_state;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_set_accept_state = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_set_accept_state;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_BIO_ctrl = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_BIO_ctrl;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_rbio = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_rbio;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_wbio = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_wbio;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_do_handshake = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_do_handshake;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_error = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_error;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CIPHER_get_version = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CIPHER_get_version;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_current_cipher = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_current_cipher;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_X509_free_ = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_X509_free_;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_peer_certificate = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_peer_certificate;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_X509_NAME_oneline = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_X509_NAME_oneline;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_X509_NAME_get_text_by_NID = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_X509_NAME_get_text_by_NID;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_X509_get_subject_name = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_X509_get_subject_name;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_X509_get_issuer_name = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_X509_get_issuer_name;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SSLInterface_SSL_get_alt_names = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_alt_names;
		#else
		tbl->SSLInterface_SSL_get_alt_names = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_alt_names;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_set_read_ahead = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_set_read_ahead;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_pending = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_pending;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_get_shutdown = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_get_shutdown;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSLInterface_SSL_CTX_use_PrivateKey_ASN1_RSA = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_SSL_CTX_use_PrivateKey_ASN1_RSA;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SSLInterface_VerifySignature = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_VerifySignature;
		#else
		tbl->SSLInterface_VerifySignature = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_VerifySignature;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SSLInterface_CreateSignature = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_CreateSignature;
		#else
		tbl->SSLInterface_CreateSignature = &Hxx2::Wrapper<Hxx2::Unresolved>::SSLInterface_CreateSignature;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
