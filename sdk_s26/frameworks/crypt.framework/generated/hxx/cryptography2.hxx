...
struct CryptographyStreamConversionInterface::MTable
{
	...
	Bool (*CryptographyStreamConversionInterface_IsChainingChiffre) (const maxon::GenericComponent* this_);
	...
	{
		CryptographyStreamConversionInterface_IsChainingChiffre = &W::CryptographyStreamConversionInterface_IsChainingChiffre;
		CryptographyStreamConversionInterface_IsChainingChiffre_Offset = offset;
	}
	}
...
struct CryptographyStreamConversionInterface::Hxx2
{
	...
	public:
		...
		static Bool CryptographyStreamConversionInterface_IsChainingChiffre(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->IsChainingChiffre(); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto CryptographyStreamConversionInterface::IsChainingChiffre() const -> Bool
{
	const CryptographyStreamConversionInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CryptographyStreamConversionInterface, this); return mt_.CryptographyStreamConversionInterface_IsChainingChiffre((const maxon::GenericComponent*) this + mt_.CryptographyStreamConversionInterface_IsChainingChiffre_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CryptographyStreamConversionInterface::Hxx1::ConstFn<S>::IsChainingChiffre() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	...
	return (mt_.CryptographyStreamConversionInterface_IsChainingChiffre(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CryptographyStreamConversionInterface_IsChainingChiffre_Offset));
}
