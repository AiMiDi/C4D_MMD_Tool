...
namespace enum1537
{
	...
	static const maxon::UInt64 MACHINEFEATURESTYPE_values[] = {maxon::UInt64(enum1537::MACHINEFEATURESTYPE::CURRENT), maxon::UInt64(enum1537::MACHINEFEATURESTYPE::HARDWARE_OGL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MACHINEFEATURESTYPE1537(){ return enum1537::MACHINEFEATURESTYPE_info; }
#ifdef CINEWARE_NAMESPACE_ENABLE
