...
namespace enum86
{
	...
	static const maxon::UInt64 TOOLTRANSFORM_FLAG_values[] = {maxon::UInt64(enum86::TOOLTRANSFORM_FLAG::NO_TRANSFORM), maxon::UInt64(enum86::TOOLTRANSFORM_FLAG::NO_RECURSE), maxon::UInt64(enum86::TOOLTRANSFORM_FLAG::NO_PARAMS), maxon::UInt64(enum86::TOOLTRANSFORM_FLAG::NONE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_TOOLTRANSFORM_FLAG86(){ return enum86::TOOLTRANSFORM_FLAG_info; }
namespace enum888
{
	...
	static const maxon::UInt64 MULTILINEEDITTEXTMESSAGEFLAGS_values[] = {maxon::UInt64(enum888::MULTILINEEDITTEXTMESSAGEFLAGS::NONE), maxon::UInt64(enum888::MULTILINEEDITTEXTMESSAGEFLAGS::SET)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MULTILINEEDITTEXTMESSAGEFLAGS888(){ return enum888::MULTILINEEDITTEXTMESSAGEFLAGS_info; }
namespace enum1126
{
	...
	static const maxon::UInt64 MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT_values[] = {maxon::UInt64(enum1126::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::CANCEL), maxon::UInt64(enum1126::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::MERGE), maxon::UInt64(enum1126::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::NEWSCENE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT1126(){ return enum1126::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT_info; }
