...
struct C4D_BaseList
{
	...
	maxon::Result<void> (*NbmPortToDescID2)(maxon::NimbusInterface* nbm, const maxon::NodePath& node, const maxon::NodePath& port, DescID& result);
};
...
struct C4D_Document
{
	...
	maxon::CString (BaseDocument::*GetNameFromColorSpaceId)(const Int32 category, const Int32 id);
};
...
struct C4D_Material
{
	...
	BaseContainer (*GetNewMaterialOnDoubleClickComboboxChildrens)(BaseDocument* doc);
	...
	BaseMaterial* 		(*CreateMaterialCommad)(BaseDocument* doc, Int32 matCmdId);
...
struct C4D_CAnimation
{
	...
	CTrack*					(CCurve::*GetTrackCSeq				)(void) const;
...
struct C4D_Painter
{
	...
	// R22
	BaseBitmap*			(*CLL_GetLockListBitmapEx)(BaseDocument *doc, Filename &fn, Int32 frame, LayerSet *lsl, LockList*& lockList);
