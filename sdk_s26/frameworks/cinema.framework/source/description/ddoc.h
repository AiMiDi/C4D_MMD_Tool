...
enum
{
	...
	DOCUMENT_OCIO_INPUT_COLORSPACE_LOW			= 50031,
	DOCUMENT_OCIO_INPUT_COLORSPACE_HIGH			= 50032,
	...
	DOCUMENT_COLOR_MANAGEMENT							= 50050,
		DOCUMENT_COLOR_MANAGEMENT_NONE			= 0,	// Equivalent to "Linear Workflow" = Off and "Color Profile" = Disabled
		DOCUMENT_COLOR_MANAGEMENT_BASIC			= 1,	// Replicates workflow of pre-R26 color management
		DOCUMENT_COLOR_MANAGEMENT_OCIO			= 2,	// New in R26
