...
{
	return C4DOS.Pa->UVSetGetEdgeSel(this);
}

maxon::Block<Int32> TempUVHandle::GetUVIslands()
{
	return C4DOS.Pa->UVGetIslands(this);
}
...
{
	return C4DOS.Pa->UVSetSetUVPointSelectionFromTextureView(this, uvPointSelection, bleedSelection);
}

Bool TempUVHandle::SetUVEdgeSelection(const BaseSelect* uvEdgeSelection)
{
	return C4DOS.Pa->UVSetSetUVEdgeSelection(this, uvEdgeSelection);
}
...
{
	return C4DOS.Pa->UpdateMeshUVInt(fullUpdate);
}
...
{
	return C4DOS.Pa->PT_GetBrush(bd, brushData);
}
