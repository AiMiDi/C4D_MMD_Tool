...
{
	return C4DOS.Cd->AddGadget(Get(), DIALOG_ISDOCKETORTABBED, 0, nullptr, 0, 0, 0, 0, nullptr, nullptr);
}
...
{
	return C4DOS.Cd->CBF_GetWindowInterface((CBaseFrame*)cd);
}
...
{
	return C4DOS.Cd->AddGadget(cd, DIALOG_ISMINIMIZED, 0, nullptr, 0, 0, 0, 0, nullptr, nullptr);
}
...
{
	return C4DOS.Cd->AddGadget(cd, DIALOG_ADDMENUSEP, 0, (String*)&title, 0, 0, 0, 0, nullptr, nullptr);
}
