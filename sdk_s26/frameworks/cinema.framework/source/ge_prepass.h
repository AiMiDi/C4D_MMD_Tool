...
#define WPREF_MATVP_DEFAULT_SIZE			        1096			///< ::Int32 The default texture size of materials in the viewport. This can be overridden in the "Viewport" tab of every material individually. @since R26
...
#define WPREF_ONLINEUPDATER_LANGUAGE_PACK_SELECTION 40017		///< ::String Language pack to download and install.
...
#define WPREF_NODE_EDITOR_WIRE_STYLE	1055260	///< ::Int32 Selects the node editor wire style. @since R23
...
/// @addtogroup WPREF_NODE_EDITOR_WIRE_STYLE
/// @ingroup group_enumeration
/// @{
#define WPREF_NODE_EDITOR_WIRE_STYLE_BEZIER		0 ///< Bezier node editor wire style.
#define WPREF_NODE_EDITOR_WIRE_STYLE_STRAIGHT	1 ///< Straight node editor wire style.
/// @}
...
#define VIEWCOLOR_MAXCOLORS																	113
/// @}
...
#define FORMAT_FORGERINPORT			1057656			///< forger inport. @since R25
...
enum
{
	...
	DIALOG_ISDOCKETORTABBED,						///< Returns DIALOG_ISDOCKED | DIALOG_ISTABBED, 0 if individual window
