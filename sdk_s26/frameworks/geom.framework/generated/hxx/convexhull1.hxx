...
struct ConvexHullInterface::Hxx1
{
	...
	public:
		...
		static Fn PrivateLookupFn(ConvexHullInterface**);
...
/// @return												The amount the convex hull was shrunk by. if value is negative the convex hull is empty because it shrunk to much.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(ConvexHullInterface**);
...
#ifdef DOXYGEN
public FnDoxy<ConvexHullRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ConvexHullInterface, maxon::StrongRefHandler, ConvexHullRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ConvexHullInterface, maxon::StrongRefHandler, ConvexHullRef>>>>);
