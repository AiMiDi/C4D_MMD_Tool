...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(Float levelOfDetail, UInt32 maxVoxelCount) 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Float, UInt32>::Invoke, (const void*) mt_.ConvexDecompositionInterface_Init));
			return proxy_result;
		}
		...
		Result<DataDictionary> GetSettings() const 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_GetSettings, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataDictionary>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ConvexDecompositionInterface_GetSettings));
			return proxy_result;
		}
		...
		Bool IsReady() const 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_IsReady, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ConvexDecompositionInterface_IsReady));
			return proxy_result;
		}
		...
		Result<UInt16> GetProgress() const 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_GetProgress, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<UInt16>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ConvexDecompositionInterface_GetProgress));
			return proxy_result;
		}
		...
		Result<void> Compute(const GeometryObject& geometryObject) 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_Compute, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const GeometryObject&>::Invoke, (const void*) mt_.ConvexDecompositionInterface_Compute));
			return proxy_result;
		}
		...
		Result<Array<GeometryObject>> FetchResults() 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_FetchResults, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Array<GeometryObject>>, maxon::GenericComponent*>::Invoke, (const void*) mt_.ConvexDecompositionInterface_FetchResults));
			return proxy_result;
		}
		...
		Result<void> Cancel() 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_Cancel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.ConvexDecompositionInterface_Cancel));
			return proxy_result;
		}
		...
		Result<void> Clear() 
		{
			...
			(*handler_)(_fn_ConvexDecompositionInterface_Clear, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.ConvexDecompositionInterface_Clear));
			return proxy_result;
		}
