...
namespace maxon
{
	...
	public:
		...
		const DataType& GetInterpolateDataType() const 
		{
			...
			(*handler_)(_fn_InterpolateTypeInterface_GetInterpolateDataType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.InterpolateTypeInterface_GetInterpolateDataType));
			return *proxy_result;
		}
		...
		void InterpolateLinear(void* data1, const void* data2, Float blend) const 
		{
			...
			(*handler_)(_fn_InterpolateTypeInterface_InterpolateLinear, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*, Float>::Invoke, (const void*) mt_.InterpolateTypeInterface_InterpolateLinear));
		}
		...
		void InterpolateInOutline(void* data, const Block<void*>& outline, const Block<Float>& weights) const 
		{
			...
			(*handler_)(_fn_InterpolateTypeInterface_InterpolateInOutline, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const Block<void*>&, const Block<Float>&>::Invoke, (const void*) mt_.InterpolateTypeInterface_InterpolateInOutline));
		}
		...
		void Average(void* data, const Block<const void*>& dataSet) const 
		{
			...
			(*handler_)(_fn_InterpolateTypeInterface_Average, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const Block<const void*>&>::Invoke, (const void*) mt_.InterpolateTypeInterface_Average));
		}
	...
	static maxon::Result<void> RegisterReflection_InterpolateTypeInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(InterpolateTypeInterface::Hxx2::StaticMTable::_instance.InterpolateTypeInterface_GetInterpolationClass)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "datatype\0", 1LL, nullptr),
		};
