...
namespace maxon
{
	...
	maxon::Bool ConvexHullInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->ConvexHullInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::ConvexHullInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ConvexHullInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::ConvexHullInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ConvexHullInterface_ComputeConvexHull = &Hxx2::Wrapper<Hxx2::Unresolved>::ConvexHullInterface_ComputeConvexHull;
		#else
		tbl->ConvexHullInterface_ComputeConvexHull = &Hxx2::Wrapper<Hxx2::Unresolved>::ConvexHullInterface_ComputeConvexHull;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ConvexHullInterface_ComputeConvexHull_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ConvexHullInterface_ComputeConvexHull_1;
		#else
		tbl->ConvexHullInterface_ComputeConvexHull_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ConvexHullInterface_ComputeConvexHull_1;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
