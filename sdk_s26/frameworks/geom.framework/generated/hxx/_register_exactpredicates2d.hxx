...
namespace maxon
{
	...
	maxon::Bool ExactPredicates2DInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->ExactPredicates2DInterface_Orient = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_Orient;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ExactPredicates2DInterface_InCircle = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InCircle;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_InTriangle = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InTriangle;
		#else
		tbl->ExactPredicates2DInterface_InTriangle = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InTriangle;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_InSector = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InSector;
		#else
		tbl->ExactPredicates2DInterface_InSector = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InSector;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_OutlineSelfIntersectionTest = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlineSelfIntersectionTest;
		#else
		tbl->ExactPredicates2DInterface_OutlineSelfIntersectionTest = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlineSelfIntersectionTest;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_OutlinesIntersectionTest = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlinesIntersectionTest;
		#else
		tbl->ExactPredicates2DInterface_OutlinesIntersectionTest = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlinesIntersectionTest;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_OutlinesIntersectionTest_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlinesIntersectionTest_1;
		#else
		tbl->ExactPredicates2DInterface_OutlinesIntersectionTest_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlinesIntersectionTest_1;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
