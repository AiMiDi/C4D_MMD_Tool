...
namespace maxon
{
	namespace enum16
	{
		...
		static const maxon::UInt64 GRAPH_TYPE_values[] = {maxon::UInt64(enum16::GRAPH_TYPE::CONTINUOS), maxon::UInt64(enum16::GRAPH_TYPE::SPARSE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GRAPH_TYPE16(){ return enum16::GRAPH_TYPE_info; }
}
#endif
