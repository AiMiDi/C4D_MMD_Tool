...
namespace maxon
{
	...
	maxon::Bool Voronoi3DInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->Voronoi3DInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Voronoi3DInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_Init;
		#else
		tbl->Voronoi3DInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_Init;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CopyFrom = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CopyFrom;
		#else
		tbl->Voronoi3DInterface_CopyFrom = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CopyFrom;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Voronoi3DInterface_IsReadyButPendingChanges = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_IsReadyButPendingChanges;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Voronoi3DInterface_IsReady = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_IsReady;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_SetPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetPoints;
		#else
		tbl->Voronoi3DInterface_SetPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetPoints;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_AddPoint = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_AddPoint;
		#else
		tbl->Voronoi3DInterface_AddPoint = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_AddPoint;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_AddPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_AddPoints;
		#else
		tbl->Voronoi3DInterface_AddPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_AddPoints;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CalcCells = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CalcCells;
		#else
		tbl->Voronoi3DInterface_CalcCells = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CalcCells;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CalcTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CalcTetrahedralization;
		#else
		tbl->Voronoi3DInterface_CalcTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CalcTetrahedralization;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Voronoi3DInterface_SetForClipping = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetForClipping;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Voronoi3DInterface_GetCellCount = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Vector>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetVoronoiPointPositions = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetVoronoiPointPositions;
		#else
		tbl->Voronoi3DInterface_GetVoronoiPointPositions = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetVoronoiPointPositions;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Vector>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetInputPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetInputPoints;
		#else
		tbl->Voronoi3DInterface_GetInputPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetInputPoints;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<Bool>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetBorderCellFlags = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetBorderCellFlags;
		#else
		tbl->Voronoi3DInterface_GetBorderCellFlags = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetBorderCellFlags;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<CellData>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetCellDataStructure = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellDataStructure;
		#else
		tbl->Voronoi3DInterface_GetCellDataStructure = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellDataStructure;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetCellHasVolume = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellHasVolume;
		#else
		tbl->Voronoi3DInterface_GetCellHasVolume = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellHasVolume;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_ScaleCell = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_ScaleCell;
		#else
		tbl->Voronoi3DInterface_ScaleCell = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_ScaleCell;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_ScaleAllCells = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_ScaleAllCells;
		#else
		tbl->Voronoi3DInterface_ScaleAllCells = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_ScaleAllCells;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<Delaunay3DRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetDelaunayTetrizer = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetDelaunayTetrizer;
		#else
		tbl->Voronoi3DInterface_GetDelaunayTetrizer = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetDelaunayTetrizer;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Voronoi3DInterface_Flush = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_Flush;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_SetCellFuseGroup = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetCellFuseGroup;
		#else
		tbl->Voronoi3DInterface_SetCellFuseGroup = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetCellFuseGroup;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_FuseCells = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_FuseCells;
		#else
		tbl->Voronoi3DInterface_FuseCells = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_FuseCells;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CreateInvertedVoronoiCell = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CreateInvertedVoronoiCell;
		#else
		tbl->Voronoi3DInterface_CreateInvertedVoronoiCell = &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CreateInvertedVoronoiCell;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
