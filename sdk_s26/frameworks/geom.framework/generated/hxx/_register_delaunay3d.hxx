...
namespace maxon
{
	...
	maxon::Bool Delaunay3DInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->Delaunay3DInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Delaunay3DInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_CopyFrom = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_CopyFrom;
		#else
		tbl->Delaunay3DInterface_CopyFrom = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_CopyFrom;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Init;
		#else
		tbl->Delaunay3DInterface_Init = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Init;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_CalculateDelaunayTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_CalculateDelaunayTetrahedralization;
		#else
		tbl->Delaunay3DInterface_CalculateDelaunayTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_CalculateDelaunayTetrahedralization;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Delaunay3DInterface_IsInitialized = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_IsInitialized;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_AddPointsIntoTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_AddPointsIntoTetrahedralization;
		#else
		tbl->Delaunay3DInterface_AddPointsIntoTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_AddPointsIntoTetrahedralization;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_AddPointIntoTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_AddPointIntoTetrahedralization;
		#else
		tbl->Delaunay3DInterface_AddPointIntoTetrahedralization = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_AddPointIntoTetrahedralization;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Tetrahedron>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetTetrahedrons = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedrons;
		#else
		tbl->Delaunay3DInterface_GetTetrahedrons = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedrons;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Tetrahedron>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetTetrahedrons_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedrons_1;
		#else
		tbl->Delaunay3DInterface_GetTetrahedrons_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedrons_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Int32>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetPointsToTetConnections = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointsToTetConnections;
		#else
		tbl->Delaunay3DInterface_GetPointsToTetConnections = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointsToTetConnections;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Vector>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPoints;
		#else
		tbl->Delaunay3DInterface_GetPoints = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPoints;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<Vector>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetPointsWrite = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointsWrite;
		#else
		tbl->Delaunay3DInterface_GetPointsWrite = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointsWrite;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Delaunay3DInterface_GetTetrahedronCount = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedronCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Delaunay3DInterface_GetPointCount = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointCount;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Reset;
		#else
		tbl->Delaunay3DInterface_Reset = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Reset;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Delaunay3DInterface_OrientDet = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_OrientDet;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->Delaunay3DInterface_Flush = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Flush;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_FindTetIndexContainingPoint = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_FindTetIndexContainingPoint;
		#else
		tbl->Delaunay3DInterface_FindTetIndexContainingPoint = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_FindTetIndexContainingPoint;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_FindTetContainingPoint = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_FindTetContainingPoint;
		#else
		tbl->Delaunay3DInterface_FindTetContainingPoint = &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_FindTetContainingPoint;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
