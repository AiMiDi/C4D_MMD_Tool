...
struct ConvexHullInterface::MTable
{
	...
	void (*ConvexHullInterface_Free) (const ConvexHullInterface* object);
	ConvexHullInterface* (*ConvexHullInterface_Alloc) (const maxon::SourceLocation& allocLocation);
	Result<Float> (*ConvexHullInterface_ComputeConvexHull) (ConvexHullInterface* this_, const Block<const Vector>& vertices, const Float shrink, const Float shrinkClamp, BaseArray<Vector>& resultVertices, BaseArray<ConvEdge>& resultEdges, BaseArray<Int>& resultFaces);
	Result<Float> (*ConvexHullInterface_ComputeConvexHull_1) (ConvexHullInterface* this_, const Block<const Vector>& vertices, const Float shrink, const Float shrinkClamp, ConvexHullData& hull);
	template <typename IMPL> void Init()
	{
		ConvexHullInterface_Free = &IMPL::ConvexHullInterface_Free;
		ConvexHullInterface_Alloc = &IMPL::ConvexHullInterface_Alloc;
		ConvexHullInterface_ComputeConvexHull = &IMPL::ConvexHullInterface_ComputeConvexHull;
		ConvexHullInterface_ComputeConvexHull_1 = &IMPL::ConvexHullInterface_ComputeConvexHull_1;
	}
};
...
struct ConvexHullInterface::Hxx2
{
	...
	public:
		...
		static Result<Float> ConvexHullInterface_ComputeConvexHull(ConvexHullInterface* this_, const Block<const Vector>& vertices, const Float shrink, const Float shrinkClamp, BaseArray<Vector>& resultVertices, BaseArray<ConvEdge>& resultEdges, BaseArray<Int>& resultFaces) { return C::Get(this_)->ComputeConvexHull(vertices, shrink, shrinkClamp, resultVertices, resultEdges, resultFaces); }
		static Result<Float> ConvexHullInterface_ComputeConvexHull_1(ConvexHullInterface* this_, const Block<const Vector>& vertices, const Float shrink, const Float shrinkClamp, ConvexHullData& hull) { return C::Get(this_)->ComputeConvexHull(vertices, shrink, shrinkClamp, hull); }
	};
...
{
	return MTable::_instance.ConvexHullInterface_ComputeConvexHull(this, vertices, shrink, shrinkClamp, resultVertices, resultEdges, resultFaces);
}
...
{
	return MTable::_instance.ConvexHullInterface_ComputeConvexHull_1(this, vertices, shrink, shrinkClamp, hull);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ConvexHullInterface::Hxx1::Fn<S>::ComputeConvexHull(const Block<const Vector>& vertices, const Float shrink, const Float shrinkClamp, BaseArray<Vector>& resultVertices, BaseArray<ConvEdge>& resultEdges, BaseArray<Int>& resultFaces) const -> Result<Float>
{
	...
	return (MTable::_instance.ConvexHullInterface_ComputeConvexHull(o_, vertices, shrink, shrinkClamp, resultVertices, resultEdges, resultFaces));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Float>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ConvexHullInterface* o_ = (ConvexHullInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance.ConvexHullInterface_ComputeConvexHull_1(o_, vertices, shrink, shrinkClamp, hull));
}
