                ...
                if punct != ';':
                    ...
                    while True:
                        ...
                        if t == '}':
                            ...
                            if not cls.interface:
                                self.errors.append(t.pos, 'MAXON_USING can only be used for interfaces.')
                            self.lex.consume('(')
                            ...
                            if member < 0:
                                self.errors.append(t.pos, 'MAXON_USING has to contain the qualified name of an inherited function or method.')
                            elif access != 'public':
                                self.errors.append(t.pos, 'MAXON_USING has to be within a public section.')
                            else:
                                baseInterface = function[:member]
                                usingName = function[member+2:]
                                for b, g in cls.baseInterfaces:
                                    if b == baseInterface:
                                        cls.usings.append((baseInterface, usingName))
                                        break
                                else:
