...
struct VoxelizationInterface::MTable
{
	...
	Result<Bool> (*VoxelizationInterface_Init) (maxon::GenericComponent* this_, PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise);
	maxon::Int VoxelizationInterface_Init_Offset;
	Result<Bool> (*VoxelizationInterface_Init_1) (maxon::GenericComponent* this_, PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride);
	maxon::Int VoxelizationInterface_Init_1_Offset;
	Result<Bool> (*VoxelizationInterface_Init_2) (maxon::GenericComponent* this_, const ConvexHullData* hull, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges);
	maxon::Int VoxelizationInterface_Init_2_Offset;
	Result<Bool> (*VoxelizationInterface_Init_3) (maxon::GenericComponent* this_, const BaseArray<BaseArray<Int32>>& facePoints, const BaseArray<Vector>& points, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges);
	maxon::Int VoxelizationInterface_Init_3_Offset;
	Result<void> (*VoxelizationInterface_GetClosestPolys) (const maxon::GenericComponent* this_, const Vector pos, BaseBitSet<>& voxelPolys, const BaseBitSet<>* polyFilter);
	maxon::Int VoxelizationInterface_GetClosestPolys_Offset;
	Result<void> (*VoxelizationInterface_GetIntersectingIndices) (const maxon::GenericComponent* this_, const Range<Vector>& toTestBox, BaseArray<Int32>& indexList);
	maxon::Int VoxelizationInterface_GetIntersectingIndices_Offset;
	Result<void> (*VoxelizationInterface_GetIntersectingIndicesPrecise) (const maxon::GenericComponent* this_, const Range<Vector>& toTestBox, const BaseArray<Range<Vector>>& polyRanges, BaseArray<Int32>& indexList);
	maxon::Int VoxelizationInterface_GetIntersectingIndicesPrecise_Offset;
	Result<Bool> (*VoxelizationInterface_GetIntersectingIndices_1) (const maxon::GenericComponent* this_, const Vector& point, BaseArray<Int32>& indexList);
	maxon::Int VoxelizationInterface_GetIntersectingIndices_1_Offset;
	const Range<Vector>& (*VoxelizationInterface_GetBoundingBox) (const maxon::GenericComponent* this_);
	maxon::Int VoxelizationInterface_GetBoundingBox_Offset;
	Range<IntVector32> (*VoxelizationInterface_GetVoxelRangesFromBoundingBox) (const maxon::GenericComponent* this_, const Range<Vector>& boundingBox);
	maxon::Int VoxelizationInterface_GetVoxelRangesFromBoundingBox_Offset;
	Bool (*VoxelizationInterface_IsInitialized) (const maxon::GenericComponent* this_);
	...
	{
		VoxelizationInterface_Init = &W::VoxelizationInterface_Init;
		VoxelizationInterface_Init_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, Init))
	{
		VoxelizationInterface_Init_1 = &W::VoxelizationInterface_Init_1;
		VoxelizationInterface_Init_1_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, Init))
	{
		VoxelizationInterface_Init_2 = &W::VoxelizationInterface_Init_2;
		VoxelizationInterface_Init_2_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, Init))
	{
		VoxelizationInterface_Init_3 = &W::VoxelizationInterface_Init_3;
		VoxelizationInterface_Init_3_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, GetClosestPolys))
	{
		VoxelizationInterface_GetClosestPolys = &W::VoxelizationInterface_GetClosestPolys;
		VoxelizationInterface_GetClosestPolys_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, GetIntersectingIndices))
	{
		VoxelizationInterface_GetIntersectingIndices = &W::VoxelizationInterface_GetIntersectingIndices;
		VoxelizationInterface_GetIntersectingIndices_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, GetIntersectingIndicesPrecise))
	{
		VoxelizationInterface_GetIntersectingIndicesPrecise = &W::VoxelizationInterface_GetIntersectingIndicesPrecise;
		VoxelizationInterface_GetIntersectingIndicesPrecise_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, GetIntersectingIndices))
	{
		VoxelizationInterface_GetIntersectingIndices_1 = &W::VoxelizationInterface_GetIntersectingIndices_1;
		VoxelizationInterface_GetIntersectingIndices_1_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, GetBoundingBox))
	{
		VoxelizationInterface_GetBoundingBox = &W::VoxelizationInterface_GetBoundingBox;
		VoxelizationInterface_GetBoundingBox_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, GetVoxelRangesFromBoundingBox))
	{
		VoxelizationInterface_GetVoxelRangesFromBoundingBox = &W::VoxelizationInterface_GetVoxelRangesFromBoundingBox;
		VoxelizationInterface_GetVoxelRangesFromBoundingBox_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VoxelizationInterface, IsInitialized))
	{
		VoxelizationInterface_IsInitialized = &W::VoxelizationInterface_IsInitialized;
		VoxelizationInterface_IsInitialized_Offset = offset;
	}
	}
...
struct VoxelizationInterface::Hxx2
{
	...
	public:
		...
		static Result<Bool> VoxelizationInterface_Init(maxon::GenericComponent* this_, PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) { return ((typename S::Implementation*) this_)->Init(polyObject, voxelResolution, minResolution, polyRanges, pointOverride, precise); }
		static Result<Bool> VoxelizationInterface_Init_1(maxon::GenericComponent* this_, PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) { return ((typename S::Implementation*) this_)->Init(polyObject, polyIslands, voxelResolution, minResolution, polyRanges, pointOverride); }
		static Result<Bool> VoxelizationInterface_Init_2(maxon::GenericComponent* this_, const ConvexHullData* hull, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) { return ((typename S::Implementation*) this_)->Init(hull, voxelResolution, minResolution, polyRanges); }
		static Result<Bool> VoxelizationInterface_Init_3(maxon::GenericComponent* this_, const BaseArray<BaseArray<Int32>>& facePoints, const BaseArray<Vector>& points, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) { return ((typename S::Implementation*) this_)->Init(facePoints, points, voxelResolution, minResolution, polyRanges); }
		static Result<void> VoxelizationInterface_GetClosestPolys(const maxon::GenericComponent* this_, const Vector pos, BaseBitSet<>& voxelPolys, const BaseBitSet<>* polyFilter) { return ((const typename S::Implementation*) this_)->GetClosestPolys(std::forward<const Vector>(pos), voxelPolys, polyFilter); }
		static Result<void> VoxelizationInterface_GetIntersectingIndices(const maxon::GenericComponent* this_, const Range<Vector>& toTestBox, BaseArray<Int32>& indexList) { return ((const typename S::Implementation*) this_)->GetIntersectingIndices(toTestBox, indexList); }
		static Result<void> VoxelizationInterface_GetIntersectingIndicesPrecise(const maxon::GenericComponent* this_, const Range<Vector>& toTestBox, const BaseArray<Range<Vector>>& polyRanges, BaseArray<Int32>& indexList) { return ((const typename S::Implementation*) this_)->GetIntersectingIndicesPrecise(toTestBox, polyRanges, indexList); }
		static Result<Bool> VoxelizationInterface_GetIntersectingIndices_1(const maxon::GenericComponent* this_, const Vector& point, BaseArray<Int32>& indexList) { return ((const typename S::Implementation*) this_)->GetIntersectingIndices(point, indexList); }
		static const Range<Vector>& VoxelizationInterface_GetBoundingBox(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetBoundingBox(); }
		static Range<IntVector32> VoxelizationInterface_GetVoxelRangesFromBoundingBox(const maxon::GenericComponent* this_, const Range<Vector>& boundingBox) { return ((const typename S::Implementation*) this_)->GetVoxelRangesFromBoundingBox(boundingBox); }
		static Bool VoxelizationInterface_IsInitialized(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->IsInitialized(); }
	};
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_Init((maxon::GenericComponent*) this + mt_.VoxelizationInterface_Init_Offset, polyObject, voxelResolution, minResolution, polyRanges, pointOverride, precise);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_Init_1((maxon::GenericComponent*) this + mt_.VoxelizationInterface_Init_1_Offset, polyObject, polyIslands, voxelResolution, minResolution, polyRanges, pointOverride);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_Init_2((maxon::GenericComponent*) this + mt_.VoxelizationInterface_Init_2_Offset, hull, voxelResolution, minResolution, polyRanges);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_Init_3((maxon::GenericComponent*) this + mt_.VoxelizationInterface_Init_3_Offset, facePoints, points, voxelResolution, minResolution, polyRanges);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_GetClosestPolys((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_GetClosestPolys_Offset, std::forward<const Vector>(pos), voxelPolys, polyFilter);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_GetIntersectingIndices((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_GetIntersectingIndices_Offset, toTestBox, indexList);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_GetIntersectingIndicesPrecise((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_GetIntersectingIndicesPrecise_Offset, toTestBox, polyRanges, indexList);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_GetIntersectingIndices_1((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_GetIntersectingIndices_1_Offset, point, indexList);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::GetBoundingBox() const -> const Range<Vector>&
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_GetBoundingBox((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_GetBoundingBox_Offset);
}
...
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_GetVoxelRangesFromBoundingBox((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_GetVoxelRangesFromBoundingBox_Offset, boundingBox);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::IsInitialized() const -> Bool
{
	const VoxelizationInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VoxelizationInterface, this); return mt_.VoxelizationInterface_IsInitialized((const maxon::GenericComponent*) this + mt_.VoxelizationInterface_IsInitialized_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::Fn<S>::Init(PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) const -> Result<Bool>
{
	...
	return (mt_.VoxelizationInterface_Init(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_Init_Offset, polyObject, voxelResolution, minResolution, polyRanges, pointOverride, precise));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::Fn<S>::Init(PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) const -> Result<Bool>
{
	...
	return (mt_.VoxelizationInterface_Init_1(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_Init_1_Offset, polyObject, polyIslands, voxelResolution, minResolution, polyRanges, pointOverride));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::Fn<S>::Init(const ConvexHullData* hull, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) const -> Result<Bool>
{
	...
	return (mt_.VoxelizationInterface_Init_2(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_Init_2_Offset, hull, voxelResolution, minResolution, polyRanges));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::Fn<S>::Init(const BaseArray<BaseArray<Int32>>& facePoints, const BaseArray<Vector>& points, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) const -> Result<Bool>
{
	...
	return (mt_.VoxelizationInterface_Init_3(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_Init_3_Offset, facePoints, points, voxelResolution, minResolution, polyRanges));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::GetClosestPolys(const Vector pos, BaseBitSet<>& voxelPolys, const BaseBitSet<>* polyFilter) const -> Result<void>
{
	...
	return (mt_.VoxelizationInterface_GetClosestPolys(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_GetClosestPolys_Offset, std::forward<const Vector>(pos), voxelPolys, polyFilter));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::GetIntersectingIndices(const Range<Vector>& toTestBox, BaseArray<Int32>& indexList) const -> Result<void>
{
	...
	return (mt_.VoxelizationInterface_GetIntersectingIndices(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_GetIntersectingIndices_Offset, toTestBox, indexList));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::GetIntersectingIndicesPrecise(const Range<Vector>& toTestBox, const BaseArray<Range<Vector>>& polyRanges, BaseArray<Int32>& indexList) const -> Result<void>
{
	...
	return (mt_.VoxelizationInterface_GetIntersectingIndicesPrecise(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_GetIntersectingIndicesPrecise_Offset, toTestBox, polyRanges, indexList));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::GetIntersectingIndices(const Vector& point, BaseArray<Int32>& indexList) const -> Result<Bool>
{
	...
	return (mt_.VoxelizationInterface_GetIntersectingIndices_1(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_GetIntersectingIndices_1_Offset, point, indexList));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::GetBoundingBox() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Range<Vector>&>, const Range<Vector>&>::type
{
	...
	return (mt_.VoxelizationInterface_GetBoundingBox(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_GetBoundingBox_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::GetVoxelRangesFromBoundingBox(const Range<Vector>& boundingBox) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Range<IntVector32>>, Range<IntVector32>>::type
{
	...
	return (mt_.VoxelizationInterface_GetVoxelRangesFromBoundingBox(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_GetVoxelRangesFromBoundingBox_Offset, boundingBox));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::ConstFn<S>::IsInitialized() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	...
	return (mt_.VoxelizationInterface_IsInitialized(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.VoxelizationInterface_IsInitialized_Offset));
}
