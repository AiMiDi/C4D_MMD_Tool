...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(PolygonObject* mesh, Bool initVoxelization) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, PolygonObject*, Bool>::Invoke, (const void*) mt_.DistanceQueryInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(SplineObject* spline) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, SplineObject*>::Invoke, (const void*) mt_.DistanceQueryInterface_Init_1));
			return proxy_result;
		}
		...
		Result<void> Init(LineObject* line) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_2, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, LineObject*>::Invoke, (const void*) mt_.DistanceQueryInterface_Init_2));
			return proxy_result;
		}
		...
		Result<void> Init(const Block<const Vector> points, const Block<const SimplePolygon> polygons, const Matrix& objectPosition) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_3, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Block<const Vector>, const Block<const SimplePolygon>, const Matrix&>::Invoke, (const void*) mt_.DistanceQueryInterface_Init_3));
			return proxy_result;
		}
		...
		void Reset() 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.DistanceQueryInterface_Reset));
		}
		...
		void GetDistanceToMesh(const Vector& pos, MeshDistanceData& distInfo, const BaseBitSet<>* polyFilter, Bool onlyPolyPrimitives) const 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_GetDistanceToMesh, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, const Vector&, MeshDistanceData&, const BaseBitSet<>*, Bool>::Invoke, (const void*) mt_.DistanceQueryInterface_GetDistanceToMesh));
		}
		...
		void GetDistanceToSpline(const Vector& pos, SplineDistanceData& distInfo) const 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_GetDistanceToSpline, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, const Vector&, SplineDistanceData&>::Invoke, (const void*) mt_.DistanceQueryInterface_GetDistanceToSpline));
		}
		...
		Bool IsInitialized() const 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_IsInitialized, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_.DistanceQueryInterface_IsInitialized));
			return proxy_result;
		}
		...
		void SetThreading(Int32 threads) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_SetThreading, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, Int32>::Invoke, (const void*) mt_.DistanceQueryInterface_SetThreading));
		}
