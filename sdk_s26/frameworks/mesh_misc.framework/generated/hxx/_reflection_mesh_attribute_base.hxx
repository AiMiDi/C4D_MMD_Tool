...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(BaseTag* tag) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseTag*>::Invoke, (const void*) mt_.CustomDataTagDisplayInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Draw(BaseTag* tag, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Draw, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseTag*, BaseObject*, BaseDraw*, BaseDrawHelp*>::Invoke, (const void*) mt_.CustomDataTagDisplayInterface_Draw));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CustomDataTagDisplayInterface_Draw;
		Result<void> DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_DisplayControl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, BaseTag*, BaseDocument*, BaseObject*, BaseDraw*, BaseDrawHelp*, ControlDisplayStruct&>::Invoke, (const void*) mt_.CustomDataTagDisplayInterface_DisplayControl));
			return proxy_result;
		}
		...
		void FreeDisplayControl(BaseTag* tag) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_FreeDisplayControl, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, BaseTag*>::Invoke, (const void*) mt_.CustomDataTagDisplayInterface_FreeDisplayControl));
		}
		...
		void Reset() 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagDisplayInterface_Reset));
		}
	...
	public:
		...
		const DataType& GetDataType() const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_GetDataType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_GetDataType));
			return *proxy_result;
		}
		...
		const DataType& GetUnderlyingDataType() const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_GetUnderlyingDataType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_GetUnderlyingDataType));
			return *proxy_result;
		}
		...
		void InterpolateLinear(void* data1, const void* data2, Float blend) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_InterpolateLinear, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*, Float>::Invoke, (const void*) mt_.MeshAttributeClassInterface_InterpolateLinear));
		}
		...
		void InterpolateInOutline(void* data, const Block<void*>& outline, const Block<Float>& weights) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_InterpolateInOutline, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const Block<void*>&, const Block<Float>&>::Invoke, (const void*) mt_.MeshAttributeClassInterface_InterpolateInOutline));
		}
		...
		void GetDefaultValue(void* data) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_GetDefaultValue, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_GetDefaultValue));
		}
		...
		Bool AtrLessThen(const void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrLessThen, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const void*, const void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrLessThen));
			return proxy_result;
		}
		...
		Bool AtrIsEqual(const void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrIsEqual, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const void*, const void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrIsEqual));
			return proxy_result;
		}
		...
		void AtrAdd(void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrAdd, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrAdd));
		}
		...
		void AtrSubstract(void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrSubstract, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrSubstract));
		}
		...
		void AtrMultiply(void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrMultiply, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrMultiply));
		}
		...
		void AtrMultiply(void* data, Float value) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrMultiply_1, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, Float>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrMultiply_1));
		}
		...
		void AtrDivide(void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrDivide, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrDivide));
		}
		...
		void AtrDivide(void* data, Float value) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrDivide_1, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, Float>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrDivide_1));
		}
		...
		String AtrToString(const void* data, const FormatStatement* formatStatement) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrToString, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const void*, const FormatStatement*>::Invoke, (const void*) mt_.MeshAttributeClassInterface_AtrToString));
			return proxy_result;
		}
	...
	public:
		...
		Int32 GetTagPluginId() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetTagPluginId));
			return proxy_result;
		}
		...
		const String& GetTagPluginName() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const String&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetTagPluginName));
			return *proxy_result;
		}
		...
		const String& GetResourceId() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetResourceId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const String&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetResourceId));
			return *proxy_result;
		}
		...
		Int32 GetTagPluginLevel() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginLevel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetTagPluginLevel));
			return proxy_result;
		}
		...
		Id GetDisplayClassId() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetDisplayClassId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Id, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetDisplayClassId));
			return proxy_result;
		}
		...
		Bool IsSdsCompatible(Int32& floatSize) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_IsSdsCompatible, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, Int32&>::Invoke, (const void*) mt_.CustomDataTagClassInterface_IsSdsCompatible));
			return proxy_result;
		}
		...
		Result<void> Read(void* data, HyperFile* hf, Int32 level) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Read, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, void*, HyperFile*, Int32>::Invoke, (const void*) mt_.CustomDataTagClassInterface_Read));
			return proxy_result;
		}
		...
		Result<void> Write(const void* data, HyperFile* hf) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Write, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const void*, HyperFile*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_Write));
			return proxy_result;
		}
		...
		Int32 GetIcon(Bool perPolyVertex) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetIcon, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*, Bool>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetIcon));
			return proxy_result;
		}
		...
		Int32 GetTagPluginFlags() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginFlags, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_GetTagPluginFlags));
			return proxy_result;
		}
		...
		Bool Message(GeListNode* node, Int32 type, void* data) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Message, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, GeListNode*, Int32, void*>::Invoke, (const void*) mt_.CustomDataTagClassInterface_Message));
			return proxy_result;
		}
