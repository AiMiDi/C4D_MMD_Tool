...
class CommandCacheDecoratorImpl : public maxon::Component<CommandCacheDecoratorImpl, CommandCacheInterface, maxon::DecoratorInterface>
{
	MAXON_COMPONENT();
...
public:
	...
	{
		return maxon::Cast<CommandCacheRef>(self.GetDecoratedObject()).Init(data);
	}

	MAXON_METHOD void Reset()
	{
		return maxon::Cast<CommandCacheRef>(self.GetDecoratedObject()).Reset();
	}
