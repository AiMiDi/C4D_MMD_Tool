...
struct LegacyCommandDataInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<Generic*> (*LegacyCommandDataInterface_GetLegacyData) (maxon::GenericComponent* this_, Int index);
	maxon::Int LegacyCommandDataInterface_GetLegacyData_Offset;
	Result<void> (*LegacyCommandDataInterface_SetLegacyData) (maxon::GenericComponent* this_, const Generic* data, Int index);
	maxon::Int LegacyCommandDataInterface_SetLegacyData_Offset;
	Int (*LegacyCommandDataInterface_GetLegacyDataCount) (const maxon::GenericComponent* this_);
	...
	{
		LegacyCommandDataInterface_GetLegacyData = &W::LegacyCommandDataInterface_GetLegacyData;
		LegacyCommandDataInterface_GetLegacyData_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, LegacyCommandDataInterface, SetLegacyData))
	{
		LegacyCommandDataInterface_SetLegacyData = &W::LegacyCommandDataInterface_SetLegacyData;
		LegacyCommandDataInterface_SetLegacyData_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, LegacyCommandDataInterface, GetLegacyDataCount))
	{
		LegacyCommandDataInterface_GetLegacyDataCount = &W::LegacyCommandDataInterface_GetLegacyDataCount;
		LegacyCommandDataInterface_GetLegacyDataCount_Offset = offset;
	}
	}
...
struct LegacyCommandDataInterface::Hxx2
{
	...
	public:
		...
		static Result<Generic*> LegacyCommandDataInterface_GetLegacyData(maxon::GenericComponent* this_, Int index) { return ((typename S::Implementation*) this_)->GetLegacyData(index); }
		static Result<void> LegacyCommandDataInterface_SetLegacyData(maxon::GenericComponent* this_, const Generic* data, Int index) { return ((typename S::Implementation*) this_)->SetLegacyData(data, index); }
		static Int LegacyCommandDataInterface_GetLegacyDataCount(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetLegacyDataCount(); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandDataInterface::GetLegacyData(Int index) -> Result<Generic*>
{
	const LegacyCommandDataInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(LegacyCommandDataInterface, this); return mt_.LegacyCommandDataInterface_GetLegacyData((maxon::GenericComponent*) this + mt_.LegacyCommandDataInterface_GetLegacyData_Offset, index);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandDataInterface::SetLegacyData(const Generic* data, Int index) -> Result<void>
{
	const LegacyCommandDataInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(LegacyCommandDataInterface, this); return mt_.LegacyCommandDataInterface_SetLegacyData((maxon::GenericComponent*) this + mt_.LegacyCommandDataInterface_SetLegacyData_Offset, data, index);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandDataInterface::GetLegacyDataCount() const -> Int
{
	const LegacyCommandDataInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(LegacyCommandDataInterface, this); return mt_.LegacyCommandDataInterface_GetLegacyDataCount((const maxon::GenericComponent*) this + mt_.LegacyCommandDataInterface_GetLegacyDataCount_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandDataInterface::Hxx1::Fn<S>::GetLegacyData(Int index) const -> Result<Generic*>
{
	...
	return (mt_.LegacyCommandDataInterface_GetLegacyData(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.LegacyCommandDataInterface_GetLegacyData_Offset, index));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandDataInterface::Hxx1::Fn<S>::SetLegacyData(const Generic* data, Int index) const -> Result<void>
{
	...
	return (mt_.LegacyCommandDataInterface_SetLegacyData(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.LegacyCommandDataInterface_SetLegacyData_Offset, data, index));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandDataInterface::Hxx1::ConstFn<S>::GetLegacyDataCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	...
	return (mt_.LegacyCommandDataInterface_GetLegacyDataCount(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.LegacyCommandDataInterface_GetLegacyDataCount_Offset));
}
...
struct CommandClassInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<COMMANDSTATE> (*CommandClassInterface_GetState) (const maxon::GenericComponent* this_, CommandDataRef& data);
	maxon::Int CommandClassInterface_GetState_Offset;
	Result<COMMANDRESULT> (*CommandClassInterface_Execute) (const maxon::GenericComponent* this_, CommandDataRef& data);
	...
	{
		CommandClassInterface_GetState = &W::CommandClassInterface_GetState;
		CommandClassInterface_GetState_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CommandClassInterface, Execute))
	{
		CommandClassInterface_Execute = &W::CommandClassInterface_Execute;
		CommandClassInterface_Execute_Offset = offset;
	}
	}
...
struct CommandClassInterface::Hxx2
{
	...
	public:
		...
		static Result<COMMANDSTATE> CommandClassInterface_GetState(const maxon::GenericComponent* this_, CommandDataRef& data) { return ((const typename S::Implementation*) this_)->GetState(data); }
		static Result<COMMANDRESULT> CommandClassInterface_Execute(const maxon::GenericComponent* this_, CommandDataRef& data) { return ((const typename S::Implementation*) this_)->Execute(data); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto CommandClassInterface::GetState(CommandDataRef& data) const -> Result<COMMANDSTATE>
{
	const CommandClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandClassInterface, this); return mt_.CommandClassInterface_GetState((const maxon::GenericComponent*) this + mt_.CommandClassInterface_GetState_Offset, data);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto CommandClassInterface::Execute(CommandDataRef& data) const -> Result<COMMANDRESULT>
{
	const CommandClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandClassInterface, this); return mt_.CommandClassInterface_Execute((const maxon::GenericComponent*) this + mt_.CommandClassInterface_Execute_Offset, data);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandClassInterface::Hxx1::ConstFn<S>::GetState(CommandDataRef& data) const -> Result<COMMANDSTATE>
{
	...
	return (mt_.CommandClassInterface_GetState(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandClassInterface_GetState_Offset, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandClassInterface::Hxx1::ConstFn<S>::Execute(CommandDataRef& data) const -> Result<COMMANDRESULT>
{
	...
	return (mt_.CommandClassInterface_Execute(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandClassInterface_Execute_Offset, data));
}
...
struct CommandInteractionClassInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<COMMANDRESULT> (*CommandInteractionClassInterface_Interact) (const maxon::GenericComponent* this_, CommandDataRef& data, INTERACTIONTYPE interactionType);
	...
	{
		CommandInteractionClassInterface_Interact = &W::CommandInteractionClassInterface_Interact;
		CommandInteractionClassInterface_Interact_Offset = offset;
	}
	}
...
struct CommandInteractionClassInterface::Hxx2
{
	...
	public:
		...
		static Result<COMMANDRESULT> CommandInteractionClassInterface_Interact(const maxon::GenericComponent* this_, CommandDataRef& data, INTERACTIONTYPE interactionType) { return ((const typename S::Implementation*) this_)->Interact(data, interactionType); }
	};
...
{
	const CommandInteractionClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandInteractionClassInterface, this); return mt_.CommandInteractionClassInterface_Interact((const maxon::GenericComponent*) this + mt_.CommandInteractionClassInterface_Interact_Offset, data, interactionType);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandInteractionClassInterface::Hxx1::ConstFn<S>::Interact(CommandDataRef& data, INTERACTIONTYPE interactionType) const -> Result<COMMANDRESULT>
{
	...
	return (mt_.CommandInteractionClassInterface_Interact(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandInteractionClassInterface_Interact_Offset, data, interactionType));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandDescriptionClassInterface::Hxx1::ConstFn<S>::SetContext(CommandDataRef& data) const -> Result<void>
{
...
struct LegacyCommandClassInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<void> (*LegacyCommandClassInterface_ConvertSettings) (const maxon::GenericComponent* this_, LegacyCommandDataRef& data);
	...
	{
		LegacyCommandClassInterface_ConvertSettings = &W::LegacyCommandClassInterface_ConvertSettings;
		LegacyCommandClassInterface_ConvertSettings_Offset = offset;
	}
	}
...
struct LegacyCommandClassInterface::Hxx2
{
	...
	public:
		...
		static Result<void> LegacyCommandClassInterface_ConvertSettings(const maxon::GenericComponent* this_, LegacyCommandDataRef& data) { return ((const typename S::Implementation*) this_)->ConvertSettings(data); }
	};
...
{
	const LegacyCommandClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(LegacyCommandClassInterface, this); return mt_.LegacyCommandClassInterface_ConvertSettings((const maxon::GenericComponent*) this + mt_.LegacyCommandClassInterface_ConvertSettings_Offset, data);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LegacyCommandClassInterface::Hxx1::ConstFn<S>::ConvertSettings(LegacyCommandDataRef& data) const -> Result<void>
{
	...
	return (mt_.LegacyCommandClassInterface_ConvertSettings(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.LegacyCommandClassInterface_ConvertSettings_Offset, data));
}
...
struct MigratedCommandClassInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Int32 (*MigratedCommandClassInterface_GetMigratedCommandId) (const maxon::GenericComponent* this_);
	...
	{
		MigratedCommandClassInterface_GetMigratedCommandId = &W::MigratedCommandClassInterface_GetMigratedCommandId;
		MigratedCommandClassInterface_GetMigratedCommandId_Offset = offset;
	}
	}
...
struct MigratedCommandClassInterface::Hxx2
{
	...
	public:
		...
		static Int32 MigratedCommandClassInterface_GetMigratedCommandId(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetMigratedCommandId(); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto MigratedCommandClassInterface::GetMigratedCommandId() const -> Int32
{
	const MigratedCommandClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(MigratedCommandClassInterface, this); return mt_.MigratedCommandClassInterface_GetMigratedCommandId((const maxon::GenericComponent*) this + mt_.MigratedCommandClassInterface_GetMigratedCommandId_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MigratedCommandClassInterface::Hxx1::ConstFn<S>::GetMigratedCommandId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
	...
	return (mt_.MigratedCommandClassInterface_GetMigratedCommandId(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.MigratedCommandClassInterface_GetMigratedCommandId_Offset));
}
...
struct CommandConversionClassInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<void> (*CommandConversionClassInterface_ConvertInput) (const maxon::GenericComponent* this_, LegacyCommandDataRef& data);
	maxon::Int CommandConversionClassInterface_ConvertInput_Offset;
	Result<void> (*CommandConversionClassInterface_ExecuteCustomActions) (const maxon::GenericComponent* this_, LegacyCommandDataRef& data, Int actionId, Int flags);
	maxon::Int CommandConversionClassInterface_ExecuteCustomActions_Offset;
	Result<void> (*CommandConversionClassInterface_ConvertOutput) (const maxon::GenericComponent* this_, LegacyCommandDataRef& data);
	maxon::Int CommandConversionClassInterface_ConvertOutput_Offset;
	Int32 (*CommandConversionClassInterface_GetLegacyCommandId) (const maxon::GenericComponent* this_);
	maxon::Int CommandConversionClassInterface_GetLegacyCommandId_Offset;
	Id (*CommandConversionClassInterface_GetCommandId) (const maxon::GenericComponent* this_);
	...
	{
		CommandConversionClassInterface_ConvertInput = &W::CommandConversionClassInterface_ConvertInput;
		CommandConversionClassInterface_ConvertInput_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CommandConversionClassInterface, ExecuteCustomActions))
	{
		CommandConversionClassInterface_ExecuteCustomActions = &W::CommandConversionClassInterface_ExecuteCustomActions;
		CommandConversionClassInterface_ExecuteCustomActions_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CommandConversionClassInterface, ConvertOutput))
	{
		CommandConversionClassInterface_ConvertOutput = &W::CommandConversionClassInterface_ConvertOutput;
		CommandConversionClassInterface_ConvertOutput_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CommandConversionClassInterface, GetLegacyCommandId))
	{
		CommandConversionClassInterface_GetLegacyCommandId = &W::CommandConversionClassInterface_GetLegacyCommandId;
		CommandConversionClassInterface_GetLegacyCommandId_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CommandConversionClassInterface, GetCommandId))
	{
		CommandConversionClassInterface_GetCommandId = &W::CommandConversionClassInterface_GetCommandId;
		CommandConversionClassInterface_GetCommandId_Offset = offset;
	}
	}
...
struct CommandConversionClassInterface::Hxx2
{
	...
	public:
		...
		static Result<void> CommandConversionClassInterface_ConvertInput(const maxon::GenericComponent* this_, LegacyCommandDataRef& data) { return ((const typename S::Implementation*) this_)->ConvertInput(data); }
		static Result<void> CommandConversionClassInterface_ExecuteCustomActions(const maxon::GenericComponent* this_, LegacyCommandDataRef& data, Int actionId, Int flags) { return ((const typename S::Implementation*) this_)->ExecuteCustomActions(data, actionId, flags); }
		static Result<void> CommandConversionClassInterface_ConvertOutput(const maxon::GenericComponent* this_, LegacyCommandDataRef& data) { return ((const typename S::Implementation*) this_)->ConvertOutput(data); }
		static Int32 CommandConversionClassInterface_GetLegacyCommandId(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetLegacyCommandId(); }
		static Id CommandConversionClassInterface_GetCommandId(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetCommandId(); }
	};
...
{
	const CommandConversionClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandConversionClassInterface, this); return mt_.CommandConversionClassInterface_ConvertInput((const maxon::GenericComponent*) this + mt_.CommandConversionClassInterface_ConvertInput_Offset, data);
}
...
{
	const CommandConversionClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandConversionClassInterface, this); return mt_.CommandConversionClassInterface_ExecuteCustomActions((const maxon::GenericComponent*) this + mt_.CommandConversionClassInterface_ExecuteCustomActions_Offset, data, actionId, flags);
}
...
{
	const CommandConversionClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandConversionClassInterface, this); return mt_.CommandConversionClassInterface_ConvertOutput((const maxon::GenericComponent*) this + mt_.CommandConversionClassInterface_ConvertOutput_Offset, data);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::GetLegacyCommandId() const -> Int32
{
	const CommandConversionClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandConversionClassInterface, this); return mt_.CommandConversionClassInterface_GetLegacyCommandId((const maxon::GenericComponent*) this + mt_.CommandConversionClassInterface_GetLegacyCommandId_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::GetCommandId() const -> Id
{
	const CommandConversionClassInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandConversionClassInterface, this); return mt_.CommandConversionClassInterface_GetCommandId((const maxon::GenericComponent*) this + mt_.CommandConversionClassInterface_GetCommandId_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::Hxx1::ConstFn<S>::ConvertInput(LegacyCommandDataRef& data) const -> Result<void>
{
	...
	return (mt_.CommandConversionClassInterface_ConvertInput(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandConversionClassInterface_ConvertInput_Offset, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::Hxx1::ConstFn<S>::ExecuteCustomActions(LegacyCommandDataRef& data, Int actionId, Int flags) const -> Result<void>
{
	...
	return (mt_.CommandConversionClassInterface_ExecuteCustomActions(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandConversionClassInterface_ExecuteCustomActions_Offset, data, actionId, flags));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::Hxx1::ConstFn<S>::ConvertOutput(LegacyCommandDataRef& data) const -> Result<void>
{
	...
	return (mt_.CommandConversionClassInterface_ConvertOutput(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandConversionClassInterface_ConvertOutput_Offset, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::Hxx1::ConstFn<S>::GetLegacyCommandId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
	...
	return (mt_.CommandConversionClassInterface_GetLegacyCommandId(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandConversionClassInterface_GetLegacyCommandId_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandConversionClassInterface::Hxx1::ConstFn<S>::GetCommandId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Id>, Id>::type
{
	...
	return (mt_.CommandConversionClassInterface_GetCommandId(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.CommandConversionClassInterface_GetCommandId_Offset));
}
...
struct CommandCacheInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<void> (*CommandCacheInterface_Init) (maxon::GenericComponent* this_, CommandDataRef& data);
	maxon::Int CommandCacheInterface_Init_Offset;
	void (*CommandCacheInterface_Reset) (maxon::GenericComponent* this_);
	...
	{
		CommandCacheInterface_Init = &W::CommandCacheInterface_Init;
		CommandCacheInterface_Init_Offset = offset;
	}
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, CommandCacheInterface, Reset))
	{
		CommandCacheInterface_Reset = &W::CommandCacheInterface_Reset;
		CommandCacheInterface_Reset_Offset = offset;
	}
	}
...
struct CommandCacheInterface::Hxx2
{
	...
	public:
		...
		static Result<void> CommandCacheInterface_Init(maxon::GenericComponent* this_, CommandDataRef& data) { return ((typename S::Implementation*) this_)->Init(data); }
		static void CommandCacheInterface_Reset(maxon::GenericComponent* this_) { return ((typename S::Implementation*) this_)->Reset(); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto CommandCacheInterface::Init(CommandDataRef& data) -> Result<void>
{
	const CommandCacheInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandCacheInterface, this); return mt_.CommandCacheInterface_Init((maxon::GenericComponent*) this + mt_.CommandCacheInterface_Init_Offset, data);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto CommandCacheInterface::Reset() -> void
{
	const CommandCacheInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(CommandCacheInterface, this); return mt_.CommandCacheInterface_Reset((maxon::GenericComponent*) this + mt_.CommandCacheInterface_Reset_Offset);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandCacheInterface::Hxx1::Fn<S>::Init(CommandDataRef& data) const -> Result<void>
{
	...
	return (mt_.CommandCacheInterface_Init(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.CommandCacheInterface_Init_Offset, data));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CommandCacheInterface::Hxx1::Fn<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	...
	mt_.CommandCacheInterface_Reset(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.CommandCacheInterface_Reset_Offset);
...
struct CommandExecutionInterface::MTable
{
	...
	static const maxon::Bool HAS_NONSTATIC = false;
	Result<COMMANDRESULT> (*CommandExecutionInterface_Invoke) (const CommandClass& command, CommandDataRef& data, Bool interactive);
	Result<COMMANDRESULT> (*CommandExecutionInterface_Invoke_1) (const CommandClass& command, CommandDataRef& data, Bool interactive, const CommandDataInterface::SetParameters& setParameters);
	Result<COMMANDRESULT> (*CommandExecutionInterface_Interact) (CommandDataRef& data, INTERACTIONTYPE interactionType);
	template <typename IMPL> void Init()
	{
		CommandExecutionInterface_Invoke = &IMPL::CommandExecutionInterface_Invoke;
		CommandExecutionInterface_Invoke_1 = &IMPL::CommandExecutionInterface_Invoke_1;
		CommandExecutionInterface_Interact = &IMPL::CommandExecutionInterface_Interact;
	}
};
