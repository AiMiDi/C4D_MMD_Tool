...
namespace maxon
{
	...
	public:
		...
		Result<Generic*> GetLegacyData(Int index) 
		{
			...
			(*handler_)(_fn_LegacyCommandDataInterface_GetLegacyData, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Generic*>, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_.LegacyCommandDataInterface_GetLegacyData));
			return proxy_result;
		}
		...
		Result<void> SetLegacyData(const Generic* data, Int index) 
		{
			...
			(*handler_)(_fn_LegacyCommandDataInterface_SetLegacyData, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Generic*, Int>::Invoke, (const void*) mt_.LegacyCommandDataInterface_SetLegacyData));
			return proxy_result;
		}
		...
		Int GetLegacyDataCount() const 
		{
			...
			(*handler_)(_fn_LegacyCommandDataInterface_GetLegacyDataCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.LegacyCommandDataInterface_GetLegacyDataCount));
			return proxy_result;
		}
	...
	public:
		...
		Result<COMMANDSTATE> GetState(CommandDataRef& data) const 
		{
			...
			(*handler_)(_fn_CommandClassInterface_GetState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<COMMANDSTATE>, const maxon::GenericComponent*, CommandDataRef&>::Invoke, (const void*) mt_.CommandClassInterface_GetState));
			return proxy_result;
		}
		...
		Result<COMMANDRESULT> Execute(CommandDataRef& data) const 
		{
			...
			(*handler_)(_fn_CommandClassInterface_Execute, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<COMMANDRESULT>, const maxon::GenericComponent*, CommandDataRef&>::Invoke, (const void*) mt_.CommandClassInterface_Execute));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> ConvertSettings(LegacyCommandDataRef& data) const 
		{
			...
			(*handler_)(_fn_LegacyCommandClassInterface_ConvertSettings, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, LegacyCommandDataRef&>::Invoke, (const void*) mt_.LegacyCommandClassInterface_ConvertSettings));
			return proxy_result;
		}
	...
	public:
		...
		Int32 GetMigratedCommandId() const 
		{
			...
			(*handler_)(_fn_MigratedCommandClassInterface_GetMigratedCommandId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MigratedCommandClassInterface_GetMigratedCommandId));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> ConvertInput(LegacyCommandDataRef& data) const 
		{
			...
			(*handler_)(_fn_CommandConversionClassInterface_ConvertInput, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, LegacyCommandDataRef&>::Invoke, (const void*) mt_.CommandConversionClassInterface_ConvertInput));
			return proxy_result;
		}
		...
		Result<void> ConvertOutput(LegacyCommandDataRef& data) const 
		{
			...
			(*handler_)(_fn_CommandConversionClassInterface_ConvertOutput, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, LegacyCommandDataRef&>::Invoke, (const void*) mt_.CommandConversionClassInterface_ConvertOutput));
			return proxy_result;
		}
		...
		Int32 GetLegacyCommandId() const 
		{
			...
			(*handler_)(_fn_CommandConversionClassInterface_GetLegacyCommandId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CommandConversionClassInterface_GetLegacyCommandId));
			return proxy_result;
		}
		...
		Id GetCommandId() const 
		{
			...
			(*handler_)(_fn_CommandConversionClassInterface_GetCommandId, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Id, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CommandConversionClassInterface_GetCommandId));
			return proxy_result;
		}
	...
	public:
		...
		Result<void> Init(CommandDataRef& data) 
		{
			...
			(*handler_)(_fn_CommandCacheInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, CommandDataRef&>::Invoke, (const void*) mt_.CommandCacheInterface_Init));
			return proxy_result;
		}
		...
		void Reset() 
		{
			...
			(*handler_)(_fn_CommandCacheInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.CommandCacheInterface_Reset));
		}
	...
	static maxon::Result<void> RegisterReflection_CommandExecutionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CommandExecutionInterface::MTable::_instance.CommandExecutionInterface_Invoke)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "command\0data\0interactive\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CommandExecutionInterface::MTable::_instance.CommandExecutionInterface_Invoke_1)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "command\0data\0interactive\0setParameters\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CommandExecutionInterface::MTable::_instance.CommandExecutionInterface_Interact)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "data\0interactionType\0", 0LL, nullptr),
		};
