...
namespace maxon
{
	...
	public:
		...
		maxon::ObservableRef<ObservableCommandPrepareInfoDelegate> ObservableCommandPrepareInfo() const 
		{
			...
			(*handler_)(_fn_CommandObserverInterface_ObservableCommandPrepareInfo, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableCommandPrepareInfoDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CommandObserverInterface_ObservableCommandPrepareInfo));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableCommandInvokedInfoDelegate> ObservableCommandInvokedInfo() const 
		{
			...
			(*handler_)(_fn_CommandObserverInterface_ObservableCommandInvokedInfo, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableCommandInvokedInfoDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CommandObserverInterface_ObservableCommandInvokedInfo));
			return proxy_result;
		}
