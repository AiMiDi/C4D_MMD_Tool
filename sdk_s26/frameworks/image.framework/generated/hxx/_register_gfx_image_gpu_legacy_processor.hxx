...
namespace maxon
{
	...
	maxon::Bool ColorProfileLegacyProcessorInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->ColorProfileLegacyProcessorInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileLegacyProcessorInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ColorProfileLegacyProcessorInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileLegacyProcessorInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->ColorProfileLegacyProcessorInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileLegacyProcessorInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ForwardRef<ColorProfileGpuHandlerRef>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileLegacyProcessorInterface_CreateHandler = &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileLegacyProcessorInterface_CreateHandler;
		#else
		tbl->ColorProfileLegacyProcessorInterface_CreateHandler = &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileLegacyProcessorInterface_CreateHandler;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
