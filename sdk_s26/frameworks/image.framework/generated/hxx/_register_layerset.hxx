...
namespace maxon
{
	...
	maxon::Bool LayerSetInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->LayerSetInterface_Free = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_Free;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_Alloc = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_Alloc;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_Alloc_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_Alloc_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_SetSelectedLayers = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_SetSelectedLayers;
		#else
		tbl->LayerSetInterface_SetSelectedLayers = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_SetSelectedLayers;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const LayerHash&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetSelectedLayers = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetSelectedLayers;
		#else
		tbl->LayerSetInterface_GetSelectedLayers = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetSelectedLayers;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_SetSelectedImage = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_SetSelectedImage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetSelectedImage = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetSelectedImage;
		#else
		tbl->LayerSetInterface_GetSelectedImage = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetSelectedImage;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_SetMode = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_SetMode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LAYERSETMODE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetMode = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetMode;
		#else
		tbl->LayerSetInterface_GetMode = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetMode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_SetCalculateAlpha = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_SetCalculateAlpha;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_GetCalculateAlpha = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetCalculateAlpha;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LayerSetInterface_IsEqual = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_IsEqual;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetHashCode;
		#else
		tbl->LayerSetInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetHashCode;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_DescribeIO;
		#else
		tbl->LayerSetInterface_DescribeIO = &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_DescribeIO;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
