...
namespace maxon
{
	...
	public:
		...
		Result<void> OnConnect(const IntVector2d& dimensions) 
		{
			...
			(*handler_)(_fn_ImageRegionObserverInterface_OnConnect, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const IntVector2d&>::Invoke, (const void*) mt_.ImageRegionObserverInterface_OnConnect));
			return proxy_result;
		}
		...
		void OnResize(const IntVector2d& dimensions) 
		{
			...
			(*handler_)(_fn_ImageRegionObserverInterface_OnResize, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const IntVector2d&>::Invoke, (const void*) mt_.ImageRegionObserverInterface_OnResize));
		}
		...
		void OnRegionDirty(const Range<IntVector2d>& dirtyRegion) 
		{
			...
			(*handler_)(_fn_ImageRegionObserverInterface_OnRegionDirty, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const Range<IntVector2d>&>::Invoke, (const void*) mt_.ImageRegionObserverInterface_OnRegionDirty));
		}
		...
		void OnDisconnect() 
		{
			...
			(*handler_)(_fn_ImageRegionObserverInterface_OnDisconnect, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageRegionObserverInterface_OnDisconnect));
		}
	...
	static maxon::Result<void> RegisterReflection_ImageRegionObservableInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageRegionObservableInterface::MTable::_instance.ImageRegionObservableInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "object\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageRegionObservableInterface::MTable::_instance.ImageRegionObservableInterface_RegisterObserver)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "observerId\0observer\0", 5LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_ImageRegionObservableHandlerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageRegionObservableHandlerInterface::MTable::_instance.ImageRegionObservableHandlerInterface_Create)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dimensions\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageRegionObservableHandlerInterface::MTable::_instance.ImageRegionObservableHandlerInterface_ResizeImage)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "dimensions\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageRegionObservableHandlerInterface::MTable::_instance.ImageRegionObservableHandlerInterface_MarkDirty)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "dirtyRegion\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageRegionObservableHandlerInterface::MTable::_instance.ImageRegionObservableHandlerInterface_GetObservable)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "", 0LL, nullptr),
		};
