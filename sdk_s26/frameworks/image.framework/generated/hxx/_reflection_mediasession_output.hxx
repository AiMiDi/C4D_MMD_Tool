...
namespace maxon
{
	...
	public:
		...
		Result<void> ResetConverter() 
		{
			...
			(*handler_)(_fn_MediaOutputInterface_ResetConverter, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.MediaOutputInterface_ResetConverter));
			return proxy_result;
		}
		...
		Result<void> SetSelectionHandler(const MediaOutputSelectionHandler& selectionHandler) 
		{
			...
			(*handler_)(_fn_MediaOutputInterface_SetSelectionHandler, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const MediaOutputSelectionHandler&>::Invoke, (const void*) mt_.MediaOutputInterface_SetSelectionHandler));
			return proxy_result;
		}
		...
		const MediaOutputSelectionHandler& GetSelectionHandler() const 
		{
			...
			(*handler_)(_fn_MediaOutputInterface_GetSelectionHandler, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const MediaOutputSelectionHandler&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MediaOutputInterface_GetSelectionHandler));
			return *proxy_result;
		}
	...
	public:
		...
		Url GetOutputUrl() const 
		{
			...
			(*handler_)(_fn_MediaOutputUrlInterface_GetOutputUrl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Url, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MediaOutputUrlInterface_GetOutputUrl));
			return proxy_result;
		}
		...
		Result<void> SetOutputUrl(const Url& url) 
		{
			...
			(*handler_)(_fn_MediaOutputUrlInterface_SetOutputUrl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_.MediaOutputUrlInterface_SetOutputUrl));
			return proxy_result;
		}
		...
		const FileFormat& GetFileFormat() const 
		{
			...
			(*handler_)(_fn_MediaOutputUrlInterface_GetFileFormat, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const FileFormat&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MediaOutputUrlInterface_GetFileFormat));
			return *proxy_result;
		}
		...
		Result<Bool> EditSystemOptions(DataDictionary& settings, const Delegate<Result<void*>()>& getParentwindowHandle) 
		{
			...
			(*handler_)(_fn_MediaOutputUrlInterface_EditSystemOptions, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, DataDictionary&, const Delegate<Result<void*>()>&>::Invoke, (const void*) mt_.MediaOutputUrlInterface_EditSystemOptions));
			return proxy_result;
		}
