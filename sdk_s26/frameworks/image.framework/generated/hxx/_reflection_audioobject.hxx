...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(Int channelCount, Int bitsPerChannel, Float sampleRate, Int sampleCount, const TimeValue& length, const Block<const Char>& data) 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int, Int, Float, Int, const TimeValue&, const Block<const Char>&>::Invoke, (const void*) mt_.AudioObjectInterface_Init));
			return proxy_result;
		}
		...
		Int GetChannelCount() const 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_GetChannelCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AudioObjectInterface_GetChannelCount));
			return proxy_result;
		}
		...
		Int GetBitsPerChannel() const 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_GetBitsPerChannel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AudioObjectInterface_GetBitsPerChannel));
			return proxy_result;
		}
		...
		Float GetSampleRate() const 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_GetSampleRate, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Float, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AudioObjectInterface_GetSampleRate));
			return proxy_result;
		}
		...
		Int GetSampleCount() const 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_GetSampleCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AudioObjectInterface_GetSampleCount));
			return proxy_result;
		}
		...
		TimeValue GetLength() const 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_GetLength, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<TimeValue, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AudioObjectInterface_GetLength));
			return proxy_result;
		}
		...
		Block<const Char> GetDataPtr() const 
		{
			...
			(*handler_)(_fn_AudioObjectInterface_GetDataPtr, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Block<const Char>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.AudioObjectInterface_GetDataPtr));
			return proxy_result;
		}
