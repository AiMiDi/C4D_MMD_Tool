...
namespace maxon
{
	...
	public:
		...
		Result<void> Convert(const TimeValue& targetTime, MEDIASESSIONFLAGS flags) 
		{
			...
			(*handler_)(_fn_MediaSessionInterface_Convert, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const TimeValue&, MEDIASESSIONFLAGS>::Invoke, (const void*) mt_.MediaSessionInterface_Convert));
			return proxy_result;
		}
		...
		Result<void> Close() 
		{
			...
			(*handler_)(_fn_MediaSessionInterface_Close, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_.MediaSessionInterface_Close));
			return proxy_result;
		}
		...
		ProgressRef GetProgress() const 
		{
			...
			(*handler_)(_fn_MediaSessionInterface_GetProgress, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ProgressRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MediaSessionInterface_GetProgress));
			return proxy_result;
		}
