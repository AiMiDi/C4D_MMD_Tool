...
namespace maxon
{
	...
	public:
		...
		Pix8u GetDefaultFillValue() const 
		{
			...
			(*handler_)(_fn_ImageChannelTypeInterface_GetDefaultFillValue, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Pix8u, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageChannelTypeInterface_GetDefaultFillValue));
			return proxy_result;
		}
		...
		ColorSpace GetColorSpace() const 
		{
			...
			(*handler_)(_fn_ImageChannelTypeInterface_GetColorSpace, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ColorSpace, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageChannelTypeInterface_GetColorSpace));
			return proxy_result;
		}
		...
		ImageChannel GetChannel(const DataType& pixelType) const 
		{
			...
			(*handler_)(_fn_ImageChannelTypeInterface_GetChannel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ImageChannel, const maxon::GenericComponent*, const DataType&>::Invoke, (const void*) mt_.ImageChannelTypeInterface_GetChannel));
			return proxy_result;
		}
	...
	public:
		...
		BITS GetChannelBits() const 
		{
			...
			(*handler_)(_fn_ImageChannelInterface_GetChannelBits, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<BITS, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageChannelInterface_GetChannelBits));
			return proxy_result;
		}
		...
		ImageChannelType GetChannelType() const 
		{
			...
			(*handler_)(_fn_ImageChannelInterface_GetChannelType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ImageChannelType, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageChannelInterface_GetChannelType));
			return proxy_result;
		}
		...
		const DataType& GetDataType() const 
		{
			...
			(*handler_)(_fn_ImageChannelInterface_GetDataType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageChannelInterface_GetDataType));
			return *proxy_result;
		}
		...
		Bool IsIdenticalComponent(const void* a, const void* b, Int oneTolerance) const 
		{
			...
			(*handler_)(_fn_ImageChannelInterface_IsIdenticalComponent, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const void*, const void*, Int>::Invoke, (const void*) mt_.ImageChannelInterface_IsIdenticalComponent));
			return proxy_result;
		}
