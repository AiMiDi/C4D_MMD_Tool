...
namespace maxon
{
	...
	maxon::Bool ImagePixelBlendInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<PixelFormat>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ImagePixelBlendInterface_GetOptimalPixelFormat = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImagePixelBlendInterface_GetOptimalPixelFormat;
		#else
		tbl->ImagePixelBlendInterface_GetOptimalPixelFormat = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImagePixelBlendInterface_GetOptimalPixelFormat;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
