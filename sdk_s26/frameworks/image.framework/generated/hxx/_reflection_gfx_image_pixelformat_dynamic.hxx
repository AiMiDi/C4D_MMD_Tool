...
namespace maxon
{
	...
	public:
		...
		Result<Int> AddChannel(const ImageChannel& channel) 
		{
			...
			(*handler_)(_fn_PixelFormatDynamicInterface_AddChannel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const ImageChannel&>::Invoke, (const void*) mt_.PixelFormatDynamicInterface_AddChannel));
			return proxy_result;
		}
