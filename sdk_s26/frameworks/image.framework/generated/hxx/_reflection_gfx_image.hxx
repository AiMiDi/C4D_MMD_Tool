...
/// @endcond
	...
	public:
		...
		Result<void> InitBase(Int width, Int height, const PixelFormat& pixelFormat, IMAGEPROPERTIES::ITYPE type) 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_InitBase, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int, Int, const PixelFormat&, IMAGEPROPERTIES::ITYPE>::Invoke, (const void*) mt_.ImageBaseInterface_InitBase));
			return proxy_result;
		}
		...
		Result<void> AddChildren(IMAGEHIERARCHY hierarchy, const ImageBaseRef& newChildren, const ImageBaseRef& insertBefore) 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_AddChildren, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, IMAGEHIERARCHY, const ImageBaseRef&, const ImageBaseRef&>::Invoke, (const void*) mt_.ImageBaseInterface_AddChildren));
			return proxy_result;
		}
		...
		Int GetWidth() const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_GetWidth, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageBaseInterface_GetWidth));
			return proxy_result;
		}
		...
		Int GetHeight() const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_GetHeight, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageBaseInterface_GetHeight));
			return proxy_result;
		}
		...
		Int GetChannelCount() const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_GetChannelCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageBaseInterface_GetChannelCount));
			return proxy_result;
		}
		...
		PixelFormat GetPixelFormat() const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_GetPixelFormat, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<PixelFormat, const maxon::GenericComponent*>::Invoke, (const void*) mt_.ImageBaseInterface_GetPixelFormat));
			return proxy_result;
		}
...
/// @cond INTERNAL
		...
		void FreePixelHandler(GetPixelHandlerStruct& pixel) const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_FreePixelHandler, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, GetPixelHandlerStruct&>::Invoke, (const void*) mt_.ImageBaseInterface_FreePixelHandler));
		}
		...
		void FreePixelHandler(SetPixelHandlerStruct& pixel) const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_FreePixelHandler_1, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, SetPixelHandlerStruct&>::Invoke, (const void*) mt_.ImageBaseInterface_FreePixelHandler_1));
		}
...
/// @endcond
		...
		Result<void> GetComponent(Int component, const ImagePos& pos, Pix* data, Int inc, GETPIXELFLAGS flags) const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_GetComponent, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, Int, const ImagePos&, Pix*, Int, GETPIXELFLAGS>::Invoke, (const void*) mt_.ImageBaseInterface_GetComponent));
			return proxy_result;
		}
		...
		Result<void> SetComponent(Int component, const ImagePos& pos, const Pix* data, Int inc, SETPIXELFLAGS flags) 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_SetComponent, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int, const ImagePos&, const Pix*, Int, SETPIXELFLAGS>::Invoke, (const void*) mt_.ImageBaseInterface_SetComponent));
			return proxy_result;
		}
		...
		Result<ImageBaseRef> CreateSubImagePart(const DrawRectInt& rect) const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_CreateSubImagePart, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<ImageBaseRef>, const maxon::GenericComponent*, const DrawRectInt&>::Invoke, (const void*) mt_.ImageBaseInterface_CreateSubImagePart));
			return proxy_result;
		}
...
/// @endcond
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ImageBaseInterface, ImageBaseInterface_ObservableRegionChanged),
		};
	...
	public:
		...
		Result<void> Save(const MediaOutputRef& fileFormat, MEDIASESSIONFLAGS flags, MediaSessionRef* returnOpenSession) const 
		{
			...
			(*handler_)(_fn_ImageTextureInterface_Save, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const MediaOutputRef&, MEDIASESSIONFLAGS, MediaSessionRef*>::Invoke, (const void*) mt_.ImageTextureInterface_Save));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ImageTextureInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageTextureInterface::Hxx2::StaticMTable::_instance.ImageTextureInterface_LoadTexture)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "name\0targetTime\0flags\0pixelStorageClass\0layerSet\0", 341LL, nullptr),
		};
	...
	public:
		...
		Result<void> Init(Int width, Int height, const Class<ImagePixelStorage>& storageFormat, const PixelFormat& pixelFormat, const Block<Pix>* defaultColor) 
		{
			...
			(*handler_)(_fn_ImageInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int, Int, const Class<ImagePixelStorage>&, const PixelFormat&, const Block<Pix>*>::Invoke, (const void*) mt_.ImageInterface_Init));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ImageFunctionsInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImageFunctionsInterface::MTable::_instance.ImageFunctionsInterface_CreateSubImagePart)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "imageRef\0rect\0", 5LL, nullptr),
		};
