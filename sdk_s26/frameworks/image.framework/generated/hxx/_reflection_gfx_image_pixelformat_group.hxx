...
namespace maxon
{
	...
	public:
		...
		PixelFormatIterator GetEntries() const 
		{
			...
			(*handler_)(_fn_PixelFormatGroupInterface_GetEntries, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<PixelFormatIterator, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatGroupInterface_GetEntries));
			return proxy_result;
		}
