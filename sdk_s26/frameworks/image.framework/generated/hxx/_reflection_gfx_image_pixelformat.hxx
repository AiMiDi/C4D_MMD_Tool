...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(const PixelFormatGroup& group, const Char* shortName) 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const PixelFormatGroup&, const Char*>::Invoke, (const void*) mt_.PixelFormatInterface_Init));
			return proxy_result;
		}
		...
		Block<const ImageChannel> GetChannels() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetChannels, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Block<const ImageChannel>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetChannels));
			return proxy_result;
		}
		...
		const PixelFormatGroup& GetPixelFormatGroup() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetPixelFormatGroup, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const PixelFormatGroup&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetPixelFormatGroup));
			return *proxy_result;
		}
		...
		Result<Pix*> CreatePix(Int width, Int height, Int lineAlignment) const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_CreatePix, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Pix*>, const maxon::GenericComponent*, Int, Int, Int>::Invoke, (const void*) mt_.PixelFormatInterface_CreatePix));
			return proxy_result;
		}
		...
		Int GetChannelCount() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetChannelCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetChannelCount));
			return proxy_result;
		}
		...
		const ChannelOffsets& GetChannelOffsets() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetChannelOffsets, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const ChannelOffsets&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetChannelOffsets));
			return *proxy_result;
		}
		...
		BITS GetBitsPerPixel() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetBitsPerPixel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<BITS, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetBitsPerPixel));
			return proxy_result;
		}
		...
		Int GetBytesPerLine(Int width, Int lineAlignment) const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetBytesPerLine, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*, Int, Int>::Invoke, (const void*) mt_.PixelFormatInterface_GetBytesPerLine));
			return proxy_result;
		}
		...
		Int GetPackedPixelCount() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetPackedPixelCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetPackedPixelCount));
			return proxy_result;
		}
		...
		Bool HasAlpha() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_HasAlpha, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_HasAlpha));
			return proxy_result;
		}
		...
		Result<Tuple<PixelFormat, Int>> GetAlphaPixelFormat() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetAlphaPixelFormat, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Tuple<PixelFormat, Int>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetAlphaPixelFormat));
			return proxy_result;
		}
		...
		ColorSpace GetColorSpace() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetColorSpace, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<ColorSpace, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetColorSpace));
			return proxy_result;
		}
		...
		const ColorProfile& GetDefaultColorProfile() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetDefaultColorProfile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const ColorProfile&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetDefaultColorProfile));
			return *proxy_result;
		}
		...
		Result<CONVERTPIXELFUNC> GetConvertPixelFunc(const PixelFormat& srcFormatPtr, const ChannelOffsets& srcChannelOffset, const ChannelOffsets& dstChannelOffset, const ColorProfile& srcColorProfile, ColorProfile* dstColorProfile, Bool forceColorProfileConversion, COLORCONVERSIONFLAGS colorConversionFlags, Bool& disableCaching) const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetConvertPixelFunc_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<CONVERTPIXELFUNC>, const maxon::GenericComponent*, const PixelFormat&, const ChannelOffsets&, const ChannelOffsets&, const ColorProfile&, ColorProfile*, Bool, COLORCONVERSIONFLAGS, Bool&>::Invoke, (const void*) mt_.PixelFormatInterface_GetConvertPixelFunc_1));
			return proxy_result;
		}
		...
		Bool IsIdenticalPixel(const ImageConstBuffer& a, const ImageConstBuffer& b, Int oneTolerance) const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_IsIdenticalPixel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const ImageConstBuffer&, const ImageConstBuffer&, Int>::Invoke, (const void*) mt_.PixelFormatInterface_IsIdenticalPixel));
			return proxy_result;
		}
		...
		String PixToString(const Pix* src) const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_PixToString, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const Pix*>::Invoke, (const void*) mt_.PixelFormatInterface_PixToString));
			return proxy_result;
		}
		...
		const Char* GetShortName() const 
		{
			...
			(*handler_)(_fn_PixelFormatInterface_GetShortName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Char*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.PixelFormatInterface_GetShortName));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_PixelFormatsInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(PixelFormatsInterface::MTable::_instance.PixelFormatsInterface_FindOrCreatePixelFormat)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "channels\0", 1LL, nullptr),
		};
