...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(const MediaStreamFormat& withFormat) 
		{
			...
			(*handler_)(_fn_MediaStreamPropertiesInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const MediaStreamFormat&>::Invoke, (const void*) mt_.MediaStreamPropertiesInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(const MediaStreamRef& withStream) 
		{
			...
			(*handler_)(_fn_MediaStreamPropertiesInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const MediaStreamRef&>::Invoke, (const void*) mt_.MediaStreamPropertiesInterface_Init_1));
			return proxy_result;
		}
