...
struct ColorProfileLegacyProcessorInterface::MTable
{
	...
	void (*ColorProfileLegacyProcessorInterface_Free) (const ColorProfileLegacyProcessorInterface* object);
	ColorProfileLegacyProcessorInterface* (*ColorProfileLegacyProcessorInterface_Alloc) (const maxon::SourceLocation& allocLocation);
	ColorProfileLegacyProcessorInterface* (*ColorProfileLegacyProcessorInterface_Alloc_1) (const maxon::SourceLocation& allocLocation, const ColorProfileLegacyProcessorInterface& object);
	Result<ForwardRef<ColorProfileGpuHandlerRef>> (*ColorProfileLegacyProcessorInterface_CreateHandler) (const ColorProfile& srcProfile, const ColorProfile& dstProfile, COLORCONVERSIONFLAGS_GPU flags, COLORCONVERSION_OPTIMIZATION_GPU_FLAGS optimization);
	template <typename IMPL> void Init()
	{
		ColorProfileLegacyProcessorInterface_Free = &IMPL::ColorProfileLegacyProcessorInterface_Free;
		ColorProfileLegacyProcessorInterface_Alloc = &IMPL::ColorProfileLegacyProcessorInterface_Alloc;
		ColorProfileLegacyProcessorInterface_Alloc_1 = &IMPL::ColorProfileLegacyProcessorInterface_Alloc_1;
		ColorProfileLegacyProcessorInterface_CreateHandler = &IMPL::ColorProfileLegacyProcessorInterface_CreateHandler;
	}
};
