...
namespace maxon
{
	...
	template <typename DUMMY> maxon::Int VectorImageInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_gfx_image_vector(0
	| maxon::VectorImageInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
