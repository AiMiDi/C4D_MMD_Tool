...
namespace maxon
{
	...
	const maxon::Char* const CodeExchangeInterface::MTable::_ids = 
		...
		"SendScriptToIDE@2ff13a673d9927f2\0" // Result<void> SendScriptToIDE(const PythonElementScriptRef& script) const
		"SendConsoleOutput@7ba6a065f0807871\0" // Result<void> SendConsoleOutput(const String& content) const
