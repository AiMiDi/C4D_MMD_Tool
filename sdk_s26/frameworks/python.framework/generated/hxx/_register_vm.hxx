...
namespace maxon
{
	namespace enum19
	{
		...
		static const maxon::UInt64 VMSETTINGS_values[] = {maxon::UInt64(enum19::VMSETTINGS::MOVE_ERRORS_TO_RESULT), maxon::UInt64(enum19::VMSETTINGS::USE_AUTO_GIL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VMSETTINGS19(){ return enum19::VMSETTINGS_info; }
	namespace enum29
	{
		...
		static const maxon::UInt64 VMINITSETTINGS_values[] = {maxon::UInt64(enum29::VMINITSETTINGS::CPYTHON_ADDITIONAL_SYS_PATH), maxon::UInt64(enum29::VMINITSETTINGS::CPYTHON_INTERPRETERFLAGS), maxon::UInt64(enum29::VMINITSETTINGS::CPYTHON_SUBINTERPRETER), maxon::UInt64(enum29::VMINITSETTINGS::PYPY_EXECUTABLE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VMINITSETTINGS29(){ return enum29::VMINITSETTINGS_info; }
	namespace enum36
	{
		...
		static const maxon::UInt64 ERRORHANDLING_values[] = {maxon::UInt64(enum36::ERRORHANDLING::PRINT), maxon::UInt64(enum36::ERRORHANDLING::CLEAR), maxon::UInt64(enum36::ERRORHANDLING::REDIRECT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_ERRORHANDLING36(){ return enum36::ERRORHANDLING_info; }
	namespace enum93
	{
		...
		static const maxon::UInt64 DEFAULTRUNTIME_values[] = {maxon::UInt64(enum93::DEFAULTRUNTIME::NONE), maxon::UInt64(enum93::DEFAULTRUNTIME::DEBUG_3_VS2015), maxon::UInt64(enum93::DEFAULTRUNTIME::RELEASE_3_VS2015), maxon::UInt64(enum93::DEFAULTRUNTIME::DEBUG_3), maxon::UInt64(enum93::DEFAULTRUNTIME::RELEASE_3), maxon::UInt64(enum93::DEFAULTRUNTIME::DEFAULT_3), maxon::UInt64(enum93::DEFAULTRUNTIME::DEFAULT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_DEFAULTRUNTIME93(){ return enum93::DEFAULTRUNTIME_info; }
#ifdef MAXON_TARGET_WINDOWS
#endif
	MAXON_WARNING_PUSH
	...
	maxon::Bool LibraryInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		#else
		tbl->LibraryInterface_ConsoleIsAvailable = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_ConsoleIsAvailable;
		#endif
#ifdef MAXON_TARGET_WINDOWS
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LibraryInterface_GetVsVersion = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_GetVsVersion;
		#else
		tbl->LibraryInterface_GetVsVersion = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_GetVsVersion;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LibraryInterface_GetVsRuntimeLibrary = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_GetVsRuntimeLibrary;
		#else
		tbl->LibraryInterface_GetVsRuntimeLibrary = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_GetVsRuntimeLibrary;
		#endif
#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LibraryInterface_GetFileContent = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_GetFileContent;
		#else
		tbl->LibraryInterface_GetFileContent = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_GetFileContent;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LibraryInterface_SetFileContent = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_SetFileContent;
		#else
		tbl->LibraryInterface_SetFileContent = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::LibraryInterface_SetFileContent;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
