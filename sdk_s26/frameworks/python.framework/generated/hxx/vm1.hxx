...
#endif
struct LibraryInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, LibraryInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(LibraryInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct LibraryInterface::Hxx1
{
	...
	public:
		...
		static ConstFn PrivateLookupFn(LibraryInterface**);
...
/// @return												Returns OK if the operation succeeded.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(LibraryInterface**);
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(LibraryInterface**);
...
#ifdef DOXYGEN
public FnDoxy<LibraryRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LibraryInterface, maxon::StrongRefHandler, LibraryRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LibraryInterface, maxon::StrongRefHandler, LibraryRef>>>>);
...
#ifdef MAXON_COMPILER_GCC
#endif
struct VmDebuggerConnectionInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VmDebuggerConnectionInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(VmDebuggerConnectionInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct VmDebuggerConnectionInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(VmDebuggerConnectionInterface**);
...
/// @return			Shutdown script, including \\n and 4-spaces. Can return an empty string.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(VmDebuggerConnectionInterface**);
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(VmDebuggerConnectionInterface**);
...
#ifdef DOXYGEN
public FnDoxy<VmDebuggerConnectionRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VmDebuggerConnectionInterface, maxon::StrongRefHandler, VmDebuggerConnectionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VmDebuggerConnectionInterface, maxon::StrongRefHandler, VmDebuggerConnectionRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct VirtualMachineScopeInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VirtualMachineScopeInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(VirtualMachineScopeInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct VirtualMachineScopeInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(VirtualMachineScopeInterface**);
...
/// Private.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(VirtualMachineScopeInterface**);
...
#ifdef DOXYGEN
public FnDoxy<VirtualMachineScopeRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VirtualMachineScopeInterface, maxon::StrongRefHandler, VirtualMachineScopeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VirtualMachineScopeInterface, maxon::StrongRefHandler, VirtualMachineScopeRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct VirtualMachineInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VirtualMachineInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(VirtualMachineInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct VirtualMachineInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(VirtualMachineInterface**);
...
/// @return												An array of available virtual machines libraries.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(VirtualMachineInterface**);
...
/// @return												Underlying virtual machine library.
	...
	public:
		...
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(VirtualMachineInterface**);
...
#ifdef DOXYGEN
public FnDoxy<VirtualMachineRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VirtualMachineInterface, maxon::StrongRefHandler, VirtualMachineRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VirtualMachineInterface, maxon::StrongRefHandler, VirtualMachineRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
