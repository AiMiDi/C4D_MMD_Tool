...
namespace maxon
{
	namespace py
	{
		...
		void Init(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) 
		{
			...
			(*handler_)(_fn_CPyInterface_Init, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*, const CPythonLibraryInterface*, REFTYPE, NativePyObject*>::Invoke, (const void*) mt_.CPyInterface_Init));
		}
		...
		void Incref() 
		{
			...
			(*handler_)(_fn_CPyInterface_Incref, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_Incref));
		}
		...
		void Decref() 
		{
			...
			(*handler_)(_fn_CPyInterface_Decref, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_Decref));
		}
		...
		Int64 GetRefCount() 
		{
			...
			(*handler_)(_fn_CPyInterface_GetRefCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int64, maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_GetRefCount));
			return proxy_result;
		}
		...
		const CPythonLibraryInterface* GetLibrary() const 
		{
			...
			(*handler_)(_fn_CPyInterface_GetLibrary, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const CPythonLibraryInterface*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_GetLibrary));
			return proxy_result;
		}
		...
		CPyTypeRef GetTypeRef() const 
		{
			...
			(*handler_)(_fn_CPyInterface_GetTypeRef, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyTypeRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_GetTypeRef));
			return proxy_result;
		}
		...
		NativePyObject* GetPyObject() const 
		{
			...
			(*handler_)(_fn_CPyInterface_GetPyObject, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<NativePyObject*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_GetPyObject));
			return proxy_result;
		}
		...
		NativePyObject* Disconnect() 
		{
			...
			(*handler_)(_fn_CPyInterface_Disconnect, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<NativePyObject*, maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyInterface_Disconnect));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyInterface::ProxyComponent::_fn_CPyInterface_Disconnect;
		...
		CPyFrameRef GetBack() const 
		{
			...
			(*handler_)(_fn_CPyFrameInterface_GetBack, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyFrameRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyFrameInterface_GetBack));
			return proxy_result;
		}
		...
		CPyCodeRef GetCode() const 
		{
			...
			(*handler_)(_fn_CPyFrameInterface_GetCode, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyCodeRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyFrameInterface_GetCode));
			return proxy_result;
		}
		...
		Int32 GetLastInstruction() const 
		{
			...
			(*handler_)(_fn_CPyFrameInterface_GetLastInstruction, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyFrameInterface_GetLastInstruction));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyFrameInterface::ProxyComponent::_fn_CPyFrameInterface_GetLastInstruction;
		...
		CPyTracebackRef GetNext() const 
		{
			...
			(*handler_)(_fn_CPyTracebackInterface_GetNext, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyTracebackRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyTracebackInterface_GetNext));
			return proxy_result;
		}
		...
		Int32 GetLineNumber() const 
		{
			...
			(*handler_)(_fn_CPyTracebackInterface_GetLineNumber, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyTracebackInterface_GetLineNumber));
			return proxy_result;
		}
		...
		CPyFrameRef GetFrameRef() const 
		{
			...
			(*handler_)(_fn_CPyTracebackInterface_GetFrameRef, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyFrameRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyTracebackInterface_GetFrameRef));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyTracebackInterface::ProxyComponent::_fn_CPyTracebackInterface_GetFrameRef;
		...
		CPyRef GetFilename() const 
		{
			...
			(*handler_)(_fn_CPyCodeInterface_GetFilename, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyCodeInterface_GetFilename));
			return proxy_result;
		}
		...
		CPyRef GetName() const 
		{
			...
			(*handler_)(_fn_CPyCodeInterface_GetName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_.CPyCodeInterface_GetName));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyCodeInterface::ProxyComponent::_fn_CPyCodeInterface_GetName;
		...
		const reflection::Function* GetFunction() 
		{
			...
			(*handler_)(_fn_MPyFunctionInterface_GetFunction, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const reflection::Function*, maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyFunctionInterface_GetFunction));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* MPyFunctionInterface::ProxyComponent::_fn_MPyFunctionInterface_GetFunction;
		...
		HashMap<Data, Data>* GetHashMap() 
		{
			...
			(*handler_)(_fn_MPyHashMapInterface_GetHashMap, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<HashMap<Data, Data>*, maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyHashMapInterface_GetHashMap));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* MPyHashMapInterface::ProxyComponent::_fn_MPyHashMapInterface_GetHashMap;
		...
		const DataType& GetType() const 
		{
			...
			(*handler_)(_fn_MPyDataTypeInterface_GetType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataTypeInterface_GetType));
			return *proxy_result;
		}
	...
	const maxon::reflection::Function* MPyDataTypeInterface::ProxyComponent::_fn_MPyDataTypeInterface_GetType;
		...
		const DataType& GetType() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataInterface_GetType));
			return *proxy_result;
		}
		...
		const DataType& GetMappingType() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetMappingType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataInterface_GetMappingType));
			return *proxy_result;
		}
		...
		Data* GetData() 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetData, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Data*, maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataInterface_GetData));
			return proxy_result;
		}
		...
		const Data* GetData() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetData_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Data*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataInterface_GetData_1));
			return proxy_result;
		}
		...
		const Generic* PrivateGetPtr() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_PrivateGetPtr, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const Generic*, const maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataInterface_PrivateGetPtr));
			return proxy_result;
		}
		...
		Generic* PrivateGetPtr() 
		{
			...
			(*handler_)(_fn_MPyDataInterface_PrivateGetPtr_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Generic*, maxon::GenericComponent*>::Invoke, (const void*) mt_.MPyDataInterface_PrivateGetPtr_1));
			return proxy_result;
		}
