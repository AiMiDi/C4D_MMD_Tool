...
namespace maxon
{
	...
	namespace py
	{
		...
		maxon::Bool CPythonLibraryInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
		{
			...
			if (maxon::details::NullReturnType<Result<PYSTARTOPERATION>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CPythonLibraryInterface_ParseCommandLine = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_ParseCommandLine;
			#else
			tbl->CPythonLibraryInterface_ParseCommandLine = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_ParseCommandLine;
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CPythonLibraryInterface_GetUrl = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_GetUrl;
			#else
			tbl->CPythonLibraryInterface_GetUrl = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_GetUrl;
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
