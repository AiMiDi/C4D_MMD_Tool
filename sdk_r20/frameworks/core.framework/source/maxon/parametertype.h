...
public:
	...
	explicit ParameterType(const DataType* t = nullptr, FLAGS f = FLAGS::NONE) : _type(t), _typeForData(DataTypeLib::GetDataTypeForData(t) iferr_ignore("TODO")), _flags(f)
	{
	}
