...
//----------------------------------------------------------------------------------------
class FunctionBaseInterface : MAXON_INTERFACE_BASES(Object)
{
...
//----------------------------------------------------------------------------------------
class CombinerInterface : MAXON_INTERFACE_BASES(Object)
{
...
//----------------------------------------------------------------------------------------
class ObservableBaseInterface : MAXON_INTERFACE_BASES(Object)
{
...
//----------------------------------------------------------------------------------------
template <typename DELEGATE> class ObservableRef : public ObservableNotifyRef<typename DELEGATE::Super>
{
public:
