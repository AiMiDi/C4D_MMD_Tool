...
/// The returned Object* can be identical to 'input', in that case no substitution takes place. So e.g. only
...
public:
	...
	static const ValueType TYPE_DATATYPE				= (1 << 14);	///< The described element is a DataType*. Only necessary if RECEIVE_DATATYPE is also used.
...
//----------------------------------------------------------------------------------------
class DataSerializeInterface : MAXON_INTERFACE_BASES(Object)
{
...
public:
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	#define DescribeLegacy(name) descriptionStream.DescribeElement(name, nullptr, 0, nullptr, (maxon::DESCRIBEFLAGS)maxon::DESCRIBEFLAGS::IS_LEGACY_ELEMENT, 0, 0)
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	#define DescribeElse() descriptionStream.DescribeElement(nullptr, nullptr, 0, nullptr, (maxon::DESCRIBEFLAGS)maxon::DESCRIBEFLAGS::CONDITION_ELSE, 0, 0)
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	#define DescribeElseIf(mask, value) descriptionStream.DescribeElement(nullptr, nullptr, 0, nullptr, (maxon::DESCRIBEFLAGS)maxon::DESCRIBEFLAGS::CONDITION_ELSE, mask, value)
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	#define DescribeEndIf() descriptionStream.DescribeElement(nullptr, nullptr, 0, nullptr, (maxon::DESCRIBEFLAGS)maxon::DESCRIBEFLAGS::CONDITION_END, 0, 0)
