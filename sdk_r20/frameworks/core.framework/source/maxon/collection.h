...
/// Block and returns the same block: Either as it is, or casted to a MoveBlock. The latter
...
public:
	...
	public:
		...
		explicit BlockIterator(CollectionType* array) : _array(array), _index(0)
		{
			if (array->GetCount() != 0)
			{
	...
	{
		return BlockIterator<false, false>(static_cast<COLLECTION*>(this));
	}
	...
	{
		return BlockIterator<true, false>(static_cast<const COLLECTION*>(this));
	}

	BlockIterator<false, true> GetStridedBlocks()
	{
		return BlockIterator<false, true>(static_cast<COLLECTION*>(this));
	}

	BlockIterator<true, true> GetStridedBlocks() const
	{
		return BlockIterator<true, true>(static_cast<const COLLECTION*>(this));
	}
};
