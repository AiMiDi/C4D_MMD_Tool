...
template <typename I> struct ReverseIterable
{
	...
	explicit ReverseIterable(I&& it) : iterable(std::forward<I>(it)) { }
	ReverseIterable(ReverseIterable&& src) : iterable(std::forward<I>(src.iterable)) { }
#endif
	I iterable;
...
public:
	...
	{
	public:
		MAXON_ATTRIBUTE_FORCE_INLINE explicit Wrapper(ITERATOR* it) : _it(it) { }

		MAXON_ATTRIBUTE_FORCE_INLINE Bool operator !=(const Wrapper&) const { return (Bool) *_it; }
	...
	static MAXON_ATTRIBUTE_FORCE_INLINE Wrapper end()
	{
