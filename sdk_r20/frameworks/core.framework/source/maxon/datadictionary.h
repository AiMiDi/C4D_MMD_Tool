...
#include "datadictionary2.hxx"
	...
	struct DataDictionaryNatVisHelperFast : public HashMap<UInt64, Data> {};
	struct DataDictionaryNatVisHelperData : public HashMap<Data, Data> {};
	static DataDictionaryNatVisHelperFast g_natvisHelperDataDictionary1;
	static DataDictionaryNatVisHelperData g_natvisHelperDataDictionary2;
#endif
