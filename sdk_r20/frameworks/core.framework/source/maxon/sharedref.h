...
public:
	...
	// workaround for msvc bug. this-> not possible with msvc 2013, test again with msvc 2015
	auto PrivateGetRef() const -> const decltype(_ref)&
	{
		return this->_ref;
	}

	auto PrivateGetRef() -> decltype(_ref)&
	{
		return this->_ref;
	}
#else
