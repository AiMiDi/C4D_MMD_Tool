...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Returns the kind of this member. This allows to tell whether this Member can be safely casted
...
public:
	//----------------------------------------------------------------------------------------
	/// If this Class is a non-virtual interface, return a corresponding NonvirtualInterfaceReference,
	/// otherwise nullptr.
	...
	//----------------------------------------------------------------------------------------
	/// If this Class is a virtual interface, return a corresponding InterfaceReference,
	/// otherwise nullptr.
...
using ProxyHandler = maxon::Delegate<void(const Function*, Object*, const ProxyInvocation&)>;
