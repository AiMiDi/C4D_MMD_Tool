...
#define PRIVATE_MAXON_ENUM_DATATYPE(FRIEND, DECL, E, N, id) \
	DECL(const maxon::DataType*, DT_##N, id); \
...
#define PRIVATE_MAXON_ENUM_TYPE2(FRIEND, DECL, EXTRA, E, id) \
	PRIVATE_MAXON_ENUM_TYPE0(FRIEND, DECL, EXTRA, E, id) \
	FRIEND maxon::Id PrivateGetEnumId(E*); \
	FRIEND void* PrivateDataTypeMarker(E*); \
	template <maxon::Bool> inline FRIEND maxon::ResultOk<const maxon::DataType*> PrivateGetEnumDataType(E*, maxon::OverloadRank1);

#define MAXON_DATATYPE_EARLY_ENUM(E) PRIVATE_MAXON_ENUM_DATATYPE(, MAXON_DECLARATION, E, E, PrivateGetEnumId((E*) nullptr))
#define MAXON_DATATYPE_EARLY_ENUM_CLASS(E, CLS) PRIVATE_MAXON_ENUM_DATATYPE(, MAXON_DECLARATION, CLS::E, CLS##_##E, PrivateGetEnumId((CLS::E*) nullptr))
...
template <typename E> inline constexpr E ConditionalFlag(Bool condition, E value)
{
