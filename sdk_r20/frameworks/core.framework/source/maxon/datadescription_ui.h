...
namespace DESCRIPTION
{
	namespace UI
	{
		namespace BASE
		{
			...
			MAXON_ATTRIBUTE(MAXON_MACROARG_TYPE(BaseArray<Tuple<InternedId, InternedId>>), PRESETMEMBERS, "net.maxon.description.ui.base.presetmembers");
			...
			MAXON_ATTRIBUTE(BaseArray<Id>, ENUM, "net.maxon.description.ui.base.enum");

			/// Internal: 
			/// 0 - not connected
			/// 1 - if the attribute represetns a linked port.
			/// 2 - connected but muted
			MAXON_ATTRIBUTE(Int, ISLINKEDPORT, "net.maxon.description.ui.base.islinkedport");
			...
			MAXON_ATTRIBUTE(BaseArray<Id>, BASELINK_ACCEPT, "net.maxon.description.ui.base.baselink.accept");
			...
			namespace MAXON
			{
				namespace UI
				{
					namespace DATA
					{
						...
						// supports MAXON::DESCRIPTION::UI::BASE::ISLINKEDPORT
					...
					namespace URL
					{
						...
						MAXON_ATTRIBUTE(Bool, TEXTUREHANDLING, "texturehandling");
					}
...
//----------------------------------------------------------------------------------------
class DataDescriptionUIInterface : MAXON_INTERFACE_BASES(Object)
{
