...
struct ConditionVariableInterface::MTable
{
	...
	{
		tbl->_ConditionVariableInterface_Free = &IMPL::_ConditionVariableInterface_Free;
		tbl->_ConditionVariableInterface_Alloc = &IMPL::_ConditionVariableInterface_Alloc;
		tbl->_ConditionVariableInterface_Alloc_1 = &IMPL::_ConditionVariableInterface_Alloc_1;
		tbl->_ConditionVariableInterface_Clear = &IMPL::_ConditionVariableInterface_Clear;
		tbl->_ConditionVariableInterface_AddDependency = &IMPL::_ConditionVariableInterface_AddDependency;
		tbl->_ConditionVariableInterface_Set = &IMPL::_ConditionVariableInterface_Set;
		tbl->_ConditionVariableInterface_Wait = &IMPL::_ConditionVariableInterface_Wait;
		tbl->_ConditionVariableInterface_PrivateAddFinishedObserver = &IMPL::_ConditionVariableInterface_PrivateAddFinishedObserver;
	}
};

template <typename C> class ConditionVariableInterface::Wrapper
{
public:
...
auto ConditionVariableInterface::Reference::Create() -> maxon::ResultMemT<ConditionVariableRef>
{
...
auto ConditionVariableInterface::Reference::Create(Bool isAutoClear) -> maxon::ResultMemT<ConditionVariableRef>
{
	ConditionVariableInterface* res_ = ConditionVariableInterface::Alloc(MAXON_SOURCE_LOCATION, isAutoClear);
	return ConditionVariableRef(maxon::ForwardResultPtr<ConditionVariableInterface>(res_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ConditionVariableInterface::ReferenceFunctionsImpl<S>::Clear(Int32 dependencyCnt) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ConditionVariableInterface* o_ = (ConditionVariableInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	MTable::_instance._ConditionVariableInterface_Clear(o_, dependencyCnt);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ConditionVariableInterface::ReferenceFunctionsImpl<S>::AddDependency() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ConditionVariableInterface* o_ = (ConditionVariableInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	MTable::_instance._ConditionVariableInterface_AddDependency(o_);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ConditionVariableInterface::ReferenceFunctionsImpl<S>::Set() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ConditionVariableInterface* o_ = (ConditionVariableInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(false); 
	return (MTable::_instance._ConditionVariableInterface_Set(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ConditionVariableInterface::ConstReferenceFunctionsImpl<S>::Wait(const TimeValue& timeout, WAITMODE mode) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ConditionVariableInterface* o_ = (const ConditionVariableInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = ConditionVariableInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
	return (MTable::_instance._ConditionVariableInterface_Wait(o_, timeout, mode));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ConditionVariableInterface::ReferenceFunctionsImpl<S>::ObservableFinished() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<ObservableFinishedBase<ConditionVariableInterface>>, ObservableFinishedBase<ConditionVariableInterface>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<ObservableFinishedBase<ConditionVariableInterface>>, ObservableFinishedBase<ConditionVariableInterface>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ConditionVariableInterface* o_ = (ConditionVariableInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateIncompleteNullReturnValue<ObservableFinishedBase<ConditionVariableInterface>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); 
