...
/// @endcond
	...
	class IoBrowseInterface::ProxyComponent : public maxon::Component<IoBrowseInterface::ProxyComponent, IoBrowseInterface>
	{
		MAXON_COMPONENT();
	public:
...
/// @cond INTERNAL
		...
		Result<void> Init(IoConnectionInterface* connection, GETBROWSEITERATORFLAGS flags) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<IoBrowseInterface>();
			...
			(*handler_)(_fn_IoBrowseInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, IoConnectionInterface*, GETBROWSEITERATORFLAGS>::Invoke, (const void*) mt_._IoBrowseInterface_Init));
			return proxy_result;
		}
...
/// @endcond
		...
		const Url& GetBasePath() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_GetBasePath, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Url&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_GetBasePath));
			return *proxy_result;
		}
		...
		Result<void> Reset() 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_Reset, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_Reset));
			return proxy_result;
		}
		...
		Result<void> GetNext() 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_GetNext, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_GetNext));
			return proxy_result;
		}
		...
		Bool HasEntry() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_HasEntry, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_HasEntry));
			return proxy_result;
		}
		...
		Url GetCurrentPath() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_GetCurrentPath, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Url, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_GetCurrentPath));
			return proxy_result;
		}
		...
		IOBROWSEFLAGS IoGetFlags() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_IoGetFlags, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<IOBROWSEFLAGS, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_IoGetFlags));
			return proxy_result;
		}
		...
		Result<IOATTRIBUTES> IoGetAttributes() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_IoGetAttributes, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<IOATTRIBUTES>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_IoGetAttributes));
			return proxy_result;
		}
		...
		Result<UniversalDateTime> IoGetTime(IOTIMEMODE mode) const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_IoGetTime, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<UniversalDateTime>, const maxon::GenericComponent*, IOTIMEMODE>::Invoke, (const void*) mt_._IoBrowseInterface_IoGetTime));
			return proxy_result;
		}
		...
		Int64 GetSize() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_GetSize, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int64, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_GetSize));
			return proxy_result;
		}
		...
		String GetExtraData() const 
		{
			...
			(*handler_)(_fn_IoBrowseInterface_GetExtraData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoBrowseInterface_GetExtraData));
			return proxy_result;
		}
...
/// @endcond
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(IoBrowseInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
/// @cond INTERNAL
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, IoBrowseInterface, _IoBrowseInterface_Init),
/// @endcond
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, IoBrowseInterface, _IoBrowseInterface_IoGetTime),
