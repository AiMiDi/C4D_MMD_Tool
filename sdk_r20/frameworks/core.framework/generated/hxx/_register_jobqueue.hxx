...
/// @endcond
	...
	const maxon::Char* const JobQueueInterface::MTable::_ids = 
		"Free@62fc138e00c811b2\0" // Free(const JobQueueInterface* object)
		"Alloc@49d181f952f4a215\0" // Alloc(const maxon::SourceLocation& allocLocation, JOBQUEUETYPE type, Int threadCnt, JOBQUEUEMODE mode, const Char* name, UInt* ownerId)
		"GetThreadCount@4386c86\0" // GetThreadCount() const
		"GetThreadCount@c84b02c7b8c9da27\0" // GetThreadCount(JobQueueInterface* queue, Int maxWaitSessionLevel)
		"Cancel@5e65c15584e9\0" // Cancel(UInt ownerId)
		"CancelAndWait@5e65c15584e9\0" // CancelAndWait(UInt ownerId)
		"GetDestinationQueue@e73b7a3823e783c5\0" // GetDestinationQueue()
		"SetDestinationQueue@67011626f513a486\0" // SetDestinationQueue(JobQueueInterface* queue)
		"GetMainThreadQueue@e73b7a3823e783c5\0" // GetMainThreadQueue()
		"GetServiceIOQueue@b94734451cdd8ec0\0" // GetServiceIOQueue()
/// @cond IGNORE

		"ExecuteJobs@152dc1ffb7620655\0" // ExecuteJobs(TimeValue timeout)
/// @endcond

	"";
	class JobQueueInterface::Unresolved : public JobQueueInterface
	{
	public:
...
/// @endcond
	...
	#else
		tbl->_JobQueueInterface_Free = &Wrapper<Unresolved>::_JobQueueInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<JobQueueInterface*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_JobQueueInterface_Alloc = &Wrapper<Unresolved>::_JobQueueInterface_Alloc;
	#else
		tbl->_JobQueueInterface_Alloc = &Wrapper<Unresolved>::_JobQueueInterface_Alloc;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_GetThreadCount = &Wrapper<Unresolved>::_JobQueueInterface_GetThreadCount;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_GetThreadCount_1 = &Wrapper<Unresolved>::_JobQueueInterface_GetThreadCount_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_Cancel = &Wrapper<Unresolved>::_JobQueueInterface_Cancel;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_CancelAndWait = &Wrapper<Unresolved>::_JobQueueInterface_CancelAndWait;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_GetDestinationQueue = &Wrapper<Unresolved>::_JobQueueInterface_GetDestinationQueue;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_JobQueueInterface_SetDestinationQueue = &Wrapper<Unresolved>::_JobQueueInterface_SetDestinationQueue;
	#else
		tbl->_JobQueueInterface_SetDestinationQueue = &Wrapper<Unresolved>::_JobQueueInterface_SetDestinationQueue;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_GetMainThreadQueue = &Wrapper<Unresolved>::_JobQueueInterface_GetMainThreadQueue;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_GetServiceIOQueue = &Wrapper<Unresolved>::_JobQueueInterface_GetServiceIOQueue;
	#endif
/// @cond IGNORE

	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_JobQueueInterface_ExecuteJobs = &Wrapper<Unresolved>::_JobQueueInterface_ExecuteJobs;
	#endif
/// @endcond
	...
	template <typename DUMMY> maxon::Int JobQueueInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
...
#endif
static maxon::details::ForceEvaluation s_forceEval_jobqueue(0
	| maxon::JobQueueInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
