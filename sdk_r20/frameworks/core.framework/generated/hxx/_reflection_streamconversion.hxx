...
namespace maxon
{
	...
	class StreamConversionInterface::ProxyComponent : public maxon::Component<StreamConversionInterface::ProxyComponent, StreamConversionInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Int GetBatchSize() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<StreamConversionInterface>();
			Int proxy_result = 0;
			...
			(*handler_)(_fn_StreamConversionInterface_GetBatchSize, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._StreamConversionInterface_GetBatchSize));
			return proxy_result;
		}
		...
		Int GetBlockSize() const 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_GetBlockSize, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._StreamConversionInterface_GetBlockSize));
			return proxy_result;
		}
		...
		Id GetCounterpart() const 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_GetCounterpart, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Id, const maxon::GenericComponent*>::Invoke, (const void*) mt_._StreamConversionInterface_GetCounterpart));
			return proxy_result;
		}
		...
		const DataType* GetSourceType() const 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_GetSourceType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._StreamConversionInterface_GetSourceType));
			return proxy_result;
		}
		...
		const DataType* GetDestinationType() const 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_GetDestinationType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._StreamConversionInterface_GetDestinationType));
			return proxy_result;
		}
		...
		Bool SupportInplaceConversion() const 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_SupportInplaceConversion, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._StreamConversionInterface_SupportInplaceConversion));
			return proxy_result;
		}
		...
		Result<Int> ConvertImpl(const Block<const Generic>& src, WritableArrayInterface<Generic>& dst, Int dstLimitHint, Bool inputFinished, Bool& outputFinished) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertImpl, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const Block<const Generic>&, WritableArrayInterface<Generic>&, Int, Bool, Bool&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertImpl));
			return proxy_result;
		}
		...
		Result<InputStreamRef> ConvertToStream(const InputStreamRef& in) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<InputStreamRef>, maxon::GenericComponent*, const InputStreamRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToStream));
			return proxy_result;
		}
		...
		Result<InputStreamRef> ConvertToStream(const DataFormatBaseReaderRef& in) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToStream_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<InputStreamRef>, maxon::GenericComponent*, const DataFormatBaseReaderRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToStream_1));
			return proxy_result;
		}
		...
		Result<DataFormatBaseReaderRef> ConvertToReader(const InputStreamRef& in) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToReader, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataFormatBaseReaderRef>, maxon::GenericComponent*, const InputStreamRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToReader));
			return proxy_result;
		}
		...
		Result<DataFormatBaseReaderRef> ConvertToReader(const DataFormatBaseReaderRef& in) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToReader_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataFormatBaseReaderRef>, maxon::GenericComponent*, const DataFormatBaseReaderRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToReader_1));
			return proxy_result;
		}
		...
		Result<OutputStreamRef> ConvertToStream(const OutputStreamRef& out) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToStream_2, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<OutputStreamRef>, maxon::GenericComponent*, const OutputStreamRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToStream_2));
			return proxy_result;
		}
		...
		Result<OutputStreamRef> ConvertToStream(const DataFormatBaseWriterRef& out) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToStream_3, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<OutputStreamRef>, maxon::GenericComponent*, const DataFormatBaseWriterRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToStream_3));
			return proxy_result;
		}
		...
		Result<DataFormatBaseWriterRef> ConvertToWriter(const OutputStreamRef& out) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToWriter, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataFormatBaseWriterRef>, maxon::GenericComponent*, const OutputStreamRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToWriter));
			return proxy_result;
		}
		...
		Result<DataFormatBaseWriterRef> ConvertToWriter(const DataFormatBaseWriterRef& out) 
		{
			...
			(*handler_)(_fn_StreamConversionInterface_ConvertToWriter_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataFormatBaseWriterRef>, maxon::GenericComponent*, const DataFormatBaseWriterRef&>::Invoke, (const void*) mt_._StreamConversionInterface_ConvertToWriter_1));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(StreamConversionInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_StreamConversionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 2404LL, StreamConversionInterface, _StreamConversionInterface_ConvertImpl),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToStream),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToStream_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToReader),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToReader_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToStream_2),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToStream_3),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToWriter),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, StreamConversionInterface, _StreamConversionInterface_ConvertToWriter_1),
		};
