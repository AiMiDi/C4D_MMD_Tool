...
/// @cond INTERNAL
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, Init), W, MTable>::type::_IoBrowseInterface_Init;
			_IoBrowseInterface_Init = reinterpret_cast<const decltype(_IoBrowseInterface_Init)&>(ptr);
			_IoBrowseInterface_Init_Offset = offset;
		}
/// @endcond

		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetBasePath))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetBasePath), W, MTable>::type::_IoBrowseInterface_GetBasePath;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, Reset))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, Reset), W, MTable>::type::_IoBrowseInterface_Reset;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetNext))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetNext), W, MTable>::type::_IoBrowseInterface_GetNext;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, HasEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, HasEntry), W, MTable>::type::_IoBrowseInterface_HasEntry;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetCurrentPath))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetCurrentPath), W, MTable>::type::_IoBrowseInterface_GetCurrentPath;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, IoGetFlags))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, IoGetFlags), W, MTable>::type::_IoBrowseInterface_IoGetFlags;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, IoGetAttributes))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, IoGetAttributes), W, MTable>::type::_IoBrowseInterface_IoGetAttributes;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, IoGetTime))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, IoGetTime), W, MTable>::type::_IoBrowseInterface_IoGetTime;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetSize))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetSize), W, MTable>::type::_IoBrowseInterface_GetSize;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetExtraData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoBrowseInterface, GetExtraData), W, MTable>::type::_IoBrowseInterface_GetExtraData;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<IoBrowseInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(IoBrowseInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class IoBrowseInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::COWReferenceFunctionsImpl<S>::Init(IoConnectionInterface* connection, GETBROWSEITERATORFLAGS flags) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::GetBasePath() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Url&>, const Url&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Url&>, const Url&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoBrowseInterface* o_ = (const IoBrowseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoBrowseInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const Url&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_GetBasePath) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ReferenceFunctionsImpl<S>::Reset() const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); IoBrowseInterface* o_ = (IoBrowseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
	return (mt_._IoBrowseInterface_Reset(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoBrowseInterface_Reset_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::COWReferenceFunctionsImpl<S>::Reset() -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); IoBrowseInterface* o_ = (IoBrowseInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
	return (mt_._IoBrowseInterface_Reset(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoBrowseInterface_Reset_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ReferenceFunctionsImpl<S>::GetNext() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::COWReferenceFunctionsImpl<S>::GetNext() -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); IoBrowseInterface* o_ = (IoBrowseInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_GetNext) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
	return (mt_._IoBrowseInterface_GetNext(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoBrowseInterface_GetNext_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::HasEntry() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::GetCurrentPath() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoBrowseInterface* o_ = (const IoBrowseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoBrowseInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Url>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_GetCurrentPath) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::IoGetAttributes() const -> Result<IOATTRIBUTES>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<IOATTRIBUTES>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoBrowseInterface* o_ = (const IoBrowseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoBrowseInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_IoGetAttributes) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::IoGetTime(IOTIMEMODE mode) const -> Result<UniversalDateTime>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<UniversalDateTime>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoBrowseInterface* o_ = (const IoBrowseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoBrowseInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_IoGetTime) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::GetSize() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int64>, Int64>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int64>, Int64>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoBrowseInterface* o_ = (const IoBrowseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoBrowseInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoBrowseInterface, o_, IoBrowseInterface_GetSize) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoBrowseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoBrowseInterface>() : PRIVATE_MAXON_VTABLE(IoBrowseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoBrowseInterface::ConstReferenceFunctionsImpl<S>::GetExtraData() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
