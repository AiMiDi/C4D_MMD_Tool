...
namespace maxon
{
	...
	class DataDescriptionDefinitionInterface::ProxyComponent : public maxon::Component<DataDescriptionDefinitionInterface::ProxyComponent, DataDescriptionDefinitionInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		DataDictionary GetInfo() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<DataDescriptionDefinitionInterface>();
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetInfo, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<DataDictionary, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_GetInfo));
			return proxy_result;
		}
		...
		Result<void> SetInfo(const DataDictionary& info) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_SetInfo, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDictionary&>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_SetInfo));
			return proxy_result;
		}
		...
		Int GetEntryCount() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetEntryCount, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_GetEntryCount));
			return proxy_result;
		}
		...
		Result<BaseArray<DataDescriptionEntry>> GetEntries() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetEntries, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<DataDescriptionEntry>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_GetEntries));
			return proxy_result;
		}
		...
		Result<DataDescriptionEntry> GetEntry(Int idx) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_GetEntry, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataDescriptionEntry>, const maxon::GenericComponent*, Int>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_GetEntry));
			return proxy_result;
		}
		...
		Result<DataDescriptionEntry> FindEntry(const InternedId& id) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_FindEntry, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataDescriptionEntry>, const maxon::GenericComponent*, const InternedId&>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_FindEntry));
			return proxy_result;
		}
		...
		Result<Int> AddEntry(const DataDescriptionEntry& props) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_AddEntry, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const DataDescriptionEntry&>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_AddEntry));
			return proxy_result;
		}
		...
		Result<void> ReplaceEntry(const DataDescriptionEntry& props) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_ReplaceEntry, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDescriptionEntry&>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_ReplaceEntry));
			return proxy_result;
		}
		...
		Result<Bool> ReplaceEntry(Int idx, const DataDescriptionEntry& props) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_ReplaceEntry_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, Int, const DataDescriptionEntry&>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_ReplaceEntry_1));
			return proxy_result;
		}
		...
		Result<void> EraseEntry(Int idx) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionInterface_EraseEntry, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_._DataDescriptionDefinitionInterface_EraseEntry));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DataDescriptionDefinitionInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_DataDescriptionDefinitionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_SetInfo),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_GetEntry),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_FindEntry),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_AddEntry),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_ReplaceEntry),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_ReplaceEntry_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionInterface, _DataDescriptionDefinitionInterface_EraseEntry),
