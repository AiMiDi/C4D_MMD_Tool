...
namespace maxon
{
	...
	class DimensionInterface::ProxyComponent : public maxon::Component<DimensionInterface::ProxyComponent, DimensionInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		const Id& GetId() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<DimensionInterface>();
			...
			(*handler_)(_fn_DimensionInterface_GetId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Id&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DimensionInterface_GetId));
			return *proxy_result;
		}
		...
		Result<Dimension> operator *(const Result<Dimension>& q) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_operatorMul, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Dimension>, const maxon::GenericComponent*, const Result<Dimension>&>::Invoke, (const void*) mt_._DimensionInterface_operatorMul));
			return proxy_result;
		}
		...
		Result<Dimension> operator /(const Result<Dimension>& q) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_operatorDiv, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Dimension>, const maxon::GenericComponent*, const Result<Dimension>&>::Invoke, (const void*) mt_._DimensionInterface_operatorDiv));
			return proxy_result;
		}
		...
		Result<Dimension> operator ^(Int exponent) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_operatorXor, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Dimension>, const maxon::GenericComponent*, Int>::Invoke, (const void*) mt_._DimensionInterface_operatorXor));
			return proxy_result;
		}
		...
		Result<Dimension> Copy(const Id& qid) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_Copy, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Dimension>, const maxon::GenericComponent*, const Id&>::Invoke, (const void*) mt_._DimensionInterface_Copy));
			return proxy_result;
		}
		...
		Int GetExponent(BASE_DIMENSION q) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_GetExponent, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*, BASE_DIMENSION>::Invoke, (const void*) mt_._DimensionInterface_GetExponent));
			return proxy_result;
		}
		...
		Result<Unit> AddUnit(const Id& unitId, Float siConversionFactor) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_AddUnit, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Unit>, const maxon::GenericComponent*, const Id&, Float>::Invoke, (const void*) mt_._DimensionInterface_AddUnit));
			return proxy_result;
		}
		...
		UnitsArray GetUnits() const 
		{
			...
			(*handler_)(_fn_DimensionInterface_GetUnits, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<UnitsArray, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DimensionInterface_GetUnits));
			return proxy_result;
		}
		...
		Bool IsEquivalent(const Dimension& other) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_IsEquivalent, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const Dimension&>::Invoke, (const void*) mt_._DimensionInterface_IsEquivalent));
			return proxy_result;
		}
		...
		String ToString(const FormatStatement* fs) const 
		{
			...
			(*handler_)(_fn_DimensionInterface_ToString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const FormatStatement*>::Invoke, (const void*) mt_._DimensionInterface_ToString));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DimensionInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_DimensionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_operatorMul),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_operatorDiv),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_operatorXor),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_Copy),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_GetExponent),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_AddUnit),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_GetUnits),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_IsEquivalent),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DimensionInterface, _DimensionInterface_ToString),
		};
	...
	static maxon::Result<void> RegisterReflection_UnitInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_operatorMul)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_operatorDiv)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_operatorXor)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_Copy)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_Copy_1)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(UnitInterface::MTable::_instance._UnitInterface_ToString)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
		};
