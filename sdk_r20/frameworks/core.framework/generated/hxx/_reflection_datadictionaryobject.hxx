...
namespace maxon
{
	...
	class DataDictionaryObjectInterface::ProxyComponent : public maxon::Component<DataDictionaryObjectInterface::ProxyComponent, DataDictionaryObjectInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<void> SetData(ForwardingDataPtr&& key, Data&& data) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<DataDictionaryObjectInterface>();
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_SetData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ForwardingDataPtr&&, Data&&>::Invoke, (const void*) mt_._DataDictionaryObjectInterface_SetData));
			return proxy_result;
		}
		...
		Result<Data> GetData(const ConstDataPtr& key) const 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_GetData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_._DataDictionaryObjectInterface_GetData));
			return proxy_result;
		}
		...
		Result<void> EraseData(const ConstDataPtr& key) 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_EraseData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_._DataDictionaryObjectInterface_EraseData));
			return proxy_result;
		}
		...
		Bool IsEmpty() const 
		{
			...
			(*handler_)(_fn_DataDictionaryObjectInterface_IsEmpty, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDictionaryObjectInterface_IsEmpty));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DataDictionaryObjectInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_DataDictionaryObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 52LL, DataDictionaryObjectInterface, _DataDictionaryObjectInterface_SetData),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, DataDictionaryObjectInterface, _DataDictionaryObjectInterface_GetData),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DataDictionaryObjectInterface, _DataDictionaryObjectInterface_EraseData),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DataDictionaryObjectInterface, _DataDictionaryObjectInterface_InitIterator),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class DataDictionaryReferenceObjectInterface::ProxyComponent : public maxon::Component<DataDictionaryReferenceObjectInterface::ProxyComponent, DataDictionaryReferenceObjectInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> Init(DataDictionary* reference) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<DataDictionaryReferenceObjectInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_DataDictionaryReferenceObjectInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, DataDictionary*>::Invoke, (const void*) mt_._DataDictionaryReferenceObjectInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(const DataDictionary* reference) 
		{
			...
			(*handler_)(_fn_DataDictionaryReferenceObjectInterface_Init_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataDictionary*>::Invoke, (const void*) mt_._DataDictionaryReferenceObjectInterface_Init_1));
			return proxy_result;
		}
		...
		const DataDictionary& GetDataContainer() const 
		{
			...
			(*handler_)(_fn_DataDictionaryReferenceObjectInterface_GetDataContainer, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataDictionary&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDictionaryReferenceObjectInterface_GetDataContainer));
			return *proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DataDictionaryReferenceObjectInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_DataDictionaryReferenceObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, DataDictionaryReferenceObjectInterface, _DataDictionaryReferenceObjectInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, DataDictionaryReferenceObjectInterface, _DataDictionaryReferenceObjectInterface_Init_1),
