...
struct DataDictionaryInterface::ReferenceClassHelper { using type = DataDictionary; };

/// Intermediate helper class for DataDictionaryInterface.
template <typename S> class DataDictionaryInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDictionaryInterface::ConstReferenceFunctionsImplDoxy : public DataDictionaryInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for DataDictionaryInterface.
template <typename S> class DataDictionaryInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDictionaryInterface::ReferenceFunctionsImplDoxy : public DataDictionaryInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for DataDictionaryInterface.
template <typename S> class DataDictionaryInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDictionaryInterface::COWReferenceFunctionsImplDoxy : public DataDictionaryInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct DataDictionaryInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class DataDictionaryInterface::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<DataDictionary>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const DataDictionaryInterface, maxon::StrongCOWRefHandler, DataDictionary>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const DataDictionaryInterface, maxon::StrongCOWRefHandler, DataDictionary>>>>);
	using NonConst = NonConstRef;
	static MAXON_ATTRIBUTE_FORCE_INLINE maxon::ResultMemT<DataDictionary> Create();
};

class DataDictionaryInterface::NonConstRef :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDictionaryInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDictionaryInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
};
...
/// @endcode
class DataDictionary : public DataDictionaryInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(DataDictionary, Reference);
};
