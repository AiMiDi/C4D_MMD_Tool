...
namespace maxon
{
	...
	class IoPipeInOutputStreamInterface::ProxyComponent : public maxon::Component<IoPipeInOutputStreamInterface::ProxyComponent, IoPipeInOutputStreamInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		PIPEHANDLE GetReadHandle() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<IoPipeInOutputStreamInterface>();
			...
			(*handler_)(_fn_IoPipeInOutputStreamInterface_GetReadHandle, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<PIPEHANDLE, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoPipeInOutputStreamInterface_GetReadHandle));
			return proxy_result;
		}
		...
		PIPEHANDLE GetWriteHandle() const 
		{
			...
			(*handler_)(_fn_IoPipeInOutputStreamInterface_GetWriteHandle, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<PIPEHANDLE, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoPipeInOutputStreamInterface_GetWriteHandle));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(IoPipeInOutputStreamInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
