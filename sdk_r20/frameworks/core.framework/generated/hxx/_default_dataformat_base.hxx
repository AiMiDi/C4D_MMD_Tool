...
class MyDataFormatBaseReaderImpl : public Component<MyDataFormatBaseReaderImpl, DataFormatBaseReaderInterface>
{
	MAXON_COMPONENT();
...
class MyDataFormatBaseWriterImpl : public Component<MyDataFormatBaseWriterImpl, DataFormatBaseWriterInterface>
{
	MAXON_COMPONENT();
