...
#ifdef DOXYGEN
template <typename REF> class IoDualInOutputStreamInterface::ConstReferenceFunctionsImplDoxy : public IoDualInOutputStreamInterface::ConstReferenceFunctionsImpl<REF>, public InOutputStreamInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for IoDualInOutputStreamInterface.
template <typename S> class IoDualInOutputStreamInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoDualInOutputStreamInterface::ReferenceFunctionsImplDoxy : public IoDualInOutputStreamInterface::ReferenceFunctionsImpl<REF>, public InOutputStreamInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for IoDualInOutputStreamInterface.
template <typename S> class IoDualInOutputStreamInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoDualInOutputStreamInterface::COWReferenceFunctionsImplDoxy : public IoDualInOutputStreamInterface::COWReferenceFunctionsImpl<REF>, public InOutputStreamInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct IoDualInOutputStreamInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename InOutputStreamInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename InOutputStreamInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename InOutputStreamInterface::ReferenceFunctions<ST>::type>>::type>::type; };
class IoDualInOutputStreamInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<IoDualInOutputStreamRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoDualInOutputStreamInterface, maxon::StrongRefHandler, IoDualInOutputStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoDualInOutputStreamInterface, maxon::StrongRefHandler, IoDualInOutputStreamRef>>>>);
...
class IoDualInOutputStreamRef : public IoDualInOutputStreamInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(IoDualInOutputStreamRef, Reference);
};
