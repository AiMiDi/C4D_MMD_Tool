...
struct DataDescriptionUIInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataDescriptionUIInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(DataDescriptionUIInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class DataDescriptionUI;

struct DataDescriptionUIInterface::ReferenceClassHelper { using type = DataDescriptionUI; };

/// Intermediate helper class for DataDescriptionUIInterface.
template <typename S> class DataDescriptionUIInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionUIInterface::ConstReferenceFunctionsImplDoxy : public DataDescriptionUIInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for DataDescriptionUIInterface.
template <typename S> class DataDescriptionUIInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionUIInterface::ReferenceFunctionsImplDoxy : public DataDescriptionUIInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for DataDescriptionUIInterface.
template <typename S> class DataDescriptionUIInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionUIInterface::COWReferenceFunctionsImplDoxy : public DataDescriptionUIInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct DataDescriptionUIInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class DataDescriptionUIInterface::Reference :
#ifdef DOXYGEN
public ConstReferenceFunctionsImplDoxy<DataDescriptionUI>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const DataDescriptionUIInterface, maxon::StrongRefHandler, DataDescriptionUI>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const DataDescriptionUIInterface, maxon::StrongRefHandler, DataDescriptionUI>>>>);
	using NonConst = NonConstRef;
};

class DataDescriptionUIInterface::NonConstRef :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDescriptionUIInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDescriptionUIInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class DataDescriptionUI : public DataDescriptionUIInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(DataDescriptionUI, Reference);
};
