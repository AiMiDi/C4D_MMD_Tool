...
namespace maxon
{
	...
	class IoErrorInterface::ProxyComponent : public maxon::Component<IoErrorInterface::ProxyComponent, IoErrorInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		void SetUrl(const Url& url) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<IoErrorInterface>();
		...
		const Url& GetUrl() const 
		{
			...
			(*handler_)(_fn_IoErrorInterface_GetUrl, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Url&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoErrorInterface_GetUrl));
			return *proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(IoErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_IoErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoErrorInterface, _IoErrorInterface_SetUrl),
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class FileFormatErrorInterface::ProxyComponent : public maxon::Component<FileFormatErrorInterface::ProxyComponent, FileFormatErrorInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(FileFormatErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class UnknownFileSizeErrorInterface::ProxyComponent : public maxon::Component<UnknownFileSizeErrorInterface::ProxyComponent, UnknownFileSizeErrorInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(UnknownFileSizeErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class BaseStreamInterface::ProxyComponent : public maxon::Component<BaseStreamInterface::ProxyComponent, BaseStreamInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<Int64> GetStreamLength() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<BaseStreamInterface>();
			...
			(*handler_)(_fn_BaseStreamInterface_GetStreamLength, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int64>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BaseStreamInterface_GetStreamLength));
			return proxy_result;
		}
		...
		Result<Int64> GetPosition() const 
		{
			...
			(*handler_)(_fn_BaseStreamInterface_GetPosition, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int64>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BaseStreamInterface_GetPosition));
			return proxy_result;
		}
		...
		Result<void> Close() 
		{
			...
			(*handler_)(_fn_BaseStreamInterface_Close, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._BaseStreamInterface_Close));
			return proxy_result;
		}
		...
		Bool SeekSupported() const 
		{
			...
			(*handler_)(_fn_BaseStreamInterface_SeekSupported, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BaseStreamInterface_SeekSupported));
			return proxy_result;
		}
		...
		Result<void> Seek(Int64 position) 
		{
			...
			(*handler_)(_fn_BaseStreamInterface_Seek, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int64>::Invoke, (const void*) mt_._BaseStreamInterface_Seek));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(BaseStreamInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_BaseStreamInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, BaseStreamInterface, _BaseStreamInterface_Seek),
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class InputStreamInterface::ProxyComponent : public maxon::Component<InputStreamInterface::ProxyComponent, InputStreamInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<Int64> BytesAvailable() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<InputStreamInterface>();
			Result<Int64> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_InputStreamInterface_BytesAvailable, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int64>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._InputStreamInterface_BytesAvailable));
			return proxy_result;
		}
		...
		Result<Int> ReadEOS(const Block<Byte>& data) 
		{
			...
			(*handler_)(_fn_InputStreamInterface_ReadEOS, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const Block<Byte>&>::Invoke, (const void*) mt_._InputStreamInterface_ReadEOS));
			return proxy_result;
		}
		...
		Result<void> Skip(Int64 bytes) 
		{
			...
			(*handler_)(_fn_InputStreamInterface_Skip, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int64>::Invoke, (const void*) mt_._InputStreamInterface_Skip));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(InputStreamInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_InputStreamInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 8LL, InputStreamInterface, _InputStreamInterface_ReadEOS),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, InputStreamInterface, _InputStreamInterface_Skip),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class OutputStreamInterface::ProxyComponent : public maxon::Component<OutputStreamInterface::ProxyComponent, OutputStreamInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> Write(const Block<const Byte>& data) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<OutputStreamInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_OutputStreamInterface_Write, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Block<const Byte>&>::Invoke, (const void*) mt_._OutputStreamInterface_Write));
			return proxy_result;
		}
		...
		Result<void> Flush() 
		{
			...
			(*handler_)(_fn_OutputStreamInterface_Flush, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._OutputStreamInterface_Flush));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(OutputStreamInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_OutputStreamInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, OutputStreamInterface, _OutputStreamInterface_Write),
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class InOutputStreamInterface::ProxyComponent : public maxon::Component<InOutputStreamInterface::ProxyComponent, InOutputStreamInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(InOutputStreamInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
