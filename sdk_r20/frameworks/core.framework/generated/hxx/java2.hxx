...
struct Java::MTable
{
	...
	{
		tbl->_Java_GetMainThreadJavaEnv = &IMPL::_Java_GetMainThreadJavaEnv;
		tbl->_Java_GetJavaEnv = &IMPL::_Java_GetJavaEnv;
		tbl->_Java_GetJavaVM = &IMPL::_Java_GetJavaVM;
		tbl->_Java_GetNativeActivityObject = &IMPL::_Java_GetNativeActivityObject;
		tbl->_Java_GetAssetManager = &IMPL::_Java_GetAssetManager;
		tbl->_Java_AllcoObject = &IMPL::_Java_AllcoObject;
		tbl->_Java_MakeGlobalRef = &IMPL::_Java_MakeGlobalRef;
		tbl->_Java_DeleteGlobalRef = &IMPL::_Java_DeleteGlobalRef;
		tbl->_Java_GetFieldID = &IMPL::_Java_GetFieldID;
		tbl->_Java_GetLongField = &IMPL::_Java_GetLongField;
		tbl->_Java_SetLongField = &IMPL::_Java_SetLongField;
		tbl->_Java_ConvertString = &IMPL::_Java_ConvertString;
		tbl->_Java_ConvertString_1 = &IMPL::_Java_ConvertString_1;
		tbl->_Java_IntGetStaticObjectField = &IMPL::_Java_IntGetStaticObjectField;
		tbl->_Java_IntCallStaticMethodObject = &IMPL::_Java_IntCallStaticMethodObject;
		tbl->_Java_IntCallStaticMethodVoid = &IMPL::_Java_IntCallStaticMethodVoid;
		tbl->_Java_IntCallStaticMethodLong = &IMPL::_Java_IntCallStaticMethodLong;
		tbl->_Java_IntCallMethodObject = &IMPL::_Java_IntCallMethodObject;
		tbl->_Java_IntCallMethodLong = &IMPL::_Java_IntCallMethodLong;
	}
};

template <typename C> class Java::Wrapper
{
public:
