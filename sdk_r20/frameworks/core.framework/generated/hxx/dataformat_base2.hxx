...
struct DataFormatBaseReaderInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseReaderInterface, CloseInput))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseReaderInterface, CloseInput), W, MTable>::type::_DataFormatBaseReaderInterface_CloseInput;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseReaderInterface, ReadDataEOS))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseReaderInterface, ReadDataEOS), W, MTable>::type::_DataFormatBaseReaderInterface_ReadDataEOS;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DataFormatBaseReaderInterface, DataDictionaryObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DataFormatBaseReaderInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class DataFormatBaseReaderInterface::Wrapper : public DataDictionaryObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseReaderInterface::COWReferenceFunctionsImpl<S>::CloseInput() -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataFormatBaseReaderInterface* o_ = (DataFormatBaseReaderInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataFormatBaseReaderInterface, o_, DataFormatBaseReaderInterface_CloseInput) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataFormatBaseReaderInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataFormatBaseReaderInterface>() : PRIVATE_MAXON_VTABLE(DataFormatBaseReaderInterface, o_); 
	return (mt_._DataFormatBaseReaderInterface_CloseInput(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DataFormatBaseReaderInterface_CloseInput_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseReaderInterface::ReferenceFunctionsImpl<S>::ReadData(void* data, Int dataSize, Int elementCount) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataFormatBaseReaderInterface* o_ = (DataFormatBaseReaderInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (o_->ReadData(data, dataSize, elementCount));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseReaderInterface::COWReferenceFunctionsImpl<S>::ReadData(void* data, Int dataSize, Int elementCount) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseReaderInterface::ReferenceFunctionsImpl<S>::ReadDataEOS(void* data, Int dataSize, Int elementCount) const -> Result<Int>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Int>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataFormatBaseReaderInterface* o_ = (DataFormatBaseReaderInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataFormatBaseReaderInterface, o_, DataFormatBaseReaderInterface_ReadDataEOS) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataFormatBaseReaderInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataFormatBaseReaderInterface>() : PRIVATE_MAXON_VTABLE(DataFormatBaseReaderInterface, o_); 
...
struct DataFormatBaseWriterInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseWriterInterface, CloseOutput))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseWriterInterface, CloseOutput), W, MTable>::type::_DataFormatBaseWriterInterface_CloseOutput;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseWriterInterface, WriteData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseWriterInterface, WriteData), W, MTable>::type::_DataFormatBaseWriterInterface_WriteData;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseWriterInterface, Flush))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataFormatBaseWriterInterface, Flush), W, MTable>::type::_DataFormatBaseWriterInterface_Flush;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DataFormatBaseWriterInterface, DataDictionaryObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DataFormatBaseWriterInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class DataFormatBaseWriterInterface::Wrapper : public DataDictionaryObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::COWReferenceFunctionsImpl<S>::CloseOutput() -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::ReferenceFunctionsImpl<S>::WriteData(const void* data, Int dataSize, Int elementCount) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::COWReferenceFunctionsImpl<S>::WriteData(const void* data, Int dataSize, Int elementCount) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::ReferenceFunctionsImpl<S>::Flush() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::COWReferenceFunctionsImpl<S>::Flush() -> Result<void>
{
...
template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::ReferenceFunctionsImpl<S>::Write(const Block<const T>& data) const -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, true, maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataFormatBaseWriterInterface* o_ = (DataFormatBaseWriterInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR)); 
	auto res_ = o_->Write<T>(data);
	return ReturnHelper::Return(this, res_.GetErrorStorage());
}
template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto DataFormatBaseWriterInterface::COWReferenceFunctionsImpl<S>::Write(const Block<const T>& data) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
