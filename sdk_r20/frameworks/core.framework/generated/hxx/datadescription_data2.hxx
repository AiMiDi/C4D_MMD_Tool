...
namespace DESCRIPTION
{
	...
	namespace DATA
	{
		...
		namespace INFO
		{
			...
			struct SUBCLASSIFICATION_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xa4538435d3d49d7cLL), maxon::UInt(49))> { };
