...
namespace maxon
{
	...
	class FileFormatInterface::ProxyComponent : public maxon::Component<FileFormatInterface::ProxyComponent, FileFormatInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<Bool> Detect(const Url& url, const InputStreamRef& probeStream) const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<FileFormatInterface>();
			...
			(*handler_)(_fn_FileFormatInterface_Detect, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, const maxon::GenericComponent*, const Url&, const InputStreamRef&>::Invoke, (const void*) mt_._FileFormatInterface_Detect));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(FileFormatInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_FileFormatInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 20LL, FileFormatInterface, _FileFormatInterface_Detect),
		};
