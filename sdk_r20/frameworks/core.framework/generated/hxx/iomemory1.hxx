...
struct IoMemoryInterface::ReferenceClassHelper { using type = IoMemoryRef; };

/// Intermediate helper class for IoMemoryInterface.
template <typename S> class IoMemoryInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoMemoryInterface::ConstReferenceFunctionsImplDoxy : public IoMemoryInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for IoMemoryInterface.
template <typename S> class IoMemoryInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoMemoryInterface::ReferenceFunctionsImplDoxy : public IoMemoryInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for IoMemoryInterface.
template <typename S> class IoMemoryInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoMemoryInterface::COWReferenceFunctionsImplDoxy : public IoMemoryInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct IoMemoryInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class IoMemoryInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<IoMemoryRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoMemoryInterface, maxon::StrongRefHandler, IoMemoryRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoMemoryInterface, maxon::StrongRefHandler, IoMemoryRef>>>>);
...
/// 	}) iferr_return;
/// @endcode
class IoMemoryRef : public IoMemoryInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(IoMemoryRef, Reference);
};
