...
struct DllInterface::ReferenceClassHelper { using type = DllRef; };

/// Intermediate helper class for DllInterface.
template <typename S> class DllInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DllInterface::ConstReferenceFunctionsImplDoxy : public DllInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for DllInterface.
template <typename S> class DllInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DllInterface::ReferenceFunctionsImplDoxy : public DllInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for DllInterface.
template <typename S> class DllInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DllInterface::COWReferenceFunctionsImplDoxy : public DllInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct DllInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class DllInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<DllRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DllInterface, maxon::StrongRefHandler, DllRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DllInterface, maxon::StrongRefHandler, DllRef>>>>);
...
class DllRef : public DllInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(DllRef, Reference);
};
