...
struct DataDescriptionDefinitionDatabaseImplInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, Contains))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, Contains), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_Contains;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, LoadDescription))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, LoadDescription), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_LoadDescription;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, StoreDescription))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, StoreDescription), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_StoreDescription;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, DeleteDescription))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, DeleteDescription), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_DeleteDescription;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, GetRegisteredDescriptions))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, GetRegisteredDescriptions), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredDescriptions;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, GetRegisteredLanguages))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, GetRegisteredLanguages), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredLanguages;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, WriteDataBases))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, WriteDataBases), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_WriteDataBases;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, RenameId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, RenameId), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_RenameId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, RenameAttribute))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, RenameAttribute), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_RenameAttribute;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, CheckUniqueAttributeName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, CheckUniqueAttributeName), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_CheckUniqueAttributeName;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, UpdateDescriptions))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, UpdateDescriptions), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_UpdateDescriptions;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, IsWritableDatabase))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, IsWritableDatabase), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_IsWritableDatabase;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, GetChangeCount))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, GetChangeCount), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, Write))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionDatabaseImplInterface, Write), W, MTable>::type::_DataDescriptionDefinitionDatabaseImplInterface_Write;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DataDescriptionDefinitionDatabaseImplInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DataDescriptionDefinitionDatabaseImplInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class DataDescriptionDefinitionDatabaseImplInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::Contains(const Id& category, const IdAndVersion& dataType, const LanguageRef& language) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionDatabaseImplInterface* o_ = (const DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionDatabaseImplInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_Contains) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImpl<S>::StoreDescription(const Id& databaseId, const Id& category, const LanguageRef& language, const IdAndVersion& dataType, const DataDescriptionDefinition& description, const DataDescriptionDefinition& overwrittenDescription, Bool usePendingSystem) const -> Result<Tuple<Bool, DataDescriptionDefinition*>>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Tuple<Bool, DataDescriptionDefinition*>>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionDatabaseImplInterface* o_ = (DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_StoreDescription) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImpl<S>::StoreDescription(const Id& databaseId, const Id& category, const LanguageRef& language, const IdAndVersion& dataType, const DataDescriptionDefinition& description, const DataDescriptionDefinition& overwrittenDescription, Bool usePendingSystem) -> Result<Tuple<Bool, DataDescriptionDefinition*>>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Tuple<Bool, DataDescriptionDefinition*>>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionDatabaseImplInterface* o_ = (DataDescriptionDefinitionDatabaseImplInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_StoreDescription) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
	return (mt_._DataDescriptionDefinitionDatabaseImplInterface_StoreDescription(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DataDescriptionDefinitionDatabaseImplInterface_StoreDescription_Offset, databaseId, category, language, dataType, description, overwrittenDescription, usePendingSystem));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImpl<S>::DeleteDescription(const Id& category, const LanguageRef& language, const IdAndVersion& dataType) const -> Result<Bool>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Bool>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionDatabaseImplInterface* o_ = (DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_DeleteDescription) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImpl<S>::DeleteDescription(const Id& category, const LanguageRef& language, const IdAndVersion& dataType) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::GetRegisteredDescriptions(const Id& category, const LanguageRef& language) const -> Result<BaseArray<IdAndVersion>>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BaseArray<IdAndVersion>>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionDatabaseImplInterface* o_ = (const DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionDatabaseImplInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredDescriptions) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::WriteDataBases() const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionDatabaseImplInterface* o_ = (const DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionDatabaseImplInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_WriteDataBases) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImpl<S>::RenameId(const Id& oldId, const Id& newId) const -> Result<Int>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Int>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionDatabaseImplInterface* o_ = (DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_RenameId) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImpl<S>::RenameId(const Id& oldId, const Id& newId) -> Result<Int>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Int>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionDatabaseImplInterface* o_ = (DataDescriptionDefinitionDatabaseImplInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_RenameId) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
	return (mt_._DataDescriptionDefinitionDatabaseImplInterface_RenameId(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DataDescriptionDefinitionDatabaseImplInterface_RenameId_Offset, oldId, newId));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImpl<S>::RenameAttribute(const InternedId& oldId, const InternedId& newId) const -> Result<Int>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImpl<S>::RenameAttribute(const InternedId& oldId, const InternedId& newId) -> Result<Int>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::CheckUniqueAttributeName(const InternedId& searchId) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::UpdateDescriptions(const Id& category, const IdAndVersion& dataTypeId, const LanguageRef& language) const -> Result<DataDescription>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<DataDescription>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionDatabaseImplInterface* o_ = (const DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionDatabaseImplInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_UpdateDescriptions) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::IsWritableDatabase(const Id& languageId) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionDatabaseImplInterface* o_ = (const DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionDatabaseImplInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_IsWritableDatabase) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::GetChangeCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionDatabaseImplInterface* o_ = (const DataDescriptionDefinitionDatabaseImplInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionDatabaseImplInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_, DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionDatabaseImplInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionDatabaseImplInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionDatabaseImplInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<S>::Write() const -> Result<void>
{
