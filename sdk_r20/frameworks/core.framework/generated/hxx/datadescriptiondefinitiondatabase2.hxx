...
struct DataDescriptionDefinitionDatabaseInterface::MTable
{
	...
	{
		tbl->_DataDescriptionDefinitionDatabaseInterface_LoadDescription = &IMPL::_DataDescriptionDefinitionDatabaseInterface_LoadDescription;
		tbl->_DataDescriptionDefinitionDatabaseInterface_StoreDescription = &IMPL::_DataDescriptionDefinitionDatabaseInterface_StoreDescription;
		tbl->_DataDescriptionDefinitionDatabaseInterface_DeleteDescription = &IMPL::_DataDescriptionDefinitionDatabaseInterface_DeleteDescription;
		tbl->_DataDescriptionDefinitionDatabaseInterface_GetRegisteredDescriptions = &IMPL::_DataDescriptionDefinitionDatabaseInterface_GetRegisteredDescriptions;
		tbl->_DataDescriptionDefinitionDatabaseInterface_WriteDataBases = &IMPL::_DataDescriptionDefinitionDatabaseInterface_WriteDataBases;
		tbl->_DataDescriptionDefinitionDatabaseInterface_QueryNeedsWriteDataBases = &IMPL::_DataDescriptionDefinitionDatabaseInterface_QueryNeedsWriteDataBases;
		tbl->_DataDescriptionDefinitionDatabaseInterface_RenameId = &IMPL::_DataDescriptionDefinitionDatabaseInterface_RenameId;
		tbl->_DataDescriptionDefinitionDatabaseInterface_RenameAttribute = &IMPL::_DataDescriptionDefinitionDatabaseInterface_RenameAttribute;
		tbl->_DataDescriptionDefinitionDatabaseInterface_CheckUniqueAttributeName = &IMPL::_DataDescriptionDefinitionDatabaseInterface_CheckUniqueAttributeName;
		tbl->_DataDescriptionDefinitionDatabaseInterface_UpdateDescription = &IMPL::_DataDescriptionDefinitionDatabaseInterface_UpdateDescription;
		tbl->_DataDescriptionDefinitionDatabaseInterface_UpdateDescriptionI = &IMPL::_DataDescriptionDefinitionDatabaseInterface_UpdateDescriptionI;
		tbl->_DataDescriptionDefinitionDatabaseInterface_RegisterDatabaseWithUrl = &IMPL::_DataDescriptionDefinitionDatabaseInterface_RegisterDatabaseWithUrl;
		tbl->_DataDescriptionDefinitionDatabaseInterface_RegisterDatabase = &IMPL::_DataDescriptionDefinitionDatabaseInterface_RegisterDatabase;
		tbl->_DataDescriptionDefinitionDatabaseInterface_UnregisterDatabase = &IMPL::_DataDescriptionDefinitionDatabaseInterface_UnregisterDatabase;
		tbl->_DataDescriptionDefinitionDatabaseInterface_IsWritableDatabase = &IMPL::_DataDescriptionDefinitionDatabaseInterface_IsWritableDatabase;
		tbl->_DataDescriptionDefinitionDatabaseInterface_GetRegisteredDatabases = &IMPL::_DataDescriptionDefinitionDatabaseInterface_GetRegisteredDatabases;
		tbl->_DataDescriptionDefinitionDatabaseInterface_BuildDescription = &IMPL::_DataDescriptionDefinitionDatabaseInterface_BuildDescription;
		tbl->_DataDescriptionDefinitionDatabaseInterface_RegisterMessage = &IMPL::_DataDescriptionDefinitionDatabaseInterface_RegisterMessage;
		tbl->_DataDescriptionDefinitionDatabaseInterface_FindNodeMessage = &IMPL::_DataDescriptionDefinitionDatabaseInterface_FindNodeMessage;
		tbl->_DataDescriptionDefinitionDatabaseInterface_ObservableSaveDatabase = &IMPL::_DataDescriptionDefinitionDatabaseInterface_ObservableSaveDatabase;
		tbl->_DataDescriptionDefinitionDatabaseInterface_ObservableDatabaseRegistrationChange = &IMPL::_DataDescriptionDefinitionDatabaseInterface_ObservableDatabaseRegistrationChange;
	}
};

template <typename C> class DataDescriptionDefinitionDatabaseInterface::Wrapper
{
public:
