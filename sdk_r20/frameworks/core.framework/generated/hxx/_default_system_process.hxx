...
class MySystemProcessKilledErrorImpl : public Component<MySystemProcessKilledErrorImpl, SystemProcessKilledErrorInterface>
{
	MAXON_COMPONENT();
...
class MySystemProcessOperationErrorImpl : public Component<MySystemProcessOperationErrorImpl, SystemProcessOperationErrorInterface>
{
	MAXON_COMPONENT();
...
class MySystemProcessObjectImpl : public Component<MySystemProcessObjectImpl, SystemProcessObjectInterface>
{
	MAXON_COMPONENT();
