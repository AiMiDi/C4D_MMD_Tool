...
struct ResolveInterface::MTable
{
	...
	{
		tbl->_ResolveInterface_Free = &IMPL::_ResolveInterface_Free;
		tbl->_ResolveInterface_RemoveDotSegments = &IMPL::_ResolveInterface_RemoveDotSegments;
	}
};

template <typename C> class ResolveInterface::Wrapper
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ResolveInterface::ConstReferenceFunctionsImpl<S>::RemoveDotSegments(const Url& url) -> Result<Url> { return (MTable::_instance._ResolveInterface_RemoveDotSegments(url)); }
...
struct IoConnectionInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, GetUrl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, GetUrl), W, MTable>::type::_IoConnectionInterface_GetUrl;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, GetBrowseIterator))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, GetBrowseIterator), W, MTable>::type::_IoConnectionInterface_GetBrowseIterator;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, OpenInputStream))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, OpenInputStream), W, MTable>::type::_IoConnectionInterface_OpenInputStream;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, OpenOutputStream))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, OpenOutputStream), W, MTable>::type::_IoConnectionInterface_OpenOutputStream;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, OpenInOutputStream))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, OpenInOutputStream), W, MTable>::type::_IoConnectionInterface_OpenInOutputStream;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, GetContentLength))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, GetContentLength), W, MTable>::type::_IoConnectionInterface_GetContentLength;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoDetect))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoDetect), W, MTable>::type::_IoConnectionInterface_IoDetect;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoGetAttributes))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoGetAttributes), W, MTable>::type::_IoConnectionInterface_IoGetAttributes;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoSetAttributes))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoSetAttributes), W, MTable>::type::_IoConnectionInterface_IoSetAttributes;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoGetTime))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoGetTime), W, MTable>::type::_IoConnectionInterface_IoGetTime;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoSetTime))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoSetTime), W, MTable>::type::_IoConnectionInterface_IoSetTime;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoDelete))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoDelete), W, MTable>::type::_IoConnectionInterface_IoDelete;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoCreateDirectory))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoCreateDirectory), W, MTable>::type::_IoConnectionInterface_IoCreateDirectory;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoCopyFile))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoCopyFile), W, MTable>::type::_IoConnectionInterface_IoCopyFile;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoMove))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoMove), W, MTable>::type::_IoConnectionInterface_IoMove;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoRename))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoRename), W, MTable>::type::_IoConnectionInterface_IoRename;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoGetFreeVolumeSpace))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoGetFreeVolumeSpace), W, MTable>::type::_IoConnectionInterface_IoGetFreeVolumeSpace;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoShowInOS))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoConnectionInterface, IoShowInOS), W, MTable>::type::_IoConnectionInterface_IoShowInOS;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<IoConnectionInterface, DataDictionaryObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(IoConnectionInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class IoConnectionInterface::Wrapper : public DataDictionaryObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ConstReferenceFunctionsImpl<S>::GetUrl() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Url&>, const Url&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Url&>, const Url&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoConnectionInterface* o_ = (const IoConnectionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoConnectionInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const Url&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_GetUrl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::OpenInputStream(OPENSTREAMFLAGS flags) -> Result<InputStreamRef>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::GetContentLength() -> Result<Int64>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Int64>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); IoConnectionInterface* o_ = (IoConnectionInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_GetContentLength) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
	return (mt_._IoConnectionInterface_GetContentLength(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoConnectionInterface_GetContentLength_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ConstReferenceFunctionsImpl<S>::IoDetect() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<IODETECT>, IODETECT>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<IODETECT>, IODETECT>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoConnectionInterface* o_ = (const IoConnectionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoConnectionInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<IODETECT>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_IoDetect) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ConstReferenceFunctionsImpl<S>::IoGetAttributes() const -> Result<IOATTRIBUTES>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<IOATTRIBUTES>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoConnectionInterface* o_ = (const IoConnectionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoConnectionInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_IoGetAttributes) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoSetAttributes(IOATTRIBUTES flags, IOATTRIBUTES mask) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); IoConnectionInterface* o_ = (IoConnectionInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_IoSetAttributes) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoSetAttributes(IOATTRIBUTES flags, IOATTRIBUTES mask) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); IoConnectionInterface* o_ = (IoConnectionInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_IoSetAttributes) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
	return (mt_._IoConnectionInterface_IoSetAttributes(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoConnectionInterface_IoSetAttributes_Offset, flags, mask));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ConstReferenceFunctionsImpl<S>::IoGetTime(IOTIMEMODE mode) const -> Result<UniversalDateTime>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<UniversalDateTime>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoConnectionInterface* o_ = (const IoConnectionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoConnectionInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_IoGetTime) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoSetTime(IOTIMEMODE mode, const UniversalDateTime& dateTime) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoSetTime(IOTIMEMODE mode, const UniversalDateTime& dateTime) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoDelete(Bool force) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoDelete(Bool force) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoCreateDirectory(Bool createParents, BaseArray<Url>* createdDirs) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoCreateDirectory(Bool createParents, BaseArray<Url>* createdDirs) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoCopyFile(const Url& destName, Bool overwrite, Bool removeReadOnly) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoCopyFile(const Url& destName, Bool overwrite, Bool removeReadOnly) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoMove(const Url& destName) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoMove(const Url& destName) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ReferenceFunctionsImpl<S>::IoRename(const Url& newName) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::COWReferenceFunctionsImpl<S>::IoRename(const Url& newName) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ConstReferenceFunctionsImpl<S>::IoGetFreeVolumeSpace(Int64& availableBytes, Int64& totalBytes) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoConnectionInterface* o_ = (const IoConnectionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoConnectionInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoConnectionInterface, o_, IoConnectionInterface_IoGetFreeVolumeSpace) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoConnectionInterface>() : PRIVATE_MAXON_VTABLE(IoConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ConstReferenceFunctionsImpl<S>::IoShowInOS(IOSHOWINOSFLAGS flags) const -> Result<void>
{
