...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_LanguageInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LanguageInterface::MTable::_instance._LanguageInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LanguageInterface::MTable::_instance._LanguageInterface_Alloc)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LanguageInterface::MTable::_instance._LanguageInterface_LoadResourceString)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, 20LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(LanguageInterface::MTable::_instance._LanguageInterface_ToString)>::type>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, 0LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_Resource(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Resource::MTable::_instance._Resource_FindLanguage)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Resource::MTable::_instance._Resource_SetCurrentLanguage)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Resource::MTable::_instance._Resource_LoadResourceString)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 5LL, nullptr),
