...
namespace maxon
{
	...
	class ReadArchiveInterface::ProxyComponent : public maxon::Component<ReadArchiveInterface::ProxyComponent, ReadArchiveInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<void> Open(const Url& inputFile, const String& password) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<ReadArchiveInterface>();
			...
			(*handler_)(_fn_ReadArchiveInterface_Open, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, const String&>::Invoke, (const void*) mt_._ReadArchiveInterface_Open));
			return proxy_result;
		}
		...
		Result<void> Close() 
		{
			...
			(*handler_)(_fn_ReadArchiveInterface_Close, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._ReadArchiveInterface_Close));
			return proxy_result;
		}
		...
		Result<Url> ExtractSingleFile(const String& archiveFile, const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) 
		{
			...
			(*handler_)(_fn_ReadArchiveInterface_ExtractSingleFile, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Url>, maxon::GenericComponent*, const String&, const Url&, ThreadRef, IOARCHIVEEXTRACTFLAGS, const ExtractCallback&>::Invoke, (const void*) mt_._ReadArchiveInterface_ExtractSingleFile));
			return proxy_result;
		}
		...
		Result<void> Extract(const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) 
		{
			...
			(*handler_)(_fn_ReadArchiveInterface_Extract, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, ThreadRef, IOARCHIVEEXTRACTFLAGS, const ExtractCallback&>::Invoke, (const void*) mt_._ReadArchiveInterface_Extract));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ReadArchiveInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_ReadArchiveInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, ReadArchiveInterface, _ReadArchiveInterface_Open),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, ReadArchiveInterface, _ReadArchiveInterface_Close),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 1364LL, ReadArchiveInterface, _ReadArchiveInterface_ExtractSingleFile),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 340LL, ReadArchiveInterface, _ReadArchiveInterface_Extract),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class WriteArchiveInterface::ProxyComponent : public maxon::Component<WriteArchiveInterface::ProxyComponent, WriteArchiveInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> Open(const Url& inputFile, Bool append, const String& password) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<WriteArchiveInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_WriteArchiveInterface_Open, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, Bool, const String&>::Invoke, (const void*) mt_._WriteArchiveInterface_Open));
			return proxy_result;
		}
		...
		Result<void> Close() 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_Close, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._WriteArchiveInterface_Close));
			return proxy_result;
		}
		...
		Result<void> SetCompressionLevel(Int compressionLevel) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_SetCompressionLevel, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Int>::Invoke, (const void*) mt_._WriteArchiveInterface_SetCompressionLevel));
			return proxy_result;
		}
		...
		Int GetCompressionLevel() const 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_GetCompressionLevel, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._WriteArchiveInterface_GetCompressionLevel));
			return proxy_result;
		}
		...
		Result<void> CreateDirectory(const String& name, const UniversalDateTime& dateTime, IOATTRIBUTES fileAttributes) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CreateDirectory, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, const UniversalDateTime&, IOATTRIBUTES>::Invoke, (const void*) mt_._WriteArchiveInterface_CreateDirectory));
			return proxy_result;
		}
		...
		Result<void> CreateFile(const String& name, const UniversalDateTime& dateTime, IOARCHIVESTOREMETHOD method, IOATTRIBUTES fileAttributes, UInt32 cryptCrc) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CreateFile, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, const UniversalDateTime&, IOARCHIVESTOREMETHOD, IOATTRIBUTES, UInt32>::Invoke, (const void*) mt_._WriteArchiveInterface_CreateFile));
			return proxy_result;
		}
		...
		Result<void> WriteFile(const Block<const Byte>& data) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_WriteFile, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Block<const Byte>&>::Invoke, (const void*) mt_._WriteArchiveInterface_WriteFile));
			return proxy_result;
		}
		...
		Result<void> CloseFile() 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CloseFile, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._WriteArchiveInterface_CloseFile));
			return proxy_result;
		}
		...
		Result<void> CopyFile(const Url& fn, const String& str, IOATTRIBUTES fileAttributes, IOATTRIBUTES fileAttributesMask) 
		{
			...
			(*handler_)(_fn_WriteArchiveInterface_CopyFile, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, const String&, IOATTRIBUTES, IOATTRIBUTES>::Invoke, (const void*) mt_._WriteArchiveInterface_CopyFile));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(WriteArchiveInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_WriteArchiveInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, WriteArchiveInterface, _WriteArchiveInterface_Open),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, WriteArchiveInterface, _WriteArchiveInterface_Close),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, WriteArchiveInterface, _WriteArchiveInterface_SetCompressionLevel),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, WriteArchiveInterface, _WriteArchiveInterface_CreateDirectory),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 1364LL, WriteArchiveInterface, _WriteArchiveInterface_CreateFile),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, WriteArchiveInterface, _WriteArchiveInterface_WriteFile),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, WriteArchiveInterface, _WriteArchiveInterface_CloseFile),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 340LL, WriteArchiveInterface, _WriteArchiveInterface_CopyFile),
		};
