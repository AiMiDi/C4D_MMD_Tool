...
class MyReadArchiveImpl : public Component<MyReadArchiveImpl, ReadArchiveInterface>
{
	MAXON_COMPONENT();
...
class MyWriteArchiveImpl : public Component<MyWriteArchiveImpl, WriteArchiveInterface>
{
	MAXON_COMPONENT();
