...
/// @cond INTERNAL
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, AddSenderSignal))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, AddSenderSignal), W, MTable>::type::_ObserverObjectInterface_AddSenderSignal;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, RemoveSenderSignal))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, RemoveSenderSignal), W, MTable>::type::_ObserverObjectInterface_RemoveSenderSignal;
...
/// @endcond
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, GetName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, GetName), W, MTable>::type::_ObserverObjectInterface_GetName;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, SetName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, SetName), W, MTable>::type::_ObserverObjectInterface_SetName;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, ObserverDestroyed))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, ObserverDestroyed), W, MTable>::type::_ObserverObjectInterface_ObserverDestroyed;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, ObserverDisconnectNotify))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, ObserverDisconnectNotify), W, MTable>::type::_ObserverObjectInterface_ObserverDisconnectNotify;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, ObserverConnectNotify))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObserverObjectInterface, ObserverConnectNotify), W, MTable>::type::_ObserverObjectInterface_ObserverConnectNotify;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<ObserverObjectInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(ObserverObjectInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class ObserverObjectInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::COWReferenceFunctionsImpl<S>::AddSenderSignal(ObservableBaseInterface* observable) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::ReferenceFunctionsImpl<S>::RemoveSenderSignal(ObservableBaseInterface* observable) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObserverObjectInterface* o_ = (ObserverObjectInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObserverObjectInterface, o_, ObserverObjectInterface_RemoveSenderSignal) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObserverObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObserverObjectInterface>() : PRIVATE_MAXON_VTABLE(ObserverObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::COWReferenceFunctionsImpl<S>::RemoveSenderSignal(ObservableBaseInterface* observable) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::ReferenceFunctionsImpl<S>::SetName(const String& name) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::ConstReferenceFunctionsImpl<S>::ObserverDisconnectNotify() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObserverDisconnectNotifyDelegate>>, maxon::ObservableRef<ObserverDisconnectNotifyDelegate>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObserverDisconnectNotifyDelegate>>, maxon::ObservableRef<ObserverDisconnectNotifyDelegate>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ObserverObjectInterface* o_ = (const ObserverObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = ObserverObjectInterface::NullValuePtr(); if (!o_) return maxon::ObservableRef<ObserverDisconnectNotifyDelegate>::NullValue(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObserverObjectInterface, o_, ObserverObjectInterface_ObserverDisconnectNotify) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObserverObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObserverObjectInterface>() : PRIVATE_MAXON_VTABLE(ObserverObjectInterface, o_); 
