...
struct StringInterface::ReferenceClassHelper { using type = String; };

/// Intermediate helper class for StringInterface.
template <typename S> class StringInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
/// @return												OK on success.
	inline Result<void> Split(const String& splitSymbol, Bool trim, BaseArray<String>& parts) const;
/// Searches for the first occurrence of 'str' within a string.
/// @param[in] str								The search string.
...
#ifdef DOXYGEN
template <typename REF> class StringInterface::ConstReferenceFunctionsImplDoxy : public StringInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for StringInterface.
template <typename S> class StringInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) Append(const StringInterface* str) const;
...
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) Append(const Utf32Char* str, Int len) const;
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												The current string.
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) AppendChar(Utf32Char v) const;
...
#ifdef DOXYGEN
template <typename REF> class StringInterface::ReferenceFunctionsImplDoxy : public StringInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for StringInterface.
template <typename S> class StringInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) Append(const StringInterface* str);
/// Concatenates 2 strings of which the second is represented by len characters at
/// address str in memory.
/// @param[in] str								Character pointer.
/// @param[in] len								Number of characters.
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) Append(const Utf32Char* str, Int len);
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												The current string.
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) AppendChar(Utf32Char v);
/// Erases a range of characters within a string.
/// @param[in] position						The starting position to delete 'count' characters. If the position is out of bounds an error will be returned.
/// @param[in] count							Number of characters to delete. If you want to delete all characters until the end pass StringEnd(). If the number is larger than what is available an error will be returned.
/// @return												OK on success.
...
#ifdef DOXYGEN
template <typename REF> class StringInterface::COWReferenceFunctionsImplDoxy : public StringInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct StringInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class StringInterface::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<String>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const StringInterface, maxon::StrongCOWRefHandler, String>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const StringInterface, maxon::StrongCOWRefHandler, String>>>>);
	using NonConst = NonConstRef;
	static MAXON_ATTRIBUTE_FORCE_INLINE maxon::ResultMemT<String> Create();
};

class StringInterface::NonConstRef :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<StringInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<StringInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
};
...
struct CStringInterface::ReferenceClassHelper { using type = CString; };

/// Intermediate helper class for CStringInterface.
template <typename S> class CStringInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
/// @param[out] parts							Array to be filled with the separated strings.
/// @return												OK on success.
	inline Result<void> Split(const CString& splitSymbol, Bool trim, BaseArray<CString>& parts) const;
/// Searches for the first occurrence of 'str' within a string.
/// @param[in] str								The search string.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return false.
...
#ifdef DOXYGEN
template <typename REF> class CStringInterface::ConstReferenceFunctionsImplDoxy : public CStringInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for CStringInterface.
template <typename S> class CStringInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) Append(const CStringInterface* str) const;
/// Concatenates 2 strings of which the second is represented by len characters at
/// address str in memory.
/// @param[in] str								Character pointer.
/// @param[in] len								Number of characters.
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) Append(const Char* str, Int len) const;
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												The current string.
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) AppendChar(Char v) const;
/// Erases a range of characters within a string.
/// @param[in] position						The starting position to delete 'count' characters. If the position is out of bounds an error will be returned.
/// @param[in] count							Number of characters to delete. If you want to delete all characters until the end pass StringEnd(). If the number is larger than what is available an error will be returned.
/// @return												OK on success.
...
#ifdef DOXYGEN
template <typename REF> class CStringInterface::ReferenceFunctionsImplDoxy : public CStringInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for CStringInterface.
template <typename S> class CStringInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) Append(const CStringInterface* str);
/// Concatenates 2 strings of which the second is represented by len characters at
/// address str in memory.
/// @param[in] str								Character pointer.
/// @param[in] len								Number of characters.
/// @return												The concatenated string. Will be an empty reference if Append fails (apply iferr for error handling).
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) Append(const Char* str, Int len);
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												The current string.
///
	inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) AppendChar(Char v);
/// Erases a range of characters within a string.
/// @param[in] position						The starting position to delete 'count' characters. If the position is out of bounds an error will be returned.
/// @param[in] count							Number of characters to delete. If you want to delete all characters until the end pass StringEnd(). If the number is larger than what is available an error will be returned.
/// @return												OK on success.
...
#ifdef DOXYGEN
template <typename REF> class CStringInterface::COWReferenceFunctionsImplDoxy : public CStringInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct CStringInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class CStringInterface::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<CString>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const CStringInterface, maxon::StrongCOWRefHandler, CString>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const CStringInterface, maxon::StrongCOWRefHandler, CString>>>>);
	using NonConst = NonConstRef;
	static MAXON_ATTRIBUTE_FORCE_INLINE maxon::ResultMemT<CString> Create();
};

class CStringInterface::NonConstRef :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CStringInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CStringInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
};
