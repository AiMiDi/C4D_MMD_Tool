...
struct ResolveInterface::ReferenceClassHelper { using type = ResolveRef; };

/// Intermediate helper class for ResolveInterface.
template <typename S> class ResolveInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ResolveInterface::ConstReferenceFunctionsImplDoxy : public ResolveInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for ResolveInterface.
template <typename S> class ResolveInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ResolveInterface::ReferenceFunctionsImplDoxy : public ResolveInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for ResolveInterface.
template <typename S> class ResolveInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ResolveInterface::COWReferenceFunctionsImplDoxy : public ResolveInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct ResolveInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class ResolveInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<ResolveRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ResolveInterface, maxon::StrongRefHandler, ResolveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ResolveInterface, maxon::StrongRefHandler, ResolveRef>>>>);
...
class ResolveRef : public ResolveInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(ResolveRef, Reference);
};

struct IoConnectionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IoConnectionInterface>::value || DataDictionaryObjectInterface::HasBase::Check<I>::value; static I* Cast(IoConnectionInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class IoConnectionRef;

struct IoConnectionInterface::ReferenceClassHelper { using type = IoConnectionRef; };

/// Intermediate helper class for IoConnectionInterface.
template <typename S> class IoConnectionInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class IoConnectionInterface::ConstReferenceFunctionsImplDoxy : public IoConnectionInterface::ConstReferenceFunctionsImpl<REF>, public DataDictionaryObjectInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for IoConnectionInterface.
template <typename S> class IoConnectionInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// @return												A pointer to the input stream. the pointer must be freed by Object::Free(). The return value needs to be checked against nullptr.
...
/// @param[in] flags							See OPENSTREAMFLAGS for details.
/// @return												Pointer to the output stream. the pointer must be freed by Object::Free(). The return value needs to be checked against nullptr.
...
/// @param[in] flags							See OPENSTREAMFLAGS for details.
/// @return												Pointer to the inoutputstream. The pointer must be freed by Object::Free(). The return value needs to be checked against nullptr.
...
#ifdef DOXYGEN
template <typename REF> class IoConnectionInterface::ReferenceFunctionsImplDoxy : public IoConnectionInterface::ReferenceFunctionsImpl<REF>, public DataDictionaryObjectInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for IoConnectionInterface.
template <typename S> class IoConnectionInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class IoConnectionInterface::COWReferenceFunctionsImplDoxy : public IoConnectionInterface::COWReferenceFunctionsImpl<REF>, public DataDictionaryObjectInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct IoConnectionInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename DataDictionaryObjectInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename DataDictionaryObjectInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename DataDictionaryObjectInterface::ReferenceFunctions<ST>::type>>::type>::type; };
class IoConnectionInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<IoConnectionRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoConnectionInterface, maxon::StrongRefHandler, IoConnectionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoConnectionInterface, maxon::StrongRefHandler, IoConnectionRef>>>>);
	using NonConst = Super::ReferenceClass;
};
...
class IoConnectionRef : public IoConnectionInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(IoConnectionRef, Reference);
};
