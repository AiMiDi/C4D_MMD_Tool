...
namespace maxon
{
	...
	class FunctionBaseInterface::ProxyComponent : public maxon::Component<FunctionBaseInterface::ProxyComponent, FunctionBaseInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<void> Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<FunctionBaseInterface>();
			...
			(*handler_)(_fn_FunctionBaseInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const ObservableForwardFunction, DelegateBase&&>::Invoke, (const void*) mt_._FunctionBaseInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function, const JobQueueRef& queue) 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_Init_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const ObservableForwardFunction, DelegateBase&&, const JobQueueRef&>::Invoke, (const void*) mt_._FunctionBaseInterface_Init_1));
			return proxy_result;
		}
		...
		const void* GetObserverPointer() const 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_GetObserverPointer, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const void*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._FunctionBaseInterface_GetObserverPointer));
			return proxy_result;
		}
		...
		Result<Data> Execute(const Block<const ConstDataPtr>& args) 
		{
			...
			(*handler_)(_fn_FunctionBaseInterface_Execute, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, maxon::GenericComponent*, const Block<const ConstDataPtr>&>::Invoke, (const void*) mt_._FunctionBaseInterface_Execute));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(FunctionBaseInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_FunctionBaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, FunctionBaseInterface, _FunctionBaseInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, FunctionBaseInterface, _FunctionBaseInterface_Init_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, FunctionBaseInterface, _FunctionBaseInterface_Set),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, FunctionBaseInterface, _FunctionBaseInterface_GetOwner),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, FunctionBaseInterface, _FunctionBaseInterface_GetObserver),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, FunctionBaseInterface, _FunctionBaseInterface_Execute),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class CombinerInterface::ProxyComponent : public maxon::Component<CombinerInterface::ProxyComponent, CombinerInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> InitCombine(Result<Data>& combinedRes) const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CombinerInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_CombinerInterface_InitCombine, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, Result<Data>&>::Invoke, (const void*) mt_._CombinerInterface_InitCombine));
			return proxy_result;
		}
		...
		Result<Bool> CombineResult(Result<Data>& combinedRes, Result<Data>&& newRes) const 
		{
			...
			(*handler_)(_fn_CombinerInterface_CombineResult, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, const maxon::GenericComponent*, Result<Data>&, Result<Data>&&>::Invoke, (const void*) mt_._CombinerInterface_CombineResult));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(CombinerInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_CombinerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 8LL, CombinerInterface, _CombinerInterface_InitCombine),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, CombinerInterface, _CombinerInterface_CombineResult),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class ObservableBaseInterface::ProxyComponent : public maxon::Component<ObservableBaseInterface::ProxyComponent, ObservableBaseInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> Init(ObserverObjectInterface* owner, const Id& observableName) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<ObservableBaseInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_ObservableBaseInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObserverObjectInterface*, const Id&>::Invoke, (const void*) mt_._ObservableBaseInterface_Init));
			return proxy_result;
		}
		...
		Id GetObservableId() const 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_GetObservableId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Id, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObservableBaseInterface_GetObservableId));
			return proxy_result;
		}
		...
		Result<void> AddObserver(ObserverObjectInterface* observer, const FunctionBaseRef& observerFunction) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_AddObserver, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObserverObjectInterface*, const FunctionBaseRef&>::Invoke, (const void*) mt_._ObservableBaseInterface_AddObserver));
			return proxy_result;
		}
		...
		Result<Data> Notify(const Block<const ConstDataPtr>& args) const 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_Notify, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*, const Block<const ConstDataPtr>&>::Invoke, (const void*) mt_._ObservableBaseInterface_Notify));
			return proxy_result;
		}
		...
		Result<void> RemoveObserver(const FunctionBaseRef& observerEntry) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_RemoveObserver, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const FunctionBaseRef&>::Invoke, (const void*) mt_._ObservableBaseInterface_RemoveObserver));
			return proxy_result;
		}
		...
		Int GetObserverCount() 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_GetObserverCount, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*>::Invoke, (const void*) mt_._ObservableBaseInterface_GetObserverCount));
			return proxy_result;
		}
		...
		ObserverObjectInterface* GetOwner() const 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_GetOwner, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<ObserverObjectInterface*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObservableBaseInterface_GetOwner));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ObservableBaseInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_ObservableBaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, ObservableBaseInterface, _ObservableBaseInterface_Init),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, ObservableBaseInterface, _ObservableBaseInterface__intDisconnectAll),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, ObservableBaseInterface, _ObservableBaseInterface_AddObserver),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, ObservableBaseInterface, _ObservableBaseInterface_Notify),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, ObservableBaseInterface, _ObservableBaseInterface_RemoveObserver),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, ObservableBaseInterface, _ObservableBaseInterface_SetInverseNotification),
	...
	static maxon::Result<void> RegisterReflection_ObservableStaticInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ObservableStaticInterface::MTable::_instance._ObservableStaticInterface_GetOrAllocClass)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
		};
