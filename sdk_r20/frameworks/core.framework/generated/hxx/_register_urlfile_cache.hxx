...
namespace maxon
{
	...
	const maxon::Char* const UrlFileCacheEntryInterface::MTable::_ids = 
		"Free@ce3c1a22d7282a43\0" // Free(const UrlFileCacheEntryInterface* object)
		"GetSourceUrl@4e33a06\0" // GetSourceUrl() const
		"GetCacheUrl@4e33a06\0" // GetCacheUrl() const
	"";
	class UrlFileCacheEntryInterface::Unresolved : public UrlFileCacheEntryInterface
	{
	public:
	...
	#else
		tbl->_UrlFileCacheEntryInterface_Free = &Wrapper<Unresolved>::_UrlFileCacheEntryInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Url>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlFileCacheEntryInterface_GetSourceUrl = &Wrapper<Unresolved>::_UrlFileCacheEntryInterface_GetSourceUrl;
	#else
		tbl->_UrlFileCacheEntryInterface_GetSourceUrl = &Wrapper<Unresolved>::_UrlFileCacheEntryInterface_GetSourceUrl;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Url>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlFileCacheEntryInterface_GetCacheUrl = &Wrapper<Unresolved>::_UrlFileCacheEntryInterface_GetCacheUrl;
	#else
		tbl->_UrlFileCacheEntryInterface_GetCacheUrl = &Wrapper<Unresolved>::_UrlFileCacheEntryInterface_GetCacheUrl;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	const maxon::Char* const UrlFileCacheInterface::MTable::_ids = 
		"IsAccessible@1aeaf711b704ef1f\0" // IsAccessible(const maxon::Url& url)
		"FindOrCreateUrl@b336bfba983c7ac9\0" // FindOrCreateUrl(const Url& sourceUrl, const TimeValue& maxCacheTime, URLFILECACHEFLAGS flags)
		"FlushCache@5b3e46c920933bb7\0" // FlushCache(const Url& url)
	"";
	class UrlFileCacheInterface::Unresolved : public UrlFileCacheInterface
	{
	public:
	...
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_UrlFileCacheInterface_IsAccessible = &Wrapper<Unresolved>::_UrlFileCacheInterface_IsAccessible;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UrlFileCacheEntry>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlFileCacheInterface_FindOrCreateUrl = &Wrapper<Unresolved>::_UrlFileCacheInterface_FindOrCreateUrl;
	#else
		tbl->_UrlFileCacheInterface_FindOrCreateUrl = &Wrapper<Unresolved>::_UrlFileCacheInterface_FindOrCreateUrl;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlFileCacheInterface_FlushCache = &Wrapper<Unresolved>::_UrlFileCacheInterface_FlushCache;
	#else
		tbl->_UrlFileCacheInterface_FlushCache = &Wrapper<Unresolved>::_UrlFileCacheInterface_FlushCache;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(_returnTypes) - 1);
	#else
	...
	template <typename DUMMY> maxon::Int UrlFileCacheInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_urlfile_cache(0
	...
	| maxon::UrlFileCacheInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
