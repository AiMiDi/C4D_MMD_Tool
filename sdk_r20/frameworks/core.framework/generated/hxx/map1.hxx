...
template <typename K, typename V> struct MapInterface<K, V>::ReferenceClassHelper { using type = Map<K, V>; };

/// Intermediate helper class for MapInterface.
template <typename K, typename V> template <typename S> class MapInterface<K, V>::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename K, typename V> template <typename REF> class MapInterface<K, V>::ConstReferenceFunctionsImplDoxy : public MapInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for MapInterface.
template <typename K, typename V> template <typename S> class MapInterface<K, V>::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename K, typename V> template <typename REF> class MapInterface<K, V>::ReferenceFunctionsImplDoxy : public MapInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for MapInterface.
template <typename K, typename V> template <typename S> class MapInterface<K, V>::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename K, typename V> template <typename REF> class MapInterface<K, V>::COWReferenceFunctionsImplDoxy : public MapInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename K, typename V> template <typename ST> struct MapInterface<K, V>::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
template <typename K, typename V> class MapInterface<K, V>::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<Map<K, V>>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const MapInterface<K, V>, maxon::StrongCOWRefHandler, Map<K, V>>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const MapInterface<K, V>, maxon::StrongCOWRefHandler, Map<K, V>>>>>);
...
template <typename K, typename V> class Map : public MapInterface<K, V>::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Map, typename MapInterface<K, V>::Reference);
};
