...
struct IoHandlerInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, GetUrlScheme))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, GetUrlScheme), W, MTable>::type::_IoHandlerInterface_GetUrlScheme;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, SetSystemPath))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, SetSystemPath), W, MTable>::type::_IoHandlerInterface_SetSystemPath;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, GetSystemPath))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, GetSystemPath), W, MTable>::type::_IoHandlerInterface_GetSystemPath;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, AppendUrl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, AppendUrl), W, MTable>::type::_IoHandlerInterface_AppendUrl;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, AppendUrl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, AppendUrl), W, MTable>::type::_IoHandlerInterface_AppendUrl_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, RemoveUrl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, RemoveUrl), W, MTable>::type::_IoHandlerInterface_RemoveUrl;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, OpenConnection))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, OpenConnection), W, MTable>::type::_IoHandlerInterface_OpenConnection;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, Normalize))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, Normalize), W, MTable>::type::_IoHandlerInterface_Normalize;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, IoNormalize))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, IoHandlerInterface, IoNormalize), W, MTable>::type::_IoHandlerInterface_IoNormalize;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<IoHandlerInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(IoHandlerInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct IoHandlerInterface::StaticMTable
{
...
template <typename S> class IoHandlerInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
{
	return StaticMTable::_instance._IoHandlerInterface_GetHandlerForScheme(scheme);
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::GetUrlScheme() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoHandlerInterface* o_ = (const IoHandlerInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoHandlerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const Id&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoHandlerInterface, o_, IoHandlerInterface_GetUrlScheme) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoHandlerInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoHandlerInterface>() : PRIVATE_MAXON_VTABLE(IoHandlerInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::GetSystemPath(const UrlInterface& url) const -> Result<String>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::AppendUrl(UrlInterface& url, const String& name) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::AppendUrl(UrlInterface& url, const Url& relativeUrl) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::RemoveUrl(UrlInterface& url) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::Normalize(const Url& url, NORMALIZEFLAGS flags) const -> Result<Url>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Url>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const IoHandlerInterface* o_ = (const IoHandlerInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = IoHandlerInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(IoHandlerInterface, o_, IoHandlerInterface_Normalize) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<IoHandlerInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<IoHandlerInterface>() : PRIVATE_MAXON_VTABLE(IoHandlerInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::IoNormalize(const Url& url, NORMALIZEFLAGS flags) const -> Result<Url>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConstReferenceFunctionsImpl<S>::GetHandlerForScheme(const UrlScheme& scheme) -> IoHandler { return (StaticMTable::_instance._IoHandlerInterface_GetHandlerForScheme(scheme)); }
