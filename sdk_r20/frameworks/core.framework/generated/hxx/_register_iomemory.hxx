...
namespace maxon
{
	const maxon::Char* const IoMemoryInterface::MTable::_ids = 
		"Free@3fc5cd2a06ba355f\0" // Free(const IoMemoryInterface* object)
		"Alloc@fa8bbec4aa9ca2e8\0" // Alloc(const maxon::SourceLocation& allocLocation)
		"Alloc@1157daf7e476f541\0" // Alloc(const maxon::SourceLocation& allocLocation, const IoMemoryInterface& src)
		"PrepareReadBuffer@5b985452992e18ab\0" // PrepareReadBuffer(const Block<const Char>& buffer, const FreeBufferCallback& freeBufferCallback)
		"Reset@44dd4274e7521437\0" // Reset(Int size)
		"operatorIndex@27f2b621723e73bf\0" // operatorIndex(Int idx)
		"GetSize@4386c86\0" // GetSize() const
		"IsWritable@76f01901\0" // IsWritable() const
		"GetUrl@a54f479993bcc9e5\0" // GetUrl() const
		"ReadBytes@cacd7b43c50db029\0" // ReadBytes(Int position, const Block<Byte>& data) const
		"ReadBytesEOS@8eb11663fc8664ac\0" // ReadBytesEOS(Int position, const Block<Byte>& data) const
		"WriteBytes@509196ff4593f4ce\0" // WriteBytes(Int position, const Block<const Byte>& data)
		"OpenInputStream@de6e6ed71b1abeea\0" // OpenInputStream(OPENSTREAMFLAGS flags) const
		"OpenOutputStream@14e528d17f28f125\0" // OpenOutputStream(OPENSTREAMFLAGS flags)
		"OpenInOutputStream@5df4ab04f0e33aaa\0" // OpenInOutputStream(OPENSTREAMFLAGS flags)
	"";
	class IoMemoryInterface::Unresolved : public IoMemoryInterface
	{
	public:
	...
	#else
		tbl->_IoMemoryInterface_Free = &Wrapper<Unresolved>::_IoMemoryInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_IoMemoryInterface_Alloc = &Wrapper<Unresolved>::_IoMemoryInterface_Alloc;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_IoMemoryInterface_Alloc_1 = &Wrapper<Unresolved>::_IoMemoryInterface_Alloc_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_PrepareReadBuffer = &Wrapper<Unresolved>::_IoMemoryInterface_PrepareReadBuffer;
	#else
		tbl->_IoMemoryInterface_PrepareReadBuffer = &Wrapper<Unresolved>::_IoMemoryInterface_PrepareReadBuffer;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_Reset = &Wrapper<Unresolved>::_IoMemoryInterface_Reset;
	#else
		tbl->_IoMemoryInterface_Reset = &Wrapper<Unresolved>::_IoMemoryInterface_Reset;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Char&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_operatorIndex = &Wrapper<Unresolved>::_IoMemoryInterface_operatorIndex;
	#else
		tbl->_IoMemoryInterface_operatorIndex = &Wrapper<Unresolved>::_IoMemoryInterface_operatorIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_IoMemoryInterface_GetSize = &Wrapper<Unresolved>::_IoMemoryInterface_GetSize;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_IoMemoryInterface_IsWritable = &Wrapper<Unresolved>::_IoMemoryInterface_IsWritable;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_GetUrl = &Wrapper<Unresolved>::_IoMemoryInterface_GetUrl;
	#else
		tbl->_IoMemoryInterface_GetUrl = &Wrapper<Unresolved>::_IoMemoryInterface_GetUrl;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_ReadBytes = &Wrapper<Unresolved>::_IoMemoryInterface_ReadBytes;
	#else
		tbl->_IoMemoryInterface_ReadBytes = &Wrapper<Unresolved>::_IoMemoryInterface_ReadBytes;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_ReadBytesEOS = &Wrapper<Unresolved>::_IoMemoryInterface_ReadBytesEOS;
	#else
		tbl->_IoMemoryInterface_ReadBytesEOS = &Wrapper<Unresolved>::_IoMemoryInterface_ReadBytesEOS;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_WriteBytes = &Wrapper<Unresolved>::_IoMemoryInterface_WriteBytes;
	#else
		tbl->_IoMemoryInterface_WriteBytes = &Wrapper<Unresolved>::_IoMemoryInterface_WriteBytes;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<InputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_OpenInputStream = &Wrapper<Unresolved>::_IoMemoryInterface_OpenInputStream;
	#else
		tbl->_IoMemoryInterface_OpenInputStream = &Wrapper<Unresolved>::_IoMemoryInterface_OpenInputStream;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<OutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_OpenOutputStream = &Wrapper<Unresolved>::_IoMemoryInterface_OpenOutputStream;
	#else
		tbl->_IoMemoryInterface_OpenOutputStream = &Wrapper<Unresolved>::_IoMemoryInterface_OpenOutputStream;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<InOutputStreamRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_IoMemoryInterface_OpenInOutputStream = &Wrapper<Unresolved>::_IoMemoryInterface_OpenInOutputStream;
	#else
		tbl->_IoMemoryInterface_OpenInOutputStream = &Wrapper<Unresolved>::_IoMemoryInterface_OpenInOutputStream;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
