...
namespace maxon
{
	...
	class MachineInterface::ProxyComponent : public maxon::Component<MachineInterface::ProxyComponent, MachineInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		String GetUniqueId() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<MachineInterface>();
			...
			(*handler_)(_fn_MachineInterface_GetUniqueId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MachineInterface_GetUniqueId));
			return proxy_result;
		}
		...
		Result<DataDictionary> GetMachineInfo() const 
		{
			...
			(*handler_)(_fn_MachineInterface_GetMachineInfo, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataDictionary>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MachineInterface_GetMachineInfo));
			return proxy_result;
		}
		...
		Result<ObjectRef> GetInterface(const Id& interfaceName) 
		{
			...
			(*handler_)(_fn_MachineInterface_GetInterface, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<ObjectRef>, maxon::GenericComponent*, const Id&>::Invoke, (const void*) mt_._MachineInterface_GetInterface));
			return proxy_result;
		}
		...
		MACHINESTATE GetState() const 
		{
			...
			(*handler_)(_fn_MachineInterface_GetState, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MACHINESTATE, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MachineInterface_GetState));
			return proxy_result;
		}
		...
		Bool SetState(MACHINESTATE stateMask, MACHINESTATE stateFlags) 
		{
			...
			(*handler_)(_fn_MachineInterface_SetState, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, MACHINESTATE, MACHINESTATE>::Invoke, (const void*) mt_._MachineInterface_SetState));
			return proxy_result;
		}
		...
		String ToString(const FormatStatement* formatStatement) const 
		{
			...
			(*handler_)(_fn_MachineInterface_ToString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const FormatStatement*>::Invoke, (const void*) mt_._MachineInterface_ToString));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableMessageReceivedDelegate> ObservableMessageReceived() const 
		{
			...
			(*handler_)(_fn_MachineInterface_ObservableMessageReceived, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableMessageReceivedDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MachineInterface_ObservableMessageReceived));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(MachineInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_MachineInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, MachineInterface, _MachineInterface_GetInterface),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, MachineInterface, _MachineInterface_GetState),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, MachineInterface, _MachineInterface_SetState),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, MachineInterface, _MachineInterface_ToString),
...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_MachinesInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance._MachinesInterface_GetRPCMachines)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 2LL, nullptr),
/// @cond INTERNAL

/// @endcond

			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance._MachinesInterface_FindRPCMachine)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
/// @cond INTERNAL

/// @endcond

			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance._MachinesInterface_FindOrAddRPCMachine)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 85LL, nullptr),
/// @cond INTERNAL

/// @endcond

			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(MachinesInterface::MTable::_instance._MachinesInterface_RemoveRPCMachine)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
