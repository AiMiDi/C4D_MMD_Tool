...
/// @endcond
	...
	class ObserverObjectInterface::ProxyComponent : public maxon::Component<ObserverObjectInterface::ProxyComponent, ObserverObjectInterface>
	{
		MAXON_COMPONENT();
	public:
...
/// @cond INTERNAL
		...
		Result<void> AddSenderSignal(ObservableBaseInterface* observable) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<ObserverObjectInterface>();
			...
			(*handler_)(_fn_ObserverObjectInterface_AddSenderSignal, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObservableBaseInterface*>::Invoke, (const void*) mt_._ObserverObjectInterface_AddSenderSignal));
			return proxy_result;
		}
...
/// @endcond
		...
		String GetName() const 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_GetName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObserverObjectInterface_GetName));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObserverDestroyedDelegate> ObserverDestroyed() const 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_ObserverDestroyed, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObserverDestroyedDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObserverObjectInterface_ObserverDestroyed));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObserverDisconnectNotifyDelegate> ObserverDisconnectNotify() const 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_ObserverDisconnectNotify, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObserverDisconnectNotifyDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObserverObjectInterface_ObserverDisconnectNotify));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObserverConnectNotifyDelegate> ObserverConnectNotify() const 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_ObserverConnectNotify, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObserverConnectNotifyDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ObserverObjectInterface_ObserverConnectNotify));
			return proxy_result;
		}
...
/// @endcond
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ObserverObjectInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
/// @cond INTERNAL
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, ObserverObjectInterface, _ObserverObjectInterface_AddSenderSignal),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, ObserverObjectInterface, _ObserverObjectInterface_RemoveSenderSignal),
/// @endcond

			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, ObserverObjectInterface, _ObserverObjectInterface_GetName),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, ObserverObjectInterface, _ObserverObjectInterface_SetName),
