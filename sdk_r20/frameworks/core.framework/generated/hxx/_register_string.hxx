...
namespace maxon
{
	...
	const maxon::Char* const StringInterface::MTable::_ids = 
		"Free@6b89c862671671d5\0" // Free(const StringInterface* object)
		"GetLength@4386c86\0" // GetLength() const
		"Init@6843523afaef7f67\0" // Init(Int count, Utf32Char fillChar)
		"Shrink@a54f4799cbe1a498\0" // Shrink()
		"Append@31f39fe32b74a8c0\0" // Append(const StringInterface* str)
		"Append@cfcaa01cdb34094f\0" // Append(const Utf32Char* str, Int len)
		"FindIndex@7b27f87b2f4552c7\0" // FindIndex(const StringInterface* str, StringPosition start) const
		"FindLastIndex@7b27f87b2f4552c7\0" // FindLastIndex(const StringInterface* str, StringPosition start) const
		"FindIndex@5b7a791ab47dcc3c\0" // FindIndex(Utf32Char ch, StringPosition start) const
		"FindLastIndex@5b7a791ab47dcc3c\0" // FindLastIndex(Utf32Char ch, StringPosition start) const
		"FindUpperIndex@7b27f87b2f4552c7\0" // FindUpperIndex(const StringInterface* str, StringPosition start) const
		"FindLastUpperIndex@7b27f87b2f4552c7\0" // FindLastUpperIndex(const StringInterface* str, StringPosition start) const
		"Erase@d2fb2ee68a77afc4\0" // Erase(StringPosition position, StringCount count)
		"Insert@65a2a7002328fe9f\0" // Insert(StringPosition position, const StringInterface* str, StringPosition strStart, StringCount strCount)
		"Insert@2760f7775d8f1882\0" // Insert(StringPosition position, Utf32Char ch)
		"GetPart@aeb7a20fe28680ad\0" // GetPart(StringPosition start, StringCount count) const
		"ToUpper@bbdf675ff799dd19\0" // ToUpper() const
		"ToLower@bbdf675ff799dd19\0" // ToLower() const
		"ComparePart@bee2cb8967d47228\0" // ComparePart(const StringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) const
		"GetHashCode@95445951\0" // GetHashCode() const
		"SetChar@ee0d63d195187c50\0" // SetChar(Int pos, Utf32Char ch)
		"GetChar@9bcb26f753eabfd2\0" // GetChar(Int pos) const
		"GetUtf32@e029f3e59e414238\0" // GetUtf32(Utf32CharBuffer& stringData) const
		"TrimLeft@a54f4799cbe1a498\0" // TrimLeft()
		"TrimRight@a54f4799cbe1a498\0" // TrimRight()
		"Split@5aad1037de6304b7\0" // Split(const String& splitSymbol, Bool trim, BaseArray<String>& parts) const
		"Replace@1ec79617ed5795f7\0" // Replace(Utf32Char find, Utf32Char replace)
		"Replace@223fc49103ee996f\0" // Replace(const String& find, const String& replace)
		"Replace@3dc0af7818e7d833\0" // Replace(Utf32Char find, const String& replace)
		"Alloc@1751981016543732\0" // Alloc(const maxon::SourceLocation& allocLocation)
		"Alloc@3c3d07742898e9ad\0" // Alloc(const maxon::SourceLocation& allocLocation, const StringInterface& object)
		"GetCStringBlock@24f69868e8f09c59\0" // GetCStringBlock(const Block<Char>& buffer, const StringEncodingRef& stringEncoding) const
		"GetCStringAppendArray@63cd211d0c0d47e6\0" // GetCStringAppendArray(const NonConstArray<Char>& array, const StringEncodingRef& stringEncoding) const
		"GetCString@401a7de2072eb5cc\0" // GetCString(const StringEncodingRef& stringEncoding) const
		"SetCString@5c5e8978bfe2a356\0" // SetCString(const Char* buffer, Int count, const StringDecodingRef& stringDecoding)
		"GetSystemEncoding@5c8c0bb74ac68b80\0" // GetSystemEncoding() const
		"SetSystemEncoding@151f188817d6b9bf\0" // SetSystemEncoding(const SysChar* buffer, Int count)
		"SetUtf32@b4033cadc2b31126\0" // SetUtf32(const Utf32Char* buffer, Int count)
		"GetUtf16@662a366f9491c8fe\0" // GetUtf16(Utf16CharBuffer& stringData) const
		"SetUtf16@b3fdc9f86a0f7020\0" // SetUtf16(const Utf16Char* buffer, Int count)
		"GetAndCacheConstString@0e1a463d73dbc150\0" // GetAndCacheConstString(const wchar_t* chr, Int len)
		"GetAndCacheConstString@14bc444251b198d1\0" // GetAndCacheConstString(const Char* chr, Int len, Int isUtf8)
		"PrivateEnumToString@755fa2dfc6de58ba\0" // PrivateEnumToString(UInt64 value, const Char* enumName, Int size, Bool flags, const UInt64* enumValues, const Char* enumValueNames, const FormatStatement* formatStatement)
		"GetVariableInternalData@420755e4e4cdd6b5\0" // GetVariableInternalData() const
		"GetCharacterWidth@4386c86\0" // GetCharacterWidth() const
	"";
	class StringInterface::Unresolved : public StringInterface
	{
	public:
		...
		StringInterface* Append(const StringInterface* str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((StringInterface*) this)->Append(str); return this;}
		StringInterface* Append(const Utf32Char* str, Int len) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((StringInterface*) this)->Append(str, len); return this;}
		...
		Result<void> Split(const String& splitSymbol, Bool trim, BaseArray<String>& parts) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const StringInterface*) this)->Split(splitSymbol, trim, parts); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	...
	#else
		tbl->_StringInterface_Free = &Wrapper<Unresolved>::_StringInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_GetLength = &Wrapper<Unresolved>::_StringInterface_GetLength;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Init = &Wrapper<Unresolved>::_StringInterface_Init;
	#else
		tbl->_StringInterface_Init = &Wrapper<Unresolved>::_StringInterface_Init;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Shrink = &Wrapper<Unresolved>::_StringInterface_Shrink;
	#else
		tbl->_StringInterface_Shrink = &Wrapper<Unresolved>::_StringInterface_Shrink;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_Append = &Wrapper<Unresolved>::_StringInterface_Append;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_Append_1 = &Wrapper<Unresolved>::_StringInterface_Append_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_FindIndex = &Wrapper<Unresolved>::_StringInterface_FindIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_FindLastIndex = &Wrapper<Unresolved>::_StringInterface_FindLastIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_FindIndex_1 = &Wrapper<Unresolved>::_StringInterface_FindIndex_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_FindLastIndex_1 = &Wrapper<Unresolved>::_StringInterface_FindLastIndex_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_FindUpperIndex = &Wrapper<Unresolved>::_StringInterface_FindUpperIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_FindLastUpperIndex = &Wrapper<Unresolved>::_StringInterface_FindLastUpperIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Erase = &Wrapper<Unresolved>::_StringInterface_Erase;
	#else
		tbl->_StringInterface_Erase = &Wrapper<Unresolved>::_StringInterface_Erase;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Insert = &Wrapper<Unresolved>::_StringInterface_Insert;
	#else
		tbl->_StringInterface_Insert = &Wrapper<Unresolved>::_StringInterface_Insert;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Insert_1 = &Wrapper<Unresolved>::_StringInterface_Insert_1;
	#else
		tbl->_StringInterface_Insert_1 = &Wrapper<Unresolved>::_StringInterface_Insert_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_GetPart = &Wrapper<Unresolved>::_StringInterface_GetPart;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_ToUpper = &Wrapper<Unresolved>::_StringInterface_ToUpper;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_ToLower = &Wrapper<Unresolved>::_StringInterface_ToLower;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_ComparePart = &Wrapper<Unresolved>::_StringInterface_ComparePart;
	#else
		tbl->_StringInterface_ComparePart = &Wrapper<Unresolved>::_StringInterface_ComparePart;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_GetHashCode = &Wrapper<Unresolved>::_StringInterface_GetHashCode;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_SetChar = &Wrapper<Unresolved>::_StringInterface_SetChar;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_GetChar = &Wrapper<Unresolved>::_StringInterface_GetChar;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetUtf32 = &Wrapper<Unresolved>::_StringInterface_GetUtf32;
	#else
		tbl->_StringInterface_GetUtf32 = &Wrapper<Unresolved>::_StringInterface_GetUtf32;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_TrimLeft = &Wrapper<Unresolved>::_StringInterface_TrimLeft;
	#else
		tbl->_StringInterface_TrimLeft = &Wrapper<Unresolved>::_StringInterface_TrimLeft;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_TrimRight = &Wrapper<Unresolved>::_StringInterface_TrimRight;
	#else
		tbl->_StringInterface_TrimRight = &Wrapper<Unresolved>::_StringInterface_TrimRight;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Split = &Wrapper<Unresolved>::_StringInterface_Split;
	#else
		tbl->_StringInterface_Split = &Wrapper<Unresolved>::_StringInterface_Split;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Replace = &Wrapper<Unresolved>::_StringInterface_Replace;
	#else
		tbl->_StringInterface_Replace = &Wrapper<Unresolved>::_StringInterface_Replace;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Replace_1 = &Wrapper<Unresolved>::_StringInterface_Replace_1;
	#else
		tbl->_StringInterface_Replace_1 = &Wrapper<Unresolved>::_StringInterface_Replace_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_Replace_2 = &Wrapper<Unresolved>::_StringInterface_Replace_2;
	#else
		tbl->_StringInterface_Replace_2 = &Wrapper<Unresolved>::_StringInterface_Replace_2;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_Alloc = &Wrapper<Unresolved>::_StringInterface_Alloc;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_Alloc_1 = &Wrapper<Unresolved>::_StringInterface_Alloc_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetCStringBlock = &Wrapper<Unresolved>::_StringInterface_GetCStringBlock;
	#else
		tbl->_StringInterface_GetCStringBlock = &Wrapper<Unresolved>::_StringInterface_GetCStringBlock;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetCStringAppendArray = &Wrapper<Unresolved>::_StringInterface_GetCStringAppendArray;
	#else
		tbl->_StringInterface_GetCStringAppendArray = &Wrapper<Unresolved>::_StringInterface_GetCStringAppendArray;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetCString = &Wrapper<Unresolved>::_StringInterface_GetCString;
	#else
		tbl->_StringInterface_GetCString = &Wrapper<Unresolved>::_StringInterface_GetCString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_SetCString = &Wrapper<Unresolved>::_StringInterface_SetCString;
	#else
		tbl->_StringInterface_SetCString = &Wrapper<Unresolved>::_StringInterface_SetCString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SysCharArray>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetSystemEncoding = &Wrapper<Unresolved>::_StringInterface_GetSystemEncoding;
	#else
		tbl->_StringInterface_GetSystemEncoding = &Wrapper<Unresolved>::_StringInterface_GetSystemEncoding;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_SetSystemEncoding = &Wrapper<Unresolved>::_StringInterface_SetSystemEncoding;
	#else
		tbl->_StringInterface_SetSystemEncoding = &Wrapper<Unresolved>::_StringInterface_SetSystemEncoding;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_SetUtf32 = &Wrapper<Unresolved>::_StringInterface_SetUtf32;
	#else
		tbl->_StringInterface_SetUtf32 = &Wrapper<Unresolved>::_StringInterface_SetUtf32;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetUtf16 = &Wrapper<Unresolved>::_StringInterface_GetUtf16;
	#else
		tbl->_StringInterface_GetUtf16 = &Wrapper<Unresolved>::_StringInterface_GetUtf16;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_SetUtf16 = &Wrapper<Unresolved>::_StringInterface_SetUtf16;
	#else
		tbl->_StringInterface_SetUtf16 = &Wrapper<Unresolved>::_StringInterface_SetUtf16;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetAndCacheConstString = &Wrapper<Unresolved>::_StringInterface_GetAndCacheConstString;
	#else
		tbl->_StringInterface_GetAndCacheConstString = &Wrapper<Unresolved>::_StringInterface_GetAndCacheConstString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetAndCacheConstString_1 = &Wrapper<Unresolved>::_StringInterface_GetAndCacheConstString_1;
	#else
		tbl->_StringInterface_GetAndCacheConstString_1 = &Wrapper<Unresolved>::_StringInterface_GetAndCacheConstString_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_PrivateEnumToString = &Wrapper<Unresolved>::_StringInterface_PrivateEnumToString;
	#else
		tbl->_StringInterface_PrivateEnumToString = &Wrapper<Unresolved>::_StringInterface_PrivateEnumToString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<StridedBlock<const Generic>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetVariableInternalData = &Wrapper<Unresolved>::_StringInterface_GetVariableInternalData;
	#else
		tbl->_StringInterface_GetVariableInternalData = &Wrapper<Unresolved>::_StringInterface_GetVariableInternalData;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_StringInterface_GetCharacterWidth = &Wrapper<Unresolved>::_StringInterface_GetCharacterWidth;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	const maxon::Char* const CStringInterface::MTable::_ids = 
		"Free@070b12f769a3a54a\0" // Free(const CStringInterface* object)
		"GetLength@4386c86\0" // GetLength() const
		"Init@a498e1935d4107cb\0" // Init(Int count, Char fillChar)
		"Shrink@a54f4799cbe1a498\0" // Shrink()
		"Append@9c651e654a44d8ca\0" // Append(const CStringInterface* str)
		"Append@3a2fd6556f3b87fc\0" // Append(const Char* str, Int len)
		"FindIndex@dc9558d1ea72e888\0" // FindIndex(const CStringInterface* str, StringPosition start) const
		"FindLastIndex@dc9558d1ea72e888\0" // FindLastIndex(const CStringInterface* str, StringPosition start) const
		"FindIndex@5e63357cbdb0bcfe\0" // FindIndex(Char ch, StringPosition start) const
		"FindLastIndex@5e63357cbdb0bcfe\0" // FindLastIndex(Char ch, StringPosition start) const
		"FindUpperIndex@dc9558d1ea72e888\0" // FindUpperIndex(const CStringInterface* str, StringPosition start) const
		"FindLastUpperIndex@dc9558d1ea72e888\0" // FindLastUpperIndex(const CStringInterface* str, StringPosition start) const
		"Erase@d2fb2ee68a77afc4\0" // Erase(StringPosition position, StringCount count)
		"Insert@94bd6371b50e624a\0" // Insert(StringPosition position, const CStringInterface* str, StringPosition strStart, StringCount strCount)
		"Insert@011a5b250d86e9d0\0" // Insert(StringPosition position, Char ch)
		"GetPart@3def6d7d5a996870\0" // GetPart(StringPosition start, StringCount count) const
		"ToUpper@ea2b972fcb31729c\0" // ToUpper() const
		"ToLower@ea2b972fcb31729c\0" // ToLower() const
		"ComparePart@f3216a82df22d2c1\0" // ComparePart(const CStringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) const
		"GetHashCode@95445951\0" // GetHashCode() const
		"SetChar@323b480d2ce5dd42\0" // SetChar(Int pos, Char ch)
		"GetChar@36a7d1384338\0" // GetChar(Int pos) const
		"GetUtf32@e029f3e59e414238\0" // GetUtf32(Utf32CharBuffer& stringData) const
		"TrimLeft@a54f4799cbe1a498\0" // TrimLeft()
		"TrimRight@a54f4799cbe1a498\0" // TrimRight()
		"Split@d1531bd29edab04f\0" // Split(const CString& splitSymbol, Bool trim, BaseArray<CString>& parts) const
		"Replace@0c55a0f09b69d017\0" // Replace(Char find, Char replace)
		"Replace@637c76fc49b1fbf7\0" // Replace(const CString& find, const CString& replace)
		"Replace@17043b8f74fd73f0\0" // Replace(Char find, const CString& replace)
		"Alloc@b7c43dffd54c3a35\0" // Alloc(const maxon::SourceLocation& allocLocation)
		"Alloc@61a6f1c14ce020fd\0" // Alloc(const maxon::SourceLocation& allocLocation, const CStringInterface& object)
		"GetCStringBlock@719f3b9d595e9a7b\0" // GetCStringBlock(const Block<Char>& buffer) const
		"GetCStringAppendArray@f922e335a68d524e\0" // GetCStringAppendArray(const NonConstArray<Char>& array) const
		"SetCString@71bd771ba9388182\0" // SetCString(const Char* buffer, Int count)
		"GetCString@d4a21abc0ae635e0\0" // GetCString() const
		"GetInternalData@c0d4f1cbab9b3d33\0" // GetInternalData() const
		"GetAndCacheConstString@7bdde785d9c7a3bd\0" // GetAndCacheConstString(const Char* chr, Int len)
	"";
	class CStringInterface::Unresolved : public CStringInterface
	{
	public:
		...
		CStringInterface* Append(const CStringInterface* str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((CStringInterface*) this)->Append(str); return this;}
		CStringInterface* Append(const Char* str, Int len) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((CStringInterface*) this)->Append(str, len); return this;}
		...
		Result<void> Split(const CString& splitSymbol, Bool trim, BaseArray<CString>& parts) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const CStringInterface*) this)->Split(splitSymbol, trim, parts); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	...
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_Free = &Wrapper<Unresolved>::_CStringInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_GetLength = &Wrapper<Unresolved>::_CStringInterface_GetLength;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Init = &Wrapper<Unresolved>::_CStringInterface_Init;
	#else
		tbl->_CStringInterface_Init = &Wrapper<Unresolved>::_CStringInterface_Init;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Shrink = &Wrapper<Unresolved>::_CStringInterface_Shrink;
	#else
		tbl->_CStringInterface_Shrink = &Wrapper<Unresolved>::_CStringInterface_Shrink;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_Append = &Wrapper<Unresolved>::_CStringInterface_Append;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_Append_1 = &Wrapper<Unresolved>::_CStringInterface_Append_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_FindIndex = &Wrapper<Unresolved>::_CStringInterface_FindIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_FindLastIndex = &Wrapper<Unresolved>::_CStringInterface_FindLastIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_FindIndex_1 = &Wrapper<Unresolved>::_CStringInterface_FindIndex_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_FindLastIndex_1 = &Wrapper<Unresolved>::_CStringInterface_FindLastIndex_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_FindUpperIndex = &Wrapper<Unresolved>::_CStringInterface_FindUpperIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_FindLastUpperIndex = &Wrapper<Unresolved>::_CStringInterface_FindLastUpperIndex;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Erase = &Wrapper<Unresolved>::_CStringInterface_Erase;
	#else
		tbl->_CStringInterface_Erase = &Wrapper<Unresolved>::_CStringInterface_Erase;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Insert = &Wrapper<Unresolved>::_CStringInterface_Insert;
	#else
		tbl->_CStringInterface_Insert = &Wrapper<Unresolved>::_CStringInterface_Insert;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Insert_1 = &Wrapper<Unresolved>::_CStringInterface_Insert_1;
	#else
		tbl->_CStringInterface_Insert_1 = &Wrapper<Unresolved>::_CStringInterface_Insert_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_GetPart = &Wrapper<Unresolved>::_CStringInterface_GetPart;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_ToUpper = &Wrapper<Unresolved>::_CStringInterface_ToUpper;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_ToLower = &Wrapper<Unresolved>::_CStringInterface_ToLower;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_ComparePart = &Wrapper<Unresolved>::_CStringInterface_ComparePart;
	#else
		tbl->_CStringInterface_ComparePart = &Wrapper<Unresolved>::_CStringInterface_ComparePart;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_GetHashCode = &Wrapper<Unresolved>::_CStringInterface_GetHashCode;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_SetChar = &Wrapper<Unresolved>::_CStringInterface_SetChar;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_GetChar = &Wrapper<Unresolved>::_CStringInterface_GetChar;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetUtf32 = &Wrapper<Unresolved>::_CStringInterface_GetUtf32;
	#else
		tbl->_CStringInterface_GetUtf32 = &Wrapper<Unresolved>::_CStringInterface_GetUtf32;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_TrimLeft = &Wrapper<Unresolved>::_CStringInterface_TrimLeft;
	#else
		tbl->_CStringInterface_TrimLeft = &Wrapper<Unresolved>::_CStringInterface_TrimLeft;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_TrimRight = &Wrapper<Unresolved>::_CStringInterface_TrimRight;
	#else
		tbl->_CStringInterface_TrimRight = &Wrapper<Unresolved>::_CStringInterface_TrimRight;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Split = &Wrapper<Unresolved>::_CStringInterface_Split;
	#else
		tbl->_CStringInterface_Split = &Wrapper<Unresolved>::_CStringInterface_Split;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Replace = &Wrapper<Unresolved>::_CStringInterface_Replace;
	#else
		tbl->_CStringInterface_Replace = &Wrapper<Unresolved>::_CStringInterface_Replace;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Replace_1 = &Wrapper<Unresolved>::_CStringInterface_Replace_1;
	#else
		tbl->_CStringInterface_Replace_1 = &Wrapper<Unresolved>::_CStringInterface_Replace_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_Replace_2 = &Wrapper<Unresolved>::_CStringInterface_Replace_2;
	#else
		tbl->_CStringInterface_Replace_2 = &Wrapper<Unresolved>::_CStringInterface_Replace_2;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_Alloc = &Wrapper<Unresolved>::_CStringInterface_Alloc;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CStringInterface_Alloc_1 = &Wrapper<Unresolved>::_CStringInterface_Alloc_1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetCStringBlock = &Wrapper<Unresolved>::_CStringInterface_GetCStringBlock;
	#else
		tbl->_CStringInterface_GetCStringBlock = &Wrapper<Unresolved>::_CStringInterface_GetCStringBlock;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetCStringAppendArray = &Wrapper<Unresolved>::_CStringInterface_GetCStringAppendArray;
	#else
		tbl->_CStringInterface_GetCStringAppendArray = &Wrapper<Unresolved>::_CStringInterface_GetCStringAppendArray;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_SetCString = &Wrapper<Unresolved>::_CStringInterface_SetCString;
	#else
		tbl->_CStringInterface_SetCString = &Wrapper<Unresolved>::_CStringInterface_SetCString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetCString = &Wrapper<Unresolved>::_CStringInterface_GetCString;
	#else
		tbl->_CStringInterface_GetCString = &Wrapper<Unresolved>::_CStringInterface_GetCString;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Block<const Char>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetInternalData = &Wrapper<Unresolved>::_CStringInterface_GetInternalData;
	#else
		tbl->_CStringInterface_GetInternalData = &Wrapper<Unresolved>::_CStringInterface_GetInternalData;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const CString&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetAndCacheConstString = &Wrapper<Unresolved>::_CStringInterface_GetAndCacheConstString;
	#else
		tbl->_CStringInterface_GetAndCacheConstString = &Wrapper<Unresolved>::_CStringInterface_GetAndCacheConstString;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		return assembler(&_interface, (maxon::Char*) tbl, _returnTypes, SIZEOF(_returnTypes) - 1);
	#else
