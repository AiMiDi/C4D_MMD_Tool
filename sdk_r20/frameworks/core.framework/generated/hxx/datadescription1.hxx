...
struct DataDescriptionInterface::ReferenceClassHelper { using type = DataDescription; };

/// Intermediate helper class for DataDescriptionInterface.
template <typename S> class DataDescriptionInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionInterface::ConstReferenceFunctionsImplDoxy : public DataDescriptionInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for DataDescriptionInterface.
template <typename S> class DataDescriptionInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionInterface::ReferenceFunctionsImplDoxy : public DataDescriptionInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for DataDescriptionInterface.
template <typename S> class DataDescriptionInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionInterface::COWReferenceFunctionsImplDoxy : public DataDescriptionInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct DataDescriptionInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class DataDescriptionInterface::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<DataDescription>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const DataDescriptionInterface, maxon::StrongCOWRefHandler, DataDescription>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const DataDescriptionInterface, maxon::StrongCOWRefHandler, DataDescription>>>>);
	using NonConst = NonConstRef;
	static MAXON_ATTRIBUTE_FORCE_INLINE maxon::ResultMemT<DataDescription> Create();
};

class DataDescriptionInterface::NonConstRef :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDescriptionInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDescriptionInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
};
...
class DataDescription : public DataDescriptionInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(DataDescription, Reference);
};
