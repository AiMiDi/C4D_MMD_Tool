...
struct ObserverObjectInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ObserverObjectInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(ObserverObjectInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class ObserverObjectRef;

struct ObserverObjectInterface::ReferenceClassHelper { using type = ObserverObjectRef; };

/// Intermediate helper class for ObserverObjectInterface.
template <typename S> class ObserverObjectInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ObserverObjectInterface::ConstReferenceFunctionsImplDoxy : public ObserverObjectInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for ObserverObjectInterface.
template <typename S> class ObserverObjectInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ObserverObjectInterface::ReferenceFunctionsImplDoxy : public ObserverObjectInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for ObserverObjectInterface.
template <typename S> class ObserverObjectInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ObserverObjectInterface::COWReferenceFunctionsImplDoxy : public ObserverObjectInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct ObserverObjectInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class ObserverObjectInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<ObserverObjectRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ObserverObjectInterface, maxon::StrongRefHandler, ObserverObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ObserverObjectInterface, maxon::StrongRefHandler, ObserverObjectRef>>>>);
...
class ObserverObjectRef : public ObserverObjectInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(ObserverObjectRef, Reference);
};
