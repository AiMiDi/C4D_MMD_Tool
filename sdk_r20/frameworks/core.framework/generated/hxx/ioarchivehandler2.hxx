...
struct ReadArchiveInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, Open))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, Open), W, MTable>::type::_ReadArchiveInterface_Open;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, Close))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, Close), W, MTable>::type::_ReadArchiveInterface_Close;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, ExtractSingleFile))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, ExtractSingleFile), W, MTable>::type::_ReadArchiveInterface_ExtractSingleFile;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, Extract))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ReadArchiveInterface, Extract), W, MTable>::type::_ReadArchiveInterface_Extract;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<ReadArchiveInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(ReadArchiveInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class ReadArchiveInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::COWReferenceFunctionsImpl<S>::Open(const Url& inputFile, const String& password) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ReadArchiveInterface* o_ = (ReadArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ReadArchiveInterface, o_, ReadArchiveInterface_Open) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ReadArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ReadArchiveInterface>() : PRIVATE_MAXON_VTABLE(ReadArchiveInterface, o_); 
	return (mt_._ReadArchiveInterface_Open(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ReadArchiveInterface_Open_Offset, inputFile, password));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::ReferenceFunctionsImpl<S>::Close() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::COWReferenceFunctionsImpl<S>::Close() -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::ReferenceFunctionsImpl<S>::ExtractSingleFile(const String& archiveFile, const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) const -> Result<Url>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Url>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ReadArchiveInterface* o_ = (ReadArchiveInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ReadArchiveInterface, o_, ReadArchiveInterface_ExtractSingleFile) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ReadArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ReadArchiveInterface>() : PRIVATE_MAXON_VTABLE(ReadArchiveInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::COWReferenceFunctionsImpl<S>::ExtractSingleFile(const String& archiveFile, const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) -> Result<Url>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Url>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ReadArchiveInterface* o_ = (ReadArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ReadArchiveInterface, o_, ReadArchiveInterface_ExtractSingleFile) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ReadArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ReadArchiveInterface>() : PRIVATE_MAXON_VTABLE(ReadArchiveInterface, o_); 
	return (mt_._ReadArchiveInterface_ExtractSingleFile(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ReadArchiveInterface_ExtractSingleFile_Offset, archiveFile, outputDirectory, std::forward<ThreadRef>(thread), flags, extractCallback));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::ReferenceFunctionsImpl<S>::Extract(const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::COWReferenceFunctionsImpl<S>::Extract(const Url& outputDirectory, ThreadRef thread, IOARCHIVEEXTRACTFLAGS flags, const ExtractCallback& extractCallback) -> Result<void>
{
...
struct WriteArchiveInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, Open))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, Open), W, MTable>::type::_WriteArchiveInterface_Open;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, Close))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, Close), W, MTable>::type::_WriteArchiveInterface_Close;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, SetCompressionLevel))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, SetCompressionLevel), W, MTable>::type::_WriteArchiveInterface_SetCompressionLevel;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, GetCompressionLevel))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, GetCompressionLevel), W, MTable>::type::_WriteArchiveInterface_GetCompressionLevel;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CreateDirectory))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CreateDirectory), W, MTable>::type::_WriteArchiveInterface_CreateDirectory;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CreateFile))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CreateFile), W, MTable>::type::_WriteArchiveInterface_CreateFile;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, WriteFile))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, WriteFile), W, MTable>::type::_WriteArchiveInterface_WriteFile;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CloseFile))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CloseFile), W, MTable>::type::_WriteArchiveInterface_CloseFile;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CopyFile))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, WriteArchiveInterface, CopyFile), W, MTable>::type::_WriteArchiveInterface_CopyFile;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<WriteArchiveInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(WriteArchiveInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class WriteArchiveInterface::Wrapper : public Object::Wrapper<S>
{
public:
	PRIVATE_MAXON_IMPLEMENTS_HELPER_MEMBER(Close);
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::Open(const Url& inputFile, Bool append, const String& password) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_Open) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::Open(const Url& inputFile, Bool append, const String& password) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_Open) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_Open(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_Open_Offset, inputFile, append, password));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::Close() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::Close() -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_Close) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_Close(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_Close_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::SetCompressionLevel(Int compressionLevel) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::SetCompressionLevel(Int compressionLevel) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_SetCompressionLevel) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_SetCompressionLevel(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_SetCompressionLevel_Offset, compressionLevel));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ConstReferenceFunctionsImpl<S>::GetCompressionLevel() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const WriteArchiveInterface* o_ = (const WriteArchiveInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = WriteArchiveInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_GetCompressionLevel) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::CreateDirectory(const String& name, const UniversalDateTime& dateTime, IOATTRIBUTES fileAttributes) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::CreateDirectory(const String& name, const UniversalDateTime& dateTime, IOATTRIBUTES fileAttributes) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_CreateDirectory) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_CreateDirectory(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_CreateDirectory_Offset, name, dateTime, fileAttributes));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::CreateFile(const String& name, const UniversalDateTime& dateTime, IOARCHIVESTOREMETHOD method, IOATTRIBUTES fileAttributes, UInt32 cryptCrc) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::CreateFile(const String& name, const UniversalDateTime& dateTime, IOARCHIVESTOREMETHOD method, IOATTRIBUTES fileAttributes, UInt32 cryptCrc) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_CreateFile) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_CreateFile(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_CreateFile_Offset, name, dateTime, method, fileAttributes, cryptCrc));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::WriteFile(const Block<const Byte>& data) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::WriteFile(const Block<const Byte>& data) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_WriteFile) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_WriteFile(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_WriteFile_Offset, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::CloseFile() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::CloseFile() -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_CloseFile) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_CloseFile(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_CloseFile_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::ReferenceFunctionsImpl<S>::CopyFile(const Url& fn, const String& str, IOATTRIBUTES fileAttributes, IOATTRIBUTES fileAttributesMask) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::COWReferenceFunctionsImpl<S>::CopyFile(const Url& fn, const String& str, IOATTRIBUTES fileAttributes, IOATTRIBUTES fileAttributesMask) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); WriteArchiveInterface* o_ = (WriteArchiveInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(WriteArchiveInterface, o_, WriteArchiveInterface_CopyFile) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<WriteArchiveInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<WriteArchiveInterface>() : PRIVATE_MAXON_VTABLE(WriteArchiveInterface, o_); 
	return (mt_._WriteArchiveInterface_CopyFile(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._WriteArchiveInterface_CopyFile_Offset, fn, str, fileAttributes, fileAttributesMask));
}
