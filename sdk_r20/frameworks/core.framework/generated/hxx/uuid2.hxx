...
struct UuidInterface::MTable
{
	...
	{
		tbl->_UuidInterface_Free = &IMPL::_UuidInterface_Free;
		tbl->_UuidInterface_Alloc = &IMPL::_UuidInterface_Alloc;
		tbl->_UuidInterface_Alloc_1 = &IMPL::_UuidInterface_Alloc_1;
		tbl->_UuidInterface_Alloc_2 = &IMPL::_UuidInterface_Alloc_2;
		tbl->_UuidInterface_Alloc_3 = &IMPL::_UuidInterface_Alloc_3;
		tbl->_UuidInterface_IsEmpty = &IMPL::_UuidInterface_IsEmpty;
		tbl->_UuidInterface_CreateId = &IMPL::_UuidInterface_CreateId;
		tbl->_UuidInterface_Set = &IMPL::_UuidInterface_Set;
		tbl->_UuidInterface_Set_1 = &IMPL::_UuidInterface_Set_1;
		tbl->_UuidInterface_Get = &IMPL::_UuidInterface_Get;
		tbl->_UuidInterface_ToString = &IMPL::_UuidInterface_ToString;
		tbl->_UuidInterface_Compare = &IMPL::_UuidInterface_Compare;
		tbl->_UuidInterface_GetHashCode = &IMPL::_UuidInterface_GetHashCode;
		tbl->_UuidInterface_DescribeIO = &IMPL::_UuidInterface_DescribeIO;
		tbl->_UuidInterface_CreateUuidString = &IMPL::_UuidInterface_CreateUuidString;
	}
};

template <typename C> class UuidInterface::Wrapper
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::IsEmpty() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UuidInterface* o_ = (const UuidInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UuidInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
	return (MTable::_instance._UuidInterface_IsEmpty(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::IsPopulated() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UuidInterface* o_ = (const UuidInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UuidInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
	return (o_->IsPopulated());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ReferenceFunctionsImpl<S>::CreateId() const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UuidInterface* o_ = (UuidInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._UuidInterface_CreateId(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::COWReferenceFunctionsImpl<S>::CreateId() -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UuidInterface* o_ = (UuidInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); 
	return (MTable::_instance._UuidInterface_CreateId(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ReferenceFunctionsImpl<S>::Set(const String& uuid) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UuidInterface* o_ = (UuidInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._UuidInterface_Set(o_, uuid));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::COWReferenceFunctionsImpl<S>::Set(const String& uuid) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UuidInterface* o_ = (UuidInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); 
	return (MTable::_instance._UuidInterface_Set(o_, uuid));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ReferenceFunctionsImpl<S>::Set(const UChar* uuid, Int uuidSize) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UuidInterface* o_ = (UuidInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._UuidInterface_Set_1(o_, uuid, uuidSize));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::COWReferenceFunctionsImpl<S>::Set(const UChar* uuid, Int uuidSize) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UuidInterface* o_ = (UuidInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); 
	return (MTable::_instance._UuidInterface_Set_1(o_, uuid, uuidSize));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::Get(UChar* uuid, Int uuidSize) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UuidInterface* o_ = (const UuidInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UuidInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UuidInterface_Get(o_, uuid, uuidSize));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* formatStatement) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UuidInterface* o_ = (const UuidInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UuidInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (MTable::_instance._UuidInterface_ToString(o_, formatStatement));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::Compare(const UuidInterface* uuid) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<COMPARERESULT>, COMPARERESULT>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<COMPARERESULT>, COMPARERESULT>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UuidInterface* o_ = (const UuidInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UuidInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<COMPARERESULT>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (MTable::_instance._UuidInterface_Compare(o_, uuid));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::DescribeIO(const DataSerializeInterface& stream) -> Result<void> { return (MTable::_instance._UuidInterface_DescribeIO(stream)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::ConstReferenceFunctionsImpl<S>::CreateUuidString() -> Result<String> { return (MTable::_instance._UuidInterface_CreateUuidString()); }
