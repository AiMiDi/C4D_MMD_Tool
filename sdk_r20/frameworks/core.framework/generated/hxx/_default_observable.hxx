...
class MyFunctionBaseImpl : public Component<MyFunctionBaseImpl, FunctionBaseInterface>
{
	MAXON_COMPONENT();
...
class MyCombinerImpl : public Component<MyCombinerImpl, CombinerInterface>
{
	MAXON_COMPONENT();
...
class MyObservableBaseImpl : public Component<MyObservableBaseImpl, ObservableBaseInterface>
{
	MAXON_COMPONENT();
