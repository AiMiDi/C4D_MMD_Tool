...
struct LoggerTypeInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, LoggerTypeInterface, Write))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, LoggerTypeInterface, Write), W, MTable>::type::_LoggerTypeInterface_Write;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, LoggerTypeInterface, Flush))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, LoggerTypeInterface, Flush), W, MTable>::type::_LoggerTypeInterface_Flush;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, LoggerTypeInterface, ObservableLoggerNotify))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, LoggerTypeInterface, ObservableLoggerNotify), W, MTable>::type::_LoggerTypeInterface_ObservableLoggerNotify;
	...
	{
		if (!W::Implementation::PROXY && (!ObserverObjectInterface::MTable::InitWithBases<W>(info, offset) || !DataDictionaryObjectInterface::MTable::InitWithBases<W>(info, offset))) return false;
		MTable* vt = (MTable*) maxon::Object::PrivateGetOrCreateMTable(info, _interface); if (!vt) return false;
		vt->Init<W>(offset); return true;
	}
	template <typename S> using CombinedMTable = maxon::CombinedMTable<LoggerTypeInterface, DataDictionaryObjectInterface::MTable::CombinedMTable<ObserverObjectInterface::MTable::CombinedMTable<S>>>;
	PRIVATE_MAXON_COMPBASE(LoggerTypeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class LoggerTypeInterface::Wrapper : public DataDictionaryObjectInterface::Wrapper<ObserverObjectInterface::Wrapper<S>>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::ReferenceFunctionsImpl<S>::Write(const String& str, const SourceLocation& loc, WRITEMETA level) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerTypeInterface* o_ = (LoggerTypeInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(LoggerTypeInterface, o_, LoggerTypeInterface_Write) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<LoggerTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<LoggerTypeInterface>() : PRIVATE_MAXON_VTABLE(LoggerTypeInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::COWReferenceFunctionsImpl<S>::Write(const String& str, const SourceLocation& loc, WRITEMETA level) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerTypeInterface* o_ = (LoggerTypeInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(LoggerTypeInterface, o_, LoggerTypeInterface_Write) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<LoggerTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<LoggerTypeInterface>() : PRIVATE_MAXON_VTABLE(LoggerTypeInterface, o_); 
	return (mt_._LoggerTypeInterface_Write(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._LoggerTypeInterface_Write_Offset, str, loc, level));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::ReferenceFunctionsImpl<S>::Flush() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::COWReferenceFunctionsImpl<S>::Flush() -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::ConstReferenceFunctionsImpl<S>::ObservableLoggerNotify() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableLoggerNotifyDelegate>>, maxon::ObservableRef<ObservableLoggerNotifyDelegate>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableLoggerNotifyDelegate>>, maxon::ObservableRef<ObservableLoggerNotifyDelegate>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const LoggerTypeInterface* o_ = (const LoggerTypeInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = LoggerTypeInterface::NullValuePtr(); if (!o_) return maxon::ObservableRef<ObservableLoggerNotifyDelegate>::NullValue(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(LoggerTypeInterface, o_, LoggerTypeInterface_ObservableLoggerNotify) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<LoggerTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<LoggerTypeInterface>() : PRIVATE_MAXON_VTABLE(LoggerTypeInterface, o_); 
...
struct FileLoggerTypeInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FileLoggerTypeInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FileLoggerTypeInterface, Init), W, MTable>::type::_FileLoggerTypeInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FileLoggerTypeInterface, GetUrl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FileLoggerTypeInterface, GetUrl), W, MTable>::type::_FileLoggerTypeInterface_GetUrl;
	...
	template <typename W> static maxon::Bool InitWithBases(maxon::ClassInfo* info, maxon::Int offset)
	{
		if (!W::Implementation::PROXY && (!LoggerTypeInterface::MTable::InitWithBases<W>(info, offset))) return false;
		MTable* vt = (MTable*) maxon::Object::PrivateGetOrCreateMTable(info, _interface); if (!vt) return false;
		vt->Init<W>(offset); return true;
	}
	template <typename S> using CombinedMTable = maxon::CombinedMTable<FileLoggerTypeInterface, LoggerTypeInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(FileLoggerTypeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class FileLoggerTypeInterface::Wrapper : public LoggerTypeInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FileLoggerTypeInterface::COWReferenceFunctionsImpl<S>::Init(const Url& url) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); FileLoggerTypeInterface* o_ = (FileLoggerTypeInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FileLoggerTypeInterface, o_, FileLoggerTypeInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FileLoggerTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FileLoggerTypeInterface>() : PRIVATE_MAXON_VTABLE(FileLoggerTypeInterface, o_); 
	return (mt_._FileLoggerTypeInterface_Init(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._FileLoggerTypeInterface_Init_Offset, url));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FileLoggerTypeInterface::ConstReferenceFunctionsImpl<S>::GetUrl() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const FileLoggerTypeInterface* o_ = (const FileLoggerTypeInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = FileLoggerTypeInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Url>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FileLoggerTypeInterface, o_, FileLoggerTypeInterface_GetUrl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FileLoggerTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FileLoggerTypeInterface>() : PRIVATE_MAXON_VTABLE(FileLoggerTypeInterface, o_); 
...
struct UserLoggerTypeInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, UserLoggerTypeInterface, Iterate))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, UserLoggerTypeInterface, Iterate), W, MTable>::type::_UserLoggerTypeInterface_Iterate;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, UserLoggerTypeInterface, GetCount))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, UserLoggerTypeInterface, GetCount), W, MTable>::type::_UserLoggerTypeInterface_GetCount;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, UserLoggerTypeInterface, Reset))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, UserLoggerTypeInterface, Reset), W, MTable>::type::_UserLoggerTypeInterface_Reset;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<UserLoggerTypeInterface, LoggerTypeInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(UserLoggerTypeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class UserLoggerTypeInterface::Wrapper : public LoggerTypeInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UserLoggerTypeInterface::COWReferenceFunctionsImpl<S>::GetCount() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int, maxon::Result<Int>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UserLoggerTypeInterface::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); UserLoggerTypeInterface* o_ = (UserLoggerTypeInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(UserLoggerTypeInterface, o_, UserLoggerTypeInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<UserLoggerTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<UserLoggerTypeInterface>() : PRIVATE_MAXON_VTABLE(UserLoggerTypeInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UserLoggerTypeInterface::COWReferenceFunctionsImpl<S>::Reset() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
struct LoggerInterface::MTable
{
	...
	{
		tbl->_LoggerInterface_Free = &IMPL::_LoggerInterface_Free;
		tbl->_LoggerInterface_Alloc = &IMPL::_LoggerInterface_Alloc;
		tbl->_LoggerInterface_AddLoggerType = &IMPL::_LoggerInterface_AddLoggerType;
		tbl->_LoggerInterface_RemoveLoggerType = &IMPL::_LoggerInterface_RemoveLoggerType;
		tbl->_LoggerInterface_RemoveLoggerTypes = &IMPL::_LoggerInterface_RemoveLoggerTypes;
		tbl->_LoggerInterface_Write = &IMPL::_LoggerInterface_Write;
		tbl->_LoggerInterface_GetName = &IMPL::_LoggerInterface_GetName;
		tbl->_LoggerInterface_SetName = &IMPL::_LoggerInterface_SetName;
		tbl->_LoggerInterface_Enable = &IMPL::_LoggerInterface_Enable;
		tbl->_LoggerInterface_IsEnabled = &IMPL::_LoggerInterface_IsEnabled;
		tbl->_LoggerInterface_GetLoggerTypes = &IMPL::_LoggerInterface_GetLoggerTypes;
		tbl->_LoggerInterface_ObservableLoggerNew = &IMPL::_LoggerInterface_ObservableLoggerNew;
		tbl->_LoggerInterface_AddNewLogger = &IMPL::_LoggerInterface_AddNewLogger;
	}
};

template <typename C> class LoggerInterface::Wrapper
{
public:
...
auto LoggerInterface::Reference::Create() -> maxon::ResultMemT<LoggerRef>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::AddLoggerType(TARGETAUDIENCE ta, const Class<LoggerTypeRef>& loggerTypeCls, const LOGGERTYPEINITCALLBACK& cb) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._LoggerInterface_AddLoggerType(o_, ta, loggerTypeCls, cb));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::RemoveLoggerType(LoggerTypeRef& loggerType) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._LoggerInterface_RemoveLoggerType(o_, loggerType));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::RemoveLoggerTypes(const Class<LoggerTypeRef>& loggerTypeCls) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._LoggerInterface_RemoveLoggerTypes(o_, loggerTypeCls));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::Write(TARGETAUDIENCE ta, const String& str, const maxon::SourceLocation& loc, WRITEMETA level) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (MTable::_instance._LoggerInterface_Write(o_, ta, str, loc, level));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ConstReferenceFunctionsImpl<S>::GetName() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const LoggerInterface* o_ = (const LoggerInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = LoggerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (MTable::_instance._LoggerInterface_GetName(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::SetName(const String& name) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	MTable::_instance._LoggerInterface_SetName(o_, name);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::Enable(Bool enable) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	MTable::_instance._LoggerInterface_Enable(o_, enable);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ReferenceFunctionsImpl<S>::IsEnabled() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); LoggerInterface* o_ = (LoggerInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(false); 
	return (MTable::_instance._LoggerInterface_IsEnabled(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ConstReferenceFunctionsImpl<S>::GetLoggerTypes() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>, BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>, BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const LoggerInterface* o_ = (const LoggerInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = LoggerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (MTable::_instance._LoggerInterface_GetLoggerTypes(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ConstReferenceFunctionsImpl<S>::ObservableLoggerNew() -> maxon::ObservableRef<ObservableLoggerNewDelegate> { return (MTable::_instance._LoggerInterface_ObservableLoggerNew()); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ConstReferenceFunctionsImpl<S>::AddNewLogger(const Id& id, const LoggerRef& logger, const maxon::ModuleInfo* module) -> Result<void> { return (MTable::_instance._LoggerInterface_AddNewLogger(id, logger, module)); }
#if defined(MAXON_DEPENDENCY_ENABLE) && !defined(PRIVATE_MAXON_REGISTRATION_UNIT)
