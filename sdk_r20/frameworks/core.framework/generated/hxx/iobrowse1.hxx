...
struct IoBrowseInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, IoBrowseInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(IoBrowseInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class IoBrowseRef;

struct IoBrowseInterface::ReferenceClassHelper { using type = IoBrowseRef; };

/// Intermediate helper class for IoBrowseInterface.
template <typename S> class IoBrowseInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoBrowseInterface::ConstReferenceFunctionsImplDoxy : public IoBrowseInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for IoBrowseInterface.
template <typename S> class IoBrowseInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoBrowseInterface::ReferenceFunctionsImplDoxy : public IoBrowseInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for IoBrowseInterface.
template <typename S> class IoBrowseInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class IoBrowseInterface::COWReferenceFunctionsImplDoxy : public IoBrowseInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct IoBrowseInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class IoBrowseInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<IoBrowseRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoBrowseInterface, maxon::StrongRefHandler, IoBrowseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<IoBrowseInterface, maxon::StrongRefHandler, IoBrowseRef>>>>);
...
class IoBrowseRef : public IoBrowseInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(IoBrowseRef, Reference);
};
