...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_RunLoop(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_AddTimer)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 341LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_RemoveTimer)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_GetLinuxDefaultDisplayAndScreen)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 10LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_ObservableFilterSystemMessage)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_PrivateSetWaitInterval)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(RunLoop::MTable::_instance._RunLoop_PrivateSetDefaultDisplayAndScreen)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
		};
