...
namespace maxon
{
	...
	class IoDualInOutputStreamInterface::ProxyComponent : public maxon::Component<IoDualInOutputStreamInterface::ProxyComponent, IoDualInOutputStreamInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<void> SetInputStream(const InputStreamRef& inputStream) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<IoDualInOutputStreamInterface>();
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_SetInputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const InputStreamRef&>::Invoke, (const void*) mt_._IoDualInOutputStreamInterface_SetInputStream));
			return proxy_result;
		}
		...
		Result<void> SetOutputStream(const OutputStreamRef& outputStream) 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_SetOutputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const OutputStreamRef&>::Invoke, (const void*) mt_._IoDualInOutputStreamInterface_SetOutputStream));
			return proxy_result;
		}
		...
		InputStreamRef GetInputStream() const 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_GetInputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<InputStreamRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoDualInOutputStreamInterface_GetInputStream));
			return proxy_result;
		}
		...
		OutputStreamRef GetOutputStream() const 
		{
			...
			(*handler_)(_fn_IoDualInOutputStreamInterface_GetOutputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<OutputStreamRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoDualInOutputStreamInterface_GetOutputStream));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(IoDualInOutputStreamInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_IoDualInOutputStreamInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoDualInOutputStreamInterface, _IoDualInOutputStreamInterface_SetInputStream),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoDualInOutputStreamInterface, _IoDualInOutputStreamInterface_SetOutputStream),
