...
namespace maxon
{
	...
	class HierarchyObjectInterface::ProxyComponent : public maxon::Component<HierarchyObjectInterface::ProxyComponent, HierarchyObjectInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		maxon::reflection::ProxyHandler _handler;
		Result<void> InsertBefore(const HierarchyObjectRef& nextSibling) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<HierarchyObjectInterface>();
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertBefore, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertBefore));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertBefore;
		Result<void> InsertAfter(const HierarchyObjectRef& prevSibling) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertAfter, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertAfter));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertAfter;
		Result<void> InsertAsFirstChildOf(const HierarchyObjectRef& parent, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertAsFirstChildOf, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertAsFirstChildOf));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertAsFirstChildOf;
		Result<void> InsertAsLastChildOf(const HierarchyObjectRef& parent, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertAsLastChildOf, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertAsLastChildOf));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertAsLastChildOf;
		Result<void> InsertAsChildAt(const HierarchyObjectRef& parent, Int position, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertAsChildAt, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&, Int, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertAsChildAt));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertAsChildAt;
		Result<void> InsertChildAsFirst(const HierarchyObjectRef& child, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertChildAsFirst, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertChildAsFirst));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertChildAsFirst;
		Result<void> InsertChildAsLast(const HierarchyObjectRef& child, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertChildAsLast, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertChildAsLast));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertChildAsLast;
		Result<void> InsertChildAt(const HierarchyObjectRef& child, Int position, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertChildAt, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&, Int, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertChildAt));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertChildAt;
		Result<void> InsertChildrenAsFirst(const BaseArray<HierarchyObjectRef>& children, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertChildrenAsFirst, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BaseArray<HierarchyObjectRef>&, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertChildrenAsFirst));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertChildrenAsFirst;
		Result<void> InsertChildrenAsLast(const BaseArray<HierarchyObjectRef>& children, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
		...
		Result<void> InsertChildrenAt(const BaseArray<HierarchyObjectRef>& children, Int position, const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_InsertChildrenAt, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BaseArray<HierarchyObjectRef>&, Int, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_InsertChildrenAt));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_InsertChildrenAt;
		Result<void> Replace(const HierarchyObjectRef& newObject) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_Replace, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const HierarchyObjectRef&>::Invoke, (const void*) mt_._HierarchyObjectInterface_Replace));
			return proxy_result;
		}
		...
		HierarchyObjectRef Remove() 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<HierarchyObjectInterface>();
			HierarchyObjectRef proxy_result = maxon::PrivateIncompleteNullReturnValue<HierarchyObjectRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
			...
			(*handler_)(_fn_HierarchyObjectInterface_Remove, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_Remove));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_Remove;
		HierarchyObjectRef RemoveChildren(const ConstDataPtr& branchId) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_RemoveChildren, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_RemoveChildren));
			return proxy_result;
		}
		...
		Result<Data> GetOwner() const 
		{
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetOwner, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetOwner));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetOwner;
		HierarchyObjectRef GetFirstChild(const ConstDataPtr& branchId) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetFirstChild, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, const maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetFirstChild));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetFirstChild;
		HierarchyObjectRef GetLastChild(const ConstDataPtr& branchId) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetLastChild, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, const maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetLastChild));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetLastChild;
		HierarchyObjectRef GetChildAt(Int position, const ConstDataPtr& branchId) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetChildAt, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, const maxon::GenericComponent*, Int, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetChildAt));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetChildAt;
		Result<BaseArray<HierarchyObjectRef>> GetChildren(const ConstDataPtr& branchId) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<HierarchyObjectInterface>();
			Result<BaseArray<HierarchyObjectRef>> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetChildren, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<HierarchyObjectRef>>, const maxon::GenericComponent*, const ConstDataPtr&>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetChildren));
			return proxy_result;
		}
		...
		Result<BaseArray<ConstDataPtr>> GetBranches() const 
		{
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetBranches, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<ConstDataPtr>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetBranches));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetBranches;
		HierarchyObjectRef GetParent() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetParent, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetParent));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetParent;
		HierarchyObjectRef GetNext() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetNext, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetNext));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_HierarchyObjectInterface_GetNext;
		HierarchyObjectRef GetPrev() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_HierarchyObjectInterface_GetPrev, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<HierarchyObjectRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetPrev));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableHierarchyInsertDelegate> ObservableHierarchyInsert() const 
		{
			...
			(*handler_)(_fn_HierarchyObjectInterface_ObservableHierarchyInsert, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableHierarchyInsertDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_ObservableHierarchyInsert));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableHierarchyRemoveDelegate> ObservableHierarchyRemove() const 
		{
			...
			(*handler_)(_fn_HierarchyObjectInterface_ObservableHierarchyRemove, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableHierarchyRemoveDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_ObservableHierarchyRemove));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(HierarchyObjectInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_HierarchyObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertBefore),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertAfter),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertAsFirstChildOf),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertAsLastChildOf),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertAsChildAt),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertChildAsFirst),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertChildAsLast),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertChildAt),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertChildrenAsFirst),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertChildrenAsLast),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, HierarchyObjectInterface, _HierarchyObjectInterface_InsertChildrenAt),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, HierarchyObjectInterface, _HierarchyObjectInterface_Replace),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, HierarchyObjectInterface, _HierarchyObjectInterface_Remove),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_RemoveChildren),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_GetFirstChild),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_GetLastChild),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 20LL, HierarchyObjectInterface, _HierarchyObjectInterface_GetChildAt),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_GetChildren),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, HierarchyObjectInterface, _HierarchyObjectInterface_ParentChanged),
