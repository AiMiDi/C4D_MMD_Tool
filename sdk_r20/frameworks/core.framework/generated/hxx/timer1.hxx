...
struct TimerInterface::ReferenceClassHelper { using type = TimerRef; };

/// Intermediate helper class for TimerInterface.
template <typename S> class TimerInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
/// @return												Timer reference.
	template <typename FN> static inline ResultMemT<TimerRef> AddPeriodicTimer(TimeValue interval, FN&& job, JobQueueInterface* queue);
...
/// @tparam FN										Type of object/lambda, deduced by the compiler.
/// @return												Timer reference.
	template <typename FN> static inline ResultMemT<TimerRef> AddOneShotTimer(TimeValue delay, FN&& job, JobQueueInterface* queue);
...
/// @cond IGNORE
	...
	static inline void PrivateDisableAllTimers();
/// @endcond

};
#ifdef DOXYGEN
template <typename REF> class TimerInterface::ConstReferenceFunctionsImplDoxy : public TimerInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for TimerInterface.
template <typename S> class TimerInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class TimerInterface::ReferenceFunctionsImplDoxy : public TimerInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for TimerInterface.
template <typename S> class TimerInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class TimerInterface::COWReferenceFunctionsImplDoxy : public TimerInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct TimerInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class TimerInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<TimerRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<TimerInterface, maxon::StrongRefHandler, TimerRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<TimerInterface, maxon::StrongRefHandler, TimerRef>>>>);
...
class TimerRef : public TimerInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(TimerRef, Reference);
};
