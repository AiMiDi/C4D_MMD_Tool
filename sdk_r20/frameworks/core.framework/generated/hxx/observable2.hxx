...
struct FunctionBaseInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Init), W, MTable>::type::_FunctionBaseInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Init), W, MTable>::type::_FunctionBaseInterface_Init_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Set))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Set), W, MTable>::type::_FunctionBaseInterface_Set;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, GetOwner))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, GetOwner), W, MTable>::type::_FunctionBaseInterface_GetOwner;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, GetObserver))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, GetObserver), W, MTable>::type::_FunctionBaseInterface_GetObserver;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, GetObserverPointer))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, GetObserverPointer), W, MTable>::type::_FunctionBaseInterface_GetObserverPointer;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Execute))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, FunctionBaseInterface, Execute), W, MTable>::type::_FunctionBaseInterface_Execute;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<FunctionBaseInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(FunctionBaseInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class FunctionBaseInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ReferenceFunctionsImpl<S>::Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); FunctionBaseInterface* o_ = (FunctionBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FunctionBaseInterface, o_, FunctionBaseInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FunctionBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FunctionBaseInterface>() : PRIVATE_MAXON_VTABLE(FunctionBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::COWReferenceFunctionsImpl<S>::Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ReferenceFunctionsImpl<S>::Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function, const JobQueueRef& queue) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::COWReferenceFunctionsImpl<S>::Init(const ObservableForwardFunction forwardFunction, DelegateBase&& function, const JobQueueRef& queue) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ReferenceFunctionsImpl<S>::Set(ObserverObjectInterface* owner, ObserverObjectInterface* observer) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); FunctionBaseInterface* o_ = (FunctionBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FunctionBaseInterface, o_, FunctionBaseInterface_Set) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FunctionBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FunctionBaseInterface>() : PRIVATE_MAXON_VTABLE(FunctionBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::COWReferenceFunctionsImpl<S>::Set(ObserverObjectInterface* owner, ObserverObjectInterface* observer) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ConstReferenceFunctionsImpl<S>::GetOwner(ObserverObjectRef& res) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const FunctionBaseInterface* o_ = (const FunctionBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = FunctionBaseInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FunctionBaseInterface, o_, FunctionBaseInterface_GetOwner) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FunctionBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FunctionBaseInterface>() : PRIVATE_MAXON_VTABLE(FunctionBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ConstReferenceFunctionsImpl<S>::GetObserver(ObserverObjectRef& res) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const FunctionBaseInterface* o_ = (const FunctionBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = FunctionBaseInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FunctionBaseInterface, o_, FunctionBaseInterface_GetObserver) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FunctionBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FunctionBaseInterface>() : PRIVATE_MAXON_VTABLE(FunctionBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ConstReferenceFunctionsImpl<S>::GetObserverPointer() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const void*>, const void*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const void*>, const void*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const FunctionBaseInterface* o_ = (const FunctionBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = FunctionBaseInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FunctionBaseInterface, o_, FunctionBaseInterface_GetObserverPointer) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FunctionBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FunctionBaseInterface>() : PRIVATE_MAXON_VTABLE(FunctionBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::ReferenceFunctionsImpl<S>::Execute(const Block<const ConstDataPtr>& args) const -> Result<Data>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Data>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); FunctionBaseInterface* o_ = (FunctionBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(FunctionBaseInterface, o_, FunctionBaseInterface_Execute) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<FunctionBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<FunctionBaseInterface>() : PRIVATE_MAXON_VTABLE(FunctionBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto FunctionBaseInterface::COWReferenceFunctionsImpl<S>::Execute(const Block<const ConstDataPtr>& args) -> Result<Data>
{
...
struct CombinerInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CombinerInterface, InitCombine))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CombinerInterface, InitCombine), W, MTable>::type::_CombinerInterface_InitCombine;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CombinerInterface, CombineResult))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CombinerInterface, CombineResult), W, MTable>::type::_CombinerInterface_CombineResult;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CombinerInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CombinerInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CombinerInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CombinerInterface::ConstReferenceFunctionsImpl<S>::CombineResult(Result<Data>& combinedRes, Result<Data>&& newRes) const -> Result<Bool>
{
...
struct ObservableBaseInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, Init), W, MTable>::type::_ObservableBaseInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, GetObservableId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, GetObservableId), W, MTable>::type::_ObservableBaseInterface_GetObservableId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, _intDisconnectAll))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, _intDisconnectAll), W, MTable>::type::_ObservableBaseInterface__intDisconnectAll;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, AddObserver))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, AddObserver), W, MTable>::type::_ObservableBaseInterface_AddObserver;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, Notify))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, Notify), W, MTable>::type::_ObservableBaseInterface_Notify;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, RemoveObserver))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, RemoveObserver), W, MTable>::type::_ObservableBaseInterface_RemoveObserver;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, SetInverseNotification))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, SetInverseNotification), W, MTable>::type::_ObservableBaseInterface_SetInverseNotification;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, GetObserverCount))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, GetObserverCount), W, MTable>::type::_ObservableBaseInterface_GetObserverCount;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, GetOwner))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, ObservableBaseInterface, GetOwner), W, MTable>::type::_ObservableBaseInterface_GetOwner;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<ObservableBaseInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(ObservableBaseInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class ObservableBaseInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::Init(ObserverObjectInterface* owner, const Id& observableName) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::Init(ObserverObjectInterface* owner, const Id& observableName) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
	return (mt_._ObservableBaseInterface_Init(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObservableBaseInterface_Init_Offset, owner, observableName));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ConstReferenceFunctionsImpl<S>::GetObservableId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Id>, Id>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Id>, Id>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ObservableBaseInterface* o_ = (const ObservableBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = ObservableBaseInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Id>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_GetObservableId) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::_intDisconnectAll(ObserverObjectInterface* observer, Int pass) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface__intDisconnectAll) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::_intDisconnectAll(ObserverObjectInterface* observer, Int pass) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::Disconnect(ObserverObjectInterface* observer) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	o_->Disconnect(observer);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::Disconnect(ObserverObjectInterface* observer) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::Free() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	o_->Free();
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::Free() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::AddObserver(ObserverObjectInterface* observer, const FunctionBaseRef& observerFunction) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::AddObserver(ObserverObjectInterface* observer, const FunctionBaseRef& observerFunction) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ConstReferenceFunctionsImpl<S>::Notify(const Block<const ConstDataPtr>& args) const -> Result<Data>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Data>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ObservableBaseInterface* o_ = (const ObservableBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = ObservableBaseInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_Notify) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::RemoveObserver(const FunctionBaseRef& observerEntry) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::RemoveObserver(const FunctionBaseRef& observerEntry) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::SetInverseNotification(Bool inverse) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_SetInverseNotification) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::SetInverseNotification(Bool inverse) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ReferenceFunctionsImpl<S>::GetObserverCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ObservableBaseInterface* o_ = (ObservableBaseInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return 0; const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_GetObserverCount) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::COWReferenceFunctionsImpl<S>::GetObserverCount() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int, maxon::Result<Int>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObservableBaseInterface::ConstReferenceFunctionsImpl<S>::GetOwner() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<ObserverObjectInterface*>, ObserverObjectInterface*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<ObserverObjectInterface*>, ObserverObjectInterface*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ObservableBaseInterface* o_ = (const ObservableBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = ObservableBaseInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ObservableBaseInterface, o_, ObservableBaseInterface_GetOwner) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ObservableBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ObservableBaseInterface>() : PRIVATE_MAXON_VTABLE(ObservableBaseInterface, o_); 
...
struct ObservableStaticInterface::MTable
{
	...
	{
		tbl->_ObservableStaticInterface_GetOrAllocClass = &IMPL::_ObservableStaticInterface_GetOrAllocClass;
	}
};

template <typename C> class ObservableStaticInterface::Wrapper
{
public:
