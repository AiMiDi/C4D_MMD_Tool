#if 1
struct ReadArchiveInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ReadArchiveInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(ReadArchiveInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class ReadArchiveRef;

struct ReadArchiveInterface::ReferenceClassHelper { using type = ReadArchiveRef; };

/// Intermediate helper class for ReadArchiveInterface.
template <typename S> class ReadArchiveInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ReadArchiveInterface::ConstReferenceFunctionsImplDoxy : public ReadArchiveInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for ReadArchiveInterface.
template <typename S> class ReadArchiveInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ReadArchiveInterface::ReferenceFunctionsImplDoxy : public ReadArchiveInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for ReadArchiveInterface.
template <typename S> class ReadArchiveInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ReadArchiveInterface::COWReferenceFunctionsImplDoxy : public ReadArchiveInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct ReadArchiveInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class ReadArchiveInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<ReadArchiveRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ReadArchiveInterface, maxon::StrongRefHandler, ReadArchiveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ReadArchiveInterface, maxon::StrongRefHandler, ReadArchiveRef>>>>);
...
///
class ReadArchiveRef : public ReadArchiveInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(ReadArchiveRef, Reference);
};

struct WriteArchiveInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, WriteArchiveInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(WriteArchiveInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class WriteArchiveRef;

struct WriteArchiveInterface::ReferenceClassHelper { using type = WriteArchiveRef; };

/// Intermediate helper class for WriteArchiveInterface.
template <typename S> class WriteArchiveInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class WriteArchiveInterface::ConstReferenceFunctionsImplDoxy : public WriteArchiveInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for WriteArchiveInterface.
template <typename S> class WriteArchiveInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class WriteArchiveInterface::ReferenceFunctionsImplDoxy : public WriteArchiveInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for WriteArchiveInterface.
template <typename S> class WriteArchiveInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class WriteArchiveInterface::COWReferenceFunctionsImplDoxy : public WriteArchiveInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct WriteArchiveInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class WriteArchiveInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<WriteArchiveRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<WriteArchiveInterface, maxon::StrongRefHandler, WriteArchiveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<WriteArchiveInterface, maxon::StrongRefHandler, WriteArchiveRef>>>>);
	using NonConst = Super::ReferenceClass;
};
...
///
class WriteArchiveRef : public WriteArchiveInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(WriteArchiveRef, Reference);
};
