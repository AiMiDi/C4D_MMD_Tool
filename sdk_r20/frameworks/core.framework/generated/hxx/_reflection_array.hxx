...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_ArrayFactory(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ArrayFactory::MTable::_instance._ArrayFactory_NewBaseArray)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ArrayFactory::MTable::_instance._ArrayFactory_NewBlockArray)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
		};
