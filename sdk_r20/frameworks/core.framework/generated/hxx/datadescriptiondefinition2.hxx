...
struct DataDescriptionDefinitionInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetInfo))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetInfo), W, MTable>::type::_DataDescriptionDefinitionInterface_GetInfo;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, SetInfo))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, SetInfo), W, MTable>::type::_DataDescriptionDefinitionInterface_SetInfo;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetEntryCount))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetEntryCount), W, MTable>::type::_DataDescriptionDefinitionInterface_GetEntryCount;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetEntries))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetEntries), W, MTable>::type::_DataDescriptionDefinitionInterface_GetEntries;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, GetEntry), W, MTable>::type::_DataDescriptionDefinitionInterface_GetEntry;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, FindEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, FindEntry), W, MTable>::type::_DataDescriptionDefinitionInterface_FindEntry;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, AddEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, AddEntry), W, MTable>::type::_DataDescriptionDefinitionInterface_AddEntry;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, ReplaceEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, ReplaceEntry), W, MTable>::type::_DataDescriptionDefinitionInterface_ReplaceEntry;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, ReplaceEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, ReplaceEntry), W, MTable>::type::_DataDescriptionDefinitionInterface_ReplaceEntry_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, EraseEntry))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, EraseEntry), W, MTable>::type::_DataDescriptionDefinitionInterface_EraseEntry;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, Reset))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDescriptionDefinitionInterface, Reset), W, MTable>::type::_DataDescriptionDefinitionInterface_Reset;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DataDescriptionDefinitionInterface, ObserverObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DataDescriptionDefinitionInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct DataDescriptionDefinitionInterface::StaticMTable
{
...
template <typename S> class DataDescriptionDefinitionInterface::Wrapper : public ObserverObjectInterface::Wrapper<S>
{
public:
...
{
	return StaticMTable::_instance._DataDescriptionDefinitionInterface_MergeDescriptionDefinition(target, source, overwriteIncludes, skipIncludes);
}
...
{
	return StaticMTable::_instance._DataDescriptionDefinitionInterface_GetDataDefaults(dataEntry);
}
...
{
	return StaticMTable::_instance._DataDescriptionDefinitionInterface_GetDataValueOrDefaults(dataId, dataEntry, flags, getDataCallback);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Create() -> DataDescriptionDefinitionInterface*
{
	return StaticMTable::_instance._DataDescriptionDefinitionInterface_Create();
}
...
{
	return StaticMTable::_instance._DataDescriptionDefinitionInterface_NullValuePtr();
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::GetInfo() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<DataDictionary>, DataDictionary>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<DataDictionary>, DataDictionary>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionInterface* o_ = (const DataDescriptionDefinitionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<DataDictionary>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_GetInfo) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ReferenceFunctionsImpl<S>::SetInfo(const DataDictionary& info) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionInterface* o_ = (DataDescriptionDefinitionInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_SetInfo) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::COWReferenceFunctionsImpl<S>::SetInfo(const DataDictionary& info) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionInterface* o_ = (DataDescriptionDefinitionInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_SetInfo) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
	return (mt_._DataDescriptionDefinitionInterface_SetInfo(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DataDescriptionDefinitionInterface_SetInfo_Offset, info));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::GetEntryCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionInterface* o_ = (const DataDescriptionDefinitionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_GetEntryCount) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::GetEntries() const -> Result<BaseArray<DataDescriptionEntry>>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BaseArray<DataDescriptionEntry>>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionInterface* o_ = (const DataDescriptionDefinitionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_GetEntries) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::GetEntry(Int idx) const -> Result<DataDescriptionEntry>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<DataDescriptionEntry>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDescriptionDefinitionInterface* o_ = (const DataDescriptionDefinitionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDescriptionDefinitionInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_GetEntry) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::FindEntry(const InternedId& id) const -> Result<DataDescriptionEntry>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ReferenceFunctionsImpl<S>::AddEntry(const DataDescriptionEntry& props) const -> Result<Int>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Int>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionInterface* o_ = (DataDescriptionDefinitionInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_AddEntry) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::COWReferenceFunctionsImpl<S>::AddEntry(const DataDescriptionEntry& props) -> Result<Int>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Int>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionInterface* o_ = (DataDescriptionDefinitionInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_AddEntry) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
	return (mt_._DataDescriptionDefinitionInterface_AddEntry(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DataDescriptionDefinitionInterface_AddEntry_Offset, props));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ReferenceFunctionsImpl<S>::ReplaceEntry(const DataDescriptionEntry& props) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::COWReferenceFunctionsImpl<S>::ReplaceEntry(const DataDescriptionEntry& props) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ReferenceFunctionsImpl<S>::ReplaceEntry(Int idx, const DataDescriptionEntry& props) const -> Result<Bool>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Bool>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionInterface* o_ = (DataDescriptionDefinitionInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_ReplaceEntry_1) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::COWReferenceFunctionsImpl<S>::ReplaceEntry(Int idx, const DataDescriptionEntry& props) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ReferenceFunctionsImpl<S>::EraseEntry(Int idx) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::COWReferenceFunctionsImpl<S>::EraseEntry(Int idx) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDescriptionDefinitionInterface* o_ = (DataDescriptionDefinitionInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDescriptionDefinitionInterface, o_, DataDescriptionDefinitionInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDescriptionDefinitionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDescriptionDefinitionInterface>() : PRIVATE_MAXON_VTABLE(DataDescriptionDefinitionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::COWReferenceFunctionsImpl<S>::Reset() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::MergeDescriptionDefinition(DataDescriptionDefinition& target, const DataDescriptionDefinition& source, Bool overwriteIncludes, Bool skipIncludes) -> Result<void> { return (StaticMTable::_instance._DataDescriptionDefinitionInterface_MergeDescriptionDefinition(target, source, overwriteIncludes, skipIncludes)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::GetDataDefaults(const DataDictionary& dataEntry) -> Result<Data> { return (StaticMTable::_instance._DataDescriptionDefinitionInterface_GetDataDefaults(dataEntry)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::GetDataValueOrDefaults(const InternedId& dataId, const DataDictionary& dataEntry, GETDATAFLAGS flags, const GetDataCallbackType& getDataCallback) -> Result<Data> { return (StaticMTable::_instance._DataDescriptionDefinitionInterface_GetDataValueOrDefaults(dataId, dataEntry, flags, getDataCallback)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::Create() -> DataDescriptionDefinition { return DataDescriptionDefinition(StaticMTable::_instance._DataDescriptionDefinitionInterface_Create()); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::ConstReferenceFunctionsImpl<S>::NullValuePtr() -> const DataDescriptionDefinitionInterface* { return (StaticMTable::_instance._DataDescriptionDefinitionInterface_NullValuePtr()); }
