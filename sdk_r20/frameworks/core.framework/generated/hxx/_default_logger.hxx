...
class MyLoggerTypeImpl : public Component<MyLoggerTypeImpl, LoggerTypeInterface>
{
	MAXON_COMPONENT();
...
class MyFileLoggerTypeImpl : public Component<MyFileLoggerTypeImpl, FileLoggerTypeInterface>
{
	MAXON_COMPONENT();
...
class MyUserLoggerTypeImpl : public Component<MyUserLoggerTypeImpl, UserLoggerTypeInterface>
{
	MAXON_COMPONENT();
