...
class MyDataDictionaryObjectImpl : public Component<MyDataDictionaryObjectImpl, DataDictionaryObjectInterface>
{
	MAXON_COMPONENT();
...
class MyDataDictionaryReferenceObjectImpl : public Component<MyDataDictionaryReferenceObjectImpl, DataDictionaryReferenceObjectInterface>
{
	MAXON_COMPONENT();
