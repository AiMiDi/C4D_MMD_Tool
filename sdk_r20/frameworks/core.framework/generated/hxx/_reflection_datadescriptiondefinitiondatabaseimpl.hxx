...
namespace maxon
{
	...
	class DataDescriptionDefinitionDatabaseImplInterface::ProxyComponent : public maxon::Component<DataDescriptionDefinitionDatabaseImplInterface::ProxyComponent, DataDescriptionDefinitionDatabaseImplInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Bool Contains(const Id& category, const IdAndVersion& dataType, const LanguageRef& language) const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<DataDescriptionDefinitionDatabaseImplInterface>();
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_Contains, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const Id&, const IdAndVersion&, const LanguageRef&>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_Contains));
			return proxy_result;
		}
		...
		Result<DataDescriptionDefinition> LoadDescription(LOADDESCRIPTIONMODE mode, const Id& category, const LanguageRef& language, const IdAndVersion& dataType, Id* foundInDatabase) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_LoadDescription, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataDescriptionDefinition>, const maxon::GenericComponent*, LOADDESCRIPTIONMODE, const Id&, const LanguageRef&, const IdAndVersion&, Id*>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_LoadDescription));
			return proxy_result;
		}
		...
		Result<Tuple<Bool, DataDescriptionDefinition*>> StoreDescription(const Id& databaseId, const Id& category, const LanguageRef& language, const IdAndVersion& dataType, const DataDescriptionDefinition& description, const DataDescriptionDefinition& overwrittenDescription, Bool usePendingSystem) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_StoreDescription, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Tuple<Bool, DataDescriptionDefinition*>>, maxon::GenericComponent*, const Id&, const Id&, const LanguageRef&, const IdAndVersion&, const DataDescriptionDefinition&, const DataDescriptionDefinition&, Bool>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_StoreDescription));
			return proxy_result;
		}
		...
		Result<Bool> DeleteDescription(const Id& category, const LanguageRef& language, const IdAndVersion& dataType) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_DeleteDescription, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, const Id&, const LanguageRef&, const IdAndVersion&>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_DeleteDescription));
			return proxy_result;
		}
		...
		Result<BaseArray<IdAndVersion>> GetRegisteredDescriptions(const Id& category, const LanguageRef& language) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredDescriptions, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<IdAndVersion>>, const maxon::GenericComponent*, const Id&, const LanguageRef&>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredDescriptions));
			return proxy_result;
		}
		...
		Result<BaseArray<LanguageRef>> GetRegisteredLanguages() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredLanguages, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<LanguageRef>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredLanguages));
			return proxy_result;
		}
		...
		Result<void> WriteDataBases() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_WriteDataBases, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_WriteDataBases));
			return proxy_result;
		}
		...
		Result<Int> RenameId(const Id& oldId, const Id& newId) 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_RenameId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int>, maxon::GenericComponent*, const Id&, const Id&>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_RenameId));
			return proxy_result;
		}
		...
		Result<DataDescription> UpdateDescriptions(const Id& category, const IdAndVersion& dataTypeId, const LanguageRef& language) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_UpdateDescriptions, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<DataDescription>, const maxon::GenericComponent*, const Id&, const IdAndVersion&, const LanguageRef&>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_UpdateDescriptions));
			return proxy_result;
		}
		...
		Bool IsWritableDatabase(const Id& languageId) const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_IsWritableDatabase, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const Id&>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_IsWritableDatabase));
			return proxy_result;
		}
		...
		Int GetChangeCount() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_GetChangeCount));
			return proxy_result;
		}
		...
		Result<void> Write() const 
		{
			...
			(*handler_)(_fn_DataDescriptionDefinitionDatabaseImplInterface_Write, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DataDescriptionDefinitionDatabaseImplInterface_Write));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DataDescriptionDefinitionDatabaseImplInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_DataDescriptionDefinitionDatabaseImplInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 84LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_Contains),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 2384LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_LoadDescription),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 1364LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_StoreDescription),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_DeleteDescription),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 20LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_GetRegisteredDescriptions),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_RenameId),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_RenameAttribute),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_CheckUniqueAttributeName),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 84LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_UpdateDescriptions),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, DataDescriptionDefinitionDatabaseImplInterface, _DataDescriptionDefinitionDatabaseImplInterface_IsWritableDatabase),
