...
struct JobQueueInterface::ReferenceClassHelper { using type = JobQueueRef; };

/// Intermediate helper class for JobQueueInterface.
template <typename S> class JobQueueInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class JobQueueInterface::ConstReferenceFunctionsImplDoxy : public JobQueueInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for JobQueueInterface.
template <typename S> class JobQueueInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class JobQueueInterface::ReferenceFunctionsImplDoxy : public JobQueueInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for JobQueueInterface.
template <typename S> class JobQueueInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class JobQueueInterface::COWReferenceFunctionsImplDoxy : public JobQueueInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct JobQueueInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class JobQueueInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<JobQueueRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<JobQueueInterface, maxon::StrongRefHandler, JobQueueRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<JobQueueInterface, maxon::StrongRefHandler, JobQueueRef>>>>);
