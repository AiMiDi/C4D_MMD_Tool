...
class MyDataSerializeImpl : public Component<MyDataSerializeImpl, DataSerializeInterface>
{
	MAXON_COMPONENT();
...
class MyDataSerializeWriterImpl : public Component<MyDataSerializeWriterImpl, DataSerializeWriterInterface>
{
	MAXON_COMPONENT();
...
class MyDataSerializeReaderImpl : public Component<MyDataSerializeReaderImpl, DataSerializeReaderInterface>
{
	MAXON_COMPONENT();
