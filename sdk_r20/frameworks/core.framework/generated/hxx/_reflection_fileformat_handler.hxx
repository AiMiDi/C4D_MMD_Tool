...
namespace maxon
{
	...
	class FileFormatHandlerInterface::ProxyComponent : public maxon::Component<FileFormatHandlerInterface::ProxyComponent, FileFormatHandlerInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		const FileFormat& GetFileFormat() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<FileFormatHandlerInterface>();
			...
			(*handler_)(_fn_FileFormatHandlerInterface_GetFileFormat, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const FileFormat&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._FileFormatHandlerInterface_GetFileFormat));
			return *proxy_result;
		}
		static const maxon::reflection::Function* _fn_FileFormatHandlerInterface_GetFileFormat;
		Result<const DataType*> GetHandlerType() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_FileFormatHandlerInterface_GetHandlerType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<const DataType*>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._FileFormatHandlerInterface_GetHandlerType));
			return proxy_result;
		}
		...
		Result<ObjectRef> CreateHandler(const Url& url) const 
		{
			...
			(*handler_)(_fn_FileFormatHandlerInterface_CreateHandler, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<ObjectRef>, const maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_._FileFormatHandlerInterface_CreateHandler));
			return proxy_result;
		}
		...
		FILEFORMAT_PRIORITY GetDependends() const 
		{
			...
			(*handler_)(_fn_FileFormatHandlerInterface_GetDependends, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<FILEFORMAT_PRIORITY, const maxon::GenericComponent*>::Invoke, (const void*) mt_._FileFormatHandlerInterface_GetDependends));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(FileFormatHandlerInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_FileFormatHandlerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, FileFormatHandlerInterface, _FileFormatHandlerInterface_CreateHandler),
...
#ifndef MAXON_COMPILER_CLANG
#endif
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(FileFormatDetectionInterface::MTable::_instance._FileFormatDetectionInterface_DetectAll)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 21LL, nullptr),
		};
