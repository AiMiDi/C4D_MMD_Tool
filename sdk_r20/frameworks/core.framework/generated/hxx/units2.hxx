...
struct DimensionInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, GetId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, GetId), W, MTable>::type::_DimensionInterface_GetId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, operatorMul))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, operatorMul), W, MTable>::type::_DimensionInterface_operatorMul;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, operatorDiv))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, operatorDiv), W, MTable>::type::_DimensionInterface_operatorDiv;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, operatorXor))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, operatorXor), W, MTable>::type::_DimensionInterface_operatorXor;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, Copy))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, Copy), W, MTable>::type::_DimensionInterface_Copy;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, GetExponent))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, GetExponent), W, MTable>::type::_DimensionInterface_GetExponent;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, AddUnit))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, AddUnit), W, MTable>::type::_DimensionInterface_AddUnit;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, GetUnits))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, GetUnits), W, MTable>::type::_DimensionInterface_GetUnits;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, IsEquivalent))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, IsEquivalent), W, MTable>::type::_DimensionInterface_IsEquivalent;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, ToString))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DimensionInterface, ToString), W, MTable>::type::_DimensionInterface_ToString;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DimensionInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DimensionInterface);
#ifdef MAXON_COMPILER_INTEL
	struct NVMTable;
#else
	using NVMTable = CombinedMTable<maxon::CombinedMTableRoot>;
#endif
	static NVMTable _nonvirtual;
	template <typename I> static const typename I::MTable& GetMTable() { return _nonvirtual.GetMTable<I>(); }
};

#ifdef MAXON_COMPILER_INTEL
struct DimensionInterface::MTable::NVMTable : public DimensionInterface::MTable::CombinedMTable<maxon::CombinedMTableRoot> { };
#endif

struct DimensionInterface::StaticMTable
{
...
template <typename S> class DimensionInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
{
	return StaticMTable::_instance._DimensionInterface_Get(q);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::GetId() const -> const Id&
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_GetId((const maxon::GenericComponent*) this + mt_._DimensionInterface_GetId_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::operator *(const Result<Dimension>& q) const -> Result<Dimension>
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_operatorMul((const maxon::GenericComponent*) this + mt_._DimensionInterface_operatorMul_Offset, q);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::operator /(const Result<Dimension>& q) const -> Result<Dimension>
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_operatorDiv((const maxon::GenericComponent*) this + mt_._DimensionInterface_operatorDiv_Offset, q);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::operator ^(Int exponent) const -> Result<Dimension>
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_operatorXor((const maxon::GenericComponent*) this + mt_._DimensionInterface_operatorXor_Offset, exponent);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Copy(const Id& qid) const -> Result<Dimension>
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_Copy((const maxon::GenericComponent*) this + mt_._DimensionInterface_Copy_Offset, qid);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::GetExponent(BASE_DIMENSION q) const -> Int
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_GetExponent((const maxon::GenericComponent*) this + mt_._DimensionInterface_GetExponent_Offset, q);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::AddUnit(const Id& unitId, Float siConversionFactor) const -> Result<Unit>
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_AddUnit((const maxon::GenericComponent*) this + mt_._DimensionInterface_AddUnit_Offset, unitId, siConversionFactor);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::GetUnits() const -> UnitsArray
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_GetUnits((const maxon::GenericComponent*) this + mt_._DimensionInterface_GetUnits_Offset);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::IsEquivalent(const Dimension& other) const -> Bool
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_IsEquivalent((const maxon::GenericComponent*) this + mt_._DimensionInterface_IsEquivalent_Offset, other);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ToString(const FormatStatement* fs) const -> String
{
	const DimensionInterface::MTable& mt_ = MTable::_nonvirtual.mtable; return mt_._DimensionInterface_ToString((const maxon::GenericComponent*) this + mt_._DimensionInterface_ToString_Offset, fs);
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ConstReferenceFunctionsImpl<S>::Get(BASE_DIMENSION q) -> const Dimension& { return (StaticMTable::_instance._DimensionInterface_Get(q)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ConstReferenceFunctionsImpl<S>::GetId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DimensionInterface* o_ = (const DimensionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DimensionInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const Id&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DimensionInterface, o_, DimensionInterface_GetId) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DimensionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DimensionInterface>() : PRIVATE_MAXON_VTABLE(DimensionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ConstReferenceFunctionsImpl<S>::operator ^(Int exponent) const -> Result<Dimension>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ConstReferenceFunctionsImpl<S>::Copy(const Id& qid) const -> Result<Dimension>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ConstReferenceFunctionsImpl<S>::IsEquivalent(const Dimension& other) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* fs) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
struct UnitInterface::MTable
{
	...
	{
		tbl->_UnitInterface_Free = &IMPL::_UnitInterface_Free;
		tbl->_UnitInterface_GetId = &IMPL::_UnitInterface_GetId;
		tbl->_UnitInterface_GetDimension = &IMPL::_UnitInterface_GetDimension;
		tbl->_UnitInterface_GetSIConversionFactor = &IMPL::_UnitInterface_GetSIConversionFactor;
		tbl->_UnitInterface_operatorMul = &IMPL::_UnitInterface_operatorMul;
		tbl->_UnitInterface_operatorDiv = &IMPL::_UnitInterface_operatorDiv;
		tbl->_UnitInterface_operatorXor = &IMPL::_UnitInterface_operatorXor;
		tbl->_UnitInterface_Copy = &IMPL::_UnitInterface_Copy;
		tbl->_UnitInterface_Copy_1 = &IMPL::_UnitInterface_Copy_1;
		tbl->_UnitInterface_AddToDimension = &IMPL::_UnitInterface_AddToDimension;
		tbl->_UnitInterface_Reduce = &IMPL::_UnitInterface_Reduce;
		tbl->_UnitInterface_ToString = &IMPL::_UnitInterface_ToString;
	}
};

template <typename C> class UnitInterface::Wrapper
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::GetId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const Id&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (MTable::_instance._UnitInterface_GetId(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::GetDimension() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Dimension&>, const Dimension&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Dimension&>, const Dimension&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const Dimension&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (MTable::_instance._UnitInterface_GetDimension(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::GetSIConversionFactor() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Float>, Float>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Float>, Float>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return 0; } 
	return (MTable::_instance._UnitInterface_GetSIConversionFactor(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::operator *(const Result<Unit>& u) const -> Result<Unit>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Unit>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::operator ^(Int exponent) const -> Result<Unit>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Unit>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UnitInterface_operatorXor(o_, exponent));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::Copy(const Id& uid) const -> Result<Unit>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Unit>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UnitInterface_Copy(o_, uid));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::Copy(const Dimension& quantity) const -> Result<Unit>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Unit>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UnitInterface_Copy_1(o_, quantity));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::AddToDimension() const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UnitInterface_AddToDimension(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::Reduce() const -> Result<Unit>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Unit>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const UnitInterface* o_ = (const UnitInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = UnitInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (MTable::_instance._UnitInterface_Reduce(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* fs) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
