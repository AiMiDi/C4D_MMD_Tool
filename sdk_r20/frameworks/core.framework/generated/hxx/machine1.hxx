#if 1
struct MachineInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MachineInterface>::value || ObserverObjectInterface::HasBase::Check<I>::value; static I* Cast(MachineInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class MachineRef;

struct MachineInterface::ReferenceClassHelper { using type = MachineRef; };

/// Intermediate helper class for MachineInterface.
template <typename S> class MachineInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class MachineInterface::ConstReferenceFunctionsImplDoxy : public MachineInterface::ConstReferenceFunctionsImpl<REF>, public ObserverObjectInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for MachineInterface.
template <typename S> class MachineInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class MachineInterface::ReferenceFunctionsImplDoxy : public MachineInterface::ReferenceFunctionsImpl<REF>, public ObserverObjectInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for MachineInterface.
template <typename S> class MachineInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class MachineInterface::COWReferenceFunctionsImplDoxy : public MachineInterface::COWReferenceFunctionsImpl<REF>, public ObserverObjectInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct MachineInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ObserverObjectInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ObserverObjectInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename ObserverObjectInterface::ReferenceFunctions<ST>::type>>::type>::type; };
class MachineInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<MachineRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<MachineInterface, maxon::StrongRefHandler, MachineRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<MachineInterface, maxon::StrongRefHandler, MachineRef>>>>);
...
class MachineRef : public MachineInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(MachineRef, Reference);
};
