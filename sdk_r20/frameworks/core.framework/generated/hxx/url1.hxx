...
struct UrlInterface::ReferenceClassHelper { using type = Url; };

/// Intermediate helper class for UrlInterface.
template <typename S> class UrlInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class UrlInterface::ConstReferenceFunctionsImplDoxy : public UrlInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for UrlInterface.
template <typename S> class UrlInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class UrlInterface::ReferenceFunctionsImplDoxy : public UrlInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for UrlInterface.
template <typename S> class UrlInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class UrlInterface::COWReferenceFunctionsImplDoxy : public UrlInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct UrlInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class UrlInterface::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<Url>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const UrlInterface, maxon::StrongCOWRefHandler, Url>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const UrlInterface, maxon::StrongCOWRefHandler, Url>>>>);
	using NonConst = NonConstRef;
	static MAXON_ATTRIBUTE_FORCE_INLINE maxon::ResultMemT<Url> Create();
};

class UrlInterface::NonConstRef :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<UrlInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<UrlInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
};
