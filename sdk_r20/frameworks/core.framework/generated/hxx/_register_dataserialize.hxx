...
namespace maxon
{
	...
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataSerializeInterface, "net.maxon.interface.dataserialize", "maxon.DataSerializeInterface", , &Object::_interface);
	const maxon::Char* const DataSerializeInterface::MTable::_ids = 
		"DescribeElement@877c23a9dcd71239\0" // DescribeElement(const Char* name, const DataType* dt, Int objectOffset, KeyValueConversionFunc* func, DESCRIBEFLAGS flags, UInt64 mask, UInt64 value) const
		"PrepareHelperClass@7e3c15422a34f012\0" // PrepareHelperClass(CreateIoHelperFunc* createFunc, DeleteIoHelperFunc* deleteFunc, ReadIoHelperFunc* readFunc, WriteIoHelperFunc* writeFunc, PREPAREHELPERFLAGS flags) const
		"RegisterObjectSubstitution@d2f84113c1d53ae8\0" // RegisterObjectSubstitution(ReferenceSubstitutionFunction&& func)
		"RegisterDefaults@588529f357742be5\0" // RegisterDefaults(CreateIoHelperFunc* createFunc, DeleteIoHelperFunc* deleteFunc) const
	"";
	template <typename DUMMY> maxon::Int DataSerializeInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataSerializeWriterInterface, "net.maxon.interface.dataserializewriter", "maxon.DataSerializeWriterInterface", , &DataSerializeInterface::_interface);
	const maxon::Char* const DataSerializeWriterInterface::MTable::_ids = 
		"WriteDocument@8379acb55f0fa3f2\0" // WriteDocument(const Id& id, const ConstDataPtr& data)
	"";
	template <typename DUMMY> maxon::Int DataSerializeWriterInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataSerializeReaderInterface, "net.maxon.interface.dataserializereader", "maxon.DataSerializeReaderInterface", , &DataSerializeInterface::_interface);
	const maxon::Char* const DataSerializeReaderInterface::MTable::_ids = 
		"ReadDocument@018a3d9dc2151ff5\0" // ReadDocument(const Id& id, const DataPtr& data)
	"";
	template <typename DUMMY> maxon::Int DataSerializeReaderInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
...
#endif
static maxon::details::ForceEvaluation s_forceEval_dataserialize(0
	| maxon::DataSerializeInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
	| maxon::DataSerializeWriterInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
	| maxon::DataSerializeReaderInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
