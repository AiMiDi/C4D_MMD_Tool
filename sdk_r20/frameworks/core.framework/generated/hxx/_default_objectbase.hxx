...
class MyObjectImpl : public Component<MyObjectImpl, Object>
{
	MAXON_COMPONENT();
...
public:
	...
	MAXON_METHOD Bool IsEqual(const maxon::Object* other) const
	{
...
class MyErrorImpl : public Component<MyErrorImpl, ErrorInterface>
{
	MAXON_COMPONENT();
