...
/// @endcond
	...
	{
		tbl->_JobQueueInterface_Free = &IMPL::_JobQueueInterface_Free;
		tbl->_JobQueueInterface_Alloc = &IMPL::_JobQueueInterface_Alloc;
		tbl->_JobQueueInterface_GetThreadCount = &IMPL::_JobQueueInterface_GetThreadCount;
		tbl->_JobQueueInterface_GetThreadCount_1 = &IMPL::_JobQueueInterface_GetThreadCount_1;
		tbl->_JobQueueInterface_Cancel = &IMPL::_JobQueueInterface_Cancel;
		tbl->_JobQueueInterface_CancelAndWait = &IMPL::_JobQueueInterface_CancelAndWait;
		tbl->_JobQueueInterface_GetDestinationQueue = &IMPL::_JobQueueInterface_GetDestinationQueue;
		tbl->_JobQueueInterface_SetDestinationQueue = &IMPL::_JobQueueInterface_SetDestinationQueue;
		tbl->_JobQueueInterface_GetMainThreadQueue = &IMPL::_JobQueueInterface_GetMainThreadQueue;
		tbl->_JobQueueInterface_GetServiceIOQueue = &IMPL::_JobQueueInterface_GetServiceIOQueue;
/// @cond IGNORE

		tbl->_JobQueueInterface_ExecuteJobs = &IMPL::_JobQueueInterface_ExecuteJobs;
/// @endcond

	}
};

template <typename C> class JobQueueInterface::Wrapper
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ConstReferenceFunctionsImpl<S>::GetThreadCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const JobQueueInterface* o_ = (const JobQueueInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = JobQueueInterface::NullValuePtr(); if (!o_) return 0; } 
	return (MTable::_instance._JobQueueInterface_GetThreadCount(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ConstReferenceFunctionsImpl<S>::GetThreadCount(JobQueueInterface* queue, Int maxWaitSessionLevel) -> Int { return (MTable::_instance._JobQueueInterface_GetThreadCount_1(queue, maxWaitSessionLevel)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ReferenceFunctionsImpl<S>::Cancel(UInt ownerId) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); JobQueueInterface* o_ = (JobQueueInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	MTable::_instance._JobQueueInterface_Cancel(o_, ownerId);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ReferenceFunctionsImpl<S>::CancelAndWait(UInt ownerId) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); JobQueueInterface* o_ = (JobQueueInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
	MTable::_instance._JobQueueInterface_CancelAndWait(o_, ownerId);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ConstReferenceFunctionsImpl<S>::GetDestinationQueue() -> JobQueueRef { return JobQueueRef(MTable::_instance._JobQueueInterface_GetDestinationQueue()); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ConstReferenceFunctionsImpl<S>::SetDestinationQueue(JobQueueInterface* queue) -> Result<void> { return (MTable::_instance._JobQueueInterface_SetDestinationQueue(queue)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ConstReferenceFunctionsImpl<S>::GetMainThreadQueue() -> JobQueueRef { return JobQueueRef(MTable::_instance._JobQueueInterface_GetMainThreadQueue()); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ConstReferenceFunctionsImpl<S>::GetServiceIOQueue() -> ServiceIOJobQueueInterface* { return (MTable::_instance._JobQueueInterface_GetServiceIOQueue()); }
/// @cond IGNORE

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto JobQueueInterface::ReferenceFunctionsImpl<S>::ExecuteJobs(TimeValue timeout) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); JobQueueInterface* o_ = (JobQueueInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); 
