...
struct DataDictionaryObjectInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, SetData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, SetData), W, MTable>::type::_DataDictionaryObjectInterface_SetData;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, GetData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, GetData), W, MTable>::type::_DataDictionaryObjectInterface_GetData;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, EraseData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, EraseData), W, MTable>::type::_DataDictionaryObjectInterface_EraseData;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, Reset))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, Reset), W, MTable>::type::_DataDictionaryObjectInterface_Reset;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, IsEmpty))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, IsEmpty), W, MTable>::type::_DataDictionaryObjectInterface_IsEmpty;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, InitIterator))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryObjectInterface, InitIterator), W, MTable>::type::_DataDictionaryObjectInterface_InitIterator;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DataDictionaryObjectInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DataDictionaryObjectInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class DataDictionaryObjectInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::COWReferenceFunctionsImpl<S>::SetData(ForwardingDataPtr&& key, Data&& data) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ReferenceFunctionsImpl<S>::SetData(ForwardingDataPtr&& key, const Data& data) const -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, true, maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryObjectInterface* o_ = (DataDictionaryObjectInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR)); 
	auto res_ = o_->SetData(std::forward<ForwardingDataPtr>(key), data);
	return ReturnHelper::Return(this, res_.GetErrorStorage());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::COWReferenceFunctionsImpl<S>::SetData(ForwardingDataPtr&& key, const Data& data) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::GetData(const ConstDataPtr& key) const -> Result<Data>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<Data>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDictionaryObjectInterface, o_, DataDictionaryObjectInterface_GetData) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDictionaryObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDictionaryObjectInterface>() : PRIVATE_MAXON_VTABLE(DataDictionaryObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::COWReferenceFunctionsImpl<S>::EraseData(const ConstDataPtr& key) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryObjectInterface* o_ = (DataDictionaryObjectInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDictionaryObjectInterface, o_, DataDictionaryObjectInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDictionaryObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDictionaryObjectInterface>() : PRIVATE_MAXON_VTABLE(DataDictionaryObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::COWReferenceFunctionsImpl<S>::Reset() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::IsEmpty() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return true; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDictionaryObjectInterface, o_, DataDictionaryObjectInterface_IsEmpty) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDictionaryObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDictionaryObjectInterface>() : PRIVATE_MAXON_VTABLE(DataDictionaryObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::IsPopulated() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION DataDictionaryObjectInterface::IsPopulated on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
	return (o_->IsPopulated());
}
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::Get(KEY&& key) const -> Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION DataDictionaryObjectInterface::Get on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->Get<typename S::ReferenceClass, T, KEY>(std::forward<KEY>(key)));
}
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::Get(KEY&& key, const T& defaultValue) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION DataDictionaryObjectInterface::Get on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->Get<typename S::ReferenceClass, T, KEY>(std::forward<KEY>(key), defaultValue));
}
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::Get(KEY&& key, T&& defaultValue) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>, typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION DataDictionaryObjectInterface::Get on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<typename std::conditional<IsFidClass<KEY>::value, typename IsFidClass<KEY>::type, T>::type>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->Get<typename S::ReferenceClass, T, KEY>(std::forward<KEY>(key), std::forward<T>(defaultValue)));
}
template <typename S> template <typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::GetOrDefault(KEY&& key) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<typename IsFidClass<KEY>::type>, typename IsFidClass<KEY>::type>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<typename IsFidClass<KEY>::type>, typename IsFidClass<KEY>::type>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION DataDictionaryObjectInterface::GetOrDefault on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<typename IsFidClass<KEY>::type>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->GetOrDefault<KEY>(std::forward<KEY>(key)));
}
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ReferenceFunctionsImpl<S>::Set(KEY&& key, T&& data) const -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, true, maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryObjectInterface* o_ = (DataDictionaryObjectInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR)); 
	auto res_ = o_->Set<typename S::ReferenceClass, T, KEY>(std::forward<KEY>(key), std::forward<T>(data));
	return ReturnHelper::Return(this, res_.GetErrorStorage());
}
template <typename S> template <typename T, typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::COWReferenceFunctionsImpl<S>::Set(KEY&& key, T&& data) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
...
template <typename S> template <typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ReferenceFunctionsImpl<S>::Erase(KEY&& key) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryObjectInterface* o_ = (DataDictionaryObjectInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateNullReturnValue<Result<void>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); 
	return (o_->Erase<typename S::ReferenceClass, KEY>(std::forward<KEY>(key)));
}
template <typename S> template <typename KEY> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::COWReferenceFunctionsImpl<S>::Erase(KEY&& key) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::InitIterator(DataDictionaryIteratorInterface* iterator, Bool end) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDictionaryObjectInterface, o_, DataDictionaryObjectInterface_InitIterator) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDictionaryObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDictionaryObjectInterface>() : PRIVATE_MAXON_VTABLE(DataDictionaryObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::Begin() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION DataDictionaryObjectInterface::Begin on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryObjectInterface* o_ = (const DataDictionaryObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<ConstIterator>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->Begin());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryObjectInterface::ConstReferenceFunctionsImpl<S>::End() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type
{
...
struct DataDictionaryReferenceObjectInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryReferenceObjectInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryReferenceObjectInterface, Init), W, MTable>::type::_DataDictionaryReferenceObjectInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryReferenceObjectInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryReferenceObjectInterface, Init), W, MTable>::type::_DataDictionaryReferenceObjectInterface_Init_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryReferenceObjectInterface, GetDataContainer))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DataDictionaryReferenceObjectInterface, GetDataContainer), W, MTable>::type::_DataDictionaryReferenceObjectInterface_GetDataContainer;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DataDictionaryReferenceObjectInterface, DataDictionaryObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DataDictionaryReferenceObjectInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class DataDictionaryReferenceObjectInterface::Wrapper : public DataDictionaryObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryReferenceObjectInterface::ReferenceFunctionsImpl<S>::Init(DataDictionary* reference) const -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, true, maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DataDictionaryReferenceObjectInterface* o_ = (DataDictionaryReferenceObjectInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDictionaryReferenceObjectInterface, o_, DataDictionaryReferenceObjectInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDictionaryReferenceObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDictionaryReferenceObjectInterface>() : PRIVATE_MAXON_VTABLE(DataDictionaryReferenceObjectInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryReferenceObjectInterface::COWReferenceFunctionsImpl<S>::Init(DataDictionary* reference) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryReferenceObjectInterface::ReferenceFunctionsImpl<S>::Init(const DataDictionary* reference) const -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryReferenceObjectInterface::COWReferenceFunctionsImpl<S>::Init(const DataDictionary* reference) -> maxon::Result<DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDictionaryReferenceObjectInterface::ConstReferenceFunctionsImpl<S>::GetDataContainer() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataDictionary&>, const DataDictionary&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataDictionary&>, const DataDictionary&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DataDictionaryReferenceObjectInterface* o_ = (const DataDictionaryReferenceObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DataDictionaryReferenceObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const DataDictionary&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DataDictionaryReferenceObjectInterface, o_, DataDictionaryReferenceObjectInterface_GetDataContainer) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DataDictionaryReferenceObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DataDictionaryReferenceObjectInterface>() : PRIVATE_MAXON_VTABLE(DataDictionaryReferenceObjectInterface, o_); 
