...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_ResolveInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ResolveInterface::MTable::_instance._ResolveInterface_Free)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ResolveInterface::MTable::_instance._ResolveInterface_RemoveDotSegments)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, 1LL, nullptr),
		};
	...
	class IoConnectionInterface::ProxyComponent : public maxon::Component<IoConnectionInterface::ProxyComponent, IoConnectionInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		const Url& GetUrl() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<IoConnectionInterface>();
			...
			(*handler_)(_fn_IoConnectionInterface_GetUrl, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Url&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoConnectionInterface_GetUrl));
			return *proxy_result;
		}
		...
		Result<IoBrowseRef> GetBrowseIterator(GETBROWSEITERATORFLAGS flags) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_GetBrowseIterator, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<IoBrowseRef>, maxon::GenericComponent*, GETBROWSEITERATORFLAGS>::Invoke, (const void*) mt_._IoConnectionInterface_GetBrowseIterator));
			return proxy_result;
		}
		...
		Result<InputStreamRef> OpenInputStream(OPENSTREAMFLAGS flags) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_OpenInputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<InputStreamRef>, maxon::GenericComponent*, OPENSTREAMFLAGS>::Invoke, (const void*) mt_._IoConnectionInterface_OpenInputStream));
			return proxy_result;
		}
		...
		Result<OutputStreamRef> OpenOutputStream(OPENSTREAMFLAGS flags) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_OpenOutputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<OutputStreamRef>, maxon::GenericComponent*, OPENSTREAMFLAGS>::Invoke, (const void*) mt_._IoConnectionInterface_OpenOutputStream));
			return proxy_result;
		}
		...
		Result<InOutputStreamRef> OpenInOutputStream(OPENSTREAMFLAGS flags) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_OpenInOutputStream, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<InOutputStreamRef>, maxon::GenericComponent*, OPENSTREAMFLAGS>::Invoke, (const void*) mt_._IoConnectionInterface_OpenInOutputStream));
			return proxy_result;
		}
		...
		Result<Int64> GetContentLength() 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_GetContentLength, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Int64>, maxon::GenericComponent*>::Invoke, (const void*) mt_._IoConnectionInterface_GetContentLength));
			return proxy_result;
		}
		...
		IODETECT IoDetect() const 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoDetect, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<IODETECT, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoConnectionInterface_IoDetect));
			return proxy_result;
		}
		...
		Result<IOATTRIBUTES> IoGetAttributes() const 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoGetAttributes, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<IOATTRIBUTES>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._IoConnectionInterface_IoGetAttributes));
			return proxy_result;
		}
		...
		Result<void> IoSetAttributes(IOATTRIBUTES flags, IOATTRIBUTES mask) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoSetAttributes, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, IOATTRIBUTES, IOATTRIBUTES>::Invoke, (const void*) mt_._IoConnectionInterface_IoSetAttributes));
			return proxy_result;
		}
		...
		Result<UniversalDateTime> IoGetTime(IOTIMEMODE mode) const 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoGetTime, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<UniversalDateTime>, const maxon::GenericComponent*, IOTIMEMODE>::Invoke, (const void*) mt_._IoConnectionInterface_IoGetTime));
			return proxy_result;
		}
		...
		Result<void> IoSetTime(IOTIMEMODE mode, const UniversalDateTime& dateTime) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoSetTime, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, IOTIMEMODE, const UniversalDateTime&>::Invoke, (const void*) mt_._IoConnectionInterface_IoSetTime));
			return proxy_result;
		}
		...
		Result<void> IoDelete(Bool force) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoDelete, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Bool>::Invoke, (const void*) mt_._IoConnectionInterface_IoDelete));
			return proxy_result;
		}
		...
		Result<void> IoCreateDirectory(Bool createParents, BaseArray<Url>* createdDirs) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoCreateDirectory, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, Bool, BaseArray<Url>*>::Invoke, (const void*) mt_._IoConnectionInterface_IoCreateDirectory));
			return proxy_result;
		}
		...
		Result<void> IoCopyFile(const Url& destName, Bool overwrite, Bool removeReadOnly) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoCopyFile, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, Bool, Bool>::Invoke, (const void*) mt_._IoConnectionInterface_IoCopyFile));
			return proxy_result;
		}
		...
		Result<void> IoMove(const Url& destName) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoMove, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_._IoConnectionInterface_IoMove));
			return proxy_result;
		}
		...
		Result<void> IoRename(const Url& newName) 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoRename, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_._IoConnectionInterface_IoRename));
			return proxy_result;
		}
		...
		Result<void> IoGetFreeVolumeSpace(Int64& availableBytes, Int64& totalBytes) const 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoGetFreeVolumeSpace, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, Int64&, Int64&>::Invoke, (const void*) mt_._IoConnectionInterface_IoGetFreeVolumeSpace));
			return proxy_result;
		}
		...
		Result<void> IoShowInOS(IOSHOWINOSFLAGS flags) const 
		{
			...
			(*handler_)(_fn_IoConnectionInterface_IoShowInOS, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, IOSHOWINOSFLAGS>::Invoke, (const void*) mt_._IoConnectionInterface_IoShowInOS));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(IoConnectionInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_IoConnectionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_GetBrowseIterator),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_OpenInputStream),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_OpenOutputStream),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_OpenInOutputStream),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, IoConnectionInterface, _IoConnectionInterface_IoSetAttributes),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_IoGetTime),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, IoConnectionInterface, _IoConnectionInterface_IoSetTime),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_IoDelete),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 36LL, IoConnectionInterface, _IoConnectionInterface_IoCreateDirectory),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 84LL, IoConnectionInterface, _IoConnectionInterface_IoCopyFile),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_IoMove),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_IoRename),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 40LL, IoConnectionInterface, _IoConnectionInterface_IoGetFreeVolumeSpace),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, IoConnectionInterface, _IoConnectionInterface_IoShowInOS),
		};
