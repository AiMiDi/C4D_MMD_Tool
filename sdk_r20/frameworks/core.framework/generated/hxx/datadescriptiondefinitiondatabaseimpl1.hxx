#if 1
struct DataDescriptionDefinitionDatabaseImplInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataDescriptionDefinitionDatabaseImplInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(DataDescriptionDefinitionDatabaseImplInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class DataDescriptionDefinitionDatabaseImplRef;

struct DataDescriptionDefinitionDatabaseImplInterface::ReferenceClassHelper { using type = DataDescriptionDefinitionDatabaseImplRef; };

/// Intermediate helper class for DataDescriptionDefinitionDatabaseImplInterface.
template <typename S> class DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImplDoxy : public DataDescriptionDefinitionDatabaseImplInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for DataDescriptionDefinitionDatabaseImplInterface.
template <typename S> class DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImplDoxy : public DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for DataDescriptionDefinitionDatabaseImplInterface.
template <typename S> class DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImplDoxy : public DataDescriptionDefinitionDatabaseImplInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct DataDescriptionDefinitionDatabaseImplInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class DataDescriptionDefinitionDatabaseImplInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<DataDescriptionDefinitionDatabaseImplRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDescriptionDefinitionDatabaseImplInterface, maxon::StrongRefHandler, DataDescriptionDefinitionDatabaseImplRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<DataDescriptionDefinitionDatabaseImplInterface, maxon::StrongRefHandler, DataDescriptionDefinitionDatabaseImplRef>>>>);
...
class DataDescriptionDefinitionDatabaseImplRef : public DataDescriptionDefinitionDatabaseImplInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(DataDescriptionDefinitionDatabaseImplRef, Reference);
};
