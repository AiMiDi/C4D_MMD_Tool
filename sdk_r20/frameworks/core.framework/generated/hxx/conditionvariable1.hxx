...
struct ConditionVariableInterface::ReferenceClassHelper { using type = ConditionVariableRef; };

/// Intermediate helper class for ConditionVariableInterface.
template <typename S> class ConditionVariableInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ConditionVariableInterface::ConstReferenceFunctionsImplDoxy : public ConditionVariableInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for ConditionVariableInterface.
template <typename S> class ConditionVariableInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ConditionVariableInterface::ReferenceFunctionsImplDoxy : public ConditionVariableInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for ConditionVariableInterface.
template <typename S> class ConditionVariableInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class ConditionVariableInterface::COWReferenceFunctionsImplDoxy : public ConditionVariableInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct ConditionVariableInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class ConditionVariableInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<ConditionVariableRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ConditionVariableInterface, maxon::StrongRefHandler, ConditionVariableRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<ConditionVariableInterface, maxon::StrongRefHandler, ConditionVariableRef>>>>);
...
class ConditionVariableRef : public ConditionVariableInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(ConditionVariableRef, Reference);
};
