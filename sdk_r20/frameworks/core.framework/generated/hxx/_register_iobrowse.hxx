...
/// @endcond
	...
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(IoBrowseInterface, "net.maxon.interface.iobrowse", "maxon.IoBrowseInterface", , &Object::_interface);
	const maxon::Char* const IoBrowseInterface::MTable::_ids = 
/// @cond INTERNAL

		"Init@247cfc1149c71d78\0" // Init(IoConnectionInterface* connection, GETBROWSEITERATORFLAGS flags)
/// @endcond

		"GetBasePath@24368c97617cbacb\0" // GetBasePath() const
		"Reset@a54f4799cbe1a498\0" // Reset()
		"GetNext@a54f4799cbe1a498\0" // GetNext()
		"HasEntry@76f01901\0" // HasEntry() const
		"GetCurrentPath@4e33a06\0" // GetCurrentPath() const
		"IoGetFlags@fcfcd0514d74d7ee\0" // IoGetFlags() const
		"IoGetAttributes@507ff8fe2ae3e399\0" // IoGetAttributes() const
		"IoGetTime@14de2ec95d150358\0" // IoGetTime(IOTIMEMODE mode) const
		"GetSize@fd7d7f404\0" // GetSize() const
		"GetExtraData@22c6ed80868\0" // GetExtraData() const
	"";
