...
namespace maxon
{
	...
	class SystemErrorInterface::ProxyComponent : public maxon::Component<SystemErrorInterface::ProxyComponent, SystemErrorInterface>
	{
		MAXON_COMPONENT();
	public:
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(SystemErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class NSSystemErrorInterface::ProxyComponent : public maxon::Component<NSSystemErrorInterface::ProxyComponent, NSSystemErrorInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		void SetNSError(NSError* osError) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<NSSystemErrorInterface>();
		...
		NSError* GetNSError() const 
		{
			...
			(*handler_)(_fn_NSSystemErrorInterface_GetNSError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NSError*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._NSSystemErrorInterface_GetNSError));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(NSSystemErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_NSSystemErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, NSSystemErrorInterface, _NSSystemErrorInterface_SetNSError),
