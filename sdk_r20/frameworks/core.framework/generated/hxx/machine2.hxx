...
struct MachineInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetUniqueId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetUniqueId), W, MTable>::type::_MachineInterface_GetUniqueId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetMachineInfo))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetMachineInfo), W, MTable>::type::_MachineInterface_GetMachineInfo;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetInterface))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetInterface), W, MTable>::type::_MachineInterface_GetInterface;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetState))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, GetState), W, MTable>::type::_MachineInterface_GetState;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, SetState))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, SetState), W, MTable>::type::_MachineInterface_SetState;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, ToString))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, ToString), W, MTable>::type::_MachineInterface_ToString;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, ObservableMessageReceived))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MachineInterface, ObservableMessageReceived), W, MTable>::type::_MachineInterface_ObservableMessageReceived;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MachineInterface, ObserverObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MachineInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MachineInterface::Wrapper : public ObserverObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ConstReferenceFunctionsImpl<S>::GetMachineInfo() const -> Result<DataDictionary>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<DataDictionary>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MachineInterface* o_ = (const MachineInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MachineInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MachineInterface, o_, MachineInterface_GetMachineInfo) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MachineInterface>() : PRIVATE_MAXON_VTABLE(MachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ReferenceFunctionsImpl<S>::GetInterface(const Id& interfaceName) const -> Result<ObjectRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<ObjectRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MachineInterface* o_ = (MachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MachineInterface, o_, MachineInterface_GetInterface) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MachineInterface>() : PRIVATE_MAXON_VTABLE(MachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::COWReferenceFunctionsImpl<S>::GetInterface(const Id& interfaceName) -> Result<ObjectRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<ObjectRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MachineInterface* o_ = (MachineInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MachineInterface, o_, MachineInterface_GetInterface) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MachineInterface>() : PRIVATE_MAXON_VTABLE(MachineInterface, o_); 
	return (mt_._MachineInterface_GetInterface(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MachineInterface_GetInterface_Offset, interfaceName));
}
template <typename S> template <typename INTERFACE> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ReferenceFunctionsImpl<S>::GetInterface() const -> Result<INTERFACE>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<INTERFACE>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MachineInterface* o_ = (MachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateNullReturnValue<Result<INTERFACE>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); 
	return (o_->GetInterface<INTERFACE>());
}
template <typename S> template <typename INTERFACE> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::COWReferenceFunctionsImpl<S>::GetInterface() -> Result<INTERFACE>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<INTERFACE>>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION MachineInterface::GetInterface on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MachineInterface* o_ = (MachineInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); 
	return (o_->GetInterface<INTERFACE>());
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ConstReferenceFunctionsImpl<S>::GetState() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<MACHINESTATE>, MACHINESTATE>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<MACHINESTATE>, MACHINESTATE>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MachineInterface* o_ = (const MachineInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MachineInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<MACHINESTATE>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MachineInterface, o_, MachineInterface_GetState) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MachineInterface>() : PRIVATE_MAXON_VTABLE(MachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ReferenceFunctionsImpl<S>::SetState(MACHINESTATE stateMask, MACHINESTATE stateFlags) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MachineInterface* o_ = (MachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(false); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MachineInterface, o_, MachineInterface_SetState) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MachineInterface>() : PRIVATE_MAXON_VTABLE(MachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::COWReferenceFunctionsImpl<S>::SetState(MACHINESTATE stateMask, MACHINESTATE stateFlags) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Bool, maxon::Result<Bool>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* formatStatement) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ConstReferenceFunctionsImpl<S>::ObservableMessageReceived() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableMessageReceivedDelegate>>, maxon::ObservableRef<ObservableMessageReceivedDelegate>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableMessageReceivedDelegate>>, maxon::ObservableRef<ObservableMessageReceivedDelegate>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MachineInterface* o_ = (const MachineInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MachineInterface::NullValuePtr(); if (!o_) return maxon::ObservableRef<ObservableMessageReceivedDelegate>::NullValue(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MachineInterface, o_, MachineInterface_ObservableMessageReceived) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MachineInterface>() : PRIVATE_MAXON_VTABLE(MachineInterface, o_); 
...
/// @endcond
	...
	{
		tbl->_MachinesInterface_GetLocal = &IMPL::_MachinesInterface_GetLocal;
		tbl->_MachinesInterface_GetRPCMachines = &IMPL::_MachinesInterface_GetRPCMachines;
/// @cond INTERNAL

/// @endcond

		tbl->_MachinesInterface_FindRPCMachine = &IMPL::_MachinesInterface_FindRPCMachine;
/// @cond INTERNAL

/// @endcond

		tbl->_MachinesInterface_FindOrAddRPCMachine = &IMPL::_MachinesInterface_FindOrAddRPCMachine;
/// @cond INTERNAL

/// @endcond

		tbl->_MachinesInterface_RemoveRPCMachine = &IMPL::_MachinesInterface_RemoveRPCMachine;
		tbl->_MachinesInterface_ObservableMachineStateChanged = &IMPL::_MachinesInterface_ObservableMachineStateChanged;
	}
};

template <typename C> class MachinesInterface::Wrapper
{
public:
