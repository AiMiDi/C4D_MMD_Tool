...
class MyIoErrorImpl : public Component<MyIoErrorImpl, IoErrorInterface>
{
	MAXON_COMPONENT();
...
class MyFileFormatErrorImpl : public Component<MyFileFormatErrorImpl, FileFormatErrorInterface>
{
	MAXON_COMPONENT();
...
class MyUnknownFileSizeErrorImpl : public Component<MyUnknownFileSizeErrorImpl, UnknownFileSizeErrorInterface>
{
	MAXON_COMPONENT();
...
class MyBaseStreamImpl : public Component<MyBaseStreamImpl, BaseStreamInterface>
{
	MAXON_COMPONENT();
...
class MyInputStreamImpl : public Component<MyInputStreamImpl, InputStreamInterface>
{
	MAXON_COMPONENT();
...
class MyOutputStreamImpl : public Component<MyOutputStreamImpl, OutputStreamInterface>
{
	MAXON_COMPONENT();
...
class MyInOutputStreamImpl : public Component<MyInOutputStreamImpl, InOutputStreamInterface>
{
	MAXON_COMPONENT();
