#if 1
struct StreamConversionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, StreamConversionInterface>::value || DataDictionaryObjectInterface::HasBase::Check<I>::value; static I* Cast(StreamConversionInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class StreamConversionRef;

struct StreamConversionInterface::ReferenceClassHelper { using type = StreamConversionRef; };

/// Intermediate helper class for StreamConversionInterface.
template <typename S> class StreamConversionInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class StreamConversionInterface::ConstReferenceFunctionsImplDoxy : public StreamConversionInterface::ConstReferenceFunctionsImpl<REF>, public DataDictionaryObjectInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for StreamConversionInterface.
template <typename S> class StreamConversionInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class StreamConversionInterface::ReferenceFunctionsImplDoxy : public StreamConversionInterface::ReferenceFunctionsImpl<REF>, public DataDictionaryObjectInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for StreamConversionInterface.
template <typename S> class StreamConversionInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class StreamConversionInterface::COWReferenceFunctionsImplDoxy : public StreamConversionInterface::COWReferenceFunctionsImpl<REF>, public DataDictionaryObjectInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct StreamConversionInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename DataDictionaryObjectInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename DataDictionaryObjectInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename DataDictionaryObjectInterface::ReferenceFunctions<ST>::type>>::type>::type; };
class StreamConversionInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<StreamConversionRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<StreamConversionInterface, maxon::StrongRefHandler, StreamConversionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<StreamConversionInterface, maxon::StrongRefHandler, StreamConversionRef>>>>);
...
class StreamConversionRef : public StreamConversionInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(StreamConversionRef, Reference);
};
