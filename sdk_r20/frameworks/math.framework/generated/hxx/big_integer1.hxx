...
struct BigIntegerInterface::ReferenceClassHelper { using type = BigInteger; };

/// Intermediate helper class for BigIntegerInterface.
template <typename S> class BigIntegerInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class BigIntegerInterface::ConstReferenceFunctionsImplDoxy : public BigIntegerInterface::ConstReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for BigIntegerInterface.
template <typename S> class BigIntegerInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class BigIntegerInterface::ReferenceFunctionsImplDoxy : public BigIntegerInterface::ReferenceFunctionsImpl<REF> { };
#endif

/// Intermediate helper class for BigIntegerInterface.
template <typename S> class BigIntegerInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class BigIntegerInterface::COWReferenceFunctionsImplDoxy : public BigIntegerInterface::COWReferenceFunctionsImpl<REF> { };
#endif

template <typename ST> struct BigIntegerInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ST::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type>, ReferenceFunctionsImpl<typename ST::type>>::type>::type; };
class BigIntegerInterface::Reference :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<BigInteger>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const BigIntegerInterface, maxon::StrongCOWRefHandler, BigInteger>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const BigIntegerInterface, maxon::StrongCOWRefHandler, BigInteger>>>>);
	using NonConst = NonConstRef;
	static MAXON_ATTRIBUTE_FORCE_INLINE maxon::ResultMemT<BigInteger> Create();
};

class BigIntegerInterface::NonConstRef :
#ifdef DOXYGEN
public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<BigIntegerInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<BigIntegerInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
};
