...
namespace maxon
{
	...
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FFTInterface, "net.maxon.interface.fft", "maxon.FFTInterface", , &Object::_interface);
	const maxon::Char* const FFTInterface::MTable::_ids = 
		"Transform1D@008e63509f2cd453\0" // Transform1D(const ArrayInterface<Generic>& in, WritableArrayInterface<Generic>& out, FFT_FLAGS fftFlags) const
		"Transform2D@2024153426df7a83\0" // Transform2D(const ConstMatrixNxMInterface& in, const MatrixNxMInterface& out, FFT_FLAGS fftFlags) const
		"GetSupportOptions@16d870df799c817b\0" // GetSupportOptions() const
	"";
