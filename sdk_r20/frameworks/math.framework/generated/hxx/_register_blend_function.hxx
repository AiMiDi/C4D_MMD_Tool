...
namespace maxon
{
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BlendFunctionInterface, "net.maxon.interface.blendfunction", "maxon.BlendFunctionInterface", , &Object::_interface);
	const maxon::Char* const BlendFunctionInterface::MTable::_ids = 
		"MapValue@0763d2e038154114\0" // MapValue(Float x, const Data& startValue, const Data& endValue)
	"";
	template <typename DUMMY> maxon::Int BlendFunctionInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
...
#endif
static maxon::details::ForceEvaluation s_forceEval_blend_function(0
	| maxon::BlendFunctionInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
