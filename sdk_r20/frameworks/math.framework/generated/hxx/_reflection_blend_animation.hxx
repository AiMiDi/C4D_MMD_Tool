...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_BlendTweenInterface(BlendTweenInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class BlendTweenInterface::ProxyComponent : public maxon::Component<BlendTweenInterface::ProxyComponent, BlendTweenInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<Data> GetMappedValue(Float xValue) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<BlendTweenInterface>();
			...
			(*handler_)(_fn_BlendTweenInterface_GetMappedValue, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, maxon::GenericComponent*, Float>::Invoke, (const void*) mt_._BlendTweenInterface_GetMappedValue));
			return proxy_result;
		}
		...
		Result<void> SetNewTarget(const BlendFunctionRef& blendFunction, const Data& endValue) 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_SetNewTarget, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BlendFunctionRef&, const Data&>::Invoke, (const void*) mt_._BlendTweenInterface_SetNewTarget));
			return proxy_result;
		}
		...
		Result<void> SetFunction(const BlendFunctionRef& blendFunction) 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_SetFunction, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BlendFunctionRef&>::Invoke, (const void*) mt_._BlendTweenInterface_SetFunction));
			return proxy_result;
		}
		...
		BlendFunctionRef GetFunction() const 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_GetFunction, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<BlendFunctionRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendTweenInterface_GetFunction));
			return proxy_result;
		}
		...
		Result<void> SetStart(const Data& value) 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_SetStart, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Data&>::Invoke, (const void*) mt_._BlendTweenInterface_SetStart));
			return proxy_result;
		}
		...
		Result<Data> GetStart() const 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_GetStart, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendTweenInterface_GetStart));
			return proxy_result;
		}
		...
		Result<void> SetEnd(const Data& value) 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_SetEnd, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Data&>::Invoke, (const void*) mt_._BlendTweenInterface_SetEnd));
			return proxy_result;
		}
		...
		Result<Data> GetEnd() const 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_GetEnd, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendTweenInterface_GetEnd));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableAnimationDelegate> ObservableAnimation() const 
		{
			...
			(*handler_)(_fn_BlendTweenInterface_ObservableAnimation, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<maxon::ObservableRef<ObservableAnimationDelegate>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendTweenInterface_ObservableAnimation));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(BlendTweenInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_BlendTweenInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, BlendTweenInterface, _BlendTweenInterface_GetMappedValue),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, BlendTweenInterface, _BlendTweenInterface_SetNewTarget),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, BlendTweenInterface, _BlendTweenInterface_SetFunction),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, BlendTweenInterface, _BlendTweenInterface_GetFunction),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, BlendTweenInterface, _BlendTweenInterface_SetStart),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, BlendTweenInterface, _BlendTweenInterface_GetStart),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, BlendTweenInterface, _BlendTweenInterface_SetEnd),
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_BlendAnimationInterface(BlendAnimationInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class BlendAnimationInterface::ProxyComponent : public maxon::Component<BlendAnimationInterface::ProxyComponent, BlendAnimationInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<BlendTweenRef> AddTween(const BlendFunctionRef& blendFunction, const Data& startValue, const Data& endValue) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<BlendAnimationInterface>();
			...
			(*handler_)(_fn_BlendAnimationInterface_AddTween, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BlendTweenRef>, maxon::GenericComponent*, const BlendFunctionRef&, const Data&, const Data&>::Invoke, (const void*) mt_._BlendAnimationInterface_AddTween));
			return proxy_result;
		}
		...
		Result<void> RemoveTween(const BlendTweenRef& tween) 
		{
			...
			(*handler_)(_fn_BlendAnimationInterface_RemoveTween, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BlendTweenRef&>::Invoke, (const void*) mt_._BlendAnimationInterface_RemoveTween));
			return proxy_result;
		}
		...
		Result<BaseArray<BlendTweenRef>> GetTweens() const 
		{
			...
			(*handler_)(_fn_BlendAnimationInterface_GetTweens, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<BlendTweenRef>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendAnimationInterface_GetTweens));
			return proxy_result;
		}
		...
		Result<void> StartAnimation(const TimeValue& timerInterval, const TimeValue& startDelay, const TimeValue& duration) 
		{
			...
			(*handler_)(_fn_BlendAnimationInterface_StartAnimation, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const TimeValue&, const TimeValue&, const TimeValue&>::Invoke, (const void*) mt_._BlendAnimationInterface_StartAnimation));
			return proxy_result;
		}
		...
		Float GetProgress() const 
		{
			...
			(*handler_)(_fn_BlendAnimationInterface_GetProgress, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Float, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendAnimationInterface_GetProgress));
			return proxy_result;
		}
		...
		ANIMBLENDSTATE GetState() const 
		{
			...
			(*handler_)(_fn_BlendAnimationInterface_GetState, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<ANIMBLENDSTATE, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendAnimationInterface_GetState));
			return proxy_result;
		}
		...
		Result<TimerRef> GetTimerRef() const 
		{
			...
			(*handler_)(_fn_BlendAnimationInterface_GetTimerRef, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<TimerRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._BlendAnimationInterface_GetTimerRef));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(BlendAnimationInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_BlendAnimationInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, BlendAnimationInterface, _BlendAnimationInterface_AddTween),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, BlendAnimationInterface, _BlendAnimationInterface_RemoveTween),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, BlendAnimationInterface, _BlendAnimationInterface_GetTweens),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, BlendAnimationInterface, _BlendAnimationInterface_StartAnimation),
