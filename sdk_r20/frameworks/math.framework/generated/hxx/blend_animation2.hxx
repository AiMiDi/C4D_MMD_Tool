...
struct BlendTweenInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetMappedValue))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetMappedValue), W, MTable>::type::_BlendTweenInterface_GetMappedValue;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetNewTarget))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetNewTarget), W, MTable>::type::_BlendTweenInterface_SetNewTarget;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetFunction))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetFunction), W, MTable>::type::_BlendTweenInterface_SetFunction;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetFunction))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetFunction), W, MTable>::type::_BlendTweenInterface_GetFunction;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetStart))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetStart), W, MTable>::type::_BlendTweenInterface_SetStart;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetStart))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetStart), W, MTable>::type::_BlendTweenInterface_GetStart;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetEnd))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, SetEnd), W, MTable>::type::_BlendTweenInterface_SetEnd;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetEnd))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, GetEnd), W, MTable>::type::_BlendTweenInterface_GetEnd;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, ObservableAnimation))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendTweenInterface, ObservableAnimation), W, MTable>::type::_BlendTweenInterface_ObservableAnimation;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<BlendTweenInterface, ObserverObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(BlendTweenInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class BlendTweenInterface::Wrapper : public ObserverObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::COWReferenceFunctionsImpl<S>::GetMappedValue(Float xValue) -> Result<Data>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::COWReferenceFunctionsImpl<S>::SetNewTarget(const BlendFunctionRef& blendFunction, const Data& endValue) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::ReferenceFunctionsImpl<S>::SetFunction(const BlendFunctionRef& blendFunction) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::COWReferenceFunctionsImpl<S>::SetFunction(const BlendFunctionRef& blendFunction) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::ReferenceFunctionsImpl<S>::SetStart(const Data& value) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::COWReferenceFunctionsImpl<S>::SetStart(const Data& value) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::ReferenceFunctionsImpl<S>::SetEnd(const Data& value) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::COWReferenceFunctionsImpl<S>::SetEnd(const Data& value) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::ConstReferenceFunctionsImpl<S>::GetEnd() const -> Result<Data>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::ConstReferenceFunctionsImpl<S>::ObservableAnimation() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableAnimationDelegate>>, maxon::ObservableRef<ObservableAnimationDelegate>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableAnimationDelegate>>, maxon::ObservableRef<ObservableAnimationDelegate>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const BlendTweenInterface* o_ = (const BlendTweenInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = BlendTweenInterface::NullValuePtr(); if (!o_) return maxon::ObservableRef<ObservableAnimationDelegate>::NullValue(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendTweenInterface, o_, BlendTweenInterface_ObservableAnimation) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendTweenInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendTweenInterface>() : PRIVATE_MAXON_VTABLE(BlendTweenInterface, o_); 
...
struct BlendAnimationInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, AddTween))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, AddTween), W, MTable>::type::_BlendAnimationInterface_AddTween;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, RemoveTween))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, RemoveTween), W, MTable>::type::_BlendAnimationInterface_RemoveTween;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetTweens))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetTweens), W, MTable>::type::_BlendAnimationInterface_GetTweens;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, StartAnimation))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, StartAnimation), W, MTable>::type::_BlendAnimationInterface_StartAnimation;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetProgress))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetProgress), W, MTable>::type::_BlendAnimationInterface_GetProgress;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetState))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetState), W, MTable>::type::_BlendAnimationInterface_GetState;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, CancelAndWait))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, CancelAndWait), W, MTable>::type::_BlendAnimationInterface_CancelAndWait;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetTimerRef))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, BlendAnimationInterface, GetTimerRef), W, MTable>::type::_BlendAnimationInterface_GetTimerRef;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<BlendAnimationInterface, ObserverObjectInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(BlendAnimationInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class BlendAnimationInterface::Wrapper : public ObserverObjectInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::ReferenceFunctionsImpl<S>::AddTween(const BlendFunctionRef& blendFunction, const Data& startValue, const Data& endValue) const -> Result<BlendTweenRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BlendTweenRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendAnimationInterface, o_, BlendAnimationInterface_AddTween) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendAnimationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendAnimationInterface>() : PRIVATE_MAXON_VTABLE(BlendAnimationInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::COWReferenceFunctionsImpl<S>::AddTween(const BlendFunctionRef& blendFunction, const Data& startValue, const Data& endValue) -> Result<BlendTweenRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BlendTweenRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendAnimationInterface, o_, BlendAnimationInterface_AddTween) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendAnimationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendAnimationInterface>() : PRIVATE_MAXON_VTABLE(BlendAnimationInterface, o_); 
	return (mt_._BlendAnimationInterface_AddTween(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._BlendAnimationInterface_AddTween_Offset, blendFunction, startValue, endValue));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::ReferenceFunctionsImpl<S>::AddTween(const BlendFunctionRef& blendFunction, const Data& startValue, const Data& endValue, AnimBlendTweenCallback&& callback, const JobQueueRef& queue) const -> Result<BlendTweenRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BlendTweenRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); 
	return (o_->AddTween(blendFunction, startValue, endValue, std::forward<AnimBlendTweenCallback>(callback), queue));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::COWReferenceFunctionsImpl<S>::AddTween(const BlendFunctionRef& blendFunction, const Data& startValue, const Data& endValue, AnimBlendTweenCallback&& callback, const JobQueueRef& queue) -> Result<BlendTweenRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BlendTweenRef>>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION BlendAnimationInterface::AddTween on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); 
	return (o_->AddTween(blendFunction, startValue, endValue, std::forward<AnimBlendTweenCallback>(callback), queue));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::ReferenceFunctionsImpl<S>::RemoveTween(const BlendTweenRef& tween) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendAnimationInterface, o_, BlendAnimationInterface_RemoveTween) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendAnimationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendAnimationInterface>() : PRIVATE_MAXON_VTABLE(BlendAnimationInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::COWReferenceFunctionsImpl<S>::RemoveTween(const BlendTweenRef& tween) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendAnimationInterface, o_, BlendAnimationInterface_RemoveTween) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendAnimationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendAnimationInterface>() : PRIVATE_MAXON_VTABLE(BlendAnimationInterface, o_); 
	return (mt_._BlendAnimationInterface_RemoveTween(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._BlendAnimationInterface_RemoveTween_Offset, tween));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::ConstReferenceFunctionsImpl<S>::GetTweens() const -> Result<BaseArray<BlendTweenRef>>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BaseArray<BlendTweenRef>>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const BlendAnimationInterface* o_ = (const BlendAnimationInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = BlendAnimationInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendAnimationInterface, o_, BlendAnimationInterface_GetTweens) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendAnimationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendAnimationInterface>() : PRIVATE_MAXON_VTABLE(BlendAnimationInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::ReferenceFunctionsImpl<S>::StartAnimation(const TimeValue& timerInterval, const TimeValue& startDelay, const TimeValue& duration) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::COWReferenceFunctionsImpl<S>::StartAnimation(const TimeValue& timerInterval, const TimeValue& startDelay, const TimeValue& duration) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::ReferenceFunctionsImpl<S>::CancelAndWait() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); BlendAnimationInterface* o_ = (BlendAnimationInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(BlendAnimationInterface, o_, BlendAnimationInterface_CancelAndWait) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<BlendAnimationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<BlendAnimationInterface>() : PRIVATE_MAXON_VTABLE(BlendAnimationInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendAnimationInterface::COWReferenceFunctionsImpl<S>::CancelAndWait() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
