...
class MyBlendTweenImpl : public Component<MyBlendTweenImpl, BlendTweenInterface>
{
	MAXON_COMPONENT();
...
class MyBlendAnimationImpl : public Component<MyBlendAnimationImpl, BlendAnimationInterface>
{
	MAXON_COMPONENT();
