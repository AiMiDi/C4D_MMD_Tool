...
namespace URLFLAGS
{
	MAXON_ATTRIBUTE(NetworkConnectionRef, TCP_NETWORKCONNECTION_REF, 'tcpr');	///< Reference to a network connection.
	MAXON_ATTRIBUTE(Int64, TCP_NETWORKCONNECTION_KNOWNSIZE, 'tcps');									///< Optional Parameter to set a known size for this stream. NOTOK defines an unknown size.
}
...
//----------------------------------------------------------------------------------------
class NetworkConnectionInterface : MAXON_INTERFACE_BASES(Object)
{
