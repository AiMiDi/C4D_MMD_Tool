...
//----------------------------------------------------------------------------------------
class NetworkUdpSocketInterface : MAXON_INTERFACE_BASES(Object)
{
...
public:
	...
	inline static MAXON_FUNCTION Result<NetworkUdpChannelRef> CreateUdpChannel(const NetworkIpAddrPort& address, const AioServiceRef& ioService, const JobQueueRef& jobQueue = JOBQUEUE_CURRENT);
	...
	inline static MAXON_FUNCTION Result<NetworkUdpSenderRef> CreateUdpSender(PROTOCOL protocol, const AioServiceRef& ioService, const JobQueueRef& jobQueue = JOBQUEUE_CURRENT);
	...
	inline static MAXON_FUNCTION Result<NetworkUdpServerRef> CreateUdpServer(const NetworkIpAddrPort& address, NetworkUdpServerInterface::ReceiveCompletionHandler handler, const AioServiceRef& ioService, const JobQueueRef& jobQueue = JOBQUEUE_CURRENT);
};
