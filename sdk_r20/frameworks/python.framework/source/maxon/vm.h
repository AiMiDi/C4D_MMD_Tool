...
//----------------------------------------------------------------------------------------
class LibraryInterface : MAXON_INTERFACE_BASES(Object)
{
...
class VmDebuggerConnectionInterface : MAXON_INTERFACE_BASES(Object)
{
...
class VirtualMachineScopeInterface : MAXON_INTERFACE_BASES(Object)
{
...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<Data*> PrivateInvoke(const String& name, BlockArray<Data>& helperStack, const DataType* expected = nullptr, const Block<Data*>* arguments = nullptr);
...
class VirtualMachineInterface : MAXON_INTERFACE_BASES(Object)
{
