...
#endif
struct LibraryInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, LibraryInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(LibraryInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class LibraryRef;

struct LibraryInterface::ReferenceClassHelper { using type = LibraryRef; };

/// Intermediate helper class for LibraryInterface.
template <typename S> class LibraryInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class LibraryInterface::ConstReferenceFunctionsImplDoxy : public LibraryInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for LibraryInterface.
template <typename S> class LibraryInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class LibraryInterface::ReferenceFunctionsImplDoxy : public LibraryInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for LibraryInterface.
template <typename S> class LibraryInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class LibraryInterface::COWReferenceFunctionsImplDoxy : public LibraryInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct LibraryInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class LibraryInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<LibraryRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<LibraryInterface, maxon::StrongRefHandler, LibraryRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<LibraryInterface, maxon::StrongRefHandler, LibraryRef>>>>);
...
class LibraryRef : public LibraryInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(LibraryRef, Reference);
};

struct VmDebuggerConnectionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VmDebuggerConnectionInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(VmDebuggerConnectionInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class VmDebuggerConnectionRef;

struct VmDebuggerConnectionInterface::ReferenceClassHelper { using type = VmDebuggerConnectionRef; };

/// Intermediate helper class for VmDebuggerConnectionInterface.
template <typename S> class VmDebuggerConnectionInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class VmDebuggerConnectionInterface::ConstReferenceFunctionsImplDoxy : public VmDebuggerConnectionInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VmDebuggerConnectionInterface.
template <typename S> class VmDebuggerConnectionInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class VmDebuggerConnectionInterface::ReferenceFunctionsImplDoxy : public VmDebuggerConnectionInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VmDebuggerConnectionInterface.
template <typename S> class VmDebuggerConnectionInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class VmDebuggerConnectionInterface::COWReferenceFunctionsImplDoxy : public VmDebuggerConnectionInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct VmDebuggerConnectionInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class VmDebuggerConnectionInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<VmDebuggerConnectionRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VmDebuggerConnectionInterface, maxon::StrongRefHandler, VmDebuggerConnectionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VmDebuggerConnectionInterface, maxon::StrongRefHandler, VmDebuggerConnectionRef>>>>);
	using NonConst = Super::ReferenceClass;
};

/// VmDebuggerConnectionRef is the reference class of VmDebuggerConnectionInterface.
class VmDebuggerConnectionRef : public VmDebuggerConnectionInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(VmDebuggerConnectionRef, Reference);
};

struct VirtualMachineScopeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VirtualMachineScopeInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(VirtualMachineScopeInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class VirtualMachineScopeRef;

struct VirtualMachineScopeInterface::ReferenceClassHelper { using type = VirtualMachineScopeRef; };

/// Intermediate helper class for VirtualMachineScopeInterface.
template <typename S> class VirtualMachineScopeInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class VirtualMachineScopeInterface::ConstReferenceFunctionsImplDoxy : public VirtualMachineScopeInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VirtualMachineScopeInterface.
template <typename S> class VirtualMachineScopeInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// @param arguments			(Optional) Arguments which will be passed to the callable object.
	inline Result<Data*> PrivateInvoke(const String& name, BlockArray<Data>& helperStack, const DataType* expected = nullptr, const Block<Data*>* arguments = nullptr) const;
...
#ifdef DOXYGEN
template <typename REF> class VirtualMachineScopeInterface::ReferenceFunctionsImplDoxy : public VirtualMachineScopeInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VirtualMachineScopeInterface.
template <typename S> class VirtualMachineScopeInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// @param expected				(Optional) Datatype of the returned object, otherwise the type of the object will be chosen automatically.
/// @param arguments			(Optional) Arguments which will be passed to the callable object.
	inline Result<Data*> PrivateInvoke(const String& name, BlockArray<Data>& helperStack, const DataType* expected = nullptr, const Block<Data*>* arguments = nullptr);
/// Normally to reset the error state of the internal virtual machine. E.g. In Python PyErr_Print is executed.
/// Normally used after VirtualMachineScopeInterface.Execute or VirtualMachineScopeInterface.PrivateInvoke failed, but only if scope is initialized with ERRORHANDLING.REDIRECT.
/// @return				OK if the error was handled, otherwise an exception is returned.
...
#ifdef DOXYGEN
template <typename REF> class VirtualMachineScopeInterface::COWReferenceFunctionsImplDoxy : public VirtualMachineScopeInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct VirtualMachineScopeInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class VirtualMachineScopeInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<VirtualMachineScopeRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VirtualMachineScopeInterface, maxon::StrongRefHandler, VirtualMachineScopeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VirtualMachineScopeInterface, maxon::StrongRefHandler, VirtualMachineScopeRef>>>>);
	using NonConst = Super::ReferenceClass;
};

/// VirtualMachineScopeRef is the reference class of VirtualMachineScopeInterface.
class VirtualMachineScopeRef : public VirtualMachineScopeInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(VirtualMachineScopeRef, Reference);
};

struct VirtualMachineInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VirtualMachineInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(VirtualMachineInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class VirtualMachineRef;

struct VirtualMachineInterface::ReferenceClassHelper { using type = VirtualMachineRef; };

/// Intermediate helper class for VirtualMachineInterface.
template <typename S> class VirtualMachineInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class VirtualMachineInterface::ConstReferenceFunctionsImplDoxy : public VirtualMachineInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VirtualMachineInterface.
template <typename S> class VirtualMachineInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// @param runtimeInfo					Information about the virtual machine, how to start it up.
...
#ifdef DOXYGEN
template <typename REF> class VirtualMachineInterface::ReferenceFunctionsImplDoxy : public VirtualMachineInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VirtualMachineInterface.
template <typename S> class VirtualMachineInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class VirtualMachineInterface::COWReferenceFunctionsImplDoxy : public VirtualMachineInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct VirtualMachineInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class VirtualMachineInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<VirtualMachineRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VirtualMachineInterface, maxon::StrongRefHandler, VirtualMachineRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VirtualMachineInterface, maxon::StrongRefHandler, VirtualMachineRef>>>>);
	using NonConst = Super::ReferenceClass;
};

/// VirtualMachineRef is the reference class of VirtualMachineInterface.
class VirtualMachineRef : public VirtualMachineInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(VirtualMachineRef, Reference);
};
