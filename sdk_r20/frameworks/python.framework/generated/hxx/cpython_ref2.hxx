...
struct CPyInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Init), W, MTable>::type::_CPyInterface_Init;
			_CPyInterface_Init = reinterpret_cast<const decltype(_CPyInterface_Init)&>(ptr);
			_CPyInterface_Init_Offset = offset;
		}
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Incref))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Incref), W, MTable>::type::_CPyInterface_Incref;
			_CPyInterface_Incref = reinterpret_cast<const decltype(_CPyInterface_Incref)&>(ptr);
			_CPyInterface_Incref_Offset = offset;
		}
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Decref))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Decref), W, MTable>::type::_CPyInterface_Decref;
			_CPyInterface_Decref = reinterpret_cast<const decltype(_CPyInterface_Decref)&>(ptr);
			_CPyInterface_Decref_Offset = offset;
		}
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetRefCount))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetRefCount), W, MTable>::type::_CPyInterface_GetRefCount;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetLibrary))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetLibrary), W, MTable>::type::_CPyInterface_GetLibrary;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetTypeRef))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetTypeRef), W, MTable>::type::_CPyInterface_GetTypeRef;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetPyObject))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, GetPyObject), W, MTable>::type::_CPyInterface_GetPyObject;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Disconnect))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyInterface, Disconnect), W, MTable>::type::_CPyInterface_Disconnect;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CPyInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CPyInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CPyInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::CreateRef27(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyRef { return (CPyInterface::CreateRef27(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::CreateRef36(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyRef { return (CPyInterface::CreateRef36(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::CreateRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyRef { return (CPyInterface::CreateRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::CreateConstRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyConstRef { return (CPyInterface::CreateConstRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::CreateTempRef(const CPythonLibraryInterface* lib, NativePyObject* pyObject) -> CPyTempRef { return (CPyInterface::CreateTempRef(lib, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ReferenceFunctionsImpl<S>::Init(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CPyInterface* o_ = (CPyInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::COWReferenceFunctionsImpl<S>::Init(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ReferenceFunctionsImpl<S>::Incref() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CPyInterface* o_ = (CPyInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_Incref) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
	mt_._CPyInterface_Incref(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPyInterface_Incref_Offset);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::COWReferenceFunctionsImpl<S>::Incref() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ReferenceFunctionsImpl<S>::Decref() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CPyInterface* o_ = (CPyInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_Decref) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
	mt_._CPyInterface_Decref(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPyInterface_Decref_Offset);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::COWReferenceFunctionsImpl<S>::Decref() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ReferenceFunctionsImpl<S>::GetRefCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int64>, Int64>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int64>, Int64>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CPyInterface* o_ = (CPyInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return 0; const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_GetRefCount) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
	return (mt_._CPyInterface_GetRefCount(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPyInterface_GetRefCount_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::COWReferenceFunctionsImpl<S>::GetRefCount() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int64, maxon::Result<Int64>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::GetLibrary() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const CPythonLibraryInterface*>, const CPythonLibraryInterface*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const CPythonLibraryInterface*>, const CPythonLibraryInterface*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyInterface* o_ = (const CPyInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_GetLibrary) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
	return (mt_._CPyInterface_GetLibrary(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._CPyInterface_GetLibrary_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::GetTypeRef() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<CPyTypeRef>, CPyTypeRef>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<CPyTypeRef>, CPyTypeRef>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyInterface* o_ = (const CPyInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<CPyTypeRef>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_GetTypeRef) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
	return (mt_._CPyInterface_GetTypeRef(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._CPyInterface_GetTypeRef_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::GetPyObject() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<NativePyObject*>, NativePyObject*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<NativePyObject*>, NativePyObject*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyInterface* o_ = (const CPyInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_GetPyObject) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ReferenceFunctionsImpl<S>::Disconnect() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<NativePyObject*>, NativePyObject*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<NativePyObject*>, NativePyObject*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CPyInterface* o_ = (CPyInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return nullptr; const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyInterface, o_, CPyInterface_Disconnect) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyInterface>() : PRIVATE_MAXON_VTABLE(CPyInterface, o_); 
	return (mt_._CPyInterface_Disconnect(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPyInterface_Disconnect_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::COWReferenceFunctionsImpl<S>::Disconnect() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), NativePyObject*, maxon::Result<NativePyObject*>>::type
{
...
template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ConstReferenceFunctionsImpl<S>::Get() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<T*>, T*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<T*>, T*>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION CPyInterface::Get on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyInterface* o_ = (const CPyInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyInterface::NullValuePtr(); if (!o_) return nullptr; } 
	return (o_->Get<T>());
}
template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::ReferenceFunctionsImpl<S>::GetAndIncref() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<T*>, T*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<T*>, T*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CPyInterface* o_ = (CPyInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return nullptr; 
	return (o_->GetAndIncref<T>());
}
template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyInterface::COWReferenceFunctionsImpl<S>::GetAndIncref() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), T*, maxon::Result<T*>>::type
{
...
struct CPyTypeInterface::MTable
{
	...
	template <typename W> static maxon::Bool InitWithBases(maxon::ClassInfo* info, maxon::Int offset)
	{
		if (!W::Implementation::PROXY && (!CPyInterface::MTable::InitWithBases<W>(info, offset))) return false;
		MTable* vt = (MTable*) maxon::Object::PrivateGetOrCreateMTable(info, _interface); if (!vt) return false;
		vt->Init<W>(offset); return true;
	}
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CPyTypeInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CPyTypeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CPyTypeInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
};


template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTypeInterface::ConstReferenceFunctionsImpl<S>::CreateTypeRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyTypeRef { return (CPyTypeInterface::CreateTypeRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTypeInterface::ConstReferenceFunctionsImpl<S>::CreateTypeConstRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyTypeConstRef { return (CPyTypeInterface::CreateTypeConstRef(lib, refType, pyObject)); }
...
struct CPyFrameInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyFrameInterface, GetBack))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyFrameInterface, GetBack), W, MTable>::type::_CPyFrameInterface_GetBack;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyFrameInterface, GetCode))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyFrameInterface, GetCode), W, MTable>::type::_CPyFrameInterface_GetCode;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyFrameInterface, GetLastInstruction))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyFrameInterface, GetLastInstruction), W, MTable>::type::_CPyFrameInterface_GetLastInstruction;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CPyFrameInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CPyFrameInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CPyFrameInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyFrameInterface::ConstReferenceFunctionsImpl<S>::CreateFrameRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyFrameRef { return (CPyFrameInterface::CreateFrameRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyFrameInterface::ConstReferenceFunctionsImpl<S>::GetBack() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<CPyFrameRef>, CPyFrameRef>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<CPyFrameRef>, CPyFrameRef>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyFrameInterface* o_ = (const CPyFrameInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyFrameInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<CPyFrameRef>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyFrameInterface, o_, CPyFrameInterface_GetBack) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyFrameInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyFrameInterface>() : PRIVATE_MAXON_VTABLE(CPyFrameInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyFrameInterface::ConstReferenceFunctionsImpl<S>::GetCode() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<CPyCodeRef>, CPyCodeRef>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<CPyCodeRef>, CPyCodeRef>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyFrameInterface* o_ = (const CPyFrameInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyFrameInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<CPyCodeRef>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyFrameInterface, o_, CPyFrameInterface_GetCode) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyFrameInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyFrameInterface>() : PRIVATE_MAXON_VTABLE(CPyFrameInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyFrameInterface::ConstReferenceFunctionsImpl<S>::GetLastInstruction() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyFrameInterface* o_ = (const CPyFrameInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyFrameInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyFrameInterface, o_, CPyFrameInterface_GetLastInstruction) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyFrameInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyFrameInterface>() : PRIVATE_MAXON_VTABLE(CPyFrameInterface, o_); 
...
struct CPyTracebackInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyTracebackInterface, GetNext))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyTracebackInterface, GetNext), W, MTable>::type::_CPyTracebackInterface_GetNext;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyTracebackInterface, GetLineNumber))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyTracebackInterface, GetLineNumber), W, MTable>::type::_CPyTracebackInterface_GetLineNumber;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyTracebackInterface, GetFrameRef))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyTracebackInterface, GetFrameRef), W, MTable>::type::_CPyTracebackInterface_GetFrameRef;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CPyTracebackInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CPyTracebackInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CPyTracebackInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTracebackInterface::ConstReferenceFunctionsImpl<S>::CreateTracebackRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyTracebackRef { return (CPyTracebackInterface::CreateTracebackRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTracebackInterface::ConstReferenceFunctionsImpl<S>::GetNext() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<CPyTracebackRef>, CPyTracebackRef>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<CPyTracebackRef>, CPyTracebackRef>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyTracebackInterface* o_ = (const CPyTracebackInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyTracebackInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<CPyTracebackRef>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyTracebackInterface, o_, CPyTracebackInterface_GetNext) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyTracebackInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyTracebackInterface>() : PRIVATE_MAXON_VTABLE(CPyTracebackInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyTracebackInterface::ConstReferenceFunctionsImpl<S>::GetLineNumber() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyTracebackInterface* o_ = (const CPyTracebackInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyTracebackInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyTracebackInterface, o_, CPyTracebackInterface_GetLineNumber) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyTracebackInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyTracebackInterface>() : PRIVATE_MAXON_VTABLE(CPyTracebackInterface, o_); 
...
struct CPyCodeInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyCodeInterface, GetFilename))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyCodeInterface, GetFilename), W, MTable>::type::_CPyCodeInterface_GetFilename;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyCodeInterface, GetName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CPyCodeInterface, GetName), W, MTable>::type::_CPyCodeInterface_GetName;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CPyCodeInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CPyCodeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CPyCodeInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyCodeInterface::ConstReferenceFunctionsImpl<S>::CreateCodeRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> CPyCodeRef { return (CPyCodeInterface::CreateCodeRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyCodeInterface::ConstReferenceFunctionsImpl<S>::GetFilename() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CPyCodeInterface* o_ = (const CPyCodeInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CPyCodeInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CPyCodeInterface, o_, CPyCodeInterface_GetFilename) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CPyCodeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CPyCodeInterface>() : PRIVATE_MAXON_VTABLE(CPyCodeInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CPyCodeInterface::ConstReferenceFunctionsImpl<S>::GetName() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type
{
...
struct MPyClassInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MPyClassInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MPyClassInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MPyClassInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
};


template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyClassInterface::ConstReferenceFunctionsImpl<S>::CreateClassRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyClassRef { return (MPyClassInterface::CreateClassRef(lib, refType, pyObject)); }
...
struct MPyMemberInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MPyMemberInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MPyMemberInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MPyMemberInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
};


template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyMemberInterface::ConstReferenceFunctionsImpl<S>::CreateMemberRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyMemberRef { return (MPyMemberInterface::CreateMemberRef(lib, refType, pyObject)); }
...
struct MPyFunctionInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyFunctionInterface, GetFunction))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyFunctionInterface, GetFunction), W, MTable>::type::_MPyFunctionInterface_GetFunction;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MPyFunctionInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MPyFunctionInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MPyFunctionInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyFunctionInterface::ConstReferenceFunctionsImpl<S>::CreateFunctionRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyFunctionRef { return (MPyFunctionInterface::CreateFunctionRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyFunctionInterface::ReferenceFunctionsImpl<S>::GetFunction() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const reflection::Function*>, const reflection::Function*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const reflection::Function*>, const reflection::Function*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MPyFunctionInterface* o_ = (MPyFunctionInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return nullptr; const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyFunctionInterface, o_, MPyFunctionInterface_GetFunction) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyFunctionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyFunctionInterface>() : PRIVATE_MAXON_VTABLE(MPyFunctionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyFunctionInterface::COWReferenceFunctionsImpl<S>::GetFunction() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), const reflection::Function*, maxon::Result<const reflection::Function*>>::type
{
...
struct MPyDataTypeInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataTypeInterface, GetType))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataTypeInterface, GetType), W, MTable>::type::_MPyDataTypeInterface_GetType;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MPyDataTypeInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MPyDataTypeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MPyDataTypeInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataTypeInterface::ConstReferenceFunctionsImpl<S>::CreateDataTypeRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyDataTypeRef { return (MPyDataTypeInterface::CreateDataTypeRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataTypeInterface::ConstReferenceFunctionsImpl<S>::GetType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MPyDataTypeInterface* o_ = (const MPyDataTypeInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MPyDataTypeInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataTypeInterface, o_, MPyDataTypeInterface_GetType) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataTypeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataTypeInterface>() : PRIVATE_MAXON_VTABLE(MPyDataTypeInterface, o_); 
...
struct MPyDataInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetType))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetType), W, MTable>::type::_MPyDataInterface_GetType;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetMappingType))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetMappingType), W, MTable>::type::_MPyDataInterface_GetMappingType;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetData), W, MTable>::type::_MPyDataInterface_GetData;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetData))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, GetData), W, MTable>::type::_MPyDataInterface_GetData_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, PrivateGetPtr))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, PrivateGetPtr), W, MTable>::type::_MPyDataInterface_PrivateGetPtr;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, PrivateGetPtr))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MPyDataInterface, PrivateGetPtr), W, MTable>::type::_MPyDataInterface_PrivateGetPtr_1;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MPyDataInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MPyDataInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MPyDataInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ConstReferenceFunctionsImpl<S>::CreateDataRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyDataRef { return (MPyDataInterface::CreateDataRef(lib, refType, pyObject)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ConstReferenceFunctionsImpl<S>::GetType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MPyDataInterface* o_ = (const MPyDataInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MPyDataInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataInterface, o_, MPyDataInterface_GetType) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataInterface>() : PRIVATE_MAXON_VTABLE(MPyDataInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ConstReferenceFunctionsImpl<S>::GetMappingType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MPyDataInterface* o_ = (const MPyDataInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MPyDataInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataInterface, o_, MPyDataInterface_GetMappingType) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataInterface>() : PRIVATE_MAXON_VTABLE(MPyDataInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ReferenceFunctionsImpl<S>::GetData() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Data*>, Data*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Data*>, Data*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MPyDataInterface* o_ = (MPyDataInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return nullptr; const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataInterface, o_, MPyDataInterface_GetData) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataInterface>() : PRIVATE_MAXON_VTABLE(MPyDataInterface, o_); 
	return (mt_._MPyDataInterface_GetData(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MPyDataInterface_GetData_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ConstReferenceFunctionsImpl<S>::GetData() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Data*>, const Data*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Data*>, const Data*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MPyDataInterface* o_ = (const MPyDataInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MPyDataInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataInterface, o_, MPyDataInterface_GetData_1) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataInterface>() : PRIVATE_MAXON_VTABLE(MPyDataInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ConstReferenceFunctionsImpl<S>::PrivateGetPtr() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Generic*>, const Generic*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const Generic*>, const Generic*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MPyDataInterface* o_ = (const MPyDataInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MPyDataInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataInterface, o_, MPyDataInterface_PrivateGetPtr) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataInterface>() : PRIVATE_MAXON_VTABLE(MPyDataInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyDataInterface::ReferenceFunctionsImpl<S>::PrivateGetPtr() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Generic*>, Generic*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Generic*>, Generic*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MPyDataInterface* o_ = (MPyDataInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return nullptr; const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MPyDataInterface, o_, MPyDataInterface_PrivateGetPtr_1) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MPyDataInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MPyDataInterface>() : PRIVATE_MAXON_VTABLE(MPyDataInterface, o_); 
...
struct MPyCallerContextInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MPyCallerContextInterface, CPyInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MPyCallerContextInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MPyCallerContextInterface::Wrapper : public CPyInterface::Wrapper<S>
{
public:
};


template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MPyCallerContextInterface::ConstReferenceFunctionsImpl<S>::CreateCallerContextRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) -> MPyCallerContextRef { return (MPyCallerContextInterface::CreateCallerContextRef(lib, refType, pyObject)); }
