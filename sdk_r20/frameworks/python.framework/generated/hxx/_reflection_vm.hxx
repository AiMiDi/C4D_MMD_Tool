...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_LibraryInterface(LibraryInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class LibraryInterface::ProxyComponent : public maxon::Component<LibraryInterface::ProxyComponent, LibraryInterface>
	{
		MAXON_COMPONENT();
	public:
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(LibraryInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_VmDebuggerConnectionInterface(VmDebuggerConnectionInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class VmDebuggerConnectionInterface::ProxyComponent : public maxon::Component<VmDebuggerConnectionInterface::ProxyComponent, VmDebuggerConnectionInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		String GetName() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<VmDebuggerConnectionInterface>();
			...
			(*handler_)(_fn_VmDebuggerConnectionInterface_GetName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VmDebuggerConnectionInterface_GetName));
			return proxy_result;
		}
		...
		Url GetPath() const 
		{
			...
			(*handler_)(_fn_VmDebuggerConnectionInterface_GetPath, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Url, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VmDebuggerConnectionInterface_GetPath));
			return proxy_result;
		}
		...
		String GetStartupScript() const 
		{
			...
			(*handler_)(_fn_VmDebuggerConnectionInterface_GetStartupScript, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VmDebuggerConnectionInterface_GetStartupScript));
			return proxy_result;
		}
		...
		String GetShutdownScript() const 
		{
			...
			(*handler_)(_fn_VmDebuggerConnectionInterface_GetShutdownScript, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VmDebuggerConnectionInterface_GetShutdownScript));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(VmDebuggerConnectionInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_VirtualMachineScopeInterface(VirtualMachineScopeInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class VirtualMachineScopeInterface::ProxyComponent : public maxon::Component<VirtualMachineScopeInterface::ProxyComponent, VirtualMachineScopeInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> Init(const String& identifier, const String& code, ERRORHANDLING errorHandling, const VmDebuggerConnectionRef* debug) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<VirtualMachineScopeInterface>();
			...
			(*handler_)(_fn_VirtualMachineScopeInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, const String&, ERRORHANDLING, const VmDebuggerConnectionRef*>::Invoke, (const void*) mt_._VirtualMachineScopeInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Add(const String& name, const Data& data) 
		{
			...
			(*handler_)(_fn_VirtualMachineScopeInterface_Add, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, const Data&>::Invoke, (const void*) mt_._VirtualMachineScopeInterface_Add));
			return proxy_result;
		}
		...
		Result<Data> Get(const String& name) 
		{
			...
			(*handler_)(_fn_VirtualMachineScopeInterface_Get, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data>, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_._VirtualMachineScopeInterface_Get));
			return proxy_result;
		}
		...
		Result<void> Execute() 
		{
			...
			(*handler_)(_fn_VirtualMachineScopeInterface_Execute, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineScopeInterface_Execute));
			return proxy_result;
		}
		...
		Result<Data*> PrivateInvoke(const String& name, BlockArray<Data>& helperStack, const DataType* expected, const Block<Data*>* arguments) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<VirtualMachineScopeInterface>();
			Result<Data*> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._VirtualMachineScopeInterface_PrivateInvoke_Offset), maxon::reflection::Argument::ByReference(name), maxon::reflection::Argument::ByReference(helperStack), maxon::reflection::Argument::ByValue(expected), maxon::reflection::Argument::ByValue(arguments)};
			(*handler_)(_fn_VirtualMachineScopeInterface_PrivateInvoke, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data*>, maxon::GenericComponent*, const String&, BlockArray<Data>&, const DataType*, const Block<Data*>*>::Invoke, (const void*) mt_._VirtualMachineScopeInterface_PrivateInvoke));
			return proxy_result;
		}
		...
		Result<void> ErrorHandling() 
		{
			...
			(*handler_)(_fn_VirtualMachineScopeInterface_ErrorHandling, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineScopeInterface_ErrorHandling));
			return proxy_result;
		}
		...
		Result<void> _PrivateInit(const LibraryRef& lib) 
		{
			...
			(*handler_)(_fn_VirtualMachineScopeInterface__PrivateInit, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const LibraryRef&>::Invoke, (const void*) mt_._VirtualMachineScopeInterface__PrivateInit));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(VirtualMachineScopeInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_VirtualMachineScopeInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 256LL, VirtualMachineScopeInterface, _VirtualMachineScopeInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineScopeInterface, _VirtualMachineScopeInterface_Add),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineScopeInterface, _VirtualMachineScopeInterface_Get),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineScopeInterface, _VirtualMachineScopeInterface_Execute),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineScopeInterface, _VirtualMachineScopeInterface_PrivateInvoke),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineScopeInterface, _VirtualMachineScopeInterface__PrivateInit),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_VirtualMachineInterface(VirtualMachineInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class VirtualMachineInterface::ProxyComponent : public maxon::Component<VirtualMachineInterface::ProxyComponent, VirtualMachineInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Result<void> Init(const LoadRuntime& runtimeInfo, const DataDictionary& settings) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<VirtualMachineInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			...
			(*handler_)(_fn_VirtualMachineInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const LoadRuntime&, const DataDictionary&>::Invoke, (const void*) mt_._VirtualMachineInterface_Init));
			return proxy_result;
		}
		...
		Result<VirtualMachineScopeRef> CreateScope() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_CreateScope, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<VirtualMachineScopeRef>, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_CreateScope));
			return proxy_result;
		}
		...
		String GetName() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetName));
			return proxy_result;
		}
		...
		String GetVersion() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetVersion, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetVersion));
			return proxy_result;
		}
		...
		String GetCopyright() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetCopyright, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetCopyright));
			return proxy_result;
		}
		...
		String GetCompiler() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetCompiler, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetCompiler));
			return proxy_result;
		}
		...
		String GetBuildInfo() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetBuildInfo, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetBuildInfo));
			return proxy_result;
		}
		...
		Result<void> EnterInteractiveMode() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_EnterInteractiveMode, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_EnterInteractiveMode));
			return proxy_result;
		}
		...
		Result<void> Execute(const String& code) 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_Execute, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_._VirtualMachineInterface_Execute));
			return proxy_result;
		}
		...
		Result<void> Execute(const Url& filepath) 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_Execute_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_._VirtualMachineInterface_Execute_1));
			return proxy_result;
		}
		...
		Result<void> ExecuteModule(const String& name) 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_ExecuteModule, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_._VirtualMachineInterface_ExecuteModule));
			return proxy_result;
		}
		...
		Result<void> GetDocumentString(const String& code, DocStringMeta& meta) 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetDocumentString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&, DocStringMeta&>::Invoke, (const void*) mt_._VirtualMachineInterface_GetDocumentString));
			return proxy_result;
		}
		...
		LibraryRef GetLibraryRef() 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetLibraryRef, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<LibraryRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetLibraryRef));
			return proxy_result;
		}
		...
		Result<BaseArray<Runtime>> GetAllAvailableVirtualMachineLibraries() const 
		{
			...
			(*handler_)(_fn_VirtualMachineInterface_GetAllAvailableVirtualMachineLibraries, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<Runtime>>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VirtualMachineInterface_GetAllAvailableVirtualMachineLibraries));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(VirtualMachineInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_VirtualMachineInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineInterface, _VirtualMachineInterface_Init),
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineInterface, _VirtualMachineInterface_Execute),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineInterface, _VirtualMachineInterface_Execute_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, VirtualMachineInterface, _VirtualMachineInterface_ExecuteModule),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 32LL, VirtualMachineInterface, _VirtualMachineInterface_GetDocumentString),
