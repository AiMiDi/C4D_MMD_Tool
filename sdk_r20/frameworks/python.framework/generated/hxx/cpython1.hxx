...
#endif
	struct PythonErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PythonErrorInterface>::value || ErrorInterface::HasBase::Check<I>::value; static I* Cast(PythonErrorInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
	class PythonError;

	struct PythonErrorObjectPrivateHelper;
	struct PythonErrorInterface::ReferenceClassHelper { using type = PythonError; using object = PythonErrorObjectPrivateHelper; };

	/// Intermediate helper class for PythonErrorInterface.
	template <typename S> class PythonErrorInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
	{
	public:
...
#ifdef DOXYGEN
	template <typename REF> class PythonErrorInterface::ConstReferenceFunctionsImplDoxy : public PythonErrorInterface::ConstReferenceFunctionsImpl<REF>, public ErrorInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for PythonErrorInterface.
	template <typename S> class PythonErrorInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
...
#ifdef DOXYGEN
	template <typename REF> class PythonErrorInterface::ReferenceFunctionsImplDoxy : public PythonErrorInterface::ReferenceFunctionsImpl<REF>, public ErrorInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for PythonErrorInterface.
	template <typename S> class PythonErrorInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
...
#ifdef DOXYGEN
	template <typename REF> class PythonErrorInterface::COWReferenceFunctionsImplDoxy : public PythonErrorInterface::COWReferenceFunctionsImpl<REF>, public ErrorInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

	template <typename ST> struct PythonErrorInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>>::type>::type; };
	class PythonErrorInterface::Reference :
#ifdef DOXYGEN
	public COWReferenceFunctionsImplDoxy<PythonError>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const PythonErrorInterface, maxon::StrongCOWRefHandler, PythonError>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const PythonErrorInterface, maxon::StrongCOWRefHandler, PythonError>>>>);
		using NonConst = NonConstRef;
	};

	class PythonErrorInterface::NonConstRef :
#ifdef DOXYGEN
	public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PythonErrorInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PythonErrorInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
	};
...
/// it is manually cleared or if a function explicitly describes the meaning of this error differently.
	class PythonError : public PythonErrorInterface::Reference
	{
	public:
	friend class PythonErrorObject;
	friend class maxon::ResultBase<PythonError>;
	PythonError(maxon::ERROR_OK) { }
		PRIVATE_MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(PythonError, Reference);
	...
	struct PythonTracebackErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PythonTracebackErrorInterface>::value || ErrorInterface::HasBase::Check<I>::value; static I* Cast(PythonTracebackErrorInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
	class PythonTracebackError;

	struct PythonTracebackErrorObjectPrivateHelper;
	struct PythonTracebackErrorInterface::ReferenceClassHelper { using type = PythonTracebackError; using object = PythonTracebackErrorObjectPrivateHelper; };

	/// Intermediate helper class for PythonTracebackErrorInterface.
	template <typename S> class PythonTracebackErrorInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
	{
	public:
		ConstReferenceFunctionsImpl() = default;
		using PrivateBaseClass = S;
...
#ifdef DOXYGEN
	template <typename REF> class PythonTracebackErrorInterface::ConstReferenceFunctionsImplDoxy : public PythonTracebackErrorInterface::ConstReferenceFunctionsImpl<REF>, public ErrorInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for PythonTracebackErrorInterface.
	template <typename S> class PythonTracebackErrorInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
		ReferenceFunctionsImpl() = default;
		using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
	template <typename REF> class PythonTracebackErrorInterface::ReferenceFunctionsImplDoxy : public PythonTracebackErrorInterface::ReferenceFunctionsImpl<REF>, public ErrorInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for PythonTracebackErrorInterface.
	template <typename S> class PythonTracebackErrorInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
		COWReferenceFunctionsImpl() = default;
		using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
	template <typename REF> class PythonTracebackErrorInterface::COWReferenceFunctionsImplDoxy : public PythonTracebackErrorInterface::COWReferenceFunctionsImpl<REF>, public ErrorInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

	template <typename ST> struct PythonTracebackErrorInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>>::type>::type; };
	class PythonTracebackErrorInterface::Reference :
#ifdef DOXYGEN
	public COWReferenceFunctionsImplDoxy<PythonTracebackError>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const PythonTracebackErrorInterface, maxon::StrongCOWRefHandler, PythonTracebackError>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const PythonTracebackErrorInterface, maxon::StrongCOWRefHandler, PythonTracebackError>>>>);
		using NonConst = NonConstRef;
	};

	class PythonTracebackErrorInterface::NonConstRef :
#ifdef DOXYGEN
	public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PythonTracebackErrorInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PythonTracebackErrorInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
	};
...
/// Contains information about the traceback if an exception.
	class PythonTracebackError : public PythonTracebackErrorInterface::Reference
	{
	public:
	...
	PythonTracebackError(maxon::ERROR_OK) { }
		PRIVATE_MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(PythonTracebackError, Reference);
	...
	struct PythonSystemExitErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PythonSystemExitErrorInterface>::value || ErrorInterface::HasBase::Check<I>::value; static I* Cast(PythonSystemExitErrorInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
	class PythonSystemExitError;

	struct PythonSystemExitErrorObjectPrivateHelper;
	struct PythonSystemExitErrorInterface::ReferenceClassHelper { using type = PythonSystemExitError; using object = PythonSystemExitErrorObjectPrivateHelper; };

	/// Intermediate helper class for PythonSystemExitErrorInterface.
	template <typename S> class PythonSystemExitErrorInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
	{
	public:
		ConstReferenceFunctionsImpl() = default;
		using PrivateBaseClass = S;
...
#ifdef DOXYGEN
	template <typename REF> class PythonSystemExitErrorInterface::ConstReferenceFunctionsImplDoxy : public PythonSystemExitErrorInterface::ConstReferenceFunctionsImpl<REF>, public ErrorInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for PythonSystemExitErrorInterface.
	template <typename S> class PythonSystemExitErrorInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
		ReferenceFunctionsImpl() = default;
		using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
	template <typename REF> class PythonSystemExitErrorInterface::ReferenceFunctionsImplDoxy : public PythonSystemExitErrorInterface::ReferenceFunctionsImpl<REF>, public ErrorInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for PythonSystemExitErrorInterface.
	template <typename S> class PythonSystemExitErrorInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
		COWReferenceFunctionsImpl() = default;
		using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
	template <typename REF> class PythonSystemExitErrorInterface::COWReferenceFunctionsImplDoxy : public PythonSystemExitErrorInterface::COWReferenceFunctionsImpl<REF>, public ErrorInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

	template <typename ST> struct PythonSystemExitErrorInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename ErrorInterface::ReferenceFunctions<ST>::type>>::type>::type; };
	class PythonSystemExitErrorInterface::Reference :
#ifdef DOXYGEN
	public COWReferenceFunctionsImplDoxy<PythonSystemExitError>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const PythonSystemExitErrorInterface, maxon::StrongCOWRefHandler, PythonSystemExitError>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const PythonSystemExitErrorInterface, maxon::StrongCOWRefHandler, PythonSystemExitError>>>>);
		using NonConst = NonConstRef;
	};

	class PythonSystemExitErrorInterface::NonConstRef :
#ifdef DOXYGEN
	public COWReferenceFunctionsImplDoxy<NonConstRef>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PythonSystemExitErrorInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PythonSystemExitErrorInterface, maxon::StrongCOWRefHandler, NonConstRef>>>>);
	};
...
/// A PythonSystemExitError is thrown if the previous function executed sys.exit. Only thrown in VirtualMachineInterface::Execute(String)
	class PythonSystemExitError : public PythonSystemExitErrorInterface::Reference
	{
	public:
	...
	PythonSystemExitError(maxon::ERROR_OK) { }
		PRIVATE_MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(PythonSystemExitError, Reference);
	...
	struct CPythonLibraryInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPythonLibraryInterface>::value || LibraryInterface::HasBase::Check<I>::value; static I* Cast(CPythonLibraryInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
	class CPythonLibraryRef;

	struct CPythonLibraryInterface::ReferenceClassHelper { using type = CPythonLibraryRef; };

	/// Intermediate helper class for CPythonLibraryInterface.
	template <typename S> class CPythonLibraryInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
	{
	public:
		ConstReferenceFunctionsImpl() = default;
		using PrivateBaseClass = S;
...
/// @return          String object or empty object if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyString_FromString(const Char* str) const;
...
#ifdef DOXYGEN
	template <typename REF> class CPythonLibraryInterface::ConstReferenceFunctionsImplDoxy : public CPythonLibraryInterface::ConstReferenceFunctionsImpl<REF>, public LibraryInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for CPythonLibraryInterface.
	template <typename S> class CPythonLibraryInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
		ReferenceFunctionsImpl() = default;
		using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// Initializes Python random module. Must not be called on the pre-allocated Python instances!
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type PrivateCPyRandom_Init() const;
...
/// @return               Reference 
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPy_InitModule(const ModuleDefinition& module) const;
...
/// Restores the exception which got retrived by CPyErr_Fetch.
/// 
...
/// @return    True if o is a str.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type CPyString_Check(const CPyRef& o) const;
/// Converts a given block to a string object. GIL must be held.
/// 
/// @param block     Char block.
/// @return          String object or empty object if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyString_FromStringAndSize(const Block<const Char>& block) const;
/// Converts a string object to a string. GIL must be held.
/// 
/// @param str         String object.
/// @return            String or error if the exception indicator got set.
		inline Result<String> CPyString_AsString(const CPyRef& str) const;
...
/// @return            Pointer to char array, or nullptr if the the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<const Char*>, const Char*>::type CPyString_AsCString(const CPyRef& str) const;
/// Gets the size of a string. GIL must be held.
/// 
/// @param str       String object.
/// @return          Length or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type CPyString_Size(const CPyRef& str) const;
...
/// @return    True if o is a module.
		...
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type CPyModule_AddObject(const CPyRef& module, const Char* name, const CPyRef& value) const;
...
/// Checkss if multi-threading for Python is enabled.
/// 
...
/// Acquires the GIL.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type CPyEval_AcquireLock() const;
/// Releases the GIL.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type CPyEval_ReleaseLock() const;
...
/// Private. Reinitializes the multi-threading. Must not be called on the pre-allocated Python instances!
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type CPyEval_ReInitThreads() const;
...
/// @param o         Float value.
/// @return          Float object.
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyFloat_From(std::enable_if_t<std::is_same<T, Float32>::value, Float32> o) const;
/// Converts an object from a Float64 value.
/// 
/// @param o         Float value.
/// @return          Float object.
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyFloat_From(std::enable_if_t<std::is_same<T, Float64>::value, Float64> o) const;
/// Checks if the given object is an int or a subtype of PyInt_Type. GIL must be held.
/// 
/// @param o   A given object.
/// @return    True if o is a 
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type CPyInt_Check(const CPyRef& o) const;
...
/// @return                 Int object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_FromInt16(Int16 value) const;
/// Creates an int object from a UInt16 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_FromUInt16(UInt16 value) const;
/// Creates an int object from a Int32 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_FromInt32(Int32 value) const;
/// Creates an int object from a UInt32 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_FromUInt32(UInt32 value) const;
/// Creates an int object from a Int64 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_FromInt64(Int64 value) const;
/// Creates an int object from a UInt64 value. GIL must be held.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_FromUInt64(UInt64 value) const;
/// Converts an object to an Int16 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int16>, Int16>::type CPyInt_AsInt16(const CPyRef& o) const;
/// Converts an object to an UInt16 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<UInt16>, UInt16>::type CPyInt_AsUInt16(const CPyRef& o) const;
/// Converts an object to an Int32 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type CPyInt_AsInt32(const CPyRef& o) const;
/// Converts an object to an UInt32 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<UInt32>, UInt32>::type CPyInt_AsUInt32(const CPyRef& o) const;
/// Converts an object to an Int64 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int64>, Int64>::type CPyInt_AsInt64(const CPyRef& o) const;
/// Converts an object to an UInt64 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<UInt64>, UInt64>::type CPyInt_AsUInt64(const CPyRef& o) const;
/// Converts an object to type T. GIL must be held.
/// 
/// @tparam T        Integral type.
/// @param o         Object to convert.
/// @return          Result value.
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<T>, T>::type CPyInt_As(const CPyRef& o) const;
/// Converts an object from an Int32 value. GIL must be held.
/// 
/// @param o         Int value.
/// @return          Int object.
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_From(std::enable_if_t<std::is_same<T, Int32>::value, Int32> o) const;
/// Converts an object from an Int64 value. GIL must be held.
/// 
/// @param o         Int64 value.
/// @return          Int object.
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_From(std::enable_if_t<std::is_same<T, Int64>::value, Int64> o) const;
...
/// @return      UseClassExceptionsFlag flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_UseClassExceptionsFlag() const;
...
/// @return      TabcheckFlag flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_TabcheckFlag() const;
...
/// @return      UnicodeFlag flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_UnicodeFlag() const;
...
/// @return      DivisionWarningFlag flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_DivisionWarningFlag() const;
...
/// @return      QnewFlag flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_QnewFlag() const;
...
/// @return      Py3kWarningFlag flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_Py3kWarningFlag() const;
...
/// @return      CheckInterval flag
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int32*>, Int32*>::type CPy_CheckInterval() const;
...
/// @return The RecursionErrorInst exception.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyConstRef>, CPyConstRef>::type CPyExc_RecursionErrorInst() const;
/// Returns the Warning.
///
...
/// @return      Type of CPyString.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyTypeConstRef>, CPyTypeConstRef>::type CPyString_Type() const;
/// Returns thetype of CPyInt.
/// @return      Type of CPyInt.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyTypeConstRef>, CPyTypeConstRef>::type CPyInt_Type() const;
...
/// @return                 Pointer to the first array of the string sequence. Can be casted to the corresponding code unit type.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<const PyChar*>, const PyChar*>::type ConvertAndCacheString(const String& str, const StringEncodingRef& encoding) const;
/// Private.
...
/// Private.
		...
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<MPyDataRef>, MPyDataRef>::type MPyData_New(const DataType* dt, Generic* data, Bool owner, const DataType* mapDt = nullptr) const;
...
/// @return           New DataType capsule or empty object if expception indicator is set.
		...
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::enable_if<std::is_same<T, DataType*>::value, ResultPtr<const DataType>>::type>, typename std::enable_if<std::is_same<T, DataType*>::value, ResultPtr<const DataType>>::type>::type ParseArgument(const CPyRef& args, Int32 argIndex, Bool isOptional = false) const;
		template <typename T> inline Result<T> ParseRef(const CPyRef& args, Int32 argIndex, Bool isOptional = false) const;
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::enable_if<std::is_reference<T>::value||std::is_pointer<T>::value, Result<T>>::type>, typename std::enable_if<std::is_reference<T>::value||std::is_pointer<T>::value, Result<T>>::type>::type ParseArgument(const CPyRef& args, BlockArray<Data>& tempStack, Int32 argIndex, Bool isOptional = false) const;
/// if T is not NativePyObject*
		template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::enable_if<!std::is_reference<T>::value&&!std::is_pointer<T>::value, Result<T>>::type>, typename std::enable_if<!std::is_reference<T>::value&&!std::is_pointer<T>::value, Result<T>>::type>::type ParseArgument(const CPyRef& args, BlockArray<Data>& tempStack, Int32 argIndex, Bool isOptional = false) const;
		inline Result<const DataType*> ParseDataType(const CPyRef& args, Int32 argIndex, Bool canBeNone = false) const;
		template <typename T> inline Result<T> ParseGeneric(const CPythonLibraryRef& pylib, const CPyRef& args, Int32 argIndex, const DataType*& dt, Bool unpackData) const;
...
#ifdef DOXYGEN
	template <typename REF> class CPythonLibraryInterface::ReferenceFunctionsImplDoxy : public CPythonLibraryInterface::ReferenceFunctionsImpl<REF>, public LibraryInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

	/// Intermediate helper class for CPythonLibraryInterface.
	template <typename S> class CPythonLibraryInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
	{
	public:
		COWReferenceFunctionsImpl() = default;
		using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
/// Initializes Python random module. Must not be called on the pre-allocated Python instances!
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type PrivateCPyRandom_Init();
/// Initialize a Python module by the information passed in the module definition. GIL must be held.
/// 
/// @param module         Information about the builtin module.
/// @return               Reference 
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPy_InitModule(const ModuleDefinition& module);
/// Free all resources and internals of Python.  Must not be called on the pre-allocated Python instances!
/// @param shutdownEngine				Delegate which must execute Py_Finalize. GIL got released.
...
/// @param o   A given object.
/// @return    True if o is a str.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Bool, maxon::Result<Bool>>::type CPyString_Check(const CPyRef& o);
/// Converts a given block to a string object. GIL must be held.
/// 
/// @param block     Char block.
/// @return          String object or empty object if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyString_FromStringAndSize(const Block<const Char>& block);
/// Converts a string object to a string. GIL must be held.
/// 
/// @param str         String object.
/// @return            String or error if the exception indicator got set.
		inline Result<String> CPyString_AsString(const CPyRef& str);
/// Retrieves the pointer to a chary array of a string object. The char array is alive as long as the string object
/// is alive. Until the string object gets deleted, the char array will be deleted too. GIL must be held.
/// 
/// @param str         String object.
/// @return            Pointer to char array, or nullptr if the the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), const Char*, maxon::Result<const Char*>>::type CPyString_AsCString(const CPyRef& str);
/// Gets the size of a string. GIL must be held.
/// 
/// @param str       String object.
/// @return          Length or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int, maxon::Result<Int>>::type CPyString_Size(const CPyRef& str);
/// Gets the item of a dictionary. GIL must be held.
/// 
/// @param dict           Dict object.
/// @param key            Key object.
...
/// @return    True if o is a module.
		...
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Bool, maxon::Result<Bool>>::type CPyModule_AddObject(const CPyRef& module, const Char* name, const CPyRef& value);
...
/// Acquires the GIL.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type CPyEval_AcquireLock();
/// Releases the GIL.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type CPyEval_ReleaseLock();
/// Acquires the GIL for a thread state object.
/// 
/// @param state         Thread state object.
...
/// Private. Reinitializes the multi-threading. Must not be called on the pre-allocated Python instances!
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type CPyEval_ReInitThreads();
/// Checks if the given object is a float. GIL must be held.
/// 
/// @param o   A given object.
/// @return    True if o is a float.
...
/// @param o         Float value.
/// @return          Float object.
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyFloat_From(std::enable_if_t<std::is_same<T, Float32>::value, Float32> o);
/// Converts an object from a Float64 value.
/// 
/// @param o         Float value.
/// @return          Float object.
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyFloat_From(std::enable_if_t<std::is_same<T, Float64>::value, Float64> o);
/// Checks if the given object is an int or a subtype of PyInt_Type. GIL must be held.
/// 
/// @param o   A given object.
/// @return    True if o is a 
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Bool, maxon::Result<Bool>>::type CPyInt_Check(const CPyRef& o);
/// Creates a bool object from a Bool.
///
/// @param value            Bool value.
/// @return                 bool object.
...
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_FromInt16(Int16 value);
/// Creates an int object from a UInt16 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_FromUInt16(UInt16 value);
/// Creates an int object from a Int32 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_FromInt32(Int32 value);
/// Creates an int object from a UInt32 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_FromUInt32(UInt32 value);
/// Creates an int object from a Int64 value.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_FromInt64(Int64 value);
/// Creates an int object from a UInt64 value. GIL must be held.
///
/// @param value            Int value.
/// @return                 Int object.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_FromUInt64(UInt64 value);
/// Converts an object to an Int16 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int16, maxon::Result<Int16>>::type CPyInt_AsInt16(const CPyRef& o);
/// Converts an object to an UInt16 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), UInt16, maxon::Result<UInt16>>::type CPyInt_AsUInt16(const CPyRef& o);
/// Converts an object to an Int32 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32, maxon::Result<Int32>>::type CPyInt_AsInt32(const CPyRef& o);
/// Converts an object to an UInt32 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), UInt32, maxon::Result<UInt32>>::type CPyInt_AsUInt32(const CPyRef& o);
/// Converts an object to an Int64 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int64, maxon::Result<Int64>>::type CPyInt_AsInt64(const CPyRef& o);
/// Converts an object to an UInt64 value. GIL must be held.
///
/// @param o           Object to convert.
/// @result            Integer value, or -1 if the exception indicator got set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), UInt64, maxon::Result<UInt64>>::type CPyInt_AsUInt64(const CPyRef& o);
/// Converts an object to type T. GIL must be held.
/// 
/// @tparam T        Integral type.
/// @param o         Object to convert.
/// @return          Result value.
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), T, maxon::Result<T>>::type CPyInt_As(const CPyRef& o);
/// Converts an object from an Int32 value. GIL must be held.
/// 
/// @param o         Int value.
/// @return          Int object.
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_From(std::enable_if_t<std::is_same<T, Int32>::value, Int32> o);
/// Converts an object from an Int64 value. GIL must be held.
/// 
/// @param o         Int64 value.
/// @return          Int object.
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_From(std::enable_if_t<std::is_same<T, Int64>::value, Int64> o);
/// Checks if the given object is a numeric object. GIL must be held.
/// 
/// @param o   Object to check.
/// @return    True if an object is a numeric value.
...
///
/// @return      UseClassExceptionsFlag flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_UseClassExceptionsFlag();
/// Returns a mutable pointer to a FrozenFlag. Can be nullptr if the flag is not available in this Python version.
///
/// @return      FrozenFlag flag
...
///
/// @return      TabcheckFlag flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_TabcheckFlag();
/// Returns a mutable pointer to a UnicodeFlag. Can be nullptr if the flag is not available in this Python version.
///
/// @return      UnicodeFlag flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_UnicodeFlag();
/// Returns a mutable pointer to a IgnoreEnvironmentFlag. Can be nullptr if the flag is not available in this Python version.
///
/// @return      IgnoreEnvironmentFlag flag
...
///
/// @return      DivisionWarningFlag flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_DivisionWarningFlag();
/// Returns a mutable pointer to a DontWriteBytecodeFlag. Can be nullptr if the flag is not available in this Python version.
///
/// @return      DontWriteBytecodeFlag flag
...
///
/// @return      QnewFlag flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_QnewFlag();
/// Returns a mutable pointer to a Py3kWarningFlag. Can be nullptr if the flag is not available in this Python version.
///
/// @return      Py3kWarningFlag flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_Py3kWarningFlag();
/// Returns a mutable pointer to a CheckInterval. Can be nullptr if the flag is not available in this Python version.
///
/// @return      CheckInterval flag
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Int32*, maxon::Result<Int32*>>::type CPy_CheckInterval();
/// Returns the BaseException.
///
/// @return The BaseException exception.
///------------------------------------------------
...
///
/// @return The RecursionErrorInst exception.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyConstRef, maxon::Result<CPyConstRef>>::type CPyExc_RecursionErrorInst();
/// Returns the Warning.
///
/// @return The Warning exception.
...
/// Returns the CPtype of CPyString.
/// @return      Type of CPyString.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyTypeConstRef, maxon::Result<CPyTypeConstRef>>::type CPyString_Type();
/// Returns thetype of CPyInt.
/// @return      Type of CPyInt.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyTypeConstRef, maxon::Result<CPyTypeConstRef>>::type CPyInt_Type();
/// Returns the type of CPyLong.
/// @return      Type of CPyLong.
...
/// @param encoding         Encoding to use.
/// @return                 Pointer to the first array of the string sequence. Can be casted to the corresponding code unit type.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), const PyChar*, maxon::Result<const PyChar*>>::type ConvertAndCacheString(const String& str, const StringEncodingRef& encoding);
/// Private.
...
/// Private.
		...
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), MPyDataRef, maxon::Result<MPyDataRef>>::type MPyData_New(const DataType* dt, Generic* data, Bool owner, const DataType* mapDt = nullptr);
/// Creates a DataType capsule. GIL must be held.
/// 
/// @param dt         Pointer of DataType to capsule.
/// @return           New DataType capsule or empty object if expception indicator is set.
		...
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), typename std::enable_if<std::is_same<T, DataType*>::value, ResultPtr<const DataType>>::type, maxon::Result<typename std::enable_if<std::is_same<T, DataType*>::value, ResultPtr<const DataType>>::type>>::type ParseArgument(const CPyRef& args, Int32 argIndex, Bool isOptional = false);
		template <typename T> inline Result<T> ParseRef(const CPyRef& args, Int32 argIndex, Bool isOptional = false);
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), typename std::enable_if<std::is_reference<T>::value||std::is_pointer<T>::value, Result<T>>::type, maxon::Result<typename std::enable_if<std::is_reference<T>::value||std::is_pointer<T>::value, Result<T>>::type>>::type ParseArgument(const CPyRef& args, BlockArray<Data>& tempStack, Int32 argIndex, Bool isOptional = false);
/// if T is not NativePyObject*
		template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), typename std::enable_if<!std::is_reference<T>::value&&!std::is_pointer<T>::value, Result<T>>::type, maxon::Result<typename std::enable_if<!std::is_reference<T>::value&&!std::is_pointer<T>::value, Result<T>>::type>>::type ParseArgument(const CPyRef& args, BlockArray<Data>& tempStack, Int32 argIndex, Bool isOptional = false);
		inline Result<const DataType*> ParseDataType(const CPyRef& args, Int32 argIndex, Bool canBeNone = false);
		template <typename T> inline Result<T> ParseGeneric(const CPythonLibraryRef& pylib, const CPyRef& args, Int32 argIndex, const DataType*& dt, Bool unpackData);
...
#ifdef DOXYGEN
	template <typename REF> class CPythonLibraryInterface::COWReferenceFunctionsImplDoxy : public CPythonLibraryInterface::COWReferenceFunctionsImpl<REF>, public LibraryInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

	template <typename ST> struct CPythonLibraryInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename LibraryInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename LibraryInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename LibraryInterface::ReferenceFunctions<ST>::type>>::type>::type; };
	class CPythonLibraryInterface::Reference :
#ifdef DOXYGEN
	public ReferenceFunctionsImplDoxy<CPythonLibraryRef>
#else
	public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CPythonLibraryInterface, maxon::StrongRefHandler, CPythonLibraryRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CPythonLibraryInterface, maxon::StrongRefHandler, CPythonLibraryRef>>>>);
		using NonConst = Super::ReferenceClass;
	};

	/// CPythonLibraryRef is the reference class of CPythonLibraryInterface.
	class CPythonLibraryRef : public CPythonLibraryInterface::Reference
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(CPythonLibraryRef, Reference);
	};

}
struct PyModuleInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PyModuleInterface>::value || LibraryInterface::HasBase::Check<I>::value; static I* Cast(PyModuleInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class PyModuleRef;

struct PyModuleInterface::ReferenceClassHelper { using type = PyModuleRef; };

/// Intermediate helper class for PyModuleInterface.
template <typename S> class PyModuleInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class PyModuleInterface::ConstReferenceFunctionsImplDoxy : public PyModuleInterface::ConstReferenceFunctionsImpl<REF>, public LibraryInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for PyModuleInterface.
template <typename S> class PyModuleInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
	...
	inline Result<void> GetFunctions27(BaseArray<NativePyCFunctionTable>& functions) const;
	inline Result<void> GetConstants(BaseArray<Tuple<const Char*, Int32>>& constants) const;
};
#ifdef DOXYGEN
template <typename REF> class PyModuleInterface::ReferenceFunctionsImplDoxy : public PyModuleInterface::ReferenceFunctionsImpl<REF>, public LibraryInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for PyModuleInterface.
template <typename S> class PyModuleInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
	...
	inline Result<void> GetFunctions27(BaseArray<NativePyCFunctionTable>& functions);
	inline Result<void> GetConstants(BaseArray<Tuple<const Char*, Int32>>& constants);
};
#ifdef DOXYGEN
template <typename REF> class PyModuleInterface::COWReferenceFunctionsImplDoxy : public PyModuleInterface::COWReferenceFunctionsImpl<REF>, public LibraryInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct PyModuleInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename LibraryInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename LibraryInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename LibraryInterface::ReferenceFunctions<ST>::type>>::type>::type; };
class PyModuleInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<PyModuleRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PyModuleInterface, maxon::StrongRefHandler, PyModuleRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<PyModuleInterface, maxon::StrongRefHandler, PyModuleRef>>>>);
	using NonConst = Super::ReferenceClass;
};

/// PyModuleRef is the reference class of PyModuleInterface.
class PyModuleRef : public PyModuleInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(PyModuleRef, Reference);
};
