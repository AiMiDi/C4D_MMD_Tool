...
namespace maxon
{
	namespace py
	{
		...
		static maxon::InterfaceDefinition s_PythonErrorInterface(PythonErrorInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class PythonErrorInterface::ProxyComponent : public maxon::Component<PythonErrorInterface::ProxyComponent, PythonErrorInterface>
		{
			MAXON_COMPONENT();
		public:
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(PythonErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
		static maxon::InterfaceDefinition s_PythonTracebackErrorInterface(PythonTracebackErrorInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class PythonTracebackErrorInterface::ProxyComponent : public maxon::Component<PythonTracebackErrorInterface::ProxyComponent, PythonTracebackErrorInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
			...
			void SetUrl(const Url& url) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<PythonTracebackErrorInterface>();
			...
			const Url& GetUrl() const 
			{
				...
				(*handler_)(_fn_PythonTracebackErrorInterface_GetUrl, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Url&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._PythonTracebackErrorInterface_GetUrl));
				return *proxy_result;
			}
			...
			Int GetLineNumber() const 
			{
				...
				(*handler_)(_fn_PythonTracebackErrorInterface_GetLineNumber, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, const maxon::GenericComponent*>::Invoke, (const void*) mt_._PythonTracebackErrorInterface_GetLineNumber));
				return proxy_result;
			}
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(PythonTracebackErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		static maxon::Result<void> RegisterReflection_PythonTracebackErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
		{
			...
			{
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, PythonTracebackErrorInterface, _PythonTracebackErrorInterface_SetUrl),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, PythonTracebackErrorInterface, _PythonTracebackErrorInterface_SetLineNumber),
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
		static maxon::InterfaceDefinition s_PythonSystemExitErrorInterface(PythonSystemExitErrorInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class PythonSystemExitErrorInterface::ProxyComponent : public maxon::Component<PythonSystemExitErrorInterface::ProxyComponent, PythonSystemExitErrorInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(PythonSystemExitErrorInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
		static maxon::InterfaceDefinition s_CPythonLibraryInterface(CPythonLibraryInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class CPythonLibraryInterface::ProxyComponent : public maxon::Component<CPythonLibraryInterface::ProxyComponent, CPythonLibraryInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
			...
			Result<void> Init(const Url& librarypath, Bool createSubLibrary) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				...
				(*handler_)(_fn_CPythonLibraryInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_Init));
				return proxy_result;
			}
			...
			Result<void> InitTypes() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_InitTypes, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_InitTypes));
				return proxy_result;
			}
			...
			Result<void> InitBuiltinModules() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_InitBuiltinModules, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_InitBuiltinModules));
				return proxy_result;
			}
			...
			void PrivateCPyRandom_Init() 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_PrivateCPyRandom_Init_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_PrivateCPyRandom_Init, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_PrivateCPyRandom_Init));
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_PrivateCPyRandom_Init;
			CPyRef CPy_InitModule(const ModuleDefinition& module) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_InitModule_Offset), maxon::reflection::Argument::ByReference(module)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_InitModule, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const ModuleDefinition&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_InitModule));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_InitModule;
			...
			const PythonDll& GetDll() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetDll, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const PythonDll&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetDll));
				return *proxy_result;
			}
			...
			FILE_native* FopenNative(const Char* name, const Char* mode) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_FopenNative, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<FILE_native*, maxon::GenericComponent*, const Char*, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_FopenNative));
				return proxy_result;
			}
			...
			Error LastPythonCallFailed(const maxon::SourceLocation& allocLocation, Bool withTraceback, Bool restoreError) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_LastPythonCallFailed, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Error, maxon::GenericComponent*, const maxon::SourceLocation&, Bool, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_LastPythonCallFailed));
				return proxy_result;
			}
			...
			Bool CPy_IsInitialized() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_IsInitialized, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_IsInitialized));
				return proxy_result;
			}
			...
			const Char* CPy_GetVersion() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetVersion, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Char*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetVersion));
				return proxy_result;
			}
			...
			const Char* CPy_GetPlatform() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetPlatform, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Char*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetPlatform));
				return proxy_result;
			}
			...
			const Char* CPy_GetCopyright() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetCopyright, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Char*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetCopyright));
				return proxy_result;
			}
			...
			const Char* CPy_GetCompiler() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetCompiler, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Char*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetCompiler));
				return proxy_result;
			}
			...
			const Char* CPy_GetBuildInfo() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetBuildInfo, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Char*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetBuildInfo));
				return proxy_result;
			}
			...
			Result<void> CPy_SetProgramName(const String& name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_SetProgramName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_SetProgramName));
				return proxy_result;
			}
			...
			Result<void> CPy_SetPythonHome(const Url& name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_SetPythonHome, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_SetPythonHome));
				return proxy_result;
			}
			...
			String CPy_GetProgramName() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetProgramName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetProgramName));
				return proxy_result;
			}
			...
			String CPy_GetPythonHome() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_GetPythonHome, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_GetPythonHome));
				return proxy_result;
			}
			...
			Bool ExecuteModule(const String& name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_ExecuteModule, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const String&>::Invoke, (const void*) mt_._CPythonLibraryInterface_ExecuteModule));
				return proxy_result;
			}
			...
			MPyCallerContextRef CPyCallerContext_New() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCallerContext_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyCallerContextRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCallerContext_New));
				return proxy_result;
			}
			...
			Bool CPyRun_SimpleFileExFlags(FILE_native* fp, const Char* filename, Int32 closeit, CPyCompilerFlags* flags) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyRun_SimpleFileExFlags, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, FILE_native*, const Char*, Int32, CPyCompilerFlags*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyRun_SimpleFileExFlags));
				return proxy_result;
			}
			...
			Bool CPyRun_SimpleFileExFlags(const Url& url, CPyCompilerFlags* flags) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyRun_SimpleFileExFlags_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const Url&, CPyCompilerFlags*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyRun_SimpleFileExFlags_1));
				return proxy_result;
			}
			...
			CPyRef CPyRun_SimpleStringFlags(const String& code, CPyCompilerFlags* flags) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyRun_SimpleStringFlags, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const String&, CPyCompilerFlags*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyRun_SimpleStringFlags));
				return proxy_result;
			}
			...
			NativePyObject* CPyRun_FileExFlags(FILE_native* fp, const Char* filename, Int32 start, NativePyObject* globals, NativePyObject* locals, Int32 closeit, CPyCompilerFlags* flags) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyRun_FileExFlags, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NativePyObject*, maxon::GenericComponent*, FILE_native*, const Char*, Int32, NativePyObject*, NativePyObject*, Int32, CPyCompilerFlags*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyRun_FileExFlags));
				return proxy_result;
			}
			...
			Result<void> CPyRun_InteractiveLoopFlags(FILE* fp, const Char* filename, CPyCompilerFlags* flags) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyRun_InteractiveLoopFlags, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, FILE*, const Char*, CPyCompilerFlags*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyRun_InteractiveLoopFlags));
				return proxy_result;
			}
			...
			PYGILSTATE CPyGilState_Ensure() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyGilState_Ensure, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<PYGILSTATE, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyGilState_Ensure));
				return proxy_result;
			}
			...
			GILSTATE GetGilState() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetGilState, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<GILSTATE, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetGilState));
				return proxy_result;
			}
			...
			NativePyThreadState* CPyGILState_GetThisThreadState() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyGILState_GetThisThreadState, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NativePyThreadState*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyGILState_GetThisThreadState));
				return proxy_result;
			}
			...
			NativePyThreadState* CPyThreadState_Swap(NativePyThreadState* state) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyThreadState_Swap, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NativePyThreadState*, maxon::GenericComponent*, NativePyThreadState*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyThreadState_Swap));
				return proxy_result;
			}
			...
			CPyRef CPyThreadState_GetDict() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyThreadState_GetDict, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyThreadState_GetDict));
				return proxy_result;
			}
			...
			CPyCodeRef CPy_CompileStringFlags(const Char* code, const Char* filename, PYINPUT start, CPyCompilerFlags* flags) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_CompileStringFlags, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyCodeRef, maxon::GenericComponent*, const Char*, const Char*, PYINPUT, CPyCompilerFlags*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_CompileStringFlags));
				return proxy_result;
			}
			...
			Int64 CPyGC_Collect() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyGC_Collect, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int64, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyGC_Collect));
				return proxy_result;
			}
			...
			Int32 CPyCode_Addr2Line(const CPyCodeRef& codeObject, Int32 x) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCode_Addr2Line, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, maxon::GenericComponent*, const CPyCodeRef&, Int32>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCode_Addr2Line));
				return proxy_result;
			}
			...
			CPyRef UnpackDataType(const CPyRef& obj) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_UnpackDataType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_UnpackDataType));
				return proxy_result;
			}
			...
			CPyRef UnpackData(const CPyRef& obj) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_UnpackData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_UnpackData));
				return proxy_result;
			}
			...
			CPyConstRef CPy_None() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_None, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_None));
				return proxy_result;
			}
			...
			CPyConstRef CPy_True() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_True, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_True));
				return proxy_result;
			}
			...
			CPyConstRef CPy_False() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_False, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_False));
				return proxy_result;
			}
			...
			CPyConstRef CPy_NotImplemented() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_NotImplemented, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_NotImplemented));
				return proxy_result;
			}
			...
			Bool CPyErr_Occurred(CPyRef* type) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyErr_Occurred, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, CPyRef*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyErr_Occurred));
				return proxy_result;
			}
			...
			CPyRef CPyErr_SetString(const CPyRef& errorType, const Char* errorString) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyErr_SetString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyErr_SetString));
				return proxy_result;
			}
			...
			CPyRef CPyErr_SetWithErrnoAndFilename(const CPyRef& errorType, Int32 errorNumber, const Char* filename) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyErr_SetWithErrnoAndFilename, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, Int32, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyErr_SetWithErrnoAndFilename));
				return proxy_result;
			}
			...
			CPyRef CPyErr_SetWithErrno(const CPyRef& errorType, Int32 errorNumber) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyErr_SetWithErrno, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, Int32>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyErr_SetWithErrno));
				return proxy_result;
			}
			...
			CPyRef CPyErr_SetString(const CPyRef& errorType, const String& errorString) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyErr_SetString_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const String&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyErr_SetString_1));
				return proxy_result;
			}
			...
			Bool CPyErr_ExceptionMatches(const CPyRef& exc) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyErr_ExceptionMatches, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyErr_ExceptionMatches));
				return proxy_result;
			}
			...
			Bool CPyExceptionClass_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExceptionClass_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExceptionClass_Check));
				return proxy_result;
			}
			...
			CPyRef CPyCapsule_New(void* pointer, const Char* name, CPyCapsule_Destructor* destructor) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*, void*, const Char*, CPyCapsule_Destructor*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_New));
				return proxy_result;
			}
			...
			Bool CPyCapsule_SetPointer(const CPyRef& capsule, void* pointer) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_SetPointer, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, void*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_SetPointer));
				return proxy_result;
			}
			...
			void* CPyCapsule_GetPointer(const CPyRef& capsule, const Char* name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_GetPointer, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<void*, maxon::GenericComponent*, const CPyRef&, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_GetPointer));
				return proxy_result;
			}
			...
			void* CPyCapsule_GetContext(const CPyRef& capsule) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_GetContext, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<void*, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_GetContext));
				return proxy_result;
			}
			...
			Bool CPyCapsule_SetContext(const CPyRef& capsule, void* context) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_SetContext, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, void*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_SetContext));
				return proxy_result;
			}
			...
			Bool CPyCapsule_CheckExact(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_CheckExact, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_CheckExact));
				return proxy_result;
			}
			...
			Bool CPyTraceBack_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTraceBack_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTraceBack_Check));
				return proxy_result;
			}
			...
			Bool CPyClass_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyClass_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyClass_Check));
				return proxy_result;
			}
			...
			CPyRef CPyTuple_New(UInt size) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*, UInt>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_New));
				return proxy_result;
			}
			...
			UInt CPyTuple_Size(const CPyRef& tuple) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_Size, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<UInt, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_Size));
				return proxy_result;
			}
			...
			CPyRef CPyTuple_GetItem(const CPyRef& tuple, UInt index) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_GetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, UInt>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_GetItem));
				return proxy_result;
			}
			...
			Bool CPyTuple_SetItem(const CPyRef& tuple, UInt index, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_SetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, UInt, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_SetItem));
				return proxy_result;
			}
			...
			CPyRef CPyTuple_GetSlice(const CPyRef& tuple, UInt from, UInt to) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_GetSlice, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, UInt, UInt>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_GetSlice));
				return proxy_result;
			}
			...
			Bool CPyTuple_CheckExact(const CPyRef& tuple) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_CheckExact, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_CheckExact));
				return proxy_result;
			}
			...
			Bool CPyObject_HasAttrString(const CPyRef& o, const Char* attrName) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_HasAttrString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_HasAttrString));
				return proxy_result;
			}
			...
			Bool CPyObject_SetAttrString(const CPyRef& o, const Char* name, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_SetAttrString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const Char*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_SetAttrString));
				return proxy_result;
			}
			...
			CPyRef CPyObject_GetAttrString(const CPyRef& o, const Char* name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_GetAttrString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_GetAttrString));
				return proxy_result;
			}
			...
			CPyRef CPyObject_Call(const CPyRef& callable_object, const CPyRef& tupleArg, const CPyRef& kw) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Call, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Call));
				return proxy_result;
			}
			...
			CPyRef CPyObject_Str(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Str, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Str));
				return proxy_result;
			}
			...
			CPyRef CPyObject_Repr(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Repr, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Repr));
				return proxy_result;
			}
			...
			CPyRef CPyObject_Dir(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Dir, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Dir));
				return proxy_result;
			}
			...
			CPyRef CPyObject_RichCompare(const CPyRef& o1, const CPyRef& o2, Int32 opid) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_RichCompare, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const CPyRef&, Int32>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_RichCompare));
				return proxy_result;
			}
			...
			Int64 CPyObject_Hash(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Hash, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int64, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Hash));
				return proxy_result;
			}
			...
			Bool CPyObject_IsTrue(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_IsTrue, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_IsTrue));
				return proxy_result;
			}
			...
			Bool CPyObject_Not(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Not, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Not));
				return proxy_result;
			}
			...
			Bool CPyCallable_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCallable_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCallable_Check));
				return proxy_result;
			}
			...
			Int CPyObject_Length(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Length, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Length));
				return proxy_result;
			}
			...
			CPyRef CPyObject_GetItem(const CPyRef& o, const CPyRef& key) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_GetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_GetItem));
				return proxy_result;
			}
			...
			CPyRef CPyObject_GetItemInt(const CPyRef& o, Int index) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_GetItemInt, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, Int>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_GetItemInt));
				return proxy_result;
			}
			...
			CPyRef CPyObject_GetItemString(const CPyRef& o, const Char* index) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_GetItemString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_GetItemString));
				return proxy_result;
			}
			...
			Bool CPyObject_DelItem(const CPyRef& o, const CPyRef& key) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_DelItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_DelItem));
				return proxy_result;
			}
			...
			Bool CPyObject_SetItem(const CPyRef& o, const CPyRef& key, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_SetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_SetItem));
				return proxy_result;
			}
			...
			Bool CPyObject_TypeCheck(const CPyRef& object, const CPyTypeRef& type) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_TypeCheck, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_TypeCheck));
				return proxy_result;
			}
			...
			CPyRef CPyObject_CallFunction(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_CallFunction, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_CallFunction));
				return proxy_result;
			}
			...
			CPyRef CPySys_GetObject(const Char* name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySys_GetObject, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySys_GetObject));
				return proxy_result;
			}
			...
			Bool CPySys_SetObject(const Char* name, const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySys_SetObject, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const Char*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySys_SetObject));
				return proxy_result;
			}
			...
			Result<void> CPySys_SetPath(const BaseArray<Url>& paths, PATHHANDLE add) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySys_SetPath, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BaseArray<Url>&, PATHHANDLE>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySys_SetPath));
				return proxy_result;
			}
			...
			Result<void> CPySys_SetArgvEx(const BaseArray<String>& args, Bool updatepath) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySys_SetArgvEx, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const BaseArray<String>&, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySys_SetArgvEx));
				return proxy_result;
			}
			...
			BaseArray<Url> CPySys_GetPath() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySys_GetPath, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<BaseArray<Url>, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySys_GetPath));
				return proxy_result;
			}
			...
			Result<void> CPySite_AddSiteDir(const Url& siteDir) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySite_AddSiteDir, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySite_AddSiteDir));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPySite_AddSiteDir;
			Bool CPyString_Check(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Bool proxy_result = maxon::PrivateLogNullptrError(false);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_Check_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_Check));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_Check;
			CPyRef CPyString_FromString(const Char* str) const 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_FromString_Offset), maxon::reflection::Argument::ByValue(str)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_FromString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_FromString));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_FromString;
			CPyRef CPyString_FromStringAndSize(const Block<const Char>& block) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_FromStringAndSize_Offset), maxon::reflection::Argument::ByReference(block)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_FromStringAndSize, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const Block<const Char>&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_FromStringAndSize));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_FromStringAndSize;
			Result<String> CPyString_AsString(const CPyRef& str) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_AsString_Offset), maxon::reflection::Argument::ByReference(str)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_AsString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<String>, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_AsString));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_AsString;
			const Char* CPyString_AsCString(const CPyRef& str) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				const Char* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_AsCString_Offset), maxon::reflection::Argument::ByReference(str)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_AsCString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Char*, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_AsCString));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_AsCString;
			Int CPyString_Size(const CPyRef& str) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int proxy_result = 0;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_Size_Offset), maxon::reflection::Argument::ByReference(str)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_Size, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_Size));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_Size;
			CPyRef CPyObject_GetIter(const CPyRef& o) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_GetIter, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_GetIter));
				return proxy_result;
			}
			...
			CPyRef CPyIter_Next(const CPyRef& it) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyIter_Next, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyIter_Next));
				return proxy_result;
			}
			...
			CPyRef CPyDict_New() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_New));
				return proxy_result;
			}
			...
			CPyRef CPyDict_GetItem(const CPyRef& dict, const CPyRef& key, Bool raiseKeyError) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_GetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const CPyRef&, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_GetItem));
				return proxy_result;
			}
			...
			CPyRef CPyDict_GetItemString(const CPyRef& dict, const Char* key, Bool raiseKeyError) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_GetItemString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, const Char*, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_GetItemString));
				return proxy_result;
			}
			...
			Bool CPyDict_SetItem(const CPyRef& dict, const CPyRef& key, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_SetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_SetItem));
				return proxy_result;
			}
			...
			Bool CPyDict_DelItem(const CPyRef& dict, const CPyRef& key) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_DelItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_DelItem));
				return proxy_result;
			}
			...
			CONTAINS CPyDict_Contains(const CPyRef& dict, const CPyRef& key) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Contains, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CONTAINS, maxon::GenericComponent*, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Contains));
				return proxy_result;
			}
			...
			Bool CPyDict_Next(const CPyRef& dict, Int& pos, CPyRef& key, CPyRef& value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Next, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, Int&, CPyRef&, CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Next));
				return proxy_result;
			}
			...
			CPyRef CPyDict_Keys(const CPyRef& dict) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Keys, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Keys));
				return proxy_result;
			}
			...
			CPyRef CPyDict_Values(const CPyRef& dict) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Values, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Values));
				return proxy_result;
			}
			...
			CPyRef CPyDict_Items(const CPyRef& dict) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Items, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Items));
				return proxy_result;
			}
			...
			Int CPyDict_Size(const CPyRef& dict) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Size, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Size));
				return proxy_result;
			}
			...
			CPyRef CPyDict_Copy(const CPyRef& dict) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Copy, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Copy));
				return proxy_result;
			}
			...
			Bool CPyDict_SetItemString(const CPyRef& dict, const Char* key, const CPyRef& item) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_SetItemString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const CPyRef&, const Char*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_SetItemString));
				return proxy_result;
			}
			...
			Bool CPyDict_Check(const CPyRef& o) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Check));
				return proxy_result;
			}
			...
			CPyRef CPyList_New(UInt size) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, UInt>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_New));
				return proxy_result;
			}
			...
			Bool CPyList_CheckExact(const CPyRef& list) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_CheckExact, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_CheckExact));
				return proxy_result;
			}
			...
			Int CPyList_Size(const CPyRef& list) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_Size, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_Size));
				return proxy_result;
			}
			...
			CPyRef CPyList_GetItem(const CPyRef& list, UInt index) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_GetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, UInt>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_GetItem));
				return proxy_result;
			}
			...
			Bool CPyList_SetItem(const CPyRef& list, UInt anonymous_param_2, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_SetItem, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, UInt, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_SetItem));
				return proxy_result;
			}
			...
			Bool CPyList_Insert(const CPyRef& list, UInt anonymous_param_2, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_Insert, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, UInt, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_Insert));
				return proxy_result;
			}
			...
			Bool CPyList_Append(const CPyRef& list, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_Append, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_Append));
				return proxy_result;
			}
			...
			CPyRef CPyList_GetSlice(const CPyRef& list, UInt from, UInt to) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_GetSlice, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&, UInt, UInt>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_GetSlice));
				return proxy_result;
			}
			...
			Bool CPyList_SetSlice(const CPyRef& list, UInt from, UInt to, const CPyRef& item) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_SetSlice, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, UInt, UInt, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_SetSlice));
				return proxy_result;
			}
			...
			Bool CPyList_Sort(const CPyRef& list) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_Sort, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_Sort));
				return proxy_result;
			}
			...
			Bool CPyList_Reverse(const CPyRef& list) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_Reverse, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_Reverse));
				return proxy_result;
			}
			...
			CPyRef CPyList_AsTuple(const CPyRef& list) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_AsTuple, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_AsTuple));
				return proxy_result;
			}
			...
			Bool CPyDict_DelItemString(const CPyRef& p, const Char* key) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_DelItemString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_DelItemString));
				return proxy_result;
			}
			...
			Bool CPyModule_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_Check));
				return proxy_result;
			}
			...
			Bool CPyModule_AddObject(const CPyRef& module, const Char* name, const CPyRef& value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_AddObject, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const Char*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_AddObject));
				return proxy_result;
			}
			...
			CPyRef CPyModule_GetDict(const CPyRef& module) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_GetDict, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_GetDict));
				return proxy_result;
			}
			...
			Bool CPyModule_AddIntConstant(const CPyRef& mod, const Char* name, long value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_AddIntConstant, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const Char*, long>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_AddIntConstant));
				return proxy_result;
			}
			...
			CPyRef CPyImport_ImportModule(const Char* name) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyImport_ImportModule, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const Char*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyImport_ImportModule));
				return proxy_result;
			}
			...
			CPyRef CPyImport_GetImporter(const CPyRef& path) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyImport_GetImporter, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyImport_GetImporter));
				return proxy_result;
			}
			...
			Bool CPyType_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_Check));
				return proxy_result;
			}
			...
			Bool CPyType_IsSubtype(const CPyTypeRef& a, const CPyTypeRef& b) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_IsSubtype, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyTypeRef&, const CPyTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_IsSubtype));
				return proxy_result;
			}
			...
			Bool CPyType_HasFeature(const CPyTypeRef& type, Int64 f) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_HasFeature, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const CPyTypeRef&, Int64>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_HasFeature));
				return proxy_result;
			}
			...
			Bool CPyType_FastSubclass(const CPyTypeRef& type, Int64 f) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_FastSubclass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const CPyTypeRef&, Int64>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_FastSubclass));
				return proxy_result;
			}
			...
			Result<String> CPyType_GetName(const CPyTypeRef& type) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_GetName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<String>, maxon::GenericComponent*, const CPyTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_GetName));
				return proxy_result;
			}
			...
			Bool CPyType_Ready(CPyTypeRef& type) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_Ready, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, CPyTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_Ready));
				return proxy_result;
			}
			...
			NativePyThreadState* CPyEval_SaveThread() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyEval_SaveThread, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NativePyThreadState*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyEval_SaveThread));
				return proxy_result;
			}
			...
			Bool CPyEval_ThreadsInitialized() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyEval_ThreadsInitialized, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyEval_ThreadsInitialized));
				return proxy_result;
			}
			...
			void CPyEval_AcquireLock() 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyEval_AcquireLock_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyEval_AcquireLock, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyEval_AcquireLock));
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyEval_AcquireLock;
			void CPyEval_ReleaseLock() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyEval_ReleaseLock_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyEval_ReleaseLock, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyEval_ReleaseLock));
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyEval_ReleaseLock;
			...
			CPyRef CPyEval_GetBuiltins() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyEval_GetBuiltins, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyEval_GetBuiltins));
				return proxy_result;
			}
			...
			CPyRef CPyEval_EvalCode(const CPyCodeRef& code, const CPyRef& globals, const CPyRef& locals) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyEval_EvalCode, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*, const CPyCodeRef&, const CPyRef&, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyEval_EvalCode));
				return proxy_result;
			}
			...
			Bool CPyFloat_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyFloat_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyFloat_Check));
				return proxy_result;
			}
			...
			CPyRef CPyFloat_FromFloat32(Float32 value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyFloat_FromFloat32, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, Float32>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyFloat_FromFloat32));
				return proxy_result;
			}
			...
			CPyRef CPyFloat_FromFloat64(Float64 value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyFloat_FromFloat64, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, Float64>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyFloat_FromFloat64));
				return proxy_result;
			}
			...
			Float64 CPyFloat_AsFloat64(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyFloat_AsFloat64, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Float64, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyFloat_AsFloat64));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyFloat_AsFloat64;
			Bool CPyInt_Check(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Bool proxy_result = maxon::PrivateLogNullptrError(false);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_Check_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_Check));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_Check;
			CPyRef CPyBool_FromBool(Bool value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyBool_FromBool, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyBool_FromBool));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyBool_FromBool;
			CPyRef CPyInt_FromInt16(Int16 value) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_FromInt16_Offset), maxon::reflection::Argument::ByValue(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_FromInt16, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, Int16>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_FromInt16));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_FromInt16;
			CPyRef CPyInt_FromUInt16(UInt16 value) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_FromUInt16_Offset), maxon::reflection::Argument::ByValue(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_FromUInt16, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, UInt16>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_FromUInt16));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_FromUInt16;
			CPyRef CPyInt_FromInt32(Int32 value) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_FromInt32_Offset), maxon::reflection::Argument::ByValue(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_FromInt32, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, Int32>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_FromInt32));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_FromInt32;
			CPyRef CPyInt_FromUInt32(UInt32 value) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_FromUInt32_Offset), maxon::reflection::Argument::ByValue(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_FromUInt32, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, UInt32>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_FromUInt32));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_FromUInt32;
			CPyRef CPyInt_FromInt64(Int64 value) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_FromInt64_Offset), maxon::reflection::Argument::ByValue(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_FromInt64, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, Int64>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_FromInt64));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_FromInt64;
			CPyRef CPyInt_FromUInt64(UInt64 value) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_FromUInt64_Offset), maxon::reflection::Argument::ByValue(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_FromUInt64, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, UInt64>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_FromUInt64));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_FromUInt64;
			Int16 CPyInt_AsInt16(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_AsInt16_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_AsInt16, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int16, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_AsInt16));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_AsInt16;
			UInt16 CPyInt_AsUInt16(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_AsUInt16_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_AsUInt16, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<UInt16, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_AsUInt16));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_AsUInt16;
			Int32 CPyInt_AsInt32(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32 proxy_result = 0;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_AsInt32_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_AsInt32, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_AsInt32));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_AsInt32;
			UInt32 CPyInt_AsUInt32(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_AsUInt32_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_AsUInt32, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<UInt32, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_AsUInt32));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_AsUInt32;
			Int64 CPyInt_AsInt64(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int64 proxy_result = 0;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_AsInt64_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_AsInt64, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int64, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_AsInt64));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_AsInt64;
			UInt64 CPyInt_AsUInt64(const CPyRef& o) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_AsUInt64_Offset), maxon::reflection::Argument::ByReference(o)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_AsUInt64, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<UInt64, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_AsUInt64));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_AsUInt64;
			Bool CPyNumber_Check(const CPyRef& o) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyNumber_Check, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyNumber_Check));
				return proxy_result;
			}
			...
			MPyFunctionRef MPyFunction_New(const reflection::Function* func) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyFunction_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyFunctionRef, maxon::GenericComponent*, const reflection::Function*>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyFunction_New));
				return proxy_result;
			}
			...
			MPyMemberRef MPyMember_New(const reflection::Member* member) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyMember_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyMemberRef, maxon::GenericComponent*, const reflection::Member*>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyMember_New));
				return proxy_result;
			}
			...
			MPyClassRef MPyClass_New(const reflection::Class* cls) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyClass_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyClassRef, maxon::GenericComponent*, const reflection::Class*>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyClass_New));
				return proxy_result;
			}
			...
			Int32* CPy_DebugFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_DebugFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_DebugFlag));
				return proxy_result;
			}
			...
			Int32* CPy_VerboseFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_VerboseFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_VerboseFlag));
				return proxy_result;
			}
			...
			Int32* CPy_InteractiveFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_InteractiveFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_InteractiveFlag));
				return proxy_result;
			}
			...
			Int32* CPy_InspectFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_InspectFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_InspectFlag));
				return proxy_result;
			}
			...
			Int32* CPy_OptimizeFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_OptimizeFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_OptimizeFlag));
				return proxy_result;
			}
			...
			Int32* CPy_NoSiteFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_NoSiteFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_NoSiteFlag));
				return proxy_result;
			}
			...
			Int32* CPy_BytesWarningFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_BytesWarningFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_BytesWarningFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_BytesWarningFlag;
			Int32* CPy_UseClassExceptionsFlag() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_UseClassExceptionsFlag_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_UseClassExceptionsFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_UseClassExceptionsFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_UseClassExceptionsFlag;
			Int32* CPy_FrozenFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_FrozenFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_FrozenFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_FrozenFlag;
			Int32* CPy_TabcheckFlag() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_TabcheckFlag_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_TabcheckFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_TabcheckFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_TabcheckFlag;
			Int32* CPy_UnicodeFlag() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_UnicodeFlag_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_UnicodeFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_UnicodeFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_UnicodeFlag;
			Int32* CPy_IgnoreEnvironmentFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_IgnoreEnvironmentFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_IgnoreEnvironmentFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_IgnoreEnvironmentFlag;
			Int32* CPy_DivisionWarningFlag() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_DivisionWarningFlag_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_DivisionWarningFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_DivisionWarningFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_DivisionWarningFlag;
			Int32* CPy_DontWriteBytecodeFlag() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_DontWriteBytecodeFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_DontWriteBytecodeFlag));
				return proxy_result;
			}
			...
			Int32* CPy_NoUserSiteDirectory() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPy_NoUserSiteDirectory, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_NoUserSiteDirectory));
				return proxy_result;
			}
			...
			Int32* CPy_QnewFlag() 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_QnewFlag_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_QnewFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_QnewFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_QnewFlag;
			Int32* CPy_Py3kWarningFlag() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_Py3kWarningFlag_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_Py3kWarningFlag, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_Py3kWarningFlag));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_Py3kWarningFlag;
			Int32* CPy_CheckInterval() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Int32* proxy_result = nullptr;
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPy_CheckInterval_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPy_CheckInterval, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPy_CheckInterval));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPy_CheckInterval;
			CPyConstRef CPyExc_BaseException() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_BaseException, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_BaseException));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_Exception() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_Exception, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_Exception));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_StopIteration() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_StopIteration, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_StopIteration));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_GeneratorExit() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_GeneratorExit, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_GeneratorExit));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_StandardError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_StandardError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_StandardError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_ArithmeticError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_ArithmeticError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_ArithmeticError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_LookupError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_LookupError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_LookupError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_AssertionError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_AssertionError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_AssertionError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_AttributeError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_AttributeError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_AttributeError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_EOFError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_EOFError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_EOFError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_FloatingPointError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_FloatingPointError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_FloatingPointError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_EnvironmentError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_EnvironmentError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_EnvironmentError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_IOError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_IOError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_IOError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_OSError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_OSError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_OSError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_ImportError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_ImportError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_ImportError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_IndexError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_IndexError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_IndexError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_KeyError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_KeyError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_KeyError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_KeyboardInterrupt() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_KeyboardInterrupt, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_KeyboardInterrupt));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_MemoryError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_MemoryError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_MemoryError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_NameError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_NameError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_NameError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_OverflowError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_OverflowError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_OverflowError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_RuntimeError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_RuntimeError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_RuntimeError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_NotImplementedError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_NotImplementedError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_NotImplementedError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_SyntaxError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_SyntaxError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_SyntaxError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_IndentationError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_IndentationError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_IndentationError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_TabError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_TabError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_TabError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_ReferenceError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_ReferenceError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_ReferenceError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_SystemError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_SystemError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_SystemError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_SystemExit() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_SystemExit, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_SystemExit));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_TypeError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_TypeError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_TypeError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UnboundLocalError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UnboundLocalError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UnboundLocalError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UnicodeError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UnicodeError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UnicodeError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UnicodeEncodeError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UnicodeEncodeError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UnicodeEncodeError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UnicodeDecodeError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UnicodeDecodeError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UnicodeDecodeError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UnicodeTranslateError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UnicodeTranslateError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UnicodeTranslateError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_ValueError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_ValueError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_ValueError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_ZeroDivisionError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_ZeroDivisionError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_ZeroDivisionError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_WindowsError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_WindowsError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_WindowsError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_BufferError() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_BufferError, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_BufferError));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_MemoryErrorInst() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_MemoryErrorInst, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_MemoryErrorInst));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_RecursionErrorInst() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_RecursionErrorInst, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_RecursionErrorInst));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_Warning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_Warning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_Warning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UserWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UserWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UserWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_DeprecationWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_DeprecationWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_DeprecationWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_PendingDeprecationWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_PendingDeprecationWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_PendingDeprecationWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_SyntaxWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_SyntaxWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_SyntaxWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_RuntimeWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_RuntimeWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_RuntimeWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_FutureWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_FutureWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_FutureWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_ImportWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_ImportWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_ImportWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_UnicodeWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_UnicodeWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_UnicodeWarning));
				return proxy_result;
			}
			...
			CPyConstRef CPyExc_BytesWarning() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyExc_BytesWarning, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyExc_BytesWarning));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyNullImporter_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyNullImporter_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyNullImporter_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPySuper_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySuper_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySuper_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyBool_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyBool_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyBool_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyObject_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyModule_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_Type));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyModule_Type;
			CPyTypeConstRef CPyString_Type() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyTypeConstRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyTypeConstRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyString_Type_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyString_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyString_Type));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyString_Type;
			CPyTypeConstRef CPyInt_Type() 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyTypeConstRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyTypeConstRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyInt_Type_Offset)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyInt_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyInt_Type));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyInt_Type;
			CPyTypeConstRef CPyLong_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyLong_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyLong_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyFloat_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyFloat_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyFloat_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyTuple_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTuple_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTuple_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyList_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyList_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyList_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyDict_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyDict_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyDict_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyClass_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyClass_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyClass_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyTraceBack_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyTraceBack_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyTraceBack_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPySlice_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPySlice_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPySlice_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyType_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyType_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyType_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyMemoryView_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyMemoryView_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyMemoryView_Type));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_CPyMemoryView_Type;
			const PyChar* ConvertAndCacheString(const String& str, const StringEncodingRef& encoding) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_ConvertAndCacheString_Offset), maxon::reflection::Argument::ByReference(str), maxon::reflection::Argument::ByReference(encoding)};
				(*handler_)(_fn_CPythonLibraryInterface_ConvertAndCacheString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const PyChar*, maxon::GenericComponent*, const String&, const StringEncodingRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_ConvertAndCacheString));
				return proxy_result;
			}
			...
			Result<void> RegisterSpecificPythonClass(const Id& typeId, const CPyTypeRef& type) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_RegisterSpecificPythonClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Id&, const CPyTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_RegisterSpecificPythonClass));
				return proxy_result;
			}
			...
			Result<void> PrivateRegisterBuiltinConverter(const DataType* dt, const DelegatePyObject_AsData& f1, const DelegatePyObject_FromData<>& f2) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_PrivateRegisterBuiltinConverter_Offset), maxon::reflection::Argument::ByValue(dt), maxon::reflection::Argument::ByReference(f1), maxon::reflection::Argument::ByReference(f2)};
				(*handler_)(_fn_CPythonLibraryInterface_PrivateRegisterBuiltinConverter, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataType*, const DelegatePyObject_AsData&, const DelegatePyObject_FromData<>&>::Invoke, (const void*) mt_._CPythonLibraryInterface_PrivateRegisterBuiltinConverter));
				return proxy_result;
			}
			...
			Url GetSpecialPath(SPECIALPATH anonymous_param_1) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetSpecialPath, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Url, maxon::GenericComponent*, SPECIALPATH>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetSpecialPath));
				return proxy_result;
			}
			...
			CPyTypeConstRef MPyDataCapsule_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyDataCapsule_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyDataCapsule_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyData_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyData_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyData_Type));
				return proxy_result;
			}
			...
			CPyTypeConstRef CPyCapsule_Type() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyCapsule_Type, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeConstRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyCapsule_Type));
				return proxy_result;
			}
			...
			CPyRef PrivateGetCurrentCallerContext() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_PrivateGetCurrentCallerContext, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_PrivateGetCurrentCallerContext));
				return proxy_result;
			}
			...
			CPyRef MPyDataType_ToMapperInstance(const CPyRef& capsule) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyDataType_ToMapperInstance, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyDataType_ToMapperInstance));
				return proxy_result;
			}
			...
			CPyRef MPyData_ToMapperInstance(const MPyDataRef& capsule) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyData_ToMapperInstance, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const MPyDataRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyData_ToMapperInstance));
				return proxy_result;
			}
			...
			CPyRef CPyObject_ToMapperInstance(const DataType* dt, const CPyRef& capsule) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyObject_ToMapperInstance_Offset), maxon::reflection::Argument::ByValue(dt), maxon::reflection::Argument::ByReference(capsule)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_ToMapperInstance, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const DataType*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_ToMapperInstance));
				return proxy_result;
			}
			...
			Result<void> AssociateDataTypeWithPythonTypes(const DataType* dt, const CPyRef& type) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_AssociateDataTypeWithPythonTypes_Offset), maxon::reflection::Argument::ByValue(dt), maxon::reflection::Argument::ByReference(type)};
				(*handler_)(_fn_CPythonLibraryInterface_AssociateDataTypeWithPythonTypes, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const DataType*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_AssociateDataTypeWithPythonTypes));
				return proxy_result;
			}
			...
			Result<CPyRef> GetAssociatedDataType(const DataType* dt) 
			{
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_GetAssociatedDataType_Offset), maxon::reflection::Argument::ByValue(dt)};
				(*handler_)(_fn_CPythonLibraryInterface_GetAssociatedDataType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<CPyRef>, maxon::GenericComponent*, const DataType*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetAssociatedDataType));
				return proxy_result;
			}
			...
			DelegatePyObject_FromData<>* GetConverterPyObject_FromData(const DataType* dt) 
			{
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_GetConverterPyObject_FromData_Offset), maxon::reflection::Argument::ByValue(dt)};
				(*handler_)(_fn_CPythonLibraryInterface_GetConverterPyObject_FromData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<DelegatePyObject_FromData<>*, maxon::GenericComponent*, const DataType*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetConverterPyObject_FromData));
				return proxy_result;
			}
			...
			MPyDataRef MPyData_New(Data& data) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyData_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyDataRef, maxon::GenericComponent*, Data&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyData_New));
				return proxy_result;
			}
			...
			MPyDataRef MPyData_New(const DataType* dt, Generic* data, Bool owner, const DataType* mapDt) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				MPyDataRef proxy_result = maxon::PrivateIncompleteNullReturnValue<MPyDataRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_MPyData_New_1_Offset), maxon::reflection::Argument::ByValue(dt), maxon::reflection::Argument::ByValue(data), maxon::reflection::Argument::ByValue(owner), maxon::reflection::Argument::ByValue(mapDt)};
				(*handler_)(_fn_CPythonLibraryInterface_MPyData_New_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyDataRef, maxon::GenericComponent*, const DataType*, Generic*, Bool, const DataType*>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyData_New_1));
				return proxy_result;
			}
			...
			MPyDataTypeRef MPyDataType_New(const DataType* dt) 
			{
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_MPyDataType_New_Offset), maxon::reflection::Argument::ByValue(dt)};
				(*handler_)(_fn_CPythonLibraryInterface_MPyDataType_New, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<MPyDataTypeRef, maxon::GenericComponent*, const DataType*>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyDataType_New));
				return proxy_result;
			}
			...
			Bool MPyDataType_CheckExact(const CPyRef& o) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyDataType_CheckExact, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyDataType_CheckExact));
				return proxy_result;
			}
			...
			const DataType* MPyDataType_GetDataType(const MPyDataTypeRef& o) const 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				const DataType* proxy_result = nullptr;
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyDataType_GetDataType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*, const MPyDataTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyDataType_GetDataType));
				return proxy_result;
			}
			...
			Bool MPyData_CheckExact(const CPyRef& o) const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MPyData_CheckExact, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MPyData_CheckExact));
				return proxy_result;
			}
			...
			Result<Data*> CPyObject_AsData(Int stackDepth, const CPyRef& obj, const DataType* expected, BlockArray<Data>& k, BaseArray<reflection::Argument>* n) 
			{
				...
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyObject_AsData_Offset), maxon::reflection::Argument::ByValue(stackDepth), maxon::reflection::Argument::ByReference(obj), maxon::reflection::Argument::ByValue(expected), maxon::reflection::Argument::ByReference(k), maxon::reflection::Argument::ByValue(n)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_AsData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Data*>, maxon::GenericComponent*, Int, const CPyRef&, const DataType*, BlockArray<Data>&, BaseArray<reflection::Argument>*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_AsData));
				return proxy_result;
			}
			...
			Result<BaseArray<TYPE_CONVERSION_TUPLE>> GetRegisteredTypesWithConversions() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetRegisteredTypesWithConversions, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<TYPE_CONVERSION_TUPLE>>, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetRegisteredTypesWithConversions));
				return proxy_result;
			}
			static const maxon::reflection::Function* _fn_CPythonLibraryInterface_GetRegisteredTypesWithConversions;
			Result<const DataType*> ParseDataType(const CPyRef& args, Int32 argIndex, Bool canBeNone) 
			{
				const maxon::ComponentInfo* proxy_info;
				maxon::Object* o_;
				const maxon::reflection::ProxyHandler* handler_;
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				Result<const DataType*> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
				...
				(*handler_)(_fn_CPythonLibraryInterface_ParseDataType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<const DataType*>, maxon::GenericComponent*, const CPyRef&, Int32, Bool>::Invoke, (const void*) mt_._CPythonLibraryInterface_ParseDataType));
				return proxy_result;
			}
			...
			CPyRef MaxonConvertAuto(const CPyRef& capsule) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_MaxonConvertAuto, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_MaxonConvertAuto));
				return proxy_result;
			}
			...
			CPyRef CPyObject_FromGeneric(const DataType* origDt, const Generic* object, OWNERSHIP ownership, const CPyTypeRef* expected, Int* count) 
			{
				...
				const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPythonLibraryInterface>();
				CPyRef proxy_result = maxon::PrivateIncompleteNullReturnValue<CPyRef>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyObject_FromGeneric_Offset), maxon::reflection::Argument::ByValue(origDt), maxon::reflection::Argument::ByValue(object), maxon::reflection::Argument::ByValue(ownership), maxon::reflection::Argument::ByValue(expected), maxon::reflection::Argument::ByValue(count)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyObject_FromGeneric, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, maxon::GenericComponent*, const DataType*, const Generic*, OWNERSHIP, const CPyTypeRef*, Int*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyObject_FromGeneric));
				return proxy_result;
			}
			...
			CPyRef CreateGlobalDictionary() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CreateGlobalDictionary, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_CreateGlobalDictionary));
				return proxy_result;
			}
			...
			Result<BaseArray<SourceLocation>> GetCurrentTraceback() 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetCurrentTraceback, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<BaseArray<SourceLocation>>, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetCurrentTraceback));
				return proxy_result;
			}
			...
			Class<CPyRef> GetCPyRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetCPyRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<CPyRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetCPyRefClass));
				return proxy_result;
			}
			...
			Class<CPyTypeRef> GetCPyTypeRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetCPyTypeRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<CPyTypeRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetCPyTypeRefClass));
				return proxy_result;
			}
			...
			Class<CPyFrameRef> GetCPyFrameRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetCPyFrameRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<CPyFrameRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetCPyFrameRefClass));
				return proxy_result;
			}
			...
			Class<CPyTracebackRef> GetCPyTracebackRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetCPyTracebackRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<CPyTracebackRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetCPyTracebackRefClass));
				return proxy_result;
			}
			...
			Class<CPyCodeRef> GetCPyCodeRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetCPyCodeRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<CPyCodeRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetCPyCodeRefClass));
				return proxy_result;
			}
			...
			Class<MPyClassRef> GetMPyClassRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetMPyClassRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<MPyClassRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetMPyClassRefClass));
				return proxy_result;
			}
			...
			Class<MPyMemberRef> GetMPyMemberRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetMPyMemberRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<MPyMemberRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetMPyMemberRefClass));
				return proxy_result;
			}
			...
			Class<MPyFunctionRef> GetMPyFunctionRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetMPyFunctionRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<MPyFunctionRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetMPyFunctionRefClass));
				return proxy_result;
			}
			...
			Class<MPyDataTypeRef> GetMPyDataTypeRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetMPyDataTypeRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<MPyDataTypeRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetMPyDataTypeRefClass));
				return proxy_result;
			}
			...
			Class<MPyDataRef> GetMPyDataRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetMPyDataRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<MPyDataRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetMPyDataRefClass));
				return proxy_result;
			}
			...
			Class<MPyCallerContextRef> GetMPyCallerContextRefClass() const 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_GetMPyCallerContextRefClass, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Class<MPyCallerContextRef>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPythonLibraryInterface_GetMPyCallerContextRefClass));
				return proxy_result;
			}
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_PrivateCPyRandom_Init;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_InitModule;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_Check;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_FromString;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_FromStringAndSize;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_AsString;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_AsCString;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_Size;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyEval_AcquireLock;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyEval_ReleaseLock;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_Check;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyBool_FromBool;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_FromInt16;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_FromUInt16;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_FromInt32;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_FromUInt32;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_FromInt64;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_FromUInt64;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_AsInt16;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_AsUInt16;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_AsInt32;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_AsUInt32;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_AsInt64;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_AsUInt64;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_UseClassExceptionsFlag;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_FrozenFlag;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_TabcheckFlag;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_UnicodeFlag;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_DivisionWarningFlag;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_QnewFlag;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_Py3kWarningFlag;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPy_CheckInterval;
		...
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyString_Type;
		const maxon::reflection::Function* CPythonLibraryInterface::ProxyComponent::_fn_CPythonLibraryInterface_CPyInt_Type;
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(CPythonLibraryInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		static maxon::Result<void> RegisterReflection_CPythonLibraryInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
		{
			maxon::reflection::FunctionInfo functions[] =
			{
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_Init),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_PrivateCPyRandom_Init),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_InitModule),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_Free),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_GetDll),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_FopenNative),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_LastPythonCallFailed),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_RegisterComponentProxy),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_SetProgramName),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_SetPythonHome),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_ExecuteModule),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyRun_SimpleFileExFlags),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyRun_SimpleFileExFlags_1),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyRun_SimpleStringFlags),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyRun_FileExFlags),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyRun_InteractiveLoopFlags),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyGilState_Ensure),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyGilState_Release),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyThreadState_Swap),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 256LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_CompileStringFlags),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_Incref),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_Decref),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_SafeIncref),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_SafeDecref),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyGC_Collect),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCode_Addr2Line),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_UnpackDataType),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_UnpackData),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 8LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_Occurred),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_SetString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_SetWithErrnoAndFilename),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_SetWithErrno),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_SetString_1),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_SetNone),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 168LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_Fetch),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 168LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_NormalizeException),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_Restore),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyErr_ExceptionMatches),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyExceptionClass_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCapsule_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCapsule_SetPointer),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCapsule_GetPointer),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCapsule_GetContext),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCapsule_SetContext),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCapsule_CheckExact),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTraceBack_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyClass_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTuple_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTuple_Size),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTuple_GetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTuple_SetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTuple_GetSlice),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyTuple_CheckExact),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_HasAttrString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_SetAttrString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_GetAttrString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Call),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Str),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Repr),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Dir),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_RichCompare),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Hash),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_IsTrue),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Not),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyCallable_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_Length),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_GetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_GetItemInt),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_GetItemString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_DelItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_SetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_TypeCheck),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_CallFunction),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPySys_GetObject),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPySys_SetObject),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPySys_SetPath),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPySys_SetArgvEx),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPySys_GetPath),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPySite_AddSiteDir),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_FromString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_FromStringAndSize),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_AsString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_AsCString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_Size),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_GetIter),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyIter_Next),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_GetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_GetItemString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_SetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_DelItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Contains),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Clear),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 48LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Next),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Keys),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Values),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Items),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Size),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Copy),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_SetItemString),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_CheckExact),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_Size),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_GetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_SetItem),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_Insert),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_Append),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_GetSlice),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_SetSlice),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_Sort),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_Reverse),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyList_AsTuple),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyDict_DelItemString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyModule_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyModule_AddObject),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyModule_GetDict),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyModule_AddIntConstant),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyImport_ImportModule),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyImport_GetImporter),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyType_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyType_IsSubtype),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyType_HasFeature),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyType_FastSubclass),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyType_GetName),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyType_Ready),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_SaveThread),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_RestoreThread),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_AcquireLock),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_ReleaseLock),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_AcquireThread),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_ReleaseThread),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyEval_EvalCode),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyFloat_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyFloat_FromFloat32),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyFloat_FromFloat64),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyFloat_AsFloat64),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyBool_FromBool),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_FromInt16),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_FromUInt16),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_FromInt32),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_FromUInt32),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_FromInt64),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_FromUInt64),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_AsInt16),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_AsUInt16),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_AsInt32),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_AsUInt32),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_AsInt64),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_AsUInt64),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyNumber_Check),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyFunction_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyMember_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyClass_New),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_UseClassExceptionsFlag),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_FrozenFlag),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_TabcheckFlag),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_UnicodeFlag),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_DivisionWarningFlag),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_QnewFlag),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_Py3kWarningFlag),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPy_CheckInterval),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyString_Type),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyInt_Type),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_ConvertAndCacheString),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_RegisterSpecificPythonClass),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_PrivateRegisterBuiltinConverter),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_GetSpecialPath),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_RegisterSpecialPath),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyDataType_ToMapperInstance),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyData_ToMapperInstance),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_ToMapperInstance),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_AssociateDataTypeWithPythonTypes),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_GetAssociatedDataType),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_GetConverterPyObject_FromData),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyData_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyData_New_1),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyDataType_New),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyDataType_CheckExact),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyDataType_GetDataType),
				MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MPyData_CheckExact),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_AsData),
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_ParseDataType),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_SetError),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_SetError_1),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_MaxonConvertAuto),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyObject_FromGeneric),
...
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_PyModuleInterface(PyModuleInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class PyModuleInterface::ProxyComponent : public maxon::Component<PyModuleInterface::ProxyComponent, PyModuleInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		maxon::reflection::ProxyHandler _handler;
		Result<void> GetFunctions27(BaseArray<NativePyCFunctionTable>& functions) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::Object* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<PyModuleInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._PyModuleInterface_GetFunctions27_Offset), maxon::reflection::Argument::ByReference(functions)};
			(*handler_)(_fn_PyModuleInterface_GetFunctions27, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseArray<NativePyCFunctionTable>&>::Invoke, (const void*) mt_._PyModuleInterface_GetFunctions27));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_PyModuleInterface_GetFunctions27;
		Result<void> GetConstants(BaseArray<Tuple<const Char*, Int32>>& constants) 
		{
			...
			(*handler_)(_fn_PyModuleInterface_GetConstants, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseArray<Tuple<const Char*, Int32>>&>::Invoke, (const void*) mt_._PyModuleInterface_GetConstants));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_PyModuleInterface_GetConstants;
	};
	const maxon::reflection::Function* PyModuleInterface::ProxyComponent::_fn_PyModuleInterface_GetFunctions27;
	const maxon::reflection::Function* PyModuleInterface::ProxyComponent::_fn_PyModuleInterface_GetConstants;
	PRIVATE_MAXON_COMPONENT_REGISTER(PyModuleInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_PyModuleInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, PyModuleInterface, _PyModuleInterface_GetFunctions27),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, PyModuleInterface, _PyModuleInterface_GetConstants),
		};
