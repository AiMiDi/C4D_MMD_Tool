...
namespace maxon
{
	namespace py
	{
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CPyInterface, "net.maxon.python.interface.cpyref", "maxon.py.CPyInterface", , &Object::_interface);
		const maxon::Char* const CPyInterface::MTable::_ids = 
		"Init@93ae16f30041d8b9\0" // Init(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject)
		"Incref@6b2e10f\0" // Incref()
		"Decref@6b2e10f\0" // Decref()
		"GetRefCount@82d56af6\0" // GetRefCount()
		"GetLibrary@5b0d60b0c47e8401\0" // GetLibrary() const
		"GetTypeRef@18949c5e975594e4\0" // GetTypeRef() const
		"GetPyObject@eec8a73e7dbc01c2\0" // GetPyObject() const
		"Disconnect@bd614fb7b179ad78\0" // Disconnect()
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CPyTypeInterface, "net.maxon.python.interface.cpytype", "maxon.py.CPyTypeInterface", , &CPyInterface::_interface);
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CPyFrameInterface, "net.maxon.python.interface.cpyframe", "maxon.py.CPyFrameInterface", , &CPyInterface::_interface);
		const maxon::Char* const CPyFrameInterface::MTable::_ids = 
		"GetBack@f9fd990099dae1a9\0" // GetBack() const
		"GetCode@18948eec3533ae11\0" // GetCode() const
		"GetLastInstruction@fd7d68f65\0" // GetLastInstruction() const
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CPyTracebackInterface, "net.maxon.python.interface.cpytraceback", "maxon.py.CPyTracebackInterface", , &CPyInterface::_interface);
		const maxon::Char* const CPyTracebackInterface::MTable::_ids = 
		"GetNext@a78434c2947008ca\0" // GetNext() const
		"GetLineNumber@fd7d68f65\0" // GetLineNumber() const
		"GetFrameRef@f9fd990099dae1a9\0" // GetFrameRef() const
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CPyCodeInterface, "net.maxon.python.interface.cpycode", "maxon.py.CPyCodeInterface", , &CPyInterface::_interface);
		const maxon::Char* const CPyCodeInterface::MTable::_ids = 
		"GetFilename@1be8b0e99fe\0" // GetFilename() const
		"GetName@1be8b0e99fe\0" // GetName() const
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MPyClassInterface, "net.maxon.python.interface.mpyclass", "maxon.py.MPyClassInterface", , &CPyInterface::_interface);
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MPyMemberInterface, "net.maxon.python.interface.mpymember", "maxon.py.MPyMemberInterface", , &CPyInterface::_interface);
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MPyFunctionInterface, "net.maxon.python.interface.mpyfunction", "maxon.py.MPyFunctionInterface", , &CPyInterface::_interface);
		const maxon::Char* const MPyFunctionInterface::MTable::_ids = 
		"GetFunction@546a834ab62c0b79\0" // GetFunction()
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MPyDataTypeInterface, "net.maxon.python.interface.mpydatatype", "maxon.py.MPyDataTypeInterface", , &CPyInterface::_interface);
		const maxon::Char* const MPyDataTypeInterface::MTable::_ids = 
		"GetType@f6200306f4b33440\0" // GetType() const
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MPyDataInterface, "net.maxon.python.interface.mpydata", "maxon.py.MPyDataInterface", , &CPyInterface::_interface);
		const maxon::Char* const MPyDataInterface::MTable::_ids = 
		"GetType@f6200306f4b33440\0" // GetType() const
		"GetMappingType@f6200306f4b33440\0" // GetMappingType() const
		"GetData@79969e83\0" // GetData()
		"GetData@629b06512e59f25a\0" // GetData() const
		"PrivateGetPtr@d6646c3a063c45e7\0" // PrivateGetPtr() const
		"PrivateGetPtr@39b188901530\0" // PrivateGetPtr()
		"";
		...
		MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MPyCallerContextInterface, "net.maxon.python.interface.mpycallercontext", "maxon.py.MPyCallerContextInterface", , &CPyInterface::_interface);
