...
struct LibraryInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<LibraryInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(LibraryInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct LibraryInterface::StaticMTable
{
...
template <typename S> class LibraryInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
{
	return StaticMTable::_instance._LibraryInterface_SetFileContent(filepath, str, append);
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::ConstReferenceFunctionsImpl<S>::ConsoleIsAvailable() -> Bool { return (StaticMTable::_instance._LibraryInterface_ConsoleIsAvailable()); }
#ifdef MAXON_TARGET_WINDOWS
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::ConstReferenceFunctionsImpl<S>::GetVsVersion(Int32 compilerVersion) -> Result<Int32> { return (StaticMTable::_instance._LibraryInterface_GetVsVersion(compilerVersion)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::ConstReferenceFunctionsImpl<S>::GetVsRuntimeLibrary(Int32 version, Bool release) -> Result<Url> { return (StaticMTable::_instance._LibraryInterface_GetVsRuntimeLibrary(version, release)); }
#endif
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::ConstReferenceFunctionsImpl<S>::GetFileContent(const Url& filepath) -> Result<String> { return (StaticMTable::_instance._LibraryInterface_GetFileContent(filepath)); }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LibraryInterface::ConstReferenceFunctionsImpl<S>::SetFileContent(const Url& filepath, const String& str, Bool append) -> Result<void> { return (StaticMTable::_instance._LibraryInterface_SetFileContent(filepath, str, append)); }
...
struct VmDebuggerConnectionInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetName), W, MTable>::type::_VmDebuggerConnectionInterface_GetName;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetPath))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetPath), W, MTable>::type::_VmDebuggerConnectionInterface_GetPath;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetStartupScript))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetStartupScript), W, MTable>::type::_VmDebuggerConnectionInterface_GetStartupScript;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetShutdownScript))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VmDebuggerConnectionInterface, GetShutdownScript), W, MTable>::type::_VmDebuggerConnectionInterface_GetShutdownScript;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<VmDebuggerConnectionInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(VmDebuggerConnectionInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class VmDebuggerConnectionInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VmDebuggerConnectionInterface::ConstReferenceFunctionsImpl<S>::GetPath() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const VmDebuggerConnectionInterface* o_ = (const VmDebuggerConnectionInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = VmDebuggerConnectionInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Url>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VmDebuggerConnectionInterface, o_, VmDebuggerConnectionInterface_GetPath) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VmDebuggerConnectionInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VmDebuggerConnectionInterface>() : PRIVATE_MAXON_VTABLE(VmDebuggerConnectionInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VmDebuggerConnectionInterface::ConstReferenceFunctionsImpl<S>::GetStartupScript() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VmDebuggerConnectionInterface::ConstReferenceFunctionsImpl<S>::GetShutdownScript() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
struct VirtualMachineScopeInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Init), W, MTable>::type::_VirtualMachineScopeInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Add))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Add), W, MTable>::type::_VirtualMachineScopeInterface_Add;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Get))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Get), W, MTable>::type::_VirtualMachineScopeInterface_Get;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Execute))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, Execute), W, MTable>::type::_VirtualMachineScopeInterface_Execute;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, PrivateInvoke))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, PrivateInvoke), W, MTable>::type::_VirtualMachineScopeInterface_PrivateInvoke;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, ErrorHandling))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, ErrorHandling), W, MTable>::type::_VirtualMachineScopeInterface_ErrorHandling;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, _PrivateInit))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineScopeInterface, _PrivateInit), W, MTable>::type::_VirtualMachineScopeInterface__PrivateInit;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<VirtualMachineScopeInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(VirtualMachineScopeInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class VirtualMachineScopeInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::ReferenceFunctionsImpl<S>::Init(const String& identifier, const String& code, ERRORHANDLING errorHandling, const VmDebuggerConnectionRef* debug) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineScopeInterface* o_ = (VirtualMachineScopeInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineScopeInterface, o_, VirtualMachineScopeInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineScopeInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineScopeInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineScopeInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::Init(const String& identifier, const String& code, ERRORHANDLING errorHandling, const VmDebuggerConnectionRef* debug) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::ReferenceFunctionsImpl<S>::Add(const String& name, const Data& data) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::Add(const String& name, const Data& data) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::Get(const String& name) -> Result<Data>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::ReferenceFunctionsImpl<S>::Execute() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::Execute() -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::ReferenceFunctionsImpl<S>::PrivateInvoke(const String& name, BlockArray<Data>& helperStack, const DataType* expected, const Block<Data*>* arguments) const -> Result<Data*>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::PrivateInvoke(const String& name, BlockArray<Data>& helperStack, const DataType* expected, const Block<Data*>* arguments) -> Result<Data*>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::ReferenceFunctionsImpl<S>::ErrorHandling() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::ErrorHandling() -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::ReferenceFunctionsImpl<S>::_PrivateInit(const LibraryRef& lib) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineScopeInterface::COWReferenceFunctionsImpl<S>::_PrivateInit(const LibraryRef& lib) -> Result<void>
{
...
struct VirtualMachineInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Init), W, MTable>::type::_VirtualMachineInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Free))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Free), W, MTable>::type::_VirtualMachineInterface_Free;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, CreateScope))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, CreateScope), W, MTable>::type::_VirtualMachineInterface_CreateScope;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetName), W, MTable>::type::_VirtualMachineInterface_GetName;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetVersion))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetVersion), W, MTable>::type::_VirtualMachineInterface_GetVersion;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetCopyright))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetCopyright), W, MTable>::type::_VirtualMachineInterface_GetCopyright;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetCompiler))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetCompiler), W, MTable>::type::_VirtualMachineInterface_GetCompiler;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetBuildInfo))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetBuildInfo), W, MTable>::type::_VirtualMachineInterface_GetBuildInfo;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, EnterInteractiveMode))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, EnterInteractiveMode), W, MTable>::type::_VirtualMachineInterface_EnterInteractiveMode;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Execute))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Execute), W, MTable>::type::_VirtualMachineInterface_Execute;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Execute))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, Execute), W, MTable>::type::_VirtualMachineInterface_Execute_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, ExecuteModule))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, ExecuteModule), W, MTable>::type::_VirtualMachineInterface_ExecuteModule;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetDocumentString))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetDocumentString), W, MTable>::type::_VirtualMachineInterface_GetDocumentString;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetLibraryRef))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetLibraryRef), W, MTable>::type::_VirtualMachineInterface_GetLibraryRef;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetAllAvailableVirtualMachineLibraries))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VirtualMachineInterface, GetAllAvailableVirtualMachineLibraries), W, MTable>::type::_VirtualMachineInterface_GetAllAvailableVirtualMachineLibraries;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<VirtualMachineInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(VirtualMachineInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class VirtualMachineInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::Init(const LoadRuntime& runtimeInfo, const DataDictionary& settings) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::Init(const LoadRuntime& runtimeInfo, const DataDictionary& settings) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
	return (mt_._VirtualMachineInterface_Init(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._VirtualMachineInterface_Init_Offset, runtimeInfo, settings));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::Free() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_Free) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::Free() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::CreateScope() const -> Result<VirtualMachineScopeRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<VirtualMachineScopeRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_CreateScope) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::CreateScope() -> Result<VirtualMachineScopeRef>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<VirtualMachineScopeRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_CreateScope) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
	return (mt_._VirtualMachineInterface_CreateScope(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._VirtualMachineInterface_CreateScope_Offset));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetName() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_GetName) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetName() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), String, maxon::Result<String>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetVersion() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetVersion() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), String, maxon::Result<String>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetCopyright() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetCopyright() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), String, maxon::Result<String>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetCompiler() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetCompiler() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), String, maxon::Result<String>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetBuildInfo() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetBuildInfo() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), String, maxon::Result<String>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::EnterInteractiveMode() const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::EnterInteractiveMode() -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::Execute(const String& code) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::Execute(const String& code) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::Execute(const Url& filepath) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::Execute(const Url& filepath) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::ExecuteModule(const String& name) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::ExecuteModule(const String& name) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetDocumentString(const String& code, DocStringMeta& meta) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetDocumentString(const String& code, DocStringMeta& meta) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ReferenceFunctionsImpl<S>::GetLibraryRef() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<LibraryRef>, LibraryRef>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<LibraryRef>, LibraryRef>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); VirtualMachineInterface* o_ = (VirtualMachineInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateIncompleteNullReturnValue<LibraryRef>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_GetLibraryRef) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::COWReferenceFunctionsImpl<S>::GetLibraryRef() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), LibraryRef, maxon::Result<LibraryRef>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VirtualMachineInterface::ConstReferenceFunctionsImpl<S>::GetAllAvailableVirtualMachineLibraries() const -> Result<BaseArray<Runtime>>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<BaseArray<Runtime>>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const VirtualMachineInterface* o_ = (const VirtualMachineInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = VirtualMachineInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VirtualMachineInterface, o_, VirtualMachineInterface_GetAllAvailableVirtualMachineLibraries) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VirtualMachineInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VirtualMachineInterface>() : PRIVATE_MAXON_VTABLE(VirtualMachineInterface, o_); 
