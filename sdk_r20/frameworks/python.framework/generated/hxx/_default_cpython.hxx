...
class MyPythonErrorImpl : public Component<MyPythonErrorImpl, PythonErrorInterface>
{
	MAXON_COMPONENT();
...
class MyPythonTracebackErrorImpl : public Component<MyPythonTracebackErrorImpl, PythonTracebackErrorInterface>
{
	MAXON_COMPONENT();
...
class MyPythonSystemExitErrorImpl : public Component<MyPythonSystemExitErrorImpl, PythonSystemExitErrorInterface>
{
	MAXON_COMPONENT();
...
class MyCPythonLibraryImpl : public Component<MyCPythonLibraryImpl, CPythonLibraryInterface>
{
	MAXON_COMPONENT();
...
public:
	...
	MAXON_METHOD Result<const DataType*> ParseDataType(const CPyRef& args, Int32 argIndex, Bool canBeNone)
	{
		return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
	}
...
class MyPyModuleImpl : public Component<MyPyModuleImpl, PyModuleInterface>
{
	MAXON_COMPONENT();
