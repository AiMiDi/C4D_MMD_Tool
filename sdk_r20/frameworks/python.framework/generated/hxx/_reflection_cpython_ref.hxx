...
namespace maxon
{
	namespace py
	{
		...
		class CPyInterface::ProxyComponent : public maxon::Component<CPyInterface::ProxyComponent, CPyInterface>
		{
			MAXON_COMPONENT();
		public:
		...
		void Init(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPyInterface>();
		...
		Int64 GetRefCount() 
		{
			...
			(*handler_)(_fn_CPyInterface_GetRefCount, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int64, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyInterface_GetRefCount));
			return proxy_result;
		}
		...
		const CPythonLibraryInterface* GetLibrary() const 
		{
			...
			(*handler_)(_fn_CPyInterface_GetLibrary, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const CPythonLibraryInterface*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyInterface_GetLibrary));
			return proxy_result;
		}
		...
		CPyTypeRef GetTypeRef() const 
		{
			...
			(*handler_)(_fn_CPyInterface_GetTypeRef, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTypeRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyInterface_GetTypeRef));
			return proxy_result;
		}
		...
		NativePyObject* GetPyObject() const 
		{
			...
			(*handler_)(_fn_CPyInterface_GetPyObject, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NativePyObject*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyInterface_GetPyObject));
			return proxy_result;
		}
		...
		NativePyObject* Disconnect() 
		{
			...
			(*handler_)(_fn_CPyInterface_Disconnect, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<NativePyObject*, maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyInterface_Disconnect));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyInterface::ProxyComponent::_fn_CPyInterface_Disconnect;
		PRIVATE_MAXON_COMPONENT_REGISTER(CPyInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		static maxon::Result<void> RegisterReflection_CPyInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
		{
			...
			{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, CPyInterface, _CPyInterface_Init),
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class CPyTypeInterface::ProxyComponent : public maxon::Component<CPyTypeInterface::ProxyComponent, CPyTypeInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(CPyTypeInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class CPyFrameInterface::ProxyComponent : public maxon::Component<CPyFrameInterface::ProxyComponent, CPyFrameInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		CPyFrameRef GetBack() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPyFrameInterface>();
			...
			(*handler_)(_fn_CPyFrameInterface_GetBack, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyFrameRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyFrameInterface_GetBack));
			return proxy_result;
		}
		...
		CPyCodeRef GetCode() const 
		{
			...
			(*handler_)(_fn_CPyFrameInterface_GetCode, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyCodeRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyFrameInterface_GetCode));
			return proxy_result;
		}
		...
		Int32 GetLastInstruction() const 
		{
			...
			(*handler_)(_fn_CPyFrameInterface_GetLastInstruction, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyFrameInterface_GetLastInstruction));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyFrameInterface::ProxyComponent::_fn_CPyFrameInterface_GetLastInstruction;
		PRIVATE_MAXON_COMPONENT_REGISTER(CPyFrameInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class CPyTracebackInterface::ProxyComponent : public maxon::Component<CPyTracebackInterface::ProxyComponent, CPyTracebackInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		CPyTracebackRef GetNext() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPyTracebackInterface>();
			...
			(*handler_)(_fn_CPyTracebackInterface_GetNext, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyTracebackRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyTracebackInterface_GetNext));
			return proxy_result;
		}
		...
		Int32 GetLineNumber() const 
		{
			...
			(*handler_)(_fn_CPyTracebackInterface_GetLineNumber, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyTracebackInterface_GetLineNumber));
			return proxy_result;
		}
		...
		CPyFrameRef GetFrameRef() const 
		{
			...
			(*handler_)(_fn_CPyTracebackInterface_GetFrameRef, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyFrameRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyTracebackInterface_GetFrameRef));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyTracebackInterface::ProxyComponent::_fn_CPyTracebackInterface_GetFrameRef;
		PRIVATE_MAXON_COMPONENT_REGISTER(CPyTracebackInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class CPyCodeInterface::ProxyComponent : public maxon::Component<CPyCodeInterface::ProxyComponent, CPyCodeInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		CPyRef GetFilename() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CPyCodeInterface>();
			...
			(*handler_)(_fn_CPyCodeInterface_GetFilename, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyCodeInterface_GetFilename));
			return proxy_result;
		}
		...
		CPyRef GetName() const 
		{
			...
			(*handler_)(_fn_CPyCodeInterface_GetName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<CPyRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CPyCodeInterface_GetName));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* CPyCodeInterface::ProxyComponent::_fn_CPyCodeInterface_GetName;
		PRIVATE_MAXON_COMPONENT_REGISTER(CPyCodeInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class MPyClassInterface::ProxyComponent : public maxon::Component<MPyClassInterface::ProxyComponent, MPyClassInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(MPyClassInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class MPyMemberInterface::ProxyComponent : public maxon::Component<MPyMemberInterface::ProxyComponent, MPyMemberInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(MPyMemberInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class MPyFunctionInterface::ProxyComponent : public maxon::Component<MPyFunctionInterface::ProxyComponent, MPyFunctionInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		const reflection::Function* GetFunction() 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<MPyFunctionInterface>();
			...
			(*handler_)(_fn_MPyFunctionInterface_GetFunction, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const reflection::Function*, maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyFunctionInterface_GetFunction));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* MPyFunctionInterface::ProxyComponent::_fn_MPyFunctionInterface_GetFunction;
		PRIVATE_MAXON_COMPONENT_REGISTER(MPyFunctionInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class MPyDataTypeInterface::ProxyComponent : public maxon::Component<MPyDataTypeInterface::ProxyComponent, MPyDataTypeInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		const DataType* GetType() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<MPyDataTypeInterface>();
			...
			(*handler_)(_fn_MPyDataTypeInterface_GetType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataTypeInterface_GetType));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* MPyDataTypeInterface::ProxyComponent::_fn_MPyDataTypeInterface_GetType;
		PRIVATE_MAXON_COMPONENT_REGISTER(MPyDataTypeInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class MPyDataInterface::ProxyComponent : public maxon::Component<MPyDataInterface::ProxyComponent, MPyDataInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		const DataType* GetType() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<MPyDataInterface>();
			const DataType* proxy_result = nullptr;
			...
			(*handler_)(_fn_MPyDataInterface_GetType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataInterface_GetType));
			return proxy_result;
		}
		...
		const DataType* GetMappingType() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetMappingType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataInterface_GetMappingType));
			return proxy_result;
		}
		...
		Data* GetData() 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetData, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Data*, maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataInterface_GetData));
			return proxy_result;
		}
		...
		const Data* GetData() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_GetData_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Data*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataInterface_GetData_1));
			return proxy_result;
		}
		...
		const Generic* PrivateGetPtr() const 
		{
			...
			(*handler_)(_fn_MPyDataInterface_PrivateGetPtr, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Generic*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataInterface_PrivateGetPtr));
			return proxy_result;
		}
		...
		Generic* PrivateGetPtr() 
		{
			...
			(*handler_)(_fn_MPyDataInterface_PrivateGetPtr_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Generic*, maxon::GenericComponent*>::Invoke, (const void*) mt_._MPyDataInterface_PrivateGetPtr_1));
			return proxy_result;
		}
	...
	const maxon::reflection::Function* MPyDataInterface::ProxyComponent::_fn_MPyDataInterface_PrivateGetPtr_1;
		PRIVATE_MAXON_COMPONENT_REGISTER(MPyDataInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	...
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
		class MPyCallerContextInterface::ProxyComponent : public maxon::Component<MPyCallerContextInterface::ProxyComponent, MPyCallerContextInterface>
		{
			MAXON_COMPONENT();
		public:
			static const maxon::Bool PROXY = true;
		...
		PRIVATE_MAXON_COMPONENT_REGISTER(MPyCallerContextInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
	#endif
	#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
