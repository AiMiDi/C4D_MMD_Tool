...
class MyCustomDataTagDisplayImpl : public Component<MyCustomDataTagDisplayImpl, CustomDataTagDisplayInterface>
{
	MAXON_COMPONENT();
...
class MyMeshAttributeClassImpl : public Component<MyMeshAttributeClassImpl, MeshAttributeClassInterface>
{
	MAXON_COMPONENT();
...
class MyCustomDataTagClassImpl : public Component<MyCustomDataTagClassImpl, CustomDataTagClassInterface>
{
	MAXON_COMPONENT();
