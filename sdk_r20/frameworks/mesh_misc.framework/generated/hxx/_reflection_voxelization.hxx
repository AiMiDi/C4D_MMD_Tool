...
namespace maxon
{
	...
	class VoxelizationInterface::ProxyComponent : public maxon::Component<VoxelizationInterface::ProxyComponent, VoxelizationInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<Bool> Init(PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<VoxelizationInterface>();
			...
			(*handler_)(_fn_VoxelizationInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, PolygonObject*, Int32, Int32, BaseArray<Range<Vector>>&, const Vector*, Bool>::Invoke, (const void*) mt_._VoxelizationInterface_Init));
			return proxy_result;
		}
		...
		Result<Bool> Init(PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_Init_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, PolygonObject*, BaseArray<Int32>&, Int32, Int32, BaseArray<Range<Vector>>&, const Vector*>::Invoke, (const void*) mt_._VoxelizationInterface_Init_1));
			return proxy_result;
		}
		...
		Result<Bool> Init(const ConvexHullData* hull, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_Init_2, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, const ConvexHullData*, Int32, Int32, BaseArray<Range<Vector>>&>::Invoke, (const void*) mt_._VoxelizationInterface_Init_2));
			return proxy_result;
		}
		...
		Result<void> GetClosestPolys(const Vector pos, BaseBitSet<>& voxelPolys, const BaseBitSet<>* polyFilter) const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_GetClosestPolys, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const Vector, BaseBitSet<>&, const BaseBitSet<>*>::Invoke, (const void*) mt_._VoxelizationInterface_GetClosestPolys));
			return proxy_result;
		}
		...
		Result<void> GetIntersectingIndices(const Range<Vector>& toTestBox, BaseArray<Int32>& indexList) const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_GetIntersectingIndices, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const Range<Vector>&, BaseArray<Int32>&>::Invoke, (const void*) mt_._VoxelizationInterface_GetIntersectingIndices));
			return proxy_result;
		}
		...
		Result<void> GetIntersectingIndicesPrecise(const Range<Vector>& toTestBox, const BaseArray<Range<Vector>>& polyRanges, BaseArray<Int32>& indexList) const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_GetIntersectingIndicesPrecise, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const Range<Vector>&, const BaseArray<Range<Vector>>&, BaseArray<Int32>&>::Invoke, (const void*) mt_._VoxelizationInterface_GetIntersectingIndicesPrecise));
			return proxy_result;
		}
		...
		Result<Bool> GetIntersectingIndices(const Vector& point, BaseArray<Int32>& indexList) const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_GetIntersectingIndices_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<Bool>, const maxon::GenericComponent*, const Vector&, BaseArray<Int32>&>::Invoke, (const void*) mt_._VoxelizationInterface_GetIntersectingIndices_1));
			return proxy_result;
		}
		...
		const Range<Vector>& GetBoundingBox() const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_GetBoundingBox, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const Range<Vector>&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VoxelizationInterface_GetBoundingBox));
			return *proxy_result;
		}
		...
		Range<IntVector32> GetVoxelRangesFromBoundingBox(const Range<Vector>& boundingBox) const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_GetVoxelRangesFromBoundingBox, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Range<IntVector32>, const maxon::GenericComponent*, const Range<Vector>&>::Invoke, (const void*) mt_._VoxelizationInterface_GetVoxelRangesFromBoundingBox));
			return proxy_result;
		}
		...
		Bool IsInitialized() const 
		{
			...
			(*handler_)(_fn_VoxelizationInterface_IsInitialized, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._VoxelizationInterface_IsInitialized));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(VoxelizationInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_VoxelizationInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 5716LL, VoxelizationInterface, _VoxelizationInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 6484LL, VoxelizationInterface, _VoxelizationInterface_Init_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 596LL, VoxelizationInterface, _VoxelizationInterface_Init_2),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 2388LL, VoxelizationInterface, _VoxelizationInterface_Init_3),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 100LL, VoxelizationInterface, _VoxelizationInterface_GetClosestPolys),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 36LL, VoxelizationInterface, _VoxelizationInterface_GetIntersectingIndices),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 148LL, VoxelizationInterface, _VoxelizationInterface_GetIntersectingIndicesPrecise),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 36LL, VoxelizationInterface, _VoxelizationInterface_GetIntersectingIndices_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, VoxelizationInterface, _VoxelizationInterface_GetBoundingBox),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, VoxelizationInterface, _VoxelizationInterface_GetVoxelRangesFromBoundingBox),
