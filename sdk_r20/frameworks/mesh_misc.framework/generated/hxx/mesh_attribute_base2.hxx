...
struct CustomDataTagDisplayInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, Init), W, MTable>::type::_CustomDataTagDisplayInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, Draw))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, Draw), W, MTable>::type::_CustomDataTagDisplayInterface_Draw;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, DisplayControl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, DisplayControl), W, MTable>::type::_CustomDataTagDisplayInterface_DisplayControl;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, InitDisplayControl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, InitDisplayControl), W, MTable>::type::_CustomDataTagDisplayInterface_InitDisplayControl;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, FreeDisplayControl))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, FreeDisplayControl), W, MTable>::type::_CustomDataTagDisplayInterface_FreeDisplayControl;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, Reset))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagDisplayInterface, Reset), W, MTable>::type::_CustomDataTagDisplayInterface_Reset;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CustomDataTagDisplayInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CustomDataTagDisplayInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CustomDataTagDisplayInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<S>::Init(BaseTag* tag) -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CustomDataTagDisplayInterface* o_ = (CustomDataTagDisplayInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagDisplayInterface, o_, CustomDataTagDisplayInterface_Init) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagDisplayInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagDisplayInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagDisplayInterface, o_); 
	return (mt_._CustomDataTagDisplayInterface_Init(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CustomDataTagDisplayInterface_Init_Offset, tag));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::ReferenceFunctionsImpl<S>::Draw(BaseTag* tag, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<S>::Draw(BaseTag* tag, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::ReferenceFunctionsImpl<S>::DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<S>::DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::ReferenceFunctionsImpl<S>::InitDisplayControl(BaseTag* tag, BaseDocument* doc, BaseDraw* bd, const AtomArray* active) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<S>::InitDisplayControl(BaseTag* tag, BaseDocument* doc, BaseDraw* bd, const AtomArray* active) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::ReferenceFunctionsImpl<S>::FreeDisplayControl(BaseTag* tag) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CustomDataTagDisplayInterface* o_ = (CustomDataTagDisplayInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagDisplayInterface, o_, CustomDataTagDisplayInterface_FreeDisplayControl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagDisplayInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagDisplayInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagDisplayInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<S>::FreeDisplayControl(BaseTag* tag) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); CustomDataTagDisplayInterface* o_ = (CustomDataTagDisplayInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagDisplayInterface, o_, CustomDataTagDisplayInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagDisplayInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagDisplayInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagDisplayInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<S>::Reset() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
struct MeshAttributeClassInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, GetDataType))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, GetDataType), W, MTable>::type::_MeshAttributeClassInterface_GetDataType;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, InterpolateLinear))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, InterpolateLinear), W, MTable>::type::_MeshAttributeClassInterface_InterpolateLinear;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, InterpolateInOutline))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, InterpolateInOutline), W, MTable>::type::_MeshAttributeClassInterface_InterpolateInOutline;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, GetDefaultValue))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, GetDefaultValue), W, MTable>::type::_MeshAttributeClassInterface_GetDefaultValue;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrLessThen))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrLessThen), W, MTable>::type::_MeshAttributeClassInterface_AtrLessThen;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrIsEqual))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrIsEqual), W, MTable>::type::_MeshAttributeClassInterface_AtrIsEqual;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrAdd))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrAdd), W, MTable>::type::_MeshAttributeClassInterface_AtrAdd;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrSubstract))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrSubstract), W, MTable>::type::_MeshAttributeClassInterface_AtrSubstract;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrMultiply))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrMultiply), W, MTable>::type::_MeshAttributeClassInterface_AtrMultiply;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrMultiply))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrMultiply), W, MTable>::type::_MeshAttributeClassInterface_AtrMultiply_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrDivide))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrDivide), W, MTable>::type::_MeshAttributeClassInterface_AtrDivide;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrDivide))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrDivide), W, MTable>::type::_MeshAttributeClassInterface_AtrDivide_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrToString))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, MeshAttributeClassInterface, AtrToString), W, MTable>::type::_MeshAttributeClassInterface_AtrToString;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<MeshAttributeClassInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(MeshAttributeClassInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class MeshAttributeClassInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::GetDataType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType*>, const DataType*>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return nullptr; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_GetDataType) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::InterpolateLinear(void* data1, const void* data2, Float blend) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_InterpolateLinear) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::InterpolateInOutline(void* data, const Block<void*>& outline, const Block<Float>& weights) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_InterpolateInOutline) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::GetDefaultValue(void* data) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_GetDefaultValue) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrLessThen(const void* data1, const void* data2) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrLessThen) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrIsEqual(const void* data1, const void* data2) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrIsEqual) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrAdd(void* data1, const void* data2) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrAdd) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrSubstract(void* data1, const void* data2) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrSubstract) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrMultiply(void* data1, const void* data2) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrMultiply) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrMultiply(void* data, Float value) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrMultiply_1) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrDivide(void* data1, const void* data2) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrDivide) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MeshAttributeClassInterface::ConstReferenceFunctionsImpl<S>::AtrDivide(void* data, Float value) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MeshAttributeClassInterface* o_ = (const MeshAttributeClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = MeshAttributeClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MeshAttributeClassInterface, o_, MeshAttributeClassInterface_AtrDivide_1) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<MeshAttributeClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MeshAttributeClassInterface>() : PRIVATE_MAXON_VTABLE(MeshAttributeClassInterface, o_); 
...
struct CustomDataTagClassInterface::MTable
{
	...
	template <typename W> void Init(maxon::Int offset)
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetTagPluginId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetTagPluginId), W, MTable>::type::_CustomDataTagClassInterface_GetTagPluginId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetTagPluginName))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetTagPluginName), W, MTable>::type::_CustomDataTagClassInterface_GetTagPluginName;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetResourceId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetResourceId), W, MTable>::type::_CustomDataTagClassInterface_GetResourceId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetTagPluginLevel))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetTagPluginLevel), W, MTable>::type::_CustomDataTagClassInterface_GetTagPluginLevel;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetDisplayClassId))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetDisplayClassId), W, MTable>::type::_CustomDataTagClassInterface_GetDisplayClassId;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, IsSdsCompatible))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, IsSdsCompatible), W, MTable>::type::_CustomDataTagClassInterface_IsSdsCompatible;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, Read))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, Read), W, MTable>::type::_CustomDataTagClassInterface_Read;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, Write))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, Write), W, MTable>::type::_CustomDataTagClassInterface_Write;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetIcon))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, CustomDataTagClassInterface, GetIcon), W, MTable>::type::_CustomDataTagClassInterface_GetIcon;
	...
	template <typename W> static maxon::Bool InitWithBases(maxon::ClassInfo* info, maxon::Int offset)
	{
		if (!W::Implementation::PROXY && (!MeshAttributeClassInterface::MTable::InitWithBases<W>(info, offset))) return false;
		MTable* vt = (MTable*) maxon::Object::PrivateGetOrCreateMTable(info, _interface); if (!vt) return false;
		vt->Init<W>(offset); return true;
	}
	template <typename S> using CombinedMTable = maxon::CombinedMTable<CustomDataTagClassInterface, MeshAttributeClassInterface::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(CustomDataTagClassInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class CustomDataTagClassInterface::Wrapper : public MeshAttributeClassInterface::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetTagPluginId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CustomDataTagClassInterface* o_ = (const CustomDataTagClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CustomDataTagClassInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagClassInterface, o_, CustomDataTagClassInterface_GetTagPluginId) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagClassInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetTagPluginName() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const String&>, const String&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const String&>, const String&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CustomDataTagClassInterface* o_ = (const CustomDataTagClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CustomDataTagClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const String&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagClassInterface, o_, CustomDataTagClassInterface_GetTagPluginName) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagClassInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetResourceId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const String&>, const String&>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetTagPluginLevel() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetDisplayClassId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Id>, Id>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Id>, Id>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CustomDataTagClassInterface* o_ = (const CustomDataTagClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CustomDataTagClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Id>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagClassInterface, o_, CustomDataTagClassInterface_GetDisplayClassId) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagClassInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::IsSdsCompatible(Int32& floatSize) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CustomDataTagClassInterface* o_ = (const CustomDataTagClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CustomDataTagClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagClassInterface, o_, CustomDataTagClassInterface_IsSdsCompatible) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagClassInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::Read(void* data, HyperFile* hf, Int32 level) const -> Result<void>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CustomDataTagClassInterface* o_ = (const CustomDataTagClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CustomDataTagClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(CustomDataTagClassInterface, o_, CustomDataTagClassInterface_Read) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<CustomDataTagClassInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<CustomDataTagClassInterface>() : PRIVATE_MAXON_VTABLE(CustomDataTagClassInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::Write(const void* data, HyperFile* hf) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetIcon(Bool perPolyVertex) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::ConstReferenceFunctionsImpl<S>::GetDefaultResourceId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const String&>, const String&>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<const String&>, const String&>::type>; static_assert(!std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value, "Can't invoke MAXON_FUNCTION CustomDataTagClassInterface::GetDefaultResourceId on super."); if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const CustomDataTagClassInterface* o_ = (const CustomDataTagClassInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = CustomDataTagClassInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<const String&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
