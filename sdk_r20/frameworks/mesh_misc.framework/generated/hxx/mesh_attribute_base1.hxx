#if 1
struct CustomDataTagDisplayInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CustomDataTagDisplayInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(CustomDataTagDisplayInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class CustomDataTagDisplayRef;

struct CustomDataTagDisplayInterface::ReferenceClassHelper { using type = CustomDataTagDisplayRef; };

/// Intermediate helper class for CustomDataTagDisplayInterface.
template <typename S> class CustomDataTagDisplayInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class CustomDataTagDisplayInterface::ConstReferenceFunctionsImplDoxy : public CustomDataTagDisplayInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for CustomDataTagDisplayInterface.
template <typename S> class CustomDataTagDisplayInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class CustomDataTagDisplayInterface::ReferenceFunctionsImplDoxy : public CustomDataTagDisplayInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for CustomDataTagDisplayInterface.
template <typename S> class CustomDataTagDisplayInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class CustomDataTagDisplayInterface::COWReferenceFunctionsImplDoxy : public CustomDataTagDisplayInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct CustomDataTagDisplayInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class CustomDataTagDisplayInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<CustomDataTagDisplayRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CustomDataTagDisplayInterface, maxon::StrongRefHandler, CustomDataTagDisplayRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CustomDataTagDisplayInterface, maxon::StrongRefHandler, CustomDataTagDisplayRef>>>>);
...
class CustomDataTagDisplayRef : public CustomDataTagDisplayInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(CustomDataTagDisplayRef, Reference);
};

struct MeshAttributeClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MeshAttributeClassInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(MeshAttributeClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class MeshAttributeClass;

struct MeshAttributeClassInterface::ReferenceClassHelper { using type = MeshAttributeClass; };

/// Intermediate helper class for MeshAttributeClassInterface.
template <typename S> class MeshAttributeClassInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class MeshAttributeClassInterface::ConstReferenceFunctionsImplDoxy : public MeshAttributeClassInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for MeshAttributeClassInterface.
template <typename S> class MeshAttributeClassInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class MeshAttributeClassInterface::ReferenceFunctionsImplDoxy : public MeshAttributeClassInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for MeshAttributeClassInterface.
template <typename S> class MeshAttributeClassInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class MeshAttributeClassInterface::COWReferenceFunctionsImplDoxy : public MeshAttributeClassInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct MeshAttributeClassInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class MeshAttributeClassInterface::Reference :
#ifdef DOXYGEN
public ConstReferenceFunctionsImplDoxy<MeshAttributeClass>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const MeshAttributeClassInterface, maxon::StrongRefHandler, MeshAttributeClass>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const MeshAttributeClassInterface, maxon::StrongRefHandler, MeshAttributeClass>>>>);
	using NonConst = NonConstRef;
};

class MeshAttributeClassInterface::NonConstRef :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<MeshAttributeClassInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<MeshAttributeClassInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class MeshAttributeClass : public MeshAttributeClassInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(MeshAttributeClass, Reference);
};

struct CustomDataTagClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CustomDataTagClassInterface>::value || MeshAttributeClassInterface::HasBase::Check<I>::value; static I* Cast(CustomDataTagClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class CustomDataTagClass;

struct CustomDataTagClassInterface::ReferenceClassHelper { using type = CustomDataTagClass; };

/// Intermediate helper class for CustomDataTagClassInterface.
template <typename S> class CustomDataTagClassInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
	ConstReferenceFunctionsImpl() = default;
	using PrivateBaseClass = S;
...
#ifdef DOXYGEN
template <typename REF> class CustomDataTagClassInterface::ConstReferenceFunctionsImplDoxy : public CustomDataTagClassInterface::ConstReferenceFunctionsImpl<REF>, public MeshAttributeClassInterface::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for CustomDataTagClassInterface.
template <typename S> class CustomDataTagClassInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	ReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class CustomDataTagClassInterface::ReferenceFunctionsImplDoxy : public CustomDataTagClassInterface::ReferenceFunctionsImpl<REF>, public MeshAttributeClassInterface::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for CustomDataTagClassInterface.
template <typename S> class CustomDataTagClassInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
	COWReferenceFunctionsImpl() = default;
	using PrivateBaseClass = ConstReferenceFunctionsImpl<S>;
...
#ifdef DOXYGEN
template <typename REF> class CustomDataTagClassInterface::COWReferenceFunctionsImplDoxy : public CustomDataTagClassInterface::COWReferenceFunctionsImpl<REF>, public MeshAttributeClassInterface::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct CustomDataTagClassInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename MeshAttributeClassInterface::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename MeshAttributeClassInterface::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename MeshAttributeClassInterface::ReferenceFunctions<ST>::type>>::type>::type; };
class CustomDataTagClassInterface::Reference :
#ifdef DOXYGEN
public ConstReferenceFunctionsImplDoxy<CustomDataTagClass>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const CustomDataTagClassInterface, maxon::StrongRefHandler, CustomDataTagClass>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<const CustomDataTagClassInterface, maxon::StrongRefHandler, CustomDataTagClass>>>>);
	using NonConst = NonConstRef;
};

class CustomDataTagClassInterface::NonConstRef :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<NonConstRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CustomDataTagClassInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<CustomDataTagClassInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
///	{
///		MAXON_COMPONENT();
///		MAXON_CUSTOMDATATAG(ID_CUSTOMDATA_TAG_VC, "Vertex Color Tag"_s, ""_s, Id("net.maxon.mesh_misc.meshattibutedisplay.vertxecolor"), 0);
///
///	public:
///
///		...
...
///	};
/// @endcode
class CustomDataTagClass : public CustomDataTagClassInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(CustomDataTagClass, Reference);
};
