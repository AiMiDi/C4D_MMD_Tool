...
struct DistanceQueryInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Init), W, MTable>::type::_DistanceQueryInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Init), W, MTable>::type::_DistanceQueryInterface_Init_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Init), W, MTable>::type::_DistanceQueryInterface_Init_2;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Reset))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, Reset), W, MTable>::type::_DistanceQueryInterface_Reset;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetClosestMeshPrimitive))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetClosestMeshPrimitive), W, MTable>::type::_DistanceQueryInterface_GetClosestMeshPrimitive;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetDistanceToMesh))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetDistanceToMesh), W, MTable>::type::_DistanceQueryInterface_GetDistanceToMesh;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetDistanceToMeshMaxAngleToDirection))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetDistanceToMeshMaxAngleToDirection), W, MTable>::type::_DistanceQueryInterface_GetDistanceToMeshMaxAngleToDirection;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetDistanceToSpline))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, GetDistanceToSpline), W, MTable>::type::_DistanceQueryInterface_GetDistanceToSpline;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, IsInitialized))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, IsInitialized), W, MTable>::type::_DistanceQueryInterface_IsInitialized;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, SetThreading))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, DistanceQueryInterface, SetThreading), W, MTable>::type::_DistanceQueryInterface_SetThreading;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<DistanceQueryInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(DistanceQueryInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class DistanceQueryInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::COWReferenceFunctionsImpl<S>::Init(PolygonObject* mesh, Bool initVoxelization) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ReferenceFunctionsImpl<S>::Init(SplineObject* spline) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::COWReferenceFunctionsImpl<S>::Init(SplineObject* spline) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ReferenceFunctionsImpl<S>::Init(LineObject* line) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::COWReferenceFunctionsImpl<S>::Init(LineObject* line) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DistanceQueryInterface* o_ = (DistanceQueryInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DistanceQueryInterface, o_, DistanceQueryInterface_Reset) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DistanceQueryInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DistanceQueryInterface>() : PRIVATE_MAXON_VTABLE(DistanceQueryInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::COWReferenceFunctionsImpl<S>::Reset() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ConstReferenceFunctionsImpl<S>::GetDistanceToMesh(const Vector& pos, MeshDistanceData& distInfo, const BaseBitSet<>* polyFilter, Bool onlyPolyPrimitives) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const DistanceQueryInterface* o_ = (const DistanceQueryInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = DistanceQueryInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DistanceQueryInterface, o_, DistanceQueryInterface_GetDistanceToMesh) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DistanceQueryInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DistanceQueryInterface>() : PRIVATE_MAXON_VTABLE(DistanceQueryInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ConstReferenceFunctionsImpl<S>::GetDistanceToMeshMaxAngleToDirection(const Vector& pos, const Vector& direction, const Float angle, MeshDistanceData& distInfo, const BaseBitSet<>* polyFilter, Bool onlyPolyPrimitives) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ConstReferenceFunctionsImpl<S>::GetDistanceToSpline(const Vector& pos, SplineDistanceData& distInfo) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ConstReferenceFunctionsImpl<S>::IsInitialized() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::ReferenceFunctionsImpl<S>::SetThreading(Int32 threads) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); DistanceQueryInterface* o_ = (DistanceQueryInterface*) this->GetPointer(); if (MAXON_UNLIKELY(!o_)) return maxon::PrivateLogNullptrError(); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(DistanceQueryInterface, o_, DistanceQueryInterface_SetThreading) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<DistanceQueryInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<DistanceQueryInterface>() : PRIVATE_MAXON_VTABLE(DistanceQueryInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::COWReferenceFunctionsImpl<S>::SetThreading(Int32 threads) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
