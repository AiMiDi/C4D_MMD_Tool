...
namespace maxon
{
	...
	class DistanceQueryInterface::ProxyComponent : public maxon::Component<DistanceQueryInterface::ProxyComponent, DistanceQueryInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<void> Init(PolygonObject* mesh, Bool initVoxelization) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<DistanceQueryInterface>();
			...
			(*handler_)(_fn_DistanceQueryInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, PolygonObject*, Bool>::Invoke, (const void*) mt_._DistanceQueryInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Init(SplineObject* spline) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_1, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, SplineObject*>::Invoke, (const void*) mt_._DistanceQueryInterface_Init_1));
			return proxy_result;
		}
		...
		Result<void> Init(LineObject* line) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_2, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, LineObject*>::Invoke, (const void*) mt_._DistanceQueryInterface_Init_2));
			return proxy_result;
		}
		...
		Float GetClosestMeshPrimitive(const Vector& pos, PrimitiveInformation& primInfo, const BaseBitSet<>* polyFilter) const 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_GetClosestMeshPrimitive, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Float, const maxon::GenericComponent*, const Vector&, PrimitiveInformation&, const BaseBitSet<>*>::Invoke, (const void*) mt_._DistanceQueryInterface_GetClosestMeshPrimitive));
			return proxy_result;
		}
		...
		Bool IsInitialized() const 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_IsInitialized, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._DistanceQueryInterface_IsInitialized));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DistanceQueryInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_DistanceQueryInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 20LL, DistanceQueryInterface, _DistanceQueryInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DistanceQueryInterface, _DistanceQueryInterface_Init_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DistanceQueryInterface, _DistanceQueryInterface_Init_2),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 0LL, DistanceQueryInterface, _DistanceQueryInterface_Reset),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 100LL, DistanceQueryInterface, _DistanceQueryInterface_GetClosestMeshPrimitive),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 356LL, DistanceQueryInterface, _DistanceQueryInterface_GetDistanceToMesh),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 5716LL, DistanceQueryInterface, _DistanceQueryInterface_GetDistanceToMeshMaxAngleToDirection),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 36LL, DistanceQueryInterface, _DistanceQueryInterface_GetDistanceToSpline),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 0LL, DistanceQueryInterface, _DistanceQueryInterface_IsInitialized),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, DistanceQueryInterface, _DistanceQueryInterface_SetThreading),
		};
