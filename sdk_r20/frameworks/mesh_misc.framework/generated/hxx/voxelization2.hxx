...
struct VoxelizationInterface::MTable
{
	...
	{
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init), W, MTable>::type::_VoxelizationInterface_Init;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init), W, MTable>::type::_VoxelizationInterface_Init_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init), W, MTable>::type::_VoxelizationInterface_Init_2;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, Init), W, MTable>::type::_VoxelizationInterface_Init_3;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetClosestPolys))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetClosestPolys), W, MTable>::type::_VoxelizationInterface_GetClosestPolys;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetIntersectingIndices))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetIntersectingIndices), W, MTable>::type::_VoxelizationInterface_GetIntersectingIndices;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetIntersectingIndicesPrecise))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetIntersectingIndicesPrecise), W, MTable>::type::_VoxelizationInterface_GetIntersectingIndicesPrecise;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetIntersectingIndices))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetIntersectingIndices), W, MTable>::type::_VoxelizationInterface_GetIntersectingIndices_1;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetBoundingBox))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetBoundingBox), W, MTable>::type::_VoxelizationInterface_GetBoundingBox;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetVoxelRangesFromBoundingBox))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, GetVoxelRangesFromBoundingBox), W, MTable>::type::_VoxelizationInterface_GetVoxelRangesFromBoundingBox;
		...
		if (PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, IsInitialized))
		{
			auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(W::Implementation, VoxelizationInterface, IsInitialized), W, MTable>::type::_VoxelizationInterface_IsInitialized;
	...
	template <typename S> using CombinedMTable = maxon::CombinedMTable<VoxelizationInterface, Object::MTable::CombinedMTable<S>>;
	PRIVATE_MAXON_COMPBASE(VoxelizationInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

template <typename S> class VoxelizationInterface::Wrapper : public Object::Wrapper<S>
{
public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ReferenceFunctionsImpl<S>::Init(PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::COWReferenceFunctionsImpl<S>::Init(PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ReferenceFunctionsImpl<S>::Init(PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::COWReferenceFunctionsImpl<S>::Init(PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ReferenceFunctionsImpl<S>::Init(const ConvexHullData* hull, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::COWReferenceFunctionsImpl<S>::Init(const ConvexHullData* hull, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ReferenceFunctionsImpl<S>::Init(const BaseArray<BaseArray<Int32>>& facePoints, const BaseArray<Vector>& points, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::COWReferenceFunctionsImpl<S>::Init(const BaseArray<BaseArray<Int32>>& facePoints, const BaseArray<Vector>& points, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ConstReferenceFunctionsImpl<S>::GetIntersectingIndices(const Range<Vector>& toTestBox, BaseArray<Int32>& indexList) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ConstReferenceFunctionsImpl<S>::GetIntersectingIndicesPrecise(const Range<Vector>& toTestBox, const BaseArray<Range<Vector>>& polyRanges, BaseArray<Int32>& indexList) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ConstReferenceFunctionsImpl<S>::GetIntersectingIndices(const Vector& point, BaseArray<Int32>& indexList) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ConstReferenceFunctionsImpl<S>::GetVoxelRangesFromBoundingBox(const Range<Vector>& boundingBox) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Range<IntVector32>>, Range<IntVector32>>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, false, typename std::conditional<S::HAS_ERROR, maxon::Result<Range<IntVector32>>, Range<IntVector32>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const VoxelizationInterface* o_ = (const VoxelizationInterface*) this->GetPointer(); if (!(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS) && MAXON_UNLIKELY(!o_)) { o_ = VoxelizationInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Range<IntVector32>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(VoxelizationInterface, o_, VoxelizationInterface_GetVoxelRangesFromBoundingBox) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<VoxelizationInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<VoxelizationInterface>() : PRIVATE_MAXON_VTABLE(VoxelizationInterface, o_); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::ConstReferenceFunctionsImpl<S>::IsInitialized() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
