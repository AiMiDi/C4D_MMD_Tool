#if 1
struct VoxelizationInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, VoxelizationInterface>::value || Object::HasBase::Check<I>::value; static I* Cast(VoxelizationInterface* ptr) { return static_cast<I*>(static_cast<maxon::Object*>(ptr)); } }; };
class VoxelizationRef;

struct VoxelizationInterface::ReferenceClassHelper { using type = VoxelizationRef; };

/// Intermediate helper class for VoxelizationInterface.
template <typename S> class VoxelizationInterface::ConstReferenceFunctionsImpl DOXYGEN_SWITCH(: public S,)
{
public:
...
#ifdef DOXYGEN
template <typename REF> class VoxelizationInterface::ConstReferenceFunctionsImplDoxy : public VoxelizationInterface::ConstReferenceFunctionsImpl<REF>, public Object::ConstReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VoxelizationInterface.
template <typename S> class VoxelizationInterface::ReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class VoxelizationInterface::ReferenceFunctionsImplDoxy : public VoxelizationInterface::ReferenceFunctionsImpl<REF>, public Object::ReferenceFunctionsImplDoxy<REF> { };
#endif

/// Intermediate helper class for VoxelizationInterface.
template <typename S> class VoxelizationInterface::COWReferenceFunctionsImpl : public ConstReferenceFunctionsImpl<S>
{
public:
...
#ifdef DOXYGEN
template <typename REF> class VoxelizationInterface::COWReferenceFunctionsImplDoxy : public VoxelizationInterface::COWReferenceFunctionsImpl<REF>, public Object::COWReferenceFunctionsImplDoxy<REF> { };
#endif

template <typename ST> struct VoxelizationInterface::ReferenceFunctions { using type = typename std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>, ReferenceFunctionsImpl<typename Object::ReferenceFunctions<ST>::type>>::type>::type; };
class VoxelizationInterface::Reference :
#ifdef DOXYGEN
public ReferenceFunctionsImplDoxy<VoxelizationRef>
#else
public maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VoxelizationInterface, maxon::StrongRefHandler, VoxelizationRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<ReferenceFunctions<maxon::RefBaseFunctions<maxon::DirectRef<VoxelizationInterface, maxon::StrongRefHandler, VoxelizationRef>>>>);
...
class VoxelizationRef : public VoxelizationInterface::Reference
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(VoxelizationRef, Reference);
};
