...
namespace maxon
{
	...
	class CustomDataTagDisplayInterface::ProxyComponent : public maxon::Component<CustomDataTagDisplayInterface::ProxyComponent, CustomDataTagDisplayInterface>
	{
		MAXON_COMPONENT();
	public:
		...
		Result<void> Init(BaseTag* tag) 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CustomDataTagDisplayInterface>();
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Init, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseTag*>::Invoke, (const void*) mt_._CustomDataTagDisplayInterface_Init));
			return proxy_result;
		}
		...
		Result<void> Draw(BaseTag* tag, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Draw, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseTag*, BaseObject*, BaseDraw*, BaseDrawHelp*>::Invoke, (const void*) mt_._CustomDataTagDisplayInterface_Draw));
			return proxy_result;
		}
		...
		Result<void> DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_DisplayControl, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseTag*, BaseDocument*, BaseObject*, BaseDraw*, BaseDrawHelp*, ControlDisplayStruct&>::Invoke, (const void*) mt_._CustomDataTagDisplayInterface_DisplayControl));
			return proxy_result;
		}
		...
		Result<void> InitDisplayControl(BaseTag* tag, BaseDocument* doc, BaseDraw* bd, const AtomArray* active) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_InitDisplayControl, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseTag*, BaseDocument*, BaseDraw*, const AtomArray*>::Invoke, (const void*) mt_._CustomDataTagDisplayInterface_InitDisplayControl));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(CustomDataTagDisplayInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_CustomDataTagDisplayInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, CustomDataTagDisplayInterface, _CustomDataTagDisplayInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 340LL, CustomDataTagDisplayInterface, _CustomDataTagDisplayInterface_Draw),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 5460LL, CustomDataTagDisplayInterface, _CustomDataTagDisplayInterface_DisplayControl),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 340LL, CustomDataTagDisplayInterface, _CustomDataTagDisplayInterface_InitDisplayControl),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, 4LL, CustomDataTagDisplayInterface, _CustomDataTagDisplayInterface_FreeDisplayControl),
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class MeshAttributeClassInterface::ProxyComponent : public maxon::Component<MeshAttributeClassInterface::ProxyComponent, MeshAttributeClassInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		const DataType* GetDataType() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<MeshAttributeClassInterface>();
			...
			(*handler_)(_fn_MeshAttributeClassInterface_GetDataType, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const DataType*, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MeshAttributeClassInterface_GetDataType));
			return proxy_result;
		}
		...
		Bool AtrLessThen(const void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrLessThen, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const void*, const void*>::Invoke, (const void*) mt_._MeshAttributeClassInterface_AtrLessThen));
			return proxy_result;
		}
		...
		Bool AtrIsEqual(const void* data1, const void* data2) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrIsEqual, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, const void*, const void*>::Invoke, (const void*) mt_._MeshAttributeClassInterface_AtrIsEqual));
			return proxy_result;
		}
		...
		String AtrToString(const void* data, const FormatStatement* formatStatement) const 
		{
			...
			(*handler_)(_fn_MeshAttributeClassInterface_AtrToString, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<String, const maxon::GenericComponent*, const void*, const FormatStatement*>::Invoke, (const void*) mt_._MeshAttributeClassInterface_AtrToString));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(MeshAttributeClassInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_MeshAttributeClassInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 92LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_InterpolateLinear),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 92LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_InterpolateInOutline),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 8LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_GetDefaultValue),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 20LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrLessThen),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 20LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrIsEqual),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrAdd),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrSubstract),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrMultiply),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrMultiply_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrDivide),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrDivide_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 28LL, MeshAttributeClassInterface, _MeshAttributeClassInterface_AtrToString),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	class CustomDataTagClassInterface::ProxyComponent : public maxon::Component<CustomDataTagClassInterface::ProxyComponent, CustomDataTagClassInterface>
	{
		MAXON_COMPONENT();
	public:
		static const maxon::Bool PROXY = true;
		...
		Int32 GetTagPluginId() const 
		{
			...
			const MTable& mt_ = ((const PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->GetMTable<CustomDataTagClassInterface>();
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_GetTagPluginId));
			return proxy_result;
		}
		...
		const String& GetTagPluginName() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginName, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const String&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_GetTagPluginName));
			return *proxy_result;
		}
		...
		const String& GetResourceId() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetResourceId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<const String&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_GetResourceId));
			return *proxy_result;
		}
		...
		Int32 GetTagPluginLevel() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetTagPluginLevel, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_GetTagPluginLevel));
			return proxy_result;
		}
		...
		Id GetDisplayClassId() const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetDisplayClassId, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Id, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_GetDisplayClassId));
			return proxy_result;
		}
		...
		Bool IsSdsCompatible(Int32& floatSize) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_IsSdsCompatible, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*, Int32&>::Invoke, (const void*) mt_._CustomDataTagClassInterface_IsSdsCompatible));
			return proxy_result;
		}
		...
		Result<void> Read(void* data, HyperFile* hf, Int32 level) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Read, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, void*, HyperFile*, Int32>::Invoke, (const void*) mt_._CustomDataTagClassInterface_Read));
			return proxy_result;
		}
		...
		Result<void> Write(const void* data, HyperFile* hf) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Write, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Result<void>, const maxon::GenericComponent*, const void*, HyperFile*>::Invoke, (const void*) mt_._CustomDataTagClassInterface_Write));
			return proxy_result;
		}
		...
		Int32 GetIcon(Bool perPolyVertex) const 
		{
			...
			(*handler_)(_fn_CustomDataTagClassInterface_GetIcon, o_, maxon::reflection::ProxyInvocation(&proxy_result, proxy_args, &maxon::reflection::Invocation<Int32, const maxon::GenericComponent*, Bool>::Invoke, (const void*) mt_._CustomDataTagClassInterface_GetIcon));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(CustomDataTagClassInterface::ProxyComponent, , maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry,);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::Result<void> RegisterReflection_CustomDataTagClassInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 8LL, CustomDataTagClassInterface, _CustomDataTagClassInterface_IsSdsCompatible),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 84LL, CustomDataTagClassInterface, _CustomDataTagClassInterface_Read),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 20LL, CustomDataTagClassInterface, _CustomDataTagClassInterface_Write),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, 4LL, CustomDataTagClassInterface, _CustomDataTagClassInterface_GetIcon),
		};
