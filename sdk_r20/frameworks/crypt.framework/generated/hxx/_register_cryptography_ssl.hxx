...
namespace maxon
{
	const maxon::Char* const SSLInterface::MTable::_ids = 
		"ERR_get_state@194b56c08645f5b3\0" // ERR_get_state()
		"ERR_clear_error@cfa940f4\0" // ERR_clear_error()
		"ADD_thread_state@cfa940f4\0" // ADD_thread_state()
		"SSL_load_error_strings@cfa940f4\0" // SSL_load_error_strings()
		"SSL_library_init@5fb5c8f\0" // SSL_library_init()
		"SSL_CTX_new@7d5051d8c94ee897\0" // SSL_CTX_new(const SSL_METHOD* meth)
		"TLSv1_method@8cbe0309d62facf9\0" // TLSv1_method()
		"TLSv1_1_method@8cbe0309d62facf9\0" // TLSv1_1_method()
		"TLSv1_2_method@8cbe0309d62facf9\0" // TLSv1_2_method()
		"SSLv3_method@8cbe0309d62facf9\0" // SSLv3_method()
		"SSLv2_method@8cbe0309d62facf9\0" // SSLv2_method()
		"SSLv23_method@8cbe0309d62facf9\0" // SSLv23_method()
		"SSL_new@84124121c62f86e8\0" // SSL_new(SSL_CTX* ctx)
		"ERR_get_error_string@22c6ed80851\0" // ERR_get_error_string()
		"ERR_get_error@a4d40e48b9374f67\0" // ERR_get_error()
		"ERR_peek_last_error@a4d40e48b9374f67\0" // ERR_peek_last_error()
		"SSL_set_fd@a3e0a8d8be924bae\0" // SSL_set_fd(SSL* s, int fd)
		"SSL_set_tlsext_hostname@97e15b923fa67206\0" // SSL_set_tlsext_hostname(SSL* s, const char* serverName)
		"SSL_connect@544bab97c291\0" // SSL_connect(SSL* ssl)
		"SSL_shutdown@544bab97c291\0" // SSL_shutdown(SSL* s)
		"SSL_free@b6e526942ec76\0" // SSL_free(SSL* ssl)
		"SSL_CTX_free@152dc0a558c7093e\0" // SSL_CTX_free(SSL_CTX* ctx)
		"SSL_read@1c66faecaefa9704\0" // SSL_read(SSL* ssl, void* buf, int num)
		"SSL_write@c9ca9205cde6d061\0" // SSL_write(SSL* ssl, const void* buf, int num)
		"SSL_get_verify_result@b4c6b9704478f9a1\0" // SSL_get_verify_result(const SSL* ssl)
		"SSL_CTX_set_cipher_list@bf3139d03c7b5d4e\0" // SSL_CTX_set_cipher_list(SSL_CTX* ctx, const char* str)
		"SSL_CTX_load_verify_locations@7a2f6fb87caed943\0" // SSL_CTX_load_verify_locations(SSL_CTX* ctx, const char* CAfile, const char* CApath)
		"SSL_CTX_use_PrivateKey_file@ed63261caa803feb\0" // SSL_CTX_use_PrivateKey_file(SSL_CTX* ctx, const char* file, int type)
		"SSL_CTX_use_certificate_chain_file@bf3139d03c7b5d4e\0" // SSL_CTX_use_certificate_chain_file(SSL_CTX* ctx, const char* file)
		"SSL_CTX_ctrl@a9e04f07ca5efcb1\0" // SSL_CTX_ctrl(SSL_CTX* ctx, int cmd, long larg, void* parg)
		"SSL_CTX_set_verify@57c0303d7fac3b42\0" // SSL_CTX_set_verify(SSL_CTX* ctx, int mode, sslctxsetverifycallback callback)
		"SSL_set_connect_state@b6e526942ec76\0" // SSL_set_connect_state(SSL* s)
		"SSL_set_accept_state@b6e526942ec76\0" // SSL_set_accept_state(SSL* s)
		"BIO_ctrl@306fb7243d1ba6fd\0" // BIO_ctrl(BIO* bp, int cmd, long larg, void* parg)
		"SSL_get_rbio@7d7969ddbce4d667\0" // SSL_get_rbio(const SSL* s)
		"SSL_get_wbio@7d7969ddbce4d667\0" // SSL_get_wbio(const SSL* s)
		"SSL_do_handshake@544bab97c291\0" // SSL_do_handshake(SSL* s)
		"SSL_get_error@460644b8953d0631\0" // SSL_get_error(const SSL* s, int ret_code)
		"SSL_CIPHER_get_version@969ef550a1dd5680\0" // SSL_CIPHER_get_version(const SSL_CIPHER* current)
		"SSL_get_current_cipher@909dea5cf8bba994\0" // SSL_get_current_cipher(const SSL* s)
		"X509_free_@1625bfac5ef9b2e\0" // X509_free_(X509* a)
		"SSL_get_peer_certificate@3809fa53d3642e69\0" // SSL_get_peer_certificate(const SSL* s)
		"X509_NAME_oneline@a94ecc5284b07098\0" // X509_NAME_oneline(X509_NAME_* a, char* buf, int size)
		"X509_NAME_get_text_by_NID@86551ff1abf6df3a\0" // X509_NAME_get_text_by_NID(X509_NAME_* name, int nid, char* buf, int len)
		"X509_get_subject_name@ba8310c9896ba833\0" // X509_get_subject_name(X509* a)
		"X509_get_issuer_name@ba8310c9896ba833\0" // X509_get_issuer_name(X509* a)
		"SSL_get_alt_names@0e06d84fa01b8ad6\0" // SSL_get_alt_names(X509* a, BaseArray<String>& alternativeNames)
		"SSL_set_read_ahead@152dc0a4fd1bfb13\0" // SSL_set_read_ahead(SSL* s, int yes)
		"SSL_pending@2e8b2a5d1c723694\0" // SSL_pending(const SSL* s)
		"SSL_get_shutdown@2e8b2a5d1c723694\0" // SSL_get_shutdown(const SSL* ssl)
		"SSL_CTX_use_PrivateKey_ASN1_RSA@1682f02762d8fd46\0" // SSL_CTX_use_PrivateKey_ASN1_RSA(SSL_CTX* ctx, unsigned char* d, long len)
	"";
	class SSLInterface::Unresolved : public SSLInterface
	{
	public:
	...
	#else
		tbl->_SSLInterface_ERR_get_state = &Wrapper<Unresolved>::_SSLInterface_ERR_get_state;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_ERR_clear_error = &Wrapper<Unresolved>::_SSLInterface_ERR_clear_error;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_ADD_thread_state = &Wrapper<Unresolved>::_SSLInterface_ADD_thread_state;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_load_error_strings = &Wrapper<Unresolved>::_SSLInterface_SSL_load_error_strings;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_library_init = &Wrapper<Unresolved>::_SSLInterface_SSL_library_init;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_new = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_new;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_TLSv1_method = &Wrapper<Unresolved>::_SSLInterface_TLSv1_method;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_TLSv1_1_method = &Wrapper<Unresolved>::_SSLInterface_TLSv1_1_method;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_TLSv1_2_method = &Wrapper<Unresolved>::_SSLInterface_TLSv1_2_method;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSLv3_method = &Wrapper<Unresolved>::_SSLInterface_SSLv3_method;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSLv2_method = &Wrapper<Unresolved>::_SSLInterface_SSLv2_method;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSLv23_method = &Wrapper<Unresolved>::_SSLInterface_SSLv23_method;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_new = &Wrapper<Unresolved>::_SSLInterface_SSL_new;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SSLInterface_ERR_get_error_string = &Wrapper<Unresolved>::_SSLInterface_ERR_get_error_string;
	#else
		tbl->_SSLInterface_ERR_get_error_string = &Wrapper<Unresolved>::_SSLInterface_ERR_get_error_string;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<unsigned long>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SSLInterface_ERR_get_error = &Wrapper<Unresolved>::_SSLInterface_ERR_get_error;
	#else
		tbl->_SSLInterface_ERR_get_error = &Wrapper<Unresolved>::_SSLInterface_ERR_get_error;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<unsigned long>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SSLInterface_ERR_peek_last_error = &Wrapper<Unresolved>::_SSLInterface_ERR_peek_last_error;
	#else
		tbl->_SSLInterface_ERR_peek_last_error = &Wrapper<Unresolved>::_SSLInterface_ERR_peek_last_error;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_set_fd = &Wrapper<Unresolved>::_SSLInterface_SSL_set_fd;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_set_tlsext_hostname = &Wrapper<Unresolved>::_SSLInterface_SSL_set_tlsext_hostname;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_connect = &Wrapper<Unresolved>::_SSLInterface_SSL_connect;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_shutdown = &Wrapper<Unresolved>::_SSLInterface_SSL_shutdown;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_free = &Wrapper<Unresolved>::_SSLInterface_SSL_free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_free = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_read = &Wrapper<Unresolved>::_SSLInterface_SSL_read;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_write = &Wrapper<Unresolved>::_SSLInterface_SSL_write;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_verify_result = &Wrapper<Unresolved>::_SSLInterface_SSL_get_verify_result;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_set_cipher_list = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_set_cipher_list;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_load_verify_locations = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_load_verify_locations;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_use_PrivateKey_file = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_use_PrivateKey_file;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_use_certificate_chain_file = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_use_certificate_chain_file;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_ctrl = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_ctrl;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_set_verify = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_set_verify;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_set_connect_state = &Wrapper<Unresolved>::_SSLInterface_SSL_set_connect_state;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_set_accept_state = &Wrapper<Unresolved>::_SSLInterface_SSL_set_accept_state;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_BIO_ctrl = &Wrapper<Unresolved>::_SSLInterface_BIO_ctrl;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_rbio = &Wrapper<Unresolved>::_SSLInterface_SSL_get_rbio;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_wbio = &Wrapper<Unresolved>::_SSLInterface_SSL_get_wbio;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_do_handshake = &Wrapper<Unresolved>::_SSLInterface_SSL_do_handshake;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_error = &Wrapper<Unresolved>::_SSLInterface_SSL_get_error;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CIPHER_get_version = &Wrapper<Unresolved>::_SSLInterface_SSL_CIPHER_get_version;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_current_cipher = &Wrapper<Unresolved>::_SSLInterface_SSL_get_current_cipher;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_X509_free_ = &Wrapper<Unresolved>::_SSLInterface_X509_free_;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_peer_certificate = &Wrapper<Unresolved>::_SSLInterface_SSL_get_peer_certificate;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_X509_NAME_oneline = &Wrapper<Unresolved>::_SSLInterface_X509_NAME_oneline;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_X509_NAME_get_text_by_NID = &Wrapper<Unresolved>::_SSLInterface_X509_NAME_get_text_by_NID;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_X509_get_subject_name = &Wrapper<Unresolved>::_SSLInterface_X509_get_subject_name;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_X509_get_issuer_name = &Wrapper<Unresolved>::_SSLInterface_X509_get_issuer_name;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_SSLInterface_SSL_get_alt_names = &Wrapper<Unresolved>::_SSLInterface_SSL_get_alt_names;
	#else
		tbl->_SSLInterface_SSL_get_alt_names = &Wrapper<Unresolved>::_SSLInterface_SSL_get_alt_names;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_set_read_ahead = &Wrapper<Unresolved>::_SSLInterface_SSL_set_read_ahead;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_pending = &Wrapper<Unresolved>::_SSLInterface_SSL_pending;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_get_shutdown = &Wrapper<Unresolved>::_SSLInterface_SSL_get_shutdown;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_SSLInterface_SSL_CTX_use_PrivateKey_ASN1_RSA = &Wrapper<Unresolved>::_SSLInterface_SSL_CTX_use_PrivateKey_ASN1_RSA;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
