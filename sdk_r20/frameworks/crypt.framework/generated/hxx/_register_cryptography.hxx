...
namespace maxon
{
	...
	MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CryptographyStreamConversionInterface, "net.maxon.interface.cryptographystreamconversion", "maxon.CryptographyStreamConversionInterface", , &StreamConversionInterface::_interface);
	const maxon::Char* const CryptographyStreamConversionInterface::MTable::_ids = 
		"IsChainingChiffre@76f01901\0" // IsChainingChiffre() const
	"";
	template <typename DUMMY> maxon::Int CryptographyStreamConversionInterface::PrivateInstantiateNullValueHelper()
	{
		return 0
		;
	}
...
#endif
static maxon::details::ForceEvaluation s_forceEval_cryptography(0
	| maxon::CryptographyStreamConversionInterface::PrivateInstantiateNullValueHelper<maxon::Int>()
);
