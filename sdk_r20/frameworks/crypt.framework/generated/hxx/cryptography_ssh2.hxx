...
struct SSHInterface::MTable
{
	...
	{
		tbl->_SSHInterface_libssh2_session_init = &IMPL::_SSHInterface_libssh2_session_init;
		tbl->_SSHInterface_libssh2_session_disconnect_ex = &IMPL::_SSHInterface_libssh2_session_disconnect_ex;
		tbl->_SSHInterface_libssh2_session_free = &IMPL::_SSHInterface_libssh2_session_free;
		tbl->_SSHInterface_libssh2_session_set_blocking = &IMPL::_SSHInterface_libssh2_session_set_blocking;
		tbl->_SSHInterface_libssh2_session_handshake = &IMPL::_SSHInterface_libssh2_session_handshake;
		tbl->_SSHInterface_libssh2_hostkey_hash = &IMPL::_SSHInterface_libssh2_hostkey_hash;
		tbl->_SSHInterface_libssh2_userauth_list = &IMPL::_SSHInterface_libssh2_userauth_list;
		tbl->_SSHInterface_libssh2_userauth_password_ex = &IMPL::_SSHInterface_libssh2_userauth_password_ex;
		tbl->_SSHInterface_libssh2_session_last_error = &IMPL::_SSHInterface_libssh2_session_last_error;
		tbl->_SSHInterface_libssh2_sftp_init = &IMPL::_SSHInterface_libssh2_sftp_init;
		tbl->_SSHInterface_libssh2_sftp_shutdown = &IMPL::_SSHInterface_libssh2_sftp_shutdown;
		tbl->_SSHInterface_libssh2_sftp_open_ex = &IMPL::_SSHInterface_libssh2_sftp_open_ex;
		tbl->_SSHInterface_libssh2_sftp_close_handle = &IMPL::_SSHInterface_libssh2_sftp_close_handle;
		tbl->_SSHInterface_libssh2_sftp_unlink_ex = &IMPL::_SSHInterface_libssh2_sftp_unlink_ex;
		tbl->_SSHInterface_libssh2_sftp_mkdir_ex = &IMPL::_SSHInterface_libssh2_sftp_mkdir_ex;
		tbl->_SSHInterface_libssh2_sftp_rmdir_ex = &IMPL::_SSHInterface_libssh2_sftp_rmdir_ex;
		tbl->_SSHInterface_libssh2_sftp_fstat_ex = &IMPL::_SSHInterface_libssh2_sftp_fstat_ex;
		tbl->_SSHInterface_libssh2_sftp_stat_ex = &IMPL::_SSHInterface_libssh2_sftp_stat_ex;
		tbl->_SSHInterface_libssh2_sftp_read = &IMPL::_SSHInterface_libssh2_sftp_read;
		tbl->_SSHInterface_libssh2_sftp_write = &IMPL::_SSHInterface_libssh2_sftp_write;
		tbl->_SSHInterface_libssh2_sftp_readdir_ex = &IMPL::_SSHInterface_libssh2_sftp_readdir_ex;
		tbl->_SSHInterface_libssh2_sftp_seek64 = &IMPL::_SSHInterface_libssh2_sftp_seek64;
	}
};

template <typename C> class SSHInterface::Wrapper
{
public:
