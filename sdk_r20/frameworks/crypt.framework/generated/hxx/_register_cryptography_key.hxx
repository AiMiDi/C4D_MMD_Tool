...
namespace maxon
{
	...
	const maxon::Char* const CryptoKeyInterface::MTable::_ids = 
		"Free@26169c494b695c80\0" // Free(const CryptoKeyInterface* object)
		"Alloc@10c250aab38e5d8f\0" // Alloc(const maxon::SourceLocation& allocLocation, const Id& cryptoAlgorithm, Int blockSizeBits, const void* key1, Int key1BitSize, const void* key2, Int key2BitSize, UInt64 flags, BLOCK_CIPHER_CTR_CALLBACK&& callback)
		"GetCryptoAlgorithm@12b0ccb12f8b105\0" // GetCryptoAlgorithm() const
		"GetBlockBitSize@4386c86\0" // GetBlockBitSize() const
		"GetKey1@629b065b9a9bb850\0" // GetKey1() const
		"GetKey1BitSize@4386c86\0" // GetKey1BitSize() const
		"GetKey2@629b065b9a9bb850\0" // GetKey2() const
		"GetKey2BitSize@4386c86\0" // GetKey2BitSize() const
		"GetFlags@230559bda0f\0" // GetFlags() const
		"GetCallbackFunction@6dee824896b584f5\0" // GetCallbackFunction() const
		"ToString@7de9f6f51c89c899\0" // ToString(const FormatStatement* formatStatement) const
	"";
	class CryptoKeyInterface::Unresolved : public CryptoKeyInterface
	{
	public:
	...
	#else
		tbl->_CryptoKeyInterface_Free = &Wrapper<Unresolved>::_CryptoKeyInterface_Free;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_Alloc = &Wrapper<Unresolved>::_CryptoKeyInterface_Alloc;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CryptoKeyInterface_GetCryptoAlgorithm = &Wrapper<Unresolved>::_CryptoKeyInterface_GetCryptoAlgorithm;
	#else
		tbl->_CryptoKeyInterface_GetCryptoAlgorithm = &Wrapper<Unresolved>::_CryptoKeyInterface_GetCryptoAlgorithm;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_GetBlockBitSize = &Wrapper<Unresolved>::_CryptoKeyInterface_GetBlockBitSize;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_GetKey1 = &Wrapper<Unresolved>::_CryptoKeyInterface_GetKey1;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_GetKey1BitSize = &Wrapper<Unresolved>::_CryptoKeyInterface_GetKey1BitSize;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_GetKey2 = &Wrapper<Unresolved>::_CryptoKeyInterface_GetKey2;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_GetKey2BitSize = &Wrapper<Unresolved>::_CryptoKeyInterface_GetKey2BitSize;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	#else
		tbl->_CryptoKeyInterface_GetFlags = &Wrapper<Unresolved>::_CryptoKeyInterface_GetFlags;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BLOCK_CIPHER_CTR_CALLBACK&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CryptoKeyInterface_GetCallbackFunction = &Wrapper<Unresolved>::_CryptoKeyInterface_GetCallbackFunction;
	#else
		tbl->_CryptoKeyInterface_GetCallbackFunction = &Wrapper<Unresolved>::_CryptoKeyInterface_GetCallbackFunction;
	#endif
	#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CryptoKeyInterface_ToString = &Wrapper<Unresolved>::_CryptoKeyInterface_ToString;
	#else
		tbl->_CryptoKeyInterface_ToString = &Wrapper<Unresolved>::_CryptoKeyInterface_ToString;
	#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
