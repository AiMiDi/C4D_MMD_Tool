...
directionMap = [# direction 'right':        ??        ??
                #                     --?  -'   -.?  -*?   ->           
                #                                ??   ??
                [(0, ord('-'), [0]), (0, ord('\''), [1, 2]), (0, ord('.'), [0, 6, 7]), (0, ord('*'), [0, 1, 7, 2, 6]), (0, ord('>'), None)],
                # direction 'top-right':  ?  ?           ???
                #                        /   |   ,?  .?   *?
                #                       /   /   /   /    / ? 
                ...
                #                   \   |  :   /   ?*?  ?.?  ,?  ^
                #                    |  |  |  |     |    |   |   |
                [(3, ord('\\'), [3]), (2, ord('|'), [2]), (2, ord(':'), [2]), (1, ord('/'), [1]), (2, ord('*'), [2, 3, 1, 4, 0]), (2, ord('.'), [0, 4]), (2, ord(','), [0]), (2, ord('^'), None)],
                # direction 'top-left':  ?    ?       ???
                #                         \   |  ?.   ?*
                #                          \   \   \  ? \
                ...
                #                     ?--  '-  `- ?.-  ,-   ?*-   <-
                #                                 ??  ??    ??
                [(4, ord('-'), [4]), (4, ord('\''), [2, 3]), (4, ord('`'), [2, 3]), (4, ord('.'), [4, 5, 6]), (4, ord(','), [5, 6]), (4, ord('*'), [4, 5, 3, 6, 2]), (4, ord('<'), None)],
                ...
                #                      /   |  :   \   ?*?  ?'?  `?  v
                #                     ?    ?  ?    ?  ???
                [(5, ord('/'), [5]), (6, ord('|'), [6]), (6, ord(':'), [6]), (7, ord('\\'), [7]), (6, ord('*'), [6, 7, 5, 0, 4]), (6, ord('\''), [0, 4]), (6, ord('`'), [0]), (6, ord('v'), None)],
