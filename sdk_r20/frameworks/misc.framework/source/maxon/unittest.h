...
/// @endcode
//----------------------------------------------------------------------------------------
class UnitTestInterface : MAXON_INTERFACE_BASES(Object)
{
...
public:
	static Result<void> ConfigureClass(ClassInterface& cls)
	{
		...
		// Strange warning "call through incomplete class "maxon::Declaration<maxon::Class<maxon::UnitTestInterface::ReferenceClassHelper::type>, maxon::UnitTestBaseClassPrivateHelper>" will always produce an error when instantiated"
		#pragma warning disable 3682
#endif
		return cls.AddComponents(UnitTestBaseClass());
#ifdef MAXON_COMPILER_INTEL
		#pragma warning enable 3682
#endif
	}
};
