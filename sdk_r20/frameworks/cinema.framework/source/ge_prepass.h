...
#define Obasedeform				5157				///< Base deformer.
...
#define Ovolumegroup			1039867			///< Volume Group. @since R20
...
#define WPREF_HW_OPENGL					1008			///< ::Bool This value is set on startup and can only be read. @since R18
...
#define WPREF_OPENGL_TEMP				1092			///< ::Bool Temporary setting (written on shutdown and copied to ::WPREF_HW_OPENGL on startup). @since R18
...
#define MSG_PH_2DTRACK_MODE_MCOMMAND_EXECUTE 1036105 // PH_WIP_2D_TRACK_MODE Assigned to Steve Baines for 'Msg TrkObj 2' from www.plugincafe.com on 151009.
#define MSG_PH_2DTRACK_MODE_MCOMMAND_IS_ENABLED 1039952 // PH_WIP_2D_TRACK_MODE Assigned to Steve Baines from www.plugincafe.com on 170926
