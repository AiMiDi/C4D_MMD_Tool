...
struct C4D_Object
{
	...
	Bool						(*AddTexture					)(BaseList2D *op, const Filename *fn, Int32 parameterId, Bool netRequestOnDemand, AssetData *gd, Int32 channelIndex, const maxon::String& nodePath);
...
struct C4D_Material
{
	...
	maxon::NimbusInterface*								 (BaseMaterial::*GetNimbusRef)() const;
	maxon::Result<maxon::NimbusInterface*> (BaseMaterial::*GetOrCreateNimbusRef)();
};
...
struct C4D_General
{
	...
	void						(*GetSerialInfo				)(SERIALINFO type, maxon::String *s1, maxon::String *s2, maxon::String *s3, maxon::String *s4, maxon::String *s5, maxon::String *s6);
	...
	Int32						(*SpecialGeGetWindowSize)();
	Int32						(*SpecialGeGetWindowName)();
	Bool						(*IsParallel)();
