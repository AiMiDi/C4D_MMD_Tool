...
/// @ingroup group_enumeration
/// @{
#define MSG_DESCRIPTION_INEX_DELETED											1036464				///< Sent by an in/exclude list to the parent. Tells the parent, that an entry got deleted from the list @correspondingData{DescriptionInExDeleted} @markPrivate @since R18
#define MSG_DESCRIPTION_INEX_ADDED												1036465				///< Sent by an in/exclude list to the parent. Tells the parent, that an entry got added to the list @correspondingData{DescriptionInExAdded} @markPrivate @since R18
#define MSG_DESCRIPTION_INEX_SELCHANGED										1037151				///< Sent by an in/exclude list to the parent. Tells the parent, that the selection in the InExclude List changed @correspondingData{DescriptionInExSelChanged} @markPrivate @since R18
...
public:
	...
	String			_nodePath;						///< The node path of the port the asset is assigned to in case of a nimbus material.
