...
public:
	...
	maxon::BaseArray<Vector> _rotation;			/// The rotational velocity
...
public:
	...
	maxon::Block<Vector>	_rotation;			/// The rotational velocity
...
public:
	...
	/// @return												A maxon::Result<FieldCallerStack>.
	//----------------------------------------------------------------------------------------
	static maxon::Result<FieldCallerStack> Create(BaseList2D* caller)
	{
		iferr_scope;
		FieldCallerStack stack;
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	maxon::Result<void> Add(BaseList2D* caller);
...
public:
	...
	maxon::BaseArray<BaseList2D*> _callers;		///< Detailed stack for id _value.
};
