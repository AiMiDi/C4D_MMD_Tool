...
public:
	Result<void> SetGraphNode(const GraphNode& graphNode, const GraphNode& settingsGraphNode, const String& title, Bool isMaterial);
...
{
	Result<void>(iCustomDataTypeImagePreview::*SetGraphNode)(const GraphNode& graphNode, const GraphNode& settingsGraphNode, const String& title, Bool isMaterial);
};
...
inline Result<void> PreviewImageData::SetGraphNode(const GraphNode& graphNode, const GraphNode& settingsGraphNode, const String& title, Bool isMaterial)
{
	...
	return (((iCustomDataTypeImagePreview*)this)->*lib->SetGraphNode)(graphNode, settingsGraphNode, title, isMaterial);
}
