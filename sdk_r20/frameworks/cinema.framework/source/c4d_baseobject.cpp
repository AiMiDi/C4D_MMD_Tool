...
Bool AssetData::Add(const Filename& fn, BaseList2D* bl, Int32 parameterId, Bool netRequestOnDemand, Int32 channelIndex, const maxon::String& nodePath)
{
	return C4DOS.Bo->AddTexture(bl, &fn, parameterId, netRequestOnDemand, this, channelIndex, nodePath);
}
