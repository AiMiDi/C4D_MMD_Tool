...
#else
namespace enum35 { enum class GE_CM_CLIPREGION
{
...
maxon::String PrivateToString_GE_CM_CLIPREGION35(std::underlying_type<enum35::GE_CM_CLIPREGION>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum35::GE_CM_CLIPREGION::EVENODD, (maxon::UInt64) enum35::GE_CM_CLIPREGION::WINDING_};
...
namespace enum47 { enum class GE_CM_DRAWMODE
{
...
maxon::String PrivateToString_GE_CM_DRAWMODE47(std::underlying_type<enum47::GE_CM_DRAWMODE>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum47::GE_CM_DRAWMODE::COPY, (maxon::UInt64) enum47::GE_CM_DRAWMODE::BLEND, (maxon::UInt64) enum47::GE_CM_DRAWMODE::MASK};
...
#endif
namespace enum62 { enum class GE_CM_BLIT
{
...
maxon::String PrivateToString_GE_CM_BLIT62(std::underlying_type<enum62::GE_CM_BLIT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum62::GE_CM_BLIT::COPY, (maxon::UInt64) enum62::GE_CM_BLIT::COL, (maxon::UInt64) enum62::GE_CM_BLIT::FG};
	return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "GE_CM_BLIT", SIZEOF(x), false, values, "COPY\0COL\0FG\0", fmt);
}
namespace enum74 { enum class GE_CM_ARCSEGMENT
{
...
maxon::String PrivateToString_GE_CM_ARCSEGMENT74(std::underlying_type<enum74::GE_CM_ARCSEGMENT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum74::GE_CM_ARCSEGMENT::RIGHTTOP, (maxon::UInt64) enum74::GE_CM_ARCSEGMENT::RIGHTBOTTOM, (maxon::UInt64) enum74::GE_CM_ARCSEGMENT::LEFTBOTTOM, (maxon::UInt64) enum74::GE_CM_ARCSEGMENT::LEFTTOP};
...
namespace enum85 { enum class GE_CM_FONTSORT
{
...
maxon::String PrivateToString_GE_CM_FONTSORT85(std::underlying_type<enum85::GE_CM_FONTSORT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum85::GE_CM_FONTSORT::FLAT, (maxon::UInt64) enum85::GE_CM_FONTSORT::HIERARCHICAL};
