#if 1
namespace enum771 { enum class VIEWPORTSELECTFLAGS
{
	NONE									= 0,			///< None.
...
maxon::String PrivateToString_VIEWPORTSELECTFLAGS771(std::underlying_type<enum771::VIEWPORTSELECTFLAGS>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::NONE, (maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::USE_HN, (maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::USE_DEFORMERS, (maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::REGION_SELECT, (maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::IGNORE_HIDDEN_SEL, (maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::USE_DISPLAY_MODE, (maxon::UInt64) enum771::VIEWPORTSELECTFLAGS::FORCE_USE_DEFORMERS};
...
namespace enum784 { enum class SCRIPTMODE
{
...
maxon::String PrivateToString_SCRIPTMODE784(std::underlying_type<enum784::SCRIPTMODE>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum784::SCRIPTMODE::NONE, (maxon::UInt64) enum784::SCRIPTMODE::PYTHON, (maxon::UInt64) enum784::SCRIPTMODE::AM_ID};
...
namespace enum798 { enum class BASEDRAW_HIGHLIGHT
{
...
maxon::String PrivateToString_BASEDRAW_HIGHLIGHT798(std::underlying_type<enum798::BASEDRAW_HIGHLIGHT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum798::BASEDRAW_HIGHLIGHT::BEFORE_TOOLS, (maxon::UInt64) enum798::BASEDRAW_HIGHLIGHT::AFTER_TOOLS, (maxon::UInt64) enum798::BASEDRAW_HIGHLIGHT::INVERSE_Z, (maxon::UInt64) enum798::BASEDRAW_HIGHLIGHT::DRAW_AFTER_CLEAR};
...
namespace enum813 { enum class FIELDLAYER_CHANNELFLAG
{
	NONE					= 0,						///< None.
...
maxon::String PrivateToString_FIELDLAYER_CHANNELFLAG813(std::underlying_type<enum813::FIELDLAYER_CHANNELFLAG>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum813::FIELDLAYER_CHANNELFLAG::NONE, (maxon::UInt64) enum813::FIELDLAYER_CHANNELFLAG::ENABLE, (maxon::UInt64) enum813::FIELDLAYER_CHANNELFLAG::VALUE, (maxon::UInt64) enum813::FIELDLAYER_CHANNELFLAG::COLOR, (maxon::UInt64) enum813::FIELDLAYER_CHANNELFLAG::DIRECTION, (maxon::UInt64) enum813::FIELDLAYER_CHANNELFLAG::ROTATION};
...
namespace enum827 { enum class POPUPEDITTEXTCALLBACK
{
...
maxon::String PrivateToString_POPUPEDITTEXTCALLBACK827(std::underlying_type<enum827::POPUPEDITTEXTCALLBACK>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum827::POPUPEDITTEXTCALLBACK::TEXTCHANGED, (maxon::UInt64) enum827::POPUPEDITTEXTCALLBACK::CLOSED, (maxon::UInt64) enum827::POPUPEDITTEXTCALLBACK::CANCELED, (maxon::UInt64) enum827::POPUPEDITTEXTCALLBACK::CURSOR_UP, (maxon::UInt64) enum827::POPUPEDITTEXTCALLBACK::CURSOR_DOWN};
