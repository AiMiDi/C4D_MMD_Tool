...
#else
#endif
namespace enum290 { enum class VIDEOPOST_GLINFO : UInt32
{
	NONE															= 0x00000000,
...
maxon::String PrivateToString_VIDEOPOST_GLINFO290(std::underlying_type<enum290::VIDEOPOST_GLINFO>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum290::VIDEOPOST_GLINFO::NONE, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::CUSTOM_MOUSE, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_UVW_BUFFER, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_UVW_BUFFER_FLOAT32, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_DU_BUFFER, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_DV_BUFFER, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_NORMAL_BUFFER, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_MATERIAL_ID, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_NORMAL_BUFFER_FLOAT16, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_NORMAL_BUFFER_FLOAT32, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_WORLCOORD_BUFFER, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_OBJECTID_BUFFER, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::PREPASS, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::DRAW, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::STEREO3D, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_UVW_MATID_BUFFER_FLOAT32, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::ALLOC_TEXEL_SELECTION_BUFFER_R8I, (maxon::UInt64) enum290::VIDEOPOST_GLINFO::DISABLED};
...
namespace enum304 { enum class VIDEOPOST_GLDRAW
{
	NONE								= 0,
...
maxon::String PrivateToString_VIDEOPOST_GLDRAW304(std::underlying_type<enum304::VIDEOPOST_GLDRAW>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum304::VIDEOPOST_GLDRAW::NONE, (maxon::UInt64) enum304::VIDEOPOST_GLDRAW::CUSTOM_MOUSE_INIT, (maxon::UInt64) enum304::VIDEOPOST_GLDRAW::CUSTOM_MOUSE_DRAW, (maxon::UInt64) enum304::VIDEOPOST_GLDRAW::PREPASS, (maxon::UInt64) enum304::VIDEOPOST_GLDRAW::DRAW};
