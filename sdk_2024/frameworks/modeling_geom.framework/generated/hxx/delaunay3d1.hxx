...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<Delaunay3DInterface, maxon::StrongRefHandler, Delaunay3DRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<Delaunay3DInterface, maxon::StrongRefHandler, Delaunay3DRef>>>>);
