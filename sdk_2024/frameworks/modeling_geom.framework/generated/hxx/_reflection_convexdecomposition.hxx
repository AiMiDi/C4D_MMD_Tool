...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(const DataDictionary& settings) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ConvexDecompositionInterface>();
			Result<void> proxy_result = HXXRET1(NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ConvexDecompositionInterface_Init_1_Offset), maxon::reflection::Argument::ByReference(settings)};
			(*handler_)(_fn_ConvexDecompositionInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const DataDictionary&), reinterpret_cast<const void* const&>(mt_.ConvexDecompositionInterface_Init_1)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_ConvexDecompositionInterface_Init_1;
		...
		Result<UInt16> GetProgress() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ConvexDecompositionInterface>();
			Result<UInt16> proxy_result = HXXRET1(NULLIMPL);
		...
		Result<Array<GeometryObject>> FetchResults() 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ConvexDecompositionInterface>();
			Result<Array<GeometryObject>> proxy_result = HXXRET1(NULLIMPL);
	...
	const maxon::reflection::Function* ConvexDecompositionInterface::ProxyComponent::_fn_ConvexDecompositionInterface_Init_1;
	...
	static maxon::Result<void> RegisterReflection_ConvexDecompositionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "settings\0", 0LL, ConvexDecompositionInterface, ConvexDecompositionInterface_Init_1),
