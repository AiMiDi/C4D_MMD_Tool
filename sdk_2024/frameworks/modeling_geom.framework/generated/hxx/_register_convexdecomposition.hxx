...
namespace maxon
{
	const maxon::Char* const ConvexDecompositionInterface::MTable::_ids = 
		...
		"Init@c224a0816826789a\0" // Result<void> Init(const DataDictionary& settings)
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ConvexDecompositionInterface, , "net.maxon.interface.convexdecomposition", (ObjectInterface::PrivateGetInterface()));
