...
namespace maxon
{
	namespace enum24
	{
		...
		static const maxon::UInt64 GEOMETRY_TEST_EXACT_values[] = {maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_FALSE), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_TRUE), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_PARALLEL), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_ANTIPARALLEL), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_COINCIDENT_PREV), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_COINCIDENT_NEXT), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_COINCIDENT_ALL), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_DEGENERATE), maxon::UInt64(enum24::GEOMETRY_TEST_EXACT::GEOM_INVALID_INPUT)};
		static const maxon::EnumInfo GEOMETRY_TEST_EXACT_info{"GEOMETRY_TEST_EXACT", SIZEOF(GEOMETRY_TEST_EXACT), false, "GEOM_FALSE\0GEOM_TRUE\0GEOM_PARALLEL\0GEOM_ANTIPARALLEL\0GEOM_COINCIDENT_PREV\0GEOM_COINCIDENT_NEXT\0GEOM_COINCIDENT_ALL\0GEOM_DEGENERATE\0GEOM_INVALID_INPUT\0", GEOMETRY_TEST_EXACT_values, std::extent<decltype(GEOMETRY_TEST_EXACT_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_GEOMETRY_TEST_EXACT24(){ return enum24::GEOMETRY_TEST_EXACT_info; }
	namespace enum36
	{
		...
		static const maxon::UInt64 LOOP_OVERLAP_STATE_values[] = {maxon::UInt64(enum36::LOOP_OVERLAP_STATE::INTERSECTING), maxon::UInt64(enum36::LOOP_OVERLAP_STATE::DISJOINT), maxon::UInt64(enum36::LOOP_OVERLAP_STATE::A_INSIDE_B), maxon::UInt64(enum36::LOOP_OVERLAP_STATE::B_INSIDE_A), maxon::UInt64(enum36::LOOP_OVERLAP_STATE::COINCIDENT), maxon::UInt64(enum36::LOOP_OVERLAP_STATE::DEGENERATE)};
		static const maxon::EnumInfo LOOP_OVERLAP_STATE_info{"LOOP_OVERLAP_STATE", SIZEOF(LOOP_OVERLAP_STATE), false, "INTERSECTING\0DISJOINT\0A_INSIDE_B\0B_INSIDE_A\0COINCIDENT\0DEGENERATE\0", LOOP_OVERLAP_STATE_values, std::extent<decltype(LOOP_OVERLAP_STATE_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_LOOP_OVERLAP_STATE36(){ return enum36::LOOP_OVERLAP_STATE_info; }
	const maxon::Char* const DegeneratedInputErrorInterface::MTable::_ids = 
	"";
	const maxon::METHOD_FLAGS DegeneratedInputErrorInterface::MTable::_flags[] = 
	{
		maxon::METHOD_FLAGS::NONE
	};
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DegeneratedInputErrorInterface, , "net.maxon.interface.degeneratedinputerror", (ErrorInterface::PrivateGetInterface()));
	...
	const maxon::Char* const GeometryUtilsInterface::MTable::_ids = 
		...
		"ArePointsCoLinearWithinTolerance@976695183ede6bea\0" // Bool ArePointsCoLinearWithinTolerance(const Block<const Vector>& points, maxon::Float tol)
	"";
	MAXON_WARNING_PUSH
	...
	public:
		...
		static Vector CalculateOutlineNormal(const Block<const Vector>& points, const Block<const Int32>& indices, Bool normalized) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::CalculateOutlineNormal(points, indices, normalized); return HXXRET3(UNRESOLVED, Vector);}
		static Vector CalculateOutlineNormal(const Block<const Vector>& points, Bool normalize) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::CalculateOutlineNormal(points, normalize); return HXXRET3(UNRESOLVED, Vector);}
		...
		static GEOMETRY_TEST_EXACT IsVertexConvexExact2D(const Vector2d& vertex, const Vector2d& next, const Vector2d& pred, Float epsilon) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::IsVertexConvexExact2D(vertex, next, pred, epsilon); return HXXRET3(UNRESOLVED, GEOMETRY_TEST_EXACT);}
		static Vector2d CalculateBarycentricCoordinate(const Vector& point, const Vector& a, const Vector& b, const Vector& c) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::CalculateBarycentricCoordinate(point, a, b, c); return HXXRET3(UNRESOLVED, Vector2d);}
		static Vector CalculateBarycentricCoordinate3D(const Vector& point, const Vector& a, const Vector& b, const Vector& c) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::CalculateBarycentricCoordinate3D(point, a, b, c); return HXXRET3(UNRESOLVED, Vector);}
		...
		static Vector CalculateBisector(const Vector& v1, const Vector& v2, const Vector& up, Float w1, Float w2) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::CalculateBisector(v1, v2, up, w1, w2); return HXXRET3(UNRESOLVED, Vector);}
		...
		static Vector BilinearInterpolate(const Vector& pa, const Vector& pb, const Vector& pc, const Vector& pd, const Float s, const Float t) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::BilinearInterpolate(pa, pb, pc, pd, s, t); return HXXRET3(UNRESOLVED, Vector);}
		...
		static Result<void> CalculateMeanValueCoordinatesWeights(const Vector& point, const Block<const Vector>& outline, const Vector& normal, WritableArrayInterface<Float>& weights) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateMeanValueCoordinatesWeights(point, outline, normal, weights); return HXXRET1(UNRESOLVED);}
		...
		static Result<Bool> IsWoundClockwise2D(const Block<const Vector2d>& outlinePoints) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::IsWoundClockwise2D(outlinePoints); return HXXRET1(UNRESOLVED);}
		static Vector2d CalculateOutlineCentroidAndArea2D(const Block<const Vector2d>& outlinePoints, Float* area, Bool* windingPolarity) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::CalculateOutlineCentroidAndArea2D(outlinePoints, area, windingPolarity); return HXXRET3(UNRESOLVED, Vector2d);}
		...
		static Result<BaseArray<Int>> CalculateConvexHull2D(const Block<const Vector2d>& outlinePoints) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateConvexHull2D(outlinePoints); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<BaseArray<Int>>> CalculateConvexDecomposition2D(const Block<const Vector2d>& outlinePoints) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateConvexDecomposition2D(outlinePoints); return HXXRET1(UNRESOLVED);}
		static Result<Bool> CleanLoop2DInPlace(BaseArray<Vector2d>& outlinePoints, Bool maintainStart) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CleanLoop2DInPlace(outlinePoints, maintainStart); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<Vector2d>> CalculateNoFitPolygonForConvex(const Block<const Vector2d>& outlinePointsA, const Block<const Vector2d>& outlinePointsB, Bool relativeBToA) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateNoFitPolygonForConvex(outlinePointsA, outlinePointsB, relativeBToA); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<Vector2d>> CalculateNoFitPolygonUsingSliding(const Block<const Vector2d>& outlinePointsA, const Block<const Vector2d>& outlinePointsB, Bool relativeBToA) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateNoFitPolygonUsingSliding(outlinePointsA, outlinePointsB, relativeBToA); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<Vector2d>> CalculateInnerFitPolygonUsingSliding(const Block<const Vector2d>& outlinePointsCcwA, const Block<const Vector2d>& outlinePointsB) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateInnerFitPolygonUsingSliding(outlinePointsCcwA, outlinePointsB); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<Vector2d>> CalculateNoFitPolygonForConvex(const Block<const Vector2d>& outlinePointsA, const Block<const Vector2d>& outlinePointsB, const Matrix2d& transformA, const Matrix2d& transformB, Bool relativeBToA) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateNoFitPolygonForConvex(outlinePointsA, outlinePointsB, transformA, transformB, relativeBToA); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<Vector2d>> CalculateNoFitPolygonUsingSliding(const Block<const Vector2d>& outlinePointsA, const Block<const Vector2d>& outlinePointsB, const Matrix2d& transformA, const Matrix2d& transformB, Bool relativeBToA) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateNoFitPolygonUsingSliding(outlinePointsA, outlinePointsB, transformA, transformB, relativeBToA); return HXXRET1(UNRESOLVED);}
		static Result<BaseArray<BaseArray<Vector2d>>> CalculateUnionOfPolygons(const Block<const Vector2d>& outlinePointsA, const Block<const Vector2d>& outlinePointsB, Bool includeHolesInResult, Bool createOuterLoop) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return GeometryUtilsInterface::CalculateUnionOfPolygons(outlinePointsA, outlinePointsB, includeHolesInResult, createOuterLoop); return HXXRET1(UNRESOLVED);}
		...
		static LOOP_OVERLAP_STATE GetContainmentStateForNonIntersectingLoops(const Block<const Vector2d>& outlinePointsA, const Block<const Vector2d>& outlinePointsB) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::GetContainmentStateForNonIntersectingLoops(outlinePointsA, outlinePointsB); return HXXRET3(UNRESOLVED, LOOP_OVERLAP_STATE);}
		...
		static Bool ArePointsCoLinearWithinTolerance(const Block<const Vector>& points, maxon::Float tol) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return GeometryUtilsInterface::ArePointsCoLinearWithinTolerance(points, tol); return maxon::PrivateLogNullptrError(false);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE GeometryUtilsInterface::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<Float>::value,
		maxon::details::UnresolvedReturnType<Float>::value,
		maxon::details::UnresolvedReturnType<Float>::value,
		maxon::details::UnresolvedReturnType<Float>::value,
		...
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<Vector>::value,
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<Float>::value,
		maxon::details::UnresolvedReturnType<Float>::value,
		maxon::details::UnresolvedReturnType<Float>::value,
		...
		maxon::details::UnresolvedReturnType<Vector>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<GEOMETRY_TEST_EXACT>::value,
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<GEOMETRY_TEST_EXACT>::value,
		maxon::details::UnresolvedReturnType<Vector2d>::value,
		maxon::details::UnresolvedReturnType<Vector>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		...
		maxon::details::UnresolvedReturnType<Vector2d>::value,
		maxon::details::UnresolvedReturnType<Result<Vector2d>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<Int>>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<BaseArray<Int>>>>::value,
		maxon::details::UnresolvedReturnType<Result<Bool>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value,
		maxon::details::UnresolvedReturnType<Result<BaseArray<BaseArray<Vector2d>>>>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<LOOP_OVERLAP_STATE>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
	...
	maxon::Bool GeometryUtilsInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->GeometryUtilsInterface_LinearRemapToRange = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_LinearRemapToRange), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_LinearRemapToRange);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_GetAngle2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetAngle2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetAngle2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_InterpolatePointOnSegment = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_InterpolatePointOnSegment), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_InterpolatePointOnSegment);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_InterpolatePointOnSegment2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_InterpolatePointOnSegment2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_InterpolatePointOnSegment2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateBestFitPlane = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBestFitPlane), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBestFitPlane);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Points3Dto2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points3Dto2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points3Dto2D);
		#else
		tbl->GeometryUtilsInterface_Points3Dto2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points3Dto2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points3Dto2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Points3Dto2D_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points3Dto2D_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points3Dto2D_1);
		#else
		tbl->GeometryUtilsInterface_Points3Dto2D_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points3Dto2D_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points3Dto2D_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Point2Dto3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Point2Dto3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Point2Dto3D);
		#else
		tbl->GeometryUtilsInterface_Point2Dto3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Point2Dto3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Point2Dto3D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Points2Dto3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points2Dto3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points2Dto3D);
		#else
		tbl->GeometryUtilsInterface_Points2Dto3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points2Dto3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points2Dto3D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateTriangleArea = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateTriangleArea), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateTriangleArea);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateSignedTriangleArea = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateSignedTriangleArea), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateSignedTriangleArea);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateQuadrangleArea = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateQuadrangleArea), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateQuadrangleArea);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateOutlineArea = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineArea), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineArea);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateOutlineNormal = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineNormal), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineNormal);
		#else
		tbl->GeometryUtilsInterface_CalculateOutlineNormal = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineNormal), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineNormal);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateOutlineNormal_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineNormal_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineNormal_1);
		#else
		tbl->GeometryUtilsInterface_CalculateOutlineNormal_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineNormal_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineNormal_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IsVertexConvex = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvex), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<GEOMETRY_TEST_EXACT>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_IsVertexConvexExact = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvexExact), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvexExact);
		#else
		tbl->GeometryUtilsInterface_IsVertexConvexExact = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvexExact), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvexExact);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights);
		#else
		tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1);
		#else
		tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IsVertexConvex2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvex2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvex2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<GEOMETRY_TEST_EXACT>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_IsVertexConvexExact2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvexExact2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvexExact2D);
		#else
		tbl->GeometryUtilsInterface_IsVertexConvexExact2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvexExact2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvexExact2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector2d>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateBarycentricCoordinate = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBarycentricCoordinate), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBarycentricCoordinate);
		#else
		tbl->GeometryUtilsInterface_CalculateBarycentricCoordinate = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBarycentricCoordinate), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBarycentricCoordinate);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateBarycentricCoordinate3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBarycentricCoordinate3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBarycentricCoordinate3D);
		#else
		tbl->GeometryUtilsInterface_CalculateBarycentricCoordinate3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBarycentricCoordinate3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBarycentricCoordinate3D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInTriangle = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInTriangle), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInTriangle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInTriangle2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInTriangle2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInTriangle2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_GetPointInPolygonWindingNumber2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetPointInPolygonWindingNumber2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetPointInPolygonWindingNumber2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_GetPointInPolygonWindingNumber2DExact = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetPointInPolygonWindingNumber2DExact), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetPointInPolygonWindingNumber2DExact);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_GetPointInPolygonWindingNumber2D_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetPointInPolygonWindingNumber2D_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetPointInPolygonWindingNumber2D_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_GetPointInPolygonWindingNumber = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetPointInPolygonWindingNumber), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetPointInPolygonWindingNumber);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_GetPointInPolygonWindingNumber_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetPointInPolygonWindingNumber_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetPointInPolygonWindingNumber_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInOutline2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInOutline2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInOutline2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInOutlineRobust2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInOutlineRobust2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInOutlineRobust2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateBisector = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBisector), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBisector);
		#else
		tbl->GeometryUtilsInterface_CalculateBisector = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBisector), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBisector);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateCircumcenter2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateCircumcenter2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateCircumcenter2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateCircumcenter = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateCircumcenter), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateCircumcenter);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_SegmentsIntersectionTest2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_SegmentsIntersectionTest2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_SegmentsIntersectionTest2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_SegmentRayIntersectionTest2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_SegmentRayIntersectionTest2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_SegmentRayIntersectionTest2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectSegments2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectSegments2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectSegments2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_LineLineDistance = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_LineLineDistance), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_LineLineDistance);
		#else
		tbl->GeometryUtilsInterface_LineLineDistance = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_LineLineDistance), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_LineLineDistance);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInSegment2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInSegment2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInSegment2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInSegment = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInSegment), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInSegment);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_PointInHalfLine = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_PointInHalfLine), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_PointInHalfLine);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLines = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLines), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLines);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLineSegment = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLineSegment), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLineSegment);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectSegments = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectSegments), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectSegments);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectHalfLines = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectHalfLines), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectHalfLines);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLineHalfLine = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLineHalfLine), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLineHalfLine);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectHalfLineSegment = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectHalfLineSegment), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectHalfLineSegment);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectPlanes = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectPlanes), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectPlanes);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLinePlane = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLinePlane), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLinePlane);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLinePlane_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLinePlane_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLinePlane_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectSegmentPlane = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectSegmentPlane), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectSegmentPlane);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectHalfLinePlane = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectHalfLinePlane), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectHalfLinePlane);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLineTriangle = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLineTriangle), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLineTriangle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectHalfLineTriangle = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectHalfLineTriangle), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectHalfLineTriangle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectLineQuadrangle = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectLineQuadrangle), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectLineQuadrangle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectHalfLineQuadrangle = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectHalfLineQuadrangle), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectHalfLineQuadrangle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectSegmentTriangle = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectSegmentTriangle), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectSegmentTriangle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_TrianglesIntersectionTest = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_TrianglesIntersectionTest), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_TrianglesIntersectionTest);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculatePolygonPointST = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculatePolygonPointST), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculatePolygonPointST);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_InverseBilinarInterpolate = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_InverseBilinarInterpolate), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_InverseBilinarInterpolate);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_InverseBilinarInterpolateNewton = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_InverseBilinarInterpolateNewton), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_InverseBilinarInterpolateNewton);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_InverseBilinarInterpolate2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_InverseBilinarInterpolate2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_InverseBilinarInterpolate2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_InverseBilinarInterpolate2DNewton = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_InverseBilinarInterpolate2DNewton), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_InverseBilinarInterpolate2DNewton);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_BilinearInterpolate = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_BilinearInterpolate), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_BilinearInterpolate);
		#else
		tbl->GeometryUtilsInterface_BilinearInterpolate = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_BilinearInterpolate), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_BilinearInterpolate);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateSignedTriangleArea_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateSignedTriangleArea_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateSignedTriangleArea_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2);
		#else
		tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculatePerimeterLength2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculatePerimeterLength2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculatePerimeterLength2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Bool>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_IsWoundClockwise2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsWoundClockwise2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsWoundClockwise2D);
		#else
		tbl->GeometryUtilsInterface_IsWoundClockwise2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsWoundClockwise2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsWoundClockwise2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Vector2d>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D);
		#else
		tbl->GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Vector2d>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateMultiOutlineCentroidAndAreas2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMultiOutlineCentroidAndAreas2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMultiOutlineCentroidAndAreas2D);
		#else
		tbl->GeometryUtilsInterface_CalculateMultiOutlineCentroidAndAreas2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMultiOutlineCentroidAndAreas2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMultiOutlineCentroidAndAreas2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<Int>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateConvexHull2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateConvexHull2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateConvexHull2D);
		#else
		tbl->GeometryUtilsInterface_CalculateConvexHull2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateConvexHull2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateConvexHull2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<BaseArray<Int>>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateConvexDecomposition2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateConvexDecomposition2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateConvexDecomposition2D);
		#else
		tbl->GeometryUtilsInterface_CalculateConvexDecomposition2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateConvexDecomposition2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateConvexDecomposition2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Bool>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CleanLoop2DInPlace = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CleanLoop2DInPlace), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CleanLoop2DInPlace);
		#else
		tbl->GeometryUtilsInterface_CleanLoop2DInPlace = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CleanLoop2DInPlace), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CleanLoop2DInPlace);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateNoFitPolygonForConvex = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonForConvex), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonForConvex);
		#else
		tbl->GeometryUtilsInterface_CalculateNoFitPolygonForConvex = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonForConvex), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonForConvex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding);
		#else
		tbl->GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateInnerFitPolygonUsingSliding = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateInnerFitPolygonUsingSliding), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateInnerFitPolygonUsingSliding);
		#else
		tbl->GeometryUtilsInterface_CalculateInnerFitPolygonUsingSliding = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateInnerFitPolygonUsingSliding), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateInnerFitPolygonUsingSliding);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1);
		#else
		tbl->GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<Vector2d>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding_1);
		#else
		tbl->GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonUsingSliding_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<BaseArray<Vector2d>>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateUnionOfPolygons = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateUnionOfPolygons), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateUnionOfPolygons);
		#else
		tbl->GeometryUtilsInterface_CalculateUnionOfPolygons = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateUnionOfPolygons), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateUnionOfPolygons);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_IntersectsSegmentsExact2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IntersectsSegmentsExact2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IntersectsSegmentsExact2D);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<LOOP_OVERLAP_STATE>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops);
		#else
		tbl->GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_AreLoopsEqualToWithinTolerance = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_AreLoopsEqualToWithinTolerance), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_AreLoopsEqualToWithinTolerance);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_CalculateBoundingBoxIndices = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBoundingBoxIndices), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBoundingBoxIndices);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->GeometryUtilsInterface_ArePointsCoLinearWithinTolerance = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_ArePointsCoLinearWithinTolerance), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_ArePointsCoLinearWithinTolerance);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(GeometryUtilsInterface, "net.maxon.geom.geometryutils", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int GeometryUtilsInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<GEOMETRY_TEST_EXACT>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<LOOP_OVERLAP_STATE>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<Vector>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_geometryutils(0
	| maxon::GeometryUtilsInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
