...
struct NURBSCurveInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_EvaluateAt, NURBSCurveInterface, const, (Result<Vector>), Float s) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->EvaluateAt(s); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_DeriveAt, NURBSCurveInterface, const, (Result<Vector>), Float s) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->DeriveAt(s); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetDegree, NURBSCurveInterface, const, (Result<Int>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetDegree(); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetMaxDegree, NURBSCurveInterface, const, (Result<Int>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetMaxDegree(); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetPointCount, NURBSCurveInterface, const, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetPointCount(); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetWeightCount, NURBSCurveInterface, const, (Result<Int>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetWeightCount(); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetPoint, NURBSCurveInterface, const, (Result<Vector>), Int i) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetPoint(i); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetPointWithWeight, NURBSCurveInterface, const, (Result<Vector4d>), Int i) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetPointWithWeight(i); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetPointsWithWeights, NURBSCurveInterface, const, (const Block<const Vector4d>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetPointsWithWeights(); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_GetWeight, NURBSCurveInterface, const, (Result<Float>), Int i) { return S::Get(PRIVATE_MAXON_MF_THIS(const NURBSCurveInterface))->GetWeight(i); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_SetPoint, NURBSCurveInterface,, (Result<void>), Int i, const Vector& point) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->SetPoint(i, point); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_SetPointWithWeight, NURBSCurveInterface,, (Result<void>), Int i, const Vector4d& point) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->SetPointWithWeight(i, point); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_ChangePoints, NURBSCurveInterface,, (Result<void>), const Block<Vector>& points) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->ChangePoints(points); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_SetPointsWithWeights, NURBSCurveInterface,, (Result<void>), const Block<const Vector4d>& points) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->SetPointsWithWeights(points); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_SetWeight, NURBSCurveInterface,, (Result<void>), Int i, Float weight) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->SetWeight(i, weight); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_ChangeWeights, NURBSCurveInterface,, (Result<void>), const Block<const Float>& weights) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->ChangeWeights(weights); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_ChangeWeights_1, NURBSCurveInterface,, (Result<void>), const Block<const Float32>& weights) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->ChangeWeights(weights); }
		PRIVATE_MAXON_MF_WRAPPER(NURBSCurveInterface_AddControlPoint, NURBSCurveInterface,, (Result<Pair<Block<Vector4d>, Int>>), const Float t) { return S::Get(PRIVATE_MAXON_MF_THIS(NURBSCurveInterface))->AddControlPoint(t); }
	};
...
{
	HXXRETURN0(Result<Vector>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto NURBSCurveInterface::Hxx1::ConstFn<S>::GetPointCount() const -> HXXADDRET2(Int)
{
...
{
	HXXRETURN0(Result<Vector4d>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((NURBSCurveInterface::MTable*) (o_->_vtableCls + 1))[-1].NURBSCurveInterface_GetPointWithWeight, i));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto NURBSCurveInterface::Hxx1::ConstFn<S>::GetPointsWithWeights() const -> HXXADDRET2(const Block<const Vector4d>)
{
	HXXRETURN0(HXXADDRET2(const Block<const Vector4d>)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const Block<const Vector4d>)) 
...
{
	HXXRETURN0(Result<Pair<Block<Vector4d>, Int>>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) 
