...
struct VolumeCommandData
{
	...
	BaseArray<const ::BaseObject*>* reference = nullptr;		// Reference volumes for field conversion and MoSpline reference for spline conversion.
	...
	const SplineData* splineData = nullptr;									// A spline data pointer used for scaling of spline radii
};
