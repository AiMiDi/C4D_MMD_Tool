...
public:
	...
	Vector TransformColor(const Vector& input) const
	{
		...
		else
		{
			if (document_colorprofile == DOCUMENT_COLORPROFILE_SRGB && linear_workflow)
				return CINEWARE_NAMESPACE::BasicTransformColor(input, COLORSPACETRANSFORMATION::SRGB_TO_LINEAR);
			else if (document_colorprofile == DOCUMENT_COLORPROFILE_LINEAR && !linear_workflow)
				return CINEWARE_NAMESPACE::BasicTransformColor(input, COLORSPACETRANSFORMATION::LINEAR_TO_SRGB);
		}
		return input;
	}
	maxon::Color TransformColor(const maxon::Color& input) const
	{
		...
		{
			if (document_colorprofile == DOCUMENT_COLORPROFILE_SRGB && linear_workflow)
				return maxon::Color(CINEWARE_NAMESPACE::BasicTransformColor(Vector(input), COLORSPACETRANSFORMATION::SRGB_TO_LINEAR));
			else if (document_colorprofile == DOCUMENT_COLORPROFILE_LINEAR && !linear_workflow)
				return maxon::Color(CINEWARE_NAMESPACE::BasicTransformColor(Vector(input), COLORSPACETRANSFORMATION::LINEAR_TO_SRGB));
		}
		return input;
	}
};
