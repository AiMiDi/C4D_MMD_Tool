...
#define CUSTOMDATATYPE_INFO_NO_ALIASTRANS							(1 << 9)										///< Set if DataTypeClass::CopyData() doesn't need AliasTrans. This enabled the power of COW (Copy-On-Write)
#define CUSTOMDATATYPE_INFO_BLOCKING									(1 << 10)										///< Forces a blocking drag evaluation in the AM. This prevents asynchronous read and edit of the customgui and custom datatype.
/// @}
...
template <Int32 TDATATYPEID> struct CustomDataTypeT : public CustomDataType
{
	static constexpr Int32 DATATYPEID = TDATATYPEID;
};
...
//----------------------------------------------------------------------------------------
template <class X, Int32 TDATATYPEID> struct iCustomDataType : public CustomDataTypeT<TDATATYPEID>
{
#ifdef USE_API_MAXON
	//----------------------------------------------------------------------------------------
