...
{
	return C4DOS_Cd->AddGadget(Get(), DIALOG_ISDOCKEDORTABBED, 0, nullptr, 0, 0, 0, 0, nullptr, nullptr);
}
...
Bool GeUserArea::OpenPopUpMenu(Int32 menuid, Int32 localx, Int32 localy, Int32 watchhotkey)
{
	...
	if (localx != -1 && localy != -1)
		C4DOS_Cu->Local2Screen((CBaseFrame*)cu, &localx, &localy);
...
{
	return C4DOS_Cd->CBF_GetParentBackgroundColor((CBaseFrame*)cu);
}
...
{
	return C4DOS_Cd->CBF_GetColorRGB((CBaseFrame*)cu, colorid, r, g, b);
}

void GeUserArea::ActivateFading(Int32 milliseconds)
{
	C4DOS_Cd->CBF_ActivateFading((CBaseFrame*)cu, milliseconds);
}

void GeUserArea::AdjustColor(Int32 colorid, Int32 highlightid, Float percent)
{
	C4DOS_Cd->CBF_AdjustColor((CBaseFrame*)cu, colorid, highlightid, percent);
}
...
{
	return C4DOS_Cu->GetInputState((CBaseFrame*)cu, askdevice, askchannel, &res);
}

Bool GeUserArea::GetInputEvent(Int32 askdevice, BaseContainer& res) const
{
	return C4DOS_Cu->GetInputEvent((CBaseFrame*)cu, askdevice, &res);
}
...
Float GeUserArea::GetPixelRatio() const
{
	if (!cu)
		return 1.0;
	return C4DOS_Cu->GetPixelRatio(reinterpret_cast<const CBaseFrame*>(cu));
}

Bool GeUserArea::Global2Local(Int32* x, Int32* y) const
{
	return C4DOS_Cu->Global2Local((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Local2Global(Int32* x, Int32* y) const
{
	return C4DOS_Cu->Local2Global((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Local2Screen(Int32* x, Int32* y) const
{
	return C4DOS_Cu->Local2Screen((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Screen2Local(Int32* x, Int32* y) const
{
	return C4DOS_Cu->Screen2Local((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Global2Local(Float& x, Float& y) const
{
	return C4DOS_Cu->Global2LocalF((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Local2Global(Float& x, Float& y) const
{
	return C4DOS_Cu->Local2GlobalF((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Local2Screen(Float& x, Float& y) const
{
	return C4DOS_Cu->Local2ScreenF((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Screen2Local(Float& x, Float& y) const
{
	return C4DOS_Cu->Screen2LocalF((CBaseFrame*)cu, x, y);
}
