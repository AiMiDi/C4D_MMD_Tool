...
/// @param[in] priority						The interaction priority (Draw/MouseInput/KeyboardInput/GetCursorInfo).
/// @note													Draw function from a SceneHookData with a lower priority will be called after and could draw over SceneHookData called with higher priority.
/// @node													AddToExecution have to be used to change the SceneHookData::Execute priority.
