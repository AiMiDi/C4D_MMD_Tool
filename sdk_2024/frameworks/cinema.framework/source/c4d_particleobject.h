...
public:
	...
	//----------------------------------------------------------------------------------------
	const Particle* GetParticleR(ParticleTag* pt, Int32 i) { return C4DOS_Bo->PrGetParticleR(this, pt, i); }
	...
	/// @return												The particle information structure. @theOwnsPointed{particle object,particle information}
	//----------------------------------------------------------------------------------------
	Particle* GetParticleW(ParticleTag* pt, Int32 i) { return C4DOS_Bo->PrGetParticleW(this, pt, i); }
	...
	//----------------------------------------------------------------------------------------
	ParticleDetails* GetParticleDetails(const BaseDocument* doc);
};
