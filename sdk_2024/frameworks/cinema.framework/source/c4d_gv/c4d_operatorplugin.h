...
struct OPERATORPLUGIN : public NODEPLUGIN
{
	...
	String				(GvOperatorData::*GetDetailedText							)(const GvNode *bn) const;
	String				(GvOperatorData::*GetText											)(const GvNode *bn) const;
	String				(GvOperatorData::*GetTitle										)(const GvNode *bn) const;
	BaseBitmap*		(GvOperatorData::*GetPortIcon									)(GvNode *bn, Int32 id, GvLayoutType layout_type);
	void					(GvOperatorData::*GetBodySize									)(const GvNode *bn, Int32 *width, Int32 *height) const;
	Vector				(GvOperatorData::*GetBodyColor								)(const GvNode *bn) const;
	...
	Bool					(GvOperatorData::*GetOperatorDescription			)(const GvNode *bn, GvOperatorDescription *od) const;
	...
	String				(GvOperatorData::*GetErrorString							)(const GvNode *bn, Int32 error) const;
	...
	DescID				(GvOperatorData::*GetDescID										)(GvNode *bn, GvPortIO io, Int32 main_id);
