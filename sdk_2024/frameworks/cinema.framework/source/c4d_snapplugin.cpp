...
{
	return CheckLib<SnapCoreLib>(ID_SNAPCORE_LIB, offset, snaplib_cache);
}
...
Bool SnapCore::Init(BaseDocument* doc, BaseDraw* bd, AtomArray* exclude/*= nullptr*/)
{
	...
	return (reinterpret_cast<iSnapCore*>(this)->*(slib->Init))(doc, bd, exclude);
}

Bool SnapCore::Update()
{
	SnapCoreLib* slib = CheckSnapLib(LIBOFFSET(SnapCoreLib, Update));
	if (!slib || !slib->Update)
		return false;

	return (reinterpret_cast<iSnapCore*>(this)->*(slib->Update))();
}
...
Bool SnapCore::Snap(const Vector& p, SnapResult& result, SNAPFLAGS flags)
{
	...
	return (reinterpret_cast<iSnapCore*>(this)->*(slib->Snap))(p, result, flags);
}
...
Bool SnapCore::Intersect(const Vector& p, const Vector& n, Bool plane, SnapResult& result, SNAPFLAGS flags)
{
	...
	return (reinterpret_cast<iSnapCore*>(this)->*(slib->Intersect))(p, n, plane, result, flags);
}
...
BaseObject* SnapCore::AddInferred(BaseDocument* doc, const Matrix& mat, INFERREDGUIDETYPE type)
{
	...
	return (BaseObject*)(reinterpret_cast<iSnapCore*>(this)->*(slib->AddInferred))(doc, mat, type);
}

Bool SnapCore::FlushInferred()
{
	SnapCoreLib* slib = CheckSnapLib(LIBOFFSET(SnapCoreLib, FlushInferred));
	if (!slib || !slib->FlushInferred)
		return false;

	return (reinterpret_cast<iSnapCore*>(this)->*(slib->FlushInferred))();
...
void SnapCore::SetToolObject(BaseObject* op)
{
	...
	(reinterpret_cast<iSnapCore*>(this)->*(slib->SetToolObject))(op);
}

SnapCore* SnapCore::Alloc()
{
...
void SnapCore::SetCustomExcludeList(maxon::BaseArray<SnapExclude>* snapExcludeList)
{
	...
	if (!slib || !slib->SetCustomExcludeList)
		return;
	(reinterpret_cast<iSnapCore*>(this)->*(slib->SetCustomExcludeList))(snapExcludeList);
}

//////////////////////////////////////////////////////////////////////////
// !Helper functions
Bool IsSnapEnabled(const BaseDocument* doc, Int32 mode)
{
