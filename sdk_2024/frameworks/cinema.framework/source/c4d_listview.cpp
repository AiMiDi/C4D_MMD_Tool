...
GeListView::GeListView()
{
	cd = nullptr;
	lv = (_GeListView*)C4DOS_Cu->GeListView_Alloc();
}

GeListView::~GeListView()
{
	C4DOS_Cu->GeListView_Free(lv);
	lv = nullptr;
	cd = nullptr;
}
...
{
	C4DOS_Cu->GeListView_LvSuperCall(lv, res_type, result, secret, cmd, line, col);
}

void GeListView::Redraw()
{
	C4DOS_Cu->GeListView_Redraw(lv);
}

void GeListView::DataChanged()
{
	C4DOS_Cu->GeListView_DataChanged(lv);
}

Bool GeListView::ExtractMouseInfo(void* secret, MouseDownInfo& info, Int32 size)
{
	return C4DOS_Cu->GeListView_ExtractMouseInfo(lv, secret, info, size);
}
void GeListView::ShowCell(Int32 line, Int32 col)
{
	C4DOS_Cu->GeListView_ShowCell(lv, line, col);
}

Bool GeListView::ExtractDrawInfo(void* secret, DrawInfo& info, Int32 size)
{
	return C4DOS_Cu->GeListView_ExtractDrawInfo(lv, secret, info, size);
}

Bool GeListView::SendParentMessage(const BaseContainer& msg)
{
	return C4DOS_Cu->GeListView_SendParentMessage(lv, &msg);
}

Int32 GeListView::GetId()
{
	return C4DOS_Cu->GeListView_GetId(lv);
}
...
{
	return C4DOS_Cu->GeListView_Attach(lv, dlg->Get(), id, ListViewCallBackFunc, this);
}
...
SimpleListView::SimpleListView()
{
	...
	C4DOS_Cu->GeListView_Free(lv);
	lv = (_GeListView*)C4DOS_Cu->SimpleListView_Alloc();
}
...
{
	return C4DOS_Cu->SimpleListView_SetLayout((_SimpleListView*)lv, columns, data);
}

Bool SimpleListView::SetItem(Int32 id, const BaseContainer& data)
{
	return C4DOS_Cu->SimpleListView_SetItem((_SimpleListView*)lv, id, data);
}

Bool SimpleListView::GetItem(Int32 id, BaseContainer* data)
{
	return C4DOS_Cu->SimpleListView_GetItem((_SimpleListView*)lv, id, data);
}

Int32 SimpleListView::GetItemCount()
{
	return C4DOS_Cu->SimpleListView_GetItemCount(reinterpret_cast<_SimpleListView*>(lv));
}

Bool SimpleListView::GetItemLine(Int32 num, Int32* id, BaseContainer* data)
{
	return C4DOS_Cu->SimpleListView_GetItemLine((_SimpleListView*)lv, num, id, data);
}

Bool SimpleListView::RemoveItem(Int32 id)
{
	return C4DOS_Cu->SimpleListView_RemoveItem((_SimpleListView*)lv, id);
}
...
{
	return C4DOS_Cu->SimpleListView_GetSelection((_SimpleListView*)lv, selection);
}

Bool SimpleListView::SetSelection(BaseSelect* selection)
{
	return C4DOS_Cu->SimpleListView_SetSelection((_SimpleListView*)lv, selection);
}

Bool SimpleListView::SetProperty(Int32 id, Int32 val)
{
	return C4DOS_Cu->SimpleListView_SetProperty((_SimpleListView*)lv, id, val);
}

Int32 SimpleListView::GetProperty(Int32 id)
{
	return C4DOS_Cu->SimpleListView_GetProperty((_SimpleListView*)lv, id);
}

void SimpleListView::ShowCell(Int32 line, Int32 col)
{
	return C4DOS_Cu->SimpleListView_ShowCell((_SimpleListView*)lv, line, col);
}
