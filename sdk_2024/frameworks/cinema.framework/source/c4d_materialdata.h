...
#define PLUGINFLAG_MATERIAL_SHOW_IN_DEFAULT_MENU 		(1 << 5)									///< If set, material will appear in Preferences / Material / Material Manager / Default Material dropdown. @deprecated Use API in materialdelegate.h instead.
/// @}
