...
Bool VideoPostData::GlDrawDummy(BaseVideoPost* node, BaseDraw* bd, GlFrameBuffer* fbuf, Int32 colortex, Int32 depthtex, UInt32 flags)
{
	return false;
}

UInt32 VideoPostData::GetGlInfoDummy(BaseVideoPost* node, BaseDocument* doc, BaseDraw* bd)
{
	return 0;
}
...
Bool VideoPostData::RenderEngineCheck(const BaseVideoPost* node, Int32 id) const
{
	return true;
}
...
void VideoPostData::GetColorProfileInfo(BaseVideoPost* node, VideoPostStruct *vps, ColorProfileInfo& info)
{
}
...
Bool RegisterVideoPostPlugin(Int32 id, const maxon::String& str, Int32 info, DataAllocator* g, const maxon::String& description, Int32 disklevel, Int32 priority)
{
	...
	np.GlDraw	= &VideoPostData::GlDrawDummy;
	np.GetGlInfo = &VideoPostData::GetGlInfoDummy;
	...
	np.GetColorProfileInfo	= &VideoPostData::GetColorProfileInfo;
