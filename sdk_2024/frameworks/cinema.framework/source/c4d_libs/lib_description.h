...
#ifndef ConstDescID
	#define ConstDescID(...)	DescID(maxon::IN_PLACE_TYPE::VALUE, ConstDescIDMem<MAXON_MAKE_COMMA_LIST(AddDescX, , , __VA_ARGS__)>::ToArray())
	#define CreateDescID(...) DescID::Create(__VA_ARGS__)
#endif
