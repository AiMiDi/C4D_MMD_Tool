...
public:
	...
	{
		if (static_cast<SDKReferenceObjectPtr&>(src).itf)
			static_cast<SDKReferenceObjectPtr&>(src).itf->add_reference();					// There is an additional reference to the interface
		itf = static_cast<SDKReferenceObjectPtr&>(src).itf;												// Get pointer
	}
	...
	{
		if (src_itf)
			static_cast<ObjectInterface *>(src_itf)->add_reference();				// There is an additional reference to the interface
	...
	//----------------------------------------------------------------------------------------
	inline ObjectInterface	*GetPtr() const
	{
		return static_cast<ObjectInterface *>(itf);
	}
	...
	SDKReferenceObjectPtr&	operator =(const SDKReferenceObjectBasePtr &src)
	{
		...
		old_itf = itf;
		itf = static_cast<SDKReferenceObjectPtr&>(src).itf;					// Assign the new pointer
	...
	/// @return												The pointer to the interface.
	//----------------------------------------------------------------------------------------
	inline operator ObjectInterface*() const
	{
		return static_cast<ObjectInterface *>(itf);
	}
	...
	/// @return												The pointer to the interface.
	//----------------------------------------------------------------------------------------
	inline ObjectInterface	*operator->() const
	{
		return static_cast<ObjectInterface *>(itf);
	}
