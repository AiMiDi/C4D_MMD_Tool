...
#define SculptBrushBaseLibraryCall(b) 		SculptBrushBaseLibrary *lib = CheckSculptBrushBaseLibrary(LIBOFFSET(SculptBrushBaseLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<iSculptBrushBase*>(this)->*lib->b)
...
#define SculptBrushBaseLibraryCallR(a, b)  SculptBrushBaseLibrary *lib = CheckSculptBrushBaseLibrary(LIBOFFSET(SculptBrushBaseLibrary, b)); \
															...
															return (reinterpret_cast<iSculptBrushBase*>(this)->*lib->b)

#define SculptBrushBaseLibraryCallRC(a, b)  SculptBrushBaseLibrary *lib = CheckSculptBrushBaseLibrary(LIBOFFSET(SculptBrushBaseLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const iSculptBrushBase*>(this)->*lib->b)
