...
static PolygonReductionLibrary* CheckPolygonReductionLib(Int32 offset)
{
	...
	return CheckLib<PolygonReductionLibrary>(ID_POLYGONREDUCTION_LIB, offset, polygonReduction_lib_cache);
}
...
Bool PolygonReduction::PreProcess(const PolygonReductionData& data)
{
	...
	return (reinterpret_cast<iPolygonReduction*>(this)->*(lib->PreProcess))(data);
}
...
Bool PolygonReduction::IsPreprocessing()
{
	...
	return (reinterpret_cast<iPolygonReduction*>(this)->*(lib->IsPreprocessing))();
}
...
void PolygonReduction::StopPreprocessing()
{
	...
	(reinterpret_cast<iPolygonReduction*>(this)->*(lib->StopPreprocessing))();
}
...
void PolygonReduction::Reset()
{
	...
	(reinterpret_cast<iPolygonReduction*>(this)->*(lib->Reset))();
}
...
Bool PolygonReduction::SetReductionStrengthLevel(Float strengthLevel)
{
	...
	return (reinterpret_cast<iPolygonReduction*>(this)->*(lib->SetReductionStrengthLevel))(strengthLevel);
}
...
Bool PolygonReduction::SetTriangleLevel(Int32 desiredLevel)
{
	...
	return (reinterpret_cast<iPolygonReduction*>(this)->*(lib->SetTriangleLevel))(desiredLevel);
}
...
Bool PolygonReduction::SetVertexLevel(Int32 desiredLevel)
{
	...
	return (reinterpret_cast<iPolygonReduction*>(this)->*(lib->SetVertexLevel))(desiredLevel);
}
...
Bool PolygonReduction::SetRemainingEdgesLevel(Int32 desiredLevel)
{
	...
	return (reinterpret_cast<iPolygonReduction*>(this)->*(lib->SetRemainingEdgesLevel))(desiredLevel);
}
...
Float PolygonReduction::GetReductionStrengthLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetReductionStrengthLevel))();
}
...
Int32 PolygonReduction::GetTriangleLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetTriangleLevel))();
}
...
Int32 PolygonReduction::GetVertexLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetVertexLevel))();
}
...
Int32 PolygonReduction::GetRemainingEdgesLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetRemainingEdgesLevel))();
}
...
Float PolygonReduction::GetMaxReductionStrengthLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetMaxReductionStrengthLevel))();
}
...
Int32 PolygonReduction::GetMaxTriangleLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetMaxTriangleLevel))();
}
...
Int32 PolygonReduction::GetMaxVertexLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetMaxVertexLevel))();
}
...
Int32 PolygonReduction::GetMaxRemainingEdgesLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetMaxRemainingEdgesLevel))();
}
...
Int32 PolygonReduction::GetMinTriangleLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetMinTriangleLevel))();
}
...
Int32 PolygonReduction::GetMinVertexLevel() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetMinVertexLevel))();
}
...
const PolygonReductionData& PolygonReduction::GetData() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->GetData))();
}
...
Bool PolygonReduction::IsValid() const
{
	...
	return (reinterpret_cast<const iPolygonReduction*>(this)->*(lib->IsValid))();
}
