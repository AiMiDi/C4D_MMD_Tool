...
{
	return CheckLib<NetLibrary>(C4D_NETRENDER_LIBRARY_ID, offset, net_lib_cache);
}
...
JOBSTATE RenderJob::GetState() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->RenderJobGetState))();
}
...
RENDERRESULT RenderJob::GetRenderResult() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->RenderJobGetRenderResult))();
}
...
void RenderJob::SetState(JOBSTATE state, Bool sendSignal)
{
	...
	(static_cast<RenderJob*>(this)->*(lib->RenderJobSetState))(state, sendSignal);
}
...
NetRenderService* RenderJob::GetNetRenderService() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->GetNetRenderService))();
}
...
const C4DUuid RenderJob::GetUuid() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->RenderJobGetUuid))();
}
...
ProgressHook* RenderJob::GetProgressHook(void*& context)
{
	...
	return (static_cast<RenderJob*>(this)->*(lib->GetProgressHook))(context);
}
...
WriteProgressHook* RenderJob::GetWriteProgressHook(void*& context)
{
	...
	return (static_cast<RenderJob*>(this)->*(lib->GetWriteProgressHook))(context);
}
...
void RenderJob::SetDefaultScenePath(const Filename& defaultSceneName)
{
	...
	(static_cast<RenderJob*>(this)->*(lib->RenderJobSetDefaultSceneName))(defaultSceneName);
}
...
Filename RenderJob::GetDefaultScenePath() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->RenderJobGetDefaultSceneName))();
}
...
const C4DUuid RenderJob::GetCreatorUuid() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->RenderJobGetCreatorUuid))();
}
...
void RenderJob::SetCreatorUuid(const C4DUuid& creatorUuid)
{
	...
	(static_cast<RenderJob*>(this)->*(lib->RenderJobSetCreatorUuid))(creatorUuid);
}
...
const C4DUuid RenderJob::GetServerUuid() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->RenderJobGetServerUuid))();
}
...
void RenderJob::SetServerUuid(const C4DUuid& serverUuid)
{
	...
	(static_cast<RenderJob*>(this)->*(lib->RenderJobSetServerUuid))(serverUuid);
}
...
void RenderJob::UpdateProgress(Float progress, Bool completed)
{
	...
	(static_cast<RenderJob*>(this)->*(lib->UpdateProgress))(progress, completed);
}
...
const NetRenderData* RenderJob::GetRenderData() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->GetRenderData))();
}
...
RelativeFilename RenderJob::GetProjectFolder() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->GetProjectFolder))();
}
...
Bool NetRenderService::AddLogToJob(const C4DUuid& jobUuid, const String& log, Bool doLock, Bool append)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->AddLogToJob))(jobUuid, log, doLock, append);
}
...
Bool NetRenderService::AddLogToMachine(const C4DUuid& machineUuid, const String& log, Bool doLock)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->AddLogToMachine))(machineUuid, log, doLock);
}
...
maxon::Result<void> NetRenderService::CopyRenderTaskFrom(const C4DUuid& jobUuid, maxon::BaseArray<RenderTask>& todo)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->CopyRenderTaskFrom))(jobUuid, todo);
}
...
BaseContainer* NetRenderService::GetNetPreferences() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetNetPreferences))();
}
...
EDITION NetRenderService::GetEdition() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetEdition))();
}
...
String NetRenderService::GetName() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetName))();
}
...
Bool NetRenderService::IsRunning() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->IsRunning))();
}
...
Int32 NetRenderService::GetCpuCount() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetCpuCount))();
}
...
void NetRenderService::GetAllMachineUuids(maxon::BaseArray<C4DUuid>& machineUuids, MACHINELIST list, VERIFICATIONBIT bits, Bool includeLocalMachine, Bool includeZeroConfMachines)
{
	...
	(static_cast<NetRenderService*>(this)->*(lib->GetAllMachineUuids))(machineUuids, list, bits, includeLocalMachine, includeZeroConfMachines);
}
...
UserPool& NetRenderService::GetUserPool()
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->GetUserPool))();
}
...
Bool NetRenderService::GetJobsList(const BaseContainer& settings, maxon::BaseArray<BaseContainer>& jobs, Bool triggerWatchDog, DETAILSELECTOR rdata, DETAILSELECTOR assets, DETAILSELECTOR results, DETAILSELECTOR log, const C4DUuid* getOnlyThisJob, Bool selectedJobOnly, const C4DUuid* user)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->GetJobsList2))(settings, jobs, triggerWatchDog, rdata, assets, results, log, getOnlyThisJob, selectedJobOnly, user);
}
...
Bool NetRenderService::GetMachinesList(maxon::BaseArray<BaseContainer>& machines, Int32 logCount, const C4DUuid* getOnlyThisMachine) const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetMachinesList))(machines, logCount, getOnlyThisMachine);
}
...
Bool NetRenderService::InsertJobBefore(const C4DUuid& jobUuid1, const C4DUuid& jobUuid2)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->InsertJobBefore))(jobUuid1, jobUuid2);
}
...
Bool NetRenderService::SetDefaultSceneName(const C4DUuid& jobUuid, const Filename& defaultSceneName)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->SetDefaultSceneName))(jobUuid, defaultSceneName);
}
...
Bool NetRenderService::InsertJobAfter(const C4DUuid& jobUuid1, const C4DUuid& jobUuid2)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->InsertJobAfter))(jobUuid1, jobUuid2);
}
...
RenderJob* NetRenderService::FindRenderJob(const C4DUuid& jobUuid, Bool lookInServerList) const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->FindRenderJob))(jobUuid, lookInServerList);
}
...
MachineGroup* NetRenderService::GetMachineHead() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetMachineHead))();
}
...
Machine* NetRenderService::GetFirstMachine() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetFirstMachine))();
}
...
Machine* NetRenderService::FindMachine(const C4DUuid& uid, MACHINELIST list, VERIFICATIONBIT bits) const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->FindMachine))(uid, list, bits);
}

maxon::RWSpinlock& NetRenderService::GetMachineLock()
{
	NetLibrary *lib = CheckNetRenderLib(LIBOFFSET(NetLibrary, GetMachineLock));
	return (static_cast<NetRenderService*>(this)->*(lib->GetMachineLock))();
}
...
const C4DUuid NetRenderService::GetUuid() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetUuid2))();
}
...
void NetRenderService::StopRendering(THREADMODE mode, const C4DUuid& jobUuid, RENDERRESULT result)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->StopRendering))(mode, jobUuid, result);
}
...
void NetRenderService::GetMacAddress(maxon::BaseArray<UChar>& macAddress) const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetMacAddress2))(macAddress);
}
...
void NetRenderService::GetGlobalSelectedMachines(maxon::BaseArray<C4DUuid>& machines, Bool& atLeastOneMachineOnline)
{
	...
	(static_cast<NetRenderService*>(this)->*(lib->GetGlobalSelectedMachines))(machines, atLeastOneMachineOnline);
}
...
void NetRenderService::CopyClientTasksFrom(maxon::BaseArray<C4DUuid>& jobUuids, maxon::BaseArray<Task>& tasks)
{
	...
	(static_cast<NetRenderService*>(this)->*(lib->CopyClientTasksFrom))(jobUuids, tasks);
}
...
Repository& NetRenderService::GetRepository()
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->GetRepository))();
}
...
Bool NetRenderService::GetGlobalSelected(maxon::BaseArray<C4DUuid>& machines)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->GetGlobalSelected2))(machines);
}
...
CREATEJOBRESULT NetRenderService::CreateRenderJob(const String& docName, C4DUuid& jobUuid, RENDERJOBCREATOR creator, const String& username, BaseThread* bt, const Filename* watchFolderName)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->CreateRenderJob))(docName, jobUuid, creator, username, bt, watchFolderName);
}
...
RENDERRESULT NetRenderService::StartRendering(THREADMODE mode, BaseDocument* doc, const C4DUuid& jobUuid, BaseThread* bt)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->StartRendering))(mode, doc, jobUuid, bt);
}
...
Bool NetRenderService::ClearResults(const C4DUuid& jobUuid)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->ClearResults))(jobUuid);
}
...
Bool NetRenderService::RemoveResult(const C4DUuid& jobUuid, const Filename& resResultPath)
{
	...
	if (!lib || !lib->ClearResults) return false;
	return (static_cast<NetRenderService*>(this)->*(lib->RemoveResult))(jobUuid, resResultPath);
}
...
Bool NetRenderService::Message(const C4DUuid& remoteUuid, const NetworkIpAddrPort* remoteAddr, Bool isPrivate, const BaseContainer& msg, BaseContainer& result)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->Message))(remoteUuid, remoteAddr, isPrivate, msg, result);
}
...
RENDERRESULT NetRenderService::InitRendering(BaseDocument* doc, const BaseContainer& rdata, const C4DUuid& jobUuid, NETRENDERFLAGS flags, PictureViewer* pv, const BaseContainer& machines, MultipassBitmap* bmp, ProgressHook* prog, WriteProgressHook* wprog, void* context, Bool* useFrameNumberAsSuffix, Filename* dispname, const maxon::BaseArray<Bool>* renderTasks)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->InitRendering))(doc, rdata, jobUuid, flags, pv, machines, bmp, prog, wprog, context, useFrameNumberAsSuffix, dispname, renderTasks);
}
...
Bool NetRenderService::VerifyServerOnClient(THREADMODE mode, const C4DUuid& machineUuid, const String& securityToken, Bool setClientAsGlobalSelected, Bool doLock, Int32 waitUntilExecutionInMs)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->VerifyServerOnClient))(mode, machineUuid, securityToken, setClientAsGlobalSelected, doLock, waitUntilExecutionInMs);
}
...
Bool NetRenderService::InitAndStartRenderingFullAsync(const C4DUuid& jobUuid)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->InitAndStartRenderingFullAsync))(jobUuid);
}
...
Bool NetRenderService::DeleteRenderJob(const C4DUuid& jobUuid, Bool informClients)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->DeleteRenderJob))(jobUuid, informClients);
}
...
void NetRenderService::NetConsoleOutput(maxon::OUTPUT flags, const maxon::String& value, maxon::OUTPUTLOCATION output, const maxon::SourceLocation& loc)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->NetConsoleOutput))(flags, value, output, loc);
}
...
String NetRenderService::GetCurrentJobCommandAsString() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetCurrentJobCommandAsString))();
}
...
RenderJob* NetRenderService::GetActive() const
{
	...
	return (static_cast<const NetRenderService*>(this)->*(lib->GetActive))();
}
...
maxon::RWSpinlock& NetRenderService::GetClientRenderJobLock()
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->GetClientRenderJobLock))();
}
...
Bool NetRenderService::AddMachine(const String& address, const String& securityToken, Bool allowGui, const C4DUuid* uuidOfMachineToOverwrite)
{
	...
	return (static_cast<NetRenderService*>(this)->*(lib->AddMachine2))(address, securityToken, allowGui, uuidOfMachineToOverwrite);
}
...
const C4DUuid Machine::GetUuid() const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetUuid))();
}
...
EDITION Machine::GetEdition() const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetEdition2))();
}
...
Bool Machine::GetGlobalSelected() const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetGlobalSelected))();
}
...
void Machine::SetGlobalSelected(Bool globalSelected)
{
	...
	(static_cast<Machine*>(this)->*(lib->SetGlobalSelected))(globalSelected);
}
...
String Machine::GetFullyQualifiedDomainName(Bool* isPrivate) const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetFullyQualifiedDomainName))(isPrivate);
}
...
void Machine::ClearVerificationBit(VERIFICATIONBIT state)
{
	...
	return (static_cast<Machine*>(this)->*(lib->ClearVerificationBit))(state);
}
...
Bool Machine::GetVerificationBit(VERIFICATIONBIT state) const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetVerificationBit))(state);
}
...
void Machine::SetVerificationBit(VERIFICATIONBIT state)
{
	...
	return (static_cast<Machine*>(this)->*(lib->SetVerificationBit))(state);
}
...
void Machine::SetUuid(const C4DUuid& uid)
{
	...
	(static_cast<Machine*>(this)->*(lib->SetUuid))(uid);
}
...
void Machine::SetMacAddress(const maxon::BaseArray<UChar>& macAddress)
{
	...
	(static_cast<Machine*>(this)->*(lib->SetMacAddress))(macAddress);
}
...
void Machine::GetMacAddress(maxon::BaseArray<UChar>& macAddress) const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetMacAddress))(macAddress);
}
...
Vector Machine::GetColor(const Vector* bgColor) const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetColor))(bgColor);
}
...
void Machine::SetColor(const Vector& color)
{
	...
	(static_cast<Machine*>(this)->*(lib->SetColor))(color);
}
...
void Machine::FoundViaZeroConf(Bool foundViaZeroConf)
{
	...
	(static_cast<Machine*>(this)->*(lib->FoundViaZeroConf))(foundViaZeroConf);
}
...
Bool Machine::FoundViaZeroConf() const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->FoundViaZeroConf2))();
}
...
OPERATINGSYSTEM Machine::GetOperatingSystem()
{
	...
	return (static_cast<Machine*>(this)->*(lib->GetOperatingSystem))();
}
...
void Machine::SetOperatingSystem(OPERATINGSYSTEM operatingSystem)
{
	...
	(static_cast<Machine*>(this)->*(lib->SetOperatingSystem))(operatingSystem);
}
...
const BaseContainer& Machine::GetMachineFeatures() const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetMachineFeatures))();
}
...
void Machine::SetMachineFeatures(const BaseContainer& t_bc)
{
	...
	(static_cast<Machine*>(this)->*(lib->SetMachineFeatures))(t_bc);
}
...
JOBCOMMAND Machine::GetCurrentJobCommand(C4DUuid* rendersFor) const
{
	...
	return (static_cast<const Machine*>(this)->*(lib->GetCurrentJobCommand))(rendersFor);
}
...
Filename Repository::GetRepositoryPath() const
{
	...
	return (static_cast<const Repository*>(this)->*(lib->GetRepositoryPath))();
}
...
Filename Repository::GetJobsPath(Bool server) const
{
	...
	return (static_cast<const Repository*>(this)->*(lib->GetJobsPath))(server);
}
...
void Repository::SetRepositoryPath(const Filename& repositoryPath)
{
	...
	return (static_cast<Repository*>(this)->*(lib->SetRepositoryPath))(repositoryPath);
}
...
Filename Repository::ConvertRelative2Absolute(RenderJob* job, Asset* asset) const
{
	...
	return (static_cast<const Repository*>(this)->*(lib->ConvertRelative2Absolute))(job, asset);
}
...
Bool Repository::ConvertAbsolute2RelativePath(const Filename &absolutePath, RelativeFilename &relativePath, Bool server) const
{
	...
	return (static_cast<const Repository*>(this)->*(lib->ConvertAbsolute2RelativePath))(absolutePath, relativePath, server);
}
...
Asset* RenderJob::GetFirstAsset() const
{
	...
	return (static_cast<const RenderJob*>(this)->*(lib->GetFirstAsset))();
}
...
Bool UserPool::AddUser(const String& username, const String& password, const String& description, Bool isAdmin)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->AddUser))(username, password, description, isAdmin);
}
...
Bool UserPool::DeleteUser(const C4DUuid& userUuid)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->DeleteUser))(userUuid);
}
...
Bool UserPool::ChangePassword(const C4DUuid& userUuid, const String& oldPassword, const String& newPassword)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->ChangePassword))(userUuid, oldPassword, newPassword);
}
...
Bool UserPool::ChangeDefaultLanguage(const C4DUuid& userUuid, const String& defaultLanguage)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->ChangeDefaultLanguage))(userUuid, defaultLanguage);
}
...
Bool UserPool::CheckUserCredentials(const String& username, const String& password) const
{
	...
	return (static_cast<const UserPool*>(this)->*(lib->CheckUserCredentials))(username, password);
}
...
void UserPool::GetUsers(maxon::BaseArray<User*>& users) const
{
	...
	return (static_cast<const UserPool*>(this)->*(lib->GetUsers))(users);
}
...
Bool UserPool::ChangeUserAccountType(const C4DUuid& userUuid, const Bool isAdmin)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->ChangeUserAccountType))(userUuid, isAdmin);
}
...
Bool UserPool::ChangeUserInfo(const C4DUuid& userUuid, const String& description)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->ChangeUserInfo))(userUuid, description);
}
...
Bool UserPool::ChangeUserPassword(const C4DUuid& userUuid, const String& password)
{
	...
	return (static_cast<UserPool*>(this)->*(lib->ChangeUserPassword))(userUuid, password);
}
C4DUuid User::GetUuid() const
{
	...
	return (reinterpret_cast<const iUser*>(this)->*(lib->GetUserUuid))();
}
...
String User::GetUsername() const
{
	...
	return (reinterpret_cast<const iUser*>(this)->*(lib->GetUserUsername))();
}
...
String User::GetDescription() const
{
	...
	return (reinterpret_cast<const iUser*>(this)->*(lib->GetUserDescription))();
}
...
Bool User::IsAdmin() const
{
	...
	return (reinterpret_cast<const iUser*>(this)->*(lib->IsUserAdmin))();
}
...
String User::GetDefaultLanguage() const
{
	...
	return (reinterpret_cast<const iUser*>(this)->*(lib->GetUserDefaultLanguage))();
}
...
String NetRenderData::GetName() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetName2))();
}
...
Bool NetRenderData::IsSingleFrameRendering() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->IsSingleFrameRendering))();
}
...
Int32 NetRenderData::GetRealFps() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetRealFps))();
}
...
Float NetRenderData::GetFps() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetFps))();
}
...
BaseTime NetRenderData::GetFrameFrom() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetFrameFrom))();
}
...
BaseTime NetRenderData::GetFrameTo() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetFrameTo))();
}
...
BaseContainer& NetRenderData::GetData()
{
	...
	if (!lib || !lib->GetData2)
		DebugStop();
	return (static_cast<NetRenderData*>(this)->*(lib->GetData2))();
}
...
const BaseContainer& NetRenderData::GetData() const
{
	...
	if (!lib || !lib->GetData3)
		DebugStop();
	return (static_cast<const NetRenderData*>(this)->*(lib->GetData3))();
}
...
Int32 NetRenderData::GetWidth() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetWidth))();
}
...
Int32  NetRenderData::GetHeight() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetHeight))();
}
...
Int32 NetRenderData::GetFrameRange() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetFrameRange))();
}
...
Int32 NetRenderData::GetNameFormat() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetNameFormat))();
}
...
Int32 NetRenderData::GetFrameStep() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetFrameStep))();
}
...
Bool NetRenderData::UseFrameNumberAsSuffix() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->UseFrameNumberAsSuffix))();
}
...
Bool NetRenderData::ShowHud() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->ShowHud))();
}
...
Bool NetRenderData::SaveImage() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->SaveImage))();
}
...
Int32 NetRenderData::GetImageFormat() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetImageFormat))();
}
...
Filename NetRenderData::GetImageFilename() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetImageFilename))();
}
...
Filename NetRenderData::GetImageAbsResultFolder() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetImageAbsResultFolder))();
}
...
Bool NetRenderData::GetImageFormatIsMovie() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetImageFormatIsMovie))();
}
...
Bool NetRenderData::SaveMultipass() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->SaveMultipass))();
}
...
Int32 NetRenderData::GetMultipassImageFormat() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetMultipassImageFormat))();
}
...
Filename NetRenderData::GetMultipassFilename() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetMultipassFilename))();
}
...
Filename NetRenderData::GetMultipassAbsResultFolder() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetMultipassAbsResultFolder))();
}
...
Bool NetRenderData::GetMultipassFormatIsMovie() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetMultipassFormatIsMovie))();
}
...
Int32 NetRenderData::GetRealImageBitDepth() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetRealImageBitDepth))();
}
...
Int32 NetRenderData::GetRealMultipassBitDepth() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetRealMultipassBitDepth))();
}
...
Bool NetRenderData::GetMultipassSaveMultilayer() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetMultipassSaveMultilayer))();
}
...
Bool NetRenderData::ShowTextureError() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->ShowTextureError))();
}
...
NETRENDERFLAGS NetRenderData::GetFlags() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetFlags))();
}
...
Filename NetRenderData::GetB3dTempFolder() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetB3dTempFolder))();
}
...
Filename NetRenderData::GetOriginDocumentDirectoryPath() const
{
	...
	return (static_cast<const NetRenderData*>(this)->*(lib->GetOriginDocumentDirectoryPath))();
}
