...
#define CallCustomDataTypePlugin(plug, fnc)		(static_cast<CustomDataTypeClass*>((((CUSTOMDATATYPEPLUGIN*)plug->GetPluginStructure())->adr))->*((CUSTOMDATATYPEPLUGIN*)plug->GetPluginStructure())->fnc)
#define CallResourceDataTypePlugin(plug, fnc)	(static_cast<ResourceDataTypeClass*>((((RESOURCEDATATYPEPLUGIN*)plug->GetPluginStructure())->adr))->*((RESOURCEDATATYPEPLUGIN*)plug->GetPluginStructure())->fnc)

#define CallCustomDataType(plug, fnc)		(static_cast<CustomDataTypeClass*>((plug->adr))->*plug->fnc)
#define CallResourceDataType(plug, fnc)	(static_cast<ResourceDataTypeClass*>((plug->adr))->*plug->fnc)
