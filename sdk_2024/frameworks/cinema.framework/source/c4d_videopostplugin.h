...
struct VIDEOPOSTPLUGIN : public NODEPLUGIN
{
	...
	Bool					(VideoPostData::*GlDraw												)(BaseVideoPost *node, BaseDraw *bd, GlFrameBuffer* fbuf, Int32 colortex, Int32 depthtex, UInt32 flags);
	...
	UInt32				(VideoPostData::*GetGlInfo										)(BaseVideoPost *node, BaseDocument* doc, BaseDraw *bd);
