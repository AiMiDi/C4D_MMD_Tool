...
public:
	...
	//----------------------------------------------------------------------------------------
	Bool IsQuaternionRotationMode() { return BoCall(IsQuaternionRotationMode) (); }
	...
	//----------------------------------------------------------------------------------------
	UInt64 GetGUID() { return C4DOS_Bo->GetGUID(this); }
	...
	/// @markPrivate
	//----------------------------------------------------------------------------------------
	void GetDrawStateData(void* state) const { BoCall(GetDrawStateData)(state); }
	/// @}
