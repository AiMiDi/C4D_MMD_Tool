...
//----------------------------------------------------------------------------------------
class MatAssignData : public CustomDataTypeT<CUSTOMDATATYPE_MATASSIGN>
{
private:
	MatAssignData();
	~MatAssignData();
...
// INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF
	...
	class CINEWARE_SINGLEINHERITANCE iMatAssignData {};
	class CINEWARE_SINGLEINHERITANCE iMatAssignTable {};
#else
...
struct CustomGuiMatAssignLib : public BaseCustomGuiLib
{
	...
	Int32						(iMatAssignData::*GetObjectCount)() const;
