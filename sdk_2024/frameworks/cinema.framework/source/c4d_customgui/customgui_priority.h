...
//----------------------------------------------------------------------------------------
class PriorityData : public CustomDataTypeT<CUSTOMGUI_PRIORITY_DATA>
{
private:
	PriorityData();
	~PriorityData();
...
// INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF -- INTERNAL STUFF
	...
	class CINEWARE_SINGLEINHERITANCE iPriorityCustomGui : public iBaseCustomGui
	{
		iPriorityCustomGui(const BaseContainer &settings, CUSTOMGUIPLUGIN *plugin) : iBaseCustomGui(settings, plugin) { }
	};
	class CINEWARE_SINGLEINHERITANCE iPriorityData {};
#else
