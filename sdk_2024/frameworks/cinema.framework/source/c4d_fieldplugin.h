...
public:
	...
	//----------------------------------------------------------------------------------------
	virtual maxon::Result<maxon::GenericData> InitSampling(const FieldObject& op, const FieldInfo& info) const { return {}; }
	...
	//----------------------------------------------------------------------------------------
	virtual FIELDOBJECT_FLAG GetFieldFlags(const FieldObject& op, const BaseDocument* doc) const { return FIELDOBJECT_FLAG::NONE; }
};
...
public:
	...
	/// @return												OK on success, error will cancel sampling.
	//----------------------------------------------------------------------------------------
	virtual maxon::Result<maxon::Tuple<maxon::GenericData, Int32>> InitSampling(const FieldLayer& layer, const FieldInfo& info) const { return {}; }
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	virtual maxon::Result<void> Aggregate(const FieldLayer& layer, const FieldInput& inputs, const FieldOutputBlock& outputs, const FieldInfo& info, const maxon::GenericData& extraData) const { return maxon::OK; }
	...
	//----------------------------------------------------------------------------------------
	virtual FieldLayerLink GetLinkedObject(const FieldLayer& layer, const BaseDocument* doc) const { return FieldLayerLink(); }
	...
	virtual maxon::Result<Bool> GetAccessedObjectsForSampling(const FieldLayer& layer, const BaseList2D* caller, AccessedObjectsCallback& access) const;
};
...
struct FIELDPLUGIN : public OBJECTPLUGIN
{
	...
	maxon::Result<maxon::GenericData>	(FieldData::*InitSampling				 )(const FieldObject& op, const FieldInfo& info) const;
	void								(FieldData::*FreeSampling				 )(const FieldObject& op, const FieldInfo& info, maxon::GenericData& extraData) const;
	maxon::Result<void>	(FieldData::*Sample							 )(const FieldObject& op, const FieldInput& inputs, FieldOutputBlock& outputs, const FieldInfo& info, const maxon::GenericData& extraData) const;
	FIELDOBJECT_FLAG		(FieldData::*GetFieldFlags			 )(const FieldObject& op, const BaseDocument* doc) const;
...
struct FIELDLAYERPLUGIN : public NODEPLUGIN
{
	...
	maxon::Result<maxon::Tuple<maxon::GenericData, Int32>>	(FieldLayerData::*InitSampling			)(const FieldLayer& layer, const FieldInfo& info) const;
	maxon::Result<void>	(FieldLayerData::*Sample						)(const FieldLayer& layer, const FieldInput& inputs, FieldOutputBlock& outputs, const FieldInfo& info, const maxon::GenericData& extraData) const;
	maxon::Result<void>	(FieldLayerData::*Aggregate					)(const FieldLayer& layer, const FieldInput& inputs, const FieldOutputBlock& outputs, const FieldInfo& info, const maxon::GenericData& extraData) const;
	void								(FieldLayerData::*FreeSampling			)(const FieldLayer& layer, const FieldInfo& info, maxon::GenericData& extraData) const;
	Bool								(FieldLayerData::*IsEqual						)(const FieldLayer& layer, const FieldLayerData& comp) const;
	FieldLayerLink			(FieldLayerData::*GetLinkedObject		)(const FieldLayer& layer, const BaseDocument* doc) const;
	Bool								(FieldLayerData::*SetLinkedObject		)(FieldLayer& layer, const FieldLayerLink& link);
	void								(FieldLayerData::*CheckDirty				)(FieldLayer& layer, const BaseDocument* doc);
	maxon::Result<Bool>	(FieldLayerData::*GetAccessedObjectsForSampling)(const FieldLayer& layer, const BaseList2D* caller, AccessedObjectsCallback& access) const;
