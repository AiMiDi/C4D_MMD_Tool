...
namespace enum88
{
	...
	static const maxon::UInt64 TOOLTRANSFORM_FLAG_values[] = {maxon::UInt64(enum88::TOOLTRANSFORM_FLAG::NO_TRANSFORM), maxon::UInt64(enum88::TOOLTRANSFORM_FLAG::NO_RECURSE), maxon::UInt64(enum88::TOOLTRANSFORM_FLAG::NO_PARAMS), maxon::UInt64(enum88::TOOLTRANSFORM_FLAG::NONE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_TOOLTRANSFORM_FLAG88(){ return enum88::TOOLTRANSFORM_FLAG_info; }
namespace enum121
{
	...
	static const maxon::UInt64 MODIFIER_FLAG_values[] = {maxon::UInt64(enum121::MODIFIER_FLAG::NO_NORMAL_DEFORMATION), maxon::UInt64(enum121::MODIFIER_FLAG::NONE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MODIFIER_FLAG121(){ return enum121::MODIFIER_FLAG_info; }
namespace enum910
{
	...
	static const maxon::UInt64 MULTILINEEDITTEXTMESSAGEFLAGS_values[] = {maxon::UInt64(enum910::MULTILINEEDITTEXTMESSAGEFLAGS::NONE), maxon::UInt64(enum910::MULTILINEEDITTEXTMESSAGEFLAGS::SET)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MULTILINEEDITTEXTMESSAGEFLAGS910(){ return enum910::MULTILINEEDITTEXTMESSAGEFLAGS_info; }
namespace enum1148
{
	...
	static const maxon::UInt64 MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT_values[] = {maxon::UInt64(enum1148::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::CANCEL), maxon::UInt64(enum1148::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::MERGE), maxon::UInt64(enum1148::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::NEWSCENE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT1148(){ return enum1148::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT_info; }
