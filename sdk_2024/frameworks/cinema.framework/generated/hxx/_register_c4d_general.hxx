...
namespace enum1584
{
	...
	static const maxon::UInt64 MACHINEFEATURESTYPE_values[] = {maxon::UInt64(enum1584::MACHINEFEATURESTYPE::CURRENT), maxon::UInt64(enum1584::MACHINEFEATURESTYPE::HARDWARE_OGL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MACHINEFEATURESTYPE1584(){ return enum1584::MACHINEFEATURESTYPE_info; }
#ifdef CINEWARE_NAMESPACE_ENABLE
