...
#define PRIVATE_MAXON_MICRONODE_METHOD(name, N, ...) \
	...
	private: \
		...
		{ \
			static_assert(std::is_const<PORTS>::value || !PORTS::ExpectConst, "The parameter of the Process method needs to be const."); \
			static_assert(!std::is_const<PORTS>::value || PORTS::ExpectConst, "The parameter of the Process method needs to be non-const."); \
...
public:
	...
	static const WIRETYPE IS_SOURCE_OF = WIRETYPE::DOMAIN_FLOW_PURE_VALUE_SEQUENCED_LIFETIME | WIRETYPE::ALIAS;
...
public:
	static const WIRETYPE IS_TARGET_OF = WIRETYPE::DOMAIN_FLOW_SEQUENCED | WIRETYPE::PORT | WIRETYPE::LIFETIME | WIRETYPE::SUBTRACTIVE_DOMAIN | WIRETYPE::ELEMENT_DOMAIN | WIRETYPE::MATCH_DOMAIN | WIRETYPE::FIX_DOMAIN;
	static const WIRETYPE IS_SOURCE_OF = WIRETYPE::DOMAIN_FLOW_SEQUENCED | WIRETYPE::PORT | WIRETYPE::MATCH_DOMAIN | WIRETYPE::FIX_DOMAIN;
