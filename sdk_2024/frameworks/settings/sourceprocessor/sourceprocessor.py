...
FUNCVAR_QUALIFIER_PREFIXES = {
    'constexpr', 'inline', 'static', 'virtual', 'extern', 'thread_local', 'explicit', 'friend', 'MAXON_IMPLICIT', 
    'MAXON_WARN_UNUSED', '__declspec', '@property', 'IBOutlet', 'MAXON_ATTRIBUTE_FORCE_INLINE', 
        ...
        if t == 'class' or t == 'struct' or t == 'union' or t == '@class' or t == '@protocol' or t == '@interface' or t == 'interface':
            ...
            if anonymous:
                ...
                if name == 'MAXON_WARN_UNUSED_CLASS':
                    name = self.lex.get(owner)                  
                if name == 'CINEMA4DC_SINGLEINHERITANCE' or name == 'CINEWARE_SINGLEINHERITANCE': # For the C4D classic API the PTMF on Windows must only take 8 bytes.
                    name = self.lex.get(owner)
