...
#include "_include_polygroup_tag.hxx"
...
#include "_reflection_polygroup_tag.hxx"
...
#include "_register_polygroup_tag.hxx"
#include "_register_voxelization.hxx"

static const maxon::LiteralId g_usedFrameworks[] = {maxon::LiteralId("net.maxon.core.framework"), maxon::LiteralId("net.maxon.modeling_geom.framework")};
