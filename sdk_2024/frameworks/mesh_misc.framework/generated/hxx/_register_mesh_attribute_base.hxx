...
namespace maxon
{
	const maxon::Char* const CustomDataTagDisplayInterface::MTable::_ids = 
		...
		"DisplayControl@339dcf79d68e89c8\0" // Result<void> DisplayControl(const BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const
