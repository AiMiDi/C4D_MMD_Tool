...
public:
	...
	ComponentAccessType(ComponentAccessType&& src) : MAXON_MOVE_MEMBERS(_portType, _nodeId, _accessNodeResultId, _meta, _accessIo, _invokeFunc)
	{}
	...
	{
		iferr_scope;
		MAXON_COPYFROM_MEMBERS(_portType, _nodeId, _accessNodeResultId, _meta, _accessIo, _invokeFunc);
		return OK;
	}
	...
	DataDictionary _meta;						/// Future use (custom attributes).
...
//----------------------------------------------------------------------------------------
/// This attribute is set in a component access' definition meta data to enable use of nested access ports.
/// For instance to enable showing decomposed X Y Z ports under a matrix's translation access port. 
//----------------------------------------------------------------------------------------
