...
{
public:
	DataDictionaryIterator() : _hasIterator(false), _pair(DefaultValue<const Data&>(), DefaultValue<const Data&>())
	{
	}
	...
	//----------------------------------------------------------------------------------------
	template <typename T> Result<typename std::conditional<STD_IS_REPLACEMENT(void, T), void, typename ByValueParam<T>::type>::type> Get() const
	{
