...
//----------------------------------------------------------------------------------------
#define MAXON_API_ABI_VERSION 2023904

//----------------------------------------------------------------------------------------
/// The core framework version is increased with every major application version.
//----------------------------------------------------------------------------------------
#define MAXON_CORE_FRAMEWORK_VERSION 2024000

// Disable exceptions for vcruntime.h before including anything
#ifdef MAXON_TARGET_WINDOWS

	// TODO: (Sven) move to props
...
inline const String& operator "" _s(const char* str, std::size_t cnt)
{
	...
	return StringInterface_GetAndCacheConstString(str, Int(cnt), -1);
}
...
{
	return StringInterface_GetAndCacheConstString(str, Int(cnt));
}
...
template <typename T> inline T DefaultValue();
...
public:
	...
	// Adding constructors would furthermore break binary compatiblity.
	// Do not add a constructor to this class and do not use default member initialization!
