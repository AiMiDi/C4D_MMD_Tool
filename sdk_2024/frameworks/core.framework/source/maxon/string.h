...
#undef CONSTSTRING
#define CONSTSTRING(x) (maxon::StringInterface::GetAndCacheConstString((const maxon::Char*) (PRIVATE_MAXON_AS_UTF8("") PRIVATE_MAXON_AS_UTF8(x)), SIZEOF(PRIVATE_MAXON_AS_UTF8(x)) - 1, MAXON_CONSTEXPR_EVAL(maxon::Bool, maxon::PrivateIsUtf8(PRIVATE_MAXON_AS_UTF8(x), SIZEOF(PRIVATE_MAXON_AS_UTF8(x))))))
