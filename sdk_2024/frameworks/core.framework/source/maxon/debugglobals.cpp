...
{
	if (StringInterface::_interface.IsInitialized())
	{
		iferr_scope_handler
		{
			err.DbgStop();
		...
		BaseArray<Char> buf = str.GetCString() iferr_return;
