...
private:
	...
	// Runs single threaded finalizers when requested.
	template <typename WORKER, Bool SINGLETHREADED> class SingleThreadedFinalize
	{
	public:
	...
	template <typename WORKER> class SingleThreadedFinalize<WORKER, false>
	{
	public:
