...
Result<void> AddConversionTestSetting(MAXON_SOURCE_LOCATION_DECLARATION, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Char>& srcData, const Block<const Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(MAXON_SOURCE_LOCATION_FORWARD, resultArray, set, srcData, compareData, forbidLargeTest);
}

Result<void> AddConversionTestSetting(MAXON_SOURCE_LOCATION_DECLARATION, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Utf32Char>& srcData, const Block<const Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(MAXON_SOURCE_LOCATION_FORWARD, resultArray, set, srcData, compareData, forbidLargeTest);
}

Result<void> AddConversionTestSetting(MAXON_SOURCE_LOCATION_DECLARATION, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Char>& srcData, const Block<const Utf32Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(MAXON_SOURCE_LOCATION_FORWARD, resultArray, set, srcData, compareData, forbidLargeTest);
}

Result<void> AddConversionTestSetting(MAXON_SOURCE_LOCATION_DECLARATION, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Utf32Char>& srcData, const Block<const Utf32Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(MAXON_SOURCE_LOCATION_FORWARD, resultArray, set, srcData, compareData, forbidLargeTest);
}
