...
#pragma warning disable 597
	...
	operator SetInterface<typename std::conditional<STD_IS_REPLACEMENT(same, TYPE, Generic), DeleteReturnType02, Generic>::type>&()
	{
...
#pragma warning enable 597
	...
	operator const NonConstSet<typename std::conditional<STD_IS_REPLACEMENT(same, TYPE, Generic), DeleteReturnType03, Generic>::type>&()
	{
		return *reinterpret_cast<const NonConstSet<typename std::conditional<STD_IS_REPLACEMENT(same, TYPE, Generic), DeleteReturnType03, Generic>::type>*>(this);
	}
...
public:
	...
	operator const NonConstSet<typename std::conditional<STD_IS_REPLACEMENT(same, TYPE, Generic), DeleteReturnType01, Generic>::type>&() const
	{
		return *reinterpret_cast<const NonConstSet<typename std::conditional<STD_IS_REPLACEMENT(same, TYPE, Generic), DeleteReturnType01, Generic>::type>*>(this);
	}
...
template <typename SET> MAXON_IMPLEMENTATION_SIMPLE_REGISTER(SetImpl<SET>);
