...
namespace maxon
{
	namespace enum74
	{
		...
		static const maxon::UInt64 CONVERSION_FLAGS_values[] = {maxon::UInt64(enum74::CONVERSION_FLAGS::NONE), maxon::UInt64(enum74::CONVERSION_FLAGS::NARROWING), maxon::UInt64(enum74::CONVERSION_FLAGS::WIDENING_LOSSY), maxon::UInt64(enum74::CONVERSION_FLAGS::WIDENING_LOSSLESS), maxon::UInt64(enum74::CONVERSION_FLAGS::REDUCING), maxon::UInt64(enum74::CONVERSION_FLAGS::EXPANDING), maxon::UInt64(enum74::CONVERSION_FLAGS::STRUCT_CAST), maxon::UInt64(enum74::CONVERSION_FLAGS::ITERATION), maxon::UInt64(enum74::CONVERSION_FLAGS::INCONVERTIBLE), maxon::UInt64(enum74::CONVERSION_FLAGS::WIDENING_MASK), maxon::UInt64(enum74::CONVERSION_FLAGS::NARROWING_REDUCING_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CONVERSION_FLAGS74(){ return enum74::CONVERSION_FLAGS_info; }
	...
	namespace enum601
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum601::FLAGS::NONE), maxon::UInt64(enum601::FLAGS::GLOBALLY_REFERENCED), maxon::UInt64(enum601::FLAGS::OWNS_DEFAULT_VALUE)};
		static const maxon::EnumInfo FLAGS_info{"DataTypeImpl::FLAGS", SIZEOF(FLAGS), true, "NONE\0GLOBALLY_REFERENCED\0OWNS_DEFAULT_VALUE\0", FLAGS_values, std::extent<decltype(FLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_FLAGS601(void*){ return enum601::FLAGS_info; }
	...
	namespace enum1074
	{
		...
		static const maxon::UInt64 BASE_OF_MODE_values[] = {maxon::UInt64(enum1074::BASE_OF_MODE::NONE), maxon::UInt64(enum1074::BASE_OF_MODE::ORDERED_TYPE_ONLY), maxon::UInt64(enum1074::BASE_OF_MODE::UNORDERED_BY_NAME), maxon::UInt64(enum1074::BASE_OF_MODE::GENERIC_DOWNCAST)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_BASE_OF_MODE1074(void*){ return enum1074::BASE_OF_MODE_info; }
	...
	namespace enum1179
	{
		...
		static const maxon::UInt64 GET_DATATYPE_POLICY_values[] = {maxon::UInt64(enum1179::GET_DATATYPE_POLICY::NONE), maxon::UInt64(enum1179::GET_DATATYPE_POLICY::GENERIC_FOR_UNKNOWN), maxon::UInt64(enum1179::GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN), maxon::UInt64(enum1179::GET_DATATYPE_POLICY::RESULT_FOR_UNKNOWN_MASK)};
		static const maxon::EnumInfo GET_DATATYPE_POLICY_info{"GET_DATATYPE_POLICY", SIZEOF(GET_DATATYPE_POLICY), true, "NONE\0GENERIC_FOR_UNKNOWN\0ERROR_FOR_UNKNOWN\0RESULT_FOR_UNKNOWN_MASK\0", GET_DATATYPE_POLICY_values, std::extent<decltype(GET_DATATYPE_POLICY_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_GET_DATATYPE_POLICY1179(){ return enum1179::GET_DATATYPE_POLICY_info; }
}
#endif
