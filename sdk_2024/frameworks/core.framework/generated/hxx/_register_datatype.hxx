...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UnregisteredDataTypeErrorInterface, , "net.maxon.interface.unregistereddatatypeerror", (ErrorInterface::PrivateGetInterface()));
