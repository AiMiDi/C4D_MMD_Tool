...
namespace maxon
{
	...
	const maxon::UNRESOLVED_RETURN_TYPE CrashReportServices::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<Int32>::value,
	...
	MAXON_INTERFACE_REGISTER(CrashReportServices, "net.maxon.interface.crashreportservices", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
