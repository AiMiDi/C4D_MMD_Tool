...
namespace maxon
{
	namespace enum21
	{
		...
		static const maxon::UInt64 BASEARRAYFLAGS_values[] = {maxon::UInt64(enum21::BASEARRAYFLAGS::NONE), maxon::UInt64(enum21::BASEARRAYFLAGS::MOVEANDCOPYOBJECTS), maxon::UInt64(enum21::BASEARRAYFLAGS::ZEROINITIALIZE)};
		static const maxon::EnumInfo BASEARRAYFLAGS_info{"BASEARRAYFLAGS", SIZEOF(BASEARRAYFLAGS), true, "NONE\0MOVEANDCOPYOBJECTS\0ZEROINITIALIZE\0", BASEARRAYFLAGS_values, std::extent<decltype(BASEARRAYFLAGS_values)>::value};
	}
