...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ValueChangedCallbackInterface, , "net.maxon.interface.valuechangedcallback", (ObjectInterface::PrivateGetInterface()));
}
#ifdef __API_INTERN__
#endif
#endif
