...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDictionaryObjectInterface, maxon::StrongRefHandler, DataDictionaryObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDictionaryObjectInterface, maxon::StrongRefHandler, DataDictionaryObjectRef>>>>);
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDictionaryReferenceObjectInterface, maxon::StrongRefHandler, DataDictionaryReferenceObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDictionaryReferenceObjectInterface, maxon::StrongRefHandler, DataDictionaryReferenceObjectRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
