...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(OutOfMemoryErrorInterface, , "net.maxon.interface.outofmemoryerror", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FunctionNotImplementedErrorInterface, , "net.maxon.interface.functionnotimplementederror", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(IllegalArgumentErrorInterface, , "net.maxon.interface.illegalargumenterror", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(NullptrErrorInterface, , "net.maxon.interface.nullptrerror", (IllegalArgumentErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(IllegalStateErrorInterface, , "net.maxon.interface.illegalstateerror", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(UnexpectedErrorInterface, , "net.maxon.interface.unexpectederror", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(OperationCancelledErrorInterface, , "net.maxon.interface.OperationCancelledError", (ErrorInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(AggregatedErrorInterface, , "net.maxon.interface.aggregatederror", (ErrorInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int AggregatedErrorInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_errorbase(0
	| maxon::AggregatedErrorInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
