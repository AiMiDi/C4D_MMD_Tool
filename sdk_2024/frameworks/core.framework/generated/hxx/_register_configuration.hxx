...
namespace maxon
{
	namespace enum23
	{
		...
		static const maxon::UInt64 CONFIGURATION_CATEGORY_values[] = {maxon::UInt64(enum23::CONFIGURATION_CATEGORY::REGULAR), maxon::UInt64(enum23::CONFIGURATION_CATEGORY::DEVELOPMENT), maxon::UInt64(enum23::CONFIGURATION_CATEGORY::MODULE), maxon::UInt64(enum23::CONFIGURATION_CATEGORY::EXTENSION), maxon::UInt64(enum23::CONFIGURATION_CATEGORY::IMPLEMENTATION), maxon::UInt64(enum23::CONFIGURATION_CATEGORY::NONE), maxon::UInt64(enum23::CONFIGURATION_CATEGORY::SUBSCRIBER)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CONFIGURATION_CATEGORY23(){ return enum23::CONFIGURATION_CATEGORY_info; }
	namespace enum32
	{
		...
		static const maxon::UInt64 CONFIGURATIONENTRY_ORIGIN_values[] = {maxon::UInt64(enum32::CONFIGURATIONENTRY_ORIGIN::APPLICATION), maxon::UInt64(enum32::CONFIGURATIONENTRY_ORIGIN::CONFIGURATION), maxon::UInt64(enum32::CONFIGURATIONENTRY_ORIGIN::ENVIRONMENT), maxon::UInt64(enum32::CONFIGURATIONENTRY_ORIGIN::COMMANDLINE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CONFIGURATIONENTRY_ORIGIN32(){ return enum32::CONFIGURATIONENTRY_ORIGIN_info; }
	namespace enum41
	{
		...
		static const maxon::UInt64 CONFIGURATIONENTRY_STATE_values[] = {maxon::UInt64(enum41::CONFIGURATIONENTRY_STATE::UNUSED), maxon::UInt64(enum41::CONFIGURATIONENTRY_STATE::INVALIDARGUMENT), maxon::UInt64(enum41::CONFIGURATIONENTRY_STATE::USED), maxon::UInt64(enum41::CONFIGURATIONENTRY_STATE::OUTOFRANGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CONFIGURATIONENTRY_STATE41(){ return enum41::CONFIGURATIONENTRY_STATE_info; }
/// @cond INTERNAL
