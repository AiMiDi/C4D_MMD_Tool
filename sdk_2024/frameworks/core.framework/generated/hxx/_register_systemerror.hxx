...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(SystemErrorInterface, , "net.maxon.interface.systemerror", (ErrorInterface::PrivateGetInterface()));
	...
	const maxon::Char* const NSSystemErrorInterface::MTable::_ids = 
		...
		"SetCFError@f81d5a362c60dafa\0" // void SetCFError(CFErrorRef osError)
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(NSSystemErrorInterface, , "net.maxon.interface.nsystemerror", (ErrorInterface::PrivateGetInterface()));
