...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FileFormatHandlerInterface, , "net.maxon.interface.fileformathandler", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int FileFormatHandlerInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<FILEFORMAT_PRIORITY>(OVERLOAD_MAX_RANK)
...
#ifndef MAXON_COMPILER_CLANG
#endif
		"DetectAll@6d47c836172ce2ab\0" // Result<BaseArray<FileFormatHandler>> DetectAll(const Url& url, const Block<const DataType>& limitDetection, FILEFORMATDETECTIONFLAGS flags, const DetectedCallback& detectedCallback)
	"";
	MAXON_WARNING_PUSH
...
#ifndef MAXON_COMPILER_CLANG
#endif
		static Result<BaseArray<FileFormatHandler>> DetectAll(const Url& url, const Block<const DataType>& limitDetection, FILEFORMATDETECTIONFLAGS flags, const DetectedCallback& detectedCallback) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return FileFormatDetectionInterface::DetectAll(url, limitDetection, flags, detectedCallback); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE FileFormatDetectionInterface::MTable::_returnTypes[] = 
	{
#ifndef MAXON_COMPILER_CLANG
#endif
		maxon::details::UnresolvedReturnType<Result<BaseArray<FileFormatHandler>>>::value,
	...
	maxon::Bool FileFormatDetectionInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<Result<BaseArray<FileFormatHandler>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->FileFormatDetectionInterface_DetectAll = PRIVATE_MAXON_MF_CAST(decltype(FileFormatDetectionInterface_DetectAll), &Hxx2::Wrapper<Hxx2::Unresolved>::FileFormatDetectionInterface_DetectAll);
		#else
		tbl->FileFormatDetectionInterface_DetectAll = PRIVATE_MAXON_MF_CAST(decltype(FileFormatDetectionInterface_DetectAll), &Hxx2::Wrapper<Hxx2::Unresolved>::FileFormatDetectionInterface_DetectAll);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(FileFormatDetectionInterface, "net.maxon.interface.fileformatdetection", nullptr, maxon::EntityBase::FLAGS::NONE);
...
static maxon::details::ForceEvaluation s_forceEval_fileformat_handler(0
	| maxon::FileFormatHandlerInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
