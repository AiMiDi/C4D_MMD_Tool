...
/// @endcond
	...
	const maxon::Char* const JobQueueInterface::MTable::_ids = 
		...
		"AlwaysUseCurrentThread@1fd33a9b3668efbc\0" // void AlwaysUseCurrentThread(UInt ownerId)
		"SetIdleSpinTime@d51936872293b976\0" // void SetIdleSpinTime(UInt ownerId, TimeValue spinTime)
...
/// @endcond
	...
	public:
		...
		void AlwaysUseCurrentThread(UInt ownerId) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((JobQueueInterface*) this)->AlwaysUseCurrentThread(ownerId); return maxon::PrivateLogNullptrError();}
		void SetIdleSpinTime(UInt ownerId, TimeValue spinTime) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((JobQueueInterface*) this)->SetIdleSpinTime(ownerId, std::forward<TimeValue>(spinTime)); return maxon::PrivateLogNullptrError();}
		...
		static Result<void> SetDestinationQueue(JobQueueInterface* queue) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return JobQueueInterface::SetDestinationQueue(queue); return HXXRET1(UNRESOLVED);}
...
/// @endcond
	...
	const maxon::UNRESOLVED_RETURN_TYPE JobQueueInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<Result<JobQueueInterface*>>::value,
		...
		maxon::details::UnresolvedReturnType<void>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<void>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<JobQueueInterface*>::value,
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<JobQueueInterface*>::value,
		maxon::details::UnresolvedReturnType<ServiceIOJobQueueInterface*>::value,
/// @cond IGNORE
...
/// @endcond
	...
	maxon::Bool JobQueueInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->JobQueueInterface_Free = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_Free), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_Free);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<JobQueueInterface*>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->JobQueueInterface_Alloc = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_Alloc), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_Alloc);
		#else
		tbl->JobQueueInterface_Alloc = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_Alloc), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_Alloc);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_GetThreadCount = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_GetThreadCount), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_GetThreadCount);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_GetThreadCount_1 = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_GetThreadCount_1), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_GetThreadCount_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_Cancel = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_Cancel), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_Cancel);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_CancelAndWait = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_CancelAndWait), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_CancelAndWait);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_EnableThreadAffinity = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_EnableThreadAffinity), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_EnableThreadAffinity);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_AlwaysUseCurrentThread = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_AlwaysUseCurrentThread), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_AlwaysUseCurrentThread);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_SetIdleSpinTime = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_SetIdleSpinTime), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_SetIdleSpinTime);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_GetDestinationQueue = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_GetDestinationQueue), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_GetDestinationQueue);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->JobQueueInterface_SetDestinationQueue = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_SetDestinationQueue), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_SetDestinationQueue);
		#else
		tbl->JobQueueInterface_SetDestinationQueue = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_SetDestinationQueue), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_SetDestinationQueue);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_GetMainThreadQueue = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_GetMainThreadQueue), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_GetMainThreadQueue);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_GetServiceIOQueue = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_GetServiceIOQueue), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_GetServiceIOQueue);
		#endif
/// @cond IGNORE

		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->JobQueueInterface_ExecuteJobs = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_ExecuteJobs), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_ExecuteJobs);
		#endif
/// @endcond
	...
	MAXON_INTERFACE_REGISTER(JobQueueInterface, "net.maxon.interface.jobqueue", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
