...
namespace maxon
{
	...
	public:
		...
		static Result<String> DecomposeStringHfs(const String& str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return UnicodeUtils::DecomposeStringHfs(str); return HXXRET1(UNRESOLVED);}
		static Result<String> DecomposeString(const String& str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return UnicodeUtils::DecomposeString(str); return HXXRET1(UNRESOLVED);}
		static String GetUnicodeVersion() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return UnicodeUtils::GetUnicodeVersion(); return HXXRET3(UNRESOLVED, String);}
		static Result<String> NormalizeString(NORMALIZATION form, const String& str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return UnicodeUtils::NormalizeString(form, str); return HXXRET1(UNRESOLVED);}
		...
		static COMPARERESULT UniCodeCompare(Utf32Char a, Utf32Char b) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return UnicodeUtils::UniCodeCompare(a, b); return HXXRET3(UNRESOLVED, COMPARERESULT);}
		static CHARACTERTYPE GetCharacterType(Utf32Char chr) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return UnicodeUtils::GetCharacterType(chr); return HXXRET3(UNRESOLVED, CHARACTERTYPE);}
	...
	const maxon::UNRESOLVED_RETURN_TYPE UnicodeUtils::MTable::_returnTypes[] = 
	{
		...
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<COMPARERESULT>::value,
		maxon::details::UnresolvedReturnType<CHARACTERTYPE>::value,
		maxon::details::UnresolvedReturnType<Utf32Char>::value,
		maxon::details::UnresolvedReturnType<Utf32Char>::value,
		maxon::details::UnresolvedReturnType<Utf32Char>::value,
	...
	maxon::Bool UnicodeUtils::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<Result<String>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnicodeUtils_DecomposeStringHfs = PRIVATE_MAXON_MF_CAST(decltype(UnicodeUtils_DecomposeStringHfs), &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_DecomposeStringHfs);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<String>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnicodeUtils_DecomposeString = PRIVATE_MAXON_MF_CAST(decltype(UnicodeUtils_DecomposeString), &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_DecomposeString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<String>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnicodeUtils_GetUnicodeVersion = PRIVATE_MAXON_MF_CAST(decltype(UnicodeUtils_GetUnicodeVersion), &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_GetUnicodeVersion);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<String>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnicodeUtils_NormalizeString = PRIVATE_MAXON_MF_CAST(decltype(UnicodeUtils_NormalizeString), &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_NormalizeString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<COMPARERESULT>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnicodeUtils_UniCodeCompare = PRIVATE_MAXON_MF_CAST(decltype(UnicodeUtils_UniCodeCompare), &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_UniCodeCompare);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<CHARACTERTYPE>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnicodeUtils_GetCharacterType = PRIVATE_MAXON_MF_CAST(decltype(UnicodeUtils_GetCharacterType), &Hxx2::Wrapper<Hxx2::Unresolved>::UnicodeUtils_GetCharacterType);
		#else
	...
	MAXON_INTERFACE_REGISTER(UnicodeUtils, "net.maxon.interface.unicodeutils", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int UnicodeUtils::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<CHARACTERTYPE>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_unicodeutils(0
	| maxon::UnicodeUtils::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
