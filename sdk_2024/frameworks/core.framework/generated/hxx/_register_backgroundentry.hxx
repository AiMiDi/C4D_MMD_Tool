...
namespace maxon
{
	...
	const maxon::Char* const BackgroundProgressInterface::MTable::_ids = 
		...
		"ObservableStateChanged@f01d8b6b284425ca\0" // maxon::ObservableRef<ObservableStateChangedDelegate> ObservableStateChanged(Bool create) const
		"ObservableTotalProgressNotification@909ae1812a01784f\0" // maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> ObservableTotalProgressNotification(Bool create) const
	"";
