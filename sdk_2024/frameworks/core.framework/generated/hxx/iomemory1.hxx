...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoMemoryInterface, maxon::StrongRefHandler, IoMemoryRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoMemoryInterface, maxon::StrongRefHandler, IoMemoryRef>>>>);
