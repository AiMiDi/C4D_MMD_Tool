...
struct RunLoop::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(RunLoop_ObservableExitLoop, ObservableExitLoop, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableExitLoopDelegate>), Bool create);
	PRIVATE_MAXON_SF_POINTER(RunLoop_ObservableActivationChange, ObservableActivationChange, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableActivationChangeDelegate>), Bool create);
	PRIVATE_MAXON_SF_POINTER(RunLoop_ObservableRunLoopMessage, ObservableRunLoopMessage, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableRunLoopMessageDelegate>), Bool create);
...
struct RunLoop::Hxx2
{
	...
	public:
		...
		static maxon::ObservableRef<ObservableExitLoopDelegate> RunLoop_ObservableExitLoop(Bool create) { return S::ObservableExitLoop(create); }
		static maxon::ObservableRef<ObservableActivationChangeDelegate> RunLoop_ObservableActivationChange(Bool create) { return S::ObservableActivationChange(create); }
		static maxon::ObservableRef<ObservableRunLoopMessageDelegate> RunLoop_ObservableRunLoopMessage(Bool create) { return S::ObservableRunLoopMessage(create); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::ObservableExitLoop(Bool create) -> maxon::ObservableRef<ObservableExitLoopDelegate>
{
	return MTable::_instance.RunLoop_ObservableExitLoop(create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::ObservableActivationChange(Bool create) -> maxon::ObservableRef<ObservableActivationChangeDelegate>
{
	return MTable::_instance.RunLoop_ObservableActivationChange(create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::ObservableRunLoopMessage(Bool create) -> maxon::ObservableRef<ObservableRunLoopMessageDelegate>
{
