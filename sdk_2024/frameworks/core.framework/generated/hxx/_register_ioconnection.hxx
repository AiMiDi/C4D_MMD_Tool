...
namespace maxon
{
	...
	const maxon::Char* const IoConnectionInterface::Hxx2::StaticMTable::_ids = 
		"ObservableErrorOpenFile@71e7766dde049eea\0" // maxon::ObservableRef<ObservableErrorOpenFileDelegate> ObservableErrorOpenFile(Bool create)
	"";
