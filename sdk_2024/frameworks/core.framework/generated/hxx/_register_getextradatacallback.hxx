...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(GetExtraDataCallbackInterface, , "net.maxon.interface.getextradatacallback", (ObjectInterface::PrivateGetInterface()));
}
#ifdef __API_INTERN__
#endif
#endif
