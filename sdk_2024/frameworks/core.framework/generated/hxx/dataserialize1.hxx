...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeInterface, maxon::StrongRefHandler, DataSerializeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeInterface, maxon::StrongRefHandler, DataSerializeRef>>>>);
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeWriterInterface, maxon::StrongRefHandler, DataSerializeWriterRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeWriterInterface, maxon::StrongRefHandler, DataSerializeWriterRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeReaderInterface, maxon::StrongRefHandler, DataSerializeReaderRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeReaderInterface, maxon::StrongRefHandler, DataSerializeReaderRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
