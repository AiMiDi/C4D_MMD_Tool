...
/// Enables support for job groups with thread affinity.
...
/// Enables using the current thread for EnqueueAndWait even though it belongs to a different queue context (useful for alien threads).
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<JobQueueInterface, maxon::StrongRefHandler, JobQueueRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<JobQueueInterface, maxon::StrongRefHandler, JobQueueRef>>>>);
