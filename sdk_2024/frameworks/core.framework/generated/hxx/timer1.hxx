...
/// Notifies the observers that the timer has started.
		inline HXXADDRET2(maxon::ObservableRef<ObservableTimerStartedDelegate>) ObservableTimerStarted(Bool create) const;
/// Notifies the observers that the timer has finished.
		inline HXXADDRET2(maxon::ObservableRef<ObservableTimerFinishedDelegate>) ObservableTimerFinished(Bool create) const;
...
/// param[in] maxDuration				Maximum time that was suggested.
		inline HXXADDRET2(maxon::ObservableRef<ObservableTimerOverloadDelegate>) ObservableTimerOverload(Bool create) const;
/// @cond IGNORE
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<TimerInterface, maxon::StrongRefHandler, TimerRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<TimerInterface, maxon::StrongRefHandler, TimerRef>>>>);
