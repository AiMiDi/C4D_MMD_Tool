...
public:
	...
	using OBSERVABLECOMBINER = ObservableCombinerRunAllAggregateErrorsComponent_PrivateHelper;
};
...
public:
	...
	using OBSERVABLECOMBINER = ObservableCombinerRunAllBoolUntilTrue_PrivateHelper;
};
