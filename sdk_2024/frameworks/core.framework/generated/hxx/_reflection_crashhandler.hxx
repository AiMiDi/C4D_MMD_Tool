...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_CrashHandler(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(CrashHandler::MTable::_instance.CrashHandler_ObservableCrashDataDirectory)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "create\0", 0LL, nullptr),
		};
