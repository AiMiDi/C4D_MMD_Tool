...
/// @endcond
	...
	public:
		...
		const Id& GetId() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetId(); return maxon::PrivateDefaultReturnValue<const Id&>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		KIND GetKind() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetKind(); return maxon::PrivateDefaultReturnValue<KIND>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		Block<const ComponentInfo* const> GetComponents() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetComponents(); return maxon::PrivateDefaultReturnValue<Block<const ComponentInfo* const>>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		const DataType& GetDataType() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetDataType(); return maxon::PrivateDefaultReturnValue<const DataType&>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		String ToString(const FormatStatement* formatStatement) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->ToString(formatStatement); return maxon::PrivateDefaultReturnValue<String>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		const DataDictionary& GetMetaData() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetMetaData(); return maxon::PrivateDefaultReturnValue<const DataDictionary&>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
