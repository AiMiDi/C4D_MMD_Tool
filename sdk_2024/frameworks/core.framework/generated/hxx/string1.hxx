...
/// @return												The converted string.
		inline Result<String> Prettify(Int indent = 0, const String& indentStr = "\t"_s, Int breakUpThreshold = 100, Bool angularBrackets = false) const;
	};
	/// Intermediate helper class for StringInterface.
...
/// Concatenates 2 strings, use this operation instead of a = a + b as it is much faster.
/// @return												OK on success.
		inline Result<void> Append(const String& str) const;
...
/// Concatenates 2 strings, use this operation instead of a = a + b as it is much faster.
/// @return												OK on success.
		inline Result<void> Append(const String& str);
/// Concatenates 2 strings of which the second is represented by len characters at
/// address str in memory.
/// @param[in] str								Character pointer.
/// @param[in] len								Number of characters.
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const StringInterface, maxon::StrongCOWRefHandler, String>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const StringInterface, maxon::StrongCOWRefHandler, String>>>>);
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
/// Concatenates 2 strings, use this operation instead of a = a + b as it is much faster.
/// @return												OK on success.
		inline Result<void> Append(const CString& str) const;
/// Concatenates 2 strings of which the second is represented by len characters at
/// address str in memory.
/// @param[in] str								Character pointer.
/// @param[in] len								Number of characters.
...
/// Concatenates 2 strings, use this operation instead of a = a + b as it is much faster.
/// @return												OK on success.
		inline Result<void> Append(const CString& str);
/// Concatenates 2 strings of which the second is represented by len characters at
/// address str in memory.
/// @param[in] str								Character pointer.
/// @param[in] len								Number of characters.
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const CStringInterface, maxon::StrongCOWRefHandler, CString>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const CStringInterface, maxon::StrongCOWRefHandler, CString>>>>);
	using NonConst = Hxx1::NonConstRef;
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CStringInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CStringInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
