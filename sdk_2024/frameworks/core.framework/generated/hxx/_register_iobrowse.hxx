...
/// @endcond
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(IoBrowseInterface, , "net.maxon.interface.iobrowse", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int IoBrowseInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<IOBROWSEFLAGS>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_iobrowse(0
	| maxon::IoBrowseInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
