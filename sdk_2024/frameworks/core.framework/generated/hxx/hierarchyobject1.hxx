...
/// -param[in] branchId           The branch the object belongs to.
		inline HXXADDRET2(maxon::ObservableRef<ObservableHierarchyInsertDelegate>) ObservableHierarchyInsert(Bool create) const;
...
/// -param[in] branchId           The branch the object belongs to.
		inline HXXADDRET2(maxon::ObservableRef<ObservableHierarchyRemoveDelegate>) ObservableHierarchyRemove(Bool create) const;
	};
	/// Intermediate helper class for HierarchyObjectInterface.
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<HierarchyObjectInterface, maxon::StrongRefHandler, HierarchyObjectRef<HIERARCHY_>>>, HIERARCHY_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<HierarchyObjectInterface, maxon::StrongRefHandler, HierarchyObjectRef<HIERARCHY_>>>, HIERARCHY_>>);
