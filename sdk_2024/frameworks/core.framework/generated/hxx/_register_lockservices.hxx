...
/// @cond INTERNAL
	...
	const maxon::UNRESOLVED_RETURN_TYPE LockServices::MTable::_returnTypes[] = 
	{
	...
	maxon::Bool LockServices::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->LockServices_Serialize = PRIVATE_MAXON_MF_CAST(decltype(LockServices_Serialize), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_Serialize);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_SerializeAsync = PRIVATE_MAXON_MF_CAST(decltype(LockServices_SerializeAsync), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_SerializeAsync);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_AllocRWLockSlot = PRIVATE_MAXON_MF_CAST(decltype(LockServices_AllocRWLockSlot), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_AllocRWLockSlot);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_FreeRWLockSlot = PRIVATE_MAXON_MF_CAST(decltype(LockServices_FreeRWLockSlot), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_FreeRWLockSlot);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_ARWReadLock = PRIVATE_MAXON_MF_CAST(decltype(LockServices_ARWReadLock), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_ARWReadLock);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_ARWReadUnlock = PRIVATE_MAXON_MF_CAST(decltype(LockServices_ARWReadUnlock), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_ARWReadUnlock);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_ARWWriteLock = PRIVATE_MAXON_MF_CAST(decltype(LockServices_ARWWriteLock), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_ARWWriteLock);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_ARWWriteUnlock = PRIVATE_MAXON_MF_CAST(decltype(LockServices_ARWWriteUnlock), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_ARWWriteUnlock);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->LockServices_ARWAttemptWriteLock = PRIVATE_MAXON_MF_CAST(decltype(LockServices_ARWAttemptWriteLock), &Hxx2::Wrapper<Hxx2::Unresolved>::LockServices_ARWAttemptWriteLock);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(LockServices, "net.maxon.interface.lockservices", nullptr, maxon::EntityBase::FLAGS::NONE);
/// @endcond
