...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ReadArchiveInterface, maxon::StrongRefHandler, ReadArchiveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ReadArchiveInterface, maxon::StrongRefHandler, ReadArchiveRef>>>>);
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<WriteArchiveInterface, maxon::StrongRefHandler, WriteArchiveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<WriteArchiveInterface, maxon::StrongRefHandler, WriteArchiveRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
