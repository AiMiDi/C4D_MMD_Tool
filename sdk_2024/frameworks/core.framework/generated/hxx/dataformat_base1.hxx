...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseReaderInterface, maxon::StrongRefHandler, DataFormatBaseReaderRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseReaderInterface, maxon::StrongRefHandler, DataFormatBaseReaderRef>>>>);
...
#else
public maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseWriterInterface, maxon::StrongRefHandler, DataFormatBaseWriterRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseWriterInterface, maxon::StrongRefHandler, DataFormatBaseWriterRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
