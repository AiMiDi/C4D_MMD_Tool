...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FunctionBaseInterface, , "net.maxon.interface.functionbase", (ObjectInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CombinerInterface, , "net.maxon.interface.combiner", (ObjectInterface::PrivateGetInterface()));
	...
	const maxon::Char* const ObservableBaseInterface::MTable::_ids = 
		...
		"PrivateDisconnectAll@5f3d9457126c0f5f\0" // void PrivateDisconnectAll(ObserverObjectInterface* observer, Int pass)
		...
		"RemoveObserver@5a4b9d54843ea17b\0" // Bool RemoveObserver(const FunctionBaseRef& observerEntry)
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ObservableBaseInterface, , "net.maxon.interface.observablebase", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int ObservableBaseInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
	...
	const maxon::UNRESOLVED_RETURN_TYPE ObservableStaticInterface::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<const ClassInterface*>::value,
	...
	MAXON_INTERFACE_REGISTER(ObservableStaticInterface, "net.maxon.interface.observablestatic", nullptr, maxon::EntityBase::FLAGS::NONE);
#ifndef DOXYGEN
#else
#endif
}
...
static maxon::details::ForceEvaluation s_forceEval_observable(0
	| maxon::ObservableBaseInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
