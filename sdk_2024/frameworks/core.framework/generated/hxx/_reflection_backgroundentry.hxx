...
namespace maxon
{
	...
	public:
		...
		maxon::ObservableRef<ObservableStateChangedDelegate> ObservableStateChanged(Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_BackgroundProgressInterface_ObservableStateChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableStateChangedDelegate>), Bool), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_ObservableStateChanged)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_BackgroundProgressInterface_ObservableStateChanged;
		maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> ObservableTotalProgressNotification(Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
