...
struct IoConnectionInterface::Hxx2
{
	...
	struct StaticMTable
	{
		...
		static const maxon::Char* const _ids;
		static const maxon::UNRESOLVED_RETURN_TYPE _returnTypes[];
	PRIVATE_MAXON_SF_POINTER(IoConnectionInterface_ObservableErrorOpenFile, ObservableErrorOpenFile, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableErrorOpenFileDelegate>), Bool create);
	...
	public:
		...
		static maxon::ObservableRef<ObservableErrorOpenFileDelegate> IoConnectionInterface_ObservableErrorOpenFile(Bool create) { return S::Implementation::ObservableErrorOpenFile(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ObservableErrorOpenFile(Bool create) -> maxon::ObservableRef<ObservableErrorOpenFileDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ConstFn<S>::ObservableErrorOpenFile(Bool create) -> maxon::ObservableRef<ObservableErrorOpenFileDelegate>
{
	return (Hxx2::StaticMTable::_instance.IoConnectionInterface_ObservableErrorOpenFile(create));
}
