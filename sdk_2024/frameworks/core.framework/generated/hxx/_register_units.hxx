...
namespace maxon
{
	...
	{
	public:
		static const Dimension& Get(BASE_DIMENSION q) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, true)) return DimensionInterface::Get(q); return HXXRET3(UNRESOLVED, const Dimension&);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE DimensionInterface::Hxx2::StaticMTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<const Dimension&>::value,
	...
	maxon::Bool DimensionInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<const Dimension&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DimensionInterface_Get = PRIVATE_MAXON_MF_CAST(decltype(DimensionInterface_Get), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DimensionInterface_Get);
		#else
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE_SINGLE_IMPL(DimensionInterface, , "net.maxon.interface.dimension", (ObjectInterface::PrivateGetInterface()));
	...
	template <typename DUMMY> maxon::Int DimensionInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<String>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<UnitsArray>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const Dimension&>(OVERLOAD_MAX_RANK)
	...
	public:
		...
		const Id& GetId() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const UnitInterface*) this)->GetId(); return HXXRET3(UNRESOLVED, const Id&);}
		const Dimension& GetDimension() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const UnitInterface*) this)->GetDimension(); return HXXRET3(UNRESOLVED, const Dimension&);}
		...
		Result<Unit> operator *(const Result<Unit>& u) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->operator *(u); return HXXRET1(UNRESOLVED);}
		Result<Unit> operator /(const Result<Unit>& u) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->operator /(u); return HXXRET1(UNRESOLVED);}
		Result<Unit> operator ^(Int exponent) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->operator ^(exponent); return HXXRET1(UNRESOLVED);}
		Result<Unit> Copy(const Id& uid) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->Copy(uid); return HXXRET1(UNRESOLVED);}
		Result<Unit> Copy(const Dimension& quantity) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->Copy(quantity); return HXXRET1(UNRESOLVED);}
		Result<void> AddToDimension() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->AddToDimension(); return HXXRET1(UNRESOLVED);}
		Result<Unit> Reduce() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const UnitInterface*) this)->Reduce(); return HXXRET1(UNRESOLVED);}
		String ToString(const FormatStatement* fs) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const UnitInterface*) this)->ToString(fs); return HXXRET3(UNRESOLVED, String);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE UnitInterface::MTable::_returnTypes[] = 
	{
		...
		maxon::details::UnresolvedReturnType<const Dimension&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<Unit>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<Unit>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<Unit>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<Unit>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<Unit>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
	...
	maxon::Bool UnitInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const Id&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_GetId = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_GetId), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const Dimension&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_GetDimension = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_GetDimension), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_GetDimension);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Unit>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_operatorMul = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_operatorMul), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorMul);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Unit>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_operatorDiv = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_operatorDiv), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorDiv);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Unit>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_operatorXor = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_operatorXor), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_operatorXor);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Unit>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_Copy = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_Copy), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy);
		#else
		tbl->UnitInterface_Copy = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_Copy), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Unit>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_Copy_1 = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_Copy_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Copy_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_AddToDimension = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_AddToDimension), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_AddToDimension);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Unit>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_Reduce = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_Reduce), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_Reduce);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<String>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->UnitInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(UnitInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::UnitInterface_ToString);
		#else
	...
	MAXON_INTERFACE_REGISTER(UnitInterface, "net.maxon.interface.unit", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int UnitInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<String>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const Dimension&>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_units(0
	| maxon::DimensionInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
	| maxon::UnitInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
