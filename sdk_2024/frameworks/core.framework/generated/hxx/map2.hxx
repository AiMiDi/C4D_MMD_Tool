...
{
	HXXRETURN0(HXXADDRET2(ResultRef<V>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultRef<V>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
