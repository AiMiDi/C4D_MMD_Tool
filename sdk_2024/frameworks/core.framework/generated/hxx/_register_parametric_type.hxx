...
namespace maxon
{
	template <typename DUMMY> maxon::Int ParametricTypeInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
	...
	namespace ParametricTypes
	{
		...
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(Atomic, , "net.maxon.parametrictype.atomic");
		...
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(Bundle, , "net.maxon.parametrictype.bundle");
		...
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(ContainerInterface, , "net.maxon.parametrictype.container");
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(RecursiveContainerInterface, , "net.maxon.parametrictype.recursivecontainer");
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(GenericInstantiation, , "net.maxon.parametrictype.genericinstantiation");
	}
}
#endif
static maxon::details::ForceEvaluation s_forceEval_parametric_type(0
	| maxon::ParametricTypeInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
