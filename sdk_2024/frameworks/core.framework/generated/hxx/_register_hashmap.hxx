...
namespace maxon
{
	...
	namespace enum1001
	{
		...
		static const maxon::UInt64 HASHMAP_MODE_values[] = {maxon::UInt64(enum1001::HASHMAP_MODE::DEFAULT), maxon::UInt64(enum1001::HASHMAP_MODE::SYNCHRONIZED), maxon::UInt64(enum1001::HASHMAP_MODE::NO_NONEMPTY_BUCKET_TABLE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_HASHMAP_MODE1001(){ return enum1001::HASHMAP_MODE_info; }
}
#endif
