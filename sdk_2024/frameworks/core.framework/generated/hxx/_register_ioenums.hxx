...
namespace maxon
{
	...
	namespace enum33
	{
		enum class URLCOMPARE
		{
			...
			FULL         = 5,	///< DEFAULT + compare with all data dictionaries.
		} ;
		static const maxon::UInt64 URLCOMPARE_values[] = {maxon::UInt64(enum33::URLCOMPARE::DEFAULT), maxon::UInt64(enum33::URLCOMPARE::NORMALIZE), maxon::UInt64(enum33::URLCOMPARE::IONORMALIZE), maxon::UInt64(enum33::URLCOMPARE::LEGACY), maxon::UInt64(enum33::URLCOMPARE::FULL)};
		static const maxon::EnumInfo URLCOMPARE_info{"URLCOMPARE", SIZEOF(URLCOMPARE), false, "DEFAULT\0NORMALIZE\0IONORMALIZE\0LEGACY\0FULL\0", URLCOMPARE_values, std::extent<decltype(URLCOMPARE_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_URLCOMPARE33(){ return enum33::URLCOMPARE_info; }
	...
	namespace enum47
	{
		...
		static const maxon::UInt64 IODETECT_values[] = {maxon::UInt64(enum47::IODETECT::ERRORSTATE), maxon::UInt64(enum47::IODETECT::NONEXISTENT), maxon::UInt64(enum47::IODETECT::UNKNOWN), maxon::UInt64(enum47::IODETECT::FILE), maxon::UInt64(enum47::IODETECT::LINK), maxon::UInt64(enum47::IODETECT::DIRECTORY)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IODETECT47(){ return enum47::IODETECT_info; }
	...
	namespace enum78
	{
		...
		static const maxon::UInt64 OPENSTREAMFLAGS_values[] = {maxon::UInt64(enum78::OPENSTREAMFLAGS::NONE), maxon::UInt64(enum78::OPENSTREAMFLAGS::WRITE_DONT_TRUNCATE), maxon::UInt64(enum78::OPENSTREAMFLAGS::ALLOW_SHARED_READ_WRITE_ACCESS), maxon::UInt64(enum78::OPENSTREAMFLAGS::SEEK_TO_END), maxon::UInt64(enum78::OPENSTREAMFLAGS::FULL_DUPLEX), maxon::UInt64(enum78::OPENSTREAMFLAGS::ASK_FOR_REMOVE_WRITE_PROTECTION)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_OPENSTREAMFLAGS78(){ return enum78::OPENSTREAMFLAGS_info; }
	...
	namespace enum94
	{
		...
		static const maxon::UInt64 NORMALIZEFLAGS_values[] = {maxon::UInt64(enum94::NORMALIZEFLAGS::NONE), maxon::UInt64(enum94::NORMALIZEFLAGS::SCHEME_BASED), maxon::UInt64(enum94::NORMALIZEFLAGS::CASE), maxon::UInt64(enum94::NORMALIZEFLAGS::PATH_SEGMENT), maxon::UInt64(enum94::NORMALIZEFLAGS::UNICODE_DECOMPOSITION), maxon::UInt64(enum94::NORMALIZEFLAGS::UNDERLYING), maxon::UInt64(enum94::NORMALIZEFLAGS::UNDERLYING_RECURSIVE)};
		static const maxon::EnumInfo NORMALIZEFLAGS_info{"NORMALIZEFLAGS", SIZEOF(NORMALIZEFLAGS), true, "NONE\0SCHEME_BASED\0CASE\0PATH_SEGMENT\0UNICODE_DECOMPOSITION\0UNDERLYING\0UNDERLYING_RECURSIVE\0", NORMALIZEFLAGS_values, std::extent<decltype(NORMALIZEFLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_NORMALIZEFLAGS94(){ return enum94::NORMALIZEFLAGS_info; }
	...
	namespace enum124
	{
		...
		static const maxon::UInt64 IOATTRIBUTES_values[] = {maxon::UInt64(enum124::IOATTRIBUTES::NONE), maxon::UInt64(enum124::IOATTRIBUTES::READONLY), maxon::UInt64(enum124::IOATTRIBUTES::HIDDEN), maxon::UInt64(enum124::IOATTRIBUTES::ARCHIVE), maxon::UInt64(enum124::IOATTRIBUTES::LOCKED), maxon::UInt64(enum124::IOATTRIBUTES::OWNER_R), maxon::UInt64(enum124::IOATTRIBUTES::OWNER_W), maxon::UInt64(enum124::IOATTRIBUTES::OWNER_X), maxon::UInt64(enum124::IOATTRIBUTES::GROUP_R), maxon::UInt64(enum124::IOATTRIBUTES::GROUP_W), maxon::UInt64(enum124::IOATTRIBUTES::GROUP_X), maxon::UInt64(enum124::IOATTRIBUTES::PUBLIC_R), maxon::UInt64(enum124::IOATTRIBUTES::PUBLIC_W), maxon::UInt64(enum124::IOATTRIBUTES::PUBLIC_X), maxon::UInt64(enum124::IOATTRIBUTES::RW_MASK), maxon::UInt64(enum124::IOATTRIBUTES::RWX_MASK), maxon::UInt64(enum124::IOATTRIBUTES::MASK_ALL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IOATTRIBUTES124(){ return enum124::IOATTRIBUTES_info; }
	...
	namespace enum157
	{
		...
		static const maxon::UInt64 IOSHOWINOSFLAGS_values[] = {maxon::UInt64(enum157::IOSHOWINOSFLAGS::NONE), maxon::UInt64(enum157::IOSHOWINOSFLAGS::SHOW_IN_EXPLORER), maxon::UInt64(enum157::IOSHOWINOSFLAGS::OPEN_IN_EXPLORER)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IOSHOWINOSFLAGS157(){ return enum157::IOSHOWINOSFLAGS_info; }
