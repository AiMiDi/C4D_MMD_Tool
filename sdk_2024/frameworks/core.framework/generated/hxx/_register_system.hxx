...
namespace maxon
{
	...
	public:
		...
		static const Block<const Binary* const>& GetBinaries() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return System::GetBinaries(); return HXXRET3(UNRESOLVED, const Block<const Binary* const>&);}
	...
	const maxon::UNRESOLVED_RETURN_TYPE System::MTable::_returnTypes[] = 
	{
		...
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<const Block<const Binary* const>&>::value,
		maxon::details::UnresolvedReturnType<void>::value,
	...
	maxon::Bool System::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const Block<const Binary* const>&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->System_GetBinaries = PRIVATE_MAXON_MF_CAST(decltype(System_GetBinaries), &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetBinaries);
		#else
	...
	template <typename DUMMY> maxon::Int System::PrivateInstantiateDefaultValueHelper()
	{
		...
		| maxon::details::InstantiateDefaultReturnValue<const Block<const Binary* const>&>(OVERLOAD_MAX_RANK)
		;
	}
}
#endif
