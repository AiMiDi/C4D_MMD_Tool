...
namespace maxon
{
	...
	public:
		...
		static jobject GetNativeActivityObject() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::GetNativeActivityObject(); return HXXRET3(UNRESOLVED, jobject);}
		...
		static jobject AllcoObject(JNIEnv* env, jclass javaClass) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::AllcoObject(env, std::forward<jclass>(javaClass)); return HXXRET3(UNRESOLVED, jobject);}
		static jclass MakeGlobalRef(JNIEnv* env, const char* className) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::MakeGlobalRef(env, className); return HXXRET3(UNRESOLVED, jclass);}
		...
		static jfieldID GetFieldID(JNIEnv* env, jclass javaClass, const char* memberName, const char* signature) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::GetFieldID(env, std::forward<jclass>(javaClass), memberName, signature); return HXXRET3(UNRESOLVED, jfieldID);}
		static jlong GetLongField(JNIEnv* env, jobject obj, jfieldID field) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::GetLongField(env, std::forward<jobject>(obj), std::forward<jfieldID>(field)); return HXXRET3(UNRESOLVED, jlong);}
		...
		static String ConvertString(JNIEnv* env, jstring str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::ConvertString(env, std::forward<jstring>(str)); return HXXRET3(UNRESOLVED, String);}
		static jstring ConvertString(JNIEnv* env, const String& str) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::ConvertString(env, str); return HXXRET3(UNRESOLVED, jstring);}
		static jobject IntGetStaticObjectField(JNIEnv* env, const Char* className, const Char* memberName, const Char* signature) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::IntGetStaticObjectField(env, className, memberName, signature); return HXXRET3(UNRESOLVED, jobject);}
		static jobject IntCallStaticMethodObject(JNIEnv* env, const Char* className, const Char* memberName, const Char* signature, va_list list) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::IntCallStaticMethodObject(env, className, memberName, signature, list); return HXXRET3(UNRESOLVED, jobject);}
		...
		static jlong IntCallStaticMethodLong(JNIEnv* env, const Char* className, const Char* memberName, const Char* signature, va_list list) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::IntCallStaticMethodLong(env, className, memberName, signature, list); return HXXRET3(UNRESOLVED, jlong);}
		static jobject IntCallMethodObject(JNIEnv* env, jobject object, const Char* className, const Char* memberName, const Char* signature, va_list list) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::IntCallMethodObject(env, std::forward<jobject>(object), className, memberName, signature, list); return HXXRET3(UNRESOLVED, jobject);}
		static jlong IntCallMethodLong(JNIEnv* env, jobject object, const Char* className, const Char* memberName, const Char* signature, va_list list) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Java::IntCallMethodLong(env, std::forward<jobject>(object), className, memberName, signature, list); return HXXRET3(UNRESOLVED, jlong);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE Java::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<JNIEnv*>::value,
		maxon::details::UnresolvedReturnType<JNIEnv*>::value,
		maxon::details::UnresolvedReturnType<JavaVM*>::value,
		maxon::details::UnresolvedReturnType<jobject>::value,
		maxon::details::UnresolvedReturnType<AAssetManager*>::value,
		maxon::details::UnresolvedReturnType<jobject>::value,
		maxon::details::UnresolvedReturnType<jclass>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<jfieldID>::value,
		maxon::details::UnresolvedReturnType<jlong>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<String>::value,
		maxon::details::UnresolvedReturnType<jstring>::value,
		maxon::details::UnresolvedReturnType<jobject>::value,
		maxon::details::UnresolvedReturnType<jobject>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<jlong>::value,
	...
	maxon::Bool Java::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jobject>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_GetNativeActivityObject = PRIVATE_MAXON_MF_CAST(decltype(Java_GetNativeActivityObject), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetNativeActivityObject);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jobject>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_AllcoObject = PRIVATE_MAXON_MF_CAST(decltype(Java_AllcoObject), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_AllcoObject);
		#else
		tbl->Java_AllcoObject = PRIVATE_MAXON_MF_CAST(decltype(Java_AllcoObject), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_AllcoObject);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jclass>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_MakeGlobalRef = PRIVATE_MAXON_MF_CAST(decltype(Java_MakeGlobalRef), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_MakeGlobalRef);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jfieldID>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_GetFieldID = PRIVATE_MAXON_MF_CAST(decltype(Java_GetFieldID), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetFieldID);
		#else
		tbl->Java_GetFieldID = PRIVATE_MAXON_MF_CAST(decltype(Java_GetFieldID), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetFieldID);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jlong>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_GetLongField = PRIVATE_MAXON_MF_CAST(decltype(Java_GetLongField), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_GetLongField);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<String>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_ConvertString = PRIVATE_MAXON_MF_CAST(decltype(Java_ConvertString), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString);
		#else
		tbl->Java_ConvertString = PRIVATE_MAXON_MF_CAST(decltype(Java_ConvertString), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jstring>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_ConvertString_1 = PRIVATE_MAXON_MF_CAST(decltype(Java_ConvertString_1), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_ConvertString_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jobject>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_IntGetStaticObjectField = PRIVATE_MAXON_MF_CAST(decltype(Java_IntGetStaticObjectField), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntGetStaticObjectField);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jobject>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_IntCallStaticMethodObject = PRIVATE_MAXON_MF_CAST(decltype(Java_IntCallStaticMethodObject), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodObject);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jlong>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_IntCallStaticMethodLong = PRIVATE_MAXON_MF_CAST(decltype(Java_IntCallStaticMethodLong), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallStaticMethodLong);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jobject>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_IntCallMethodObject = PRIVATE_MAXON_MF_CAST(decltype(Java_IntCallMethodObject), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallMethodObject);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<jlong>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Java_IntCallMethodLong = PRIVATE_MAXON_MF_CAST(decltype(Java_IntCallMethodLong), &Hxx2::Wrapper<Hxx2::Unresolved>::Java_IntCallMethodLong);
		#else
	...
	MAXON_INTERFACE_REGISTER(Java, "net.maxon.interface.java", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int Java::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<String>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<jclass>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<jfieldID>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<jlong>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<jobject>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<jstring>(OVERLOAD_MAX_RANK)
		;
	}
#endif
}
...
static maxon::details::ForceEvaluation s_forceEval_java(0
	| maxon::Java::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
#endif
