...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataDescriptionDefinitionDatabaseImplInterface, , "net.maxon.interface.datadescriptiondefinitiondatabaseimpl", (ObjectInterface::PrivateGetInterface()));
}
#endif
