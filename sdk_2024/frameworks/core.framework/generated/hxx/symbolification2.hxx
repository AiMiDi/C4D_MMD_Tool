...
struct SymbolificationInterface::Hxx2
{
	...
	public:
		...
		static void SymbolificationInterface_Free(const SymbolificationInterface* object) { return S::Free(object); }
		static SymbolificationInterface* SymbolificationInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		PRIVATE_MAXON_MF_WRAPPER(SymbolificationInterface_Init, SymbolificationInterface,, (Result<void>), const Url& symbolFile, const String& architecture) { return S::Get(PRIVATE_MAXON_MF_THIS(SymbolificationInterface))->Init(symbolFile, architecture); }
		PRIVATE_MAXON_MF_WRAPPER(SymbolificationInterface_FindSymbol, SymbolificationInterface,, (Result<void>), UInt64 addr, String& file, Int& line, String& function) { return S::Get(PRIVATE_MAXON_MF_THIS(SymbolificationInterface))->FindSymbol(addr, file, line, function); }
	};
