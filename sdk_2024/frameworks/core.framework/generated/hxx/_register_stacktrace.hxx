...
namespace maxon
{
	...
	const maxon::UNRESOLVED_RETURN_TYPE StackTrace::MTable::_returnTypes[] = 
	{
#if defined MAXON_TARGET_WINDOWS || defined MAXON_TARGET_ANDROID
#else
#endif
	...
	maxon::Bool StackTrace::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->StackTrace_FindSymbol = PRIVATE_MAXON_MF_CAST(decltype(StackTrace_FindSymbol), &Hxx2::Wrapper<Hxx2::Unresolved>::StackTrace_FindSymbol);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(StackTrace, "net.maxon.interface.stacktrace", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
