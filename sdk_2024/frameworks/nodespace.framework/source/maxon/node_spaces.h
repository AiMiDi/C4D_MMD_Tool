...
namespace NODESPACE
{
	...
	/// @code
	/// const maxon::DataDictionary graphContext = graph.GetRoot().GetValue(maxon::nodes::NODESPACE::NodeSpaceContext).GetValueOrDefault() iferr_return;
...
{
	MAXON_INTERFACE_NONVIRTUAL(NodeSpaceHelpersInterface, MAXON_REFERENCE_STATIC, "net.maxon.nodes.interface.nodespacehelpers");
public:
