...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD CINEWARE_NAMESPACE::BaseList2D* GetBaseListRoot();
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<CINEWARE_NAMESPACE::BaseList2D*> UuidToBaseList2D(const Uuid& uuid) const;
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<Uuid> BaseList2DToUuid(CINEWARE_NAMESPACE::BaseList2D* object) const;
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<void> GetDescID(const NodePath& port, CINEWARE_NAMESPACE::DescID& result);
};
