...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImagePixelDeepImageStorageInterface, , "net.maxon.image.interface.imagepixeldeepimagestorage", (ImagePixelStorageInterface::PrivateGetInterface()));
