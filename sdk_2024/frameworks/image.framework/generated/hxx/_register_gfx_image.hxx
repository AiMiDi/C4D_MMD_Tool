...
namespace maxon
{
	...
	namespace enum126
	{
		...
		static const maxon::UInt64 TRANSFORM_COLORS_FLAGS_values[] = {maxon::UInt64(enum126::TRANSFORM_COLORS_FLAGS::NONE), maxon::UInt64(enum126::TRANSFORM_COLORS_FLAGS::INVERSE_DIRECTION)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TRANSFORM_COLORS_FLAGS126(){ return enum126::TRANSFORM_COLORS_FLAGS_info; }
/// @cond INTERNAL
...
/// @endcond
		...
		"ObservableRegionChanged@733c2bbf1b1fbf6d\0" // maxon::ObservableRef<ObservableRegionChangedDelegate> ObservableRegionChanged(Bool create) const
	"";
