...
struct MediaInputInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<MediaInputInterface, typename MediaConverterInterface::MTable::template CombinedMTable<S>>;
