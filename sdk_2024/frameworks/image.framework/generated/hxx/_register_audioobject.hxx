...
namespace maxon
{
	...
	"";
	const maxon::METHOD_FLAGS AudioObjectInterface::MTable::_flags[] = 
	{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(AudioObjectInterface, , "net.maxon.image.interface.audioobject", (DataDictionaryObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int AudioObjectInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_audioobject(0
	| maxon::AudioObjectInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
