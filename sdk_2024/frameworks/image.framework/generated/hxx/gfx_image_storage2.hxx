...
/// @endcond
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<ImagePixelStorageInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ImagePixelStorageInterface_Init); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ImagePixelStorageInterface_Init); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ImagePixelStorageInterface_Init_Offset), mt_.ImagePixelStorageInterface_Init, width, height, format, defaultColor));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelStorageInterface::Hxx1::ConstFn<S>::GetWidth() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(ImagePixelStorageInterface_GetWidth); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelStorageInterface::Hxx1::ConstFn<S>::GetHeight() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(ImagePixelStorageInterface_GetHeight); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelStorageInterface::Hxx1::ConstFn<S>::GetChannelCount() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(ImagePixelStorageInterface_GetChannelCount); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelStorageInterface::Hxx1::ConstFn<S>::GetPixelFormat() const -> HXXADDRET2(PixelFormat)
{
	HXXRETURN0(HXXADDRET2(PixelFormat)); HXXRES; HXXCONST(HXXRET3(NULLPTR, PixelFormat)) HXXTABLE(ImagePixelStorageInterface_GetPixelFormat); 
...
{
	HXXRETURN0(Result<GetPixelHandlerStruct>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(ImagePixelStorageInterface_GetPixelHandler); 
...
{
	HXXRETURN0(Result<SetPixelHandlerStruct>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ImagePixelStorageInterface_SetPixelHandler); 
...
{
	HXXRETURN0(Result<SetPixelHandlerStruct>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ImagePixelStorageInterface_SetPixelHandler); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ImagePixelStorageInterface_SetPixelHandler_Offset), mt_.ImagePixelStorageInterface_SetPixelHandler, srcFormat, channelOffsets, srcColorProfile, dstColorProfile, flags, updateRegionNotification));
}
/// @cond INTERNAL

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelStorageInterface::Hxx1::ConstFn<S>::FreePixelHandler(GetPixelHandlerStruct& pixel) const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError()) HXXTABLE(ImagePixelStorageInterface_FreePixelHandler); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImagePixelStorageInterface::Hxx1::ConstFn<S>::FreePixelHandler(SetPixelHandlerStruct& pixel, const Delegate<void(const UpdateRegion&)>& updateRegionNotification) const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError()) HXXTABLE(ImagePixelStorageInterface_FreePixelHandler_1); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(ImagePixelStorageInterface_GetComponent); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ImagePixelStorageInterface_SetComponent); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ImagePixelStorageInterface_SetComponent); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ImagePixelStorageInterface_SetComponent_Offset), mt_.ImagePixelStorageInterface_SetComponent, component, pos, data, inc, flags));
}
