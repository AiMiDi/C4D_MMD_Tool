...
struct ColorProfileLegacyProcessorInterface::Hxx2
{
	...
	public:
		...
		static void ColorProfileLegacyProcessorInterface_Free(const ColorProfileLegacyProcessorInterface* object) { return S::Free(object); }
		static ColorProfileLegacyProcessorInterface* ColorProfileLegacyProcessorInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		static ColorProfileLegacyProcessorInterface* ColorProfileLegacyProcessorInterface_Alloc_1(const maxon::SourceLocation& allocLocation, const ColorProfileLegacyProcessorInterface& object) { return S::Alloc(allocLocation, ((const S&) object)); }
		static Result<ForwardRef<ColorProfileGpuHandlerRef>> ColorProfileLegacyProcessorInterface_CreateHandler(const ColorProfile& srcProfile, const ColorProfile& dstProfile, COLORCONVERSIONFLAGS_GPU flags, COLORCONVERSION_OPTIMIZATION_GPU_FLAGS optimization) { return S::CreateHandler(srcProfile, dstProfile, flags, optimization); }
	};
