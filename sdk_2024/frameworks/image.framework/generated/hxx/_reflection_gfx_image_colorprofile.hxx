...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_ColorProfileInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(ColorProfileInterface::MTable::_instance.ColorProfileInterface_IsOcioDisplayViewTransform)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
/// @cond INTERNAL
