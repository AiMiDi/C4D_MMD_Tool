...
namespace maxon
{
	...
	const maxon::UNRESOLVED_RETURN_TYPE ColorProfileLegacyProcessorInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<ColorProfileLegacyProcessorInterface*>::value,
		maxon::details::UnresolvedReturnType<ColorProfileLegacyProcessorInterface*>::value,
		maxon::details::UnresolvedReturnType<Result<ForwardRef<ColorProfileGpuHandlerRef>>>::value,
	...
	maxon::Bool ColorProfileLegacyProcessorInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<ForwardRef<ColorProfileGpuHandlerRef>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ColorProfileLegacyProcessorInterface_CreateHandler = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileLegacyProcessorInterface_CreateHandler), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileLegacyProcessorInterface_CreateHandler);
		#else
	...
	MAXON_INTERFACE_REGISTER(ColorProfileLegacyProcessorInterface, "net.maxon.image.interface.legacygpuprocessor", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
