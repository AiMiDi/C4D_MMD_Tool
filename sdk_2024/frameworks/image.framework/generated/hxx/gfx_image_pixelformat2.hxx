...
struct PixelFormatInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<PixelFormatInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_Init); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(PixelFormatInterface_Init); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.PixelFormatInterface_Init_Offset), mt_.PixelFormatInterface_Init, group, shortName));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetChannels() const -> HXXADDRET2(Block<const ImageChannel>)
{
	HXXRETURN0(HXXADDRET2(Block<const ImageChannel>)); HXXRES; HXXCONST(HXXRET3(NULLPTR, Block<const ImageChannel>)) HXXTABLE(PixelFormatInterface_GetChannels); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetPixelFormatGroup() const -> HXXADDRET2(const PixelFormatGroup&)
{
	HXXRETURN0(HXXADDRET2(const PixelFormatGroup&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const PixelFormatGroup&)) HXXTABLE(PixelFormatInterface_GetPixelFormatGroup); 
...
{
	HXXRETURN0(Result<Pix*>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_CreatePix); 
...
{
	HXXRETURN0(Result<TYPE*>); HXXSUPER("PixelFormatInterface::CreatePix"); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
	return (o_->CreatePix<TYPE>(width, height, lineAlignment));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetChannelCount() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(PixelFormatInterface_GetChannelCount); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetChannelOffsets() const -> HXXADDRET2(const ChannelOffsets&)
{
	HXXRETURN0(HXXADDRET2(const ChannelOffsets&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const ChannelOffsets&)) HXXTABLE(PixelFormatInterface_GetChannelOffsets); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetBitsPerPixel() const -> HXXADDRET2(BITS)
{
	HXXRETURN0(HXXADDRET2(BITS)); HXXRES; HXXCONST(HXXRET3(NULLPTR, BITS)) HXXTABLE(PixelFormatInterface_GetBitsPerPixel); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetBytesPerLine(Int width, Int lineAlignment) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(PixelFormatInterface_GetBytesPerLine); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetPackedPixelCount() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(PixelFormatInterface_GetPackedPixelCount); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::HasAlpha() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) HXXTABLE(PixelFormatInterface_HasAlpha); 
...
{
	HXXRETURN0(Result<Tuple<PixelFormat, Int>>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_GetAlphaPixelFormat); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetColorSpace() const -> HXXADDRET2(ColorSpace)
{
	HXXRETURN0(HXXADDRET2(ColorSpace)); HXXRES; HXXCONST(HXXRET3(NULLPTR, ColorSpace)) HXXTABLE(PixelFormatInterface_GetColorSpace); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetDefaultColorProfile() const -> HXXADDRET2(const ColorProfile&)
{
	HXXRETURN0(HXXADDRET2(const ColorProfile&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const ColorProfile&)) HXXTABLE(PixelFormatInterface_GetDefaultColorProfile); 
...
{
	HXXRETURN0(Result<CONVERTPIXELFUNC>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_GetConvertPixelFunc); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetConvertPixelFunc(const PixelFormat& srcFormatPtr, const ChannelOffsets& srcChannelOffset, const ChannelOffsets& dstChannelOffset, const ColorProfile& srcColorProfile, ColorProfile* dstColorProfile, Bool forceColorProfileConversion, COLORCONVERSIONFLAGS colorConversionFlags, Bool& disableCaching) const -> Result<CONVERTPIXELFUNC>
{
	HXXRETURN0(Result<CONVERTPIXELFUNC>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_GetConvertPixelFunc_1); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_ConvertPixelFromSlow); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::IsIdenticalPixel(const ImageConstBuffer& a, const ImageConstBuffer& b, Int oneTolerance) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) HXXTABLE(PixelFormatInterface_IsIdenticalPixel); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::PixToString(const Pix* src) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(HXXRET3(NULLPTR, String)) HXXTABLE(PixelFormatInterface_PixToString); 
...
{
	HXXRETURN0(Result<CONVERTPIXELFUNC>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_GetConvertPixelFromFunc); 
...
{
	HXXRETURN0(Result<CONVERTPIXELFUNC>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(PixelFormatInterface_GetConvertPixelToFunc); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto PixelFormatInterface::Hxx1::ConstFn<S>::GetShortName() const -> HXXADDRET2(const Char*)
{
	HXXRETURN0(HXXADDRET2(const Char*)); HXXRES; HXXCONST(nullptr) HXXTABLE(PixelFormatInterface_GetShortName); 
...
struct PixelFormatsInterface::Hxx2
{
	...
	public:
		...
		static Result<PixelFormat> PixelFormatsInterface_FindOrCreatePixelFormat(const Block<const ImageChannel>& channels) { return S::FindOrCreatePixelFormat(channels); }
	};
