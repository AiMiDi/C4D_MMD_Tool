...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaSessionInterface, , "net.maxon.image.interface.mediasession", (ObserverObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int MediaSessionInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<ProgressRef>(OVERLOAD_MAX_RANK)
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_mediasession_session(0
	| maxon::MediaSessionInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
