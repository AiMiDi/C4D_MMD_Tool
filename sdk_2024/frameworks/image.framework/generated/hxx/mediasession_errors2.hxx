...
struct MediaSessionWrongTypeErrorInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<MediaSessionWrongTypeErrorInterface, typename ErrorInterface::MTable::template CombinedMTable<S>>;
...
struct MediaStreamEOFErrorInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<MediaStreamEOFErrorInterface, typename ErrorInterface::MTable::template CombinedMTable<S>>;
