...
namespace maxon
{
	...
	{
	public:
		static Result<PixelFormat> GetOptimalPixelFormat(const Block<PixelFormat>& formats) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, false)) return ImagePixelBlendInterface::GetOptimalPixelFormat(formats); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE ImagePixelBlendInterface::Hxx2::StaticMTable::_returnTypes[] = 
	{
	...
	maxon::Bool ImagePixelBlendInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<Result<PixelFormat>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ImagePixelBlendInterface_GetOptimalPixelFormat = PRIVATE_MAXON_MF_CAST(decltype(ImagePixelBlendInterface_GetOptimalPixelFormat), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImagePixelBlendInterface_GetOptimalPixelFormat);
		#else
		tbl->ImagePixelBlendInterface_GetOptimalPixelFormat = PRIVATE_MAXON_MF_CAST(decltype(ImagePixelBlendInterface_GetOptimalPixelFormat), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImagePixelBlendInterface_GetOptimalPixelFormat);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImagePixelBlendInterface, , "net.maxon.image.interface.imagepixelblend", (ObjectInterface::PrivateGetInterface()));
