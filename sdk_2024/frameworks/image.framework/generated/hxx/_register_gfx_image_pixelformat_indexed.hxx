...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(PixelFormatIndexedColorInterface, , "net.maxon.image.interface.pixelformatindexedcolor", (PixelFormatInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int PixelFormatIndexedColorInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_gfx_image_pixelformat_indexed(0
	| maxon::PixelFormatIndexedColorInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
