...
public:
	static const Profiler& DefaultValueRef()
	{
...
{
	MAXON_INTERFACE_NONVIRTUAL(ProfileManagerInterface, MAXON_REFERENCE_STATIC, "net.maxon.interface.profilemanager");
...
#define PROFILER_SCOPE(...) \
	PROFILER_SCOPE_ENTER(__VA_ARGS__); \
	finally \
	{ \
		PROFILER_SCOPE_LEAVE(); \
	};
...
extern Bool g_enableProfilerDumpRegistry;					// enable/disable profiler dump registry
extern Bool g_enableProfilerDumpRegistryErrors;		// enable/disable profiler dump registry errors (if any)
extern Bool g_enableProfilerGetMethodNameTrace;		// enable/disable profiler GetMethodName trace
}
