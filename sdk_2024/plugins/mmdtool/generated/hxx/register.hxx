...
static const maxon::LiteralId g_usedFrameworks[] = {maxon::LiteralId("net.maxon.asset.framework"), maxon::LiteralId("net.maxon.c4d.cinema.framework"), maxon::LiteralId("net.maxon.core.framework"), maxon::LiteralId("net.maxon.graph.framework"), maxon::LiteralId("net.maxon.image.framework"), maxon::LiteralId("net.maxon.math.framework"), maxon::LiteralId("net.maxon.mesh_misc.framework"), maxon::LiteralId("net.maxon.misc.framework"), maxon::LiteralId("net.maxon.modeling_geom.framework"), maxon::LiteralId("net.maxon.nodes.framework"), maxon::LiteralId("net.maxon.nodespace.framework")};
