...
namespace maxon
{
	...
	public:
		...
		Result<void> DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_DisplayControl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), BaseTag*, BaseDocument*, BaseObject*, BaseDraw*, BaseDrawHelp*, ControlDisplayStruct&), reinterpret_cast<const void* const&>(mt_.CustomDataTagDisplayInterface_DisplayControl)));
			return proxy_result;
		}
