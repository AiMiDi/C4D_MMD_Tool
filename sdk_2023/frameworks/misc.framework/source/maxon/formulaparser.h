...
/// symbols <em>e</em> and <em>pi</em> are being interpreted as the respective irrantional numbers, and both the dot and
/// comma character will be interprted as a decimal point.
///
