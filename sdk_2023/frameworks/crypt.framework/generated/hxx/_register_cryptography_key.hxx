...
namespace maxon
{
	...
	maxon::Bool CryptoKeyInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->CryptoKeyInterface_Free = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_Free), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_Free);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_Alloc = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_Alloc), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_Alloc);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CryptoKeyInterface_GetCryptoAlgorithm = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetCryptoAlgorithm), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetCryptoAlgorithm);
		#else
		tbl->CryptoKeyInterface_GetCryptoAlgorithm = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetCryptoAlgorithm), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetCryptoAlgorithm);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_GetBlockBitSize = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetBlockBitSize), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetBlockBitSize);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_GetKey1 = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetKey1), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetKey1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_GetKey1BitSize = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetKey1BitSize), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetKey1BitSize);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_GetKey2 = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetKey2), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetKey2);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_GetKey2BitSize = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetKey2BitSize), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetKey2BitSize);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->CryptoKeyInterface_GetFlags = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetFlags), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetFlags);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BLOCK_CIPHER_CTR_CALLBACK&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CryptoKeyInterface_GetCallbackFunction = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetCallbackFunction), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetCallbackFunction);
		#else
		tbl->CryptoKeyInterface_GetCallbackFunction = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_GetCallbackFunction), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_GetCallbackFunction);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CryptoKeyInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_ToString);
		#else
		tbl->CryptoKeyInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(CryptoKeyInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::CryptoKeyInterface_ToString);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
