...
namespace maxon
{
	...
	maxon::Bool SSHInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->SSHInterface_libssh2_session_init = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_session_init), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_session_init);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_session_disconnect_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_session_disconnect_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_session_disconnect_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_session_free = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_session_free), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_session_free);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_session_set_blocking = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_session_set_blocking), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_session_set_blocking);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_session_handshake = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_session_handshake), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_session_handshake);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_hostkey_hash = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_hostkey_hash), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_hostkey_hash);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_userauth_list = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_userauth_list), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_userauth_list);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_userauth_password_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_userauth_password_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_userauth_password_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_session_last_error = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_session_last_error), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_session_last_error);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_init = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_init), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_init);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_shutdown = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_shutdown), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_shutdown);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_open_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_open_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_open_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_close_handle = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_close_handle), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_close_handle);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_unlink_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_unlink_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_unlink_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_mkdir_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_mkdir_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_mkdir_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_rmdir_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_rmdir_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_rmdir_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_fstat_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_fstat_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_fstat_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_stat_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_stat_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_stat_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_read = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_read), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_read);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_write = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_write), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_write);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_readdir_ex = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_readdir_ex), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_readdir_ex);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->SSHInterface_libssh2_sftp_seek64 = PRIVATE_MAXON_MF_CAST(decltype(SSHInterface_libssh2_sftp_seek64), &Hxx2::Wrapper<Hxx2::Unresolved>::SSHInterface_libssh2_sftp_seek64);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
