...
public:
	...
	//----------------------------------------------------------------------------------------
	StaticJob(INDEXTYPE from, INDEXTYPE to, Int threadIndex, BreakCondition* breakCondition, const LOOP& obj) : ParallelFor::ParallelForJob(GetJumpTable<StaticJob>()), _obj(obj)
	{
	...
	//----------------------------------------------------------------------------------------
	StaticJob(INDEXTYPE from, INDEXTYPE to, Int threadIndex, BreakCondition* breakCondition, const LOOP& obj, const INIT& init, const FINALIZE& finalize) : ParallelFor::ParallelForJob(GetJumpTable<StaticJob>()), _obj(obj)
	{
