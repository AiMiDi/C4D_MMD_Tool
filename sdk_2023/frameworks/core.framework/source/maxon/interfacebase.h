...
#endif
//----------------------------------------------------------------------------------------
using DataTypeInitializer = Result<void>(*)(DataTypeImpl* info, Id&& type, const NonvirtualInterfaceImplementation* impl, const void* nullValue);
...
{
	static Result<void> Init(DataTypeImpl* info, Id&& iid, const NonvirtualInterfaceImplementation* impl, const void* nullValue)
	{
		new (info) DataTypeImpl(std::move(iid), nullptr, nullptr, (T*) nullValue, (typename InterfaceDataTypeFunctionsTrait<T>::Functions*) nullptr, VALUEKIND::NONE, impl, VALUEKIND::NONVIRTUAL_INTERFACE | VALUEKIND::ABSTRACT);
...
public:
	...
	{
		return _type.type.GetNullValue();
	}
...
public:
	...
	MAXON_IMPLICIT RefBase(std::nullptr_t) = delete;
	...
	static MAXON_ATTRIBUTE_FORCE_INLINE const typename ReferenceBaseSuper::ReferenceClass& NullValue()
	{
...
/// @see MAXON_INTERFACE_NONVIRTUAL
//----------------------------------------------------------------------------------------
#define MAXON_REFERENCE_STATIC(FREEIMPL) MAXON_REFERENCE_NONE(FREEIMPL)
...
#define MAXON_IMPLEMENTATION_NO_ALLOC(C, cast) \
	...
	public: \
		...
		static void Free(const volatile BaseInterface* object) { maxon::details::PrivateFreeWithDestructor<C>((const C*) object); } \
...
#define MAXON_IMPLEMENTATION_SIMPLE(C) \
	public: \
		using IsAllocType = std::false_type; \
		using MTable = std::false_type; /* for the IsInterfaceType detection */ \
		static void Free(const typename Interface::BaseInterface* o) { DeleteConstPtrObj((const C*) o); } \
...
#define MAXON_IMPLEMENTATION_SIMPLE_REGISTER(C) \
	const typename C::Interface::MTable C::_clsMTable = typename C::Interface::MTable((C*) nullptr);
