...
public:
	...
	static MAXON_ATTRIBUTE_FORCE_INLINE const typename D::Type& NullValue() { return reinterpret_cast<DeclarationUse<D, UNIT, UNIT_HASH, WEAK>&>(_instance).NullValueImpl(); }
};
...
public:
	...
	{
		return _object ? *_object : NullValue();
	}
...
private:
	...
	static MAXON_ATTRIBUTE_FORCE_INLINE const T& NullValue()
	{
...
#define MAXON_DECLARATION(T, Name, id, ...) \
	PRIVATE_MAXON_DECLARATION(T, Name, id, ;, extern, __VA_ARGS__); \
