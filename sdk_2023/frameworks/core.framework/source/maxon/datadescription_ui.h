			...
			namespace MAXON
			{
				namespace UI
				{
					namespace DATA
					{
						...
						// supports MAXON::DESCRIPTION::UI::BASE::PRESETDATABASEDYNAMICID
...
public:
	...
	//----------------------------------------------------------------------------------------
	[[deprecated("Use other EvaluateCondition")]] static MAXON_METHOD Result<Bool> EvaluateCondition(const CString& condition, const DataDescriptionWithUIAndString& description,
