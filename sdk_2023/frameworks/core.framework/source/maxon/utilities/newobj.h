...
public:
	...
	static inline void Free(const T* o)
	{
		...
		ForwardFree<STD_IS_REPLACEMENT(destructible, ConstructorType)>::FreeWithDestructor((ConstructorType*)o);
	}
...
#define NewObj(T, ...) (maxon::details::NewDelete<T>::IS_ALLOC_TYPE ? maxon::details::NewDelete<T>::Cast(maxon::details::NewDelete<T>::AllocType::Alloc(MAXON_SOURCE_LOCATION_NAME(T), ##__VA_ARGS__)) \
												:	maxon::ResultPtr<T>((T*) MAXON_SAFE_PLACEMENT_NEW(maxon::details::NewDelete<T>::AllocatorType::Alloc(maxon::details::NewDelete<T>::SIZE, MAXON_SOURCE_LOCATION_NAME(T))) typename maxon::details::NewDelete<T>::ConstructorType{__VA_ARGS__}))


/// Deprecated.
#define NewObjPtr(T, ...) ((T*) MAXON_SAFE_PLACEMENT_NEW(maxon::details::NewDelete<T>::AllocatorType::Alloc(maxon::details::NewDelete<T>::SIZE, MAXON_SOURCE_LOCATION_NAME(T))) typename maxon::details::NewDelete<T>::ConstructorType(__VA_ARGS__))
...
#define NewObjClear(T, ...) (maxon::details::NewDelete<T>::IS_ALLOC_TYPE ? maxon::details::NewDelete<T>::Cast(maxon::details::NewDelete<T>::AllocType::Alloc(MAXON_SOURCE_LOCATION_NAME(T), ##__VA_ARGS__)).GetValue() \
												:	(T*) MAXON_SAFE_PLACEMENT_NEW(maxon::details::NewDelete<T>::AllocatorType::AllocClear(maxon::details::NewDelete<T>::SIZE, MAXON_SOURCE_LOCATION_NAME(T))) typename maxon::details::NewDelete<T>::ConstructorType(__VA_ARGS__))
#endif
