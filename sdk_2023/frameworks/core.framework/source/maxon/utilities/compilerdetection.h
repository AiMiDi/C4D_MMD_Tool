...
#define MAXON_SWITCH_CHECKALLENUMS_END								MAXON_WARNING_POP
	...
	inline void* operator new(size_t size, maxon::details::EnforceNullptrCheck x, void* ptr) noexcept { return ptr; }
	// Placement new needs a matching deletion function, otherwise warning C4291 is triggered.
	inline void operator delete(void*, maxon::details::EnforceNullptrCheck x, void* ptr) noexcept { }
	//----------------------------------------------------------------------------------------
