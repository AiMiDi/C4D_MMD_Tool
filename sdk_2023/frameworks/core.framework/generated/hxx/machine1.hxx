...
/// @return												The converted result.
		...
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>>, maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>>::type ObservablePrivateSplashMessageReceived() const;
...
/// When the app is becoming inactive you can e.g. idle some computations
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableActivationChangedDelegate>>, maxon::ObservableRef<ObservableActivationChangedDelegate>>::type ObservableActivationChanged() const;
	};
	/// Intermediate helper class for MachineInterface.
