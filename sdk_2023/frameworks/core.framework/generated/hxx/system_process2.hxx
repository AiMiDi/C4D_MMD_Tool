...
struct SystemProcessObjectInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(SystemProcessObjectInterface_ObservableProcessFinished, ObservableProcessFinished, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableProcessFinishedDelegate>));
...
struct SystemProcessObjectInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(SystemProcessObjectInterface_ObservableProcessFinished, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableProcessFinishedDelegate>)) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableProcessFinished(); }
	};
...
{
	const SystemProcessObjectInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(SystemProcessObjectInterface, this); return PRIVATE_MAXON_MF_INVOKE(((const maxon::GenericComponent*) this + mt_.SystemProcessObjectInterface_ObservableProcessFinished_Offset), mt_.SystemProcessObjectInterface_ObservableProcessFinished);
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SystemProcessObjectInterface* o_ = (const SystemProcessObjectInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SystemProcessObjectInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(SystemProcessObjectInterface, o_, SystemProcessObjectInterface_GetExitCode) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<SystemProcessObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<SystemProcessObjectInterface>() : PRIVATE_MAXON_VTABLE(SystemProcessObjectInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Url>, Url>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SystemProcessObjectInterface* o_ = (const SystemProcessObjectInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SystemProcessObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<Url>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(SystemProcessObjectInterface, o_, SystemProcessObjectInterface_GetProcessUrl) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<SystemProcessObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<SystemProcessObjectInterface>() : PRIVATE_MAXON_VTABLE(SystemProcessObjectInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<ObservableProcessFinishedDelegate>>, maxon::ObservableRef<ObservableProcessFinishedDelegate>>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SystemProcessObjectInterface* o_ = (const SystemProcessObjectInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SystemProcessObjectInterface::NullValuePtr(); if (!o_) return maxon::ObservableRef<ObservableProcessFinishedDelegate>::NullValue(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(SystemProcessObjectInterface, o_, SystemProcessObjectInterface_ObservableProcessFinished) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<SystemProcessObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<SystemProcessObjectInterface>() : PRIVATE_MAXON_VTABLE(SystemProcessObjectInterface, o_); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.SystemProcessObjectInterface_ObservableProcessFinished_Offset), mt_.SystemProcessObjectInterface_ObservableProcessFinished));
}
