...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_Misc(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<decltype(Misc::MTable::_instance.Misc_SetFloatingPointChecks)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "on\0", 1LL, nullptr),
		};
