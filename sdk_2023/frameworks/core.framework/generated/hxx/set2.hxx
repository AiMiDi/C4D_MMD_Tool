...
template <typename TYPE> struct SetInterface<TYPE>::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_GetCount, SetInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->GetCount(); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Contains, SetInterface, const, (Bool), const TYPE& value) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->Contains(value); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Insert, SetInterface,, (Result<void>), const TYPE& value, Bool& added) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->Insert(value, added); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Insert_1, SetInterface,, (Result<void>), TYPE&& value, Bool& added) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->Insert(std::forward<TYPE>(value), added); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Erase, SetInterface,, (Result<Bool>), const TYPE& value) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->Erase(value); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Erase_1, SetInterface,, (Iterator), const Iterator& iterator) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->Erase(iterator); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Reset, SetInterface,, (void)) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->Reset(); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Flush, SetInterface,, (void)) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->Flush(); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_CopyFrom, SetInterface,, (Result<void>), const SetInterface& other) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->CopyFrom(other); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_Clone, SetInterface, const, (Result<SetInterface*>), Bool copyContent) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->Clone(copyContent); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_GetValueDataType, SetInterface, const, (const DataType&)) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->GetValueDataType(); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_ToString, SetInterface, const, (String), const FormatStatement* formatStatement) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->ToString(formatStatement); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_GetMemorySize, SetInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->GetMemorySize(); }
#ifdef MAXON_COMPILER_INTEL
#endif
#ifdef MAXON_COMPILER_INTEL
#endif
...
#ifdef CPP_853_HACK
#endif
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorInit, SetInterface,, (void), Iterator* it, Bool end) { return C::Get(PRIVATE_MAXON_MF_THIS(SetInterface))->IteratorInit(it, end); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorInit_1, SetInterface, const, (void), ConstIterator* it, Bool end) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorInit(it, end); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorInitMove, SetInterface, const, (void), Iterator* dest, Iterator* src) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorInitMove(dest, src); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorInitMove_1, SetInterface, const, (void), ConstIterator* dest, ConstIterator* src) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorInitMove(dest, src); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorFree, SetInterface, const, (void), Iterator* it) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorFree(it); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorFree_1, SetInterface, const, (void), ConstIterator* it) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorFree(it); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorIsEqual, SetInterface, const, (Bool), const Iterator* a, const Iterator* b) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorIsEqual(a, b); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorIsEqual_1, SetInterface, const, (Bool), const ConstIterator* a, const ConstIterator* b) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorIsEqual(a, b); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorInc, SetInterface, const, (void), Iterator* it) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorInc(it); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorInc_1, SetInterface, const, (void), ConstIterator* it) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorInc(it); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorGet, SetInterface, const, (const TYPE*), const Iterator* it) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorGet(it); }
		PRIVATE_MAXON_MF_WRAPPER(SetInterface_IteratorGet_1, SetInterface, const, (const TYPE*), const ConstIterator* it) { return C::Get(PRIVATE_MAXON_MF_THIS(const SetInterface))->IteratorGet(it); }
	};
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return true; } 
	return (o_->IsEmpty());
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Bool>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Iterator>, Iterator>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateNullReturnValue<Iterator>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Iterator, maxon::Result<Iterator>>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->MakeWritable(true).GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((SetInterface::MTable*) (o_->_vtableCls + 1))[-1].SetInterface_Erase_1, iterator));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->MakeWritable(true).GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } 
	PRIVATE_MAXON_MF_INVOKE((o_), ((SetInterface::MTable*) (o_->_vtableCls + 1))[-1].SetInterface_Reset);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<SetInterface*>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<const DataType&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } 
	o_->AssertType<T>();
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
#ifdef MAXON_COMPILER_INTEL
