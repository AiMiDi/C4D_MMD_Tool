...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionUIInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionUIInterface::Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "condition\0description\0uiEntries\0getDataCallback\0externalVariables\0", 341LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionUIInterface::Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition_1)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "condition\0description\0getDataCallback\0externalVariables\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionUIInterface::Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition_2)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "condition\0description\0getDescCallback\0getDataCallback\0externalVariables\0", 341LL, nullptr),
