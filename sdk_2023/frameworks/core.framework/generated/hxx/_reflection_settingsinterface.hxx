...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_SettingsInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(SettingsInterface::Hxx2::StaticMTable::_instance.SettingsInterface_ObservableSettingsChanged)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
