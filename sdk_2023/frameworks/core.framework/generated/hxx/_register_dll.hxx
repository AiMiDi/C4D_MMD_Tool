...
namespace maxon
{
	...
	maxon::Bool DllInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DllRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_LoadDll = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_LoadDll), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_LoadDll);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DllRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetModule = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_GetModule), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetModule);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_AddDllPath = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_AddDllPath), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_AddDllPath);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_RemoveDllPath = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_RemoveDllPath), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_RemoveDllPath);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetLoadedDlls = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_GetLoadedDlls), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetLoadedDlls);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_Unload = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_Unload), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Unload);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_Release = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_Release), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_Release);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_FindSymbolPointer = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_FindSymbolPointer), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_FindSymbolPointer);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Binary*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetBinary = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_GetBinary), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetBinary);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_UpdateSymbolData = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_UpdateSymbolData), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_UpdateSymbolData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DllInterface_GetPath = PRIVATE_MAXON_MF_CAST(decltype(DllInterface_GetPath), &Hxx2::Wrapper<Hxx2::Unresolved>::DllInterface_GetPath);
		#else
