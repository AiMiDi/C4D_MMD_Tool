...
#endif
			maxon::reflection::GetFunctionInfo<decltype(Application::MTable::_instance.Application_ObservableApplicationMessage)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(Application::MTable::_instance.Application_GetUrlI)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "urlType\0", 0LL, nullptr),
		};
