...
/// @return												The number of changes.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type GetChangeCounts() const;
/// Returns the number of changes made by user since the last Write().
/// @return												The number of changes.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type GetUserChangeCount() const;
