...
/// @endcond
	...
	maxon::Bool TimerInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableTimerStartedDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->TimerInterface_ObservableTimerStarted = PRIVATE_MAXON_MF_CAST(decltype(TimerInterface_ObservableTimerStarted), &Hxx2::Wrapper<Hxx2::Unresolved>::TimerInterface_ObservableTimerStarted);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableTimerFinishedDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->TimerInterface_ObservableTimerFinished = PRIVATE_MAXON_MF_CAST(decltype(TimerInterface_ObservableTimerFinished), &Hxx2::Wrapper<Hxx2::Unresolved>::TimerInterface_ObservableTimerFinished);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableTimerOverloadDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->TimerInterface_ObservableTimerOverload = PRIVATE_MAXON_MF_CAST(decltype(TimerInterface_ObservableTimerOverload), &Hxx2::Wrapper<Hxx2::Unresolved>::TimerInterface_ObservableTimerOverload);
		#else
...
/// @cond IGNORE
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->TimerInterface_Start = PRIVATE_MAXON_MF_CAST(decltype(TimerInterface_Start), &Hxx2::Wrapper<Hxx2::Unresolved>::TimerInterface_Start);
		#else
