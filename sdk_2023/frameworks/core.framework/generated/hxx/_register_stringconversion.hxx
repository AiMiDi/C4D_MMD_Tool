...
namespace maxon
{
	...
	maxon::Bool StringConversion::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_FloatToString = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_FloatToString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FloatToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_FloatToString_1 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_FloatToString_1), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_FloatToString_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_MemorySizeToString = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_MemorySizeToString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_MemorySizeToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_HexToString = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_HexToString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_HexToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_HexToString_1 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_HexToString_1), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_HexToString_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToFloat32 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_ToFloat32), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToFloat32);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToFloat64 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_ToFloat64), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToFloat64);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToInt64 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_ToInt64), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToInt64);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToInt32 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_ToInt32), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToInt32);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UInt64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToUInt64 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_ToUInt64), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToUInt64);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UInt32>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_ToUInt32 = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_ToUInt32), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_ToUInt32);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Float64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_StringToFloat = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_StringToFloat), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_StringToFloat);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<UInt64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_StringToInteger = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_StringToInteger), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_StringToInteger);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_GetLineEnd = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_GetLineEnd), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_GetLineEnd);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const CString&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringConversion_GetLineEndC = PRIVATE_MAXON_MF_CAST(decltype(StringConversion_GetLineEndC), &Hxx2::Wrapper<Hxx2::Unresolved>::StringConversion_GetLineEndC);
		#else
