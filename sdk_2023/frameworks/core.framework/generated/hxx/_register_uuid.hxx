...
namespace maxon
{
	...
	public:
		...
		UniqueHash GetUniqueHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const UuidInterface*) this)->GetUniqueHashCode(); return maxon::PrivateIncompleteNullReturnValue<UniqueHash>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
	...
	maxon::Bool UuidInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_CreateId = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_CreateId), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_CreateId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_Set = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_Set), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_Set);
		#else
		tbl->UuidInterface_Set = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_Set), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_Set);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_Set_1 = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_Set_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_Set_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_Get = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_Get), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_Get);
		#else
		tbl->UuidInterface_Get = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_Get), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_Get);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_ToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_Compare = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_Compare), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_Compare);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<UniqueHash>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_GetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_GetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_GetUniqueHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_DescribeIO);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_CreateUuidString = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_CreateUuidString), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_CreateUuidString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UuidInterface_CreateUuid = PRIVATE_MAXON_MF_CAST(decltype(UuidInterface_CreateUuid), &Hxx2::Wrapper<Hxx2::Unresolved>::UuidInterface_CreateUuid);
		#else
