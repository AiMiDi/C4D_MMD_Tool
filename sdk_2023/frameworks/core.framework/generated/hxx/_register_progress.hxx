...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ProgressInterface, , "net.maxon.interface.progress", "maxon.ProgressInterface", (ObserverObjectInterface::PrivateGetInterface()));
