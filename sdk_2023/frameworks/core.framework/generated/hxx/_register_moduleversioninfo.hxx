...
namespace maxon
{
	...
	maxon::Bool ModuleVersionInfoInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ModuleVersionInfoInterface_RegisterIntern = PRIVATE_MAXON_MF_CAST(decltype(ModuleVersionInfoInterface_RegisterIntern), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ModuleVersionInfoInterface_RegisterIntern);
		#else
