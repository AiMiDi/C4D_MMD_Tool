...
namespace maxon
{
	...
	maxon::Bool SystemProcessInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<SystemProcessObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_CreateProcess = PRIVATE_MAXON_MF_CAST(decltype(SystemProcessInterface_CreateProcess), &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_CreateProcess);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SystemProcessObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_StartProcessAndWait = PRIVATE_MAXON_MF_CAST(decltype(SystemProcessInterface_StartProcessAndWait), &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_StartProcessAndWait);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_GetSystemProcesses = PRIVATE_MAXON_MF_CAST(decltype(SystemProcessInterface_GetSystemProcesses), &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetSystemProcesses);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SystemProcessObjectRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_GetProcess = PRIVATE_MAXON_MF_CAST(decltype(SystemProcessInterface_GetProcess), &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_GetProcess);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<WAIT_PROCESS_RESULT>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SystemProcessInterface_WaitForProcess = PRIVATE_MAXON_MF_CAST(decltype(SystemProcessInterface_WaitForProcess), &Hxx2::Wrapper<Hxx2::Unresolved>::SystemProcessInterface_WaitForProcess);
		#else
