...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_TimerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(TimerInterface::MTable::_instance.TimerInterface_ObservableTimerStarted)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(TimerInterface::MTable::_instance.TimerInterface_ObservableTimerFinished)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(TimerInterface::MTable::_instance.TimerInterface_ObservableTimerOverload)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
/// @cond IGNORE
