...
namespace maxon
{
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_INNERMOST_MEMBER396(){ return enum396::INNERMOST_MEMBER_info; }
	...
	maxon::Bool DataTypeLib::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDataTypeType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDataTypeType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDataTypeType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetVoidType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetVoidType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetVoidType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetNullptrType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetNullptrType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetNullptrType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetGenericType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetGenericType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetGenericType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetGenericArithmeticType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetGenericArithmeticType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetGenericArithmeticType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetParametricTypeType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetParametricTypeType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetParametricTypeType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetComponentDescriptorType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetComponentDescriptorType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetComponentDescriptorType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetEllipsisType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetEllipsisType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetEllipsisType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetInvalidType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetInvalidType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetInvalidType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_Substitute = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_Substitute), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_Substitute);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetRuntimeDataType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetRuntimeDataType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetRuntimeDataType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Block<const Int>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetTupleMemberOffsets = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetTupleMemberOffsets), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetTupleMemberOffsets);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Block<const Int>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetMemberOrder = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetMemberOrder), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetMemberOrder);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DelegateDataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDelegateType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDelegateType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDelegateType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DelegateDataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDelegateType_1 = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDelegateType_1), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDelegateType_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_InvokeDelegate = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_InvokeDelegate), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_InvokeDelegate);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DelegateBase>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_CreateDelegate = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_CreateDelegate), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_CreateDelegate);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDelegateReturnType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDelegateReturnType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDelegateReturnType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Block<const DataType>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDelegateParameterTypes = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDelegateParameterTypes), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDelegateParameterTypes);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<EnumDataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetEnumType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetEnumType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetEnumType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Block<const Tuple<Id, Data>>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetEnumerators = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetEnumerators), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetEnumerators);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_RegisterEnumType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_RegisterEnumType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_RegisterEnumType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDataTypeOfInterfaces = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDataTypeOfInterfaces), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDataTypeOfInterfaces);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetReferenceType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetReferenceType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetReferenceType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Tuple<DataType, const Char*>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_ParseDataType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_ParseDataType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_ParseDataType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Tuple<Member, const Char*>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_ParseMember = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_ParseMember), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_ParseMember);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Tuple<Int64, const Char*>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_ParseInt = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_ParseInt), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_ParseInt);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDataType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDataType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDataType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetNumberedId = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetNumberedId), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetNumberedId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<const MemberMap*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetMemberMap = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetMemberMap), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetMemberMap);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<const MemberMap*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetIdentityMemberMap = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetIdentityMemberMap), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetIdentityMemberMap);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<const MemberMap*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_ConcatMemberMap = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_ConcatMemberMap), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_ConcatMemberMap);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<const MemberMap*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetMemberMap_1 = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetMemberMap_1), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetMemberMap_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_GetDataTypeForData = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_GetDataTypeForData), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_GetDataTypeForData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_ConvertToData = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_ConvertToData), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_ConvertToData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_MoveFromData = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_MoveFromData), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_MoveFromData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<StrongRef<TypeArguments>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_CreateTypeArguments = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_CreateTypeArguments), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_CreateTypeArguments);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<StrongRef<TypeArguments>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_CreateTypeArguments_1 = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_CreateTypeArguments_1), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_CreateTypeArguments_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultMem>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_FinalizeTypeArguments = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_FinalizeTypeArguments), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_FinalizeTypeArguments);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataType&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataTypeLib_PrivateGetPrimaryDataTypeType = PRIVATE_MAXON_MF_CAST(decltype(DataTypeLib_PrivateGetPrimaryDataTypeType), &Hxx2::Wrapper<Hxx2::Unresolved>::DataTypeLib_PrivateGetPrimaryDataTypeType);
		#else
