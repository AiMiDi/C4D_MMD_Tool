...
namespace maxon
{
	...
	namespace enum620
	{
		...
		static const maxon::UInt64 ENUM_DONT_INITIALIZE_values[] = {maxon::UInt64(enum620::ENUM_DONT_INITIALIZE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_ENUM_DONT_INITIALIZE620(){ return enum620::ENUM_DONT_INITIALIZE_info; }
	namespace enum630
	{
		...
		static const maxon::UInt64 IN_PLACE_TYPE_values[] = {maxon::UInt64(enum630::IN_PLACE_TYPE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IN_PLACE_TYPE630(){ return enum630::IN_PLACE_TYPE_info; }
...
/// @cond INTERNAL
	...
	namespace enum1772
	{
		...
		static const maxon::UInt64 TYPE_values[] = {maxon::UInt64(enum1772::TYPE::INVALID_0), maxon::UInt64(enum1772::TYPE::INTERFACE), maxon::UInt64(enum1772::TYPE::INTERFACE_NVMTABLE), maxon::UInt64(enum1772::TYPE::NONVIRTUAL_INTERFACE), maxon::UInt64(enum1772::TYPE::DECLARATION), maxon::UInt64(enum1772::TYPE::COMPONENT), maxon::UInt64(enum1772::TYPE::CLASS), maxon::UInt64(enum1772::TYPE::TRANSLATION_UNIT), maxon::UInt64(enum1772::TYPE::MODULE), maxon::UInt64(enum1772::TYPE::INITIALIZATION), maxon::UInt64(enum1772::TYPE::DEPENDENCY), maxon::UInt64(enum1772::TYPE::REGISTRY), maxon::UInt64(enum1772::TYPE::UNUSED), maxon::UInt64(enum1772::TYPE::GLOBAL), maxon::UInt64(enum1772::TYPE::COUNT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TYPE1772(void*){ return enum1772::TYPE_info; }
	namespace enum1899
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum1899::FLAGS::NONE), maxon::UInt64(enum1899::FLAGS::CONSTRUCTED), maxon::UInt64(enum1899::FLAGS::DISABLED), maxon::UInt64(enum1899::FLAGS::INITIALIZED), maxon::UInt64(enum1899::FLAGS::INITIALIZING), maxon::UInt64(enum1899::FLAGS::INITIALIZATION_FAILED), maxon::UInt64(enum1899::FLAGS::NULL_AS_DEFAULT), maxon::UInt64(enum1899::FLAGS::USED), maxon::UInt64(enum1899::FLAGS::HIDDEN), maxon::UInt64(enum1899::FLAGS::REGISTRATION_UNIT), maxon::UInt64(enum1899::FLAGS::DEFINITION), maxon::UInt64(enum1899::FLAGS::SINGLE_BASE), maxon::UInt64(enum1899::FLAGS::IGNORE_WARNINGS), maxon::UInt64(enum1899::FLAGS::EXPLICIT), maxon::UInt64(enum1899::FLAGS::FRAMEWORK), maxon::UInt64(enum1899::FLAGS::CORE), maxon::UInt64(enum1899::FLAGS::PROXY), maxon::UInt64(enum1899::FLAGS::CLASS_PROXY), maxon::UInt64(enum1899::FLAGS::FINAL), maxon::UInt64(enum1899::FLAGS::SINGLE_IMPLEMENTATION), maxon::UInt64(enum1899::FLAGS::MAIN_DEFINITION), maxon::UInt64(enum1899::FLAGS::CALLABLE), maxon::UInt64(enum1899::FLAGS::IMPLEMENTABLE), maxon::UInt64(enum1899::FLAGS::ADAPTER), maxon::UInt64(enum1899::FLAGS::SYNTHETIC), maxon::UInt64(enum1899::FLAGS::LIVE), maxon::UInt64(enum1899::FLAGS::EXPECT_FAILURE), maxon::UInt64(enum1899::FLAGS::FRAMEWORK_REGISTRATION), maxon::UInt64(enum1899::FLAGS::EXTENDED), maxon::UInt64(enum1899::FLAGS::MARK), maxon::UInt64(enum1899::FLAGS::PUBLIC), maxon::UInt64(enum1899::FLAGS::REFERENCE_NONE), maxon::UInt64(enum1899::FLAGS::REFERENCE_POINTER), maxon::UInt64(enum1899::FLAGS::REFERENCE_CONST_POINTER), maxon::UInt64(enum1899::FLAGS::REFERENCE_NORMAL), maxon::UInt64(enum1899::FLAGS::REFERENCE_CONST), maxon::UInt64(enum1899::FLAGS::REFERENCE_COPY_ON_WRITE), maxon::UInt64(enum1899::FLAGS::REFERENCE_ALWAYS_COPY_ON_WRITE), maxon::UInt64(enum1899::FLAGS::REFERENCE_MASK), maxon::UInt64(enum1899::FLAGS::ON_CONSTRUCTION_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FLAGS1899(void*){ return enum1899::FLAGS_info; }
	namespace details
	{
...
/// @endcond
	...
	namespace enum2419
	{
		...
		static const maxon::UInt64 VALUEKIND_values[] = {maxon::UInt64(enum2419::VALUEKIND::NONE), maxon::UInt64(enum2419::VALUEKIND::VOID_TYPE), maxon::UInt64(enum2419::VALUEKIND::GENERIC), maxon::UInt64(enum2419::VALUEKIND::GENERIC_ARITHMETIC), maxon::UInt64(enum2419::VALUEKIND::SCALAR), maxon::UInt64(enum2419::VALUEKIND::INTEGRAL), maxon::UInt64(enum2419::VALUEKIND::FLOATING_POINT), maxon::UInt64(enum2419::VALUEKIND::ENUM), maxon::UInt64(enum2419::VALUEKIND::ENUM_LIST), maxon::UInt64(enum2419::VALUEKIND::ENUM_FLAGS), maxon::UInt64(enum2419::VALUEKIND::DATA), maxon::UInt64(enum2419::VALUEKIND::DATAPTR), maxon::UInt64(enum2419::VALUEKIND::NONVIRTUAL_INTERFACE), maxon::UInt64(enum2419::VALUEKIND::VIRTUAL_INTERFACE), maxon::UInt64(enum2419::VALUEKIND::REF_OR_POINTER), maxon::UInt64(enum2419::VALUEKIND::POINTER), maxon::UInt64(enum2419::VALUEKIND::STRONG_REFERENCE), maxon::UInt64(enum2419::VALUEKIND::COW_REFERENCE), maxon::UInt64(enum2419::VALUEKIND::UNIQUE_REFERENCE), maxon::UInt64(enum2419::VALUEKIND::ACOW_REFERENCE), maxon::UInt64(enum2419::VALUEKIND::LV_REFERENCE), maxon::UInt64(enum2419::VALUEKIND::RV_REFERENCE), maxon::UInt64(enum2419::VALUEKIND::TUPLE), maxon::UInt64(enum2419::VALUEKIND::STRUCT), maxon::UInt64(enum2419::VALUEKIND::SIMD), maxon::UInt64(enum2419::VALUEKIND::BLOCK), maxon::UInt64(enum2419::VALUEKIND::STRIDED_BLOCK), maxon::UInt64(enum2419::VALUEKIND::BASEARRAY), maxon::UInt64(enum2419::VALUEKIND::BLOCKARRAY), maxon::UInt64(enum2419::VALUEKIND::RESULT), maxon::UInt64(enum2419::VALUEKIND::DELEGATE), maxon::UInt64(enum2419::VALUEKIND::FUNCTION), maxon::UInt64(enum2419::VALUEKIND::CONST_QUALIFIED), maxon::UInt64(enum2419::VALUEKIND::SOURCE_LEVEL), maxon::UInt64(enum2419::VALUEKIND::DEEP_CONSTNESS), maxon::UInt64(enum2419::VALUEKIND::INT_SIZE_OR_LESS), maxon::UInt64(enum2419::VALUEKIND::ZERO_INITIALIZED), maxon::UInt64(enum2419::VALUEKIND::ORDERED), maxon::UInt64(enum2419::VALUEKIND::TRIVIALLY_CONSTRUCTIBLE), maxon::UInt64(enum2419::VALUEKIND::TRIVIALLY_DESTRUCTIBLE), maxon::UInt64(enum2419::VALUEKIND::TRIVIALLY_COPYABLE), maxon::UInt64(enum2419::VALUEKIND::TRIVIALLY_EQUATABLE), maxon::UInt64(enum2419::VALUEKIND::TRIVIALLY_HASHABLE), maxon::UInt64(enum2419::VALUEKIND::OBJECT_REF), maxon::UInt64(enum2419::VALUEKIND::VALUE), maxon::UInt64(enum2419::VALUEKIND::ELEMENT_TYPE_AS_ARG), maxon::UInt64(enum2419::VALUEKIND::NEVER_NULLPTR), maxon::UInt64(enum2419::VALUEKIND::SIGNED), maxon::UInt64(enum2419::VALUEKIND::GENERIC_INSTANTIATION), maxon::UInt64(enum2419::VALUEKIND::ABSTRACT), maxon::UInt64(enum2419::VALUEKIND::NAMED), maxon::UInt64(enum2419::VALUEKIND::CONTAINER_REF), maxon::UInt64(enum2419::VALUEKIND::GENERIC_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::RECURSIVE_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::RESOLVED_RECURSIVE_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::CONTAINER), maxon::UInt64(enum2419::VALUEKIND::EMPTY_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::VIRTUAL_TUPLE_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::STATIC_ARRAY_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::ARRAY_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::ARRAY), maxon::UInt64(enum2419::VALUEKIND::CONTAINER_MASK), maxon::UInt64(enum2419::VALUEKIND::NAMED_TUPLE), maxon::UInt64(enum2419::VALUEKIND::CONTAINS_RECURSIVE_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::CONTAINS_INVALID_TYPE), maxon::UInt64(enum2419::VALUEKIND::BUNDLE), maxon::UInt64(enum2419::VALUEKIND::MIN_DERIVED_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::MIN_ARRAY_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::MAX_ARRAY_CONTAINER), maxon::UInt64(enum2419::VALUEKIND::COW_MASK), maxon::UInt64(enum2419::VALUEKIND::STRONG_MASK), maxon::UInt64(enum2419::VALUEKIND::PTR_MASK), maxon::UInt64(enum2419::VALUEKIND::CONTAINER_OR_REF), maxon::UInt64(enum2419::VALUEKIND::REFERENCE_MASK), maxon::UInt64(enum2419::VALUEKIND::ARITHMETIC_MASK), maxon::UInt64(enum2419::VALUEKIND::TUPLE_MASK), maxon::UInt64(enum2419::VALUEKIND::TUPLE_INHERIT_MASK), maxon::UInt64(enum2419::VALUEKIND::POINTER_FLAGS), maxon::UInt64(enum2419::VALUEKIND::QUALIFIER_MASK), maxon::UInt64(enum2419::VALUEKIND::CONTAINS_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VALUEKIND2419(){ return enum2419::VALUEKIND_info; }
	...
	namespace enum2466
	{
		...
		static const maxon::UInt64 COLLECTION_KIND_values[] = {maxon::UInt64(enum2466::COLLECTION_KIND::NONE), maxon::UInt64(enum2466::COLLECTION_KIND::ARRAY), maxon::UInt64(enum2466::COLLECTION_KIND::SET), maxon::UInt64(enum2466::COLLECTION_KIND::MAP)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_COLLECTION_KIND2466(){ return enum2466::COLLECTION_KIND_info; }
