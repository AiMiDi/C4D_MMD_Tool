...
struct DataDescriptionUIInterface::Hxx2
{
	...
	PRIVATE_MAXON_SF_POINTER(DataDescriptionUIInterface_EvaluateCondition_1, EvaluateCondition, MAXON_EXPAND_VA_ARGS, (Result<Bool>), const CString& condition, const DataDescriptionWithUIAndString& description, const GetDataCallbackType& getDataCallback, const HashMap<CString, CString>& externalVariables);
	PRIVATE_MAXON_SF_POINTER(DataDescriptionUIInterface_EvaluateCondition_2, EvaluateCondition, MAXON_EXPAND_VA_ARGS, (Result<Bool>), const CString& condition, const DataDescriptionWithUIAndString& description, const GetDescEntriesCallbackType& getDescCallback, const GetDataCallbackType& getDataCallback, const HashMap<CString, CString>& externalVariables);
	PRIVATE_MAXON_SF_POINTER(DataDescriptionUIInterface_TokenizeCondition, TokenizeCondition, MAXON_EXPAND_VA_ARGS, (Result<BaseArray<CString>>), const CString& condition, const DataDescriptionWithUIAndString& description, const GetDescEntriesCallbackType& getDescCallback, const GetDataCallbackType& getDataCallback, const ValueReceiver<const ConditionToken&>& tokenRecv);
		...
		tbl->DataDescriptionUIInterface_EvaluateCondition_2 = DataDescriptionUIInterface_EvaluateCondition_2_GetPtr<IMPL>(true);
...
[[deprecated("Use other EvaluateCondition")]] MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionUIInterface::EvaluateCondition(const CString& condition, const DataDescriptionWithUIAndString& description, const BaseArray<DataDictionary>& uiEntries, const GetDataCallbackType& getDataCallback, const HashMap<CString, CString>& externalVariables) -> Result<Bool>
{
...
{
	return Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition_1(condition, description, getDataCallback, externalVariables);
}
...
{
	return Hxx2::StaticMTable::_instance.DataDescriptionUIInterface_EvaluateCondition_2(condition, description, getDescCallback, getDataCallback, externalVariables);
}
