...
namespace maxon
{
	...
	public:
		...
		UniqueHash GetUniqueHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const StringInterface*) this)->GetUniqueHashCode(); return maxon::PrivateIncompleteNullReturnValue<UniqueHash>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
	...
	maxon::Bool StringInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Shrink = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Shrink), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Shrink);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Append = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Append), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Append);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Append_1 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Append_1), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Append_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Erase = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Erase), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Erase);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Insert = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Insert), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Insert);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Insert_1 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Insert_1), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Insert_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_ComparePart = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_ComparePart), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_ComparePart);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<UniqueHash>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUniqueHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetUtf32 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetUtf32), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUtf32);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_TrimLeft = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_TrimLeft), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_TrimLeft);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_TrimRight = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_TrimRight), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_TrimRight);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Split = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Split), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Split);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Replace = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Replace), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Replace_1 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Replace_1), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Replace_2 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Replace_2), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Replace_2);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetCStringBlock = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetCStringBlock), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCStringBlock);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetCStringAppendArray = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetCStringAppendArray), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCStringAppendArray);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetCString = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetCString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetCString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetCString = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_SetCString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetCString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<SysCharArray>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetSystemEncoding = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetSystemEncoding), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetSystemEncoding);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetSystemEncoding = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_SetSystemEncoding), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetSystemEncoding);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetUtf32 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_SetUtf32), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetUtf32);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetUtf16 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetUtf16), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetUtf16);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_SetUtf16 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_SetUtf16), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_SetUtf16);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetAndCacheConstString = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetAndCacheConstString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetAndCacheConstString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetAndCacheConstString_1 = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetAndCacheConstString_1), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetAndCacheConstString_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_PrivateEnumToString = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_PrivateEnumToString), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_PrivateEnumToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<StridedBlock<const Generic>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_GetVariableInternalData = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_GetVariableInternalData), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_GetVariableInternalData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->StringInterface_Prettify = PRIVATE_MAXON_MF_CAST(decltype(StringInterface_Prettify), &Hxx2::Wrapper<Hxx2::Unresolved>::StringInterface_Prettify);
		#else
	...
	public:
		...
		UniqueHash GetUniqueHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const CStringInterface*) this)->GetUniqueHashCode(); return maxon::PrivateIncompleteNullReturnValue<UniqueHash>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		Result<Block<Char>> Disconnect() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((CStringInterface*) this)->Disconnect(); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	...
	const maxon::NULL_RETURN_TYPE CStringInterface::MTable::_returnTypes[] = 
	{
		...
		maxon::details::NullReturnType<Result<Int>>::value,
		maxon::details::NullReturnType<Result<void>>::value,
		maxon::details::NullReturnType<Result<Block<Char>>>::value,
		maxon::details::NullReturnType<Result<void>>::value,
		maxon::details::NullReturnType<Result<BaseArray<Char>>>::value,
	...
	maxon::Bool CStringInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Shrink = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Shrink), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Shrink);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Append = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Append), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Append);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Append_1 = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Append_1), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Append_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Erase = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Erase), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Erase);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Insert = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Insert), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Insert);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Insert_1 = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Insert_1), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Insert_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_ComparePart = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_ComparePart), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_ComparePart);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<UniqueHash>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetUniqueHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetUtf32 = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetUtf32), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetUtf32);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_TrimLeft = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_TrimLeft), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_TrimLeft);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_TrimRight = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_TrimRight), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_TrimRight);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Split = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Split), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Split);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Replace = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Replace), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Replace_1 = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Replace_1), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Replace_2 = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Replace_2), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Replace_2);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetCStringBlock = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetCStringBlock), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCStringBlock);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetCStringAppendArray = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetCStringAppendArray), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCStringAppendArray);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Block<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_Disconnect = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_Disconnect), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_Disconnect);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_SetCString = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_SetCString), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_SetCString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetCString = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetCString), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetCString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Block<const Char>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetInternalData = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetInternalData), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetInternalData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const CString&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CStringInterface_GetAndCacheConstString = PRIVATE_MAXON_MF_CAST(decltype(CStringInterface_GetAndCacheConstString), &Hxx2::Wrapper<Hxx2::Unresolved>::CStringInterface_GetAndCacheConstString);
		#else
