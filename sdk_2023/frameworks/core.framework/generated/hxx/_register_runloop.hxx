...
namespace maxon
{
	...
	maxon::Bool RunLoop::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_EnterLoop = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_EnterLoop), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop);
		#else
		tbl->RunLoop_EnterLoop = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_EnterLoop), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_EnterLoop_1 = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_EnterLoop_1), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_EnterLoop_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Timer*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_AddTimer = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_AddTimer), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_AddTimer);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableExitLoopDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_ObservableExitLoop = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_ObservableExitLoop), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableExitLoop);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableActivationChangeDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_ObservableActivationChange = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_ObservableActivationChange), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableActivationChange);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableRunLoopMessageDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->RunLoop_ObservableRunLoopMessage = PRIVATE_MAXON_MF_CAST(decltype(RunLoop_ObservableRunLoopMessage), &Hxx2::Wrapper<Hxx2::Unresolved>::RunLoop_ObservableRunLoopMessage);
		#else
