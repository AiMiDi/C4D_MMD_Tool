...
namespace maxon
{
	...
	maxon::Bool Configuration::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryBool = PRIVATE_MAXON_MF_CAST(decltype(Configuration_QueryBool), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryBool);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryInt = PRIVATE_MAXON_MF_CAST(decltype(Configuration_QueryInt), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryInt);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryFloat = PRIVATE_MAXON_MF_CAST(decltype(Configuration_QueryFloat), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryFloat);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_QueryString = PRIVATE_MAXON_MF_CAST(decltype(Configuration_QueryString), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_QueryString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForBool = PRIVATE_MAXON_MF_CAST(decltype(Configuration_AddHelpForBool), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForBool);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForInt = PRIVATE_MAXON_MF_CAST(decltype(Configuration_AddHelpForInt), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForInt);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForFloat = PRIVATE_MAXON_MF_CAST(decltype(Configuration_AddHelpForFloat), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForFloat);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForString = PRIVATE_MAXON_MF_CAST(decltype(Configuration_AddHelpForString), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_AddHelpForOption = PRIVATE_MAXON_MF_CAST(decltype(Configuration_AddHelpForOption), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_AddHelpForOption);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastBool = PRIVATE_MAXON_MF_CAST(decltype(Configuration_BroadcastBool), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastBool);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastInt = PRIVATE_MAXON_MF_CAST(decltype(Configuration_BroadcastInt), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastInt);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastFloat = PRIVATE_MAXON_MF_CAST(decltype(Configuration_BroadcastFloat), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastFloat);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Configuration_BroadcastString = PRIVATE_MAXON_MF_CAST(decltype(Configuration_BroadcastString), &Hxx2::Wrapper<Hxx2::Unresolved>::Configuration_BroadcastString);
		#else
