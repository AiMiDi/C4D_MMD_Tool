...
/// @endcond
	...
	maxon::Bool JobQueueInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<JobQueueInterface*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->JobQueueInterface_Alloc = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_Alloc), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_Alloc);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->JobQueueInterface_SetDestinationQueue = PRIVATE_MAXON_MF_CAST(decltype(JobQueueInterface_SetDestinationQueue), &Hxx2::Wrapper<Hxx2::Unresolved>::JobQueueInterface_SetDestinationQueue);
		#else
