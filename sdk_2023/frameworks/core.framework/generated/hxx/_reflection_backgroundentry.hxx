...
namespace maxon
{
	...
	public:
		...
		maxon::ObservableRef<ObservableStateChangedDelegate> ObservableStateChanged() const 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_ObservableStateChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableStateChangedDelegate>)), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_ObservableStateChanged)));
			return proxy_result;
		}
