...
struct CrashHandler::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(CrashHandler_ObservableCrashDataDirectory, ObservableCrashDataDirectory, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableCrashDataDirectoryDelegate>));
