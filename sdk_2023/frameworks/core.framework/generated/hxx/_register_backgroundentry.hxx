...
namespace maxon
{
	...
	maxon::Bool BackgroundProgressInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<BackgroundProgressRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BackgroundProgressInterface_GetMaster = PRIVATE_MAXON_MF_CAST(decltype(BackgroundProgressInterface_GetMaster), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::BackgroundProgressInterface_GetMaster);
		#else
