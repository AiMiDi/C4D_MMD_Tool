...
struct RegistryEntryIteratorInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(RegistryEntryIteratorInterface_HasValue, RegistryEntryIteratorInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryEntryIteratorInterface))->HasValue(); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryEntryIteratorInterface_MoveToNext, RegistryEntryIteratorInterface,, (void)) { return C::Get(PRIVATE_MAXON_MF_THIS(RegistryEntryIteratorInterface))->MoveToNext(); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryEntryIteratorInterface_GetId, RegistryEntryIteratorInterface, const, (const Id&)) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryEntryIteratorInterface))->GetId(); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryEntryIteratorInterface_GetEntry, RegistryEntryIteratorInterface, const, (ConstDataPtr)) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryEntryIteratorInterface))->GetEntry(); }
	};
...
struct RegistryInterface::Hxx2
{
	...
	public:
		using Implementation = C;
		PRIVATE_MAXON_MF_WRAPPER(RegistryInterface_GetId, RegistryInterface, const, (const Id&)) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryInterface))->GetId(); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryInterface_GetStamp, RegistryInterface, const, (UInt)) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryInterface))->GetStamp(); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryInterface_GetDataType, RegistryInterface, const, (const DataType&)) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryInterface))->GetDataType(); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryInterface_AddObserver, RegistryInterface, const, (Result<GenericData>), Delegate<void(const Id&eid,const ConstDataPtr&value,Bool inserted)>&& observer, Bool notifyDuringRegistration) { return C::Get(PRIVATE_MAXON_MF_THIS(const RegistryInterface))->AddObserver(std::forward<Delegate<void(const Id&eid,const ConstDataPtr&value,Bool inserted)>>(observer), notifyDuringRegistration); }
