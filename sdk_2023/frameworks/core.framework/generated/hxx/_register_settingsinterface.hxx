...
namespace maxon
{
	...
	maxon::Bool SettingsInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<SettingsRef>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SettingsInterface_GetSettings = PRIVATE_MAXON_MF_CAST(decltype(SettingsInterface_GetSettings), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::SettingsInterface_GetSettings);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableSettingsChangedDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SettingsInterface_ObservableSettingsChanged = PRIVATE_MAXON_MF_CAST(decltype(SettingsInterface_ObservableSettingsChanged), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::SettingsInterface_ObservableSettingsChanged);
		#else
