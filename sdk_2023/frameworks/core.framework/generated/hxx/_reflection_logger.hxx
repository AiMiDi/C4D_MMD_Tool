...
namespace maxon
{
	...
	public:
		...
		maxon::ObservableRef<ObservableLoggerNotifyDelegate> ObservableLoggerNotify() const 
		{
			...
			(*handler_)(_fn_LoggerTypeInterface_ObservableLoggerNotify, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableLoggerNotifyDelegate>)), reinterpret_cast<const void* const&>(mt_.LoggerTypeInterface_ObservableLoggerNotify)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_LoggerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(LoggerInterface::MTable::_instance.LoggerInterface_ObservableLoggerNew)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
