...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_RunLoop(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(RunLoop::MTable::_instance.RunLoop_ObservableExitLoop)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(RunLoop::MTable::_instance.RunLoop_ObservableActivationChange)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(RunLoop::MTable::_instance.RunLoop_ObservableRunLoopMessage)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
