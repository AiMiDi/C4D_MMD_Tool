...
namespace maxon
{
	...
	maxon::Bool DebugHardwareBreakPointInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DebugHardwareBreakPointRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DebugHardwareBreakPointInterface_SetHardwareBreakpoint = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_SetHardwareBreakpoint), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_SetHardwareBreakpoint);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint);
		#else
