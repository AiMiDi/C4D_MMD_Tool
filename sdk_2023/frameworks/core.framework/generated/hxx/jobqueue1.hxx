...
/// @param[in] ownerId						Owner id of the queue.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type EnableThreadAffinity(UInt ownerId) const;
...
/// THREADSAFE.
/// @param[in] ownerId						Owner id of the queue.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type AlwaysUseCurrentThread(UInt ownerId) const;
...
/// THREADSAFE.
/// @param[in] ownerId						Owner id of the queue.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type SetIdleSpinTime(UInt ownerId, TimeValue spinTime) const;
/// @cond IGNORE
