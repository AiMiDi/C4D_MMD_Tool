...
/// @endcond
		...
		maxon::ObservableRef<ObserverDestroyedDelegate> ObserverDestroyed() const 
		{
			...
			(*handler_)(_fn_ObserverObjectInterface_ObserverDestroyed, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObserverDestroyedDelegate>)), reinterpret_cast<const void* const&>(mt_.ObserverObjectInterface_ObserverDestroyed)));
			return proxy_result;
		}
