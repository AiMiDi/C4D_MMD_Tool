...
namespace maxon
{
	...
	maxon::Bool DataDescriptionDefinitionInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->DataDescriptionDefinitionInterface_NullValuePtr = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionInterface_NullValuePtr), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::DataDescriptionDefinitionInterface_NullValuePtr);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataDescriptionDefinitionInterface, , "net.maxon.interface.datadescriptiondefinition", "maxon.DataDescriptionDefinitionInterface", (ObjectInterface::PrivateGetInterface()));
