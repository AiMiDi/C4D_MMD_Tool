...
/// @cond INTERNAL
	...
	maxon::Bool ThreadServices::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_Start = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_Start), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_Start);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_GetResult = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_GetResult), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_GetResult);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_Reset = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_Reset), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_Reset);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_AddFinishedObserver = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_AddFinishedObserver), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_AddFinishedObserver);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_AddCancelledObserver = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_AddCancelledObserver), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_AddCancelledObserver);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_RemoveCancelledObserver = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_RemoveCancelledObserver), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_RemoveCancelledObserver);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<THREADTYPE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_GetCurrentThreadType = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_GetCurrentThreadType), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_GetCurrentThreadType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<THREADTYPE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_GetCurrentThreadType_1 = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_GetCurrentThreadType_1), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_GetCurrentThreadType_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_GroupGetResult = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_GroupGetResult), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_GroupGetResult);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_AddJob = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_AddJob), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_AddJob);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_AddGroup = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_AddGroup), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_AddGroup);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_EnqueueGroupAndWait = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_EnqueueGroupAndWait), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_EnqueueGroupAndWait);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_GroupBatchAdd = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_GroupBatchAdd), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_GroupBatchAdd);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_AddGroupFinishedObserver = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_AddGroupFinishedObserver), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_AddGroupFinishedObserver);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ThreadServices_AssimilateAlienThread = PRIVATE_MAXON_MF_CAST(decltype(ThreadServices_AssimilateAlienThread), &Hxx2::Wrapper<Hxx2::Unresolved>::ThreadServices_AssimilateAlienThread);
		#else
