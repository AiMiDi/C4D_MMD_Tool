...
namespace maxon
{
	...
	maxon::Bool LoggerInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_AddLoggerType = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_AddLoggerType), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_AddLoggerType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_RemoveLoggerType = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_RemoveLoggerType), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_RemoveLoggerType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_RemoveLoggerTypes = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_RemoveLoggerTypes), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_RemoveLoggerTypes);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_Write = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_Write), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_Write);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_GetName = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_GetName), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_GetName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<BaseArray<Pair<LoggerTypeRef, TARGETAUDIENCE>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_GetLoggerTypes = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_GetLoggerTypes), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_GetLoggerTypes);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<maxon::ObservableRef<ObservableLoggerNewDelegate>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_ObservableLoggerNew = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_ObservableLoggerNew), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_ObservableLoggerNew);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LoggerInterface_AddNewLogger = PRIVATE_MAXON_MF_CAST(decltype(LoggerInterface_AddNewLogger), &Hxx2::Wrapper<Hxx2::Unresolved>::LoggerInterface_AddNewLogger);
		#else
