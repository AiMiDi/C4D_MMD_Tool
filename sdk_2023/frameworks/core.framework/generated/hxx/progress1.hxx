...
/// Returns the details of the progress.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type GetDetailsText() const;
/// SupportsCancelJob returns true if the progress object supports job cancellation.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type SupportsCancelJob() const;
	};
	/// Intermediate helper class for ProgressInterface.
...
/// @param[in] details						New details to be set.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type SetDetailsText(const String& details) const;
...
/// IsCancelled returns true if the job is cancelled.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type IsCancelled() const;
	};
	/// Intermediate helper class for ProgressInterface.
...
/// Sets the details of the progress.
/// @param[in] details						New details to be set.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type SetDetailsText(const String& details);
/// SetCancelJobDelegate allows to set a job cancellation delegate.
/// @param[in] cancelJobDelegate	Delegate which is called to cancel the job
/// @return                       OK on success.
...
/// IsCancelled returns true if the job is cancelled.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), Bool, maxon::Result<Bool>>::type IsCancelled();
	};
