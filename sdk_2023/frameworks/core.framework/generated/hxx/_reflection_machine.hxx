...
namespace maxon
{
	...
	public:
		...
		maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> ObservablePrivateSplashMessageReceived() const 
		{
			...
			(*handler_)(_fn_MachineInterface_ObservablePrivateSplashMessageReceived, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>)), reinterpret_cast<const void* const&>(mt_.MachineInterface_ObservablePrivateSplashMessageReceived)));
			return proxy_result;
		}
		...
		maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged() const 
		{
			...
			(*handler_)(_fn_MachineInterface_ObservableActivationChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableActivationChangedDelegate>)), reinterpret_cast<const void* const&>(mt_.MachineInterface_ObservableActivationChanged)));
			return proxy_result;
		}
...
/// @endcond
			...
			maxon::reflection::GetFunctionInfo<decltype(MachinesInterface::MTable::_instance.MachinesInterface_ObservableMachineStateChanged)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
