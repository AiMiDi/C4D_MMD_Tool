...
namespace maxon
{
	...
	public:
		...
		static Result<Id> ResolveVariableIdentifier(const Id& identifier, const AssetRepositoryRef& repository, const GetDataCallbackType& getDataCallback, Opt<const DataDictionary&> dataEntry, Opt<const DataDictionary&> guiEntry) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return DataDescriptionDatabaseInterface::ResolveVariableIdentifier(identifier, repository, getDataCallback, std::forward<Opt<const DataDictionary&>>(dataEntry), std::forward<Opt<const DataDictionary&>>(guiEntry)); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	...
	const maxon::NULL_RETURN_TYPE DataDescriptionDatabaseInterface::MTable::_returnTypes[] = 
	{
		...
		maxon::details::NullReturnType<Result<BaseArray<Tuple<Id, Data, String>>>>::value,
		maxon::details::NullReturnType<Result<void>>::value,
		maxon::details::NullReturnType<Result<Id>>::value,
		maxon::details::NullReturnType<Result<Id>>::value,
	...
	maxon::Bool DataDescriptionDatabaseInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<DataDescription>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_LoadDescription = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDatabaseInterface_LoadDescription), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_LoadDescription);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<DataDescription>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_LoadDescription_1 = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDatabaseInterface_LoadDescription_1), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_LoadDescription_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Tuple<Id, Data, String>>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_GetEffectiveEnumList_1 = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDatabaseInterface_GetEffectiveEnumList_1), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_GetEffectiveEnumList_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Id>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_ResolveVariableIdentifier = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDatabaseInterface_ResolveVariableIdentifier), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_ResolveVariableIdentifier);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Id>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDatabaseInterface_GetAndResolvePresetIdentifier = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDatabaseInterface_GetAndResolvePresetIdentifier), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDatabaseInterface_GetAndResolvePresetIdentifier);
		#else
