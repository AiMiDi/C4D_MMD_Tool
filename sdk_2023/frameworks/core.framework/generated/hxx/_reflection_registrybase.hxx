...
/// @cond INTERNAL
	...
	static maxon::Result<void> RegisterReflection_RegistryEntryIteratorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<decltype(RegistryEntryIteratorInterface::MTable::_instance.RegistryEntryIteratorInterface_Free)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "iterator\0", 1LL, nullptr),
