...
namespace maxon
{
	...
	public:
		...
		static Result<Array<Generic>> ConvertToSingleBlock(const Array<Generic>& source) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ArrayFactory::ConvertToSingleBlock(source); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::NULL_RETURN_TYPE ArrayFactory::MTable::_returnTypes[] = 
	{
		maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value,
		maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value,
		maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value,
		maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value,
		maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value,
	...
	maxon::Bool ArrayFactory::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_NewBaseArray = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_NewBaseArray), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_NewBaseArray);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_NewBaseArrayFromContainerType = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_NewBaseArrayFromContainerType), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_NewBaseArrayFromContainerType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_NewBlockArray = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_NewBlockArray), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_NewBlockArray);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_NewPagedArray = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_NewPagedArray), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_NewPagedArray);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_NewPagedArrayFromContainerType = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_NewPagedArrayFromContainerType), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_NewPagedArrayFromContainerType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_Slice = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_Slice), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_Slice);
		#else
		tbl->ArrayFactory_Slice = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_Slice), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_Slice);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_NewSingleValueArray = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_NewSingleValueArray), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_NewSingleValueArray);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_ExtractMember = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_ExtractMember), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_ExtractMember);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_Reinterpret = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_Reinterpret), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_Reinterpret);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>::NonConst>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_PrivateNewPagedArrayFromBase = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_PrivateNewPagedArrayFromBase), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_PrivateNewPagedArrayFromBase);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Array<Generic>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ArrayFactory_ConvertToSingleBlock = PRIVATE_MAXON_MF_CAST(decltype(ArrayFactory_ConvertToSingleBlock), &Hxx2::Wrapper<Hxx2::Unresolved>::ArrayFactory_ConvertToSingleBlock);
		#else
