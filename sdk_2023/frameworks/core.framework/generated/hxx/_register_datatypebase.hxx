...
namespace maxon
{
	...
	namespace enum601
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum601::FLAGS::NONE), maxon::UInt64(enum601::FLAGS::GLOBALLY_REFERENCED), maxon::UInt64(enum601::FLAGS::OWNS_NULL_VALUE)};
		static const maxon::EnumInfo FLAGS_info{"DataTypeImpl::FLAGS", SIZEOF(FLAGS), true, "NONE\0GLOBALLY_REFERENCED\0OWNS_NULL_VALUE\0", FLAGS_values, std::extent<decltype(FLAGS_values)>::value};
	}
	...
	namespace enum1069
	{
		...
		static const maxon::UInt64 BASE_OF_MODE_values[] = {maxon::UInt64(enum1069::BASE_OF_MODE::NONE), maxon::UInt64(enum1069::BASE_OF_MODE::ORDERED_TYPE_ONLY), maxon::UInt64(enum1069::BASE_OF_MODE::UNORDERED_BY_NAME), maxon::UInt64(enum1069::BASE_OF_MODE::GENERIC_DOWNCAST)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_BASE_OF_MODE1069(void*){ return enum1069::BASE_OF_MODE_info; }
	...
	namespace enum1174
	{
		...
		static const maxon::UInt64 GET_DATATYPE_POLICY_values[] = {maxon::UInt64(enum1174::GET_DATATYPE_POLICY::NONE), maxon::UInt64(enum1174::GET_DATATYPE_POLICY::GENERIC_FOR_UNKNOWN), maxon::UInt64(enum1174::GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN), maxon::UInt64(enum1174::GET_DATATYPE_POLICY::RESULT_FOR_UNKNOWN_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GET_DATATYPE_POLICY1174(){ return enum1174::GET_DATATYPE_POLICY_info; }
}
#endif
