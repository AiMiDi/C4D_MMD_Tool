...
namespace maxon
{
	...
	public:
		...
		static Result<void> WriteUserChangedDataBases() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return DataDescriptionDefinitionDatabaseInterface::WriteUserChangedDataBases(); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
	...
	maxon::Bool DataDescriptionDefinitionDatabaseInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<DataDescriptionDefinition>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_LoadDescription = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_LoadDescription), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_LoadDescription);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_StoreDescription = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_StoreDescription), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_StoreDescription);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<IdAndVersion>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_GetRegisteredDescriptions = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_GetRegisteredDescriptions), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_GetRegisteredDescriptions);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_WriteDataBases = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_WriteDataBases), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_WriteDataBases);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_RenameId = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_RenameId), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_RenameId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_RenameAttribute = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_RenameAttribute), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_RenameAttribute);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_CheckUniqueAttributeName = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_CheckUniqueAttributeName), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_CheckUniqueAttributeName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_RegisterDatabaseWithUrl = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_RegisterDatabaseWithUrl), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_RegisterDatabaseWithUrl);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_UnregisterDatabase = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_UnregisterDatabase), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_UnregisterDatabase);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_RegisterMessage = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_RegisterMessage), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_RegisterMessage);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_RegisterValueChangedMessage = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_RegisterValueChangedMessage), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_RegisterValueChangedMessage);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_FindNodeValueChangedMessage = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_FindNodeValueChangedMessage), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_FindNodeValueChangedMessage);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps = PRIVATE_MAXON_MF_CAST(decltype(DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps);
		#else
