...
namespace maxon
{
	...
	public:
		...
		void _intDisconnectAll(ObserverObjectInterface* observer, Int pass) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface__intDisconnectAll, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((void), ObserverObjectInterface*, Int), reinterpret_cast<const void* const&>(mt_.ObservableBaseInterface__intDisconnectAll)));
		}
		...
		Result<void> RemoveObserver(const FunctionBaseRef& observerEntry) 
		{
			...
			(*handler_)(_fn_ObservableBaseInterface_RemoveObserver, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const FunctionBaseRef&), reinterpret_cast<const void* const&>(mt_.ObservableBaseInterface_RemoveObserver)));
			return proxy_result;
		}
