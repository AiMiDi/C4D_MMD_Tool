...
namespace maxon
{
	...
	maxon::Bool SymbolificationInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SymbolificationInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(SymbolificationInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::SymbolificationInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SymbolificationInterface_FindSymbol = PRIVATE_MAXON_MF_CAST(decltype(SymbolificationInterface_FindSymbol), &Hxx2::Wrapper<Hxx2::Unresolved>::SymbolificationInterface_FindSymbol);
		#else
