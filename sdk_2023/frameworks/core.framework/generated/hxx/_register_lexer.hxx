...
namespace maxon
{
	...
	maxon::Bool LexerInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_AddOperator = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_AddOperator), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_AddOperator);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_Close = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_Close), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_Close);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Utf32Char>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_ReadNextChar = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_ReadNextChar), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_ReadNextChar);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_SkipSpaces = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_SkipSpaces), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_SkipSpaces);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_SkipLineToEnd = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_SkipLineToEnd), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_SkipLineToEnd);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<LEXERSYMBOL>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_ReadNextSymbol = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_ReadNextSymbol), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_ReadNextSymbol);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_ReadNextSymbolExpected = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_ReadNextSymbolExpected), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_ReadNextSymbolExpected);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LEXERSYMBOL>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetSymbol = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetSymbol), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetSymbol);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetIdent = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetIdent), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetIdent);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetFloat = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetFloat), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetFloat);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetFloat_1 = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetFloat_1), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetFloat_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetInt = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetInt), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetInt);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetInt_1 = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetInt_1), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetInt_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetUInt = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetUInt), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetUInt);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetUInt_1 = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetUInt_1), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetUInt_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetCurrentReadPosition = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetCurrentReadPosition), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetCurrentReadPosition);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int64>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LexerInterface_GetSymbolPosition = PRIVATE_MAXON_MF_CAST(decltype(LexerInterface_GetSymbolPosition), &Hxx2::Wrapper<Hxx2::Unresolved>::LexerInterface_GetSymbolPosition);
		#else
