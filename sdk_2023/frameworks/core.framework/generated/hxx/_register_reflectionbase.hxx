...
namespace maxon
{
	namespace reflection
	{
		...
		maxon::Bool Member::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
		{
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<KIND>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetKind = PRIVATE_MAXON_MF_CAST(decltype(Member_GetKind), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetKind);
			#else
			tbl->Member_GetKind = PRIVATE_MAXON_MF_CAST(decltype(Member_GetKind), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetKind);
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetSimpleName = PRIVATE_MAXON_MF_CAST(decltype(Member_GetSimpleName), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetSimpleName);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<const Id&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetId = PRIVATE_MAXON_MF_CAST(decltype(Member_GetId), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetId);
			#else
			tbl->Member_GetId = PRIVATE_MAXON_MF_CAST(decltype(Member_GetId), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetId);
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_ToString = PRIVATE_MAXON_MF_CAST(decltype(Member_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_ToString);
			#else
			tbl->Member_ToString = PRIVATE_MAXON_MF_CAST(decltype(Member_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_ToString);
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Member_GetMembers = PRIVATE_MAXON_MF_CAST(decltype(Member_GetMembers), &Hxx2::Wrapper<Hxx2::Unresolved>::Member_GetMembers);
			#else
		...
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Class* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_GetClasses = PRIVATE_MAXON_MF_CAST(decltype(Container_GetClasses), &Hxx2::Wrapper<Hxx2::Unresolved>::Container_GetClasses);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Function* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_GetFunctions = PRIVATE_MAXON_MF_CAST(decltype(Container_GetFunctions), &Hxx2::Wrapper<Hxx2::Unresolved>::Container_GetFunctions);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<const Function*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_FindFunction = PRIVATE_MAXON_MF_CAST(decltype(Container_FindFunction), &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindFunction);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Container_FindFunctions = PRIVATE_MAXON_MF_CAST(decltype(Container_FindFunctions), &Hxx2::Wrapper<Hxx2::Unresolved>::Container_FindFunctions);
			#else
		...
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Package* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Package_GetPackages = PRIVATE_MAXON_MF_CAST(decltype(Package_GetPackages), &Hxx2::Wrapper<Hxx2::Unresolved>::Package_GetPackages);
			#else
		...
		maxon::Bool Class::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
		{
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const Class* const>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Class_GetBaseClasses = PRIVATE_MAXON_MF_CAST(decltype(Class_GetBaseClasses), &Hxx2::Wrapper<Hxx2::Unresolved>::Class_GetBaseClasses);
			#else
		...
		{
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_Invoke = PRIVATE_MAXON_MF_CAST(decltype(Function_Invoke), &Hxx2::Wrapper<Hxx2::Unresolved>::Function_Invoke);
			#else
			tbl->Function_Invoke = PRIVATE_MAXON_MF_CAST(decltype(Function_Invoke), &Hxx2::Wrapper<Hxx2::Unresolved>::Function_Invoke);
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<ParameterType>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_GetReturnType = PRIVATE_MAXON_MF_CAST(decltype(Function_GetReturnType), &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetReturnType);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Block<const ParameterType>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_GetParameterTypes = PRIVATE_MAXON_MF_CAST(decltype(Function_GetParameterTypes), &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetParameterTypes);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<const Block<const Parameter>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_GetParameters = PRIVATE_MAXON_MF_CAST(decltype(Function_GetParameters), &Hxx2::Wrapper<Hxx2::Unresolved>::Function_GetParameters);
			#else
			...
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Function_FindAll = PRIVATE_MAXON_MF_CAST(decltype(Function_FindAll), &Hxx2::Wrapper<Hxx2::Unresolved>::Function_FindAll);
			#else
