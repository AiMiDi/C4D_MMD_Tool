...
struct LexerInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_Init, LexerInterface,, (Result<void>), UrlOrInputStream&& fileName, LEXERINITFLAGS flags, const String& stringEscapeCharacters, const StringDecodingRef& stringDecoding, LEXERSYMBOLFLAGS firstParseFlag) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->Init(std::forward<UrlOrInputStream>(fileName), flags, stringEscapeCharacters, stringDecoding, firstParseFlag); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_AddOperator, LexerInterface,, (Result<void>), const String& chars) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->AddOperator(chars); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_Close, LexerInterface,, (Result<void>)) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->Close(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_ReadNextChar, LexerInterface,, (Result<Utf32Char>)) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->ReadNextChar(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_SkipSpaces, LexerInterface,, (Result<Bool>)) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->SkipSpaces(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_SkipLineToEnd, LexerInterface,, (Result<Bool>), Bool collectSkipped) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->SkipLineToEnd(collectSkipped); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_ReadNextSymbol, LexerInterface,, (Result<LEXERSYMBOL>), LEXERSYMBOLFLAGS flags) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->ReadNextSymbol(flags); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_ReadNextSymbolExpected, LexerInterface,, (Result<void>), LEXERSYMBOL expectedSymbols, LEXERSYMBOLFLAGS flags) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->ReadNextSymbolExpected(expectedSymbols, flags); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_RewindSymbol, LexerInterface,, (void)) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->RewindSymbol(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetSymbol, LexerInterface, const, (LEXERSYMBOL)) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetSymbol(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetLeadingSpace, LexerInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetLeadingSpace(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetIdent, LexerInterface, const, (String)) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetIdent(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetFloat, LexerInterface, const, (Result<void>), Float32& val) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetFloat(val); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetFloat_1, LexerInterface, const, (Result<void>), Float64& val) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetFloat(val); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetInt, LexerInterface, const, (Result<void>), Int32& val) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetInt(val); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetInt_1, LexerInterface, const, (Result<void>), Int64& val) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetInt(val); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetUInt, LexerInterface, const, (Result<void>), UInt32& val) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetUInt(val); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetUInt_1, LexerInterface, const, (Result<void>), UInt64& val) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetUInt(val); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetCurrentReadPosition, LexerInterface, const, (Result<Int64>)) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetCurrentReadPosition(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetSymbolPosition, LexerInterface, const, (Result<Int64>)) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetSymbolPosition(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_CheckIdent, LexerInterface, const, (Bool), const Char* cmp) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->CheckIdent(cmp); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_CheckIdent_1, LexerInterface, const, (Bool), const String& cmp) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->CheckIdent(cmp); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_GetLine, LexerInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const LexerInterface))->GetLine(); }
		PRIVATE_MAXON_MF_WRAPPER(LexerInterface_SetStringQuoteCharacters, LexerInterface,, (void), const String& quoteChar) { return C::Get(PRIVATE_MAXON_MF_THIS(LexerInterface))->SetStringQuoteCharacters(quoteChar); }
	};
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); LexerInterface* o_ = (LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Utf32Char>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); LexerInterface* o_ = (LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<LEXERSYMBOL>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); LexerInterface* o_ = (LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); LexerInterface* o_ = (LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<LEXERSYMBOL>, LEXERSYMBOL>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const LexerInterface* o_ = (const LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = LexerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<LEXERSYMBOL>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const LexerInterface* o_ = (const LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = LexerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const LexerInterface* o_ = (const LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = LexerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const LexerInterface* o_ = (const LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = LexerInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Int64>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const LexerInterface* o_ = (const LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = LexerInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const LexerInterface* o_ = (const LexerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = LexerInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
