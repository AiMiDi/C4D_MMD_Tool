...
namespace maxon
{
	...
	namespace enum74
	{
		...
		static const maxon::UInt64 CONVERTTOUINAMEFLAGS_values[] = {maxon::UInt64(enum74::CONVERTTOUINAMEFLAGS::NONE), maxon::UInt64(enum74::CONVERTTOUINAMEFLAGS::NAMEONLY), maxon::UInt64(enum74::CONVERTTOUINAMEFLAGS::DIRECTORYONLY), maxon::UInt64(enum74::CONVERTTOUINAMEFLAGS::ADDVERSION), maxon::UInt64(enum74::CONVERTTOUINAMEFLAGS::CLEARSUFFIX), maxon::UInt64(enum74::CONVERTTOUINAMEFLAGS::DONTADDDATABASE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CONVERTTOUINAMEFLAGS74(){ return enum74::CONVERTTOUINAMEFLAGS_info; }
	...
	public:
		...
		Result<void> SetPath(const String& path, Bool convertWindowsBackslashes) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((UrlInterface*) this)->SetPath(path, convertWindowsBackslashes); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
		...
		CString ToCString() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const UrlInterface*) this)->ToCString(); return maxon::PrivateIncompleteNullReturnValue<CString>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
	...
	const maxon::NULL_RETURN_TYPE UrlInterface::MTable::_returnTypes[] = 
	{
		...
		maxon::details::NullReturnType<Result<void>>::value,
		maxon::details::NullReturnType<String>::value,
		maxon::details::NullReturnType<CString>::value,
		maxon::details::NullReturnType<Result<String>>::value,
		maxon::details::NullReturnType<Result<Url>>::value,
		maxon::details::NullReturnType<Result<void>>::value,
		maxon::details::NullReturnType<Result<String>>::value,
	...
	maxon::Bool UrlInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const UrlScheme&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetScheme = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetScheme), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetScheme);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetScheme = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetScheme), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetScheme);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_Append = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_Append), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_Append);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_Append_1 = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_Append_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_Append_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_RemoveName = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_RemoveName), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_RemoveName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Url>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetEmbeddedUrl = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetEmbeddedUrl), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetEmbeddedUrl);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetEmbeddedUrl = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetEmbeddedUrl), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetEmbeddedUrl);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetName = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetName), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetName = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetName), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Url>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetDirectory = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetDirectory), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetDirectory);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetPath = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetPath), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetPath);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetPath_1 = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetPath_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetPath_1);
		#else
		tbl->UrlInterface_SetPath_1 = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetPath_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetPath_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const String&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetPath = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetPath), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetPath);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetSystemPath = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetSystemPath), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetSystemPath);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetSystemPath = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetSystemPath), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetSystemPath);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetUrl = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetUrl), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetUrl);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetUrl = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetUrl), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetUrl);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetAuthority = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetAuthority), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetAuthority);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetAuthority_1 = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetAuthority_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetAuthority_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const Url&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetAuthority = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetAuthority), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetAuthority);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetComponents = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetComponents), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetComponents);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetRelativeUrl = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetRelativeUrl), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetRelativeUrl);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetSuffix = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetSuffix), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetSuffix);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetSuffix = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetSuffix), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetSuffix);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_Compare = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_Compare), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_Compare);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Data>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_GetData = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_GetData), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_GetData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetData = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetData), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_SetData_1 = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_SetData_1), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_SetData_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_EraseData = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_EraseData), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_EraseData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<CString>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_ToCString = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ToCString), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ToCString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_ConvertToUiName = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ConvertToUiName), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ConvertToUiName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_ConvertFromUiName = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ConvertFromUiName), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ConvertFromUiName);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_DescribeIO);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_ConvertToUiNameWithRepository = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ConvertToUiNameWithRepository), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ConvertToUiNameWithRepository);
		#else
		tbl->UrlInterface_ConvertToUiNameWithRepository = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ConvertToUiNameWithRepository), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ConvertToUiNameWithRepository);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->UrlInterface_ConvertFromUiNameWithRepository = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ConvertFromUiNameWithRepository), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ConvertFromUiNameWithRepository);
		#else
		tbl->UrlInterface_ConvertFromUiNameWithRepository = PRIVATE_MAXON_MF_CAST(decltype(UrlInterface_ConvertFromUiNameWithRepository), &Hxx2::Wrapper<Hxx2::Unresolved>::UrlInterface_ConvertFromUiNameWithRepository);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
