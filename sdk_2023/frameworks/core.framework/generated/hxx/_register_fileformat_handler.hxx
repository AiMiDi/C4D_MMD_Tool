...
namespace maxon
{
	...
	maxon::Bool FileFormatDetectionInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<BaseArray<FileFormatHandler>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->FileFormatDetectionInterface_DetectAll = PRIVATE_MAXON_MF_CAST(decltype(FileFormatDetectionInterface_DetectAll), &Hxx2::Wrapper<Hxx2::Unresolved>::FileFormatDetectionInterface_DetectAll);
		#else
