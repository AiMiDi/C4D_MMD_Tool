	...
	public:
		...
		void operator ++()
		{
			if (ACCESS_FLAGS & PORTSACCESS_FLAGS::ITERATION)
			{
				...
				{
					const Int start = reinterpret_cast<ViewIteratorMember*>(static_cast<typename std::conditional<STD_IS_REPLACEMENT(empty, OutputMembers), Members, OutputMembers>::type*>((Members*) nullptr)) - (ViewIteratorMember*) nullptr;
