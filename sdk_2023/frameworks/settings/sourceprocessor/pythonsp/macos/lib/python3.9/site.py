...
def main():
    ...
    # [Ferdinand Hoppe] : Commented the next line, as it adds the vanilla CPython interpreter's site-package
    # to the sys.path due to hard coded OS-specific paths in _get_path() above.
    # Which in turn will shadow packages installed with Cinema 4D.
