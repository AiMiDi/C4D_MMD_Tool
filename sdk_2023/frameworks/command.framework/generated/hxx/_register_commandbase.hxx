...
namespace maxon
{
	...
	maxon::Bool CommandExecutionInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<COMMANDRESULT>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CommandExecutionInterface_Invoke = PRIVATE_MAXON_MF_CAST(decltype(CommandExecutionInterface_Invoke), &Hxx2::Wrapper<Hxx2::Unresolved>::CommandExecutionInterface_Invoke);
		#else
		tbl->CommandExecutionInterface_Invoke = PRIVATE_MAXON_MF_CAST(decltype(CommandExecutionInterface_Invoke), &Hxx2::Wrapper<Hxx2::Unresolved>::CommandExecutionInterface_Invoke);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<COMMANDRESULT>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CommandExecutionInterface_Invoke_1 = PRIVATE_MAXON_MF_CAST(decltype(CommandExecutionInterface_Invoke_1), &Hxx2::Wrapper<Hxx2::Unresolved>::CommandExecutionInterface_Invoke_1);
		#else
		tbl->CommandExecutionInterface_Invoke_1 = PRIVATE_MAXON_MF_CAST(decltype(CommandExecutionInterface_Invoke_1), &Hxx2::Wrapper<Hxx2::Unresolved>::CommandExecutionInterface_Invoke_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<COMMANDRESULT>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CommandExecutionInterface_Interact = PRIVATE_MAXON_MF_CAST(decltype(CommandExecutionInterface_Interact), &Hxx2::Wrapper<Hxx2::Unresolved>::CommandExecutionInterface_Interact);
		#else
		tbl->CommandExecutionInterface_Interact = PRIVATE_MAXON_MF_CAST(decltype(CommandExecutionInterface_Interact), &Hxx2::Wrapper<Hxx2::Unresolved>::CommandExecutionInterface_Interact);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
