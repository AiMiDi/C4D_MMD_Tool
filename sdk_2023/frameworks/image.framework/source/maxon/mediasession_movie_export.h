	...
	namespace MF
	{
		namespace EXPORT
		{
			...
			MAXON_ATTRIBUTE(Id, CODEC, "net.maxon.mediasession.mf.export.codec",
				RESOURCE_DEFINE(ENUM_H_264, Id("H.264"))
				RESOURCE_DEFINE(ENUM_WMV1, Id("WMV1"))
				RESOURCE_DEFINE(ENUM_WMV2, Id("WMV2"))
				RESOURCE_DEFINE(ENUM_WMV3, Id("WMV3"))
				RESOURCE_DEFINE(ENUM_PRORES422, Id("ProRes422"))
				RESOURCE_DEFINE(ENUM_PRORES4444, Id("ProRes4444"))
			...
			MAXON_ATTRIBUTE(Id, AUDIO_CODEC, "net.maxon.mediasession.mf.export.audio.codec",
				RESOURCE_DEFINE(ENUM_AAC, Id("aac"))
				RESOURCE_DEFINE(ENUM_MP3, Id("mp3")));
