...
namespace maxon
{
	...
	public:
		...
		Result<DataDictionary> GetExifDictionary() const 
		{
			...
			(*handler_)(_fn_ExifInterface_GetExifDictionary, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<DataDictionary>)), reinterpret_cast<const void* const&>(mt_.ExifInterface_GetExifDictionary)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ExifStaticInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<decltype(ExifStaticInterface::MTable::_instance.ExifStaticInterface_OpenFromMemory)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "exifChunk\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(ExifStaticInterface::MTable::_instance.ExifStaticInterface_OpenJpgFromUrl)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "fileName\0", 1LL, nullptr),
		};
