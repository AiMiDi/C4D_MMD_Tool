...
/// @endcond
	...
	maxon::Bool ImageTextureInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<ImageTextureRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ImageTextureInterface_LoadTexture = PRIVATE_MAXON_MF_CAST(decltype(ImageTextureInterface_LoadTexture), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImageTextureInterface_LoadTexture);
		#else
	...
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ImageBaseRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ImageFunctionsInterface_CreateSubImagePart = PRIVATE_MAXON_MF_CAST(decltype(ImageFunctionsInterface_CreateSubImagePart), &Hxx2::Wrapper<Hxx2::Unresolved>::ImageFunctionsInterface_CreateSubImagePart);
		#else
