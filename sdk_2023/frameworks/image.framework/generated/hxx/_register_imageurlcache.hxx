...
namespace maxon
{
	...
	maxon::Bool ImageUrlCacheInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ImageUrlCacheInterface_InvalidateCache = PRIVATE_MAXON_MF_CAST(decltype(ImageUrlCacheInterface_InvalidateCache), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImageUrlCacheInterface_InvalidateCache);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ImageUrlCacheRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ImageUrlCacheInterface_FindOrCreate = PRIVATE_MAXON_MF_CAST(decltype(ImageUrlCacheInterface_FindOrCreate), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImageUrlCacheInterface_FindOrCreate);
		#else
