...
/// @endcond
		...
		maxon::ObservableRef<ObservableRegionChangedDelegate> ObservableRegionChanged() const 
		{
			...
			(*handler_)(_fn_ImageBaseInterface_ObservableRegionChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableRegionChangedDelegate>)), reinterpret_cast<const void* const&>(mt_.ImageBaseInterface_ObservableRegionChanged)));
			return proxy_result;
		}
