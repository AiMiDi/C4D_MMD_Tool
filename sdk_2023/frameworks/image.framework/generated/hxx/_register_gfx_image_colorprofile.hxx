...
/// @endcond
	...
	public:
		...
		static Result<ColorProfile> CreateProfile(const OcioConfig& config, const Url& iccPath) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ColorProfileInterface::CreateProfile(config, iccPath); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
		...
		static Result<ColorProfile> CreateProfile(const ColorProfile& viewTransform, const ColorProfile& displayColorSpace) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ColorProfileInterface::CreateProfile(viewTransform, displayColorSpace); return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::UNRESOLVED);}
		...
		UniqueHash GetUniqueHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ColorProfileInterface*) this)->GetUniqueHashCode(); return maxon::PrivateIncompleteNullReturnValue<UniqueHash>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
...
/// @endcond
	...
	maxon::Bool ColorProfileInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfile>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_OpenProfileFromFile = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_OpenProfileFromFile), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_OpenProfileFromFile);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfile>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_OpenProfileFromMemory = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_OpenProfileFromMemory), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_OpenProfileFromMemory);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfile>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_CreateProfile = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_CreateProfile), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_CreateProfile);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfile>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_CreateProfile_1 = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_CreateProfile_1), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_CreateProfile_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfile>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_CreateProfile_2 = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_CreateProfile_2), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_CreateProfile_2);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfile>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_CreateProfile_3 = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_CreateProfile_3), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_CreateProfile_3);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_WriteProfileToMemory = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_WriteProfileToMemory), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_WriteProfileToMemory);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_WriteProfileToFile = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_WriteProfileToFile), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_WriteProfileToFile);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_GetInfo = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_GetInfo), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_GetInfo);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<UniqueHash>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_GetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_GetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_GetUniqueHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ColorSpace>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_GetColorSpace = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_GetColorSpace), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_GetColorSpace);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_ToString);
		#else
...
/// @cond INTERNAL
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileInterface_DescribeIO);
		#else
...
/// @endcond
	...
	maxon::Bool ColorProfileConvertInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfileConvert>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileConvertInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileConvertInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileConvertInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileConvertInterface_Convert = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileConvertInterface_Convert), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileConvertInterface_Convert);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileConvertInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileConvertInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileConvertInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<PixelFormat>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileConvertInterface_GetNearestNativeFormat = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileConvertInterface_GetNearestNativeFormat), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileConvertInterface_GetNearestNativeFormat);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ColorProfileConvert>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileConvertInterface_InitGPU = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileConvertInterface_InitGPU), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileConvertInterface_InitGPU);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ForwardRef<ColorProfileGpuHandlerRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->ColorProfileConvertInterface_GetGpuHandler = PRIVATE_MAXON_MF_CAST(decltype(ColorProfileConvertInterface_GetGpuHandler), &Hxx2::Wrapper<Hxx2::Unresolved>::ColorProfileConvertInterface_GetGpuHandler);
		#else
