...
namespace maxon
{
	...
	maxon::Bool LayerSetInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_SetSelectedLayers = PRIVATE_MAXON_MF_CAST(decltype(LayerSetInterface_SetSelectedLayers), &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_SetSelectedLayers);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const LayerHash&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetSelectedLayers = PRIVATE_MAXON_MF_CAST(decltype(LayerSetInterface_GetSelectedLayers), &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetSelectedLayers);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetSelectedImage = PRIVATE_MAXON_MF_CAST(decltype(LayerSetInterface_GetSelectedImage), &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetSelectedImage);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LAYERSETMODE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetMode = PRIVATE_MAXON_MF_CAST(decltype(LayerSetInterface_GetMode), &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetMode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(LayerSetInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->LayerSetInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(LayerSetInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::LayerSetInterface_DescribeIO);
		#else
