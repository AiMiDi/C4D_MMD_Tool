...
extern const Id URLSCHEME_ASSET;	 ///< "asset://" - the real asset url containing a assetid and version
extern const Id URLSCHEME_ASSETDB; ///< user readable asset name, this is never stored in the fileformat and only for visualization
extern const Id URLSCHEME_META;		 ///< "meta://" contains a relative file link to a metadata in a asset repository
extern const Id URLSCHEME_METASQ;	 ///< "metasq://" contains a like to the repository with a sql database to read from
...
public:
	...
	{
		return Get<typename ATTR::ValueType>(ATTR::GetInstance().Get());
	}
