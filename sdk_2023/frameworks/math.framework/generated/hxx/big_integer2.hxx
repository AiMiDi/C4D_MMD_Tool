...
struct BigIntegerInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set, BigIntegerInterface,, (Result<void>), Char c) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(c); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_1, BigIntegerInterface,, (Result<void>), UChar c) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(c); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_2, BigIntegerInterface,, (Result<void>), Int16 i) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(i); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_3, BigIntegerInterface,, (Result<void>), UInt16 u) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(u); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_4, BigIntegerInterface,, (Result<void>), Int32 i) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(i); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_5, BigIntegerInterface,, (Result<void>), UInt32 u) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(u); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_6, BigIntegerInterface,, (Result<void>), Int64 i) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(i); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_7, BigIntegerInterface,, (Result<void>), UInt64 u) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(u); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_SetRandom, BigIntegerInterface,, (Result<void>), Int bitCount, SecureRandomProvider provider) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->SetRandom(bitCount, std::forward<SecureRandomProvider>(provider)); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_SetRandomPrime, BigIntegerInterface,, (Result<void>), Int bitCount, UInt certainty, SecureRandomProvider provider) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->SetRandomPrime(bitCount, certainty, std::forward<SecureRandomProvider>(provider)); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_8, BigIntegerInterface,, (Result<void>), const Block<const Byte>& mem, Bool littleEndian) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(mem, littleEndian); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Set_9, BigIntegerInterface,, (Result<void>), const String& str) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Set(str); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_SetHex, BigIntegerInterface,, (Result<void>), const String& str) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->SetHex(str); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsEven, BigIntegerInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsEven(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsOdd, BigIntegerInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsOdd(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsOne, BigIntegerInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsOne(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsZero, BigIntegerInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsZero(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsNegative, BigIntegerInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsNegative(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsPowerOfTwo, BigIntegerInterface, const, (Bool)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsPowerOfTwo(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsProbablyPrime, BigIntegerInterface, const, (Result<Bool>), UInt certainty) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsProbablyPrime(certainty); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Sign, BigIntegerInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->Sign(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetHighestNonSignBit, BigIntegerInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetHighestNonSignBit(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestSetBit, BigIntegerInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestSetBit(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestClearedBit, BigIntegerInterface, const, (Int)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestClearedBit(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_IsBitSet, BigIntegerInterface, const, (Bool), Int bit) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->IsBitSet(bit); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits8U, BigIntegerInterface, const, (UChar)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits8U(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits8S, BigIntegerInterface, const, (Char)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits8S(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits16U, BigIntegerInterface, const, (UInt16)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits16U(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits16S, BigIntegerInterface, const, (Int16)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits16S(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits32U, BigIntegerInterface, const, (UInt32)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits32U(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits32S, BigIntegerInterface, const, (Int32)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits32S(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits64U, BigIntegerInterface, const, (UInt64)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits64U(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetLowestBits64S, BigIntegerInterface, const, (Int64)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetLowestBits64S(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetDataCopy, BigIntegerInterface, const, (Result<void>), Bool littleEndian, BaseArray<UChar>& data) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetDataCopy(littleEndian, data); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Add, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Add(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Sub, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Sub(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Inc, BigIntegerInterface,, (Result<void>)) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Inc(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Dec, BigIntegerInterface,, (Result<void>)) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Dec(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Mul, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Mul(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Div, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Div(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Mod, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Mod(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_DivMod, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b, BigInteger& r) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->DivMod(b, r); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Pow, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Pow(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_PowMod, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b, const BigIntegerInterface* mod) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->PowMod(b, mod); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GreatestCommonDivisor, BigIntegerInterface,, (Result<void>), const BigIntegerInterface* b) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->GreatestCommonDivisor(b); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_MultiplicativeInverse, BigIntegerInterface,, (Result<Bool>), const BigIntegerInterface* m) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->MultiplicativeInverse(m); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_LeftShift, BigIntegerInterface,, (Result<void>), Int s) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->LeftShift(s); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_RightShift, BigIntegerInterface,, (Result<void>), Int s) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->RightShift(s); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Negate, BigIntegerInterface,, (Result<void>)) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->Negate(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_SetBit, BigIntegerInterface,, (Result<void>), Int bit) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->SetBit(bit); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_ClearBit, BigIntegerInterface,, (Result<void>), Int bit) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->ClearBit(bit); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_ToggleBit, BigIntegerInterface,, (Result<void>), Int bit) { return C::Get(PRIVATE_MAXON_MF_THIS(BigIntegerInterface))->ToggleBit(bit); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_Compare, BigIntegerInterface, const, (COMPARERESULT), const BigIntegerInterface* arg2) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->Compare(arg2); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetHashCode, BigIntegerInterface, const, (HashInt)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_GetUniqueHashCode, BigIntegerInterface, const, (UniqueHash)) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->GetUniqueHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(BigIntegerInterface_ToString, BigIntegerInterface, const, (String), const FormatStatement* formatStatement) { return C::Get(PRIVATE_MAXON_MF_THIS(const BigIntegerInterface))->ToString(formatStatement); }
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); BigIntegerInterface* o_ = (BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Bool>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<UChar>, UChar>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Char>, Char>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<UInt16>, UInt16>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int16>, Int16>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<UInt32>, UInt32>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int32>, Int32>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int64>, Int64>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return 0; } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Bool>>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); BigIntegerInterface* o_ = (BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<COMPARERESULT>, COMPARERESULT>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<COMPARERESULT>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && MAXON_UNLIKELY(this->GetErrorStorage().GetReferencedError())) return ReturnHelper::ReturnErrorOf(this); const BigIntegerInterface* o_ = (const BigIntegerInterface*) this->GetPointer(); if (!std::integral_constant<maxon::Bool, maxon::Bool(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR))>::value && MAXON_UNLIKELY(!o_)) { o_ = BigIntegerInterface::NullValuePtr(); if (!o_) return maxon::PrivateIncompleteNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
