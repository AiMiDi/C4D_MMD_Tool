...
namespace maxon
{
	...
	maxon::Bool NoiseInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_GetGradientTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetGradientTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetGradientTable);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_GetFbmTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetFbmTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetFbmTable);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultMemT<FbmTableRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->NoiseInterface_InitFbm = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_InitFbm), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_InitFbm);
		#else
