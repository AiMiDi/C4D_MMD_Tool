...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_NoiseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(NoiseInterface::MTable::_instance.NoiseInterface_GetFbmTable)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "table\0fbm\0", 5LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(NoiseInterface::MTable::_instance.NoiseInterface_InitFbm)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "lacunarity\0gain\0", 5LL, nullptr),
