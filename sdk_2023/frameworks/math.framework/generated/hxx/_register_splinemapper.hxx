...
namespace maxon
{
	...
	maxon::Bool SplineMapperInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector2d>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_GetPoint = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_GetPoint), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_GetPoint);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_InsertKnot = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_InsertKnot), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_InsertKnot);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_InsertKnot_1 = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_InsertKnot_1), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_InsertKnot_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_DeleteKnot = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_DeleteKnot), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_DeleteKnot);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<SplineMapperKnot>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_GetKnots = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_GetKnots), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_GetKnots);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector2d>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_ClampPosition = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_ClampPosition), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_ClampPosition);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->SplineMapperInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(SplineMapperInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::SplineMapperInterface_DescribeIO);
		#else
