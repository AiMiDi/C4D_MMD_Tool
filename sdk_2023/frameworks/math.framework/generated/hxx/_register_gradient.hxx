...
namespace maxon
{
	...
	maxon::Bool GradientInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Gradient*>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_AllocAlphaGradient = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_AllocAlphaGradient), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_AllocAlphaGradient);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Int>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_InsertKnot = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_InsertKnot), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_InsertKnot);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_RemoveKnot = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_RemoveKnot), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_RemoveKnot);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<GradientKnot>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_GetKnot = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_GetKnot), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_GetKnot);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_SetKnot = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_SetKnot), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_SetKnot);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_InvertKnots = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_InvertKnots), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_InvertKnots);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_DoubleKnots = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_DoubleKnots), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_DoubleKnots);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_Compare = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_Compare), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_Compare);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<GradientRenderData>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientInterface_InitRender = PRIVATE_MAXON_MF_CAST(decltype(GradientInterface_InitRender), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientInterface_InitRender);
		#else
	...
	maxon::Bool GradientRenderDataInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Color>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientRenderDataInterface_CalcGradientPixel = PRIVATE_MAXON_MF_CAST(decltype(GradientRenderDataInterface_CalcGradientPixel), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientRenderDataInterface_CalcGradientPixel);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<GradientKnot>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientRenderDataInterface_GetKnots = PRIVATE_MAXON_MF_CAST(decltype(GradientRenderDataInterface_GetKnots), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientRenderDataInterface_GetKnots);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientRenderDataInterface_Compare = PRIVATE_MAXON_MF_CAST(decltype(GradientRenderDataInterface_Compare), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientRenderDataInterface_Compare);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GradientRenderDataInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(GradientRenderDataInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::GradientRenderDataInterface_GetHashCode);
		#else
