...
namespace maxon
{
	...
	public:
		...
		UniqueHash GetUniqueHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const BigIntegerInterface*) this)->GetUniqueHashCode(); return maxon::PrivateIncompleteNullReturnValue<UniqueHash>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
	...
	maxon::Bool BigIntegerInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_1 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_1), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_2 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_2), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_2);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_3 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_3), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_3);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_4 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_4), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_4);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_5 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_5), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_5);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_6 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_6), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_6);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_7 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_7), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_7);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_SetRandom = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_SetRandom), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_SetRandom);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_SetRandomPrime = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_SetRandomPrime), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_SetRandomPrime);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_8 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_8), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_8);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Set_9 = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Set_9), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Set_9);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_SetHex = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_SetHex), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_SetHex);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_IsProbablyPrime = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_IsProbablyPrime), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_IsProbablyPrime);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_GetDataCopy = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_GetDataCopy), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_GetDataCopy);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Add = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Add), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Add);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Sub = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Sub), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Sub);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Inc = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Inc), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Inc);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Dec = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Dec), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Dec);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Mul = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Mul), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Mul);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Div = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Div), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Div);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Mod = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Mod), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Mod);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_DivMod = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_DivMod), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_DivMod);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Pow = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Pow), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Pow);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_PowMod = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_PowMod), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_PowMod);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_GreatestCommonDivisor = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_GreatestCommonDivisor), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_GreatestCommonDivisor);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_MultiplicativeInverse = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_MultiplicativeInverse), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_MultiplicativeInverse);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_LeftShift = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_LeftShift), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_LeftShift);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_RightShift = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_RightShift), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_RightShift);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Negate = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Negate), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Negate);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_SetBit = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_SetBit), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_SetBit);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_ClearBit = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_ClearBit), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_ClearBit);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_ToggleBit = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_ToggleBit), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_ToggleBit);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<COMPARERESULT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_Compare = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_Compare), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_Compare);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<UniqueHash>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_GetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_GetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_GetUniqueHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_ToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->BigIntegerInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(BigIntegerInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::BigIntegerInterface_DescribeIO);
		#else
