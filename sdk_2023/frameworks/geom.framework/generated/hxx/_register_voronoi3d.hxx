...
namespace maxon
{
	...
	maxon::Bool Voronoi3DInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CopyFrom = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_CopyFrom), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CopyFrom);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_SetPoints = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_SetPoints), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetPoints);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_AddPoint = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_AddPoint), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_AddPoint);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_AddPoints = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_AddPoints), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_AddPoints);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CalcCells = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_CalcCells), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CalcCells);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CalcTetrahedralization = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_CalcTetrahedralization), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CalcTetrahedralization);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Vector>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetVoronoiPointPositions = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_GetVoronoiPointPositions), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetVoronoiPointPositions);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const BaseArray<Vector>&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetInputPoints = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_GetInputPoints), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetInputPoints);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<Bool>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetBorderCellFlags = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_GetBorderCellFlags), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetBorderCellFlags);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<CellData>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetCellDataStructure = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_GetCellDataStructure), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellDataStructure);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<BaseArray<Char>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetCellHasVolume = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_GetCellHasVolume), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetCellHasVolume);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_ScaleCell = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_ScaleCell), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_ScaleCell);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_ScaleAllCells = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_ScaleAllCells), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_ScaleAllCells);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<ResultRef<Delaunay3DRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_GetDelaunayTetrizer = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_GetDelaunayTetrizer), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_GetDelaunayTetrizer);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_SetCellFuseGroup = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_SetCellFuseGroup), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_SetCellFuseGroup);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_FuseCells = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_FuseCells), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_FuseCells);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->Voronoi3DInterface_CreateInvertedVoronoiCell = PRIVATE_MAXON_MF_CAST(decltype(Voronoi3DInterface_CreateInvertedVoronoiCell), &Hxx2::Wrapper<Hxx2::Unresolved>::Voronoi3DInterface_CreateInvertedVoronoiCell);
		#else
