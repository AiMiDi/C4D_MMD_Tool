...
namespace maxon
{
	...
	maxon::Bool GeometryUtilsInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Points3Dto2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points3Dto2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points3Dto2D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Points3Dto2D_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points3Dto2D_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points3Dto2D_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Point2Dto3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Point2Dto3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Point2Dto3D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_Points2Dto3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_Points2Dto3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_Points2Dto3D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateOutlineNormal = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineNormal), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineNormal);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateOutlineNormal_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineNormal_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineNormal_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<GEOMETRY_TEST_EXACT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_IsVertexConvexExact = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvexExact), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvexExact);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<GEOMETRY_TEST_EXACT>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_IsVertexConvexExact2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsVertexConvexExact2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsVertexConvexExact2D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateBarycentricCoordinate3D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBarycentricCoordinate3D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBarycentricCoordinate3D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateBisector = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateBisector), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateBisector);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_LineLineDistance = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_LineLineDistance), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_LineLineDistance);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_BilinearInterpolate = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_BilinearInterpolate), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_BilinearInterpolate);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateMeanValueCoordinatesWeights_2);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_IsWoundClockwise2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_IsWoundClockwise2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_IsWoundClockwise2D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Vector2d>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateOutlineCentroidAndArea2D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Int>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateConvexHull2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateConvexHull2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateConvexHull2D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<BaseArray<Int>>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateConvexDecomposition2D = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateConvexDecomposition2D), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateConvexDecomposition2D);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Bool>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CleanLoop2DInPlace = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CleanLoop2DInPlace), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CleanLoop2DInPlace);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Vector2d>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateNoFitPolygonForConvex = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonForConvex), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonForConvex);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<BaseArray<Vector2d>>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1 = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_CalculateNoFitPolygonForConvex_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<LOOP_OVERLAP_STATE>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops = PRIVATE_MAXON_MF_CAST(decltype(GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops), &Hxx2::Wrapper<Hxx2::Unresolved>::GeometryUtilsInterface_GetContainmentStateForNonIntersectingLoops);
		#else
