...
namespace maxon
{
	...
	namespace py
	{
		...
		maxon::Bool CPythonLibraryInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
		{
			...
			if (maxon::details::NullReturnType<Result<PYSTARTOPERATION>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CPythonLibraryInterface_ParseCommandLine = PRIVATE_MAXON_MF_CAST(decltype(CPythonLibraryInterface_ParseCommandLine), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_ParseCommandLine);
			#else
			tbl->CPythonLibraryInterface_ParseCommandLine = PRIVATE_MAXON_MF_CAST(decltype(CPythonLibraryInterface_ParseCommandLine), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_ParseCommandLine);
			#endif
			#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
			if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->CPythonLibraryInterface_GetUrl = PRIVATE_MAXON_MF_CAST(decltype(CPythonLibraryInterface_GetUrl), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_GetUrl);
			#else
			tbl->CPythonLibraryInterface_GetUrl = PRIVATE_MAXON_MF_CAST(decltype(CPythonLibraryInterface_GetUrl), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::CPythonLibraryInterface_GetUrl);
			#endif
		#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
		...
		const maxon::Char* const CPythonLibraryInterface::MTable::_ids = 
			...
			"CPyList_Clear@deca63b112827ad6\0" // Bool CPyList_Clear(const CPyRef& list)
			...
			"MPyHashMap_New@799a1fd273a9f2e2\0" // MPyHashMapRef MPyHashMap_New(const HashMap<Data, Data>& map)
			"MPyHashMap_New@604dc9b333393dab\0" // MPyHashMapRef MPyHashMap_New(HashMap<Data, Data>&& map)
			...
			"CPyId_Type@e5513ca0b8c7ce1e\0" // CPyTypeConstRef CPyId_Type()
			"CPyInternedId_Type@e5513ca0b8c7ce1e\0" // CPyTypeConstRef CPyInternedId_Type()
			...
			"GetMPyHashMapRefClass@d52bd3e24d15023b\0" // Class<MPyHashMapRef> GetMPyHashMapRefClass() const
		...
		template <typename DUMMY> maxon::Int CPythonLibraryInterface::PrivateInstantiateNullValueHelper()
		{
			...
			| maxon::details::InstantiateNullReturnValue<Class<MPyHashMapRef>>(OVERLOAD_MAX_RANK)
