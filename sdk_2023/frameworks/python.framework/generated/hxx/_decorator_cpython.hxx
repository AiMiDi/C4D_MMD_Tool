...
public:
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyList_Clear(list);
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyModule_AddType(module, value);
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).MPyHashMap_New(map);
	}

	MAXON_METHOD MPyHashMapRef MPyHashMap_New(HashMap<Data, Data>&& map)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).MPyHashMap_New(std::forward<HashMap<Data, Data>>(map));
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyId_Type();
	}

	MAXON_METHOD CPyTypeConstRef CPyInternedId_Type()
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInternedId_Type();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).GetMPyHashMapRefClass();
	}
...
public:
	...
	{
		return maxon::Cast<PyModuleRef>(self.GetDecoratedObject()).GetFunctions3(functions);
	}
