...
namespace maxon
{
	...
	public:
		...
		Result<void> Start() 
		{
			...
			(*handler_)(_fn_CodeExchangeInterface_Start, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>)), reinterpret_cast<const void* const&>(mt_.CodeExchangeInterface_Start)));
			return proxy_result;
		}
		...
		Result<void> Stop() 
		{
			...
			(*handler_)(_fn_CodeExchangeInterface_Stop, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>)), reinterpret_cast<const void* const&>(mt_.CodeExchangeInterface_Stop)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CodeExchangeInterface_Stop;
		Result<void> SendScriptToIDE(const PythonElementScriptRef& script) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CodeExchangeInterface_SendScriptToIDE, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const PythonElementScriptRef&), reinterpret_cast<const void* const&>(mt_.CodeExchangeInterface_SendScriptToIDE)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CodeExchangeInterface_SendScriptToIDE;
		Result<void> SendConsoleOutput(const String& content) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CodeExchangeInterface_SendConsoleOutput, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const String&), reinterpret_cast<const void* const&>(mt_.CodeExchangeInterface_SendConsoleOutput)));
			return proxy_result;
		}
		...
		InternedId GetLanguage() const 
		{
			...
			(*handler_)(_fn_CodeExchangeInterface_GetLanguage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((InternedId)), reinterpret_cast<const void* const&>(mt_.CodeExchangeInterface_GetLanguage)));
			return proxy_result;
		}
		...
		String GetName() const 
		{
			...
			(*handler_)(_fn_CodeExchangeInterface_GetName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((String)), reinterpret_cast<const void* const&>(mt_.CodeExchangeInterface_GetName)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_CodeExchangeInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "script\0", 1LL, CodeExchangeInterface, CodeExchangeInterface_SendScriptToIDE),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "content\0", 1LL, CodeExchangeInterface, CodeExchangeInterface_SendConsoleOutput),
