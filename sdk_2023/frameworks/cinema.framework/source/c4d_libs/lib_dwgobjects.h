...
class CINEWARE_SINGLEINHERITANCE xBaseCurveClass : public NodeData
{
		xBaseCurveClass();
		~xBaseCurveClass();
	public:
...
class CINEWARE_SINGLEINHERITANCE xBaseGeometryData
{
		xBaseGeometryData() { }
		~xBaseGeometryData() {}
	public:
...
class CINEWARE_SINGLEINHERITANCE xLineCurveData : public xBaseCurveClass
{
		xLineCurveData();
		~xLineCurveData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xCircularCurveData : public xBaseCurveData
{
		xCircularCurveData();
		~xCircularCurveData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xConicCurveData : public xBaseCurveData
{
		xConicCurveData();
		~xConicCurveData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xNurbsKnots
{
		xNurbsKnots();
		~xNurbsKnots();
	public:
...
class CINEWARE_SINGLEINHERITANCE xBaseCurvePoint
{
		xBaseCurvePoint();
		~xBaseCurvePoint();
	public:
...
class CINEWARE_SINGLEINHERITANCE xNurbsCurvePoint : public xBaseCurvePoint
{
		xNurbsCurvePoint();
		~xNurbsCurvePoint();
	public:
...
class CINEWARE_SINGLEINHERITANCE xNurbsCurveData : public xBaseCurveData
{
		xNurbsCurveData();
		~xNurbsCurveData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xCompositeCurveData : public xBaseCurveData
{
		xCompositeCurveData();
		~xCompositeCurveData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xBaseSurfaceData : public xBaseGeometryData
{
		xBaseSurfaceData();
		~xBaseSurfaceData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xExtrudeSurfaceData : public xBaseSurfaceData
{
		xExtrudeSurfaceData();
		~xExtrudeSurfaceData();
...
class CINEWARE_SINGLEINHERITANCE xPlaneSurfaceData : public xBaseSurfaceData
{
		xPlaneSurfaceData();
		~xPlaneSurfaceData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xPolynomCurvePoint : public xBaseCurvePoint
{
		xPolynomCurvePoint();
		~xPolynomCurvePoint();
	public:
...
class CINEWARE_SINGLEINHERITANCE xPolynomCurveData : public xBaseCurveData
{
		xPolynomCurveData();
		~xPolynomCurveData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xPolynomSurfacePoint : public xPolynomCurvePoint
{
...
class CINEWARE_SINGLEINHERITANCE xPolynomSurfaceData : public xBaseSurfaceData
{
		xPolynomSurfaceData();
		~xPolynomSurfaceData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xUVPairFF
{
		xUVPairFF();
		~xUVPairFF();
	public:
...
class CINEWARE_SINGLEINHERITANCE xNurbsSurfaceData : public xBaseSurfaceData
{
		xNurbsSurfaceData();
		~xNurbsSurfaceData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xMappedCurveClass : public ObjectData
{
		xMappedCurveClass();
		~xMappedCurveClass();
	public:
...
class CINEWARE_SINGLEINHERITANCE xStandardMappedCurveData : public xMappedCurveData
{
...
class CINEWARE_SINGLEINHERITANCE xSegmentMappedCurveData : public xMappedCurveData
{
...
class CINEWARE_SINGLEINHERITANCE xTrimmedSurfaceData : public xBaseGeometryData
{
		xTrimmedSurfaceData();
		~xTrimmedSurfaceData();
	public:
...
class CINEWARE_SINGLEINHERITANCE xStandardTrimmedSurfaceData : public xTrimmedSurfaceData
{
