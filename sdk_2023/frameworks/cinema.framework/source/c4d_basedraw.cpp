...
{
	return C4DOS.Bv->VSPickObject(bd, doc, x, y, rad, flags, ls, list, m, sampleLocation);
}
...
{
	return C4DOS.Bv->VSPickObject1(bd, doc, x, y, rad, xr, yr, wr, hr, pixels, flags, ls, list, m, sampleLocation);
}
...
{
	return C4DOS.Bv->VSPickObject2(bd, doc, x1, y1, x2, y2, xr, yr, wr, hr, pixels, flags, ls, list, m, sampleLocation);
}
