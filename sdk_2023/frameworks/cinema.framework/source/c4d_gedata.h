...
public:
	...
	/// @return												The value. Only valid as long as the GeData value exists.
	//----------------------------------------------------------------------------------------
	const maxon::Data& GetData(void) const { return C4DOS.Gd->GetMaxonData(this); }
	...
	/// @param[in] v									The new value.
	//----------------------------------------------------------------------------------------
	void SetData(const maxon::Data& v) { C4DOS.Gd->SetMaxonData(this, &v); }
