...
enum
{
	...
	SUBSTANCEASSET_LOCK_RATIO							= 1007,			// BOOL

	SUBSTANCEASSET_INPUT_DYNAMIC_START		= 10000,		// start id of dynamic input parameters
	// If the two first values of the dynamic input are not the resolution anymore, the lockRatio will break.
	...
	SUBSTANCEASSET_GROUP_STATUS						= 105000,		// status group
