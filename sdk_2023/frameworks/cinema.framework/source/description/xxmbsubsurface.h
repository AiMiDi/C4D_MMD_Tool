...
enum
{
	...
	XMBSUBSURFACESHADER_GROUP_GPURENDER				= 9406,

	XMBSUBSURFACESHADER_GPURENDER_EMISSION_COLOR				= 9500,
	XMBSUBSURFACESHADER_GPURENDER_EMISSION_SHADER				= 9501,
	XMBSUBSURFACESHADER_GPURENDER_EMISSION_BRIGHTNESS				= 9502,
	XMBSUBSURFACESHADER_GPURENDER_SSS_WEIGHT				= 9503,
	XMBSUBSURFACESHADER_GPURENDER_SSS_COLOR				= 9504,
	XMBSUBSURFACESHADER_GPURENDER_RADIUS_RGB				= 9505,
	XMBSUBSURFACESHADER_GPURENDER_RADIUS_SCALE				= 9506,
	XMBSUBSURFACESHADER_GPURENDER_PHASE				= 9507,
	XMBSUBSURFACESHADER_GPURENDER_MULTISCATTER_ENABLED				= 9508,
	XMBSUBSURFACESHADER_GPURENDER_IS_TRANSPARENT				= 9509,
	XMBSUBSURFACESHADER_GPURENDER_PRESET				= 9510,
	XMBSUBSURFACESHADER_GPURENDER_SURFACE_COLOR				= 9511,
	XMBSUBSURFACESHADER_GPURENDER_SURFACE_COLOR_SHADER				= 9512,
	XMBSUBSURFACESHADER_GPURENDER_SSS_WEIGHT_SHADER				= 9513,
};
