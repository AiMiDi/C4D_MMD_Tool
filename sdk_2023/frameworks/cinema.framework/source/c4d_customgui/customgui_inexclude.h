...
public:
	...
	//----------------------------------------------------------------------------------------
	BaseList2D* ObjectFromIndex(const BaseDocument *doc, Int32 lIndex) const;
	...
	/// @return												The data container. See @ref IN_EXCLUDE_DATA_SELECTION. @theOwnsPointed{inexclude list,container}
	//----------------------------------------------------------------------------------------
	BaseContainer* GetData(const BaseDocument *doc, const BaseList2D* pObject) const { return GetData(GetObjectIndex(doc, pObject)); }
...
struct CustomGuiInExcludeLib : public BaseCustomGuiLib
{
	...
	BaseList2D*			(iIncludeExcludeData::*ObjectFromIndex)(const BaseDocument *doc, Int32 lIndex) const;
