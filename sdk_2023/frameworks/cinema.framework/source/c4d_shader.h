...
public:
	...
	{
		return C4DOS.Sh->TransformColorOcio64(this, v, colorSpaceTransformation);
	}
	...
	{
		return C4DOS.Sh->TransformColorOcio32(this, v, colorSpaceTransformation);
	}
	...
	{
		return C4DOS.Sh->TransformColorsOcio64(this, v, count, colorSpaceTransformation);
	}
	...
	{
		return C4DOS.Sh->TransformColorsOcio32(this, v, count, colorSpaceTransformation);
	}
	...
	{
		return C4DOS.Sh->GetOcioConverter(this, colorSpaceTransformation, converter);
	}
};
...
public:
	...
	maxon::StrongRef<OcioConverter> ocioConverter;	///< OCIO converter.
