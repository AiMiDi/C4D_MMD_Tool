...
public:
	...
	/// @param[in] fullPath	Determines if the full path is returned
	...
	/// @since R2023.000
	/// @return												An array containg the names of the color spaces.
	//----------------------------------------------------------------------------------------
	...
	/// @since R2023.000
	/// @return												An array containg the names of the rendering color spaces.
	//----------------------------------------------------------------------------------------
	...
	/// @since R2023.000
	/// @return												An array containg the names of the view transforms.
	//----------------------------------------------------------------------------------------
