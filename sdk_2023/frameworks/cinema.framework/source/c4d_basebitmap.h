...
public:
	...
	//----------------------------------------------------------------------------------------
	Vector32 GetPixelDirect(Int32 x, Int32 y) const { return C4DOS.Bm->GetPixelDirect(this, x, y); }
	...
	//----------------------------------------------------------------------------------------
	void GetUpdateRegion(Int32& xMin, Int32& xMax, Int32& yMin, Int32& yMax, Bool reset) { C4DOS.Bm->GetUpdateRegion(this, xMin, xMax, yMin, yMax, reset); }
	...
	//----------------------------------------------------------------------------------------
	Bool SetColorProfile(const ColorProfile* profile, Int32 index = COLORPROFILE_INDEX_IMAGE) { return C4DOS.Bm->SetColorProfile(this, profile, index); }

	//----------------------------------------------------------------------------------------
	/// Gets the color profile of the bitmap.
	/// @return												The color profile of the bitmap, or @formatConstant{nullptr} if not available.
	//----------------------------------------------------------------------------------------
	const ColorProfile* GetColorProfile(Int32 index = COLORPROFILE_INDEX_IMAGE) const { return C4DOS.Bm->GetColorProfile(this, index); }
