...
Int32 GeListNode::GetInfo(void) const
{
...
maxon::NimbusForwardRef BaseList2D::GetNimbusRef(const maxon::Id& spaceId) const
{
	return maxon::NimbusForwardRef(reinterpret_cast<maxon::ObjectInterface*>(BlCall(GetNimbusRef)(spaceId)));
}
...
{
	return C4DOS.Ge->HandleModifyFilenameMessage(msgType, msgData, filename, undoBl, modifyFilenameDelegate);
}
