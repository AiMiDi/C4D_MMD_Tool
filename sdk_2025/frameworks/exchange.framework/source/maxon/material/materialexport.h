...
public:
	...
	//----------------------------------------------------------------------------------------
	static MAXON_METHOD Result<MaterialExchangeData> Export(const cinema::BaseMaterial& baseMaterial, const DataDictionary& config);
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<void> Initialize(const cinema::BaseMaterial& baseMaterial, const DataDictionary& config);
