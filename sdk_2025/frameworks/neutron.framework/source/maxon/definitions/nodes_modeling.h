...
namespace NEUTRON
{
	...
	namespace GEOMETRY
	{
		...
		namespace CONNECT_GEOMETRIES
		{
			...
			MAXON_ATTRIBUTE(String, ERROR_MSG_MAX_DATA_COUNT_REACHED, "error_msg_max_data_count_reached");

			MAXON_ATTRIBUTE(String, ERROR_MSG_FILTER_GEOMS_FAILED, "error_msg_filter_geoms_failed");

			MAXON_ATTRIBUTE(String, ERROR_MSG_WRONG_GEOM_DT, "error_msg_wrong_geom_dt");
		}
		...
		namespace COPY_TO_POINTS
		{
			...
			/// This type is defined at runtine in the nodetemplate as
			/// UnionType{Array<Vector>, Array<Matrix>, GeometryObject, Distribution}
		...
		namespace DELETE_PROPERTY
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.delete_property");
			...
			MAXON_ATTRIBUTE(String, ACCESSORNAMEIN, "accessornamein");

			MAXON_ATTRIBUTE(Bool, ONLYFIRSTIN, "onlyfirstin");

			MAXON_ATTRIBUTE(void, GEOMETRYOUT, "geometryout");

			MAXON_ATTRIBUTE(String, DELETE, "delete");
		}
		...
		namespace GETVERTEXSELECTIONDATA
		{
			...
			MAXON_ATTRIBUTE(Array<Array<Int32>>, POLYIDSOUT, "polyidsout");
		...
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.get_property");
			...
			MAXON_ATTRIBUTE(Id, COMPONENTIN, "componentin",
				RESOURCE_DEFINE(ENUM_POINTS, LiteralId("points"))
				RESOURCE_DEFINE(ENUM_POLYPOINTS, LiteralId("polypoints")));

			MAXON_ATTRIBUTE(Id, FALLBACKMODEIN, "fallbackmodein",
				RESOURCE_DEFINE(ENUM_NONE, LiteralId("none"))
				RESOURCE_DEFINE(ENUM_DEFAULT, LiteralId("default"))
				RESOURCE_DEFINE(ENUM_CUSTOM, LiteralId("custom")));

			MAXON_ATTRIBUTE(Generic, FALLBACKVALUEIN, "fallbackvaluein");

			MAXON_ATTRIBUTE(Id, ACCESSORTYPEOUT, "accessortypeout");

			MAXON_ATTRIBUTE(String, ACCESSORNAMEOUT, "accessornameout");

			MAXON_ATTRIBUTE(Bool, ISATTRIBUTEFOUNDOUT, "isattributefoundout");

			MAXON_ATTRIBUTE(void, ARRAY, "array");

			MAXON_ATTRIBUTE(void, TOPOLOGY, "topology");

			MAXON_ATTRIBUTE(String, GET, "get");
		}
		...
		namespace POINTSMODIFIER
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.pointsmodifier");
			...
			MAXON_ATTRIBUTE(void, SELECTIONIN, "selectionin");

			MAXON_ATTRIBUTE(InternedId, SELECTIONMODEIN, "selectionmodein");
			...
			MAXON_ATTRIBUTE(void, POINTIN_INDEX, "pointin_index");

			MAXON_ATTRIBUTE(void, POINTIN_RATIO, "pointin_ratio");

			MAXON_ATTRIBUTE(void, POINTIN_NEIGHBORS, "pointin_neighbors");

			MAXON_ATTRIBUTE(void, POINTIN_POLYGON, "pointin_polygon");

			MAXON_ATTRIBUTE(void, POINTIN_EDGE, "pointin_edge");

			MAXON_ATTRIBUTE(void, POINTIN_SELECTED, "pointin_selected");

			MAXON_ATTRIBUTE(void, POINTIN_POSITION, "pointin_position");

			MAXON_ATTRIBUTE(Group, SELECTION, "net.maxon.neutron.geometry.pointsmodifier.selection");

			MAXON_ATTRIBUTE(Group, PROPERTIES, "net.maxon.neutron.geometry.pointsmodifier.properties");

			MAXON_ATTRIBUTE(Group, POINTOUT, "net.maxon.neutron.geometry.pointsmodifier.pointout");

			MAXON_ATTRIBUTE(Group, POINTIN, "net.maxon.neutron.geometry.pointsmodifier.pointin");

			MAXON_ATTRIBUTE(Group, PROPERTIES_NORMALS, "net.maxon.neutron.geometry.pointsmodifier.properties_normals");

			MAXON_ATTRIBUTE(Group, PROPERTIES_COLORS, "net.maxon.neutron.geometry.pointsmodifier.properties_colors");

			MAXON_ATTRIBUTE(Group, PROPERTIES_WEIGHTS, "net.maxon.neutron.geometry.pointsmodifier.properties_weights");
		}
		...
		//----------------------------------------------------------------------------------------
		/// Deprecated node, use the new node net.maxon.neutron.geometry.set_property
		//----------------------------------------------------------------------------------------
		namespace SET
		{
		...
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.set_property");
			...
			MAXON_ATTRIBUTE(String, SET, "set");

			MAXON_ATTRIBUTE(String, ERROR_WRONG_INPUT_VALUE, "error_wrong_input_value");

			MAXON_ATTRIBUTE(String, ERROR_NO_TOPO, "error_no_topo");

			MAXON_ATTRIBUTE(String, ERROR_NO_DATA_FOR_POLY_ID, "error_no_data_for_poly_id");

			MAXON_ATTRIBUTE(String, ERROR_CANT_GET_ATTRIBUTE_NAMED, "error_cant_get_attribute_named");

			MAXON_ATTRIBUTE(String, ERROR_PT_INDEX_NEGATIVE, "error_pt_index_negative");

			MAXON_ATTRIBUTE(String, ERROR_PT_INDEX_BIGGER_DT_COUNT, "error_pt_index_bigger_dt_count");

			MAXON_ATTRIBUTE(String, ERROR_OUTLINE_NEGATIVE, "error_outline_negative");

			MAXON_ATTRIBUTE(String, ERROR_OUTLINE_COUNT_TOO_BIG, "error_outline_count_too_big");

			MAXON_ATTRIBUTE(String, ERROR_SPLINE_NORMAL, "error_spline_normal");
		}
		...
		namespace SPLINE
		{
			...
			namespace OUTLINE
			{
				MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.spline.outline");
				...
				MAXON_ATTRIBUTE(InternedId, OUTPUTIN, "outputin");
				MAXON_ATTRIBUTE(void, OUTPUTIN_ENUM_ALL, "all");
				MAXON_ATTRIBUTE(void, OUTPUTIN_ENUM_INSIDE, "inside");
				MAXON_ATTRIBUTE(void, OUTPUTIN_ENUM_OUTSIDE, "outside");

				MAXON_ATTRIBUTE(Float, ALIGNIN, "alignin");

				MAXON_ATTRIBUTE(Float, THICKNESSIN, "thicknessin");

				MAXON_ATTRIBUTE(String, THICKNESSMAPIN, "thicknessmapin");

				MAXON_ATTRIBUTE(InternedId, CAPSTARTIN, "capstartin");
				MAXON_ATTRIBUTE(void, CAPSTARTIN_ENUM_OFF, "off");
				MAXON_ATTRIBUTE(void, CAPSTARTIN_ENUM_LINEAR, "linear");
				MAXON_ATTRIBUTE(void, CAPSTARTIN_ENUM_ROUND, "round");

				MAXON_ATTRIBUTE(InternedId, CAPENDIN, "capendin");
				MAXON_ATTRIBUTE(void, CAPENDIN_ENUM_OFF, "off");
				MAXON_ATTRIBUTE(void, CAPENDIN_ENUM_LINEAR, "linear");
				MAXON_ATTRIBUTE(void, CAPENDIN_ENUM_ROUND, "round");

				MAXON_ATTRIBUTE(InternedId, PLANEIN, "planein");
				MAXON_ATTRIBUTE(void, PLANEIN_ENUM_AUTO, "auto");
				MAXON_ATTRIBUTE(void, PLANEIN_ENUM_XY, "xy");
				MAXON_ATTRIBUTE(void, PLANEIN_ENUM_ZY, "zy");
				MAXON_ATTRIBUTE(void, PLANEIN_ENUM_XZ, "xz");

				MAXON_ATTRIBUTE(Bool, SELSTARTENABLEIN, "selstartenablein");

				MAXON_ATTRIBUTE(String, SELSTARTNAMEIN, "selstartnamein");

				MAXON_ATTRIBUTE(Bool, SELENDENABLEIN, "selendenablein");

				MAXON_ATTRIBUTE(String, SELENDNAMEIN, "selendnamein");

				MAXON_ATTRIBUTE(Bool, SELINSIDEENABLEIN, "selinsideenablein");

				MAXON_ATTRIBUTE(String, SELINSIDENAMEIN, "selinsidenamein");

				MAXON_ATTRIBUTE(Bool, SELOUTSIDEENABLEIN, "seloutsideenablein");

				MAXON_ATTRIBUTE(String, SELOUTSIDENAMEIN, "seloutsidenamein");

				MAXON_ATTRIBUTE(GeometryObject, GEOMETRYOUT, "geometryout");

				MAXON_ATTRIBUTE(Group, GROUPCAPS, "groupcaps");

				MAXON_ATTRIBUTE(Group, GROUPSELECTIONIN, "groupselectionin");
			}

			namespace RESAMPLE
			{
				MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.spline.resample");
				...
				MAXON_ATTRIBUTE(Id, MODEIN, "modein",
					RESOURCE_DEFINE(ENUM_COUNT, LiteralId("count"))
					RESOURCE_DEFINE(ENUM_STEP, LiteralId("step"))
					RESOURCE_DEFINE(ENUM_INSERT, LiteralId("insert")));

				MAXON_ATTRIBUTE(Int32, COUNTIN, "countin");

				MAXON_ATTRIBUTE(Float, STEPIN, "stepin");

				MAXON_ATTRIBUTE(Bool, UNIFORMIN, "uniformin");

				MAXON_ATTRIBUTE(Id, SEGMENTDISTRIBUTIONIN, "segmentdistributionin",
					RESOURCE_DEFINE(ENUM_DISTANCE, LiteralId("distance"))
					RESOURCE_DEFINE(ENUM_NUMBER, LiteralId("number")));

				MAXON_ATTRIBUTE(Bool, PERSEGMENTIN, "persegmentin");

				MAXON_ATTRIBUTE(Int32, INSERTIN, "insertin");

				MAXON_ATTRIBUTE(Bool, KEEPPOINTSIN, "keeppointsin");

				MAXON_ATTRIBUTE(String, ERROR_MSG_WRONG_GEO_TYPE, "error_msg_wrong_geo_type");

				MAXON_ATTRIBUTE(String, ERROR_MSG_COUNT_EXPECT_POSITIVE_NUMBER, "error_msg_count_expect_positive_number");

				MAXON_ATTRIBUTE(String, ERROR_MSG_STEP_EXPECT_POSITIVE_NUMBER, "error_msg_step_expect_positive_number");

				MAXON_ATTRIBUTE(String, ERROR_MSG_INSERT_EXPECT_POSITIVE_NUMBER, "error_msg_insert_expect_positive_number");
			}

			namespace SETCLOSEDSTATUS
			{
				MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.geometry.spline.setclosedstatus");
				...
				MAXON_ATTRIBUTE(Bool, CLOSEDIN, "closedin");

				MAXON_ATTRIBUTE(void, GEOMETRYOUT, "geometryout");

				MAXON_ATTRIBUTE(String, STR_CLOSE, "str.close");

				MAXON_ATTRIBUTE(String, STR_OPEN, "str.open");

				MAXON_ATTRIBUTE(String, ERR_NOTASPLINE, "err.notaspline");
			}
	...
	namespace MODELING
	{
		...
		//----------------------------------------------------------------------------------------
		/// This Node is hidden and deprecated, if you are looking for the new Connect node, 
		/// have a look at net.maxon.neutron.modeling.connect_geometries
		//----------------------------------------------------------------------------------------
		namespace CONNECT
		{
		...
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.modeling.disconnect");
			...
			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_DISCONNECT_PRESERVEGROUPS, "net.maxon.command.modeling.disconnect.preservegroups");
		}
		...
		namespace EDGESMOOTH
		{
			...
			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_EDGESMOOTH_KEEPSPACING, "net.maxon.command.modeling.edgesmooth.keepspacing");
		...
		namespace QUADREMESH
		{
			...
			// supports MAXON::COMMAND::MODELING::QUADREMESH::TRANSFERATTRIBUTES
		}
		...
		namespace SPLIT
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.modeling.split");
			...
			MAXON_ATTRIBUTE(Bool, SWAPIN, "swapin");

			MAXON_ATTRIBUTE(GeometryObject, REMAINDERGEOOUT, "remaindergeoout");
		}
		...
		namespace SYMMETRY
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.modeling.symmetry");
			...
			MAXON_ATTRIBUTE(Vector, COMMAND_MODELING_SYMMETRYNODECOMMAND_POSITION, "net.maxon.command.modeling.symmetrynodecommand.position");

			MAXON_ATTRIBUTE(Vector, COMMAND_MODELING_SYMMETRYNODECOMMAND_ROTATION, "net.maxon.command.modeling.symmetrynodecommand.rotation");

			MAXON_ATTRIBUTE(Id, COMMAND_MODELING_SYMMETRYNODECOMMAND_TYPE, "net.maxon.command.modeling.symmetrynodecommand.type",
				RESOURCE_DEFINE(ENUM_PLANAR, LiteralId("planar"))
				RESOURCE_DEFINE(ENUM_RADIAL, LiteralId("radial")));

			MAXON_ATTRIBUTE(Id, COMMAND_MODELING_SYMMETRYNODECOMMAND_PLANARAXISX, "net.maxon.command.modeling.symmetrynodecommand.planaraxisx",
				RESOURCE_DEFINE(ENUM_OFF, LiteralId("off"))
				RESOURCE_DEFINE(ENUM_POSTONEG, LiteralId("postoneg"))
				RESOURCE_DEFINE(ENUM_NEGTOPOS, LiteralId("negtopos")));

			MAXON_ATTRIBUTE(Id, COMMAND_MODELING_SYMMETRYNODECOMMAND_PLANARAXISY, "net.maxon.command.modeling.symmetrynodecommand.planaraxisy",
				RESOURCE_DEFINE(ENUM_OFF, LiteralId("off"))
				RESOURCE_DEFINE(ENUM_POSTONEG, LiteralId("postoneg"))
				RESOURCE_DEFINE(ENUM_NEGTOPOS, LiteralId("negtopos")));

			MAXON_ATTRIBUTE(Id, COMMAND_MODELING_SYMMETRYNODECOMMAND_PLANARAXISZ, "net.maxon.command.modeling.symmetrynodecommand.planaraxisz",
				RESOURCE_DEFINE(ENUM_OFF, LiteralId("off"))
				RESOURCE_DEFINE(ENUM_POSTONEG, LiteralId("postoneg"))
				RESOURCE_DEFINE(ENUM_NEGTOPOS, LiteralId("negtopos")));

			MAXON_ATTRIBUTE(Id, COMMAND_MODELING_SYMMETRYNODECOMMAND_RADIALAXIS, "net.maxon.command.modeling.symmetrynodecommand.radialaxis",
				RESOURCE_DEFINE(ENUM_X, LiteralId("x"))
				RESOURCE_DEFINE(ENUM_Y, LiteralId("y"))
				RESOURCE_DEFINE(ENUM_Z, LiteralId("z")));

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_SYMMETRYNODECOMMAND_RADIALROTATIONOFFSET, "net.maxon.command.modeling.symmetrynodecommand.radialrotationoffset");

			MAXON_ATTRIBUTE(Int, COMMAND_MODELING_SYMMETRYNODECOMMAND_RADIALSLICECOUNT, "net.maxon.command.modeling.symmetrynodecommand.radialslicecount");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_SYMMETRYNODECOMMAND_RADIALMIRROR, "net.maxon.command.modeling.symmetrynodecommand.radialmirror");

			MAXON_ATTRIBUTE(Int, COMMAND_MODELING_SYMMETRYNODECOMMAND_RADIALSOURCESLICE, "net.maxon.command.modeling.symmetrynodecommand.radialsourceslice");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_SYMMETRYNODECOMMAND_CUTALONGPLANE, "net.maxon.command.modeling.symmetrynodecommand.cutalongplane");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_SYMMETRYNODECOMMAND_REMOVEOUTSIDE, "net.maxon.command.modeling.symmetrynodecommand.removeoutside");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_SYMMETRYNODECOMMAND_WELDSEAM, "net.maxon.command.modeling.symmetrynodecommand.weldseam");

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_SYMMETRYNODECOMMAND_TOLERANCE, "net.maxon.command.modeling.symmetrynodecommand.tolerance");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_SYMMETRYNODECOMMAND_DISSOLVE, "net.maxon.command.modeling.symmetrynodecommand.dissolve");
		}

		namespace THICKEN
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.neutron.modeling.thicken");
			...
			MAXON_ATTRIBUTE(Id, COMMAND_MODELING_THICKENNODECOMMAND_MODE, "net.maxon.command.modeling.thickennodecommand.mode",
				RESOURCE_DEFINE(ENUM_BASIC, LiteralId("basic"))
				RESOURCE_DEFINE(ENUM_ADVANCED, LiteralId("advanced")));

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_THICKENNODECOMMAND_THICKNESS, "net.maxon.command.modeling.thickennodecommand.thickness");

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_THICKENNODECOMMAND_THICKNESSCLAMP, "net.maxon.command.modeling.thickennodecommand.thicknessclamp");

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_THICKENNODECOMMAND_POSITION, "net.maxon.command.modeling.thickennodecommand.position");

			MAXON_ATTRIBUTE(Int, COMMAND_MODELING_THICKENNODECOMMAND_SUBDIVISION, "net.maxon.command.modeling.thickennodecommand.subdivision");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_THICKENNODECOMMAND_CREATESHELL, "net.maxon.command.modeling.thickennodecommand.createshell");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_THICKENNODECOMMAND_CREATESTARTCAP, "net.maxon.command.modeling.thickennodecommand.createstartcap");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_THICKENNODECOMMAND_CREATEENDCAP, "net.maxon.command.modeling.thickennodecommand.createendcap");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_THICKENNODECOMMAND_RESOLVEINTERSECTIONS, "net.maxon.command.modeling.thickennodecommand.resolveintersections");

			MAXON_ATTRIBUTE(Bool, COMMAND_MODELING_THICKENNODECOMMAND_OPTIMIZE, "net.maxon.command.modeling.thickennodecommand.optimize");

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_THICKENNODECOMMAND_PERPENDICULARBOUNDARY, "net.maxon.command.modeling.thickennodecommand.perpendicularboundary");

			MAXON_ATTRIBUTE(Float, COMMAND_MODELING_THICKENNODECOMMAND_PRESERVECORNERS, "net.maxon.command.modeling.thickennodecommand.preservecorners");
		}
