...
//----------------------------------------------------------------------------------------
/// @brief Gets the capsule's serializable node data.
/// To yield a NodeSystemData that can be instantiated as a node or capsule, the resulting NodeSystemData will be created as if the capsule was a node.
/// Hence, the SerializationNodeData will have a node asset as base id, not CAPSULEASSETWRAPPERID.
/// Also the capsule related template arguments will be removed.
/// Later capsule instantiation of this asset will instantiate CAPSULEASSETWRAPPERID NodeSystem 
/// with some capsule TemplatArguments to identify the asset used as a capsule.
/// Arguments: Tuple<NodeSystemData /* Where to write the serializable data */, Array<IdAndVersion> /* List of base assets */>*
//----------------------------------------------------------------------------------------
...
static constexpr Int32 MSG_ADD_POST_CALCULATE_CACHES_ACTION = 180420126;
...
//----------------------------------------------------------------------------------------
/// @brief Capsule instantiation message.
...
//----------------------------------------------------------------------------------------
/// @brief Capsule IdAndVersion request message.
/// Send this message to a BaseList2D of type neutron::CAPSULE_BASE_ID to get the identifier of the node asset from which this capsule originates.
/// Argument: IdAndVersion* (output)
//----------------------------------------------------------------------------------------
static constexpr Int32 MSG_GET_ASSET_WITH_VERSION = 1062823;
