...
public:
	...
	//----------------------------------------------------------------------------------------
	static MAXON_METHOD Result<void> InitInterpolationClasses();
...
namespace InterpolateTypes
{
	...
	MAXON_DECLARATION(InterpolateTypes::EntryType, TANGENT, "net.maxon.geometry.interpolation.types.tangent3d");
	MAXON_DECLARATION(InterpolateTypes::EntryType, TANGENT2D, "net.maxon.geometry.interpolation.types.tangent2d");
}
