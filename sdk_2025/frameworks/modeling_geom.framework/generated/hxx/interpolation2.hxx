...
struct InterpolateTypeInterface::Hxx2
{
	...
	PRIVATE_MAXON_SF_POINTER(InterpolateTypeInterface_InitInterpolationClasses, InitInterpolationClasses, MAXON_EXPAND_VA_ARGS, (Result<void>));
		...
		tbl->InterpolateTypeInterface_InitInterpolationClasses = InterpolateTypeInterface_InitInterpolationClasses_GetPtr<IMPL>(true);
		}
	};
	...
	public:
		...
		static Result<void> InterpolateTypeInterface_InitInterpolationClasses() { return S::Implementation::InitInterpolationClasses(); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto InterpolateTypeInterface::InitInterpolationClasses() -> Result<void>
{
	return Hxx2::StaticMTable::_instance.InterpolateTypeInterface_InitInterpolationClasses();
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto InterpolateTypeInterface::Hxx1::ConstFn<S>::InitInterpolationClasses() -> Result<void>
{
	return (Hxx2::StaticMTable::_instance.InterpolateTypeInterface_InitInterpolationClasses());
}
