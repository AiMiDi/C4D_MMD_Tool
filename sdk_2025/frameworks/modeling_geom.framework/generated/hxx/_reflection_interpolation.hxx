...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_InterpolateTypeInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(InterpolateTypeInterface::Hxx2::StaticMTable::_instance.InterpolateTypeInterface_InitInterpolationClasses)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
