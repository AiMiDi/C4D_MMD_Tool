...
namespace maxon
{
	...
	public:
		...
		static Result<Float> InTriangle(const Vector2d& pointA, const Vector2d& pointB, const Vector2d& pointC, const Vector2d& testPoint) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ExactPredicates2DInterface::InTriangle(pointA, pointB, pointC, testPoint); return HXXRET1(UNRESOLVED);}
		static Result<Float> InSector(const Vector2d& center, const Vector2d& rayA, const Vector2d& rayB, const Vector2d& testPoint) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ExactPredicates2DInterface::InSector(center, rayA, rayB, testPoint); return HXXRET1(UNRESOLVED);}
		static Result<Bool> OutlineSelfIntersectionTest(const Block<const Vector2d>& outline) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ExactPredicates2DInterface::OutlineSelfIntersectionTest(outline); return HXXRET1(UNRESOLVED);}
		static Result<Bool> OutlinesIntersectionTest(const Block<const Vector2d>& outline1, const Block<const Vector2d>& outline2) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ExactPredicates2DInterface::OutlinesIntersectionTest(outline1, outline2); return HXXRET1(UNRESOLVED);}
		static Result<Bool> OutlinesIntersectionTest(const Block<const Block<const Vector2d>>& outlines) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ExactPredicates2DInterface::OutlinesIntersectionTest(outlines); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE ExactPredicates2DInterface::MTable::_returnTypes[] = 
	{
	...
	maxon::Bool ExactPredicates2DInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Float>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_InTriangle = PRIVATE_MAXON_MF_CAST(decltype(ExactPredicates2DInterface_InTriangle), &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InTriangle);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Float>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_InSector = PRIVATE_MAXON_MF_CAST(decltype(ExactPredicates2DInterface_InSector), &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_InSector);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Bool>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_OutlineSelfIntersectionTest = PRIVATE_MAXON_MF_CAST(decltype(ExactPredicates2DInterface_OutlineSelfIntersectionTest), &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlineSelfIntersectionTest);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Bool>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ExactPredicates2DInterface_OutlinesIntersectionTest = PRIVATE_MAXON_MF_CAST(decltype(ExactPredicates2DInterface_OutlinesIntersectionTest), &Hxx2::Wrapper<Hxx2::Unresolved>::ExactPredicates2DInterface_OutlinesIntersectionTest);
		#else
	...
	MAXON_INTERFACE_REGISTER(ExactPredicates2DInterface, "net.maxon.interface.exactpredicates2d", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
