...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<Voronoi3DInterface, maxon::StrongRefHandler, Voronoi3DRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<Voronoi3DInterface, maxon::StrongRefHandler, Voronoi3DRef>>>>);
