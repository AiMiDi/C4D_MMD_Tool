...
namespace maxon
{
	...
	public:
		...
		static Result<void> InitInterpolationClasses() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, false)) return InterpolateTypeInterface::InitInterpolationClasses(); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
	...
	maxon::Bool InterpolateTypeInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->InterpolateTypeInterface_InitInterpolationClasses = PRIVATE_MAXON_MF_CAST(decltype(InterpolateTypeInterface_InitInterpolationClasses), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::InterpolateTypeInterface_InitInterpolationClasses);
		#else
		tbl->InterpolateTypeInterface_InitInterpolationClasses = PRIVATE_MAXON_MF_CAST(decltype(InterpolateTypeInterface_InitInterpolationClasses), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::InterpolateTypeInterface_InitInterpolationClasses);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	const maxon::Char* const InterpolateTypeInterface::Hxx2::StaticMTable::_ids = 
		...
		"InitInterpolationClasses@a0cff72f181cfa62\0" // Result<void> InitInterpolationClasses()
	"";
