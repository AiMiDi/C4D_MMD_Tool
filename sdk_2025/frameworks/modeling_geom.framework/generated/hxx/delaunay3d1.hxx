...
struct Delaunay3DInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = Delaunay3DInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(Delaunay3DInterface**);
...
/// @return												A constant reference to a BaseArray<Tetrahedron> with the tetrahedrons, that make up the tetrahedralization.
		inline HXXADDRET2(const BaseArray<Tetrahedron>&) GetTetrahedrons(Int& arrayCount, Int& pointCount) const;
/// Gets a constant reference to the tetrahedrons list.
/// THREADSAFE.
/// @return												A constant reference to a BaseArray<Tetrahedron> with the tetrahedrons, that make up the tetrahedralization.
		inline HXXADDRET2(const BaseArray<Tetrahedron>&) GetTetrahedrons() const;
...
/// @return												A constant reference to a BaseArray<Int32> with the tetrahedron index to the point at the same array position as added.
		inline HXXADDRET2(const BaseArray<Int32>&) GetPointsToTetConnections() const;
...
/// @return												A constant reference to a BaseArray<Vector> with the points of the tetrahedralization.
		inline HXXADDRET2(const BaseArray<Vector>&) GetPoints() const;
/// Gets the current amount of tetrahedrons.
/// THREADSAFE.
/// @return												Amount of tetrahedrons.
		inline HXXADDRET2(Int) GetTetrahedronCount() const;
...
/// @return												True if the point was inside a tetrahedron, false otherwise or on error.
	...
	public:
		...
		using PrivateInterface = Delaunay3DInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(Delaunay3DInterface**);
...
/// @return												A reference to a BaseArray<Vector> with the points of the tetrahedralization.
		inline HXXADDRET2(ResultRef<BaseArray<Vector>>) GetPointsWrite() const;
...
/// Resets all data structures for a new calculation. Needs to be reinitialized before its reused.
	...
	public:
		...
		using PrivateInterface = Delaunay3DInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(Delaunay3DInterface**);
...
#ifdef DOXYGEN
public FnDoxy<Delaunay3DRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<Delaunay3DInterface, maxon::StrongRefHandler, Delaunay3DRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<Delaunay3DInterface, maxon::StrongRefHandler, Delaunay3DRef>>>>);
