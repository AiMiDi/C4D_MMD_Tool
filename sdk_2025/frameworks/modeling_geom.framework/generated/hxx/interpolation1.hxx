...
struct InterpolateTypeInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = InterpolateTypeInterface;
...
/// @return												The datatype.
		inline HXXADDRET2(const DataType&) GetInterpolateDataType() const;
...
/// @param[in] dataSet						The data set to average.
		inline HXXADDRET2(void) Average(void* data, const Block<const void*>& dataSet) const;
...
/// @param[in] blendT							The second blend percentage [0.0..blend..1.0]. Interpolation Scheme [blendS1 .. blendT .. blendS2]
		inline HXXADDRET2(void) InterpolateBilinear(const DataTypePtr dataType, void* data1, const void* data2, const void* data3, const void* data4, Float blendS, Float blendT) const;
/// Return the interpolation class for the passed data type if exist.
/// Not thread safe. Make a prior call to InitInterpolationClasses for thread safe calls.
...
/// Force non lazy interpolation class list initialization.
/// @return												OK on success..
		static inline Result<void> InitInterpolationClasses();
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const InterpolateTypeInterface, maxon::StrongRefHandler, InterpolateType>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const InterpolateTypeInterface, maxon::StrongRefHandler, InterpolateType>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<InterpolateTypeInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<InterpolateTypeInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
