...
namespace maxon
{
	...
	public:
		...
		Result<void> CopyFrom(const Delaunay3DInterface* src, COLLECTION_RESIZE_FLAGS resizeFlags) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((Delaunay3DInterface*) this)->CopyFrom(src, resizeFlags); return HXXRET1(UNRESOLVED);}
		Result<void> Init(const Range<Vector>& workSpace) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((Delaunay3DInterface*) this)->Init(workSpace); return HXXRET1(UNRESOLVED);}
		Result<void> CalculateDelaunayTetrahedralization() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((Delaunay3DInterface*) this)->CalculateDelaunayTetrahedralization(); return HXXRET1(UNRESOLVED);}
		...
		Result<void> AddPointsIntoTetrahedralization(const BaseArray<Vector>& newPointsIn) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((Delaunay3DInterface*) this)->AddPointsIntoTetrahedralization(newPointsIn); return HXXRET1(UNRESOLVED);}
		Result<void> AddPointIntoTetrahedralization(const Vector& newPointIn) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((Delaunay3DInterface*) this)->AddPointIntoTetrahedralization(newPointIn); return HXXRET1(UNRESOLVED);}
		const BaseArray<Tetrahedron>& GetTetrahedrons(Int& arrayCount, Int& pointCount) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const Delaunay3DInterface*) this)->GetTetrahedrons(arrayCount, pointCount); return HXXRET3(UNRESOLVED, const BaseArray<Tetrahedron>&);}
		const BaseArray<Tetrahedron>& GetTetrahedrons() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const Delaunay3DInterface*) this)->GetTetrahedrons(); return HXXRET3(UNRESOLVED, const BaseArray<Tetrahedron>&);}
		const BaseArray<Int32>& GetPointsToTetConnections() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const Delaunay3DInterface*) this)->GetPointsToTetConnections(); return HXXRET3(UNRESOLVED, const BaseArray<Int32>&);}
		const BaseArray<Vector>& GetPoints() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const Delaunay3DInterface*) this)->GetPoints(); return HXXRET3(UNRESOLVED, const BaseArray<Vector>&);}
		ResultRef<BaseArray<Vector>> GetPointsWrite() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((Delaunay3DInterface*) this)->GetPointsWrite(); return HXXRET3(UNRESOLVED, ResultRef<BaseArray<Vector>>);}
		...
		Result<void> Reset() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((Delaunay3DInterface*) this)->Reset(); return HXXRET1(UNRESOLVED);}
		...
		Result<Bool> FindTetIndexContainingPoint(const Vector& point, Int32& foundTetIndex, Int32& onFace1, Int32& onFace2) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const Delaunay3DInterface*) this)->FindTetIndexContainingPoint(point, foundTetIndex, onFace1, onFace2); return HXXRET1(UNRESOLVED);}
		Result<Bool> FindTetContainingPoint(const Vector& point, Int32& foundTetIndex) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const Delaunay3DInterface*) this)->FindTetContainingPoint(point, foundTetIndex); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE Delaunay3DInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<Delaunay3DInterface*>::value,
		...
		maxon::details::UnresolvedReturnType<Result<void>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<void>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const BaseArray<Tetrahedron>&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const BaseArray<Tetrahedron>&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const BaseArray<Int32>&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const BaseArray<Vector>&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<ResultRef<BaseArray<Vector>>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
	...
	maxon::Bool Delaunay3DInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_CopyFrom = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_CopyFrom), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_CopyFrom);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Init);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_CalculateDelaunayTetrahedralization = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_CalculateDelaunayTetrahedralization), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_CalculateDelaunayTetrahedralization);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_AddPointsIntoTetrahedralization = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_AddPointsIntoTetrahedralization), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_AddPointsIntoTetrahedralization);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_AddPointIntoTetrahedralization = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_AddPointIntoTetrahedralization), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_AddPointIntoTetrahedralization);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const BaseArray<Tetrahedron>&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetTetrahedrons = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_GetTetrahedrons), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedrons);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const BaseArray<Tetrahedron>&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetTetrahedrons_1 = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_GetTetrahedrons_1), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetTetrahedrons_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const BaseArray<Int32>&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetPointsToTetConnections = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_GetPointsToTetConnections), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointsToTetConnections);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const BaseArray<Vector>&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetPoints = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_GetPoints), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPoints);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<ResultRef<BaseArray<Vector>>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_GetPointsWrite = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_GetPointsWrite), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_GetPointsWrite);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_Reset = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_Reset), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_Reset);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Bool>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_FindTetIndexContainingPoint = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_FindTetIndexContainingPoint), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_FindTetIndexContainingPoint);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Bool>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->Delaunay3DInterface_FindTetContainingPoint = PRIVATE_MAXON_MF_CAST(decltype(Delaunay3DInterface_FindTetContainingPoint), &Hxx2::Wrapper<Hxx2::Unresolved>::Delaunay3DInterface_FindTetContainingPoint);
		#else
	...
	MAXON_INTERFACE_REGISTER(Delaunay3DInterface, "net.maxon.interface.delaunay3d", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int Delaunay3DInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<ResultRef<BaseArray<Vector>>>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const BaseArray<Int32>&>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const BaseArray<Tetrahedron>&>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_delaunay3d(0
	| maxon::Delaunay3DInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
