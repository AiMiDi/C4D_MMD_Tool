...
struct Voronoi3DInterface::Hxx2
{
	...
	public:
		...
		static void Voronoi3DInterface_Free(const Voronoi3DInterface* object) { return S::Free(object); }
		static Voronoi3DInterface* Voronoi3DInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_Init, Voronoi3DInterface,, (Result<void>), const Range<Vector>& workSpace) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->Init(workSpace); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_CopyFrom, Voronoi3DInterface,, (Result<void>), const Voronoi3DInterface* src, COLLECTION_RESIZE_FLAGS resizeFlags) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->CopyFrom(src, resizeFlags); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_IsReadyButPendingChanges, Voronoi3DInterface,, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->IsReadyButPendingChanges(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_IsReady, Voronoi3DInterface,, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->IsReady(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_SetPoints, Voronoi3DInterface,, (Result<void>), const BaseArray<Vector>& points) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->SetPoints(points); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_AddPoint, Voronoi3DInterface,, (Result<void>), const Vector& pointIn) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->AddPoint(pointIn); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_AddPoints, Voronoi3DInterface,, (Result<void>), const BaseArray<Vector>& points) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->AddPoints(points); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_CalcCells, Voronoi3DInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->CalcCells(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_CalcTetrahedralization, Voronoi3DInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->CalcTetrahedralization(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_SetForClipping, Voronoi3DInterface,, (void), Bool clipping) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->SetForClipping(clipping); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetCellCount, Voronoi3DInterface,, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->GetCellCount(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetVoronoiPointPositions, Voronoi3DInterface, const, (const BaseArray<Vector>&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Voronoi3DInterface))->GetVoronoiPointPositions(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetInputPoints, Voronoi3DInterface, const, (const BaseArray<Vector>&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Voronoi3DInterface))->GetInputPoints(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetBorderCellFlags, Voronoi3DInterface,, (ResultRef<BaseArray<Bool>>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->GetBorderCellFlags(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetCellDataStructure, Voronoi3DInterface,, (ResultRef<BaseArray<CellData>>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->GetCellDataStructure(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetCellHasVolume, Voronoi3DInterface,, (ResultRef<BaseArray<Char>>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->GetCellHasVolume(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_ScaleCell, Voronoi3DInterface,, (Result<void>), Int cellIndex, Float scaleValue) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->ScaleCell(cellIndex, scaleValue); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_ScaleAllCells, Voronoi3DInterface,, (Result<void>), Float scaleValue) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->ScaleAllCells(scaleValue); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_GetDelaunayTetrizer, Voronoi3DInterface,, (ResultRef<Delaunay3DRef>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->GetDelaunayTetrizer(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_Flush, Voronoi3DInterface,, (void)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->Flush(); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_SetCellFuseGroup, Voronoi3DInterface,, (Result<void>), BaseArray<Int>& fuseIndices) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->SetCellFuseGroup(fuseIndices); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_FuseCells, Voronoi3DInterface,, (Result<void>), BaseArray<Pair<Int, Int>>& joinList) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->FuseCells(joinList); }
		PRIVATE_MAXON_MF_WRAPPER(Voronoi3DInterface_CreateInvertedVoronoiCell, Voronoi3DInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(Voronoi3DInterface))->CreateInvertedVoronoiCell(); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::IsReadyButPendingChanges() const -> HXXADDRET2(Bool)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::IsReady() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXNONCONST(, , false, maxon::PrivateLogNullptrError(false)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::SetForClipping(Bool clipping) const -> HXXADDRET2(void)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::GetCellCount() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXNONCONST(, , false, 0) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.Voronoi3DInterface_GetCellCount));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::ConstFn<S>::GetVoronoiPointPositions() const -> HXXADDRET2(const BaseArray<Vector>&)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::ConstFn<S>::GetInputPoints() const -> HXXADDRET2(const BaseArray<Vector>&)
{
	HXXRETURN0(HXXADDRET2(const BaseArray<Vector>&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const BaseArray<Vector>&)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.Voronoi3DInterface_GetInputPoints));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::GetBorderCellFlags() const -> HXXADDRET2(ResultRef<BaseArray<Bool>>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<BaseArray<Bool>>)); HXXRES; HXXNONCONST(, , false, HXXRET3(NULLPTR, ResultRef<BaseArray<Bool>>)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.Voronoi3DInterface_GetBorderCellFlags));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::GetCellDataStructure() const -> HXXADDRET2(ResultRef<BaseArray<CellData>>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<BaseArray<CellData>>)); HXXRES; HXXNONCONST(, , false, HXXRET3(NULLPTR, ResultRef<BaseArray<CellData>>)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.Voronoi3DInterface_GetCellDataStructure));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::GetCellHasVolume() const -> HXXADDRET2(ResultRef<BaseArray<Char>>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<BaseArray<Char>>)); HXXRES; HXXNONCONST(, , false, HXXRET3(NULLPTR, ResultRef<BaseArray<Char>>)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::GetDelaunayTetrizer() const -> HXXADDRET2(ResultRef<Delaunay3DRef>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<Delaunay3DRef>)); HXXRES; HXXNONCONST(, , false, HXXRET3(NULLPTR, ResultRef<Delaunay3DRef>)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.Voronoi3DInterface_GetDelaunayTetrizer));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto Voronoi3DInterface::Hxx1::Fn<S>::Flush() const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXNONCONST(DebugStop(), , false, maxon::PrivateLogNullptrError()) 
