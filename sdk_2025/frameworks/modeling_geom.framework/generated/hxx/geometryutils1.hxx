...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DegeneratedInputErrorInterface, maxon::StrongCOWRefHandler, DegeneratedInputError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DegeneratedInputErrorInterface, maxon::StrongCOWRefHandler, DegeneratedInputError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DegeneratedInputErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DegeneratedInputErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] DegeneratedInputError : public DegeneratedInputErrorInterface::Hxx1::Reference
{
public:
