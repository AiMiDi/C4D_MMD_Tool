...
MPyHashMapRef MPyHashMapInterface::CreateHashMapRef(const CPythonLibraryInterface* lib, REFTYPE refType, NativePyObject* pyObject)
{
	iferr (MPyHashMapRef res = lib->GetMPyHashMapRefClass().Create())
		return {};
	res.Init(lib, refType, pyObject);
	return res;
}
