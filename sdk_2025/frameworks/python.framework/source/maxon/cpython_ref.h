...
public:
	...
	{
		if (*static_cast<const Super*>(this) == nullptr)
			return true;
	...
	{
		if (*static_cast<const Super*>(this) == static_cast<const Super&>(o))
			return true;
...
class MPyHashMapRef : public CPyCompare<MPyHashMapInterface::Reference>
{
private:
	using Super = CPyCompare<MPyHashMapInterface::Reference>;
public:
	using Super::Super;
	using Super::operator =;
};
...
class CPyConstRef : public CPyRef
{
	using Super = CPyRef;
...
class CPyTypeConstRef : public CPyTypeRef
{
	using Super = CPyTypeRef;
