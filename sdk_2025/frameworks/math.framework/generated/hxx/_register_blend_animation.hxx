...
namespace maxon
{
	...
	const maxon::Char* const BlendTweenInterface::MTable::_ids = 
		...
		"ObservableAnimation@ed1358e509f0ee6c\0" // maxon::ObservableRef<ObservableAnimationDelegate> ObservableAnimation(maxon::Bool create) const
	"";
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BlendTweenInterface, , "net.maxon.interface.blendtween", (ObserverObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int BlendTweenInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<BlendFunctionRef>(OVERLOAD_MAX_RANK)
		;
	}
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BlendAnimationInterface, , "net.maxon.interface.blendanimation", (ObserverObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int BlendAnimationInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<ANIMBLENDSTATE>(OVERLOAD_MAX_RANK)
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_blend_animation(0
	| maxon::BlendTweenInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
	| maxon::BlendAnimationInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
