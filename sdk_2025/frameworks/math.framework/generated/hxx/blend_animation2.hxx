...
struct BlendTweenInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(BlendTweenInterface_ObservableAnimation, ObservableAnimation, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableAnimationDelegate>), maxon::Bool create);
...
struct BlendTweenInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(BlendTweenInterface_ObservableAnimation, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableAnimationDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableAnimation(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::ObservableAnimation(maxon::Bool create) const -> maxon::ObservableRef<ObservableAnimationDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BlendTweenInterface::Hxx1::ConstFn<S>::ObservableAnimation(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableAnimationDelegate>)
{
