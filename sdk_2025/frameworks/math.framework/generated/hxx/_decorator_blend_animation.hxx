...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservableAnimationDelegate> ObservableAnimation(maxon::Bool create) const
	{
		return maxon::Cast<BlendTweenRef>(self.GetDecoratedObject()).ObservableAnimation(create);
	}
...
public:
	...
	{
		return maxon::Cast<BlendAnimationRef>(self.GetDecoratedObject()).SetStartProgress(startProgress);
	}

	MAXON_METHOD void SetDirection(Bool reverse)
	{
		return maxon::Cast<BlendAnimationRef>(self.GetDecoratedObject()).SetDirection(reverse);
	}
