...
namespace maxon
{
	const maxon::Char* const NoiseInterface::MTable::_ids = 
		...
		"Alloc@b92bc59b023dd876\0" // NoiseInterface* Alloc(const maxon::SourceLocation& allocLocation, UInt32 seed, Int permutationTablePower)
		...
		"GetFbmTable@ff2f027bd021b759\0" // Result<void> GetFbmTable(FbmTableRef table, BaseArray<Float32>& fbm)
		...
		"InitFbm@cae1729a6905e2d3\0" // ResultMemT<FbmTableRef> InitFbm(Float32 lacunarity, Float32 gain)
	...
	public:
		...
		static NoiseInterface* Alloc(const maxon::SourceLocation& allocLocation, UInt32 seed, Int permutationTablePower) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return NoiseInterface::Alloc(allocLocation, seed, permutationTablePower); return nullptr;}
		Result<void> Init(UInt32 seed, Int permutationTablePower) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((NoiseInterface*) this)->Init(seed, permutationTablePower); return HXXRET1(UNRESOLVED);}
		...
		Result<void> GetGradientTable(Bool gradient3D, BaseArray<Vector4d32>& gradient) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const NoiseInterface*) this)->GetGradientTable(gradient3D, gradient); return HXXRET1(UNRESOLVED);}
		static Result<void> GetFbmTable(FbmTableRef table, BaseArray<Float32>& fbm) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return NoiseInterface::GetFbmTable(std::forward<FbmTableRef>(table), fbm); return HXXRET1(UNRESOLVED);}
		...
		static ResultMemT<FbmTableRef> InitFbm(Float32 lacunarity, Float32 gain) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return NoiseInterface::InitFbm(lacunarity, gain); return HXXRET3(UNRESOLVED, ResultMemT<FbmTableRef>);}
	...
	const maxon::UNRESOLVED_RETURN_TYPE NoiseInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<NoiseInterface*>::value,
		maxon::details::UnresolvedReturnType<NoiseInterface*>::value,
		...
		maxon::details::UnresolvedReturnType<const BaseArray<UInt16>*>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<void>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<const BaseArray<Vector4d32>*>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<void>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<void>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<ResultMemT<FbmTableRef>>::value,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Float32>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
	...
	maxon::Bool NoiseInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->NoiseInterface_Free = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Free), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Free);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Alloc = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Alloc), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Alloc);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Alloc_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Alloc_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Alloc_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->NoiseInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Init);
		#else
		tbl->NoiseInterface_Init = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Init), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Init);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetSeed = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetSeed), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetSeed);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetPermutationTablePower = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetPermutationTablePower), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetPermutationTablePower);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetPermutationTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetPermutationTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetPermutationTable);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->NoiseInterface_GetGradientTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetGradientTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetGradientTable);
		#else
		tbl->NoiseInterface_GetGradientTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetGradientTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetGradientTable);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->NoiseInterface_GetFbmTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetFbmTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetFbmTable);
		#else
		tbl->NoiseInterface_GetFbmTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetFbmTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetFbmTable);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_GetRandomTable = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_GetRandomTable), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_GetRandomTable);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_SNoise = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_SNoise), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_SNoise);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_SNoise_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_SNoise_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_SNoise_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_PeriodicSNoise = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_PeriodicSNoise), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_PeriodicSNoise);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_PeriodicSNoise_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_PeriodicSNoise_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_PeriodicSNoise_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Voronoi = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Voronoi), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Voronoi);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Voronoi_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Voronoi_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Voronoi_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<ResultMemT<FbmTableRef>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->NoiseInterface_InitFbm = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_InitFbm), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_InitFbm);
		#else
		tbl->NoiseInterface_InitFbm = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_InitFbm), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_InitFbm);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Fbm = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Fbm), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Fbm);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Fbm_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Fbm_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Fbm_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Turbulence = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Turbulence), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Turbulence);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_Turbulence_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_Turbulence_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_Turbulence_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_RidgedMultifractal = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_RidgedMultifractal), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_RidgedMultifractal);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->NoiseInterface_RidgedMultifractal_1 = PRIVATE_MAXON_MF_CAST(decltype(NoiseInterface_RidgedMultifractal_1), &Hxx2::Wrapper<Hxx2::Unresolved>::NoiseInterface_RidgedMultifractal_1);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(NoiseInterface, "net.maxon.render.interface.noise", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int NoiseInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<ResultMemT<FbmTableRef>>(OVERLOAD_MAX_RANK)
		;
	}
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(RenderNoiseInterface, , "net.maxon.render.interface.rendernoise", (ObjectInterface::PrivateGetInterface()));
...
static maxon::details::ForceEvaluation s_forceEval_noise(0
	| maxon::NoiseInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
