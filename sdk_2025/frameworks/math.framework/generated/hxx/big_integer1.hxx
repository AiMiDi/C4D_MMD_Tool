...
struct BigIntegerInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = BigIntegerInterface;
...
/// @return												-1 if the number is negative, 0 if it is zero, 1 if it is positive.
		inline HXXADDRET2(Int) Sign() const;
...
/// @return												The comparison result.
		inline HXXADDRET2(COMPARERESULT) Compare(const BigIntegerInterface* arg2) const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const BigIntegerInterface, maxon::StrongCOWRefHandler, BigInteger>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const BigIntegerInterface, maxon::StrongCOWRefHandler, BigInteger>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BigIntegerInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BigIntegerInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
