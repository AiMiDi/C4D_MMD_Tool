...
/// -param[in] animValue					The animated value.
		inline HXXADDRET2(maxon::ObservableRef<ObservableAnimationDelegate>) ObservableAnimation(maxon::Bool create) const;
	};
	/// Intermediate helper class for BlendTweenInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BlendTweenInterface, maxon::StrongRefHandler, BlendTweenRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BlendTweenInterface, maxon::StrongRefHandler, BlendTweenRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BlendAnimationInterface, maxon::StrongRefHandler, BlendAnimationRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BlendAnimationInterface, maxon::StrongRefHandler, BlendAnimationRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
