...
struct BlendFunctionInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = BlendFunctionInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BlendFunctionInterface, maxon::StrongRefHandler, BlendFunctionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BlendFunctionInterface, maxon::StrongRefHandler, BlendFunctionRef>>>>);
