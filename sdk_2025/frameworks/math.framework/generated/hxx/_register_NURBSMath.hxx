...
namespace maxon
{
	template <typename DUMMY> maxon::Int NURBSCurveInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<const Block<const Vector4d>>(OVERLOAD_MAX_RANK)
		;
	}
	namespace enum156
	{
		...
		static const maxon::UInt64 NURBSCURVE_KNOTMODE_values[] = {maxon::UInt64(enum156::NURBSCURVE_KNOTMODE::CLAMPED_UNIFORM), maxon::UInt64(enum156::NURBSCURVE_KNOTMODE::CLAMPED_CHORDAL), maxon::UInt64(enum156::NURBSCURVE_KNOTMODE::CLAMPED_CENTRIPETAL), maxon::UInt64(enum156::NURBSCURVE_KNOTMODE::UNCLAMPED_UNIFORM), maxon::UInt64(enum156::NURBSCURVE_KNOTMODE::USER_DEFINED)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_NURBSCURVE_KNOTMODE156(){ return enum156::NURBSCURVE_KNOTMODE_info; }
#if 0
#endif
}
#endif
static maxon::details::ForceEvaluation s_forceEval_NURBSMath(0
	| maxon::NURBSCurveInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
