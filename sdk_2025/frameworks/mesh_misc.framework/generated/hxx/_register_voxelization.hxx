...
namespace maxon
{
	const maxon::Char* const VoxelizationInterface::MTable::_ids = 
		"Init@1dadc2ef8f67ca83\0" // Result<Bool> Init(cinema::PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise)
		"Init@68d31081722a86d3\0" // Result<Bool> Init(cinema::PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride)
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(VoxelizationInterface, , "net.maxon.geom.interface.voxelization", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int VoxelizationInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<Range<IntVector32>>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const Range<Vector>&>(OVERLOAD_MAX_RANK)
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_voxelization(0
	| maxon::VoxelizationInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
