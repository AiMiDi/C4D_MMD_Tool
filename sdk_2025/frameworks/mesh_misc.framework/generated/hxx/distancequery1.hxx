...
/// @return												OK on success.
		inline Result<void> Init(cinema::PolygonObject* mesh, Bool initVoxelization = false) const;
...
/// @return												OK on success.
		inline Result<void> Init(cinema::SplineObject* spline) const;
...
/// @return												OK on success.
		inline Result<void> Init(cinema::LineObject* line) const;
...
/// @param[in] initVoxelization		Initializes a voxelization for the distance query. This Is useful for massive tests on high poly polygon objects.
/// @return												OK on success.
		inline Result<void> Init(cinema::PolygonObject* mesh, Bool initVoxelization = false);
/// Initializes the distance query with a spline object.
/// @param[in] spline							Reference to the spline object that the distance query is initialized to.
/// @return												OK on success.
		inline Result<void> Init(cinema::SplineObject* spline);
/// Initializes the distance query with a line object.
/// @param[in] line								Reference to the line object that the distance query is initialized to.
/// @return												OK on success.
		inline Result<void> Init(cinema::LineObject* line);
/// Initializes the distance query with a list of points and polygons.
/// @param[in] points							Block of Vectors that represent the points of the mesh.
/// @param[in] polygons						Block to Simple polygons that represent the topology.
/// @param[in] objectPosition			The matrix of the geometry.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DistanceQueryInterface, maxon::StrongRefHandler, DistanceQueryRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DistanceQueryInterface, maxon::StrongRefHandler, DistanceQueryRef>>>>);
