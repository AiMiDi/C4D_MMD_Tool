...
struct CustomDataTagDisplayInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(CustomDataTagDisplayInterface_Init, Init, true, maxon::GenericComponent,, (Result<void>), cinema::BaseTag* tag);
	maxon::Int CustomDataTagDisplayInterface_Init_Offset;
	PRIVATE_MAXON_MF_POINTER(CustomDataTagDisplayInterface_Draw, Draw, true, maxon::GenericComponent,, (Result<void>), cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh);
	maxon::Int CustomDataTagDisplayInterface_Draw_Offset;
	PRIVATE_MAXON_MF_POINTER(CustomDataTagDisplayInterface_DisplayControl, DisplayControl, true, maxon::GenericComponent, const, (Result<void>), const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds);
	maxon::Int CustomDataTagDisplayInterface_DisplayControl_Offset;
	PRIVATE_MAXON_MF_POINTER(CustomDataTagDisplayInterface_InitDisplayControl, InitDisplayControl, true, maxon::GenericComponent,, (Result<void>), cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active);
	maxon::Int CustomDataTagDisplayInterface_InitDisplayControl_Offset;
	PRIVATE_MAXON_MF_POINTER(CustomDataTagDisplayInterface_FreeDisplayControl, FreeDisplayControl, true, maxon::GenericComponent,, (void), cinema::BaseTag* tag);
...
struct CustomDataTagDisplayInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagDisplayInterface_Init, maxon::GenericComponent,, (Result<void>), cinema::BaseTag* tag) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->Init(tag); }
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagDisplayInterface_Draw, maxon::GenericComponent,, (Result<void>), cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->Draw(tag, op, bd, bh); }
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagDisplayInterface_DisplayControl, maxon::GenericComponent, const, (Result<void>), const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->DisplayControl(tag, doc, op, bd, bh, cds); }
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagDisplayInterface_InitDisplayControl, maxon::GenericComponent,, (Result<void>), cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->InitDisplayControl(tag, doc, bd, active); }
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagDisplayInterface_FreeDisplayControl, maxon::GenericComponent,, (void), cinema::BaseTag* tag) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->FreeDisplayControl(tag); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Init(cinema::BaseTag* tag) -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh) -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::DisplayControl(const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds) const -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active) -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::FreeDisplayControl(cinema::BaseTag* tag) -> void
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::Fn<S>::Init(cinema::BaseTag* tag) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::COWFn<S>::Init(cinema::BaseTag* tag) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::Fn<S>::Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::COWFn<S>::Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::ConstFn<S>::DisplayControl(const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::Fn<S>::InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::COWFn<S>::InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::Fn<S>::FreeDisplayControl(cinema::BaseTag* tag) const -> HXXADDRET2(void)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagDisplayInterface::Hxx1::COWFn<S>::FreeDisplayControl(cinema::BaseTag* tag) -> HXXADDRET1(void)
{
...
struct CustomDataTagClassInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(CustomDataTagClassInterface_Read, Read, true, maxon::GenericComponent, const, (Result<void>), void* data, cinema::HyperFile* hf, Int32 level);
	maxon::Int CustomDataTagClassInterface_Read_Offset;
	PRIVATE_MAXON_MF_POINTER(CustomDataTagClassInterface_Write, Write, true, maxon::GenericComponent, const, (Result<void>), const void* data, cinema::HyperFile* hf);
	...
	PRIVATE_MAXON_MF_POINTER(CustomDataTagClassInterface_Message, Message, true, maxon::GenericComponent, const, (Bool), cinema::GeListNode* node, Int32 type, void* data);
...
struct CustomDataTagClassInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagClassInterface_Read, maxon::GenericComponent, const, (Result<void>), void* data, cinema::HyperFile* hf, Int32 level) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->Read(data, hf, level); }
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagClassInterface_Write, maxon::GenericComponent, const, (Result<void>), const void* data, cinema::HyperFile* hf) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->Write(data, hf); }
		...
		PRIVATE_MAXON_MF_WRAPPER(CustomDataTagClassInterface_Message, maxon::GenericComponent, const, (Bool), cinema::GeListNode* node, Int32 type, void* data) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->Message(node, type, data); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Read(void* data, cinema::HyperFile* hf, Int32 level) const -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Write(const void* data, cinema::HyperFile* hf) const -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Message(cinema::GeListNode* node, Int32 type, void* data) const -> Bool
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Hxx1::ConstFn<S>::Read(void* data, cinema::HyperFile* hf, Int32 level) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Hxx1::ConstFn<S>::Write(const void* data, cinema::HyperFile* hf) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CustomDataTagClassInterface::Hxx1::ConstFn<S>::Message(cinema::GeListNode* node, Int32 type, void* data) const -> HXXADDRET2(Bool)
{
