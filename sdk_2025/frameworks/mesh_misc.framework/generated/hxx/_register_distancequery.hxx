...
namespace maxon
{
	namespace enum29
	{
		...
		static const maxon::UInt64 PRIMITIVETYPE_values[] = {maxon::UInt64(enum29::PRIMITIVETYPE::NONE), maxon::UInt64(enum29::PRIMITIVETYPE::POINT), maxon::UInt64(enum29::PRIMITIVETYPE::EDGE), maxon::UInt64(enum29::PRIMITIVETYPE::POLYGON)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_PRIMITIVETYPE29(){ return enum29::PRIMITIVETYPE_info; }
	const maxon::Char* const DistanceQueryInterface::MTable::_ids = 
		"Init@8c155a9f56112b11\0" // Result<void> Init(cinema::PolygonObject* mesh, Bool initVoxelization)
		"Init@1673299a70ed870a\0" // Result<void> Init(cinema::SplineObject* spline)
		"Init@3c03ed451b2d058b\0" // Result<void> Init(cinema::LineObject* line)
