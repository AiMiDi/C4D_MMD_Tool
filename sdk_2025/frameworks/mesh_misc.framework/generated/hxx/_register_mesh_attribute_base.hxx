...
namespace maxon
{
	const maxon::Char* const CustomDataTagDisplayInterface::MTable::_ids = 
		"Init@3eeff15c5054e711\0" // Result<void> Init(cinema::BaseTag* tag)
		"Draw@cac36c24756aebed\0" // Result<void> Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh)
		"DisplayControl@2c43f7d86c18cfe6\0" // Result<void> DisplayControl(const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds) const
		"InitDisplayControl@a6c9bf7f6c4706e6\0" // Result<void> InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active)
		"FreeDisplayControl@239b614262cea9c0\0" // void FreeDisplayControl(cinema::BaseTag* tag)
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CustomDataTagDisplayInterface, , "net.maxon.mesh_misc.interface.customdatatagdisplay", (ObjectInterface::PrivateGetInterface()));
	const maxon::Char* const MeshAttributeClassInterface::MTable::_ids = 
		...
		"GetUnderlyingDataType@a6c0b400f1ac4207\0" // const DataType& GetUnderlyingDataType() const
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MeshAttributeClassInterface, , "net.maxon.mesh_misc.interface.meshattributeclass", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int MeshAttributeClassInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
	...
	const maxon::Char* const CustomDataTagClassInterface::MTable::_ids = 
		...
		"Read@624088b6b16ac626\0" // Result<void> Read(void* data, cinema::HyperFile* hf, Int32 level) const
		"Write@f6fbdcdeeaad3e81\0" // Result<void> Write(const void* data, cinema::HyperFile* hf) const
		...
		"Message@ba73682a308efc5d\0" // Bool Message(cinema::GeListNode* node, Int32 type, void* data) const
	"";
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CustomDataTagClassInterface, , "net.maxon.mesh_misc.interface.customdatattag", (MeshAttributeClassInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int CustomDataTagClassInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_mesh_attribute_base(0
	| maxon::MeshAttributeClassInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
	| maxon::CustomDataTagClassInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
