...
/// @return												OK on success.
		inline Result<void> DisplayControl(const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds) const;
	};
	/// Intermediate helper class for CustomDataTagDisplayInterface.
...
/// @return												OK on success.
		inline Result<void> Init(cinema::BaseTag* tag) const;
/// Draws the visual representation of the tag data in 3D views.
/// @calledThreadContext
/// @note To get the current drawpass call @formatParam{bd}->@link cinema::BaseDraw::GetDrawPass GetDrawPass()@endlink.
...
/// @return												OK on success.
		inline Result<void> Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh) const;
/// Initializes resources for the display control used in @ref DisplayControl.
/// @param[in] tag								The cinema::BaseTag connected with the TagData instance. Equal to <tt>static_cast</tt><@ref TagData*>Get(). Provided for speed and convenience. @cinemaOwnsPointed{tag}
/// @param[in] doc								The active document. @cinemaOwnsPointed{document}
/// @param[in] bd									The active editor view. @cinemaOwnsPointed{base draw}
/// @param[in] active							The active objects array. @cinemaOwnsPointed{array}
/// @return												OK on success.
		inline Result<void> InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active) const;
/// Frees resources allocated by @ref InitDisplayControl.
/// @param[in] tag								The cinema::BaseTag connected with the TagData instance. Equal to <tt>static_cast</tt><@ref TagData*>Get(). Provided for speed and convenience. @cinemaOwnsPointed{tag}
		inline HXXADDRET2(void) FreeDisplayControl(cinema::BaseTag* tag) const;
...
/// @param[in] tag								The tag that owns the attributes.
/// @return												OK on success.
		inline Result<void> Init(cinema::BaseTag* tag);
/// Draws the visual representation of the tag data in 3D views.
/// @calledThreadContext
/// @note To get the current drawpass call @formatParam{bd}->@link cinema::BaseDraw::GetDrawPass GetDrawPass()@endlink.
/// @warning Only draw in @ref DRAWPASS::HIGHLIGHTS if you really know what you are doing. Otherwise always check the drawpass and then do not draw if it is @ref DRAWPASS::HIGHLIGHTS.
...
/// @param[in] bh									The helper for the editor's view. @callerOwnsPointed{view helper}
/// @return												OK on success.
		inline Result<void> Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh);
/// Initializes resources for the display control used in @ref DisplayControl.
/// @param[in] tag								The cinema::BaseTag connected with the TagData instance. Equal to <tt>static_cast</tt><@ref TagData*>Get(). Provided for speed and convenience. @cinemaOwnsPointed{tag}
/// @param[in] doc								The active document. @cinemaOwnsPointed{document}
/// @param[in] bd									The active editor view. @cinemaOwnsPointed{base draw}
/// @param[in] active							The active objects array. @cinemaOwnsPointed{array}
/// @return												OK on success.
		inline Result<void> InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active);
/// Frees resources allocated by @ref InitDisplayControl.
/// @param[in] tag								The cinema::BaseTag connected with the TagData instance. Equal to <tt>static_cast</tt><@ref TagData*>Get(). Provided for speed and convenience. @cinemaOwnsPointed{tag}
		inline HXXADDRET1(void) FreeDisplayControl(cinema::BaseTag* tag);
/// Resets any local data before destroying the class instance.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CustomDataTagDisplayInterface, maxon::StrongRefHandler, CustomDataTagDisplayRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CustomDataTagDisplayInterface, maxon::StrongRefHandler, CustomDataTagDisplayRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MeshAttributeClassInterface, maxon::StrongRefHandler, MeshAttributeClass>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MeshAttributeClassInterface, maxon::StrongRefHandler, MeshAttributeClass>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MeshAttributeClassInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MeshAttributeClassInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
/// @return												OK on success.
		inline Result<void> Read(void* data, cinema::HyperFile* hf, Int32 level) const;
/// Writes a single data entry to a fil.
/// @param[in] data								The data pointer.
/// @param[in] hf									The file handle to write on.
/// @return												OK on success.
		inline Result<void> Write(const void* data, cinema::HyperFile* hf) const;
...
/// @return												True on success.
		inline HXXADDRET2(Bool) Message(cinema::GeListNode* node, Int32 type, void* data) const;
	};
	template <typename ST> struct FnHelper : public std::conditional<
	false, void,
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const CustomDataTagClassInterface, maxon::StrongRefHandler, CustomDataTagClass>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const CustomDataTagClassInterface, maxon::StrongRefHandler, CustomDataTagClass>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CustomDataTagClassInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CustomDataTagClassInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
