...
struct VoxelizationInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(VoxelizationInterface_Init, Init, true, maxon::GenericComponent,, (Result<Bool>), cinema::PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise);
	maxon::Int VoxelizationInterface_Init_Offset;
	PRIVATE_MAXON_MF_POINTER(VoxelizationInterface_Init_1, Init, true, maxon::GenericComponent,, (Result<Bool>), cinema::PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride);
...
MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Init(cinema::PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) -> Result<Bool>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Init(cinema::PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::Fn<S>::Init(cinema::PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::COWFn<S>::Init(cinema::PolygonObject* polyObject, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride, Bool precise) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::Fn<S>::Init(cinema::PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VoxelizationInterface::Hxx1::COWFn<S>::Init(cinema::PolygonObject* polyObject, BaseArray<Int32>& polyIslands, Int32 voxelResolution, Int32 minResolution, BaseArray<Range<Vector>>& polyRanges, const Vector* pointOverride) -> Result<Bool>
{
