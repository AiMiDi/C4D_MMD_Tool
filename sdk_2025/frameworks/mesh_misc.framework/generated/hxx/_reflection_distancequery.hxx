...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(cinema::PolygonObject* mesh, Bool initVoxelization) 
		{
			...
			(*handler_)(_fn_DistanceQueryInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), cinema::PolygonObject*, Bool), reinterpret_cast<const void* const&>(mt_.DistanceQueryInterface_Init)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_DistanceQueryInterface_Init;
		Result<void> Init(cinema::SplineObject* spline) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), cinema::SplineObject*), reinterpret_cast<const void* const&>(mt_.DistanceQueryInterface_Init_1)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_DistanceQueryInterface_Init_1;
		Result<void> Init(cinema::LineObject* line) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_DistanceQueryInterface_Init_2, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), cinema::LineObject*), reinterpret_cast<const void* const&>(mt_.DistanceQueryInterface_Init_2)));
			return proxy_result;
		}
