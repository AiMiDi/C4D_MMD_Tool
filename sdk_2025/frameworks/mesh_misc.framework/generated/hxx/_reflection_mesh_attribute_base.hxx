...
namespace maxon
{
	...
	public:
		...
		Result<void> Init(cinema::BaseTag* tag) 
		{
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), cinema::BaseTag*), reinterpret_cast<const void* const&>(mt_.CustomDataTagDisplayInterface_Init)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CustomDataTagDisplayInterface_Init;
		Result<void> Draw(cinema::BaseTag* tag, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_Draw, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), cinema::BaseTag*, cinema::BaseObject*, cinema::BaseDraw*, cinema::BaseDrawHelp*), reinterpret_cast<const void* const&>(mt_.CustomDataTagDisplayInterface_Draw)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CustomDataTagDisplayInterface_Draw;
		Result<void> DisplayControl(const cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseObject* op, cinema::BaseDraw* bd, cinema::BaseDrawHelp* bh, cinema::ControlDisplayStruct& cds) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_DisplayControl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const cinema::BaseTag*, cinema::BaseDocument*, cinema::BaseObject*, cinema::BaseDraw*, cinema::BaseDrawHelp*, cinema::ControlDisplayStruct&), reinterpret_cast<const void* const&>(mt_.CustomDataTagDisplayInterface_DisplayControl)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CustomDataTagDisplayInterface_DisplayControl;
		Result<void> InitDisplayControl(cinema::BaseTag* tag, cinema::BaseDocument* doc, cinema::BaseDraw* bd, const cinema::AtomArray* active) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_InitDisplayControl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), cinema::BaseTag*, cinema::BaseDocument*, cinema::BaseDraw*, const cinema::AtomArray*), reinterpret_cast<const void* const&>(mt_.CustomDataTagDisplayInterface_InitDisplayControl)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CustomDataTagDisplayInterface_InitDisplayControl;
		void FreeDisplayControl(cinema::BaseTag* tag) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagDisplayInterface_FreeDisplayControl, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((void), cinema::BaseTag*), reinterpret_cast<const void* const&>(mt_.CustomDataTagDisplayInterface_FreeDisplayControl)));
		}
	...
	public:
		...
		Result<void> Read(void* data, cinema::HyperFile* hf, Int32 level) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Read, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), void*, cinema::HyperFile*, Int32), reinterpret_cast<const void* const&>(mt_.CustomDataTagClassInterface_Read)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_CustomDataTagClassInterface_Read;
		Result<void> Write(const void* data, cinema::HyperFile* hf) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Write, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const void*, cinema::HyperFile*), reinterpret_cast<const void* const&>(mt_.CustomDataTagClassInterface_Write)));
			return proxy_result;
		}
		...
		Bool Message(cinema::GeListNode* node, Int32 type, void* data) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_CustomDataTagClassInterface_Message, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Bool), cinema::GeListNode*, Int32, void*), reinterpret_cast<const void* const&>(mt_.CustomDataTagClassInterface_Message)));
			return proxy_result;
		}
