...
struct DistanceQueryInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(DistanceQueryInterface_Init, Init, true, maxon::GenericComponent,, (Result<void>), cinema::PolygonObject* mesh, Bool initVoxelization);
	maxon::Int DistanceQueryInterface_Init_Offset;
	PRIVATE_MAXON_MF_POINTER(DistanceQueryInterface_Init_1, Init, true, maxon::GenericComponent,, (Result<void>), cinema::SplineObject* spline);
	maxon::Int DistanceQueryInterface_Init_1_Offset;
	PRIVATE_MAXON_MF_POINTER(DistanceQueryInterface_Init_2, Init, true, maxon::GenericComponent,, (Result<void>), cinema::LineObject* line);
...
struct DistanceQueryInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(DistanceQueryInterface_Init, maxon::GenericComponent,, (Result<void>), cinema::PolygonObject* mesh, Bool initVoxelization) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->Init(mesh, initVoxelization); }
		PRIVATE_MAXON_MF_WRAPPER(DistanceQueryInterface_Init_1, maxon::GenericComponent,, (Result<void>), cinema::SplineObject* spline) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->Init(spline); }
		PRIVATE_MAXON_MF_WRAPPER(DistanceQueryInterface_Init_2, maxon::GenericComponent,, (Result<void>), cinema::LineObject* line) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->Init(line); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Init(cinema::PolygonObject* mesh, Bool initVoxelization) -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Init(cinema::SplineObject* spline) -> Result<void>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Init(cinema::LineObject* line) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::Fn<S>::Init(cinema::PolygonObject* mesh, Bool initVoxelization) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::COWFn<S>::Init(cinema::PolygonObject* mesh, Bool initVoxelization) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::Fn<S>::Init(cinema::SplineObject* spline) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::COWFn<S>::Init(cinema::SplineObject* spline) -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::Fn<S>::Init(cinema::LineObject* line) const -> Result<void>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DistanceQueryInterface::Hxx1::COWFn<S>::Init(cinema::LineObject* line) -> Result<void>
{
