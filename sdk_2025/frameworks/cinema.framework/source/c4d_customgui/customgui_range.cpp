...
#define RangeSliderCall(b) 			cinema::RangeSliderLib *lib = cinema::CheckRangeSliderLib(LIBOFFSET(cinema::RangeSliderLib, b)); \
																if (!lib || !lib->b) return; \
																(reinterpret_cast<cinema::iRangeData*>(this)->*lib->b)

#define RangeSliderCallC(b) 		cinema::RangeSliderLib *lib = cinema::CheckRangeSliderLib(LIBOFFSET(cinema::RangeSliderLib, b)); \
																if (!lib || !lib->b) return; \
																(reinterpret_cast<const cinema::iRangeData*>(this)->*lib->b)

#define RangeSliderCallR(a, b)	cinema::RangeSliderLib *lib = cinema::CheckRangeSliderLib(LIBOFFSET(cinema::RangeSliderLib, b)); \
																if (!lib || !lib->b) return a; \
																return (reinterpret_cast<cinema::iRangeData*>(this)->*lib->b)

#define RangeSliderCallRC(a, b)	cinema::RangeSliderLib *lib = cinema::CheckRangeSliderLib(LIBOFFSET(cinema::RangeSliderLib, b)); \
																if (!lib || !lib->b) return a; \
																return (reinterpret_cast<const cinema::iRangeData*>(this)->*lib->b)
