...
#define ListViewCall(b)       cinema::CustomGuiListViewLib *lib = cinema::CheckListView2(LIBOFFSET(cinema::CustomGuiListViewLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iListViewData*>(this)->*lib->b)

#define ListViewCallC(b)       cinema::CustomGuiListViewLib *lib = cinema::CheckListView2(LIBOFFSET(cinema::CustomGuiListViewLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<const cinema::iListViewData*>(this)->*lib->b)

#define ListViewCallR(a, b)     cinema::CustomGuiListViewLib *lib = cinema::CheckListView2(LIBOFFSET(cinema::CustomGuiListViewLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iListViewData*>(this)->*lib->b)

#define ListViewCallRC(a, b)     cinema::CustomGuiListViewLib *lib = cinema::CheckListView2(LIBOFFSET(cinema::CustomGuiListViewLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iListViewData*>(this)->*lib->b)
