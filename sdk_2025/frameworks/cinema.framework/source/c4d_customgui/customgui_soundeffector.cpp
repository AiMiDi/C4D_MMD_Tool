...
#define SoundDataCall(func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
														if (!lib || !lib->func) return; \
														(reinterpret_cast<cinema::iSoundData*>(this)->*lib->func)
#define SoundDataCallC(func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
														if (!lib || !lib->func) return; \
														(reinterpret_cast<const cinema::iSoundData*>(this)->*lib->func)
#define SoundDataCallR(returnV, func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																			if (!lib || !lib->func) return returnV; \
																			return (reinterpret_cast<cinema::iSoundData*>(this)->*lib->func)
#define SoundDataCallRC(returnV, func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																			if (!lib || !lib->func) return returnV; \
																			return (reinterpret_cast<const cinema::iSoundData*>(this)->*lib->func)
#define SoundDataGuiCall(func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																if (!lib || !lib->func) return; \
																(reinterpret_cast<cinema::iSoundDataCustomGui*>(this)->*lib->func)
#define SoundDataGuiCallR(returnV, func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																					if (!lib || !lib->func) return returnV; \
																					return (reinterpret_cast<cinema::iSoundDataCustomGui*>(this)->*lib->func)
#define SoundDataGuiCallRC(returnV, func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																					if (!lib || !lib->func) return returnV; \
																					return (reinterpret_cast<const cinema::iSoundDataCustomGui*>(this)->*lib->func)
#define ProbeCall(func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
												if (!lib || !lib->func) return; \
												(reinterpret_cast<cinema::iProbe*>(this)->*lib->func)
#define ProbeCallR(returnV, func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																	if (!lib || !lib->func) return returnV; \
																	return (reinterpret_cast<cinema::iProbe*>(this)->*lib->func)
#define ProbeCallRC(returnV, func)	cinema::CustomGuiSoundDataLib* lib = cinema::CheckCustomGuiSoundDataLib(LIBOFFSET(cinema::CustomGuiSoundDataLib, func)); \
																	if (!lib || !lib->func) return returnV; \
																	return (reinterpret_cast<const cinema::iProbe*>(this)->*lib->func)
