...
#define FieldGuiCall(b)	cinema::CustomGuiFieldLib* lib = cinema::CheckGuiFieldLib(LIBOFFSET(cinema::CustomGuiFieldLib, b)); \
	if (!lib || !lib->b) return; \
	(reinterpret_cast<cinema::iFieldCustomDatatype*>(this)->*lib->b)

#define FieldGuiCallC(b)	cinema::CustomGuiFieldLib* lib = cinema::CheckGuiFieldLib(LIBOFFSET(cinema::CustomGuiFieldLib, b)); \
	if (!lib || !lib->b) return; \
	(reinterpret_cast<const cinema::iFieldCustomDatatype*>(this)->*lib->b)

#define FieldGuiCallR(a, b)	cinema::CustomGuiFieldLib* lib = cinema::CheckGuiFieldLib(LIBOFFSET(cinema::CustomGuiFieldLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<cinema::iFieldCustomDatatype*>(this)->*lib->b)

#define FieldGuiCallRC(a, b)	cinema::CustomGuiFieldLib* lib = cinema::CheckGuiFieldLib(LIBOFFSET(cinema::CustomGuiFieldLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<const cinema::iFieldCustomDatatype*>(this)->*lib->b)
