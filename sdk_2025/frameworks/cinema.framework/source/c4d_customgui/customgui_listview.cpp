...
{
	return CheckLib<TreeViewLib>(CUSTOMGUI_TREEVIEW, offset, lib_tree);
}

#define TreeViewGuiCall(b) 		cinema::TreeViewLib *lib = cinema::CheckListview(LIBOFFSET(cinema::TreeViewLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iTreeViewCustomGui*>(this)->*lib->b)

#define TreeViewGuiCallR(a, b) cinema::TreeViewLib *lib = cinema::CheckListview(LIBOFFSET(cinema::TreeViewLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iTreeViewCustomGui*>(this)->*lib->b)

#define TreeViewGuiCallRC(a, b) cinema::TreeViewLib *lib = cinema::CheckListview(LIBOFFSET(cinema::TreeViewLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iTreeViewCustomGui*>(this)->*lib->b)
...
String TreeViewF::GetBubbleHelp(TreeViewFunctions* pFuncs, void* root, void* userdata, void* obj, Int32 col, MouseInfo* info)
{
	return pFuncs->GetBubbleHelp(root, userdata, obj, col, info);
}

Bool TreeViewF::IsSelectable(TreeViewFunctions* pFuncs, void *root, void *userdata, void *obj)
{
...
maxon::Result<maxon::Data> TreeViewF::StartInput(TreeViewFunctions* pFuncs, void* root, void* userdata)
{
	return pFuncs->StartInput(root, userdata);
}

void TreeViewF::FinishInput(TreeViewFunctions* pFuncs, void* root, void* userdata, maxon::Data& obj)
{
	pFuncs->FinishInput(root, userdata, obj);
}
...
Bool TreeViewCustomGui::SetRoot(void *root, TreeViewFunctions *functions, void *userdata)
{
	...
	f->StartInput					 = &TreeViewF::StartInput;
	f->FinishInput				 = &TreeViewF::FinishInput;

	return (reinterpret_cast<iTreeViewCustomGui*>(this)->*lib->SetRoot)(root, f, userdata, sizeof(InternalFunctionTable), &TreeViewControlFunctions, functions);
}
...
void TreeViewCustomGui::SetShowLines(Bool show)
{
	TreeViewGuiCall(SetShowLines)(show);
}

Bool TreeViewCustomGui::GetShowLines() const
{
	TreeViewGuiCallRC(false, GetShowLines)();
}

Bool TreeViewCustomGui::GetLineAndColumnHit(Int32 screenX, Int32 screenY, Int32& lineHit, Int32& columnHit)
{
	TreeViewGuiCallR(false, GetLineAndColumnHit)(screenX, screenY, lineHit, columnHit);
}
...
String TreeViewFunctions::GetBubbleHelp(void* root, void* userdata, void* obj, Int32 col, MouseInfo* info)
{
	return "";
}
...
Bool TreeViewFunctions::IsSelectable(void *root, void *userdata, void *obj)
{
	return true;
}
...
maxon::Result<maxon::Data> TreeViewFunctions::StartInput(void* root, void* userdata)
{
	return maxon::Data();
}

void TreeViewFunctions::FinishInput(void* root, void* userdata, maxon::Data& data)
{
}
