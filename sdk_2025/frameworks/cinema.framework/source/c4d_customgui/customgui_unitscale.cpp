...
#define UnitScaleCall(b) 			cinema::UnitScaleCustomGuiLib *lib = cinema::CheckUnitScaleCustomGuiLib(LIBOFFSET(cinema::UnitScaleCustomGuiLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iUnitScaleData*>(this)->*lib->b)

#define UnitScaleCallR(a, b) 		cinema::UnitScaleCustomGuiLib *lib = cinema::CheckUnitScaleCustomGuiLib(LIBOFFSET(cinema::UnitScaleCustomGuiLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iUnitScaleData*>(this)->*lib->b)

#define UnitScaleCallRC(a, b) cinema::UnitScaleCustomGuiLib *lib = cinema::CheckUnitScaleCustomGuiLib(LIBOFFSET(cinema::UnitScaleCustomGuiLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iUnitScaleData*>(this)->*lib->b)

#define UnitScaleGuiCall(b) 		cinema::UnitScaleCustomGuiLib *lib = cinema::CheckUnitScaleCustomGuiLib(LIBOFFSET(cinema::UnitScaleCustomGuiLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iUnitScaleCustomGui*>(this)->*lib->b)

#define UnitScaleGuiCallR(a, b) cinema::UnitScaleCustomGuiLib *lib = cinema::CheckUnitScaleCustomGuiLib(LIBOFFSET(cinema::UnitScaleCustomGuiLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iUnitScaleCustomGui*>(this)->*lib->b)

#define UnitScaleGuiCallRC(a, b) cinema::UnitScaleCustomGuiLib *lib = cinema::CheckUnitScaleCustomGuiLib(LIBOFFSET(cinema::UnitScaleCustomGuiLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iUnitScaleCustomGui*>(this)->*lib->b)
