...
void DescriptionCustomGui::SetTranslation(const maxon::Delegate<Bool(C4DAtom* node, const DescID& id, DescID& resultId, C4DAtom*& resultAtom)>& func, Bool objectControl)
{
