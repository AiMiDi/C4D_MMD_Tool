...
Int32 BaseDraw::GetFrameScreen(Int32* cl, Int32* ct, Int32* cr, Int32* cb) const
{
	return C4DOS_Bv->GetFrameScreen(this, cl, ct, cr, cb);
}

Int32 BaseDraw::GetFrameScreen(Float* cl, Float* ct, Float* cr, Float* cb, Float* windowScale) const
{
	return C4DOS_Bv->GetFrameScreenF(this, cl, ct, cr, cb, windowScale);
}
