...
{
	return CheckLib<DWGObjectsLib>(DWGOBJECTS_LIB, offset, lib_dwg);
}

#define DWGObjectsLibCall(b) 		cinema::DWGObjectsLib *lib = cinema::CheckLibI(LIBOFFSET(cinema::DWGObjectsLib, b)); \
	if (!lib || !lib->b) return; \
	(static_cast<cinema::RijndaelCipher*>(this)->*lib->b)

#define DWGObjectsLibCallR(a, b)  cinema::DWGObjectsLib *lib = cinema::CheckLibI(LIBOFFSET(cinema::DWGObjectsLib, b)); \
	if (!lib || !lib->b) return a; \
	return (static_cast<cinema::RijndaelCipher*>(this)->*lib->b)
