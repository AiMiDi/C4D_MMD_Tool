...
#define RegExprLibCall(b) 		cinema::RegExprLib *lib = cinema::CheckLibRegExpr(LIBOFFSET(cinema::RegExprLib, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::RegExpParser*>(this)->*lib->b)

#define RegExprLibCallR(a, b)  cinema::RegExprLib *lib = cinema::CheckLibRegExpr(LIBOFFSET(cinema::RegExprLib, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::RegExpParser*>(this)->*lib->b)
