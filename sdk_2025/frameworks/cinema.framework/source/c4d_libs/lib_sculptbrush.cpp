...
{
	return CheckLib<SculptBrushBaseLibrary>(LIBRARY_SCULPTBRUSH, offset, lib_SculptBrushBase);
}

#define SculptBrushBaseLibraryCall(b) 		cinema::SculptBrushBaseLibrary *lib = cinema::CheckSculptBrushBaseLibrary(LIBOFFSET(cinema::SculptBrushBaseLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iSculptBrushBase*>(this)->*lib->b)

#define SculptBrushBaseLibraryCallR(a, b)  cinema::SculptBrushBaseLibrary *lib = cinema::CheckSculptBrushBaseLibrary(LIBOFFSET(cinema::SculptBrushBaseLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iSculptBrushBase*>(this)->*lib->b)

#define SculptBrushBaseLibraryCallRC(a, b)  cinema::SculptBrushBaseLibrary *lib = cinema::CheckSculptBrushBaseLibrary(LIBOFFSET(cinema::SculptBrushBaseLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iSculptBrushBase*>(this)->*lib->b)

#define BrushLibraryCall(b) 	cinema::SculptBrushBaseLibrary *lib = cinema::CheckSculptBrushBaseLibrary(LIBOFFSET(cinema::SculptBrushBaseLibrary, b)); \
	if (!lib || !lib->b) return; \
	(lib->b)

#define BrushLibraryCallR(a, b)  cinema::SculptBrushBaseLibrary *lib = cinema::CheckSculptBrushBaseLibrary(LIBOFFSET(cinema::SculptBrushBaseLibrary, b)); \
	if (!lib || !lib->b) return a; \
	return (lib->b)
...
Bool CustomSculptBrushBase::GetDEnabling(const BaseDocument* doc, const BaseContainer& data, const DescID& id, const GeData& t_data, DESCFLAGS_ENABLE flags, const BaseContainer* itemdesc, const SculptBrushToolData *tool) const { SculptBrushBaseLibraryCallRC(false, GetDEnabling)(doc, data, id, t_data, flags, itemdesc, tool); }
...
Bool CustomSculptBrushBase::GetDDescription(const BaseDocument* doc, const BaseContainer& data, Description* description, DESCFLAGS_DESC& flags, const SculptBrushToolData *tool) const { SculptBrushBaseLibraryCallRC(false, GetDDescription)(doc, data, description, flags, tool); }
...
Bool CustomSculptBrushBase::GetDParameter(const BaseDocument* doc, const BaseContainer& data, const DescID& id, GeData& t_data, DESCFLAGS_GET& flags, const SculptBrushToolData *tool) const { SculptBrushBaseLibraryCallRC(true, GetDParameter)(doc, data, id, t_data, flags, tool); }
Bool CustomSculptBrushBase::DisplayControl(BaseDocument* doc, BaseObject* op, BaseObject* chainstart, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds, const SculptBrushToolData *tool) const { SculptBrushBaseLibraryCallRC(true, DisplayControl)(doc, op, chainstart, bd, bh, cds, tool); }
Bool CustomSculptBrushBase::InitDisplayControl(BaseDocument* doc, const BaseContainer& data, BaseDraw* bd, const AtomArray* active, SculptBrushToolData *tool) { SculptBrushBaseLibraryCallR(true, InitDisplayControl)(doc, data, bd, active, tool); }
...
Bool CustomSculptBrushBase::GetEnabling(Int32 id) const { SculptBrushBaseLibraryCallRC(true, GetEnabling)(id); }
...
Bool SculptBrushToolData::GetDEnabling(const BaseDocument* doc, const BaseContainer& data, const DescID& id, const GeData& t_data, DESCFLAGS_ENABLE flags, const BaseContainer* itemdesc) const
{
...
Bool SculptBrushToolData::GetDDescription(const BaseDocument* doc, const BaseContainer& data, Description* description, DESCFLAGS_DESC& flags) const
{
	if (!m_pBrushBase)
		MAXON_REMOVE_CONST(this)->m_pBrushBase = CustomSculptBrushBase::Alloc();
...
Bool SculptBrushToolData::GetDParameter(const BaseDocument* doc, const BaseContainer& data, const DescID& id, GeData& t_data, DESCFLAGS_GET& flags) const
{
	return (m_pBrushBase) ? m_pBrushBase->GetDParameter(doc, data, id, t_data, flags, this) : true;
}

Bool SculptBrushToolData::DisplayControl(BaseDocument* doc, BaseObject* op, BaseObject* chainstart, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const
{
	return (m_pBrushBase)?m_pBrushBase->DisplayControl(doc, op, chainstart, bd, bh, cds, this) : true;
}

Bool SculptBrushToolData::InitDisplayControl(BaseDocument* doc, const BaseContainer& data, BaseDraw* bd, const AtomArray* active)
{
	return (m_pBrushBase)?m_pBrushBase->InitDisplayControl(doc, data, bd, active, this) : true;
}

void SculptBrushToolData::FreeDisplayControl()
{
...
Bool SculptBrushToolData::GetEnabling(Int32 id) const
{
