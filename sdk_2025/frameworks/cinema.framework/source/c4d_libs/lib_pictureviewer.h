...
class PictureViewer
{
	...
	public:
		...
		GeListNode *BeginRendering(GeListNode *pNode, BaseBitmap *Bmp, const String &Name, const BaseTime &Time, Int32 Frame, const Filename &savename, Bool fully_saved, const Filename &dispname, Int32 lStream, STEREOTYPE lStereoType, Bool handleUpdateRegions);
...
class CINEWARE_SINGLEINHERITANCE iPictureViewer;
...
struct PictureViewLibrary : public C4DLibrary
{
	...
	GeListNode*		(iPictureViewer::*BeginRendering2)		(GeListNode *pNode, BaseBitmap *Bmp, const String &Name, const BaseTime &Time, Int32 Frame, const Filename &savename, Bool fully_saved, const Filename &dispname, Int32 lStream, STEREOTYPE lStereoType, Bool supportsDirtyRegions);
};
