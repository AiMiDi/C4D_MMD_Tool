...
#define Mt2dTrackDataClassCall(b) 		cinema::Sdk2dTrackDataLibrary *lib = cinema::CheckLibClass2dTrackData(LIBOFFSET(cinema::Sdk2dTrackDataLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::Mt2dTrackDataSdk*>(this)->*lib->b)

#define Mt2dTrackDataClassCallC(b) 		cinema::Sdk2dTrackDataLibrary *lib = cinema::CheckLibClass2dTrackData(LIBOFFSET(cinema::Sdk2dTrackDataLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<const cinema::Mt2dTrackDataSdk*>(this)->*lib->b)

#define Mt2dTrackDataClassCallR(a, b) cinema::Sdk2dTrackDataLibrary *lib = cinema::CheckLibClass2dTrackData(LIBOFFSET(cinema::Sdk2dTrackDataLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::Mt2dTrackDataSdk*>(this)->*lib->b)

#define Mt2dTrackDataClassCallRC(a, b) cinema::Sdk2dTrackDataLibrary *lib = cinema::CheckLibClass2dTrackData(LIBOFFSET(cinema::Sdk2dTrackDataLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::Mt2dTrackDataSdk*>(this)->*lib->b)
...
#define Mt2dTrackClassCall(b) 		cinema::Sdk2dTrackLibrary *lib = cinema::CheckLibClass2dTrack(LIBOFFSET(cinema::Sdk2dTrackLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::Mt2dTrackSdk*>(this)->*lib->b)

#define Mt2dTrackClassCallR(a, b) cinema::Sdk2dTrackLibrary *lib = cinema::CheckLibClass2dTrack(LIBOFFSET(cinema::Sdk2dTrackLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::Mt2dTrackSdk*>(this)->*lib->b)

#define Mt2dTrackClassCallRC(a, b) cinema::Sdk2dTrackLibrary *lib = cinema::CheckLibClass2dTrack(LIBOFFSET(cinema::Sdk2dTrackLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::Mt2dTrackSdk*>(this)->*lib->b)
...
#define MtDataClassCall(b) 		cinema::SdkDataLibrary *lib = cinema::CheckLibClassData(LIBOFFSET(cinema::SdkDataLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::MtDataSdk*>(this)->*lib->b)

#define MtDataClassCallR(a, b) cinema::SdkDataLibrary *lib = cinema::CheckLibClassData(LIBOFFSET(cinema::SdkDataLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::MtDataSdk*>(this)->*lib->b)

#define MtDataClassCallRC(a, b) cinema::SdkDataLibrary *lib = cinema::CheckLibClassData(LIBOFFSET(cinema::SdkDataLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::MtDataSdk*>(this)->*lib->b)
...
#define MtFootageClassCall(b) 		cinema::SdkFootageDataLibrary *lib = cinema::CheckLibClassFootage(LIBOFFSET(cinema::SdkFootageDataLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::MtFootageDataSdk*>(this)->*lib->b)

#define MtFootageClassCallR(a, b) cinema::SdkFootageDataLibrary *lib = cinema::CheckLibClassFootage(LIBOFFSET(cinema::SdkFootageDataLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::MtFootageDataSdk*>(this)->*lib->b)

#define MtFootageClassCallRC(a, b) cinema::SdkFootageDataLibrary *lib = cinema::CheckLibClassFootage(LIBOFFSET(cinema::SdkFootageDataLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::MtFootageDataSdk*>(this)->*lib->b)
...
#define MtTrkGidClassCall(b) 		cinema::SdkTrkGidLibrary *lib = cinema::CheckLibClassTrkGid(LIBOFFSET(cinema::SdkTrkGidLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::MtTrkGidSdk*>(this)->*lib->b)

#define MtTrkGidClassCallR(a, b) cinema::SdkTrkGidLibrary *lib = cinema::CheckLibClassTrkGid(LIBOFFSET(cinema::SdkTrkGidLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::MtTrkGidSdk*>(this)->*lib->b)

#define MtTrkGidClassCallRC(a, b) cinema::SdkTrkGidLibrary *lib = cinema::CheckLibClassTrkGid(LIBOFFSET(cinema::SdkTrkGidLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::MtTrkGidSdk*>(this)->*lib->b)
