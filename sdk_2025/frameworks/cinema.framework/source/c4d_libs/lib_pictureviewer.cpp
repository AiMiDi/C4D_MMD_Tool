...
{
	return CheckLib<PictureViewLibrary>(C4D_PICTUREVIEWER_LIBRARY_ID, offset, picture_viewer_lib_cache);
}
...
Bool PictureViewer::Open()
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->Open))();
}
...
Bool PictureViewer::ShowFile(const Filename &File)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->ShowFile))(File);
}
...
Bool PictureViewer::ShowImage(BaseBitmap *Bmp, const String &Name)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->ShowImage))(Bmp, Name);
}
...
Bool PictureViewer::AddSound(GeListNode *pNode, const BaseTime &from, const BaseTime &to, BaseSound *sound)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->AddSound))(pNode, from, to, sound);
}
...
GeListNode* PictureViewer::OpenRendering(const String &Name, Float Fps, Int32 lStart, Int32 lEnd, BaseContainer* bcrender)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->OpenRendering))(Name, Fps, lStart, lEnd, bcrender);
}
...
void PictureViewer::SetIsNet(GeListNode *pNode, Bool isNet)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->SetIsNet))(pNode, isNet);
}
...
Bool PictureViewer::Message(Int32 id, void *t_data)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->Message))(id, t_data);
}
...
GeListNode *PictureViewer::BeginRendering(GeListNode *pNode, BaseBitmap *Bmp, const String &Name, const BaseTime &Time, Int32 Frame, const Filename &savename, Bool fully_saved, const Filename &dispname, Int32 lStream, STEREOTYPE lStereoType)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->BeginRendering))(pNode, Bmp, Name, Time, Frame, savename, fully_saved, dispname, lStream, lStereoType);
}

GeListNode *PictureViewer::BeginRendering(GeListNode *pNode, BaseBitmap *Bmp, const String &Name, const BaseTime &Time, Int32 Frame, const Filename &savename, Bool fully_saved, const Filename &dispname, Int32 lStream, STEREOTYPE lStereoType, Bool supportsDirtyRegions)
{
	PictureViewLibrary *lib = CheckPictureViewLib(LIBOFFSET(PictureViewLibrary, BeginRendering));
	if (!lib || !lib->BeginRendering) return nullptr;
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->BeginRendering2))(pNode, Bmp, Name, Time, Frame, savename, fully_saved, dispname, lStream, lStereoType, supportsDirtyRegions);
}
...
Bool PictureViewer::OverwriteBitmap(GeListNode *node, BaseBitmap* bmp, STEREOTYPE stereotype, Int32 lLastStream)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->OverwriteBitmap))(node, bmp, stereotype, lLastStream);
}
...
Bool PictureViewer::EndRendering(GeListNode *beginNode, PVFRAME_FINISH finish, Bool incomplete, PVFinalizeImage *callback, void *userdata)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->EndRendering))(beginNode, finish, incomplete, callback, userdata);
}
...
Bool PictureViewer::CloseRendering(GeListNode *&pNode)
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->CloseRendering))(pNode);
}
...
Bool PictureViewer::CheckHDMemory()
{
	...
	return (reinterpret_cast<iPictureViewer*>(this)->*(lib->CheckHDMemory))();
}
