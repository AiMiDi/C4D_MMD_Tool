...
{
	return CheckLib<AESLib>(AES_LIB, offset, lib_aes);
}

#define AESLibCall(b) 		cinema::AESLib *lib = cinema::CheckLibAES(LIBOFFSET(cinema::AESLib, b)); \
	if (!lib || !lib->b) return; \
	(reinterpret_cast<cinema::RijndaelCipher*>(this)->*lib->b)

#define AESLibCallR(a, b)  cinema::AESLib *lib = cinema::CheckLibAES(LIBOFFSET(cinema::AESLib, b)); \
	if (!lib || !lib->b) return a; \
	return (reinterpret_cast<cinema::RijndaelCipher*>(this)->*lib->b)
