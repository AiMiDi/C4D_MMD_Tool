...
{
	return CheckLib<CALibrary>(LIBRARY_CA, offset, lib_ca);
}

#define CALibCall(b) 		cinema::CALibrary *lib = cinema::CheckCALib(LIBOFFSET(cinema::CALibrary, b)); \
															if (!lib || !lib->b) return; \
															(lib->b)

#define CALibCallR(a, b)  cinema::CALibrary *lib = cinema::CheckCALib(LIBOFFSET(cinema::CALibrary, b)); \
...
Int32 CAWeightTag::GetJointCount() const { CALibCallR(0, weightGetJointCount)(this); }
Int32 CAWeightTag::FindJoint(const BaseObject *op, const BaseDocument *doc) const { CALibCallR(NOTOK, weightFindJoint)(this, op, doc); }
JointRestState CAWeightTag::GetJointRestState(Int32 index) const { CALibCallR(JointRestState(), weightGetJointRestState)(this, index); }
...
void CAWeightTag::GetWeightMap(Int32 index, Float32 *map, Int32 cnt, Bool includeEffectors) const { CALibCall(weightGetWeightMap)(this, index, map, cnt, includeEffectors); }
Bool CAWeightTag::SetWeightMap(Int32 index, Float32 *map, Int32 cnt) { CALibCallR(false, weightSetWeightMap)(this, index, map, cnt); }
Int32 CAWeightTag::GetWeightCount(Int32 index) const { CALibCallR(0, weightGetWeightCount)(this, index); }
void CAWeightTag::GetIndexWeight(Int32 index, Int32 windex, Int32 &pntindex, Float &weight) const { CALibCall(weightGetIndexWeight)(this, index, windex, pntindex, weight); }
Float CAWeightTag::GetWeight(Int32 index, Int32 pntindex) const { CALibCallR(0.0, weightGetWeight)(this, index, pntindex); }
...
UInt32 CAWeightTag::GetWeightDirty() const { CALibCallR(0, weightGetDirty)(this); }
void CAWeightTag::WeightDirty() { CALibCall(weightDirty)(this); }
Matrix CAWeightTag::GetGeomMg() const { CALibCallR(Matrix(), weightGetGeomMg)(this); }
...
Bool CAWeightTag::ResetBindPose(BaseDocument* doc, Bool doUndo) { CALibCallR(false, weightResetBindPose)(this, doc, doUndo); }
Bool CAWeightTag::SetBindPose(BaseDocument* doc, Bool doUndo) { CALibCallR(false, weightSetBindPose)(this, doc, doUndo); }
...
maxon::Result<Int32> CAWeightMgr::GetAutoWeightAlgoIndex(BaseDocument* doc, const maxon::Id& id) { CALibCallR(NOTOK, weightMgrGetAutoWeightAlgoIndex)(doc, id); }
...
Int32 CAPoseMorphTag::GetMorphCount() const { CALibCallR(0, pmorphGetCount)(this); }
const CAMorph *CAPoseMorphTag::GetMorph(Int32 index) const { CALibCallR(nullptr, pmorphGetMorph)(this, index); }
DescID CAPoseMorphTag::GetMorphID(Int32 index) const { CALibCallR(DescID(), pmorphGetDescID)(this, index); }
Int32 CAPoseMorphTag::GetActiveMorphIndex() const { CALibCallR(NOTOK, pmorphGetActive)(this); }
Int32 CAPoseMorphTag::GetMode() const { CALibCallR(NOTOK, pmorphGetMode)(this); }
...
Int32 CAPoseMorphTag::GetMorphIndex(const CAMorph *morph) const { CALibCallR(NOTOK, pmorphGetMorphIndex)(this, morph); }
...
const CAMorphNode *CAMorph::Find(const CAPoseMorphTag *tag, const BaseList2D *bl) const { CALibCallR(nullptr, pmorphFind)(this, tag, bl); }
...
Int32 CAMorph::FindIndex(const CAPoseMorphTag *tag, const BaseList2D *bl) const { CALibCallR(NOTOK, pmorphFindIndex)(this, tag, bl); }
const CAMorphNode *CAMorph::FindFromIndex(const CAPoseMorphTag *tag, Int32 index) const { CALibCallR(nullptr, pmorphFindFromIndex)(this, tag, index); }
...
Int32 CAMorph::GetNodeIndex(const CAMorphNode *node) const { CALibCallR(NOTOK, pmorphGetNodeIndex)(this, node); }
...
const BaseList2D *CAMorphNode::GetLink(const CAPoseMorphTag *tag, const CAMorph *morph, const BaseDocument *doc) const { CALibCallR(nullptr, pmorphnodeGetLink)(this, tag, morph, doc); }
Int32 CAMorphNode::GetPointCount() const { CALibCallR(0, pmorphnodeGetPointCount)(this); }
Vector CAMorphNode::GetPoint(Int32 index) const { CALibCallR(Vector(), pmorphnodeGetPoint)(this, index); }
void CAMorphNode::SetPoint(Int32 index, const Vector &pnt) { CALibCall(pmorphnodeSetPoint)(this, index, pnt); }
Int32 CAMorphNode::GetTangentCount() const { CALibCallR(0, pmorphGetTangentCount)(this); }
Vector CAMorphNode::GetTangent(Int32 index) const { CALibCallR(Vector(), pmorphGetTangent)(this, index); }
void CAMorphNode::SetTangent(Int32 index, const Vector &v) { CALibCall(pmorphSetTangent)(this, index, v); }
Int32 CAMorphNode::GetVertexMapTagCount() const { CALibCallR(0, pmorphGetVertexMapTagCount)(this); }
Int32 CAMorphNode::GetVertexMapCount(Int32 tindex) const { CALibCallR(0, pmorphGetVertexMapCount)(this, tindex); }
Float CAMorphNode::GetVertexMap(Int32 tindex, Int32 index) const { CALibCallR(0.0, pmorphGetVertexMap)(this, tindex, index); }
...
CAMORPH_DATA_FLAGS CAMorphNode::GetInfo() const { CALibCallR(CAMORPH_DATA_FLAGS::NONE, pmorphGetInfo)(this); }
Vector CAMorphNode::GetP() const { CALibCallR(Vector(0.0), pmorphGetP)(this); }
Vector CAMorphNode::GetS() const { CALibCallR(Vector(0.0), pmorphGetS)(this); }
Vector CAMorphNode::GetR() const { CALibCallR(Vector(0.0), pmorphGetR)(this); }
...
Int32 CAMorphNode::GetParamCount() const { CALibCallR(false, pmorphGetParamCount)(this); }
Bool CAMorphNode::SetParamCount(Int32 cnt) { CALibCallR(false, pmorphSetParamCount)(this, cnt); }
Bool CAMorphNode::GetParam(Int32 index, GeData &data, DescID &id) const { CALibCallR(false, pmorphGetParam)(this, index, data, id); }
void CAMorphNode::SetParam(Int32 index, const GeData &data, const DescID &id) { CALibCall(pmorphSetParam)(this, index, data, id); }
Int32 CAMorphNode::GetUVTagCount() const { CALibCallR(false, pmorphGetUVTagCount)(this); }
Int32 CAMorphNode::GetUVCount(Int32 tindex) const { CALibCallR(false, pmorphGetUVCount)(this, tindex); }
Bool CAMorphNode::SetUVCount(Int32 tindex, Int32 cnt) { CALibCallR(false, pmorphSetUVCount)(this, tindex, cnt); }
void CAMorphNode::GetUV(Int32 tindex, Int32 index, UVWStruct &uv) const { CALibCall(pmorphGetUV)(this, tindex, index, uv); }
void CAMorphNode::SetUV(Int32 tindex, Int32 index, const UVWStruct &uv) { CALibCall(pmorphSetUV)(this, tindex, index, uv); }
Int32 CAMorphNode::GetWeightMapTagCount() const { CALibCallR(false, pmorphGetWeightMapTagCount)(this); }
Int32 CAMorphNode::GetWeightMapJointCount(Int32 tindex) const { CALibCallR(false, pmorphGetWeightMapJointCount)(this, tindex); }
Int32 CAMorphNode::GetWeightMapCount(Int32 tindex, Int32 jindex) const { CALibCallR(false, pmorphGetWeightMapCount)(this, tindex, jindex); }
...
Float CAMorphNode::GetWeightMap(Int32 tindex, Int32 jindex, Int32 index) const { CALibCallR(false, pmorphGetWeightMap)(this, tindex, jindex, index); }
...
Int32 CAMorphNode::GetNormalTagCount() const { CALibCallR(false, pmorphGetNormalTagCount)(this); }
Int32 CAMorphNode::GetNormalCount(Int32 tindex) const { CALibCallR(false, pmorphGetNormalCount)(this, tindex); }
Bool CAMorphNode::SetNormalCount(Int32 tindex, Int32 cnt) { CALibCallR(false, pmorphSetNormalCount)(this, tindex, cnt); }
void CAMorphNode::GetNormal(Int32 tindex, Int32 index, NormalStruct& ns) const { CALibCall(pmorphGetNormal)(this, tindex, index, ns); }
void CAMorphNode::SetNormal(Int32 tindex, Int32 index, const NormalStruct& ns) { CALibCall(pmorphSetNormal)(this, tindex, index, ns); }
...
{
	return CheckLib<BrushBaseLibrary>(LIBRARY_BRUSH, offset, lib_brushbase);
}

#define BrushBaseLibraryCall(b) 		cinema::BrushBaseLibrary *lib = cinema::CheckBrushBaseLibrary(LIBOFFSET(cinema::BrushBaseLibrary, b)); \
															if (!lib || !lib->b) return; \
															(reinterpret_cast<cinema::iBrushBase*>(this)->*lib->b)

#define BrushBaseLibraryCallR(a, b)  cinema::BrushBaseLibrary *lib = cinema::CheckBrushBaseLibrary(LIBOFFSET(cinema::BrushBaseLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<cinema::iBrushBase*>(this)->*lib->b)

#define BrushBaseLibraryCallRC(a, b)  cinema::BrushBaseLibrary *lib = cinema::CheckBrushBaseLibrary(LIBOFFSET(cinema::BrushBaseLibrary, b)); \
															if (!lib || !lib->b) return a; \
															return (reinterpret_cast<const cinema::iBrushBase*>(this)->*lib->b)
...
Bool BrushBase::GetDEnabling(const BaseDocument* doc, const BaseContainer& data, const DescID& id, const GeData& t_data, DESCFLAGS_ENABLE flags, const BaseContainer* itemdesc) const { BrushBaseLibraryCallRC(false, GetDEnabling)(doc, data, id, t_data, flags, itemdesc); }
...
Bool BrushBase::GetDDescription(const BaseDocument* doc, const BaseContainer& data, Description* description, DESCFLAGS_DESC& flags) const { BrushBaseLibraryCallRC(false, GetDDescription)(doc, data, description, flags); }
...
Float BrushBase::GetFalloff(Float dst, Int32 flags) const { BrushBaseLibraryCallRC(0.0_f, GetFalloff)(dst, flags); }
...
Float BrushBase::GetStrength() const { BrushBaseLibraryCallRC(0.0_f, GetStrength)(); }
Float BrushBase::GetStrengthMultiplier() const { BrushBaseLibraryCallRC(0.0_f, GetStrengthMultiplier)(); }
...
Bool BrushToolData::GetDEnabling(const BaseDocument* doc, const BaseContainer& data, const DescID& id, const GeData& t_data, DESCFLAGS_ENABLE flags, const BaseContainer* itemdesc) const { return (m_pBrushBase)?m_pBrushBase->GetDEnabling(doc, data, id, t_data, flags, itemdesc):false; }
...
Bool BrushToolData::GetDDescription(const BaseDocument* doc, const BaseContainer& data, Description* description, DESCFLAGS_DESC& flags) const
{
	if (!m_pBrushBase)
		MAXON_REMOVE_CONST(this)->m_pBrushBase = BrushBase::Alloc(); // FIX[12637]
