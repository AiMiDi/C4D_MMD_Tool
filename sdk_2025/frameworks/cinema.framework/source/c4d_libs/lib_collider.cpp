...
{
	return CheckLib<ColliderCacheLib>(LIB_COLLIDERCACHE, offset, library_cache);
}
...
#define ColliderCacheLib				cinema::ColliderEngineLib
...
{
	return CheckLib<ColliderCacheLib>(LIB_COLLIDERCACHE_ID, offset, library_engine);
}
...
#define ColliderCacheLib				cinema::RayColliderLib
...
{
	return CheckLib<ColliderCacheLib>(LIB_COLLIDERCACHE_ID, offset, library_ray);
}
...
Bool GeRayCollider::Init(const BaseObject* object, Bool force)
{
