...
#define ID_OPERATOR_PYTHON                1022471     ///< Python operator. @since 2024.0
...
// this file.
#define ID_OPERATOR_MG_SAMPLE		 1019296	 ///< Node plugin 'Sample Effector'. @PublicExposure
#define ID_OPERATOR_MG_DATA			 1019010	 ///< Node plugin 'Motion Graphics Data'. @PublicExposure
#define ID_OPERATOR_MG_FALLOFF	 1019302	 ///< Node plugin 'Falloff'. @PublicExposure
#define ID_OPERATOR_MG_SELECTION 1021344	 ///< Node plugin 'MoGraph Selection'. @PublicExposure
#define ID_OPERATOR_MG_WEIGHT		 440000233 ///< Node plugin 'MoGraph Weight'. @PublicExposure
/// @}
...
{
	GvPort* inPort = nullptr; ///< connected port
	DescID	outDescId;				///< description id of the outport
};
...
#define GV_INVALID_POS_VALUE						(cinema::LIMIT<cinema::Int32>::MAX)
...
#define GV_PORT_INVALID_DESC		cinema::DescID()
...
#define GV_VALUE_SEPARATOR					cinema::String(";")
#define GV_VALUE_SEPARATOR_SPACED		cinema::String(" ; ")
#define GV_VALUE_SEPARATOR_CHR			';'

#define GV_ELEMENT_SEPARATOR				cinema::String("|")
#define GV_ELEMENT_SEPARATOR_SPACED	cinema::String(" | ")
#define GV_ELEMENT_SEPARATOR_CHR		'|'
/// @}
...
enum GvOperatorFlags
{
	...
	GV_OPERATORFLAG_LOCAL								= (1 << 0),			///< A local operator which doesn't read or write external state.
...
#define GV_MULTIPLE_PORTS		((cinema::GvValueType)(-1))			///< All ports.

typedef Int32* GvIdTablePtr;
/// @addtogroup GV_PORTS
/// @ingroup group_enumeration
/// @{
#define GV_EXISTING_PORTS		((cinema::GvIdTablePtr)(0x00000000))			///< Existing ports.
#define GV_DEFINED_PORTS		((cinema::GvIdTablePtr)(cinema::Int)(-1))					///< Defined ports.
/// @}
...
struct C4D_GvGlobals
{
	...
	Vector							(*GetDefaultBodyColor				)(const GvNode *node);
...
struct C4D_GvNodeMaster
{
	...
	GvCalcError			(*Execute										)(GvNodeMaster *master, BaseThread *thread, GvCalcFlags flags);
	maxon::Result<Bool> (*GetBranchInfo					)(const GvNodeMaster *master, const maxon::ValueReceiver<const BranchInfo&>& info);
...
struct C4D_GvNode
{
	...
	Int32						(*GetInPortCount						)(const GvNode *gn);
	Int32						(*GetOutPortCount						)(const GvNode *gn);
	...
	Int32						(*GetOperatorID							)(const GvNode *gn);
	Int32						(*GetOwnerID								)(const GvNode *gn);
	Bool						(*IsGroupNode								)(const GvNode *gn);
	...
	String					(*OperatorGetDetailedText		)(GvNode *gn);
	String					(*OperatorGetErrorString		)(GvNode *gn, Int32 error);
	...
	Bool						(*GetPortDescription				)(const GvNode *gn, GvPortIO port, Int32 id, GvPortDescription *pd, Int32 privateflags);
	void						(*GetPortList								)(const GvNode *bn, GvPortIO port, GvPortList &portlist, Int32 privateflags);
	String					(*GetTitle									)(const GvNode *bn, Int32 privateflags);
...
struct C4D_GvPort
{
	...
	Bool						(*IsIncomingConnected				)(const GvPort *port);
	...
	Int32						(*GetMainID									)(const GvPort *port);
	void						(*SetUserID									)(GvPort *port, Int32 id);
	Int32						(*GetUserID									)(GvPort *port);
	Int32						(*GetSubID									)(const GvPort *port);
	...
	const String		(*GetName										)(const GvPort *port, const GvNode *node);
...
class CINEWARE_SINGLEINHERITANCE iGvPortList;
...
struct C4D_GvPortList
{
	...
	Int32						(iGvPortList::*GetCount			)() const;
