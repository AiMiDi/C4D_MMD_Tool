...
#define CallCustomDataTypePlugin(plug, fnc)		(static_cast<cinema::CustomDataTypeClass*>((((cinema::CUSTOMDATATYPEPLUGIN*)plug->GetPluginStructure())->adr))->*((cinema::CUSTOMDATATYPEPLUGIN*)plug->GetPluginStructure())->fnc)
#define CallResourceDataTypePlugin(plug, fnc)	(static_cast<cinema::ResourceDataTypeClass*>((((cinema::RESOURCEDATATYPEPLUGIN*)plug->GetPluginStructure())->adr))->*((cinema::RESOURCEDATATYPEPLUGIN*)plug->GetPluginStructure())->fnc)

#define CallCustomDataType(plug, fnc)		(static_cast<cinema::CustomDataTypeClass*>((plug->adr))->*plug->fnc)
#define CallResourceDataType(plug, fnc)	(static_cast<cinema::ResourceDataTypeClass*>((plug->adr))->*plug->fnc)
