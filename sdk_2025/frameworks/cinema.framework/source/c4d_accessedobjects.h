...
enum class ACCESSED_OBJECTS_MASK
{
	...
	EXTERNAL_MASK					= CAMERA | TIME | EXTERNAL,
...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD maxon::Result<Bool> MayAccessDeprecated(const BaseList2D* object, ACCESSED_OBJECTS_MASK readMask, ACCESSED_OBJECTS_MASK writeMask);
