...
inline const String& MaxonConvert(const maxon::String& val);
inline String MaxonConvert(maxon::String&& val);
inline const maxon::String& MaxonConvert(const String& val);
...
{
	#define StCall(fnc) (this->*C4DOS_St->fnc)
...
public:
...
#endif
		C4DOS_St->InitCString(this, cstr, -1, type);
	}
	...
	//----------------------------------------------------------------------------------------
	static String MemoryToString(Int64 mem) { return C4DOS_St->MemoryToString(mem); }
	...
	/// @return												The ::Float32 as a string.
	//----------------------------------------------------------------------------------------
	static String FloatToStringDeprecated(Float32 v, Int32 vvk, Int32 nnk = -1, Bool e = false, Utf32Char xchar = '0') { return C4DOS_St->FloatToString32(v, vvk, nnk, e, xchar); }
	...
	/// @return												The ::Float64 as a string.
	//----------------------------------------------------------------------------------------
	static String FloatToStringDeprecated(Float64 v, Int32 vvk, Int32 nnk = -1, Bool e = false, Utf32Char xchar = '0') { return C4DOS_St->FloatToString64(v, vvk, nnk, e, xchar); }
	...
	void SetCString(const Char* cstr, Int count = -1, STRINGENCODING type = STRINGENCODING::XBIT)
	{
		...
		C4DOS_St->InitCString(this, cstr, Int32(count), type);
	}
...
inline const String& MaxonConvert(const maxon::String& val)
{
	return reinterpret_cast<const String&>(val);
}
...
inline Bool operator ==(const String& left, const maxon::String& right)
{
	return left.CompareDeprecated(MaxonConvert(right)) == 0;
}

inline Bool operator ==(const maxon::String& left, const String& right)
{
	return MaxonConvert(left).CompareDeprecated(right) == 0;
}
