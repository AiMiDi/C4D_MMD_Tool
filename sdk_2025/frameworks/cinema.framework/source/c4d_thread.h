...
template <>
struct LockTraits<cinema::AutoLock>
{
	static void AcquireReadLock(cinema::AutoLock& lock)		{ lock.Lock(); }
	static void ReleaseReadLock(cinema::AutoLock& lock)		{ lock.Unlock(); }
	static void AcquireWriteLock(cinema::AutoLock& lock)	{ lock.Lock(); }
	static void ReleaseWriteLock(cinema::AutoLock& lock)	{ lock.Unlock(); }
};
