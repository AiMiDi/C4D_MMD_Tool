...
enum
{
	...
	MDATA_ADDPOINT_POLYTYPE						= 1117, //LONG CYCLE
		MDATA_ADDPOINT_POLYTYPE_TRIANGLES 	= 0,
		MDATA_ADDPOINT_POLYTYPE_QUADRANGLES = 1,
		MDATA_ADDPOINT_POLYTYPE_NGON 				= 2,
	MDATA_ADDPOINT_POSITION           = 1118,
	MDATA_ADDPOINT_
};
