...
#define CallCustomGuiCmd(plug, fnc)	(static_cast<cinema::CustomGuiData*>((((cinema::CUSTOMGUIPLUGIN *)plug->GetPluginStructure())->adr))->*((cinema::CUSTOMGUIPLUGIN *)plug->GetPluginStructure())->fnc)
