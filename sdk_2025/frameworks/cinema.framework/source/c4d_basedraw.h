...
public:
	...
	//----------------------------------------------------------------------------------------
	void SetVertexColor(maxon::Color32* vertexcolor, Bool perPolygon) { C4DOS_Br->BbSetVertexColor(this, vertexcolor, perPolygon); }
...
/// @}
	...
	//----------------------------------------------------------------------------------------
	void SetMatrix_Matrix(BaseObject* op, const Matrix& mg) { C4DOS_Br->SetMatrix_Matrix(this, op, mg); }
	...
	/// 															- selected edges (level @em 4)
	//----------------------------------------------------------------------------------------
	void SetMatrix_Matrix(BaseObject* op, const Matrix& mg, Int32 zoffset) { C4DOS_Br->SetMatrix_MatrixO(this, op, mg, zoffset); }
