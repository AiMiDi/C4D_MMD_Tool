...
namespace cinema
{
	namespace enum99
	{
		...
		static const maxon::UInt64 SNAPPRIORITY_values[] = {maxon::UInt64(enum99::SNAPPRIORITY::NONE), maxon::UInt64(enum99::SNAPPRIORITY::PLANE), maxon::UInt64(enum99::SNAPPRIORITY::GUIDE), maxon::UInt64(enum99::SNAPPRIORITY::EDGE), maxon::UInt64(enum99::SNAPPRIORITY::POINT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SNAPPRIORITY99(){ return enum99::SNAPPRIORITY_info; }
	namespace enum113
	{
		...
		static const maxon::UInt64 SNAPFLAGS_values[] = {maxon::UInt64(enum113::SNAPFLAGS::NONE), maxon::UInt64(enum113::SNAPFLAGS::IGNORE_SELECTED), maxon::UInt64(enum113::SNAPFLAGS::IGNORE_AXIS), maxon::UInt64(enum113::SNAPFLAGS::POINTSONLY), maxon::UInt64(enum113::SNAPFLAGS::SURFACEONLY)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SNAPFLAGS113(){ return enum113::SNAPFLAGS_info; }
	namespace enum125
	{
		...
		static const maxon::UInt64 INFERREDGUIDETYPE_values[] = {maxon::UInt64(enum125::INFERREDGUIDETYPE::POINT), maxon::UInt64(enum125::INFERREDGUIDETYPE::LINE), maxon::UInt64(enum125::INFERREDGUIDETYPE::PLANE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_INFERREDGUIDETYPE125(){ return enum125::INFERREDGUIDETYPE_info; }
}
#endif
