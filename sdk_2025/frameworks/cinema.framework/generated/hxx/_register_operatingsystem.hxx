...
namespace cinema
{
	namespace enum876
	{
		...
		static const maxon::UInt64 OPENDIALOGFLAGS_values[] = {maxon::UInt64(enum876::OPENDIALOGFLAGS::NONE), maxon::UInt64(enum876::OPENDIALOGFLAGS::IGNORELAYOUT), maxon::UInt64(enum876::OPENDIALOGFLAGS::CLIENTCOORDINATES), maxon::UInt64(enum876::OPENDIALOGFLAGS::ALIGNTOPLEFTATMOUSE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_OPENDIALOGFLAGS876(){ return enum876::OPENDIALOGFLAGS_info; }
	namespace enum892
	{
		...
		static const maxon::UInt64 VIEWPORTSELECTFLAGS_values[] = {maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::NONE), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::USE_HN), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::USE_DEFORMERS), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::REGION_SELECT), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::IGNORE_HIDDEN_SEL), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::USE_DISPLAY_MODE), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::FORCE_USE_DEFORMERS), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::ALLOW_ASYNC), maxon::UInt64(enum892::VIEWPORTSELECTFLAGS::BUILD_ALL_FRAMENTS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VIEWPORTSELECTFLAGS892(){ return enum892::VIEWPORTSELECTFLAGS_info; }
	namespace enum905
	{
		...
		static const maxon::UInt64 SCRIPTMODE_values[] = {maxon::UInt64(enum905::SCRIPTMODE::NONE), maxon::UInt64(enum905::SCRIPTMODE::PYTHON), maxon::UInt64(enum905::SCRIPTMODE::AM_ID)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SCRIPTMODE905(){ return enum905::SCRIPTMODE_info; }
	namespace enum919
	{
		...
		static const maxon::UInt64 BASEDRAW_HIGHLIGHT_values[] = {maxon::UInt64(enum919::BASEDRAW_HIGHLIGHT::BEFORE_TOOLS), maxon::UInt64(enum919::BASEDRAW_HIGHLIGHT::AFTER_TOOLS), maxon::UInt64(enum919::BASEDRAW_HIGHLIGHT::INVERSE_Z), maxon::UInt64(enum919::BASEDRAW_HIGHLIGHT::DRAW_AFTER_CLEAR)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_BASEDRAW_HIGHLIGHT919(){ return enum919::BASEDRAW_HIGHLIGHT_info; }
	namespace enum934
	{
		...
		static const maxon::UInt64 FIELDLAYER_CHANNELFLAG_values[] = {maxon::UInt64(enum934::FIELDLAYER_CHANNELFLAG::NONE), maxon::UInt64(enum934::FIELDLAYER_CHANNELFLAG::ENABLE), maxon::UInt64(enum934::FIELDLAYER_CHANNELFLAG::VALUE), maxon::UInt64(enum934::FIELDLAYER_CHANNELFLAG::COLOR), maxon::UInt64(enum934::FIELDLAYER_CHANNELFLAG::DIRECTION), maxon::UInt64(enum934::FIELDLAYER_CHANNELFLAG::ROTATION)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FIELDLAYER_CHANNELFLAG934(){ return enum934::FIELDLAYER_CHANNELFLAG_info; }
	namespace enum948
	{
		...
		static const maxon::UInt64 POPUPEDITTEXTCALLBACK_values[] = {maxon::UInt64(enum948::POPUPEDITTEXTCALLBACK::TEXTCHANGED), maxon::UInt64(enum948::POPUPEDITTEXTCALLBACK::CLOSED), maxon::UInt64(enum948::POPUPEDITTEXTCALLBACK::CANCELED), maxon::UInt64(enum948::POPUPEDITTEXTCALLBACK::CURSOR_UP), maxon::UInt64(enum948::POPUPEDITTEXTCALLBACK::CURSOR_DOWN)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_POPUPEDITTEXTCALLBACK948(){ return enum948::POPUPEDITTEXTCALLBACK_info; }
/// @cond IGNORE
	...
	namespace enum2215
	{
		...
		static const maxon::UInt64 VARIABLETAGACCESS_values[] = {maxon::UInt64(enum2215::VARIABLETAGACCESS::READACCESS), maxon::UInt64(enum2215::VARIABLETAGACCESS::WRITEACCESS), maxon::UInt64(enum2215::VARIABLETAGACCESS::COUNT), maxon::UInt64(enum2215::VARIABLETAGACCESS::DATARAW), maxon::UInt64(enum2215::VARIABLETAGACCESS::DATAHASH)};
		static const maxon::EnumInfo VARIABLETAGACCESS_info{"VARIABLETAGACCESS", SIZEOF(VARIABLETAGACCESS), false, "READACCESS\0WRITEACCESS\0COUNT\0DATARAW\0DATAHASH\0", VARIABLETAGACCESS_values, std::extent<decltype(VARIABLETAGACCESS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_VARIABLETAGACCESS2215(){ return enum2215::VARIABLETAGACCESS_info; }
