...
namespace cinema
{
	...
	namespace enum841
	{
		...
		static const maxon::UInt64 CAMORPH_COPY_FLAGS_values[] = {maxon::UInt64(enum841::CAMORPH_COPY_FLAGS::NONE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CAMORPH_COPY_FLAGS841(){ return enum841::CAMORPH_COPY_FLAGS_info; }
	namespace enum855
	{
		...
		static const maxon::UInt64 CAMORPH_MODE_FLAGS_values[] = {maxon::UInt64(enum855::CAMORPH_MODE_FLAGS::COLLAPSE), maxon::UInt64(enum855::CAMORPH_MODE_FLAGS::EXPAND), maxon::UInt64(enum855::CAMORPH_MODE_FLAGS::ALL), maxon::UInt64(enum855::CAMORPH_MODE_FLAGS::NONE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CAMORPH_MODE_FLAGS855(){ return enum855::CAMORPH_MODE_FLAGS_info; }
	namespace enum872
	{
		...
		static const maxon::UInt64 CAMORPH_MODE_values[] = {maxon::UInt64(enum872::CAMORPH_MODE::ABS), maxon::UInt64(enum872::CAMORPH_MODE::REL), maxon::UInt64(enum872::CAMORPH_MODE::ROT), maxon::UInt64(enum872::CAMORPH_MODE::CORRECTIONAL), maxon::UInt64(enum872::CAMORPH_MODE::CORRECTIONAL_AREA), maxon::UInt64(enum872::CAMORPH_MODE::PSD), maxon::UInt64(enum872::CAMORPH_MODE::AUTO), maxon::UInt64(enum872::CAMORPH_MODE::NONE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CAMORPH_MODE872(){ return enum872::CAMORPH_MODE_info; }
	namespace enum900
	{
		...
		static const maxon::UInt64 CAMORPH_DATA_FLAGS_values[] = {maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::P), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::S), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::R), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::POINTS), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::TANGENTS), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::VERTEXMAPS), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::WEIGHTMAPS), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::PARAMS), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::USERDATA), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::UV), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::NORMAL), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::ASTAG), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::ALL), maxon::UInt64(enum900::CAMORPH_DATA_FLAGS::NONE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CAMORPH_DATA_FLAGS900(){ return enum900::CAMORPH_DATA_FLAGS_info; }
	namespace enum914
	{
		...
		static const maxon::UInt64 CAMORPH_PSDINTERPOLATION_MODE_values[] = {maxon::UInt64(enum914::CAMORPH_PSDINTERPOLATION_MODE::AXIS), maxon::UInt64(enum914::CAMORPH_PSDINTERPOLATION_MODE::JOINT), maxon::UInt64(enum914::CAMORPH_PSDINTERPOLATION_MODE::GLOBAL), maxon::UInt64(enum914::CAMORPH_PSDINTERPOLATION_MODE::DEFAULT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CAMORPH_PSDINTERPOLATION_MODE914(){ return enum914::CAMORPH_PSDINTERPOLATION_MODE_info; }
#ifndef __API_INTERN__
#endif
#ifndef __API_INTERN__
#endif
