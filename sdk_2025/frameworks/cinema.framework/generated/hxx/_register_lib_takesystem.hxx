...
namespace cinema
{
	namespace enum48
	{
		...
		static const maxon::UInt64 TAKE_MODE_values[] = {maxon::UInt64(enum48::TAKE_MODE::MANUAL), maxon::UInt64(enum48::TAKE_MODE::AUTO)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TAKE_MODE48(){ return enum48::TAKE_MODE_info; }
	namespace enum70
	{
		...
		static const maxon::UInt64 OVERRIDEENABLING_values[] = {maxon::UInt64(enum70::OVERRIDEENABLING::NONE), maxon::UInt64(enum70::OVERRIDEENABLING::OBJECT), maxon::UInt64(enum70::OVERRIDEENABLING::TAG), maxon::UInt64(enum70::OVERRIDEENABLING::MATERIAL), maxon::UInt64(enum70::OVERRIDEENABLING::SHADER), maxon::UInt64(enum70::OVERRIDEENABLING::LAYER), maxon::UInt64(enum70::OVERRIDEENABLING::OTHER), maxon::UInt64(enum70::OVERRIDEENABLING::GLOBAL), maxon::UInt64(enum70::OVERRIDEENABLING::ENABLING), maxon::UInt64(enum70::OVERRIDEENABLING::TRANSFOM), maxon::UInt64(enum70::OVERRIDEENABLING::CAMERA), maxon::UInt64(enum70::OVERRIDEENABLING::RS), maxon::UInt64(enum70::OVERRIDEENABLING::PARAM)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_OVERRIDEENABLING70(){ return enum70::OVERRIDEENABLING_info; }
