...
namespace cinema
{
	namespace enum62
	{
		...
		static const maxon::UInt64 SCULPTBRUSHID_values[] = {maxon::UInt64(enum62::SCULPTBRUSHID::SMOOTH), maxon::UInt64(enum62::SCULPTBRUSHID::PULL), maxon::UInt64(enum62::SCULPTBRUSHID::FLATTEN), maxon::UInt64(enum62::SCULPTBRUSHID::PINCH), maxon::UInt64(enum62::SCULPTBRUSHID::ERASE), maxon::UInt64(enum62::SCULPTBRUSHID::GRAB), maxon::UInt64(enum62::SCULPTBRUSHID::MASK), maxon::UInt64(enum62::SCULPTBRUSHID::KNIFE), maxon::UInt64(enum62::SCULPTBRUSHID::WAX), maxon::UInt64(enum62::SCULPTBRUSHID::INFLATE), maxon::UInt64(enum62::SCULPTBRUSHID::FILL), maxon::UInt64(enum62::SCULPTBRUSHID::SCRAPE), maxon::UInt64(enum62::SCULPTBRUSHID::REPEAT), maxon::UInt64(enum62::SCULPTBRUSHID::AMPLIFY), maxon::UInt64(enum62::SCULPTBRUSHID::SELECT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SCULPTBRUSHID62(){ return enum62::SCULPTBRUSHID_info; }
	namespace enum73
	{
		...
		static const maxon::UInt64 FIRSTHITPPOINTTYPE_values[] = {maxon::UInt64(enum73::FIRSTHITPPOINTTYPE::SELECTED), maxon::UInt64(enum73::FIRSTHITPPOINTTYPE::AVERAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FIRSTHITPPOINTTYPE73(){ return enum73::FIRSTHITPPOINTTYPE_info; }
	namespace enum86
	{
		...
		static const maxon::UInt64 SCULPTBRUSHMODE_values[] = {maxon::UInt64(enum86::SCULPTBRUSHMODE::NORMAL), maxon::UInt64(enum86::SCULPTBRUSHMODE::GRAB)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SCULPTBRUSHMODE86(){ return enum86::SCULPTBRUSHMODE_info; }
	namespace enum100
	{
		...
		static const maxon::UInt64 SCULPTBRUSHDATATYPE_values[] = {maxon::UInt64(enum100::SCULPTBRUSHDATATYPE::NONE), maxon::UInt64(enum100::SCULPTBRUSHDATATYPE::POINT), maxon::UInt64(enum100::SCULPTBRUSHDATATYPE::MASK), maxon::UInt64(enum100::SCULPTBRUSHDATATYPE::COLOR), maxon::UInt64(enum100::SCULPTBRUSHDATATYPE::DIRTYPOINTS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SCULPTBRUSHDATATYPE100(){ return enum100::SCULPTBRUSHDATATYPE_info; }
	namespace enum115
	{
		enum class OVERRIDE
		{
		...
		static const maxon::UInt64 OVERRIDE_values[] = {maxon::UInt64(enum115::OVERRIDE::NONE), maxon::UInt64(enum115::OVERRIDE::INVERT), maxon::UInt64(enum115::OVERRIDE::SMOOTH), maxon::UInt64(enum115::OVERRIDE::SMOOTHTOOL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_OVERRIDE115(){ return enum115::OVERRIDE_info; }
	namespace enum125
	{
		...
		static const maxon::UInt64 SAMPLEMODE_values[] = {maxon::UInt64(enum125::SAMPLEMODE::TAKEONEPIXEL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SAMPLEMODE125(){ return enum125::SAMPLEMODE_info; }
	namespace enum137
	{
		...
		static const maxon::UInt64 SCULPTOFFSETFLAGS_values[] = {maxon::UInt64(enum137::SCULPTOFFSETFLAGS::NONE), maxon::UInt64(enum137::SCULPTOFFSETFLAGS::RESPECTSTRENGTH), maxon::UInt64(enum137::SCULPTOFFSETFLAGS::IGNOREMASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SCULPTOFFSETFLAGS137(){ return enum137::SCULPTOFFSETFLAGS_info; }
/// @cond IGNORE
