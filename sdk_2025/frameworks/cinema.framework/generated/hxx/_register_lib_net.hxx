...
namespace cinema
{
	namespace enum288
	{
		...
		static const maxon::UInt64 TASKSTATE_values[] = {maxon::UInt64(enum288::TASKSTATE::NEW), maxon::UInt64(enum288::TASKSTATE::ASSIGNED), maxon::UInt64(enum288::TASKSTATE::TRANSFERED), maxon::UInt64(enum288::TASKSTATE::ASSEMBLED), maxon::UInt64(enum288::TASKSTATE::SKIPPED)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TASKSTATE288(){ return enum288::TASKSTATE_info; }
#ifdef __NET_LIB__
#endif
#ifdef __NET_LIB__
#endif
