...
namespace cinema
{
	namespace enum49
	{
		...
		static const maxon::UInt64 FIELDLIST_FLAGS_values[] = {maxon::UInt64(enum49::FIELDLIST_FLAGS::NONE), maxon::UInt64(enum49::FIELDLIST_FLAGS::CLAMPOUTPUT), maxon::UInt64(enum49::FIELDLIST_FLAGS::ENABLEDIRECTIONBYDEFAULT), maxon::UInt64(enum49::FIELDLIST_FLAGS::ENABLECOLORBYDEFAULT), maxon::UInt64(enum49::FIELDLIST_FLAGS::DISABLEVALUEBYDEFAULT), maxon::UInt64(enum49::FIELDLIST_FLAGS::SIMPLEGUI), maxon::UInt64(enum49::FIELDLIST_FLAGS::ENABLEROTATIONBYDEFAULT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FIELDLIST_FLAGS49(){ return enum49::FIELDLIST_FLAGS_info; }
/// @cond IGNORE
