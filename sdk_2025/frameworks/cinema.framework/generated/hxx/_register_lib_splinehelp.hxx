...
namespace cinema
{
	namespace enum41
	{
		...
		static const maxon::UInt64 SPLINEHELPFLAGS_values[] = {maxon::UInt64(enum41::SPLINEHELPFLAGS::NONE), maxon::UInt64(enum41::SPLINEHELPFLAGS::USERDEFORMERS), maxon::UInt64(enum41::SPLINEHELPFLAGS::GLOBALSPACE), maxon::UInt64(enum41::SPLINEHELPFLAGS::TARGETRAIL), maxon::UInt64(enum41::SPLINEHELPFLAGS::CONTINUECURVE), maxon::UInt64(enum41::SPLINEHELPFLAGS::FORCEUPDATE), maxon::UInt64(enum41::SPLINEHELPFLAGS::RETAINLINEOBJECT), maxon::UInt64(enum41::SPLINEHELPFLAGS::RETAINSPLINECACHE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SPLINEHELPFLAGS41(){ return enum41::SPLINEHELPFLAGS_info; }
/// @cond IGNORE
