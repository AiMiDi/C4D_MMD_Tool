...
namespace cinema
{
	namespace enum39
	{
		...
		static const maxon::UInt64 GE_CM_CLIPREGION_values[] = {maxon::UInt64(enum39::GE_CM_CLIPREGION::EVENODD), maxon::UInt64(enum39::GE_CM_CLIPREGION::WINDING_)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GE_CM_CLIPREGION39(){ return enum39::GE_CM_CLIPREGION_info; }
	namespace enum51
	{
		...
		static const maxon::UInt64 GE_CM_DRAWMODE_values[] = {maxon::UInt64(enum51::GE_CM_DRAWMODE::COPY), maxon::UInt64(enum51::GE_CM_DRAWMODE::BLEND), maxon::UInt64(enum51::GE_CM_DRAWMODE::MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GE_CM_DRAWMODE51(){ return enum51::GE_CM_DRAWMODE_info; }
	...
	namespace enum66
	{
		...
		static const maxon::UInt64 GE_CM_BLIT_values[] = {maxon::UInt64(enum66::GE_CM_BLIT::COPY), maxon::UInt64(enum66::GE_CM_BLIT::COL), maxon::UInt64(enum66::GE_CM_BLIT::FG)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GE_CM_BLIT66(){ return enum66::GE_CM_BLIT_info; }
	namespace enum78
	{
		...
		static const maxon::UInt64 GE_CM_ARCSEGMENT_values[] = {maxon::UInt64(enum78::GE_CM_ARCSEGMENT::RIGHTTOP), maxon::UInt64(enum78::GE_CM_ARCSEGMENT::RIGHTBOTTOM), maxon::UInt64(enum78::GE_CM_ARCSEGMENT::LEFTBOTTOM), maxon::UInt64(enum78::GE_CM_ARCSEGMENT::LEFTTOP)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GE_CM_ARCSEGMENT78(){ return enum78::GE_CM_ARCSEGMENT_info; }
	namespace enum89
	{
		...
		static const maxon::UInt64 GE_CM_FONTSORT_values[] = {maxon::UInt64(enum89::GE_CM_FONTSORT::FLAT), maxon::UInt64(enum89::GE_CM_FONTSORT::HIERARCHICAL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GE_CM_FONTSORT89(){ return enum89::GE_CM_FONTSORT_info; }
}
#endif
/// @cond IGNORE
