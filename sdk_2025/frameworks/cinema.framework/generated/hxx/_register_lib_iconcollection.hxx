...
namespace cinema
{
	namespace enum28
	{
		...
		static const maxon::UInt64 ICONFLAG_values[] = {maxon::UInt64(enum28::ICONFLAG::NONE), maxon::UInt64(enum28::ICONFLAG::COPY), maxon::UInt64(enum28::ICONFLAG::OVERWRITE), maxon::UInt64(enum28::ICONFLAG::DOUBLESIZE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_ICONFLAG28(){ return enum28::ICONFLAG_info; }
/// @cond IGNORE
