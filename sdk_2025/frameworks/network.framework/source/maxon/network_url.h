...
namespace URLFLAGS
{
	...
	/// Append a '/' character to the end of the file path. out url class doesn't allow to end with a '/' character.
	MAXON_ATTRIBUTE(Bool, APPEND_SLASH, "net.maxon.url.appendslash");
}
