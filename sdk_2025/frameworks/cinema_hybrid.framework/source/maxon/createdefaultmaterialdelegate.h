...
/// }
/// @endcode
using CreateMaterialWithDataDelegate = Delegate<cinema::BaseMaterial*(cinema::BaseDocument*, const Data& textureUrlOrColor)>;
...
using CreateDefaultMaterialDelegate = Delegate<cinema::BaseMaterial*(cinema::BaseDocument*)>;
