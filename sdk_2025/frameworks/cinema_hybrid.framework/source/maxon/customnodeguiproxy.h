...
namespace ATTRIBUTEMANAGER
{
	...
	using SetValueCallback = Delegate<Result<void>(Bool triState, const cinema::GeData& value)>;
	using ChangeValueCallback = Delegate<Result<void>(const cinema::DescID& id, const cinema::BaseContainer& msg, cinema::GeData& resultValue)>;
...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<AttributeManagerProxyRef> GetAttributeManager(cinema::GeDialog& dialog) const;
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Int32 Message(cinema::iBaseCustomGui& gui, const cinema::BaseContainer& msg, cinema::BaseContainer& result);
};
