...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaConverterInterface, , "net.maxon.image.interface.mediaconverter", (MediaBaseInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaConverterErrorInterface, , "net.maxon.image.interface.mediaconvertererror", (ErrorInterface::PrivateGetInterface()));
