...
struct MediaConverterInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = MediaConverterInterface;
...
/// @return												True for supported imported strategy, false otherwise.
		inline HXXADDRET2(Bool) SupportImportStrategy() const;
...
/// @return												True for supported export strategy, false otherwise.
		inline HXXADDRET2(Bool) SupportExportStrategy() const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaConverterInterface, maxon::StrongRefHandler, MediaConverterRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaConverterInterface, maxon::StrongRefHandler, MediaConverterRef>>>>);
...
struct MediaConverterErrorObject_PrivateHelper;
struct MediaConverterErrorInterface::Hxx1
{
	class Reference;
	class NonConstRef;
	using ErrObj = MediaConverterErrorObject_PrivateHelper;
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaConverterErrorInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaConverterErrorInterface, maxon::StrongCOWRefHandler, MediaConverterError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaConverterErrorInterface, maxon::StrongCOWRefHandler, MediaConverterError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaConverterErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaConverterErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] MediaConverterError : public MediaConverterErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(MediaConverterError, MediaConverterErrorObject, "net.maxon.image.error.mediaconverter",  MAXON_IMPLEMENTATION_MODULE("net.maxon.image"););
#endif
