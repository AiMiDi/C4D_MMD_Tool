...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorProfileLegacyProcessorInterface, maxon::StrongACOWRefHandler, ColorProfileLegacyProcessor>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorProfileLegacyProcessorInterface, maxon::StrongACOWRefHandler, ColorProfileLegacyProcessor>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorProfileLegacyProcessorInterface, maxon::StrongACOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorProfileLegacyProcessorInterface, maxon::StrongACOWRefHandler, NonConstRef>>>>);
};
