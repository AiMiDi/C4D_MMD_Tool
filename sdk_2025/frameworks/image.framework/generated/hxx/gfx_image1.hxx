...
/// Observable: This observable is fired as soon as anybody modifies the pixel data of this object.
		inline HXXADDRET2(maxon::ObservableRef<ObservableRegionChangedDelegate>) ObservableRegionChanged(maxon::Bool create) const;
	};
	/// Intermediate helper class for ImageBaseInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageBaseInterface, maxon::StrongRefHandler, ImageBaseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageBaseInterface, maxon::StrongRefHandler, ImageBaseRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageTextureInterface, maxon::StrongRefHandler, ImageTextureRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageTextureInterface, maxon::StrongRefHandler, ImageTextureRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageInterface, maxon::StrongRefHandler, ImageRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageInterface, maxon::StrongRefHandler, ImageRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageLayerInterface, maxon::StrongRefHandler, ImageLayerRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageLayerInterface, maxon::StrongRefHandler, ImageLayerRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
