...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamAudioDataExportInterface, , "net.maxon.image.interface.mediastreamaudiodataexport", (MediaStreamInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int MediaStreamAudioDataExportInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<AudioObjectRef>(OVERLOAD_MAX_RANK)
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_mediasession_audiodata(0
	| maxon::MediaStreamAudioDataExportInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
