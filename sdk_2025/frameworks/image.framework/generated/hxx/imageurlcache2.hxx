...
struct ImageUrlCacheInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(ImageUrlCacheInterface_ObservableFreeCache, ObservableFreeCache, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableFreeCacheDelegate>), maxon::Bool create);
	maxon::Int ImageUrlCacheInterface_ObservableFreeCache_Offset;
	PRIVATE_MAXON_MF_POINTER(ImageUrlCacheInterface_GetImage, GetImage, true, maxon::GenericComponent, const, (Result<Opt<ImageBaseRef>>), UpdateCacheDelegate&& updateDelegate, Bool async);
...
struct ImageUrlCacheInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(ImageUrlCacheInterface_ObservableFreeCache, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableFreeCacheDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableFreeCache(create); }
		PRIVATE_MAXON_MF_WRAPPER(ImageUrlCacheInterface_GetImage, maxon::GenericComponent, const, (Result<Opt<ImageBaseRef>>), UpdateCacheDelegate&& updateDelegate, Bool async) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->GetImage(std::forward<UpdateCacheDelegate>(updateDelegate), async); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ImageUrlCacheInterface::ObservableFreeCache(maxon::Bool create) const -> maxon::ObservableRef<ObservableFreeCacheDelegate>
{
...
{
	const ImageUrlCacheInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(ImageUrlCacheInterface, this); return PRIVATE_MAXON_MF_INVOKE(((const maxon::GenericComponent*) this + mt_.ImageUrlCacheInterface_GetImage_Offset), mt_.ImageUrlCacheInterface_GetImage, std::forward<UpdateCacheDelegate>(updateDelegate), async);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageUrlCacheInterface::Hxx1::ConstFn<S>::ObservableFreeCache(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableFreeCacheDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageUrlCacheInterface::Hxx1::ConstFn<S>::GetImage(UpdateCacheDelegate&& updateDelegate, Bool async) const -> Result<Opt<ImageBaseRef>>
{
	...
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.ImageUrlCacheInterface_GetImage_Offset), mt_.ImageUrlCacheInterface_GetImage, std::forward<UpdateCacheDelegate>(updateDelegate), async));
}
