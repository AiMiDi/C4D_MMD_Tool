...
struct PixelFormatDynamicInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = PixelFormatDynamicInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const PixelFormatDynamicInterface, maxon::StrongCOWRefHandler, PixelFormatDynamic>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const PixelFormatDynamicInterface, maxon::StrongCOWRefHandler, PixelFormatDynamic>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<PixelFormatDynamicInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<PixelFormatDynamicInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
