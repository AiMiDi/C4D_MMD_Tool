...
struct MediaOutputInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = MediaOutputInterface;
...
/// @return												OK on success.
		inline HXXADDRET2(const MediaOutputSelectionHandler&) GetSelectionHandler() const;
	};
	/// Intermediate helper class for MediaOutputInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaOutputInterface, maxon::StrongRefHandler, MediaOutputRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaOutputInterface, maxon::StrongRefHandler, MediaOutputRef>>>>);
...
struct MediaOutputTextureInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaOutputTextureInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaOutputTextureInterface, maxon::StrongRefHandler, MediaOutputTextureRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaOutputTextureInterface, maxon::StrongRefHandler, MediaOutputTextureRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct MediaOutputUrlInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaOutputUrlInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(MediaOutputUrlInterface**);
/// Returns the output url.
		inline HXXADDRET2(Url) GetOutputUrl() const;
/// Returns the corresponding file format.
		inline HXXADDRET2(const FileFormat&) GetFileFormat() const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaOutputUrlInterface, maxon::StrongRefHandler, MediaOutputUrlRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaOutputUrlInterface, maxon::StrongRefHandler, MediaOutputUrlRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
