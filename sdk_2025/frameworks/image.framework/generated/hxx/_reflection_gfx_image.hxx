...
/// @endcond
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImageBaseInterface);
...
/// @endcond
		...
		maxon::ObservableRef<ObservableRegionChangedDelegate> ObservableRegionChanged(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_ImageBaseInterface_ObservableRegionChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableRegionChangedDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.ImageBaseInterface_ObservableRegionChanged)));
			return proxy_result;
		}
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImageTextureInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImageInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImageLayerInterface);
