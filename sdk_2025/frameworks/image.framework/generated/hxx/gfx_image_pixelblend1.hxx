...
struct ImagePixelBlendInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ImagePixelBlendInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(ImagePixelBlendInterface**);
...
#ifdef DOXYGEN
public ConstFnDoxy<ImagePixelBlend>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ImagePixelBlendInterface, maxon::StrongRefHandler, ImagePixelBlend>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ImagePixelBlendInterface, maxon::StrongRefHandler, ImagePixelBlend>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImagePixelBlendInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImagePixelBlendInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
