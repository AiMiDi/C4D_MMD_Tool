...
struct VectorImageInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(VectorImageInterface_GetSVGDocument, GetSVGDocument, true, maxon::GenericComponent, const, (const SVGDocument&));
	maxon::Int VectorImageInterface_GetSVGDocument_Offset;
	PRIVATE_MAXON_MF_POINTER(VectorImageInterface_GetSVGDocument_1, GetSVGDocument, true, maxon::GenericComponent,, (SVGDocument&));
	maxon::Int VectorImageInterface_GetSVGDocument_1_Offset;
	...
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, VectorImageInterface, GetSVGDocument))
	{
		maxon::Tie(VectorImageInterface_GetSVGDocument_1, VectorImageInterface_GetSVGDocument_1_Offset) = VectorImageInterface_GetSVGDocument_1_GetPtr<W>(offset, true);
	}
	}
...
struct VectorImageInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(VectorImageInterface_GetSVGDocument, maxon::GenericComponent, const, (const SVGDocument&)) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->GetSVGDocument(); }
		PRIVATE_MAXON_MF_WRAPPER(VectorImageInterface_GetSVGDocument_1, maxon::GenericComponent,, (SVGDocument&)) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->GetSVGDocument(); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto VectorImageInterface::GetSVGDocument() const -> const SVGDocument&
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto VectorImageInterface::GetSVGDocument() -> SVGDocument&
{
	const VectorImageInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(VectorImageInterface, this); return PRIVATE_MAXON_MF_INVOKE(((maxon::GenericComponent*) this + mt_.VectorImageInterface_GetSVGDocument_1_Offset), mt_.VectorImageInterface_GetSVGDocument_1);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto VectorImageInterface::Hxx1::ConstFn<S>::GetSVGDocument() const -> HXXADDRET2(const SVGDocument&)
{
	HXXRETURN0(HXXADDRET2(const SVGDocument&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const SVGDocument&)) HXXTABLE(VectorImageInterface_GetSVGDocument); 
