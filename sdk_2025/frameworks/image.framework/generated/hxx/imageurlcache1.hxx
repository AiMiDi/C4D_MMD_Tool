...
/// @return                       Cache on success.
		...
		inline HXXADDRET2(maxon::ObservableRef<ObservableFreeCacheDelegate>) ObservableFreeCache(maxon::Bool create) const;
...
/// @return                       Image or nullptr on success.
		inline Result<Opt<ImageBaseRef>> GetImage(UpdateCacheDelegate&& updateDelegate, Bool async = true) const;
	};
	/// Intermediate helper class for ImageUrlCacheInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageUrlCacheInterface, maxon::StrongRefHandler, ImageUrlCacheRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageUrlCacheInterface, maxon::StrongRefHandler, ImageUrlCacheRef>>>>);
