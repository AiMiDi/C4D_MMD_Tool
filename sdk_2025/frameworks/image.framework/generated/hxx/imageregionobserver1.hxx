...
struct ImageRegionObserverInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ImageRegionObserverInterface;
...
/// @param[in] dimensions					The new image size.
		inline HXXADDRET2(void) OnResize(const IntVector2d& dimensions) const;
...
/// @param[in] dirtyRegion				The pixel area that has been invalidated.
		inline HXXADDRET2(void) OnRegionDirty(const Range<IntVector2d>& dirtyRegion) const;
/// Notifies about the disconnection from the observed image. This marks the end of the observation.
		inline HXXADDRET2(void) OnDisconnect() const;
	};
	/// Intermediate helper class for ImageRegionObserverInterface.
...
/// Notifies about the resize of the observed image.
/// @param[in] dimensions					The new image size.
		inline HXXADDRET1(void) OnResize(const IntVector2d& dimensions);
/// Notifies about a regional invalidation of the observed image.
/// @param[in] dirtyRegion				The pixel area that has been invalidated.
		inline HXXADDRET1(void) OnRegionDirty(const Range<IntVector2d>& dirtyRegion);
/// Notifies about the disconnection from the observed image. This marks the end of the observation.
		inline HXXADDRET1(void) OnDisconnect();
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageRegionObserverInterface, maxon::StrongRefHandler, ImageRegionObserverRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageRegionObserverInterface, maxon::StrongRefHandler, ImageRegionObserverRef>>>>);
...
struct ImageRegionObservableInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = ImageRegionObservableInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(ImageRegionObservableInterface**);
/// Checks if the handler is a handler for this ovserver.
/// @param[in] handler						Handler zo check,
/// @return												True, if the handler was registered for this observer.
		inline HXXADDRET2(Bool) Check(const GenericData& handler) const;
	};
	/// Intermediate helper class for ImageRegionObservableInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageRegionObservableInterface, maxon::StrongRefHandler, ImageRegionObservableRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageRegionObservableInterface, maxon::StrongRefHandler, ImageRegionObservableRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct ImageRegionObservableHandlerInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = ImageRegionObservableHandlerInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageRegionObservableHandlerInterface, maxon::StrongRefHandler, ImageRegionObservableHandlerRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImageRegionObservableHandlerInterface, maxon::StrongRefHandler, ImageRegionObservableHandlerRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
