...
struct ColorProfileInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(ColorProfileInterface_IsOcioDisplayViewTransform, IsOcioDisplayViewTransform, false, ColorProfileInterface, const, (Bool));
/// @cond INTERNAL
...
/// @endcond
	...
	template <typename IMPL> void Init()
	{
		...
		ColorProfileInterface_IsOcioDisplayViewTransform = ColorProfileInterface_IsOcioDisplayViewTransform_GetPtr<IMPL>(0, true).first;
/// @cond INTERNAL
...
struct ColorProfileInterface::Hxx2
{
	...
	public:
		...
		static void ColorProfileInterface_Free(const ColorProfileInterface* object) { return S::Free(object); }
		static ColorProfileInterface* ColorProfileInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		static ColorProfileInterface* ColorProfileInterface_Alloc_1(const maxon::SourceLocation& allocLocation, const ColorProfileInterface& object) { return S::Alloc(allocLocation, ((const S&) object)); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_IsEqual, ColorProfileInterface, const, (Bool), const ColorProfileInterface* other) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->IsEqual(other); }
		static Result<ColorProfile> ColorProfileInterface_OpenProfileFromFile(const Url& fn) { return S::OpenProfileFromFile(fn); }
		static Result<ColorProfile> ColorProfileInterface_OpenProfileFromMemory(const Block<const Byte>& mem) { return S::OpenProfileFromMemory(mem); }
		static Result<ColorProfile> ColorProfileInterface_CreateProfile(const OcioConfig& config, const CString& name) { return S::CreateProfile(config, name); }
		static Result<ColorProfile> ColorProfileInterface_CreateProfile_1(const OcioConfig& config, const Url& iccPath) { return S::CreateProfile(config, iccPath); }
		static Result<ColorProfile> ColorProfileInterface_CreateProfile_2(const OcioConfig& config, const CString& viewTransform, const CString& displayColorSpace) { return S::CreateProfile(config, viewTransform, displayColorSpace); }
		static Result<ColorProfile> ColorProfileInterface_CreateProfile_3(const ColorProfile& viewTransform, const ColorProfile& displayColorSpace) { return S::CreateProfile(viewTransform, displayColorSpace); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_WriteProfileToMemory, ColorProfileInterface, const, (Result<void>), WritableArrayInterface<Char>& mem) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->WriteProfileToMemory(mem); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_WriteProfileToFile, ColorProfileInterface, const, (Result<void>), const Url& fn) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->WriteProfileToFile(fn); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_GetInfo, ColorProfileInterface, const, (String), COLORPROFILEINFO info) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->GetInfo(info); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_GetCrc, ColorProfileInterface, const, (UInt32)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->GetCrc(); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_HasProfile, ColorProfileInterface, const, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->HasProfile(); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_CheckCompatiblePixelFormat, ColorProfileInterface, const, (Bool), const PixelFormat& pixelFormat) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->CheckCompatiblePixelFormat(pixelFormat); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_IsMonitorProfileMode, ColorProfileInterface, const, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->IsMonitorProfileMode(); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_GetHashCode, ColorProfileInterface, const, (HashInt)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->GetHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_GetUniqueHashCode, ColorProfileInterface, const, (UniqueHash)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->GetUniqueHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_GetColorSpace, ColorProfileInterface, const, (ColorSpace)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->GetColorSpace(); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_ToString, ColorProfileInterface, const, (String), const FormatStatement* formatStatement) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->ToString(formatStatement); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_GetOcioConfig, ColorProfileInterface, const, (void), OcioConfig& config) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->GetOcioConfig(config); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_IsOcioDisplayViewTransform, ColorProfileInterface, const, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileInterface))->IsOcioDisplayViewTransform(); }
/// @cond INTERNAL

		PRIVATE_MAXON_MF_WRAPPER(ColorProfileInterface_SetMonitorProfileMode, ColorProfileInterface,, (Bool), Bool on) { return S::Get(PRIVATE_MAXON_MF_THIS(ColorProfileInterface))->SetMonitorProfileMode(on); }
		static Result<void> ColorProfileInterface_DescribeIO(const DataSerializeInterface& stream) { return S::DescribeIO(stream); }
/// @endcond
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::IsOcioDisplayViewTransform() const -> Bool
{
	return PRIVATE_MAXON_MF_INVOKE((this), MTable::_instance.ColorProfileInterface_IsOcioDisplayViewTransform);
}
/// @cond INTERNAL
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::IsEqual(const ColorProfileInterface* other) const -> HXXADDRET2(Bool)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::GetInfo(COLORPROFILEINFO info) const -> HXXADDRET2(String)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::GetCrc() const -> HXXADDRET2(UInt32)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::HasProfile() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.ColorProfileInterface_HasProfile));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::CheckCompatiblePixelFormat(const PixelFormat& pixelFormat) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.ColorProfileInterface_CheckCompatiblePixelFormat, pixelFormat));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::IsMonitorProfileMode() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.ColorProfileInterface_IsMonitorProfileMode));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::GetColorSpace() const -> HXXADDRET2(ColorSpace)
{
	HXXRETURN0(HXXADDRET2(ColorSpace)); HXXRES; HXXCONST(HXXRET3(NULLPTR, ColorSpace)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.ColorProfileInterface_GetColorSpace));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::ToString(const FormatStatement* formatStatement) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(HXXRET3(NULLPTR, String)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.ColorProfileInterface_ToString, formatStatement));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::GetOcioConfig(OcioConfig& config) const -> HXXADDRET2(void)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::ConstFn<S>::IsOcioDisplayViewTransform() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.ColorProfileInterface_IsOcioDisplayViewTransform));
}
/// @cond INTERNAL

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::Fn<S>::SetMonitorProfileMode(Bool on) const -> HXXADDRET2(Bool)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileInterface::Hxx1::COWFn<S>::SetMonitorProfileMode(Bool on) -> HXXADDRET1(Bool)
{
...
struct ColorProfileConvertInterface::Hxx2
{
	...
	public:
		using Implementation = S;
		static void ColorProfileConvertInterface_Free(const ColorProfileConvertInterface* object) { return S::Free(object); }
		static Result<ColorProfileConvert> ColorProfileConvertInterface_Init(const PixelFormat& srcPixelFormat, const ColorProfile& srcProfile, const PixelFormat& dstPixelFormat, const ColorProfile& dstProfile, COLORCONVERSIONINTENT intent, COLORCONVERSIONFLAGS flags) { return S::Init(srcPixelFormat, srcProfile, dstPixelFormat, dstProfile, intent, flags); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileConvertInterface_Convert, ColorProfileConvertInterface, const, (Result<void>), const ImageConstBuffer& src, const ImageMutableBuffer& dst, Int cnt) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileConvertInterface))->Convert(src, dst, cnt); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileConvertInterface_GetHashCode, ColorProfileConvertInterface, const, (HashInt)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileConvertInterface))->GetHashCode(); }
		static Result<PixelFormat> ColorProfileConvertInterface_GetNearestNativeFormat(const PixelFormat& format) { return S::GetNearestNativeFormat(format); }
		static Result<ColorProfileConvert> ColorProfileConvertInterface_InitGPU(const ColorProfile& srcProfile, const ColorProfile& dstProfile, COLORCONVERSIONFLAGS_GPU flags, COLORCONVERSION_OPTIMIZATION_GPU_FLAGS optimization) { return S::InitGPU(srcProfile, dstProfile, flags, optimization); }
		PRIVATE_MAXON_MF_WRAPPER(ColorProfileConvertInterface_GetGpuHandler, ColorProfileConvertInterface, const, (ForwardRef<ColorProfileGpuHandlerRef>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const ColorProfileConvertInterface))->GetGpuHandler(); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ColorProfileConvertInterface::Hxx1::ConstFn<S>::GetGpuHandler() const -> HXXADDRET2(ForwardRef<ColorProfileGpuHandlerRef>)
{
	HXXRETURN0(HXXADDRET2(ForwardRef<ColorProfileGpuHandlerRef>)); HXXRES; HXXCONST(HXXRET3(NULLPTR, ForwardRef<ColorProfileGpuHandlerRef>)) 
