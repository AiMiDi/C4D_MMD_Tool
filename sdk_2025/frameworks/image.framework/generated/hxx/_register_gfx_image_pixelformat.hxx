...
namespace maxon
{
	...
	namespace enum49
	{
		enum class GETPIXELHANDLERFLAGS
		{
			...
			ALLOW_INVALIDATE_ALPHA = 1 << 3,				///< Allow GetPixelCntP to invalidate the alpha. E.g. if the source image is RGB and the destination buffer is RGBA, the Alpha channel of the destination may contain garbage.
		} ;
		static const maxon::UInt64 GETPIXELHANDLERFLAGS_values[] = {maxon::UInt64(enum49::GETPIXELHANDLERFLAGS::NONE), maxon::UInt64(enum49::GETPIXELHANDLERFLAGS::FORCECOLORPROFILECONVERSION), maxon::UInt64(enum49::GETPIXELHANDLERFLAGS::DEEPIMAGE), maxon::UInt64(enum49::GETPIXELHANDLERFLAGS::DONTAPPLYMASK), maxon::UInt64(enum49::GETPIXELHANDLERFLAGS::ALLOW_INVALIDATE_ALPHA)};
		static const maxon::EnumInfo GETPIXELHANDLERFLAGS_info{"GETPIXELHANDLERFLAGS", SIZEOF(GETPIXELHANDLERFLAGS), true, "NONE\0FORCECOLORPROFILECONVERSION\0DEEPIMAGE\0DONTAPPLYMASK\0ALLOW_INVALIDATE_ALPHA\0", GETPIXELHANDLERFLAGS_values, std::extent<decltype(GETPIXELHANDLERFLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_GETPIXELHANDLERFLAGS49(){ return enum49::GETPIXELHANDLERFLAGS_info; }
	namespace enum59
	{
		...
		static const maxon::UInt64 GETPIXELFLAGS_values[] = {maxon::UInt64(enum59::GETPIXELFLAGS::NONE), maxon::UInt64(enum59::GETPIXELFLAGS::DEEPIMAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GETPIXELFLAGS59(){ return enum59::GETPIXELFLAGS_info; }
	namespace enum73
	{
		...
		static const maxon::UInt64 SETPIXELHANDLERFLAGS_values[] = {maxon::UInt64(enum73::SETPIXELHANDLERFLAGS::NONE), maxon::UInt64(enum73::SETPIXELHANDLERFLAGS::FORCECOLORPROFILECONVERSION), maxon::UInt64(enum73::SETPIXELHANDLERFLAGS::DEEPIMAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SETPIXELHANDLERFLAGS73(){ return enum73::SETPIXELHANDLERFLAGS_info; }
	namespace enum82
	{
		...
		static const maxon::UInt64 SETPIXELFLAGS_values[] = {maxon::UInt64(enum82::SETPIXELFLAGS::NONE), maxon::UInt64(enum82::SETPIXELFLAGS::DEEPIMAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SETPIXELFLAGS82(){ return enum82::SETPIXELFLAGS_info; }
