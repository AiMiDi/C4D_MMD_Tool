...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImageRegionObserverInterface);
	...
	static maxon::Result<void> RegisterReflection_ImageRegionObservableInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(ImageRegionObservableInterface::MTable::_instance.ImageRegionObservableInterface_Check)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "handler\0", 1LL, nullptr),
		};
