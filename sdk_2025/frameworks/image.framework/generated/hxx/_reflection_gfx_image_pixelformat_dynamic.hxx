...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(PixelFormatDynamicInterface);
	...
	public:
		...
		Result<Int> AddChannel(const ImageChannel& channel) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.PixelFormatDynamicInterface_AddChannel_Offset), maxon::reflection::Argument::ByReference(channel)};
			(*handler_)(_fn_PixelFormatDynamicInterface_AddChannel, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<Int>), const ImageChannel&), reinterpret_cast<const void* const&>(mt_.PixelFormatDynamicInterface_AddChannel)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_PixelFormatDynamicInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "channel\0", 1LL, PixelFormatDynamicInterface, PixelFormatDynamicInterface_AddChannel),
		};
