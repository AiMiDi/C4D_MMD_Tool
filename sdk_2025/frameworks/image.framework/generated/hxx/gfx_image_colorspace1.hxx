...
struct ColorSpaceInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ColorSpaceInterface;
...
/// Returns the default non-linear color profile (gamma != 1.0) for this color space for 8/16 bit integer formats.
		inline HXXADDRET2(const ColorProfile&) GetDefaultNonlinearColorProfile() const;
/// Returns the default color profile for this color space for floating point data.
		inline HXXADDRET2(const ColorProfile&) GetDefaultLinearColorProfile() const;
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorSpaceInterface, maxon::StrongRefHandler, ColorSpace>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorSpaceInterface, maxon::StrongRefHandler, ColorSpace>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorSpaceInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorSpaceInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
