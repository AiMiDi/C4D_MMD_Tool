...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL(MediaStreamInterface, MediaStreamInterface, , , "net.maxon.image.interface.mediastream", (MediaBaseInterface::PrivateGetInterface()), (HierarchyObjectInterface::PrivateGetInterface()), nullptr);
	template <typename DUMMY> maxon::Int MediaStreamInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<MediaStreamFormat>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const Data&>(OVERLOAD_MAX_RANK)
		;
	}
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamExifDataInterface, , "net.maxon.image.interface.mediastreamexifdata", (MediaStreamInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamImageBaseInterface, , "net.maxon.image.interface.mediastreamimagebase", (MediaStreamInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamImageDataImportInterface, , "net.maxon.image.interface.mediastreamimagedataimport", (MediaStreamImageBaseInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamImageDataExportInterface, , "net.maxon.image.interface.mediastreamimagedataexport", (MediaStreamImageBaseInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamImageDataForwardImportInterface, , "net.maxon.image.interface.mediastreamimagedataforwardimport", (MediaStreamImageDataImportInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaStreamAudioDataImportInterface, , "net.maxon.image.interface.mediastreamaudiodataimport", (MediaStreamInterface::PrivateGetInterface()));
...
static maxon::details::ForceEvaluation s_forceEval_mediasession_stream(0
	| maxon::MediaStreamInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
