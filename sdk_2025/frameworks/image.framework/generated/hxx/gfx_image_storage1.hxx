...
struct ImagePixelStorageInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ImagePixelStorageInterface;
...
/// Private.
		inline HXXADDRET2(void) FreePixelHandler(SetPixelHandlerStruct& pixel, const Delegate<void(const UpdateRegion&)>& updateRegionNotification) const;
/// @endcond
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ImagePixelStorageInterface, maxon::StrongCOWRefHandler, ImagePixelStorage>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ImagePixelStorageInterface, maxon::StrongCOWRefHandler, ImagePixelStorage>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImagePixelStorageInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImagePixelStorageInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
