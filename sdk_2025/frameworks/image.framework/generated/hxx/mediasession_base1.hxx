...
struct MediaBaseInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = MediaBaseInterface;
...
/// @return												If successful a valid MediaSessionRef will be returned.
		inline HXXADDRET2(MediaSessionRef) GetSession() const;
	};
	/// Intermediate helper class for MediaBaseInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaBaseInterface, maxon::StrongRefHandler, MediaBaseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaBaseInterface, maxon::StrongRefHandler, MediaBaseRef>>>>);
