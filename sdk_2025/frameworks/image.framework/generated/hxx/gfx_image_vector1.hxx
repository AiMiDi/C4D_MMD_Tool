...
/// GetSVGDocument returns the SVGDocument connected to this image (read only).
		inline HXXADDRET2(const SVGDocument&) GetSVGDocument() const;
	};
	/// Intermediate helper class for VectorImageInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VectorImageInterface, maxon::StrongRefHandler, VectorImageRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<VectorImageInterface, maxon::StrongRefHandler, VectorImageRef>>>>);
