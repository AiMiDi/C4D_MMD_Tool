...
struct MediaStreamInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = MediaStreamInterface;
...
/// returns the format of the given id.
		inline HXXADDRET2(MediaStreamFormat) GetFormat(const Data& formatId) const;
/// returns the selected format.
		inline HXXADDRET2(const Data&) GetSelectedFormat() const;
/// Returns true if the stream is subscribed by a media converter.
		inline HXXADDRET2(Bool) IsSubscribed() const;
	};
	/// Intermediate helper class for MediaStreamInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamInterface, maxon::StrongRefHandler, MediaStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamInterface, maxon::StrongRefHandler, MediaStreamRef>>>>);
...
struct MediaStreamExifDataInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamExifDataInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamExifDataInterface, maxon::StrongRefHandler, MediaStreamExifDataRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamExifDataInterface, maxon::StrongRefHandler, MediaStreamExifDataRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct MediaStreamImageBaseInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamImageBaseInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageBaseInterface, maxon::StrongRefHandler, MediaStreamImageBaseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageBaseInterface, maxon::StrongRefHandler, MediaStreamImageBaseRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct MediaStreamImageDataImportInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamImageDataImportInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageDataImportInterface, maxon::StrongRefHandler, MediaStreamImageDataImportRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageDataImportInterface, maxon::StrongRefHandler, MediaStreamImageDataImportRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct MediaStreamImageDataExportInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamImageDataExportInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageDataExportInterface, maxon::StrongRefHandler, MediaStreamImageDataExportRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageDataExportInterface, maxon::StrongRefHandler, MediaStreamImageDataExportRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct MediaStreamImageDataForwardImportInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamImageDataForwardImportInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageDataForwardImportInterface, maxon::StrongRefHandler, MediaStreamImageDataForwardImportRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamImageDataForwardImportInterface, maxon::StrongRefHandler, MediaStreamImageDataForwardImportRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
struct MediaStreamAudioDataImportInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamAudioDataImportInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamAudioDataImportInterface, maxon::StrongRefHandler, MediaStreamAudioDataImportRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamAudioDataImportInterface, maxon::StrongRefHandler, MediaStreamAudioDataImportRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
