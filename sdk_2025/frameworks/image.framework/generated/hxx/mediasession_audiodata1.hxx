...
struct MediaStreamAudioDataExportInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = MediaStreamAudioDataExportInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(MediaStreamAudioDataExportInterface**);
/// Returns the object given at Init.
/// @return												OK on success.
		inline HXXADDRET2(AudioObjectRef) GetAudioObject() const;
	};
	/// Intermediate helper class for MediaStreamAudioDataExportInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamAudioDataExportInterface, maxon::StrongRefHandler, MediaStreamAudioDataExportRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamAudioDataExportInterface, maxon::StrongRefHandler, MediaStreamAudioDataExportRef>>>>);
