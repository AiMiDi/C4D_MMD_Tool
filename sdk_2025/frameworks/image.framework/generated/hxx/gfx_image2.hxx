...
/// @endcond
	...
	PRIVATE_MAXON_MF_POINTER(ImageBaseInterface_ObservableRegionChanged, ObservableRegionChanged, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableRegionChangedDelegate>), maxon::Bool create);
...
/// @endcond
		...
		PRIVATE_MAXON_MF_WRAPPER(ImageBaseInterface_ObservableRegionChanged, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableRegionChangedDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableRegionChanged(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ImageBaseInterface::ObservableRegionChanged(maxon::Bool create) const -> maxon::ObservableRef<ObservableRegionChangedDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageBaseInterface::Hxx1::ConstFn<S>::ObservableRegionChanged(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableRegionChangedDelegate>)
{
