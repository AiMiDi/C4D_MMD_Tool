...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ImagePixelDeepImageStorageInterface, maxon::StrongCOWRefHandler, ImagePixelDeepImageStorage>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ImagePixelDeepImageStorageInterface, maxon::StrongCOWRefHandler, ImagePixelDeepImageStorage>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImagePixelDeepImageStorageInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ImagePixelDeepImageStorageInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
