...
namespace maxon
{
	...
	"";
	const maxon::METHOD_FLAGS PixelFormatDynamicInterface::MTable::_flags[] = 
	{
		maxon::METHOD_FLAGS::NONE,
		maxon::METHOD_FLAGS::NONE
	};
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(PixelFormatDynamicInterface, , "net.maxon.image.interface.pixelformatdynamic", (PixelFormatInterface::PrivateGetInterface()));
