...
namespace maxon
{
	...
	namespace enum118
	{
		...
		static const maxon::UInt64 IMAGEHIERARCHY_values[] = {maxon::UInt64(enum118::IMAGEHIERARCHY::TEXTURE), maxon::UInt64(enum118::IMAGEHIERARCHY::IMAGE), maxon::UInt64(enum118::IMAGEHIERARCHY::ALPHA), maxon::UInt64(enum118::IMAGEHIERARCHY::LAYER), maxon::UInt64(enum118::IMAGEHIERARCHY::MASK), maxon::UInt64(enum118::IMAGEHIERARCHY::DEEPIMAGEDATA), maxon::UInt64(enum118::IMAGEHIERARCHY::MAX_ELEMENTS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IMAGEHIERARCHY118(){ return enum118::IMAGEHIERARCHY_info; }
	namespace enum127
	{
		enum class TRANSFORM_COLORS_FLAGS
		{
			NONE = 0,											///< No flags.
			INVERSE_DIRECTION = (1 << 0)  ///< Inverse direction.
		} ;
		static const maxon::UInt64 TRANSFORM_COLORS_FLAGS_values[] = {maxon::UInt64(enum127::TRANSFORM_COLORS_FLAGS::NONE), maxon::UInt64(enum127::TRANSFORM_COLORS_FLAGS::INVERSE_DIRECTION)};
		static const maxon::EnumInfo TRANSFORM_COLORS_FLAGS_info{"TRANSFORM_COLORS_FLAGS", SIZEOF(TRANSFORM_COLORS_FLAGS), true, "NONE\0INVERSE_DIRECTION\0", TRANSFORM_COLORS_FLAGS_values, std::extent<decltype(TRANSFORM_COLORS_FLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_TRANSFORM_COLORS_FLAGS127(){ return enum127::TRANSFORM_COLORS_FLAGS_info; }
/// @cond INTERNAL
...
/// @endcond
		...
		"TransformColors@109f2b3a95420c5b\0" // Result<ImageBaseRef> TransformColors(const ColorProfile& srcProfile, const ColorProfile& dstProfile, TRANSFORM_COLORS_FLAGS flags)
		"ObservableRegionChanged@a25c7563738ce826\0" // maxon::ObservableRef<ObservableRegionChangedDelegate> ObservableRegionChanged(maxon::Bool create) const
	"";
...
/// @endcond
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL(ImageBaseInterface, ImageBaseInterface, , , "net.maxon.image.interface.imagebase", (DataDictionaryObjectInterface::PrivateGetInterface()), (HierarchyObjectInterface::PrivateGetInterface()), nullptr);
	template <typename DUMMY> maxon::Int ImageBaseInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
	...
	{
	public:
		static Result<ImageTextureRef> LoadTexture(const Url& name, const TimeValue& targetTime, MEDIASESSIONFLAGS flags, const Class<ImagePixelStorage>& pixelStorageClass, const LayerSetInterface* layerSet) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, false)) return ImageTextureInterface::LoadTexture(name, targetTime, flags, pixelStorageClass, layerSet); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE ImageTextureInterface::Hxx2::StaticMTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<Result<ImageTextureRef>>::value,
	...
	maxon::Bool ImageTextureInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<Result<ImageTextureRef>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ImageTextureInterface_LoadTexture = PRIVATE_MAXON_MF_CAST(decltype(ImageTextureInterface_LoadTexture), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImageTextureInterface_LoadTexture);
		#else
		tbl->ImageTextureInterface_LoadTexture = PRIVATE_MAXON_MF_CAST(decltype(ImageTextureInterface_LoadTexture), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::ImageTextureInterface_LoadTexture);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImageTextureInterface, , "net.maxon.image.interface.imagetexture", (ImageBaseInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImageInterface, , "net.maxon.image.interface.image", (ImageBaseInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImageLayerInterface, , "net.maxon.image.interface.imagelayer", (ImageInterface::PrivateGetInterface()));
	...
	public:
		...
		static Result<ImageBaseRef> CreateSubImagePart(const ImageBaseRef& imageRef, const DrawRectInt& rect) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ImageFunctionsInterface::CreateSubImagePart(imageRef, rect); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE ImageFunctionsInterface::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<Result<ImageBaseRef>>::value,
		maxon::UNRESOLVED_RETURN_TYPE::OTHER
	};
#endif
	...
	{
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<ImageBaseRef>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ImageFunctionsInterface_CreateSubImagePart = PRIVATE_MAXON_MF_CAST(decltype(ImageFunctionsInterface_CreateSubImagePart), &Hxx2::Wrapper<Hxx2::Unresolved>::ImageFunctionsInterface_CreateSubImagePart);
		#else
		tbl->ImageFunctionsInterface_CreateSubImagePart = PRIVATE_MAXON_MF_CAST(decltype(ImageFunctionsInterface_CreateSubImagePart), &Hxx2::Wrapper<Hxx2::Unresolved>::ImageFunctionsInterface_CreateSubImagePart);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(ImageFunctionsInterface, "net.maxon.image.interface.imagefunctions", nullptr, maxon::EntityBase::FLAGS::NONE);
...
static maxon::details::ForceEvaluation s_forceEval_gfx_image(0
	| maxon::ImageBaseInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
