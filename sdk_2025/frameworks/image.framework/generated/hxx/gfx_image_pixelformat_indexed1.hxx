...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const PixelFormatIndexedColorInterface, maxon::StrongCOWRefHandler, PixelFormatIndexedColor>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const PixelFormatIndexedColorInterface, maxon::StrongCOWRefHandler, PixelFormatIndexedColor>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<PixelFormatIndexedColorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<PixelFormatIndexedColorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
