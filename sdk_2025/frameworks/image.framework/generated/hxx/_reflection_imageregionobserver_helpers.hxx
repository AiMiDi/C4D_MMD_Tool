...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImageRegionTilesObserverInterface);
	...
	public:
		...
		Result<void> Init(Int tileSize) 
		{
			...
			(*handler_)(_fn_ImageRegionTilesObserverInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), Int), reinterpret_cast<const void* const&>(mt_.ImageRegionTilesObserverInterface_Init)));
			return proxy_result;
		}
		...
		Result<void> GetAndResetDirtyState(DirtyState& dirtyState) 
		{
			...
			(*handler_)(_fn_ImageRegionTilesObserverInterface_GetAndResetDirtyState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), DirtyState&), reinterpret_cast<const void* const&>(mt_.ImageRegionTilesObserverInterface_GetAndResetDirtyState)));
			return proxy_result;
		}
