...
struct MediaSessionFileFormatHandlerInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = MediaSessionFileFormatHandlerInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaSessionFileFormatHandlerInterface, maxon::StrongRefHandler, MediaSessionFileFormatHandler>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaSessionFileFormatHandlerInterface, maxon::StrongRefHandler, MediaSessionFileFormatHandler>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaSessionFileFormatHandlerInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaSessionFileFormatHandlerInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
