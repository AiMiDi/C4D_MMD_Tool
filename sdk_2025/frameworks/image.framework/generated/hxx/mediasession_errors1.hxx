...
struct MediaSessionWrongTypeErrorObject_PrivateHelper;
struct MediaSessionWrongTypeErrorInterface::Hxx1
{
	class Reference;
	class NonConstRef;
	using ErrObj = MediaSessionWrongTypeErrorObject_PrivateHelper;
	...
	public:
		...
		using PrivateInterface = MediaSessionWrongTypeErrorInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaSessionWrongTypeErrorInterface, maxon::StrongCOWRefHandler, MediaSessionWrongTypeError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaSessionWrongTypeErrorInterface, maxon::StrongCOWRefHandler, MediaSessionWrongTypeError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaSessionWrongTypeErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaSessionWrongTypeErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] MediaSessionWrongTypeError : public MediaSessionWrongTypeErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(MediaSessionWrongTypeError, MediaSessionWrongTypeErrorObject, "net.maxon.image.error.mediasessionwrongtype",  MAXON_IMPLEMENTATION_MODULE("net.maxon.image"););
...
struct MediaStreamEOFErrorObject_PrivateHelper;
struct MediaStreamEOFErrorInterface::Hxx1
{
	class Reference;
	class NonConstRef;
	using ErrObj = MediaStreamEOFErrorObject_PrivateHelper;
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = MediaStreamEOFErrorInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaStreamEOFErrorInterface, maxon::StrongCOWRefHandler, MediaStreamEOFError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const MediaStreamEOFErrorInterface, maxon::StrongCOWRefHandler, MediaStreamEOFError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamEOFErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MediaStreamEOFErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};

/// MediaStreamEOFError is the reference class of MediaStreamEOFErrorInterface.
///
/// End of Media Stream is reached.
class [[nodiscard]] MediaStreamEOFError : public MediaStreamEOFErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(MediaStreamEOFError, MediaStreamEOFErrorObject, "net.maxon.image.error.mediastreameof",  MAXON_IMPLEMENTATION_MODULE("net.maxon.image"););
#endif
