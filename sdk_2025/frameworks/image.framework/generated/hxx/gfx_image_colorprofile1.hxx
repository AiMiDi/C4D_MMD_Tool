...
struct ColorProfileInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ColorProfileInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(ColorProfileInterface**);
		inline HXXADDRET2(Bool) IsEqual(const ColorProfileInterface* other) const;
...
/// @return												String with the information stored in the color profile.
		inline HXXADDRET2(String) GetInfo(COLORPROFILEINFO info) const;
/// Returns the crc representing this color profile.
		inline HXXADDRET2(UInt32) GetCrc() const;
/// Returns whether this object contains a valid color profile.
		inline HXXADDRET2(Bool) HasProfile() const;
...
/// @return												True if the pixel format is compatible with the color profile.
		inline HXXADDRET2(Bool) CheckCompatiblePixelFormat(const PixelFormat& pixelFormat) const;
/// Returns whether the color profile is linked to a color profile of a monitor.
		inline HXXADDRET2(Bool) IsMonitorProfileMode() const;
...
/// @param[out] config						The OCIO conig.
		inline HXXADDRET2(void) GetOcioConfig(OcioConfig& config) const;
/// Checks if the curernt profile is a display - view tranform.
/// @return												True, of the current profile is a display - view transform.
		inline HXXADDRET2(Bool) IsOcioDisplayViewTransform() const;
/// @cond INTERNAL
...
/// Private.
		inline HXXADDRET2(Bool) SetMonitorProfileMode(Bool on) const;
/// @endcond
...
/// Private.
		inline HXXADDRET1(Bool) SetMonitorProfileMode(Bool on);
/// @endcond
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorProfileInterface, maxon::StrongACOWRefHandler, ColorProfile>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorProfileInterface, maxon::StrongACOWRefHandler, ColorProfile>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorProfileInterface, maxon::StrongACOWRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorProfileInterface, maxon::StrongACOWRefHandler, NonConstRef>>>>);
};
...
struct ColorProfileConvertInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = ColorProfileConvertInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
/// @return												GPU handler for this conversion.
		inline HXXADDRET2(ForwardRef<ColorProfileGpuHandlerRef>) GetGpuHandler() const;
	};
	template <typename ST> struct FnHelper : public std::conditional<
	false, void,
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorProfileConvertInterface, maxon::StrongRefHandler, ColorProfileConvert>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ColorProfileConvertInterface, maxon::StrongRefHandler, ColorProfileConvert>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorProfileConvertInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ColorProfileConvertInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
