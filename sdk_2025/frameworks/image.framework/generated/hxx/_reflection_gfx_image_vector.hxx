...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(VectorImageInterface);
	...
	public:
		...
		Result<void> Init(const Url& url) 
		{
			...
			(*handler_)(_fn_VectorImageInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const Url&), reinterpret_cast<const void* const&>(mt_.VectorImageInterface_Init)));
			return proxy_result;
		}
		...
		Result<void> Init(const SVGDocument& svgDocument) 
		{
			...
			(*handler_)(_fn_VectorImageInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const SVGDocument&), reinterpret_cast<const void* const&>(mt_.VectorImageInterface_Init_1)));
			return proxy_result;
		}
		...
		const Url& GetUrl() const 
		{
			...
			(*handler_)(_fn_VectorImageInterface_GetUrl, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((const Url&)), reinterpret_cast<const void* const&>(mt_.VectorImageInterface_GetUrl)));
			return *proxy_result;
		}
		...
		const SVGDocument& GetSVGDocument() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<VectorImageInterface>();
			const SVGDocument* proxy_result = &HXXRET3(NULLIMPL, const SVGDocument&);
			...
			(*handler_)(_fn_VectorImageInterface_GetSVGDocument, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((const SVGDocument&)), reinterpret_cast<const void* const&>(mt_.VectorImageInterface_GetSVGDocument)));
			return *proxy_result;
		}
		...
		SVGDocument& GetSVGDocument() 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<VectorImageInterface>();
			SVGDocument* proxy_result = &HXXRET3(NULLIMPL, SVGDocument&);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.VectorImageInterface_GetSVGDocument_1_Offset)};
			(*handler_)(_fn_VectorImageInterface_GetSVGDocument_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((SVGDocument&)), reinterpret_cast<const void* const&>(mt_.VectorImageInterface_GetSVGDocument_1)));
			return *proxy_result;
		}
		static const maxon::reflection::Function* _fn_VectorImageInterface_GetSVGDocument_1;
	};
	...
	const maxon::reflection::Function* VectorImageInterface::ProxyComponent::_fn_VectorImageInterface_GetSVGDocument_1;
	...
	static maxon::Result<void> RegisterReflection_VectorImageInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "", 0LL, VectorImageInterface, VectorImageInterface_GetSVGDocument_1),
		};
