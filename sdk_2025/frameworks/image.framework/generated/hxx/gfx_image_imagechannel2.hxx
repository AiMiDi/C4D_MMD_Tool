...
{
	HXXRETURN0(HXXADDRET2(ImageChannel)); HXXSUPER("ImageChannelTypeInterface::GetChannel"); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<ImageChannel, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
