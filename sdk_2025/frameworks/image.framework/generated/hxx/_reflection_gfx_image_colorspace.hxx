...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ColorSpaceInterface);
	...
	public:
		...
		const ColorProfile& GetDefaultNonlinearColorProfile() const 
		{
			...
			const ColorProfile* proxy_result = &HXXRET3(NULLIMPL, const ColorProfile&);
			...
			(*handler_)(_fn_ColorSpaceInterface_GetDefaultNonlinearColorProfile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((const ColorProfile&)), reinterpret_cast<const void* const&>(mt_.ColorSpaceInterface_GetDefaultNonlinearColorProfile)));
			return *proxy_result;
		}
		...
		const ColorProfile& GetDefaultLinearColorProfile() const 
		{
			...
			(*handler_)(_fn_ColorSpaceInterface_GetDefaultLinearColorProfile, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((const ColorProfile&)), reinterpret_cast<const void* const&>(mt_.ColorSpaceInterface_GetDefaultLinearColorProfile)));
			return *proxy_result;
		}
