...
/// @endcond
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ImagePixelStorageInterface);
	...
	public:
		...
		Result<void> Init(Int width, Int height, const PixelFormat& format, const Block<Pix>* defaultColor) 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), Int, Int, const PixelFormat&, const Block<Pix>*), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_Init)));
			return proxy_result;
		}
		...
		Int GetWidth() const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_GetWidth, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_GetWidth)));
			return proxy_result;
		}
		...
		Int GetHeight() const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_GetHeight, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_GetHeight)));
			return proxy_result;
		}
		...
		Int GetChannelCount() const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_GetChannelCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_GetChannelCount)));
			return proxy_result;
		}
		...
		PixelFormat GetPixelFormat() const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_GetPixelFormat, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((PixelFormat)), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_GetPixelFormat)));
			return proxy_result;
		}
		...
		Result<SetPixelHandlerStruct> SetPixelHandler(const PixelFormat& srcFormat, const ChannelOffsets& channelOffsets, const ColorProfile& srcColorProfile, const ColorProfile& dstColorProfile, SETPIXELHANDLERFLAGS flags, const Delegate<void(const UpdateRegion&)>& updateRegionNotification) 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_SetPixelHandler, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<SetPixelHandlerStruct>), const PixelFormat&, const ChannelOffsets&, const ColorProfile&, const ColorProfile&, SETPIXELHANDLERFLAGS, const Delegate<void(const UpdateRegion&)>&), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_SetPixelHandler)));
			return proxy_result;
		}
...
/// @cond INTERNAL
		...
		void FreePixelHandler(GetPixelHandlerStruct& pixel) const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_FreePixelHandler, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((void), GetPixelHandlerStruct&), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_FreePixelHandler)));
		}
		...
		void FreePixelHandler(SetPixelHandlerStruct& pixel, const Delegate<void(const UpdateRegion&)>& updateRegionNotification) const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_FreePixelHandler_1, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((void), SetPixelHandlerStruct&, const Delegate<void(const UpdateRegion&)>&), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_FreePixelHandler_1)));
		}
...
/// @endcond
		...
		Result<void> GetComponent(Int component, const ImagePos& pos, Pix* data, Int inc, GETPIXELFLAGS flags) const 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_GetComponent, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), Int, const ImagePos&, Pix*, Int, GETPIXELFLAGS), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_GetComponent)));
			return proxy_result;
		}
		...
		Result<void> SetComponent(Int component, const ImagePos& pos, const Pix* data, Int inc, SETPIXELFLAGS flags) 
		{
			...
			(*handler_)(_fn_ImagePixelStorageInterface_SetComponent, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), Int, const ImagePos&, const Pix*, Int, SETPIXELFLAGS), reinterpret_cast<const void* const&>(mt_.ImagePixelStorageInterface_SetComponent)));
			return proxy_result;
		}
