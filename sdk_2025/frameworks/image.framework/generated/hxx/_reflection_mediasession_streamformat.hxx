...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(MediaStreamFormatInterface);
	static maxon::InterfaceDefinition s_MediaStreamFormatInterface(MediaStreamFormatInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION,"maxon::MediaStreamFormat");
#endif
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(MediaStreamFormatInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, &maxon::g_translationUnit, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(MediaStreamPropertiesInterface);
	static maxon::InterfaceDefinition s_MediaStreamPropertiesInterface(MediaStreamPropertiesInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION,"maxon::MediaStreamProperties");
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	...
	public:
		...
		Result<void> Init(const MediaStreamFormat& withFormat) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.MediaStreamPropertiesInterface_Init_Offset), maxon::reflection::Argument::ByReference(withFormat)};
			(*handler_)(_fn_MediaStreamPropertiesInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const MediaStreamFormat&), reinterpret_cast<const void* const&>(mt_.MediaStreamPropertiesInterface_Init)));
			return proxy_result;
		}
		...
		Result<void> Init(const MediaStreamRef& withStream) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<MediaStreamPropertiesInterface>();
			Result<void> proxy_result = HXXRET1(NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.MediaStreamPropertiesInterface_Init_1_Offset), maxon::reflection::Argument::ByReference(withStream)};
			(*handler_)(_fn_MediaStreamPropertiesInterface_Init_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const MediaStreamRef&), reinterpret_cast<const void* const&>(mt_.MediaStreamPropertiesInterface_Init_1)));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(MediaStreamPropertiesInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, &maxon::g_translationUnit, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_MediaStreamPropertiesInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "withFormat\0", 0LL, MediaStreamPropertiesInterface, MediaStreamPropertiesInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "withStream\0", 0LL, MediaStreamPropertiesInterface, MediaStreamPropertiesInterface_Init_1),
		};
