...
MAXON_DATATYPE(DrawPoint3dInt, "net.maxon.image.drawpoint3dint", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));

//----------------------------------------------------------------------------------------
/// DrawPoint3d for Float types.
//----------------------------------------------------------------------------------------
using DrawPoint3dFloat = DrawPoint3d<Float>;
MAXON_DATATYPE(DrawPoint3dFloat, "net.maxon.image.drawpoint3dfloat", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
MAXON_DATATYPE(DrawDimension3dInt, "net.maxon.image.drawdimension3dint", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));

//----------------------------------------------------------------------------------------
/// DrawDimension3d for Float types.
//----------------------------------------------------------------------------------------
using DrawDimension3dFloat = DrawDimension3d<Float>;
MAXON_DATATYPE(DrawDimension3dFloat, "net.maxon.image.drawdimension3dfloat", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
MAXON_DATATYPE(DrawVolumeInt, "net.maxon.image.drawvolumeint", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));

//----------------------------------------------------------------------------------------
/// DrawVolume for Float types.
//----------------------------------------------------------------------------------------
using DrawVolumeFloat = DrawVolume<Float>;
MAXON_DATATYPE(DrawVolumeFloat, "net.maxon.image.drawvolumefloat", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));

#include "gfx_basictypes_3d1.hxx"
#include "gfx_basictypes_3d2.hxx"
