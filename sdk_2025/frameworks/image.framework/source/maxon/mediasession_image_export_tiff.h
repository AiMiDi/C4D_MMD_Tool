	...
	namespace TIFF
	{
		namespace EXPORT
		{
			...
			MAXON_ATTRIBUTE(Id, BYTEORDER, "net.maxon.mediasession.tiff.export.byteorder",
				RESOURCE_DEFINE(ENUM_IBMPC, LiteralId("ibmpc"))
				RESOURCE_DEFINE(ENUM_MOTOROLA, LiteralId("motorola")));

			MAXON_ATTRIBUTE(Id, COMPRESSION, "net.maxon.mediasession.tiff.export.compression",
				RESOURCE_DEFINE(ENUM_NONE, LiteralId("none"))
				RESOURCE_DEFINE(ENUM_PACKBITS, LiteralId("packbits"))
				RESOURCE_DEFINE(ENUM_LZW, LiteralId("lzw"))
...
{
	MAXON_DECLARATION(ImageSaverClasses::EntryType, Tif, MEDIASESSION::TIFF::EXPORT::GetId(), MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));	///< TIF image saver.
}
