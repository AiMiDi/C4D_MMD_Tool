...
{
	MAXON_INTERFACE(PixelFormatGroupInterface, MAXON_REFERENCE_CONST, "net.maxon.image.interface.pixelformatgroup", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_DECLARATION(PixelFormatGroup, RGBGroup, "net.maxon.image.pixelformat.rgbgroup", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
}
