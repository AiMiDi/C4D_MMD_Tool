...
{
	MAXON_INTERFACE(MediaOutputInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediaoutput", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaOutputTextureInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediaoutputtexture", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(MediaOutputUrlInterface, MAXON_REFERENCE_NORMAL, "net.maxon.image.interface.mediaoutputurl", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
MAXON_DECLARATION(Class<MediaOutputRef>, MediaOutputBaseClass, "net.maxon.image.class.mediaoutputbase", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaOutputTextureRef>, MediaOutputTextureClass, "net.maxon.image.class.mediaoutputtexture", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
MAXON_DECLARATION(Class<MediaOutputUrlRef>, MediaOutputUrlBaseClass, "net.maxon.image.class.mediaoutputurlbase", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
