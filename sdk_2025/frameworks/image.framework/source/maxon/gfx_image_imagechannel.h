...
using Pix16f = HalfFloat; ///< pixel format with 16 bit floating point values (half float).
...
{
	MAXON_INTERFACE(ImageChannelTypeInterface, MAXON_REFERENCE_CONST, "net.maxon.image.interface.imagechanneltype", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
{
	MAXON_INTERFACE(ImageChannelInterface, MAXON_REFERENCE_CONST, "net.maxon.image.interface.imagechannel", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
