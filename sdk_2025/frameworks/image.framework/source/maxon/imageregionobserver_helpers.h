...
{
	MAXON_INTERFACE(ImageRegionTilesObserverInterface, MAXON_REFERENCE_NORMAL, "net.maxon.nodes.interface.imageregionobserver.tiles", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
...
//----------------------------------------------------------------------------------------
MAXON_DECLARATION(Class<ImageRegionTilesObserverRef>, ImageRegionSingleTileObserverClass, "net.maxon.class.imageregionobserver.tiles", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
