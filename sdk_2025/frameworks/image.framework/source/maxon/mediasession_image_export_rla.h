...
{
	MAXON_DECLARATION(ImageSaverClasses::EntryType, Rla, MEDIASESSION::RLA::EXPORT::GetId(), MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));	///< Rla image saver.
	MAXON_DECLARATION(ImageSaverClasses::EntryType, Rpf, MEDIASESSION::RPF::EXPORT::GetId(), MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));	///< Rpf image saver.
}
