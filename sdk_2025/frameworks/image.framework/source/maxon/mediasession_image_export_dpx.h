...
namespace MEDIASESSION
{
	namespace DPX
	{
		namespace EXPORT
		{
			...
			MAXON_ATTRIBUTE(Id, BITDEPTH, "net.maxon.mediasession.dpx.export.bitdepth",
				RESOURCE_DEFINE(ENUM_DEFAULT, LiteralId("Default"))
				RESOURCE_DEFINE(ENUM_10_BIT, LiteralId("10 Bit"))
				RESOURCE_DEFINE(ENUM_12_BIT, LiteralId("12 Bit")));

			/// Save in planar mode.
			MAXON_ATTRIBUTE(Bool, PLANAR, "net.maxon.mediasession.dpx.export.planar");
		}
	}
}
}
...
{
	MAXON_DECLARATION(ImageSaverClasses::EntryType, Dpx, MEDIASESSION::DPX::EXPORT::GetId(), MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));	///< Dpx image saver.
}
