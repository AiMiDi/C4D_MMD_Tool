...
{
	MAXON_INTERFACE(MediaSessionWrongTypeErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.image.interface.mediasessionwrongtypeerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
};
...
{
	MAXON_INTERFACE(MediaStreamEOFErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.image.interface.mediastreameoferror", MAXON_IMPLEMENTATION_MODULE("net.maxon.image"));
};
