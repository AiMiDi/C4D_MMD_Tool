...
namespace MEDIASESSION
{
	...
	namespace MF
	{
		namespace EXPORT
		{
			...
			MAXON_ATTRIBUTE(Id, CODEC, "net.maxon.mediasession.mf.export.codec",
				RESOURCE_DEFINE(ENUM_H_264, LiteralId("H.264"))
				RESOURCE_DEFINE(ENUM_WMV1, LiteralId("WMV1"))
				RESOURCE_DEFINE(ENUM_WMV2, LiteralId("WMV2"))
				RESOURCE_DEFINE(ENUM_WMV3, LiteralId("WMV3"))
				RESOURCE_DEFINE(ENUM_PRORES422, LiteralId("ProRes422"))
				RESOURCE_DEFINE(ENUM_PRORES4444, LiteralId("ProRes4444"))
				RESOURCE_DEFINE(ENUM_JPEG, LiteralId("JPEG")));
			...
			MAXON_ATTRIBUTE(Id, AUDIO_CODEC, "net.maxon.mediasession.mf.export.audio.codec",
				RESOURCE_DEFINE(ENUM_AAC, LiteralId("aac"))
				RESOURCE_DEFINE(ENUM_MP3, LiteralId("mp3")));
