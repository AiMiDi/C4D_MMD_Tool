...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueZeroInitializedHelper
{
public:
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueZeroInitializedHelper<T&, ALLOW_NONCONST>
{
public:
	static MAXON_ATTRIBUTE_FORCE_INLINE T& Get()
	{
		static_assert(ALLOW_NONCONST, "There is no default value for a non-const reference.");
		return *const_cast<T*>(reinterpret_cast<const T*>(g_zeroMemory));
	}
};

template <typename T, Bool ALLOW_NONCONST> class DefaultValueZeroInitializedHelper<const T&, ALLOW_NONCONST>
{
public:
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueTypeHelper
{
public:
	static T Get()
	{
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueTypeHelper<T&, ALLOW_NONCONST>
{
public:
	static MAXON_ATTRIBUTE_FORCE_INLINE T& Get()
	{
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueTypeHelper<const T&, ALLOW_NONCONST>
{
public:
	static MAXON_ATTRIBUTE_FORCE_INLINE const T& Get()
	{
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueFunctionsHelper
{
public:
	static T Get()
	{
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueFunctionsHelper<T&, ALLOW_NONCONST>
{
public:
	static MAXON_ATTRIBUTE_FORCE_INLINE T& Get()
	{
...
template <typename T, Bool ALLOW_NONCONST> class DefaultValueFunctionsHelper<const T&, ALLOW_NONCONST>
{
public:
	static MAXON_ATTRIBUTE_FORCE_INLINE const T& Get()
	{
...
template <typename T, Bool ALLOW_NONCONST> MAXON_ATTRIBUTE_FORCE_INLINE T PrivateDefaultValueDispatcher(OverloadRank0)
{
	return DefaultValueFunctionsHelper<T, ALLOW_NONCONST>::Get();
}

template <typename T, Bool ALLOW_NONCONST> MAXON_ATTRIBUTE_FORCE_INLINE typename SFINAEHelper<T, typename DefaultValueFunctions<typename std::decay<T>::type>::Default>::type PrivateDefaultValueDispatcher(OverloadRank1)
{
	return DefaultValueTypeHelper<T, ALLOW_NONCONST>::Get();
}

template <typename T, Bool ALLOW_NONCONST> MAXON_ATTRIBUTE_FORCE_INLINE typename std::enable_if<IsZeroInitialized<typename std::decay<T>::type>::value || STD_IS_REPLACEMENT(same, typename std::decay<T>::type, Generic), T>::type PrivateDefaultValueDispatcher(OverloadRank2)
{
	return DefaultValueZeroInitializedHelper<T, ALLOW_NONCONST>::Get();
}
...
///  - If ALLOW_NONCONST is true, a non-const reference to write-protected memory will be returned,
///    so any write access to the returned reference will crash.
...
/// @tparam ALLOW_NONCONST				With the default value of false, a compilation error occurs for non-const reference types.
/// 															With true, a non-const reference to write-protected memory will be returned,
/// 															so any write access to the returned reference will crash.
///
...
//----------------------------------------------------------------------------------------
template <typename T, Bool ALLOW_NONCONST> MAXON_ATTRIBUTE_FORCE_INLINE T DefaultValue()
{
	return PrivateDefaultValueDispatcher<T, ALLOW_NONCONST>(OVERLOAD_MAX_RANK);
}

template <> MAXON_ATTRIBUTE_FORCE_INLINE void DefaultValue<void, false>()
{
}
...
template <typename T, Bool ALLOW_CONST> MAXON_ATTRIBUTE_FORCE_INLINE T PrivateDefaultReturnValue(NULL_RETURN_REASON reason, OverloadRank0)
{
	return DefaultValueFunctionsHelper<T, ALLOW_CONST>::Get();
}

template <typename T, Bool ALLOW_CONST> MAXON_ATTRIBUTE_FORCE_INLINE typename SFINAEHelper<T, typename DefaultValueFunctions<typename std::decay<T>::type>::Default>::type PrivateDefaultReturnValue(NULL_RETURN_REASON reason, OverloadRank1)
{
	return DefaultValueTypeHelper<T, ALLOW_CONST>::Get();
}

template <typename T, Bool ALLOW_CONST> MAXON_ATTRIBUTE_FORCE_INLINE typename SFINAEHelper<T, typename DefaultValueFunctions<typename std::decay<T>::type>::ResultMarker>::type PrivateDefaultReturnValue(NULL_RETURN_REASON reason, OverloadRank2)
{
	return T(PrivateGetNullReturnError((typename SFINAEHelper<NULL_RETURN_REASON, T>::type) reason));
}

template <typename T, Bool ALLOW_CONST> MAXON_ATTRIBUTE_FORCE_INLINE typename std::enable_if<STD_IS_REPLACEMENT(same, Id, typename std::decay<T>::type), T>::type PrivateDefaultReturnValue(NULL_RETURN_REASON reason, OverloadRank3)
{
	return DefaultValueTypeHelper<T, ALLOW_CONST>::Get();
}

template <typename T, Bool ALLOW_CONST> MAXON_ATTRIBUTE_FORCE_INLINE typename std::enable_if<IsZeroInitialized<typename std::decay<T>::type>::value || STD_IS_REPLACEMENT(same, typename std::decay<T>::type, Generic), T>::type PrivateDefaultReturnValue(NULL_RETURN_REASON reason, OverloadRank4)
{
	return DefaultValueZeroInitializedHelper<T, ALLOW_CONST>::Get();
}
...
{
	return DefaultValueFunctionsHelper<T, false>::Get();
}
...
{
	return DefaultValueTypeHelper<T, false>::IncompleteGet();
}
...
{
	return DefaultValueTypeHelper<T, false>::Get();
}
...
{
	return DefaultValueZeroInitializedHelper<T, false>::Get();
}
