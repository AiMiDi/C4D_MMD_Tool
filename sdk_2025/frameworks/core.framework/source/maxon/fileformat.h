...
} MAXON_ENUM_FLAGS(FILEFORMATDETECTIONFLAGS);
...
{
	MAXON_INTERFACE(FileFormatInterface, MAXON_REFERENCE_CONST, "net.maxon.interface.fileformat", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_DECLARATION(FileFormat, Browsable, "net.maxon.fileformat.browsable", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
	MAXON_DECLARATION(FileFormat, File, "net.maxon.fileformat.file", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
	MAXON_DECLARATION(FileFormat, MaxonDocumentBinary, "net.maxon.fileformat.maxondocumentbinary", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
	MAXON_DECLARATION(FileFormat, MaxonDocumentJson, "net.maxon.fileformat.maxondocumentjson", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
	MAXON_DECLARATION(FileFormat, MaxonDocumentXml, "net.maxon.fileformat.maxondocumentxml", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
}
...
MAXON_DECLARATION(Class<FileFormat>, FileFormatBaseClass, "net.maxon.class.fileformatbase", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
