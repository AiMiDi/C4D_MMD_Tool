...
{
	MAXON_INTERFACE(DataFormatReaderInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.dataformatreader", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE(DataFormatWriterInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.dataformatwriter", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
