...
// Target Detection, in case compiler settings are not properly adjusted
	...
	#include <TargetConditionals.h>
		...
		#endif
	#endif
	#if TARGET_OS_MAC && (TARGET_OS_IPHONE || TARGET_OS_SIMULATOR) && !defined(MAXON_TARGET_IOS)
	...
	#endif
	#if TARGET_OS_MAC && (TARGET_OS_SIMULATOR) && !defined(MAXON_TARGET_IOS_SIMULATOR)
...
#if defined(MAXON_TARGET_ABI_WIN_X64) || defined(MAXON_TARGET_ABI_SYSTEMV_AMD64) || defined(MAXON_TARGET_ABI_AARCH64) || defined(MAXON_TARGET_ABI_WIN_ARM64)
