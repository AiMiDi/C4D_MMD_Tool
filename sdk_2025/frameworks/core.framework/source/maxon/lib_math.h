...
//----------------------------------------------------------------------------------------
/// @see VectorToSquareMatrix. Same but will add a parallel check between the supplied vector
