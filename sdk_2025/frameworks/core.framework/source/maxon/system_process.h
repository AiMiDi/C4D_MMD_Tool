...
{
	MAXON_INTERFACE(SystemProcessKilledErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.systemprocesskillederror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(SystemProcessOperationErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.systemprocessoperationerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(SystemProcessObjectInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.systemprocessobject", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
public:
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<Bool> GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) const;
};
...
{
	MAXON_INTERFACE_NONVIRTUAL(SystemProcessInterface, MAXON_REFERENCE_STATIC, "net.maxon.interface.systemprocess", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
