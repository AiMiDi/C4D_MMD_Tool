...
{
	MAXON_INTERFACE(LoggerTypeInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.loggertype", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE(FileLoggerTypeInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.fileloggertype", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE(UserLoggerTypeInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.userloggertype", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
