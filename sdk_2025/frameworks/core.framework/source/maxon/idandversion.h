...
namespace ASSET_VERSIONS
{
	/// @brief Asset with LATEST version is using the latest major.minor available version.
	/// @see IdAndVersion
	/// Use Id type (not LiteralId) to match with IdAndVersion and also avoid Data type mismatches of asset versions.
	inline const Id LATESTID{"latest"};
}	// namespace ASSET_VERSIONS
