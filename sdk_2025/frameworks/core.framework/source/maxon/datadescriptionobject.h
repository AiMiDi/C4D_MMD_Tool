...
{
	MAXON_INTERFACE(DataDescriptionObjectInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.datadescriptionobject", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DECLARATION(Class<DataDescriptionObjectRef>, DataDescriptionObjectClass, "net.maxon.class.datadescriptionobject", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
