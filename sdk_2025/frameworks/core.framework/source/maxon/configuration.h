...
#define MAXON_CONFIGURATION_STRING(CONFIGVALUE, DEFVALUE, DEVCATEGORY, HELPTEXT) maxon::String CONFIGVALUE = (ConfigurationRegisterString(# CONFIGVALUE, CONFIGVALUE, DEFVALUE, DEVCATEGORY, HELPTEXT) ? maxon::String() : maxon::String())
	...
	#define MAXON_CONFIGURATION_BOOL_SUBSCRIBER(CONFIGVALUE) extern maxon::Bool CONFIGVALUE
	#define MAXON_CONFIGURATION_INT_SUBSCRIBER(CONFIGVALUE) extern maxon::Int CONFIGVALUE
	#define MAXON_CONFIGURATION_FLOAT_SUBSCRIBER(CONFIGVALUE) extern maxon::Float CONFIGVALUE
	#define MAXON_CONFIGURATION_STRING_SUBSCRIBER(CONFIGVALUE) extern maxon::String CONFIGVALUE
#else
	#define MAXON_CONFIGURATION_BOOL_SUBSCRIBER(CONFIGVALUE) maxon::Bool CONFIGVALUE = ConfigurationRegisterBool(# CONFIGVALUE, CONFIGVALUE, false, maxon::CONFIGURATION_CATEGORY::SUBSCRIBER, nullptr)
	#define MAXON_CONFIGURATION_INT_SUBSCRIBER(CONFIGVALUE) maxon::Int CONFIGVALUE = ConfigurationRegisterInt(# CONFIGVALUE, CONFIGVALUE, 0, 0, 1, maxon::CONFIGURATION_CATEGORY::SUBSCRIBER, nullptr)
	#define MAXON_CONFIGURATION_FLOAT_SUBSCRIBER(CONFIGVALUE) maxon::Float CONFIGVALUE = ConfigurationRegisterFloat(# CONFIGVALUE, CONFIGVALUE, 0.0, 0.1, 1.0, maxon::CONFIGURATION_CATEGORY::SUBSCRIBER, nullptr)
	#define MAXON_CONFIGURATION_STRING_SUBSCRIBER(CONFIGVALUE) maxon::String CONFIGVALUE = (ConfigurationRegisterString(# CONFIGVALUE, CONFIGVALUE, "", maxon::CONFIGURATION_CATEGORY::SUBSCRIBER, nullptr) ? maxon::String() : maxon::String());
#endif

MAXON_DATATYPE(ConfigInit, "net.maxon.datatype.configinit", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DEPENDENCY(configuration);

#include "configuration1.hxx"
#include "configuration2.hxx"
