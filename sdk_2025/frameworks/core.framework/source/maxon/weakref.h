...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Compute hash code based on the targeted object's pointer. WeakRefs pointing to the same target will have the same hash code.
	...
	//----------------------------------------------------------------------------------------
	/// Compute hash value based on the targeted object's pointer. WeakRefs pointing to the same target will have the same hash value.
