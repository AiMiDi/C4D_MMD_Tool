...
MAXON_DECLARATION(Class<IoHandler>, IoHandlerObjectBaseClass, "net.maxon.class.iohandlerobjectbase", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
MAXON_DECLARATION(Class<IoHandler>, IoHandlerObjectFileClass, "net.maxon.class.iohandlerobjectfile", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
