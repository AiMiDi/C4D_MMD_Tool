...
static EntityUse g_dependency_ObjectImpl{ObjectBaseClass.GetReference(), &g_translationUnit, "maxon/objectbase.h", false};
#endif
...
#define PRIVATE_MAXON_CLASS_REGISTER(C, TEMPLATE, REGISTRY, TYPE, ...) \
	...
	template <typename> extern maxon::ObjectDefinition private_class; \
	template <> maxon::ObjectDefinition private_class<C>{PRIVATE_MAXON_COMPONENT_ID(__VA_ARGS__), &C::PrivateConstructClass<TYPE>, (REGISTRY*) nullptr, &maxon::g_translationUnit, MAXON_FILE, maxon::EntityBase::FLAGS::NONE}; \
	TEMPLATE const maxon::Class<>& C::PrivateGetClass() \
	{ \
		const void* generic = private_class<C>.PrivateGet(); \
