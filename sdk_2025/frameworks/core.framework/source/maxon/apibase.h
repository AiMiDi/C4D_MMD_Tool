...
/// @endcond
	...
	#define PRIVATE_MAXON_TRANSLATIONUNIT_FLAGS_2 EntityBase::FLAGS::IGNORE_WARNINGS
#else
	#define PRIVATE_MAXON_TRANSLATIONUNIT_FLAGS_2 EntityBase::FLAGS::NONE
#endif
...
TranslationUnit g_translationUnit{&PRIVATE_MAXON_MODULE, __BASE_FILE__, PRIVATE_MAXON_TRANSLATIONUNIT_FLAGS | PRIVATE_MAXON_TRANSLATIONUNIT_FLAGS_2};
#else
...
TranslationUnit g_translationUnit{&PRIVATE_MAXON_MODULE, PRIVATE_MAXON_PLACEHOLDER_FILENAME, PRIVATE_MAXON_TRANSLATIONUNIT_FLAGS | PRIVATE_MAXON_TRANSLATIONUNIT_FLAGS_2};
#endif
