...
{
	MAXON_INTERFACE(IoDualInOutputStreamInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.iodualinoutputstream", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DECLARATION(Class<IoDualInOutputStreamRef>, InOutputStreamDualClass, "net.maxon.class.inoutputstreamdual", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
