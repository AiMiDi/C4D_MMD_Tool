...
class UrlInterface
{
	MAXON_INTERFACE_NONVIRTUAL(UrlInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.url", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
//----------------------------------------------------------------------------------------
/// @brief Scheme identifier for relative @ref maxon::Url "Urls" which can be resolved with @ref maxon::UrlInterface::IoNormalize "IoNormalize".
/// @see UrlScheme
//----------------------------------------------------------------------------------------
