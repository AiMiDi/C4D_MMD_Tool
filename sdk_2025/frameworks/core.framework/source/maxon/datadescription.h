...
{
	MAXON_INTERFACE_NONVIRTUAL(DataDescriptionInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.datadescription", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DATATYPE(LanguageStringDataDescription, "net.maxon.datatype.languagestringdatadescription", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
