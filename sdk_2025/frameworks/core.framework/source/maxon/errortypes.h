...
{
	MAXON_INTERFACE(UnsupportedArgumentErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.unsupportedargumenterror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(UnresolvedErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.unresolvederror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(UnknownErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.unknownerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(ShutdownErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.shutdownerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(DisabledErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.disablederror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
};
...
{
	MAXON_INTERFACE(ErrnoErrorInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.errnoerror", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
