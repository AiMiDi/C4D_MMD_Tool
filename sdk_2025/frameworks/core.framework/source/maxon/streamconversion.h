...
{
	MAXON_INTERFACE(StreamConversionInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.streamconversion", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
template <typename SRCTYPE, typename DSTTYPE> MAXON_ATTRIBUTE_FORCE_INLINE Result<void> AddConversionTestSettingT(MAXON_SOURCE_LOCATION_DECLARATION, BaseArray<DataDictionary>& resultArray,
								const Block<const ConversionTestSet>& set, const Block<const SRCTYPE>& srcData, const Block<const DSTTYPE>& compareData, Bool forbidLargeTest = false)
{
	DataDictionary res;
...
template <typename SLOC> Result<void> AddConversionTestSetting(const SLOC& allocLocation, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Char>& srcData, const Block<const Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(allocLocation, resultArray, set, srcData, compareData, forbidLargeTest);
}

template <typename SLOC> Result<void> AddConversionTestSetting(const SLOC& allocLocation, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Utf32Char>& srcData, const Block<const Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(allocLocation, resultArray, set, srcData, compareData, forbidLargeTest);
}

template <typename SLOC> Result<void> AddConversionTestSetting(const SLOC& allocLocation, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Char>& srcData, const Block<const Utf32Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(allocLocation, resultArray, set, srcData, compareData, forbidLargeTest);
}

template <typename SLOC> Result<void> AddConversionTestSetting(const SLOC& allocLocation, BaseArray<DataDictionary>& resultArray, const Block<const ConversionTestSet>& set, const Block<const Utf32Char>& srcData, const Block<const Utf32Char>& compareData, Bool forbidLargeTest = false)
{
	return AddConversionTestSettingT(allocLocation, resultArray, set, srcData, compareData, forbidLargeTest);
}
