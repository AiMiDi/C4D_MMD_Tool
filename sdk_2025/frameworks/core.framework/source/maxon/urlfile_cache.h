...
{
	MAXON_INTERFACE_NONVIRTUAL(UrlFileCacheEntryInterface, MAXON_REFERENCE_CONST, "net.maxon.interface.urlfilecacheentry", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE_NONVIRTUAL(UrlFileCacheInterface, MAXON_REFERENCE_STATIC, "net.maxon.interface.urlfilecache", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
