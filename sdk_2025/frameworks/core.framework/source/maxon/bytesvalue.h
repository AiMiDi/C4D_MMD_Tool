...
public:
	...
	{
		return (Float32)_value * Float32(0.001);
	}
	...
	{
		return (Float32)_value / Float32(1024);
	}
	...
	{
		return Float32(_value) * Float32(0.001) * Float32(0.001);
	}
	...
	{
		return (Float32)_value / Float32(1024) / Float32(1024);
	}
	...
	{
		return (Float32)_value * Float32(0.001) * Float32(0.001) * Float32(0.001);
	}
	...
	{
		return (Float32)_value / Float32(1024) / Float32(1024) / Float32(1024);
	}
	...
	{
		return (Float32)_value * Float32(0.001) * Float32(0.001) * Float32(0.001) * Float32(0.001);
	}
	...
	{
		return (Float32)_value / Float32(1024) / Float32(1024) / Float32(1024) / Float32(1024);
	}
...
MAXON_DATATYPE(BytesValue, "net.maxon.datatype.bytesvalue", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));

#include "bytesvalue1.hxx"
#include "bytesvalue2.hxx"
