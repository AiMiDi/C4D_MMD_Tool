...
{
	MAXON_INTERFACE(MachineInterface, MAXON_REFERENCE_NORMAL, "net.maxon.interface.machine", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
{
	MAXON_INTERFACE_NONVIRTUAL(MachinesInterface, MAXON_REFERENCE_STATIC, "net.maxon.interface.machines", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
// message ids for ObservableMachineStateChanged
...
MAXON_DECLARATION(Class<MachineRef>, LocalMachineClass, "net.maxon.class.localmachine", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
...
MAXON_DATATYPE(CreateObjectRefFunc, "net.maxon.datatype.createobjectreffunc", MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"));
