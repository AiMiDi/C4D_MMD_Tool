...
template <typename D, TranslationUnit& UNIT, UInt64 UNIT_HASH, Bool WEAK, typename CHECK = void> class DeclarationUse : public EntityUse
{
public:
...
template <typename D, TranslationUnit& UNIT, UInt64 UNIT_HASH, Bool WEAK>
class DeclarationUse<D, UNIT, UNIT_HASH, WEAK, typename std::enable_if<maxon::CStringCompare::GetHashCode(D::PrivateImplementationModule) != details::ModuleIdHash>::type>
{
public:
	const typename D::Type& DefaultValueImpl() const
	{
	...
	static MAXON_ATTRIBUTE_FORCE_INLINE const typename D::Type& DefaultValue()
	{
		return reinterpret_cast<const DeclarationUse&>(g_PrivateDependencyOnModule<UNIT, UNIT_HASH, WEAK, typename PrivateFixedSizeArrayBuilder<D, std::make_index_sequence<SIZEOF(D::PrivateImplementationModule)>>::type>).DefaultValueImpl();
	}
};


template <typename D, TranslationUnit& UNIT, UInt64 UNIT_HASH, Bool WEAK, typename CHECK> DeclarationUse<D, UNIT, UNIT_HASH, WEAK, CHECK> DeclarationUse<D, UNIT, UNIT_HASH, WEAK, CHECK>::_instance;
...
public:
	...
	template <TranslationUnit& UNIT = g_translationUnit, UInt64 UNIT_HASH = g_translationUnitHash> const T& operator ()() const
	{
		...
		{
			return Initialize(std::conditional<C::DEPENDENCIES_ENABLED, DeclarationUse<C, UNIT, UNIT_HASH, false>, Declaration>::type::DefaultValue());
		}
	}
	...
	template <TranslationUnit& UNIT = g_translationUnit, UInt64 UNIT_HASH = g_translationUnitHash> Result<const T&> WeakGet() const
	{
		...
		else
		{
			...
			DebugStop();
			return DeclarationUse<C, UNIT, UNIT_HASH, true>::DefaultValue();
		}
	}
...
public:
	...
	template <TranslationUnit& UNIT = g_translationUnit, UInt64 UNIT_HASH = g_translationUnitHash> MAXON_ATTRIBUTE_FORCE_INLINE const T& operator ()() const
	{
		return GetInstance().template operator ()<UNIT, UNIT_HASH>();
	}
	...
	template <TranslationUnit& UNIT = g_translationUnit, UInt64 UNIT_HASH = g_translationUnitHash> MAXON_ATTRIBUTE_FORCE_INLINE Result<const T&> WeakGet() const
	{
		return GetInstance().template WeakGet<UNIT, UNIT_HASH>();
	}
...
#define PRIVATE_MAXON_INITIALIZATION_C(ID) \
	...
	{ \
		...
		{ \
			MAXON_CONCAT(PrivateInitialization_, ID)(maxon::Result<void> (*init) (), void (*free) ()) : maxon::details::InitializationFunctions(MAXON_FILE, init, free, &maxon::g_translationUnit) { } \
		}; \
	} \
...
#define PRIVATE_MAXON_DECLARATION_REGISTER_1(cnt, Name) \
	...
	static maxon::ObjectDefinition g_obj##cnt(decltype(Name)::GetId(), &Private_InitObj##cnt, (decltype(Name)::Registry*) nullptr, &maxon::g_translationUnit, MAXON_FILE, maxon::EntityBase::FLAGS::NONE); \
...
#define PRIVATE_MAXON_DECLARATION_REGISTER_2(cnt, REGISTRY, Name) \
	...
	static maxon::ObjectDefinition g_obj##cnt(maxon::ObjectDefinition::MakeId(Name), &Private_InitObj##cnt, (REGISTRY::Registry*) nullptr, &maxon::g_translationUnit, MAXON_FILE, maxon::EntityBase::FLAGS::HIDDEN); \
...
#define PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(Name, prefix, id) \
	maxon::details::TranslationUnitAndModule prefix Name##_PrivateHelper::GetTranslationUnitAndModule() { return {&maxon::g_translationUnit, &PRIVATE_MAXON_MODULE}; }
...
#define MAXON_DEPENDENCY_REGISTER(Name) \
	maxon::EntityDefinition g_dependency_##Name(maxon::EntityBase::TYPE::DEPENDENCY, maxon::LiteralId(#Name), &maxon::g_translationUnit, MAXON_FILE, maxon::EntityBase::FLAGS::HIDDEN);
#endif
...
#define MAXON_DEPENDENCY(Name) \
	...
	static maxon::EntityUse s_ud_##Name("." #Name, &maxon::g_translationUnit, &g_dependency_##Name, false);
...
#define MAXON_DEPENDENCY_ON_REFLECTION \
	static maxon::EntityUse s_dep_reflection(".reflection", &maxon::g_translationUnit, &maxon::g_privateReflectionRegistrationDependency<>, false)
