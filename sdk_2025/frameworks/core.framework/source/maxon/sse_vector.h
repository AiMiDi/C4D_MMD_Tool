...
#include "maxon/sse_matrix_4f64_sse.h"
#include "maxon/sse_matrix_4f64.h"
...
//----------------------------------------------------------------------------------------
/// Converts one Vector4f64 to two Vector2f64.
/// @param[in] a									Input vector.
/// @param[out] result1						The two upper values of the input vector.
/// @param[out] result2						The two lower values of the input vector.
//----------------------------------------------------------------------------------------
MAXON_ATTRIBUTE_FORCE_INLINE void ConvertToVectors2f64(const Vector4f64& a, Vector2f64& result1, Vector2f64& result2)
{
	result1._val = _mm256_extractf128_pd(a.Get(), 0);
	result2._val = _mm256_extractf128_pd(a.Get(), 1);
}
...
//----------------------------------------------------------------------------------------
/// Converts one Vector4f32 to a Vector4f64 vector.
/// @return												A Vector4f64 vector.
//----------------------------------------------------------------------------------------
MAXON_ATTRIBUTE_FORCE_INLINE Vector4f64 ConvertToVector4f64(const Vector4f32& a)
{
	return Vector4f64(_mm256_cvtps_pd(a.Get()));
}

//----------------------------------------------------------------------------------------
/// Converts two Vector2f64 to a Vector4f64 vector.
/// @return												A Vector4f64 vector.
//----------------------------------------------------------------------------------------
MAXON_ATTRIBUTE_FORCE_INLINE Vector4f64 ConvertToVector4f64(const Vector2f64& a, const Vector2f64& b)
{
	return Vector4f64(_mm256_set_m128d(b.Get(), a.Get()));
}
