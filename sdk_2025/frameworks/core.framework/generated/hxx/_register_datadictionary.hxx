...
namespace maxon
{
	...
	public:
		...
		Result<void> SetData(ForwardingDataPtr&& key, const Data& data) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((DataDictionaryInterface*) this)->SetData(std::forward<ForwardingDataPtr>(key), data); return HXXRET1(UNRESOLVED);}
		Result<void> SetData(ForwardingDataPtr&& key, Data&& data) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((DataDictionaryInterface*) this)->SetData(std::forward<ForwardingDataPtr>(key), std::forward<Data>(data)); return HXXRET1(UNRESOLVED);}
		Result<void> SetData(ForwardingDataPtr&& key, ForwardingDataPtr&& data) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((DataDictionaryInterface*) this)->SetData(std::forward<ForwardingDataPtr>(key), std::forward<ForwardingDataPtr>(data)); return HXXRET1(UNRESOLVED);}
		Result<Data> GetData(const ConstDataPtr& key) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const DataDictionaryInterface*) this)->GetData(key); return HXXRET1(UNRESOLVED);}
		Result<void> EraseData(const ConstDataPtr& key) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((DataDictionaryInterface*) this)->EraseData(key); return HXXRET1(UNRESOLVED);}
		...
		String ToString(const FormatStatement* formatStatement) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const DataDictionaryInterface*) this)->ToString(formatStatement); return HXXRET3(UNRESOLVED, String);}
		static Result<void> DescribeIO(const DataSerializeInterface& stream) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return DataDictionaryInterface::DescribeIO(stream); return HXXRET1(UNRESOLVED);}
		...
		HashInt GetHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const DataDictionaryInterface*) this)->GetHashCode(); return HXXRET3(UNRESOLVED, HashInt);}
		UniqueHash GetUniqueHashCode() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const DataDictionaryInterface*) this)->GetUniqueHashCode(); return HXXRET3(UNRESOLVED, UniqueHash);}
	...
	const maxon::UNRESOLVED_RETURN_TYPE DataDictionaryInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<DataDictionaryInterface*>::value,
		maxon::details::UnresolvedReturnType<DataDictionaryInterface*>::value,
		...
		maxon::details::UnresolvedReturnType<void>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const Data*>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
	...
	maxon::Bool DataDictionaryInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_SetData = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_SetData), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_SetData_1 = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_SetData_1), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData_1);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_SetData_2 = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_SetData_2), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_SetData_2);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Data>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_GetData = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_GetData), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_EraseData = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_EraseData), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_EraseData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<String>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_ToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_DescribeIO = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_DescribeIO), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_DescribeIO);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<HashInt>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_GetHashCode = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_GetHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<UniqueHash>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DataDictionaryInterface_GetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(DataDictionaryInterface_GetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::DataDictionaryInterface_GetUniqueHashCode);
		#else
	...
	MAXON_INTERFACE_REGISTER(DataDictionaryInterface, "net.maxon.interface.datadictionary", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int DataDictionaryInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_datadictionary(0
	| maxon::DataDictionaryInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
