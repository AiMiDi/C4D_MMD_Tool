...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnsupportedArgumentErrorInterface, maxon::StrongCOWRefHandler, UnsupportedArgumentError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnsupportedArgumentErrorInterface, maxon::StrongCOWRefHandler, UnsupportedArgumentError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnsupportedArgumentErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnsupportedArgumentErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] UnsupportedArgumentError : public UnsupportedArgumentErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(UnsupportedArgumentError, UnsupportedArgumentErrorObject, "net.maxon.error.unsupportedargument",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnresolvedErrorInterface, maxon::StrongCOWRefHandler, UnresolvedError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnresolvedErrorInterface, maxon::StrongCOWRefHandler, UnresolvedError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnresolvedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnresolvedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] UnresolvedError : public UnresolvedErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(UnresolvedError, UnresolvedErrorObject, "net.maxon.error.unresolved",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class UnknownError;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnknownErrorInterface, maxon::StrongCOWRefHandler, UnknownError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnknownErrorInterface, maxon::StrongCOWRefHandler, UnknownError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnknownErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnknownErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] UnknownError : public UnknownErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(UnknownError, UnknownErrorObject, "net.maxon.error.unknown",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnsupportedOperationErrorInterface, maxon::StrongCOWRefHandler, UnsupportedOperationError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnsupportedOperationErrorInterface, maxon::StrongCOWRefHandler, UnsupportedOperationError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnsupportedOperationErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnsupportedOperationErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] UnsupportedOperationError : public UnsupportedOperationErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(UnsupportedOperationError, UnsupportedOperationErrorObject, "net.maxon.error.unsupportedoperation",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class ShutdownError;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ShutdownErrorInterface, maxon::StrongCOWRefHandler, ShutdownError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ShutdownErrorInterface, maxon::StrongCOWRefHandler, ShutdownError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ShutdownErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ShutdownErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] ShutdownError : public ShutdownErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(ShutdownError, ShutdownErrorObject, "net.maxon.error.shutdown",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class DisabledError;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DisabledErrorInterface, maxon::StrongCOWRefHandler, DisabledError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DisabledErrorInterface, maxon::StrongCOWRefHandler, DisabledError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DisabledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DisabledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] DisabledError : public DisabledErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(DisabledError, DisabledErrorObject, "net.maxon.error.disabled",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class ErrnoError;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ErrnoErrorInterface, maxon::StrongCOWRefHandler, ErrnoError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ErrnoErrorInterface, maxon::StrongCOWRefHandler, ErrnoError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ErrnoErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ErrnoErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] ErrnoError : public ErrnoErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(ErrnoError, ErrnoErrorObject, "net.maxon.error.errno",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
#endif
