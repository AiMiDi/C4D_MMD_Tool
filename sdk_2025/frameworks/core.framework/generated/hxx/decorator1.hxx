...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DecoratorInterface, maxon::StrongRefHandler, DecoratorRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DecoratorInterface, maxon::StrongRefHandler, DecoratorRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<EagerDecoratorInterface, maxon::StrongRefHandler, EagerDecoratorRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<EagerDecoratorInterface, maxon::StrongRefHandler, EagerDecoratorRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<WeakDecoratorInterface, maxon::StrongRefHandler, WeakDecoratorRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<WeakDecoratorInterface, maxon::StrongRefHandler, WeakDecoratorRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
