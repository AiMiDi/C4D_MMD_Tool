...
struct SystemProcessObjectInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(SystemProcessObjectInterface_ObservableProcessFinished, ObservableProcessFinished, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableProcessFinishedDelegate>), maxon::Bool create);
	maxon::Int SystemProcessObjectInterface_ObservableProcessFinished_Offset;
	PRIVATE_MAXON_MF_POINTER(SystemProcessObjectInterface_GetLoadedDlls, GetLoadedDlls, true, maxon::GenericComponent, const, (Result<Bool>), const ValueReceiver<const DllRef&>& dlls);
...
struct SystemProcessObjectInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(SystemProcessObjectInterface_ObservableProcessFinished, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableProcessFinishedDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableProcessFinished(create); }
		PRIVATE_MAXON_MF_WRAPPER(SystemProcessObjectInterface_GetLoadedDlls, maxon::GenericComponent, const, (Result<Bool>), const ValueReceiver<const DllRef&>& dlls) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->GetLoadedDlls(dlls); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto SystemProcessObjectInterface::ObservableProcessFinished(maxon::Bool create) const -> maxon::ObservableRef<ObservableProcessFinishedDelegate>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto SystemProcessObjectInterface::GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) const -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SystemProcessObjectInterface::Hxx1::ConstFn<S>::ObservableProcessFinished(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableProcessFinishedDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SystemProcessObjectInterface::Hxx1::ConstFn<S>::GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) const -> Result<Bool>
{
	HXXRETURN0(Result<Bool>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(SystemProcessObjectInterface_GetLoadedDlls); 
