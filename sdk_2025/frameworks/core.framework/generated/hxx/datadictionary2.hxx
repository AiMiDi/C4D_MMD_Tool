...
{
	HXXRETURN0(HXXADDRET2(typename std::conditional<std::is_void<T>::value, typename IsFidClass<KEY>::type, T>::type)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<typename std::conditional<std::is_void<T>::value, typename IsFidClass<KEY>::type, T>::type, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
