...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_UrlInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(UrlInterface::MTable::_instance.UrlInterface_SetPath)>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "path\0convertWindowsBackslashes\0", 5LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(UrlInterface::MTable::_instance.UrlInterface_GetUrlEncoded)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(UrlInterface::MTable::_instance.UrlInterface_ConvertToUiName)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "flags\0lookupRepository\0", 5LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(UrlInterface::MTable::_instance.UrlInterface_ConvertFromUiName)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "str\0lookupRepository\0", 5LL, nullptr),
		};
