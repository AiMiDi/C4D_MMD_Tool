...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ModuleVersionInfoInterface);
	static maxon::InterfaceDefinition s_ModuleVersionInfoInterface(ModuleVersionInfoInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION,"maxon::ModuleVersionInfo");
#endif
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ModuleVersionInfoInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, &maxon::g_translationUnit, ::MaxonRegistry, maxon::LiteralId());
#endif
	...
	static maxon::Result<void> RegisterReflection_ModuleVersionInfoInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<decltype(ModuleVersionInfoInterface::Hxx2::StaticMTable::_instance.ModuleVersionInfoInterface_RegisterIntern)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "uniqueId\0moduleInfo\0info\0", 21LL, nullptr),
		};
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_REGISTRY_DEFINE(ReplaceModule);
#endif
}
#endif
