...
{
	HXXRETURN0(HXXADDRET2(const Id&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const Id&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(KIND)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<KIND, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(Block<const ComponentInfo* const>)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<Block<const ComponentInfo* const>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(const Block<const InterfaceReference* const>&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const Block<const InterfaceReference* const>&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(const DataDictionary&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const DataDictionary&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(const maxon::Class<typename S::PrivateErasedReferencedType::Hxx1::ReferenceClass>&)); HXXSUPER("ObjectInterface::GetClass"); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const maxon::Class<typename S::PrivateErasedReferencedType::Hxx1::ReferenceClass>&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
struct ErrorInterface::MTable
{
	...
	PRIVATE_MAXON_IMPLEMENTS_CHECK(GetMessageDelegate);
	...
	PRIVATE_MAXON_MF_POINTER(ErrorInterface_SetMessageDelegate, SetMessageDelegate, true, maxon::GenericComponent,, (void), MessageDelegate&& message);
	maxon::Int ErrorInterface_SetMessageDelegate_Offset;
	PRIVATE_MAXON_MF_POINTER(ErrorInterface_GetMessageDelegate, GetMessageDelegate, true, maxon::GenericComponent, const, (const MessageDelegate&));
	maxon::Int ErrorInterface_GetMessageDelegate_Offset;
	...
	if constexpr (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, ErrorInterface, GetMessageDelegate))
	{
		maxon::Tie(ErrorInterface_GetMessageDelegate, ErrorInterface_GetMessageDelegate_Offset) = ErrorInterface_GetMessageDelegate_GetPtr<W>(offset, true);
	}
...
struct ErrorInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_IMPLEMENTS_HELPER_MEMBER(GetMessageDelegate);
		...
		PRIVATE_MAXON_MF_WRAPPER(ErrorInterface_SetMessageDelegate, maxon::GenericComponent,, (void), MessageDelegate&& message) { return ((typename S::Implementation*) PRIVATE_MAXON_MF_THIS(maxon::GenericComponent))->SetMessageDelegate(std::forward<MessageDelegate>(message)); }
		PRIVATE_MAXON_MF_WRAPPER(ErrorInterface_GetMessageDelegate, maxon::GenericComponent, const, (const MessageDelegate&)) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->GetMessageDelegate(); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ErrorInterface::SetMessageDelegate(MessageDelegate&& message) -> void
{
	const ErrorInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(ErrorInterface, this); return PRIVATE_MAXON_MF_INVOKE(((maxon::GenericComponent*) this + mt_.ErrorInterface_SetMessageDelegate_Offset), mt_.ErrorInterface_SetMessageDelegate, std::forward<MessageDelegate>(message));
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ErrorInterface::GetMessageDelegate() const -> const MessageDelegate&
{
	const ErrorInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(ErrorInterface, this); return PRIVATE_MAXON_MF_INVOKE(((const maxon::GenericComponent*) this + mt_.ErrorInterface_GetMessageDelegate_Offset), mt_.ErrorInterface_GetMessageDelegate);
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ErrorInterface::Hxx1::Fn<S>::SetMessageDelegate(MessageDelegate&& message) const -> DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S)
{
	...
	PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ErrorInterface_SetMessageDelegate_Offset), mt_.ErrorInterface_SetMessageDelegate, std::forward<MessageDelegate>(message));
	return this->PrivateGetRefMember();
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ErrorInterface::Hxx1::COWFn<S>::SetMessageDelegate(MessageDelegate&& message) -> DOXYGEN_SWITCH(maxon::RefMemberType<S>, S)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ErrorInterface::Hxx1::ConstFn<S>::GetMessageDelegate() const -> HXXADDRET2(const MessageDelegate&)
{
	HXXRETURN0(HXXADDRET2(const MessageDelegate&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const MessageDelegate&)) HXXTABLE(ErrorInterface_GetMessageDelegate); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.ErrorInterface_GetMessageDelegate_Offset), mt_.ErrorInterface_GetMessageDelegate));
}
