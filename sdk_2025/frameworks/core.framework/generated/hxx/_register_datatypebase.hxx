...
namespace maxon
{
	...
	namespace enum599
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum599::FLAGS::NONE), maxon::UInt64(enum599::FLAGS::GLOBALLY_REFERENCED), maxon::UInt64(enum599::FLAGS::OWNS_DEFAULT_VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_FLAGS599(void*){ return enum599::FLAGS_info; }
	...
	namespace enum1102
	{
		...
		static const maxon::UInt64 BASE_OF_MODE_values[] = {maxon::UInt64(enum1102::BASE_OF_MODE::NONE), maxon::UInt64(enum1102::BASE_OF_MODE::ORDERED_TYPE_ONLY), maxon::UInt64(enum1102::BASE_OF_MODE::UNORDERED_BY_NAME), maxon::UInt64(enum1102::BASE_OF_MODE::GENERIC_DOWNCAST)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_BASE_OF_MODE1102(void*){ return enum1102::BASE_OF_MODE_info; }
	...
	namespace enum1209
	{
		...
		static const maxon::UInt64 GET_DATATYPE_POLICY_values[] = {maxon::UInt64(enum1209::GET_DATATYPE_POLICY::NONE), maxon::UInt64(enum1209::GET_DATATYPE_POLICY::GENERIC_FOR_UNKNOWN), maxon::UInt64(enum1209::GET_DATATYPE_POLICY::ERROR_FOR_UNKNOWN), maxon::UInt64(enum1209::GET_DATATYPE_POLICY::RESULT_FOR_UNKNOWN_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GET_DATATYPE_POLICY1209(){ return enum1209::GET_DATATYPE_POLICY_info; }
}
#endif
