...
{
	HXXRETURN0(HXXADDRET2(const ContainerDataType<>&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const ContainerDataType<>&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(INTERFACES)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<INTERFACES, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
