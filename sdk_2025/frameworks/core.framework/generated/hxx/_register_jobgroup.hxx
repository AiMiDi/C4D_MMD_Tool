...
/// @endcond
	...
	namespace enum635
	{
		...
		static const maxon::UInt64 STATICJOBGROUPFLAGS_values[] = {maxon::UInt64(enum635::STATICJOBGROUPFLAGS::DEFAULT), maxon::UInt64(enum635::STATICJOBGROUPFLAGS::WILL_RUN_FINALIZER), maxon::UInt64(enum635::STATICJOBGROUPFLAGS::ENQUEUEING_THREAD_WAITS), maxon::UInt64(enum635::STATICJOBGROUPFLAGS::THREAD_AFFINITY), maxon::UInt64(enum635::STATICJOBGROUPFLAGS::NO_JOB_DESTRUCTOR)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_STATICJOBGROUPFLAGS635(){ return enum635::STATICJOBGROUPFLAGS_info; }
	namespace enum885
	{
		...
		static const maxon::UInt64 STATICJOBARRAYFLAGS_values[] = {maxon::UInt64(enum885::STATICJOBARRAYFLAGS::DEFAULT), maxon::UInt64(enum885::STATICJOBARRAYFLAGS::INITIALIZE_LATER)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_STATICJOBARRAYFLAGS885(){ return enum885::STATICJOBARRAYFLAGS_info; }
/// @cond IGNORE
