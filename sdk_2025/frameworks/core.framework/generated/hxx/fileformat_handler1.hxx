...
struct FileFormatHandlerInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = FileFormatHandlerInterface;
...
/// This function should not be called except from FileFormatDetectionInterface::DetectAll().
		inline HXXADDRET2(FILEFORMAT_PRIORITY) GetDependends() const;
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const FileFormatHandlerInterface, maxon::StrongRefHandler, FileFormatHandler>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const FileFormatHandlerInterface, maxon::StrongRefHandler, FileFormatHandler>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileFormatHandlerInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileFormatHandlerInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
