...
namespace maxon
{
	const maxon::Char* const LoggerTypeInterface::MTable::_ids = 
		...
		"ObservableLoggerNotify@8b2c1a071190b99\0" // maxon::ObservableRef<ObservableLoggerNotifyDelegate> ObservableLoggerNotify(maxon::Bool create) const
	"";
	...
	const maxon::Char* const LoggerInterface::MTable::_ids = 
		...
		"ObservableLoggerNew@417084d4426207ef\0" // maxon::ObservableRef<ObservableLoggerNewDelegate> ObservableLoggerNew(maxon::Bool create)
	...
	public:
		...
		static maxon::ObservableRef<ObservableLoggerNewDelegate> ObservableLoggerNew(maxon::Bool create) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return LoggerInterface::ObservableLoggerNew(create); return maxon::ObservableRef<ObservableLoggerNewDelegate>::DefaultValue();}
