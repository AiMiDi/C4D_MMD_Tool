...
struct ValueChangedCallbackInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ValueChangedCallbackInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(ValueChangedCallbackInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = ValueChangedCallbackInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(ValueChangedCallbackInterface**);
...
#ifdef DOXYGEN
public FnDoxy<ValueChangedCallbackRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ValueChangedCallbackInterface, maxon::StrongRefHandler, ValueChangedCallbackRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ValueChangedCallbackInterface, maxon::StrongRefHandler, ValueChangedCallbackRef>>>>);
