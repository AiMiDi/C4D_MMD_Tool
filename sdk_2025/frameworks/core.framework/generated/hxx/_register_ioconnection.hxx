...
namespace maxon
{
	...
	public:
		...
		static Result<Url> RemoveDotSegments(const Url& url) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ResolveInterface::RemoveDotSegments(url); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE ResolveInterface::MTable::_returnTypes[] = 
	{
	...
	maxon::Bool ResolveInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Url>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ResolveInterface_RemoveDotSegments = PRIVATE_MAXON_MF_CAST(decltype(ResolveInterface_RemoveDotSegments), &Hxx2::Wrapper<Hxx2::Unresolved>::ResolveInterface_RemoveDotSegments);
		#else
	...
	MAXON_INTERFACE_REGISTER(ResolveInterface, "net.maxon.interface.resolve", nullptr, maxon::EntityBase::FLAGS::NONE);
	MAXON_WARNING_PUSH
	MAXON_WARNING_DISABLE_DEPRECATED
	class IoConnectionInterface::Hxx2::Unresolved : public IoConnectionInterface
	{
	public:
		static maxon::ObservableRef<ObservableErrorOpenFileDelegate> ObservableErrorOpenFile(maxon::Bool create) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, true)) return IoConnectionInterface::ObservableErrorOpenFile(create); return maxon::ObservableRef<ObservableErrorOpenFileDelegate>::DefaultValue();}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE IoConnectionInterface::Hxx2::StaticMTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<maxon::ObservableRef<ObservableErrorOpenFileDelegate>>::value,
		maxon::UNRESOLVED_RETURN_TYPE::OTHER
	};
#endif
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(IoConnectionInterface, , "net.maxon.interface.ioconnection", (DataDictionaryObjectInterface::PrivateGetInterface()));
	const maxon::Char* const IoConnectionInterface::Hxx2::StaticMTable::_ids = 
		"ObservableErrorOpenFile@faff45bac86155e9\0" // maxon::ObservableRef<ObservableErrorOpenFileDelegate> ObservableErrorOpenFile(maxon::Bool create)
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_STATIC(IoConnectionInterface, , "net.maxon.interface.ioconnection");
	template <typename DUMMY> maxon::Int IoConnectionInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
static maxon::details::ForceEvaluation s_forceEval_ioconnection(0
	| maxon::IoConnectionInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
