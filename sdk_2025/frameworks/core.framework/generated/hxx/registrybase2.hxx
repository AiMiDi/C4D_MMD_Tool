...
struct RegistryEntryIteratorInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(RegistryEntryIteratorInterface_GetEntry, GetEntry, false, RegistryEntryIteratorInterface, const, (const Generic*), const DataType& type);
	PRIVATE_MAXON_MF_POINTER(RegistryEntryIteratorInterface_GetEntry_1, GetEntry, false, RegistryEntryIteratorInterface, const, (ConstDataPtr));
	template <typename IMPL> void Init()
	{
		...
		RegistryEntryIteratorInterface_GetEntry_1 = RegistryEntryIteratorInterface_GetEntry_1_GetPtr<IMPL>(0, true).first;
	}
};
...
struct RegistryEntryIteratorInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(RegistryEntryIteratorInterface_GetEntry, RegistryEntryIteratorInterface, const, (const Generic*), const DataType& type) { return S::Get(PRIVATE_MAXON_MF_THIS(const RegistryEntryIteratorInterface))->GetEntry(type); }
		PRIVATE_MAXON_MF_WRAPPER(RegistryEntryIteratorInterface_GetEntry_1, RegistryEntryIteratorInterface, const, (ConstDataPtr)) { return S::Get(PRIVATE_MAXON_MF_THIS(const RegistryEntryIteratorInterface))->GetEntry(); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto RegistryEntryIteratorInterface::GetEntry(const DataType& type) const -> const Generic*
{
	return PRIVATE_MAXON_MF_INVOKE((this), MTable::_instance.RegistryEntryIteratorInterface_GetEntry, type);
}
[[deprecated]] MAXON_ATTRIBUTE_FORCE_INLINE auto RegistryEntryIteratorInterface::GetEntry() const -> ConstDataPtr
{
	return PRIVATE_MAXON_MF_INVOKE((this), MTable::_instance.RegistryEntryIteratorInterface_GetEntry_1);
}
...
struct RegistryInterface::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(RegistryInterface_FindEntryValue, FindEntryValue, MAXON_EXPAND_VA_ARGS, (const Generic*), const RegistryInterface* registry, const Id& eid, const DataType& type);
	PRIVATE_MAXON_SF_POINTER(RegistryInterface_FindEntryValue_1, FindEntryValue, MAXON_EXPAND_VA_ARGS, (ConstDataPtr), const RegistryInterface* registry, const Id& eid);
	...
	template <typename IMPL> void Init()
	{
		...
		RegistryInterface_FindEntryValue_1 = RegistryInterface_FindEntryValue_1_GetPtr<IMPL>(true);
...
struct RegistryInterface::Hxx2
{
	...
	public:
		...
		static const Generic* RegistryInterface_FindEntryValue(const RegistryInterface* registry, const Id& eid, const DataType& type) { return S::FindEntryValue(registry, eid, type); }
		static ConstDataPtr RegistryInterface_FindEntryValue_1(const RegistryInterface* registry, const Id& eid) { return S::FindEntryValue(registry, eid); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto RegistryInterface::FindEntryValue(const RegistryInterface* registry, const Id& eid, const DataType& type) -> const Generic*
{
	return MTable::_instance.RegistryInterface_FindEntryValue(registry, eid, type);
}
[[deprecated]] MAXON_ATTRIBUTE_FORCE_INLINE auto RegistryInterface::FindEntryValue(const RegistryInterface* registry, const Id& eid) -> ConstDataPtr
{
	return MTable::_instance.RegistryInterface_FindEntryValue_1(registry, eid);
}
