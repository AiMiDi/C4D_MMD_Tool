...
struct GenericContainerInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = GenericContainerInterface;
		...
		using ITERATOR_ACCESS = GenericContainerInterface::ITERATOR_ACCESS;
		...
		inline HXXADDRET2(const ContainerDataType<>&) GetContainerType() const;
...
/// @return												INTERFACES flags for this container.
		inline HXXADDRET2(INTERFACES) GetInterfaces() const;
		inline HXXADDRET2(String) ToString(const FormatStatement* formatStatement = nullptr) const;
		inline HXXADDRET2(Bool) IsEqual(const GenericContainerInterface* other, EQUALITY equality) const;
...
/// @return												Index of the member, or -1 if it doesn't exist.
		inline HXXADDRET2(Int) FindMemberIndex(const InternedId& name) const;
		inline HXXADDRET2(Int) FindMemberIndex(const Member& member) const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const typename T_::template Apply<ContainerInterface>, maxon::StrongCOWRefHandler, typename T_::template Apply<Container>>>, T_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const typename T_::template Apply<ContainerInterface>, maxon::StrongCOWRefHandler, typename T_::template Apply<Container>>>, T_>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<typename T_::template Apply<ContainerInterface>, maxon::StrongRefHandler, NonConstRef<T_>>>, T_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<typename T_::template Apply<ContainerInterface>, maxon::StrongRefHandler, NonConstRef<T_>>>, T_>>);
};
...
struct GenericIndexableContainerInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = GenericIndexableContainerInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const typename T_::template Apply<IndexableContainerInterface>, maxon::StrongCOWRefHandler, typename T_::template Apply<IndexableContainer>>>, T_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const typename T_::template Apply<IndexableContainerInterface>, maxon::StrongCOWRefHandler, typename T_::template Apply<IndexableContainer>>>, T_>>);
	using NonConst = Hxx1::NonConstRef<T_>;
};
...
public FnDoxy<NonConstRef<T_>>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<typename T_::template Apply<IndexableContainerInterface>, maxon::StrongRefHandler, NonConstRef<T_>>>, T_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<typename T_::template Apply<IndexableContainerInterface>, maxon::StrongRefHandler, NonConstRef<T_>>>, T_>>);
};
