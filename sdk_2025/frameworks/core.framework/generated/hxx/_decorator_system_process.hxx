...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservableProcessFinishedDelegate> ObservableProcessFinished(maxon::Bool create) const
	{
		return maxon::Cast<SystemProcessObjectRef>(self.GetDecoratedObject()).ObservableProcessFinished(create);
	}
