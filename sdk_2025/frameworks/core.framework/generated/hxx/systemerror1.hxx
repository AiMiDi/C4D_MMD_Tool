...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const SystemErrorInterface, maxon::StrongCOWRefHandler, SystemError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const SystemErrorInterface, maxon::StrongCOWRefHandler, SystemError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] SystemError : public SystemErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(SystemError, SystemErrorObject, "net.maxon.error.system",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class NSSystemError;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const NSSystemErrorInterface, maxon::StrongCOWRefHandler, NSSystemError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const NSSystemErrorInterface, maxon::StrongCOWRefHandler, NSSystemError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<NSSystemErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<NSSystemErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] NSSystemError : public NSSystemErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(NSSystemError, NSSystemErrorObject, "net.maxon.error.nsystem",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
#endif
