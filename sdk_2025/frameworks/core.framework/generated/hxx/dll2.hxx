...
struct DllInterface::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(DllInterface_GetLoadedDlls, GetLoadedDlls, MAXON_EXPAND_VA_ARGS, (Result<Bool>), const ValueReceiver<const DllRef&>& dlls);
...
struct DllInterface::Hxx2
{
	...
	public:
		...
		static Result<Bool> DllInterface_GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) { return S::GetLoadedDlls(dlls); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto DllInterface::GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) -> Result<Bool>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DllInterface::Hxx1::ConstFn<S>::GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) -> Result<Bool>
{
	return (MTable::_instance.DllInterface_GetLoadedDlls(dlls));
}
