...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(JobErrorInterface);
...
/// @cond INTERNAL
	...
	static maxon::Result<void> RegisterReflection_ThreadServices(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(ThreadServices::MTable::_instance.ThreadServices_CreateGroupForQueue)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "queue\0cnt\0jobSize\0flags\0", 93LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(ThreadServices::MTable::_instance.ThreadServices_AddJob)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "group\0pod\0flags\0", 5LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(ThreadServices::MTable::_instance.ThreadServices_AddJobs)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "group\0memory\0cnt\0jobPODOffset\0flags\0", 341LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(ThreadServices::MTable::_instance.ThreadServices_DisconnectPredecessor)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "pod\0prev\0", 9LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(ThreadServices::MTable::_instance.ThreadServices_CalculatePartitions)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "cnt\0threadCnt\0minChunkSize\0partitions\0", 149LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(ThreadServices::MTable::_instance.ThreadServices_SetMainThreadYieldDelegate)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "d\0", 0LL, nullptr),
		};
