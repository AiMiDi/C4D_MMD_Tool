...
struct HierarchyObjectInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(HierarchyObjectInterface_ObservableHierarchyInsert, ObservableHierarchyInsert, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableHierarchyInsertDelegate>), maxon::Bool create);
	maxon::Int HierarchyObjectInterface_ObservableHierarchyInsert_Offset;
	PRIVATE_MAXON_MF_POINTER(HierarchyObjectInterface_ObservableHierarchyRemove, ObservableHierarchyRemove, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableHierarchyRemoveDelegate>), maxon::Bool create);
...
struct HierarchyObjectInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(HierarchyObjectInterface_ObservableHierarchyInsert, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableHierarchyInsertDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableHierarchyInsert(create); }
		PRIVATE_MAXON_MF_WRAPPER(HierarchyObjectInterface_ObservableHierarchyRemove, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableHierarchyRemoveDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableHierarchyRemove(create); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::ObservableHierarchyInsert(maxon::Bool create) const -> maxon::ObservableRef<ObservableHierarchyInsertDelegate>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::ObservableHierarchyRemove(maxon::Bool create) const -> maxon::ObservableRef<ObservableHierarchyRemoveDelegate>
{
...
{
	HXXRETURN0(HXXADDRET2(HierarchyObjectRef<>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<HierarchyObjectRef<>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) HXXTABLE(HierarchyObjectInterface_Remove); 
...
{
	HXXRETURN0(HXXADDRET2(ConstDataPtr)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<ConstDataPtr, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) HXXTABLE(HierarchyObjectInterface_GetBranchId); 
...
{
	HXXRETURN0(HXXADDRET2(std::add_pointer<HierarchyObjectInterface>::type)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<std::add_pointer<HierarchyObjectInterface>::type, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) HXXTABLE(HierarchyObjectInterface_GetParentPtr); 
...
{
	HXXRETURN0(HXXADDRET2(typename HIERARCHY_::template Sibling<Interface>::type)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<typename HIERARCHY_::template Sibling<Interface>::type, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) HXXTABLE(HierarchyObjectInterface_GetFirst); 
...
{
	HXXRETURN0(HXXADDRET2(typename HIERARCHY_::template Sibling<Interface>::type)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<typename HIERARCHY_::template Sibling<Interface>::type, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) HXXTABLE(HierarchyObjectInterface_GetLast); 
...
{
	HXXRETURN0(HXXADDRET2(std::add_pointer<HierarchyObjectInterface>::type)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<std::add_pointer<HierarchyObjectInterface>::type, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) HXXTABLE(HierarchyObjectInterface_FindNextLeaf); 
...
template <typename S, typename HIERARCHY_> MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::Hxx1::ConstFn<S, HIERARCHY_>::ObservableHierarchyInsert(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableHierarchyInsertDelegate>)
{
...
template <typename S, typename HIERARCHY_> MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::Hxx1::ConstFn<S, HIERARCHY_>::ObservableHierarchyRemove(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableHierarchyRemoveDelegate>)
{
