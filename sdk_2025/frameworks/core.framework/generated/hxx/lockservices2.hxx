...
struct LockServices::Hxx2
{
	...
	public:
		...
		static void LockServices_Serialize(CoreSerializerPOD& serializer, CoreSerializerCallback jobCallback, void* jobParam) { return S::Serialize(serializer, std::forward<CoreSerializerCallback>(jobCallback), jobParam); }
		static void LockServices_SerializeAsync(CoreSerializerPOD& serializer, CoreSerializerBuildWrapper wrapperCallback, void* fn) { return S::SerializeAsync(serializer, std::forward<CoreSerializerBuildWrapper>(wrapperCallback), fn); }
		static void LockServices_AllocRWLockSlot(ARWLock* arw) { return S::AllocRWLockSlot(arw); }
		static void LockServices_FreeRWLockSlot(ARWLock* arw) { return S::FreeRWLockSlot(arw); }
		static void LockServices_ARWReadLock(ARWLock* arw) { return S::ARWReadLock(arw); }
		static void LockServices_ARWReadUnlock(ARWLock* arw) { return S::ARWReadUnlock(arw); }
		static void LockServices_ARWWriteLock(ARWLock* arw) { return S::ARWWriteLock(arw); }
		static void LockServices_ARWWriteUnlock(ARWLock* arw) { return S::ARWWriteUnlock(arw); }
		static Bool LockServices_ARWAttemptWriteLock(ARWLock* arw) { return S::ARWAttemptWriteLock(arw); }
	};
