...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringEncodingInterface, maxon::StrongRefHandler, StringEncodingRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringEncodingInterface, maxon::StrongRefHandler, StringEncodingRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringDecodingInterface, maxon::StrongRefHandler, StringDecodingRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringDecodingInterface, maxon::StrongRefHandler, StringDecodingRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
