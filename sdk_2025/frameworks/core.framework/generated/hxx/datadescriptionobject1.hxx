...
struct DataDescriptionObjectInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DataDescriptionObjectInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionObjectInterface, maxon::StrongRefHandler, DataDescriptionObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionObjectInterface, maxon::StrongRefHandler, DataDescriptionObjectRef>>>>);
