...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(StringEncodingInterface, , "net.maxon.interface.stringencoding", (StreamConversionInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(StringDecodingInterface, , "net.maxon.interface.stringdecoding", (StreamConversionInterface::PrivateGetInterface()));
