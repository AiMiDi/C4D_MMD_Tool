...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(LoggerTypeInterface);
	...
	public:
		...
		maxon::ObservableRef<ObservableLoggerNotifyDelegate> ObservableLoggerNotify(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_LoggerTypeInterface_ObservableLoggerNotify, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableLoggerNotifyDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.LoggerTypeInterface_ObservableLoggerNotify)));
			return proxy_result;
		}
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(FileLoggerTypeInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(UserLoggerTypeInterface);
