...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FunctionBaseInterface, maxon::StrongRefHandler, FunctionBaseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FunctionBaseInterface, maxon::StrongRefHandler, FunctionBaseRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CombinerInterface, maxon::StrongRefHandler, CombinerRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CombinerInterface, maxon::StrongRefHandler, CombinerRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ObservableBaseInterface, maxon::StrongRefHandler, ObservableBaseRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ObservableBaseInterface, maxon::StrongRefHandler, ObservableBaseRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
