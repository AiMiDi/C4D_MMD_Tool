...
struct Member::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(Member_GetEnclosingContainer, Member, const, (const Container*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Member))->GetEnclosingContainer(); }
		PRIVATE_MAXON_MF_WRAPPER(Member_GetKind, Member, const, (KIND)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Member))->GetKind(); }
		PRIVATE_MAXON_MF_WRAPPER(Member_GetSimpleName, Member, const, (const Id&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Member))->GetSimpleName(); }
		PRIVATE_MAXON_MF_WRAPPER(Member_GetId, Member, const, (const Id&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Member))->GetId(); }
		PRIVATE_MAXON_MF_WRAPPER(Member_ToString, Member, const, (String), const FormatStatement* fs) { return S::Get(PRIVATE_MAXON_MF_THIS(const Member))->ToString(fs); }
		static Result<Bool> Member_GetMembers(const ValueReceiver<const Member&>& members) { return S::GetMembers(members); }
		static const Member* Member_Find(const Id& memberId) { return S::Find(memberId); }
	};
...
{
	class Unresolved;
	template <typename S> class Wrapper : public Member::Hxx2::Wrapper<S>
	{
	public:
		PRIVATE_MAXON_MF_WRAPPER(Container_GetClasses, Container, const, (Block<const Class* const>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Container))->GetClasses(); }
		PRIVATE_MAXON_MF_WRAPPER(Container_FindClass, Container, const, (const Class*), const Id& name) { return S::Get(PRIVATE_MAXON_MF_THIS(const Container))->FindClass(name); }
		PRIVATE_MAXON_MF_WRAPPER(Container_GetFunctions, Container, const, (Block<const Function* const>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Container))->GetFunctions(); }
		PRIVATE_MAXON_MF_WRAPPER(Container_FindFunction, Container, const, (Result<const Function*>), const Id& name) { return S::Get(PRIVATE_MAXON_MF_THIS(const Container))->FindFunction(name); }
		PRIVATE_MAXON_MF_WRAPPER(Container_FindFunctions, Container, const, (Result<void>), const Id& name, const ValueReceiver<const Function*>& result) { return S::Get(PRIVATE_MAXON_MF_THIS(const Container))->FindFunctions(name, result); }
	};
...
{
	class Unresolved;
	template <typename S> class Wrapper : public Container::Hxx2::Wrapper<S>
	{
	public:
		PRIVATE_MAXON_MF_WRAPPER(Package_GetPackages, Package, const, (Block<const Package* const>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Package))->GetPackages(); }
		PRIVATE_MAXON_MF_WRAPPER(Package_FindPackage, Package, const, (const Package*), const Id& name) { return S::Get(PRIVATE_MAXON_MF_THIS(const Package))->FindPackage(name); }
		static const Package* Package_GetGlobalPackage() { return S::GetGlobalPackage(); }
	};
...
struct Class::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(Class_GetType, GetType, false, Class, const, (const DataType&));
	...
	template <typename IMPL> void Init()
	{
		...
		Class_GetType = Class_GetType_GetPtr<IMPL>(0, true).first;
...
struct Class::Hxx2
{
	...
	{
	public:
		PRIVATE_MAXON_MF_WRAPPER(Class_GetInterface, Class, const, (const InterfaceReference*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Class))->GetInterface(); }
		PRIVATE_MAXON_MF_WRAPPER(Class_GetNonvirtualInterface, Class, const, (const NonvirtualInterfaceReference*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Class))->GetNonvirtualInterface(); }
		PRIVATE_MAXON_MF_WRAPPER(Class_GetType, Class, const, (const DataType&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Class))->GetType(); }
		PRIVATE_MAXON_MF_WRAPPER(Class_GetBaseClasses, Class, const, (Block<const Class* const>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Class))->GetBaseClasses(); }
		PRIVATE_MAXON_MF_WRAPPER(Class_GetStaticInterface, Class, const, (const Class*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Class))->GetStaticInterface(); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto Class::GetType() const -> const DataType&
{
	return PRIVATE_MAXON_MF_INVOKE((this), MTable::_instance.Class_GetType);
}
...
struct Function::Hxx2
{
	...
	{
	public:
		PRIVATE_MAXON_MF_WRAPPER(Function_Invoke, Function, const, (Result<void>), void* result, const Block<Argument>& arguments) { return S::Get(PRIVATE_MAXON_MF_THIS(const Function))->Invoke(result, arguments); }
		PRIVATE_MAXON_MF_WRAPPER(Function_GetReturnType, Function, const, (ParameterType)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Function))->GetReturnType(); }
		PRIVATE_MAXON_MF_WRAPPER(Function_GetParameterTypes, Function, const, (Block<const ParameterType>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Function))->GetParameterTypes(); }
		PRIVATE_MAXON_MF_WRAPPER(Function_GetParameters, Function, const, (const Block<const Parameter>&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Function))->GetParameters(); }
		PRIVATE_MAXON_MF_WRAPPER(Function_IsPure, Function, const, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Function))->IsPure(); }
		PRIVATE_MAXON_MF_WRAPPER(Function_GetAddress, Function, const, (void*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const Function))->GetAddress(); }
		static const Function* Function_PrivateFindMethod(const InterfaceReference& vi, Int offset) { return S::PrivateFindMethod(vi, offset); }
		static Result<void> Function_FindAll(const Id& memberId, const ValueReceiver<const Function*>& result) { return S::FindAll(memberId, result); }
	};
