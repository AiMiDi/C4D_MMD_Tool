...
struct DataDictionaryInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DataDictionaryInterface;
...
/// @return												True if the object is identical.
		inline HXXADDRET2(Bool) IsEqual(const DataDictionaryInterface* other, EQUALITY equality) const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DataDictionaryInterface, maxon::StrongCOWRefHandler, DataDictionary>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DataDictionaryInterface, maxon::StrongCOWRefHandler, DataDictionary>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDictionaryInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDictionaryInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
