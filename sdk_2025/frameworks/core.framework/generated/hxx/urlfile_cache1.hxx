...
struct UrlFileCacheEntryInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = UrlFileCacheEntryInterface;
		...
		inline HXXADDRET2(Url) GetSourceUrl() const;
		inline HXXADDRET2(Url) GetCacheUrl() const;
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UrlFileCacheEntryInterface, maxon::StrongRefHandler, UrlFileCacheEntry>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UrlFileCacheEntryInterface, maxon::StrongRefHandler, UrlFileCacheEntry>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UrlFileCacheEntryInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UrlFileCacheEntryInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
