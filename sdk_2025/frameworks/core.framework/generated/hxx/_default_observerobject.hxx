...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObserverDestroyedDelegate> ObserverDestroyed(maxon::Bool create) const
	{
		return maxon::ObservableRef<ObserverDestroyedDelegate>::DefaultValue();
	}

	MAXON_METHOD maxon::ObservableRef<ObserverDisconnectNotifyDelegate> ObserverDisconnectNotify(maxon::Bool create) const
	{
		return maxon::ObservableRef<ObserverDisconnectNotifyDelegate>::DefaultValue();
	}

	MAXON_METHOD maxon::ObservableRef<ObserverConnectNotifyDelegate> ObserverConnectNotify(maxon::Bool create) const
	{
