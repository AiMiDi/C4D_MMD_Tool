...
template <typename K, typename V> struct MapInterface<K, V>::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_GetCount, MapInterface, const, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->GetCount(); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_InsertKey, MapInterface,, (ResultRef<V>), const K& key, Bool& created) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->InsertKey(key, created); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_InsertKey_1, MapInterface,, (ResultRef<V>), K&& key, Bool& created) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->InsertKey(std::forward<K>(key), created); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_FindValue, MapInterface,, (V*), const K& key) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->FindValue(key); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_FindValue_1, MapInterface, const, (const V*), const K& key) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->FindValue(key); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_Erase, MapInterface,, (Result<Bool>), const K& key) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->Erase(key); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_Erase_1, MapInterface,, (Iterator), const Iterator& iterator) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->Erase(iterator); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_Reset, MapInterface,, (void)) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->Reset(); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_Flush, MapInterface,, (void)) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->Flush(); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_CopyFrom, MapInterface,, (Result<void>), const MapInterface& other) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->CopyFrom(other); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_Clone, MapInterface, const, (Result<MapInterface*>), Bool copyContent) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->Clone(copyContent); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_GetKeyDataType, MapInterface, const, (const DataType&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->GetKeyDataType(); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_GetValueDataType, MapInterface, const, (const DataType&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->GetValueDataType(); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_ToString, MapInterface, const, (String), const FormatStatement* formatStatement) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->ToString(formatStatement); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_GetMemorySize, MapInterface, const, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->GetMemorySize(); }
#ifdef MAXON_COMPILER_INTEL
#endif
#ifdef MAXON_COMPILER_INTEL
#endif
...
#ifdef CPP_853_HACK
#endif
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorInit, MapInterface,, (void), Iterator* it, Bool end) { return S::Get(PRIVATE_MAXON_MF_THIS(MapInterface))->IteratorInit(it, end); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorInit_1, MapInterface, const, (void), ConstIterator* it, Bool end) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorInit(it, end); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorInitMove, MapInterface, const, (void), Iterator* dest, Iterator* src) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorInitMove(dest, src); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorInitMove_1, MapInterface, const, (void), ConstIterator* dest, ConstIterator* src) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorInitMove(dest, src); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorFree, MapInterface, const, (void), Iterator* it) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorFree(it); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorFree_1, MapInterface, const, (void), ConstIterator* it) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorFree(it); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorIsEqual, MapInterface, const, (Bool), const Iterator* a, const Iterator* b) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorIsEqual(a, b); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorIsEqual_1, MapInterface, const, (Bool), const ConstIterator* a, const ConstIterator* b) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorIsEqual(a, b); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorInc, MapInterface, const, (void), Iterator* it) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorInc(it); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorInc_1, MapInterface, const, (void), ConstIterator* it) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorInc(it); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorGet, MapInterface, const, (Pair<const K&, V&>), const Iterator* it) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorGet(it); }
		PRIVATE_MAXON_MF_WRAPPER(MapInterface_IteratorGet_1, MapInterface, const, (Pair<const K&, const V&>), const ConstIterator* it) { return S::Get(PRIVATE_MAXON_MF_THIS(const MapInterface))->IteratorGet(it); }
	};
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::GetCount() const -> HXXADDRET2(Int)
{
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::IsEmpty() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(true) 
	return (o_->IsEmpty());
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::IsPopulated() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->IsPopulated());
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::InsertKey(const K& key, Bool& created) const -> HXXADDRET2(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<V>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultRef<V>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_InsertKey, key, created));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::InsertKey(const K& key, Bool& created) -> HXXADDRET1(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET1(ResultRef<V>)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_InsertKey, key, created));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::InsertKey(K&& key, Bool& created) const -> HXXADDRET2(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<V>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultRef<V>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::InsertKey(K&& key, Bool& created) -> HXXADDRET1(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET1(ResultRef<V>)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_InsertKey_1, std::forward<K>(key), created));
}
template <typename K, typename V> template <typename S> template <typename VALUE> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::Insert(const K& key, VALUE&& value, Bool& created) const -> HXXADDRET2(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<V>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultRef<V>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (o_->Insert<VALUE>(key, std::forward<VALUE>(value), created));
}
template <typename K, typename V> template <typename S> template <typename VALUE> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::Insert(const K& key, VALUE&& value, Bool& created) -> HXXADDRET1(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET1(ResultRef<V>)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (o_->Insert<VALUE>(key, std::forward<VALUE>(value), created));
}
template <typename K, typename V> template <typename S> template <typename VALUE> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::Insert(K&& key, VALUE&& value, Bool& created) const -> HXXADDRET2(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET2(ResultRef<V>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultRef<V>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (o_->Insert<VALUE>(std::forward<K>(key), std::forward<VALUE>(value), created));
}
template <typename K, typename V> template <typename S> template <typename VALUE> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::Insert(K&& key, VALUE&& value, Bool& created) -> HXXADDRET1(ResultRef<V>)
{
	HXXRETURN0(HXXADDRET1(ResultRef<V>)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (o_->Insert<VALUE>(std::forward<K>(key), std::forward<VALUE>(value), created));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::FindValue(const K& key) const -> HXXADDRET2(V*)
{
	HXXRETURN0(HXXADDRET2(V*)); HXXRES; HXXNONCONST(, , false, nullptr) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_FindValue, key));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::FindValue(const K& key) const -> HXXADDRET2(const V*)
{
	HXXRETURN0(HXXADDRET2(const V*)); HXXRES; HXXCONST(nullptr) 
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::Erase(const Iterator& iterator) const -> HXXADDRET2(Iterator)
{
	HXXRETURN0(HXXADDRET2(Iterator)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<Iterator, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_Erase_1, iterator));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::Erase(const Iterator& iterator) -> HXXADDRET1(Iterator)
{
	HXXRETURN0(HXXADDRET1(Iterator)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_Erase_1, iterator));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::Reset() const -> HXXADDRET2(void)
{
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::Reset() -> HXXADDRET1(void)
{
	HXXRETURN0(HXXADDRET1(void)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_Reset);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::Fn<S>::Flush() const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXNONCONST(DebugStop(), , false, maxon::PrivateLogNullptrError()) 
	PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_Flush);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::COWFn<S>::Flush() -> HXXADDRET1(void)
{
	HXXRETURN0(HXXADDRET1(void)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_Flush);
	return (typename ReturnHelper::ReturnType) maxon::OK;
...
{
	HXXRETURN0(Result<MapInterface*>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_Clone, copyContent));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::GetKeyDataType() const -> HXXADDRET2(const DataType&)
{
	HXXRETURN0(HXXADDRET2(const DataType&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const DataType&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_GetKeyDataType));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::GetValueDataType() const -> HXXADDRET2(const DataType&)
{
	HXXRETURN0(HXXADDRET2(const DataType&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const DataType&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_GetValueDataType));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::ToString(const FormatStatement* formatStatement) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<String, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_ToString, formatStatement));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::GetMemorySize() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), ((MapInterface::MTable*) (o_->_vtableCls + 1))[-1].MapInterface_GetMemorySize));
}
template <typename K, typename V> template <typename S> template <typename KT, typename VT> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::HasType() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->HasType<KT, VT>());
}
template <typename K, typename V> template <typename S> template <typename KT, typename VT> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstFn<S>::AssertType() const -> HXXADDRET2(void)
{
