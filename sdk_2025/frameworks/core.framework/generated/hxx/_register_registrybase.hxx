...
/// @cond INTERNAL
	...
	const maxon::Char* const RegistryEntryIteratorInterface::MTable::_ids = 
		...
		"GetEntry@a6fded741a35772b\0" // const Generic* GetEntry(const DataType& type) const
	...
	public:
		...
		const Generic* GetEntry(const DataType& type) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const RegistryEntryIteratorInterface*) this)->GetEntry(type); return nullptr;}
	...
	const maxon::UNRESOLVED_RETURN_TYPE RegistryEntryIteratorInterface::MTable::_returnTypes[] = 
	{
		...
		maxon::details::UnresolvedReturnType<const Generic*>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
	...
	maxon::Bool RegistryEntryIteratorInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<ConstDataPtr>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->RegistryEntryIteratorInterface_GetEntry_1 = PRIVATE_MAXON_MF_CAST(decltype(RegistryEntryIteratorInterface_GetEntry_1), &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_GetEntry_1);
		#else
		tbl->RegistryEntryIteratorInterface_GetEntry_1 = PRIVATE_MAXON_MF_CAST(decltype(RegistryEntryIteratorInterface_GetEntry_1), &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryEntryIteratorInterface_GetEntry_1);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	const maxon::Char* const RegistryInterface::MTable::_ids = 
		...
		"FindEntryValue@17396f7b2eaaeaad\0" // const Generic* FindEntryValue(const RegistryInterface* registry, const Id& eid, const DataType& type)
	...
	public:
		...
		static const Generic* FindEntryValue(const RegistryInterface* registry, const Id& eid, const DataType& type) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return RegistryInterface::FindEntryValue(registry, eid, type); return nullptr;}
	...
	const maxon::UNRESOLVED_RETURN_TYPE RegistryInterface::MTable::_returnTypes[] = 
	{
		...
		maxon::details::UnresolvedReturnType<const Generic*>::value,
	...
	maxon::Bool RegistryInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<ConstDataPtr>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->RegistryInterface_FindEntryValue_1 = PRIVATE_MAXON_MF_CAST(decltype(RegistryInterface_FindEntryValue_1), &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_FindEntryValue_1);
		#else
		tbl->RegistryInterface_FindEntryValue_1 = PRIVATE_MAXON_MF_CAST(decltype(RegistryInterface_FindEntryValue_1), &Hxx2::Wrapper<Hxx2::Unresolved>::RegistryInterface_FindEntryValue_1);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
