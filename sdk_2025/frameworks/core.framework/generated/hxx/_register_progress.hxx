...
namespace maxon
{
	const maxon::Char* const ProgressInterface::MTable::_ids = 
		...
		"ObservableProgressNotification@5d69bf76c22de2b4\0" // maxon::ObservableRef<ObservableProgressNotificationDelegate> ObservableProgressNotification(maxon::Bool create) const
