...
struct ParserInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ParserInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(ParserInterface**);
...
/// @return the file extension as a string.
		inline HXXADDRET2(String) GetFileExtension() const;
	};
	/// Intermediate helper class for ParserInterface.
	...
	public:
		...
		using PrivateInterface = ParserInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(ParserInterface**);
...
/// @return                       OK on success.
	...
	public:
		...
		using PrivateInterface = ParserInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(ParserInterface**);
...
#ifdef DOXYGEN
public FnDoxy<ParserRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ParserInterface, maxon::StrongRefHandler, ParserRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ParserInterface, maxon::StrongRefHandler, ParserRef>>>>);
