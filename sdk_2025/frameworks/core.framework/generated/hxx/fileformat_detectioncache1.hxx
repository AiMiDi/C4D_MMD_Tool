...
struct FileFormatDetectionCacheInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = FileFormatDetectionCacheInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileFormatDetectionCacheInterface, maxon::StrongRefHandler, FileFormatDetectionCacheRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileFormatDetectionCacheInterface, maxon::StrongRefHandler, FileFormatDetectionCacheRef>>>>);
