...
namespace maxon
{
	const maxon::Char* const HierarchyObjectInterface::MTable::_ids = 
		...
		"ObservableHierarchyInsert@b6fc9dd557ff0af0\0" // maxon::ObservableRef<ObservableHierarchyInsertDelegate> ObservableHierarchyInsert(maxon::Bool create) const
		"ObservableHierarchyRemove@c7d3bcbcbe35fc75\0" // maxon::ObservableRef<ObservableHierarchyRemoveDelegate> ObservableHierarchyRemove(maxon::Bool create) const
