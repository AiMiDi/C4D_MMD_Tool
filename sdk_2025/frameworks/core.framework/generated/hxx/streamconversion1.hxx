...
/// If true is returned it's possible to call ConvertAllInplace().
		inline HXXADDRET2(Bool) SupportInplaceConversion() const;
	};
	/// Intermediate helper class for StreamConversionInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StreamConversionInterface, maxon::StrongRefHandler, StreamConversionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StreamConversionInterface, maxon::StrongRefHandler, StreamConversionRef>>>>);
