...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataFormatBaseReaderInterface, , "net.maxon.interface.dataformatbasereader", (DataDictionaryObjectInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataFormatBaseWriterInterface, , "net.maxon.interface.dataformatbasewriter", (DataDictionaryObjectInterface::PrivateGetInterface()));
}
#endif
