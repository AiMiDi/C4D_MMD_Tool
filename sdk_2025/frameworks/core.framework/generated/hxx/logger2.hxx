...
struct LoggerTypeInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(LoggerTypeInterface_ObservableLoggerNotify, ObservableLoggerNotify, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableLoggerNotifyDelegate>), maxon::Bool create);
...
struct LoggerTypeInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(LoggerTypeInterface_ObservableLoggerNotify, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableLoggerNotifyDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableLoggerNotify(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::ObservableLoggerNotify(maxon::Bool create) const -> maxon::ObservableRef<ObservableLoggerNotifyDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerTypeInterface::Hxx1::ConstFn<S>::ObservableLoggerNotify(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableLoggerNotifyDelegate>)
{
...
struct LoggerInterface::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(LoggerInterface_ObservableLoggerNew, ObservableLoggerNew, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableLoggerNewDelegate>), maxon::Bool create);
...
struct LoggerInterface::Hxx2
{
	...
	public:
		...
		static maxon::ObservableRef<ObservableLoggerNewDelegate> LoggerInterface_ObservableLoggerNew(maxon::Bool create) { return S::ObservableLoggerNew(create); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::ObservableLoggerNew(maxon::Bool create) -> maxon::ObservableRef<ObservableLoggerNewDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto LoggerInterface::Hxx1::ConstFn<S>::ObservableLoggerNew(maxon::Bool create) -> maxon::ObservableRef<ObservableLoggerNewDelegate>
{
	return (MTable::_instance.LoggerInterface_ObservableLoggerNew(create));
}
