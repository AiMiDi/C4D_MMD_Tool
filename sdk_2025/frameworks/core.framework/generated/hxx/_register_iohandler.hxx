...
namespace maxon
{
	...
	{
	public:
		static IoHandler GetHandlerForScheme(const UrlScheme& scheme) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, true)) return IoHandlerInterface::GetHandlerForScheme(scheme); return HXXRET3(UNRESOLVED, IoHandler);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE IoHandlerInterface::Hxx2::StaticMTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<IoHandler>::value,
	...
	maxon::Bool IoHandlerInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<IoHandler>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->IoHandlerInterface_GetHandlerForScheme = PRIVATE_MAXON_MF_CAST(decltype(IoHandlerInterface_GetHandlerForScheme), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::IoHandlerInterface_GetHandlerForScheme);
		#else
	...
	const maxon::Char* const IoHandlerInterface::MTable::_ids = 
		...
		"ConvertToUiName@9311c89f9a1d1b95\0" // Result<String> ConvertToUiName(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository) const
	"";
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(IoHandlerInterface, , "net.maxon.interface.iohandler", (ObjectInterface::PrivateGetInterface()));
	...
	template <typename DUMMY> maxon::Int IoHandlerInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<IoHandler>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_iohandler(0
	| maxon::IoHandlerInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
