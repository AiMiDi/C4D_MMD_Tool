...
struct IoPipeInOutputStreamInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = IoPipeInOutputStreamInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(IoPipeInOutputStreamInterface**);
		inline HXXADDRET2(PIPEHANDLE) GetReadHandle() const;
		inline HXXADDRET2(PIPEHANDLE) GetWriteHandle() const;
	};
	/// Intermediate helper class for IoPipeInOutputStreamInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoPipeInOutputStreamInterface, maxon::StrongRefHandler, IoPipeInOutputStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoPipeInOutputStreamInterface, maxon::StrongRefHandler, IoPipeInOutputStreamRef>>>>);
