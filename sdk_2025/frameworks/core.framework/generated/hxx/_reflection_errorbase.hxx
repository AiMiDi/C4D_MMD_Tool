...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(OutOfMemoryErrorInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(FunctionNotImplementedErrorInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(IllegalArgumentErrorInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(NullptrErrorInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(IllegalStateErrorInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(UnexpectedErrorInterface);
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(OperationCancelledErrorInterface);
	static maxon::InterfaceDefinition s_OperationCancelledErrorInterface(OperationCancelledErrorInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION,"maxon::OperationCancelledError");
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	class OperationCancelledErrorInterface::ProxyComponent : public maxon::Component<ProxyComponent, OperationCancelledErrorInterface>
	{
		MAXON_COMPONENT();
	public:
		using typename maxon::Component<ProxyComponent, OperationCancelledErrorInterface>::_Wrapper;
		static const maxon::Bool PROXY = true;
		maxon::reflection::ProxyHandler _handler;
	};
	PRIVATE_MAXON_COMPONENT_REGISTER(OperationCancelledErrorInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, &maxon::g_translationUnit, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_OperationCancelledErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		return callback(cls, reinterpret_cast<const maxon::EntityReference*>(&OperationCancelledErrorInterface::_interface), maxon::Block<maxon::reflection::FunctionInfo>());
	}
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_REFLECTION
	static maxon::reflection::ContainerInfo g_reflection_OperationCancelledErrorInterface(nullptr, &OperationCancelledErrorInterface::ProxyComponent::_descriptor, &RegisterReflection_OperationCancelledErrorInterface, &PRIVATE_MAXON_MODULE);
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(AggregatedErrorInterface);
	...
	public:
		...
		Bool AddError(const Error& error) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.AggregatedErrorInterface_AddError_Offset), maxon::reflection::Argument::ByReference(error)};
			(*handler_)(_fn_AggregatedErrorInterface_AddError, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Bool), const Error&), reinterpret_cast<const void* const&>(mt_.AggregatedErrorInterface_AddError)));
			return proxy_result;
		}
		...
		Bool AddError(Error&& error) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<AggregatedErrorInterface>();
			Bool proxy_result = maxon::PrivateLogNullptrError(false);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.AggregatedErrorInterface_AddError_1_Offset), maxon::reflection::Argument::ByReference(error)};
			(*handler_)(_fn_AggregatedErrorInterface_AddError_1, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Bool), Error&&), reinterpret_cast<const void* const&>(mt_.AggregatedErrorInterface_AddError_1)));
			return proxy_result;
		}
		...
		Int GetCount() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<AggregatedErrorInterface>();
			Int proxy_result = 0;
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.AggregatedErrorInterface_GetCount_Offset)};
			(*handler_)(_fn_AggregatedErrorInterface_GetCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.AggregatedErrorInterface_GetCount)));
			return proxy_result;
		}
		...
		const Error& GetError(Int index) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<AggregatedErrorInterface>();
			const Error* proxy_result = &HXXRET3(NULLIMPL, const Error&);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.AggregatedErrorInterface_GetError_Offset), maxon::reflection::Argument::ByValue(index)};
			(*handler_)(_fn_AggregatedErrorInterface_GetError, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((const Error&), Int), reinterpret_cast<const void* const&>(mt_.AggregatedErrorInterface_GetError)));
			return *proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_AggregatedErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "error\0", 1LL, AggregatedErrorInterface, AggregatedErrorInterface_AddError),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "error\0", 1LL, AggregatedErrorInterface, AggregatedErrorInterface_AddError_1),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, AggregatedErrorInterface, AggregatedErrorInterface_GetCount),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "index\0", 1LL, AggregatedErrorInterface, AggregatedErrorInterface_GetError),
		};
