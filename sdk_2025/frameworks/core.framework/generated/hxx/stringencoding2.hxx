...
struct StringEncodingInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<StringEncodingInterface, typename StreamConversionInterface::MTable::template CombinedMTable<S>>;
...
struct StringDecodingInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<StringDecodingInterface, typename StreamConversionInterface::MTable::template CombinedMTable<S>>;
