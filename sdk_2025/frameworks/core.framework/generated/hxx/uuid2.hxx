...
struct UuidInterface::Hxx2
{
	...
	public:
		...
		static void UuidInterface_Free(const UuidInterface* object) { return S::Free(object); }
		static UuidInterface* UuidInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		static UuidInterface* UuidInterface_Alloc_1(const maxon::SourceLocation& allocLocation, const UuidInterface& object) { return S::Alloc(allocLocation, ((const S&) object)); }
		static UuidInterface* UuidInterface_Alloc_2(const maxon::SourceLocation& allocLocation, const String& uuid) { return S::Alloc(allocLocation, uuid); }
		static UuidInterface* UuidInterface_Alloc_3(const maxon::SourceLocation& allocLocation, const UChar* uuid, Int uuidSize) { return S::Alloc(allocLocation, uuid, uuidSize); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_IsEmpty, UuidInterface, const, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UuidInterface))->IsEmpty(); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_CreateId, UuidInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(UuidInterface))->CreateId(); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_Set, UuidInterface,, (Result<void>), const String& uuid) { return S::Get(PRIVATE_MAXON_MF_THIS(UuidInterface))->Set(uuid); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_Set_1, UuidInterface,, (Result<void>), const UChar* uuid, Int uuidSize) { return S::Get(PRIVATE_MAXON_MF_THIS(UuidInterface))->Set(uuid, uuidSize); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_Get, UuidInterface, const, (Result<void>), UChar* uuid, Int uuidSize) { return S::Get(PRIVATE_MAXON_MF_THIS(const UuidInterface))->Get(uuid, uuidSize); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_ToString, UuidInterface, const, (String), const FormatStatement* formatStatement) { return S::Get(PRIVATE_MAXON_MF_THIS(const UuidInterface))->ToString(formatStatement); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_Compare, UuidInterface, const, (COMPARERESULT), const UuidInterface* uuid) { return S::Get(PRIVATE_MAXON_MF_THIS(const UuidInterface))->Compare(uuid); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_GetHashCode, UuidInterface, const, (HashInt)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UuidInterface))->GetHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(UuidInterface_GetUniqueHashCode, UuidInterface, const, (UniqueHash)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UuidInterface))->GetUniqueHashCode(); }
		static Result<void> UuidInterface_DescribeIO(const DataSerializeInterface& stream) { return S::DescribeIO(stream); }
		static Result<String> UuidInterface_CreateUuidString() { return S::CreateUuidString(); }
		static Result<void> UuidInterface_CreateUuid(maxon::AddArrayT<UChar, 16>& uuid) { return S::CreateUuid(uuid); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::Hxx1::ConstFn<S>::IsEmpty() const -> HXXADDRET2(Bool)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::Hxx1::ConstFn<S>::IsPopulated() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::Hxx1::ConstFn<S>::ToString(const FormatStatement* formatStatement) const -> HXXADDRET2(String)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UuidInterface::Hxx1::ConstFn<S>::Compare(const UuidInterface* uuid) const -> HXXADDRET2(COMPARERESULT)
{
