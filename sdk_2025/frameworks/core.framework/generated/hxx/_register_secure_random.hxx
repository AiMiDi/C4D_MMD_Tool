...
namespace maxon
{
	...
	public:
		...
		static SecureRandomProvider GetDefaultProvider() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return SecureRandom::GetDefaultProvider(); return HXXRET3(UNRESOLVED, SecureRandomProvider);}
	...
	const maxon::UNRESOLVED_RETURN_TYPE SecureRandom::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<SecureRandomProvider>::value,
	...
	maxon::Bool SecureRandom::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<SecureRandomProvider>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->SecureRandom_GetDefaultProvider = PRIVATE_MAXON_MF_CAST(decltype(SecureRandom_GetDefaultProvider), &Hxx2::Wrapper<Hxx2::Unresolved>::SecureRandom_GetDefaultProvider);
		#else
	...
	MAXON_INTERFACE_REGISTER(SecureRandom, "net.maxon.interface.securerandom", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int SecureRandom::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<SecureRandomProvider>(OVERLOAD_MAX_RANK)
		;
	}
}
#endif
static maxon::details::ForceEvaluation s_forceEval_secure_random(0
	| maxon::SecureRandom::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
