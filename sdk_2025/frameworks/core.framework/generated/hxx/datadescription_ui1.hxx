...
struct DataDescriptionUIInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DataDescriptionUIInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DataDescriptionUIInterface, maxon::StrongRefHandler, DataDescriptionUI>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DataDescriptionUIInterface, maxon::StrongRefHandler, DataDescriptionUI>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionUIInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionUIInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
