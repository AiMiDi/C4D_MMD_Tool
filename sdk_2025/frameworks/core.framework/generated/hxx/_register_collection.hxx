...
namespace maxon
{
	namespace enum146
	{
		...
		static const maxon::UInt64 COLLECTION_RESIZE_FLAGS_values[] = {maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::NONE), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_SHRINK_KEEP_CAPACITY), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_SHRINK_FIT_TO_SIZE), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_GROW_RESERVE_CAPACITY), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_GROW_FIT_TO_SIZE), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_GROW_UNINITIALIZED), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_GROW_UNSPECIFIED), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_RESIZE_UNSPECIFIED), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::ON_RESIZE_MAKE_WRITABLE), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::FIT_TO_SIZE), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::DEFAULT), maxon::UInt64(enum146::COLLECTION_RESIZE_FLAGS::POD_UNINITIALIZED)};
		static const maxon::EnumInfo COLLECTION_RESIZE_FLAGS_info{"COLLECTION_RESIZE_FLAGS", SIZEOF(COLLECTION_RESIZE_FLAGS), true, "NONE\0ON_SHRINK_KEEP_CAPACITY\0ON_SHRINK_FIT_TO_SIZE\0ON_GROW_RESERVE_CAPACITY\0ON_GROW_FIT_TO_SIZE\0ON_GROW_UNINITIALIZED\0ON_GROW_UNSPECIFIED\0ON_RESIZE_UNSPECIFIED\0ON_RESIZE_MAKE_WRITABLE\0FIT_TO_SIZE\0DEFAULT\0POD_UNINITIALIZED\0", COLLECTION_RESIZE_FLAGS_values, std::extent<decltype(COLLECTION_RESIZE_FLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_COLLECTION_RESIZE_FLAGS146(){ return enum146::COLLECTION_RESIZE_FLAGS_info; }
