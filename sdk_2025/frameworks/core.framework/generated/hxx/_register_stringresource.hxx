...
namespace maxon
{
	...
	const maxon::Char* const Resource::MTable::_ids = 
		...
		"ObservableLanguageChanged@285337e179ed50df\0" // maxon::ObservableRef<ObservableLanguageChangedDelegate> ObservableLanguageChanged(maxon::Bool create)
	"";
	MAXON_WARNING_PUSH
	MAXON_WARNING_DISABLE_DEPRECATED
	...
	public:
		...
		static maxon::ObservableRef<ObservableLanguageChangedDelegate> ObservableLanguageChanged(maxon::Bool create) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return Resource::ObservableLanguageChanged(create); return maxon::ObservableRef<ObservableLanguageChangedDelegate>::DefaultValue();}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
