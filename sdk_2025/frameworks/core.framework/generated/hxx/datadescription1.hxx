...
struct DataDescriptionInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DataDescriptionInterface;
...
/// @return												True in equality.
		inline HXXADDRET2(Bool) IsEqual(const DataDescriptionInterface* other, EQUALITY equality) const;
/// Compares the 2 values.
		inline HXXADDRET2(COMPARERESULT) Compare(const DataDescriptionInterface* other) const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DataDescriptionInterface, maxon::StrongCOWRefHandler, DataDescription>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DataDescriptionInterface, maxon::StrongCOWRefHandler, DataDescription>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
