...
struct SettingsInterface::Hxx2
{
	...
	PRIVATE_MAXON_SF_POINTER(SettingsInterface_ObservableSettingsChanged, ObservableSettingsChanged, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableSettingsChangedDelegate>), maxon::Bool create);
	...
	public:
		...
		static maxon::ObservableRef<ObservableSettingsChangedDelegate> SettingsInterface_ObservableSettingsChanged(maxon::Bool create) { return S::Implementation::ObservableSettingsChanged(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto SettingsInterface::ObservableSettingsChanged(maxon::Bool create) -> maxon::ObservableRef<ObservableSettingsChangedDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SettingsInterface::Hxx1::ConstFn<S>::ObservableSettingsChanged(maxon::Bool create) -> maxon::ObservableRef<ObservableSettingsChangedDelegate>
{
	return (Hxx2::StaticMTable::_instance.SettingsInterface_ObservableSettingsChanged(create));
}
