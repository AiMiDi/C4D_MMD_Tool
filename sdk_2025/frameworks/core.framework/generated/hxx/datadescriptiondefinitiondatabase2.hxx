...
struct DataDescriptionDefinitionDatabaseInterface::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(DataDescriptionDefinitionDatabaseInterface_ObservableSaveDatabase, ObservableSaveDatabase, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableSaveDatabaseDelegate>), maxon::Bool create);
	PRIVATE_MAXON_SF_POINTER(DataDescriptionDefinitionDatabaseInterface_ObservableDatabaseRegistrationChange, ObservableDatabaseRegistrationChange, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableDatabaseRegistrationChangeDelegate>), maxon::Bool create);
...
struct DataDescriptionDefinitionDatabaseInterface::Hxx2
{
	...
	public:
		...
		static maxon::ObservableRef<ObservableSaveDatabaseDelegate> DataDescriptionDefinitionDatabaseInterface_ObservableSaveDatabase(maxon::Bool create) { return S::ObservableSaveDatabase(create); }
		static maxon::ObservableRef<ObservableDatabaseRegistrationChangeDelegate> DataDescriptionDefinitionDatabaseInterface_ObservableDatabaseRegistrationChange(maxon::Bool create) { return S::ObservableDatabaseRegistrationChange(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseInterface::ObservableSaveDatabase(maxon::Bool create) -> maxon::ObservableRef<ObservableSaveDatabaseDelegate>
{
	return MTable::_instance.DataDescriptionDefinitionDatabaseInterface_ObservableSaveDatabase(create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionDatabaseInterface::ObservableDatabaseRegistrationChange(maxon::Bool create) -> maxon::ObservableRef<ObservableDatabaseRegistrationChangeDelegate>
{
