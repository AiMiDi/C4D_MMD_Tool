...
/// @endcond
	...
	namespace enum757
	{
		...
		static const maxon::UInt64 KIND_values[] = {maxon::UInt64(enum757::KIND::NORMAL), maxon::UInt64(enum757::KIND::SINGLETON), maxon::UInt64(enum757::KIND::ABSTRACT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_KIND757(void*){ return enum757::KIND_info; }
	...
	public:
		...
		const Id& GetId() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetId(); return maxon::PrivateDefaultReturnValue<const Id&, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		KIND GetKind() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetKind(); return maxon::PrivateDefaultReturnValue<KIND, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		Block<const ComponentInfo* const> GetComponents() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetComponents(); return maxon::PrivateDefaultReturnValue<Block<const ComponentInfo* const>, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		Result<void> AddComponent(const ComponentDescriptor& component) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((ClassInterface*) this)->AddComponent(component); return HXXRET1(UNRESOLVED);}
		...
		Result<void> AddComponents(const Class<>& cls) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((ClassInterface*) this)->AddComponents(cls); return HXXRET1(UNRESOLVED);}
		Result<void> Finalize() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((ClassInterface*) this)->Finalize(); return HXXRET1(UNRESOLVED);}
		...
		const Block<const InterfaceReference* const>& GetImplementedInterfaces() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetImplementedInterfaces(); return maxon::PrivateDefaultReturnValue<const Block<const InterfaceReference* const>&, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		const DataType& GetDataType() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetDataType(); return maxon::PrivateDefaultReturnValue<const DataType&, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		Result<typename maxon::details::ClassGetNonConst<REF>::type> Create() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const ClassInterface*) this)->Create(); return HXXRET1(UNRESOLVED);}
		Result<ObjectInterface*> CreatePointer(Int size) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((const ClassInterface*) this)->CreatePointer(size); return HXXRET1(UNRESOLVED);}
		...
		String ToString(const FormatStatement* formatStatement) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->ToString(formatStatement); return maxon::PrivateDefaultReturnValue<String, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		const DataDictionary& GetMetaData() const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const ClassInterface*) this)->GetMetaData(); return maxon::PrivateDefaultReturnValue<const DataDictionary&, false>(maxon::NULL_RETURN_REASON::UNRESOLVED, OVERLOAD_MAX_RANK);}
		...
		static Result<void> CopyInstance(ObjectInterface* dest, const ObjectInterface* src) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ClassInterface::CopyInstance(dest, src); return HXXRET1(UNRESOLVED);}
		...
		Result<Int> AddProxyComponent(const ComponentDescriptor& component, Bool shared) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((ClassInterface*) this)->AddProxyComponent(component, shared); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE ClassInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<ClassInterface*>::value,
		...
		maxon::details::UnresolvedReturnType<Block<const ComponentInfo* const>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		...
		maxon::details::UnresolvedReturnType<const Block<const InterfaceReference* const>&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const DataType&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<typename maxon::details::ClassGetNonConst<REF>::type>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Result<ObjectInterface*>>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<Bool>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<String>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<const DataDictionary&>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<void>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<Result<void>>::value,
		maxon::details::UnresolvedReturnType<const ClassInfo*>::value | maxon::UNRESOLVED_RETURN_TYPE::MEMBER_FUNCTION_FLAG,
		maxon::details::UnresolvedReturnType<void*>::value,
	...
	maxon::Bool ClassInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const Id&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_GetId = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_GetId), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<KIND>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_GetKind = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_GetKind), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetKind);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Block<const ComponentInfo* const>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_GetComponents = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_GetComponents), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetComponents);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_AddComponent = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_AddComponent), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddComponent);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_AddComponents = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_AddComponents), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddComponents);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_Finalize = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_Finalize), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Finalize);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const Block<const InterfaceReference* const>&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_GetImplementedInterfaces = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_GetImplementedInterfaces), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetImplementedInterfaces);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const DataType&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_GetDataType = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_GetDataType), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetDataType);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<typename maxon::details::ClassGetNonConst<REF>::type>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_Create = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_Create), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_Create);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<ObjectInterface*>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_CreatePointer = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_CreatePointer), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CreatePointer);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<String>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_ToString = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_ToString), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_ToString);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<const DataDictionary&>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_GetMetaData = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_GetMetaData), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_GetMetaData);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_CopyInstance = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_CopyInstance), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_CopyInstance);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<Int>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->ClassInterface_AddProxyComponent = PRIVATE_MAXON_MF_CAST(decltype(ClassInterface_AddProxyComponent), &Hxx2::Wrapper<Hxx2::Unresolved>::ClassInterface_AddProxyComponent);
		#else
	...
	MAXON_INTERFACE_REGISTER(ClassInterface, "net.maxon.interface.class", nullptr, maxon::EntityBase::FLAGS::NONE);
/// @cond INTERNAL
...
/// @endcond
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL(ObjectInterface, ObjectInterface, , , "net.maxon.interface.object", nullptr);
	template <typename DUMMY> maxon::Int ObjectInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
...
/// @endcond
	...
	const maxon::Char* const ErrorInterface::MTable::_ids = 
		...
		"SetMessageDelegate@76ee20bf935b78f0\0" // void SetMessageDelegate(MessageDelegate&& message)
		"GetMessageDelegate@14eb44df4c5af807\0" // const MessageDelegate& GetMessageDelegate() const
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ErrorInterface, , "net.maxon.interface.error", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int ErrorInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<Block<void* const>>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<String>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<ThreadReferencedError>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const Error&>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const MessageDelegate&>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<const SourceLocation&>(OVERLOAD_MAX_RANK)
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_objectbase(0
	| maxon::ObjectInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
	| maxon::ErrorInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
