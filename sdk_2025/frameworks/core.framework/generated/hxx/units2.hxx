...
struct DimensionInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<DimensionInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
struct DimensionInterface::MTable::NVMTable : public CombinedMTable<maxon::CombinedMTableRoot> { static NVMTable _instance; };
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Hxx1::ConstFn<S>::GetId() const -> HXXADDRET2(const Id&)
{
	HXXRETURN0(HXXADDRET2(const Id&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const Id&)) HXXTABLE(DimensionInterface_GetId); 
...
{
	HXXRETURN0(Result<Dimension>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DimensionInterface_operatorMul); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Hxx1::ConstFn<S>::operator /(const Result<Dimension>& q) const -> Result<Dimension>
{
	HXXRETURN0(Result<Dimension>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DimensionInterface_operatorDiv); 
...
{
	HXXRETURN0(Result<Dimension>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DimensionInterface_operatorXor); 
...
{
	HXXRETURN0(Result<Dimension>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DimensionInterface_Copy); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Hxx1::ConstFn<S>::GetExponent(BASE_DIMENSION q) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(DimensionInterface_GetExponent); 
...
{
	HXXRETURN0(Result<Unit>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DimensionInterface_AddUnit); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Hxx1::ConstFn<S>::GetUnits() const -> HXXADDRET2(UnitsArray)
{
	HXXRETURN0(HXXADDRET2(UnitsArray)); HXXRES; HXXCONST(HXXRET3(NULLPTR, UnitsArray)) HXXTABLE(DimensionInterface_GetUnits); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Hxx1::ConstFn<S>::IsEquivalent(const Dimension& other) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) HXXTABLE(DimensionInterface_IsEquivalent); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DimensionInterface::Hxx1::ConstFn<S>::ToString(const FormatStatement* fs) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(HXXRET3(NULLPTR, String)) HXXTABLE(DimensionInterface_ToString); 
...
struct UnitInterface::Hxx2
{
	...
	public:
		...
		static void UnitInterface_Free(const UnitInterface* object) { return S::Free(object); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_GetId, UnitInterface, const, (const Id&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->GetId(); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_GetDimension, UnitInterface, const, (const Dimension&)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->GetDimension(); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_GetSIConversionFactor, UnitInterface, const, (Float)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->GetSIConversionFactor(); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_operatorMul, UnitInterface, const, (Result<Unit>), const Result<Unit>& u) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->operator *(u); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_operatorDiv, UnitInterface, const, (Result<Unit>), const Result<Unit>& u) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->operator /(u); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_operatorXor, UnitInterface, const, (Result<Unit>), Int exponent) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->operator ^(exponent); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_Copy, UnitInterface, const, (Result<Unit>), const Id& uid) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->Copy(uid); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_Copy_1, UnitInterface, const, (Result<Unit>), const Dimension& quantity) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->Copy(quantity); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_AddToDimension, UnitInterface, const, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->AddToDimension(); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_Reduce, UnitInterface, const, (Result<Unit>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->Reduce(); }
		PRIVATE_MAXON_MF_WRAPPER(UnitInterface_ToString, UnitInterface, const, (String), const FormatStatement* fs) { return S::Get(PRIVATE_MAXON_MF_THIS(const UnitInterface))->ToString(fs); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::Hxx1::ConstFn<S>::GetId() const -> HXXADDRET2(const Id&)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::Hxx1::ConstFn<S>::GetDimension() const -> HXXADDRET2(const Dimension&)
{
	HXXRETURN0(HXXADDRET2(const Dimension&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const Dimension&)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.UnitInterface_GetDimension));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::Hxx1::ConstFn<S>::GetSIConversionFactor() const -> HXXADDRET2(Float)
{
...
{
	HXXRETURN0(Result<Unit>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UnitInterface::Hxx1::ConstFn<S>::ToString(const FormatStatement* fs) const -> HXXADDRET2(String)
{
