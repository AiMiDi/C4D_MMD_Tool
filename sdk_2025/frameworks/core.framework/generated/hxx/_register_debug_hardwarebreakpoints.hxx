...
namespace maxon
{
	...
	public:
		...
		static Result<DebugHardwareBreakPointRef> SetHardwareBreakpoint(HARDWAREBREAKPOINTTYPE type, HARDWAREBREAKPOINTSIZE size, void* watchAddress) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return DebugHardwareBreakPointInterface::SetHardwareBreakpoint(type, size, watchAddress); return HXXRET1(UNRESOLVED);}
		Result<void> RemoveHardwareBreakpoint() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return ((DebugHardwareBreakPointInterface*) this)->RemoveHardwareBreakpoint(); return HXXRET1(UNRESOLVED);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE DebugHardwareBreakPointInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<Result<DebugHardwareBreakPointRef>>::value,
	...
	maxon::Bool DebugHardwareBreakPointInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#else
		tbl->DebugHardwareBreakPointInterface_Free = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_Free), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_Free);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<DebugHardwareBreakPointRef>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DebugHardwareBreakPointInterface_SetHardwareBreakpoint = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_SetHardwareBreakpoint), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_SetHardwareBreakpoint);
		#else
		tbl->DebugHardwareBreakPointInterface_SetHardwareBreakpoint = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_SetHardwareBreakpoint), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_SetHardwareBreakpoint);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<void>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint);
		#else
		tbl->DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint = PRIVATE_MAXON_MF_CAST(decltype(DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint), &Hxx2::Wrapper<Hxx2::Unresolved>::DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	MAXON_INTERFACE_REGISTER(DebugHardwareBreakPointInterface, "net.maxon.interface.debughardwarebreakpoint", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
