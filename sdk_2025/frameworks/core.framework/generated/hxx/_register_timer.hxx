...
/// @endcond
	...
	const maxon::Char* const TimerInterface::MTable::_ids = 
		...
		"ObservableTimerStarted@b05c762d3149fb7a\0" // maxon::ObservableRef<ObservableTimerStartedDelegate> ObservableTimerStarted(maxon::Bool create) const
		"ObservableTimerFinished@194563839e975b31\0" // maxon::ObservableRef<ObservableTimerFinishedDelegate> ObservableTimerFinished(maxon::Bool create) const
		"ObservableTimerOverload@ca6aba18ebfb7525\0" // maxon::ObservableRef<ObservableTimerOverloadDelegate> ObservableTimerOverload(maxon::Bool create) const
/// @cond IGNORE
...
/// @endcond
	...
	public:
		...
		maxon::ObservableRef<ObservableTimerStartedDelegate> ObservableTimerStarted(maxon::Bool create) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const TimerInterface*) this)->ObservableTimerStarted(create); return maxon::ObservableRef<ObservableTimerStartedDelegate>::DefaultValue();}
		maxon::ObservableRef<ObservableTimerFinishedDelegate> ObservableTimerFinished(maxon::Bool create) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const TimerInterface*) this)->ObservableTimerFinished(create); return maxon::ObservableRef<ObservableTimerFinishedDelegate>::DefaultValue();}
		maxon::ObservableRef<ObservableTimerOverloadDelegate> ObservableTimerOverload(maxon::Bool create) const { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return ((const TimerInterface*) this)->ObservableTimerOverload(create); return maxon::ObservableRef<ObservableTimerOverloadDelegate>::DefaultValue();}
/// @cond IGNORE
