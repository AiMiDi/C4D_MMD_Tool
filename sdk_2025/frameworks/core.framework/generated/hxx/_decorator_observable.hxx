...
public:
	...
	{
		return maxon::Cast<ObservableBaseRef>(self.GetDecoratedObject()).PrivateDisconnectAll(observer, pass);
	}
	...
	{
		return maxon::Cast<ObservableBaseRef>(self.GetDecoratedObject()).AddObserver(observer, observerFunction, priority);
	}
