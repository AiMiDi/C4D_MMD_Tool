...
/// -param[in] ta									For which audience is the string intended.
		inline HXXADDRET2(maxon::ObservableRef<ObservableLoggerNotifyDelegate>) ObservableLoggerNotify(maxon::Bool create) const;
	};
	/// Intermediate helper class for LoggerTypeInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LoggerTypeInterface, maxon::StrongRefHandler, LoggerTypeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LoggerTypeInterface, maxon::StrongRefHandler, LoggerTypeRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileLoggerTypeInterface, maxon::StrongRefHandler, FileLoggerTypeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileLoggerTypeInterface, maxon::StrongRefHandler, FileLoggerTypeRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UserLoggerTypeInterface, maxon::StrongRefHandler, UserLoggerTypeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UserLoggerTypeInterface, maxon::StrongRefHandler, UserLoggerTypeRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
/// -param[in] logger							The new logger
		static inline maxon::ObservableRef<ObservableLoggerNewDelegate> ObservableLoggerNew(maxon::Bool create);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LoggerInterface, maxon::StrongRefHandler, LoggerRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LoggerInterface, maxon::StrongRefHandler, LoggerRef>>>>);
	using NonConst = typename Super::ReferenceClass;
/// Allocates a logger.
