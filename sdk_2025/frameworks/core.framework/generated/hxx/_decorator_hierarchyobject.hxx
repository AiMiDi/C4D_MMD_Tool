...
public:
	...
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).GetBranchId();
	}

	MAXON_METHOD void SetLocking(const Bool locking)
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).SetLocking(locking);
	}

	MAXON_METHOD Bool IsLocked() const
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).IsLocked();
	}
	...
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).GetParentPtr();
	}
	...
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).GetFirst();
	}

	MAXON_METHOD typename HIERARCHY::template Sibling<Interface>::type GetLast() const
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).GetLast();
	}
	...
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).FindNextLeaf(stopAtParent);
	}

	MAXON_METHOD maxon::ObservableRef<ObservableHierarchyInsertDelegate> ObservableHierarchyInsert(maxon::Bool create) const
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).ObservableHierarchyInsert(create);
	}

	MAXON_METHOD maxon::ObservableRef<ObservableHierarchyRemoveDelegate> ObservableHierarchyRemove(maxon::Bool create) const
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).ObservableHierarchyRemove(create);
	}

	MAXON_METHOD void FlushBranches()
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).FlushBranches();
	}
