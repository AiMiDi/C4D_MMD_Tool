...
class OperationCancelledErrorDecoratorImpl : public maxon::Component<OperationCancelledErrorDecoratorImpl, OperationCancelledErrorInterface, maxon::DecoratorInterface>
{
	MAXON_COMPONENT();
