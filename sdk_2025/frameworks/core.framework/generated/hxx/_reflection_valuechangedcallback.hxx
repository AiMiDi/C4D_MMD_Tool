...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ValueChangedCallbackInterface);
	...
	public:
		...
		Result<void> ValueChangedMessage(const InternedId& id) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ValueChangedCallbackInterface_ValueChangedMessage_Offset), maxon::reflection::Argument::ByReference(id)};
			(*handler_)(_fn_ValueChangedCallbackInterface_ValueChangedMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const InternedId&), reinterpret_cast<const void* const&>(mt_.ValueChangedCallbackInterface_ValueChangedMessage)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ValueChangedCallbackInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "id\0", 1LL, ValueChangedCallbackInterface, ValueChangedCallbackInterface_ValueChangedMessage),
		};
