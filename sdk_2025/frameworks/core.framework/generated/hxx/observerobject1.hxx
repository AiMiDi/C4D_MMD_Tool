...
/// -observableparam[in] sender				A pointer to the destroyed object. Do not convert this pointer into a BaseRef (see comments above).
		inline HXXADDRET2(maxon::ObservableRef<ObserverDestroyedDelegate>) ObserverDestroyed(maxon::Bool create) const;
...
/// -observableparam[in] observer			A reference to the connected object. This parameter can be zero.
		inline HXXADDRET2(maxon::ObservableRef<ObserverDisconnectNotifyDelegate>) ObserverDisconnectNotify(maxon::Bool create) const;
...
/// -observableparam[in] observer			A reference to the connected object. This parameter can be zero, e.g. if a lambda function is connected.
		inline HXXADDRET2(maxon::ObservableRef<ObserverConnectNotifyDelegate>) ObserverConnectNotify(maxon::Bool create) const;
	};
	/// Intermediate helper class for ObserverObjectInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ObserverObjectInterface, maxon::StrongRefHandler, ObserverObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ObserverObjectInterface, maxon::StrongRefHandler, ObserverObjectRef>>>>);
