...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservableLoggerNotifyDelegate> ObservableLoggerNotify(maxon::Bool create) const
	{
		return maxon::Cast<LoggerTypeRef>(self.GetDecoratedObject()).ObservableLoggerNotify(create);
	}
