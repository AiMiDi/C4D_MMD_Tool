...
struct JobErrorInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<JobErrorInterface, typename ErrorInterface::MTable::template CombinedMTable<S>>;
...
struct ThreadServices::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(ThreadServices_AddJob, AddJob, MAXON_EXPAND_VA_ARGS, (Result<void>), CoreJobGroup& group, const JobInterfacePOD& pod, UInt flags);
	PRIVATE_MAXON_SF_POINTER(ThreadServices_AddJobs, AddJobs, MAXON_EXPAND_VA_ARGS, (Result<void>), CoreJobGroup& group, void** memory, Int cnt, Int jobPODOffset, UInt flags);
	...
	PRIVATE_MAXON_SF_POINTER(ThreadServices_CalculatePartitions, CalculatePartitions, MAXON_EXPAND_VA_ARGS, (Int), UInt cnt, Int threadCnt, Int minChunkSize, WorkerThreadPartitions& partitions);
	PRIVATE_MAXON_SF_POINTER(ThreadServices_SetMainThreadYieldDelegate, SetMainThreadYieldDelegate, MAXON_EXPAND_VA_ARGS, (void), MainThreadYieldDelegate d);
	template <typename IMPL> void Init()
	{
		...
		ThreadServices_AddJobs = ThreadServices_AddJobs_GetPtr<IMPL>(true);
		...
		ThreadServices_CalculatePartitions = ThreadServices_CalculatePartitions_GetPtr<IMPL>(true);
		ThreadServices_SetMainThreadYieldDelegate = ThreadServices_SetMainThreadYieldDelegate_GetPtr<IMPL>(true);
	}
};
...
struct ThreadServices::Hxx2
{
	...
	public:
		...
		static Result<void> ThreadServices_Start(const JobInterfacePOD& pod, THREADPRIORITY priority) { return S::Start(pod, priority); }
		static void ThreadServices_Enqueue(const JobInterfacePOD& pod, JobQueueInterface* queue) { return S::Enqueue(pod, queue); }
		static Bool ThreadServices_Wait(const JobInterfacePOD& pod, Float64 timeout, WAITMODE mode) { return S::Wait(pod, timeout, mode); }
		static Result<void> ThreadServices_GetResult(const JobInterfacePOD& pod, Float64 timeout, WAITMODE mode) { return S::GetResult(pod, timeout, mode); }
		static Result<void> ThreadServices_Reset(const JobInterfacePOD& pod) { return S::Reset(pod); }
		static void ThreadServices_Cancel(const JobInterfacePOD& pod) { return S::Cancel(pod); }
		static Result<void> ThreadServices_AddFinishedObserver(const JobInterfacePOD& pod, const JobInterfacePOD& observerPod, JobQueueInterface* observerQueue) { return S::AddFinishedObserver(pod, observerPod, observerQueue); }
		static Result<void> ThreadServices_AddCancelledObserver(const JobInterfacePOD& pod, const JobInterfacePOD& observerPod, JobQueueInterface* observerQueue) { return S::AddCancelledObserver(pod, observerPod, observerQueue); }
		static Result<void> ThreadServices_RemoveCancelledObserver(const JobInterfacePOD& pod, const JobInterfacePOD& observerPod) { return S::RemoveCancelledObserver(pod, observerPod); }
		static Bool ThreadServices_IsRunning(const JobInterfacePOD& pod) { return S::IsRunning(pod); }
		static Bool ThreadServices_IsCancelled(const JobInterfacePOD& pod) { return S::IsCancelled(pod); }
		static void ThreadServices_AddJobReference(const JobInterfacePOD& pod) { return S::AddJobReference(pod); }
		static void ThreadServices_RemoveJobReference(const JobInterfacePOD& pod) { return S::RemoveJobReference(pod); }
		static Bool ThreadServices_CreateStrongJobReference(const JobInterfacePOD& pod) { return S::CreateStrongJobReference(pod); }
		static void ThreadServices_AddWeakJobReference(const JobInterfacePOD& pod, WeakRefBase& weakRef) { return S::AddWeakJobReference(pod, weakRef); }
		static CoreJobGroup* ThreadServices_GetGroup(const JobInterfacePOD& pod) { return S::GetGroup(pod); }
		static const JobInterface* ThreadServices_GetCurrentJob() { return S::GetCurrentJob(); }
		static const ThreadInterface* ThreadServices_GetCurrentThread() { return S::GetCurrentThread(); }
		static THREADTYPE ThreadServices_GetCurrentThreadType() { return S::GetCurrentThreadType(); }
		static THREADTYPE ThreadServices_GetCurrentThreadType_1(Int& threadIdentifier) { return S::GetCurrentThreadType(threadIdentifier); }
		static Int ThreadServices_GetCpuCount() { return S::GetCpuCount(); }
		static void* ThreadServices_GetStackEnd() { return S::GetStackEnd(); }
		static CoreJobGroup* ThreadServices_CreateGroup(Int cnt, Int jobSize, UInt flags) { return S::CreateGroup(cnt, jobSize, flags); }
		static CoreJobGroup* ThreadServices_CreateGroupForQueue(JobQueueInterface* queue, Int& cnt, Int jobSize, UInt flags) { return S::CreateGroupForQueue(queue, cnt, jobSize, flags); }
		static void ThreadServices_AddGroupReference(CoreJobGroup& group) { return S::AddGroupReference(group); }
		static void ThreadServices_RemoveGroupReference(CoreJobGroup& group) { return S::RemoveGroupReference(group); }
		static Bool ThreadServices_WaitGroup(CoreJobGroup& group, Float64 timeout, WAITMODE mode) { return S::WaitGroup(group, timeout, mode); }
		static Result<void> ThreadServices_GroupGetResult(CoreJobGroup& group, Float64 timeout, WAITMODE mode) { return S::GroupGetResult(group, timeout, mode); }
		static Result<void> ThreadServices_AddJob(CoreJobGroup& group, const JobInterfacePOD& pod, UInt flags) { return S::AddJob(group, pod, flags); }
		static Result<void> ThreadServices_AddJobs(CoreJobGroup& group, void** memory, Int cnt, Int jobPODOffset, UInt flags) { return S::AddJobs(group, memory, cnt, jobPODOffset, flags); }
		static Result<void> ThreadServices_AddGroup(CoreJobGroup& group, CoreJobGroup* subGroup) { return S::AddGroup(group, subGroup); }
		static void ThreadServices_EnqueueGroup(CoreJobGroup& group, JobQueueInterface* queue) { return S::EnqueueGroup(group, queue); }
		static Result<void> ThreadServices_EnqueueGroupAndWait(CoreJobGroup& group, JobQueueInterface* queue) { return S::EnqueueGroupAndWait(group, queue); }
		static void* ThreadServices_GetStaticJobBuffer(const CoreJobGroup& group, Int* capacity) { return S::GetStaticJobBuffer(group, capacity); }
		static Result<void> ThreadServices_GroupBatchAdd(CoreJobGroup& group, const JobInterfacePOD* first, void* memory, Int cnt, Int size) { return S::GroupBatchAdd(group, first, memory, cnt, size); }
		static Result<void> ThreadServices_AddGroupFinishedObserver(CoreJobGroup& group, const JobInterfacePOD& observerPod, JobQueueInterface* observerQueue) { return S::AddGroupFinishedObserver(group, observerPod, observerQueue); }
		static void ThreadServices_GroupCancel(CoreJobGroup& group) { return S::GroupCancel(group); }
		static void ThreadServices_GroupMarkAsFinished(CoreJobGroup& group) { return S::GroupMarkAsFinished(group); }
		static Int ThreadServices_GetCurrentWorkerThreadIndex() { return S::GetCurrentWorkerThreadIndex(); }
		static Bool ThreadServices_IsCurrentJobCancelled() { return S::IsCurrentJobCancelled(); }
		static Result<void> ThreadServices_AssimilateAlienThread() { return S::AssimilateAlienThread(); }
		static const void* ThreadServices_ThreadedExclusiveResource(Int selector, const void* resourcePtr) { return S::ThreadedExclusiveResource(selector, resourcePtr); }
		static void ThreadServices_AddJobStatusReference(const JobInterfacePOD& pod) { return S::AddJobStatusReference(pod); }
		static void ThreadServices_RemoveJobStatusReference(const JobInterfacePOD& pod) { return S::RemoveJobStatusReference(pod); }
		static void ThreadServices_DisconnectPredecessor(const JobInterfacePOD& pod, JobInterface** prev) { return S::DisconnectPredecessor(pod, prev); }
		static Int ThreadServices_CalculatePartitions(UInt cnt, Int threadCnt, Int minChunkSize, WorkerThreadPartitions& partitions) { return S::CalculatePartitions(cnt, threadCnt, minChunkSize, partitions); }
		static void ThreadServices_SetMainThreadYieldDelegate(MainThreadYieldDelegate d) { return S::SetMainThreadYieldDelegate(std::forward<MainThreadYieldDelegate>(d)); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ThreadServices::AddJob(CoreJobGroup& group, const JobInterfacePOD& pod, UInt flags) -> Result<void>
{
	return MTable::_instance.ThreadServices_AddJob(group, pod, flags);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ThreadServices::AddJobs(CoreJobGroup& group, void** memory, Int cnt, Int jobPODOffset, UInt flags) -> Result<void>
{
	return MTable::_instance.ThreadServices_AddJobs(group, memory, cnt, jobPODOffset, flags);
}
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ThreadServices::CalculatePartitions(UInt cnt, Int threadCnt, Int minChunkSize, WorkerThreadPartitions& partitions) -> Int
{
	return MTable::_instance.ThreadServices_CalculatePartitions(cnt, threadCnt, minChunkSize, partitions);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ThreadServices::SetMainThreadYieldDelegate(MainThreadYieldDelegate d) -> void
{
	return MTable::_instance.ThreadServices_SetMainThreadYieldDelegate(std::forward<MainThreadYieldDelegate>(d));
}
