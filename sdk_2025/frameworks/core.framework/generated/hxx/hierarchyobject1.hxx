#if 1
struct HierarchyObjectInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, HierarchyObjectInterface>::value || ObserverObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(HierarchyObjectInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct HierarchyObjectInterface::Hxx1
{
	...
	template <typename S, typename HIERARCHY_> class ConstFn DOXYGEN_SWITCH_REVERSED(, : public S)
	{
	public:
		ConstFn() = default;
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = HierarchyObjectInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(HierarchyObjectInterface**);
		using HIERARCHY = HIERARCHY_;
		using S::GenericVarianceCheck;
		template <typename _S> static typename std::integral_constant<bool, true>::type GenericVarianceCheck(const ConstFn<_S, HIERARCHY_>*);
		template <typename _S> static typename std::true_type GenericVarianceCheck(ConstFn<_S, DefaultHierarchy<void>>*);
...
/// @return												Child object or nullptr if not available.
		inline HXXADDRET2(typename HIERARCHY_::template Child<maxon::details::GetPrivateReferencedType<S>>::type) GetFirstChild(const ConstDataPtr& branchId = ConstDataPtr()) const;
/// Returns the last child of this object.
/// @param[in] branchId           The branch.
/// @return												Child object or nullptr if not available.
		inline HXXADDRET2(typename HIERARCHY_::template Child<maxon::details::GetPrivateReferencedType<S>>::type) GetLastChild(const ConstDataPtr& branchId = ConstDataPtr()) const;
/// Returns the n'th child of this object.
/// @param[in] position						The child position.
/// @param[in] branchId           The branch.
/// @return												Child object or nullptr if not available.
		inline HXXADDRET2(typename HIERARCHY_::template Child<maxon::details::GetPrivateReferencedType<S>>::type) GetChildAt(Int position, const ConstDataPtr& branchId = ConstDataPtr()) const;
...
/// Returns the branch the object belongs to.
		inline HXXADDRET2(ConstDataPtr) GetBranchId() const;
/// Get the locking of an object.
/// If the object is locked it cannot be removed or changed in the hierarchy.
/// @return                        True if locked.
		inline HXXADDRET2(Bool) IsLocked() const;
/// Returns the parent of this object.
		inline HXXADDRET2(typename HIERARCHY_::template Parent<maxon::details::GetPrivateReferencedType<S>>::type) GetParent() const;
		inline HXXADDRET2(std::add_pointer<HierarchyObjectInterface>::type) GetParentPtr() const;
/// Returns the next sibling of this object.
		inline HXXADDRET2(typename HIERARCHY_::template Sibling<maxon::details::GetPrivateReferencedType<S>>::type) GetNext() const;
/// Returns the previous sibling of this object.
		inline HXXADDRET2(typename HIERARCHY_::template Sibling<maxon::details::GetPrivateReferencedType<S>>::type) GetPrev() const;
/// Returns the first sibling of this chain.
/// If the object is already the first element the object is returned;
		inline HXXADDRET2(typename HIERARCHY_::template Sibling<Interface>::type) GetFirst() const;
/// Returns the last sibling of this chain.
/// If the object is already the first element the object is returned;
		inline HXXADDRET2(typename HIERARCHY_::template Sibling<Interface>::type) GetLast() const;
		inline HXXADDRET2(std::add_pointer<HierarchyObjectInterface>::type) FindNextLeaf(const HierarchyObjectInterface* stopAtParent) const;
...
/// -param[in] branchId           The branch the object belongs to.
		inline HXXADDRET2(maxon::ObservableRef<ObservableHierarchyInsertDelegate>) ObservableHierarchyInsert(maxon::Bool create) const;
...
/// -param[in] branchId           The branch the object belongs to.
		inline HXXADDRET2(maxon::ObservableRef<ObservableHierarchyRemoveDelegate>) ObservableHierarchyRemove(maxon::Bool create) const;
	};
	/// Intermediate helper class for HierarchyObjectInterface.
	template <typename S, typename HIERARCHY_> class Fn : public ConstFn<S, HIERARCHY_>
	{
	public:
		Fn() = default;
		using PrivateBaseClass = ConstFn<S, HIERARCHY_>;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = HierarchyObjectInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(HierarchyObjectInterface**);
		using HIERARCHY = HIERARCHY_;
...
/// If you specify a position of 1 the given children will be inserted as the first child.
///
...
/// @return												This object including the descendants hierarchy.
		inline HXXADDRET2(HierarchyObjectRef<>) Remove() const;
...
/// @return												Descendants hierarchy.
		inline HXXADDRET2(typename HIERARCHY_::template Child<maxon::details::GetPrivateReferencedType<S>>::type) RemoveChildren(const ConstDataPtr& branchId = ConstDataPtr()) const;
/// Removes all descendants from the hierarchy including all branches.
		inline HXXADDRET2(void) RemoveAllChildren() const;
/// Set the locking of an object.
/// If the object is locked it cannot be removed or changed in the hierarchy.
		inline HXXADDRET2(void) SetLocking(const Bool locking) const;
...
/// @param[in] removed						Flag if the object has been removed (true) or inserted (false).
		inline HXXADDRET2(void) ParentChanged(Bool removed) const;
/// Removes all brances in the object.
		inline HXXADDRET2(void) FlushBranches() const;
	};
	/// Intermediate helper class for HierarchyObjectInterface.
	template <typename S, typename HIERARCHY_> class COWFn : public ConstFn<S, HIERARCHY_>
	{
	public:
		COWFn() = default;
		using PrivateBaseClass = ConstFn<S, HIERARCHY_>;
		...
		using PrivateInterface = HierarchyObjectInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(HierarchyObjectInterface**);
		using HIERARCHY = HIERARCHY_;
...
/// Removes this object from the hierarchy, including all descendants.
/// @return												This object including the descendants hierarchy.
		inline HXXADDRET1(HierarchyObjectRef<>) Remove();
/// Removes all descendants from the given branch hierarchy.
/// The descendants hierarchy is returned as a reference which has the ownership of the descendants.
/// @param[in] branchId						Defines from which branch the children are removed.
/// @return												Descendants hierarchy.
		inline HXXADDRET1(typename HIERARCHY_::template Child<maxon::details::GetPrivateReferencedType<S>>::type) RemoveChildren(const ConstDataPtr& branchId = ConstDataPtr());
/// Removes all descendants from the hierarchy including all branches.
		inline HXXADDRET1(void) RemoveAllChildren();
/// Set the locking of an object.
/// If the object is locked it cannot be removed or changed in the hierarchy.
		inline HXXADDRET1(void) SetLocking(const Bool locking);
/// Is invoked whenever the parent of this object changes. This method can be overridden
/// when special actions have to be taken on such a change, for example the update of an
/// underlying hierarchy which has to be kept in sync with this hierarchy.
///
/// This method must not be invoked by user code.
/// @param[in] removed						Flag if the object has been removed (true) or inserted (false).
		inline HXXADDRET1(void) ParentChanged(Bool removed);
/// Removes all brances in the object.
		inline HXXADDRET1(void) FlushBranches();
	};
	template <typename ST, typename HIERARCHY_ = DefaultHierarchy<void>> struct FnHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWFn<typename ObserverObjectInterface::Hxx1::template FnHelper<ST>::type, HIERARCHY_>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstFn<typename ObserverObjectInterface::Hxx1::template FnHelper<ST>::type, HIERARCHY_>, Fn<typename ObserverObjectInterface::Hxx1::template FnHelper<ST>::type, HIERARCHY_>>::type
	> { };
};
template <typename HIERARCHY_> class HierarchyObjectInterface::Hxx1::Reference :
#ifdef DOXYGEN
public FnDoxy<HierarchyObjectRef<HIERARCHY_>>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<HierarchyObjectInterface, maxon::StrongRefHandler, HierarchyObjectRef<HIERARCHY_>>>, HIERARCHY_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<HierarchyObjectInterface, maxon::StrongRefHandler, HierarchyObjectRef<HIERARCHY_>>>, HIERARCHY_>>);
...
public:
	...
	using ConstPtr = typename HierarchyObjectInterface::ConstPtr;
...
class HierarchyObjectInterface::ObservableHierarchyInsertDelegate : public maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&,const ConstDataPtr&)>
{
public:
	using Super = maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&,const ConstDataPtr&)>;
...
class HierarchyObjectInterface::ObservableHierarchyRemoveDelegate : public maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&,const ConstDataPtr&)>
{
public:
	using Super = maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&,const ConstDataPtr&)>;
