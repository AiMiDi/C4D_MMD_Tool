...
struct StringInterface::Hxx2
{
	...
	public:
		...
		static void StringInterface_Free(const StringInterface* object) { return S::Free(object); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetLength, StringInterface, const, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetLength(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Init, StringInterface,, (Result<void>), Int count, Utf32Char fillChar) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Init(count, fillChar); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Shrink, StringInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Shrink(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Append, StringInterface,, (Result<void>), const StringInterface* str) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Append(str); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Append_1, StringInterface,, (Result<void>), const Utf32Char* str, Int len) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Append(str, len); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_FindIndex, StringInterface, const, (Int), const StringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->FindIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_FindLastIndex, StringInterface, const, (Int), const StringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->FindLastIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_FindIndex_1, StringInterface, const, (Int), Utf32Char ch, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->FindIndex(ch, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_FindLastIndex_1, StringInterface, const, (Int), Utf32Char ch, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->FindLastIndex(ch, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_FindUpperIndex, StringInterface, const, (Int), const StringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->FindUpperIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_FindLastUpperIndex, StringInterface, const, (Int), const StringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->FindLastUpperIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Erase, StringInterface,, (Result<void>), StringPosition position, StringCount count) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Erase(std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Insert, StringInterface,, (Result<void>), StringPosition position, const StringInterface* str, StringPosition strStart, StringCount strCount) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Insert(std::forward<StringPosition>(position), str, std::forward<StringPosition>(strStart), std::forward<StringCount>(strCount)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Insert_1, StringInterface,, (Result<void>), StringPosition position, Utf32Char ch) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Insert(std::forward<StringPosition>(position), ch); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetPart, StringInterface, const, (StringInterface*), StringPosition start, StringCount count) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetPart(std::forward<StringPosition>(start), std::forward<StringCount>(count)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_ToUpper, StringInterface, const, (StringInterface*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->ToUpper(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_ToLower, StringInterface, const, (StringInterface*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->ToLower(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_ComparePart, StringInterface, const, (COMPARERESULT), const StringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->ComparePart(str, mode, std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetHashCode, StringInterface, const, (HashInt)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetUniqueHashCode, StringInterface, const, (UniqueHash)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetUniqueHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_SetChar, StringInterface,, (void), Int pos, Utf32Char ch) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->SetChar(pos, ch); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetChar, StringInterface, const, (Utf32Char), Int pos) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetChar(pos); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetUtf32, StringInterface, const, (Result<void>), Utf32CharBuffer& stringData) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetUtf32(stringData); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_TrimLeft, StringInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->TrimLeft(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_TrimRight, StringInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->TrimRight(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Split, StringInterface, const, (Result<void>), const String& splitSymbol, Bool trim, const ValueReceiver<const String&>& parts) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->Split(splitSymbol, trim, parts); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Replace, StringInterface,, (Result<Int>), Utf32Char find, Utf32Char replace) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Replace(find, replace); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Replace_1, StringInterface,, (Result<Int>), const String& find, const String& replace) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Replace(find, replace); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Replace_2, StringInterface,, (Result<Int>), Utf32Char find, const String& replace) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->Replace(find, replace); }
		static StringInterface* StringInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		static StringInterface* StringInterface_Alloc_1(const maxon::SourceLocation& allocLocation, const StringInterface& object) { return S::Alloc(allocLocation, ((const S&) object)); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetCStringBlock, StringInterface, const, (Result<Int>), const Block<Char>& buffer, const StringEncodingRef& stringEncoding) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetCStringBlock(buffer, stringEncoding); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetCStringAppendArray, StringInterface, const, (Result<void>), const NonConstArray<Char>& array, const StringEncodingRef& stringEncoding) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetCStringAppendArray(array, stringEncoding); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetCString, StringInterface, const, (Result<BaseArray<Char>>), const StringEncodingRef& stringEncoding) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetCString(stringEncoding); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_SetCString, StringInterface,, (Result<void>), const Char* buffer, Int count, const StringDecodingRef& stringDecoding) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->SetCString(buffer, count, stringDecoding); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetSystemEncoding, StringInterface, const, (Result<SysCharArray>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetSystemEncoding(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_SetSystemEncoding, StringInterface,, (Result<void>), const SysChar* buffer, Int count) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->SetSystemEncoding(buffer, count); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_SetUtf32, StringInterface,, (Result<void>), const Utf32Char* buffer, Int count) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->SetUtf32(buffer, count); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetUtf16, StringInterface, const, (Result<void>), Utf16CharBuffer& stringData) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetUtf16(stringData); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_SetUtf16, StringInterface,, (Result<void>), const Utf16Char* buffer, Int count) { return S::Get(PRIVATE_MAXON_MF_THIS(StringInterface))->SetUtf16(buffer, count); }
		static const String& StringInterface_GetAndCacheConstString(const wchar_t* chr, Int len) { return S::GetAndCacheConstString(chr, len); }
		static const String& StringInterface_GetAndCacheConstString_1(const Char* chr, Int len, Int isUtf8) { return S::GetAndCacheConstString(chr, len, isUtf8); }
		static String StringInterface_PrivateEnumToString(const EnumInfo& info, UInt64 value, const FormatStatement* formatStatement) { return S::PrivateEnumToString(info, value, formatStatement); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetVariableInternalData, StringInterface, const, (StridedBlock<const Generic>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetVariableInternalData(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_GetCharacterWidth, StringInterface, const, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->GetCharacterWidth(); }
		PRIVATE_MAXON_MF_WRAPPER(StringInterface_Prettify, StringInterface, const, (Result<String>), Int indent, const String& indentStr, Int breakUpThreshold, Bool angularBrackets) { return S::Get(PRIVATE_MAXON_MF_THIS(const StringInterface))->Prettify(indent, indentStr, breakUpThreshold, angularBrackets); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::GetLength() const -> HXXADDRET2(Int)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindIndex(const StringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_FindIndex, str, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindLastIndex(const StringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_FindLastIndex, str, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindIndex(Utf32Char ch, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_FindIndex_1, ch, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindLastIndex(Utf32Char ch, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_FindLastIndex_1, ch, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindUpperIndex(const StringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_FindUpperIndex, str, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindLastUpperIndex(const StringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::GetPart(StringPosition start, StringCount count) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(String::DefaultValue()) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::ToUpper() const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(String::DefaultValue()) 
	return String(PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_ToUpper));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::ToLower() const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(String::DefaultValue()) 
	return String(PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_ToLower));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::ComparePart(const StringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) const -> HXXADDRET2(COMPARERESULT)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::Compare(const StringInterface* str, STRINGCOMPARISON mode) const -> HXXADDRET2(COMPARERESULT)
{
	HXXRETURN0(HXXADDRET2(COMPARERESULT)); HXXRES; HXXCONST(HXXRET3(NULLPTR, COMPARERESULT)) 
	return (o_->Compare(str, mode));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::IsEqual(const StringInterface* str) const -> HXXADDRET2(Bool)
{
...
{
	HXXRETURN0(Result<Float64>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<Float32>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<Float>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<Int32>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<UInt64>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<UInt32>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<UInt>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXNORES("StringInterface::AppendInt"); HXXNONCONST(, , false, this->PrivateGetRefMember()) 
...
{
	HXXNORES("StringInterface::AppendInt"); HXXNONCONST(, MakeWritable(true)., true, this->PrivateGetRefMember()) 
	if (o_->AppendInt(v) == nullptr) this->ResetReference();
	return this->PrivateGetRefMember();
}
...
{
	HXXNORES("StringInterface::AppendUInt"); HXXNONCONST(, , false, this->PrivateGetRefMember()) 
...
{
	HXXNORES("StringInterface::AppendUInt"); HXXNONCONST(, MakeWritable(true)., true, this->PrivateGetRefMember()) 
	if (o_->AppendUInt(v) == nullptr) this->ResetReference();
	return this->PrivateGetRefMember();
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::Find(const String& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->Find(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindLast(const String& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindLast(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::Find(Utf32Char ch, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->Find(ch, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindLast(Utf32Char ch, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindLast(ch, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindUpper(const String& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindUpper(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::FindLastUpper(const String& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindLastUpper(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::GetLeftPart(StringPosition start) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(String::DefaultValue()) 
	return String(o_->GetLeftPart(std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::GetRightPart(StringPosition start) const -> HXXADDRET2(String)
{
	HXXRETURN0(HXXADDRET2(String)); HXXRES; HXXCONST(String::DefaultValue()) 
	return String(o_->GetRightPart(std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::StartsWith(Utf32Char ch) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->StartsWith(ch));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::StartsWith(const String& str) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->StartsWith(str));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::EndsWith(Utf32Char ch) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->EndsWith(ch));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::EndsWith(const String& str) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
...
{
	HXXRETURN0(Result<BaseArray<Char>>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<SysCharArray>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::GetVariableInternalData() const -> HXXADDRET2(StridedBlock<const Generic>)
{
	HXXRETURN0(HXXADDRET2(StridedBlock<const Generic>)); HXXRES; HXXCONST(HXXRET3(NULLPTR, StridedBlock<const Generic>)) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_GetVariableInternalData));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::GetCharacterWidth() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.StringInterface_GetCharacterWidth));
}
template <typename S> template <typename SCR> MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::Hxx1::ConstFn<S>::ConvertString(const SCR& converter) const -> Result<String>
{
	HXXRETURN0(Result<String>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) 
	return (o_->ConvertString<SCR>(converter));
}
...
#if defined(MAXON_API) || defined(PRIVATE_MODULE_net_maxon_kernel)
...
#elif !defined(PRIVATE_MODULE_net_maxon_kernel_DEPENDENCY)
#define PRIVATE_MODULE_net_maxon_kernel_DEPENDENCY
MAXON_DEPENDENCY_ON_MODULE("net.maxon.kernel");
#endif
...
struct CStringInterface::Hxx2
{
	...
	public:
		using Implementation = S;
		static void CStringInterface_Free(const CStringInterface* object) { return S::Free(object); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetLength, CStringInterface, const, (Int)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetLength(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Init, CStringInterface,, (Result<void>), Int count, Char fillChar) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Init(count, fillChar); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Shrink, CStringInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Shrink(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Append, CStringInterface,, (Result<void>), const CStringInterface* str) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Append(str); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Append_1, CStringInterface,, (Result<void>), const Char* str, Int len) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Append(str, len); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_FindIndex, CStringInterface, const, (Int), const CStringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->FindIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_FindLastIndex, CStringInterface, const, (Int), const CStringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->FindLastIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_FindIndex_1, CStringInterface, const, (Int), Char ch, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->FindIndex(ch, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_FindLastIndex_1, CStringInterface, const, (Int), Char ch, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->FindLastIndex(ch, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_FindUpperIndex, CStringInterface, const, (Int), const CStringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->FindUpperIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_FindLastUpperIndex, CStringInterface, const, (Int), const CStringInterface* str, StringPosition start) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->FindLastUpperIndex(str, std::forward<StringPosition>(start)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Erase, CStringInterface,, (Result<void>), StringPosition position, StringCount count) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Erase(std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Insert, CStringInterface,, (Result<void>), StringPosition position, const CStringInterface* str, StringPosition strStart, StringCount strCount) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Insert(std::forward<StringPosition>(position), str, std::forward<StringPosition>(strStart), std::forward<StringCount>(strCount)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Insert_1, CStringInterface,, (Result<void>), StringPosition position, Char ch) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Insert(std::forward<StringPosition>(position), ch); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetPart, CStringInterface, const, (CStringInterface*), StringPosition start, StringCount count) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetPart(std::forward<StringPosition>(start), std::forward<StringCount>(count)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_ToUpper, CStringInterface, const, (CStringInterface*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->ToUpper(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_ToLower, CStringInterface, const, (CStringInterface*)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->ToLower(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_ComparePart, CStringInterface, const, (COMPARERESULT), const CStringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->ComparePart(str, mode, std::forward<StringPosition>(position), std::forward<StringCount>(count)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetHashCode, CStringInterface, const, (HashInt)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetUniqueHashCode, CStringInterface, const, (UniqueHash)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetUniqueHashCode(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_SetChar, CStringInterface,, (void), Int pos, Char ch) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->SetChar(pos, ch); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetChar, CStringInterface, const, (Char), Int pos) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetChar(pos); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetUtf32, CStringInterface, const, (Result<void>), Utf32CharBuffer& stringData) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetUtf32(stringData); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_TrimLeft, CStringInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->TrimLeft(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_TrimRight, CStringInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->TrimRight(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Split, CStringInterface, const, (Result<void>), const CString& splitSymbol, Bool trim, const ValueReceiver<const CString&>& parts) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->Split(splitSymbol, trim, parts); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Replace, CStringInterface,, (Result<Int>), Char find, Char replace) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Replace(find, replace); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Replace_1, CStringInterface,, (Result<Int>), const CString& find, const CString& replace) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Replace(find, replace); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Replace_2, CStringInterface,, (Result<Int>), Char find, const CString& replace) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Replace(find, replace); }
		static CStringInterface* CStringInterface_Alloc(const maxon::SourceLocation& allocLocation) { return S::Alloc(allocLocation); }
		static CStringInterface* CStringInterface_Alloc_1(const maxon::SourceLocation& allocLocation, const CStringInterface& object) { return S::Alloc(allocLocation, ((const S&) object)); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetCStringBlock, CStringInterface, const, (Result<Int>), const Block<Char>& buffer) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetCStringBlock(buffer); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetCStringAppendArray, CStringInterface, const, (Result<void>), const NonConstArray<Char>& array) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetCStringAppendArray(array); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_Disconnect, CStringInterface,, (Result<Block<Char>>)) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->Disconnect(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_SetCString, CStringInterface,, (Result<void>), const Char* buffer, Int count) { return S::Get(PRIVATE_MAXON_MF_THIS(CStringInterface))->SetCString(buffer, count); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetCString, CStringInterface, const, (Result<BaseArray<Char>>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetCString(); }
		PRIVATE_MAXON_MF_WRAPPER(CStringInterface_GetInternalData, CStringInterface, const, (Block<const Char>)) { return S::Get(PRIVATE_MAXON_MF_THIS(const CStringInterface))->GetInternalData(); }
		static const CString& CStringInterface_GetAndCacheConstString(const Char* chr, Int len) { return S::GetAndCacheConstString(chr, len); }
	};
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::GetLength() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindIndex(const CStringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_FindIndex, str, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindLastIndex(const CStringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_FindLastIndex, str, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindIndex(Char ch, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_FindIndex_1, ch, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindLastIndex(Char ch, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_FindLastIndex_1, ch, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindUpperIndex(const CStringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_FindUpperIndex, str, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindLastUpperIndex(const CStringInterface* str, StringPosition start) const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(InvalidArrayIndex) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::GetPart(StringPosition start, StringCount count) const -> HXXADDRET2(CString)
{
	HXXRETURN0(HXXADDRET2(CString)); HXXRES; HXXCONST(CString::DefaultValue()) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::ToUpper() const -> HXXADDRET2(CString)
{
	HXXRETURN0(HXXADDRET2(CString)); HXXRES; HXXCONST(CString::DefaultValue()) 
	return CString(PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_ToUpper));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::ToLower() const -> HXXADDRET2(CString)
{
	HXXRETURN0(HXXADDRET2(CString)); HXXRES; HXXCONST(CString::DefaultValue()) 
	return CString(PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_ToLower));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::ComparePart(const CStringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) const -> HXXADDRET2(COMPARERESULT)
{
	HXXRETURN0(HXXADDRET2(COMPARERESULT)); HXXRES; HXXCONST(HXXRET3(NULLPTR, COMPARERESULT)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::Compare(const CStringInterface* str, STRINGCOMPARISON mode) const -> HXXADDRET2(COMPARERESULT)
{
	HXXRETURN0(HXXADDRET2(COMPARERESULT)); HXXRES; HXXCONST(HXXRET3(NULLPTR, COMPARERESULT)) 
	return (o_->Compare(str, mode));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::IsEqual(const CStringInterface* str) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->IsEqual(str));
}
...
{
	HXXNORES("CStringInterface::AppendInt"); HXXNONCONST(, , false, this->PrivateGetRefMember()) 
	if (o_->AppendInt(v) == nullptr) this->ResetReference();
	return this->PrivateGetRefMember();
}
...
{
	HXXNORES("CStringInterface::AppendInt"); HXXNONCONST(, MakeWritable(true)., true, this->PrivateGetRefMember()) 
	if (o_->AppendInt(v) == nullptr) this->ResetReference();
	return this->PrivateGetRefMember();
}
...
{
	HXXNORES("CStringInterface::AppendUInt"); HXXNONCONST(, , false, this->PrivateGetRefMember()) 
	if (o_->AppendUInt(v) == nullptr) this->ResetReference();
	return this->PrivateGetRefMember();
}
...
{
	HXXNORES("CStringInterface::AppendUInt"); HXXNONCONST(, MakeWritable(true)., true, this->PrivateGetRefMember()) 
	if (o_->AppendUInt(v) == nullptr) this->ResetReference();
	return this->PrivateGetRefMember();
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::Find(const CString& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->Find(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindLast(const CString& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindLast(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::Find(Char ch, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->Find(ch, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindLast(Char ch, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindLast(ch, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindUpper(const CString& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindUpper(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::FindLastUpper(const CString& str, Int* pos, StringPosition start) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->FindLastUpper(str, pos, std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::GetLeftPart(StringPosition start) const -> HXXADDRET2(CString)
{
	HXXRETURN0(HXXADDRET2(CString)); HXXRES; HXXCONST(CString::DefaultValue()) 
	return CString(o_->GetLeftPart(std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::GetRightPart(StringPosition start) const -> HXXADDRET2(CString)
{
	HXXRETURN0(HXXADDRET2(CString)); HXXRES; HXXCONST(CString::DefaultValue()) 
	return CString(o_->GetRightPart(std::forward<StringPosition>(start)));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::StartsWith(Char ch) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->StartsWith(ch));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::StartsWith(const CString& str) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->StartsWith(str));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::EndsWith(Char ch) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->EndsWith(ch));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::EndsWith(const CString& str) const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) 
	return (o_->EndsWith(str));
}
...
{
	HXXRETURN0(Result<Block<Char>>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) 
...
{
	HXXRETURN0(Result<Block<Char>>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (PRIVATE_MAXON_MF_INVOKE((o_), MTable::_instance.CStringInterface_Disconnect));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto CStringInterface::Hxx1::ConstFn<S>::GetInternalData() const -> HXXADDRET2(Block<const Char>)
{
	HXXRETURN0(HXXADDRET2(Block<const Char>)); HXXRES; HXXCONST(HXXRET3(NULLPTR, Block<const Char>)) 
