...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const SystemProcessKilledErrorInterface, maxon::StrongCOWRefHandler, SystemProcessKilledError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const SystemProcessKilledErrorInterface, maxon::StrongCOWRefHandler, SystemProcessKilledError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemProcessKilledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemProcessKilledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] SystemProcessKilledError : public SystemProcessKilledErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(SystemProcessKilledError, SystemProcessKilledErrorObject, "net.maxon.error.systemprocesskilled",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const SystemProcessOperationErrorInterface, maxon::StrongCOWRefHandler, SystemProcessOperationError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const SystemProcessOperationErrorInterface, maxon::StrongCOWRefHandler, SystemProcessOperationError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemProcessOperationErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemProcessOperationErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] SystemProcessOperationError : public SystemProcessOperationErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(SystemProcessOperationError, SystemProcessOperationErrorObject, "net.maxon.error.systemprocessoperation",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
/// @return												ObservableRef to operate on.
		inline HXXADDRET2(maxon::ObservableRef<ObservableProcessFinishedDelegate>) ObservableProcessFinished(maxon::Bool create) const;
/// Gets an array of all loaded dlls for this process.
/// @return												Result of the value receiver (true/false).
		inline Result<Bool> GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) const;
	};
	/// Intermediate helper class for SystemProcessObjectInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemProcessObjectInterface, maxon::StrongRefHandler, SystemProcessObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SystemProcessObjectInterface, maxon::StrongRefHandler, SystemProcessObjectRef>>>>);
