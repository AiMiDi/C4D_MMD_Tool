...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_System(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(System::MTable::_instance.System_AddEpochObserver)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "data\0observer\0", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(System::MTable::_instance.System_PrivateHasherFinalize)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "state\0", 0LL, nullptr),
