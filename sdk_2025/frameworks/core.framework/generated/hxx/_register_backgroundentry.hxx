...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BackgroundEntryInterface, , "net.maxon.interface.backgroundentry", (ObjectInterface::PrivateGetInterface()));
	template <typename DUMMY> maxon::Int BackgroundEntryInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<STATE>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<String>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<TimeValue>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<UniversalDateTime>(OVERLOAD_MAX_RANK)
		;
	}
	namespace enum93
	{
	...
	{
	public:
		static BackgroundProgressRef GetMaster() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_staticInterface, true)) return BackgroundProgressInterface::GetMaster(); return HXXRET3(UNRESOLVED, BackgroundProgressRef);}
	};
	MAXON_WARNING_POP
#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	const maxon::UNRESOLVED_RETURN_TYPE BackgroundProgressInterface::Hxx2::StaticMTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<BackgroundProgressRef>::value,
	...
	maxon::Bool BackgroundProgressInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if constexpr (maxon::details::UnresolvedReturnType<BackgroundProgressRef>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->BackgroundProgressInterface_GetMaster = PRIVATE_MAXON_MF_CAST(decltype(BackgroundProgressInterface_GetMaster), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::BackgroundProgressInterface_GetMaster);
		#else
		tbl->BackgroundProgressInterface_GetMaster = PRIVATE_MAXON_MF_CAST(decltype(BackgroundProgressInterface_GetMaster), &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::BackgroundProgressInterface_GetMaster);
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	const maxon::Char* const BackgroundProgressInterface::MTable::_ids = 
		...
		"ObservableStateChanged@e816648975c071a7\0" // maxon::ObservableRef<ObservableStateChangedDelegate> ObservableStateChanged(maxon::Bool create) const
		"ObservableTotalProgressNotification@b88cd983351f1c9c\0" // maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> ObservableTotalProgressNotification(maxon::Bool create) const
	"";
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL(BackgroundProgressInterface, BackgroundProgressInterface, , , "net.maxon.interface.backgroundprogress", (ProgressInterface::PrivateGetInterface()), (BackgroundEntryInterface::PrivateGetInterface()), nullptr);
	...
	template <typename DUMMY> maxon::Int BackgroundProgressInterface::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<BackgroundProgressRef>(OVERLOAD_MAX_RANK)
		;
	}
...
static maxon::details::ForceEvaluation s_forceEval_backgroundentry(0
	| maxon::BackgroundEntryInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
	| maxon::BackgroundProgressInterface::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
