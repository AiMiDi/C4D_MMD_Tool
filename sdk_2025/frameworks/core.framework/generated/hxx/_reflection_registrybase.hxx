...
/// @cond INTERNAL
	...
	static maxon::Result<void> RegisterReflection_RegistryEntryIteratorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(RegistryEntryIteratorInterface::MTable::_instance.RegistryEntryIteratorInterface_GetEntry)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "type\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(RegistryEntryIteratorInterface::MTable::_instance.RegistryEntryIteratorInterface_GetEntry_1)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_RegistryInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(RegistryInterface::MTable::_instance.RegistryInterface_FindEntryValue)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "registry\0eid\0type\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(RegistryInterface::MTable::_instance.RegistryInterface_FindEntryValue_1)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "registry\0eid\0", 0LL, nullptr),
