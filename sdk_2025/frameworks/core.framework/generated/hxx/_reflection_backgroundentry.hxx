...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(BackgroundEntryInterface);
	...
	public:
		...
		String GetName() const 
		{
			...
			(*handler_)(_fn_BackgroundEntryInterface_GetName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((String)), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_GetName)));
			return proxy_result;
		}
		...
		UniversalDateTime GetStartTime() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<BackgroundEntryInterface>();
			UniversalDateTime proxy_result = HXXRET3(NULLIMPL, UniversalDateTime);
			...
			(*handler_)(_fn_BackgroundEntryInterface_GetStartTime, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((UniversalDateTime)), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_GetStartTime)));
			return proxy_result;
		}
		...
		TimeValue GetDuration() const 
		{
			...
			(*handler_)(_fn_BackgroundEntryInterface_GetDuration, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((TimeValue)), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_GetDuration)));
			return proxy_result;
		}
		...
		STATE GetState() 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<BackgroundEntryInterface>();
			STATE proxy_result = HXXRET3(NULLIMPL, STATE);
			...
			(*handler_)(_fn_BackgroundEntryInterface_GetState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((STATE)), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_GetState)));
			return proxy_result;
		}
		...
		Result<Bool> GetStates(const ValueReceiver<STATE, const String&>& state) const 
		{
			...
			(*handler_)(_fn_BackgroundEntryInterface_GetStates, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<Bool>), const ValueReceiver<STATE, const String&>&), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_GetStates)));
			return proxy_result;
		}
		...
		Int GetStateCount() const 
		{
			...
			(*handler_)(_fn_BackgroundEntryInterface_GetStateCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_GetStateCount)));
			return proxy_result;
		}
		...
		Result<void> AddState(STATE state, const String& message) 
		{
			...
			(*handler_)(_fn_BackgroundEntryInterface_AddState, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), STATE, const String&), reinterpret_cast<const void* const&>(mt_.BackgroundEntryInterface_AddState)));
			return proxy_result;
		}
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(BackgroundProgressInterface);
	...
	public:
		...
		Result<BackgroundProgressRef> AddActiveEntry(const String& title, Bool sendToHistory) 
		{
			...
			Result<BackgroundProgressRef> proxy_result = HXXRET1(NULLIMPL);
			...
			(*handler_)(_fn_BackgroundProgressInterface_AddActiveEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<BackgroundProgressRef>), const String&, Bool), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_AddActiveEntry)));
			return proxy_result;
		}
		...
		Result<void> RemoveActiveEntry(const BackgroundProgressRef& entry) 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_RemoveActiveEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const BackgroundProgressRef&), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_RemoveActiveEntry)));
			return proxy_result;
		}
		...
		Result<Bool> GetActiveEntries(const ValueReceiver<const BackgroundProgressRef&>& entry) const 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_GetActiveEntries, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<Bool>), const ValueReceiver<const BackgroundProgressRef&>&), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_GetActiveEntries)));
			return proxy_result;
		}
		...
		Int GetActiveCount() const 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_GetActiveCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_GetActiveCount)));
			return proxy_result;
		}
		...
		Int GetHistoryCount() const 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_GetHistoryCount, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Int)), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_GetHistoryCount)));
			return proxy_result;
		}
		...
		Result<void> RemoveHistoryEntry(const BackgroundEntryRef& entry) 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_RemoveHistoryEntry, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const BackgroundEntryRef&), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_RemoveHistoryEntry)));
			return proxy_result;
		}
		...
		Result<void> ClearHistory() 
		{
			...
			(*handler_)(_fn_BackgroundProgressInterface_ClearHistory, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>)), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_ClearHistory)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_BackgroundProgressInterface_ClearHistory;
		maxon::ObservableRef<ObservableStateChangedDelegate> ObservableStateChanged(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<BackgroundProgressInterface>();
			maxon::ObservableRef<ObservableStateChangedDelegate> proxy_result = maxon::ObservableRef<ObservableStateChangedDelegate>::DefaultValue();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.BackgroundProgressInterface_ObservableStateChanged_Offset), maxon::reflection::Argument::ByValue(create)};
			(*handler_)(_fn_BackgroundProgressInterface_ObservableStateChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableStateChangedDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_ObservableStateChanged)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_BackgroundProgressInterface_ObservableStateChanged;
		maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> ObservableTotalProgressNotification(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<BackgroundProgressInterface>();
			maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> proxy_result = maxon::ObservableRef<ObservableTotalProgressNotificationDelegate>::DefaultValue();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.BackgroundProgressInterface_ObservableTotalProgressNotification_Offset), maxon::reflection::Argument::ByValue(create)};
			(*handler_)(_fn_BackgroundProgressInterface_ObservableTotalProgressNotification, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableTotalProgressNotificationDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.BackgroundProgressInterface_ObservableTotalProgressNotification)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_BackgroundProgressInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<decltype(BackgroundProgressInterface::Hxx2::StaticMTable::_instance.BackgroundProgressInterface_GetMaster)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_BackgroundProgressInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "create\0", 0LL, BackgroundProgressInterface, BackgroundProgressInterface_ObservableStateChanged),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "create\0", 0LL, BackgroundProgressInterface, BackgroundProgressInterface_ObservableTotalProgressNotification),
		};
