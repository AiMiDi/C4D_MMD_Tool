...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> ObservablePrivateSplashMessageReceived(maxon::Bool create) const
	{
		return maxon::Cast<MachineRef>(self.GetDecoratedObject()).ObservablePrivateSplashMessageReceived(create);
	}

	MAXON_METHOD maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged(maxon::Bool create) const
	{
		return maxon::Cast<MachineRef>(self.GetDecoratedObject()).ObservableActivationChanged(create);
	}
