...
struct SymbolificationInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = SymbolificationInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SymbolificationInterface, maxon::StrongRefHandler, SymbolificationRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SymbolificationInterface, maxon::StrongRefHandler, SymbolificationRef>>>>);
