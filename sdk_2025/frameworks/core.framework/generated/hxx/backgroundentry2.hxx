...
struct BackgroundProgressInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(BackgroundProgressInterface_ObservableStateChanged, ObservableStateChanged, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableStateChangedDelegate>), maxon::Bool create);
	maxon::Int BackgroundProgressInterface_ObservableStateChanged_Offset;
	PRIVATE_MAXON_MF_POINTER(BackgroundProgressInterface_ObservableTotalProgressNotification, ObservableTotalProgressNotification, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableTotalProgressNotificationDelegate>), maxon::Bool create);
...
struct BackgroundProgressInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(BackgroundProgressInterface_ObservableStateChanged, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableStateChangedDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableStateChanged(create); }
		PRIVATE_MAXON_MF_WRAPPER(BackgroundProgressInterface_ObservableTotalProgressNotification, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableTotalProgressNotificationDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableTotalProgressNotification(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto BackgroundProgressInterface::ObservableStateChanged(maxon::Bool create) const -> maxon::ObservableRef<ObservableStateChangedDelegate>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto BackgroundProgressInterface::ObservableTotalProgressNotification(maxon::Bool create) const -> maxon::ObservableRef<ObservableTotalProgressNotificationDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BackgroundProgressInterface::Hxx1::ConstFn<S>::ObservableStateChanged(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableStateChangedDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BackgroundProgressInterface::Hxx1::ConstFn<S>::ObservableTotalProgressNotification(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableTotalProgressNotificationDelegate>)
{
