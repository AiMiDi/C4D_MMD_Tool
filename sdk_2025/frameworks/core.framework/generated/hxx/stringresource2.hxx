...
struct Resource::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(Resource_ObservableLanguageChanged, ObservableLanguageChanged, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableLanguageChangedDelegate>), maxon::Bool create);
	template <typename IMPL> void Init()
	{
...
struct Resource::Hxx2
{
	...
	public:
		...
		static maxon::ObservableRef<ObservableLanguageChangedDelegate> Resource_ObservableLanguageChanged(maxon::Bool create) { return S::ObservableLanguageChanged(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto Resource::ObservableLanguageChanged(maxon::Bool create) -> maxon::ObservableRef<ObservableLanguageChangedDelegate>
{
