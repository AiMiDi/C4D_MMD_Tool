...
struct DllInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DllInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(DllInterface**);
...
/// @return												Result of the value receiver (true/false).
		static inline Result<Bool> GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls);
...
/// @return												Url of the loaded dll.
	...
	public:
		...
		using PrivateInterface = DllInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(DllInterface**);
...
/// this has to be triggered manually after all modules have been loaded. 
	...
	public:
		...
		using PrivateInterface = DllInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(DllInterface**);
...
#ifdef DOXYGEN
public FnDoxy<DllRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DllInterface, maxon::StrongRefHandler, DllRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DllInterface, maxon::StrongRefHandler, DllRef>>>>);
...
public:
	...
	using ConstPtr = typename DllInterface::ConstPtr;
};
