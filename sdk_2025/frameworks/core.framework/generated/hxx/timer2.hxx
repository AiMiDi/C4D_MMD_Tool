...
struct TimerInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(TimerInterface_ObservableTimerStarted, ObservableTimerStarted, false, TimerInterface, const, (maxon::ObservableRef<ObservableTimerStartedDelegate>), maxon::Bool create);
	PRIVATE_MAXON_MF_POINTER(TimerInterface_ObservableTimerFinished, ObservableTimerFinished, false, TimerInterface, const, (maxon::ObservableRef<ObservableTimerFinishedDelegate>), maxon::Bool create);
	PRIVATE_MAXON_MF_POINTER(TimerInterface_ObservableTimerOverload, ObservableTimerOverload, false, TimerInterface, const, (maxon::ObservableRef<ObservableTimerOverloadDelegate>), maxon::Bool create);
/// @cond IGNORE
...
struct TimerInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(TimerInterface_ObservableTimerStarted, TimerInterface, const, (maxon::ObservableRef<ObservableTimerStartedDelegate>), maxon::Bool create) { return S::Get(PRIVATE_MAXON_MF_THIS(const TimerInterface))->ObservableTimerStarted(create); }
		PRIVATE_MAXON_MF_WRAPPER(TimerInterface_ObservableTimerFinished, TimerInterface, const, (maxon::ObservableRef<ObservableTimerFinishedDelegate>), maxon::Bool create) { return S::Get(PRIVATE_MAXON_MF_THIS(const TimerInterface))->ObservableTimerFinished(create); }
		PRIVATE_MAXON_MF_WRAPPER(TimerInterface_ObservableTimerOverload, TimerInterface, const, (maxon::ObservableRef<ObservableTimerOverloadDelegate>), maxon::Bool create) { return S::Get(PRIVATE_MAXON_MF_THIS(const TimerInterface))->ObservableTimerOverload(create); }
/// @cond IGNORE
...
MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::ObservableTimerStarted(maxon::Bool create) const -> maxon::ObservableRef<ObservableTimerStartedDelegate>
{
	return PRIVATE_MAXON_MF_INVOKE((this), MTable::_instance.TimerInterface_ObservableTimerStarted, create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::ObservableTimerFinished(maxon::Bool create) const -> maxon::ObservableRef<ObservableTimerFinishedDelegate>
{
	return PRIVATE_MAXON_MF_INVOKE((this), MTable::_instance.TimerInterface_ObservableTimerFinished, create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::ObservableTimerOverload(maxon::Bool create) const -> maxon::ObservableRef<ObservableTimerOverloadDelegate>
{
...
{
	HXXRETURN0(HXXADDRET2(DISABLE_IF_JOBREF(FN,Result<void>))); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<DISABLE_IF_JOBREF(FN,Result<void>), false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::ConstFn<S>::ObservableTimerStarted(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableTimerStartedDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::ConstFn<S>::ObservableTimerFinished(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableTimerFinishedDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto TimerInterface::Hxx1::ConstFn<S>::ObservableTimerOverload(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableTimerOverloadDelegate>)
{
