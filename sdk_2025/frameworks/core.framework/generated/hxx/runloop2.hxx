...
struct RunLoop::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(RunLoop_ObservableExitLoop, ObservableExitLoop, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableExitLoopDelegate>), maxon::Bool create);
	PRIVATE_MAXON_SF_POINTER(RunLoop_ObservableActivationChange, ObservableActivationChange, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableActivationChangeDelegate>), maxon::Bool create);
	PRIVATE_MAXON_SF_POINTER(RunLoop_ObservableRunLoopMessage, ObservableRunLoopMessage, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableRunLoopMessageDelegate>), maxon::Bool create);
...
struct RunLoop::Hxx2
{
	...
	public:
		...
		static Result<void> RunLoop_EnterLoop(Bool isInternalLoop) { return S::EnterLoop(isInternalLoop); }
		static Result<void> RunLoop_EnterLoop_1(Bool isInternalLoop, void* osSpecific) { return S::EnterLoop(isInternalLoop, osSpecific); }
		static void RunLoop_ExitLoop() { return S::ExitLoop(); }
		static void RunLoop_TriggerMainThreadQueue() { return S::TriggerMainThreadQueue(); }
		static Result<Timer*> RunLoop_AddTimer(TimeValue interval, TimeValue delay, TimeValue tolerance, TimerCallback callback, void* self) { return S::AddTimer(std::forward<TimeValue>(interval), std::forward<TimeValue>(delay), std::forward<TimeValue>(tolerance), std::forward<TimerCallback>(callback), self); }
		static void RunLoop_RemoveTimer(Timer* timer) { return S::RemoveTimer(timer); }
		static void RunLoop_GetLinuxDefaultDisplayAndScreen(void*& display, int& screen) { return S::GetLinuxDefaultDisplayAndScreen(display, screen); }
		static maxon::ObservableRef<ObservableExitLoopDelegate> RunLoop_ObservableExitLoop(maxon::Bool create) { return S::ObservableExitLoop(create); }
		static maxon::ObservableRef<ObservableActivationChangeDelegate> RunLoop_ObservableActivationChange(maxon::Bool create) { return S::ObservableActivationChange(create); }
		static maxon::ObservableRef<ObservableRunLoopMessageDelegate> RunLoop_ObservableRunLoopMessage(maxon::Bool create) { return S::ObservableRunLoopMessage(create); }
		static void** RunLoop_PrivateGetMainThreadQueueTrigger() { return S::PrivateGetMainThreadQueueTrigger(); }
		static void RunLoop_PrivateSetWaitInterval(TimeValue waitInterval) { return S::PrivateSetWaitInterval(std::forward<TimeValue>(waitInterval)); }
		static void RunLoop_PrivateSetDefaultDisplayAndScreen(void* display, int screen) { return S::PrivateSetDefaultDisplayAndScreen(display, screen); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::ObservableExitLoop(maxon::Bool create) -> maxon::ObservableRef<ObservableExitLoopDelegate>
{
	return MTable::_instance.RunLoop_ObservableExitLoop(create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::ObservableActivationChange(maxon::Bool create) -> maxon::ObservableRef<ObservableActivationChangeDelegate>
{
	return MTable::_instance.RunLoop_ObservableActivationChange(create);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto RunLoop::ObservableRunLoopMessage(maxon::Bool create) -> maxon::ObservableRef<ObservableRunLoopMessageDelegate>
{
	return MTable::_instance.RunLoop_ObservableRunLoopMessage(create);
}
