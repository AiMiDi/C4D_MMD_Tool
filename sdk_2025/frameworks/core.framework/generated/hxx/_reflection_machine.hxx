...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(MachineInterface);
	...
	public:
		...
		maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> ObservablePrivateSplashMessageReceived(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_MachineInterface_ObservablePrivateSplashMessageReceived, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.MachineInterface_ObservablePrivateSplashMessageReceived)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_MachineInterface_ObservablePrivateSplashMessageReceived;
		maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_MachineInterface_ObservableActivationChanged, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableActivationChangedDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.MachineInterface_ObservableActivationChanged)));
			return proxy_result;
		}
