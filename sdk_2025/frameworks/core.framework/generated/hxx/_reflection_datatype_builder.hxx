...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(DataTypeBuilderInterface);
	...
	static maxon::Result<void> RegisterReflection_DataTypeBuilderInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<decltype(DataTypeBuilderInterface::Hxx2::StaticMTable::_instance.DataTypeBuilderInterface_GetDataTypeName)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "dt\0category\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(DataTypeBuilderInterface::Hxx2::StaticMTable::_instance.DataTypeBuilderInterface_RecurseDataType)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "category\0dt\0parentTypeId\0globalIdentifier\0components\0", 0LL, nullptr),
		};
