...
namespace maxon
{
	...
	namespace enum590
	{
		...
		static const maxon::UInt64 ENUM_DONT_INITIALIZE_values[] = {maxon::UInt64(enum590::ENUM_DONT_INITIALIZE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_ENUM_DONT_INITIALIZE590(){ return enum590::ENUM_DONT_INITIALIZE_info; }
	namespace enum600
	{
		...
		static const maxon::UInt64 IN_PLACE_TYPE_values[] = {maxon::UInt64(enum600::IN_PLACE_TYPE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_IN_PLACE_TYPE600(){ return enum600::IN_PLACE_TYPE_info; }
...
/// @cond INTERNAL
	...
	namespace enum1782
	{
		...
		static const maxon::UInt64 TYPE_values[] = {maxon::UInt64(enum1782::TYPE::INVALID_0), maxon::UInt64(enum1782::TYPE::INTERFACE), maxon::UInt64(enum1782::TYPE::INTERFACE_NVMTABLE), maxon::UInt64(enum1782::TYPE::NONVIRTUAL_INTERFACE), maxon::UInt64(enum1782::TYPE::DECLARATION), maxon::UInt64(enum1782::TYPE::COMPONENT), maxon::UInt64(enum1782::TYPE::CLASS), maxon::UInt64(enum1782::TYPE::DATATYPE), maxon::UInt64(enum1782::TYPE::TRANSLATION_UNIT), maxon::UInt64(enum1782::TYPE::MODULE), maxon::UInt64(enum1782::TYPE::INITIALIZATION), maxon::UInt64(enum1782::TYPE::DEPENDENCY), maxon::UInt64(enum1782::TYPE::REGISTRY), maxon::UInt64(enum1782::TYPE::UNUSED), maxon::UInt64(enum1782::TYPE::GLOBAL), maxon::UInt64(enum1782::TYPE::COUNT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_TYPE1782(void*){ return enum1782::TYPE_info; }
	namespace enum1914
	{
		...
		static const maxon::UInt64 FLAGS_values[] = {maxon::UInt64(enum1914::FLAGS::NONE), maxon::UInt64(enum1914::FLAGS::CONSTRUCTED), maxon::UInt64(enum1914::FLAGS::DISABLED), maxon::UInt64(enum1914::FLAGS::INITIALIZED), maxon::UInt64(enum1914::FLAGS::INITIALIZING), maxon::UInt64(enum1914::FLAGS::INITIALIZATION_FAILED), maxon::UInt64(enum1914::FLAGS::NULL_AS_DEFAULT), maxon::UInt64(enum1914::FLAGS::USED), maxon::UInt64(enum1914::FLAGS::HIDDEN), maxon::UInt64(enum1914::FLAGS::REGISTRATION_UNIT), maxon::UInt64(enum1914::FLAGS::DEFINITION), maxon::UInt64(enum1914::FLAGS::SINGLE_BASE), maxon::UInt64(enum1914::FLAGS::IGNORE_WARNINGS), maxon::UInt64(enum1914::FLAGS::EXPLICIT), maxon::UInt64(enum1914::FLAGS::FRAMEWORK), maxon::UInt64(enum1914::FLAGS::ALLOW_MISSING_METHODS), maxon::UInt64(enum1914::FLAGS::CLASS_DEFINITION), maxon::UInt64(enum1914::FLAGS::CORE), maxon::UInt64(enum1914::FLAGS::PROXY), maxon::UInt64(enum1914::FLAGS::CLASS_PROXY), maxon::UInt64(enum1914::FLAGS::FINAL), maxon::UInt64(enum1914::FLAGS::SINGLE_IMPLEMENTATION), maxon::UInt64(enum1914::FLAGS::MAIN_DEFINITION), maxon::UInt64(enum1914::FLAGS::CALLABLE), maxon::UInt64(enum1914::FLAGS::IMPLEMENTABLE), maxon::UInt64(enum1914::FLAGS::ADAPTER), maxon::UInt64(enum1914::FLAGS::SYNTHETIC), maxon::UInt64(enum1914::FLAGS::LIVE), maxon::UInt64(enum1914::FLAGS::EXPECT_FAILURE), maxon::UInt64(enum1914::FLAGS::FRAMEWORK_REGISTRATION), maxon::UInt64(enum1914::FLAGS::MARK), maxon::UInt64(enum1914::FLAGS::PUBLIC), maxon::UInt64(enum1914::FLAGS::REFLECTION_REGISTRATION), maxon::UInt64(enum1914::FLAGS::REFERENCE_NONE), maxon::UInt64(enum1914::FLAGS::REFERENCE_POINTER), maxon::UInt64(enum1914::FLAGS::REFERENCE_CONST_POINTER), maxon::UInt64(enum1914::FLAGS::REFERENCE_NORMAL), maxon::UInt64(enum1914::FLAGS::REFERENCE_CONST), maxon::UInt64(enum1914::FLAGS::REFERENCE_COPY_ON_WRITE), maxon::UInt64(enum1914::FLAGS::REFERENCE_ALWAYS_COPY_ON_WRITE), maxon::UInt64(enum1914::FLAGS::REFERENCE_MASK), maxon::UInt64(enum1914::FLAGS::ON_CONSTRUCTION_MASK)};
		static const maxon::EnumInfo FLAGS_info{"EntityBase::FLAGS", SIZEOF(FLAGS), true, "NONE\0CONSTRUCTED\0DISABLED\0INITIALIZED\0INITIALIZING\0INITIALIZATION_FAILED\0NULL_AS_DEFAULT\0USED\0HIDDEN\0REGISTRATION_UNIT\0DEFINITION\0SINGLE_BASE\0IGNORE_WARNINGS\0EXPLICIT\0FRAMEWORK\0ALLOW_MISSING_METHODS\0CLASS_DEFINITION\0CORE\0PROXY\0CLASS_PROXY\0FINAL\0SINGLE_IMPLEMENTATION\0MAIN_DEFINITION\0CALLABLE\0IMPLEMENTABLE\0ADAPTER\0SYNTHETIC\0LIVE\0EXPECT_FAILURE\0FRAMEWORK_REGISTRATION\0MARK\0PUBLIC\0REFLECTION_REGISTRATION\0REFERENCE_NONE\0REFERENCE_POINTER\0REFERENCE_CONST_POINTER\0REFERENCE_NORMAL\0REFERENCE_CONST\0REFERENCE_COPY_ON_WRITE\0REFERENCE_ALWAYS_COPY_ON_WRITE\0REFERENCE_MASK\0ON_CONSTRUCTION_MASK\0", FLAGS_values, std::extent<decltype(FLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_FLAGS1914(void*){ return enum1914::FLAGS_info; }
	namespace details
	{
...
/// @endcond
	...
	namespace enum2262
	{
		...
		static const maxon::UInt64 SYSTEMBEHAVIORFLAGS_values[] = {maxon::UInt64(enum2262::SYSTEMBEHAVIORFLAGS::NONE), maxon::UInt64(enum2262::SYSTEMBEHAVIORFLAGS::OMIT_HELP), maxon::UInt64(enum2262::SYSTEMBEHAVIORFLAGS::DONTWARN_MISSINGARGUMENTS), maxon::UInt64(enum2262::SYSTEMBEHAVIORFLAGS::IGNORE_UNKNOWN_CONFIGURATIONS), maxon::UInt64(enum2262::SYSTEMBEHAVIORFLAGS::CREATE_PREFERENCES)};
		static const maxon::EnumInfo SYSTEMBEHAVIORFLAGS_info{"SYSTEMBEHAVIORFLAGS", SIZEOF(SYSTEMBEHAVIORFLAGS), true, "NONE\0OMIT_HELP\0DONTWARN_MISSINGARGUMENTS\0IGNORE_UNKNOWN_CONFIGURATIONS\0CREATE_PREFERENCES\0", SYSTEMBEHAVIORFLAGS_values, std::extent<decltype(SYSTEMBEHAVIORFLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_SYSTEMBEHAVIORFLAGS2262(){ return enum2262::SYSTEMBEHAVIORFLAGS_info; }
	...
	namespace enum2452
	{
		...
		static const maxon::UInt64 VALUEKIND_values[] = {maxon::UInt64(enum2452::VALUEKIND::NONE), maxon::UInt64(enum2452::VALUEKIND::VOID_TYPE), maxon::UInt64(enum2452::VALUEKIND::GENERIC), maxon::UInt64(enum2452::VALUEKIND::GENERIC_ARITHMETIC), maxon::UInt64(enum2452::VALUEKIND::SCALAR), maxon::UInt64(enum2452::VALUEKIND::INTEGRAL), maxon::UInt64(enum2452::VALUEKIND::FLOATING_POINT), maxon::UInt64(enum2452::VALUEKIND::ENUM), maxon::UInt64(enum2452::VALUEKIND::ENUM_LIST), maxon::UInt64(enum2452::VALUEKIND::ENUM_FLAGS), maxon::UInt64(enum2452::VALUEKIND::DATA), maxon::UInt64(enum2452::VALUEKIND::DATAPTR), maxon::UInt64(enum2452::VALUEKIND::NONVIRTUAL_INTERFACE), maxon::UInt64(enum2452::VALUEKIND::VIRTUAL_INTERFACE), maxon::UInt64(enum2452::VALUEKIND::REF_OR_POINTER), maxon::UInt64(enum2452::VALUEKIND::POINTER), maxon::UInt64(enum2452::VALUEKIND::STRONG_REFERENCE), maxon::UInt64(enum2452::VALUEKIND::COW_REFERENCE), maxon::UInt64(enum2452::VALUEKIND::UNIQUE_REFERENCE), maxon::UInt64(enum2452::VALUEKIND::ACOW_REFERENCE), maxon::UInt64(enum2452::VALUEKIND::LV_REFERENCE), maxon::UInt64(enum2452::VALUEKIND::RV_REFERENCE), maxon::UInt64(enum2452::VALUEKIND::TUPLE), maxon::UInt64(enum2452::VALUEKIND::STRUCT), maxon::UInt64(enum2452::VALUEKIND::SIMD), maxon::UInt64(enum2452::VALUEKIND::BLOCK), maxon::UInt64(enum2452::VALUEKIND::STRIDED_BLOCK), maxon::UInt64(enum2452::VALUEKIND::BASEARRAY), maxon::UInt64(enum2452::VALUEKIND::BLOCKARRAY), maxon::UInt64(enum2452::VALUEKIND::RESULT), maxon::UInt64(enum2452::VALUEKIND::DELEGATE), maxon::UInt64(enum2452::VALUEKIND::FUNCTION), maxon::UInt64(enum2452::VALUEKIND::CONST_QUALIFIED), maxon::UInt64(enum2452::VALUEKIND::SOURCE_LEVEL), maxon::UInt64(enum2452::VALUEKIND::DEEP_CONSTNESS), maxon::UInt64(enum2452::VALUEKIND::INT_SIZE_OR_LESS), maxon::UInt64(enum2452::VALUEKIND::ZERO_INITIALIZED), maxon::UInt64(enum2452::VALUEKIND::ORDERED), maxon::UInt64(enum2452::VALUEKIND::TRIVIALLY_CONSTRUCTIBLE), maxon::UInt64(enum2452::VALUEKIND::TRIVIALLY_DESTRUCTIBLE), maxon::UInt64(enum2452::VALUEKIND::TRIVIALLY_COPYABLE), maxon::UInt64(enum2452::VALUEKIND::TRIVIALLY_EQUATABLE), maxon::UInt64(enum2452::VALUEKIND::TRIVIALLY_HASHABLE), maxon::UInt64(enum2452::VALUEKIND::OBJECT_REF), maxon::UInt64(enum2452::VALUEKIND::VALUE), maxon::UInt64(enum2452::VALUEKIND::ELEMENT_TYPE_AS_ARG), maxon::UInt64(enum2452::VALUEKIND::NEVER_NULLPTR), maxon::UInt64(enum2452::VALUEKIND::SIGNED), maxon::UInt64(enum2452::VALUEKIND::GENERIC_INSTANTIATION), maxon::UInt64(enum2452::VALUEKIND::ABSTRACT), maxon::UInt64(enum2452::VALUEKIND::NAMED), maxon::UInt64(enum2452::VALUEKIND::CONTAINER_REF), maxon::UInt64(enum2452::VALUEKIND::GENERIC_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::RECURSIVE_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::RESOLVED_RECURSIVE_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::CONTAINER), maxon::UInt64(enum2452::VALUEKIND::EMPTY_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::VIRTUAL_TUPLE_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::STATIC_ARRAY_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::ARRAY_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::ARRAY), maxon::UInt64(enum2452::VALUEKIND::CONTAINER_MASK), maxon::UInt64(enum2452::VALUEKIND::NAMED_TUPLE), maxon::UInt64(enum2452::VALUEKIND::CONTAINS_RECURSIVE_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::CONTAINS_INVALID_TYPE), maxon::UInt64(enum2452::VALUEKIND::BUNDLE), maxon::UInt64(enum2452::VALUEKIND::MIN_DERIVED_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::MIN_ARRAY_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::MAX_ARRAY_CONTAINER), maxon::UInt64(enum2452::VALUEKIND::COW_MASK), maxon::UInt64(enum2452::VALUEKIND::STRONG_MASK), maxon::UInt64(enum2452::VALUEKIND::PTR_MASK), maxon::UInt64(enum2452::VALUEKIND::CONTAINER_OR_REF), maxon::UInt64(enum2452::VALUEKIND::REFERENCE_MASK), maxon::UInt64(enum2452::VALUEKIND::ARITHMETIC_MASK), maxon::UInt64(enum2452::VALUEKIND::TUPLE_MASK), maxon::UInt64(enum2452::VALUEKIND::TUPLE_INHERIT_MASK), maxon::UInt64(enum2452::VALUEKIND::POINTER_FLAGS), maxon::UInt64(enum2452::VALUEKIND::QUALIFIER_MASK), maxon::UInt64(enum2452::VALUEKIND::CONTAINS_MASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_VALUEKIND2452(){ return enum2452::VALUEKIND_info; }
	...
	namespace enum2499
	{
		...
		static const maxon::UInt64 COLLECTION_KIND_values[] = {maxon::UInt64(enum2499::COLLECTION_KIND::NONE), maxon::UInt64(enum2499::COLLECTION_KIND::ARRAY), maxon::UInt64(enum2499::COLLECTION_KIND::SET), maxon::UInt64(enum2499::COLLECTION_KIND::MAP)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_COLLECTION_KIND2499(){ return enum2499::COLLECTION_KIND_info; }
