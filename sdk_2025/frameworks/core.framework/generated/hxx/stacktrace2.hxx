...
#else
#endif
		static Bool StackTrace_FindSymbol(const void* function, const Block<Char>& name, const Block<Char>& module, Int& offset) { return S::FindSymbol(function, name, module, offset); }
	};
