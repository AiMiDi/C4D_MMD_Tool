...
struct MachineInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(MachineInterface_ObservablePrivateSplashMessageReceived, ObservablePrivateSplashMessageReceived, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>), maxon::Bool create);
	maxon::Int MachineInterface_ObservablePrivateSplashMessageReceived_Offset;
	PRIVATE_MAXON_MF_POINTER(MachineInterface_ObservableActivationChanged, ObservableActivationChanged, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableActivationChangedDelegate>), maxon::Bool create);
...
struct MachineInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(MachineInterface_ObservablePrivateSplashMessageReceived, maxon::GenericComponent, const, (maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservablePrivateSplashMessageReceived(create); }
		PRIVATE_MAXON_MF_WRAPPER(MachineInterface_ObservableActivationChanged, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableActivationChangedDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObservableActivationChanged(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ObservablePrivateSplashMessageReceived(maxon::Bool create) const -> maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::ObservableActivationChanged(maxon::Bool create) const -> maxon::ObservableRef<ObservableActivationChangedDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::Hxx1::ConstFn<S>::ObservablePrivateSplashMessageReceived(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MachineInterface::Hxx1::ConstFn<S>::ObservableActivationChanged(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableActivationChangedDelegate>)
{
...
/// @endcond
	...
	PRIVATE_MAXON_SF_POINTER(MachinesInterface_ObservableMachineStateChanged, ObservableMachineStateChanged, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableMachineStateChangedDelegate>), maxon::Bool create);
...
/// @endcond
		...
		static maxon::ObservableRef<ObservableMachineStateChangedDelegate> MachinesInterface_ObservableMachineStateChanged(maxon::Bool create) { return S::ObservableMachineStateChanged(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto MachinesInterface::ObservableMachineStateChanged(maxon::Bool create) -> maxon::ObservableRef<ObservableMachineStateChangedDelegate>
{
