...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ProgressInterface);
	...
	public:
		...
		Result<void> InitProgress(const TimeValue& delayFirstProgress, const TimeValue& minProgressUpdate) 
		{
			...
			(*handler_)(_fn_ProgressInterface_InitProgress, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), const TimeValue&, const TimeValue&), reinterpret_cast<const void* const&>(mt_.ProgressInterface_InitProgress)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_ProgressInterface_InitProgress;
		Result<Int> AddProgressJob(Float jobWeight, const String& jobName) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_ProgressInterface_AddProgressJob, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<Int>), Float, const String&), reinterpret_cast<const void* const&>(mt_.ProgressInterface_AddProgressJob)));
			return proxy_result;
		}
		...
		Result<void> SetProgressAndCheckBreak(Int jobIndex, Float percent) 
		{
			...
			(*handler_)(_fn_ProgressInterface_SetProgressAndCheckBreak, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), Int, Float), reinterpret_cast<const void* const&>(mt_.ProgressInterface_SetProgressAndCheckBreak)));
			return proxy_result;
		}
		...
		Result<Float> GetProgress(Int jobIndex) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ProgressInterface>();
			Result<Float> proxy_result = HXXRET1(NULLIMPL);
			...
			(*handler_)(_fn_ProgressInterface_GetProgress, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<Float>), Int), reinterpret_cast<const void* const&>(mt_.ProgressInterface_GetProgress)));
			return proxy_result;
		}
		...
		Float GetTotalWeight() const 
		{
			...
			(*handler_)(_fn_ProgressInterface_GetTotalWeight, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Float)), reinterpret_cast<const void* const&>(mt_.ProgressInterface_GetTotalWeight)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_ProgressInterface_GetTotalWeight;
		maxon::ObservableRef<ObservableProgressNotificationDelegate> ObservableProgressNotification(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ProgressInterface>();
			maxon::ObservableRef<ObservableProgressNotificationDelegate> proxy_result = maxon::ObservableRef<ObservableProgressNotificationDelegate>::DefaultValue();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ProgressInterface_ObservableProgressNotification_Offset), maxon::reflection::Argument::ByValue(create)};
			(*handler_)(_fn_ProgressInterface_ObservableProgressNotification, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObservableProgressNotificationDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.ProgressInterface_ObservableProgressNotification)));
			return proxy_result;
		}
		...
		Result<Tuple<TimeValue, TimeValue>> GetTime() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ProgressInterface>();
			Result<Tuple<TimeValue, TimeValue>> proxy_result = HXXRET1(NULLIMPL);
			...
			(*handler_)(_fn_ProgressInterface_GetTime, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<Tuple<TimeValue, TimeValue>>)), reinterpret_cast<const void* const&>(mt_.ProgressInterface_GetTime)));
			return proxy_result;
		}
		...
		String GetDetailsText() const 
		{
			...
			(*handler_)(_fn_ProgressInterface_GetDetailsText, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((String)), reinterpret_cast<const void* const&>(mt_.ProgressInterface_GetDetailsText)));
			return proxy_result;
		}
		...
		void SetDetailsText(const String& details) 
		{
			...
			(*handler_)(_fn_ProgressInterface_SetDetailsText, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((void), const String&), reinterpret_cast<const void* const&>(mt_.ProgressInterface_SetDetailsText)));
		}
		...
		Bool SupportsCancelJob() const 
		{
			...
			(*handler_)(_fn_ProgressInterface_SupportsCancelJob, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Bool)), reinterpret_cast<const void* const&>(mt_.ProgressInterface_SupportsCancelJob)));
			return proxy_result;
		}
		...
		Result<void> SetCancelJobDelegate(JobCancelDelegate&& cancelJobDelegate) 
		{
			...
			(*handler_)(_fn_ProgressInterface_SetCancelJobDelegate, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>), JobCancelDelegate&&), reinterpret_cast<const void* const&>(mt_.ProgressInterface_SetCancelJobDelegate)));
			return proxy_result;
		}
		...
		Result<void> CancelJob() 
		{
			...
			(*handler_)(_fn_ProgressInterface_CancelJob, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<void>)), reinterpret_cast<const void* const&>(mt_.ProgressInterface_CancelJob)));
			return proxy_result;
		}
		...
		Bool IsCancelled() 
		{
			...
			(*handler_)(_fn_ProgressInterface_IsCancelled, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Bool)), reinterpret_cast<const void* const&>(mt_.ProgressInterface_IsCancelled)));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ProgressInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "create\0", 0LL, ProgressInterface, ProgressInterface_ObservableProgressNotification),
