...
struct IoErrorInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<IoErrorInterface, typename ErrorInterface::MTable::template CombinedMTable<S>>;
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoErrorInterface::Hxx1::Fn<S>::SetUrl(const Url& url) const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXNONCONST(DebugStop(), , false, maxon::PrivateLogNullptrError()) HXXTABLE(IoErrorInterface_SetUrl); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoErrorInterface::Hxx1::COWFn<S>::SetUrl(const Url& url) -> HXXADDRET1(void)
{
	HXXRETURN0(HXXADDRET1(void)); HXXRES; HXXNONCONST(, MakeWritable(false)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoErrorInterface_SetUrl); 
	PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoErrorInterface_SetUrl_Offset), mt_.IoErrorInterface_SetUrl, url);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoErrorInterface::Hxx1::ConstFn<S>::GetUrl() const -> HXXADDRET2(const Url&)
{
	HXXRETURN0(HXXADDRET2(const Url&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const Url&)) HXXTABLE(IoErrorInterface_GetUrl); 
...
struct FileFormatErrorInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<FileFormatErrorInterface, typename IoErrorInterface::MTable::template CombinedMTable<S>>;
...
struct UnknownFileSizeErrorInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<UnknownFileSizeErrorInterface, typename ErrorInterface::MTable::template CombinedMTable<S>>;
...
struct BaseStreamInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<BaseStreamInterface, typename DataDictionaryObjectInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<Int64>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(BaseStreamInterface_GetStreamLength); 
...
{
	HXXRETURN0(Result<Int64>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(BaseStreamInterface_GetPosition); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(BaseStreamInterface_Close); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(BaseStreamInterface_Close); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.BaseStreamInterface_Close_Offset), mt_.BaseStreamInterface_Close));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BaseStreamInterface::Hxx1::ConstFn<S>::SeekSupported() const -> HXXADDRET2(Bool)
{
	HXXRETURN0(HXXADDRET2(Bool)); HXXRES; HXXCONST(maxon::PrivateLogNullptrError(false)) HXXTABLE(BaseStreamInterface_SeekSupported); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(BaseStreamInterface_Seek); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(BaseStreamInterface_Seek); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.BaseStreamInterface_Seek_Offset), mt_.BaseStreamInterface_Seek, position));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BaseStreamInterface::Hxx1::Fn<S>::DisableBuffering() const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXNONCONST(DebugStop(), , false, maxon::PrivateLogNullptrError()) HXXTABLE(BaseStreamInterface_DisableBuffering); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto BaseStreamInterface::Hxx1::COWFn<S>::DisableBuffering() -> HXXADDRET1(void)
{
	HXXRETURN0(HXXADDRET1(void)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(BaseStreamInterface_DisableBuffering); 
	PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.BaseStreamInterface_DisableBuffering_Offset), mt_.BaseStreamInterface_DisableBuffering);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
...
struct InputStreamInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<InputStreamInterface, typename BaseStreamInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<Int64>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(InputStreamInterface_BytesAvailable); 
...
{
	HXXRETURN0(Result<void>); HXXSUPER("InputStreamInterface::Read"); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) 
	return (o_->Read(data));
}
...
{
	HXXRETURN0(Result<Int>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(InputStreamInterface_ReadEOS); 
...
{
	HXXRETURN0(Result<Int>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(InputStreamInterface_ReadEOS); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.InputStreamInterface_ReadEOS_Offset), mt_.InputStreamInterface_ReadEOS, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto InputStreamInterface::Hxx1::Fn<S>::Skip(Int64 bytes) const -> Result<void>
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(InputStreamInterface_Skip); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(InputStreamInterface_Skip); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.InputStreamInterface_Skip_Offset), mt_.InputStreamInterface_Skip, bytes));
}
...
struct OutputStreamInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<OutputStreamInterface, typename BaseStreamInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(OutputStreamInterface_Write); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(OutputStreamInterface_Write); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.OutputStreamInterface_Write_Offset), mt_.OutputStreamInterface_Write, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto OutputStreamInterface::Hxx1::Fn<S>::Flush() const -> Result<void>
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(OutputStreamInterface_Flush); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(OutputStreamInterface_Flush); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.OutputStreamInterface_Flush_Offset), mt_.OutputStreamInterface_Flush));
}
...
struct InOutputStreamInterface::MTable
{
	...
	static const maxon::METHOD_FLAGS _flags[];
	static const maxon::Bool HAS_NONSTATIC = false;
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<InOutputStreamInterface, typename OutputStreamInterface::MTable::template CombinedMTable<typename InputStreamInterface::MTable::template CombinedMTable<S>>>;
