...
namespace maxon
{
	...
	const maxon::Char* const SettingsInterface::Hxx2::StaticMTable::_ids = 
		...
		"ObservableSettingsChanged@1135abc87d70b83a\0" // maxon::ObservableRef<ObservableSettingsChangedDelegate> ObservableSettingsChanged(maxon::Bool create)
	"";
