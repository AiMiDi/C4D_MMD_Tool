...
public:
	...
	{
		return maxon::Cast<DataDescriptionDefinitionDatabaseImplRef>(self.GetDecoratedObject()).GetChangeCounts();
	}

	MAXON_METHOD Int GetUserChangeCount() const
	{
		return maxon::Cast<DataDescriptionDefinitionDatabaseImplRef>(self.GetDecoratedObject()).GetUserChangeCount();
	}
	...
	{
		return maxon::Cast<DataDescriptionDefinitionDatabaseImplRef>(self.GetDecoratedObject()).WriteUserChangedDataBases();
	}
