...
struct SettingsInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = SettingsInterface;
...
/// GetAccessLevel returns the current level of this object.
		inline HXXADDRET2(ACCESSLEVEL) GetAccessLevel() const;
/// GetParentSettings returns the SettingsRef from which settings are inherited.
		inline HXXADDRET2(SettingsRef) GetParentSettings() const;
...
/// @return                       SettingsRef on success.
		...
		static inline maxon::ObservableRef<ObservableSettingsChangedDelegate> ObservableSettingsChanged(maxon::Bool create);
	};
	/// Intermediate helper class for SettingsInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SettingsInterface, maxon::StrongRefHandler, SettingsRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<SettingsInterface, maxon::StrongRefHandler, SettingsRef>>>>);
