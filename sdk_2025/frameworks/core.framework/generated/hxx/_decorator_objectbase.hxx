...
public:
	...
	{
		return maxon::Cast<ObjectRef>(self.GetDecoratedObject()).GetUniqueHashCodeImpl();
	}
...
public:
	...
	{
		return maxon::Cast<Error>(self.GetDecoratedObject()).SetMessageDelegate(std::forward<MessageDelegate>(message));
	}

	MAXON_METHOD const MessageDelegate& GetMessageDelegate() const
	{
		return maxon::Cast<Error>(self.GetDecoratedObject()).GetMessageDelegate();
	}
