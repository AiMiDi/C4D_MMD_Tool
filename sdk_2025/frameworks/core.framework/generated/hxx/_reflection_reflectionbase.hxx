...
namespace maxon
{
	namespace reflection
	{
		...
		static maxon::Result<void> RegisterReflection_Class(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(Class::MTable::_instance.Class_GetType)>(nullptr, maxon::reflection::Member::KIND::CONST_INSTANCE_FUNCTION, "", 0LL, nullptr),
