...
struct ClassInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ClassInterface;
...
/// @return												Reference to the list of components.
		inline HXXADDRET2(Block<const ComponentInfo* const>) GetComponents() const;
/// Returns true if the class has been finalized successfully before.
/// @return												True if the class is finalized.
/// @see Finalize
		inline HXXADDRET2(Bool) IsFinalized() const;
...
/// @return												Block of all implemented interfaces.
		inline HXXADDRET2(const Block<const InterfaceReference* const>&) GetImplementedInterfaces() const;
...
/// @return												True if this class implements the interface, false otherwise.
		inline HXXADDRET2(Bool) Implements(const InterfaceReference& iref) const;
...
/// @return												True if this class implements the interface I, false otherwise.
		template <typename I> inline HXXADDRET2(Bool) Implements() const;
...
/// @return												True if this class is a subclass of #other, false otherwise.
		inline HXXADDRET2(Bool) IsSubclassOf(const Class<>& other) const;
...
/// @return												The meta data of this class.
		inline HXXADDRET2(const DataDictionary&) GetMetaData() const;
...
/// @param[in] data								The meta data.
		inline HXXADDRET2(void) InitMetaData(DataDictionary&& data) const;
	};
	/// Intermediate helper class for ClassInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ClassInterface, maxon::StrongRefHandler, Class<REF_>>>, REF_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ClassInterface, maxon::StrongRefHandler, Class<REF_>>>, REF_>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ClassInterface, maxon::StrongRefHandler, NonConstRef<REF_>>>, REF_>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ClassInterface, maxon::StrongRefHandler, NonConstRef<REF_>>>, REF_>>);
};
...
struct ObjectInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = ObjectInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
/// @return												Class of this object.
		inline HXXADDRET2(const maxon::Class<typename S::PrivateErasedReferencedType::Hxx1::ReferenceClass>&) GetClass() const;
/// Returns the class information of this object.
/// @return												Class information of this object.
		inline HXXADDRET2(const ClassInfo*) GetClassInfo() const;
#if defined(_MSC_VER) && !defined(__clang__)
#else
#endif
...
/// @return												True if both objects have the same class.
		inline HXXADDRET2(Bool) HasSameClass(const ObjectInterface* obj) const;
...
/// @return												True if this object is an instance of #I, false otherwise.
		template <typename I> inline HXXADDRET2(Bool) IsInstanceOf() const;
...
/// @return												True if this object is an instance of #type, false otherwise.
		inline HXXADDRET2(Bool) IsInstanceOf(const DataType& type) const;
/// Returns a readable string of the content.
/// @param[in] formatStatement		Nullptr or additional formatting instruction. Currently no additional formatting instructions are supported.
...
/// @return												True if both object are equal, false otherwise.
		inline HXXADDRET2(Bool) IsEqual(const maxon::ObjectInterface* other) const;
/// Compares this and #other.
/// If you implement this method in a component, make sure to incorporate the result of the super implementation in the result.
/// @param[in] other							Another object.
/// @return												Result of the comparison.
		inline HXXADDRET2(COMPARERESULT) Compare(const maxon::ObjectInterface* other) const;
/// Returns a hash code for this object.
/// If you implement this method in a component, make sure to incorporate the result of the super implementation in the result.
/// @return												Hash code for this object.
		inline HXXADDRET2(HashInt) GetHashCodeImpl() const;
...
/// @return												Hash value for this object.
		inline HXXADDRET2(UniqueHash) GetUniqueHashCodeImpl() const;
#ifndef _HAS_CPP20_COMPARISONS
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ObjectInterface, maxon::StrongRefHandler, ObjectRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ObjectInterface, maxon::StrongRefHandler, ObjectRef>>>>);
...
/// @return												Formatted human-readable message.
		inline HXXADDRET2(String) FormatMessage(const LanguageRef& language, const PartFormatter& partFormatter) const;
/// Gets the message delegate of this error.
/// @see SetMessageDelegate
/// @return												The delegate
		inline HXXADDRET2(const MessageDelegate&) GetMessageDelegate() const;
...
/// @return												Cause of this error, this will be a null reference in most cases.
		inline HXXADDRET2(const Error&) GetCause() const;
/// Returns the machine that caused this error.
/// @param[out] machine						Receives the machine that caused this error.
		inline HXXADDRET2(void) GetMachine(MachineRef& machine) const;
		inline HXXADDRET2(Int) PrivateGetCode() const;
		inline HXXADDRET2(void) PrivateSetPreallocation(ThreadReferencedError preallocation) const;
		inline HXXADDRET2(ThreadReferencedError) PrivateGetPreallocation() const;
		inline HXXADDRET2(void) PrivateSetDebugError(const Error& cause) const;
	};
	/// Intermediate helper class for ErrorInterface.
	template <typename S> class Fn : public ConstFn<S>
	{
...
///
		inline DOXYGEN_SWITCH(maxon::RefMemberType<S const>, S) SetMessageDelegate(MessageDelegate&& message) const;
...
/// @param[in] machine						Machine that caused this error.
		inline HXXADDRET2(void) SetMachine(const MachineRef& machine) const;
...
/// @param[in] message						Error message delegate to use for this error.
///
		inline DOXYGEN_SWITCH(maxon::RefMemberType<S>, S) SetMessageDelegate(MessageDelegate&& message);
/// Sets the cause of this error. A cause is itself an error of which the
/// current error is a subsequent error.
/// @param[in] cause							Cause to use for this error.
///
...
/// Sets the machine that caused this error.
/// @param[in] machine						Machine that caused this error.
		inline HXXADDRET1(void) SetMachine(const MachineRef& machine);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ErrorInterface, maxon::StrongCOWRefHandler, Error>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const ErrorInterface, maxon::StrongCOWRefHandler, Error>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] Error : public ErrorInterface::Hxx1::Reference
{
public:
