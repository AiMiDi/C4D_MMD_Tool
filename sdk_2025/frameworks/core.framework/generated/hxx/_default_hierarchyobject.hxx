...
public:
	...
	{
		return maxon::PrivateDefaultReturnValue<HierarchyObjectRef<>, false>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}

	MAXON_METHOD typename HIERARCHY::template Child<Interface>::type RemoveChildren(const ConstDataPtr& branchId)
	{
		return maxon::PrivateDefaultReturnValue<typename HIERARCHY::template Child<Interface>::type, false>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}
	...
	{
		return maxon::PrivateDefaultReturnValue<ConstDataPtr, false>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}
	...
	{
		return maxon::PrivateDefaultReturnValue<typename HIERARCHY::template Parent<Interface>::type, false>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}

	MAXON_METHOD std::add_pointer<HierarchyObjectInterface>::type GetParentPtr() const
	{
		return maxon::PrivateDefaultReturnValue<std::add_pointer<HierarchyObjectInterface>::type, false>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}

	MAXON_METHOD typename HIERARCHY::template Sibling<Interface>::type GetNext() const
	{
		return maxon::PrivateDefaultReturnValue<typename HIERARCHY::template Sibling<Interface>::type, false>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}
	...
	MAXON_METHOD maxon::ObservableRef<ObservableHierarchyInsertDelegate> ObservableHierarchyInsert(maxon::Bool create) const
	{
		return maxon::ObservableRef<ObservableHierarchyInsertDelegate>::DefaultValue();
	}

	MAXON_METHOD maxon::ObservableRef<ObservableHierarchyRemoveDelegate> ObservableHierarchyRemove(maxon::Bool create) const
	{
