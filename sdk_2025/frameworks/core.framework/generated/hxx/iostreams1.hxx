...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IoErrorInterface, maxon::StrongCOWRefHandler, IoError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IoErrorInterface, maxon::StrongCOWRefHandler, IoError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};

/// IoError is the reference class of IoErrorInterface.
///
/// Error of the category I/O.
class [[nodiscard]] IoError : public IoErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(IoError, IoErrorObject, "net.maxon.error.io",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const FileFormatErrorInterface, maxon::StrongCOWRefHandler, FileFormatError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const FileFormatErrorInterface, maxon::StrongCOWRefHandler, FileFormatError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileFormatErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FileFormatErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] FileFormatError : public FileFormatErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(FileFormatError, FileFormatErrorObject, "net.maxon.error.fileformat",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnknownFileSizeErrorInterface, maxon::StrongCOWRefHandler, UnknownFileSizeError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnknownFileSizeErrorInterface, maxon::StrongCOWRefHandler, UnknownFileSizeError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnknownFileSizeErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnknownFileSizeErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] UnknownFileSizeError : public UnknownFileSizeErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(UnknownFileSizeError, UnknownFileSizeErrorObject, "net.maxon.error.unknownfilesize",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class BaseStreamRef;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BaseStreamInterface, maxon::StrongRefHandler, BaseStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<BaseStreamInterface, maxon::StrongRefHandler, BaseStreamRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<InputStreamInterface, maxon::StrongRefHandler, InputStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<InputStreamInterface, maxon::StrongRefHandler, InputStreamRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<OutputStreamInterface, maxon::StrongRefHandler, OutputStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<OutputStreamInterface, maxon::StrongRefHandler, OutputStreamRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<InOutputStreamInterface, maxon::StrongRefHandler, InOutputStreamRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<InOutputStreamInterface, maxon::StrongRefHandler, InOutputStreamRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
