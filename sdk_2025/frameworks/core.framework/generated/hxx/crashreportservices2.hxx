...
struct CrashReportServices::Hxx2
{
	...
	public:
		...
		static Int32 CrashReportServices_CreateCrashReportProperty(const Char* name, const Char* value) { return S::CreateCrashReportProperty(name, value); }
		static void CrashReportServices_FreeCrashReportProperty(Int32 propertyIdx) { return S::FreeCrashReportProperty(propertyIdx); }
		static void* CrashReportServices_GetCrashReportProperties(void* osThread) { return S::GetCrashReportProperties(osThread); }
	};
