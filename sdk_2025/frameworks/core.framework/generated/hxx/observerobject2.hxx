...
/// @endcond
	...
	PRIVATE_MAXON_MF_POINTER(ObserverObjectInterface_ObserverDestroyed, ObserverDestroyed, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObserverDestroyedDelegate>), maxon::Bool create);
	maxon::Int ObserverObjectInterface_ObserverDestroyed_Offset;
	PRIVATE_MAXON_MF_POINTER(ObserverObjectInterface_ObserverDisconnectNotify, ObserverDisconnectNotify, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObserverDisconnectNotifyDelegate>), maxon::Bool create);
	maxon::Int ObserverObjectInterface_ObserverDisconnectNotify_Offset;
	PRIVATE_MAXON_MF_POINTER(ObserverObjectInterface_ObserverConnectNotify, ObserverConnectNotify, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObserverConnectNotifyDelegate>), maxon::Bool create);
...
/// @endcond
		...
		PRIVATE_MAXON_MF_WRAPPER(ObserverObjectInterface_ObserverDestroyed, maxon::GenericComponent, const, (maxon::ObservableRef<ObserverDestroyedDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObserverDestroyed(create); }
		PRIVATE_MAXON_MF_WRAPPER(ObserverObjectInterface_ObserverDisconnectNotify, maxon::GenericComponent, const, (maxon::ObservableRef<ObserverDisconnectNotifyDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObserverDisconnectNotify(create); }
		PRIVATE_MAXON_MF_WRAPPER(ObserverObjectInterface_ObserverConnectNotify, maxon::GenericComponent, const, (maxon::ObservableRef<ObserverConnectNotifyDelegate>), maxon::Bool create) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ObserverConnectNotify(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::ObserverDestroyed(maxon::Bool create) const -> maxon::ObservableRef<ObserverDestroyedDelegate>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::ObserverDisconnectNotify(maxon::Bool create) const -> maxon::ObservableRef<ObserverDisconnectNotifyDelegate>
{
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::ObserverConnectNotify(maxon::Bool create) const -> maxon::ObservableRef<ObserverConnectNotifyDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::Hxx1::ConstFn<S>::ObserverDestroyed(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObserverDestroyedDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::Hxx1::ConstFn<S>::ObserverDisconnectNotify(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObserverDisconnectNotifyDelegate>)
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ObserverObjectInterface::Hxx1::ConstFn<S>::ObserverConnectNotify(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObserverConnectNotifyDelegate>)
{
