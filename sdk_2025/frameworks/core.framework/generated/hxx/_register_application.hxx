...
namespace maxon
{
	...
	namespace enum132
	{
		...
		static const maxon::UInt64 APPLICATION_URLTYPE_values[] = {maxon::UInt64(enum132::APPLICATION_URLTYPE::STARTUP_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::APPLICATION), maxon::UInt64(enum132::APPLICATION_URLTYPE::APP_EXECUTABLE), maxon::UInt64(enum132::APPLICATION_URLTYPE::CORELIBS_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::RESOURCE_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::TEMP_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::PREFS_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::GLOBALPREFS_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::DESKTOP_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::USER_HOME_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::USER_DOCUMENTS_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::SYSTEM_PROGRAMS_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::CURRENT_WORKING_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::CURRENT_MODULE_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::CURRENT_MODULE_RESOURCE_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::LIBRARY_DIR), maxon::UInt64(enum132::APPLICATION_URLTYPE::PREFS_DIR_STATIC), maxon::UInt64(enum132::APPLICATION_URLTYPE::TESTDATA_DIR)};
		static const maxon::EnumInfo APPLICATION_URLTYPE_info{"APPLICATION_URLTYPE", SIZEOF(APPLICATION_URLTYPE), false, "STARTUP_DIR\0APPLICATION\0APP_EXECUTABLE\0CORELIBS_DIR\0RESOURCE_DIR\0TEMP_DIR\0PREFS_DIR\0GLOBALPREFS_DIR\0DESKTOP_DIR\0USER_HOME_DIR\0USER_DOCUMENTS_DIR\0SYSTEM_PROGRAMS_DIR\0CURRENT_WORKING_DIR\0CURRENT_MODULE_DIR\0CURRENT_MODULE_RESOURCE_DIR\0LIBRARY_DIR\0PREFS_DIR_STATIC\0TESTDATA_DIR\0", APPLICATION_URLTYPE_values, std::extent<decltype(APPLICATION_URLTYPE_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATION_URLTYPE132(){ return enum132::APPLICATION_URLTYPE_info; }
	...
	namespace enum141
	{
		...
		static const maxon::UInt64 APPLICATIONMODE_values[] = {maxon::UInt64(enum141::APPLICATIONMODE::DONTWAIT), maxon::UInt64(enum141::APPLICATIONMODE::KEEPRUNNING), maxon::UInt64(enum141::APPLICATIONMODE::SHUTDOWN)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATIONMODE141(){ return enum141::APPLICATIONMODE_info; }
	...
	namespace enum149
	{
		...
		static const maxon::UInt64 APPLICATIONFEATURE_values[] = {maxon::UInt64(enum149::APPLICATIONFEATURE::NONE), maxon::UInt64(enum149::APPLICATIONFEATURE::COMMANDLINE), maxon::UInt64(enum149::APPLICATIONFEATURE::LIBRARY), maxon::UInt64(enum149::APPLICATIONFEATURE::UI)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATIONFEATURE149(){ return enum149::APPLICATIONFEATURE_info; }
...
#endif
		"ObservableApplicationMessage@1c228112557835ea\0" // maxon::ObservableRef<ObservableApplicationMessageDelegate> ObservableApplicationMessage(maxon::Bool create)
