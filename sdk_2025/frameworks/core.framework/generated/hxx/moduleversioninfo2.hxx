...
struct ModuleVersionInfoInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<ModuleVersionInfoInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
