...
struct ResolveInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ResolveInterface;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ResolveInterface, maxon::StrongRefHandler, ResolveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ResolveInterface, maxon::StrongRefHandler, ResolveRef>>>>);
...
struct IoConnectionInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = IoConnectionInterface;
		using PrivateBaseClass::PrivateLookupFn;
...
/// return true to continue calling handlers, false to stop.
		static inline maxon::ObservableRef<ObservableErrorOpenFileDelegate> ObservableErrorOpenFile(maxon::Bool create);
	};
	/// Intermediate helper class for IoConnectionInterface.
	template <typename S> class Fn : public ConstFn<S>
	{
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoConnectionInterface, maxon::StrongRefHandler, IoConnectionRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoConnectionInterface, maxon::StrongRefHandler, IoConnectionRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
public:
	...
	using OBSERVABLECOMBINER = ObservableCombinerRunAllBoolUntilFalse_PrivateHelper;
};
