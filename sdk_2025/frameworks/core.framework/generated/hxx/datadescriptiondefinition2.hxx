...
struct DataDescriptionDefinitionInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<DataDescriptionDefinitionInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
struct DataDescriptionDefinitionInterface::Hxx2
{
	...
	PRIVATE_MAXON_SF_POINTER(DataDescriptionDefinitionInterface_DefaultValuePtr, DefaultValuePtr, MAXON_EXPAND_VA_ARGS, (const DataDescriptionDefinitionInterface*));
		...
		tbl->DataDescriptionDefinitionInterface_DefaultValuePtr = DataDescriptionDefinitionInterface_DefaultValuePtr_GetPtr<IMPL>(true);
		}
	};
	...
	public:
		...
		static const DataDescriptionDefinitionInterface* DataDescriptionDefinitionInterface_DefaultValuePtr() { return S::Implementation::DefaultValuePtr(); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::DefaultValuePtr() -> const DataDescriptionDefinitionInterface*
{
	return Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_DefaultValuePtr();
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstFn<S>::GetInfo() const -> HXXADDRET2(DataDictionary)
{
	HXXRETURN0(HXXADDRET2(DataDictionary)); HXXRES; HXXCONST(HXXRET3(NULLPTR, DataDictionary)) HXXTABLE(DataDescriptionDefinitionInterface_GetInfo); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_SetInfo); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_SetInfo); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_SetInfo_Offset), mt_.DataDescriptionDefinitionInterface_SetInfo, info));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstFn<S>::GetEntryCount() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(DataDescriptionDefinitionInterface_GetEntryCount); 
...
{
	HXXRETURN0(Result<BaseArray<DataDescriptionEntry>>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_GetEntries); 
...
{
	HXXRETURN0(Result<DataDescriptionEntry>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_GetEntry); 
...
{
	HXXRETURN0(Result<DataDescriptionEntry>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_FindEntry); 
...
{
	HXXRETURN0(Result<Int>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_AddEntry); 
...
{
	HXXRETURN0(Result<Int>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_AddEntry); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_AddEntry_Offset), mt_.DataDescriptionDefinitionInterface_AddEntry, props));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_ReplaceEntry); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_ReplaceEntry); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_ReplaceEntry_Offset), mt_.DataDescriptionDefinitionInterface_ReplaceEntry, props));
}
...
{
	HXXRETURN0(Result<Bool>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_ReplaceEntry_1); 
...
{
	HXXRETURN0(Result<Bool>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_ReplaceEntry_1); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_ReplaceEntry_1_Offset), mt_.DataDescriptionDefinitionInterface_ReplaceEntry_1, idx, props));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_EraseEntry); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_EraseEntry); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_EraseEntry_Offset), mt_.DataDescriptionDefinitionInterface_EraseEntry, idx));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(DataDescriptionDefinitionInterface_EraseEntry_1); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_EraseEntry_1); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_EraseEntry_1_Offset), mt_.DataDescriptionDefinitionInterface_EraseEntry_1, id));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::Fn<S>::Reset() const -> HXXADDRET2(void)
{
	HXXRETURN0(HXXADDRET2(void)); HXXRES; HXXNONCONST(DebugStop(), , false, maxon::PrivateLogNullptrError()) HXXTABLE(DataDescriptionDefinitionInterface_Reset); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::COWFn<S>::Reset() -> HXXADDRET1(void)
{
	HXXRETURN0(HXXADDRET1(void)); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(DataDescriptionDefinitionInterface_Reset); 
	PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionDefinitionInterface_Reset_Offset), mt_.DataDescriptionDefinitionInterface_Reset);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto DataDescriptionDefinitionInterface::Hxx1::ConstFn<S>::DefaultValuePtr() -> const DataDescriptionDefinitionInterface*
{
	return (Hxx2::StaticMTable::_instance.DataDescriptionDefinitionInterface_DefaultValuePtr());
}
