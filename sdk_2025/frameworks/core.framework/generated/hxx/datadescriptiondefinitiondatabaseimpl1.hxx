...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionDefinitionDatabaseImplInterface, maxon::StrongRefHandler, DataDescriptionDefinitionDatabaseImplRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataDescriptionDefinitionDatabaseImplInterface, maxon::StrongRefHandler, DataDescriptionDefinitionDatabaseImplRef>>>>);
