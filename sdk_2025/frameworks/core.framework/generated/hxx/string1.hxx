...
struct StringInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = StringInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(StringInterface**);
/// Returns the length (number of elements) of the string, not the size of the block.
		inline HXXADDRET2(Int) GetLength() const;
...
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindIndex(const StringInterface* str, StringPosition start = 0) const;
...
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindLastIndex(const StringInterface* str, StringPosition start = StringEnd()) const;
...
/// @return												The index at which 'ch' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindIndex(Utf32Char ch, StringPosition start = 0) const;
/// Searches for the last occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'ch' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindLastIndex(Utf32Char ch, StringPosition start = StringEnd()) const;
...
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindUpperIndex(const StringInterface* str, StringPosition start = 0) const;
/// Uppercase search for the last occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindLastUpperIndex(const StringInterface* str, StringPosition start = StringEnd()) const;
...
/// @return												See COMPARERESULT.
		inline HXXADDRET2(COMPARERESULT) ComparePart(const StringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) const;
/// Compares the object against 'str' for exact match.
/// @param[in] str								Comparison object.
/// @param[in] mode								Comparison mode.
/// @return												See COMPARERESULT.
		inline HXXADDRET2(COMPARERESULT) Compare(const StringInterface* str, STRINGCOMPARISON mode = STRINGCOMPARISON::UNICODE_NUMBERS) const;
/// Compare strings for equality.
/// @return												True if equal.
		inline HXXADDRET2(Bool) IsEqual(const StringInterface* str) const;
...
/// @return												True if 'str' has been found, in that case *pos contains the position where the first occurance was found.
		inline HXXADDRET2(Bool) Find(const String& str, Int* pos, StringPosition start = 0) const;
/// Searches for the last occurrence of 'str' within a string.
/// @param[in] str								The search string.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found *pos is initialized with InvalidArrayIndex.
...
/// @return												True if 'str' has been found, in that case *pos contains the position where the last occurance was found.
		inline HXXADDRET2(Bool) FindLast(const String& str, Int* pos, StringPosition start = StringEnd()) const;
/// Searches for the first occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
...
/// @return												True if 'ch' has been found, in that case *pos contains the position where the first occurance was found.
		inline HXXADDRET2(Bool) Find(Utf32Char ch, Int* pos, StringPosition start = 0) const;
/// Searches for the last occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
/// @param[out] pos								Pointer to be filled with the position where 'ch' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return false.
/// @return												True if 'ch' has been found, in that case *pos contains the position where the last occurance was found.
		inline HXXADDRET2(Bool) FindLast(Utf32Char ch, Int* pos, StringPosition start = StringEnd()) const;
/// Uppercase search for the first occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return false.
/// @return												True if 'str' has been found, in that case *pos contains the position where the first occurance was found.
		inline HXXADDRET2(Bool) FindUpper(const String& str, Int* pos, StringPosition start = 0) const;
/// Uppercase search for the last occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return false.
/// @return												True if 'str' has been found, in that case *pos contains the position where the last occurance was found.
		inline HXXADDRET2(Bool) FindLastUpper(const String& str, Int* pos, StringPosition start = StringEnd()) const;
...
/// @return												The partial string, or empty string if 'start' was out of boundaries. Will be an empty reference on failure (apply iferr for error handling).
		inline HXXADDRET2(String) GetLeftPart(StringPosition start) const;
/// Returns the string part right of the given position. The character at position will be included.
/// @param[in] start							Partitioning position.
/// @return												The partial string, or empty string if 'start' was out of boundaries. Will be an empty reference on failure (apply iferr for error handling).
		inline HXXADDRET2(String) GetRightPart(StringPosition start) const;
...
/// @return												True if the string starts with the given character.
		inline HXXADDRET2(Bool) StartsWith(Utf32Char ch) const;
...
/// @return												Block describing the internal character buffer. The data is read only! Please note that GetCount() will return the number of characters (and not bytes).
		inline HXXADDRET2(StridedBlock<const Generic>) GetVariableInternalData() const;
/// Retrieves the string's character width. The width determines the result of GetInternalDataX().
/// @return												1, 2 or 4 (bytes).
		inline HXXADDRET2(Int) GetCharacterWidth() const;
...
/// @return												The converted string.
		template <typename SCR = StreamConversionRef> inline Result<String> ConvertString(const SCR& converter) const;
...
/// @return												The converted string.
		inline Result<String> Prettify(Int indent = 0, const String& indentStr = CONSTSTRING("\t"), Int breakUpThreshold = 100, Bool angularBrackets = false) const;
	};
	/// Intermediate helper class for StringInterface.
	...
	public:
		...
		using PrivateInterface = StringInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(StringInterface**);
...
/// @return												OK on success.
		inline Result<void> Append(const Block<const Utf32Char>& block) const;
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = StringInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(StringInterface**);
...
/// @param[in] block							Character block.
/// @return												OK on success.
		inline Result<void> Append(const Block<const Utf32Char>& block);
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												OK on success.
...
/// @return												OK on success.
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	Result<void> Append(const String& str)
	{
		const auto& s = static_cast<const typename SFINAEHelper<String, S>::type&>(str);
		if (s.IsEmpty())
		{
			return OK;
		}
		else if (!(this->GetPointer() && this->GetPointer()->GetLength()))
		{
			this->GetBaseRef() = s;
			return OK;
		}
...
#ifdef DOXYGEN
public COWFnDoxy<String>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const StringInterface, maxon::StrongCOWRefHandler, String>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const StringInterface, maxon::StrongCOWRefHandler, String>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<StringInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
struct CStringInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = CStringInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(CStringInterface**);
/// Returns the length (number of elements) of the string, not the size of the block.
		inline HXXADDRET2(Int) GetLength() const;
/// Searches for the first occurrence of 'str' within a string.
/// @param[in] str								The search string.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindIndex(const CStringInterface* str, StringPosition start = 0) const;
/// Searches for the last occurrence of 'str' within a string.
/// @param[in] str								The search string.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindLastIndex(const CStringInterface* str, StringPosition start = StringEnd()) const;
/// Searches for the first occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'ch' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindIndex(Char ch, StringPosition start = 0) const;
/// Searches for the last occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'ch' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindLastIndex(Char ch, StringPosition start = StringEnd()) const;
/// Uppercase search for the first occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindUpperIndex(const CStringInterface* str, StringPosition start = 0) const;
/// Uppercase search for the last occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return InvalidArrayIndex.
/// @return												The index at which 'str' has been found or InvalidArrayIndex.
		inline HXXADDRET2(Int) FindLastUpperIndex(const CStringInterface* str, StringPosition start = StringEnd()) const;
/// Creates a part of the current string.
/// @param[in] start							Position where the new partial string will start.
/// @param[in] count							Number of characters for the partial string. If it is larger than the number of available characters an empty string will be returned.
/// @return												The partial string, or empty string if 'start' was out of boundaries. Will be an empty reference if GetPart fails (apply iferr for error handling).
		inline HXXADDRET2(CString) GetPart(StringPosition start, StringCount count) const;
/// Returns the uppercase version of a string.
/// @return												Uppercase version of a string. Will be an empty reference if ToUpper fails (apply iferr for error handling).
		inline HXXADDRET2(CString) ToUpper() const;
/// Returns the lowercase version of a string.
/// @return												Lowercase version of a string. Will be an empty reference if ToLower fails (apply iferr for error handling).
		inline HXXADDRET2(CString) ToLower() const;
/// Compares a part of this against 'str' for exact match.
/// Example:
/// @code
/// "abcdefghijk"_s.ComparePart("bcd"_s,STRINGCOMPARISON::MEMORY,1,3);
...
/// @param[in] count							Number of characters in the current string that 'str' will be compared against. count can be longer than the string length and will be clipped accordingly.
/// @return												See COMPARERESULT.
		inline HXXADDRET2(COMPARERESULT) ComparePart(const CStringInterface* str, STRINGCOMPARISON mode, StringPosition position, StringCount count) const;
/// Compares the object against 'str' for exact match.
/// @param[in] str								Comparison object.
/// @param[in] mode								Comparison mode.
/// @return												See COMPARERESULT.
		inline HXXADDRET2(COMPARERESULT) Compare(const CStringInterface* str, STRINGCOMPARISON mode = STRINGCOMPARISON::UNICODE_NUMBERS) const;
/// Compare strings for equality.
/// @return												True if equal.
		inline HXXADDRET2(Bool) IsEqual(const CStringInterface* str) const;
/// Converts a string to a 64-bit floating point value.
/// This routine does no formula parsing.
/// While leading whitespaces are allowed by default no trailing characters of any kind are allowed.
/// @param[in] flags							Optional flags for the conversion.
...
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return false.
/// @return												True if 'str' has been found, in that case *pos contains the position where the first occurance was found.
		inline HXXADDRET2(Bool) Find(const CString& str, Int* pos, StringPosition start = 0) const;
/// Searches for the last occurrence of 'str' within a string.
/// @param[in] str								The search string.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return false.
/// @return												True if 'str' has been found, in that case *pos contains the position where the last occurance was found.
		inline HXXADDRET2(Bool) FindLast(const CString& str, Int* pos, StringPosition start = StringEnd()) const;
/// Searches for the first occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
/// @param[out] pos								Pointer to be filled with the position where 'ch' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return false.
/// @return												True if 'ch' has been found, in that case *pos contains the position where the first occurance was found.
		inline HXXADDRET2(Bool) Find(Char ch, Int* pos, StringPosition start = 0) const;
/// Searches for the last occurrence of character 'ch' within a string.
/// @param[in] ch									The search character.
/// @param[out] pos								Pointer to be filled with the position where 'ch' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return false.
/// @return												True if 'ch' has been found, in that case *pos contains the position where the last occurance was found.
		inline HXXADDRET2(Bool) FindLast(Char ch, Int* pos, StringPosition start = StringEnd()) const;
/// Uppercase search for the first occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from. If it is out of bounds the function will return false.
/// @return												True if 'str' has been found, in that case *pos contains the position where the first occurance was found.
		inline HXXADDRET2(Bool) FindUpper(const CString& str, Int* pos, StringPosition start = 0) const;
/// Uppercase search for the last occurrence of 'str' within a string (which doesn't need to contain uppercase characters).
/// @param[in] str								The search string, must be completely uppercase, otherwise no matches will be found.
/// @param[out] pos								Pointer to be filled with the position where 'str' was found. This parameter can be a nullptr. In case no occurence was found, *pos is initialized with InvalidArrayIndex.
/// @param[in] start							Starting position within the current string to search from (backwards). The character at the given position will not be included in the search. If it is out of bounds the function will return false.
/// @return												True if 'str' has been found, in that case *pos contains the position where the last occurance was found.
		inline HXXADDRET2(Bool) FindLastUpper(const CString& str, Int* pos, StringPosition start = StringEnd()) const;
/// Returns the string part left of the given position. The character at position will not be included.
/// @param[in] start							Partitioning position.
/// @return												The partial string, or empty string if 'start' was out of boundaries. Will be an empty reference on failure (apply iferr for error handling).
		inline HXXADDRET2(CString) GetLeftPart(StringPosition start) const;
/// Returns the string part right of the given position. The character at position will be included.
/// @param[in] start							Partitioning position.
/// @return												The partial string, or empty string if 'start' was out of boundaries. Will be an empty reference on failure (apply iferr for error handling).
		inline HXXADDRET2(CString) GetRightPart(StringPosition start) const;
/// Checks if the string starts with a certain character.
/// @param[in] ch									The character to be checked.
/// @return												True if the string starts with the given character.
		inline HXXADDRET2(Bool) StartsWith(Char ch) const;
/// Checks if the current string starts with a given string.
/// @param[in] str								The string part.
/// @return												True if the string starts with the string 'str'.
		inline HXXADDRET2(Bool) StartsWith(const CString& str) const;
/// Checks if the string ends with a certain character.
/// @param[in] ch									The character to be checked.
/// @return												True if the string end with the given character.
		inline HXXADDRET2(Bool) EndsWith(Char ch) const;
/// Checks if the current string end with a given string.
/// @param[in] str								The string part.
/// @return												True if the string ends with the string 'str'.
		inline HXXADDRET2(Bool) EndsWith(const CString& str) const;
...
/// @return												Block describing the internal character buffer. The data is read only!
		inline HXXADDRET2(Block<const Char>) GetInternalData() const;
/// @markInternal
/// Caches a static constant string and returns a maxon::CString.
	...
	public:
		...
		using PrivateInterface = CStringInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(CStringInterface**);
/// Initializes the string with a specific length and a default character.
/// @param[in] count							Number of characters of the new string.
/// @param[in] fillChar						Character to fill the string with.
/// @return												OK on success.
...
/// @param[in] block							Character block.
/// @return												OK on success.
		inline Result<void> Append(const Block<const Char>& block) const;
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												OK on success.
...
/// @return												The length of the corresponding 8-bit string for the given encoding. the \0 byte is not counted.
		inline Result<Block<Char>> Disconnect() const;
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = CStringInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(CStringInterface**);
...
/// @param[in] block							Character block.
/// @return												OK on success.
		inline Result<void> Append(const Block<const Char>& block);
/// Appends a character to the current string.
/// @param[in] v									The character that will be added.
/// @return												OK on success.
...
/// Disconnected the cstring internally and returns the memory
/// @return												The length of the corresponding 8-bit string for the given encoding. the \0 byte is not counted.
		inline Result<Block<Char>> Disconnect();
/// Initializes the string with a given 8-bit Char string (the CString will contain an exact copy of
/// the buffer, there's no encoding to a different character set).
/// @param[out] buffer						Pointer to the 8-bit character string.
/// @param[in] count							Number of valid characters in the buffer, a value of -1 automatically detects the
...
/// @return												OK on success.
	...
	/// @return												OK on success.
	//----------------------------------------------------------------------------------------
	Result<void> Append(const CString& str)
	{
		const auto& s = static_cast<const typename SFINAEHelper<CString, S>::type&>(str);
		if (s.IsEmpty())
		{
			return OK;
		}
...
#ifdef DOXYGEN
public COWFnDoxy<CString>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const CStringInterface, maxon::StrongCOWRefHandler, CString>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const CStringInterface, maxon::StrongCOWRefHandler, CString>>>>);
	using NonConst = Hxx1::NonConstRef;
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CStringInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<CStringInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
