...
struct IoHandlerInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = IoHandlerInterface;
...
/// @return												Url scheme of this handler.
		inline HXXADDRET2(const Id&) GetUrlScheme() const;
...
/// @return                       String on success.
		inline Result<String> ConvertToUiName(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository) const;
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IoHandlerInterface, maxon::StrongRefHandler, IoHandler>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IoHandlerInterface, maxon::StrongRefHandler, IoHandler>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoHandlerInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoHandlerInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
