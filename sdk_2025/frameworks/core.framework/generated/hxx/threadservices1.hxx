...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const JobErrorInterface, maxon::StrongCOWRefHandler, JobError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const JobErrorInterface, maxon::StrongCOWRefHandler, JobError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<JobErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<JobErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};

/// JobError is the reference class of JobErrorInterface.
///
/// Error of the category jobs, groups and threads.
class [[nodiscard]] JobError : public JobErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(JobError, JobErrorObject, "net.maxon.error.job",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
/// @cond INTERNAL
