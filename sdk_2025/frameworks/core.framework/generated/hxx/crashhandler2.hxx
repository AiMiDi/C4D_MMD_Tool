...
struct CrashHandler::MTable
{
	...
	PRIVATE_MAXON_SF_POINTER(CrashHandler_ObservableCrashDataDirectory, ObservableCrashDataDirectory, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableCrashDataDirectoryDelegate>), maxon::Bool create);
...
struct CrashHandler::Hxx2
{
	...
	public:
		...
		static maxon::ObservableRef<ObservableCrashDataDirectoryDelegate> CrashHandler_ObservableCrashDataDirectory(maxon::Bool create) { return S::ObservableCrashDataDirectory(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto CrashHandler::ObservableCrashDataDirectory(maxon::Bool create) -> maxon::ObservableRef<ObservableCrashDataDirectoryDelegate>
{
