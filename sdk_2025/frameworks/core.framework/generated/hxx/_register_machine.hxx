...
namespace maxon
{
	...
	const maxon::Char* const MachineInterface::MTable::_ids = 
		...
		"ObservablePrivateSplashMessageReceived@19208b8f271b43f8\0" // maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate> ObservablePrivateSplashMessageReceived(maxon::Bool create) const
		"ObservableActivationChanged@974699d9bfd40dee\0" // maxon::ObservableRef<ObservableActivationChangedDelegate> ObservableActivationChanged(maxon::Bool create) const
	"";
...
/// @endcond
		...
		"ObservableMachineStateChanged@a652bd4cc55099cf\0" // maxon::ObservableRef<ObservableMachineStateChangedDelegate> ObservableMachineStateChanged(maxon::Bool create)
	"";
	MAXON_WARNING_PUSH
