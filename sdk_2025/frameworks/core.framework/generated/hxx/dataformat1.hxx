...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatReaderInterface, maxon::StrongRefHandler, DataFormatReaderRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatReaderInterface, maxon::StrongRefHandler, DataFormatReaderRef>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatWriterInterface, maxon::StrongRefHandler, DataFormatWriterRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatWriterInterface, maxon::StrongRefHandler, DataFormatWriterRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
