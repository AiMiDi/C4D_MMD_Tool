...
namespace maxon
{
	const maxon::Char* const RunLoop::MTable::_ids = 
		...
		"ObservableExitLoop@dc8295d3efc01c81\0" // maxon::ObservableRef<ObservableExitLoopDelegate> ObservableExitLoop(maxon::Bool create)
		"ObservableActivationChange@379b33417aa554eb\0" // maxon::ObservableRef<ObservableActivationChangeDelegate> ObservableActivationChange(maxon::Bool create)
		"ObservableRunLoopMessage@2adc9421faf30671\0" // maxon::ObservableRef<ObservableRunLoopMessageDelegate> ObservableRunLoopMessage(maxon::Bool create)
	...
	public:
		...
		static maxon::ObservableRef<ObservableExitLoopDelegate> ObservableExitLoop(maxon::Bool create) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return RunLoop::ObservableExitLoop(create); return maxon::ObservableRef<ObservableExitLoopDelegate>::DefaultValue();}
		static maxon::ObservableRef<ObservableActivationChangeDelegate> ObservableActivationChange(maxon::Bool create) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return RunLoop::ObservableActivationChange(create); return maxon::ObservableRef<ObservableActivationChangeDelegate>::DefaultValue();}
		static maxon::ObservableRef<ObservableRunLoopMessageDelegate> ObservableRunLoopMessage(maxon::Bool create) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return RunLoop::ObservableRunLoopMessage(create); return maxon::ObservableRef<ObservableRunLoopMessageDelegate>::DefaultValue();}
