...
struct DescriptionProcessorInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DescriptionProcessorInterface;
...
/// @return												Some object whose destructor will be called when the description database is unregistered.
		inline Result<GenericData> Process(const Id& descriptionId, const DataDescriptionDefinition& dataDescriptionDef, const DataDescription& dataDescription) const;
	};
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DescriptionProcessorInterface, maxon::StrongRefHandler, DescriptionProcessor>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const DescriptionProcessorInterface, maxon::StrongRefHandler, DescriptionProcessor>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DescriptionProcessorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DescriptionProcessorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
