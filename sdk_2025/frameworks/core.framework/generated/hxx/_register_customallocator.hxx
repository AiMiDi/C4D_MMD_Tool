...
namespace maxon
{
	...
	const maxon::UNRESOLVED_RETURN_TYPE CustomAllocatorInterface::MTable::_returnTypes[] = 
	{
		maxon::UNRESOLVED_RETURN_TYPE::VOID_ZERO_FREE_FUNCTION,
		maxon::details::UnresolvedReturnType<CustomAllocatorInterface*>::value,
	...
	MAXON_INTERFACE_REGISTER(CustomAllocatorInterface, "net.maxon.interface.customallocator", nullptr, maxon::EntityBase::FLAGS::NONE);
}
#endif
