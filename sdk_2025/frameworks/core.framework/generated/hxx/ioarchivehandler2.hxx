...
struct ReadArchiveInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<ReadArchiveInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ReadArchiveInterface_Open); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ReadArchiveInterface_Open); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ReadArchiveInterface_Open_Offset), mt_.ReadArchiveInterface_Open, inputFile, password));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ReadArchiveInterface::Hxx1::Fn<S>::Close() const -> Result<void>
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ReadArchiveInterface_Close); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ReadArchiveInterface_Close); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ReadArchiveInterface_Close_Offset), mt_.ReadArchiveInterface_Close));
}
...
{
	HXXRETURN0(Result<Url>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ReadArchiveInterface_ExtractSingleFile); 
...
{
	HXXRETURN0(Result<Url>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ReadArchiveInterface_ExtractSingleFile); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ReadArchiveInterface_ExtractSingleFile_Offset), mt_.ReadArchiveInterface_ExtractSingleFile, archiveFile, outputDirectory, std::forward<ThreadRef>(thread), flags, extractCallback));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(ReadArchiveInterface_Extract); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(ReadArchiveInterface_Extract); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ReadArchiveInterface_Extract_Offset), mt_.ReadArchiveInterface_Extract, outputDirectory, std::forward<ThreadRef>(thread), flags, extractCallback));
}
...
struct WriteArchiveInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<WriteArchiveInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_Open); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_Open); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_Open_Offset), mt_.WriteArchiveInterface_Open, inputFile, append, password));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::Hxx1::Fn<S>::Close() const -> Result<void>
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_Close); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_Close); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_Close_Offset), mt_.WriteArchiveInterface_Close));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_SetCompressionLevel); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_SetCompressionLevel); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_SetCompressionLevel_Offset), mt_.WriteArchiveInterface_SetCompressionLevel, compressionLevel));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::Hxx1::ConstFn<S>::GetCompressionLevel() const -> HXXADDRET2(Int)
{
	HXXRETURN0(HXXADDRET2(Int)); HXXRES; HXXCONST(0) HXXTABLE(WriteArchiveInterface_GetCompressionLevel); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_CreateDirectory); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_CreateDirectory); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_CreateDirectory_Offset), mt_.WriteArchiveInterface_CreateDirectory, name, dateTime, fileAttributes));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_CreateFile); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_CreateFile); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_CreateFile_Offset), mt_.WriteArchiveInterface_CreateFile, name, dateTime, method, fileAttributes, cryptCrc));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_WriteFile); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_WriteFile); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_WriteFile_Offset), mt_.WriteArchiveInterface_WriteFile, data));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto WriteArchiveInterface::Hxx1::Fn<S>::CloseFile() const -> Result<void>
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_CloseFile); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_CloseFile); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_CloseFile_Offset), mt_.WriteArchiveInterface_CloseFile));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(WriteArchiveInterface_CopyFile); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(WriteArchiveInterface_CopyFile); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.WriteArchiveInterface_CopyFile_Offset), mt_.WriteArchiveInterface_CopyFile, fn, str, fileAttributes, fileAttributesMask));
}
