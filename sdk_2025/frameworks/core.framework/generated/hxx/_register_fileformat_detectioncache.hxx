...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(FileFormatDetectionCacheInterface, , "net.maxon.interface.fileformatdetectioncacheinterface", (ObjectInterface::PrivateGetInterface()));
