...
namespace maxon
{
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(DataDescriptionObjectInterface);
	static maxon::InterfaceDefinition s_DataDescriptionObjectInterface(DataDescriptionObjectInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION,"maxon::DataDescriptionObjectRef");
#endif
	...
	public:
		...
		Result<DataDescription> GetObjectDescription(const Id& category, const LanguageRef& language, const DataDictionaryObjectRef& objectData) const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.DataDescriptionObjectInterface_GetObjectDescription_Offset), maxon::reflection::Argument::ByReference(category), maxon::reflection::Argument::ByReference(language), maxon::reflection::Argument::ByReference(objectData)};
			(*handler_)(_fn_DataDescriptionObjectInterface_GetObjectDescription, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((Result<DataDescription>), const Id&, const LanguageRef&, const DataDictionaryObjectRef&), reinterpret_cast<const void* const&>(mt_.DataDescriptionObjectInterface_GetObjectDescription)));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DataDescriptionObjectInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, &maxon::g_translationUnit, ::MaxonRegistry, maxon::LiteralId());
#endif
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionObjectInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionObjectInterface::Hxx2::StaticMTable::_instance.DataDescriptionObjectInterface_GetObjectName)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "classId\0language\0", 5LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "category\0language\0objectData\0", 21LL, DataDescriptionObjectInterface, DataDescriptionObjectInterface_GetObjectDescription),
		};
