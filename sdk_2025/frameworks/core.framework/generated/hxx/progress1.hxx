...
/// -param[in] userData						User data passed from the caller.
		inline HXXADDRET2(maxon::ObservableRef<ObservableProgressNotificationDelegate>) ObservableProgressNotification(maxon::Bool create) const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ProgressInterface, maxon::StrongRefHandler, ProgressRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ProgressInterface, maxon::StrongRefHandler, ProgressRef>>>>);
