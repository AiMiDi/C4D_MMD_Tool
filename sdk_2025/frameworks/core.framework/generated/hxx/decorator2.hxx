...
{
	HXXRETURN0(HXXADDRET2(ObjectBaseRef<maxon::details::GetPrivateReferencedType<S>>)); HXXSUPER("DecoratorInterface::GetDecoratedObject"); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<ObjectBaseRef<maxon::details::GetPrivateReferencedType<S>>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
