...
/// @endcond
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ObserverObjectInterface);
...
/// @endcond
		...
		maxon::ObservableRef<ObserverDestroyedDelegate> ObserverDestroyed(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_ObserverObjectInterface_ObserverDestroyed, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((maxon::ObservableRef<ObserverDestroyedDelegate>), maxon::Bool), reinterpret_cast<const void* const&>(mt_.ObserverObjectInterface_ObserverDestroyed)));
			return proxy_result;
		}
		static const maxon::reflection::Function* _fn_ObserverObjectInterface_ObserverDestroyed;
		maxon::ObservableRef<ObserverDisconnectNotifyDelegate> ObserverDisconnectNotify(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
		...
		maxon::ObservableRef<ObserverConnectNotifyDelegate> ObserverConnectNotify(maxon::Bool create) const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
