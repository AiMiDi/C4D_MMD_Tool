...
namespace maxon
{
	...
	const maxon::Char* const SystemProcessObjectInterface::MTable::_ids = 
		...
		"ObservableProcessFinished@78d060560b3ae269\0" // maxon::ObservableRef<ObservableProcessFinishedDelegate> ObservableProcessFinished(maxon::Bool create) const
		"GetLoadedDlls@2b0a9ff4ee7da53a\0" // Result<Bool> GetLoadedDlls(const ValueReceiver<const DllRef&>& dlls) const
	"";
