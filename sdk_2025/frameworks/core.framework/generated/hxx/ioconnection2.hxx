...
struct ResolveInterface::Hxx2
{
	...
	public:
		...
		static void ResolveInterface_Free(const ResolveInterface* object) { return S::Free(object); }
		static Result<Url> ResolveInterface_RemoveDotSegments(const Url& url) { return S::RemoveDotSegments(url); }
	};
...
struct IoConnectionInterface::MTable
{
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<IoConnectionInterface, typename DataDictionaryObjectInterface::MTable::template CombinedMTable<S>>;
...
struct IoConnectionInterface::Hxx2
{
	...
	struct StaticMTable
	{
		...
		static const maxon::Char* const _ids;
		static const maxon::UNRESOLVED_RETURN_TYPE _returnTypes[];
	PRIVATE_MAXON_SF_POINTER(IoConnectionInterface_ObservableErrorOpenFile, ObservableErrorOpenFile, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableErrorOpenFileDelegate>), maxon::Bool create);
	...
	public:
		...
		static maxon::ObservableRef<ObservableErrorOpenFileDelegate> IoConnectionInterface_ObservableErrorOpenFile(maxon::Bool create) { return S::Implementation::ObservableErrorOpenFile(create); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::ObservableErrorOpenFile(maxon::Bool create) -> maxon::ObservableRef<ObservableErrorOpenFileDelegate>
{
	return Hxx2::StaticMTable::_instance.IoConnectionInterface_ObservableErrorOpenFile(create);
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ConstFn<S>::GetUrl() const -> HXXADDRET2(const Url&)
{
	HXXRETURN0(HXXADDRET2(const Url&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const Url&)) HXXTABLE(IoConnectionInterface_GetUrl); 
...
{
	HXXRETURN0(Result<IoBrowseRef>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_GetBrowseIterator); 
...
{
	HXXRETURN0(Result<IoBrowseRef>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_GetBrowseIterator); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_GetBrowseIterator_Offset), mt_.IoConnectionInterface_GetBrowseIterator, flags));
}
...
{
	HXXRETURN0(Result<InputStreamRef>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_OpenInputStream); 
...
{
	HXXRETURN0(Result<InputStreamRef>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_OpenInputStream); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_OpenInputStream_Offset), mt_.IoConnectionInterface_OpenInputStream, flags));
}
...
{
	HXXRETURN0(Result<OutputStreamRef>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_OpenOutputStream); 
...
{
	HXXRETURN0(Result<OutputStreamRef>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_OpenOutputStream); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_OpenOutputStream_Offset), mt_.IoConnectionInterface_OpenOutputStream, flags));
}
...
{
	HXXRETURN0(Result<InOutputStreamRef>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_OpenInOutputStream); 
...
{
	HXXRETURN0(Result<InOutputStreamRef>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_OpenInOutputStream); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_OpenInOutputStream_Offset), mt_.IoConnectionInterface_OpenInOutputStream, flags));
}
...
{
	HXXRETURN0(Result<Int64>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_GetContentLength); 
...
{
	HXXRETURN0(Result<Int64>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_GetContentLength); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_GetContentLength_Offset), mt_.IoConnectionInterface_GetContentLength));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ConstFn<S>::IoDetect() const -> HXXADDRET2(IODETECT)
{
	HXXRETURN0(HXXADDRET2(IODETECT)); HXXRES; HXXCONST(HXXRET3(NULLPTR, IODETECT)) HXXTABLE(IoConnectionInterface_IoDetect); 
...
{
	HXXRETURN0(Result<IOATTRIBUTES>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoGetAttributes); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoSetAttributes); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoSetAttributes); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoSetAttributes_Offset), mt_.IoConnectionInterface_IoSetAttributes, flags, mask));
}
...
{
	HXXRETURN0(Result<UniversalDateTime>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoGetTime); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoSetTime); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoSetTime); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoSetTime_Offset), mt_.IoConnectionInterface_IoSetTime, mode, dateTime));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoDelete); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoDelete); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoDelete_Offset), mt_.IoConnectionInterface_IoDelete, force));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoCreateDirectory); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoCreateDirectory); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoCreateDirectory_Offset), mt_.IoConnectionInterface_IoCreateDirectory, createParents, createdDirs));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoCopyFile); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoCopyFile); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoCopyFile_Offset), mt_.IoConnectionInterface_IoCopyFile, destName, overwrite, removeReadOnly));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoCopyFileProgress); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoCopyFileProgress); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoCopyFileProgress_Offset), mt_.IoConnectionInterface_IoCopyFileProgress, destName, overwrite, removeReadOnly, progress));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoMove); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoMove); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoMove_Offset), mt_.IoConnectionInterface_IoMove, destName));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, , false, HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoRename); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXNONCONST(, MakeWritable(true)., true, HXXRET2a(HXXRET1(MAKE_WRITABLE_FAILED))) HXXTABLE(IoConnectionInterface_IoRename); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.IoConnectionInterface_IoRename_Offset), mt_.IoConnectionInterface_IoRename, newName));
}
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoGetFreeVolumeSpace); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoConnectionInterface_IoShowInOS); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ConstFn<S>::ObservableErrorOpenFile(maxon::Bool create) -> maxon::ObservableRef<ObservableErrorOpenFileDelegate>
{
	return (Hxx2::StaticMTable::_instance.IoConnectionInterface_ObservableErrorOpenFile(create));
}
