...
{
	HXXRETURN0(HXXADDRET2(const TYPE&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const TYPE&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(ResultRef<TYPE>)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultRef<TYPE>, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(ResultMem)); HXXRES; HXXNONCONST(, , false, maxon::PrivateDefaultReturnValue<ResultMem, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(const PersistentIdGenerator&)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<const PersistentIdGenerator&, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
...
{
	HXXRETURN0(HXXADDRET2(typename StaticArrayInterface<TYPE>::ConstIterator)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<typename StaticArrayInterface<TYPE>::ConstIterator, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (o_->Begin());
}
...
{
	HXXRETURN0(HXXADDRET2(typename ArrayInterface<TYPE>::ConstIterator)); HXXRES; HXXCONST(maxon::PrivateDefaultReturnValue<typename ArrayInterface<TYPE>::ConstIterator, false>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK)) 
	return (o_->Begin());
}
