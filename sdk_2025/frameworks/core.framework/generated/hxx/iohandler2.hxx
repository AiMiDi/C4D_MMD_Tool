...
struct IoHandlerInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(IoHandlerInterface_ConvertToUiName, ConvertToUiName, true, maxon::GenericComponent, const, (Result<String>), const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository);
	...
	template <typename S> using CombinedMTable = maxon::PrivateCombinedMTable<IoHandlerInterface, typename ObjectInterface::MTable::template CombinedMTable<S>>;
...
struct IoHandlerInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(IoHandlerInterface_ConvertToUiName, maxon::GenericComponent, const, (Result<String>), const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository) { return ((const typename S::Implementation*) PRIVATE_MAXON_MF_THIS(const maxon::GenericComponent))->ConvertToUiName(url, flags, lookupRepository); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::ConvertToUiName(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository) const -> Result<String>
{
	const IoHandlerInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(IoHandlerInterface, this); return PRIVATE_MAXON_MF_INVOKE(((const maxon::GenericComponent*) this + mt_.IoHandlerInterface_ConvertToUiName_Offset), mt_.IoHandlerInterface_ConvertToUiName, url, flags, lookupRepository);
}

template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::Hxx1::ConstFn<S>::GetUrlScheme() const -> HXXADDRET2(const Id&)
{
	HXXRETURN0(HXXADDRET2(const Id&)); HXXRES; HXXCONST(HXXRET3(NULLPTR, const Id&)) HXXTABLE(IoHandlerInterface_GetUrlScheme); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_SetSystemPath); 
...
{
	HXXRETURN0(Result<String>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_GetSystemPath); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_AppendUrl); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_AppendUrl_1); 
...
{
	HXXRETURN0(Result<void>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_RemoveUrl); 
...
{
	HXXRETURN0(Result<IoConnectionRef>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_OpenConnection); 
...
{
	HXXRETURN0(Result<Url>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_Normalize); 
...
{
	HXXRETURN0(Result<Url>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_IoNormalize); 
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoHandlerInterface::Hxx1::ConstFn<S>::ConvertToUiName(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags, const AssetRepositoryRef& lookupRepository) const -> Result<String>
{
	HXXRETURN0(Result<String>); HXXRES; HXXCONST(HXXRET1(NULLPTR)) HXXTABLE(IoHandlerInterface_ConvertToUiName); 
	return (PRIVATE_MAXON_MF_INVOKE((reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_.IoHandlerInterface_ConvertToUiName_Offset), mt_.IoHandlerInterface_ConvertToUiName, url, flags, lookupRepository));
}
