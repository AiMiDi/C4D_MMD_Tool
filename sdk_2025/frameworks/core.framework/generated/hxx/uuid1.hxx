...
struct UuidInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = UuidInterface;
...
/// @return												See COMPARERESULT.
		inline HXXADDRET2(COMPARERESULT) Compare(const UuidInterface* uuid) const;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UuidInterface, maxon::StrongCOWRefHandler, Uuid>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UuidInterface, maxon::StrongCOWRefHandler, Uuid>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UuidInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UuidInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
