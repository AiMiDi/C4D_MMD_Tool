...
namespace maxon
{
	const maxon::Char* const CrashHandler::MTable::_ids = 
		...
		"ObservableCrashDataDirectory@272a6ca3f5af859d\0" // maxon::ObservableRef<ObservableCrashDataDirectoryDelegate> ObservableCrashDataDirectory(maxon::Bool create)
	"";
	MAXON_WARNING_PUSH
