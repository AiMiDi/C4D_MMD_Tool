#if 1
constexpr inline const maxon::Char* DT_IDENT_VOID_CppName() { return "maxon::IDENT_VOID"; }
...
struct DataSerializeInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataSerializeInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(DataSerializeInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataSerializeInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DataSerializeInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(DataSerializeInterface**);
...
/// @return												The allocated class or a nullptr.
	...
	public:
		...
		using PrivateInterface = DataSerializeInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(DataSerializeInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = DataSerializeInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(DataSerializeInterface**);
...
#ifdef DOXYGEN
public FnDoxy<DataSerializeRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeInterface, maxon::StrongRefHandler, DataSerializeRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeInterface, maxon::StrongRefHandler, DataSerializeRef>>>>);
...
public:
	...
	using ConstPtr = typename DataSerializeInterface::ConstPtr;
};

class DataSerializeWriterRef;

struct DataSerializeWriterInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataSerializeWriterInterface>::value || DataSerializeInterface::HasBaseDetector::template Check<I>::value; static I* Cast(DataSerializeWriterInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataSerializeWriterInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = DataSerializeWriterInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(DataSerializeWriterInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = DataSerializeWriterInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(DataSerializeWriterInterface**);
...
/// @return												OK on success.
	...
	template <typename ST> struct FnHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWFn<typename DataSerializeInterface::Hxx1::template FnHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename DataSerializeInterface::Hxx1::template FnHelper<ST>::type, Fn<typename DataSerializeInterface::Hxx1::template FnHelper<ST>::type>>::type
	> { };
};
class DataSerializeWriterInterface::Hxx1::Reference :
#ifdef DOXYGEN
public FnDoxy<DataSerializeWriterRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeWriterInterface, maxon::StrongRefHandler, DataSerializeWriterRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeWriterInterface, maxon::StrongRefHandler, DataSerializeWriterRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
public:
	...
	using ConstPtr = typename DataSerializeWriterInterface::ConstPtr;
};

class DataSerializeReaderRef;

struct DataSerializeReaderInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataSerializeReaderInterface>::value || DataSerializeInterface::HasBaseDetector::template Check<I>::value; static I* Cast(DataSerializeReaderInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataSerializeReaderInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = DataSerializeReaderInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(DataSerializeReaderInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = DataSerializeReaderInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(DataSerializeReaderInterface**);
...
#ifdef DOXYGEN
public FnDoxy<DataSerializeReaderRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeReaderInterface, maxon::StrongRefHandler, DataSerializeReaderRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataSerializeReaderInterface, maxon::StrongRefHandler, DataSerializeReaderRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
public:
	...
	using ConstPtr = typename DataSerializeReaderInterface::ConstPtr;
};
