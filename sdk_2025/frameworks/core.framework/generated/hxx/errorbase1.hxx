...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const OutOfMemoryErrorInterface, maxon::StrongCOWRefHandler, OutOfMemoryError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const OutOfMemoryErrorInterface, maxon::StrongCOWRefHandler, OutOfMemoryError>>>>);
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<OutOfMemoryErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<OutOfMemoryErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] OutOfMemoryError : public OutOfMemoryErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(OutOfMemoryError, OutOfMemoryErrorObject, "net.maxon.error.outofmemory",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const FunctionNotImplementedErrorInterface, maxon::StrongCOWRefHandler, FunctionNotImplementedError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const FunctionNotImplementedErrorInterface, maxon::StrongCOWRefHandler, FunctionNotImplementedError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FunctionNotImplementedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<FunctionNotImplementedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] FunctionNotImplementedError : public FunctionNotImplementedErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(FunctionNotImplementedError, FunctionNotImplementedErrorObject, "net.maxon.error.functionnotimplemented",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IllegalArgumentErrorInterface, maxon::StrongCOWRefHandler, IllegalArgumentError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IllegalArgumentErrorInterface, maxon::StrongCOWRefHandler, IllegalArgumentError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IllegalArgumentErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IllegalArgumentErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] IllegalArgumentError : public IllegalArgumentErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(IllegalArgumentError, IllegalArgumentErrorObject, "net.maxon.error.illegalargument",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
class NullptrError;
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const NullptrErrorInterface, maxon::StrongCOWRefHandler, NullptrError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const NullptrErrorInterface, maxon::StrongCOWRefHandler, NullptrError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<NullptrErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<NullptrErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] NullptrError : public NullptrErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(NullptrError, NullptrErrorObject, "net.maxon.error.nullptr",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IllegalStateErrorInterface, maxon::StrongCOWRefHandler, IllegalStateError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const IllegalStateErrorInterface, maxon::StrongCOWRefHandler, IllegalStateError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IllegalStateErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IllegalStateErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] IllegalStateError : public IllegalStateErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(IllegalStateError, IllegalStateErrorObject, "net.maxon.error.illegalstate",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnexpectedErrorInterface, maxon::StrongCOWRefHandler, UnexpectedError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const UnexpectedErrorInterface, maxon::StrongCOWRefHandler, UnexpectedError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnexpectedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<UnexpectedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] UnexpectedError : public UnexpectedErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(UnexpectedError, UnexpectedErrorObject, "net.maxon.error.unexpected",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const OperationCancelledErrorInterface, maxon::StrongCOWRefHandler, OperationCancelledError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const OperationCancelledErrorInterface, maxon::StrongCOWRefHandler, OperationCancelledError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<OperationCancelledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<OperationCancelledErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
...
class [[nodiscard]] OperationCancelledError : public OperationCancelledErrorInterface::Hxx1::Reference
{
public:
...
MAXON_DECLARATION(OperationCancelledError, OperationCancelledErrorObject, "net.maxon.error.OperationCancelledError",  MAXON_IMPLEMENTATION_MODULE("net.maxon.kernel"););
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const AggregatedErrorInterface, maxon::StrongCOWRefHandler, AggregatedError>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<const AggregatedErrorInterface, maxon::StrongCOWRefHandler, AggregatedError>>>>);
	using NonConst = Hxx1::NonConstRef;
};
...
public FnDoxy<NonConstRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<AggregatedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<AggregatedErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
};
