...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservableStateChangedDelegate> ObservableStateChanged(maxon::Bool create) const
	{
		return maxon::ObservableRef<ObservableStateChangedDelegate>::DefaultValue();
	}

	MAXON_METHOD maxon::ObservableRef<ObservableTotalProgressNotificationDelegate> ObservableTotalProgressNotification(maxon::Bool create) const
	{
