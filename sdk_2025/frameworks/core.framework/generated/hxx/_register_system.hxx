...
namespace maxon
{
	namespace enum42
	{
		...
		static const maxon::UInt64 MEMORYDIAGNOSTICSMODE_values[] = {maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::ESTIMATEONLY), maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::QUIET), maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::VERBOSE), maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::LEAKGRAPH), maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::PRIVATE_OFF), maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::PRIVATE_ON), maxon::UInt64(enum42::MEMORYDIAGNOSTICSMODE::PRIVATE_GARBAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_MEMORYDIAGNOSTICSMODE42(void*){ return enum42::MEMORYDIAGNOSTICSMODE_info; }
	namespace enum49
	{
		...
		static const maxon::UInt64 MEMORYOBSERVERMODE_values[] = {maxon::UInt64(enum49::MEMORYOBSERVERMODE::LOWMEM_CLEANUP), maxon::UInt64(enum49::MEMORYOBSERVERMODE::LOWMEM_FAILURE), maxon::UInt64(enum49::MEMORYOBSERVERMODE::WARNMEM_LIMIT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_MEMORYOBSERVERMODE49(void*){ return enum49::MEMORYOBSERVERMODE_info; }
	const maxon::Char* const System::MTable::_ids = 
		...
		"AddEpochObserver@c4fea2639ca3df6f\0" // void AddEpochObserver(void* data, maxon::details::EpochObserver observer)
		...
		"PrivateHasherFinalize@9bf3a5391f0aaf9d\0" // UniqueHash PrivateHasherFinalize(const UniqueHasher& state)
	...
	public:
		...
		static OUTPUT GetConsoleOutputType() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return System::GetConsoleOutputType(); return HXXRET3(UNRESOLVED, OUTPUT);}
		...
		static void AddEpochObserver(void* data, maxon::details::EpochObserver observer) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return System::AddEpochObserver(data, std::forward<maxon::details::EpochObserver>(observer)); return maxon::PrivateLogNullptrError();}
		...
		static Result<const Id*> PrivateGetInternedId(const Id& value) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, false)) return System::PrivateGetInternedId(value); return HXXRET1(UNRESOLVED);}
		...
		static Id GetApplicationId() { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return System::GetApplicationId(); return HXXRET3(UNRESOLVED, Id);}
		...
		static UniqueHash PrivateGetUniqueHashCode(const Byte* ptr, Int count) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return System::PrivateGetUniqueHashCode(ptr, count); return HXXRET3(UNRESOLVED, UniqueHash);}
		...
		static UniqueHash PrivateHasherFinalize(const UniqueHasher& state) { if (maxon::NonvirtualInterfaceReference::PrivateResolve(&_interface, true)) return System::PrivateHasherFinalize(state); return HXXRET3(UNRESOLVED, UniqueHash);}
	...
	const maxon::UNRESOLVED_RETURN_TYPE System::MTable::_returnTypes[] = 
	{
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<OUTPUT>::value,
		maxon::details::UnresolvedReturnType<void*>::value,
		maxon::details::UnresolvedReturnType<void*>::value,
		maxon::details::UnresolvedReturnType<void*>::value,
		...
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<Float64>::value,
		maxon::details::UnresolvedReturnType<Int>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<Char*>::value,
		maxon::details::UnresolvedReturnType<Int>::value,
		maxon::details::UnresolvedReturnType<const InterfaceReference*>::value,
		maxon::details::UnresolvedReturnType<EntityDefinition*>::value,
		maxon::details::UnresolvedReturnType<void*>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<const Error*>::value,
		maxon::details::UnresolvedReturnType<const Error*>::value,
		maxon::details::UnresolvedReturnType<const Error*>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<const ErrorInterface*>::value,
		maxon::details::UnresolvedReturnType<Result<const Id*>>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<const Char*>::value,
		maxon::details::UnresolvedReturnType<Id>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<Bool>::value,
		maxon::details::UnresolvedReturnType<UniqueHash>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<void>::value,
		maxon::details::UnresolvedReturnType<UniqueHash>::value,
	...
	maxon::Bool System::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<OUTPUT>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->System_GetConsoleOutputType = PRIVATE_MAXON_MF_CAST(decltype(System_GetConsoleOutputType), &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetConsoleOutputType);
		#else
		...
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->System_AddEpochObserver = PRIVATE_MAXON_MF_CAST(decltype(System_AddEpochObserver), &Hxx2::Wrapper<Hxx2::Unresolved>::System_AddEpochObserver);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Result<const Id*>>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->System_PrivateGetInternedId = PRIVATE_MAXON_MF_CAST(decltype(System_PrivateGetInternedId), &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateGetInternedId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<Id>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->System_GetApplicationId = PRIVATE_MAXON_MF_CAST(decltype(System_GetApplicationId), &Hxx2::Wrapper<Hxx2::Unresolved>::System_GetApplicationId);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<UniqueHash>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->System_PrivateGetUniqueHashCode = PRIVATE_MAXON_MF_CAST(decltype(System_PrivateGetUniqueHashCode), &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateGetUniqueHashCode);
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if constexpr (maxon::details::UnresolvedReturnType<UniqueHash>::value == maxon::UNRESOLVED_RETURN_TYPE::OTHER) tbl->System_PrivateHasherFinalize = PRIVATE_MAXON_MF_CAST(decltype(System_PrivateHasherFinalize), &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateHasherFinalize);
		#else
		tbl->System_PrivateHasherFinalize = PRIVATE_MAXON_MF_CAST(decltype(System_PrivateHasherFinalize), &Hxx2::Wrapper<Hxx2::Unresolved>::System_PrivateHasherFinalize);
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
	...
	MAXON_INTERFACE_REGISTER(System, "net.maxon.interface.system", nullptr, maxon::EntityBase::FLAGS::NONE);
	template <typename DUMMY> maxon::Int System::PrivateInstantiateDefaultValueHelper()
	{
		return 0
		| maxon::details::InstantiateDefaultReturnValue<Id>(OVERLOAD_MAX_RANK)
		| maxon::details::InstantiateDefaultReturnValue<OUTPUT>(OVERLOAD_MAX_RANK)
...
static maxon::details::ForceEvaluation s_forceEval_system(0
	| maxon::System::PrivateInstantiateDefaultValueHelper<maxon::Int>()
);
