...
struct DataDescriptionDatabaseInterface::Hxx2
{
	...
	public:
		...
		static Result<DataDescription> DataDescriptionDatabaseInterface_LoadDescription(const Id& category, const LanguageRef& language, const Id& dataType) { return S::LoadDescription(category, language, dataType); }
		static Result<DataDescription> DataDescriptionDatabaseInterface_LoadDescription_1(const Id& category, const LanguageRef& language, const IdAndVersion& dataType) { return S::LoadDescription(category, language, dataType); }
		static Result<void> DataDescriptionDatabaseInterface_DescriptionDefinitionChanged(const Id& category, const LanguageRef& language, const IdAndVersion& dataType) { return S::DescriptionDefinitionChanged(category, language, dataType); }
		static Result<BaseArray<Tuple<Id, Data, String>>> DataDescriptionDatabaseInterface_GetEffectiveEnumList(const DataDictionary& dataEntry, const DataDictionary& guiEntry, const DataDescription& stringDescription, Bool resolveExtensionPointsAndGui, Bool withStrings, const LanguageRef& language, const AssetRepositoryRef& repository, const Data* filterData) { return S::GetEffectiveEnumList(dataEntry, guiEntry, stringDescription, resolveExtensionPointsAndGui, withStrings, language, repository, filterData); }
		static Result<BaseArray<Tuple<Id, Data, String>>> DataDescriptionDatabaseInterface_GetEffectiveEnumList_1(const DataDictionary& dataEntry, const DataDictionary& guiEntry, const DataDescription& stringDescription, Bool resolveExtensionPointsAndGui, Bool withStrings, const LanguageRef& language, const AssetRepositoryRef& repository, const GetDataCallbackType& getDataCallback, const Data* filterData) { return S::GetEffectiveEnumList(dataEntry, guiEntry, stringDescription, resolveExtensionPointsAndGui, withStrings, language, repository, getDataCallback, filterData); }
		static Result<void> DataDescriptionDatabaseInterface_PostProcessStringDescription(DataDescription& description, const BaseArray<DataDictionary>& entries) { return S::PostProcessStringDescription(description, entries); }
		static Result<Id> DataDescriptionDatabaseInterface_ResolveVariableIdentifier(const Id& identifier, const AssetRepositoryRef& repository, const GetDataCallbackType& getDataCallback, Opt<const DataDictionary&> dataEntry, Opt<const DataDictionary&> guiEntry) { return S::ResolveVariableIdentifier(identifier, repository, getDataCallback, std::forward<Opt<const DataDictionary&>>(dataEntry), std::forward<Opt<const DataDictionary&>>(guiEntry)); }
		static Result<Id> DataDescriptionDatabaseInterface_GetAndResolvePresetIdentifier(const AssetRepositoryRef& repository, const GetDataCallbackType& getDataCallback, const DataDictionary& guiEntry, Opt<const DataDictionary&> dataEntry, Bool& outResolveSuccess) { return S::GetAndResolvePresetIdentifier(repository, getDataCallback, guiEntry, std::forward<Opt<const DataDictionary&>>(dataEntry), outResolveSuccess); }
	};
