...
struct DataDictionaryIteratorInterface::Hxx2
{
	...
	public:
		...
		PRIVATE_MAXON_MF_WRAPPER(DataDictionaryIteratorInterface_Destruct, DataDictionaryIteratorInterface,, (void)) { return S::Get(PRIVATE_MAXON_MF_THIS(DataDictionaryIteratorInterface))->Destruct(); }
		PRIVATE_MAXON_MF_WRAPPER(DataDictionaryIteratorInterface_MoveConstruct, DataDictionaryIteratorInterface,, (void), DataDictionaryIteratorInterface* src) { return S::Get(PRIVATE_MAXON_MF_THIS(DataDictionaryIteratorInterface))->MoveConstruct(src); }
		PRIVATE_MAXON_MF_WRAPPER(DataDictionaryIteratorInterface_HasValue, DataDictionaryIteratorInterface, const, (Bool)) { return S::Get(PRIVATE_MAXON_MF_THIS(const DataDictionaryIteratorInterface))->HasValue(); }
		PRIVATE_MAXON_MF_WRAPPER(DataDictionaryIteratorInterface_IsEqual, DataDictionaryIteratorInterface, const, (Bool), const DataDictionaryIteratorInterface* other) { return S::Get(PRIVATE_MAXON_MF_THIS(const DataDictionaryIteratorInterface))->IsEqual(other); }
		PRIVATE_MAXON_MF_WRAPPER(DataDictionaryIteratorInterface_MoveToNext, DataDictionaryIteratorInterface,, (void)) { return S::Get(PRIVATE_MAXON_MF_THIS(DataDictionaryIteratorInterface))->MoveToNext(); }
		PRIVATE_MAXON_MF_WRAPPER(DataDictionaryIteratorInterface_GetKeyAndData, DataDictionaryIteratorInterface, const, (void), Tuple<const Data&, const Data&>& res) { return S::Get(PRIVATE_MAXON_MF_THIS(const DataDictionaryIteratorInterface))->GetKeyAndData(res); }
	};
