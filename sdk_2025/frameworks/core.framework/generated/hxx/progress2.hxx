...
struct ProgressInterface::MTable
{
	...
	PRIVATE_MAXON_MF_POINTER(ProgressInterface_ObservableProgressNotification, ObservableProgressNotification, true, maxon::GenericComponent, const, (maxon::ObservableRef<ObservableProgressNotificationDelegate>), maxon::Bool create);
...
MAXON_ATTRIBUTE_FORCE_INLINE auto ProgressInterface::ObservableProgressNotification(maxon::Bool create) const -> maxon::ObservableRef<ObservableProgressNotificationDelegate>
{
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ProgressInterface::Hxx1::ConstFn<S>::ObservableProgressNotification(maxon::Bool create) const -> HXXADDRET2(maxon::ObservableRef<ObservableProgressNotificationDelegate>)
{
