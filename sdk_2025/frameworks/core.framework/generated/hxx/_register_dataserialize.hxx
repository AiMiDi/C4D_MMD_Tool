...
namespace maxon
{
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataSerializeInterface, , "net.maxon.interface.dataserialize", (ObjectInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataSerializeWriterInterface, , "net.maxon.interface.dataserializewriter", (DataSerializeInterface::PrivateGetInterface()));
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(DataSerializeReaderInterface, , "net.maxon.interface.dataserializereader", (DataSerializeInterface::PrivateGetInterface()));
