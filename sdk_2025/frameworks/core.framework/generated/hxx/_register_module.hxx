...
/// @cond INTERNAL
	...
	namespace enum327
	{
		...
		static const maxon::UInt64 DEPENDENCY_values[] = {maxon::UInt64(enum327::DEPENDENCY::STRONG), maxon::UInt64(enum327::DEPENDENCY::WEAK), maxon::UInt64(enum327::DEPENDENCY::OPTIONAL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_DEPENDENCY327(void*){ return enum327::DEPENDENCY_info; }
#endif
