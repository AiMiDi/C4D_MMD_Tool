...
struct ReadArchiveInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ReadArchiveInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(ReadArchiveInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct ReadArchiveInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = ReadArchiveInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(ReadArchiveInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = ReadArchiveInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(ReadArchiveInterface**);
...
#ifdef DOXYGEN
public FnDoxy<ReadArchiveRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ReadArchiveInterface, maxon::StrongRefHandler, ReadArchiveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<ReadArchiveInterface, maxon::StrongRefHandler, ReadArchiveRef>>>>);
...
public:
	...
	using ConstPtr = typename ReadArchiveInterface::ConstPtr;
};

class WriteArchiveRef;

struct WriteArchiveInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, WriteArchiveInterface>::value || ObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(WriteArchiveInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct WriteArchiveInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = WriteArchiveInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(WriteArchiveInterface**);
/// Returns the current compression level.
/// @return												The current compression level.
		inline HXXADDRET2(Int) GetCompressionLevel() const;
	};
	/// Intermediate helper class for WriteArchiveInterface.
	...
	public:
		...
		using PrivateInterface = WriteArchiveInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(WriteArchiveInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = WriteArchiveInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(WriteArchiveInterface**);
...
#ifdef DOXYGEN
public FnDoxy<WriteArchiveRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<WriteArchiveInterface, maxon::StrongRefHandler, WriteArchiveRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<WriteArchiveInterface, maxon::StrongRefHandler, WriteArchiveRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
public:
	...
	using ConstPtr = typename WriteArchiveInterface::ConstPtr;
};
