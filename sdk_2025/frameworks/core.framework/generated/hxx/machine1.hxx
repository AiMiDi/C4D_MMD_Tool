...
/// @return												The converted result.
		...
		inline HXXADDRET2(maxon::ObservableRef<ObservablePrivateSplashMessageReceivedDelegate>) ObservablePrivateSplashMessageReceived(maxon::Bool create) const;
...
/// When the app is becoming inactive you can e.g. idle some computations
		inline HXXADDRET2(maxon::ObservableRef<ObservableActivationChangedDelegate>) ObservableActivationChanged(maxon::Bool create) const;
	};
	/// Intermediate helper class for MachineInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MachineInterface, maxon::StrongRefHandler, MachineRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<MachineInterface, maxon::StrongRefHandler, MachineRef>>>>);
