...
struct DebugHardwareBreakPointInterface::Hxx2
{
	...
	public:
		...
		static void DebugHardwareBreakPointInterface_Free(const DebugHardwareBreakPointInterface* object) { return S::Free(object); }
		static Result<DebugHardwareBreakPointRef> DebugHardwareBreakPointInterface_SetHardwareBreakpoint(HARDWAREBREAKPOINTTYPE type, HARDWAREBREAKPOINTSIZE size, void* watchAddress) { return S::SetHardwareBreakpoint(type, size, watchAddress); }
		PRIVATE_MAXON_MF_WRAPPER(DebugHardwareBreakPointInterface_RemoveHardwareBreakpoint, DebugHardwareBreakPointInterface,, (Result<void>)) { return S::Get(PRIVATE_MAXON_MF_THIS(DebugHardwareBreakPointInterface))->RemoveHardwareBreakpoint(); }
	};
