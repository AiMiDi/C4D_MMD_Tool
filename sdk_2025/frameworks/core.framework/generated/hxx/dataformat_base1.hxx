...
struct DataFormatBaseReaderInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataFormatBaseReaderInterface>::value || DataDictionaryObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(DataFormatBaseReaderInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataFormatBaseReaderInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = DataFormatBaseReaderInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(DataFormatBaseReaderInterface**);
...
/// @return												Returns the number of elements (not bytes) that have been read.
	...
	public:
		...
		using PrivateInterface = DataFormatBaseReaderInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(DataFormatBaseReaderInterface**);
...
#ifdef DOXYGEN
public FnDoxy<DataFormatBaseReaderRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseReaderInterface, maxon::StrongRefHandler, DataFormatBaseReaderRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseReaderInterface, maxon::StrongRefHandler, DataFormatBaseReaderRef>>>>);
...
public:
	...
	using ConstPtr = typename DataFormatBaseReaderInterface::ConstPtr;
};

class DataFormatBaseWriterRef;

struct DataFormatBaseWriterInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataFormatBaseWriterInterface>::value || DataDictionaryObjectInterface::HasBaseDetector::template Check<I>::value; static I* Cast(DataFormatBaseWriterInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataFormatBaseWriterInterface::Hxx1
{
	...
	public:
		...
		using PrivateBaseClass = S;
		using PrivateBaseClass::PrivateBaseClass;
		using PrivateInterface = DataFormatBaseWriterInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(DataFormatBaseWriterInterface**);
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = DataFormatBaseWriterInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(DataFormatBaseWriterInterface**);
...
#ifdef DOXYGEN
public FnDoxy<DataFormatBaseWriterRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseWriterInterface, maxon::StrongRefHandler, DataFormatBaseWriterRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<DataFormatBaseWriterInterface, maxon::StrongRefHandler, DataFormatBaseWriterRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
...
public:
	...
	using ConstPtr = typename DataFormatBaseWriterInterface::ConstPtr;
};
