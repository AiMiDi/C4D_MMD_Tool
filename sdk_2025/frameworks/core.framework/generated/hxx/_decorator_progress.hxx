...
public:
	...
	MAXON_METHOD maxon::ObservableRef<ObservableProgressNotificationDelegate> ObservableProgressNotification(maxon::Bool create) const
	{
		return maxon::Cast<ProgressRef>(self.GetDecoratedObject()).ObservableProgressNotification(create);
	}
