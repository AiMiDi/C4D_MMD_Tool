...
#endif
	PRIVATE_MAXON_SF_POINTER(Application_ObservableApplicationMessage, ObservableApplicationMessage, MAXON_EXPAND_VA_ARGS, (maxon::ObservableRef<ObservableApplicationMessageDelegate>), maxon::Bool create);
...
#endif
		static maxon::ObservableRef<ObservableApplicationMessageDelegate> Application_ObservableApplicationMessage(maxon::Bool create) { return S::ObservableApplicationMessage(create); }
...
#endif
MAXON_ATTRIBUTE_FORCE_INLINE auto Application::ObservableApplicationMessage(maxon::Bool create) -> maxon::ObservableRef<ObservableApplicationMessageDelegate>
{
