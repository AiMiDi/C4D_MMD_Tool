...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionDefinitionDatabaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionDefinitionDatabaseInterface::MTable::_instance.DataDescriptionDefinitionDatabaseInterface_BuildDescription)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "category\0dataTypeId\0language\0", 21LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionDefinitionDatabaseInterface::MTable::_instance.DataDescriptionDefinitionDatabaseInterface_BuildDescription_1)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "category\0language\0descriptionId\0srcDefinition\0", 85LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionDefinitionDatabaseInterface::MTable::_instance.DataDescriptionDefinitionDatabaseInterface_ObservableSaveDatabase)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "create\0", 0LL, nullptr),
			maxon::reflection::GetFunctionInfo<decltype(DataDescriptionDefinitionDatabaseInterface::MTable::_instance.DataDescriptionDefinitionDatabaseInterface_ObservableDatabaseRegistrationChange)>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "create\0", 0LL, nullptr),
		};
