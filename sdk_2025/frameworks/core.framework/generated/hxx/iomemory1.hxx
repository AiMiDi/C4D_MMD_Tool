...
struct IoMemoryInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = IoMemoryInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static ConstFn PrivateLookupFn(IoMemoryInterface**);
...
/// @return												The current mode.
		inline HXXADDRET2(Bool) IsWritable() const;
...
/// @return												Number of bytes copied.
	...
	public:
		...
		using PrivateInterface = IoMemoryInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static Fn PrivateLookupFn(IoMemoryInterface**);
...
/// @return												Value of the position in the buffer.
		inline HXXADDRET2(const Char&) operator [](Int idx) const;
...
/// @return												OK on success.
	...
	public:
		...
		using PrivateInterface = IoMemoryInterface;
		using PrivateBaseClass::PrivateLookupFn;
		static COWFn PrivateLookupFn(IoMemoryInterface**);
...
#ifdef DOXYGEN
public FnDoxy<IoMemoryRef>
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoMemoryInterface, maxon::StrongRefHandler, IoMemoryRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<IoMemoryInterface, maxon::StrongRefHandler, IoMemoryRef>>>>);
...
public:
	...
	using ConstPtr = typename IoMemoryInterface::ConstPtr;
};
