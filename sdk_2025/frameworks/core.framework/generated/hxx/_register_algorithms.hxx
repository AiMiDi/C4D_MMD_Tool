...
namespace maxon
{
	...
	namespace enum1967
	{
		...
		static const maxon::UInt64 NO_MATCH_TYPE_values[] = {maxon::UInt64(enum1967::NO_MATCH_TYPE::VALUE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_NO_MATCH_TYPE1967(){ return enum1967::NO_MATCH_TYPE_info; }
}
#endif
