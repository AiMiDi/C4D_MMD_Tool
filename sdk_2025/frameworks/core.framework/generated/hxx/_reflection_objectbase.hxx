...
/// @endcond
	...
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ObjectInterface);
	...
	public:
		...
		COMPARERESULT Compare(const maxon::ObjectInterface* other) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObjectInterface>();
			COMPARERESULT proxy_result = HXXRET3(NULLIMPL, COMPARERESULT);
		...
		HashInt GetHashCodeImpl() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObjectInterface>();
			HashInt proxy_result = HXXRET3(NULLIMPL, HashInt);
		...
		UniqueHash GetUniqueHashCodeImpl() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObjectInterface>();
			UniqueHash proxy_result = HXXRET3(NULLIMPL, UniqueHash);
...
/// @endcond
...
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	PRIVATE_MAXON_CHECK_IMPLEMENTATION_MODULE(ErrorInterface);
	...
	public:
		...
		const SourceLocation& GetLocation() const 
		{
			...
			const SourceLocation* proxy_result = &HXXRET3(NULLIMPL, const SourceLocation&);
		...
		Block<void* const> GetStackTrace() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			Block<void* const> proxy_result = HXXRET3(NULLIMPL, Block<void* const>);
		...
		void SetMessageDelegate(MessageDelegate&& message) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_ErrorInterface_SetMessageDelegate, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((void), MessageDelegate&&), reinterpret_cast<const void* const&>(mt_.ErrorInterface_SetMessageDelegate)));
		}
		static const maxon::reflection::Function* _fn_ErrorInterface_SetMessageDelegate;
		const MessageDelegate& GetMessageDelegate() const 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			const MessageDelegate* proxy_result = &HXXRET3(NULLIMPL, const MessageDelegate&);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_.ErrorInterface_GetMessageDelegate_Offset)};
			(*handler_)(_fn_ErrorInterface_GetMessageDelegate, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, PRIVATE_MAXON_MF_REFLECTION_INVOCATION((const MessageDelegate&)), reinterpret_cast<const void* const&>(mt_.ErrorInterface_GetMessageDelegate)));
			return *proxy_result;
		}
		static const maxon::reflection::Function* _fn_ErrorInterface_GetMessageDelegate;
		...
		ThreadReferencedError PrivateGetPreallocation() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ErrorInterface>();
			ThreadReferencedError proxy_result = HXXRET3(NULLIMPL, ThreadReferencedError);
	...
	const maxon::reflection::Function* ErrorInterface::ProxyComponent::_fn_ErrorInterface_GetMessageDelegate;
	...
	static maxon::Result<void> RegisterReflection_ErrorInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ErrorInterface, ErrorInterface_GetMessageDelegate),
