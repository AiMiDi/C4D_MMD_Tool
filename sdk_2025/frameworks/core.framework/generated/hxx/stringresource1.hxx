...
struct LanguageInterface::Hxx1
{
	...
	public:
		...
		using PrivateInterface = LanguageInterface;
...
/// @return												The name.
		inline HXXADDRET2(Id) GetIdentifier() const;
...
/// @return												Nullptr if the language has no fallback language (e.g. "en-US" has none because it's the root of all languages).
		inline HXXADDRET2(LanguageRef) GetFallbackLanguage() const;
/// @copydoc DefaultDoc::ToString
		inline HXXADDRET2(String) ToString(const maxon::FormatStatement* fs = nullptr) const;
	};
	/// Intermediate helper class for LanguageInterface.
...
/// @return												String.
		inline HXXADDRET2(String) LoadResourceString(const Id& scope, const InternedId& keyValue) const;
	};
	/// Intermediate helper class for LanguageInterface.
...
#else
public maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LanguageInterface, maxon::StrongRefHandler, LanguageRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::RefBase<typename Hxx1::FnHelper<maxon::RefBaseFn<maxon::DirectRef<LanguageInterface, maxon::StrongRefHandler, LanguageRef>>>>);
