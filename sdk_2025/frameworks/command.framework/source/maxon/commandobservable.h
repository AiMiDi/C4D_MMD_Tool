...
template <Bool ALLOW_NONCONST> class DefaultValueFunctionsHelper<const Result<COMMANDRESULT>&, ALLOW_NONCONST>
{
public:
...
{
	MAXON_INTERFACE(CommandObserverInterface, MAXON_REFERENCE_NORMAL, "net.maxon.command.interface.observer", MAXON_IMPLEMENTATION_MODULE("net.maxon.command"));
