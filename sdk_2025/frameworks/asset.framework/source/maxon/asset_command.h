...
namespace ASSETMETADATA
{
	...
	MAXON_INTERNED_ID("net.maxon.asset.command.type.object.emitter",	 CommandTypeObjectEmitter);  	///< Emitter Object command.
	MAXON_INTERNED_ID("net.maxon.asset.command.type.object.modifier",	 CommandTypeObjectModifier);	///< Particle Modifier Object command.
	MAXON_INTERNED_ID("net.maxon.asset.command.type.object.logic",	   CommandTypeObjectLogic);	    ///< Particle Logic Object command.
	...
	MAXON_INTERNED_ID("net.maxon.asset.command.scope.simulation",		CommandScopeSimulation);		///< Scope for the new simulation related items.
