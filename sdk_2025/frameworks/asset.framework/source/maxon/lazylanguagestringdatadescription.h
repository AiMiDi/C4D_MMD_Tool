...
using LanguageStringDataDescriptionDefinition = HashMap<Id /* LanguageRef */, DataDescriptionDefinition> MAXON_FORWARD("maxon/datadescriptiondefinition.h");
...
{
	MAXON_INTERFACE(LazyLanguageStringDataDescriptionDefinitionInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.lazylanguagestringdatadescriptiondefinition", MAXON_IMPLEMENTATION_MODULE("net.maxon.asset"));
...
public:
	...
	//----------------------------------------------------------------------------------------
	static MAXON_METHOD const LazyLanguageStringDataDescriptionDefinitionInterface* DefaultValuePtr();
};
...
{
	MAXON_INTERFACE(LazyLanguageDictionaryInterface, MAXON_REFERENCE_COPY_ON_WRITE, "net.maxon.interface.lazylanguagedictionary", MAXON_IMPLEMENTATION_MODULE("net.maxon.asset"));
...
public:
	...
	/// Helper function to return the default value for an empty cow object.
	//----------------------------------------------------------------------------------------
	static MAXON_METHOD const LazyLanguageDictionaryInterface* DefaultValuePtr();
