...
{
	MAXON_INTERFACE(NodeSystemDerivationHandlerInterface, MAXON_REFERENCE_CONST, "net.maxon.node.interface.nodesystemderivationhandler", MAXON_IMPLEMENTATION_MODULE("net.maxon.nodes"));
public:
	//----------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------
	/// Allows to override the EffectivePortValue and its mode on #port.
	/// This method is called during validation of the EffectivePortValue and related attributes, and it allows
	/// to override the EffectivePortValue and the VALUEMODE of any port (input or output) after regular derivation
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<Bool> OverrideEffectivePortValue(const Port& port, VALUEMODE& outMode, Data& outValue) const;
};
