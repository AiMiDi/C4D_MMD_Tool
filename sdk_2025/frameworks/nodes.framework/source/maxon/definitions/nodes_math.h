...
namespace NODE
{
	...
	namespace ARITHMETIC
	{
		...
		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_ADD, "net.maxon.object.base.tags.operation.add");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_SUB, "net.maxon.object.base.tags.operation.sub");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_MUL, "net.maxon.object.base.tags.operation.mul");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_DIV, "net.maxon.object.base.tags.operation.div");
	}
	...
	namespace BOOLEANOPERATOR
	{
		...
		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_AND, "net.maxon.object.base.tags.operation.and");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_OR, "net.maxon.object.base.tags.operation.or");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_XOR, "net.maxon.object.base.tags.operation.xor");
	}
	...
	namespace COMPARE
	{
		...
		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_GT, "net.maxon.object.base.tags.operation.gt");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_LT, "net.maxon.object.base.tags.operation.lt");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_GE, "net.maxon.object.base.tags.operation.ge");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_LE, "net.maxon.object.base.tags.operation.le");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_EQ, "net.maxon.object.base.tags.operation.eq");

		MAXON_ATTRIBUTE(String, OBJECT_BASE_TAGS_OPERATION_NE, "net.maxon.object.base.tags.operation.ne");
	}
