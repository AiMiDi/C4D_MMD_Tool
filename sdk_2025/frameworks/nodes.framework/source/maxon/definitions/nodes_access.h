...
namespace NODE
{
	...
	{
		//----------------------------------------------------------------------------------------
		/// INTERNAL. Used for Node Editor component access ports.
		//----------------------------------------------------------------------------------------
		...
		/// INTERNAL. Used for Node Editor component access ports.
		//----------------------------------------------------------------------------------------
		namespace COMPOSECSTRING
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.node.access.composecstring");
			...
			MAXON_ATTRIBUTE(CString, STRINGIN, "stringin");

			MAXON_ATTRIBUTE(Int, MAXLENGTHIN, "maxlengthin");

			MAXON_ATTRIBUTE(CString, STRINGOUT, "stringout");
		}
		...
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.node.access.composestring");
			...
			MAXON_ATTRIBUTE(String, STRINGOUT, "stringout");
		}
		...
		/// INTERNAL. Used for Node Editor component access ports.
		//----------------------------------------------------------------------------------------
		namespace DECOMPOSECSTRING
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.node.access.decomposecstring");
			...
			MAXON_ATTRIBUTE(Int, LENGTHOUT, "lengthout");
		}
		...
		namespace DECOMPOSEMATRIX32
		{
			...
			MAXON_ATTRIBUTE(Matrix32, NORMALIZEDOUT, "normalizedout");

			MAXON_ATTRIBUTE(Matrix32, INVERSEDOUT, "inversedout");
		}
		...
		namespace DECOMPOSEMATRIX64
		{
			...
			MAXON_ATTRIBUTE(Matrix64, NORMALIZEDOUT, "normalizedout");

			MAXON_ATTRIBUTE(Matrix64, INVERSEDOUT, "inversedout");
		}

		//----------------------------------------------------------------------------------------
		/// INTERNAL. Used for Node Editor component access ports.
		//----------------------------------------------------------------------------------------
		namespace DECOMPOSESTRING
		{
			MAXON_RESOURCE_DATABASE_SCOPE("net.maxon.node.access.decomposestring");
		...
		namespace DECOMPOSEVECTOR3D32
		{
			...
			MAXON_ATTRIBUTE(Float32, LENOUT, "lenout");

			MAXON_ATTRIBUTE(Vector32, NORMALIZEDOUT, "normalizedout");
		}
		...
		namespace DECOMPOSEVECTOR3D64
		{
			...
			MAXON_ATTRIBUTE(Float64, LENOUT, "lenout");

			MAXON_ATTRIBUTE(Vector64, NORMALIZEDOUT, "normalizedout");
		}
