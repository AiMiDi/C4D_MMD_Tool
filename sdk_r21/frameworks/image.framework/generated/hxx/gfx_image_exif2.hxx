...
struct ExifInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(ExifInterface);
...
{
	struct EXIFDATA_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x52f1bbce0e02c6a9LL), maxon::UInt(24))> { };
}
#endif
