...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_ImagePixelBlendInterface(ImagePixelBlendInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	public:
		...
		Result<BlendPixelHandlerStruct> GetBlendPixelHandler(const PixelFormat& bgFormat, const ChannelOffsets& bgChannelOffsets, const PixelFormat& fgFormat, const ChannelOffsets& fgChannelOffsets, Float opacity) const 
		{
			...
			Result<BlendPixelHandlerStruct> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ImagePixelBlendInterface_GetBlendPixelHandler_Offset), maxon::reflection::Argument::ByReference(bgFormat), maxon::reflection::Argument::ByReference(bgChannelOffsets), maxon::reflection::Argument::ByReference(fgFormat), maxon::reflection::Argument::ByReference(fgChannelOffsets), maxon::reflection::Argument::ByValue(opacity)};
			(*handler_)(_fn_ImagePixelBlendInterface_GetBlendPixelHandler, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<BlendPixelHandlerStruct>, const maxon::GenericComponent*, const PixelFormat&, const ChannelOffsets&, const PixelFormat&, const ChannelOffsets&, Float>::Invoke, (const void*) mt_._ImagePixelBlendInterface_GetBlendPixelHandler));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ImagePixelBlendInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
	...
	static maxon::Result<void> RegisterReflection_ImagePixelBlendInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ImagePixelBlendInterface::Hxx2::StaticMTable::_instance._ImagePixelBlendInterface_GetOptimalPixelFormat)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "formats\0", 1LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_ImagePixelBlendInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "bgFormat\0bgChannelOffsets\0fgFormat\0fgChannelOffsets\0opacity\0", 341LL, ImagePixelBlendInterface, _ImagePixelBlendInterface_GetBlendPixelHandler),
		};
