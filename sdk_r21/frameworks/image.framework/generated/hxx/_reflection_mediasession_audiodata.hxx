...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_MediaStreamAudioDataExportInterface(MediaStreamAudioDataExportInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(MediaStreamAudioDataExportInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
