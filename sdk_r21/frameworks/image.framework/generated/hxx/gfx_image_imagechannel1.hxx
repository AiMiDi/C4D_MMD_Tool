...
struct ImageChannelTypeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ImageChannelTypeInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(ImageChannelTypeInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct ImageChannelInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, ImageChannelInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(ImageChannelInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
