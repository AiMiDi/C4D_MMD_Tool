...
struct MediaStreamFormatInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(MediaStreamFormatInterface);
...
struct MediaStreamPropertiesInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(MediaStreamPropertiesInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct MediaStreamPropertiesInterface::Hxx2
{
	template <typename S> class Wrapper : public MediaStreamFormatInterface::Hxx2::template Wrapper<S>
	{
	public:
