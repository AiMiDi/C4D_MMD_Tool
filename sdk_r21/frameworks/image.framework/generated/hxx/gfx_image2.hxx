...
{
	struct TYPE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x9c4506e5552404a9LL), maxon::UInt(20))> { };
	struct NAME_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x9c4506e55520effaLL), maxon::UInt(20))> { };
	struct ALPHANAME_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x0b45ba8df846e4daLL), maxon::UInt(25))> { };
	namespace TEXTURE
	{
		struct AUDIODATA_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x0b45bac526dc4871LL), maxon::UInt(25))> { };
	}
	namespace IMAGE
	{
		struct ASPECTRATIO_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x50c1f731ed739264LL), maxon::UInt(27))> { };
		struct DPI_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xf4865b0fa7e8260eLL), maxon::UInt(19))> { };
		struct COLORPROFILE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xc8257af2b9ad6b55LL), maxon::UInt(28))> { };
		struct FPS_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xf4865b0fa7e82d9aLL), maxon::UInt(19))> { };
		struct DURATION_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x52f1bbc7168b7383LL), maxon::UInt(24))> { };
		struct SAMPLETIME_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5d733f6e60ac49a6LL), maxon::UInt(26))> { };
		struct EXPORTSETTINGS_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5e35c9ec098f9286LL), maxon::UInt(30))> { };
		struct HOTSPOTX_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x52f1bbdf7d106178LL), maxon::UInt(24))> { };
		struct HOTSPOTY_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x52f1bbdf7d106179LL), maxon::UInt(24))> { };
		struct SUBIMAGEINDEX_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xed6f3faeb5624608LL), maxon::UInt(29))> { };
	}
	namespace LAYER
	{
		struct ENABLED_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x9a2017fcfde5c715LL), maxon::UInt(29))> { };
		struct BLENDMODE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x927a0a5576a6e048LL), maxon::UInt(31))> { };
		struct OPACITY_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x9a2017ff124e33dfLL), maxon::UInt(29))> { };
		struct FILLOPACITY_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xdc2c2ddc67808afcLL), maxon::UInt(33))> { };
		struct TRANSPARENCYPROTECTED_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x6ee7aaed86155c2aLL), maxon::UInt(43))> { };
		struct LAYERGROUP_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xbcc828c6e3330f7aLL), maxon::UInt(32))> { };
		struct MASKDEFCOLOR_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xabbacb807cfdca16LL), maxon::UInt(34))> { };
		struct BOUNDINGBOX_X_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5856c589a24b30b4LL), maxon::UInt(35))> { };
		struct BOUNDINGBOX_Y_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5856c589a24b30b5LL), maxon::UInt(35))> { };
		struct BOUNDINGBOX_W_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5856c589a24b30b3LL), maxon::UInt(35))> { };
		struct BOUNDINGBOX_H_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5856c589a24b30a4LL), maxon::UInt(35))> { };
		namespace FOLDER
		{
			struct ISOPEN_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xcb2a535ac4fe8820LL), maxon::UInt(28))> { };
		}
		namespace ADJUSTMENT
		{
			struct PSD_FILTERID_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xacfc923a7727eafdLL), maxon::UInt(34))> { };
			struct PSD_DATA_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xa9e2e7ea42efc514LL), maxon::UInt(30))> { };
		}
	}
}
/// @cond INTERNAL
...
/// @endcond
	...
	PRIVATE_MAXON_COMPBASE(ImageBaseInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct ImageBaseInterface::Hxx2
{
	template <typename S> class Wrapper : public HierarchyObjectInterface::Hxx2::template Wrapper<typename DataDictionaryObjectInterface::Hxx2::template Wrapper<S>>
	{
	public:
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ImageBaseInterface* o_ = (ImageBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageBaseInterface, o_, ImageBaseInterface_AddChildren) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageBaseInterface>() : PRIVATE_MAXON_VTABLE(ImageBaseInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ImageBaseInterface* o_ = (const ImageBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = ImageBaseInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageBaseInterface, o_, ImageBaseInterface_GetHeight) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageBaseInterface>() : PRIVATE_MAXON_VTABLE(ImageBaseInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<SetPixelHandlerStruct>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ImageBaseInterface* o_ = (ImageBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageBaseInterface, o_, ImageBaseInterface_SetPixelHandler) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageBaseInterface>() : PRIVATE_MAXON_VTABLE(ImageBaseInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ImageBaseInterface* o_ = (const ImageBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = ImageBaseInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageBaseInterface, o_, ImageBaseInterface_FreePixelHandler_1) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageBaseInterface>() : PRIVATE_MAXON_VTABLE(ImageBaseInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ImageBaseInterface* o_ = (ImageBaseInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageBaseInterface, o_, ImageBaseInterface_SetComponent) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageBaseInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageBaseInterface>() : PRIVATE_MAXON_VTABLE(ImageBaseInterface, o_); 
...
struct ImageTextureInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(ImageTextureInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};
...
struct ImageTextureInterface::Hxx2
{
	...
	template <typename S> class Wrapper : public ImageBaseInterface::Hxx2::template Wrapper<S>
	{
	public:
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ImageTextureInterface::Hxx1::ConstReferenceFunctionsImpl<S>::LoadTexture(const Url& name, const TimeValue& targetTime, MEDIASESSIONFLAGS flags, const Class<ImagePixelStorage>& pixelStorageClass, const LayerSetInterface* layerSet) -> Result<ImageTextureRef> { return (Hxx2::StaticMTable::_instance._ImageTextureInterface_LoadTexture(name, targetTime, flags, pixelStorageClass, layerSet)); }
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<MediaSessionRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ImageTextureInterface* o_ = (ImageTextureInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageTextureInterface, o_, ImageTextureInterface_Load) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageTextureInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageTextureInterface>() : PRIVATE_MAXON_VTABLE(ImageTextureInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<MediaSessionRef>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); ImageTextureInterface* o_ = (ImageTextureInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageTextureInterface, o_, ImageTextureInterface_Load) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageTextureInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageTextureInterface>() : PRIVATE_MAXON_VTABLE(ImageTextureInterface, o_); 
	return (mt_._ImageTextureInterface_Load(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ImageTextureInterface_Load_Offset, url, targetTime, flags, pixelStorageClass, layerSet));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const ImageTextureInterface* o_ = (const ImageTextureInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = ImageTextureInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(ImageTextureInterface, o_, ImageTextureInterface_Save) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBase::template Check<ImageTextureInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<ImageTextureInterface>() : PRIVATE_MAXON_VTABLE(ImageTextureInterface, o_); 
...
struct ImageInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(ImageInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};
...
struct ImageLayerInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(ImageLayerInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct ImageLayerInterface::Hxx2
{
	template <typename S> class Wrapper : public ImageInterface::Hxx2::template Wrapper<S>
	{
	public:
	};
