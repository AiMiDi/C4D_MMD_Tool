...
struct MediaOutputInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(MediaOutputInterface);
...
struct MediaOutputTextureInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(MediaOutputTextureInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};

struct MediaOutputTextureInterface::Hxx2
{
	template <typename S> class Wrapper : public MediaOutputInterface::Hxx2::template Wrapper<S>
	{
	public:
...
{
	struct SUPPORTS_IMAGE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x194d805fc433d0a7LL), maxon::UInt(37))> { };
	struct SUPPORTS_VIDEO_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x194d805fc4e93bc7LL), maxon::UInt(37))> { };
	struct SUPPORTS_AUDIO_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x194d805fc3c6c322LL), maxon::UInt(37))> { };
	struct SUPPORTS_SYSTEMOPTIONS_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x5ca8c145b1b02cdbLL), maxon::UInt(45))> { };
	struct MAXIMALALPHACHANNELS_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x91328c74620a09e2LL), maxon::UInt(43))> { };
	struct MAXIMALIMAGERESOLUTION_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x03020fab1e5301fbLL), maxon::UInt(45))> { };
	struct MAXIMALLAYERRESOLUTION_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x409427d672023271LL), maxon::UInt(45))> { };
	struct BITDEPTHSIMAGE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x16c13e23e3386ae5LL), maxon::UInt(37))> { };
	struct BITDEPTHSLAYER_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0x16c13e23e35d96dbLL), maxon::UInt(37))> { };
	struct EMBED_COLORPROFILE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xcb2941b94e6719d3LL), maxon::UInt(41))> { };
}
...
struct MediaOutputUrlInterface::MTable
{
	...
	PRIVATE_MAXON_COMPBASE(MediaOutputUrlInterface);
	template <typename I> static const typename I::MTable& GetMTable() { return maxon::GetZeroRef<typename I::MTable>(); }
};
