...
namespace maxon
{
	...
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(MediaSessionFileFormatHandlerInterface, , "net.maxon.image.interface.mediasessionfileformathandler", "maxon.MediaSessionFileFormatHandlerInterface", (&FileFormatHandlerInterface::_interface));
