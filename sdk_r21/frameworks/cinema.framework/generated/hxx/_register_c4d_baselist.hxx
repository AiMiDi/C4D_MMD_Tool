...
namespace enum828 { enum class MULTILINEEDITTEXTMESSAGEFLAGS
{
	NONE	= 0,						///< No flags.
	SET		= (1 << 0)			///< Set.
} ; }
maxon::String PrivateToString_MULTILINEEDITTEXTMESSAGEFLAGS828(std::underlying_type<enum828::MULTILINEEDITTEXTMESSAGEFLAGS>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum828::MULTILINEEDITTEXTMESSAGEFLAGS::NONE, (maxon::UInt64) enum828::MULTILINEEDITTEXTMESSAGEFLAGS::SET};
...
namespace enum1052 { enum class MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT
{
...
maxon::String PrivateToString_MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT1052(std::underlying_type<enum1052::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum1052::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::CANCEL, (maxon::UInt64) enum1052::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::MERGE, (maxon::UInt64) enum1052::MSG_DOCUMENTINFO_TYPE_BEFOREMERGE_RESULT::NEWSCENE};
