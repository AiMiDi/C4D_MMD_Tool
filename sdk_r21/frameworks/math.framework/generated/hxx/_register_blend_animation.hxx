...
namespace maxon
{
	...
	const maxon::Char* const BlendTweenInterface::MTable::_ids = 
		"GetMappedValue@820398451190d1ae\0" // Result<Data> GetMappedValue(Float xValue)
		"SetNewTarget@3d9f5bcaf7b1461a\0" // Result<void> SetNewTarget(const BlendFunctionRef& blendFunction, const Data& endValue)
		"SetFunction@fe4b4327e60f11a7\0" // Result<void> SetFunction(const BlendFunctionRef& blendFunction)
		"GetFunction@5cecc2ab34063ea1\0" // BlendFunctionRef GetFunction() const
		"SetStart@5b3e46c91f9c1707\0" // Result<void> SetStart(const Data& value)
		"GetStart@0499ab95441128ac\0" // Result<Data> GetStart() const
		"SetEnd@5b3e46c91f9c1707\0" // Result<void> SetEnd(const Data& value)
		"GetEnd@0499ab95441128ac\0" // Result<Data> GetEnd() const
		"ObservableAnimation@c78db15b92ab7abe\0" // maxon::ObservableRef<ObservableAnimationDelegate> ObservableAnimation() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BlendTweenInterface, , "net.maxon.interface.blendtween", "maxon.BlendTweenInterface", (&ObserverObjectInterface::_interface));
	...
	const maxon::Char* const BlendAnimationInterface::MTable::_ids = 
		"AddTween@d5b85797ac080666\0" // Result<BlendTweenRef> AddTween(const BlendFunctionRef& blendFunction, const Data& startValue, const Data& endValue)
		"RemoveTween@368855503a7764c2\0" // Result<void> RemoveTween(const BlendTweenRef& tween)
		"GetTweens@3bda17a69bc8555d\0" // Result<BaseArray<BlendTweenRef>> GetTweens() const
		"StartAnimation@c7f24991e10e0937\0" // Result<void> StartAnimation(const TimeValue& timerInterval, const TimeValue& startDelay, const TimeValue& duration)
		"GetProgress@f358997b3\0" // Float GetProgress() const
		"GetState@3327731b52698fe8\0" // ANIMBLENDSTATE GetState() const
		"CancelAndWait@6b2e10f\0" // void CancelAndWait()
		"GetTimerRef@8232ea84a4765e48\0" // Result<TimerRef> GetTimerRef() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BlendAnimationInterface, , "net.maxon.interface.blendanimation", "maxon.BlendAnimationInterface", (&ObserverObjectInterface::_interface));
