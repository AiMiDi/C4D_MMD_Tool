...
namespace maxon
{
	...
	public:
		...
		Bool IsChainingChiffre() const 
		{
			...
			(*handler_)(_fn_CryptographyStreamConversionInterface_IsChainingChiffre, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, const maxon::GenericComponent*>::Invoke, (const void*) mt_._CryptographyStreamConversionInterface_IsChainingChiffre));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(CryptographyStreamConversionInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
