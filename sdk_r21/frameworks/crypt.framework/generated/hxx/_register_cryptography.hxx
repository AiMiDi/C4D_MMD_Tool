...
namespace maxon
{
	...
	const maxon::Char* const CryptographyStreamConversionInterface::MTable::_ids = 
		"IsChainingChiffre@76f01901\0" // Bool IsChainingChiffre() const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CryptographyStreamConversionInterface, , "net.maxon.interface.cryptographystreamconversion", "maxon.CryptographyStreamConversionInterface", (&StreamConversionInterface::_interface));
