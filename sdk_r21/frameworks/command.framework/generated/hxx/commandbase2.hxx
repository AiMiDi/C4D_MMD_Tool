...
namespace COMMAND
{
	struct INTERACTIVE_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xd89fd4c735cf1b83LL), maxon::UInt(29))> { };
	struct INTERACTIONCLASS_PrivateAttribute::HASHCODE : public std::integral_constant<maxon::UInt, PRIVATE_MAXON_ID_HASHCODE(maxon::UInt(0xca14e1daa8aa46a5LL), maxon::UInt(34))> { };
}
#endif
