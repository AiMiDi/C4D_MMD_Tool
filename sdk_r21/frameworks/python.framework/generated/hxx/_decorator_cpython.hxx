...
public:
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).PrivateCPyRandom_Init();
	}

	MAXON_METHOD CPyRef CPy_InitModule(const ModuleDefinition& module)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_InitModule(module);
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_Check(o);
	}

	MAXON_METHOD CPyRef CPyString_FromString(const Char* str) const
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_FromString(str);
	}

	MAXON_METHOD CPyRef CPyString_FromStringAndSize(const Block<const Char>& block)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_FromStringAndSize(block);
	}

	MAXON_METHOD Result<String> CPyString_AsString(const CPyRef& str)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_AsString(str);
	}

	MAXON_METHOD const Char* CPyString_AsCString(const CPyRef& str)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_AsCString(str);
	}

	MAXON_METHOD Int CPyString_Size(const CPyRef& str)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_Size(str);
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyEval_AcquireLock();
	}

	MAXON_METHOD void CPyEval_ReleaseLock()
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyEval_ReleaseLock();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_Check(o);
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_FromInt16(value);
	}

	MAXON_METHOD CPyRef CPyInt_FromUInt16(UInt16 value)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_FromUInt16(value);
	}

	MAXON_METHOD CPyRef CPyInt_FromInt32(Int32 value)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_FromInt32(value);
	}

	MAXON_METHOD CPyRef CPyInt_FromUInt32(UInt32 value)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_FromUInt32(value);
	}

	MAXON_METHOD CPyRef CPyInt_FromInt64(Int64 value)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_FromInt64(value);
	}

	MAXON_METHOD CPyRef CPyInt_FromUInt64(UInt64 value)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_FromUInt64(value);
	}

	MAXON_METHOD Int16 CPyInt_AsInt16(const CPyRef& o)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_AsInt16(o);
	}

	MAXON_METHOD UInt16 CPyInt_AsUInt16(const CPyRef& o)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_AsUInt16(o);
	}

	MAXON_METHOD Int32 CPyInt_AsInt32(const CPyRef& o)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_AsInt32(o);
	}

	MAXON_METHOD UInt32 CPyInt_AsUInt32(const CPyRef& o)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_AsUInt32(o);
	}

	MAXON_METHOD Int64 CPyInt_AsInt64(const CPyRef& o)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_AsInt64(o);
	}

	MAXON_METHOD UInt64 CPyInt_AsUInt64(const CPyRef& o)
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_AsUInt64(o);
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_UseClassExceptionsFlag();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_TabcheckFlag();
	}

	MAXON_METHOD Int32* CPy_UnicodeFlag()
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_UnicodeFlag();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_DivisionWarningFlag();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_QnewFlag();
	}

	MAXON_METHOD Int32* CPy_Py3kWarningFlag()
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_Py3kWarningFlag();
	}

	MAXON_METHOD Int32* CPy_CheckInterval()
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPy_CheckInterval();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyString_Type();
	}

	MAXON_METHOD CPyTypeConstRef CPyInt_Type()
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).CPyInt_Type();
	}
	...
	{
		return maxon::Cast<CPythonLibraryRef>(self.GetDecoratedObject()).ConvertAndCacheString(str, encoding);
	}
...
public:
	...
	{
		return maxon::Cast<PyModuleRef>(self.GetDecoratedObject()).GetFunctions27(functions);
	}
