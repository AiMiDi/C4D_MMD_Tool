...
struct CPyInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPyInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(CPyInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CPyTypeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPyTypeInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(CPyTypeInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CPyFrameInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPyFrameInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(CPyFrameInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CPyTracebackInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPyTracebackInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(CPyTracebackInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CPyCodeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPyCodeInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(CPyCodeInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MPyClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MPyClassInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(MPyClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MPyMemberInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MPyMemberInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(MPyMemberInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MPyFunctionInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MPyFunctionInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(MPyFunctionInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MPyDataTypeInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MPyDataTypeInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(MPyDataTypeInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MPyDataInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MPyDataInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(MPyDataInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MPyCallerContextInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MPyCallerContextInterface>::value || CPyInterface::HasBase::template Check<I>::value; static I* Cast(MPyCallerContextInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
