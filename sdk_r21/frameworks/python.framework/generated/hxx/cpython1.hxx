...
namespace py
{
	...
	struct PythonErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PythonErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(PythonErrorInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PythonErrorInterface, maxon::StrongCOWRefHandler, PythonError>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PythonErrorInterface, maxon::StrongCOWRefHandler, PythonError>>>>);
...
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PythonErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PythonErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
	};
...
/// it is manually cleared or if a function explicitly describes the meaning of this error differently.
	...
	struct PythonTracebackErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PythonTracebackErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(PythonTracebackErrorInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
/// @param[in] line								Line number.
...
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PythonTracebackErrorInterface, maxon::StrongCOWRefHandler, PythonTracebackError>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PythonTracebackErrorInterface, maxon::StrongCOWRefHandler, PythonTracebackError>>>>);
		using NonConst = Hxx1::NonConstRef;
	};
	...
	public ReferenceFunctionsImplDoxy<NonConstRef>
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PythonTracebackErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PythonTracebackErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
	};
...
/// Contains information about the traceback if an exception.
	...
	struct PythonSystemExitErrorInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PythonSystemExitErrorInterface>::value || ErrorInterface::HasBase::template Check<I>::value; static I* Cast(PythonSystemExitErrorInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PythonSystemExitErrorInterface, maxon::StrongCOWRefHandler, PythonSystemExitError>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<const PythonSystemExitErrorInterface, maxon::StrongCOWRefHandler, PythonSystemExitError>>>>);
		using NonConst = Hxx1::NonConstRef;
	};
	...
	public ReferenceFunctionsImplDoxy<NonConstRef>
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PythonSystemExitErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(NonConstRef, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PythonSystemExitErrorInterface, maxon::StrongRefHandler, NonConstRef>>>>);
	};
...
/// A PythonSystemExitError is thrown if the previous function executed sys.exit. Only thrown in VirtualMachineInterface::Execute(String)
	...
	struct CPythonLibraryInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CPythonLibraryInterface>::value || LibraryInterface::HasBase::template Check<I>::value; static I* Cast(CPythonLibraryInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
/// @return           New DataType capsule or empty object if exception indicator is set.
			...
			template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<typename std::enable_if<std::is_same<T, DataType>::value, ResultPtr<DataType>>::type>, typename std::enable_if<std::is_same<T, DataType>::value, ResultPtr<DataType>>::type>::type ParseArgument(const CPyRef& args, Int32 argIndex, Bool isOptional = false) const;
...
/// @return           New DataType capsule or empty object if exception indicator is set.
			...
			template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), typename std::enable_if<std::is_same<T, DataType>::value, ResultPtr<DataType>>::type, maxon::Result<typename std::enable_if<std::is_same<T, DataType>::value, ResultPtr<DataType>>::type>>::type ParseArgument(const CPyRef& args, Int32 argIndex, Bool isOptional = false);
...
/// if T is not NativePyObject*
		...
		template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)), COWReferenceFunctionsImpl<typename LibraryInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename LibraryInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename LibraryInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type> { };
	};
	class CPythonLibraryInterface::Hxx1::Reference :
#ifdef DOXYGEN
	public ReferenceFunctionsImplDoxy<CPythonLibraryRef>
#else
	public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<CPythonLibraryInterface, maxon::StrongRefHandler, CPythonLibraryRef>>>>
#endif
	{
	public:
		MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<CPythonLibraryInterface, maxon::StrongRefHandler, CPythonLibraryRef>>>>);
...
struct PyModuleInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, PyModuleInterface>::value || LibraryInterface::HasBase::template Check<I>::value; static I* Cast(PyModuleInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
#else
public maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PyModuleInterface, maxon::StrongRefHandler, PyModuleRef>>>>
#endif
{
public:
	MAXON_DEFAULT_REFERENCE_CONSTRUCTORS(Reference, maxon::ReferenceBase<Hxx1::ReferenceFunctionsHelper<maxon::RefBaseFunctions<maxon::DirectRef<PyModuleInterface, maxon::StrongRefHandler, PyModuleRef>>>>);
	using NonConst = typename Super::ReferenceClass;
};
