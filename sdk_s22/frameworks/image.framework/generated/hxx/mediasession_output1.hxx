...
struct MediaOutputInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaOutputInterface>::value || MediaConverterInterface::HasBase::template Check<I>::value; static I* Cast(MediaOutputInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MediaOutputTextureInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaOutputTextureInterface>::value || MediaOutputInterface::HasBase::template Check<I>::value; static I* Cast(MediaOutputTextureInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MediaOutputUrlInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MediaOutputUrlInterface>::value || MediaOutputInterface::HasBase::template Check<I>::value; static I* Cast(MediaOutputUrlInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
