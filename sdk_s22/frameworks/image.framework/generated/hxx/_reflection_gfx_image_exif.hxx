...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_ExifInterface(ExifInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	public:
		...
		Result<DataDictionary> GetExifDictionary() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ExifInterface_GetExifDictionary_Offset)};
			(*handler_)(_fn_ExifInterface_GetExifDictionary, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DataDictionary>, const maxon::GenericComponent*>::Invoke, (const void*) mt_._ExifInterface_GetExifDictionary));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(ExifInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_ExifInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, ExifInterface, _ExifInterface_GetExifDictionary),
		};
	...
	static maxon::Result<void> RegisterReflection_ExifStaticInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ExifStaticInterface::MTable::_instance._ExifStaticInterface_OpenFromMemory)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "exifChunk\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ExifStaticInterface::MTable::_instance._ExifStaticInterface_OpenJpgFromUrl)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "fileName\0", 1LL, nullptr),
		};
