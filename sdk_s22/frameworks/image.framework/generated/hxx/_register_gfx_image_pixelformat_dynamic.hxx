...
namespace maxon
{
	const maxon::Char* const PixelFormatDynamicInterface::MTable::_ids = 
		"AddChannel@be5579dc8ae1aa4c\0" // Result<Int> AddChannel(const ImageChannel& channel)
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(PixelFormatDynamicInterface, , "net.maxon.image.interface.pixelformatdynamic", "maxon.PixelFormatDynamicInterface", (&PixelFormatInterface::_interface));
