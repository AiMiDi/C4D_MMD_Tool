...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_MediaBaseInterface(MediaBaseInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	public:
		...
		Result<void> ConnectToSession(const MediaSessionRef& session) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MediaBaseInterface_ConnectToSession_Offset), maxon::reflection::Argument::ByReference(session)};
			(*handler_)(_fn_MediaBaseInterface_ConnectToSession, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const MediaSessionRef&>::Invoke, (const void*) mt_._MediaBaseInterface_ConnectToSession));
			return proxy_result;
		}
		...
		MediaSessionRef GetSession() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MediaBaseInterface_GetSession_Offset)};
			(*handler_)(_fn_MediaBaseInterface_GetSession, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<MediaSessionRef, const maxon::GenericComponent*>::Invoke, (const void*) mt_._MediaBaseInterface_GetSession));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(MediaBaseInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_MediaBaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "session\0", 1LL, MediaBaseInterface, _MediaBaseInterface_ConnectToSession),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, MediaBaseInterface, _MediaBaseInterface_GetSession),
		};
