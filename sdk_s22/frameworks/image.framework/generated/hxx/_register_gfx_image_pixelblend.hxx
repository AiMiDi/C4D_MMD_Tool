...
namespace maxon
{
	namespace enum18 { enum class BLENDPIXELFLAGS
	{
		NONE,									///< no options set.
	} ; }
	maxon::String PrivateToString_BLENDPIXELFLAGS18(std::underlying_type<enum18::BLENDPIXELFLAGS>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum18::BLENDPIXELFLAGS::NONE};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "BLENDPIXELFLAGS", SIZEOF(x), true, values, "NONE\0", fmt);
	}
	...
	maxon::Bool ImagePixelBlendInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<PixelFormat>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ImagePixelBlendInterface_GetOptimalPixelFormat = &Hxx2::Wrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImagePixelBlendInterface_GetOptimalPixelFormat;
		#else
		tbl->_ImagePixelBlendInterface_GetOptimalPixelFormat = &Hxx2::Wrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImagePixelBlendInterface_GetOptimalPixelFormat;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
	...
	const maxon::Char* const ImagePixelBlendInterface::MTable::_ids = 
		"GetBlendPixelHandler@d8161195d9a69f8e\0" // Result<BlendPixelHandlerStruct> GetBlendPixelHandler(const PixelFormat& bgFormat, const ChannelOffsets& bgChannelOffsets, const PixelFormat& fgFormat, const ChannelOffsets& fgChannelOffsets, Float opacity) const
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ImagePixelBlendInterface, , "net.maxon.image.interface.imagepixelblend", "maxon.ImagePixelBlendInterface", (&ObjectInterface::_interface));
	const maxon::Char* const ImagePixelBlendInterface::Hxx2::StaticMTable::_ids = 
		"GetOptimalPixelFormat@471c36384d102d8d\0" // Result<PixelFormat> GetOptimalPixelFormat(const Block<PixelFormat>& formats)
	"";
