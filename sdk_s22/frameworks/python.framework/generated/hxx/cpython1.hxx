...
/// @return												Int object.
			template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_From(std::enable_if_t<STD_IS_REPLACEMENT(same,T,Int32), Int32> o) const;
/// Converts an object from an Int64 value. GIL must be held.
/// 
/// @param[in] o									Int64 value.
/// @return												Int object.
			template <typename T> inline typename std::conditional<S::HAS_ERROR, maxon::Result<CPyRef>, CPyRef>::type CPyInt_From(std::enable_if_t<STD_IS_REPLACEMENT(same,T,Int64), Int64> o) const;
...
/// @param[in] o									Int value.
/// @return												Int object.
			template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_From(std::enable_if_t<STD_IS_REPLACEMENT(same,T,Int32), Int32> o);
/// Converts an object from an Int64 value. GIL must be held.
/// 
/// @param[in] o									Int64 value.
/// @return												Int object.
			template <typename T> inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), CPyRef, maxon::Result<CPyRef>>::type CPyInt_From(std::enable_if_t<STD_IS_REPLACEMENT(same,T,Int64), Int64> o);
/// Checks if the given object is a numeric object. GIL must be held.
/// 
/// @param[in] o									Object to check.
/// @return												True if an object is a numeric value.
