#if 1
namespace enum846 { enum class VIEWPORTSELECTFLAGS
{
	NONE									= 0,			///< None.
...
maxon::String PrivateToString_VIEWPORTSELECTFLAGS846(std::underlying_type<enum846::VIEWPORTSELECTFLAGS>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::NONE, (maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::USE_HN, (maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::USE_DEFORMERS, (maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::REGION_SELECT, (maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::IGNORE_HIDDEN_SEL, (maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::USE_DISPLAY_MODE, (maxon::UInt64) enum846::VIEWPORTSELECTFLAGS::FORCE_USE_DEFORMERS};
...
namespace enum859 { enum class SCRIPTMODE
{
...
maxon::String PrivateToString_SCRIPTMODE859(std::underlying_type<enum859::SCRIPTMODE>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum859::SCRIPTMODE::NONE, (maxon::UInt64) enum859::SCRIPTMODE::PYTHON, (maxon::UInt64) enum859::SCRIPTMODE::AM_ID};
...
namespace enum873 { enum class BASEDRAW_HIGHLIGHT
{
...
maxon::String PrivateToString_BASEDRAW_HIGHLIGHT873(std::underlying_type<enum873::BASEDRAW_HIGHLIGHT>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum873::BASEDRAW_HIGHLIGHT::BEFORE_TOOLS, (maxon::UInt64) enum873::BASEDRAW_HIGHLIGHT::AFTER_TOOLS, (maxon::UInt64) enum873::BASEDRAW_HIGHLIGHT::INVERSE_Z, (maxon::UInt64) enum873::BASEDRAW_HIGHLIGHT::DRAW_AFTER_CLEAR};
...
namespace enum888 { enum class FIELDLAYER_CHANNELFLAG
{
	NONE					= 0,						///< None.
...
maxon::String PrivateToString_FIELDLAYER_CHANNELFLAG888(std::underlying_type<enum888::FIELDLAYER_CHANNELFLAG>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum888::FIELDLAYER_CHANNELFLAG::NONE, (maxon::UInt64) enum888::FIELDLAYER_CHANNELFLAG::ENABLE, (maxon::UInt64) enum888::FIELDLAYER_CHANNELFLAG::VALUE, (maxon::UInt64) enum888::FIELDLAYER_CHANNELFLAG::COLOR, (maxon::UInt64) enum888::FIELDLAYER_CHANNELFLAG::DIRECTION, (maxon::UInt64) enum888::FIELDLAYER_CHANNELFLAG::ROTATION};
...
namespace enum902 { enum class POPUPEDITTEXTCALLBACK
{
...
maxon::String PrivateToString_POPUPEDITTEXTCALLBACK902(std::underlying_type<enum902::POPUPEDITTEXTCALLBACK>::type x, const maxon::FormatStatement* fmt)
{
	const maxon::UInt64 values[] = {(maxon::UInt64) enum902::POPUPEDITTEXTCALLBACK::TEXTCHANGED, (maxon::UInt64) enum902::POPUPEDITTEXTCALLBACK::CLOSED, (maxon::UInt64) enum902::POPUPEDITTEXTCALLBACK::CANCELED, (maxon::UInt64) enum902::POPUPEDITTEXTCALLBACK::CURSOR_UP, (maxon::UInt64) enum902::POPUPEDITTEXTCALLBACK::CURSOR_DOWN};
