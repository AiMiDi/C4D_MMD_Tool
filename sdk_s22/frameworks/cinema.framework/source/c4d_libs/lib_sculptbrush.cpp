...
Bool CustomSculptBrushBase::DisplayControl(BaseDocument* doc, BaseObject* op, BaseObject* chainstart, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds, const SculptBrushToolData *tool) const { SculptBrushBaseLibraryCallR(true, DisplayControl)(doc, op, chainstart, bd, bh, cds, tool); }
