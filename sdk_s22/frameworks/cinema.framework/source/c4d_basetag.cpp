...
maxon::Range<Vector32> UVWTag::CalculateBoundingBox() const { return C4DOS.Tg->CalculateBoundingBox(this); }
...
DISPLAYMODE DisplayTag::GetDisplayMode(Bool original) const { return C4DOS.Tg->GetDisplayMode(this, original); }
Int32 DisplayTag::GetVectorDisplayMode() const { return C4DOS.Tg->GetVectorDisplayMode(this); }
