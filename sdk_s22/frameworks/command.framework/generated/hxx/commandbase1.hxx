...
struct CommandDataInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CommandDataInterface>::value || DataDictionaryObjectInterface::HasBase::template Check<I>::value; static I* Cast(CommandDataInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct LegacyCommandDataInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, LegacyCommandDataInterface>::value || CommandDataInterface::HasBase::template Check<I>::value; static I* Cast(LegacyCommandDataInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CommandClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CommandClassInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(CommandClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CommandInteractionClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CommandInteractionClassInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(CommandInteractionClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct LegacyCommandClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, LegacyCommandClassInterface>::value || CommandClassInterface::HasBase::template Check<I>::value; static I* Cast(LegacyCommandClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct MigratedCommandClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, MigratedCommandClassInterface>::value || LegacyCommandClassInterface::HasBase::template Check<I>::value; static I* Cast(MigratedCommandClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CommandConversionClassInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CommandConversionClassInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(CommandConversionClassInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
...
struct CommandCacheInterface::HasBase { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, CommandCacheInterface>::value || ObjectInterface::HasBase::template Check<I>::value; static I* Cast(CommandCacheInterface* ptr) { return static_cast<I*>(static_cast<maxon::ObjectInterface*>(ptr)); } }; };
