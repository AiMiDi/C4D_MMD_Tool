...
namespace maxon
{
	...
	PRIVATE_MAXON_DATATYPE_REGISTER_ENUM(INTERACTIONTYPE, "net.maxon.command.interationtype", SIZEOF(INTERACTIONTYPE), false, "NONE\0START\0ITERATE\0END\0REALTIME\0", const maxon::UInt64 values[] = {(maxon::UInt64) INTERACTIONTYPE::NONE, (maxon::UInt64) INTERACTIONTYPE::START, (maxon::UInt64) INTERACTIONTYPE::ITERATE, (maxon::UInt64) INTERACTIONTYPE::END, (maxon::UInt64) INTERACTIONTYPE::REALTIME})
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
...
#endif
#ifndef MAXON_REGISTRATION_EXCLUDE_INTERFACES
	static maxon::InterfaceDefinition s_CommandCacheInterface(CommandCacheInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	...
	public:
		...
		Result<void> Init(CommandDataRef& data) 
		{
			...
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CommandCacheInterface_Init_Offset), maxon::reflection::Argument::ByReference(data)};
			(*handler_)(_fn_CommandCacheInterface_Init, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, CommandDataRef&>::Invoke, (const void*) mt_._CommandCacheInterface_Init));
			return proxy_result;
		}
		...
		void Reset() 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<CommandCacheInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CommandCacheInterface_Reset_Offset)};
			(*handler_)(_fn_CommandCacheInterface_Reset, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_._CommandCacheInterface_Reset));
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(CommandCacheInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_CommandCacheInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "data\0", 0LL, CommandCacheInterface, _CommandCacheInterface_Init),
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "", 0LL, CommandCacheInterface, _CommandCacheInterface_Reset),
		};
