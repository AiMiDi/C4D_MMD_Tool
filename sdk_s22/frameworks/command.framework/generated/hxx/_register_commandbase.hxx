...
namespace maxon
{
	namespace enum30 { enum class COMMANDSTATE
	{
		DISABLED = 0,	///< The command can't be executed.
		ENABLED	 = 1  ///< The command can be executed.
	} ; }
	maxon::String PrivateToString_COMMANDSTATE30(std::underlying_type<enum30::COMMANDSTATE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum30::COMMANDSTATE::DISABLED, (maxon::UInt64) enum30::COMMANDSTATE::ENABLED};
	...
	namespace enum40 { enum class COMMANDRESULT
	{
	...
	maxon::String PrivateToString_COMMANDRESULT40(std::underlying_type<enum40::COMMANDRESULT>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum40::COMMANDRESULT::OK, (maxon::UInt64) enum40::COMMANDRESULT::SKIP, (maxon::UInt64) enum40::COMMANDRESULT::BREAK};
	...
	namespace enum52 { enum class INTERACTIONTYPE
	{
	...
	maxon::String PrivateToString_INTERACTIONTYPE52(std::underlying_type<enum52::INTERACTIONTYPE>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum52::INTERACTIONTYPE::NONE, (maxon::UInt64) enum52::INTERACTIONTYPE::START, (maxon::UInt64) enum52::INTERACTIONTYPE::ITERATE, (maxon::UInt64) enum52::INTERACTIONTYPE::END, (maxon::UInt64) enum52::INTERACTIONTYPE::REALTIME};
	...
	const maxon::Char* const CommandCacheInterface::MTable::_ids = 
		"Init@4ddf47a53a2ff170\0" // Result<void> Init(CommandDataRef& data)
		"Reset@6b2e10f\0" // void Reset()
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(CommandCacheInterface, , "net.maxon.command.interface.cache", "maxon.CommandCacheInterface", (&ObjectInterface::_interface));
