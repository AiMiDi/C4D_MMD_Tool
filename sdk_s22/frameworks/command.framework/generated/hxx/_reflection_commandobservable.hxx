...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_CommandObserverInterface(CommandObserverInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
