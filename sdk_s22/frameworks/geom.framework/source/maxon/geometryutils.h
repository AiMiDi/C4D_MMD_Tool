...
public:
	...
	/// @return												True if the segments intersect in 2D.
	/// @MAXON_ANNOTATION{methodId="IntersectSegments2D@96bc3236d1ba05fb"->"IntersectsSegments2D@96bc3236d1ba05fb"}
	//----------------------------------------------------------------------------------------
	...
	///																			for a match to be found. If false then vertices with the same indices must have the same coordinates to declare a match.
	/// @param[in] ignoreTranslationOffset	If true then and translational offset between the loops is ignored. I.e. the same shapes at different offsets will be considered to match.
