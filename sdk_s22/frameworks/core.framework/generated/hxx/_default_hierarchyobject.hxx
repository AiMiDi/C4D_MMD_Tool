...
public:
	...
	{
		return maxon::PrivateNullReturnValue<ConstDataPtr>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}
	...
	{
		return maxon::PrivateNullReturnValue<std::add_pointer<HierarchyObjectInterface>::type>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
	}
	...
	{
		return maxon::ObservableRef<DeprecatedObservableHierarchyInsertDelegate>::NullValue();
	}
	...
	{
		return maxon::ObservableRef<DeprecatedObservableHierarchyRemoveDelegate>::NullValue();
	}
