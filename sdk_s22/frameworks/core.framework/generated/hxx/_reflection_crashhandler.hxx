...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_CrashHandler(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(CrashHandler::MTable::_instance._CrashHandler_GetProcessModules)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "modules\0", 2LL, nullptr),
