...
struct Configuration::MTable
{
	...
	void (*_Configuration_DeprecatedQueryBool) (const String& key, Bool& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	Result<void> (*_Configuration_QueryBool) (const String& key, Bool& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	void (*_Configuration_DeprecatedQueryInt) (const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	Result<void> (*_Configuration_QueryInt) (const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	void (*_Configuration_DeprecatedQueryFloat) (const String& key, Float& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	Result<void> (*_Configuration_QueryFloat) (const String& key, Float& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	void (*_Configuration_DeprecatedQueryString) (const String& key, String& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	Result<void> (*_Configuration_QueryString) (const String& key, String& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	...
	{
		_Configuration_DeprecatedQueryBool = &IMPL::_Configuration_DeprecatedQueryBool;
		_Configuration_QueryBool = &IMPL::_Configuration_QueryBool;
		_Configuration_DeprecatedQueryInt = &IMPL::_Configuration_DeprecatedQueryInt;
		_Configuration_QueryInt = &IMPL::_Configuration_QueryInt;
		_Configuration_DeprecatedQueryFloat = &IMPL::_Configuration_DeprecatedQueryFloat;
		_Configuration_QueryFloat = &IMPL::_Configuration_QueryFloat;
		_Configuration_DeprecatedQueryString = &IMPL::_Configuration_DeprecatedQueryString;
...
struct Configuration::Hxx2
{
	...
	{
	public:
	static void _Configuration_DeprecatedQueryBool(const String& key, Bool& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::DeprecatedQueryBool(key, result, origin, state); }
	static Result<void> _Configuration_QueryBool(const String& key, Bool& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::QueryBool(key, result, origin, state); }
	static void _Configuration_DeprecatedQueryInt(const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::DeprecatedQueryInt(key, result, origin, state); }
	static Result<void> _Configuration_QueryInt(const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::QueryInt(key, result, origin, state); }
	static void _Configuration_DeprecatedQueryFloat(const String& key, Float& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::DeprecatedQueryFloat(key, result, origin, state); }
	static Result<void> _Configuration_QueryFloat(const String& key, Float& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::QueryFloat(key, result, origin, state); }
	static void _Configuration_DeprecatedQueryString(const String& key, String& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::DeprecatedQueryString(key, result, origin, state); }
	static Result<void> _Configuration_QueryString(const String& key, String& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) { return C::QueryString(key, result, origin, state); }
...
MAXON_ATTRIBUTE_FORCE_INLINE auto Configuration::DeprecatedQueryBool(const String& key, Bool& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) -> void
{
	return MTable::_instance._Configuration_DeprecatedQueryBool(key, result, origin, state);
}
...
MAXON_ATTRIBUTE_FORCE_INLINE auto Configuration::DeprecatedQueryInt(const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) -> void
{
	return MTable::_instance._Configuration_DeprecatedQueryInt(key, result, origin, state);
}
...
MAXON_ATTRIBUTE_FORCE_INLINE auto Configuration::DeprecatedQueryFloat(const String& key, Float& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) -> void
{
	return MTable::_instance._Configuration_DeprecatedQueryFloat(key, result, origin, state);
}
...
MAXON_ATTRIBUTE_FORCE_INLINE auto Configuration::DeprecatedQueryString(const String& key, String& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state) -> void
{
	return MTable::_instance._Configuration_DeprecatedQueryString(key, result, origin, state);
}
