...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_GetExtraDataCallbackInterface(GetExtraDataCallbackInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	public:
		...
		Result<DelegateBase> GetExtraDataMessage(const Id& cmdId) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._GetExtraDataCallbackInterface_GetExtraDataMessage_Offset), maxon::reflection::Argument::ByReference(cmdId)};
			(*handler_)(_fn_GetExtraDataCallbackInterface_GetExtraDataMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<DelegateBase>, maxon::GenericComponent*, const Id&>::Invoke, (const void*) mt_._GetExtraDataCallbackInterface_GetExtraDataMessage));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(GetExtraDataCallbackInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_GetExtraDataCallbackInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "cmdId\0", 1LL, GetExtraDataCallbackInterface, _GetExtraDataCallbackInterface_GetExtraDataMessage),
		};
