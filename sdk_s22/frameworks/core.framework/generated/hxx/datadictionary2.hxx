...
struct DataDictionaryInterface::Hxx2
{
	...
	static Result<void> _DataDictionaryInterface_SetData_2(DataDictionaryInterface* this_, ForwardingDataPtr&& key, ForwardingDataPtr&& data) { return ((C*) this_)->SetData(std::forward<ForwardingDataPtr>(key), std::forward<ForwardingDataPtr>(data)); }
