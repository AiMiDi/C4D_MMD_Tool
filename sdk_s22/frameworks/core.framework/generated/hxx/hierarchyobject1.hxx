...
/// Returns the branch the object belongs to.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<ConstDataPtr>, ConstDataPtr>::type GetBranchId() const;
/// Get the locking of an object.
/// If the object is locked it cannot be removed or changed in the hierarchy.
/// @return                        True if locked.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type IsLocked() const;
...
/// If the object is already the first element the object is returned;
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<typename HIERARCHY_::template Sibling<Interface>::type>, typename HIERARCHY_::template Sibling<Interface>::type>::type GetFirst() const;
/// Returns the last sibling of this chain.
/// If the object is already the first element the object is returned;
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<typename HIERARCHY_::template Sibling<Interface>::type>, typename HIERARCHY_::template Sibling<Interface>::type>::type GetLast() const;
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<std::add_pointer<HierarchyObjectInterface>::type>, std::add_pointer<HierarchyObjectInterface>::type>::type FindNextLeaf(const HierarchyObjectInterface* stopAtParent) const;
...
/// -param[in] branchId           The branch the object belongs to.
		...
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<DeprecatedObservableHierarchyInsertDelegate>>, maxon::ObservableRef<DeprecatedObservableHierarchyInsertDelegate>>::type DeprecatedObservableHierarchyInsert() const;
...
/// -param[in] branchId           The branch the object belongs to.
		...
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<maxon::ObservableRef<DeprecatedObservableHierarchyRemoveDelegate>>, maxon::ObservableRef<DeprecatedObservableHierarchyRemoveDelegate>>::type DeprecatedObservableHierarchyRemove() const;
	};
	/// Intermediate helper class for HierarchyObjectInterface.
...
/// If the object is locked it cannot be removed or changed in the hierarchy.
		inline typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type SetLocking(const Bool locking) const;
...
/// Set the locking of an object.
/// If the object is locked it cannot be removed or changed in the hierarchy.
		inline typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type SetLocking(const Bool locking);
/// Is invoked whenever the parent of this object changes. This method can be overridden
/// when special actions have to be taken on such a change, for example the update of an
/// underlying hierarchy which has to be kept in sync with this hierarchy.
///
...
class HierarchyObjectInterface::DeprecatedObservableHierarchyInsertDelegate : public maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&)>
{
public:
	using Super = maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&)>;
	MAXON_MEMBERFUNCTION_DETECTOR(HandleDeprecatedObservableHierarchyInsert);
	DeprecatedObservableHierarchyInsertDelegate() = default;
	template <typename FN> static maxon::ResultOk<Super> Create(FN&& src, typename std::enable_if<HasHandleDeprecatedObservableHierarchyInsert<typename maxon::Dereference<typename std::decay<FN>::type, false>::type>::value, void>::type* = nullptr) { return Super::CreateByReference(std::forward<FN>(src), &maxon::Dereference<typename std::decay<FN>::type, false>::type::HandleDeprecatedObservableHierarchyInsert); }
	template <typename FN> static maxon::Result<Super> Create(FN&& src, typename std::enable_if<!HasHandleDeprecatedObservableHierarchyInsert<typename maxon::Dereference<typename std::decay<FN>::type, false>::type>::value, void>::type* = nullptr){ return Super::Create(std::forward<FN>(src)); }
	using OBSERVABLECOMBINER = ObservableCombinerRunAllComponentPrivateHelper;
};
...
class HierarchyObjectInterface::DeprecatedObservableHierarchyRemoveDelegate : public maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&)>
{
public:
	using Super = maxon::Delegate<Result<void>(const HierarchyObjectRef<>&,const HierarchyObjectRef<>&)>;
	MAXON_MEMBERFUNCTION_DETECTOR(HandleDeprecatedObservableHierarchyRemove);
	DeprecatedObservableHierarchyRemoveDelegate() = default;
	template <typename FN> static maxon::ResultOk<Super> Create(FN&& src, typename std::enable_if<HasHandleDeprecatedObservableHierarchyRemove<typename maxon::Dereference<typename std::decay<FN>::type, false>::type>::value, void>::type* = nullptr) { return Super::CreateByReference(std::forward<FN>(src), &maxon::Dereference<typename std::decay<FN>::type, false>::type::HandleDeprecatedObservableHierarchyRemove); }
	template <typename FN> static maxon::Result<Super> Create(FN&& src, typename std::enable_if<!HasHandleDeprecatedObservableHierarchyRemove<typename maxon::Dereference<typename std::decay<FN>::type, false>::type>::value, void>::type* = nullptr){ return Super::Create(std::forward<FN>(src)); }
	using OBSERVABLECOMBINER = ObservableCombinerRunAllComponentPrivateHelper;
};
