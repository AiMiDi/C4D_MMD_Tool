...
namespace maxon
{
	...
	static maxon::InterfaceDefinition s_DescriptionMessageCallbackInterface(DescriptionMessageCallbackInterface::_interface, &maxon::g_translationUnit, maxon::EntityBase::FLAGS::MAIN_DEFINITION);
#endif
	...
	public:
		...
		Result<Tuple<Bool, Bool>> DescriptionMessage(const InternedId& id, const Id& cmdId, Int32 type, void* data) 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._DescriptionMessageCallbackInterface_DescriptionMessage_Offset), maxon::reflection::Argument::ByReference(id), maxon::reflection::Argument::ByReference(cmdId), maxon::reflection::Argument::ByValue(type), maxon::reflection::Argument::ByValue(data)};
			(*handler_)(_fn_DescriptionMessageCallbackInterface_DescriptionMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Tuple<Bool, Bool>>, maxon::GenericComponent*, const InternedId&, const Id&, Int32, void*>::Invoke, (const void*) mt_._DescriptionMessageCallbackInterface_DescriptionMessage));
			return proxy_result;
		}
	...
	PRIVATE_MAXON_COMPONENT_REGISTER(DescriptionMessageCallbackInterface::ProxyComponent, , typename, maxon::EntityBase::FLAGS::PROXY, ::MaxonRegistry, maxon::LiteralId());
#endif
#if defined(PRIVATE_MAXON_REGISTRATION_FRAMEWORK) && !defined(MAXON_REGISTRATION_EXCLUDE_REFLECTION)
	static maxon::Result<void> RegisterReflection_DescriptionMessageCallbackInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "id\0cmdId\0type\0data\0", 85LL, DescriptionMessageCallbackInterface, _DescriptionMessageCallbackInterface_DescriptionMessage),
		};
