...
template <typename TYPE> struct StaticArrayInterface<TYPE>::MTable
{
	...
	void (*_StaticArrayInterface_Free) (const StaticArrayInterface* object);
	...
	Result<Int> (*_StaticArrayInterface_GetWritableBlock) (StaticArrayInterface* this_, Int index, SimdBlock<TYPE>& block);
	Result<StaticArrayInterface*> (*_StaticArrayInterface_MakeWritable) (const StaticArrayInterface* this_, Bool cloneElements);
	const DataType& (*_StaticArrayInterface_GetValueDataType) (const StaticArrayInterface* this_);
	String (*_StaticArrayInterface_ToString) (const StaticArrayInterface* this_, const FormatStatement* formatStatement);
	Bool (*_StaticArrayInterface_IsEqual) (const StaticArrayInterface* this_, const StaticArrayInterface* other, EQUALITY equality);
	UInt (*_StaticArrayInterface_GetHashCode) (const StaticArrayInterface* this_);
	template <typename IMPL> void Init()
	{
		_StaticArrayInterface_Free = &IMPL::_StaticArrayInterface_Free;
		...
		_StaticArrayInterface_GetWritableBlock = &IMPL::_StaticArrayInterface_GetWritableBlock;
		_StaticArrayInterface_MakeWritable = &IMPL::_StaticArrayInterface_MakeWritable;
		_StaticArrayInterface_GetValueDataType = &IMPL::_StaticArrayInterface_GetValueDataType;
		_StaticArrayInterface_ToString = &IMPL::_StaticArrayInterface_ToString;
		_StaticArrayInterface_IsEqual = &IMPL::_StaticArrayInterface_IsEqual;
		_StaticArrayInterface_GetHashCode = &IMPL::_StaticArrayInterface_GetHashCode;
	}
};
...
template <typename TYPE> struct StaticArrayInterface<TYPE>::Hxx2
{
	...
	{
	public:
	static void _StaticArrayInterface_Free(const StaticArrayInterface* object) { return C::Free((const C*) object); }
	static Int _StaticArrayInterface_GetCount(const StaticArrayInterface* this_) { return ((const C*) this_)->GetCount(); }
	static const TYPE& _StaticArrayInterface_operatorIndex(const StaticArrayInterface* this_, Int index) { return ((const C*) this_)->operator [](index); }
	static ResultRef<TYPE> _StaticArrayInterface_GetWritable(StaticArrayInterface* this_, Int index) { return ((C*) this_)->GetWritable(index); }
	static Int _StaticArrayInterface_GetBlock(const StaticArrayInterface* this_, Int index, SimdBlock<const TYPE>& block) { return ((const C*) this_)->GetBlock(index, block); }
	static Result<Int> _StaticArrayInterface_GetWritableBlock(StaticArrayInterface* this_, Int index, SimdBlock<TYPE>& block) { return ((C*) this_)->GetWritableBlock(index, block); }
	static Result<StaticArrayInterface*> _StaticArrayInterface_MakeWritable(const StaticArrayInterface* this_, Bool cloneElements) { return ((const C*) this_)->MakeWritable(cloneElements); }
	static const DataType& _StaticArrayInterface_GetValueDataType(const StaticArrayInterface* this_) { return ((const C*) this_)->GetValueDataType(); }
	static String _StaticArrayInterface_ToString(const StaticArrayInterface* this_, const FormatStatement* formatStatement) { return ((const C*) this_)->ToString(formatStatement); }
	static Bool _StaticArrayInterface_IsEqual(const StaticArrayInterface* this_, const StaticArrayInterface* other, EQUALITY equality) { return ((const C*) this_)->IsEqual(other, equality); }
	static UInt _StaticArrayInterface_GetHashCode(const StaticArrayInterface* this_) { return ((const C*) this_)->GetHashCode(); }
	};

};
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Free(const StaticArrayInterface* object) -> void
{
	if (!object)
		return;
	return ((StaticArrayInterface::MTable*) object->_vtable)->_StaticArrayInterface_Free(object);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::GetCount() const -> Int
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_GetCount(this);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::operator [](Int index) const -> const TYPE&
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_operatorIndex(this, index);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::GetWritable(Int index) -> ResultRef<TYPE>
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_GetWritable(this, index);
}
...
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_GetBlock(this, index, block);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::GetWritableBlock(Int index, SimdBlock<TYPE>& block) -> Result<Int>
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_GetWritableBlock(this, index, block);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::MakeWritable(Bool cloneElements) const -> Result<StaticArrayInterface*>
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_MakeWritable(this, cloneElements);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::GetValueDataType() const -> const DataType&
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_GetValueDataType(this);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::ToString(const FormatStatement* formatStatement) const -> String
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_ToString(this, formatStatement);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::IsEqual(const StaticArrayInterface* other, EQUALITY equality) const -> Bool
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_IsEqual(this, other, equality);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::GetHashCode() const -> UInt
{
	return ((StaticArrayInterface::MTable*) this->_vtable)->_StaticArrayInterface_GetHashCode(this);
}
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::GetCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	...
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_GetCount(o_));
}
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::operator [](Int index) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const TYPE&>, const TYPE&>::type
{
	...
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_operatorIndex(o_, index));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::GetWritable(Int index) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<TYPE&>, ResultRef<TYPE>>::type
{
	...
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_GetWritable(o_, index));
}
...
template <typename TYPE> template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::Set(Int index, T&& value) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, ResultMem>::type
{
...
template <typename TYPE> template <typename S> template <typename T> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::COWReferenceFunctionsImpl<S>::Set(Int index, T&& value) -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), ResultMem, maxon::Result<void>>::type
{
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const StaticArrayInterface* o_ = (const StaticArrayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = StaticArrayInterface::NullValuePtr(); if (!o_) return 0; } 
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_GetBlock(o_, index, block));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::GetWritableBlock(Int index, SimdBlock<TYPE>& block) const -> Result<Int>
{
	...
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_GetWritableBlock(o_, index, block));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::COWReferenceFunctionsImpl<S>::GetWritableBlock(Int index, SimdBlock<TYPE>& block) -> Result<Int>
{
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::GetValueDataType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type
{
	...
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_GetValueDataType(o_));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* formatStatement) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const StaticArrayInterface* o_ = (const StaticArrayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = StaticArrayInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<String>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_ToString(o_, formatStatement));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::IsEqual(const StaticArrayInterface* other, EQUALITY equality) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const StaticArrayInterface* o_ = (const StaticArrayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = StaticArrayInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
	return (((StaticArrayInterface::MTable*) o_->_vtable)->_StaticArrayInterface_IsEqual(o_, other, equality));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::Begin() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const StaticArrayInterface* o_ = (const StaticArrayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = StaticArrayInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<ConstIterator>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->Begin());
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto StaticArrayInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::End() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<ConstIterator>, ConstIterator>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const StaticArrayInterface* o_ = (const StaticArrayInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = StaticArrayInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<ConstIterator>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (o_->End());
}
...
template <typename TYPE> struct VArrayInterface<TYPE>::MTable
{
	...
	template <typename C> explicit MTable(C*) { Init<typename maxon::SFINAEHelper<Hxx2, C>::type::template Wrapper<C>>(); }
	template <typename C> MTable(C*, maxon::Bool) { Init<C>(); }
	PRIVATE_MAXON_ALLOC_TYPENAME StaticArrayInterface<TYPE>::MTable super;
...
{
	template <typename C> class Wrapper : public StaticArrayInterface<TYPE>::Hxx2::PRIVATE_MAXON_TEMPLATE_PREFIX Wrapper<C>
	{
	public:
...
template <typename TYPE> VArrayInterface<TYPE>::VArrayInterface(const MTable& vtable) : StaticArrayInterface<TYPE>(vtable.super) { }
