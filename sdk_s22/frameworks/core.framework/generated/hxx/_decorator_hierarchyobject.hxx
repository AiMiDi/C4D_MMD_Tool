...
public:
	...
	MAXON_METHOD maxon::ObservableRef<DeprecatedObservableHierarchyInsertDelegate> DeprecatedObservableHierarchyInsert() const
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).DeprecatedObservableHierarchyInsert();
	}
	...
	MAXON_METHOD maxon::ObservableRef<DeprecatedObservableHierarchyRemoveDelegate> DeprecatedObservableHierarchyRemove() const
	{
		return maxon::Cast<HierarchyObjectRef>(self.GetDecoratedObject()).DeprecatedObservableHierarchyRemove();
	}
