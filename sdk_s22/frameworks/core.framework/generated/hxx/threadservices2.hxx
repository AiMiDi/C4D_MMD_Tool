...
MAXON_ATTRIBUTE_CONSTRUCTOR static void Register_s_ui_maxon_ThreadCancelledErrorInterface() { new (s_ui_maxon_ThreadCancelledErrorInterface) maxon::EntityUse(ThreadCancelledErrorInterface::_interface.GetReference(), &maxon::g_translationUnit, "maxon/threadservices.h", false); }
#else // !MAXON_USE_REGISTER_FUNCTION
static maxon::EntityUse s_ui_maxon_ThreadCancelledErrorInterface(ThreadCancelledErrorInterface::_interface.GetReference(), &maxon::g_translationUnit, "maxon/threadservices.h", false);
...
struct ThreadServices::MTable
{
	...
	THREADTYPE (*_ThreadServices_GetCurrentThreadType_1) (Int& threadIdentifier);
	...
	void (*_ThreadServices_AddJobStatusReference) (const JobInterfacePOD& pod);
	void (*_ThreadServices_RemoveJobStatusReference) (const JobInterfacePOD& pod);
	template <typename IMPL> void Init()
	{
		...
		_ThreadServices_GetCurrentThreadType_1 = &IMPL::_ThreadServices_GetCurrentThreadType_1;
		...
		_ThreadServices_AddJobStatusReference = &IMPL::_ThreadServices_AddJobStatusReference;
		_ThreadServices_RemoveJobStatusReference = &IMPL::_ThreadServices_RemoveJobStatusReference;
	}
};
...
struct ThreadServices::Hxx2
{
	...
	static THREADTYPE _ThreadServices_GetCurrentThreadType_1(Int& threadIdentifier) { return C::GetCurrentThreadType(threadIdentifier); }
	...
	static void _ThreadServices_AddJobStatusReference(const JobInterfacePOD& pod) { return C::AddJobStatusReference(pod); }
	static void _ThreadServices_RemoveJobStatusReference(const JobInterfacePOD& pod) { return C::RemoveJobStatusReference(pod); }
	};
...
{
	return MTable::_instance._ThreadServices_GetCurrentThreadType_1(threadIdentifier);
}
...
{
	return MTable::_instance._ThreadServices_AddJobStatusReference(pod);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ThreadServices::RemoveJobStatusReference(const JobInterfacePOD& pod) -> void
{
	return MTable::_instance._ThreadServices_RemoveJobStatusReference(pod);
}
