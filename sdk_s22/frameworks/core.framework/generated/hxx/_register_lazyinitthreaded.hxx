...
namespace maxon
{
	namespace enum83 { enum class OPTIONS : Int
		{
			NONE = 0,
	...
	maxon::String PrivateToString_OPTIONS83(std::underlying_type<enum83::OPTIONS>::type x, const maxon::FormatStatement* fmt, void*)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum83::OPTIONS::NONE, (maxon::UInt64) enum83::OPTIONS::FORWARD_CANCELLATION, (maxon::UInt64) enum83::OPTIONS::RETRY_ON_FAILURE, (maxon::UInt64) enum83::OPTIONS::RETRY_ON_CANCELLATION, (maxon::UInt64) enum83::OPTIONS::DEFAULT};
