...
namespace maxon
{
	namespace enum144 { enum class COLLECTION_RESIZE_FLAGS
	{
		NONE										= 0,
	...
	maxon::String PrivateToString_COLLECTION_RESIZE_FLAGS144(std::underlying_type<enum144::COLLECTION_RESIZE_FLAGS>::type x, const maxon::FormatStatement* fmt)
	{
		const maxon::UInt64 values[] = {(maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::NONE, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_SHRINK_KEEP_CAPACITY, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_SHRINK_FIT_TO_SIZE, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_GROW_RESERVE_CAPACITY, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_GROW_FIT_TO_SIZE, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_GROW_UNINITIALIZED, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_GROW_UNSPECIFIED, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::ON_RESIZE_UNSPECIFIED, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::FIT_TO_SIZE, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::DEFAULT, (maxon::UInt64) enum144::COLLECTION_RESIZE_FLAGS::POD_UNINITIALIZED};
		return maxon::StringInterface::PrivateEnumToString((maxon::UInt64) x, "COLLECTION_RESIZE_FLAGS", SIZEOF(x), true, values, "NONE\0ON_SHRINK_KEEP_CAPACITY\0ON_SHRINK_FIT_TO_SIZE\0ON_GROW_RESERVE_CAPACITY\0ON_GROW_FIT_TO_SIZE\0ON_GROW_UNINITIALIZED\0ON_GROW_UNSPECIFIED\0ON_RESIZE_UNSPECIFIED\0FIT_TO_SIZE\0DEFAULT\0POD_UNINITIALIZED\0", fmt);
	}
