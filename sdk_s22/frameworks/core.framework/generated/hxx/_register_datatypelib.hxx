...
namespace maxon
{
	namespace enum303 { enum class INNERMOST_MEMBER : Int32
	{
	} ; }
	maxon::String PrivateToString_INNERMOST_MEMBER303(std::underlying_type<enum303::INNERMOST_MEMBER>::type x, const maxon::FormatStatement* fmt)
	{
	...
	const maxon::Char* const DataTypeLib::MTable::_ids = 
		...
		"ParseDataType@5ef9a7fc20bede23\0" // Result<Tuple<DataType, const Char*>> ParseDataType(const Char* str)
		"ParseMember@24746ca8ffa64679\0" // Result<Tuple<Member, const Char*>> ParseMember(const Char* str)
		"ParseInt@900dcbf10bbbbf46\0" // Result<Tuple<Int64, const Char*>> ParseInt(const Char* str)
		...
		"PrivateIsBaseOfOrSame@a9fca32001dc6064\0" // Bool PrivateIsBaseOfOrSame(const DataTypeImpl* type, const DataTypeImpl* other, DataType::BASE_OF_MODE mode)
