...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_Configuration(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Configuration::MTable::_instance._Configuration_DeprecatedQueryBool)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "key\0result\0origin\0state\0", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Configuration::MTable::_instance._Configuration_DeprecatedQueryInt)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "key\0result\0origin\0state\0", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Configuration::MTable::_instance._Configuration_DeprecatedQueryFloat)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "key\0result\0origin\0state\0", 0LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(Configuration::MTable::_instance._Configuration_DeprecatedQueryString)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "key\0result\0origin\0state\0", 0LL, nullptr),
