...
namespace maxon
{
	const maxon::Char* const HierarchyObjectInterface::MTable::_ids = 
		...
		"GetBranchId@953440e2cb2a6258\0" // ConstDataPtr GetBranchId() const
		"SetLocking@908beb5b7ac9a7f6\0" // void SetLocking(const Bool locking)
		"IsLocked@76f01901\0" // Bool IsLocked() const
		...
		"GetFirst@13c3e32f7298ccfc\0" // typename HIERARCHY::template Sibling<Interface>::type GetFirst() const
		"GetLast@13c3e32f7298ccfc\0" // typename HIERARCHY::template Sibling<Interface>::type GetLast() const
		"ParentChanged@5e65c14d7099\0" // void ParentChanged(Bool removed)
		"FindNextLeaf@586629328f13c442\0" // std::add_pointer<HierarchyObjectInterface>::type FindNextLeaf(const HierarchyObjectInterface* stopAtParent) const
		"ObservableHierarchyInsert@1\0" // maxon::ObservableRef<ObservableHierarchyInsertDelegate> ObservableHierarchyInsert() const
		"ObservableHierarchyInsert@5951a8412a632934\0" // maxon::ObservableRef<DeprecatedObservableHierarchyInsertDelegate> DeprecatedObservableHierarchyInsert() const
		"ObservableHierarchyRemove@1\0" // maxon::ObservableRef<ObservableHierarchyRemoveDelegate> ObservableHierarchyRemove() const
		"ObservableHierarchyRemove@385aebd11063f689\0" // maxon::ObservableRef<DeprecatedObservableHierarchyRemoveDelegate> DeprecatedObservableHierarchyRemove() const
	"";
