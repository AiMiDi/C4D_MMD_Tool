...
public:
	...
	//----------------------------------------------------------------------------------------
	/// @MAXON_ANNOTATION{methodId="DeprecatedQueryBool@63864ec04cd2f567"->"QueryBool@ef8f9ea4628ac75d"}
	//----------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------
	/// Retrieves a boolean value from the configuration database.
  /// If an entry is not present the function will return an error.
	/// If an entry is present but its state is invalid the function will also return an error and set 'state' to CONFIGURATIONENTRY_STATE::INVALID.
  ...
  //----------------------------------------------------------------------------------------
	/// @MAXON_ANNOTATION{methodId="DeprecatedQueryInt@7475aef3facaa268"->"QueryInt@cb8ec20bda75b9b2"}
  //----------------------------------------------------------------------------------------
	static MAXON_METHOD void DeprecatedQueryInt(const String& key, Int& result, CONFIGURATIONENTRY_ORIGIN& origin, CONFIGURATIONENTRY_STATE& state);
	  ...
	  //----------------------------------------------------------------------------------------
  /// Retrieves an integer value from the configuration database.
  /// If an entry is not present the function will return an error.
  /// If an entry is present but its state is invalid the function will also return an error and set 'state' to CONFIGURATIONENTRY_STATE::INVALID.
  /// In that case you can use GetConfigurationDatabaseString to retrieve the text content of the entry.
  ///
  ...
  //----------------------------------------------------------------------------------------
	/// @MAXON_ANNOTATION{methodId="DeprecatedQueryFloat@b40040353208ac9b"->"QueryFloat@a920ecd3d34b1965"}
  //----------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------
  /// Retrieves a floating point value from the configuration database.
  /// If an entry is not present the function will return an error.
  /// If an entry is present but its state is invalid the function will also return an error and set 'state' to CONFIGURATIONENTRY_STATE::INVALID.
  /// In that case you can use GetConfigurationDatabaseString to retrieve the text content of the entry.
  ///
  ...
  //----------------------------------------------------------------------------------------
	/// @MAXON_ANNOTATION{methodId="DeprecatedQueryString@007933d8fb5fad20"->"QueryString@af6e1b0e826ad996"}
  //----------------------------------------------------------------------------------------
  ...
  //----------------------------------------------------------------------------------------
  /// Retrieves a string from the configuration database.
