...
public:
  ...
  /// @param[in] branchId           The branch the object belongs to.
	/// @MAXON_ANNOTATION{methodId="ObservableHierarchyInsert@5951a8412a632934"->"ObservableHierarchyInsert@1"}
	//----------------------------------------------------------------------------------------
	...
	/// @MAXON_ANNOTATION{methodId="DeprecatedObservableHierarchyInsert@6b23b8ee984b36c7"->"ObservableHierarchyInsert@5951a8412a632934"}
  ...
  /// @param[in] branchId           The branch the object belongs to.
	/// @MAXON_ANNOTATION{methodId="ObservableHierarchyRemove@385aebd11063f689"->"ObservableHierarchyRemove@1"}
	//----------------------------------------------------------------------------------------
	...
	/// @MAXON_ANNOTATION{methodId="DeprecatedObservableHierarchyRemove@4a2cfc7e7e4c041c"->"ObservableHierarchyRemove@385aebd11063f689"}
