...
template <typename HASH, typename T1, typename... T> inline UInt TupleGetHashCode(const T1& a1, const T&... rest)
{
	...
	return 31 * TupleGetHashCode<HASH>(rest...) + HASH::GetHashCode(a1);
}
...
private:
	...
	template <typename HASH, size_t... I> UInt GetHashCodeImpl(std::index_sequence<I...>*) const
	{
		// Reverse the order of arguments.
		return maxon::details::TupleGetHashCode<HASH>(Get<sizeof...(T)-1-I>()...);
	}
...
public:
	...
	template <typename HASH> UInt GetHashCode() const { return 0; }
