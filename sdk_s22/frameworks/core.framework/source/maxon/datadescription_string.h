...
namespace DESCRIPTION
{
	namespace STRING
	{
		namespace BASE
		{
			...
			MAXON_ATTRIBUTE(String, REFERENCESTRING, "net.maxon.description.string.base.referencestring");

			/// Original reference string of the translated string at the time of the last translation.
			MAXON_ATTRIBUTE(String, TRANSLATEDREFERENCESTRING, "net.maxon.description.string.base.translatedreferencestring");
