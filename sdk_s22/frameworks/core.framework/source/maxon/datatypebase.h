...
public:
											 ...
											 _getPtr, _isEqualData)
	{
		...
		DebugAssert(!(qualification & ~(VALUEKIND::QUALIFIER_MASK | VALUEKIND::FUNCTION | VALUEKIND::ENUM | VALUEKIND::ENUM_LIST | VALUEKIND::ENUM_FLAGS | VALUEKIND::DELEGATE | VALUEKIND::GENERIC_INSTANTIATION | VALUEKIND::RECURSIVE_CONTAINER)));
		DebugAssert(!(_valueKind & VALUEKIND::GLOBALLY_REFERENCED));
	}
