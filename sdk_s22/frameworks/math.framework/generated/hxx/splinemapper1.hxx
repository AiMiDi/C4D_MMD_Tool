...
/// @param[in] knot										The knot to insert
		...
		inline Result<Int> InsertKnot(Float x, Float y, Int flags, Bool adaptTangents) const;
...
/// @param[in] knot										The knot to insert
		...
		inline Result<Int> InsertKnot(Float x, Float y, Int flags, Bool adaptTangents);
