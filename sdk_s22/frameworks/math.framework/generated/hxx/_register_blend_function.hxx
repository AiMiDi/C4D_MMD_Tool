...
namespace maxon
{
	const maxon::Char* const BlendFunctionInterface::MTable::_ids = 
		"MapValue@0763d2e038154114\0" // Result<Data> MapValue(Float x, const Data& startValue, const Data& endValue)
	"";
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(BlendFunctionInterface, , "net.maxon.interface.blendfunction", "maxon.BlendFunctionInterface", (&ObjectInterface::_interface));
