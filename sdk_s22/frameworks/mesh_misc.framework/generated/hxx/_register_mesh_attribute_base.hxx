...
namespace maxon
{
	const maxon::Char* const CustomDataTagDisplayInterface::MTable::_ids = 
		...
		"DisplayControl@173f8bfb6029a6ca\0" // Result<void> DisplayControl(BaseTag* tag, BaseDocument* doc, BaseObject* op, BaseDraw* bd, BaseDrawHelp* bh, ControlDisplayStruct& cds) const
	...
	const maxon::Char* const CustomDataTagClassInterface::MTable::_ids = 
		...
		"Message@bb9a3a255c9d3adb\0" // Bool Message(GeListNode* node, Int32 type, void* data) const
	"";
