...
namespace
{
	...
	{
		return RegisterObjectPlugin(g_mmd_bone_manager_object_id, GeLoadString(IDS_O_MMD_BONE_MANAGER), PLUGINFLAG_HIDEPLUGINMENU, MMDBoneManagerObject::Alloc, "OMMDBoneManager"_s, AutoBitmap("OMMDBoneManager.png"_s), 0);
	}
	...
	{
		return RegisterTagPlugin(g_mmd_bone_tag_id, GeLoadString(IDS_T_MMD_BONE), TAG_VISIBLE | TAG_EXPRESSION, MMDBoneTag::Alloc, "TMMDBone"_s, AutoBitmap("TMMDBone.png"_s), 0);
	}
}
