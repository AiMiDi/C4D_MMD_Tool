...
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\Common7\IDE\devenv.com" sdk_2023\plugins\project\plugins.sln /Build "Release"
cd "D:\Program Files (x86)\Inno Setup 6\"
ISCC.exe 
iscc /DMyAppVersion="0.4.5.1" "%~dp0setup\c4d_plugin.iss"
pause