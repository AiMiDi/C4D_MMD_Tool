...
static maxon::Id g_usedFrameworks[] = {maxon::Id("net.maxon.cinema.framework"), maxon::Id("net.maxon.mesh_misc.framework"), maxon::Id("net.maxon.math.framework"), maxon::Id("net.maxon.crypt.framework"), maxon::Id("net.maxon.python.framework"), maxon::Id("net.maxon.core.framework"), maxon::Id("net.maxon.")};
