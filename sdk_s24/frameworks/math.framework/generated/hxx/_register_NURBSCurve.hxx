...
namespace maxon
{
	namespace enum14
	{
		...
		static const maxon::UInt64 NURBSCURVE_CONTINUITY_values[] = {maxon::UInt64(enum14::NURBSCURVE_CONTINUITY::OPEN), maxon::UInt64(enum14::NURBSCURVE_CONTINUITY::CLOSED), maxon::UInt64(enum14::NURBSCURVE_CONTINUITY::PERIODIC)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_NURBSCURVE_CONTINUITY14(){ return enum14::NURBSCURVE_CONTINUITY_info; }
}
#endif
