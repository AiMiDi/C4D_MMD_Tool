...
namespace maxon
{
	namespace py
	{
		namespace enum36
		{
			...
			static const maxon::UInt64 REFTYPE_values[] = {maxon::UInt64(enum36::REFTYPE::DECREF), maxon::UInt64(enum36::REFTYPE::BORROWED), maxon::UInt64(enum36::REFTYPE::PRIVATE_SHORTTERM_BORROWED), maxon::UInt64(enum36::REFTYPE::PRIVATE_MUST_NOT_BE_USED_ANYMORE)};
		...
		const maxon::EnumInfo& PrivateGetEnumInfo_REFTYPE36(){ return enum36::REFTYPE_info; }
