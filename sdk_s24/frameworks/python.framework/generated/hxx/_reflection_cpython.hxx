...
namespace maxon
{
	namespace py
	{
		...
		public:
			...
			Result<Bool> CPyModule_AddObject(const CPyRef& module, const Char* name, const CPyRef& value) 
			{
				...
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_AddObject, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<Bool>, maxon::GenericComponent*, const CPyRef&, const Char*, const CPyRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_AddObject));
				return proxy_result;
			}
			...
			Bool CPyModule_AddType(const CPyRef& module, const CPyTypeRef& value) 
			{
				...
				const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<CPythonLibraryInterface>();
				Bool proxy_result = maxon::PrivateLogNullptrError(false);
				maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._CPythonLibraryInterface_CPyModule_AddType_Offset), maxon::reflection::Argument::ByReference(module), maxon::reflection::Argument::ByReference(value)};
				(*handler_)(_fn_CPythonLibraryInterface_CPyModule_AddType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Bool, maxon::GenericComponent*, const CPyRef&, const CPyTypeRef&>::Invoke, (const void*) mt_._CPythonLibraryInterface_CPyModule_AddType));
				return proxy_result;
			}
		...
		static maxon::Result<void> RegisterReflection_CPythonLibraryInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
		{
			maxon::reflection::FunctionInfo functions[] =
			{
				...
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "module\0name\0value\0", 21LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyModule_AddObject),
				MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "module\0value\0", 5LL, CPythonLibraryInterface, _CPythonLibraryInterface_CPyModule_AddType),
	...
	public:
		...
		Result<void> GetFunctions3(BaseArray<NativePyCFunctionTable>& functions) 
		{
			...
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._PyModuleInterface_GetFunctions3_Offset), maxon::reflection::Argument::ByReference(functions)};
			(*handler_)(_fn_PyModuleInterface_GetFunctions3, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, BaseArray<NativePyCFunctionTable>&>::Invoke, (const void*) mt_._PyModuleInterface_GetFunctions3));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_PyModuleInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "functions\0", 0LL, PyModuleInterface, _PyModuleInterface_GetFunctions3),
