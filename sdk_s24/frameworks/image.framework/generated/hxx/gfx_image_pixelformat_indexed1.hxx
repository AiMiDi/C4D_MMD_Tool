...
/// @return												OK on success.
	...
	COWReferenceFunctionsImpl<typename PixelFormatInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename PixelFormatInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename PixelFormatInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
