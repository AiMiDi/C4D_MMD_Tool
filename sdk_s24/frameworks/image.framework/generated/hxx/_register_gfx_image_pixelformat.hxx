...
namespace maxon
{
	namespace enum35
	{
		...
		static const maxon::UInt64 CONVERTPIXELFLAGS_values[] = {maxon::UInt64(enum35::CONVERTPIXELFLAGS::NONE), maxon::UInt64(enum35::CONVERTPIXELFLAGS::FORCECOLORPROFILECONVERSION)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_CONVERTPIXELFLAGS35(){ return enum35::CONVERTPIXELFLAGS_info; }
	namespace enum47
	{
		...
		static const maxon::UInt64 GETPIXELHANDLERFLAGS_values[] = {maxon::UInt64(enum47::GETPIXELHANDLERFLAGS::NONE), maxon::UInt64(enum47::GETPIXELHANDLERFLAGS::FORCECOLORPROFILECONVERSION), maxon::UInt64(enum47::GETPIXELHANDLERFLAGS::DEEPIMAGE), maxon::UInt64(enum47::GETPIXELHANDLERFLAGS::DONTAPPLYMASK)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GETPIXELHANDLERFLAGS47(){ return enum47::GETPIXELHANDLERFLAGS_info; }
	namespace enum57
	{
		...
		static const maxon::UInt64 GETPIXELFLAGS_values[] = {maxon::UInt64(enum57::GETPIXELFLAGS::NONE), maxon::UInt64(enum57::GETPIXELFLAGS::DEEPIMAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GETPIXELFLAGS57(){ return enum57::GETPIXELFLAGS_info; }
	namespace enum71
	{
		...
		static const maxon::UInt64 SETPIXELHANDLERFLAGS_values[] = {maxon::UInt64(enum71::SETPIXELHANDLERFLAGS::NONE), maxon::UInt64(enum71::SETPIXELHANDLERFLAGS::FORCECOLORPROFILECONVERSION), maxon::UInt64(enum71::SETPIXELHANDLERFLAGS::DEEPIMAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SETPIXELHANDLERFLAGS71(){ return enum71::SETPIXELHANDLERFLAGS_info; }
	namespace enum80
	{
		...
		static const maxon::UInt64 SETPIXELFLAGS_values[] = {maxon::UInt64(enum80::SETPIXELFLAGS::NONE), maxon::UInt64(enum80::SETPIXELFLAGS::DEEPIMAGE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SETPIXELFLAGS80(){ return enum80::SETPIXELFLAGS_info; }
