...
namespace maxon
{
	...
	maxon::Bool ImageUrlCacheInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ImageUrlCacheInterface_InvalidateCache = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImageUrlCacheInterface_InvalidateCache;
		#else
		tbl->_ImageUrlCacheInterface_InvalidateCache = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImageUrlCacheInterface_InvalidateCache;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<ImageUrlCacheRef>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ImageUrlCacheInterface_FindOrCreate = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImageUrlCacheInterface_FindOrCreate;
		#else
		tbl->_ImageUrlCacheInterface_FindOrCreate = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_ImageUrlCacheInterface_FindOrCreate;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
