...
struct MediaSessionProgressInterface::MTable
{
	...
	Result<Float> (*_MediaSessionProgressInterface_GetProgress) (maxon::GenericComponent* this_, Int jobIndex);
	maxon::Int _MediaSessionProgressInterface_GetProgress_Offset;
	...
	Float (*_MediaSessionProgressInterface_GetTotalWeight) (const maxon::GenericComponent* this_);
	maxon::Int _MediaSessionProgressInterface_GetTotalWeight_Offset;
	...
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MediaSessionProgressInterface, GetProgress))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MediaSessionProgressInterface, GetProgress), W, MTable>::type::_MediaSessionProgressInterface_GetProgress;
		_MediaSessionProgressInterface_GetProgress = reinterpret_cast<const decltype(_MediaSessionProgressInterface_GetProgress)&>(ptr);
		_MediaSessionProgressInterface_GetProgress_Offset = offset;
	}
	...
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MediaSessionProgressInterface, GetTotalWeight))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, MediaSessionProgressInterface, GetTotalWeight), W, MTable>::type::_MediaSessionProgressInterface_GetTotalWeight;
		_MediaSessionProgressInterface_GetTotalWeight = reinterpret_cast<const decltype(_MediaSessionProgressInterface_GetTotalWeight)&>(ptr);
		_MediaSessionProgressInterface_GetTotalWeight_Offset = offset;
	}
	}
	...
	template <typename SUPER> using CompBase = maxon::PrivateComponentBase<MediaSessionProgressInterface, SUPER>;
...
struct MediaSessionProgressInterface::Hxx2
{
	...
	public:
		...
		static Result<Float> _MediaSessionProgressInterface_GetProgress(maxon::GenericComponent* this_, Int jobIndex) { return ((typename S::Implementation*) this_)->GetProgress(jobIndex); }
		...
		static Float _MediaSessionProgressInterface_GetTotalWeight(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetTotalWeight(); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto MediaSessionProgressInterface::GetProgress(Int jobIndex) -> Result<Float>
{
	const MediaSessionProgressInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, this); return mt_._MediaSessionProgressInterface_GetProgress((maxon::GenericComponent*) this + mt_._MediaSessionProgressInterface_GetProgress_Offset, jobIndex);
}
...
MAXON_ATTRIBUTE_FORCE_INLINE auto MediaSessionProgressInterface::GetTotalWeight() const -> Float
{
	const MediaSessionProgressInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, this); return mt_._MediaSessionProgressInterface_GetTotalWeight((const maxon::GenericComponent*) this + mt_._MediaSessionProgressInterface_GetTotalWeight_Offset);
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MediaSessionProgressInterface* o_ = (MediaSessionProgressInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MediaSessionProgressInterface, o_, MediaSessionProgressInterface_InitProgress) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<MediaSessionProgressInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MediaSessionProgressInterface>() : PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, o_); 
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MediaSessionProgressInterface* o_ = (MediaSessionProgressInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MediaSessionProgressInterface, o_, MediaSessionProgressInterface_InitProgress) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<MediaSessionProgressInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MediaSessionProgressInterface>() : PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, o_); 
	return (mt_._MediaSessionProgressInterface_InitProgress(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MediaSessionProgressInterface_InitProgress_Offset, delayFirstProgress, minProgressUpdate));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MediaSessionProgressInterface::Hxx1::ReferenceFunctionsImpl<S>::GetProgress(Int jobIndex) const -> Result<Float>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Float>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MediaSessionProgressInterface* o_ = (MediaSessionProgressInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MediaSessionProgressInterface, o_, MediaSessionProgressInterface_GetProgress) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<MediaSessionProgressInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MediaSessionProgressInterface>() : PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, o_); 
	return (mt_._MediaSessionProgressInterface_GetProgress(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MediaSessionProgressInterface_GetProgress_Offset, jobIndex));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MediaSessionProgressInterface::Hxx1::COWReferenceFunctionsImpl<S>::GetProgress(Int jobIndex) -> Result<Float>
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Float>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MediaSessionProgressInterface* o_ = (MediaSessionProgressInterface*) this->MakeWritable(true).GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return ReturnHelper::Return(this, maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::MAKE_WRITABLE_FAILED)); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MediaSessionProgressInterface, o_, MediaSessionProgressInterface_GetProgress) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<MediaSessionProgressInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MediaSessionProgressInterface>() : PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, o_); 
	return (mt_._MediaSessionProgressInterface_GetProgress(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._MediaSessionProgressInterface_GetProgress_Offset, jobIndex));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MediaSessionProgressInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetTotalWeight() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Float>, Float>::type
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Float>, Float>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MediaSessionProgressInterface* o_ = (const MediaSessionProgressInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = MediaSessionProgressInterface::NullValuePtr(); if (!o_) return 0; } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(MediaSessionProgressInterface, o_, MediaSessionProgressInterface_GetTotalWeight) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<MediaSessionProgressInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<MediaSessionProgressInterface>() : PRIVATE_MAXON_VTABLE(MediaSessionProgressInterface, o_); 
	return (mt_._MediaSessionProgressInterface_GetTotalWeight(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._MediaSessionProgressInterface_GetTotalWeight_Offset));
}
