...
struct IoMemoryInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _IoMemoryInterface_PrepareReadBuffer(IoMemoryInterface* this_, const Block<const Char>& buffer, const FreeBufferCallback& freeBufferCallback) { return C::Get(this_)->PrepareReadBuffer(buffer, freeBufferCallback); }
		static Result<void> _IoMemoryInterface_Reset(IoMemoryInterface* this_, Int size) { return C::Get(this_)->Reset(size); }
		static const Char& _IoMemoryInterface_operatorIndex(IoMemoryInterface* this_, Int idx) { return C::Get(this_)->operator [](idx); }
		static Int _IoMemoryInterface_GetSize(const IoMemoryInterface* this_) { return C::Get(this_)->GetSize(); }
		static Bool _IoMemoryInterface_IsWritable(const IoMemoryInterface* this_) { return C::Get(this_)->IsWritable(); }
		static Result<Url> _IoMemoryInterface_GetUrl(const IoMemoryInterface* this_) { return C::Get(this_)->GetUrl(); }
		static Result<void> _IoMemoryInterface_ReadBytes(const IoMemoryInterface* this_, Int position, const Block<Byte>& data) { return C::Get(this_)->ReadBytes(position, data); }
		static Result<Int> _IoMemoryInterface_ReadBytesEOS(const IoMemoryInterface* this_, Int position, const Block<Byte>& data) { return C::Get(this_)->ReadBytesEOS(position, data); }
		static Result<void> _IoMemoryInterface_WriteBytes(IoMemoryInterface* this_, Int position, const Block<const Byte>& data) { return C::Get(this_)->WriteBytes(position, data); }
		static Result<InputStreamRef> _IoMemoryInterface_OpenInputStream(const IoMemoryInterface* this_, OPENSTREAMFLAGS flags) { return C::Get(this_)->OpenInputStream(flags); }
		static Result<OutputStreamRef> _IoMemoryInterface_OpenOutputStream(IoMemoryInterface* this_, OPENSTREAMFLAGS flags) { return C::Get(this_)->OpenOutputStream(flags); }
		static Result<InOutputStreamRef> _IoMemoryInterface_OpenInOutputStream(IoMemoryInterface* this_, OPENSTREAMFLAGS flags) { return C::Get(this_)->OpenInOutputStream(flags); }
	};
