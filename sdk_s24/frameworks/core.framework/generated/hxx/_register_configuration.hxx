...
namespace maxon
{
	namespace enum23
	{
		...
		static const maxon::EnumInfo CONFIGURATION_CATEGORY_info{"CONFIGURATION_CATEGORY", SIZEOF(CONFIGURATION_CATEGORY), false, "REGULAR\0DEVELOPMENT\0MODULE\0EXTENSION\0IMPLEMENTATION\0NONE\0", CONFIGURATION_CATEGORY_values, std::extent<decltype(CONFIGURATION_CATEGORY_values)>::value};
	}
