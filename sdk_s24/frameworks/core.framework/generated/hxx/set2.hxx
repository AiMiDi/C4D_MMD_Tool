...
template <typename TYPE> struct SetInterface<TYPE>::MTable
{
	...
	template <typename IMPL> auto GetFreeMethod(maxon::OverloadRank1) { return &IMPL::_SetInterface_Free; }
	template <typename IMPL, typename = typename IMPL::Implementation::PrivateComponentWithBase> auto GetFreeMethod(maxon::OverloadRank2) { return reinterpret_cast<decltype(_SetInterface_Free)>(&maxon::ObjectInterface::PrivateFreeInstance); }
	...
	template <typename IMPL> void Init()
	{
		...
		_SetInterface_Free = GetFreeMethod<IMPL>(OVERLOAD_MAX_RANK);
	}
...
template <typename TYPE> struct SetInterface<TYPE>::Hxx2
{
	...
	public:
		...
		static Int _SetInterface_GetCount(const SetInterface* this_) { return C::Get(this_)->GetCount(); }
		static Bool _SetInterface_Contains(const SetInterface* this_, const TYPE& value) { return C::Get(this_)->Contains(value); }
		static Result<void> _SetInterface_Insert(SetInterface* this_, const TYPE& value, Bool& added) { return C::Get(this_)->Insert(value, added); }
		static Result<void> _SetInterface_Insert_1(SetInterface* this_, TYPE&& value, Bool& added) { return C::Get(this_)->Insert(std::forward<TYPE>(value), added); }
		static Result<Bool> _SetInterface_Erase(SetInterface* this_, const TYPE& value) { return C::Get(this_)->Erase(value); }
		static Iterator _SetInterface_Erase_1(SetInterface* this_, const Iterator& iterator) { return C::Get(this_)->Erase(iterator); }
		static void _SetInterface_Reset(SetInterface* this_) { return C::Get(this_)->Reset(); }
		static void _SetInterface_Flush(SetInterface* this_) { return C::Get(this_)->Flush(); }
		static Result<void> _SetInterface_CopyFrom(SetInterface* this_, const SetInterface& other) { return C::Get(this_)->CopyFrom(other); }
		static Result<SetInterface*> _SetInterface_Clone(const SetInterface* this_, Bool cloneElements) { return C::Get(this_)->Clone(cloneElements); }
		static const DataType& _SetInterface_GetValueDataType(const SetInterface* this_) { return C::Get(this_)->GetValueDataType(); }
		static String _SetInterface_ToString(const SetInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
		static Int _SetInterface_GetMemorySize(const SetInterface* this_) { return C::Get(this_)->GetMemorySize(); }
#ifdef MAXON_COMPILER_INTEL
#endif
#ifdef MAXON_COMPILER_INTEL
#endif
...
#ifdef CPP_853_HACK
#endif
		static void _SetInterface_IteratorInit(SetInterface* this_, Iterator* it, Bool end) { return C::Get(this_)->IteratorInit(it, end); }
		static void _SetInterface_IteratorInit_1(const SetInterface* this_, ConstIterator* it, Bool end) { return C::Get(this_)->IteratorInit(it, end); }
		static void _SetInterface_IteratorInitMove(const SetInterface* this_, Iterator* dest, Iterator* src) { return C::Get(this_)->IteratorInitMove(dest, src); }
		static void _SetInterface_IteratorInitMove_1(const SetInterface* this_, ConstIterator* dest, ConstIterator* src) { return C::Get(this_)->IteratorInitMove(dest, src); }
		static void _SetInterface_IteratorFree(const SetInterface* this_, Iterator* it) { return C::Get(this_)->IteratorFree(it); }
		static void _SetInterface_IteratorFree_1(const SetInterface* this_, ConstIterator* it) { return C::Get(this_)->IteratorFree(it); }
		static Bool _SetInterface_IteratorIsEqual(const SetInterface* this_, const Iterator* a, const Iterator* b) { return C::Get(this_)->IteratorIsEqual(a, b); }
		static Bool _SetInterface_IteratorIsEqual_1(const SetInterface* this_, const ConstIterator* a, const ConstIterator* b) { return C::Get(this_)->IteratorIsEqual(a, b); }
		static void _SetInterface_IteratorInc(const SetInterface* this_, Iterator* it) { return C::Get(this_)->IteratorInc(it); }
		static void _SetInterface_IteratorInc_1(const SetInterface* this_, ConstIterator* it) { return C::Get(this_)->IteratorInc(it); }
		static const TYPE* _SetInterface_IteratorGet(const SetInterface* this_, const Iterator* it) { return C::Get(this_)->IteratorGet(it); }
		static const TYPE* _SetInterface_IteratorGet_1(const SetInterface* this_, const ConstIterator* it) { return C::Get(this_)->IteratorGet(it); }
		static void _SetInterface_Free(const SetInterface* object) { return C::Free(C::Get(object)); }
	};

};
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::GetCount() const -> Int
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_GetCount(this);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Contains(const TYPE& value) const -> Bool
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_Contains(this, value);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_Clone(this, cloneElements);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::GetValueDataType() const -> const DataType&
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_GetValueDataType(this);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_ToString(this, formatStatement);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::GetMemorySize() const -> Int
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_GetMemorySize(this);
}
#ifdef MAXON_COMPILER_INTEL
#endif
#ifdef MAXON_COMPILER_INTEL
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorInit(this, it, end);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorInit_1(this, it, end);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorInitMove(this, dest, src);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorInitMove_1(this, dest, src);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::IteratorFree(Iterator* it) const -> void
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorFree(this, it);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::IteratorFree(ConstIterator* it) const -> void
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorFree_1(this, it);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorIsEqual(this, a, b);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorIsEqual_1(this, a, b);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::IteratorInc(Iterator* it) const -> void
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorInc(this, it);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::IteratorInc(ConstIterator* it) const -> void
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorInc_1(this, it);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorGet(this, it);
}
...
{
	return ((SetInterface::MTable*) (this->_vtableCls + 1))[-1]._SetInterface_IteratorGet_1(this, it);
}
template <typename TYPE> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Free(const SetInterface* object) -> void
{
	if (!object)
		return;
	return ((SetInterface::MTable*) (object->_vtableCls + 1))[-1]._SetInterface_Free(object);
}

template <typename TYPE> SetInterface<TYPE>::SetInterface(const MTable& vtable) : _vtableCls(&vtable._class) { }
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::GetCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_GetCount(o_));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return maxon::PrivateLogNullptrError(false); } 
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Contains(o_, value));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::Insert(const TYPE& value, Bool& added) const -> Result<void>
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Insert(o_, value, added));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Insert_1(o_, std::forward<TYPE>(value), added));
}
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::Erase(const TYPE& value) const -> Result<Bool>
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Erase(o_, value));
}
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::Erase(const Iterator& iterator) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Iterator>, Iterator>::type
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Erase_1(o_, iterator));
}
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	...
	((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Reset(o_);
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
	((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Flush(o_);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<void>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); SetInterface* o_ = (SetInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } 
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_CopyFrom(o_, other));
}
...
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::Clone(Bool cloneElements) const -> Result<SetInterface*>
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_Clone(o_, cloneElements));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::GetValueDataType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_GetValueDataType(o_));
}
template <typename TYPE> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto SetInterface<TYPE>::Hxx1::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* formatStatement) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
	...
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_ToString(o_, formatStatement));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const SetInterface* o_ = (const SetInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = SetInterface::NullValuePtr(); if (!o_) return 0; } 
	return (((SetInterface::MTable*) (o_->_vtableCls + 1))[-1]._SetInterface_GetMemorySize(o_));
}
