...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto IoConnectionInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ObservableErrorOpenFile() -> maxon::ObservableRef<ObservableErrorOpenFileDelegate> { return (Hxx2::StaticMTable::_instance._IoConnectionInterface_ObservableErrorOpenFile()); }
