...
namespace maxon
{
	...
	maxon::Bool DimensionInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<const Dimension&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_DimensionInterface_Get = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_DimensionInterface_Get;
		#else
		tbl->_DimensionInterface_Get = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_DimensionInterface_Get;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
