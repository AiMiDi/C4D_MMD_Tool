...
namespace maxon
{
	...
	"";
	const maxon::METHOD_FLAGS StringEncodingInterface::MTable::_flags[] = 
	{
		maxon::METHOD_FLAGS::NONE
	};
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(StringEncodingInterface, , "net.maxon.interface.stringencoding", "maxon.StringEncodingInterface", (StreamConversionInterface::PrivateGetInterface()));
	const maxon::Char* const StringDecodingInterface::MTable::_ids = 
	"";
	const maxon::METHOD_FLAGS StringDecodingInterface::MTable::_flags[] = 
	{
		maxon::METHOD_FLAGS::NONE
	};
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(StringDecodingInterface, , "net.maxon.interface.stringdecoding", "maxon.StringDecodingInterface", (StreamConversionInterface::PrivateGetInterface()));
	...
	namespace StringEncodings
	{
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(UrlQueryParameter, , "net.maxon.stringencoding.urlqueryparam");
	}
	namespace StringDecodings
	{
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(UrlQueryParameter, , "net.maxon.stringdecoding.urlqueryparam");
	}
	namespace StreamConversions
	{
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(StringUrlQueryParameterEncoder, , "net.maxon.streamconversion.urlqueryparamenc");
		PRIVATE_MAXON_DECLARATION_REGISTER_DECLARATION(StringUrlQueryParameterDecoder, , "net.maxon.streamconversion.urlqueryparamdec");
	}
	namespace StringEncodings
	{
