...
namespace maxon
{
	...
	public:
		...
		void FlushBranches() 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<HierarchyObjectInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._HierarchyObjectInterface_FlushBranches_Offset)};
			(*handler_)(_fn_HierarchyObjectInterface_FlushBranches, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_FlushBranches));
		}
		...
		std::add_pointer<HierarchyObjectInterface>::type GetParentPtr() const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<HierarchyObjectInterface>();
			std::add_pointer<HierarchyObjectInterface>::type proxy_result = maxon::PrivateNullReturnValue<std::add_pointer<HierarchyObjectInterface>::type>(maxon::NULL_RETURN_REASON::NULLIMPL, OVERLOAD_MAX_RANK);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._HierarchyObjectInterface_GetParentPtr_Offset)};
			(*handler_)(_fn_HierarchyObjectInterface_GetParentPtr, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<std::add_pointer<HierarchyObjectInterface>::type, const maxon::GenericComponent*>::Invoke, (const void*) mt_._HierarchyObjectInterface_GetParentPtr));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_HierarchyObjectInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "", 0LL, HierarchyObjectInterface, _HierarchyObjectInterface_FlushBranches),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, HierarchyObjectInterface, _HierarchyObjectInterface_GetParentPtr),
		};
