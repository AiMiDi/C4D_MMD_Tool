...
{
	template <typename S> using CWrapper = typename DataSerializeReaderInterface::Hxx2::template CWrapper<typename DataFormatBaseReaderInterface::Hxx2::template CWrapper<S>>;
};
...
{
	template <typename S> using CWrapper = typename DataSerializeWriterInterface::Hxx2::template CWrapper<typename DataFormatBaseWriterInterface::Hxx2::template CWrapper<S>>;
};
