...
struct StringConversion::MTable
{
	...
	StringProxy* (*_StringConversion_FormatXArgs) (const String& formatString, Int argsCnt, const void** args, const TOSTR* argFuncs);
...
struct StringConversion::Hxx2
{
	...
	public:
		...
		static StringProxy* _StringConversion_FormatXArgs(const String& formatString, Int argsCnt, const void** args, const TOSTR* argFuncs) { return C::FormatXArgs(formatString, argsCnt, args, argFuncs); }
