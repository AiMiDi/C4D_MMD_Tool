...
struct LexerInterface::Hxx2
{
	...
	public:
		...
		static Result<void> _LexerInterface_Init(LexerInterface* this_, UrlOrInputStream&& fileName, LEXERINITFLAGS flags, const String& stringEscapeCharacters, const StringDecodingRef& stringDecoding) { return C::Get(this_)->Init(std::forward<UrlOrInputStream>(fileName), flags, stringEscapeCharacters, stringDecoding); }
