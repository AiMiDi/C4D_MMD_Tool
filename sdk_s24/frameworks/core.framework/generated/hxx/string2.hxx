...
struct StringInterface::MTable
{
	...
	String (*_StringInterface_PrivateEnumToString_1) (const EnumInfo& info, UInt64 value, const FormatStatement* formatStatement);
	...
	template <typename IMPL> void Init()
	{
		...
		_StringInterface_PrivateEnumToString_1 = &IMPL::_StringInterface_PrivateEnumToString_1;
...
struct StringInterface::Hxx2
{
	...
	public:
		...
		static String _StringInterface_PrivateEnumToString_1(const EnumInfo& info, UInt64 value, const FormatStatement* formatStatement) { return C::PrivateEnumToString(info, value, formatStatement); }
...
[[deprecated]] MAXON_ATTRIBUTE_FORCE_INLINE auto StringInterface::PrivateEnumToString(UInt64 value, const Char* enumName, Int size, Bool flags, const UInt64* enumValues, const Char* enumValueNames, const FormatStatement* formatStatement) -> String
{
...
{
	return MTable::_instance._StringInterface_PrivateEnumToString_1(info, value, formatStatement);
}
