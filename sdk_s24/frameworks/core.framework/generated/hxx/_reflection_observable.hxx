...
namespace maxon
{
	...
	public:
		...
		Result<void> AddObserver(ObserverObjectInterface* observer, const FunctionBaseRef& observerFunction, Int priority) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<ObservableBaseInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._ObservableBaseInterface_AddObserver_Offset), maxon::reflection::Argument::ByValue(observer), maxon::reflection::Argument::ByReference(observerFunction), maxon::reflection::Argument::ByValue(priority)};
			(*handler_)(_fn_ObservableBaseInterface_AddObserver, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, ObserverObjectInterface*, const FunctionBaseRef&, Int>::Invoke, (const void*) mt_._ObservableBaseInterface_AddObserver));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_ObservableBaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "observer\0observerFunction\0priority\0", 21LL, ObservableBaseInterface, _ObservableBaseInterface_AddObserver),
