...
/// @cond INTERNAL
	...
	static maxon::Result<void> RegisterReflection_ThreadServices(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ThreadServices::MTable::_instance._ThreadServices_GetCurrentThreadType_1)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "threadIdentifier\0", 2LL, nullptr),
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ThreadServices::MTable::_instance._ThreadServices_AddJobStatusReference)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "pod\0", 1LL, nullptr),
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(ThreadServices::MTable::_instance._ThreadServices_RemoveJobStatusReference)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "pod\0", 1LL, nullptr),
		};
