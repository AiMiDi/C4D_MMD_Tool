...
namespace maxon
{
	...
	public:
		...
		Result<String> ConvertToUiName(const UrlInterface& url, CONVERTTOUINAMEFLAGS flags) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<IoHandlerInterface>();
			Result<String> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoHandlerInterface_ConvertToUiName_Offset), maxon::reflection::Argument::ByReference(url), maxon::reflection::Argument::ByValue(flags)};
			(*handler_)(_fn_IoHandlerInterface_ConvertToUiName, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<String>, const maxon::GenericComponent*, const UrlInterface&, CONVERTTOUINAMEFLAGS>::Invoke, (const void*) mt_._IoHandlerInterface_ConvertToUiName));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_IoHandlerInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "url\0flags\0", 5LL, IoHandlerInterface, _IoHandlerInterface_ConvertToUiName),
		};
