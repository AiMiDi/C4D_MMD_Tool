...
/// @endcond
	...
	static maxon::Result<void> RegisterReflection_JobQueueInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(JobQueueInterface::MTable::_instance._JobQueueInterface_EnableThreadAffinity)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "ownerId\0", 1LL, nullptr),
