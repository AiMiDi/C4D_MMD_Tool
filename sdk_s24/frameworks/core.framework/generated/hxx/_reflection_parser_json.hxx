...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_JsonParserInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(JsonParserInterface::MTable::_instance._JsonParserInterface_WriteFile)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "out\0stringEncoding\0dict\0niceFormatting\0", 85LL, nullptr),
		};
