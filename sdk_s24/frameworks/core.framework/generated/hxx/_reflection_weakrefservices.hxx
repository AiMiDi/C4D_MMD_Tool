...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_WeakRefServices(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(WeakRefServices::MTable::_instance._WeakRefServices_EraseObserver)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "target\0callback\0callbackData\0", 21LL, nullptr),
