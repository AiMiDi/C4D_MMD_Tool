...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDescriptionDefinitionDatabaseInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDescriptionDefinitionDatabaseInterface::MTable::_instance._DataDescriptionDefinitionDatabaseInterface_FixDatabaseProps)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "version\0entry\0", 5LL, nullptr),
