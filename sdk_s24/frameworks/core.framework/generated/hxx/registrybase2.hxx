...
struct RegistryEntryIteratorInterface::Hxx2
{
	...
	public:
		...
		static Bool _RegistryEntryIteratorInterface_HasValue(const RegistryEntryIteratorInterface* this_) { return C::Get(this_)->HasValue(); }
		static void _RegistryEntryIteratorInterface_MoveToNext(RegistryEntryIteratorInterface* this_) { return C::Get(this_)->MoveToNext(); }
		static const Id& _RegistryEntryIteratorInterface_GetId(const RegistryEntryIteratorInterface* this_) { return C::Get(this_)->GetId(); }
		static ConstDataPtr _RegistryEntryIteratorInterface_GetEntry(const RegistryEntryIteratorInterface* this_) { return C::Get(this_)->GetEntry(); }
	};
...
struct RegistryInterface::Hxx2
{
	...
	{
	public:
		static const Id& _RegistryInterface_GetId(const RegistryInterface* this_) { return C::Get(this_)->GetId(); }
		static UInt _RegistryInterface_GetStamp(const RegistryInterface* this_) { return C::Get(this_)->GetStamp(); }
		static const DataType& _RegistryInterface_GetDataType(const RegistryInterface* this_) { return C::Get(this_)->GetDataType(); }
		static Result<GenericData> _RegistryInterface_AddObserver(const RegistryInterface* this_, Delegate<void(const Id&eid,const ConstDataPtr&value,Bool inserted)>&& observer, Bool notifyDuringRegistration) { return C::Get(this_)->AddObserver(std::forward<Delegate<void(const Id&eid,const ConstDataPtr&value,Bool inserted)>>(observer), notifyDuringRegistration); }
