...
namespace maxon
{
	namespace enum22
	{
		...
		static const maxon::UInt64 SUBSYSTEM_values[] = {maxon::UInt64(enum22::SUBSYSTEM::UNDEFINED), maxon::UInt64(enum22::SUBSYSTEM::CONSOLE), maxon::UInt64(enum22::SUBSYSTEM::WINDOWS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_SUBSYSTEM22(){ return enum22::SUBSYSTEM_info; }
	...
	namespace enum119
	{
		...
		static const maxon::UInt64 APPLICATION_URLTYPE_values[] = {maxon::UInt64(enum119::APPLICATION_URLTYPE::STARTUP_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::APPLICATION), maxon::UInt64(enum119::APPLICATION_URLTYPE::APP_EXECUTABLE), maxon::UInt64(enum119::APPLICATION_URLTYPE::CORELIBS_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::RESOURCE_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::TEMP_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::PREFS_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::GLOBALPREFS_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::DESKTOP_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::USER_HOME_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::USER_DOCUMENTS_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::SYSTEM_PROGRAMS_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::CURRENT_WORKING_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::CURRENT_MODULE_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::CURRENT_MODULE_RESOURCE_DIR), maxon::UInt64(enum119::APPLICATION_URLTYPE::PREFS_DIR_STATIC)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATION_URLTYPE119(){ return enum119::APPLICATION_URLTYPE_info; }
	...
	namespace enum128
	{
		...
		static const maxon::UInt64 APPLICATIONMODE_values[] = {maxon::UInt64(enum128::APPLICATIONMODE::DONTWAIT), maxon::UInt64(enum128::APPLICATIONMODE::KEEPRUNNING), maxon::UInt64(enum128::APPLICATIONMODE::SHUTDOWN)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATIONMODE128(){ return enum128::APPLICATIONMODE_info; }
	...
	namespace enum134
	{
		...
		static const maxon::UInt64 APPLICATIONFEATURE_values[] = {maxon::UInt64(enum134::APPLICATIONFEATURE::NONE), maxon::UInt64(enum134::APPLICATIONFEATURE::COMMANDLINE)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_APPLICATIONFEATURE134(){ return enum134::APPLICATIONFEATURE_info; }
