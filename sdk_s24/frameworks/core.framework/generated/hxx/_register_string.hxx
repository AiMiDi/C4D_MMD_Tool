...
namespace maxon
{
	...
	const maxon::Char* const StringInterface::MTable::_ids = 
		...
		"PrivateEnumToString@ffd397c64753407b\0" // String PrivateEnumToString(UInt64 value, const Char* enumName, Int size, Bool flags, const UInt64* enumValues, const Char* enumValueNames, const FormatStatement* formatStatement)
	...
	maxon::Bool StringInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::_StringInterface_GetHashCode;
		#else
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<String>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_StringInterface_PrivateEnumToString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::_StringInterface_PrivateEnumToString_1;
		#else
		tbl->_StringInterface_PrivateEnumToString_1 = &Hxx2::Wrapper<Hxx2::Unresolved>::_StringInterface_PrivateEnumToString_1;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
	...
	maxon::Bool CStringInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<HashInt>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_CStringInterface_GetHashCode = &Hxx2::Wrapper<Hxx2::Unresolved>::_CStringInterface_GetHashCode;
		#else
