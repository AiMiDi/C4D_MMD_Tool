...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DataDictionaryInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(DataDictionaryInterface::MTable::_instance._DataDictionaryInterface_SetData_2)>::type>(nullptr, maxon::reflection::Member::KIND::INSTANCE_FUNCTION, "key\0data\0", 5LL, nullptr),
