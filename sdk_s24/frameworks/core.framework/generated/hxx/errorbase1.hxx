...
struct NullptrErrorInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename IllegalArgumentErrorInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename IllegalArgumentErrorInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type
	> { };
};
