...
/// @endcond
	...
	public:
		...
		Result<void> HandleMessage(const InternedId& message, const void* argument) 
		{
			const maxon::ComponentInfo* proxy_info;
			maxon::ObjectInterface* o_;
			const maxon::reflection::ProxyHandler* handler_;
			...
			(*handler_)(_fn_ObjectInterface_HandleMessage, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const InternedId&, const void*>::Invoke, (const void*) mt_._ObjectInterface_HandleMessage));
			return proxy_result;
		}
