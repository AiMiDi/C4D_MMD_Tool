...
struct IoPipeInOutputStreamInterface::Hxx1
{
	...
	COWReferenceFunctionsImpl<typename InOutputStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename InOutputStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename InOutputStreamInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
