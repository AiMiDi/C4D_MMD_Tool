...
struct CrashHandler::MTable
{
	...
	Result<void> (*_CrashHandler_GetProcessModules) (WritableArrayInterface<CrashModuleEntry>& modules);
	...
	template <typename IMPL> void Init()
	{
		...
		_CrashHandler_GetProcessModules = &IMPL::_CrashHandler_GetProcessModules;
...
struct CrashHandler::Hxx2
{
	...
	public:
		...
		static Result<void> _CrashHandler_GetProcessModules(WritableArrayInterface<CrashModuleEntry>& modules) { return C::GetProcessModules(modules); }
...
{
	return MTable::_instance._CrashHandler_GetProcessModules(modules);
}
