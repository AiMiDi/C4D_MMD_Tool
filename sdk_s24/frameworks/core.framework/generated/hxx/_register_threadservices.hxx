...
namespace maxon
{
	...
	"";
	const maxon::METHOD_FLAGS ThreadCancelledErrorInterface::MTable::_flags[] = 
	{
		maxon::METHOD_FLAGS::NONE
	};
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(ThreadCancelledErrorInterface, , "net.maxon.interface.threadcancellederror", "maxon.ThreadCancelledErrorInterface", (ErrorInterface::PrivateGetInterface()));
