...
namespace maxon
{
	...
	public:
		...
		Result<void> IoCopyFileProgress(const Url& destName, Bool overwrite, Bool removeReadOnly, const IoProgressDelegate& progress) 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<IoConnectionInterface>();
			Result<void> proxy_result = maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLIMPL);
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._IoConnectionInterface_IoCopyFileProgress_Offset), maxon::reflection::Argument::ByReference(destName), maxon::reflection::Argument::ByValue(overwrite), maxon::reflection::Argument::ByValue(removeReadOnly), maxon::reflection::Argument::ByReference(progress)};
			(*handler_)(_fn_IoConnectionInterface_IoCopyFileProgress, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<Result<void>, maxon::GenericComponent*, const Url&, Bool, Bool, const IoProgressDelegate&>::Invoke, (const void*) mt_._IoConnectionInterface_IoCopyFileProgress));
			return proxy_result;
		}
	...
	static maxon::Result<void> RegisterReflection_IoConnectionInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(IoConnectionInterface::Hxx2::StaticMTable::_instance._IoConnectionInterface_ObservableErrorOpenFile)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "", 0LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_IoConnectionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			...
			MAXON_GET_VIRTUAL_METHOD_INFO(INSTANCE_FUNCTION, "destName\0overwrite\0removeReadOnly\0progress\0", 85LL, IoConnectionInterface, _IoConnectionInterface_IoCopyFileProgress),
		};
