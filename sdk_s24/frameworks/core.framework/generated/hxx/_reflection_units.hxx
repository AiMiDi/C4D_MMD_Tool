...
namespace maxon
{
	...
	static maxon::Result<void> RegisterReflection_DimensionInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "", 0LL, DimensionInterface, _DimensionInterface_GetId),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "q\0", 0LL, DimensionInterface, _DimensionInterface_operatorMul),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "q\0", 0LL, DimensionInterface, _DimensionInterface_operatorDiv),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "exponent\0", 0LL, DimensionInterface, _DimensionInterface_operatorXor),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "qid\0", 0LL, DimensionInterface, _DimensionInterface_Copy),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "q\0", 0LL, DimensionInterface, _DimensionInterface_GetExponent),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "unitId\0siConversionFactor\0", 0LL, DimensionInterface, _DimensionInterface_AddUnit),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "", 0LL, DimensionInterface, _DimensionInterface_GetUnits),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "other\0", 0LL, DimensionInterface, _DimensionInterface_IsEquivalent),
			MAXON_GET_VIRTUAL_METHOD_INFO_NO_PROXY(CONST_INSTANCE_FUNCTION, "fs\0", 0LL, DimensionInterface, _DimensionInterface_ToString),
		};
