...
struct ParametricTypeInterface::Hxx2
{
	...
	public:
		...
		static const Id& _ParametricTypeInterface_GetId(const ParametricTypeInterface* this_) { return C::Get(this_)->GetId(); }
		static Result<DataType> _ParametricTypeInterface_Instantiate(const ParametricTypeInterface* this_, const Block<const Member>& args, const Block<const Int64>& iargs) { return C::Get(this_)->Instantiate(args, iargs); }
		static Bool _ParametricTypeInterface_IsBaseOfOrSame(const ParametricTypeInterface* this_, const DataType& type, const DataType& other) { return C::Get(this_)->IsBaseOfOrSame(type, other); }
		static Result<void> _ParametricTypeInterface_Convert(const ParametricTypeInterface* this_, const DataPtr& dest, const ConstDataPtr& src, CONVERSION_FLAGS ignore) { return C::Get(this_)->Convert(dest, src, ignore); }
		static Result<Tuple<DataType, const Char*>> _ParametricTypeInterface_Parse(const ParametricTypeInterface* this_, const Char* params) { return C::Get(this_)->Parse(params); }
		static void _ParametricTypeInterface_ResetInstantiated(const ParametricTypeInterface* this_, DataTypeImpl* type) { return C::Get(this_)->ResetInstantiated(type); }
		static DataTypeImpl*& _ParametricTypeInterface_GetLeakingLink(const ParametricTypeInterface* this_, DataTypeImpl* type) { return C::Get(this_)->GetLeakingLink(type); }
	};

};
MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::GetId() const -> const Id&
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_GetId(this);
}
...
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_Instantiate(this, args, iargs);
}
...
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_IsBaseOfOrSame(this, type, other);
}
...
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_Convert(this, dest, src, ignore);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Parse(const Char* params) const -> Result<Tuple<DataType, const Char*>>
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_Parse(this, params);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::ResetInstantiated(DataTypeImpl* type) const -> void
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_ResetInstantiated(this, type);
}
MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::GetLeakingLink(DataTypeImpl* type) const -> DataTypeImpl*&
{
	return ((ParametricTypeInterface::MTable*) (this->_vtableCls + 1))[-1]._ParametricTypeInterface_GetLeakingLink(this, type);
}

ParametricTypeInterface::ParametricTypeInterface(const MTable& vtable) : _vtableCls(&vtable._class) { }
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetId() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const Id&>, const Id&>::type
{
	...
	return (((ParametricTypeInterface::MTable*) (o_->_vtableCls + 1))[-1]._ParametricTypeInterface_GetId(o_));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Instantiate(const Block<const Member>& args, const Block<const Int64>& iargs) const -> Result<DataType>
{
	...
	return (((ParametricTypeInterface::MTable*) (o_->_vtableCls + 1))[-1]._ParametricTypeInterface_Instantiate(o_, args, iargs));
}
...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::IsBaseOfOrSame(const DataType& type, const DataType& other) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Bool>, Bool>::type
{
	...
	return (((ParametricTypeInterface::MTable*) (o_->_vtableCls + 1))[-1]._ParametricTypeInterface_IsBaseOfOrSame(o_, type, other));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Convert(const DataPtr& dest, const ConstDataPtr& src, CONVERSION_FLAGS ignore) const -> Result<void>
{
	...
	return (((ParametricTypeInterface::MTable*) (o_->_vtableCls + 1))[-1]._ParametricTypeInterface_Convert(o_, dest, src, ignore));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::Parse(const Char* params) const -> Result<Tuple<DataType, const Char*>>
{
	...
	return (((ParametricTypeInterface::MTable*) (o_->_vtableCls + 1))[-1]._ParametricTypeInterface_Parse(o_, params));
}
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto ParametricTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ResetInstantiated(DataTypeImpl* type) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	...
	((ParametricTypeInterface::MTable*) (o_->_vtableCls + 1))[-1]._ParametricTypeInterface_ResetInstantiated(o_, type);
