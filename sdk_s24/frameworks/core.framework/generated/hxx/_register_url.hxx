...
namespace maxon
{
	...
	namespace enum54
	{
		...
		static const maxon::UInt64 GETBROWSEITERATORFLAGS_values[] = {maxon::UInt64(enum54::GETBROWSEITERATORFLAGS::NONE), maxon::UInt64(enum54::GETBROWSEITERATORFLAGS::NOERRORONOPEN), maxon::UInt64(enum54::GETBROWSEITERATORFLAGS::RESOLVEPATHS)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_GETBROWSEITERATORFLAGS54(){ return enum54::GETBROWSEITERATORFLAGS_info; }
	namespace enum65
	{
		...
		static const maxon::UInt64 CONVERTTOUINAMEFLAGS_values[] = {maxon::UInt64(enum65::CONVERTTOUINAMEFLAGS::NONE), maxon::UInt64(enum65::CONVERTTOUINAMEFLAGS::NAMEONLY), maxon::UInt64(enum65::CONVERTTOUINAMEFLAGS::DIRECTORYONLY), maxon::UInt64(enum65::CONVERTTOUINAMEFLAGS::ADDVERSION)};
		static const maxon::EnumInfo CONVERTTOUINAMEFLAGS_info{"CONVERTTOUINAMEFLAGS", SIZEOF(CONVERTTOUINAMEFLAGS), true, "NONE\0NAMEONLY\0DIRECTORYONLY\0ADDVERSION\0", CONVERTTOUINAMEFLAGS_values, std::extent<decltype(CONVERTTOUINAMEFLAGS_values)>::value};
	}
	const maxon::EnumInfo& PrivateGetEnumInfo_CONVERTTOUINAMEFLAGS65(){ return enum65::CONVERTTOUINAMEFLAGS_info; }
	...
	maxon::Bool UrlInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<void>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlInterface_EraseData = &Hxx2::Wrapper<Hxx2::Unresolved>::_UrlInterface_EraseData;
		#else
		tbl->_UrlInterface_EraseData = &Hxx2::Wrapper<Hxx2::Unresolved>::_UrlInterface_EraseData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<String>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlInterface_ConvertToUiName = &Hxx2::Wrapper<Hxx2::Unresolved>::_UrlInterface_ConvertToUiName;
		#else
		tbl->_UrlInterface_ConvertToUiName = &Hxx2::Wrapper<Hxx2::Unresolved>::_UrlInterface_ConvertToUiName;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<Result<Url>>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_UrlInterface_ConvertFromUiName = &Hxx2::Wrapper<Hxx2::Unresolved>::_UrlInterface_ConvertFromUiName;
		#else
		tbl->_UrlInterface_ConvertFromUiName = &Hxx2::Wrapper<Hxx2::Unresolved>::_UrlInterface_ConvertFromUiName;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
