...
struct DataTypeBuilderInterface::HasBaseDetector { template <typename I> struct Check { static const maxon::Bool value = std::is_same<I, DataTypeBuilderInterface>::value || Object::HasBaseDetector::template Check<I>::value; static I* Cast(DataTypeBuilderInterface* ptr) { return reinterpret_cast<I*>(ptr); } }; };
struct DataTypeBuilderInterface::Hxx1
{
	class Reference;
	using ReferenceClass = DataTypeBuilderRef;
	template <template <typename...> class TEMPL> using SubstituteBases = TEMPL<Object>;
	...
	COWReferenceFunctionsImpl<typename Object::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename Object::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename Object::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
