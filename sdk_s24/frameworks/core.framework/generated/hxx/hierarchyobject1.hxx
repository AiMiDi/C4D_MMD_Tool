...
struct HierarchyObjectInterface::Hxx1
{
	...
	public:
		...
		[[deprecated]] inline Result<Data> GetOwner() const;
...
/// Removes all brances in the object.
	...
	template <typename ST, typename HIERARCHY_ = DefaultHierarchy<void>> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename ObserverObjectInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, HIERARCHY_>,
