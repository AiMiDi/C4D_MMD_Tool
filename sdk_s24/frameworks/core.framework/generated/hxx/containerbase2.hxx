...
struct GenericContainerInterface::MTable
{
	...
	template <typename IMPL> auto GetFreeMethod(maxon::OverloadRank1) { return &IMPL::_GenericContainerInterface_Free; }
	template <typename IMPL, typename = typename IMPL::Implementation::PrivateComponentWithBase> auto GetFreeMethod(maxon::OverloadRank2) { return reinterpret_cast<decltype(_GenericContainerInterface_Free)>(&maxon::ObjectInterface::PrivateFreeInstance); }
	...
	template <typename IMPL> void Init()
	{
		...
		_GenericContainerInterface_Free = GetFreeMethod<IMPL>(OVERLOAD_MAX_RANK);
	}
...
struct GenericContainerInterface::Hxx2
{
	...
	public:
		...
		static void _GenericContainerInterface_Free(const GenericContainerInterface* object) { return C::Free(C::Get(object)); }
	};
...
MAXON_ATTRIBUTE_FORCE_INLINE auto GenericContainerInterface::Free(const GenericContainerInterface* object) -> void
{
	if (!object)
		return;
	return ((GenericContainerInterface::MTable*) (object->_vtableCls + 1))[-1]._GenericContainerInterface_Free(object);
}

GenericContainerInterface::GenericContainerInterface(const MTable& vtable) : _vtableCls(&vtable._class) { }
