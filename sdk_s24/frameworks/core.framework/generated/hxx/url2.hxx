...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto UrlInterface::Hxx1::ConstReferenceFunctionsImpl<S>::ConvertFromUiName(const String& str) -> Result<Url> { return (MTable::_instance._UrlInterface_ConvertFromUiName(str)); }
