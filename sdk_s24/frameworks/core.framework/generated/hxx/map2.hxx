...
template <typename K, typename V> struct MapInterface<K, V>::MTable
{
	...
	template <typename IMPL> auto GetFreeMethod(maxon::OverloadRank1) { return &IMPL::_MapInterface_Free; }
	template <typename IMPL, typename = typename IMPL::Implementation::PrivateComponentWithBase> auto GetFreeMethod(maxon::OverloadRank2) { return reinterpret_cast<decltype(_MapInterface_Free)>(&maxon::ObjectInterface::PrivateFreeInstance); }
	...
	template <typename IMPL> void Init()
	{
		...
		_MapInterface_Free = GetFreeMethod<IMPL>(OVERLOAD_MAX_RANK);
	}
...
template <typename K, typename V> struct MapInterface<K, V>::Hxx2
{
	...
	public:
		...
		static Int _MapInterface_GetCount(const MapInterface* this_) { return C::Get(this_)->GetCount(); }
		static ResultRef<V> _MapInterface_InsertKey(MapInterface* this_, const K& key, Bool& created) { return C::Get(this_)->InsertKey(key, created); }
		static ResultRef<V> _MapInterface_InsertKey_1(MapInterface* this_, K&& key, Bool& created) { return C::Get(this_)->InsertKey(std::forward<K>(key), created); }
		static V* _MapInterface_FindValue(MapInterface* this_, const K& key) { return C::Get(this_)->FindValue(key); }
		static const V* _MapInterface_FindValue_1(const MapInterface* this_, const K& key) { return C::Get(this_)->FindValue(key); }
		static Result<Bool> _MapInterface_Erase(MapInterface* this_, const K& key) { return C::Get(this_)->Erase(key); }
		static Iterator _MapInterface_Erase_1(MapInterface* this_, const Iterator& iterator) { return C::Get(this_)->Erase(iterator); }
		static void _MapInterface_Reset(MapInterface* this_) { return C::Get(this_)->Reset(); }
		static void _MapInterface_Flush(MapInterface* this_) { return C::Get(this_)->Flush(); }
		static Result<void> _MapInterface_CopyFrom(MapInterface* this_, const MapInterface& other) { return C::Get(this_)->CopyFrom(other); }
		static Result<MapInterface*> _MapInterface_Clone(const MapInterface* this_, Bool cloneElements) { return C::Get(this_)->Clone(cloneElements); }
		static const DataType& _MapInterface_GetKeyDataType(const MapInterface* this_) { return C::Get(this_)->GetKeyDataType(); }
		static const DataType& _MapInterface_GetValueDataType(const MapInterface* this_) { return C::Get(this_)->GetValueDataType(); }
		static String _MapInterface_ToString(const MapInterface* this_, const FormatStatement* formatStatement) { return C::Get(this_)->ToString(formatStatement); }
		static Int _MapInterface_GetMemorySize(const MapInterface* this_) { return C::Get(this_)->GetMemorySize(); }
#ifdef MAXON_COMPILER_INTEL
#endif
#ifdef MAXON_COMPILER_INTEL
#endif
...
#ifdef CPP_853_HACK
#endif
		static void _MapInterface_IteratorInit(MapInterface* this_, Iterator* it, Bool end) { return C::Get(this_)->IteratorInit(it, end); }
		static void _MapInterface_IteratorInit_1(const MapInterface* this_, ConstIterator* it, Bool end) { return C::Get(this_)->IteratorInit(it, end); }
		static void _MapInterface_IteratorInitMove(const MapInterface* this_, Iterator* dest, Iterator* src) { return C::Get(this_)->IteratorInitMove(dest, src); }
		static void _MapInterface_IteratorInitMove_1(const MapInterface* this_, ConstIterator* dest, ConstIterator* src) { return C::Get(this_)->IteratorInitMove(dest, src); }
		static void _MapInterface_IteratorFree(const MapInterface* this_, Iterator* it) { return C::Get(this_)->IteratorFree(it); }
		static void _MapInterface_IteratorFree_1(const MapInterface* this_, ConstIterator* it) { return C::Get(this_)->IteratorFree(it); }
		static Bool _MapInterface_IteratorIsEqual(const MapInterface* this_, const Iterator* a, const Iterator* b) { return C::Get(this_)->IteratorIsEqual(a, b); }
		static Bool _MapInterface_IteratorIsEqual_1(const MapInterface* this_, const ConstIterator* a, const ConstIterator* b) { return C::Get(this_)->IteratorIsEqual(a, b); }
		static void _MapInterface_IteratorInc(const MapInterface* this_, Iterator* it) { return C::Get(this_)->IteratorInc(it); }
		static void _MapInterface_IteratorInc_1(const MapInterface* this_, ConstIterator* it) { return C::Get(this_)->IteratorInc(it); }
		static Pair<const K&, V&> _MapInterface_IteratorGet(const MapInterface* this_, const Iterator* it) { return C::Get(this_)->IteratorGet(it); }
		static Pair<const K&, const V&> _MapInterface_IteratorGet_1(const MapInterface* this_, const ConstIterator* it) { return C::Get(this_)->IteratorGet(it); }
		static void _MapInterface_Free(const MapInterface* object) { return C::Free(C::Get(object)); }
	};

};
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::GetCount() const -> Int
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_GetCount(this);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_InsertKey(this, key, created);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_CopyFrom(this, other);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_Clone(this, cloneElements);
}
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::GetKeyDataType() const -> const DataType&
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_GetKeyDataType(this);
}
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::GetValueDataType() const -> const DataType&
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_GetValueDataType(this);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_ToString(this, formatStatement);
}
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::GetMemorySize() const -> Int
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_GetMemorySize(this);
}
#ifdef MAXON_COMPILER_INTEL
#endif
#ifdef MAXON_COMPILER_INTEL
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorInit(this, it, end);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorInit_1(this, it, end);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorInitMove(this, dest, src);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorInitMove_1(this, dest, src);
}
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::IteratorFree(Iterator* it) const -> void
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorFree(this, it);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorFree_1(this, it);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorIsEqual(this, a, b);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorIsEqual_1(this, a, b);
}
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::IteratorInc(Iterator* it) const -> void
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorInc(this, it);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorInc_1(this, it);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorGet(this, it);
}
...
{
	return ((MapInterface::MTable*) (this->_vtableCls + 1))[-1]._MapInterface_IteratorGet_1(this, it);
}
template <typename K, typename V> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Free(const MapInterface* object) -> void
{
	if (!object)
		return;
	return ((MapInterface::MTable*) (object->_vtableCls + 1))[-1]._MapInterface_Free(object);
}

template <typename K, typename V> MapInterface<K, V>::MapInterface(const MTable& vtable) : _vtableCls(&vtable._class) { }
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstReferenceFunctionsImpl<S>::GetCount() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_GetCount(o_));
}
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ReferenceFunctionsImpl<S>::InsertKey(const K& key, Bool& created) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<V&>, ResultRef<V>>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_InsertKey(o_, key, created));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<V&>, ResultRef<V>>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MapInterface* o_ = (MapInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { return maxon::PrivateNullReturnValue<ResultRef<V>>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_InsertKey_1(o_, std::forward<K>(key), created));
}
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ReferenceFunctionsImpl<S>::FindValue(const K& key) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<V*>, V*>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_FindValue(o_, key));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstReferenceFunctionsImpl<S>::FindValue(const K& key) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const V*>, const V*>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_FindValue_1(o_, key));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ReferenceFunctionsImpl<S>::Erase(const K& key) const -> Result<Bool>
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_Erase(o_, key));
}
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ReferenceFunctionsImpl<S>::Erase(const Iterator& iterator) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<Iterator>, Iterator>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_Erase_1(o_, iterator));
}
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ReferenceFunctionsImpl<S>::Reset() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	...
	((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_Reset(o_);
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); MapInterface* o_ = (MapInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { DebugStop(); return maxon::PrivateLogNullptrError(); } 
	((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_Flush(o_);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ReferenceFunctionsImpl<S>::CopyFrom(const MapInterface& other) const -> Result<void>
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_CopyFrom(o_, other));
}
...
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstReferenceFunctionsImpl<S>::Clone(Bool cloneElements) const -> Result<MapInterface*>
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_Clone(o_, cloneElements));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstReferenceFunctionsImpl<S>::GetKeyDataType() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_GetKeyDataType(o_));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<const DataType&>, const DataType&>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MapInterface* o_ = (const MapInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = MapInterface::NullValuePtr(); if (!o_) return maxon::PrivateNullReturnValue<const DataType&>(maxon::NULL_RETURN_REASON::NULLPTR, OVERLOAD_MAX_RANK); } 
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_GetValueDataType(o_));
}
template <typename K, typename V> template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto MapInterface<K, V>::Hxx1::ConstReferenceFunctionsImpl<S>::ToString(const FormatStatement* formatStatement) const -> typename std::conditional<S::HAS_ERROR, maxon::Result<String>, String>::type
{
	...
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_ToString(o_, formatStatement));
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, typename std::conditional<S::HAS_ERROR, maxon::Result<Int>, Int>::type>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const MapInterface* o_ = (const MapInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = MapInterface::NullValuePtr(); if (!o_) return 0; } 
	return (((MapInterface::MTable*) (o_->_vtableCls + 1))[-1]._MapInterface_GetMemorySize(o_));
}
