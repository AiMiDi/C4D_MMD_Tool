...
/// @cond INTERNAL
	...
	namespace enum202
	{
		...
		static const maxon::UInt64 METHOD_FLAGS_values[] = {maxon::UInt64(enum202::METHOD_FLAGS::NONE), maxon::UInt64(enum202::METHOD_FLAGS::FORCE_SUPERCALL)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_METHOD_FLAGS202(){ return enum202::METHOD_FLAGS_info; }
#ifndef MAXON_TARGET_DEBUG
#endif
#ifndef MAXON_TARGET_DEBUG
#endif
/// @endcond
	...
	namespace enum755
	{
		...
		static const maxon::UInt64 KIND_values[] = {maxon::UInt64(enum755::KIND::NORMAL), maxon::UInt64(enum755::KIND::SINGLETON), maxon::UInt64(enum755::KIND::ABSTRACT)};
	...
	const maxon::EnumInfo& PrivateGetEnumInfo_KIND755(void*){ return enum755::KIND_info; }
	...
	maxon::Bool ClassInterface::MTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, MTable* tbl)
	{
		...
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		if (maxon::details::NullReturnType<const DataDictionary&>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_ClassInterface_GetMetaData = &Hxx2::Wrapper<Hxx2::Unresolved>::_ClassInterface_GetMetaData;
		#else
		tbl->_ClassInterface_GetMetaData = &Hxx2::Wrapper<Hxx2::Unresolved>::_ClassInterface_GetMetaData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
		tbl->_ClassInterface_InitMetaData = &Hxx2::Wrapper<Hxx2::Unresolved>::_ClassInterface_InitMetaData;
		#endif
		#if defined(PRIVATE_MAXON_ASSEMBLE_UNRESOLVED) && !defined(MAXON_TARGET_DEBUG)
		#else
