...
namespace maxon
{
	const maxon::Char* const HierarchyObjectInterface::MTable::_ids = 
		...
		"GetOwner@b1d39bbb7aec8c43\0" // Result<Data> GetOwner() const
		...
		"ObservableHierarchyInsert@97c868e29b02639f\0" // maxon::ObservableRef<ObservableHierarchyInsertDelegate> ObservableHierarchyInsert() const
		"ObservableHierarchyRemove@81dba67784ab0450\0" // maxon::ObservableRef<ObservableHierarchyRemoveDelegate> ObservableHierarchyRemove() const
	...
	PRIVATE_MAXON_INTERFACE_REGISTER_VIRTUAL_SINGLE_BASE(HierarchyObjectInterface, , "net.maxon.interface.hierarchyobject", "maxon.HierarchyObjectInterface", (ObserverObjectInterface::PrivateGetInterface()));
