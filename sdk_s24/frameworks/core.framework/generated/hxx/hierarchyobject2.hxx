...
struct HierarchyObjectInterface::MTable
{
	...
	void (*_HierarchyObjectInterface_FlushBranches) (maxon::GenericComponent* this_);
	maxon::Int _HierarchyObjectInterface_FlushBranches_Offset;
	std::add_pointer<HierarchyObjectInterface>::type (*_HierarchyObjectInterface_GetParentPtr) (const maxon::GenericComponent* this_);
	maxon::Int _HierarchyObjectInterface_GetParentPtr_Offset;
	...
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, HierarchyObjectInterface, FlushBranches))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, HierarchyObjectInterface, FlushBranches), W, MTable>::type::_HierarchyObjectInterface_FlushBranches;
		_HierarchyObjectInterface_FlushBranches = reinterpret_cast<const decltype(_HierarchyObjectInterface_FlushBranches)&>(ptr);
		_HierarchyObjectInterface_FlushBranches_Offset = offset;
	}
	if (PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, HierarchyObjectInterface, GetParentPtr))
	{
		auto ptr = &std::conditional<PRIVATE_MAXON_IMPLEMENTS(typename W::Implementation, HierarchyObjectInterface, GetParentPtr), W, MTable>::type::_HierarchyObjectInterface_GetParentPtr;
		_HierarchyObjectInterface_GetParentPtr = reinterpret_cast<const decltype(_HierarchyObjectInterface_GetParentPtr)&>(ptr);
		_HierarchyObjectInterface_GetParentPtr_Offset = offset;
	}
	}
...
struct HierarchyObjectInterface::Hxx2
{
	...
	public:
		...
		static void _HierarchyObjectInterface_FlushBranches(maxon::GenericComponent* this_) { return ((typename S::Implementation*) this_)->FlushBranches(); }
		static std::add_pointer<HierarchyObjectInterface>::type _HierarchyObjectInterface_GetParentPtr(const maxon::GenericComponent* this_) { return ((const typename S::Implementation*) this_)->GetParentPtr(); }
	};
...
[[deprecated]] MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::GetOwner() const -> Result<Data>
{
...
{
	const HierarchyObjectInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(HierarchyObjectInterface, this); return mt_._HierarchyObjectInterface_FlushBranches((maxon::GenericComponent*) this + mt_._HierarchyObjectInterface_FlushBranches_Offset);
}
...
{
	const HierarchyObjectInterface::MTable& mt_ = PRIVATE_MAXON_VTABLE(HierarchyObjectInterface, this); return mt_._HierarchyObjectInterface_GetParentPtr((const maxon::GenericComponent*) this + mt_._HierarchyObjectInterface_GetParentPtr_Offset);
}
...
{
	using ReturnHelper = maxon::ReferenceFunctionErrorReturnHelper<S::HAS_ERROR, maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::NEVER_NULLPTR), false, Result<Data>>; if (S::HAS_ERROR && this->GetErrorStorage().GetReferencedError()) return ReturnHelper::ReturnErrorOf(this); const HierarchyObjectInterface* o_ = (const HierarchyObjectInterface*) this->GetPointer(); if (!(S::Handler::KIND & (maxon::VALUEKIND::DEEP_CONSTNESS | maxon::VALUEKIND::NEVER_NULLPTR)) && MAXON_UNLIKELY(!o_)) { o_ = HierarchyObjectInterface::NullValuePtr(); if (!o_) return maxon::PrivateGetNullReturnError(maxon::NULL_RETURN_REASON::NULLPTR); } const MTable& mt_ = std::is_same<typename S::Handler, maxon::SuperPointerHandler>::value ? PRIVATE_MAXON_SUPERMTABLE(HierarchyObjectInterface, o_, HierarchyObjectInterface_GetOwner) : ((S::PrivateReferencedType::INTERFACE_FLAGS & maxon::EntityBase::FLAGS::SINGLE_IMPLEMENTATION) && S::PrivateReferencedType::HasBaseDetector::template Check<HierarchyObjectInterface>::value) ? S::PrivateReferencedType::MTable::template GetMTable<HierarchyObjectInterface>() : PRIVATE_MAXON_VTABLE(HierarchyObjectInterface, o_); 
...
template <typename S, typename HIERARCHY_> MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::Hxx1::ReferenceFunctionsImpl<S, HIERARCHY_>::FlushBranches() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<void>, void>::type
{
	...
	mt_._HierarchyObjectInterface_FlushBranches(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._HierarchyObjectInterface_FlushBranches_Offset);
	return (typename ReturnHelper::ReturnType) maxon::OK;
}
template <typename S, typename HIERARCHY_> MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::Hxx1::COWReferenceFunctionsImpl<S, HIERARCHY_>::FlushBranches() -> typename std::conditional<maxon::Bool(S::Handler::KIND & maxon::VALUEKIND::DEEP_CONSTNESS), void, maxon::Result<void>>::type
{
...
template <typename S, typename HIERARCHY_> MAXON_ATTRIBUTE_FORCE_INLINE auto HierarchyObjectInterface::Hxx1::ConstReferenceFunctionsImpl<S, HIERARCHY_>::GetParentPtr() const -> typename std::conditional<S::HAS_ERROR, maxon::Result<std::add_pointer<HierarchyObjectInterface>::type>, std::add_pointer<HierarchyObjectInterface>::type>::type
{
	...
	return (mt_._HierarchyObjectInterface_GetParentPtr(reinterpret_cast<const maxon::GenericComponent*>(o_) + mt_._HierarchyObjectInterface_GetParentPtr_Offset));
}
