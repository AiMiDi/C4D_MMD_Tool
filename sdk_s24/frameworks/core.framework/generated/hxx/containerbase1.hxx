...
/// @return												Index of the member, or -1 if it doesn't exist.
	...
	template <typename ST, typename T_ = NamedTuple<>> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename ST::type, T_>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type, T_>, ReferenceFunctionsImpl<typename ST::type, T_>>::type
	> { };
};
