...
/// @param[in] data								The meta data.
	...
	template <typename ST, typename REF_ = ObjectRef> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename ST::type, REF_>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename ST::type, REF_>, ReferenceFunctionsImpl<typename ST::type, REF_>>::type
	> { };
};
