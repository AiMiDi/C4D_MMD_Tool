...
namespace enum310
{
	...
	static const maxon::UInt64 SCENEFILTER_values[] = {maxon::UInt64(enum310::SCENEFILTER::NONE), maxon::UInt64(enum310::SCENEFILTER::OBJECTS), maxon::UInt64(enum310::SCENEFILTER::MATERIALS), maxon::UInt64(enum310::SCENEFILTER::DIALOGSALLOWED), maxon::UInt64(enum310::SCENEFILTER::PROGRESSALLOWED), maxon::UInt64(enum310::SCENEFILTER::MERGESCENE), maxon::UInt64(enum310::SCENEFILTER::NONEWMARKERS), maxon::UInt64(enum310::SCENEFILTER::SAVECACHES), maxon::UInt64(enum310::SCENEFILTER::NOUNDO), maxon::UInt64(enum310::SCENEFILTER::SAVE_BINARYCACHE), maxon::UInt64(enum310::SCENEFILTER::IDENTIFY_ONLY), maxon::UInt64(enum310::SCENEFILTER::ONLY_RENDERDATA), maxon::UInt64(enum310::SCENEFILTER::IGNOREMISSINGPLUGINSINNONACTIVERENDERDATA), maxon::UInt64(enum310::SCENEFILTER::IGNOREXREFS), maxon::UInt64(enum310::SCENEFILTER::DONTCORRECTOUTPUTFORMAT), maxon::UInt64(enum310::SCENEFILTER::SKIPOLDERTHANV13), maxon::UInt64(enum310::SCENEFILTER::PREVIEWONLY), maxon::UInt64(enum310::SCENEFILTER::DOCUMENTPREFSONLY)};
	static const maxon::EnumInfo SCENEFILTER_info{"SCENEFILTER", SIZEOF(SCENEFILTER), true, "NONE\0OBJECTS\0MATERIALS\0DIALOGSALLOWED\0PROGRESSALLOWED\0MERGESCENE\0NONEWMARKERS\0SAVECACHES\0NOUNDO\0SAVE_BINARYCACHE\0IDENTIFY_ONLY\0ONLY_RENDERDATA\0IGNOREMISSINGPLUGINSINNONACTIVERENDERDATA\0IGNOREXREFS\0DONTCORRECTOUTPUTFORMAT\0SKIPOLDERTHANV13\0PREVIEWONLY\0DOCUMENTPREFSONLY\0", SCENEFILTER_values, std::extent<decltype(SCENEFILTER_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_SCENEFILTER310(){ return enum310::SCENEFILTER_info; }
namespace enum324
{
	enum class OVERVIEW
	{
	...
	static const maxon::UInt64 OVERVIEW_values[] = {maxon::UInt64(enum324::OVERVIEW::DEFAULT), maxon::UInt64(enum324::OVERVIEW::AKTU), maxon::UInt64(enum324::OVERVIEW::SCENE), maxon::UInt64(enum324::OVERVIEW::COMPLETE), maxon::UInt64(enum324::OVERVIEW::SELECTED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_OVERVIEW324(){ return enum324::OVERVIEW_info; }
namespace enum346
{
	enum class GEMB
	{
	...
	static const maxon::UInt64 GEMB_values[] = {maxon::UInt64(enum346::GEMB::OK), maxon::UInt64(enum346::GEMB::OKCANCEL), maxon::UInt64(enum346::GEMB::ABORTRETRYIGNORE), maxon::UInt64(enum346::GEMB::YESNOCANCEL), maxon::UInt64(enum346::GEMB::YESNO), maxon::UInt64(enum346::GEMB::RETRYCANCEL), maxon::UInt64(enum346::GEMB::FORCEDIALOG), maxon::UInt64(enum346::GEMB::ICONSTOP), maxon::UInt64(enum346::GEMB::ICONQUESTION), maxon::UInt64(enum346::GEMB::ICONEXCLAMATION), maxon::UInt64(enum346::GEMB::ICONASTERISK), maxon::UInt64(enum346::GEMB::MULTILINE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GEMB346(){ return enum346::GEMB_info; }
namespace enum364
{
	enum class GEMB_R
	{
	...
	static const maxon::UInt64 GEMB_R_values[] = {maxon::UInt64(enum364::GEMB_R::V_UNDEFINED), maxon::UInt64(enum364::GEMB_R::V_OK), maxon::UInt64(enum364::GEMB_R::V_CANCEL), maxon::UInt64(enum364::GEMB_R::V_ABORT), maxon::UInt64(enum364::GEMB_R::V_RETRY), maxon::UInt64(enum364::GEMB_R::V_IGNORE), maxon::UInt64(enum364::GEMB_R::V_YES), maxon::UInt64(enum364::GEMB_R::V_NO)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GEMB_R364(){ return enum364::GEMB_R_info; }
namespace enum376
{
	...
	static const maxon::UInt64 MOUSEDRAGRESULT_values[] = {maxon::UInt64(enum376::MOUSEDRAGRESULT::ESCAPE), maxon::UInt64(enum376::MOUSEDRAGRESULT::FINISHED), maxon::UInt64(enum376::MOUSEDRAGRESULT::CONTINUE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MOUSEDRAGRESULT376(){ return enum376::MOUSEDRAGRESULT_info; }
namespace enum391
{
	...
	static const maxon::UInt64 MOUSEDRAGFLAGS_values[] = {maxon::UInt64(enum391::MOUSEDRAGFLAGS::NONE), maxon::UInt64(enum391::MOUSEDRAGFLAGS::DONTHIDEMOUSE), maxon::UInt64(enum391::MOUSEDRAGFLAGS::NOMOVE), maxon::UInt64(enum391::MOUSEDRAGFLAGS::EVERYPACKET), maxon::UInt64(enum391::MOUSEDRAGFLAGS::COMPENSATEVIEWPORTORG), maxon::UInt64(enum391::MOUSEDRAGFLAGS::AIRBRUSH)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MOUSEDRAGFLAGS391(){ return enum391::MOUSEDRAGFLAGS_info; }
namespace enum405
{
	...
	static const maxon::UInt64 INITRENDERRESULT_values[] = {maxon::UInt64(enum405::INITRENDERRESULT::OK), maxon::UInt64(enum405::INITRENDERRESULT::OUTOFMEMORY), maxon::UInt64(enum405::INITRENDERRESULT::ASSETMISSING), maxon::UInt64(enum405::INITRENDERRESULT::UNKNOWNERROR), maxon::UInt64(enum405::INITRENDERRESULT::USERBREAK)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_INITRENDERRESULT405(){ return enum405::INITRENDERRESULT_info; }
namespace enum425
{
	...
	static const maxon::UInt64 RENDERRESULT_values[] = {maxon::UInt64(enum425::RENDERRESULT::OK), maxon::UInt64(enum425::RENDERRESULT::OUTOFMEMORY), maxon::UInt64(enum425::RENDERRESULT::ASSETMISSING), maxon::UInt64(enum425::RENDERRESULT::SAVINGFAILED), maxon::UInt64(enum425::RENDERRESULT::USERBREAK), maxon::UInt64(enum425::RENDERRESULT::GICACHEMISSING), maxon::UInt64(enum425::RENDERRESULT::NOMACHINE), maxon::UInt64(enum425::RENDERRESULT::PROJECTNOTFOUND), maxon::UInt64(enum425::RENDERRESULT::ERRORLOADINGPROJECT), maxon::UInt64(enum425::RENDERRESULT::NOOUTPUTSPECIFIED)};
	static const maxon::EnumInfo RENDERRESULT_info{"RENDERRESULT", SIZEOF(RENDERRESULT), false, "OK\0OUTOFMEMORY\0ASSETMISSING\0SAVINGFAILED\0USERBREAK\0GICACHEMISSING\0NOMACHINE\0PROJECTNOTFOUND\0ERRORLOADINGPROJECT\0NOOUTPUTSPECIFIED\0", RENDERRESULT_values, std::extent<decltype(RENDERRESULT_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_RENDERRESULT425(){ return enum425::RENDERRESULT_info; }
namespace enum479
{
	...
	static const maxon::UInt64 COLORMODE_values[] = {maxon::UInt64(enum479::COLORMODE::ILLEGAL), maxon::UInt64(enum479::COLORMODE::ALPHA), maxon::UInt64(enum479::COLORMODE::GRAY), maxon::UInt64(enum479::COLORMODE::AGRAY), maxon::UInt64(enum479::COLORMODE::RGB), maxon::UInt64(enum479::COLORMODE::ARGB), maxon::UInt64(enum479::COLORMODE::CMYK), maxon::UInt64(enum479::COLORMODE::ACMYK), maxon::UInt64(enum479::COLORMODE::MASK), maxon::UInt64(enum479::COLORMODE::AMASK), maxon::UInt64(enum479::COLORMODE::ILLEGALw), maxon::UInt64(enum479::COLORMODE::GRAYw), maxon::UInt64(enum479::COLORMODE::AGRAYw), maxon::UInt64(enum479::COLORMODE::RGBw), maxon::UInt64(enum479::COLORMODE::ARGBw), maxon::UInt64(enum479::COLORMODE::MASKw), maxon::UInt64(enum479::COLORMODE::ILLEGALf), maxon::UInt64(enum479::COLORMODE::GRAYf), maxon::UInt64(enum479::COLORMODE::AGRAYf), maxon::UInt64(enum479::COLORMODE::RGBf), maxon::UInt64(enum479::COLORMODE::ARGBf), maxon::UInt64(enum479::COLORMODE::MASKf)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_COLORMODE479(){ return enum479::COLORMODE_info; }
namespace enum494
{
	...
	static const maxon::UInt64 COLORSPACETRANSFORMATION_values[] = {maxon::UInt64(enum494::COLORSPACETRANSFORMATION::NONE), maxon::UInt64(enum494::COLORSPACETRANSFORMATION::LINEAR_TO_SRGB), maxon::UInt64(enum494::COLORSPACETRANSFORMATION::SRGB_TO_LINEAR), maxon::UInt64(enum494::COLORSPACETRANSFORMATION::LINEAR_TO_VIEW), maxon::UInt64(enum494::COLORSPACETRANSFORMATION::SRGB_TO_VIEW)};
	static const maxon::EnumInfo COLORSPACETRANSFORMATION_info{"COLORSPACETRANSFORMATION", SIZEOF(COLORSPACETRANSFORMATION), false, "NONE\0LINEAR_TO_SRGB\0SRGB_TO_LINEAR\0LINEAR_TO_VIEW\0SRGB_TO_VIEW\0", COLORSPACETRANSFORMATION_values, std::extent<decltype(COLORSPACETRANSFORMATION_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_COLORSPACETRANSFORMATION494(){ return enum494::COLORSPACETRANSFORMATION_info; }
namespace enum509
{
	enum class PIXELCNT
	{
	...
	static const maxon::UInt64 PIXELCNT_values[] = {maxon::UInt64(enum509::PIXELCNT::NONE), maxon::UInt64(enum509::PIXELCNT::DITHERING), maxon::UInt64(enum509::PIXELCNT::B3DLAYERS), maxon::UInt64(enum509::PIXELCNT::APPLYALPHA), maxon::UInt64(enum509::PIXELCNT::INTERNAL_SETLINE), maxon::UInt64(enum509::PIXELCNT::INTERNAL_ALPHAVALUE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_PIXELCNT509(){ return enum509::PIXELCNT_info; }
namespace enum523
{
	...
	static const maxon::UInt64 INITBITMAPFLAGS_values[] = {maxon::UInt64(enum523::INITBITMAPFLAGS::NONE), maxon::UInt64(enum523::INITBITMAPFLAGS::GRAYSCALE), maxon::UInt64(enum523::INITBITMAPFLAGS::SYSTEM), maxon::UInt64(enum523::INITBITMAPFLAGS::DPNULL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_INITBITMAPFLAGS523(){ return enum523::INITBITMAPFLAGS_info; }
namespace enum535
{
	...
	static const maxon::UInt64 MPB_GETLAYERS_values[] = {maxon::UInt64(enum535::MPB_GETLAYERS::NONE), maxon::UInt64(enum535::MPB_GETLAYERS::ALPHA), maxon::UInt64(enum535::MPB_GETLAYERS::IMAGE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MPB_GETLAYERS535(){ return enum535::MPB_GETLAYERS_info; }
namespace enum555
{
	enum class MPBTYPE
	{
	...
	static const maxon::UInt64 MPBTYPE_values[] = {maxon::UInt64(enum555::MPBTYPE::SHOW), maxon::UInt64(enum555::MPBTYPE::SAVE), maxon::UInt64(enum555::MPBTYPE::PERCENT), maxon::UInt64(enum555::MPBTYPE::BLENDMODE), maxon::UInt64(enum555::MPBTYPE::COLORMODE), maxon::UInt64(enum555::MPBTYPE::BITMAPTYPE), maxon::UInt64(enum555::MPBTYPE::NAME), maxon::UInt64(enum555::MPBTYPE::DPI), maxon::UInt64(enum555::MPBTYPE::USERID), maxon::UInt64(enum555::MPBTYPE::USERSUBID), maxon::UInt64(enum555::MPBTYPE::FORCEBLEND)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MPBTYPE555(){ return enum555::MPBTYPE_info; }
namespace enum575
{
	...
	static const maxon::UInt64 LENGTHUNIT_values[] = {maxon::UInt64(enum575::LENGTHUNIT::PIXEL), maxon::UInt64(enum575::LENGTHUNIT::KM), maxon::UInt64(enum575::LENGTHUNIT::M), maxon::UInt64(enum575::LENGTHUNIT::CM), maxon::UInt64(enum575::LENGTHUNIT::MM), maxon::UInt64(enum575::LENGTHUNIT::UM), maxon::UInt64(enum575::LENGTHUNIT::NM), maxon::UInt64(enum575::LENGTHUNIT::MILE), maxon::UInt64(enum575::LENGTHUNIT::YARD), maxon::UInt64(enum575::LENGTHUNIT::FEET), maxon::UInt64(enum575::LENGTHUNIT::INCH)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_LENGTHUNIT575(){ return enum575::LENGTHUNIT_info; }
namespace enum592
{
	...
	static const maxon::UInt64 SPLINETYPE_values[] = {maxon::UInt64(enum592::SPLINETYPE::LINEAR), maxon::UInt64(enum592::SPLINETYPE::CUBIC), maxon::UInt64(enum592::SPLINETYPE::AKIMA), maxon::UInt64(enum592::SPLINETYPE::BSPLINE), maxon::UInt64(enum592::SPLINETYPE::BEZIER), maxon::UInt64(enum592::SPLINETYPE::RESERVEDSPLINETYPE1), maxon::UInt64(enum592::SPLINETYPE::RESERVEDSPLINETYPE2)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SPLINETYPE592(){ return enum592::SPLINETYPE_info; }
namespace enum605
{
	...
	static const maxon::UInt64 BREAKTANGENTS_values[] = {maxon::UInt64(enum605::BREAKTANGENTS::V_FALSE), maxon::UInt64(enum605::BREAKTANGENTS::V_TRUE), maxon::UInt64(enum605::BREAKTANGENTS::V_AUTO)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BREAKTANGENTS605(){ return enum605::BREAKTANGENTS_info; }
namespace enum617
{
	...
	static const maxon::UInt64 TANGENTSIDE_values[] = {maxon::UInt64(enum617::TANGENTSIDE::NONE), maxon::UInt64(enum617::TANGENTSIDE::LEFT), maxon::UInt64(enum617::TANGENTSIDE::RIGHT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_TANGENTSIDE617(){ return enum617::TANGENTSIDE_info; }
namespace enum631
{
	...
	static const maxon::UInt64 TANGENTTRANSFORMFLAG_values[] = {maxon::UInt64(enum631::TANGENTTRANSFORMFLAG::NONE), maxon::UInt64(enum631::TANGENTTRANSFORMFLAG::LOCK_LENGTH), maxon::UInt64(enum631::TANGENTTRANSFORMFLAG::LOCK_ANGLE), maxon::UInt64(enum631::TANGENTTRANSFORMFLAG::BREAK_SCALE), maxon::UInt64(enum631::TANGENTTRANSFORMFLAG::BREAK)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_TANGENTTRANSFORMFLAG631(){ return enum631::TANGENTTRANSFORMFLAG_info; }
namespace enum645
{
	...
	static const maxon::UInt64 SPLINEBOOL_AXIS_values[] = {maxon::UInt64(enum645::SPLINEBOOL_AXIS::NONE), maxon::UInt64(enum645::SPLINEBOOL_AXIS::SCREEN), maxon::UInt64(enum645::SPLINEBOOL_AXIS::ZY), maxon::UInt64(enum645::SPLINEBOOL_AXIS::XZ), maxon::UInt64(enum645::SPLINEBOOL_AXIS::XY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SPLINEBOOL_AXIS645(){ return enum645::SPLINEBOOL_AXIS_info; }
namespace enum660
{
	...
	static const maxon::UInt64 SPLINEBOOL_MODE_values[] = {maxon::UInt64(enum660::SPLINEBOOL_MODE::AMINUSB), maxon::UInt64(enum660::SPLINEBOOL_MODE::BMINUSA), maxon::UInt64(enum660::SPLINEBOOL_MODE::UNION), maxon::UInt64(enum660::SPLINEBOOL_MODE::AND), maxon::UInt64(enum660::SPLINEBOOL_MODE::OR), maxon::UInt64(enum660::SPLINEBOOL_MODE::INTERSECTION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SPLINEBOOL_MODE660(){ return enum660::SPLINEBOOL_MODE_info; }
namespace enum672
{
	...
	static const maxon::UInt64 PARTICLEFLAGS_values[] = {maxon::UInt64(enum672::PARTICLEFLAGS::NONE), maxon::UInt64(enum672::PARTICLEFLAGS::VISIBLE), maxon::UInt64(enum672::PARTICLEFLAGS::ALIVE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_PARTICLEFLAGS672(){ return enum672::PARTICLEFLAGS_info; }
namespace enum800
{
	enum class NBIT
	{
	...
	static const maxon::UInt64 NBIT_values[] = {maxon::UInt64(enum800::NBIT::NONE), maxon::UInt64(enum800::NBIT::TL1_FOLD), maxon::UInt64(enum800::NBIT::TL2_FOLD), maxon::UInt64(enum800::NBIT::TL3_FOLD), maxon::UInt64(enum800::NBIT::TL4_FOLD), maxon::UInt64(enum800::NBIT::TL1_SELECT), maxon::UInt64(enum800::NBIT::TL2_SELECT), maxon::UInt64(enum800::NBIT::TL3_SELECT), maxon::UInt64(enum800::NBIT::TL4_SELECT), maxon::UInt64(enum800::NBIT::TL1_TDRAW), maxon::UInt64(enum800::NBIT::TL2_TDRAW), maxon::UInt64(enum800::NBIT::TL3_TDRAW), maxon::UInt64(enum800::NBIT::TL4_TDRAW), maxon::UInt64(enum800::NBIT::CKEY_ACTIVE), maxon::UInt64(enum800::NBIT::OM1_FOLD), maxon::UInt64(enum800::NBIT::OM2_FOLD), maxon::UInt64(enum800::NBIT::OM3_FOLD), maxon::UInt64(enum800::NBIT::OM4_FOLD), maxon::UInt64(enum800::NBIT::TL1_FOLDTR), maxon::UInt64(enum800::NBIT::TL2_FOLDTR), maxon::UInt64(enum800::NBIT::TL3_FOLDTR), maxon::UInt64(enum800::NBIT::TL4_FOLDTR), maxon::UInt64(enum800::NBIT::TL1_FOLDFC), maxon::UInt64(enum800::NBIT::TL2_FOLDFC), maxon::UInt64(enum800::NBIT::TL3_FOLDFC), maxon::UInt64(enum800::NBIT::TL4_FOLDFC), maxon::UInt64(enum800::NBIT::SOURCEOPEN), maxon::UInt64(enum800::NBIT::TL1_HIDE), maxon::UInt64(enum800::NBIT::TL2_HIDE), maxon::UInt64(enum800::NBIT::TL3_HIDE), maxon::UInt64(enum800::NBIT::TL4_HIDE), maxon::UInt64(enum800::NBIT::SOLO_ANIM), maxon::UInt64(enum800::NBIT::SOLO_LAYER), maxon::UInt64(enum800::NBIT::TL1_SELECT2), maxon::UInt64(enum800::NBIT::TL2_SELECT2), maxon::UInt64(enum800::NBIT::TL3_SELECT2), maxon::UInt64(enum800::NBIT::TL4_SELECT2), maxon::UInt64(enum800::NBIT::SOLO_MOTION), maxon::UInt64(enum800::NBIT::CKEY_LOCK_T), maxon::UInt64(enum800::NBIT::CKEY_LOCK_V), maxon::UInt64(enum800::NBIT::CKEY_MUTE), maxon::UInt64(enum800::NBIT::CKEY_CLAMP), maxon::UInt64(enum800::NBIT::CKEY_BREAK), maxon::UInt64(enum800::NBIT::CKEY_KEEPVISUALANGLE), maxon::UInt64(enum800::NBIT::CKEY_LOCK_O), maxon::UInt64(enum800::NBIT::CKEY_LOCK_L), maxon::UInt64(enum800::NBIT::CKEY_AUTO), maxon::UInt64(enum800::NBIT::CKEY_ZERO_O_OLD), maxon::UInt64(enum800::NBIT::CKEY_ZERO_L_OLD), maxon::UInt64(enum800::NBIT::TL1_FCSELECT), maxon::UInt64(enum800::NBIT::TL2_FCSELECT), maxon::UInt64(enum800::NBIT::TL3_FCSELECT), maxon::UInt64(enum800::NBIT::TL4_FCSELECT), maxon::UInt64(enum800::NBIT::CKEY_BREAKDOWN), maxon::UInt64(enum800::NBIT::TL1_FOLDMOTION), maxon::UInt64(enum800::NBIT::TL2_FOLDMOTION), maxon::UInt64(enum800::NBIT::TL3_FOLDMOTION), maxon::UInt64(enum800::NBIT::TL4_FOLDMOTION), maxon::UInt64(enum800::NBIT::TL1_SELECTMOTION), maxon::UInt64(enum800::NBIT::TL2_SELECTMOTION), maxon::UInt64(enum800::NBIT::TL3_SELECTMOTION), maxon::UInt64(enum800::NBIT::TL4_SELECTMOTION), maxon::UInt64(enum800::NBIT::OHIDE), maxon::UInt64(enum800::NBIT::TL_TBAKE), maxon::UInt64(enum800::NBIT::TL1_FOLDSM), maxon::UInt64(enum800::NBIT::TL2_FOLDSM), maxon::UInt64(enum800::NBIT::TL3_FOLDSM), maxon::UInt64(enum800::NBIT::TL4_FOLDSM), maxon::UInt64(enum800::NBIT::SUBOBJECT), maxon::UInt64(enum800::NBIT::LINK_ACTIVE), maxon::UInt64(enum800::NBIT::THIDE), maxon::UInt64(enum800::NBIT::SUBOBJECT_AM), maxon::UInt64(enum800::NBIT::PROTECTION), maxon::UInt64(enum800::NBIT::NOANIM), maxon::UInt64(enum800::NBIT::NOSELECT), maxon::UInt64(enum800::NBIT::EHIDE), maxon::UInt64(enum800::NBIT::REF), maxon::UInt64(enum800::NBIT::REF_NO_DD), maxon::UInt64(enum800::NBIT::REF_OHIDE), maxon::UInt64(enum800::NBIT::NO_DD), maxon::UInt64(enum800::NBIT::HIDEEXCEPTVIEWSELECT), maxon::UInt64(enum800::NBIT::CKEY_WEIGHTEDTANGENT), maxon::UInt64(enum800::NBIT::CKEY_REMOVEOVERSHOOT), maxon::UInt64(enum800::NBIT::CKEY_AUTOWEIGHT), maxon::UInt64(enum800::NBIT::TAKE_LOCK), maxon::UInt64(enum800::NBIT::TAKE_OBJINGROUP), maxon::UInt64(enum800::NBIT::TAKE_EGROUPOVERIDDEN), maxon::UInt64(enum800::NBIT::TAKE_RGROUPOVERIDDEN), maxon::UInt64(enum800::NBIT::CKEY_BREAKDOWNCOLOR), maxon::UInt64(enum800::NBIT::NO_DELETE), maxon::UInt64(enum800::NBIT::LOD_HIDE), maxon::UInt64(enum800::NBIT::LOD_PRIVATECACHE), maxon::UInt64(enum800::NBIT::AHIDE_FOR_HOST), maxon::UInt64(enum800::NBIT::NODE_TEMP), maxon::UInt64(enum800::NBIT::MAX)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_NBIT800(){ return enum800::NBIT_info; }
namespace enum818
{
	...
	static const maxon::UInt64 CREATEJOBRESULT_values[] = {maxon::UInt64(enum818::CREATEJOBRESULT::OK), maxon::UInt64(enum818::CREATEJOBRESULT::OUTOFMEMORY), maxon::UInt64(enum818::CREATEJOBRESULT::ASSETMISSING), maxon::UInt64(enum818::CREATEJOBRESULT::SAVINGFAILED), maxon::UInt64(enum818::CREATEJOBRESULT::REPOSITORYERROR)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CREATEJOBRESULT818(){ return enum818::CREATEJOBRESULT_info; }
namespace enum831
{
	...
	static const maxon::UInt64 NBITCONTROL_values[] = {maxon::UInt64(enum831::NBITCONTROL::SET), maxon::UInt64(enum831::NBITCONTROL::CLEAR), maxon::UInt64(enum831::NBITCONTROL::TOGGLE), maxon::UInt64(enum831::NBITCONTROL::PRIVATE_NODIRTY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_NBITCONTROL831(){ return enum831::NBITCONTROL_info; }
namespace enum1673
{
	...
	static const maxon::UInt64 VOLUMECOMMANDTYPE_values[] = {maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::NONE), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::VOLUMETOMESH), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::MESHTOVOLUME), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::VOLUMEBOOLE), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::PARTICLESTOVOLUME), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::SPLINETOVOLUME), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::FILTER), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::SDFFILTER), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::SDFTOFOG), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::FOGTOSDF), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::RESAMPLE), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::MIX), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::FIELDTOVOLUME), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::CREATESPHEREVOLUME), maxon::UInt64(enum1673::VOLUMECOMMANDTYPE::CREATEPLATONICVOLUME)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VOLUMECOMMANDTYPE1673(){ return enum1673::VOLUMECOMMANDTYPE_info; }
namespace enum1688
{
	enum class GRIDTYPE
	{
	...
	static const maxon::UInt64 GRIDTYPE_values[] = {maxon::UInt64(enum1688::GRIDTYPE::NONE), maxon::UInt64(enum1688::GRIDTYPE::FLOAT), maxon::UInt64(enum1688::GRIDTYPE::DOUBLE), maxon::UInt64(enum1688::GRIDTYPE::INT32), maxon::UInt64(enum1688::GRIDTYPE::INT64), maxon::UInt64(enum1688::GRIDTYPE::INTVECTOR32), maxon::UInt64(enum1688::GRIDTYPE::VECTOR32), maxon::UInt64(enum1688::GRIDTYPE::VECTOR64), maxon::UInt64(enum1688::GRIDTYPE::STRING), maxon::UInt64(enum1688::GRIDTYPE::BOOLEAN)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GRIDTYPE1688(){ return enum1688::GRIDTYPE_info; }
namespace enum1698
{
	...
	static const maxon::UInt64 GRIDCLASS_values[] = {maxon::UInt64(enum1698::GRIDCLASS::NONE), maxon::UInt64(enum1698::GRIDCLASS::SDF), maxon::UInt64(enum1698::GRIDCLASS::FOG), maxon::UInt64(enum1698::GRIDCLASS::STAGGERED), maxon::UInt64(enum1698::GRIDCLASS::UNKNOWN)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GRIDCLASS1698(){ return enum1698::GRIDCLASS_info; }
namespace enum1713
{
	...
	static const maxon::UInt64 VOLUMETOMESHSETTINGS_values[] = {maxon::UInt64(enum1713::VOLUMETOMESHSETTINGS::NONE), maxon::UInt64(enum1713::VOLUMETOMESHSETTINGS::ISO), maxon::UInt64(enum1713::VOLUMETOMESHSETTINGS::ADAPTIVE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VOLUMETOMESHSETTINGS1713(){ return enum1713::VOLUMETOMESHSETTINGS_info; }
namespace enum1729
{
	...
	static const maxon::UInt64 MESHTOVOLUMESETTINGS_values[] = {maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::NONE), maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::GRIDSIZE), maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::BANDWIDTH_INTERIOR), maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::BANDWIDTH_EXTERIOR), maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::USE_POINTS), maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::RADIUS), maxon::UInt64(enum1729::MESHTOVOLUMESETTINGS::UNSIGNED_DISTANCE_FIELD)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MESHTOVOLUMESETTINGS1729(){ return enum1729::MESHTOVOLUMESETTINGS_info; }
namespace enum1744
{
	...
	static const maxon::UInt64 PARTICLESTOVOLUMESETTINGS_values[] = {maxon::UInt64(enum1744::PARTICLESTOVOLUMESETTINGS::NONE), maxon::UInt64(enum1744::PARTICLESTOVOLUMESETTINGS::GRIDSIZE), maxon::UInt64(enum1744::PARTICLESTOVOLUMESETTINGS::BANDWIDTH), maxon::UInt64(enum1744::PARTICLESTOVOLUMESETTINGS::RADIUS), maxon::UInt64(enum1744::PARTICLESTOVOLUMESETTINGS::VELOCITY_SCALE), maxon::UInt64(enum1744::PARTICLESTOVOLUMESETTINGS::USE_PARTICLE_SIZE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_PARTICLESTOVOLUMESETTINGS1744(){ return enum1744::PARTICLESTOVOLUMESETTINGS_info; }
namespace enum1759
{
	...
	static const maxon::UInt64 SPLINETOVOLUMESETTINGS_values[] = {maxon::UInt64(enum1759::SPLINETOVOLUMESETTINGS::NONE), maxon::UInt64(enum1759::SPLINETOVOLUMESETTINGS::GRIDSIZE), maxon::UInt64(enum1759::SPLINETOVOLUMESETTINGS::BANDWIDTH), maxon::UInt64(enum1759::SPLINETOVOLUMESETTINGS::RADIUS), maxon::UInt64(enum1759::SPLINETOVOLUMESETTINGS::DENSITY), maxon::UInt64(enum1759::SPLINETOVOLUMESETTINGS::SCALESEGMENT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SPLINETOVOLUMESETTINGS1759(){ return enum1759::SPLINETOVOLUMESETTINGS_info; }
namespace enum1781
{
	...
	static const maxon::UInt64 FILTERSETTINGS_values[] = {maxon::UInt64(enum1781::FILTERSETTINGS::NONE), maxon::UInt64(enum1781::FILTERSETTINGS::FILTERTYPE), maxon::UInt64(enum1781::FILTERSETTINGS::ITERATIONS), maxon::UInt64(enum1781::FILTERSETTINGS::RADIUS), maxon::UInt64(enum1781::FILTERSETTINGS::OFFSET), maxon::UInt64(enum1781::FILTERSETTINGS::FALLOFF), maxon::UInt64(enum1781::FILTERSETTINGS::REMAP_OLD_MIN), maxon::UInt64(enum1781::FILTERSETTINGS::REMAP_OLD_MAX), maxon::UInt64(enum1781::FILTERSETTINGS::REMAP_NEW_MIN), maxon::UInt64(enum1781::FILTERSETTINGS::REMAP_NEW_MAX), maxon::UInt64(enum1781::FILTERSETTINGS::STRENGTH), maxon::UInt64(enum1781::FILTERSETTINGS::SPLINE), maxon::UInt64(enum1781::FILTERSETTINGS::INVERTPOINT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILTERSETTINGS1781(){ return enum1781::FILTERSETTINGS_info; }
namespace enum1799
{
	...
	static const maxon::UInt64 SDFFILTERSETTINGS_values[] = {maxon::UInt64(enum1799::SDFFILTERSETTINGS::NONE), maxon::UInt64(enum1799::SDFFILTERSETTINGS::FILTERTYPE), maxon::UInt64(enum1799::SDFFILTERSETTINGS::ITERATIONS), maxon::UInt64(enum1799::SDFFILTERSETTINGS::STENCILWIDTH), maxon::UInt64(enum1799::SDFFILTERSETTINGS::FILTERACCURACY), maxon::UInt64(enum1799::SDFFILTERSETTINGS::OFFSET), maxon::UInt64(enum1799::SDFFILTERSETTINGS::HALFWIDTH), maxon::UInt64(enum1799::SDFFILTERSETTINGS::FALLOFF), maxon::UInt64(enum1799::SDFFILTERSETTINGS::STRENGTH)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SDFFILTERSETTINGS1799(){ return enum1799::SDFFILTERSETTINGS_info; }
namespace enum1810
{
	...
	static const maxon::UInt64 BOOLESETTINGS_values[] = {maxon::UInt64(enum1810::BOOLESETTINGS::NONE), maxon::UInt64(enum1810::BOOLESETTINGS::BOOLETYPE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BOOLESETTINGS1810(){ return enum1810::BOOLESETTINGS_info; }
namespace enum1823
{
	enum class BOOLTYPE
	{
	...
	static const maxon::UInt64 BOOLTYPE_values[] = {maxon::UInt64(enum1823::BOOLTYPE::NONE), maxon::UInt64(enum1823::BOOLTYPE::UNION), maxon::UInt64(enum1823::BOOLTYPE::DIFF), maxon::UInt64(enum1823::BOOLTYPE::INTERSECT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BOOLTYPE1823(){ return enum1823::BOOLTYPE_info; }
namespace enum1834
{
	...
	static const maxon::UInt64 MIXSETTINGS_values[] = {maxon::UInt64(enum1834::MIXSETTINGS::NONE), maxon::UInt64(enum1834::MIXSETTINGS::MIXTYPE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MIXSETTINGS1834(){ return enum1834::MIXSETTINGS_info; }
namespace enum1851
{
	enum class MIXTYPE
	{
	...
	static const maxon::UInt64 MIXTYPE_values[] = {maxon::UInt64(enum1851::MIXTYPE::NONE), maxon::UInt64(enum1851::MIXTYPE::NORMAL), maxon::UInt64(enum1851::MIXTYPE::MAX), maxon::UInt64(enum1851::MIXTYPE::MIN), maxon::UInt64(enum1851::MIXTYPE::ADD), maxon::UInt64(enum1851::MIXTYPE::SUBTRACT), maxon::UInt64(enum1851::MIXTYPE::MULTIPLY), maxon::UInt64(enum1851::MIXTYPE::DIVIDE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MIXTYPE1851(){ return enum1851::MIXTYPE_info; }
namespace enum1862
{
	...
	static const maxon::UInt64 SDFTOFOGSETTINGS_values[] = {maxon::UInt64(enum1862::SDFTOFOGSETTINGS::NONE), maxon::UInt64(enum1862::SDFTOFOGSETTINGS::FALLOFFCUTOFF)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SDFTOFOGSETTINGS1862(){ return enum1862::SDFTOFOGSETTINGS_info; }
namespace enum1873
{
	...
	static const maxon::UInt64 FOGTOSDFSETTINGS_values[] = {maxon::UInt64(enum1873::FOGTOSDFSETTINGS::NONE), maxon::UInt64(enum1873::FOGTOSDFSETTINGS::ISO)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FOGTOSDFSETTINGS1873(){ return enum1873::FOGTOSDFSETTINGS_info; }
namespace enum1885
{
	...
	static const maxon::UInt64 RESAMPLESETTINGS_values[] = {maxon::UInt64(enum1885::RESAMPLESETTINGS::NONE), maxon::UInt64(enum1885::RESAMPLESETTINGS::GRIDSIZE), maxon::UInt64(enum1885::RESAMPLESETTINGS::INTERPOLATIONTYPE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RESAMPLESETTINGS1885(){ return enum1885::RESAMPLESETTINGS_info; }
namespace enum1898
{
	...
	static const maxon::UInt64 RESAMPLEINTERPOLATIONTYPE_values[] = {maxon::UInt64(enum1898::RESAMPLEINTERPOLATIONTYPE::NONE), maxon::UInt64(enum1898::RESAMPLEINTERPOLATIONTYPE::NEAREST), maxon::UInt64(enum1898::RESAMPLEINTERPOLATIONTYPE::LINEAR), maxon::UInt64(enum1898::RESAMPLEINTERPOLATIONTYPE::QUADRATIC)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RESAMPLEINTERPOLATIONTYPE1898(){ return enum1898::RESAMPLEINTERPOLATIONTYPE_info; }
namespace enum1911
{
	...
	static const maxon::UInt64 FIELDTOVOLUMESETTINGS_values[] = {maxon::UInt64(enum1911::FIELDTOVOLUMESETTINGS::NONE), maxon::UInt64(enum1911::FIELDTOVOLUMESETTINGS::BOUNDINGBOXMIN), maxon::UInt64(enum1911::FIELDTOVOLUMESETTINGS::BOUNDINGBOXMAX), maxon::UInt64(enum1911::FIELDTOVOLUMESETTINGS::GRIDSIZE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FIELDTOVOLUMESETTINGS1911(){ return enum1911::FIELDTOVOLUMESETTINGS_info; }
namespace enum1925
{
	...
	static const maxon::UInt64 CREATESPHEREVOLUMESETTINGS_values[] = {maxon::UInt64(enum1925::CREATESPHEREVOLUMESETTINGS::NONE), maxon::UInt64(enum1925::CREATESPHEREVOLUMESETTINGS::RADIUS), maxon::UInt64(enum1925::CREATESPHEREVOLUMESETTINGS::POSITION), maxon::UInt64(enum1925::CREATESPHEREVOLUMESETTINGS::BANDWIDTH), maxon::UInt64(enum1925::CREATESPHEREVOLUMESETTINGS::GRIDSIZE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CREATESPHEREVOLUMESETTINGS1925(){ return enum1925::CREATESPHEREVOLUMESETTINGS_info; }
namespace enum1940
{
	...
	static const maxon::UInt64 CREATEPLATONICVOLUMESETTINGS_values[] = {maxon::UInt64(enum1940::CREATEPLATONICVOLUMESETTINGS::NONE), maxon::UInt64(enum1940::CREATEPLATONICVOLUMESETTINGS::FACES), maxon::UInt64(enum1940::CREATEPLATONICVOLUMESETTINGS::SIZE), maxon::UInt64(enum1940::CREATEPLATONICVOLUMESETTINGS::POSITION), maxon::UInt64(enum1940::CREATEPLATONICVOLUMESETTINGS::BANDWIDTH), maxon::UInt64(enum1940::CREATEPLATONICVOLUMESETTINGS::GRIDSIZE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CREATEPLATONICVOLUMESETTINGS1940(){ return enum1940::CREATEPLATONICVOLUMESETTINGS_info; }
namespace enum2602
{
	enum class EVENT
	{
	...
	static const maxon::UInt64 EVENT_values[] = {maxon::UInt64(enum2602::EVENT::NONE), maxon::UInt64(enum2602::EVENT::FORCEREDRAW), maxon::UInt64(enum2602::EVENT::ANIMATE), maxon::UInt64(enum2602::EVENT::NOEXPRESSION), maxon::UInt64(enum2602::EVENT::GLHACK), maxon::UInt64(enum2602::EVENT::CAMERAEXPRESSION), maxon::UInt64(enum2602::EVENT::ENQUEUE_REDRAW), maxon::UInt64(enum2602::EVENT::DONT_OVERWRITE_RENDERING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_EVENT2602(){ return enum2602::EVENT_info; }
namespace enum2632
{
	...
	static const maxon::UInt64 DRAWFLAGS_values[] = {maxon::UInt64(enum2632::DRAWFLAGS::NONE), maxon::UInt64(enum2632::DRAWFLAGS::NO_THREAD), maxon::UInt64(enum2632::DRAWFLAGS::NO_ANIMATION), maxon::UInt64(enum2632::DRAWFLAGS::ONLY_ACTIVE_VIEW), maxon::UInt64(enum2632::DRAWFLAGS::NO_EXPRESSIONS), maxon::UInt64(enum2632::DRAWFLAGS::INDRAG), maxon::UInt64(enum2632::DRAWFLAGS::NO_HIGHLIGHT_PLANE), maxon::UInt64(enum2632::DRAWFLAGS::FORCEFULLREDRAW), maxon::UInt64(enum2632::DRAWFLAGS::ONLY_CAMERAEXPRESSION), maxon::UInt64(enum2632::DRAWFLAGS::INMOVE), maxon::UInt64(enum2632::DRAWFLAGS::ONLY_BASEDRAW), maxon::UInt64(enum2632::DRAWFLAGS::ONLY_HIGHLIGHT), maxon::UInt64(enum2632::DRAWFLAGS::STATICBREAK), maxon::UInt64(enum2632::DRAWFLAGS::NO_PRESENT), maxon::UInt64(enum2632::DRAWFLAGS::PRIVATE_NO_WAIT_GL_FINISHED), maxon::UInt64(enum2632::DRAWFLAGS::PRIVATE_ONLYBACKGROUND), maxon::UInt64(enum2632::DRAWFLAGS::PRIVATE_NOBLIT), maxon::UInt64(enum2632::DRAWFLAGS::PRIVATE_OPENGLHACK), maxon::UInt64(enum2632::DRAWFLAGS::PRIVATE_ONLY_PREPARE), maxon::UInt64(enum2632::DRAWFLAGS::PRIVATE_NO_3DCLIPPING), maxon::UInt64(enum2632::DRAWFLAGS::DONT_OVERWRITE_RENDERING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAWFLAGS2632(){ return enum2632::DRAWFLAGS_info; }
namespace enum2647
{
	...
	static const maxon::UInt64 ANIMATEFLAGS_values[] = {maxon::UInt64(enum2647::ANIMATEFLAGS::NONE), maxon::UInt64(enum2647::ANIMATEFLAGS::NO_PARTICLES), maxon::UInt64(enum2647::ANIMATEFLAGS::NO_CHILDREN), maxon::UInt64(enum2647::ANIMATEFLAGS::INRENDER), maxon::UInt64(enum2647::ANIMATEFLAGS::NO_MINMAX), maxon::UInt64(enum2647::ANIMATEFLAGS::NO_NLA), maxon::UInt64(enum2647::ANIMATEFLAGS::NLA_SUM)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ANIMATEFLAGS2647(){ return enum2647::ANIMATEFLAGS_info; }
namespace enum2666
{
	...
	static const maxon::UInt64 SAVEDOCUMENTFLAGS_values[] = {maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::NONE), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::DIALOGSALLOWED), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::SAVEAS), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::DONTADDTORECENTLIST), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::AUTOSAVE), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::SAVECACHES), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::EXPORTDIALOG), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::CRASHSITUATION), maxon::UInt64(enum2666::SAVEDOCUMENTFLAGS::NO_SHADERCACHE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SAVEDOCUMENTFLAGS2666(){ return enum2666::SAVEDOCUMENTFLAGS_info; }
namespace enum2703
{
	...
	static const maxon::UInt64 COPYFLAGS_values[] = {maxon::UInt64(enum2703::COPYFLAGS::NONE), maxon::UInt64(enum2703::COPYFLAGS::NO_HIERARCHY), maxon::UInt64(enum2703::COPYFLAGS::NO_ANIMATION), maxon::UInt64(enum2703::COPYFLAGS::NO_BITS), maxon::UInt64(enum2703::COPYFLAGS::NO_MATERIALPREVIEW), maxon::UInt64(enum2703::COPYFLAGS::NO_BRANCHES), maxon::UInt64(enum2703::COPYFLAGS::DOCUMENT), maxon::UInt64(enum2703::COPYFLAGS::NO_NGONS), maxon::UInt64(enum2703::COPYFLAGS::CACHE_BUILD), maxon::UInt64(enum2703::COPYFLAGS::RECURSIONCHECK), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_IDENTMARKER), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_NO_INTERNALS), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_NO_PLUGINLAYER), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_UNDO), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_CONTAINER_COPY_DIRTY), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_CONTAINER_COPY_IDENTICAL), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_NO_TAGS), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_DELETE), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_CLIPBOARD_COPY), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_NO_ASSETS), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_NO_RESULTASSETS), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_NO_LOGS), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_RENDER), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_BODYPAINT_NODATA), maxon::UInt64(enum2703::COPYFLAGS::PRIVATE_BODYPAINT_CONVERTLAYER)};
	static const maxon::EnumInfo COPYFLAGS_info{"COPYFLAGS", SIZEOF(COPYFLAGS), true, "NONE\0NO_HIERARCHY\0NO_ANIMATION\0NO_BITS\0NO_MATERIALPREVIEW\0NO_BRANCHES\0DOCUMENT\0NO_NGONS\0CACHE_BUILD\0RECURSIONCHECK\0PRIVATE_IDENTMARKER\0PRIVATE_NO_INTERNALS\0PRIVATE_NO_PLUGINLAYER\0PRIVATE_UNDO\0PRIVATE_CONTAINER_COPY_DIRTY\0PRIVATE_CONTAINER_COPY_IDENTICAL\0PRIVATE_NO_TAGS\0PRIVATE_DELETE\0PRIVATE_CLIPBOARD_COPY\0PRIVATE_NO_ASSETS\0PRIVATE_NO_RESULTASSETS\0PRIVATE_NO_LOGS\0PRIVATE_RENDER\0PRIVATE_BODYPAINT_NODATA\0PRIVATE_BODYPAINT_CONVERTLAYER\0", COPYFLAGS_values, std::extent<decltype(COPYFLAGS_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_COPYFLAGS2703(){ return enum2703::COPYFLAGS_info; }
namespace enum2733
{
	enum class UNDOTYPE
	{
	...
	static const maxon::UInt64 UNDOTYPE_values[] = {maxon::UInt64(enum2733::UNDOTYPE::NONE), maxon::UInt64(enum2733::UNDOTYPE::CHANGE), maxon::UInt64(enum2733::UNDOTYPE::CHANGE_NOCHILDREN), maxon::UInt64(enum2733::UNDOTYPE::CHANGE_SMALL), maxon::UInt64(enum2733::UNDOTYPE::CHANGE_SELECTION), maxon::UInt64(enum2733::UNDOTYPE::NEWOBJ), maxon::UInt64(enum2733::UNDOTYPE::DELETEOBJ), maxon::UInt64(enum2733::UNDOTYPE::ACTIVATE), maxon::UInt64(enum2733::UNDOTYPE::DEACTIVATE), maxon::UInt64(enum2733::UNDOTYPE::BITS), maxon::UInt64(enum2733::UNDOTYPE::HIERARCHY_PSR), maxon::UInt64(enum2733::UNDOTYPE::PRIVATE_STRING), maxon::UInt64(enum2733::UNDOTYPE::PRIVATE_MULTISELECTIONAXIS), maxon::UInt64(enum2733::UNDOTYPE::START), maxon::UInt64(enum2733::UNDOTYPE::END)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_UNDOTYPE2733(){ return enum2733::UNDOTYPE_info; }
namespace enum2750
{
	...
	static const maxon::UInt64 DRAWHANDLE_values[] = {maxon::UInt64(enum2750::DRAWHANDLE::MINI), maxon::UInt64(enum2750::DRAWHANDLE::SMALL), maxon::UInt64(enum2750::DRAWHANDLE::MIDDLE), maxon::UInt64(enum2750::DRAWHANDLE::BIG), maxon::UInt64(enum2750::DRAWHANDLE::CUSTOM), maxon::UInt64(enum2750::DRAWHANDLE::POINTSIZE), maxon::UInt64(enum2750::DRAWHANDLE::SELPOINTSIZE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAWHANDLE2750(){ return enum2750::DRAWHANDLE_info; }
namespace enum2763
{
	...
	static const maxon::UInt64 DRAW_ALPHA_values[] = {maxon::UInt64(enum2763::DRAW_ALPHA::NONE), maxon::UInt64(enum2763::DRAW_ALPHA::INVERTED), maxon::UInt64(enum2763::DRAW_ALPHA::NORMAL), maxon::UInt64(enum2763::DRAW_ALPHA::FROM_IMAGE), maxon::UInt64(enum2763::DRAW_ALPHA::NORMAL_FROM_IMAGE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAW_ALPHA2763(){ return enum2763::DRAW_ALPHA_info; }
namespace enum2790
{
	...
	static const maxon::UInt64 DRAW_TEXTUREFLAGS_values[] = {maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::NONE), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::COLOR_IMAGE_TO_LINEAR), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::COLOR_SRGB_TO_LINEAR), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::COLOR_IMAGE_TO_SRGB), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::COLOR_LINEAR_TO_SRGB), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::COLOR_CORRECTION_MASK), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::USE_PROFILE_COLOR), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::ALLOW_FLOATINGPOINT), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::TILE), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::TEMPORARY), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::INTERPOLATION_NEAREST), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::INTERPOLATION_LINEAR), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::INTERPOLATION_LINEAR_MIPMAP), maxon::UInt64(enum2790::DRAW_TEXTUREFLAGS::INTERPOLATION_MASK)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAW_TEXTUREFLAGS2790(){ return enum2790::DRAW_TEXTUREFLAGS_info; }
namespace enum2802
{
	enum class TOOLDRAW
	{
	...
	static const maxon::UInt64 TOOLDRAW_values[] = {maxon::UInt64(enum2802::TOOLDRAW::NONE), maxon::UInt64(enum2802::TOOLDRAW::HANDLES), maxon::UInt64(enum2802::TOOLDRAW::AXIS), maxon::UInt64(enum2802::TOOLDRAW::HIGHLIGHTS)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_TOOLDRAW2802(){ return enum2802::TOOLDRAW_info; }
namespace enum2815
{
	...
	static const maxon::UInt64 TOOLDRAWFLAGS_values[] = {maxon::UInt64(enum2815::TOOLDRAWFLAGS::NONE), maxon::UInt64(enum2815::TOOLDRAWFLAGS::INVERSE_Z), maxon::UInt64(enum2815::TOOLDRAWFLAGS::HIGHLIGHT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_TOOLDRAWFLAGS2815(){ return enum2815::TOOLDRAWFLAGS_info; }
namespace enum2956
{
	...
	static const maxon::UInt64 DIRTYFLAGS_values[] = {maxon::UInt64(enum2956::DIRTYFLAGS::NONE), maxon::UInt64(enum2956::DIRTYFLAGS::MATRIX), maxon::UInt64(enum2956::DIRTYFLAGS::DATA), maxon::UInt64(enum2956::DIRTYFLAGS::SELECT), maxon::UInt64(enum2956::DIRTYFLAGS::CACHE), maxon::UInt64(enum2956::DIRTYFLAGS::CHILDREN), maxon::UInt64(enum2956::DIRTYFLAGS::DESCRIPTION), maxon::UInt64(enum2956::DIRTYFLAGS::SELECTION_OBJECTS), maxon::UInt64(enum2956::DIRTYFLAGS::SELECTION_TAGS), maxon::UInt64(enum2956::DIRTYFLAGS::SELECTION_MATERIALS), maxon::UInt64(enum2956::DIRTYFLAGS::ALL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DIRTYFLAGS2956(){ return enum2956::DIRTYFLAGS_info; }
namespace enum2977
{
	...
	static const maxon::UInt64 HDIRTY_ID_values[] = {maxon::UInt64(enum2977::HDIRTY_ID::ANIMATION), maxon::UInt64(enum2977::HDIRTY_ID::OBJECT), maxon::UInt64(enum2977::HDIRTY_ID::OBJECT_MATRIX), maxon::UInt64(enum2977::HDIRTY_ID::OBJECT_HIERARCHY), maxon::UInt64(enum2977::HDIRTY_ID::TAG), maxon::UInt64(enum2977::HDIRTY_ID::MATERIAL), maxon::UInt64(enum2977::HDIRTY_ID::SHADER), maxon::UInt64(enum2977::HDIRTY_ID::RENDERSETTINGS), maxon::UInt64(enum2977::HDIRTY_ID::VP), maxon::UInt64(enum2977::HDIRTY_ID::FILTER), maxon::UInt64(enum2977::HDIRTY_ID::NBITS), maxon::UInt64(enum2977::HDIRTY_ID::MAX)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_HDIRTY_ID2977(){ return enum2977::HDIRTY_ID_info; }
namespace enum3000
{
	...
	static const maxon::UInt64 HDIRTYFLAGS_values[] = {maxon::UInt64(enum3000::HDIRTYFLAGS::NONE), maxon::UInt64(enum3000::HDIRTYFLAGS::ANIMATION), maxon::UInt64(enum3000::HDIRTYFLAGS::OBJECT), maxon::UInt64(enum3000::HDIRTYFLAGS::OBJECT_MATRIX), maxon::UInt64(enum3000::HDIRTYFLAGS::OBJECT_HIERARCHY), maxon::UInt64(enum3000::HDIRTYFLAGS::TAG), maxon::UInt64(enum3000::HDIRTYFLAGS::MATERIAL), maxon::UInt64(enum3000::HDIRTYFLAGS::SHADER), maxon::UInt64(enum3000::HDIRTYFLAGS::RENDERSETTINGS), maxon::UInt64(enum3000::HDIRTYFLAGS::VP), maxon::UInt64(enum3000::HDIRTYFLAGS::FILTER), maxon::UInt64(enum3000::HDIRTYFLAGS::NBITS), maxon::UInt64(enum3000::HDIRTYFLAGS::ALL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_HDIRTYFLAGS3000(){ return enum3000::HDIRTYFLAGS_info; }
namespace enum3024
{
	...
	static const maxon::UInt64 ROTATIONORDER_values[] = {maxon::UInt64(enum3024::ROTATIONORDER::YXZGLOBAL), maxon::UInt64(enum3024::ROTATIONORDER::YZXGLOBAL), maxon::UInt64(enum3024::ROTATIONORDER::ZYXGLOBAL), maxon::UInt64(enum3024::ROTATIONORDER::ZXYGLOBAL), maxon::UInt64(enum3024::ROTATIONORDER::XZYGLOBAL), maxon::UInt64(enum3024::ROTATIONORDER::XYZGLOBAL), maxon::UInt64(enum3024::ROTATIONORDER::YXZLOCAL), maxon::UInt64(enum3024::ROTATIONORDER::YZXLOCAL), maxon::UInt64(enum3024::ROTATIONORDER::ZYXLOCAL), maxon::UInt64(enum3024::ROTATIONORDER::ZXYLOCAL), maxon::UInt64(enum3024::ROTATIONORDER::XZYLOCAL), maxon::UInt64(enum3024::ROTATIONORDER::XYZLOCAL), maxon::UInt64(enum3024::ROTATIONORDER::HPB), maxon::UInt64(enum3024::ROTATIONORDER::DEFAULT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ROTATIONORDER3024(){ return enum3024::ROTATIONORDER_info; }
namespace enum3035
{
	...
	static const maxon::UInt64 ROTATIONINTERPOLATION_QUATERNION_values[] = {maxon::UInt64(enum3035::ROTATIONINTERPOLATION_QUATERNION::SLERP), maxon::UInt64(enum3035::ROTATIONINTERPOLATION_QUATERNION::CUBIC)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ROTATIONINTERPOLATION_QUATERNION3035(){ return enum3035::ROTATIONINTERPOLATION_QUATERNION_info; }
namespace enum3047
{
	...
	static const maxon::UInt64 CURVEINTERPOLATION_MODE_values[] = {maxon::UInt64(enum3047::CURVEINTERPOLATION_MODE::R23), maxon::UInt64(enum3047::CURVEINTERPOLATION_MODE::CURRENT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CURVEINTERPOLATION_MODE3047(){ return enum3047::CURVEINTERPOLATION_MODE_info; }
namespace enum3062
{
	...
	static const maxon::UInt64 BUILDFLAGS_values[] = {maxon::UInt64(enum3062::BUILDFLAGS::NONE), maxon::UInt64(enum3062::BUILDFLAGS::INTERNALRENDERER), maxon::UInt64(enum3062::BUILDFLAGS::EXTERNALRENDERER), maxon::UInt64(enum3062::BUILDFLAGS::ISOPARM), maxon::UInt64(enum3062::BUILDFLAGS::EXPORTONLY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BUILDFLAGS3062(){ return enum3062::BUILDFLAGS_info; }
namespace enum3081
{
	...
	static const maxon::UInt64 EXECUTIONFLAGS_values[] = {maxon::UInt64(enum3081::EXECUTIONFLAGS::NONE), maxon::UInt64(enum3081::EXECUTIONFLAGS::ANIMATION), maxon::UInt64(enum3081::EXECUTIONFLAGS::EXPRESSION), maxon::UInt64(enum3081::EXECUTIONFLAGS::CACHEBUILDING), maxon::UInt64(enum3081::EXECUTIONFLAGS::CAMERAONLY), maxon::UInt64(enum3081::EXECUTIONFLAGS::INDRAG), maxon::UInt64(enum3081::EXECUTIONFLAGS::INMOVE), maxon::UInt64(enum3081::EXECUTIONFLAGS::RENDER), maxon::UInt64(enum3081::EXECUTIONFLAGS::ALLOW_PRIORITYSHIFT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_EXECUTIONFLAGS3081(){ return enum3081::EXECUTIONFLAGS_info; }
namespace enum3095
{
	...
	static const maxon::UInt64 SCENEHOOKDRAW_values[] = {maxon::UInt64(enum3095::SCENEHOOKDRAW::NONE), maxon::UInt64(enum3095::SCENEHOOKDRAW::DRAW_PASS), maxon::UInt64(enum3095::SCENEHOOKDRAW::HIGHLIGHT_PASS_BEFORE_TOOL), maxon::UInt64(enum3095::SCENEHOOKDRAW::HIGHLIGHT_PASS), maxon::UInt64(enum3095::SCENEHOOKDRAW::HIGHLIGHT_PASS_INV), maxon::UInt64(enum3095::SCENEHOOKDRAW::DRAW_PASS_AFTER_CLEAR)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SCENEHOOKDRAW3095(){ return enum3095::SCENEHOOKDRAW_info; }
namespace enum3115
{
	...
	static const maxon::UInt64 DESCFLAGS_DESC_values[] = {maxon::UInt64(enum3115::DESCFLAGS_DESC::NONE), maxon::UInt64(enum3115::DESCFLAGS_DESC::RESOLVEMULTIPLEDATA), maxon::UInt64(enum3115::DESCFLAGS_DESC::LOADED), maxon::UInt64(enum3115::DESCFLAGS_DESC::RECURSIONLOCK), maxon::UInt64(enum3115::DESCFLAGS_DESC::DONTLOADDEFAULT), maxon::UInt64(enum3115::DESCFLAGS_DESC::MAPTAGS), maxon::UInt64(enum3115::DESCFLAGS_DESC::NEEDDEFAULTVALUE), maxon::UInt64(enum3115::DESCFLAGS_DESC::TRISTATE), maxon::UInt64(enum3115::DESCFLAGS_DESC::EXPORTHELPSYMBOLSMODE), maxon::UInt64(enum3115::DESCFLAGS_DESC::MATREFLECTANCEOVERLAP), maxon::UInt64(enum3115::DESCFLAGS_DESC::XPRESSO)};
	static const maxon::EnumInfo DESCFLAGS_DESC_info{"DESCFLAGS_DESC", SIZEOF(DESCFLAGS_DESC), true, "NONE\0RESOLVEMULTIPLEDATA\0LOADED\0RECURSIONLOCK\0DONTLOADDEFAULT\0MAPTAGS\0NEEDDEFAULTVALUE\0TRISTATE\0EXPORTHELPSYMBOLSMODE\0MATREFLECTANCEOVERLAP\0XPRESSO\0", DESCFLAGS_DESC_values, std::extent<decltype(DESCFLAGS_DESC_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_DESCFLAGS_DESC3115(){ return enum3115::DESCFLAGS_DESC_info; }
namespace enum3129
{
	...
	static const maxon::UInt64 DESCFLAGS_GET_values[] = {maxon::UInt64(enum3129::DESCFLAGS_GET::NONE), maxon::UInt64(enum3129::DESCFLAGS_GET::PARAM_GET), maxon::UInt64(enum3129::DESCFLAGS_GET::NO_GLOBALDATA), maxon::UInt64(enum3129::DESCFLAGS_GET::NO_GEDATADEFAULTVALUE), maxon::UInt64(enum3129::DESCFLAGS_GET::ALLOW_TRISTATE)};
	static const maxon::EnumInfo DESCFLAGS_GET_info{"DESCFLAGS_GET", SIZEOF(DESCFLAGS_GET), true, "NONE\0PARAM_GET\0NO_GLOBALDATA\0NO_GEDATADEFAULTVALUE\0ALLOW_TRISTATE\0", DESCFLAGS_GET_values, std::extent<decltype(DESCFLAGS_GET_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_DESCFLAGS_GET3129(){ return enum3129::DESCFLAGS_GET_info; }
namespace enum3149
{
	...
	static const maxon::UInt64 DESCFLAGS_SET_values[] = {maxon::UInt64(enum3149::DESCFLAGS_SET::NONE), maxon::UInt64(enum3149::DESCFLAGS_SET::PARAM_SET), maxon::UInt64(enum3149::DESCFLAGS_SET::USERINTERACTION), maxon::UInt64(enum3149::DESCFLAGS_SET::DONTCHECKMINMAX), maxon::UInt64(enum3149::DESCFLAGS_SET::DONTAFFECTINHERITANCE), maxon::UInt64(enum3149::DESCFLAGS_SET::FORCESET), maxon::UInt64(enum3149::DESCFLAGS_SET::DONTFREESPLINECACHE), maxon::UInt64(enum3149::DESCFLAGS_SET::INDRAG), maxon::UInt64(enum3149::DESCFLAGS_SET::INRESETTODEFAULT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DESCFLAGS_SET3149(){ return enum3149::DESCFLAGS_SET_info; }
namespace enum3158
{
	...
	static const maxon::UInt64 DESCFLAGS_ENABLE_values[] = {maxon::UInt64(enum3158::DESCFLAGS_ENABLE::NONE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DESCFLAGS_ENABLE3158(){ return enum3158::DESCFLAGS_ENABLE_info; }
namespace enum3173
{
	...
	static const maxon::UInt64 HIERARCHYCLONEFLAGS_values[] = {maxon::UInt64(enum3173::HIERARCHYCLONEFLAGS::NONE), maxon::UInt64(enum3173::HIERARCHYCLONEFLAGS::ASIS), maxon::UInt64(enum3173::HIERARCHYCLONEFLAGS::ASPOLY), maxon::UInt64(enum3173::HIERARCHYCLONEFLAGS::ASLINE), maxon::UInt64(enum3173::HIERARCHYCLONEFLAGS::ASSPLINE), maxon::UInt64(enum3173::HIERARCHYCLONEFLAGS::ASVOLUME)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_HIERARCHYCLONEFLAGS3173(){ return enum3173::HIERARCHYCLONEFLAGS_info; }
namespace enum3188
{
	...
	static const maxon::UInt64 CHECKVALUEFORMAT_values[] = {maxon::UInt64(enum3188::CHECKVALUEFORMAT::NOTHING), maxon::UInt64(enum3188::CHECKVALUEFORMAT::DEGREE), maxon::UInt64(enum3188::CHECKVALUEFORMAT::PERCENT), maxon::UInt64(enum3188::CHECKVALUEFORMAT::METER), maxon::UInt64(enum3188::CHECKVALUEFORMAT::INT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CHECKVALUEFORMAT3188(){ return enum3188::CHECKVALUEFORMAT_info; }
namespace enum3207
{
	...
	static const maxon::UInt64 CHECKVALUERANGE_values[] = {maxon::UInt64(enum3207::CHECKVALUERANGE::GREATER), maxon::UInt64(enum3207::CHECKVALUERANGE::GREATEROREQUAL), maxon::UInt64(enum3207::CHECKVALUERANGE::LESS), maxon::UInt64(enum3207::CHECKVALUERANGE::LESSOREQUAL), maxon::UInt64(enum3207::CHECKVALUERANGE::BETWEEN), maxon::UInt64(enum3207::CHECKVALUERANGE::BETWEENOREQUAL), maxon::UInt64(enum3207::CHECKVALUERANGE::BETWEENOREQUALX), maxon::UInt64(enum3207::CHECKVALUERANGE::BETWEENOREQUALY), maxon::UInt64(enum3207::CHECKVALUERANGE::DIFFERENT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CHECKVALUERANGE3207(){ return enum3207::CHECKVALUERANGE_info; }
namespace enum3236
{
	...
	static const maxon::UInt64 PAINTMESHFLAGS_values[] = {maxon::UInt64(enum3236::PAINTMESHFLAGS::NONE), maxon::UInt64(enum3236::PAINTMESHFLAGS::QUAD), maxon::UInt64(enum3236::PAINTMESHFLAGS::SEL), maxon::UInt64(enum3236::PAINTMESHFLAGS::SELA), maxon::UInt64(enum3236::PAINTMESHFLAGS::SELB), maxon::UInt64(enum3236::PAINTMESHFLAGS::SELC), maxon::UInt64(enum3236::PAINTMESHFLAGS::SELD), maxon::UInt64(enum3236::PAINTMESHFLAGS::TA), maxon::UInt64(enum3236::PAINTMESHFLAGS::TB), maxon::UInt64(enum3236::PAINTMESHFLAGS::TC), maxon::UInt64(enum3236::PAINTMESHFLAGS::TD), maxon::UInt64(enum3236::PAINTMESHFLAGS::INACTIVE), maxon::UInt64(enum3236::PAINTMESHFLAGS::EDGEA), maxon::UInt64(enum3236::PAINTMESHFLAGS::EDGEB), maxon::UInt64(enum3236::PAINTMESHFLAGS::EDGEC), maxon::UInt64(enum3236::PAINTMESHFLAGS::EDGED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_PAINTMESHFLAGS3236(){ return enum3236::PAINTMESHFLAGS_info; }
namespace enum3250
{
	...
	static const maxon::UInt64 GETBRANCHINFO_values[] = {maxon::UInt64(enum3250::GETBRANCHINFO::NONE), maxon::UInt64(enum3250::GETBRANCHINFO::ONLYWITHCHILDREN), maxon::UInt64(enum3250::GETBRANCHINFO::GELISTNODES), maxon::UInt64(enum3250::GETBRANCHINFO::ONLYMODIFIABLE), maxon::UInt64(enum3250::GETBRANCHINFO::ONLYWITHANIMATION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GETBRANCHINFO3250(){ return enum3250::GETBRANCHINFO_info; }
namespace enum3263
{
	...
	static const maxon::UInt64 BRANCHINFOFLAGS_values[] = {maxon::UInt64(enum3263::BRANCHINFOFLAGS::NONE), maxon::UInt64(enum3263::BRANCHINFOFLAGS::ANIMATE), maxon::UInt64(enum3263::BRANCHINFOFLAGS::HIDEINTIMELINE), maxon::UInt64(enum3263::BRANCHINFOFLAGS::HASFIELDS)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BRANCHINFOFLAGS3263(){ return enum3263::BRANCHINFOFLAGS_info; }
namespace enum3275
{
	...
	static const maxon::UInt64 GETACTIVEOBJECTFLAGS_values[] = {maxon::UInt64(enum3275::GETACTIVEOBJECTFLAGS::NONE), maxon::UInt64(enum3275::GETACTIVEOBJECTFLAGS::CHILDREN), maxon::UInt64(enum3275::GETACTIVEOBJECTFLAGS::SELECTIONORDER)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GETACTIVEOBJECTFLAGS3275(){ return enum3275::GETACTIVEOBJECTFLAGS_info; }
namespace enum3288
{
	enum class DRAWPASS
	{
	...
	static const maxon::UInt64 DRAWPASS_values[] = {maxon::UInt64(enum3288::DRAWPASS::OBJECT), maxon::UInt64(enum3288::DRAWPASS::BOX), maxon::UInt64(enum3288::DRAWPASS::HANDLES), maxon::UInt64(enum3288::DRAWPASS::HIGHLIGHTS), maxon::UInt64(enum3288::DRAWPASS::XRAY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAWPASS3288(){ return enum3288::DRAWPASS_info; }
namespace enum3379
{
	...
	static const maxon::UInt64 SAVEPROJECT_values[] = {maxon::UInt64(enum3379::SAVEPROJECT::NONE), maxon::UInt64(enum3379::SAVEPROJECT::ASSETS), maxon::UInt64(enum3379::SAVEPROJECT::SCENEFILE), maxon::UInt64(enum3379::SAVEPROJECT::DIALOGSALLOWED), maxon::UInt64(enum3379::SAVEPROJECT::SHOWMISSINGASSETDIALOG), maxon::UInt64(enum3379::SAVEPROJECT::ADDTORECENTLIST), maxon::UInt64(enum3379::SAVEPROJECT::DONTCOPYFILES), maxon::UInt64(enum3379::SAVEPROJECT::PROGRESSALLOWED), maxon::UInt64(enum3379::SAVEPROJECT::DONTTOUCHDOCUMENT), maxon::UInt64(enum3379::SAVEPROJECT::DONTFAILONMISSINGASSETS), maxon::UInt64(enum3379::SAVEPROJECT::ISNET), maxon::UInt64(enum3379::SAVEPROJECT::USEDOCUMENTNAMEASFILENAME), maxon::UInt64(enum3379::SAVEPROJECT::DONTCLEARSUGGESTEDFOLDER), maxon::UInt64(enum3379::SAVEPROJECT::WITHCACHES), maxon::UInt64(enum3379::SAVEPROJECT::DONTGENERATEPAINTTEX), maxon::UInt64(enum3379::SAVEPROJECT::ASSETLINKS_COPY_FILEASSETS), maxon::UInt64(enum3379::SAVEPROJECT::ASSETLINKS_COPY_NODEASSETS)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SAVEPROJECT3379(){ return enum3379::SAVEPROJECT_info; }
namespace enum3391
{
	...
	static const maxon::UInt64 ICONDATAFLAGS_values[] = {maxon::UInt64(enum3391::ICONDATAFLAGS::NONE), maxon::UInt64(enum3391::ICONDATAFLAGS::APPLYCOLORPROFILE), maxon::UInt64(enum3391::ICONDATAFLAGS::DISABLED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ICONDATAFLAGS3391(){ return enum3391::ICONDATAFLAGS_info; }
namespace enum3406
{
	...
	static const maxon::UInt64 USERAREAFLAGS_values[] = {maxon::UInt64(enum3406::USERAREAFLAGS::NONE), maxon::UInt64(enum3406::USERAREAFLAGS::TABSTOP), maxon::UInt64(enum3406::USERAREAFLAGS::HANDLEFOCUS), maxon::UInt64(enum3406::USERAREAFLAGS::COREMESSAGE), maxon::UInt64(enum3406::USERAREAFLAGS::SYNCMESSAGE), maxon::UInt64(enum3406::USERAREAFLAGS::DONT_MIRROR)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_USERAREAFLAGS3406(){ return enum3406::USERAREAFLAGS_info; }
...
namespace enum3667
{
	...
	static const maxon::UInt64 EXECUTIONRESULT_values[] = {maxon::UInt64(enum3667::EXECUTIONRESULT::OK), maxon::UInt64(enum3667::EXECUTIONRESULT::USERBREAK), maxon::UInt64(enum3667::EXECUTIONRESULT::OUTOFMEMORY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_EXECUTIONRESULT3667(){ return enum3667::EXECUTIONRESULT_info; }
namespace enum3695
{
	...
	static const maxon::UInt64 IMAGERESULT_values[] = {maxon::UInt64(enum3695::IMAGERESULT::OK), maxon::UInt64(enum3695::IMAGERESULT::NOTEXISTING), maxon::UInt64(enum3695::IMAGERESULT::WRONGTYPE), maxon::UInt64(enum3695::IMAGERESULT::OUTOFMEMORY), maxon::UInt64(enum3695::IMAGERESULT::FILEERROR), maxon::UInt64(enum3695::IMAGERESULT::FILESTRUCTURE), maxon::UInt64(enum3695::IMAGERESULT::MISC_ERROR), maxon::UInt64(enum3695::IMAGERESULT::PARAM_ERROR), maxon::UInt64(enum3695::IMAGERESULT::THREADCANCELED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_IMAGERESULT3695(){ return enum3695::IMAGERESULT_info; }
namespace enum3710
{
	...
	static const maxon::UInt64 STRINGENCODING_values[] = {maxon::UInt64(enum3710::STRINGENCODING::XBIT), maxon::UInt64(enum3710::STRINGENCODING::BIT7), maxon::UInt64(enum3710::STRINGENCODING::BIT7HEX), maxon::UInt64(enum3710::STRINGENCODING::UTF8)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_STRINGENCODING3710(){ return enum3710::STRINGENCODING_info; }
namespace enum3721
{
	...
	static const maxon::UInt64 THREADMODE_values[] = {maxon::UInt64(enum3721::THREADMODE::DEPRECATED_SYNCHRONOUS), maxon::UInt64(enum3721::THREADMODE::ASYNC), maxon::UInt64(enum3721::THREADMODE::PRIVATE_OPENGL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_THREADMODE3721(){ return enum3721::THREADMODE_info; }
namespace enum3733
{
	...
	static const maxon::UInt64 THREADPRIORITYEX_values[] = {maxon::UInt64(enum3733::THREADPRIORITYEX::NORMAL), maxon::UInt64(enum3733::THREADPRIORITYEX::ABOVE), maxon::UInt64(enum3733::THREADPRIORITYEX::BELOW), maxon::UInt64(enum3733::THREADPRIORITYEX::LOWEST)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_THREADPRIORITYEX3733(){ return enum3733::THREADPRIORITYEX_info; }
namespace enum3748
{
	...
	static const maxon::UInt64 HYPERFILEARRAY_values[] = {maxon::UInt64(enum3748::HYPERFILEARRAY::CHAR), maxon::UInt64(enum3748::HYPERFILEARRAY::WORD), maxon::UInt64(enum3748::HYPERFILEARRAY::LONG), maxon::UInt64(enum3748::HYPERFILEARRAY::LLONG), maxon::UInt64(enum3748::HYPERFILEARRAY::SREAL), maxon::UInt64(enum3748::HYPERFILEARRAY::LREAL), maxon::UInt64(enum3748::HYPERFILEARRAY::REAL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_HYPERFILEARRAY3748(){ return enum3748::HYPERFILEARRAY_info; }
namespace enum3772
{
	...
	static const maxon::UInt64 FILEERROR_values[] = {maxon::UInt64(enum3772::FILEERROR::NONE), maxon::UInt64(enum3772::FILEERROR::OPEN), maxon::UInt64(enum3772::FILEERROR::CLOSE), maxon::UInt64(enum3772::FILEERROR::READ), maxon::UInt64(enum3772::FILEERROR::WRITE), maxon::UInt64(enum3772::FILEERROR::SEEK), maxon::UInt64(enum3772::FILEERROR::INVALID), maxon::UInt64(enum3772::FILEERROR::OUTOFMEMORY), maxon::UInt64(enum3772::FILEERROR::USERBREAK), maxon::UInt64(enum3772::FILEERROR::WRONG_VALUE), maxon::UInt64(enum3772::FILEERROR::CHUNK_NUMBER), maxon::UInt64(enum3772::FILEERROR::VALUE_NO_CHUNK), maxon::UInt64(enum3772::FILEERROR::FILEEND), maxon::UInt64(enum3772::FILEERROR::UNKNOWN_VALUE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILEERROR3772(){ return enum3772::FILEERROR_info; }
namespace enum3788
{
	enum class FILEOPEN
	{
	...
	static const maxon::UInt64 FILEOPEN_values[] = {maxon::UInt64(enum3788::FILEOPEN::APPEND), maxon::UInt64(enum3788::FILEOPEN::READ), maxon::UInt64(enum3788::FILEOPEN::WRITE), maxon::UInt64(enum3788::FILEOPEN::READWRITE), maxon::UInt64(enum3788::FILEOPEN::READ_NOCACHE), maxon::UInt64(enum3788::FILEOPEN::SHAREDREAD), maxon::UInt64(enum3788::FILEOPEN::SHAREDWRITE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILEOPEN3788(){ return enum3788::FILEOPEN_info; }
namespace enum3799
{
	enum class LOCATION
	{
	...
	static const maxon::UInt64 LOCATION_values[] = {maxon::UInt64(enum3799::LOCATION::DISK), maxon::UInt64(enum3799::LOCATION::IPCONNECTION), maxon::UInt64(enum3799::LOCATION::MEMORY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_LOCATION3799(){ return enum3799::LOCATION_info; }
namespace enum3809
{
	enum class FILESEEK
	{
	...
	static const maxon::UInt64 FILESEEK_values[] = {maxon::UInt64(enum3809::FILESEEK::START), maxon::UInt64(enum3809::FILESEEK::RELATIVE_)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILESEEK3809(){ return enum3809::FILESEEK_info; }
namespace enum3820
{
	...
	static const maxon::UInt64 FILEDIALOG_values[] = {maxon::UInt64(enum3820::FILEDIALOG::NONE), maxon::UInt64(enum3820::FILEDIALOG::ANY), maxon::UInt64(enum3820::FILEDIALOG::IGNOREOPEN)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILEDIALOG3820(){ return enum3820::FILEDIALOG_info; }
namespace enum3831
{
	...
	static const maxon::UInt64 FILESELECT_values[] = {maxon::UInt64(enum3831::FILESELECT::LOAD), maxon::UInt64(enum3831::FILESELECT::SAVE), maxon::UInt64(enum3831::FILESELECT::DIRECTORY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILESELECT3831(){ return enum3831::FILESELECT_info; }
namespace enum3843
{
	...
	static const maxon::UInt64 FILESELECTTYPE_values[] = {maxon::UInt64(enum3843::FILESELECTTYPE::ANYTHING), maxon::UInt64(enum3843::FILESELECTTYPE::IMAGES), maxon::UInt64(enum3843::FILESELECTTYPE::SCENES), maxon::UInt64(enum3843::FILESELECTTYPE::BODYPAINT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FILESELECTTYPE3843(){ return enum3843::FILESELECTTYPE_info; }
namespace enum3854
{
	...
	static const maxon::UInt64 OPERATINGSYSTEM_values[] = {maxon::UInt64(enum3854::OPERATINGSYSTEM::WIN), maxon::UInt64(enum3854::OPERATINGSYSTEM::OSX), maxon::UInt64(enum3854::OPERATINGSYSTEM::LINUX)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_OPERATINGSYSTEM3854(){ return enum3854::OPERATINGSYSTEM_info; }
namespace enum3865
{
	...
	static const maxon::UInt64 BYTEORDER_values[] = {maxon::UInt64(enum3865::BYTEORDER::V_MOTOROLA), maxon::UInt64(enum3865::BYTEORDER::V_INTEL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BYTEORDER3865(){ return enum3865::BYTEORDER_info; }
namespace enum3912
{
	...
	static const maxon::UInt64 HYPERFILEVALUE_values[] = {maxon::UInt64(enum3912::HYPERFILEVALUE::NONE), maxon::UInt64(enum3912::HYPERFILEVALUE::START), maxon::UInt64(enum3912::HYPERFILEVALUE::STOP), maxon::UInt64(enum3912::HYPERFILEVALUE::CSTOP), maxon::UInt64(enum3912::HYPERFILEVALUE::CHAR), maxon::UInt64(enum3912::HYPERFILEVALUE::UCHAR), maxon::UInt64(enum3912::HYPERFILEVALUE::INT16), maxon::UInt64(enum3912::HYPERFILEVALUE::UINT16), maxon::UInt64(enum3912::HYPERFILEVALUE::INT32), maxon::UInt64(enum3912::HYPERFILEVALUE::UINT32), maxon::UInt64(enum3912::HYPERFILEVALUE::INT64), maxon::UInt64(enum3912::HYPERFILEVALUE::UINT64), maxon::UInt64(enum3912::HYPERFILEVALUE::FLOAT), maxon::UInt64(enum3912::HYPERFILEVALUE::FLOAT64), maxon::UInt64(enum3912::HYPERFILEVALUE::BOOLEAN), maxon::UInt64(enum3912::HYPERFILEVALUE::TIME), maxon::UInt64(enum3912::HYPERFILEVALUE::VECTOR), maxon::UInt64(enum3912::HYPERFILEVALUE::VECTOR64), maxon::UInt64(enum3912::HYPERFILEVALUE::MATRIX), maxon::UInt64(enum3912::HYPERFILEVALUE::MATRIX64), maxon::UInt64(enum3912::HYPERFILEVALUE::VECTOR32), maxon::UInt64(enum3912::HYPERFILEVALUE::MATRIX32), maxon::UInt64(enum3912::HYPERFILEVALUE::FLOAT32), maxon::UInt64(enum3912::HYPERFILEVALUE::MEMORY), maxon::UInt64(enum3912::HYPERFILEVALUE::IMAGE), maxon::UInt64(enum3912::HYPERFILEVALUE::STRING), maxon::UInt64(enum3912::HYPERFILEVALUE::FILENAME), maxon::UInt64(enum3912::HYPERFILEVALUE::CONTAINER), maxon::UInt64(enum3912::HYPERFILEVALUE::ALIASLINK), maxon::UInt64(enum3912::HYPERFILEVALUE::LMEMORY), maxon::UInt64(enum3912::HYPERFILEVALUE::VECTOR_ARRAY_EX), maxon::UInt64(enum3912::HYPERFILEVALUE::POLYGON_ARRAY_EX), maxon::UInt64(enum3912::HYPERFILEVALUE::UINT16_ARRAY_EX), maxon::UInt64(enum3912::HYPERFILEVALUE::PARTICLE_ARRAY_EX), maxon::UInt64(enum3912::HYPERFILEVALUE::SREAL_ARRAY_EX), maxon::UInt64(enum3912::HYPERFILEVALUE::ARRAY), maxon::UInt64(enum3912::HYPERFILEVALUE::UUID)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_HYPERFILEVALUE3912(){ return enum3912::HYPERFILEVALUE_info; }
namespace enum3923
{
	enum class FINDANIM
	{
	...
	static const maxon::UInt64 FINDANIM_values[] = {maxon::UInt64(enum3923::FINDANIM::EXACT), maxon::UInt64(enum3923::FINDANIM::LEFT), maxon::UInt64(enum3923::FINDANIM::RIGHT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FINDANIM3923(){ return enum3923::FINDANIM_info; }
namespace enum3945
{
	enum class CCURVE
	{
	...
	static const maxon::UInt64 CCURVE_values[] = {maxon::UInt64(enum3945::CCURVE::CURVE), maxon::UInt64(enum3945::CCURVE::HLE_BASE), maxon::UInt64(enum3945::CCURVE::HLE_CURVE), maxon::UInt64(enum3945::CCURVE::SS_CURVE), maxon::UInt64(enum3945::CCURVE::SS_CURVE2), maxon::UInt64(enum3945::CCURVE::SS_CURVE3), maxon::UInt64(enum3945::CCURVE::SS_CURVE4), maxon::UInt64(enum3945::CCURVE::SS_CURVE5), maxon::UInt64(enum3945::CCURVE::HLE_SCALE), maxon::UInt64(enum3945::CCURVE::HLE_MOVE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CCURVE3945(){ return enum3945::CCURVE_info; }
namespace enum3960
{
	enum class CLOOP
	{
	...
	static const maxon::UInt64 CLOOP_values[] = {maxon::UInt64(enum3960::CLOOP::OFF), maxon::UInt64(enum3960::CLOOP::CONSTANT), maxon::UInt64(enum3960::CLOOP::CONTINUE), maxon::UInt64(enum3960::CLOOP::REPEAT), maxon::UInt64(enum3960::CLOOP::OFFSETREPEAT), maxon::UInt64(enum3960::CLOOP::OSCILLATE), maxon::UInt64(enum3960::CLOOP::LOOP)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CLOOP3960(){ return enum3960::CLOOP_info; }
namespace enum3973
{
	...
	static const maxon::UInt64 CINTERPOLATION_values[] = {maxon::UInt64(enum3973::CINTERPOLATION::SPLINE), maxon::UInt64(enum3973::CINTERPOLATION::LINEAR), maxon::UInt64(enum3973::CINTERPOLATION::STEP), maxon::UInt64(enum3973::CINTERPOLATION::DUMMY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CINTERPOLATION3973(){ return enum3973::CINTERPOLATION_info; }
namespace enum3984
{
	...
	static const maxon::UInt64 CAUTOMODE_values[] = {maxon::UInt64(enum3984::CAUTOMODE::CLASSIC), maxon::UInt64(enum3984::CAUTOMODE::FIXEDSLOPE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CAUTOMODE3984(){ return enum3984::CAUTOMODE_info; }
namespace enum3998
{
	...
	static const maxon::UInt64 CKEYPRESET_values[] = {maxon::UInt64(enum3998::CKEYPRESET::AUTO_CLAMP), maxon::UInt64(enum3998::CKEYPRESET::AUTO_OVERSHOOT), maxon::UInt64(enum3998::CKEYPRESET::FIXED_OVERSHOOTWEIGHTED), maxon::UInt64(enum3998::CKEYPRESET::CUSTOM), maxon::UInt64(enum3998::CKEYPRESET::AUTO_OVERSHOOTWEIGHTED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CKEYPRESET3998(){ return enum3998::CKEYPRESET_info; }
namespace enum4009
{
	...
	static const maxon::UInt64 CLIPBOARDTYPE_values[] = {maxon::UInt64(enum4009::CLIPBOARDTYPE::EMPTY), maxon::UInt64(enum4009::CLIPBOARDTYPE::STRING), maxon::UInt64(enum4009::CLIPBOARDTYPE::BITMAP)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CLIPBOARDTYPE4009(){ return enum4009::CLIPBOARDTYPE_info; }
namespace enum4021
{
	...
	static const maxon::UInt64 EDGESELECTIONTYPE_values[] = {maxon::UInt64(enum4021::EDGESELECTIONTYPE::SELECTION), maxon::UInt64(enum4021::EDGESELECTIONTYPE::HIDDEN), maxon::UInt64(enum4021::EDGESELECTIONTYPE::PHONG)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_EDGESELECTIONTYPE4021(){ return enum4021::EDGESELECTIONTYPE_info; }
namespace enum4059
{
	...
	static const maxon::UInt64 REGISTRYTYPE_values[] = {maxon::UInt64(enum4059::REGISTRYTYPE::ANY), maxon::UInt64(enum4059::REGISTRYTYPE::WINDOW), maxon::UInt64(enum4059::REGISTRYTYPE::OBJECT), maxon::UInt64(enum4059::REGISTRYTYPE::TAG), maxon::UInt64(enum4059::REGISTRYTYPE::MATERIAL), maxon::UInt64(enum4059::REGISTRYTYPE::SHADER), maxon::UInt64(enum4059::REGISTRYTYPE::SOUND), maxon::UInt64(enum4059::REGISTRYTYPE::LAYOUT), maxon::UInt64(enum4059::REGISTRYTYPE::BITMAPFILTER), maxon::UInt64(enum4059::REGISTRYTYPE::VIDEOPOST), maxon::UInt64(enum4059::REGISTRYTYPE::SCENEHOOK), maxon::UInt64(enum4059::REGISTRYTYPE::NODE), maxon::UInt64(enum4059::REGISTRYTYPE::DESCRIPTION), maxon::UInt64(enum4059::REGISTRYTYPE::LIBRARY), maxon::UInt64(enum4059::REGISTRYTYPE::CUSTOMDATATYPE), maxon::UInt64(enum4059::REGISTRYTYPE::RESOURCEDATATYPE), maxon::UInt64(enum4059::REGISTRYTYPE::SCENELOADER), maxon::UInt64(enum4059::REGISTRYTYPE::SCENESAVER), maxon::UInt64(enum4059::REGISTRYTYPE::CTRACK), maxon::UInt64(enum4059::REGISTRYTYPE::CSEQ), maxon::UInt64(enum4059::REGISTRYTYPE::CKEY), maxon::UInt64(enum4059::REGISTRYTYPE::PAINTER), maxon::UInt64(enum4059::REGISTRYTYPE::GV_VALUE), maxon::UInt64(enum4059::REGISTRYTYPE::GV_VALGROUP), maxon::UInt64(enum4059::REGISTRYTYPE::GV_OPGROUP), maxon::UInt64(enum4059::REGISTRYTYPE::GV_OPCLASS), maxon::UInt64(enum4059::REGISTRYTYPE::GV_DATA), maxon::UInt64(enum4059::REGISTRYTYPE::GADGETS), maxon::UInt64(enum4059::REGISTRYTYPE::PREFS), maxon::UInt64(enum4059::REGISTRYTYPE::FIELDLAYER)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_REGISTRYTYPE4059(){ return enum4059::REGISTRYTYPE_info; }
namespace enum4071
{
	...
	static const maxon::UInt64 MODELINGCOMMANDMODE_values[] = {maxon::UInt64(enum4071::MODELINGCOMMANDMODE::ALL), maxon::UInt64(enum4071::MODELINGCOMMANDMODE::POINTSELECTION), maxon::UInt64(enum4071::MODELINGCOMMANDMODE::POLYGONSELECTION), maxon::UInt64(enum4071::MODELINGCOMMANDMODE::EDGESELECTION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MODELINGCOMMANDMODE4071(){ return enum4071::MODELINGCOMMANDMODE_info; }
namespace enum4082
{
	...
	static const maxon::UInt64 MODELINGCOMMANDFLAGS_values[] = {maxon::UInt64(enum4082::MODELINGCOMMANDFLAGS::NONE), maxon::UInt64(enum4082::MODELINGCOMMANDFLAGS::CREATEUNDO), maxon::UInt64(enum4082::MODELINGCOMMANDFLAGS::IMPORTER)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MODELINGCOMMANDFLAGS4082(){ return enum4082::MODELINGCOMMANDFLAGS_info; }
namespace enum4118
{
	...
	static const maxon::UInt64 PLUGINTYPE_values[] = {maxon::UInt64(enum4118::PLUGINTYPE::ANY), maxon::UInt64(enum4118::PLUGINTYPE::SHADER), maxon::UInt64(enum4118::PLUGINTYPE::MATERIAL), maxon::UInt64(enum4118::PLUGINTYPE::COMMAND), maxon::UInt64(enum4118::PLUGINTYPE::OBJECT), maxon::UInt64(enum4118::PLUGINTYPE::TAG), maxon::UInt64(enum4118::PLUGINTYPE::BITMAPFILTER), maxon::UInt64(enum4118::PLUGINTYPE::VIDEOPOST), maxon::UInt64(enum4118::PLUGINTYPE::TOOL), maxon::UInt64(enum4118::PLUGINTYPE::SCENEHOOK), maxon::UInt64(enum4118::PLUGINTYPE::NODE), maxon::UInt64(enum4118::PLUGINTYPE::LIBRARY), maxon::UInt64(enum4118::PLUGINTYPE::BITMAPLOADER), maxon::UInt64(enum4118::PLUGINTYPE::BITMAPSAVER), maxon::UInt64(enum4118::PLUGINTYPE::SCENELOADER), maxon::UInt64(enum4118::PLUGINTYPE::SCENESAVER), maxon::UInt64(enum4118::PLUGINTYPE::COREMESSAGE), maxon::UInt64(enum4118::PLUGINTYPE::CUSTOMGUI), maxon::UInt64(enum4118::PLUGINTYPE::CUSTOMDATATYPE), maxon::UInt64(enum4118::PLUGINTYPE::RESOURCEDATATYPE), maxon::UInt64(enum4118::PLUGINTYPE::MANAGERINFORMATION), maxon::UInt64(enum4118::PLUGINTYPE::CTRACK), maxon::UInt64(enum4118::PLUGINTYPE::FALLOFF), maxon::UInt64(enum4118::PLUGINTYPE::VMAPTRANSFER), maxon::UInt64(enum4118::PLUGINTYPE::PREFS), maxon::UInt64(enum4118::PLUGINTYPE::SNAP), maxon::UInt64(enum4118::PLUGINTYPE::FIELDLAYER)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_PLUGINTYPE4118(){ return enum4118::PLUGINTYPE_info; }
namespace enum4129
{
	...
	static const maxon::UInt64 DRAWRESULT_values[] = {maxon::UInt64(enum4129::DRAWRESULT::FAILURE), maxon::UInt64(enum4129::DRAWRESULT::OK), maxon::UInt64(enum4129::DRAWRESULT::SKIP)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAWRESULT4129(){ return enum4129::DRAWRESULT_info; }
namespace enum4162
{
	...
	static const maxon::UInt64 DISPLAYMODE_values[] = {maxon::UInt64(enum4162::DISPLAYMODE::UNKNOWN), maxon::UInt64(enum4162::DISPLAYMODE::GOURAUD), maxon::UInt64(enum4162::DISPLAYMODE::QUICK), maxon::UInt64(enum4162::DISPLAYMODE::WIRE), maxon::UInt64(enum4162::DISPLAYMODE::ISOPARM), maxon::UInt64(enum4162::DISPLAYMODE::SHADEDBOX), maxon::UInt64(enum4162::DISPLAYMODE::BOX), maxon::UInt64(enum4162::DISPLAYMODE::SKELETON), maxon::UInt64(enum4162::DISPLAYMODE::GOURAUDWIRE), maxon::UInt64(enum4162::DISPLAYMODE::GOURAUDISOPARM), maxon::UInt64(enum4162::DISPLAYMODE::QUICKWIRE), maxon::UInt64(enum4162::DISPLAYMODE::QUICKISOPARM), maxon::UInt64(enum4162::DISPLAYMODE::FLATWIRE), maxon::UInt64(enum4162::DISPLAYMODE::FLATISOPARM), maxon::UInt64(enum4162::DISPLAYMODE::FLATBOX), maxon::UInt64(enum4162::DISPLAYMODE::HIDDENWIRE), maxon::UInt64(enum4162::DISPLAYMODE::HIDDENISOPARM), maxon::UInt64(enum4162::DISPLAYMODE::HIDDENBOX), maxon::UInt64(enum4162::DISPLAYMODE::SHADEDBOXWIRE), maxon::UInt64(enum4162::DISPLAYMODE::QUICKBOXWIRE), maxon::UInt64(enum4162::DISPLAYMODE::QUICKBOX), maxon::UInt64(enum4162::DISPLAYMODE::PRIVATE_ISOLINE), maxon::UInt64(enum4162::DISPLAYMODE::PRIVATE_FLAT), maxon::UInt64(enum4162::DISPLAYMODE::PRIVATE_HIDDEN)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DISPLAYMODE4162(){ return enum4162::DISPLAYMODE_info; }
namespace enum4178
{
	...
	static const maxon::UInt64 DOCUMENTSETTINGS_values[] = {maxon::UInt64(enum4178::DOCUMENTSETTINGS::GENERAL), maxon::UInt64(enum4178::DOCUMENTSETTINGS::MODELING), maxon::UInt64(enum4178::DOCUMENTSETTINGS::DOCUMENT), maxon::UInt64(enum4178::DOCUMENTSETTINGS::ANIMATIONSYSTEM), maxon::UInt64(enum4178::DOCUMENTSETTINGS::TOOLS)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DOCUMENTSETTINGS4178(){ return enum4178::DOCUMENTSETTINGS_info; }
namespace enum4203
{
	...
	static const maxon::UInt64 VERSIONTYPE_values[] = {maxon::UInt64(enum4203::VERSIONTYPE::UNKNOWN), maxon::UInt64(enum4203::VERSIONTYPE::LITE), maxon::UInt64(enum4203::VERSIONTYPE::BENCHMARK), maxon::UInt64(enum4203::VERSIONTYPE::UPDATER), maxon::UInt64(enum4203::VERSIONTYPE::TEAMRENDER_CLIENT), maxon::UInt64(enum4203::VERSIONTYPE::TEAMRENDER_SERVER), maxon::UInt64(enum4203::VERSIONTYPE::CINEMA4D), maxon::UInt64(enum4203::VERSIONTYPE::COMMANDLINE), maxon::UInt64(enum4203::VERSIONTYPE::CINEWARE), maxon::UInt64(enum4203::VERSIONTYPE::CPYTHON), maxon::UInt64(enum4203::VERSIONTYPE::CPYTHON3)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VERSIONTYPE4203(){ return enum4203::VERSIONTYPE_info; }
namespace enum4216
{
	...
	static const maxon::UInt64 LAYERSETMODE_values[] = {maxon::UInt64(enum4216::LAYERSETMODE::LAYERS), maxon::UInt64(enum4216::LAYERSETMODE::LAYERMASKS), maxon::UInt64(enum4216::LAYERSETMODE::ALPHAS), maxon::UInt64(enum4216::LAYERSETMODE::LAYERALPHA), maxon::UInt64(enum4216::LAYERSETMODE::DISABLED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_LAYERSETMODE4216(){ return enum4216::LAYERSETMODE_info; }
namespace enum4263
{
	...
	static const maxon::UInt64 OBJECTCATEGORY_values[] = {maxon::UInt64(enum4263::OBJECTCATEGORY::NULLOBJECT), maxon::UInt64(enum4263::OBJECTCATEGORY::POLYGON), maxon::UInt64(enum4263::OBJECTCATEGORY::SPLINE), maxon::UInt64(enum4263::OBJECTCATEGORY::GENERATOR), maxon::UInt64(enum4263::OBJECTCATEGORY::HYPERNURBS), maxon::UInt64(enum4263::OBJECTCATEGORY::UNUSED1), maxon::UInt64(enum4263::OBJECTCATEGORY::DEFORMER), maxon::UInt64(enum4263::OBJECTCATEGORY::CAMERA), maxon::UInt64(enum4263::OBJECTCATEGORY::LIGHT), maxon::UInt64(enum4263::OBJECTCATEGORY::SCENE), maxon::UInt64(enum4263::OBJECTCATEGORY::PARTICLE), maxon::UInt64(enum4263::OBJECTCATEGORY::OTHER), maxon::UInt64(enum4263::OBJECTCATEGORY::UNUSED2), maxon::UInt64(enum4263::OBJECTCATEGORY::GRID), maxon::UInt64(enum4263::OBJECTCATEGORY::HORIZON), maxon::UInt64(enum4263::OBJECTCATEGORY::WORLDAXIS), maxon::UInt64(enum4263::OBJECTCATEGORY::BOUNDS), maxon::UInt64(enum4263::OBJECTCATEGORY::HUD), maxon::UInt64(enum4263::OBJECTCATEGORY::SDS), maxon::UInt64(enum4263::OBJECTCATEGORY::HIGHLIGHTING), maxon::UInt64(enum4263::OBJECTCATEGORY::MULTIAXIS), maxon::UInt64(enum4263::OBJECTCATEGORY::OBJECTHANDLES), maxon::UInt64(enum4263::OBJECTCATEGORY::HANDLEBANDS), maxon::UInt64(enum4263::OBJECTCATEGORY::SDSCAGE), maxon::UInt64(enum4263::OBJECTCATEGORY::NGONLINES), maxon::UInt64(enum4263::OBJECTCATEGORY::JOINT), maxon::UInt64(enum4263::OBJECTCATEGORY::OBJECTHIGHLIGHTING), maxon::UInt64(enum4263::OBJECTCATEGORY::GUIDELINES), maxon::UInt64(enum4263::OBJECTCATEGORY::POI), maxon::UInt64(enum4263::OBJECTCATEGORY::GRADIENT), maxon::UInt64(enum4263::OBJECTCATEGORY::BASEGRID), maxon::UInt64(enum4263::OBJECTCATEGORY::HANDLES), maxon::UInt64(enum4263::OBJECTCATEGORY::HAIR), maxon::UInt64(enum4263::OBJECTCATEGORY::FIELD)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_OBJECTCATEGORY4263(){ return enum4263::OBJECTCATEGORY_info; }
namespace enum4284
{
	...
	static const maxon::UInt64 SELECTIONFILTERBIT_values[] = {maxon::UInt64(enum4284::SELECTIONFILTERBIT::NONE), maxon::UInt64(enum4284::SELECTIONFILTERBIT::NULLOBJECT), maxon::UInt64(enum4284::SELECTIONFILTERBIT::POLYGON), maxon::UInt64(enum4284::SELECTIONFILTERBIT::SPLINE), maxon::UInt64(enum4284::SELECTIONFILTERBIT::GENERATOR), maxon::UInt64(enum4284::SELECTIONFILTERBIT::HYPERNURBS), maxon::UInt64(enum4284::SELECTIONFILTERBIT::DEFORMER), maxon::UInt64(enum4284::SELECTIONFILTERBIT::CAMERA), maxon::UInt64(enum4284::SELECTIONFILTERBIT::LIGHT), maxon::UInt64(enum4284::SELECTIONFILTERBIT::SCENE), maxon::UInt64(enum4284::SELECTIONFILTERBIT::PARTICLE), maxon::UInt64(enum4284::SELECTIONFILTERBIT::OTHER), maxon::UInt64(enum4284::SELECTIONFILTERBIT::JOINT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SELECTIONFILTERBIT4284(){ return enum4284::SELECTIONFILTERBIT_info; }
namespace enum4298
{
	...
	static const maxon::UInt64 OBJECTSTATE_values[] = {maxon::UInt64(enum4298::OBJECTSTATE::EDITOR), maxon::UInt64(enum4298::OBJECTSTATE::RENDER), maxon::UInt64(enum4298::OBJECTSTATE::DEFORM), maxon::UInt64(enum4298::OBJECTSTATE::REAL_DEFORM), maxon::UInt64(enum4298::OBJECTSTATE::EDITOR_HIERARCHICAL), maxon::UInt64(enum4298::OBJECTSTATE::RENDER_HIERARCHICAL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_OBJECTSTATE4298(){ return enum4298::OBJECTSTATE_info; }
namespace enum4343
{
	...
	static const maxon::UInt64 DISPLAYFILTER_values[] = {maxon::UInt64(enum4343::DISPLAYFILTER::NONE), maxon::UInt64(enum4343::DISPLAYFILTER::NULLOBJECT), maxon::UInt64(enum4343::DISPLAYFILTER::POLYGON), maxon::UInt64(enum4343::DISPLAYFILTER::SPLINE), maxon::UInt64(enum4343::DISPLAYFILTER::GENERATOR), maxon::UInt64(enum4343::DISPLAYFILTER::HYPERNURBS), maxon::UInt64(enum4343::DISPLAYFILTER::UNUSED1), maxon::UInt64(enum4343::DISPLAYFILTER::DEFORMER), maxon::UInt64(enum4343::DISPLAYFILTER::CAMERA), maxon::UInt64(enum4343::DISPLAYFILTER::LIGHT), maxon::UInt64(enum4343::DISPLAYFILTER::SCENE), maxon::UInt64(enum4343::DISPLAYFILTER::PARTICLE), maxon::UInt64(enum4343::DISPLAYFILTER::OTHER), maxon::UInt64(enum4343::DISPLAYFILTER::UNUSED2), maxon::UInt64(enum4343::DISPLAYFILTER::GRID), maxon::UInt64(enum4343::DISPLAYFILTER::HORIZON), maxon::UInt64(enum4343::DISPLAYFILTER::WORLDAXIS), maxon::UInt64(enum4343::DISPLAYFILTER::BOUNDS), maxon::UInt64(enum4343::DISPLAYFILTER::HUD), maxon::UInt64(enum4343::DISPLAYFILTER::SDS), maxon::UInt64(enum4343::DISPLAYFILTER::HIGHLIGHTING), maxon::UInt64(enum4343::DISPLAYFILTER::MULTIAXIS), maxon::UInt64(enum4343::DISPLAYFILTER::OBJECTHANDLES), maxon::UInt64(enum4343::DISPLAYFILTER::HANDLEBANDS), maxon::UInt64(enum4343::DISPLAYFILTER::SDSCAGE), maxon::UInt64(enum4343::DISPLAYFILTER::NGONLINES), maxon::UInt64(enum4343::DISPLAYFILTER::JOINT), maxon::UInt64(enum4343::DISPLAYFILTER::OBJECTHIGHLIGHTING), maxon::UInt64(enum4343::DISPLAYFILTER::GUIDELINES), maxon::UInt64(enum4343::DISPLAYFILTER::POI), maxon::UInt64(enum4343::DISPLAYFILTER::GRADIENT), maxon::UInt64(enum4343::DISPLAYFILTER::BASEGRID), maxon::UInt64(enum4343::DISPLAYFILTER::HANDLES), maxon::UInt64(enum4343::DISPLAYFILTER::HAIR), maxon::UInt64(enum4343::DISPLAYFILTER::FIELD)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DISPLAYFILTER4343(){ return enum4343::DISPLAYFILTER_info; }
namespace enum4357
{
	...
	static const maxon::UInt64 DISPLAYEDITSTATE_values[] = {maxon::UInt64(enum4357::DISPLAYEDITSTATE::NONE), maxon::UInt64(enum4357::DISPLAYEDITSTATE::SDS), maxon::UInt64(enum4357::DISPLAYEDITSTATE::DEFORM), maxon::UInt64(enum4357::DISPLAYEDITSTATE::DOCUMENT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DISPLAYEDITSTATE4357(){ return enum4357::DISPLAYEDITSTATE_info; }
namespace enum4369
{
	...
	static const maxon::UInt64 THREADTYPE_values[] = {maxon::UInt64(enum4369::THREADTYPE::NONE), maxon::UInt64(enum4369::THREADTYPE::EDITORREDRAW), maxon::UInt64(enum4369::THREADTYPE::RENDEREDITOR), maxon::UInt64(enum4369::THREADTYPE::RENDEREXTERNAL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_THREADTYPE4369(){ return enum4369::THREADTYPE_info; }
namespace enum4383
{
	...
	static const maxon::UInt64 RENDERPROGRESSTYPE_values[] = {maxon::UInt64(enum4383::RENDERPROGRESSTYPE::BEFORERENDERING), maxon::UInt64(enum4383::RENDERPROGRESSTYPE::DURINGRENDERING), maxon::UInt64(enum4383::RENDERPROGRESSTYPE::AFTERRENDERING), maxon::UInt64(enum4383::RENDERPROGRESSTYPE::GLOBALILLUMINATION), maxon::UInt64(enum4383::RENDERPROGRESSTYPE::QUICK_PREVIEW), maxon::UInt64(enum4383::RENDERPROGRESSTYPE::AMBIENTOCCLUSION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RENDERPROGRESSTYPE4383(){ return enum4383::RENDERPROGRESSTYPE_info; }
namespace enum4394
{
	...
	static const maxon::UInt64 RDATA_SAVECALLBACK_CMD_values[] = {maxon::UInt64(enum4394::RDATA_SAVECALLBACK_CMD::OPEN), maxon::UInt64(enum4394::RDATA_SAVECALLBACK_CMD::WRITE), maxon::UInt64(enum4394::RDATA_SAVECALLBACK_CMD::CLOSE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RDATA_SAVECALLBACK_CMD4394(){ return enum4394::RDATA_SAVECALLBACK_CMD_info; }
namespace enum4408
{
	...
	static const maxon::UInt64 VPGETINFO_values[] = {maxon::UInt64(enum4408::VPGETINFO::XRESOLUTION), maxon::UInt64(enum4408::VPGETINFO::YRESOLUTION), maxon::UInt64(enum4408::VPGETINFO::BITDEPTH), maxon::UInt64(enum4408::VPGETINFO::CPP), maxon::UInt64(enum4408::VPGETINFO::VISIBLE), maxon::UInt64(enum4408::VPGETINFO::LINEOFFSET)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VPGETINFO4408(){ return enum4408::VPGETINFO_info; }
namespace enum4444
{
	...
	static const maxon::UInt64 DRAWOBJECT_values[] = {maxon::UInt64(enum4444::DRAWOBJECT::NONE), maxon::UInt64(enum4444::DRAWOBJECT::FORCELINES), maxon::UInt64(enum4444::DRAWOBJECT::NOBACKCULL), maxon::UInt64(enum4444::DRAWOBJECT::LOCALMATRIX), maxon::UInt64(enum4444::DRAWOBJECT::EDITMODE), maxon::UInt64(enum4444::DRAWOBJECT::FORCEBASE), maxon::UInt64(enum4444::DRAWOBJECT::FORCEPOINTS), maxon::UInt64(enum4444::DRAWOBJECT::NO_EOGL), maxon::UInt64(enum4444::DRAWOBJECT::USE_OBJECT_COLOR), maxon::UInt64(enum4444::DRAWOBJECT::USE_CUSTOM_COLOR), maxon::UInt64(enum4444::DRAWOBJECT::XRAY_ON), maxon::UInt64(enum4444::DRAWOBJECT::XRAY_OFF), maxon::UInt64(enum4444::DRAWOBJECT::IMMEDIATELY), maxon::UInt64(enum4444::DRAWOBJECT::Z_OFFSET), maxon::UInt64(enum4444::DRAWOBJECT::PRIVATE_ANY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DRAWOBJECT4444(){ return enum4444::DRAWOBJECT_info; }
namespace enum4467
{
	...
	static const maxon::UInt64 RENDERFLAGS_values[] = {maxon::UInt64(enum4467::RENDERFLAGS::NONE), maxon::UInt64(enum4467::RENDERFLAGS::EXTERNAL), maxon::UInt64(enum4467::RENDERFLAGS::NODOCUMENTCLONE), maxon::UInt64(enum4467::RENDERFLAGS::SHOWERRORS), maxon::UInt64(enum4467::RENDERFLAGS::PREVIEWRENDER), maxon::UInt64(enum4467::RENDERFLAGS::IRR), maxon::UInt64(enum4467::RENDERFLAGS::CREATE_PICTUREVIEWER), maxon::UInt64(enum4467::RENDERFLAGS::OPEN_PICTUREVIEWER), maxon::UInt64(enum4467::RENDERFLAGS::KEEP_CONTEXT), maxon::UInt64(enum4467::RENDERFLAGS::BATCHRENDER), maxon::UInt64(enum4467::RENDERFLAGS::NET), maxon::UInt64(enum4467::RENDERFLAGS::DONTANIMATE), maxon::UInt64(enum4467::RENDERFLAGS::PREVIEWSETTINGS), maxon::UInt64(enum4467::RENDERFLAGS::RENDERQUEUEERRORS), maxon::UInt64(enum4467::RENDERFLAGS::INTERNAL_SPECIAL_PREVIEW)};
	static const maxon::EnumInfo RENDERFLAGS_info{"RENDERFLAGS", SIZEOF(RENDERFLAGS), true, "NONE\0EXTERNAL\0NODOCUMENTCLONE\0SHOWERRORS\0PREVIEWRENDER\0IRR\0CREATE_PICTUREVIEWER\0OPEN_PICTUREVIEWER\0KEEP_CONTEXT\0BATCHRENDER\0NET\0DONTANIMATE\0PREVIEWSETTINGS\0RENDERQUEUEERRORS\0INTERNAL_SPECIAL_PREVIEW\0", RENDERFLAGS_values, std::extent<decltype(RENDERFLAGS_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_RENDERFLAGS4467(){ return enum4467::RENDERFLAGS_info; }
namespace enum4478
{
	...
	static const maxon::UInt64 WRITEMODE_values[] = {maxon::UInt64(enum4478::WRITEMODE::STANDARD), maxon::UInt64(enum4478::WRITEMODE::ASSEMBLE_MOVIE), maxon::UInt64(enum4478::WRITEMODE::ASSEMBLE_SINGLEIMAGE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_WRITEMODE4478(){ return enum4478::WRITEMODE_info; }
namespace enum4498
{
	...
	static const maxon::UInt64 NETRENDERFLAGS_values[] = {maxon::UInt64(enum4498::NETRENDERFLAGS::NONE), maxon::UInt64(enum4498::NETRENDERFLAGS::OPEN_PICTUREVIEWER), maxon::UInt64(enum4498::NETRENDERFLAGS::SHOWERRORS), maxon::UInt64(enum4498::NETRENDERFLAGS::DELETEAFTERRENDERING), maxon::UInt64(enum4498::NETRENDERFLAGS::NOPEERTOPEERASSETDISTRIBUTION), maxon::UInt64(enum4498::NETRENDERFLAGS::NOREQUESTONDEMAND), maxon::UInt64(enum4498::NETRENDERFLAGS::EXCLUDECLIENTONLOADINGERROR), maxon::UInt64(enum4498::NETRENDERFLAGS::SAVERESULTSINREPOSITORY), maxon::UInt64(enum4498::NETRENDERFLAGS::ASSEMBLEB3DFILESIMMEDIATLEY), maxon::UInt64(enum4498::NETRENDERFLAGS::NOWRITETEST), maxon::UInt64(enum4498::NETRENDERFLAGS::HANDLEWARNINGASERROR), maxon::UInt64(enum4498::NETRENDERFLAGS::KEEPB3DFILESAFTERASSEMBLING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_NETRENDERFLAGS4498(){ return enum4498::NETRENDERFLAGS_info; }
namespace enum4515
{
	...
	static const maxon::UInt64 CHECKISRUNNING_values[] = {maxon::UInt64(enum4515::CHECKISRUNNING::ANIMATIONRUNNING), maxon::UInt64(enum4515::CHECKISRUNNING::VIEWDRAWING), maxon::UInt64(enum4515::CHECKISRUNNING::EDITORRENDERING), maxon::UInt64(enum4515::CHECKISRUNNING::EXTERNALRENDERING), maxon::UInt64(enum4515::CHECKISRUNNING::PAINTERUPDATING), maxon::UInt64(enum4515::CHECKISRUNNING::MATERIALPREVIEWRUNNING), maxon::UInt64(enum4515::CHECKISRUNNING::EVENTSYSTEM), maxon::UInt64(enum4515::CHECKISRUNNING::BAKING), maxon::UInt64(enum4515::CHECKISRUNNING::INTERACTIVERENDERING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CHECKISRUNNING4515(){ return enum4515::CHECKISRUNNING_info; }
namespace enum4535
{
	...
	static const maxon::UInt64 BAKE_TEX_ERR_values[] = {maxon::UInt64(enum4535::BAKE_TEX_ERR::NONE), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_DOC), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_MEM), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_RENDER_DOC), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_TEXTURE_TAG), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_OBJECT), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_UVW_TAG), maxon::UInt64(enum4535::BAKE_TEX_ERR::TEXTURE_MISSING), maxon::UInt64(enum4535::BAKE_TEX_ERR::WRONG_BITMAP), maxon::UInt64(enum4535::BAKE_TEX_ERR::USERBREAK), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_OPTIMAL_MAPPING), maxon::UInt64(enum4535::BAKE_TEX_ERR::NO_SOURCE_UVW_TAG)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BAKE_TEX_ERR4535(){ return enum4535::BAKE_TEX_ERR_info; }
namespace enum4546
{
	...
	static const maxon::UInt64 GL_MESSAGE_values[] = {maxon::UInt64(enum4546::GL_MESSAGE::OK), maxon::UInt64(enum4546::GL_MESSAGE::ERROR_), maxon::UInt64(enum4546::GL_MESSAGE::FORCE_EMULATION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GL_MESSAGE4546(){ return enum4546::GL_MESSAGE_info; }
namespace enum4563
{
	...
	static const maxon::UInt64 VIEWPORT_PICK_FLAGS_values[] = {maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::NONE), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::ALLOW_OGL), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::DONT_STOP_THREADS), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::USE_SEL_FILTER), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::OGL_ONLY_TOPMOST), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::OGL_ONLY_VISIBLE), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::OGL_IGNORE_Z), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::OGL_ONLY_TOPMOST_WITH_OBJ), maxon::UInt64(enum4563::VIEWPORT_PICK_FLAGS::NO_DEPTH_CORRECTION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VIEWPORT_PICK_FLAGS4563(){ return enum4563::VIEWPORT_PICK_FLAGS_info; }
namespace enum4603
{
	...
	static const maxon::UInt64 BACKGROUNDHANDLERCOMMAND_values[] = {maxon::UInt64(enum4603::BACKGROUNDHANDLERCOMMAND::ISRUNNING), maxon::UInt64(enum4603::BACKGROUNDHANDLERCOMMAND::STOP), maxon::UInt64(enum4603::BACKGROUNDHANDLERCOMMAND::START), maxon::UInt64(enum4603::BACKGROUNDHANDLERCOMMAND::REMOVE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BACKGROUNDHANDLERCOMMAND4603(){ return enum4603::BACKGROUNDHANDLERCOMMAND_info; }
namespace enum4629
{
	...
	static const maxon::UInt64 BACKGROUNDHANDLERFLAGS_values[] = {maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::NONE), maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::VIEWREDRAW), maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::EDITORRENDDER), maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::MATERIALPREVIEW), maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::RENDEREXTERNAL), maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::PRIVATE_VIEWREDRAW), maxon::UInt64(enum4629::BACKGROUNDHANDLERFLAGS::SHUTDOWN)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BACKGROUNDHANDLERFLAGS4629(){ return enum4629::BACKGROUNDHANDLERFLAGS_info; }
namespace enum4652
{
	...
	static const maxon::UInt64 IDENTIFYFILE_values[] = {maxon::UInt64(enum4652::IDENTIFYFILE::NONE), maxon::UInt64(enum4652::IDENTIFYFILE::SCENE), maxon::UInt64(enum4652::IDENTIFYFILE::IMAGE), maxon::UInt64(enum4652::IDENTIFYFILE::MOVIE), maxon::UInt64(enum4652::IDENTIFYFILE::SKIPQUICKTIME), maxon::UInt64(enum4652::IDENTIFYFILE::SCRIPT), maxon::UInt64(enum4652::IDENTIFYFILE::SOUND), maxon::UInt64(enum4652::IDENTIFYFILE::LAYOUT), maxon::UInt64(enum4652::IDENTIFYFILE::PYTHON)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_IDENTIFYFILE4652(){ return enum4652::IDENTIFYFILE_info; }
namespace enum4664
{
	...
	static const maxon::UInt64 CALCHARDSHADOW_values[] = {maxon::UInt64(enum4664::CALCHARDSHADOW::NONE), maxon::UInt64(enum4664::CALCHARDSHADOW::TRANSPARENCY), maxon::UInt64(enum4664::CALCHARDSHADOW::SPECIALGISHADOW), maxon::UInt64(enum4664::CALCHARDSHADOW::SPECIALSELFSHADOW)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CALCHARDSHADOW4664(){ return enum4664::CALCHARDSHADOW_info; }
namespace enum4682
{
	...
	static const maxon::UInt64 ILLUMINATEFLAGS_values[] = {maxon::UInt64(enum4682::ILLUMINATEFLAGS::NONE), maxon::UInt64(enum4682::ILLUMINATEFLAGS::SHADOW), maxon::UInt64(enum4682::ILLUMINATEFLAGS::NOENVIRONMENT), maxon::UInt64(enum4682::ILLUMINATEFLAGS::DISABLESHADOWMAP_CORRECTION), maxon::UInt64(enum4682::ILLUMINATEFLAGS::DISABLESHADOWCASTERMP_CORRECTION), maxon::UInt64(enum4682::ILLUMINATEFLAGS::LIGHTDIRNORMALS), maxon::UInt64(enum4682::ILLUMINATEFLAGS::NODISTANCEFALLOFF), maxon::UInt64(enum4682::ILLUMINATEFLAGS::NOGRAIN), maxon::UInt64(enum4682::ILLUMINATEFLAGS::BACKLIGHT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ILLUMINATEFLAGS4682(){ return enum4682::ILLUMINATEFLAGS_info; }
namespace enum4710
{
	enum class RAYBIT
	{
	...
	static const maxon::UInt64 RAYBIT_values[] = {maxon::UInt64(enum4710::RAYBIT::NONE), maxon::UInt64(enum4710::RAYBIT::REFLECTION), maxon::UInt64(enum4710::RAYBIT::TRANSPARENCY), maxon::UInt64(enum4710::RAYBIT::REFRACTION), maxon::UInt64(enum4710::RAYBIT::CUSTOM), maxon::UInt64(enum4710::RAYBIT::CURR_REFLECTION), maxon::UInt64(enum4710::RAYBIT::CURR_TRANSPARENCY), maxon::UInt64(enum4710::RAYBIT::CURR_REFRACTION), maxon::UInt64(enum4710::RAYBIT::CURR_CUSTOM), maxon::UInt64(enum4710::RAYBIT::VOLUMETRICLIGHT), maxon::UInt64(enum4710::RAYBIT::ALLOWVLMIX), maxon::UInt64(enum4710::RAYBIT::GI), maxon::UInt64(enum4710::RAYBIT::BLURRY), maxon::UInt64(enum4710::RAYBIT::SSS), maxon::UInt64(enum4710::RAYBIT::AO), maxon::UInt64(enum4710::RAYBIT::COMPOSITING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RAYBIT4710(){ return enum4710::RAYBIT_info; }
namespace enum4734
{
	...
	static const maxon::UInt64 VOLUMEINFO_values[] = {maxon::UInt64(enum4734::VOLUMEINFO::NONE), maxon::UInt64(enum4734::VOLUMEINFO::REFLECTION), maxon::UInt64(enum4734::VOLUMEINFO::TRANSPARENCY), maxon::UInt64(enum4734::VOLUMEINFO::ALPHA), maxon::UInt64(enum4734::VOLUMEINFO::CHANGENORMAL), maxon::UInt64(enum4734::VOLUMEINFO::DISPLACEMENT), maxon::UInt64(enum4734::VOLUMEINFO::ENVREQUIRED), maxon::UInt64(enum4734::VOLUMEINFO::DUDVREQUIRED), maxon::UInt64(enum4734::VOLUMEINFO::MIPSAT), maxon::UInt64(enum4734::VOLUMEINFO::VOLUMETRIC), maxon::UInt64(enum4734::VOLUMEINFO::TRANSFORM), maxon::UInt64(enum4734::VOLUMEINFO::EVALUATEPROJECTION), maxon::UInt64(enum4734::VOLUMEINFO::PRIVATE_GLOW), maxon::UInt64(enum4734::VOLUMEINFO::INITCALCULATION), maxon::UInt64(enum4734::VOLUMEINFO::FINAL_ALPHA), maxon::UInt64(enum4734::VOLUMEINFO::ISNBMMATERIAL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VOLUMEINFO4734(){ return enum4734::VOLUMEINFO_info; }
namespace enum4759
{
	...
	static const maxon::UInt64 VIDEOPOSTINFO_values[] = {maxon::UInt64(enum4759::VIDEOPOSTINFO::NONE), maxon::UInt64(enum4759::VIDEOPOSTINFO::STOREFRAGMENTS), maxon::UInt64(enum4759::VIDEOPOSTINFO::EXECUTELINE), maxon::UInt64(enum4759::VIDEOPOSTINFO::EXECUTEPIXEL), maxon::UInt64(enum4759::VIDEOPOSTINFO::REQUEST_MOTIONMATRIX), maxon::UInt64(enum4759::VIDEOPOSTINFO::REQUEST_MOTIONGEOMETRY), maxon::UInt64(enum4759::VIDEOPOSTINFO::CALCVOLUMETRIC), maxon::UInt64(enum4759::VIDEOPOSTINFO::CALCSHADOW), maxon::UInt64(enum4759::VIDEOPOSTINFO::CUSTOMLENS), maxon::UInt64(enum4759::VIDEOPOSTINFO::GLOBALILLUMINATION), maxon::UInt64(enum4759::VIDEOPOSTINFO::CAUSTICS), maxon::UInt64(enum4759::VIDEOPOSTINFO::CUSTOMLENS_EXTENDED), maxon::UInt64(enum4759::VIDEOPOSTINFO::NETFRAME), maxon::UInt64(enum4759::VIDEOPOSTINFO::NETRUNONSERVER), maxon::UInt64(enum4759::VIDEOPOSTINFO::NETCREATEBUFFER), maxon::UInt64(enum4759::VIDEOPOSTINFO::NETCREATEBUFFER_MULTI), maxon::UInt64(enum4759::VIDEOPOSTINFO::REQUEST_MOTIONFULL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VIDEOPOSTINFO4759(){ return enum4759::VIDEOPOSTINFO_info; }
namespace enum4776
{
	...
	static const maxon::UInt64 SHADERINFO_values[] = {maxon::UInt64(enum4776::SHADERINFO::NONE), maxon::UInt64(enum4776::SHADERINFO::TRANSFORM), maxon::UInt64(enum4776::SHADERINFO::BUMP_SUPPORT), maxon::UInt64(enum4776::SHADERINFO::ALPHA_SUPPORT), maxon::UInt64(enum4776::SHADERINFO::REFLECTIONS), maxon::UInt64(enum4776::SHADERINFO::DUDVREQUIRED), maxon::UInt64(enum4776::SHADERINFO::DYNAMICSUBSHADERS), maxon::UInt64(enum4776::SHADERINFO::TRANSPARENCIES)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SHADERINFO4776(){ return enum4776::SHADERINFO_info; }
namespace enum4787
{
	...
	static const maxon::UInt64 SAMPLEBUMP_values[] = {maxon::UInt64(enum4787::SAMPLEBUMP::NONE), maxon::UInt64(enum4787::SAMPLEBUMP::MIPFALLOFF)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SAMPLEBUMP4787(){ return enum4787::SAMPLEBUMP_info; }
namespace enum4800
{
	...
	static const maxon::UInt64 INITCALCULATION_values[] = {maxon::UInt64(enum4800::INITCALCULATION::SURFACE), maxon::UInt64(enum4800::INITCALCULATION::TRANSPARENCY), maxon::UInt64(enum4800::INITCALCULATION::DISPLACEMENT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_INITCALCULATION4800(){ return enum4800::INITCALCULATION_info; }
namespace enum4821
{
	...
	static const maxon::UInt64 FIELDLAYER_FLAG_values[] = {maxon::UInt64(enum4821::FIELDLAYER_FLAG::NONE), maxon::UInt64(enum4821::FIELDLAYER_FLAG::SKIP), maxon::UInt64(enum4821::FIELDLAYER_FLAG::ERRORSKIP), maxon::UInt64(enum4821::FIELDLAYER_FLAG::HIDE), maxon::UInt64(enum4821::FIELDLAYER_FLAG::MODIFYDATA), maxon::UInt64(enum4821::FIELDLAYER_FLAG::PRESERVEALPHA), maxon::UInt64(enum4821::FIELDLAYER_FLAG::NOCHILDVALUE), maxon::UInt64(enum4821::FIELDLAYER_FLAG::NOCHILDCOLOR), maxon::UInt64(enum4821::FIELDLAYER_FLAG::NOCHILDDIRECTION), maxon::UInt64(enum4821::FIELDLAYER_FLAG::TEMPORARY), maxon::UInt64(enum4821::FIELDLAYER_FLAG::NOCHILDROTATION)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FIELDLAYER_FLAG4821(){ return enum4821::FIELDLAYER_FLAG_info; }
namespace enum4931
{
	...
	static const maxon::UInt64 MULTIPASSCHANNEL_values[] = {maxon::UInt64(enum4931::MULTIPASSCHANNEL::NONE), maxon::UInt64(enum4931::MULTIPASSCHANNEL::IMAGELAYER), maxon::UInt64(enum4931::MULTIPASSCHANNEL::MATERIALCHANNEL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MULTIPASSCHANNEL4931(){ return enum4931::MULTIPASSCHANNEL_info; }
namespace enum4950
{
	enum class DLG_TYPE
	{
	...
	static const maxon::UInt64 DLG_TYPE_values[] = {maxon::UInt64(enum4950::DLG_TYPE::MODAL), maxon::UInt64(enum4950::DLG_TYPE::MODAL_RESIZEABLE), maxon::UInt64(enum4950::DLG_TYPE::ASYNC), maxon::UInt64(enum4950::DLG_TYPE::ASYNC_POPUP_RESIZEABLE), maxon::UInt64(enum4950::DLG_TYPE::ASYNC_POPUPEDIT), maxon::UInt64(enum4950::DLG_TYPE::ASYNC_FULLSCREEN_WORK), maxon::UInt64(enum4950::DLG_TYPE::ASYNC_FULLSCREEN_MONITOR), maxon::UInt64(enum4950::DLG_TYPE::DUMMY)};
	static const maxon::EnumInfo DLG_TYPE_info{"DLG_TYPE", SIZEOF(DLG_TYPE), false, "MODAL\0MODAL_RESIZEABLE\0ASYNC\0ASYNC_POPUP_RESIZEABLE\0ASYNC_POPUPEDIT\0ASYNC_FULLSCREEN_WORK\0ASYNC_FULLSCREEN_MONITOR\0DUMMY\0", DLG_TYPE_values, std::extent<decltype(DLG_TYPE_values)>::value};
}
const maxon::EnumInfo& PrivateGetEnumInfo_DLG_TYPE4950(){ return enum4950::DLG_TYPE_info; }
namespace enum4963
{
	...
	static const maxon::UInt64 MULTIMSG_ROUTE_values[] = {maxon::UInt64(enum4963::MULTIMSG_ROUTE::NONE), maxon::UInt64(enum4963::MULTIMSG_ROUTE::UP), maxon::UInt64(enum4963::MULTIMSG_ROUTE::ROOT), maxon::UInt64(enum4963::MULTIMSG_ROUTE::DOWN), maxon::UInt64(enum4963::MULTIMSG_ROUTE::BROADCAST)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_MULTIMSG_ROUTE4963(){ return enum4963::MULTIMSG_ROUTE_info; }
namespace enum4974
{
	...
	static const maxon::UInt64 VPGETFRAGMENTS_values[] = {maxon::UInt64(enum4974::VPGETFRAGMENTS::NONE), maxon::UInt64(enum4974::VPGETFRAGMENTS::Z_P), maxon::UInt64(enum4974::VPGETFRAGMENTS::N)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VPGETFRAGMENTS4974(){ return enum4974::VPGETFRAGMENTS_info; }
namespace enum5002
{
	...
	static const maxon::UInt64 NAV2DCAMERASETTINGSCACHEMODE_values[] = {maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::REVERT), maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::STOREIFIN2D), maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::STOREIFIN2DANDNOTALREADYSTORED), maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::FORCESTORE), maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::RET_CHANGED), maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::RET_NOCHANGE), maxon::UInt64(enum5002::NAV2DCAMERASETTINGSCACHEMODE::INVALID)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_NAV2DCAMERASETTINGSCACHEMODE5002(){ return enum5002::NAV2DCAMERASETTINGSCACHEMODE_info; }
namespace enum5014
{
	...
	static const maxon::UInt64 SIGNALMODE_values[] = {maxon::UInt64(enum5014::SIGNALMODE::V_DEFAULT), maxon::UInt64(enum5014::SIGNALMODE::V_RESERVED)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SIGNALMODE5014(){ return enum5014::SIGNALMODE_info; }
namespace enum5028
{
	...
	static const maxon::UInt64 QUALIFIER_values[] = {maxon::UInt64(enum5028::QUALIFIER::NONE), maxon::UInt64(enum5028::QUALIFIER::SHIFT), maxon::UInt64(enum5028::QUALIFIER::CTRL), maxon::UInt64(enum5028::QUALIFIER::ALT), maxon::UInt64(enum5028::QUALIFIER::MOUSEHIT)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_QUALIFIER5028(){ return enum5028::QUALIFIER_info; }
namespace enum5238
{
	...
	static const maxon::UInt64 NOTIFY_EVENT_values[] = {maxon::UInt64(enum5238::NOTIFY_EVENT::NONE), maxon::UInt64(enum5238::NOTIFY_EVENT::ALL), maxon::UInt64(enum5238::NOTIFY_EVENT::ANY), maxon::UInt64(enum5238::NOTIFY_EVENT::PRE_DEFORM), maxon::UInt64(enum5238::NOTIFY_EVENT::POST_DEFORM), maxon::UInt64(enum5238::NOTIFY_EVENT::UNDO), maxon::UInt64(enum5238::NOTIFY_EVENT::MESSAGE), maxon::UInt64(enum5238::NOTIFY_EVENT::FREE), maxon::UInt64(enum5238::NOTIFY_EVENT::COPY), maxon::UInt64(enum5238::NOTIFY_EVENT::CACHE), maxon::UInt64(enum5238::NOTIFY_EVENT::REMOVE), maxon::UInt64(enum5238::NOTIFY_EVENT::CLONE), maxon::UInt64(enum5238::NOTIFY_EVENT::INSERT), maxon::UInt64(enum5238::NOTIFY_EVENT::SELECTIONBIT), maxon::UInt64(enum5238::NOTIFY_EVENT::HIGHLIGHTBIT), maxon::UInt64(enum5238::NOTIFY_EVENT::SETNAME)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_NOTIFY_EVENT5238(){ return enum5238::NOTIFY_EVENT_info; }
namespace enum5256
{
	...
	static const maxon::UInt64 NOTIFY_EVENT_FLAG_values[] = {maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::REMOVED), maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::COPY_UNDO), maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::COPY_CACHE), maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::COPY_DUPLICATE), maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::ONCE), maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::COPY), maxon::UInt64(enum5256::NOTIFY_EVENT_FLAG::NONE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_NOTIFY_EVENT_FLAG5256(){ return enum5256::NOTIFY_EVENT_FLAG_info; }
namespace enum5269
{
	...
	static const maxon::UInt64 DESCIDSTATE_values[] = {maxon::UInt64(enum5269::DESCIDSTATE::NONE), maxon::UInt64(enum5269::DESCIDSTATE::LOCKED), maxon::UInt64(enum5269::DESCIDSTATE::HIDDEN), maxon::UInt64(enum5269::DESCIDSTATE::OVERRIDE), maxon::UInt64(enum5269::DESCIDSTATE::FORBIDOVERRIDE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_DESCIDSTATE5269(){ return enum5269::DESCIDSTATE_info; }
namespace enum5280
{
	...
	static const maxon::UInt64 BASEDRAW_HOOK_MESSAGE_values[] = {maxon::UInt64(enum5280::BASEDRAW_HOOK_MESSAGE::ADAPTVIEW), maxon::UInt64(enum5280::BASEDRAW_HOOK_MESSAGE::SET_SCENE_CAMERA), maxon::UInt64(enum5280::BASEDRAW_HOOK_MESSAGE::DELETEBASEDRAW)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_BASEDRAW_HOOK_MESSAGE5280(){ return enum5280::BASEDRAW_HOOK_MESSAGE_info; }
namespace enum5297
{
	...
	static const maxon::UInt64 CINEMAINFO_values[] = {maxon::UInt64(enum5297::CINEMAINFO::TABLETT), maxon::UInt64(enum5297::CINEMAINFO::OPENGL), maxon::UInt64(enum5297::CINEMAINFO::TABLETT_HIRES), maxon::UInt64(enum5297::CINEMAINFO::FORBID_GUI), maxon::UInt64(enum5297::CINEMAINFO::MINIMAL_VIEWPORT), maxon::UInt64(enum5297::CINEMAINFO::LISTEN), maxon::UInt64(enum5297::CINEMAINFO::WATCH_PID), maxon::UInt64(enum5297::CINEMAINFO::SETFOREGROUND), maxon::UInt64(enum5297::CINEMAINFO::FORCEDIALOG)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_CINEMAINFO5297(){ return enum5297::CINEMAINFO_info; }
namespace enum5308
{
	enum class PROTOCOL
	{
	...
	static const maxon::UInt64 PROTOCOL_values[] = {maxon::UInt64(enum5308::PROTOCOL::ZERO), maxon::UInt64(enum5308::PROTOCOL::IPV4), maxon::UInt64(enum5308::PROTOCOL::IPV6)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_PROTOCOL5308(){ return enum5308::PROTOCOL_info; }
namespace enum5319
{
	...
	static const maxon::UInt64 RESOLVERESULT_values[] = {maxon::UInt64(enum5319::RESOLVERESULT::OK), maxon::UInt64(enum5319::RESOLVERESULT::UNKNOWN)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RESOLVERESULT5319(){ return enum5319::RESOLVERESULT_info; }
namespace enum5331
{
	...
	static const maxon::UInt64 SERVERJOBLIST_values[] = {maxon::UInt64(enum5331::SERVERJOBLIST::INACTIVE), maxon::UInt64(enum5331::SERVERJOBLIST::ACTIVE), maxon::UInt64(enum5331::SERVERJOBLIST::DOWNLOAD), maxon::UInt64(enum5331::SERVERJOBLIST::ALL)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SERVERJOBLIST5331(){ return enum5331::SERVERJOBLIST_info; }
namespace enum5343
{
	enum class EDITION
	{
	...
	static const maxon::UInt64 EDITION_values[] = {maxon::UInt64(enum5343::EDITION::C4D), maxon::UInt64(enum5343::EDITION::NETCLIENT), maxon::UInt64(enum5343::EDITION::NETSERVER), maxon::UInt64(enum5343::EDITION::NET)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_EDITION5343(){ return enum5343::EDITION_info; }
namespace enum5360
{
	...
	static const maxon::UInt64 JOBCOMMAND_values[] = {maxon::UInt64(enum5360::JOBCOMMAND::NONE), maxon::UInt64(enum5360::JOBCOMMAND::FETCHJOB), maxon::UInt64(enum5360::JOBCOMMAND::ALLOCATESPACE), maxon::UInt64(enum5360::JOBCOMMAND::DOWNLOAD), maxon::UInt64(enum5360::JOBCOMMAND::RENDER), maxon::UInt64(enum5360::JOBCOMMAND::DELETE_), maxon::UInt64(enum5360::JOBCOMMAND::STOPANDDELETE), maxon::UInt64(enum5360::JOBCOMMAND::ASSEMBLE), maxon::UInt64(enum5360::JOBCOMMAND::END)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_JOBCOMMAND5360(){ return enum5360::JOBCOMMAND_info; }
namespace enum5371
{
	...
	static const maxon::UInt64 RENDERTARGET_values[] = {maxon::UInt64(enum5371::RENDERTARGET::ALL), maxon::UInt64(enum5371::RENDERTARGET::SPECIFIED), maxon::UInt64(enum5371::RENDERTARGET::MINMAX)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_RENDERTARGET5371(){ return enum5371::RENDERTARGET_info; }
namespace enum5407
{
	enum class JOBSTATE
	{
	...
	static const maxon::UInt64 JOBSTATE_values[] = {maxon::UInt64(enum5407::JOBSTATE::IDLE), maxon::UInt64(enum5407::JOBSTATE::PREPARING_RUNNING), maxon::UInt64(enum5407::JOBSTATE::PREPARING_FAILED), maxon::UInt64(enum5407::JOBSTATE::PREPARING_OK), maxon::UInt64(enum5407::JOBSTATE::RENDER_RUNNING), maxon::UInt64(enum5407::JOBSTATE::TE_RENDER_PAUSED), maxon::UInt64(enum5407::JOBSTATE::RENDER_OK), maxon::UInt64(enum5407::JOBSTATE::RENDER_FAILED), maxon::UInt64(enum5407::JOBSTATE::ALLOCATESPACE_RUNNING), maxon::UInt64(enum5407::JOBSTATE::ALLOCATESPACE_OK), maxon::UInt64(enum5407::JOBSTATE::ALLOCATESPACE_FAILED), maxon::UInt64(enum5407::JOBSTATE::DOWNLOAD_RUNNING), maxon::UInt64(enum5407::JOBSTATE::DOWNLOAD_OK), maxon::UInt64(enum5407::JOBSTATE::DOWNLOAD_FAILED), maxon::UInt64(enum5407::JOBSTATE::ASSEMBLE_RUNNING), maxon::UInt64(enum5407::JOBSTATE::ASSEMBLE_OK), maxon::UInt64(enum5407::JOBSTATE::ASSEMBLE_FAILED), maxon::UInt64(enum5407::JOBSTATE::STOPPED), maxon::UInt64(enum5407::JOBSTATE::QUEUED), maxon::UInt64(enum5407::JOBSTATE::PENDING), maxon::UInt64(enum5407::JOBSTATE::QUEUED_WAITING), maxon::UInt64(enum5407::JOBSTATE::ASSEMBLE_PENDING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_JOBSTATE5407(){ return enum5407::JOBSTATE_info; }
namespace enum5419
{
	...
	static const maxon::UInt64 ZEROCONFMACHINESTATE_values[] = {maxon::UInt64(enum5419::ZEROCONFMACHINESTATE::ONLINE), maxon::UInt64(enum5419::ZEROCONFMACHINESTATE::OFFLINE), maxon::UInt64(enum5419::ZEROCONFMACHINESTATE::REMOVED), maxon::UInt64(enum5419::ZEROCONFMACHINESTATE::UPDATE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ZEROCONFMACHINESTATE5419(){ return enum5419::ZEROCONFMACHINESTATE_info; }
namespace enum5430
{
	...
	static const maxon::UInt64 ZEROCONFACTION_values[] = {maxon::UInt64(enum5430::ZEROCONFACTION::NONE), maxon::UInt64(enum5430::ZEROCONFACTION::RESOLVE), maxon::UInt64(enum5430::ZEROCONFACTION::MONITOR)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ZEROCONFACTION5430(){ return enum5430::ZEROCONFACTION_info; }
namespace enum5469
{
	...
	static const maxon::UInt64 ZEROCONFERROR_values[] = {maxon::UInt64(enum5469::ZEROCONFERROR::OK), maxon::UInt64(enum5469::ZEROCONFERROR::UNKNOWN), maxon::UInt64(enum5469::ZEROCONFERROR::NOSUCHNAME), maxon::UInt64(enum5469::ZEROCONFERROR::NOMEMORY), maxon::UInt64(enum5469::ZEROCONFERROR::BADPARAM), maxon::UInt64(enum5469::ZEROCONFERROR::BADREFERENCE), maxon::UInt64(enum5469::ZEROCONFERROR::BADSTATE), maxon::UInt64(enum5469::ZEROCONFERROR::BADFLAGS), maxon::UInt64(enum5469::ZEROCONFERROR::UNSUPPORTED), maxon::UInt64(enum5469::ZEROCONFERROR::NOTINITIALIZED), maxon::UInt64(enum5469::ZEROCONFERROR::ALREADYREGISTERED), maxon::UInt64(enum5469::ZEROCONFERROR::NAMECONFLICT), maxon::UInt64(enum5469::ZEROCONFERROR::INVALID), maxon::UInt64(enum5469::ZEROCONFERROR::FIREWALL), maxon::UInt64(enum5469::ZEROCONFERROR::INCOMPATIBLE), maxon::UInt64(enum5469::ZEROCONFERROR::BADINTERFACEINDEX), maxon::UInt64(enum5469::ZEROCONFERROR::REFUSED), maxon::UInt64(enum5469::ZEROCONFERROR::NOSUCHRECORD), maxon::UInt64(enum5469::ZEROCONFERROR::NOAUTH), maxon::UInt64(enum5469::ZEROCONFERROR::NOSUCHKEY), maxon::UInt64(enum5469::ZEROCONFERROR::NATTRAVERSAL), maxon::UInt64(enum5469::ZEROCONFERROR::DOUBLENAT), maxon::UInt64(enum5469::ZEROCONFERROR::BADTIME), maxon::UInt64(enum5469::ZEROCONFERROR::BADSIGNAL), maxon::UInt64(enum5469::ZEROCONFERROR::BADKEY), maxon::UInt64(enum5469::ZEROCONFERROR::TRANSIENT), maxon::UInt64(enum5469::ZEROCONFERROR::SERVICENOTRUNNING), maxon::UInt64(enum5469::ZEROCONFERROR::NATPORTMAPPINGUNSUPPORTED), maxon::UInt64(enum5469::ZEROCONFERROR::NATPORTMAPPINGDISABLED), maxon::UInt64(enum5469::ZEROCONFERROR::NOROUTER), maxon::UInt64(enum5469::ZEROCONFERROR::POLLINGMODE)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_ZEROCONFERROR5469(){ return enum5469::ZEROCONFERROR_info; }
namespace enum5499
{
	...
	static const maxon::UInt64 COMPONENT_SELECTION_MODES_values[] = {maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::POINTS), maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::EDGES), maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::POLYGONS), maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::UVPOINTS), maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::UVPOLYGONS), maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::CURRENT), maxon::UInt64(enum5499::COMPONENT_SELECTION_MODES::UVEDGES)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_COMPONENT_SELECTION_MODES5499(){ return enum5499::COMPONENT_SELECTION_MODES_info; }
namespace enum5513
{
	...
	static const maxon::UInt64 FIELDSAMPLE_FLAG_values[] = {maxon::UInt64(enum5513::FIELDSAMPLE_FLAG::VALUE), maxon::UInt64(enum5513::FIELDSAMPLE_FLAG::DIRECTION), maxon::UInt64(enum5513::FIELDSAMPLE_FLAG::COLOR), maxon::UInt64(enum5513::FIELDSAMPLE_FLAG::ROTATION), maxon::UInt64(enum5513::FIELDSAMPLE_FLAG::ALL), maxon::UInt64(enum5513::FIELDSAMPLE_FLAG::NONLINEARCOLOR)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FIELDSAMPLE_FLAG5513(){ return enum5513::FIELDSAMPLE_FLAG_info; }
namespace enum5523
{
	...
	static const maxon::UInt64 FIELDOBJECTSAMPLE_FLAG_values[] = {maxon::UInt64(enum5523::FIELDOBJECTSAMPLE_FLAG::NONE), maxon::UInt64(enum5523::FIELDOBJECTSAMPLE_FLAG::DISABLEDIRECTIONFALLOFF)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FIELDOBJECTSAMPLE_FLAG5523(){ return enum5523::FIELDOBJECTSAMPLE_FLAG_info; }
namespace enum5537
{
	...
	static const maxon::UInt64 FIELDOBJECT_FLAG_values[] = {maxon::UInt64(enum5537::FIELDOBJECT_FLAG::NONE), maxon::UInt64(enum5537::FIELDOBJECT_FLAG::INLINE), maxon::UInt64(enum5537::FIELDOBJECT_FLAG::GENERATINGCOLOR), maxon::UInt64(enum5537::FIELDOBJECT_FLAG::PRESERVEALPHA), maxon::UInt64(enum5537::FIELDOBJECT_FLAG::SKIP), maxon::UInt64(enum5537::FIELDOBJECT_FLAG::ERRORSKIP)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FIELDOBJECT_FLAG5537(){ return enum5537::FIELDOBJECT_FLAG_info; }
namespace enum5549
{
	...
	static const maxon::UInt64 VIEWPORT_RENDER_ID_values[] = {maxon::UInt64(enum5549::VIEWPORT_RENDER_ID::RENDER_OBJECT), maxon::UInt64(enum5549::VIEWPORT_RENDER_ID::DATA_SETTER)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VIEWPORT_RENDER_ID5549(){ return enum5549::VIEWPORT_RENDER_ID_info; }
namespace enum5567
{
	...
	static const maxon::UInt64 GETALLASSETSRESULT_values[] = {maxon::UInt64(enum5567::GETALLASSETSRESULT::FAILED), maxon::UInt64(enum5567::GETALLASSETSRESULT::OK), maxon::UInt64(enum5567::GETALLASSETSRESULT::MISSING)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_GETALLASSETSRESULT5567(){ return enum5567::GETALLASSETSRESULT_info; }
namespace enum5579
{
	...
	static const maxon::UInt64 VIEWPORTTYPE_values[] = {maxon::UInt64(enum5579::VIEWPORTTYPE::NONE), maxon::UInt64(enum5579::VIEWPORTTYPE::MAIN_VIEW), maxon::UInt64(enum5579::VIEWPORTTYPE::UV_VIEW)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_VIEWPORTTYPE5579(){ return enum5579::VIEWPORTTYPE_info; }
namespace enum5592
{
	...
	static const maxon::UInt64 SCENENODES_IDS_values[] = {maxon::UInt64(enum5592::SCENENODES_IDS::SCENEHOOK_ID), maxon::UInt64(enum5592::SCENENODES_IDS::MSGUPDATE_LEGACYOBJ_ID), maxon::UInt64(enum5592::SCENENODES_IDS::PERSISTENT_HASH_LOW_ID)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_SCENENODES_IDS5592(){ return enum5592::SCENENODES_IDS_info; }
namespace enum5601
{
	enum class FOLDMODE
	{
	...
	static const maxon::UInt64 FOLDMODE_values[] = {maxon::UInt64(enum5601::FOLDMODE::NONE), maxon::UInt64(enum5601::FOLDMODE::HIDEMYSELF), maxon::UInt64(enum5601::FOLDMODE::EXPAND1STEP), maxon::UInt64(enum5601::FOLDMODE::EXPANDCOMPLETELY)};
...
const maxon::EnumInfo& PrivateGetEnumInfo_FOLDMODE5601(){ return enum5601::FOLDMODE_info; }
#ifdef CINEWARE_NAMESPACE_ENABLE
