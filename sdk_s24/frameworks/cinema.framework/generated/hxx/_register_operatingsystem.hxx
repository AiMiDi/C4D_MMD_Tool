...
namespace enum853
{
	enum class OPENDIALOGFLAGS
	{
		...
		ALIGNTOPRIGHTATMOUSE = (1 << 2), ///< aligns the manager at the top/right position of the current mouse position.
	} ;
	static const maxon::UInt64 OPENDIALOGFLAGS_values[] = {maxon::UInt64(enum853::OPENDIALOGFLAGS::NONE), maxon::UInt64(enum853::OPENDIALOGFLAGS::IGNORELAYOUT), maxon::UInt64(enum853::OPENDIALOGFLAGS::CLIENTCOORDINATES), maxon::UInt64(enum853::OPENDIALOGFLAGS::ALIGNTOPRIGHTATMOUSE)};
	static const maxon::EnumInfo OPENDIALOGFLAGS_info{"OPENDIALOGFLAGS", SIZEOF(OPENDIALOGFLAGS), true, "NONE\0IGNORELAYOUT\0CLIENTCOORDINATES\0ALIGNTOPRIGHTATMOUSE\0", OPENDIALOGFLAGS_values, std::extent<decltype(OPENDIALOGFLAGS_values)>::value};
}
