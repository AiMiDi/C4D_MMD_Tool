...
{
	template <typename S> using CWrapper = typename DataDictionaryObjectInterface::Hxx2::template CWrapper<S>;
};
...
{
	template <typename S> using CWrapper = typename DataDescriptionObjectInterface::Hxx2::template CWrapper<typename DataDictionaryReferenceObjectInterface::Hxx2::template CWrapper<S>>;
};
