...
/// @return												The command result or an error.
	...
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, typename DataDictionaryObjectInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type, ReferenceFunctionsImpl<typename DataDictionaryObjectInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
/// @return												Reference to the legacy data at index.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	maxon::Bool(ST::type::Handler::KIND & (maxon::VALUEKIND::COW_MASK | maxon::VALUEKIND::DEEP_CONSTNESS)),
	COWReferenceFunctionsImpl<typename CommandDataInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>,
	typename std::conditional<std::is_const<typename ST::type::PrivateReferencedType>::value, ConstReferenceFunctionsImpl<typename CommandDataInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>, ReferenceFunctionsImpl<typename CommandDataInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>>::type
	> { };
};
...
struct CommandDescriptionClassInterface::Hxx1
{
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	false, void,
	ConstReferenceFunctionsImpl<typename DataDescriptionObjectInterface::Hxx1::template ReferenceFunctionsHelper<typename DataDictionaryReferenceObjectInterface::Hxx1::template ReferenceFunctionsHelper<ST>>::type>
	> { };
};
...
/// @return												OK on success.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	false, void,
	ConstReferenceFunctionsImpl<typename CommandClassInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>
	> { };
};
...
/// @return												The command plugin id.
	...
	template <typename ST> struct ReferenceFunctionsHelper : public std::conditional<
	false, void,
	ConstReferenceFunctionsImpl<typename LegacyCommandClassInterface::Hxx1::template ReferenceFunctionsHelper<ST>::type>
	> { };
};
