...
namespace maxon
{
	...
	maxon::Bool InterpolateTypeInterface::Hxx2::StaticMTable::InitUnresolved(maxon::NonvirtualInterfaceReference::UnresolvedAssembler assembler, Hxx2::StaticMTable* tbl)
	{
		...
		if (maxon::details::NullReturnType<InterpolateType>::value == maxon::NULL_RETURN_TYPE::OTHER) tbl->_InterpolateTypeInterface_GetInterpolationClass = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_InterpolateTypeInterface_GetInterpolationClass;
		#else
		tbl->_InterpolateTypeInterface_GetInterpolationClass = &Hxx2::CWrapper<maxon::StaticHelper<Hxx2::Unresolved>>::_InterpolateTypeInterface_GetInterpolationClass;
		#endif
	#ifdef PRIVATE_MAXON_ASSEMBLE_UNRESOLVED
