...
template <typename S> MAXON_ATTRIBUTE_FORCE_INLINE auto InterpolateTypeInterface::Hxx1::ConstReferenceFunctionsImpl<S>::GetInterpolationClass(const DataType& datatype) -> InterpolateType { return (Hxx2::StaticMTable::_instance._InterpolateTypeInterface_GetInterpolationClass(datatype)); }
