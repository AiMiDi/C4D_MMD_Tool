...
namespace maxon
{
	...
	public:
		...
		const DataType& GetInterpolateDataType() const 
		{
			...
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._InterpolateTypeInterface_GetInterpolateDataType_Offset)};
			(*handler_)(_fn_InterpolateTypeInterface_GetInterpolateDataType, o_, maxon::reflection::ProxyInvocation(std::addressof(proxy_result), proxy_args, &maxon::reflection::Invocation<const DataType&, const maxon::GenericComponent*>::Invoke, (const void*) mt_._InterpolateTypeInterface_GetInterpolateDataType));
			return *proxy_result;
		}
		...
		void InterpolateLinear(void* data1, const void* data2, Float blend) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<InterpolateTypeInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._InterpolateTypeInterface_InterpolateLinear_Offset), maxon::reflection::Argument::ByValue(data1), maxon::reflection::Argument::ByValue(data2), maxon::reflection::Argument::ByValue(blend)};
			(*handler_)(_fn_InterpolateTypeInterface_InterpolateLinear, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const void*, Float>::Invoke, (const void*) mt_._InterpolateTypeInterface_InterpolateLinear));
		}
		...
		void InterpolateInOutline(void* data, const Block<void*>& outline, const Block<Float>& weights) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<InterpolateTypeInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._InterpolateTypeInterface_InterpolateInOutline_Offset), maxon::reflection::Argument::ByValue(data), maxon::reflection::Argument::ByReference(outline), maxon::reflection::Argument::ByReference(weights)};
			(*handler_)(_fn_InterpolateTypeInterface_InterpolateInOutline, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const Block<void*>&, const Block<Float>&>::Invoke, (const void*) mt_._InterpolateTypeInterface_InterpolateInOutline));
		}
		...
		void Average(void* data, const Block<const void*>& dataSet) const 
		{
			...
			const MTable& mt_ = ((const typename ProxyComponent::PrivateSuperMTable*) proxy_info->_supervtable.GetPointer())->template GetMTable<InterpolateTypeInterface>();
			maxon::reflection::Argument proxy_args[] = {maxon::reflection::Argument::ByValue(reinterpret_cast<maxon::GenericComponent*>(o_) + mt_._InterpolateTypeInterface_Average_Offset), maxon::reflection::Argument::ByValue(data), maxon::reflection::Argument::ByReference(dataSet)};
			(*handler_)(_fn_InterpolateTypeInterface_Average, o_, maxon::reflection::ProxyInvocation(nullptr, proxy_args, &maxon::reflection::Invocation<void, const maxon::GenericComponent*, void*, const Block<const void*>&>::Invoke, (const void*) mt_._InterpolateTypeInterface_Average));
		}
	...
	static maxon::Result<void> RegisterReflection_InterpolateTypeInterface_Static(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		...
		{
			maxon::reflection::GetFunctionInfo<std::remove_pointer<decltype(InterpolateTypeInterface::Hxx2::StaticMTable::_instance._InterpolateTypeInterface_GetInterpolationClass)>::type>(nullptr, maxon::reflection::Member::KIND::FUNCTION, "datatype\0", 1LL, nullptr),
		};
	...
	static maxon::Result<void> RegisterReflection_InterpolateTypeInterface(maxon::reflection::Class* cls, maxon::reflection::FunctionRegistrationCallback callback)
	{
		maxon::reflection::FunctionInfo functions[] =
		{
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "", 0LL, InterpolateTypeInterface, _InterpolateTypeInterface_GetInterpolateDataType),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "data1\0data2\0blend\0", 23LL, InterpolateTypeInterface, _InterpolateTypeInterface_InterpolateLinear),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "data\0outline\0weights\0", 23LL, InterpolateTypeInterface, _InterpolateTypeInterface_InterpolateInOutline),
			MAXON_GET_VIRTUAL_METHOD_INFO(CONST_INSTANCE_FUNCTION, "data\0dataSet\0", 7LL, InterpolateTypeInterface, _InterpolateTypeInterface_Average),
		};
