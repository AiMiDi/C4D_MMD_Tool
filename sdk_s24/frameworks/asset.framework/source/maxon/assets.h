...
//----------------------------------------------------------------------------------------
class AssetTypeInterface : MAXON_INTERFACE_BASES(ObjectInterface)
{
...
private:
	[[deprecated]] MAXON_METHOD Result<String> GetAssetName(const AssetDescription& asset, const LanguageRef& languageRef) const;

	[[deprecated]] MAXON_METHOD Result<void> SetAssetName(const AssetDescription& asset, const String& name, const LanguageRef& languageRef) const;
...
//----------------------------------------------------------------------------------------
MAXON_DECLARATION(ComponentDescriptor, AssetTypeBaseComponent, "net.maxon.component.assettypebase");
...
public:
	...
	/// @MAXON_ANNOTATION{methodId="PrivateFindAssets@55403f5e37ca2414"->"PrivateFindAssets@64b3d047f1424e58"}
	...
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<AssetDescription> FindLatestAsset(const Id& type, const Id& aid, const Id& version) const;
...
public:
	...
	/// @return												The found asset, or a null reference.
	//----------------------------------------------------------------------------------------
	MAXON_METHOD Result<AssetDescription> FindLatestAsset(const Id& type, const Id& aid, const Id& version, ASSET_FIND_MODE findMode) const;
...
private:
	[[deprecated]] MAXON_METHOD Result<String> GetAssetName(const LanguageRef& languageRef, const String& fallbackName) const;

	[[deprecated]] MAXON_METHOD Result<void> SetAssetName(const String& name, const LanguageRef& languageRef) const;
...
using DndAsset = Tuple<AssetDescription, Url>;
